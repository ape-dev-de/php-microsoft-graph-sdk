...
/**
 * Tests for DirectoryRoleTemplates collection
 */
class DirectoryRoleTemplatesTest extends GraphTestCase
{
    public function testCanAccessBuilder(): void
    {
        $builder = self::$client->directoryRoleTemplates();
        $this->assertNotNull($builder);
    }

    public function testCanGetCollection(): void
    {
        $collection = self::$client->directoryRoleTemplates()->get();
    ...
    public function testCanGetItemById(): void
    {
        ...
        // Get item by ID
        $fetchedItem = self::$client->directoryRoleTemplates()->byId($itemId)->get();
    ...
    {
        $queryOptionsClass = 'ApeDevDe\\MicrosoftGraphSdk\\QueryOptions\\DirectoryRoleTemplatesQueryOptions';
        ...
        $this->assertNotEmpty($constants, 'DirectoryRoleTemplatesQueryOptions should have field constants');
        ...
        $this->assertNotEmpty($fieldConstants, 'DirectoryRoleTemplatesQueryOptions should have FIELD_* constants');
    }

    public function testCollectionResponseHasTypeSafety(): void
    {
        $collectionClass = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\DirectoryRoleTemplateCollectionResponse';
        
        if (!class_exists($collectionClass)) {
            $this->markTestSkipped('DirectoryRoleTemplateCollectionResponse does not exist');
        }
        ...
        if (count($parameters) > 0) {
            $this->assertTrue($parameters[0]->isVariadic(), 'DirectoryRoleTemplateCollectionResponse should have variadic setValue parameter');
        }
    }
    ...
    public function testCanAccessCheckMemberGroupsSubpath(): void
    {
        ...
        $result = self::$client->directoryRoleTemplates()->byId($itemId)->checkMemberGroups()->get();
    ...
    public function testCanAccessCheckMemberObjectsSubpath(): void
    {
        ...
        // Access subpath and get data
        $result = self::$client->directoryRoleTemplates()->byId($itemId)->checkMemberObjects()->get();
        $this->assertNotNull($result);
    }
    ...
    public function testCanAccessGetMemberGroupsSubpath(): void
    {
        ...
        // Access subpath and get data
        $result = self::$client->directoryRoleTemplates()->byId($itemId)->getMemberGroups()->get();
        $this->assertNotNull($result);
    }
