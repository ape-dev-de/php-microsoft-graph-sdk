...
/**
 * Tests for Agreements collection
 */
class AgreementsTest extends GraphTestCase
{
    public function testCanAccessBuilder(): void
    {
        $builder = self::$client->agreements();
        $this->assertNotNull($builder);
    }

    public function testCanGetCollection(): void
    {
        $collection = self::$client->agreements()->get();
    ...
    public function testCanGetItemById(): void
    {
        ...
        // Get item by ID
        $fetchedItem = self::$client->agreements()->byId($itemId)->get();
    ...
    {
        $queryOptionsClass = 'ApeDevDe\\MicrosoftGraphSdk\\QueryOptions\\AgreementsQueryOptions';
        ...
        $this->assertNotEmpty($constants, 'AgreementsQueryOptions should have field constants');
        ...
        $this->assertNotEmpty($fieldConstants, 'AgreementsQueryOptions should have FIELD_* constants');
    }

    public function testCollectionResponseHasTypeSafety(): void
    {
        $collectionClass = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\AgreementCollectionResponse';
        
        if (!class_exists($collectionClass)) {
            $this->markTestSkipped('AgreementCollectionResponse does not exist');
        }
        ...
        if (count($parameters) > 0) {
            $this->assertTrue($parameters[0]->isVariadic(), 'AgreementCollectionResponse should have variadic setValue parameter');
        }
    }

    public function testCanAccessAcceptancesSubpath(): void
    {
        // Get first item from collection
        $collection = self::$client->agreements()->get(
            queryParameters: ['$top' => 1]
        ...
        $result = self::$client->agreements()->byId($itemId)->acceptances()->get();
        $this->assertNotNull($result);
    }

    public function testCanAccessFileSubpath(): void
    {
        // Get first item from collection
        $collection = self::$client->agreements()->get(
            queryParameters: ['$top' => 1]
        ...
        // Access subpath and get data
        $result = self::$client->agreements()->byId($itemId)->file()->get();
        $this->assertNotNull($result);
    }

    public function testCanAccessFilesSubpath(): void
    {
        // Get first item from collection
        $collection = self::$client->agreements()->get(
            queryParameters: ['$top' => 1]
        ...
        // Access subpath and get data
        $result = self::$client->agreements()->byId($itemId)->files()->get();
        $this->assertNotNull($result);
    }

    public function testCanAccessFileLocalizationsNestedSubpath(): void
    {
        // Get first item from collection
        $collection = self::$client->agreements()->get(
            queryParameters: ['$top' => 1]
        ...
        $result = self::$client->agreements()->byId($itemId)->file()->localizations()->get();
        $this->assertNotNull($result);
    }
