...
/**
 * Tests for DirectoryRoles collection
 */
class DirectoryRolesTest extends GraphTestCase
{
    public function testCanAccessBuilder(): void
    {
        $builder = self::$client->directoryRoles();
        $this->assertNotNull($builder);
    }

    public function testCanGetCollection(): void
    {
        $collection = self::$client->directoryRoles()->get();
    ...
    public function testCanGetItemById(): void
    {
        ...
        // Get item by ID
        $fetchedItem = self::$client->directoryRoles()->byId($itemId)->get();
    ...
    {
        $queryOptionsClass = 'ApeDevDe\\MicrosoftGraphSdk\\QueryOptions\\DirectoryRolesQueryOptions';
        ...
        $this->assertNotEmpty($constants, 'DirectoryRolesQueryOptions should have field constants');
        ...
        $this->assertNotEmpty($fieldConstants, 'DirectoryRolesQueryOptions should have FIELD_* constants');
    }

    public function testCollectionResponseHasTypeSafety(): void
    {
        $collectionClass = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\DirectoryRoleCollectionResponse';
        
        if (!class_exists($collectionClass)) {
            $this->markTestSkipped('DirectoryRoleCollectionResponse does not exist');
        }
        ...
        if (count($parameters) > 0) {
            $this->assertTrue($parameters[0]->isVariadic(), 'DirectoryRoleCollectionResponse should have variadic setValue parameter');
        }
    }
    ...
    public function testCanAccessMembersSubpath(): void
    {
        ...
        $result = self::$client->directoryRoles()->byId($itemId)->members()->get();
    ...
    public function testCanAccessCheckMemberGroupsSubpath(): void
    {
        ...
        // Access subpath and get data
        $result = self::$client->directoryRoles()->byId($itemId)->checkMemberGroups()->get();
        $this->assertNotNull($result);
    }
    ...
    public function testCanAccessCheckMemberObjectsSubpath(): void
    {
        ...
        // Access subpath and get data
        $result = self::$client->directoryRoles()->byId($itemId)->checkMemberObjects()->get();
        $this->assertNotNull($result);
    }
    ...
    public function testCanAccessMembersAddNestedSubpath(): void
    {
        ...
        $result = self::$client->directoryRoles()->byId($itemId)->members()->add()->get();
        $this->assertNotNull($result);
    }
    ...
    public function testCanAccessMembersRemoveNestedSubpath(): void
    {
        ...
        // Access nested subpath and get data
        $result = self::$client->directoryRoles()->byId($itemId)->members()->remove()->get();
        $this->assertNotNull($result);
    }
