...
/**
 * Tests for Compliance singular resource
 */
class ComplianceTest extends GraphTestCase
{
    public function testCanAccessBuilder(): void
    {
        $builder = self::$client->compliance();
        $this->assertNotNull($builder);
    }

    public function testCanGetResource(): void
    {
        $resource = self::$client->compliance()->get();
    ...
    public function testModelClassExists(): void
    {
        ...
        $builderFile = __DIR__ . '/../../build/RequestBuilders/ComplianceRequestBuilder.php';
        ...
        $modelClass = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\Compliance';
        $modelClassSingular = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\Compliance';
