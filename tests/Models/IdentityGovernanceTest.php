...
/**
 * Tests for IdentityGovernance singular resource
 */
class IdentityGovernanceTest extends GraphTestCase
{
    public function testCanAccessBuilder(): void
    {
        $builder = self::$client->identityGovernance();
        $this->assertNotNull($builder);
    }

    public function testCanGetResource(): void
    {
        $resource = self::$client->identityGovernance()->get();
    ...
    public function testModelClassExists(): void
    {
        ...
        $builderFile = __DIR__ . '/../../build/RequestBuilders/IdentityGovernanceRequestBuilder.php';
        ...
        $modelClass = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\IdentityGovernance';
        $modelClassSingular = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\IdentityGovernance';
