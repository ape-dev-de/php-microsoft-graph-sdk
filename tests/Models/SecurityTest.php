...
/**
 * Tests for Security singular resource
 */
class SecurityTest extends GraphTestCase
{
    public function testCanAccessBuilder(): void
    {
        $builder = self::$client->security();
        $this->assertNotNull($builder);
    }

    public function testCanGetResource(): void
    {
        $resource = self::$client->security()->get();
    ...
    public function testModelClassExists(): void
    {
        ...
        $builderFile = __DIR__ . '/../../build/RequestBuilders/SecurityRequestBuilder.php';
        ...
        $modelClass = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\Security';
        $modelClassSingular = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\Security';
