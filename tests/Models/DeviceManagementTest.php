...
/**
 * Tests for DeviceManagement singular resource
 */
class DeviceManagementTest extends GraphTestCase
{
    public function testCanAccessBuilder(): void
    {
        $builder = self::$client->deviceManagement();
        $this->assertNotNull($builder);
    }

    public function testCanGetResource(): void
    {
        $resource = self::$client->deviceManagement()->get();
    ...
    public function testModelClassExists(): void
    {
        ...
        $builderFile = __DIR__ . '/../../build/RequestBuilders/DeviceManagementRequestBuilder.php';
        ...
        $modelClass = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\DeviceManagement';
        $modelClassSingular = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\DeviceManagement';
