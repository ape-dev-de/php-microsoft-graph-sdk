...
/**
 * Tests for External singular resource
 */
class ExternalTest extends GraphTestCase
{
    public function testCanAccessBuilder(): void
    {
        $builder = self::$client->external();
        $this->assertNotNull($builder);
    }

    public function testCanGetResource(): void
    {
        $resource = self::$client->external()->get();
    ...
    public function testModelClassExists(): void
    {
        ...
        $builderFile = __DIR__ . '/../../build/RequestBuilders/ExternalRequestBuilder.php';
        ...
        $modelClass = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\External';
        $modelClassSingular = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\External';
