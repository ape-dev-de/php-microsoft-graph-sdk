...
/**
 * Tests for DeviceAppManagement singular resource
 */
class DeviceAppManagementTest extends GraphTestCase
{
    public function testCanAccessBuilder(): void
    {
        $builder = self::$client->deviceAppManagement();
        $this->assertNotNull($builder);
    }

    public function testCanGetResource(): void
    {
        $resource = self::$client->deviceAppManagement()->get();
    ...
    public function testModelClassExists(): void
    {
        ...
        $builderFile = __DIR__ . '/../../build/RequestBuilders/DeviceAppManagementRequestBuilder.php';
        ...
        $modelClass = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\DeviceAppManagement';
        $modelClassSingular = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\DeviceAppManagement';
