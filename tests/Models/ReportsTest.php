...
class ReportsTest extends GraphTestCase
{
    ...
    public function testModelClassExists(): void
    {
        ...
        $builderFile = __DIR__ . '/../../build/RequestBuilders/ReportsRequestBuilder.php';
        ...
        $modelClass = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\Reports';
        $modelClassSingular = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\Report';
