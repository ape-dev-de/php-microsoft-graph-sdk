...
/**
 * Tests for Communications singular resource
 */
class CommunicationsTest extends GraphTestCase
{
    public function testCanAccessBuilder(): void
    {
        $builder = self::$client->communications();
        $this->assertNotNull($builder);
    }

    public function testCanGetResource(): void
    {
        $resource = self::$client->communications()->get();
    ...
    public function testModelClassExists(): void
    {
        ...
        $builderFile = __DIR__ . '/../../build/RequestBuilders/CommunicationsRequestBuilder.php';
        ...
        $modelClass = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\Communications';
        $modelClassSingular = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\Communication';
