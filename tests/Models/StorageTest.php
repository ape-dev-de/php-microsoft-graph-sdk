...
/**
 * Tests for Storage singular resource
 */
class StorageTest extends GraphTestCase
{
    public function testCanAccessBuilder(): void
    {
        $builder = self::$client->storage();
        $this->assertNotNull($builder);
    }

    public function testCanGetResource(): void
    {
        $resource = self::$client->storage()->get();
    ...
    public function testModelClassExists(): void
    {
        ...
        $builderFile = __DIR__ . '/../../build/RequestBuilders/StorageRequestBuilder.php';
        ...
        $modelClass = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\Storage';
        $modelClassSingular = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\Storage';
