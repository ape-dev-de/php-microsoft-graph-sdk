...
/**
 * Tests for Admin singular resource
 */
class AdminTest extends GraphTestCase
{
    public function testCanAccessBuilder(): void
    {
        $builder = self::$client->admin();
        $this->assertNotNull($builder);
    }

    public function testCanGetResource(): void
    {
        $resource = self::$client->admin()->get();
    ...
    public function testModelClassExists(): void
    {
        ...
        $builderFile = __DIR__ . '/../../build/RequestBuilders/AdminRequestBuilder.php';
        ...
        $modelClass = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\Admin';
        $modelClassSingular = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\Admin';
