...
/**
 * Tests for Privacy singular resource
 */
class PrivacyTest extends GraphTestCase
{
    public function testCanAccessBuilder(): void
    {
        $builder = self::$client->privacy();
        $this->assertNotNull($builder);
    }

    public function testCanGetResource(): void
    {
        $resource = self::$client->privacy()->get();
    ...
    public function testModelClassExists(): void
    {
        ...
        $builderFile = __DIR__ . '/../../build/RequestBuilders/PrivacyRequestBuilder.php';
        ...
        $modelClass = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\Privacy';
        $modelClassSingular = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\Privacy';
