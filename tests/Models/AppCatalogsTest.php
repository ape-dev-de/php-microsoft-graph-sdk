...
/**
 * Tests for AppCatalogs singular resource
 */
class AppCatalogsTest extends GraphTestCase
{
    public function testCanAccessBuilder(): void
    {
        $builder = self::$client->appCatalogs();
        $this->assertNotNull($builder);
    }

    public function testCanGetResource(): void
    {
        $resource = self::$client->appCatalogs()->get();
    ...
    public function testModelClassExists(): void
    {
        ...
        $builderFile = __DIR__ . '/../../build/RequestBuilders/AppCatalogsRequestBuilder.php';
        ...
        $modelClass = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\AppCatalogs';
        $modelClassSingular = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\AppCatalog';
