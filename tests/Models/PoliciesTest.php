...
/**
 * Tests for Policies singular resource
 */
class PoliciesTest extends GraphTestCase
{
    public function testCanAccessBuilder(): void
    {
        $builder = self::$client->policies();
        $this->assertNotNull($builder);
    }

    public function testCanGetResource(): void
    {
        $resource = self::$client->policies()->get();
    ...
    public function testModelClassExists(): void
    {
        ...
        $builderFile = __DIR__ . '/../../build/RequestBuilders/PoliciesRequestBuilder.php';
        ...
        $modelClass = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\Policies';
        $modelClassSingular = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\Policie';
