...
/**
 * Tests for AuditLogs singular resource
 */
class AuditLogsTest extends GraphTestCase
{
    public function testCanAccessBuilder(): void
    {
        $builder = self::$client->auditLogs();
        $this->assertNotNull($builder);
    }

    public function testCanGetResource(): void
    {
        $resource = self::$client->auditLogs()->get();
    ...
    public function testModelClassExists(): void
    {
        ...
        $builderFile = __DIR__ . '/../../build/RequestBuilders/AuditLogsRequestBuilder.php';
        ...
        $modelClass = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\AuditLogs';
        $modelClassSingular = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\AuditLog';
