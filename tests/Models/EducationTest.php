...
/**
 * Tests for Education singular resource
 */
class EducationTest extends GraphTestCase
{
    public function testCanAccessBuilder(): void
    {
        $builder = self::$client->education();
        $this->assertNotNull($builder);
    }

    public function testCanGetResource(): void
    {
        $resource = self::$client->education()->get();
    ...
    public function testModelClassExists(): void
    {
        ...
        $builderFile = __DIR__ . '/../../build/RequestBuilders/EducationRequestBuilder.php';
        ...
        $modelClass = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\Education';
        $modelClassSingular = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\Education';
