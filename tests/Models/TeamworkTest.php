...
/**
 * Tests for Teamwork singular resource
 */
class TeamworkTest extends GraphTestCase
{
    public function testCanAccessBuilder(): void
    {
        $builder = self::$client->teamwork();
        $this->assertNotNull($builder);
    }

    public function testCanGetResource(): void
    {
        $resource = self::$client->teamwork()->get();
    ...
    public function testModelClassExists(): void
    {
        ...
        $builderFile = __DIR__ . '/../../build/RequestBuilders/TeamworkRequestBuilder.php';
        ...
        $modelClass = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\Teamwork';
        $modelClassSingular = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\Teamwork';
