...
/**
 * Tests for InformationProtection singular resource
 */
class InformationProtectionTest extends GraphTestCase
{
    public function testCanAccessBuilder(): void
    {
        $builder = self::$client->informationProtection();
        $this->assertNotNull($builder);
    }

    public function testCanGetResource(): void
    {
        $resource = self::$client->informationProtection()->get();
    ...
    public function testModelClassExists(): void
    {
        ...
        $builderFile = __DIR__ . '/../../build/RequestBuilders/InformationProtectionRequestBuilder.php';
        ...
        $modelClass = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\InformationProtection';
        $modelClassSingular = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\InformationProtection';
