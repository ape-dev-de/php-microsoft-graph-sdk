...
/**
 * Tests for RoleManagement singular resource
 */
class RoleManagementTest extends GraphTestCase
{
    public function testCanAccessBuilder(): void
    {
        $builder = self::$client->roleManagement();
        $this->assertNotNull($builder);
    }

    public function testCanGetResource(): void
    {
        $resource = self::$client->roleManagement()->get();
    ...
    public function testModelClassExists(): void
    {
        ...
        $builderFile = __DIR__ . '/../../build/RequestBuilders/RoleManagementRequestBuilder.php';
        ...
        $modelClass = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\RoleManagement';
        $modelClassSingular = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\RoleManagement';
