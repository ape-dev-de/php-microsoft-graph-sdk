...
/**
 * Tests for Solutions singular resource
 */
class SolutionsTest extends GraphTestCase
{
    public function testCanAccessBuilder(): void
    {
        $builder = self::$client->solutions();
        $this->assertNotNull($builder);
    }

    public function testCanGetResource(): void
    {
        $resource = self::$client->solutions()->get();
    ...
    public function testModelClassExists(): void
    {
        ...
        $builderFile = __DIR__ . '/../../build/RequestBuilders/SolutionsRequestBuilder.php';
        ...
        $modelClass = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\Solutions';
        $modelClassSingular = 'ApeDevDe\\MicrosoftGraphSdk\\Models\\Solution';
