...
/**
 * Collection response for MediaSourceContentCategory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MediaSourceContentCategoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return MediaSourceContentCategory[]
     */
     ...
     * 
     * @param MediaSourceContentCategory[] $items
     * @return self
     */
    public function setValue(array|MediaSourceContentCategory $items, MediaSourceContentCategory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MediaSourceContentCategory> $value
     * @return self
     ...
     * 
     * @param MediaSourceContentCategory $item
     * @return self
     */
    public function addValue(MediaSourceContentCategory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MediaSourceContentCategory>
     */
