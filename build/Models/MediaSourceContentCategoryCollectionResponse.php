...
/**
 * MediaSourceContentCategoryCollectionResponse - Collection response
 */
class MediaSourceContentCategoryCollectionResponse
{
    /**
     * @var array<int, MediaSourceContentCategory>
     */
    public array $value = [];
