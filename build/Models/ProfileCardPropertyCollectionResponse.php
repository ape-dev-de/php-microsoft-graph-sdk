...
/**
 * Collection response for ProfileCardProperty
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProfileCardPropertyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ProfileCardProperty[] $items
     * @return self
     */
    public function setValue(array|ProfileCardProperty $items, ProfileCardProperty ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProfileCardProperty> $value
     * @return self
     ...
     * 
     * @param ProfileCardProperty $item
     * @return self
     */
    public function addValue(ProfileCardProperty $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProfileCardProperty>
     */
