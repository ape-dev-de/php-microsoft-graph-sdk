...
/**
 * Collection response for ExternalEmailOtpState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalEmailOtpStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalEmailOtpState[]
     */
    private array $value = [];
     ...
     * 
     * @param ExternalEmailOtpState[] $items
     * @return self
     */
    public function setValue(array|ExternalEmailOtpState $items, ExternalEmailOtpState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalEmailOtpState> $value
     * @return self
     ...
     * 
     * @param ExternalEmailOtpState $item
     * @return self
     */
    public function addValue(ExternalEmailOtpState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ExternalEmailOtpState>
     */
