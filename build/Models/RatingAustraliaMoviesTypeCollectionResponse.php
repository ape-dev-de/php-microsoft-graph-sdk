...
/**
 * Collection response for RatingAustraliaMoviesType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RatingAustraliaMoviesTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RatingAustraliaMoviesType[]
     */
    private array $value = [];
     ...
     * 
     * @return RatingAustraliaMoviesType[]
     */
     ...
     * 
     * @param RatingAustraliaMoviesType[] $items
     * @return self
     */
    public function setValue(array|RatingAustraliaMoviesType $items, RatingAustraliaMoviesType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RatingAustraliaMoviesType> $value
     * @return self
     ...
     * 
     * @param RatingAustraliaMoviesType $item
     * @return self
     */
    public function addValue(RatingAustraliaMoviesType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RatingAustraliaMoviesType>
     */
