...
/**
 * RatingAustraliaMoviesTypeCollectionResponse - Collection response
 */
class RatingAustraliaMoviesTypeCollectionResponse
{
    /**
     * @var array<int, RatingAustraliaMoviesType>
     */
    public array $value = [];
