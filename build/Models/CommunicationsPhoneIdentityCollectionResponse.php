...
/**
 * CommunicationsPhoneIdentityCollectionResponse - Collection response
 */
class CommunicationsPhoneIdentityCollectionResponse
{
    /**
     * @var array<int, CommunicationsPhoneIdentity>
     */
    public array $value = [];
