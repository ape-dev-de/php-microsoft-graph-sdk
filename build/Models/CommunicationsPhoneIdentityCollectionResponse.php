...
/**
 * Collection response for CommunicationsPhoneIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CommunicationsPhoneIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CommunicationsPhoneIdentity[]
     */
    private array $value = [];
     ...
     * 
     * @param CommunicationsPhoneIdentity[] $items
     * @return self
     */
    public function setValue(array|CommunicationsPhoneIdentity $items, CommunicationsPhoneIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CommunicationsPhoneIdentity> $value
     * @return self
     ...
     * 
     * @param CommunicationsPhoneIdentity $item
     * @return self
     */
    public function addValue(CommunicationsPhoneIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CommunicationsPhoneIdentity|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CommunicationsPhoneIdentity>
     */
