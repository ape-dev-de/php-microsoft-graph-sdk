...
/**
 * Collection response for VirtualEventPresenterCollectionResponse
 */
class VirtualEventPresenterCollectionResponseCollectionResponse
{
    /**
     * @var VirtualEventPresenterCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param VirtualEventPresenterCollectionResponse ...$items Variable number of VirtualEventPresenterCollectionResponse items
     * @return self
     */
    public function setValue(VirtualEventPresenterCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<VirtualEventPresenterCollectionResponse> $value
     * @return self
     ...
     * 
     * @param VirtualEventPresenterCollectionResponse $item
     * @return self
     */
    public function addValue(VirtualEventPresenterCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
