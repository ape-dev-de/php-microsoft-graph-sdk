...
/**
 * AccessPackageFilterByCurrentUserOptionsCollectionResponse - Collection response
 */
class AccessPackageFilterByCurrentUserOptionsCollectionResponse
{
    /**
     * @var array<int, AccessPackageFilterByCurrentUserOptions>
     */
    public array $value = [];
