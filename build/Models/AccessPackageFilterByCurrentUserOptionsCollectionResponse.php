...
/**
 * Collection response for AccessPackageFilterByCurrentUserOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageFilterByCurrentUserOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageFilterByCurrentUserOptions[]
     */
    private array $value = [];
     ...
     * 
     * @return AccessPackageFilterByCurrentUserOptions[]
     */
     ...
     * 
     * @param AccessPackageFilterByCurrentUserOptions[] $items
     * @return self
     */
    public function setValue(array|AccessPackageFilterByCurrentUserOptions $items, AccessPackageFilterByCurrentUserOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageFilterByCurrentUserOptions> $value
     * @return self
     ...
     * 
     * @param AccessPackageFilterByCurrentUserOptions $item
     * @return self
     */
    public function addValue(AccessPackageFilterByCurrentUserOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessPackageFilterByCurrentUserOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageFilterByCurrentUserOptions>
     */
