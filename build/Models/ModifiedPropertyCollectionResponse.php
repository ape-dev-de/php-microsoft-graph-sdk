...
/**
 * Collection response for ModifiedProperty
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ModifiedPropertyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ModifiedProperty[] $items
     * @return self
     */
    public function setValue(array|ModifiedProperty $items, ModifiedProperty ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ModifiedProperty> $value
     * @return self
     ...
     * 
     * @param ModifiedProperty $item
     * @return self
     */
    public function addValue(ModifiedProperty $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ModifiedProperty>
     */
