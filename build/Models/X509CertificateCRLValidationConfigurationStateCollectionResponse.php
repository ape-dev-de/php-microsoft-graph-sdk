...
/**
 * Collection response for X509CertificateCRLValidationConfigurationState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class X509CertificateCRLValidationConfigurationStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var X509CertificateCRLValidationConfigurationState[]
     */
    private array $value = [];
     ...
     * 
     * @return X509CertificateCRLValidationConfigurationState[]
     */
     ...
     * 
     * @param X509CertificateCRLValidationConfigurationState[] $items
     * @return self
     */
    public function setValue(array|X509CertificateCRLValidationConfigurationState $items, X509CertificateCRLValidationConfigurationState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<X509CertificateCRLValidationConfigurationState> $value
     * @return self
     ...
     * 
     * @param X509CertificateCRLValidationConfigurationState $item
     * @return self
     */
    public function addValue(X509CertificateCRLValidationConfigurationState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, X509CertificateCRLValidationConfigurationState>
     */
