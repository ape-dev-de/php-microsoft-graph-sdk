...
/**
 * X509CertificateCRLValidationConfigurationStateCollectionResponse - Collection response
 */
class X509CertificateCRLValidationConfigurationStateCollectionResponse
{
    /**
     * @var array<int, X509CertificateCRLValidationConfigurationState>
     */
    public array $value = [];
