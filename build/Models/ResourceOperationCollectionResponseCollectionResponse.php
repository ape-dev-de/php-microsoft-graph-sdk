...
/**
 * Collection response for ResourceOperationCollectionResponse
 */
class ResourceOperationCollectionResponseCollectionResponse
{
    /**
     * @var ResourceOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ResourceOperationCollectionResponse ...$items Variable number of ResourceOperationCollectionResponse items
     * @return self
     */
    public function setValue(ResourceOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ResourceOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ResourceOperationCollectionResponse $item
     * @return self
     */
    public function addValue(ResourceOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
