 ...
 */
class ConversationMemberRoleUpdatedEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param ConversationMemberRoleUpdatedEventMessageDetail ...$items Variable number of ConversationMemberRoleUpdatedEventMessageDetail items
     * @return self
     */
    public function setValue(ConversationMemberRoleUpdatedEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
