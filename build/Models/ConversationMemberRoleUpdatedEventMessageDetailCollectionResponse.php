...
/**
 * Collection response for ConversationMemberRoleUpdatedEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConversationMemberRoleUpdatedEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConversationMemberRoleUpdatedEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param ConversationMemberRoleUpdatedEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|ConversationMemberRoleUpdatedEventMessageDetail $items, ConversationMemberRoleUpdatedEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConversationMemberRoleUpdatedEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param ConversationMemberRoleUpdatedEventMessageDetail $item
     * @return self
     */
    public function addValue(ConversationMemberRoleUpdatedEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ConversationMemberRoleUpdatedEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ConversationMemberRoleUpdatedEventMessageDetail>
     */
