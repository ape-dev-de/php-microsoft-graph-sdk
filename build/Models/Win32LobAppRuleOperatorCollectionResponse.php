...
/**
 * Collection response for Win32LobAppRuleOperator
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Win32LobAppRuleOperatorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Win32LobAppRuleOperator[]
     */
    private array $value = [];
     ...
     * 
     * @return Win32LobAppRuleOperator[]
     */
     ...
     * 
     * @param Win32LobAppRuleOperator[] $items
     * @return self
     */
    public function setValue(array|Win32LobAppRuleOperator $items, Win32LobAppRuleOperator ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Win32LobAppRuleOperator> $value
     * @return self
     ...
     * 
     * @param Win32LobAppRuleOperator $item
     * @return self
     */
    public function addValue(Win32LobAppRuleOperator $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Win32LobAppRuleOperator>
     */
