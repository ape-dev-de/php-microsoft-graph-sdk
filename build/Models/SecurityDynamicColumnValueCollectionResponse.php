...
/**
 * Collection response for SecurityDynamicColumnValue
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityDynamicColumnValueCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityDynamicColumnValue[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityDynamicColumnValue[]
     */
     ...
     * 
     * @param SecurityDynamicColumnValue[] $items
     * @return self
     */
    public function setValue(array|SecurityDynamicColumnValue $items, SecurityDynamicColumnValue ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityDynamicColumnValue> $value
     * @return self
     ...
     * 
     * @param SecurityDynamicColumnValue $item
     * @return self
     */
    public function addValue(SecurityDynamicColumnValue $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityDynamicColumnValue|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityDynamicColumnValue>
     */
