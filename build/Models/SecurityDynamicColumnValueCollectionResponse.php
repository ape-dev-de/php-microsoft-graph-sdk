...
/**
 * SecurityDynamicColumnValueCollectionResponse - Collection response
 */
class SecurityDynamicColumnValueCollectionResponse
{
    /**
     * @var array<int, SecurityDynamicColumnValue>
     */
    public array $value = [];
