 ...
 */
class EmployeeExperienceCollectionResponse
{
    /**
     ...
     * 
     * @param EmployeeExperience ...$items Variable number of EmployeeExperience items
     * @return self
     */
    public function setValue(EmployeeExperience ...$items): self
    {
        $this->value = $items;
        return $this;
    }
