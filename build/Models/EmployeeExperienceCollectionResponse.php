...
/**
 * Collection response for EmployeeExperience
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EmployeeExperienceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param EmployeeExperience[] $items
     * @return self
     */
    public function setValue(array|EmployeeExperience $items, EmployeeExperience ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EmployeeExperience> $value
     * @return self
     ...
     * 
     * @param EmployeeExperience $item
     * @return self
     */
    public function addValue(EmployeeExperience $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EmployeeExperience>
     */
