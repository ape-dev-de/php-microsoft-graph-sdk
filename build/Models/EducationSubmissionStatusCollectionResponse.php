...
/**
 * EducationSubmissionStatusCollectionResponse - Collection response
 */
class EducationSubmissionStatusCollectionResponse
{
    /**
     * @var array<int, EducationSubmissionStatus>
     */
    public array $value = [];
