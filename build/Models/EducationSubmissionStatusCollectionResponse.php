...
/**
 * Collection response for EducationSubmissionStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationSubmissionStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationSubmissionStatus[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationSubmissionStatus[] $items
     * @return self
     */
    public function setValue(array|EducationSubmissionStatus $items, EducationSubmissionStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationSubmissionStatus> $value
     * @return self
     ...
     * 
     * @param EducationSubmissionStatus $item
     * @return self
     */
    public function addValue(EducationSubmissionStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationSubmissionStatus>
     */
