...
/**
 * Collection response for MobileContainedApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MobileContainedAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MobileContainedApp[] $items
     * @return self
     */
    public function setValue(array|MobileContainedApp $items, MobileContainedApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MobileContainedApp> $value
     * @return self
     ...
     * 
     * @param MobileContainedApp $item
     * @return self
     */
    public function addValue(MobileContainedApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MobileContainedApp>
     */
