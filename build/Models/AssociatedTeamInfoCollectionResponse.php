...
/**
 * Collection response for AssociatedTeamInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AssociatedTeamInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AssociatedTeamInfo[] $items
     * @return self
     */
    public function setValue(array|AssociatedTeamInfo $items, AssociatedTeamInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AssociatedTeamInfo> $value
     * @return self
     ...
     * 
     * @param AssociatedTeamInfo $item
     * @return self
     */
    public function addValue(AssociatedTeamInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AssociatedTeamInfo>
     */
