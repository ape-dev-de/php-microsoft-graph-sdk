...
/**
 * Collection response for AuthenticationConfigurationValidation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationConfigurationValidationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuthenticationConfigurationValidation[]
     */
    private array $value = [];
     ...
     * 
     * @param AuthenticationConfigurationValidation[] $items
     * @return self
     */
    public function setValue(array|AuthenticationConfigurationValidation $items, AuthenticationConfigurationValidation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationConfigurationValidation> $value
     * @return self
     ...
     * 
     * @param AuthenticationConfigurationValidation $item
     * @return self
     */
    public function addValue(AuthenticationConfigurationValidation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AuthenticationConfigurationValidation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationConfigurationValidation>
     */
