 ...
 */
class AuthenticationConfigurationValidationCollectionResponse
{
    /**
     ...
     * 
     * @param AuthenticationConfigurationValidation ...$items Variable number of AuthenticationConfigurationValidation items
     * @return self
     */
    public function setValue(AuthenticationConfigurationValidation ...$items): self
    {
        $this->value = $items;
        return $this;
    }
