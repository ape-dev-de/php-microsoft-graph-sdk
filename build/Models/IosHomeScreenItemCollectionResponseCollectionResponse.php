...
/**
 * Collection response for IosHomeScreenItemCollectionResponse
 */
class IosHomeScreenItemCollectionResponseCollectionResponse
{
    /**
     * @var IosHomeScreenItemCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IosHomeScreenItemCollectionResponse ...$items Variable number of IosHomeScreenItemCollectionResponse items
     * @return self
     */
    public function setValue(IosHomeScreenItemCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IosHomeScreenItemCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IosHomeScreenItemCollectionResponse $item
     * @return self
     */
    public function addValue(IosHomeScreenItemCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
