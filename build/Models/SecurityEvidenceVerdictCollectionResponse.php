...
/**
 * Collection response for SecurityEvidenceVerdict
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityEvidenceVerdictCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityEvidenceVerdict[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityEvidenceVerdict[]
     */
     ...
     * 
     * @param SecurityEvidenceVerdict[] $items
     * @return self
     */
    public function setValue(array|SecurityEvidenceVerdict $items, SecurityEvidenceVerdict ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityEvidenceVerdict> $value
     * @return self
     ...
     * 
     * @param SecurityEvidenceVerdict $item
     * @return self
     */
    public function addValue(SecurityEvidenceVerdict $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityEvidenceVerdict|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityEvidenceVerdict>
     */
