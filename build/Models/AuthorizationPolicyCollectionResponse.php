...
/**
 * Collection response for AuthorizationPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthorizationPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AuthorizationPolicy[] $items
     * @return self
     */
    public function setValue(array|AuthorizationPolicy $items, AuthorizationPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthorizationPolicy> $value
     * @return self
     ...
     * 
     * @param AuthorizationPolicy $item
     * @return self
     */
    public function addValue(AuthorizationPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthorizationPolicy>
     */
