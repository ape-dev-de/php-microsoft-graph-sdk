...
/**
 * Collection response for SiteRestoreArtifact
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SiteRestoreArtifactCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SiteRestoreArtifact[] $items
     * @return self
     */
    public function setValue(array|SiteRestoreArtifact $items, SiteRestoreArtifact ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SiteRestoreArtifact> $value
     * @return self
     ...
     * 
     * @param SiteRestoreArtifact $item
     * @return self
     */
    public function addValue(SiteRestoreArtifact $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SiteRestoreArtifact>
     */
