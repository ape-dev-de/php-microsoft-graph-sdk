 ...
 */
class SecurityStreamCollectionResponse
{
    /**
     * @var SecurityStream[]
     */
     ...
     * 
     * @param SecurityStream ...$items Variable number of SecurityStream items
     * @return self
     */
    public function setValue(SecurityStream ...$items): self
    {
        $this->value = $items;
        return $this;
    }
