...
/**
 * Collection response for SecurityStream
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityStreamCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityStream[]
     */
     ...
     * 
     * @param SecurityStream[] $items
     * @return self
     */
    public function setValue(array|SecurityStream $items, SecurityStream ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityStream> $value
     * @return self
     ...
     * 
     * @param SecurityStream $item
     * @return self
     */
    public function addValue(SecurityStream $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityStream>
     */
