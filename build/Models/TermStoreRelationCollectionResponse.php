...
/**
 * Collection response for TermStoreRelation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TermStoreRelationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TermStoreRelation[] $items
     * @return self
     */
    public function setValue(array|TermStoreRelation $items, TermStoreRelation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TermStoreRelation> $value
     * @return self
     ...
     * 
     * @param TermStoreRelation $item
     * @return self
     */
    public function addValue(TermStoreRelation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TermStoreRelation>
     */
