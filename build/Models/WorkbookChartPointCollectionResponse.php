...
/**
 * Collection response for WorkbookChartPoint
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookChartPointCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WorkbookChartPoint[] $items
     * @return self
     */
    public function setValue(array|WorkbookChartPoint $items, WorkbookChartPoint ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookChartPoint> $value
     * @return self
     ...
     * 
     * @param WorkbookChartPoint $item
     * @return self
     */
    public function addValue(WorkbookChartPoint $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookChartPoint>
     */
