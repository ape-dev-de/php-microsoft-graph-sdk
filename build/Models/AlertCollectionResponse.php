...
/**
 * Collection response for Alert
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AlertCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Alert[]
     */
     ...
     * @return self
     */
    public function setValue(array|Alert $items, Alert ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Alert $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Alert>
     */
