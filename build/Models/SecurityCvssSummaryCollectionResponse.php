...
/**
 * Collection response for SecurityCvssSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityCvssSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityCvssSummary[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityCvssSummary[] $items
     * @return self
     */
    public function setValue(array|SecurityCvssSummary $items, SecurityCvssSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityCvssSummary> $value
     * @return self
     ...
     * 
     * @param SecurityCvssSummary $item
     * @return self
     */
    public function addValue(SecurityCvssSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityCvssSummary|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityCvssSummary>
     */
