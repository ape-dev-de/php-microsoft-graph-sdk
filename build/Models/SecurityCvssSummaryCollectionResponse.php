 ...
 */
class SecurityCvssSummaryCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityCvssSummary ...$items Variable number of SecurityCvssSummary items
     * @return self
     */
    public function setValue(SecurityCvssSummary ...$items): self
    {
        $this->value = $items;
        return $this;
    }
