...
/**
 * Collection response for TimeOffReason
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TimeOffReasonCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TimeOffReason[]
     */
     ...
     * 
     * @param TimeOffReason[] $items
     * @return self
     */
    public function setValue(array|TimeOffReason $items, TimeOffReason ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TimeOffReason> $value
     * @return self
     ...
     * 
     * @param TimeOffReason $item
     * @return self
     */
    public function addValue(TimeOffReason $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TimeOffReason>
     */
