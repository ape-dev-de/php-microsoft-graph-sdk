...
/**
 * Collection response for CalendarPermission
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CalendarPermissionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CalendarPermission[] $items
     * @return self
     */
    public function setValue(array|CalendarPermission $items, CalendarPermission ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CalendarPermission> $value
     * @return self
     ...
     * 
     * @param CalendarPermission $item
     * @return self
     */
    public function addValue(CalendarPermission $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CalendarPermission>
     */
