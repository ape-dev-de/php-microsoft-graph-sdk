...
/**
 * Collection response for DefaultManagedAppProtectionCollectionResponse
 */
class DefaultManagedAppProtectionCollectionResponseCollectionResponse
{
    /**
     * @var DefaultManagedAppProtectionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DefaultManagedAppProtectionCollectionResponse ...$items Variable number of DefaultManagedAppProtectionCollectionResponse items
     * @return self
     */
    public function setValue(DefaultManagedAppProtectionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DefaultManagedAppProtectionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DefaultManagedAppProtectionCollectionResponse $item
     * @return self
     */
    public function addValue(DefaultManagedAppProtectionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
