...
/**
 * Collection response for IdentitySource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentitySourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentitySource[]
     */
     ...
     * 
     * @param IdentitySource[] $items
     * @return self
     */
    public function setValue(array|IdentitySource $items, IdentitySource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentitySource> $value
     * @return self
     ...
     * 
     * @param IdentitySource $item
     * @return self
     */
    public function addValue(IdentitySource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentitySource>
     */
