...
/**
 * DefenderPromptForSampleSubmissionCollectionResponse - Collection response
 */
class DefenderPromptForSampleSubmissionCollectionResponse
{
    /**
     * @var array<int, DefenderPromptForSampleSubmission>
     */
    public array $value = [];
