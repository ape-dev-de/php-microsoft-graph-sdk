...
/**
 * Collection response for DefenderPromptForSampleSubmission
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DefenderPromptForSampleSubmissionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DefenderPromptForSampleSubmission[]
     */
    private array $value = [];
     ...
     * 
     * @return DefenderPromptForSampleSubmission[]
     */
     ...
     * 
     * @param DefenderPromptForSampleSubmission[] $items
     * @return self
     */
    public function setValue(array|DefenderPromptForSampleSubmission $items, DefenderPromptForSampleSubmission ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DefenderPromptForSampleSubmission> $value
     * @return self
     ...
     * 
     * @param DefenderPromptForSampleSubmission $item
     * @return self
     */
    public function addValue(DefenderPromptForSampleSubmission $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DefenderPromptForSampleSubmission>
     */
