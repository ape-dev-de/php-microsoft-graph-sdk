 ...
 */
class EmployeeOrgDataCollectionResponse
{
    /**
     * @var EmployeeOrgData[]
     */
     ...
     * 
     * @param EmployeeOrgData ...$items Variable number of EmployeeOrgData items
     * @return self
     */
    public function setValue(EmployeeOrgData ...$items): self
    {
        $this->value = $items;
        return $this;
    }
