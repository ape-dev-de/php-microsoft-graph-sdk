 ...
 */
class TeamsAppPermissionSetCollectionResponse
{
    /**
     ...
     * 
     * @param TeamsAppPermissionSet ...$items Variable number of TeamsAppPermissionSet items
     * @return self
     */
    public function setValue(TeamsAppPermissionSet ...$items): self
    {
        $this->value = $items;
        return $this;
    }
