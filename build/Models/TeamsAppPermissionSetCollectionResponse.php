...
/**
 * Collection response for TeamsAppPermissionSet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamsAppPermissionSetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamsAppPermissionSet[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamsAppPermissionSet[] $items
     * @return self
     */
    public function setValue(array|TeamsAppPermissionSet $items, TeamsAppPermissionSet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamsAppPermissionSet> $value
     * @return self
     ...
     * 
     * @param TeamsAppPermissionSet $item
     * @return self
     */
    public function addValue(TeamsAppPermissionSet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamsAppPermissionSet>
     */
