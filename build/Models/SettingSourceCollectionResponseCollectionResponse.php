...
/**
 * Collection response for SettingSourceCollectionResponse
 */
class SettingSourceCollectionResponseCollectionResponse
{
    /**
     * @var SettingSourceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SettingSourceCollectionResponse ...$items Variable number of SettingSourceCollectionResponse items
     * @return self
     */
    public function setValue(SettingSourceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SettingSourceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SettingSourceCollectionResponse $item
     * @return self
     */
    public function addValue(SettingSourceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
