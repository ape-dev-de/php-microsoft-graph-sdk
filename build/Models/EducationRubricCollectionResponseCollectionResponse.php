...
/**
 * Collection response for EducationRubricCollectionResponse
 */
class EducationRubricCollectionResponseCollectionResponse
{
    /**
     * @var EducationRubricCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationRubricCollectionResponse ...$items Variable number of EducationRubricCollectionResponse items
     * @return self
     */
    public function setValue(EducationRubricCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EducationRubricCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EducationRubricCollectionResponse $item
     * @return self
     */
    public function addValue(EducationRubricCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
