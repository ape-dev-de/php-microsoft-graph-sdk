 ...
 */
class SiteCollectionCollectionResponse
{
    /**
     * @var SiteCollection[]
     */
     ...
     * 
     * @param SiteCollection ...$items Variable number of SiteCollection items
     * @return self
     */
    public function setValue(SiteCollection ...$items): self
    {
        $this->value = $items;
        return $this;
    }
