...
/**
 * Collection response for SiteCollection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SiteCollectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SiteCollection[]
     */
     ...
     * 
     * @param SiteCollection[] $items
     * @return self
     */
    public function setValue(array|SiteCollection $items, SiteCollection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SiteCollection> $value
     * @return self
     ...
     * 
     * @param SiteCollection $item
     * @return self
     */
    public function addValue(SiteCollection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SiteCollection>
     */
