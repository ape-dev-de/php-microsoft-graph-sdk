...
/**
 * Collection response for CallRecordsUserFeedbackRating
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsUserFeedbackRatingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsUserFeedbackRating[]
     */
    private array $value = [];
     ...
     * 
     * @return CallRecordsUserFeedbackRating[]
     */
     ...
     * 
     * @param CallRecordsUserFeedbackRating[] $items
     * @return self
     */
    public function setValue(array|CallRecordsUserFeedbackRating $items, CallRecordsUserFeedbackRating ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsUserFeedbackRating> $value
     * @return self
     ...
     * 
     * @param CallRecordsUserFeedbackRating $item
     * @return self
     */
    public function addValue(CallRecordsUserFeedbackRating $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsUserFeedbackRating|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsUserFeedbackRating>
     */
