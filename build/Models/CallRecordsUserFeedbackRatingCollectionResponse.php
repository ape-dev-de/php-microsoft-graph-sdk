...
/**
 * CallRecordsUserFeedbackRatingCollectionResponse - Collection response
 */
class CallRecordsUserFeedbackRatingCollectionResponse
{
    /**
     * @var array<int, CallRecordsUserFeedbackRating>
     */
    public array $value = [];
