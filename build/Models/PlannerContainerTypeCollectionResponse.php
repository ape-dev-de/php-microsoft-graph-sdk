...
/**
 * Collection response for PlannerContainerType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerContainerTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PlannerContainerType[] $items
     * @return self
     */
    public function setValue(array|PlannerContainerType $items, PlannerContainerType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PlannerContainerType> $value
     * @return self
     ...
     * 
     * @param PlannerContainerType $item
     * @return self
     */
    public function addValue(PlannerContainerType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PlannerContainerType>
     */
