...
/**
 * Collection response for EntitlementManagementSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EntitlementManagementSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EntitlementManagementSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param EntitlementManagementSettings[] $items
     * @return self
     */
    public function setValue(array|EntitlementManagementSettings $items, EntitlementManagementSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EntitlementManagementSettings> $value
     * @return self
     ...
     * 
     * @param EntitlementManagementSettings $item
     * @return self
     */
    public function addValue(EntitlementManagementSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EntitlementManagementSettings>
     */
