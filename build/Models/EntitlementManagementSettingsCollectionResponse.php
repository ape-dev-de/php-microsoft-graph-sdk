 ...
 */
class EntitlementManagementSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param EntitlementManagementSettings ...$items Variable number of EntitlementManagementSettings items
     * @return self
     */
    public function setValue(EntitlementManagementSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
