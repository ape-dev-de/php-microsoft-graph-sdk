...
/**
 * Collection response for OnenoteUserRole
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnenoteUserRoleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnenoteUserRole[]
     */
     ...
     * 
     * @param OnenoteUserRole[] $items
     * @return self
     */
    public function setValue(array|OnenoteUserRole $items, OnenoteUserRole ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnenoteUserRole> $value
     * @return self
     ...
     * 
     * @param OnenoteUserRole $item
     * @return self
     */
    public function addValue(OnenoteUserRole $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnenoteUserRole>
     */
