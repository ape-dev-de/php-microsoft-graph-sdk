...
/**
 * CommunicationsGuestIdentityCollectionResponse - Collection response
 */
class CommunicationsGuestIdentityCollectionResponse
{
    /**
     * @var array<int, CommunicationsGuestIdentity>
     */
    public array $value = [];
