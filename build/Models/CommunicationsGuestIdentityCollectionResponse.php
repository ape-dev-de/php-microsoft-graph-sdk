...
/**
 * Collection response for CommunicationsGuestIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CommunicationsGuestIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CommunicationsGuestIdentity[]
     */
    private array $value = [];
     ...
     * 
     * @param CommunicationsGuestIdentity[] $items
     * @return self
     */
    public function setValue(array|CommunicationsGuestIdentity $items, CommunicationsGuestIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CommunicationsGuestIdentity> $value
     * @return self
     ...
     * 
     * @param CommunicationsGuestIdentity $item
     * @return self
     */
    public function addValue(CommunicationsGuestIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CommunicationsGuestIdentity|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CommunicationsGuestIdentity>
     */
