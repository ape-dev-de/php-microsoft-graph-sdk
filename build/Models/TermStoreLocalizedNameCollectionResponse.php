...
/**
 * Collection response for TermStoreLocalizedName
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TermStoreLocalizedNameCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TermStoreLocalizedName[] $items
     * @return self
     */
    public function setValue(array|TermStoreLocalizedName $items, TermStoreLocalizedName ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TermStoreLocalizedName> $value
     * @return self
     ...
     * 
     * @param TermStoreLocalizedName $item
     * @return self
     */
    public function addValue(TermStoreLocalizedName $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TermStoreLocalizedName|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TermStoreLocalizedName>
     */
