...
/**
 * Collection response for OnenoteSection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnenoteSectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnenoteSection[]
     */
     ...
     * 
     * @param OnenoteSection[] $items
     * @return self
     */
    public function setValue(array|OnenoteSection $items, OnenoteSection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnenoteSection> $value
     * @return self
     ...
     * 
     * @param OnenoteSection $item
     * @return self
     */
    public function addValue(OnenoteSection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnenoteSection>
     */
