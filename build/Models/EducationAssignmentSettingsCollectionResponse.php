...
/**
 * Collection response for EducationAssignmentSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationAssignmentSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationAssignmentSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationAssignmentSettings[] $items
     * @return self
     */
    public function setValue(array|EducationAssignmentSettings $items, EducationAssignmentSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationAssignmentSettings> $value
     * @return self
     ...
     * 
     * @param EducationAssignmentSettings $item
     * @return self
     */
    public function addValue(EducationAssignmentSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationAssignmentSettings>
     */
