 ...
 */
class EducationAssignmentSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param EducationAssignmentSettings ...$items Variable number of EducationAssignmentSettings items
     * @return self
     */
    public function setValue(EducationAssignmentSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
