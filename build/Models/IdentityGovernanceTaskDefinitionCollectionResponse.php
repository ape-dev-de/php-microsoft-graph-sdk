...
/**
 * IdentityGovernanceTaskDefinitionCollectionResponse - Collection response
 */
class IdentityGovernanceTaskDefinitionCollectionResponse
{
    /**
     * @var array<int, IdentityGovernanceTaskDefinition>
     */
    public array $value = [];
