...
/**
 * Collection response for IdentityGovernanceTaskDefinition
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceTaskDefinitionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IdentityGovernanceTaskDefinition[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceTaskDefinition $items, IdentityGovernanceTaskDefinition ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceTaskDefinition> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceTaskDefinition $item
     * @return self
     */
    public function addValue(IdentityGovernanceTaskDefinition $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceTaskDefinition>
     */
