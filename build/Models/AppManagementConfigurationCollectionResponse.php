...
/**
 * Collection response for AppManagementConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppManagementConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AppManagementConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param AppManagementConfiguration[] $items
     * @return self
     */
    public function setValue(array|AppManagementConfiguration $items, AppManagementConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppManagementConfiguration> $value
     * @return self
     ...
     * 
     * @param AppManagementConfiguration $item
     * @return self
     */
    public function addValue(AppManagementConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AppManagementConfiguration>
     */
