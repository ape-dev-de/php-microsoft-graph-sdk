 ...
 */
class AppManagementConfigurationCollectionResponse
{
    /**
     ...
     * 
     * @param AppManagementConfiguration ...$items Variable number of AppManagementConfiguration items
     * @return self
     */
    public function setValue(AppManagementConfiguration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
