...
/**
 * Collection response for TimeCardBreakCollectionResponse
 */
class TimeCardBreakCollectionResponseCollectionResponse
{
    /**
     * @var TimeCardBreakCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TimeCardBreakCollectionResponse ...$items Variable number of TimeCardBreakCollectionResponse items
     * @return self
     */
    public function setValue(TimeCardBreakCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TimeCardBreakCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TimeCardBreakCollectionResponse $item
     * @return self
     */
    public function addValue(TimeCardBreakCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
