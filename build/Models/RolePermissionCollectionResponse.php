...
/**
 * Collection response for RolePermission
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RolePermissionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RolePermission[]
     */
     ...
     * 
     * @param RolePermission[] $items
     * @return self
     */
    public function setValue(array|RolePermission $items, RolePermission ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RolePermission> $value
     * @return self
     ...
     * 
     * @param RolePermission $item
     * @return self
     */
    public function addValue(RolePermission $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RolePermission>
     */
