...
/**
 * Collection response for MetaDataKeyStringPair
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MetaDataKeyStringPairCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MetaDataKeyStringPair[] $items
     * @return self
     */
    public function setValue(array|MetaDataKeyStringPair $items, MetaDataKeyStringPair ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MetaDataKeyStringPair> $value
     * @return self
     ...
     * 
     * @param MetaDataKeyStringPair $item
     * @return self
     */
    public function addValue(MetaDataKeyStringPair $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MetaDataKeyStringPair|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MetaDataKeyStringPair>
     */
