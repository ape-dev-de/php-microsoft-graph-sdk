...
/**
 * Collection response for OnAttributeCollectionListener
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnAttributeCollectionListenerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnAttributeCollectionListener[]
     */
    private array $value = [];
     ...
     * 
     * @param OnAttributeCollectionListener[] $items
     * @return self
     */
    public function setValue(array|OnAttributeCollectionListener $items, OnAttributeCollectionListener ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnAttributeCollectionListener> $value
     * @return self
     ...
     * 
     * @param OnAttributeCollectionListener $item
     * @return self
     */
    public function addValue(OnAttributeCollectionListener $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OnAttributeCollectionListener|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OnAttributeCollectionListener>
     */
