...
/**
 * EducationSubmissionRecipientCollectionResponse - Collection response
 */
class EducationSubmissionRecipientCollectionResponse
{
    /**
     * @var array<int, EducationSubmissionRecipient>
     */
    public array $value = [];
