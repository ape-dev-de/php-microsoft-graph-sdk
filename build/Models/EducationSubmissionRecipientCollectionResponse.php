...
/**
 * Collection response for EducationSubmissionRecipient
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationSubmissionRecipientCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationSubmissionRecipient[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationSubmissionRecipient[] $items
     * @return self
     */
    public function setValue(array|EducationSubmissionRecipient $items, EducationSubmissionRecipient ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationSubmissionRecipient> $value
     * @return self
     ...
     * 
     * @param EducationSubmissionRecipient $item
     * @return self
     */
    public function addValue(EducationSubmissionRecipient $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationSubmissionRecipient>
     */
