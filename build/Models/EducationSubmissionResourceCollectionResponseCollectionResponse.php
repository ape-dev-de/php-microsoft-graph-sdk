...
/**
 * Collection response for EducationSubmissionResourceCollectionResponse
 */
class EducationSubmissionResourceCollectionResponseCollectionResponse
{
    /**
     * @var EducationSubmissionResourceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationSubmissionResourceCollectionResponse ...$items Variable number of EducationSubmissionResourceCollectionResponse items
     * @return self
     */
    public function setValue(EducationSubmissionResourceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EducationSubmissionResourceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EducationSubmissionResourceCollectionResponse $item
     * @return self
     */
    public function addValue(EducationSubmissionResourceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
