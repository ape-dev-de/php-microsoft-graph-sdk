...
/**
 * Collection response for ManagedAndroidStoreAppCollectionResponse
 */
class ManagedAndroidStoreAppCollectionResponseCollectionResponse
{
    /**
     * @var ManagedAndroidStoreAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedAndroidStoreAppCollectionResponse ...$items Variable number of ManagedAndroidStoreAppCollectionResponse items
     * @return self
     */
    public function setValue(ManagedAndroidStoreAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ManagedAndroidStoreAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ManagedAndroidStoreAppCollectionResponse $item
     * @return self
     */
    public function addValue(ManagedAndroidStoreAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
