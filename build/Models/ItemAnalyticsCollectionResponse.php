...
/**
 * Collection response for ItemAnalytics
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ItemAnalyticsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ItemAnalytics[]
     */
     ...
     * 
     * @param ItemAnalytics[] $items
     * @return self
     */
    public function setValue(array|ItemAnalytics $items, ItemAnalytics ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ItemAnalytics> $value
     * @return self
     ...
     * 
     * @param ItemAnalytics $item
     * @return self
     */
    public function addValue(ItemAnalytics $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ItemAnalytics>
     */
