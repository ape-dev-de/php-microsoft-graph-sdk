 ...
 */
class ItemAnalyticsCollectionResponse
{
    /**
     * @var ItemAnalytics[]
     */
     ...
     * 
     * @param ItemAnalytics ...$items Variable number of ItemAnalytics items
     * @return self
     */
    public function setValue(ItemAnalytics ...$items): self
    {
        $this->value = $items;
        return $this;
    }
