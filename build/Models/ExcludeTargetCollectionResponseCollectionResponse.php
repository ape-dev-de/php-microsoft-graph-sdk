...
/**
 * Collection response for ExcludeTargetCollectionResponse
 */
class ExcludeTargetCollectionResponseCollectionResponse
{
    /**
     * @var ExcludeTargetCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ExcludeTargetCollectionResponse ...$items Variable number of ExcludeTargetCollectionResponse items
     * @return self
     */
    public function setValue(ExcludeTargetCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ExcludeTargetCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ExcludeTargetCollectionResponse $item
     * @return self
     */
    public function addValue(ExcludeTargetCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
