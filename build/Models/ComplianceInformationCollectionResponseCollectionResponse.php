...
/**
 * Collection response for ComplianceInformationCollectionResponse
 */
class ComplianceInformationCollectionResponseCollectionResponse
{
    /**
     * @var ComplianceInformationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ComplianceInformationCollectionResponse ...$items Variable number of ComplianceInformationCollectionResponse items
     * @return self
     */
    public function setValue(ComplianceInformationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ComplianceInformationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ComplianceInformationCollectionResponse $item
     * @return self
     */
    public function addValue(ComplianceInformationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
