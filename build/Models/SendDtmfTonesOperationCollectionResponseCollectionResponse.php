...
/**
 * Collection response for SendDtmfTonesOperationCollectionResponse
 */
class SendDtmfTonesOperationCollectionResponseCollectionResponse
{
    /**
     * @var SendDtmfTonesOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return SendDtmfTonesOperationCollectionResponse[]
     */
     ...
     * 
     * @param SendDtmfTonesOperationCollectionResponse ...$items Variable number of SendDtmfTonesOperationCollectionResponse items
     * @return self
     */
    public function setValue(SendDtmfTonesOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SendDtmfTonesOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SendDtmfTonesOperationCollectionResponse $item
     * @return self
     */
    public function addValue(SendDtmfTonesOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
