...
/**
 * Collection response for TokenIssuerType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TokenIssuerTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TokenIssuerType[]
     */
     ...
     * 
     * @param TokenIssuerType[] $items
     * @return self
     */
    public function setValue(array|TokenIssuerType $items, TokenIssuerType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TokenIssuerType> $value
     * @return self
     ...
     * 
     * @param TokenIssuerType $item
     * @return self
     */
    public function addValue(TokenIssuerType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TokenIssuerType>
     */
