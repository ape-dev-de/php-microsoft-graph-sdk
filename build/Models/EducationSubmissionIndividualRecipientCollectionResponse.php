...
/**
 * Collection response for EducationSubmissionIndividualRecipient
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationSubmissionIndividualRecipientCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationSubmissionIndividualRecipient[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationSubmissionIndividualRecipient[] $items
     * @return self
     */
    public function setValue(array|EducationSubmissionIndividualRecipient $items, EducationSubmissionIndividualRecipient ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationSubmissionIndividualRecipient> $value
     * @return self
     ...
     * 
     * @param EducationSubmissionIndividualRecipient $item
     * @return self
     */
    public function addValue(EducationSubmissionIndividualRecipient $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EducationSubmissionIndividualRecipient|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EducationSubmissionIndividualRecipient>
     */
