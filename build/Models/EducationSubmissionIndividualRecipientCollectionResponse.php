 ...
 */
class EducationSubmissionIndividualRecipientCollectionResponse
{
    /**
     ...
     * 
     * @param EducationSubmissionIndividualRecipient ...$items Variable number of EducationSubmissionIndividualRecipient items
     * @return self
     */
    public function setValue(EducationSubmissionIndividualRecipient ...$items): self
    {
        $this->value = $items;
        return $this;
    }
