...
/**
 * Collection response for OrgContactCollectionResponse
 */
class OrgContactCollectionResponseCollectionResponse
{
    /**
     * @var OrgContactCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param OrgContactCollectionResponse ...$items Variable number of OrgContactCollectionResponse items
     * @return self
     */
    public function setValue(OrgContactCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<OrgContactCollectionResponse> $value
     * @return self
     ...
     * 
     * @param OrgContactCollectionResponse $item
     * @return self
     */
    public function addValue(OrgContactCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
