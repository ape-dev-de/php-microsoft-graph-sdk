...
/**
 * Collection response for SecurityGoogleCloudLocationType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityGoogleCloudLocationTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityGoogleCloudLocationType[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityGoogleCloudLocationType[]
     */
     ...
     * 
     * @param SecurityGoogleCloudLocationType[] $items
     * @return self
     */
    public function setValue(array|SecurityGoogleCloudLocationType $items, SecurityGoogleCloudLocationType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityGoogleCloudLocationType> $value
     * @return self
     ...
     * 
     * @param SecurityGoogleCloudLocationType $item
     * @return self
     */
    public function addValue(SecurityGoogleCloudLocationType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityGoogleCloudLocationType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityGoogleCloudLocationType>
     */
