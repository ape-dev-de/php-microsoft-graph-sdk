...
/**
 * SecurityGoogleCloudLocationTypeCollectionResponse - Collection response
 */
class SecurityGoogleCloudLocationTypeCollectionResponse
{
    /**
     * @var array<int, SecurityGoogleCloudLocationType>
     */
    public array $value = [];
