...
/**
 * Collection response for ActivityBasedTimeoutPolicyCollectionResponse
 */
class ActivityBasedTimeoutPolicyCollectionResponseCollectionResponse
{
    /**
     * @var ActivityBasedTimeoutPolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ActivityBasedTimeoutPolicyCollectionResponse ...$items Variable number of ActivityBasedTimeoutPolicyCollectionResponse items
     * @return self
     */
    public function setValue(ActivityBasedTimeoutPolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ActivityBasedTimeoutPolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ActivityBasedTimeoutPolicyCollectionResponse $item
     * @return self
     */
    public function addValue(ActivityBasedTimeoutPolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
