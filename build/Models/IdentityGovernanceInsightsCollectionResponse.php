...
/**
 * Collection response for IdentityGovernanceInsights
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceInsightsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceInsights[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityGovernanceInsights[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceInsights $items, IdentityGovernanceInsights ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceInsights> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceInsights $item
     * @return self
     */
    public function addValue(IdentityGovernanceInsights $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceInsights>
     */
