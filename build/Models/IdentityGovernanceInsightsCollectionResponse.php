...
/**
 * IdentityGovernanceInsightsCollectionResponse - Collection response
 */
class IdentityGovernanceInsightsCollectionResponse
{
    /**
     * @var array<int, IdentityGovernanceInsights>
     */
    public array $value = [];
