...
/**
 * Collection response for AccessPackageAssignmentRequestRequirements
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageAssignmentRequestRequirementsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageAssignmentRequestRequirements[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageAssignmentRequestRequirements[] $items
     * @return self
     */
    public function setValue(array|AccessPackageAssignmentRequestRequirements $items, AccessPackageAssignmentRequestRequirements ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageAssignmentRequestRequirements> $value
     * @return self
     ...
     * 
     * @param AccessPackageAssignmentRequestRequirements $item
     * @return self
     */
    public function addValue(AccessPackageAssignmentRequestRequirements $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessPackageAssignmentRequestRequirements|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageAssignmentRequestRequirements>
     */
