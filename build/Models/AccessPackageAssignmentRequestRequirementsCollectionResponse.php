 ...
 */
class AccessPackageAssignmentRequestRequirementsCollectionResponse
{
    /**
     ...
     * 
     * @param AccessPackageAssignmentRequestRequirements ...$items Variable number of AccessPackageAssignmentRequestRequirements items
     * @return self
     */
    public function setValue(AccessPackageAssignmentRequestRequirements ...$items): self
    {
        $this->value = $items;
        return $this;
    }
