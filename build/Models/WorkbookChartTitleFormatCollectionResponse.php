 ...
 */
class WorkbookChartTitleFormatCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookChartTitleFormat ...$items Variable number of WorkbookChartTitleFormat items
     * @return self
     */
    public function setValue(WorkbookChartTitleFormat ...$items): self
    {
        $this->value = $items;
        return $this;
    }
