...
/**
 * Collection response for WorkbookChartTitleFormat
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookChartTitleFormatCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookChartTitleFormat[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookChartTitleFormat[] $items
     * @return self
     */
    public function setValue(array|WorkbookChartTitleFormat $items, WorkbookChartTitleFormat ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookChartTitleFormat> $value
     * @return self
     ...
     * 
     * @param WorkbookChartTitleFormat $item
     * @return self
     */
    public function addValue(WorkbookChartTitleFormat $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookChartTitleFormat>
     */
