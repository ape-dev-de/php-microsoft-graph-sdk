...
/**
 * Collection response for SubjectRightsRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SubjectRightsRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SubjectRightsRequest[] $items
     * @return self
     */
    public function setValue(array|SubjectRightsRequest $items, SubjectRightsRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SubjectRightsRequest> $value
     * @return self
     ...
     * 
     * @param SubjectRightsRequest $item
     * @return self
     */
    public function addValue(SubjectRightsRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SubjectRightsRequest>
     */
