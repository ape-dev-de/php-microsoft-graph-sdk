...
/**
 * Collection response for ContractCollectionResponse
 */
class ContractCollectionResponseCollectionResponse
{
    /**
     * @var ContractCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ContractCollectionResponse ...$items Variable number of ContractCollectionResponse items
     * @return self
     */
    public function setValue(ContractCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ContractCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ContractCollectionResponse $item
     * @return self
     */
    public function addValue(ContractCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
