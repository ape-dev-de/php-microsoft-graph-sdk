...
/**
 * Collection response for IosVppAppCollectionResponse
 */
class IosVppAppCollectionResponseCollectionResponse
{
    /**
     * @var IosVppAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IosVppAppCollectionResponse ...$items Variable number of IosVppAppCollectionResponse items
     * @return self
     */
    public function setValue(IosVppAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IosVppAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IosVppAppCollectionResponse $item
     * @return self
     */
    public function addValue(IosVppAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
