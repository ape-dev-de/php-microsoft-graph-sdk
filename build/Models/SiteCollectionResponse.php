...
/**
 * Collection response for Site
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SiteCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Site[]
     */
     ...
     * @return self
     */
    public function setValue(array|Site $items, Site ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Site $item): self
    {
        $this->value[] = $item;
        return $this;
    }
