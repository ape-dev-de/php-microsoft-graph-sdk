...
/**
 * Collection response for DayNoteCollectionResponse
 */
class DayNoteCollectionResponseCollectionResponse
{
    /**
     * @var DayNoteCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DayNoteCollectionResponse ...$items Variable number of DayNoteCollectionResponse items
     * @return self
     */
    public function setValue(DayNoteCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DayNoteCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DayNoteCollectionResponse $item
     * @return self
     */
    public function addValue(DayNoteCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
