...
/**
 * Collection response for TitleAreaLayoutType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TitleAreaLayoutTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TitleAreaLayoutType[]
     */
    private array $value = [];
     ...
     * 
     * @param TitleAreaLayoutType[] $items
     * @return self
     */
    public function setValue(array|TitleAreaLayoutType $items, TitleAreaLayoutType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TitleAreaLayoutType> $value
     * @return self
     ...
     * 
     * @param TitleAreaLayoutType $item
     * @return self
     */
    public function addValue(TitleAreaLayoutType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TitleAreaLayoutType>
     */
