...
/**
 * Collection response for Fido2AuthenticationMethodConfigurationCollectionResponse
 */
class Fido2AuthenticationMethodConfigurationCollectionResponseCollectionResponse
{
    /**
     * @var Fido2AuthenticationMethodConfigurationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param Fido2AuthenticationMethodConfigurationCollectionResponse ...$items Variable number of Fido2AuthenticationMethodConfigurationCollectionResponse items
     * @return self
     */
    public function setValue(Fido2AuthenticationMethodConfigurationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<Fido2AuthenticationMethodConfigurationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param Fido2AuthenticationMethodConfigurationCollectionResponse $item
     * @return self
     */
    public function addValue(Fido2AuthenticationMethodConfigurationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
