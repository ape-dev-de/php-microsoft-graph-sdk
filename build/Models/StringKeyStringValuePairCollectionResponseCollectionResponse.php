...
/**
 * Collection response for StringKeyStringValuePairCollectionResponse
 */
class StringKeyStringValuePairCollectionResponseCollectionResponse
{
    /**
     * @var StringKeyStringValuePairCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param StringKeyStringValuePairCollectionResponse ...$items Variable number of StringKeyStringValuePairCollectionResponse items
     * @return self
     */
    public function setValue(StringKeyStringValuePairCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<StringKeyStringValuePairCollectionResponse> $value
     * @return self
     ...
     * 
     * @param StringKeyStringValuePairCollectionResponse $item
     * @return self
     */
    public function addValue(StringKeyStringValuePairCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
