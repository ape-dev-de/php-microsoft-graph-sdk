...
/**
 * ConditionalAccessAllExternalTenantsCollectionResponse - Collection response
 */
class ConditionalAccessAllExternalTenantsCollectionResponse
{
    /**
     * @var array<int, ConditionalAccessAllExternalTenants>
     */
    public array $value = [];
