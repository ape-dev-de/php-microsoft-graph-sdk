...
/**
 * Collection response for ConditionalAccessAllExternalTenants
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessAllExternalTenantsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessAllExternalTenants[]
     */
    private array $value = [];
     ...
     * 
     * @param ConditionalAccessAllExternalTenants[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessAllExternalTenants $items, ConditionalAccessAllExternalTenants ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessAllExternalTenants> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessAllExternalTenants $item
     * @return self
     */
    public function addValue(ConditionalAccessAllExternalTenants $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ConditionalAccessAllExternalTenants|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessAllExternalTenants>
     */
