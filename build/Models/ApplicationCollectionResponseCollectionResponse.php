...
/**
 * Collection response for ApplicationCollectionResponse
 */
class ApplicationCollectionResponseCollectionResponse
{
    /**
     * @var ApplicationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ApplicationCollectionResponse ...$items Variable number of ApplicationCollectionResponse items
     * @return self
     */
    public function setValue(ApplicationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ApplicationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ApplicationCollectionResponse $item
     * @return self
     */
    public function addValue(ApplicationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
