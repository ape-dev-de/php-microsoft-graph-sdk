...
/**
 * Collection response for X509CertificateAuthenticationMethodConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class X509CertificateAuthenticationMethodConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var X509CertificateAuthenticationMethodConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param X509CertificateAuthenticationMethodConfiguration[] $items
     * @return self
     */
    public function setValue(array|X509CertificateAuthenticationMethodConfiguration $items, X509CertificateAuthenticationMethodConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<X509CertificateAuthenticationMethodConfiguration> $value
     * @return self
     ...
     * 
     * @param X509CertificateAuthenticationMethodConfiguration $item
     * @return self
     */
    public function addValue(X509CertificateAuthenticationMethodConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return X509CertificateAuthenticationMethodConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, X509CertificateAuthenticationMethodConfiguration>
     */
