...
/**
 * SiteRestoreArtifactsBulkAdditionRequestCollectionResponse - Collection response
 */
class SiteRestoreArtifactsBulkAdditionRequestCollectionResponse
{
    /**
     * @var array<int, SiteRestoreArtifactsBulkAdditionRequest>
     */
    public array $value = [];
