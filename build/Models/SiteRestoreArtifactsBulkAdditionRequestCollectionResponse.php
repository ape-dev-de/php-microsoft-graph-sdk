...
/**
 * Collection response for SiteRestoreArtifactsBulkAdditionRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SiteRestoreArtifactsBulkAdditionRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SiteRestoreArtifactsBulkAdditionRequest[] $items
     * @return self
     */
    public function setValue(array|SiteRestoreArtifactsBulkAdditionRequest $items, SiteRestoreArtifactsBulkAdditionRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SiteRestoreArtifactsBulkAdditionRequest> $value
     * @return self
     ...
     * 
     * @param SiteRestoreArtifactsBulkAdditionRequest $item
     * @return self
     */
    public function addValue(SiteRestoreArtifactsBulkAdditionRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SiteRestoreArtifactsBulkAdditionRequest>
     */
