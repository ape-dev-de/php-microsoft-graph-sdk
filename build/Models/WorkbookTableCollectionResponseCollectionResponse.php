...
/**
 * Collection response for WorkbookTableCollectionResponse
 */
class WorkbookTableCollectionResponseCollectionResponse
{
    /**
     * @var WorkbookTableCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookTableCollectionResponse ...$items Variable number of WorkbookTableCollectionResponse items
     * @return self
     */
    public function setValue(WorkbookTableCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WorkbookTableCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WorkbookTableCollectionResponse $item
     * @return self
     */
    public function addValue(WorkbookTableCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
