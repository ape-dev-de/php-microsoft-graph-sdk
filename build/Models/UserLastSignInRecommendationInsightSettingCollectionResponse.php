 ...
 */
class UserLastSignInRecommendationInsightSettingCollectionResponse
{
    /**
     ...
     * 
     * @param UserLastSignInRecommendationInsightSetting ...$items Variable number of UserLastSignInRecommendationInsightSetting items
     * @return self
     */
    public function setValue(UserLastSignInRecommendationInsightSetting ...$items): self
    {
        $this->value = $items;
        return $this;
    }
