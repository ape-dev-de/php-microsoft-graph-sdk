...
/**
 * Collection response for UserLastSignInRecommendationInsightSetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserLastSignInRecommendationInsightSettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserLastSignInRecommendationInsightSetting[]
     */
    private array $value = [];
     ...
     * 
     * @param UserLastSignInRecommendationInsightSetting[] $items
     * @return self
     */
    public function setValue(array|UserLastSignInRecommendationInsightSetting $items, UserLastSignInRecommendationInsightSetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserLastSignInRecommendationInsightSetting> $value
     * @return self
     ...
     * 
     * @param UserLastSignInRecommendationInsightSetting $item
     * @return self
     */
    public function addValue(UserLastSignInRecommendationInsightSetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UserLastSignInRecommendationInsightSetting|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UserLastSignInRecommendationInsightSetting>
     */
