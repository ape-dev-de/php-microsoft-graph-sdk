...
/**
 * Collection response for DeviceComplianceScheduledActionForRule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceComplianceScheduledActionForRuleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceComplianceScheduledActionForRule[] $items
     * @return self
     */
    public function setValue(array|DeviceComplianceScheduledActionForRule $items, DeviceComplianceScheduledActionForRule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceComplianceScheduledActionForRule> $value
     * @return self
     ...
     * 
     * @param DeviceComplianceScheduledActionForRule $item
     * @return self
     */
    public function addValue(DeviceComplianceScheduledActionForRule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceComplianceScheduledActionForRule>
     */
