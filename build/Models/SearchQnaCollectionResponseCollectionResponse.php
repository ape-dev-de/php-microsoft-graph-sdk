...
/**
 * Collection response for SearchQnaCollectionResponse
 */
class SearchQnaCollectionResponseCollectionResponse
{
    /**
     * @var SearchQnaCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SearchQnaCollectionResponse ...$items Variable number of SearchQnaCollectionResponse items
     * @return self
     */
    public function setValue(SearchQnaCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SearchQnaCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SearchQnaCollectionResponse $item
     * @return self
     */
    public function addValue(SearchQnaCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
