...
/**
 * Collection response for SecurityHyperlinkCollectionResponse
 */
class SecurityHyperlinkCollectionResponseCollectionResponse
{
    /**
     * @var SecurityHyperlinkCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityHyperlinkCollectionResponse[]
     */
     ...
     * 
     * @param SecurityHyperlinkCollectionResponse ...$items Variable number of SecurityHyperlinkCollectionResponse items
     * @return self
     */
    public function setValue(SecurityHyperlinkCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityHyperlinkCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityHyperlinkCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityHyperlinkCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
