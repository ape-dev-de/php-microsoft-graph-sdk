...
/**
 * Collection response for Pkcs12CertificateInformationCollectionResponse
 */
class Pkcs12CertificateInformationCollectionResponseCollectionResponse
{
    /**
     * @var Pkcs12CertificateInformationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param Pkcs12CertificateInformationCollectionResponse ...$items Variable number of Pkcs12CertificateInformationCollectionResponse items
     * @return self
     */
    public function setValue(Pkcs12CertificateInformationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<Pkcs12CertificateInformationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param Pkcs12CertificateInformationCollectionResponse $item
     * @return self
     */
    public function addValue(Pkcs12CertificateInformationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
