...
/**
 * Collection response for ConversationMemberCollectionResponse
 */
class ConversationMemberCollectionResponseCollectionResponse
{
    /**
     * @var ConversationMemberCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ConversationMemberCollectionResponse ...$items Variable number of ConversationMemberCollectionResponse items
     * @return self
     */
    public function setValue(ConversationMemberCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ConversationMemberCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ConversationMemberCollectionResponse $item
     * @return self
     */
    public function addValue(ConversationMemberCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
