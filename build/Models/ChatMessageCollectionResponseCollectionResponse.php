...
/**
 * Collection response for ChatMessageCollectionResponse
 */
class ChatMessageCollectionResponseCollectionResponse
{
    /**
     * @var ChatMessageCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ChatMessageCollectionResponse ...$items Variable number of ChatMessageCollectionResponse items
     * @return self
     */
    public function setValue(ChatMessageCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ChatMessageCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ChatMessageCollectionResponse $item
     * @return self
     */
    public function addValue(ChatMessageCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
