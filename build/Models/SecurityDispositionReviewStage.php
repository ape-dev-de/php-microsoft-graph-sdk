...
class SecurityDispositionReviewStage
{
     ...
     */
    private ?string $reviewersEmailAddresses;
    ...
    public function getReviewersEmailAddresses(): ?string
    {
        return $this->reviewersEmailAddresses;
    }

    public function setReviewersEmailAddresses(?string $reviewersEmailAddresses): self
    {
