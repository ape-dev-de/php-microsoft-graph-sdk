...
/**
 * Collection response for File
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FileCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var File[]
     */
     ...
     * @return self
     */
    public function setValue(array|File $items, File ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(File $item): self
    {
        $this->value[] = $item;
        return $this;
    }
