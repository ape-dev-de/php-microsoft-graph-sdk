...
/**
 * Collection response for MailboxProtectionUnitCollectionResponse
 */
class MailboxProtectionUnitCollectionResponseCollectionResponse
{
    /**
     * @var MailboxProtectionUnitCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MailboxProtectionUnitCollectionResponse ...$items Variable number of MailboxProtectionUnitCollectionResponse items
     * @return self
     */
    public function setValue(MailboxProtectionUnitCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MailboxProtectionUnitCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MailboxProtectionUnitCollectionResponse $item
     * @return self
     */
    public function addValue(MailboxProtectionUnitCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
