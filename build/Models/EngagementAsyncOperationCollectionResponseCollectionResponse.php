...
/**
 * Collection response for EngagementAsyncOperationCollectionResponse
 */
class EngagementAsyncOperationCollectionResponseCollectionResponse
{
    /**
     * @var EngagementAsyncOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EngagementAsyncOperationCollectionResponse ...$items Variable number of EngagementAsyncOperationCollectionResponse items
     * @return self
     */
    public function setValue(EngagementAsyncOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EngagementAsyncOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EngagementAsyncOperationCollectionResponse $item
     * @return self
     */
    public function addValue(EngagementAsyncOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
