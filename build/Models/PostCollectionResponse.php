...
/**
 * Collection response for Post
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PostCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Post[]
     */
     ...
     * @return self
     */
    public function setValue(array|Post $items, Post ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Post $item): self
    {
        $this->value[] = $item;
        return $this;
    }
