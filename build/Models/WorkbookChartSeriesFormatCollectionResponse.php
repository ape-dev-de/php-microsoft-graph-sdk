 ...
 */
class WorkbookChartSeriesFormatCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookChartSeriesFormat ...$items Variable number of WorkbookChartSeriesFormat items
     * @return self
     */
    public function setValue(WorkbookChartSeriesFormat ...$items): self
    {
        $this->value = $items;
        return $this;
    }
