...
/**
 * Collection response for WorkbookChartSeriesFormat
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookChartSeriesFormatCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookChartSeriesFormat[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookChartSeriesFormat[] $items
     * @return self
     */
    public function setValue(array|WorkbookChartSeriesFormat $items, WorkbookChartSeriesFormat ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookChartSeriesFormat> $value
     * @return self
     ...
     * 
     * @param WorkbookChartSeriesFormat $item
     * @return self
     */
    public function addValue(WorkbookChartSeriesFormat $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookChartSeriesFormat>
     */
