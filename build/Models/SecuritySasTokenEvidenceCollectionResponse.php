 ...
 */
class SecuritySasTokenEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecuritySasTokenEvidence ...$items Variable number of SecuritySasTokenEvidence items
     * @return self
     */
    public function setValue(SecuritySasTokenEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
