...
/**
 * Collection response for SecuritySasTokenEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecuritySasTokenEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecuritySasTokenEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecuritySasTokenEvidence[]
     */
     ...
     * 
     * @param SecuritySasTokenEvidence[] $items
     * @return self
     */
    public function setValue(array|SecuritySasTokenEvidence $items, SecuritySasTokenEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecuritySasTokenEvidence> $value
     * @return self
     ...
     * 
     * @param SecuritySasTokenEvidence $item
     * @return self
     */
    public function addValue(SecuritySasTokenEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecuritySasTokenEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecuritySasTokenEvidence>
     */
