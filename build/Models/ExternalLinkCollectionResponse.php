...
/**
 * Collection response for ExternalLink
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalLinkCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalLink[]
     */
     ...
     * 
     * @param ExternalLink[] $items
     * @return self
     */
    public function setValue(array|ExternalLink $items, ExternalLink ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalLink> $value
     * @return self
     ...
     * 
     * @param ExternalLink $item
     * @return self
     */
    public function addValue(ExternalLink $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ExternalLink>
     */
