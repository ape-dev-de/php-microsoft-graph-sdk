...
/**
 * Collection response for Operation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Operation[]
     */
     ...
     * @return self
     */
    public function setValue(array|Operation $items, Operation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Operation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Operation>
     */
