...
/**
 * Collection response for EditionUpgradeConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EditionUpgradeConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EditionUpgradeConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param EditionUpgradeConfiguration[] $items
     * @return self
     */
    public function setValue(array|EditionUpgradeConfiguration $items, EditionUpgradeConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EditionUpgradeConfiguration> $value
     * @return self
     ...
     * 
     * @param EditionUpgradeConfiguration $item
     * @return self
     */
    public function addValue(EditionUpgradeConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EditionUpgradeConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EditionUpgradeConfiguration>
     */
