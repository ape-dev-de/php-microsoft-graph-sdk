...
/**
 * Collection response for BinaryOperator
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BinaryOperatorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BinaryOperator[]
     */
     ...
     * 
     * @param BinaryOperator[] $items
     * @return self
     */
    public function setValue(array|BinaryOperator $items, BinaryOperator ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BinaryOperator> $value
     * @return self
     ...
     * 
     * @param BinaryOperator $item
     * @return self
     */
    public function addValue(BinaryOperator $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BinaryOperator>
     */
