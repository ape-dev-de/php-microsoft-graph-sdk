...
/**
 * Collection response for DeviceManagementPartnerAppType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceManagementPartnerAppTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceManagementPartnerAppType[]
     */
    private array $value = [];
     ...
     * 
     * @return DeviceManagementPartnerAppType[]
     */
     ...
     * 
     * @param DeviceManagementPartnerAppType[] $items
     * @return self
     */
    public function setValue(array|DeviceManagementPartnerAppType $items, DeviceManagementPartnerAppType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceManagementPartnerAppType> $value
     * @return self
     ...
     * 
     * @param DeviceManagementPartnerAppType $item
     * @return self
     */
    public function addValue(DeviceManagementPartnerAppType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceManagementPartnerAppType>
     */
