...
/**
 * DeviceManagementPartnerAppTypeCollectionResponse - Collection response
 */
class DeviceManagementPartnerAppTypeCollectionResponse
{
    /**
     * @var array<int, DeviceManagementPartnerAppType>
     */
    public array $value = [];
