...
/**
 * Collection response for BroadcastMeetingAudience
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BroadcastMeetingAudienceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return BroadcastMeetingAudience[]
     */
     ...
     * 
     * @param BroadcastMeetingAudience[] $items
     * @return self
     */
    public function setValue(array|BroadcastMeetingAudience $items, BroadcastMeetingAudience ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BroadcastMeetingAudience> $value
     * @return self
     ...
     * 
     * @param BroadcastMeetingAudience $item
     * @return self
     */
    public function addValue(BroadcastMeetingAudience $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BroadcastMeetingAudience>
     */
