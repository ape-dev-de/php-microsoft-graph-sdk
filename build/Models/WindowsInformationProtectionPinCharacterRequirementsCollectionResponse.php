...
/**
 * WindowsInformationProtectionPinCharacterRequirementsCollectionResponse - Collection response
 */
class WindowsInformationProtectionPinCharacterRequirementsCollectionResponse
{
    /**
     * @var array<int, WindowsInformationProtectionPinCharacterRequirements>
     */
    public array $value = [];
