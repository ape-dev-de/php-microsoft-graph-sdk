...
/**
 * Collection response for WindowsInformationProtectionPinCharacterRequirements
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsInformationProtectionPinCharacterRequirementsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsInformationProtectionPinCharacterRequirements[]
     */
    private array $value = [];
     ...
     * 
     * @return WindowsInformationProtectionPinCharacterRequirements[]
     */
     ...
     * 
     * @param WindowsInformationProtectionPinCharacterRequirements[] $items
     * @return self
     */
    public function setValue(array|WindowsInformationProtectionPinCharacterRequirements $items, WindowsInformationProtectionPinCharacterRequirements ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsInformationProtectionPinCharacterRequirements> $value
     * @return self
     ...
     * 
     * @param WindowsInformationProtectionPinCharacterRequirements $item
     * @return self
     */
    public function addValue(WindowsInformationProtectionPinCharacterRequirements $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsInformationProtectionPinCharacterRequirements>
     */
