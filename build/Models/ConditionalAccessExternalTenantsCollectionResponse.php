 ...
 */
class ConditionalAccessExternalTenantsCollectionResponse
{
    /**
     ...
     * 
     * @param ConditionalAccessExternalTenants ...$items Variable number of ConditionalAccessExternalTenants items
     * @return self
     */
    public function setValue(ConditionalAccessExternalTenants ...$items): self
    {
        $this->value = $items;
        return $this;
    }
