...
/**
 * Collection response for ConditionalAccessExternalTenants
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessExternalTenantsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessExternalTenants[]
     */
    private array $value = [];
     ...
     * 
     * @param ConditionalAccessExternalTenants[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessExternalTenants $items, ConditionalAccessExternalTenants ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessExternalTenants> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessExternalTenants $item
     * @return self
     */
    public function addValue(ConditionalAccessExternalTenants $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessExternalTenants>
     */
