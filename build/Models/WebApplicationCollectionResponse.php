...
/**
 * Collection response for WebApplication
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WebApplicationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WebApplication[]
     */
     ...
     * 
     * @param WebApplication[] $items
     * @return self
     */
    public function setValue(array|WebApplication $items, WebApplication ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WebApplication> $value
     * @return self
     ...
     * 
     * @param WebApplication $item
     * @return self
     */
    public function addValue(WebApplication $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WebApplication>
     */
