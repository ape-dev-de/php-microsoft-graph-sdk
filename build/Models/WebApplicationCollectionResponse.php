 ...
 */
class WebApplicationCollectionResponse
{
    /**
     * @var WebApplication[]
     */
     ...
     * 
     * @param WebApplication ...$items Variable number of WebApplication items
     * @return self
     */
    public function setValue(WebApplication ...$items): self
    {
        $this->value = $items;
        return $this;
    }
