...
/**
 * Collection response for ChannelSetAsFavoriteByDefaultEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChannelSetAsFavoriteByDefaultEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChannelSetAsFavoriteByDefaultEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param ChannelSetAsFavoriteByDefaultEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|ChannelSetAsFavoriteByDefaultEventMessageDetail $items, ChannelSetAsFavoriteByDefaultEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChannelSetAsFavoriteByDefaultEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param ChannelSetAsFavoriteByDefaultEventMessageDetail $item
     * @return self
     */
    public function addValue(ChannelSetAsFavoriteByDefaultEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ChannelSetAsFavoriteByDefaultEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ChannelSetAsFavoriteByDefaultEventMessageDetail>
     */
