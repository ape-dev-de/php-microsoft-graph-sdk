 ...
 */
class ChannelSetAsFavoriteByDefaultEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param ChannelSetAsFavoriteByDefaultEventMessageDetail ...$items Variable number of ChannelSetAsFavoriteByDefaultEventMessageDetail items
     * @return self
     */
    public function setValue(ChannelSetAsFavoriteByDefaultEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
