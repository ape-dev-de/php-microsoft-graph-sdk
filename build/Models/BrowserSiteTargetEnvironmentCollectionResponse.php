...
/**
 * Collection response for BrowserSiteTargetEnvironment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BrowserSiteTargetEnvironmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return BrowserSiteTargetEnvironment[]
     */
     ...
     * 
     * @param BrowserSiteTargetEnvironment[] $items
     * @return self
     */
    public function setValue(array|BrowserSiteTargetEnvironment $items, BrowserSiteTargetEnvironment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BrowserSiteTargetEnvironment> $value
     * @return self
     ...
     * 
     * @param BrowserSiteTargetEnvironment $item
     * @return self
     */
    public function addValue(BrowserSiteTargetEnvironment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BrowserSiteTargetEnvironment>
     */
