...
/**
 * BrowserSiteTargetEnvironmentCollectionResponse - Collection response
 */
class BrowserSiteTargetEnvironmentCollectionResponse
{
    /**
     * @var array<int, BrowserSiteTargetEnvironment>
     */
    public array $value = [];
