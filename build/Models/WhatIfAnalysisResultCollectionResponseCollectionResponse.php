...
/**
 * Collection response for WhatIfAnalysisResultCollectionResponse
 */
class WhatIfAnalysisResultCollectionResponseCollectionResponse
{
    /**
     * @var WhatIfAnalysisResultCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return WhatIfAnalysisResultCollectionResponse[]
     */
     ...
     * 
     * @param WhatIfAnalysisResultCollectionResponse ...$items Variable number of WhatIfAnalysisResultCollectionResponse items
     * @return self
     */
    public function setValue(WhatIfAnalysisResultCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WhatIfAnalysisResultCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WhatIfAnalysisResultCollectionResponse $item
     * @return self
     */
    public function addValue(WhatIfAnalysisResultCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
