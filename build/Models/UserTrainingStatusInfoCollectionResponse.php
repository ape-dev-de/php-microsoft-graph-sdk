...
/**
 * Collection response for UserTrainingStatusInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserTrainingStatusInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserTrainingStatusInfo[] $items
     * @return self
     */
    public function setValue(array|UserTrainingStatusInfo $items, UserTrainingStatusInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserTrainingStatusInfo> $value
     * @return self
     ...
     * 
     * @param UserTrainingStatusInfo $item
     * @return self
     */
    public function addValue(UserTrainingStatusInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UserTrainingStatusInfo|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UserTrainingStatusInfo>
     */
