...
/**
 * Collection response for OpenShiftChangeRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OpenShiftChangeRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param OpenShiftChangeRequest[] $items
     * @return self
     */
    public function setValue(array|OpenShiftChangeRequest $items, OpenShiftChangeRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OpenShiftChangeRequest> $value
     * @return self
     ...
     * 
     * @param OpenShiftChangeRequest $item
     * @return self
     */
    public function addValue(OpenShiftChangeRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OpenShiftChangeRequest>
     */
