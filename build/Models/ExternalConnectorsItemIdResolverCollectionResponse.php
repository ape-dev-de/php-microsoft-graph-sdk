 ...
 */
class ExternalConnectorsItemIdResolverCollectionResponse
{
    /**
     ...
     * 
     * @param ExternalConnectorsItemIdResolver ...$items Variable number of ExternalConnectorsItemIdResolver items
     * @return self
     */
    public function setValue(ExternalConnectorsItemIdResolver ...$items): self
    {
        $this->value = $items;
        return $this;
    }
