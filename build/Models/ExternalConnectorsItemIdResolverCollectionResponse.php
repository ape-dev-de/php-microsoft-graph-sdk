...
/**
 * Collection response for ExternalConnectorsItemIdResolver
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsItemIdResolverCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalConnectorsItemIdResolver[]
     */
    private array $value = [];
     ...
     * 
     * @return ExternalConnectorsItemIdResolver[]
     */
     ...
     * 
     * @param ExternalConnectorsItemIdResolver[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsItemIdResolver $items, ExternalConnectorsItemIdResolver ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsItemIdResolver> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsItemIdResolver $item
     * @return self
     */
    public function addValue(ExternalConnectorsItemIdResolver $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalConnectorsItemIdResolver|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsItemIdResolver>
     */
