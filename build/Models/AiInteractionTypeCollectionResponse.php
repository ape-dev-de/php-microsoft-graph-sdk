...
/**
 * Collection response for AiInteractionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AiInteractionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AiInteractionType[] $items
     * @return self
     */
    public function setValue(array|AiInteractionType $items, AiInteractionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AiInteractionType> $value
     * @return self
     ...
     * 
     * @param AiInteractionType $item
     * @return self
     */
    public function addValue(AiInteractionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AiInteractionType>
     */
