...
/**
 * Collection response for HttpRequestEndpoint
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class HttpRequestEndpointCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var HttpRequestEndpoint[]
     */
    private array $value = [];
     ...
     * 
     * @param HttpRequestEndpoint[] $items
     * @return self
     */
    public function setValue(array|HttpRequestEndpoint $items, HttpRequestEndpoint ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<HttpRequestEndpoint> $value
     * @return self
     ...
     * 
     * @param HttpRequestEndpoint $item
     * @return self
     */
    public function addValue(HttpRequestEndpoint $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return HttpRequestEndpoint|null
     */
     ...
     * 
     * @return \ArrayIterator<int, HttpRequestEndpoint>
     */
