 ...
 */
class HttpRequestEndpointCollectionResponse
{
    /**
     ...
     * 
     * @param HttpRequestEndpoint ...$items Variable number of HttpRequestEndpoint items
     * @return self
     */
    public function setValue(HttpRequestEndpoint ...$items): self
    {
        $this->value = $items;
        return $this;
    }
