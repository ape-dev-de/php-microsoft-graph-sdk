...
/**
 * Collection response for IosManagedAppProtectionCollectionResponse
 */
class IosManagedAppProtectionCollectionResponseCollectionResponse
{
    /**
     * @var IosManagedAppProtectionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IosManagedAppProtectionCollectionResponse ...$items Variable number of IosManagedAppProtectionCollectionResponse items
     * @return self
     */
    public function setValue(IosManagedAppProtectionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IosManagedAppProtectionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IosManagedAppProtectionCollectionResponse $item
     * @return self
     */
    public function addValue(IosManagedAppProtectionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
