...
/**
 * Collection response for DeviceComplianceActionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceComplianceActionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceComplianceActionType[]
     */
    private array $value = [];
     ...
     * 
     * @return DeviceComplianceActionType[]
     */
     ...
     * 
     * @param DeviceComplianceActionType[] $items
     * @return self
     */
    public function setValue(array|DeviceComplianceActionType $items, DeviceComplianceActionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceComplianceActionType> $value
     * @return self
     ...
     * 
     * @param DeviceComplianceActionType $item
     * @return self
     */
    public function addValue(DeviceComplianceActionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceComplianceActionType>
     */
