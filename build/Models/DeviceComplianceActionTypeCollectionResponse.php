...
/**
 * DeviceComplianceActionTypeCollectionResponse - Collection response
 */
class DeviceComplianceActionTypeCollectionResponse
{
    /**
     * @var array<int, DeviceComplianceActionType>
     */
    public array $value = [];
