 ...
 */
class OnPremisesExtensionAttributesCollectionResponse
{
    /**
     ...
     * 
     * @param OnPremisesExtensionAttributes ...$items Variable number of OnPremisesExtensionAttributes items
     * @return self
     */
    public function setValue(OnPremisesExtensionAttributes ...$items): self
    {
        $this->value = $items;
        return $this;
    }
