...
/**
 * Collection response for OnPremisesExtensionAttributes
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnPremisesExtensionAttributesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param OnPremisesExtensionAttributes[] $items
     * @return self
     */
    public function setValue(array|OnPremisesExtensionAttributes $items, OnPremisesExtensionAttributes ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnPremisesExtensionAttributes> $value
     * @return self
     ...
     * 
     * @param OnPremisesExtensionAttributes $item
     * @return self
     */
    public function addValue(OnPremisesExtensionAttributes $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnPremisesExtensionAttributes>
     */
