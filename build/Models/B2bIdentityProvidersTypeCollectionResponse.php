...
/**
 * Collection response for B2bIdentityProvidersType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class B2bIdentityProvidersTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return B2bIdentityProvidersType[]
     */
     ...
     * 
     * @param B2bIdentityProvidersType[] $items
     * @return self
     */
    public function setValue(array|B2bIdentityProvidersType $items, B2bIdentityProvidersType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<B2bIdentityProvidersType> $value
     * @return self
     ...
     * 
     * @param B2bIdentityProvidersType $item
     * @return self
     */
    public function addValue(B2bIdentityProvidersType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, B2bIdentityProvidersType>
     */
