...
/**
 * Collection response for ProtectedContent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProtectedContentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ProtectedContent[] $items
     * @return self
     */
    public function setValue(array|ProtectedContent $items, ProtectedContent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProtectedContent> $value
     * @return self
     ...
     * 
     * @param ProtectedContent $item
     * @return self
     */
    public function addValue(ProtectedContent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProtectedContent>
     */
