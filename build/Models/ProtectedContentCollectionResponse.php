 ...
 */
class ProtectedContentCollectionResponse
{
    /**
     ...
     * 
     * @param ProtectedContent ...$items Variable number of ProtectedContent items
     * @return self
     */
    public function setValue(ProtectedContent ...$items): self
    {
        $this->value = $items;
        return $this;
    }
