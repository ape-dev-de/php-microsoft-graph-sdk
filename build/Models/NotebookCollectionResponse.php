...
/**
 * Collection response for Notebook
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class NotebookCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Notebook[]
     */
     ...
     * 
     * @param Notebook[] $items
     * @return self
     */
    public function setValue(array|Notebook $items, Notebook ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Notebook $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Notebook>
     */
