 ...
 */
class ConditionalAccessPolicyDetailCollectionResponse
{
    /**
     ...
     * 
     * @param ConditionalAccessPolicyDetail ...$items Variable number of ConditionalAccessPolicyDetail items
     * @return self
     */
    public function setValue(ConditionalAccessPolicyDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
