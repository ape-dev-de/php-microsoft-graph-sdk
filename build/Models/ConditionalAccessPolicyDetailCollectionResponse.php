...
/**
 * Collection response for ConditionalAccessPolicyDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessPolicyDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessPolicyDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param ConditionalAccessPolicyDetail[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessPolicyDetail $items, ConditionalAccessPolicyDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessPolicyDetail> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessPolicyDetail $item
     * @return self
     */
    public function addValue(ConditionalAccessPolicyDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessPolicyDetail>
     */
