...
/**
 * Collection response for Folder
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FolderCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Folder[]
     */
     ...
     * @return self
     */
    public function setValue(array|Folder $items, Folder ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Folder $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Folder>
     */
