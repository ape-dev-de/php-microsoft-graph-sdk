...
/**
 * Collection response for RiskyServicePrincipalCollectionResponse
 */
class RiskyServicePrincipalCollectionResponseCollectionResponse
{
    /**
     * @var RiskyServicePrincipalCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RiskyServicePrincipalCollectionResponse ...$items Variable number of RiskyServicePrincipalCollectionResponse items
     * @return self
     */
    public function setValue(RiskyServicePrincipalCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RiskyServicePrincipalCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RiskyServicePrincipalCollectionResponse $item
     * @return self
     */
    public function addValue(RiskyServicePrincipalCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
