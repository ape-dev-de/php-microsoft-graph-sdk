...
/**
 * Collection response for SecurityVmCloudProvider
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityVmCloudProviderCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityVmCloudProvider[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityVmCloudProvider[]
     */
     ...
     * 
     * @param SecurityVmCloudProvider[] $items
     * @return self
     */
    public function setValue(array|SecurityVmCloudProvider $items, SecurityVmCloudProvider ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityVmCloudProvider> $value
     * @return self
     ...
     * 
     * @param SecurityVmCloudProvider $item
     * @return self
     */
    public function addValue(SecurityVmCloudProvider $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityVmCloudProvider|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityVmCloudProvider>
     */
