...
/**
 * Collection response for UnifiedRbacResourceNamespaceCollectionResponse
 */
class UnifiedRbacResourceNamespaceCollectionResponseCollectionResponse
{
    /**
     * @var UnifiedRbacResourceNamespaceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedRbacResourceNamespaceCollectionResponse ...$items Variable number of UnifiedRbacResourceNamespaceCollectionResponse items
     * @return self
     */
    public function setValue(UnifiedRbacResourceNamespaceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UnifiedRbacResourceNamespaceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UnifiedRbacResourceNamespaceCollectionResponse $item
     * @return self
     */
    public function addValue(UnifiedRbacResourceNamespaceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
