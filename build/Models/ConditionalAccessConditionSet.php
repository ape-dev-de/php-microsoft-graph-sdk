...
class ConditionalAccessConditionSet
{
    public function __construct(
        ...
        public ?ConditionalAccessApplications $applications = null,
        /** Authentication flows included in the policy scope. */
        public ?ConditionalAccessAuthenticationFlows $authenticationFlows = null,
        /** Client applications (service principals and workload identities) included in and excluded from the policy. Either users or clientApplications is required. */
        public ?ConditionalAccessClientApplications $clientApplications = null,
        ...
        public ?ConditionalAccessDevices $devices = null,
        /** Insider risk levels included in the policy. The possible values are: minor, moderate, elevated, unknownFutureValue. */
        public ?ConditionalAccessInsiderRiskLevels $insiderRiskLevels = null,
        /** Locations included in and excluded from the policy. */
        public ?ConditionalAccessLocations $locations = null,
        /** Platforms included in and excluded from the policy. */
        public ?ConditionalAccessPlatforms $platforms = null,
        ...
        public ?ConditionalAccessUsers $users = null
    ) {}
}
