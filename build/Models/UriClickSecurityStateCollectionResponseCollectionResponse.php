...
/**
 * Collection response for UriClickSecurityStateCollectionResponse
 */
class UriClickSecurityStateCollectionResponseCollectionResponse
{
    /**
     * @var UriClickSecurityStateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UriClickSecurityStateCollectionResponse ...$items Variable number of UriClickSecurityStateCollectionResponse items
     * @return self
     */
    public function setValue(UriClickSecurityStateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UriClickSecurityStateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UriClickSecurityStateCollectionResponse $item
     * @return self
     */
    public function addValue(UriClickSecurityStateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
