...
/**
 * Collection response for CrossTenantAccessPolicyTargetConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CrossTenantAccessPolicyTargetConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CrossTenantAccessPolicyTargetConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param CrossTenantAccessPolicyTargetConfiguration[] $items
     * @return self
     */
    public function setValue(array|CrossTenantAccessPolicyTargetConfiguration $items, CrossTenantAccessPolicyTargetConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CrossTenantAccessPolicyTargetConfiguration> $value
     * @return self
     ...
     * 
     * @param CrossTenantAccessPolicyTargetConfiguration $item
     * @return self
     */
    public function addValue(CrossTenantAccessPolicyTargetConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CrossTenantAccessPolicyTargetConfiguration>
     */
