 ...
 */
class CrossTenantAccessPolicyTargetConfigurationCollectionResponse
{
    /**
     ...
     * 
     * @param CrossTenantAccessPolicyTargetConfiguration ...$items Variable number of CrossTenantAccessPolicyTargetConfiguration items
     * @return self
     */
    public function setValue(CrossTenantAccessPolicyTargetConfiguration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
