...
/**
 * Collection response for MembershipOutlierInsight
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MembershipOutlierInsightCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MembershipOutlierInsight[]
     */
    private array $value = [];
     ...
     * 
     * @param MembershipOutlierInsight[] $items
     * @return self
     */
    public function setValue(array|MembershipOutlierInsight $items, MembershipOutlierInsight ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MembershipOutlierInsight> $value
     * @return self
     ...
     * 
     * @param MembershipOutlierInsight $item
     * @return self
     */
    public function addValue(MembershipOutlierInsight $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MembershipOutlierInsight|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MembershipOutlierInsight>
     */
