...
/**
 * Collection response for AuthenticationBehaviors
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationBehaviorsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuthenticationBehaviors[]
     */
    private array $value = [];
     ...
     * 
     * @param AuthenticationBehaviors[] $items
     * @return self
     */
    public function setValue(array|AuthenticationBehaviors $items, AuthenticationBehaviors ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationBehaviors> $value
     * @return self
     ...
     * 
     * @param AuthenticationBehaviors $item
     * @return self
     */
    public function addValue(AuthenticationBehaviors $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationBehaviors>
     */
