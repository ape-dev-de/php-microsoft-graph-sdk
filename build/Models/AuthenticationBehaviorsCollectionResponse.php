 ...
 */
class AuthenticationBehaviorsCollectionResponse
{
    /**
     ...
     * 
     * @param AuthenticationBehaviors ...$items Variable number of AuthenticationBehaviors items
     * @return self
     */
    public function setValue(AuthenticationBehaviors ...$items): self
    {
        $this->value = $items;
        return $this;
    }
