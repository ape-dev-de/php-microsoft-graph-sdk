...
/**
 * Collection response for ThreatAssessmentRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ThreatAssessmentRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ThreatAssessmentRequest[] $items
     * @return self
     */
    public function setValue(array|ThreatAssessmentRequest $items, ThreatAssessmentRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ThreatAssessmentRequest> $value
     * @return self
     ...
     * 
     * @param ThreatAssessmentRequest $item
     * @return self
     */
    public function addValue(ThreatAssessmentRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ThreatAssessmentRequest>
     */
