...
/**
 * Collection response for HostSecurityStateCollectionResponse
 */
class HostSecurityStateCollectionResponseCollectionResponse
{
    /**
     * @var HostSecurityStateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param HostSecurityStateCollectionResponse ...$items Variable number of HostSecurityStateCollectionResponse items
     * @return self
     */
    public function setValue(HostSecurityStateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<HostSecurityStateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param HostSecurityStateCollectionResponse $item
     * @return self
     */
    public function addValue(HostSecurityStateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
