...
/**
 * Collection response for ExternalConnectorsLabel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsLabelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return ExternalConnectorsLabel[]
     */
     ...
     * 
     * @param ExternalConnectorsLabel[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsLabel $items, ExternalConnectorsLabel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsLabel> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsLabel $item
     * @return self
     */
    public function addValue(ExternalConnectorsLabel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalConnectorsLabel|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsLabel>
     */
