...
/**
 * Collection response for DeviceConfigurationDeviceStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceConfigurationDeviceStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceConfigurationDeviceStatus[] $items
     * @return self
     */
    public function setValue(array|DeviceConfigurationDeviceStatus $items, DeviceConfigurationDeviceStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceConfigurationDeviceStatus> $value
     * @return self
     ...
     * 
     * @param DeviceConfigurationDeviceStatus $item
     * @return self
     */
    public function addValue(DeviceConfigurationDeviceStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceConfigurationDeviceStatus>
     */
