...
/**
 * Collection response for WindowsMobileMSI
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsMobileMSICollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsMobileMSI[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsMobileMSI[] $items
     * @return self
     */
    public function setValue(array|WindowsMobileMSI $items, WindowsMobileMSI ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsMobileMSI> $value
     * @return self
     ...
     * 
     * @param WindowsMobileMSI $item
     * @return self
     */
    public function addValue(WindowsMobileMSI $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsMobileMSI>
     */
