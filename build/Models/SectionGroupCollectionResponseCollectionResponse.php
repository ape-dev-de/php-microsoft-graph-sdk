...
/**
 * Collection response for SectionGroupCollectionResponse
 */
class SectionGroupCollectionResponseCollectionResponse
{
    /**
     * @var SectionGroupCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SectionGroupCollectionResponse ...$items Variable number of SectionGroupCollectionResponse items
     * @return self
     */
    public function setValue(SectionGroupCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SectionGroupCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SectionGroupCollectionResponse $item
     * @return self
     */
    public function addValue(SectionGroupCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
