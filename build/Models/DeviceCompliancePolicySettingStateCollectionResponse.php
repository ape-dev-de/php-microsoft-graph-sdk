...
/**
 * Collection response for DeviceCompliancePolicySettingState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceCompliancePolicySettingStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceCompliancePolicySettingState[] $items
     * @return self
     */
    public function setValue(array|DeviceCompliancePolicySettingState $items, DeviceCompliancePolicySettingState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceCompliancePolicySettingState> $value
     * @return self
     ...
     * 
     * @param DeviceCompliancePolicySettingState $item
     * @return self
     */
    public function addValue(DeviceCompliancePolicySettingState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return DeviceCompliancePolicySettingState|null
     */
     ...
     * 
     * @return \ArrayIterator<int, DeviceCompliancePolicySettingState>
     */
