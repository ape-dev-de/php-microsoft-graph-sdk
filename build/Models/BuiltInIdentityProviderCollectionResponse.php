...
/**
 * Collection response for BuiltInIdentityProvider
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BuiltInIdentityProviderCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param BuiltInIdentityProvider[] $items
     * @return self
     */
    public function setValue(array|BuiltInIdentityProvider $items, BuiltInIdentityProvider ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BuiltInIdentityProvider> $value
     * @return self
     ...
     * 
     * @param BuiltInIdentityProvider $item
     * @return self
     */
    public function addValue(BuiltInIdentityProvider $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return BuiltInIdentityProvider|null
     */
     ...
     * 
     * @return \ArrayIterator<int, BuiltInIdentityProvider>
     */
