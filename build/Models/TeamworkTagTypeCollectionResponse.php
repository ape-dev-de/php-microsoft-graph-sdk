...
/**
 * Collection response for TeamworkTagType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamworkTagTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamworkTagType[]
     */
     ...
     * 
     * @param TeamworkTagType[] $items
     * @return self
     */
    public function setValue(array|TeamworkTagType $items, TeamworkTagType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamworkTagType> $value
     * @return self
     ...
     * 
     * @param TeamworkTagType $item
     * @return self
     */
    public function addValue(TeamworkTagType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamworkTagType>
     */
