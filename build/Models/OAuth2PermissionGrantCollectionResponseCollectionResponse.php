...
/**
 * Collection response for OAuth2PermissionGrantCollectionResponse
 */
class OAuth2PermissionGrantCollectionResponseCollectionResponse
{
    /**
     * @var OAuth2PermissionGrantCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param OAuth2PermissionGrantCollectionResponse ...$items Variable number of OAuth2PermissionGrantCollectionResponse items
     * @return self
     */
    public function setValue(OAuth2PermissionGrantCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<OAuth2PermissionGrantCollectionResponse> $value
     * @return self
     ...
     * 
     * @param OAuth2PermissionGrantCollectionResponse $item
     * @return self
     */
    public function addValue(OAuth2PermissionGrantCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
