...
/**
 * Collection response for WindowsAutopilotDeviceIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsAutopilotDeviceIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WindowsAutopilotDeviceIdentity[] $items
     * @return self
     */
    public function setValue(array|WindowsAutopilotDeviceIdentity $items, WindowsAutopilotDeviceIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsAutopilotDeviceIdentity> $value
     * @return self
     ...
     * 
     * @param WindowsAutopilotDeviceIdentity $item
     * @return self
     */
    public function addValue(WindowsAutopilotDeviceIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsAutopilotDeviceIdentity>
     */
