...
/**
 * Collection response for Training
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TrainingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Training[]
     */
     ...
     * 
     * @param Training[] $items
     * @return self
     */
    public function setValue(array|Training $items, Training ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Training $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Training>
     */
