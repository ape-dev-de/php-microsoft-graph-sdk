...
/**
 * Collection response for ManagedIOSStoreAppCollectionResponse
 */
class ManagedIOSStoreAppCollectionResponseCollectionResponse
{
    /**
     * @var ManagedIOSStoreAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedIOSStoreAppCollectionResponse ...$items Variable number of ManagedIOSStoreAppCollectionResponse items
     * @return self
     */
    public function setValue(ManagedIOSStoreAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ManagedIOSStoreAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ManagedIOSStoreAppCollectionResponse $item
     * @return self
     */
    public function addValue(ManagedIOSStoreAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
