 ...
 */
class WorkbookFilterCriteriaCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookFilterCriteria ...$items Variable number of WorkbookFilterCriteria items
     * @return self
     */
    public function setValue(WorkbookFilterCriteria ...$items): self
    {
        $this->value = $items;
        return $this;
    }
