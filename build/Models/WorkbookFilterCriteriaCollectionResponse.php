...
/**
 * Collection response for WorkbookFilterCriteria
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookFilterCriteriaCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WorkbookFilterCriteria[] $items
     * @return self
     */
    public function setValue(array|WorkbookFilterCriteria $items, WorkbookFilterCriteria ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookFilterCriteria> $value
     * @return self
     ...
     * 
     * @param WorkbookFilterCriteria $item
     * @return self
     */
    public function addValue(WorkbookFilterCriteria $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookFilterCriteria>
     */
