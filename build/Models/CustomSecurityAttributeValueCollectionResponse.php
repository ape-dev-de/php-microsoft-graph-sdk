...
/**
 * Collection response for CustomSecurityAttributeValue
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CustomSecurityAttributeValueCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CustomSecurityAttributeValue[]
     */
    private array $value = [];
     ...
     * 
     * @param CustomSecurityAttributeValue[] $items
     * @return self
     */
    public function setValue(array|CustomSecurityAttributeValue $items, CustomSecurityAttributeValue ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CustomSecurityAttributeValue> $value
     * @return self
     ...
     * 
     * @param CustomSecurityAttributeValue $item
     * @return self
     */
    public function addValue(CustomSecurityAttributeValue $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CustomSecurityAttributeValue>
     */
