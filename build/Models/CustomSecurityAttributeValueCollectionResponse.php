...
/**
 * CustomSecurityAttributeValueCollectionResponse - Collection response
 */
class CustomSecurityAttributeValueCollectionResponse
{
    /**
     * @var array<int, CustomSecurityAttributeValue>
     */
    public array $value = [];
