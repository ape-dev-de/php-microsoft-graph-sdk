...
/**
 * Collection response for ManagedEBookCollectionResponse
 */
class ManagedEBookCollectionResponseCollectionResponse
{
    /**
     * @var ManagedEBookCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedEBookCollectionResponse ...$items Variable number of ManagedEBookCollectionResponse items
     * @return self
     */
    public function setValue(ManagedEBookCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ManagedEBookCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ManagedEBookCollectionResponse $item
     * @return self
     */
    public function addValue(ManagedEBookCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
