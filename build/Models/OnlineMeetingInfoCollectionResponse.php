 ...
 */
class OnlineMeetingInfoCollectionResponse
{
    /**
     ...
     * 
     * @param OnlineMeetingInfo ...$items Variable number of OnlineMeetingInfo items
     * @return self
     */
    public function setValue(OnlineMeetingInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
