...
/**
 * Collection response for OnlineMeetingInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnlineMeetingInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param OnlineMeetingInfo[] $items
     * @return self
     */
    public function setValue(array|OnlineMeetingInfo $items, OnlineMeetingInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnlineMeetingInfo> $value
     * @return self
     ...
     * 
     * @param OnlineMeetingInfo $item
     * @return self
     */
    public function addValue(OnlineMeetingInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnlineMeetingInfo>
     */
