...
/**
 * Collection response for OpenShiftChangeRequestCollectionResponse
 */
class OpenShiftChangeRequestCollectionResponseCollectionResponse
{
    /**
     * @var OpenShiftChangeRequestCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param OpenShiftChangeRequestCollectionResponse ...$items Variable number of OpenShiftChangeRequestCollectionResponse items
     * @return self
     */
    public function setValue(OpenShiftChangeRequestCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<OpenShiftChangeRequestCollectionResponse> $value
     * @return self
     ...
     * 
     * @param OpenShiftChangeRequestCollectionResponse $item
     * @return self
     */
    public function addValue(OpenShiftChangeRequestCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
