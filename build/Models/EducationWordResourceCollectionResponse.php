...
/**
 * Collection response for EducationWordResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationWordResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationWordResource[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationWordResource[] $items
     * @return self
     */
    public function setValue(array|EducationWordResource $items, EducationWordResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationWordResource> $value
     * @return self
     ...
     * 
     * @param EducationWordResource $item
     * @return self
     */
    public function addValue(EducationWordResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EducationWordResource|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EducationWordResource>
     */
