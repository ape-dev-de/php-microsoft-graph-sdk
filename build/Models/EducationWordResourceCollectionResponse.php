 ...
 */
class EducationWordResourceCollectionResponse
{
    /**
     ...
     * 
     * @param EducationWordResource ...$items Variable number of EducationWordResource items
     * @return self
     */
    public function setValue(EducationWordResource ...$items): self
    {
        $this->value = $items;
        return $this;
    }
