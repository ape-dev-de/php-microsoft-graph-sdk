...
/**
 * Collection response for SecurityResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityResource[] $items
     * @return self
     */
    public function setValue(array|SecurityResource $items, SecurityResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityResource> $value
     * @return self
     ...
     * 
     * @param SecurityResource $item
     * @return self
     */
    public function addValue(SecurityResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityResource>
     */
