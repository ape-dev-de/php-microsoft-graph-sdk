...
/**
 * Collection response for ApplicationTemplate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ApplicationTemplateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ApplicationTemplate[] $items
     * @return self
     */
    public function setValue(array|ApplicationTemplate $items, ApplicationTemplate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ApplicationTemplate> $value
     * @return self
     ...
     * 
     * @param ApplicationTemplate $item
     * @return self
     */
    public function addValue(ApplicationTemplate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ApplicationTemplate>
     */
