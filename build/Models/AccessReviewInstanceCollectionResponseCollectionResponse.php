...
/**
 * Collection response for AccessReviewInstanceCollectionResponse
 */
class AccessReviewInstanceCollectionResponseCollectionResponse
{
    /**
     * @var AccessReviewInstanceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessReviewInstanceCollectionResponse ...$items Variable number of AccessReviewInstanceCollectionResponse items
     * @return self
     */
    public function setValue(AccessReviewInstanceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AccessReviewInstanceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AccessReviewInstanceCollectionResponse $item
     * @return self
     */
    public function addValue(AccessReviewInstanceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
