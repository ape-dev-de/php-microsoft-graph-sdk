...
/**
 * Collection response for ManagedMobileApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedMobileAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ManagedMobileApp[] $items
     * @return self
     */
    public function setValue(array|ManagedMobileApp $items, ManagedMobileApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedMobileApp> $value
     * @return self
     ...
     * 
     * @param ManagedMobileApp $item
     * @return self
     */
    public function addValue(ManagedMobileApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedMobileApp>
     */
