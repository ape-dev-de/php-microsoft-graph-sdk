...
/**
 * Collection response for OnInteractiveAuthFlowStartListener
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnInteractiveAuthFlowStartListenerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnInteractiveAuthFlowStartListener[]
     */
    private array $value = [];
     ...
     * 
     * @param OnInteractiveAuthFlowStartListener[] $items
     * @return self
     */
    public function setValue(array|OnInteractiveAuthFlowStartListener $items, OnInteractiveAuthFlowStartListener ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnInteractiveAuthFlowStartListener> $value
     * @return self
     ...
     * 
     * @param OnInteractiveAuthFlowStartListener $item
     * @return self
     */
    public function addValue(OnInteractiveAuthFlowStartListener $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OnInteractiveAuthFlowStartListener|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OnInteractiveAuthFlowStartListener>
     */
