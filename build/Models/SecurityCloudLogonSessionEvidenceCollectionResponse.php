 ...
 */
class SecurityCloudLogonSessionEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityCloudLogonSessionEvidence ...$items Variable number of SecurityCloudLogonSessionEvidence items
     * @return self
     */
    public function setValue(SecurityCloudLogonSessionEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
