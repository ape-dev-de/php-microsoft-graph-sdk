...
/**
 * Collection response for SecurityCloudLogonSessionEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityCloudLogonSessionEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityCloudLogonSessionEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityCloudLogonSessionEvidence[]
     */
     ...
     * 
     * @param SecurityCloudLogonSessionEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityCloudLogonSessionEvidence $items, SecurityCloudLogonSessionEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityCloudLogonSessionEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityCloudLogonSessionEvidence $item
     * @return self
     */
    public function addValue(SecurityCloudLogonSessionEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityCloudLogonSessionEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityCloudLogonSessionEvidence>
     */
