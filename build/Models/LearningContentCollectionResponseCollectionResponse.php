...
/**
 * Collection response for LearningContentCollectionResponse
 */
class LearningContentCollectionResponseCollectionResponse
{
    /**
     * @var LearningContentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param LearningContentCollectionResponse ...$items Variable number of LearningContentCollectionResponse items
     * @return self
     */
    public function setValue(LearningContentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<LearningContentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param LearningContentCollectionResponse $item
     * @return self
     */
    public function addValue(LearningContentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
