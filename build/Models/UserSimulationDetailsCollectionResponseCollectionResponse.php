...
/**
 * Collection response for UserSimulationDetailsCollectionResponse
 */
class UserSimulationDetailsCollectionResponseCollectionResponse
{
    /**
     * @var UserSimulationDetailsCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UserSimulationDetailsCollectionResponse ...$items Variable number of UserSimulationDetailsCollectionResponse items
     * @return self
     */
    public function setValue(UserSimulationDetailsCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UserSimulationDetailsCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UserSimulationDetailsCollectionResponse $item
     * @return self
     */
    public function addValue(UserSimulationDetailsCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
