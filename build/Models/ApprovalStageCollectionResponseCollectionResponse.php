...
/**
 * Collection response for ApprovalStageCollectionResponse
 */
class ApprovalStageCollectionResponseCollectionResponse
{
    /**
     * @var ApprovalStageCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ApprovalStageCollectionResponse ...$items Variable number of ApprovalStageCollectionResponse items
     * @return self
     */
    public function setValue(ApprovalStageCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ApprovalStageCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ApprovalStageCollectionResponse $item
     * @return self
     */
    public function addValue(ApprovalStageCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
