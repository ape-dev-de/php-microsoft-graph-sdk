...
/**
 * Collection response for BookingStaffMember
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingStaffMemberCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BookingStaffMember[]
     */
    private array $value = [];
     ...
     * 
     * @param BookingStaffMember[] $items
     * @return self
     */
    public function setValue(array|BookingStaffMember $items, BookingStaffMember ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingStaffMember> $value
     * @return self
     ...
     * 
     * @param BookingStaffMember $item
     * @return self
     */
    public function addValue(BookingStaffMember $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return BookingStaffMember|null
     */
     ...
     * 
     * @return \ArrayIterator<int, BookingStaffMember>
     */
