...
/**
 * Collection response for SecurityRetentionTrigger
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityRetentionTriggerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityRetentionTrigger[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityRetentionTrigger[]
     */
     ...
     * 
     * @param SecurityRetentionTrigger[] $items
     * @return self
     */
    public function setValue(array|SecurityRetentionTrigger $items, SecurityRetentionTrigger ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityRetentionTrigger> $value
     * @return self
     ...
     * 
     * @param SecurityRetentionTrigger $item
     * @return self
     */
    public function addValue(SecurityRetentionTrigger $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityRetentionTrigger|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityRetentionTrigger>
     */
