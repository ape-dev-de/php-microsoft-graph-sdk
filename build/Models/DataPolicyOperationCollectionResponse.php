...
/**
 * Collection response for DataPolicyOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DataPolicyOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DataPolicyOperation[]
     */
    private array $value = [];
     ...
     * 
     * @param DataPolicyOperation[] $items
     * @return self
     */
    public function setValue(array|DataPolicyOperation $items, DataPolicyOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DataPolicyOperation> $value
     * @return self
     ...
     * 
     * @param DataPolicyOperation $item
     * @return self
     */
    public function addValue(DataPolicyOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DataPolicyOperation>
     */
