...
/**
 * Collection response for ServicePrincipal
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServicePrincipalCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ServicePrincipal[] $items
     * @return self
     */
    public function setValue(array|ServicePrincipal $items, ServicePrincipal ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServicePrincipal> $value
     * @return self
     ...
     * 
     * @param ServicePrincipal $item
     * @return self
     */
    public function addValue(ServicePrincipal $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ServicePrincipal>
     */
