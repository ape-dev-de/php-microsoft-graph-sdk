...
/**
 * Collection response for IosLobAppCollectionResponse
 */
class IosLobAppCollectionResponseCollectionResponse
{
    /**
     * @var IosLobAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IosLobAppCollectionResponse ...$items Variable number of IosLobAppCollectionResponse items
     * @return self
     */
    public function setValue(IosLobAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IosLobAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IosLobAppCollectionResponse $item
     * @return self
     */
    public function addValue(IosLobAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
