...
/**
 * SecurityEvidenceRemediationStatusCollectionResponse - Collection response
 */
class SecurityEvidenceRemediationStatusCollectionResponse
{
    /**
     * @var array<int, SecurityEvidenceRemediationStatus>
     */
    public array $value = [];
