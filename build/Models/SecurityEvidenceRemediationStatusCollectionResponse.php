...
/**
 * Collection response for SecurityEvidenceRemediationStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityEvidenceRemediationStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityEvidenceRemediationStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityEvidenceRemediationStatus[]
     */
     ...
     * 
     * @param SecurityEvidenceRemediationStatus[] $items
     * @return self
     */
    public function setValue(array|SecurityEvidenceRemediationStatus $items, SecurityEvidenceRemediationStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityEvidenceRemediationStatus> $value
     * @return self
     ...
     * 
     * @param SecurityEvidenceRemediationStatus $item
     * @return self
     */
    public function addValue(SecurityEvidenceRemediationStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityEvidenceRemediationStatus|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityEvidenceRemediationStatus>
     */
