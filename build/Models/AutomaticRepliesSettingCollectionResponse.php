 ...
 */
class AutomaticRepliesSettingCollectionResponse
{
    /**
     ...
     * 
     * @param AutomaticRepliesSetting ...$items Variable number of AutomaticRepliesSetting items
     * @return self
     */
    public function setValue(AutomaticRepliesSetting ...$items): self
    {
        $this->value = $items;
        return $this;
    }
