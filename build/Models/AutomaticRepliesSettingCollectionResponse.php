...
/**
 * Collection response for AutomaticRepliesSetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AutomaticRepliesSettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AutomaticRepliesSetting[] $items
     * @return self
     */
    public function setValue(array|AutomaticRepliesSetting $items, AutomaticRepliesSetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AutomaticRepliesSetting> $value
     * @return self
     ...
     * 
     * @param AutomaticRepliesSetting $item
     * @return self
     */
    public function addValue(AutomaticRepliesSetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AutomaticRepliesSetting>
     */
