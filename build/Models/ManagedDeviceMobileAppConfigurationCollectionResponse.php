...
/**
 * Collection response for ManagedDeviceMobileAppConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedDeviceMobileAppConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ManagedDeviceMobileAppConfiguration[] $items
     * @return self
     */
    public function setValue(array|ManagedDeviceMobileAppConfiguration $items, ManagedDeviceMobileAppConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedDeviceMobileAppConfiguration> $value
     * @return self
     ...
     * 
     * @param ManagedDeviceMobileAppConfiguration $item
     * @return self
     */
    public function addValue(ManagedDeviceMobileAppConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedDeviceMobileAppConfiguration>
     */
