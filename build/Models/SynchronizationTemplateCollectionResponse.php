...
/**
 * Collection response for SynchronizationTemplate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationTemplateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SynchronizationTemplate[] $items
     * @return self
     */
    public function setValue(array|SynchronizationTemplate $items, SynchronizationTemplate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SynchronizationTemplate> $value
     * @return self
     ...
     * 
     * @param SynchronizationTemplate $item
     * @return self
     */
    public function addValue(SynchronizationTemplate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SynchronizationTemplate>
     */
