...
/**
 * Collection response for AadUserConversationMember
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AadUserConversationMemberCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AadUserConversationMember[]
     */
    private array $value = [];
     ...
     * 
     * @param AadUserConversationMember[] $items
     * @return self
     */
    public function setValue(array|AadUserConversationMember $items, AadUserConversationMember ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AadUserConversationMember> $value
     * @return self
     ...
     * 
     * @param AadUserConversationMember $item
     * @return self
     */
    public function addValue(AadUserConversationMember $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AadUserConversationMember|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AadUserConversationMember>
     */
