...
/**
 * Collection response for ContentSharingSession
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ContentSharingSessionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ContentSharingSession[] $items
     * @return self
     */
    public function setValue(array|ContentSharingSession $items, ContentSharingSession ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ContentSharingSession> $value
     * @return self
     ...
     * 
     * @param ContentSharingSession $item
     * @return self
     */
    public function addValue(ContentSharingSession $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ContentSharingSession>
     */
