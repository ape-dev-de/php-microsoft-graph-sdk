...
/**
 * Collection response for Win32LobAppRegistryRule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Win32LobAppRegistryRuleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Win32LobAppRegistryRule[]
     */
    private array $value = [];
     ...
     * 
     * @param Win32LobAppRegistryRule[] $items
     * @return self
     */
    public function setValue(array|Win32LobAppRegistryRule $items, Win32LobAppRegistryRule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Win32LobAppRegistryRule> $value
     * @return self
     ...
     * 
     * @param Win32LobAppRegistryRule $item
     * @return self
     */
    public function addValue(Win32LobAppRegistryRule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return Win32LobAppRegistryRule|null
     */
     ...
     * 
     * @return \ArrayIterator<int, Win32LobAppRegistryRule>
     */
