 ...
 */
class Win32LobAppRegistryRuleCollectionResponse
{
    /**
     ...
     * 
     * @param Win32LobAppRegistryRule ...$items Variable number of Win32LobAppRegistryRule items
     * @return self
     */
    public function setValue(Win32LobAppRegistryRule ...$items): self
    {
        $this->value = $items;
        return $this;
    }
