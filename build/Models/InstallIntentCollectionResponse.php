...
/**
 * Collection response for InstallIntent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InstallIntentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var InstallIntent[]
     */
     ...
     * 
     * @param InstallIntent[] $items
     * @return self
     */
    public function setValue(array|InstallIntent $items, InstallIntent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InstallIntent> $value
     * @return self
     ...
     * 
     * @param InstallIntent $item
     * @return self
     */
    public function addValue(InstallIntent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, InstallIntent>
     */
