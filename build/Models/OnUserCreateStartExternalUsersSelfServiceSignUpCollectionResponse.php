...
/**
 * Collection response for OnUserCreateStartExternalUsersSelfServiceSignUp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnUserCreateStartExternalUsersSelfServiceSignUpCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnUserCreateStartExternalUsersSelfServiceSignUp[]
     */
    private array $value = [];
     ...
     * 
     * @param OnUserCreateStartExternalUsersSelfServiceSignUp[] $items
     * @return self
     */
    public function setValue(array|OnUserCreateStartExternalUsersSelfServiceSignUp $items, OnUserCreateStartExternalUsersSelfServiceSignUp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnUserCreateStartExternalUsersSelfServiceSignUp> $value
     * @return self
     ...
     * 
     * @param OnUserCreateStartExternalUsersSelfServiceSignUp $item
     * @return self
     */
    public function addValue(OnUserCreateStartExternalUsersSelfServiceSignUp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OnUserCreateStartExternalUsersSelfServiceSignUp|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OnUserCreateStartExternalUsersSelfServiceSignUp>
     */
