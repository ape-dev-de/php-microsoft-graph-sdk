...
/**
 * OnUserCreateStartExternalUsersSelfServiceSignUpCollectionResponse - Collection response
 */
class OnUserCreateStartExternalUsersSelfServiceSignUpCollectionResponse
{
    /**
     * @var array<int, OnUserCreateStartExternalUsersSelfServiceSignUp>
     */
    public array $value = [];
