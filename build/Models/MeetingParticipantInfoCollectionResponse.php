...
/**
 * Collection response for MeetingParticipantInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MeetingParticipantInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MeetingParticipantInfo[] $items
     * @return self
     */
    public function setValue(array|MeetingParticipantInfo $items, MeetingParticipantInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MeetingParticipantInfo> $value
     * @return self
     ...
     * 
     * @param MeetingParticipantInfo $item
     * @return self
     */
    public function addValue(MeetingParticipantInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MeetingParticipantInfo>
     */
