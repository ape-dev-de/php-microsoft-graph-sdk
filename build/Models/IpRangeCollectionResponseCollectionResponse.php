...
/**
 * Collection response for IpRangeCollectionResponse
 */
class IpRangeCollectionResponseCollectionResponse
{
    /**
     * @var IpRangeCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IpRangeCollectionResponse ...$items Variable number of IpRangeCollectionResponse items
     * @return self
     */
    public function setValue(IpRangeCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IpRangeCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IpRangeCollectionResponse $item
     * @return self
     */
    public function addValue(IpRangeCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
