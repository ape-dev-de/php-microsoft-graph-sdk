...
/**
 * Collection response for MacOSDmgAppCollectionResponse
 */
class MacOSDmgAppCollectionResponseCollectionResponse
{
    /**
     * @var MacOSDmgAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MacOSDmgAppCollectionResponse ...$items Variable number of MacOSDmgAppCollectionResponse items
     * @return self
     */
    public function setValue(MacOSDmgAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MacOSDmgAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MacOSDmgAppCollectionResponse $item
     * @return self
     */
    public function addValue(MacOSDmgAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
