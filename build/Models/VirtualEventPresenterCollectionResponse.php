...
/**
 * Collection response for VirtualEventPresenter
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualEventPresenterCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param VirtualEventPresenter[] $items
     * @return self
     */
    public function setValue(array|VirtualEventPresenter $items, VirtualEventPresenter ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualEventPresenter> $value
     * @return self
     ...
     * 
     * @param VirtualEventPresenter $item
     * @return self
     */
    public function addValue(VirtualEventPresenter $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VirtualEventPresenter>
     */
