 ...
 */
class IdentityGovernanceAttributeChangeTriggerCollectionResponse
{
    /**
     ...
     * 
     * @param IdentityGovernanceAttributeChangeTrigger ...$items Variable number of IdentityGovernanceAttributeChangeTrigger items
     * @return self
     */
    public function setValue(IdentityGovernanceAttributeChangeTrigger ...$items): self
    {
        $this->value = $items;
        return $this;
    }
