...
/**
 * Collection response for IdentityGovernanceAttributeChangeTrigger
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceAttributeChangeTriggerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceAttributeChangeTrigger[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceAttributeChangeTrigger[]
     */
     ...
     * 
     * @param IdentityGovernanceAttributeChangeTrigger[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceAttributeChangeTrigger $items, IdentityGovernanceAttributeChangeTrigger ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceAttributeChangeTrigger> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceAttributeChangeTrigger $item
     * @return self
     */
    public function addValue(IdentityGovernanceAttributeChangeTrigger $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceAttributeChangeTrigger|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceAttributeChangeTrigger>
     */
