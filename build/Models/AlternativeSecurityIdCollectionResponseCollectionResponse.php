...
/**
 * Collection response for AlternativeSecurityIdCollectionResponse
 */
class AlternativeSecurityIdCollectionResponseCollectionResponse
{
    /**
     * @var AlternativeSecurityIdCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AlternativeSecurityIdCollectionResponse ...$items Variable number of AlternativeSecurityIdCollectionResponse items
     * @return self
     */
    public function setValue(AlternativeSecurityIdCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AlternativeSecurityIdCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AlternativeSecurityIdCollectionResponse $item
     * @return self
     */
    public function addValue(AlternativeSecurityIdCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
