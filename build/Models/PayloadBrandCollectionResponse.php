...
/**
 * Collection response for PayloadBrand
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PayloadBrandCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PayloadBrand[]
     */
     ...
     * 
     * @param PayloadBrand[] $items
     * @return self
     */
    public function setValue(array|PayloadBrand $items, PayloadBrand ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PayloadBrand> $value
     * @return self
     ...
     * 
     * @param PayloadBrand $item
     * @return self
     */
    public function addValue(PayloadBrand $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PayloadBrand>
     */
