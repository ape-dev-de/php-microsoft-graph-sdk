...
/**
 * Collection response for AdminReportSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AdminReportSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AdminReportSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param AdminReportSettings[] $items
     * @return self
     */
    public function setValue(array|AdminReportSettings $items, AdminReportSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AdminReportSettings> $value
     * @return self
     ...
     * 
     * @param AdminReportSettings $item
     * @return self
     */
    public function addValue(AdminReportSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AdminReportSettings>
     */
