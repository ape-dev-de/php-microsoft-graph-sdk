 ...
 */
class AdminReportSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param AdminReportSettings ...$items Variable number of AdminReportSettings items
     * @return self
     */
    public function setValue(AdminReportSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
