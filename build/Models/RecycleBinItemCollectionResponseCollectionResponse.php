...
/**
 * Collection response for RecycleBinItemCollectionResponse
 */
class RecycleBinItemCollectionResponseCollectionResponse
{
    /**
     * @var RecycleBinItemCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RecycleBinItemCollectionResponse ...$items Variable number of RecycleBinItemCollectionResponse items
     * @return self
     */
    public function setValue(RecycleBinItemCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RecycleBinItemCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RecycleBinItemCollectionResponse $item
     * @return self
     */
    public function addValue(RecycleBinItemCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
