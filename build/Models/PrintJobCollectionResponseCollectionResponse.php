...
/**
 * Collection response for PrintJobCollectionResponse
 */
class PrintJobCollectionResponseCollectionResponse
{
    /**
     * @var PrintJobCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PrintJobCollectionResponse ...$items Variable number of PrintJobCollectionResponse items
     * @return self
     */
    public function setValue(PrintJobCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PrintJobCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PrintJobCollectionResponse $item
     * @return self
     */
    public function addValue(PrintJobCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
