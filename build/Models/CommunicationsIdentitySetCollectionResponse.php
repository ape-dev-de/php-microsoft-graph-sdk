...
/**
 * Collection response for CommunicationsIdentitySet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CommunicationsIdentitySetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CommunicationsIdentitySet[]
     */
    private array $value = [];
     ...
     * 
     * @param CommunicationsIdentitySet[] $items
     * @return self
     */
    public function setValue(array|CommunicationsIdentitySet $items, CommunicationsIdentitySet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CommunicationsIdentitySet> $value
     * @return self
     ...
     * 
     * @param CommunicationsIdentitySet $item
     * @return self
     */
    public function addValue(CommunicationsIdentitySet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CommunicationsIdentitySet>
     */
