 ...
 */
class CommunicationsIdentitySetCollectionResponse
{
    /**
     ...
     * 
     * @param CommunicationsIdentitySet ...$items Variable number of CommunicationsIdentitySet items
     * @return self
     */
    public function setValue(CommunicationsIdentitySet ...$items): self
    {
        $this->value = $items;
        return $this;
    }
