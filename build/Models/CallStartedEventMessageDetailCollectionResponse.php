 ...
 */
class CallStartedEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param CallStartedEventMessageDetail ...$items Variable number of CallStartedEventMessageDetail items
     * @return self
     */
    public function setValue(CallStartedEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
