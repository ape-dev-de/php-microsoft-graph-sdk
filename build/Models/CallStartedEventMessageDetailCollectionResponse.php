...
/**
 * Collection response for CallStartedEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallStartedEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallStartedEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param CallStartedEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|CallStartedEventMessageDetail $items, CallStartedEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallStartedEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param CallStartedEventMessageDetail $item
     * @return self
     */
    public function addValue(CallStartedEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallStartedEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallStartedEventMessageDetail>
     */
