...
/**
 * Collection response for AccessPackageAssignmentFilterByCurrentUserOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageAssignmentFilterByCurrentUserOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageAssignmentFilterByCurrentUserOptions[]
     */
    private array $value = [];
     ...
     * 
     * @return AccessPackageAssignmentFilterByCurrentUserOptions[]
     */
     ...
     * 
     * @param AccessPackageAssignmentFilterByCurrentUserOptions[] $items
     * @return self
     */
    public function setValue(array|AccessPackageAssignmentFilterByCurrentUserOptions $items, AccessPackageAssignmentFilterByCurrentUserOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageAssignmentFilterByCurrentUserOptions> $value
     * @return self
     ...
     * 
     * @param AccessPackageAssignmentFilterByCurrentUserOptions $item
     * @return self
     */
    public function addValue(AccessPackageAssignmentFilterByCurrentUserOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessPackageAssignmentFilterByCurrentUserOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageAssignmentFilterByCurrentUserOptions>
     */
