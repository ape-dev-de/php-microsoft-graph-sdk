...
/**
 * AccessPackageAssignmentFilterByCurrentUserOptionsCollectionResponse - Collection response
 */
class AccessPackageAssignmentFilterByCurrentUserOptionsCollectionResponse
{
    /**
     * @var array<int, AccessPackageAssignmentFilterByCurrentUserOptions>
     */
    public array $value = [];
