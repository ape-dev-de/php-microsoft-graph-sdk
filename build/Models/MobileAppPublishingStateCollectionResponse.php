...
/**
 * Collection response for MobileAppPublishingState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MobileAppPublishingStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MobileAppPublishingState[]
     */
    private array $value = [];
     ...
     * 
     * @return MobileAppPublishingState[]
     */
     ...
     * 
     * @param MobileAppPublishingState[] $items
     * @return self
     */
    public function setValue(array|MobileAppPublishingState $items, MobileAppPublishingState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MobileAppPublishingState> $value
     * @return self
     ...
     * 
     * @param MobileAppPublishingState $item
     * @return self
     */
    public function addValue(MobileAppPublishingState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MobileAppPublishingState>
     */
