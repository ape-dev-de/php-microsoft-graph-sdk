...
/**
 * Collection response for RedirectUriSettingsCollectionResponse
 */
class RedirectUriSettingsCollectionResponseCollectionResponse
{
    /**
     * @var RedirectUriSettingsCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RedirectUriSettingsCollectionResponse ...$items Variable number of RedirectUriSettingsCollectionResponse items
     * @return self
     */
    public function setValue(RedirectUriSettingsCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RedirectUriSettingsCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RedirectUriSettingsCollectionResponse $item
     * @return self
     */
    public function addValue(RedirectUriSettingsCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
