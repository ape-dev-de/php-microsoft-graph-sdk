...
/**
 * Collection response for TrainingType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TrainingTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TrainingType[]
     */
     ...
     * 
     * @param TrainingType[] $items
     * @return self
     */
    public function setValue(array|TrainingType $items, TrainingType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TrainingType> $value
     * @return self
     ...
     * 
     * @param TrainingType $item
     * @return self
     */
    public function addValue(TrainingType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TrainingType>
     */
