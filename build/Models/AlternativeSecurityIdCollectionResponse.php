...
/**
 * Collection response for AlternativeSecurityId
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AlternativeSecurityIdCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AlternativeSecurityId[] $items
     * @return self
     */
    public function setValue(array|AlternativeSecurityId $items, AlternativeSecurityId ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AlternativeSecurityId> $value
     * @return self
     ...
     * 
     * @param AlternativeSecurityId $item
     * @return self
     */
    public function addValue(AlternativeSecurityId $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AlternativeSecurityId|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AlternativeSecurityId>
     */
