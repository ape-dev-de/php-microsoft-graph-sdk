...
/**
 * Collection response for CallRecording
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecording[]
     */
     ...
     * 
     * @param CallRecording[] $items
     * @return self
     */
    public function setValue(array|CallRecording $items, CallRecording ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecording> $value
     * @return self
     ...
     * 
     * @param CallRecording $item
     * @return self
     */
    public function addValue(CallRecording $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CallRecording>
     */
