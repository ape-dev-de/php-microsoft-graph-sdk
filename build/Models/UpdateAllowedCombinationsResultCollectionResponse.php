...
/**
 * Collection response for UpdateAllowedCombinationsResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UpdateAllowedCombinationsResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UpdateAllowedCombinationsResult[]
     */
    private array $value = [];
     ...
     * 
     * @param UpdateAllowedCombinationsResult[] $items
     * @return self
     */
    public function setValue(array|UpdateAllowedCombinationsResult $items, UpdateAllowedCombinationsResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UpdateAllowedCombinationsResult> $value
     * @return self
     ...
     * 
     * @param UpdateAllowedCombinationsResult $item
     * @return self
     */
    public function addValue(UpdateAllowedCombinationsResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UpdateAllowedCombinationsResult|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UpdateAllowedCombinationsResult>
     */
