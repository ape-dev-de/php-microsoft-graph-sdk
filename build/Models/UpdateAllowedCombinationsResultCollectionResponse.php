 ...
 */
class UpdateAllowedCombinationsResultCollectionResponse
{
    /**
     ...
     * 
     * @param UpdateAllowedCombinationsResult ...$items Variable number of UpdateAllowedCombinationsResult items
     * @return self
     */
    public function setValue(UpdateAllowedCombinationsResult ...$items): self
    {
        $this->value = $items;
        return $this;
    }
