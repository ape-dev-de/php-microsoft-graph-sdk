...
/**
 * Collection response for TargetedManagedAppPolicyAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TargetedManagedAppPolicyAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TargetedManagedAppPolicyAssignment[] $items
     * @return self
     */
    public function setValue(array|TargetedManagedAppPolicyAssignment $items, TargetedManagedAppPolicyAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TargetedManagedAppPolicyAssignment> $value
     * @return self
     ...
     * 
     * @param TargetedManagedAppPolicyAssignment $item
     * @return self
     */
    public function addValue(TargetedManagedAppPolicyAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TargetedManagedAppPolicyAssignment>
     */
