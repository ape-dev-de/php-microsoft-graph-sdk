...
/**
 * OperatingSystemUpgradeEligibilityCollectionResponse - Collection response
 */
class OperatingSystemUpgradeEligibilityCollectionResponse
{
    /**
     * @var array<int, OperatingSystemUpgradeEligibility>
     */
    public array $value = [];
