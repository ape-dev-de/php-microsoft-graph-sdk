...
/**
 * Collection response for OperatingSystemUpgradeEligibility
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OperatingSystemUpgradeEligibilityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OperatingSystemUpgradeEligibility[]
     */
    private array $value = [];
     ...
     * 
     * @return OperatingSystemUpgradeEligibility[]
     */
     ...
     * 
     * @param OperatingSystemUpgradeEligibility[] $items
     * @return self
     */
    public function setValue(array|OperatingSystemUpgradeEligibility $items, OperatingSystemUpgradeEligibility ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OperatingSystemUpgradeEligibility> $value
     * @return self
     ...
     * 
     * @param OperatingSystemUpgradeEligibility $item
     * @return self
     */
    public function addValue(OperatingSystemUpgradeEligibility $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OperatingSystemUpgradeEligibility>
     */
