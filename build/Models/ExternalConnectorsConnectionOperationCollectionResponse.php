...
/**
 * Collection response for ExternalConnectorsConnectionOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsConnectionOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ExternalConnectorsConnectionOperation[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsConnectionOperation $items, ExternalConnectorsConnectionOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsConnectionOperation> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsConnectionOperation $item
     * @return self
     */
    public function addValue(ExternalConnectorsConnectionOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsConnectionOperation>
     */
