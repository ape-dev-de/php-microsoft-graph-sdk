...
/**
 * Collection response for ReferenceUpdate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ReferenceUpdateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ReferenceUpdate[]
     */
     ...
     * 
     * @param ReferenceUpdate[] $items
     * @return self
     */
    public function setValue(array|ReferenceUpdate $items, ReferenceUpdate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ReferenceUpdate> $value
     * @return self
     ...
     * 
     * @param ReferenceUpdate $item
     * @return self
     */
    public function addValue(ReferenceUpdate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ReferenceUpdate>
     */
