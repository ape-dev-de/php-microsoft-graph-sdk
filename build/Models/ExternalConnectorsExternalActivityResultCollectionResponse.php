...
/**
 * Collection response for ExternalConnectorsExternalActivityResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsExternalActivityResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalConnectorsExternalActivityResult[]
     */
    private array $value = [];
     ...
     * 
     * @return ExternalConnectorsExternalActivityResult[]
     */
     ...
     * 
     * @param ExternalConnectorsExternalActivityResult[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsExternalActivityResult $items, ExternalConnectorsExternalActivityResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsExternalActivityResult> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsExternalActivityResult $item
     * @return self
     */
    public function addValue(ExternalConnectorsExternalActivityResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalConnectorsExternalActivityResult|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsExternalActivityResult>
     */
