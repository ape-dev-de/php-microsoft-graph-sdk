...
/**
 * ExternalConnectorsExternalActivityResultCollectionResponse - Collection response
 */
class ExternalConnectorsExternalActivityResultCollectionResponse
{
    /**
     * @var array<int, ExternalConnectorsExternalActivityResult>
     */
    public array $value = [];
