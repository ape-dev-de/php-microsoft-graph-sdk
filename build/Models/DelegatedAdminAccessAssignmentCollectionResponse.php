...
/**
 * Collection response for DelegatedAdminAccessAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DelegatedAdminAccessAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DelegatedAdminAccessAssignment[] $items
     * @return self
     */
    public function setValue(array|DelegatedAdminAccessAssignment $items, DelegatedAdminAccessAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DelegatedAdminAccessAssignment> $value
     * @return self
     ...
     * 
     * @param DelegatedAdminAccessAssignment $item
     * @return self
     */
    public function addValue(DelegatedAdminAccessAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DelegatedAdminAccessAssignment>
     */
