...
/**
 * Collection response for TermStoreGroup
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TermStoreGroupCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TermStoreGroup[]
     */
     ...
     * 
     * @param TermStoreGroup[] $items
     * @return self
     */
    public function setValue(array|TermStoreGroup $items, TermStoreGroup ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TermStoreGroup> $value
     * @return self
     ...
     * 
     * @param TermStoreGroup $item
     * @return self
     */
    public function addValue(TermStoreGroup $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TermStoreGroup>
     */
