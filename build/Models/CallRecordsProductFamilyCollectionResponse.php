...
/**
 * Collection response for CallRecordsProductFamily
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsProductFamilyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsProductFamily[]
     */
    private array $value = [];
     ...
     * 
     * @return CallRecordsProductFamily[]
     */
     ...
     * 
     * @param CallRecordsProductFamily[] $items
     * @return self
     */
    public function setValue(array|CallRecordsProductFamily $items, CallRecordsProductFamily ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsProductFamily> $value
     * @return self
     ...
     * 
     * @param CallRecordsProductFamily $item
     * @return self
     */
    public function addValue(CallRecordsProductFamily $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsProductFamily|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsProductFamily>
     */
