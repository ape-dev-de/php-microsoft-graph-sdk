...
/**
 * Collection response for CloudPcProvisioningPolicyCollectionResponse
 */
class CloudPcProvisioningPolicyCollectionResponseCollectionResponse
{
    /**
     * @var CloudPcProvisioningPolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudPcProvisioningPolicyCollectionResponse ...$items Variable number of CloudPcProvisioningPolicyCollectionResponse items
     * @return self
     */
    public function setValue(CloudPcProvisioningPolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CloudPcProvisioningPolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CloudPcProvisioningPolicyCollectionResponse $item
     * @return self
     */
    public function addValue(CloudPcProvisioningPolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
