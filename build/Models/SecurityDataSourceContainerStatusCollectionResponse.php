...
/**
 * SecurityDataSourceContainerStatusCollectionResponse - Collection response
 */
class SecurityDataSourceContainerStatusCollectionResponse
{
    /**
     * @var array<int, SecurityDataSourceContainerStatus>
     */
    public array $value = [];
