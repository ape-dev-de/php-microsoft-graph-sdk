...
/**
 * Collection response for SecurityDataSourceContainerStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityDataSourceContainerStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityDataSourceContainerStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityDataSourceContainerStatus[]
     */
     ...
     * 
     * @param SecurityDataSourceContainerStatus[] $items
     * @return self
     */
    public function setValue(array|SecurityDataSourceContainerStatus $items, SecurityDataSourceContainerStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityDataSourceContainerStatus> $value
     * @return self
     ...
     * 
     * @param SecurityDataSourceContainerStatus $item
     * @return self
     */
    public function addValue(SecurityDataSourceContainerStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityDataSourceContainerStatus|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityDataSourceContainerStatus>
     */
