...
/**
 * Collection response for Hashes
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class HashesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Hashes[]
     */
     ...
     * @return self
     */
    public function setValue(array|Hashes $items, Hashes ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Hashes $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Hashes>
     */
