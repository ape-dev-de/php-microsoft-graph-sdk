...
/**
 * Collection response for SimulationAutomationCollectionResponse
 */
class SimulationAutomationCollectionResponseCollectionResponse
{
    /**
     * @var SimulationAutomationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SimulationAutomationCollectionResponse ...$items Variable number of SimulationAutomationCollectionResponse items
     * @return self
     */
    public function setValue(SimulationAutomationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SimulationAutomationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SimulationAutomationCollectionResponse $item
     * @return self
     */
    public function addValue(SimulationAutomationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
