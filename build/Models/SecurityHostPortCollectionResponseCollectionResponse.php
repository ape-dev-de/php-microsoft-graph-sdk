...
/**
 * Collection response for SecurityHostPortCollectionResponse
 */
class SecurityHostPortCollectionResponseCollectionResponse
{
    /**
     * @var SecurityHostPortCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityHostPortCollectionResponse ...$items Variable number of SecurityHostPortCollectionResponse items
     * @return self
     */
    public function setValue(SecurityHostPortCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityHostPortCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityHostPortCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityHostPortCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
