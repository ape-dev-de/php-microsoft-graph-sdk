...
/**
 * Collection response for CloudPcRegionGroup
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcRegionGroupCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudPcRegionGroup[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudPcRegionGroup[] $items
     * @return self
     */
    public function setValue(array|CloudPcRegionGroup $items, CloudPcRegionGroup ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcRegionGroup> $value
     * @return self
     ...
     * 
     * @param CloudPcRegionGroup $item
     * @return self
     */
    public function addValue(CloudPcRegionGroup $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcRegionGroup>
     */
