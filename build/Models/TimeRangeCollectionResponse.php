...
/**
 * Collection response for TimeRange
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TimeRangeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TimeRange[]
     */
     ...
     * 
     * @param TimeRange[] $items
     * @return self
     */
    public function setValue(array|TimeRange $items, TimeRange ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(TimeRange $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TimeRange>
     */
