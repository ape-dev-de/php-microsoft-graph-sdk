 ...
 */
class Windows10NetworkProxyServerCollectionResponse
{
    /**
     ...
     * 
     * @param Windows10NetworkProxyServer ...$items Variable number of Windows10NetworkProxyServer items
     * @return self
     */
    public function setValue(Windows10NetworkProxyServer ...$items): self
    {
        $this->value = $items;
        return $this;
    }
