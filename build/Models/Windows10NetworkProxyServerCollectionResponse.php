...
/**
 * Collection response for Windows10NetworkProxyServer
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Windows10NetworkProxyServerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param Windows10NetworkProxyServer[] $items
     * @return self
     */
    public function setValue(array|Windows10NetworkProxyServer $items, Windows10NetworkProxyServer ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Windows10NetworkProxyServer> $value
     * @return self
     ...
     * 
     * @param Windows10NetworkProxyServer $item
     * @return self
     */
    public function addValue(Windows10NetworkProxyServer $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Windows10NetworkProxyServer>
     */
