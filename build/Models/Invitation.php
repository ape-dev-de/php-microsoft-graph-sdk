...
class Invitation
{
    public function __construct(
        ...
        public ?string $invitedUserMessageInfo = null,
        ...
        public ?string $invitedUser = null,
        /** @var string[] The users or groups who are sponsors of the invited user. Sponsors are users and groups that are responsible for guest users' privileges in the tenant and for keeping the guest users' information and access up to date. */
