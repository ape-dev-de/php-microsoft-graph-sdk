...
/**
 * Collection response for WindowsUniversalAppXCollectionResponse
 */
class WindowsUniversalAppXCollectionResponseCollectionResponse
{
    /**
     * @var WindowsUniversalAppXCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsUniversalAppXCollectionResponse ...$items Variable number of WindowsUniversalAppXCollectionResponse items
     * @return self
     */
    public function setValue(WindowsUniversalAppXCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WindowsUniversalAppXCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WindowsUniversalAppXCollectionResponse $item
     * @return self
     */
    public function addValue(WindowsUniversalAppXCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
