...
/**
 * Collection response for AssignedTrainingInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AssignedTrainingInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AssignedTrainingInfo[] $items
     * @return self
     */
    public function setValue(array|AssignedTrainingInfo $items, AssignedTrainingInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AssignedTrainingInfo> $value
     * @return self
     ...
     * 
     * @param AssignedTrainingInfo $item
     * @return self
     */
    public function addValue(AssignedTrainingInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AssignedTrainingInfo|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AssignedTrainingInfo>
     */
