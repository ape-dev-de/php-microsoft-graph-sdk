...
/**
 * Collection response for SecurityHostPairCollectionResponse
 */
class SecurityHostPairCollectionResponseCollectionResponse
{
    /**
     * @var SecurityHostPairCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityHostPairCollectionResponse ...$items Variable number of SecurityHostPairCollectionResponse items
     * @return self
     */
    public function setValue(SecurityHostPairCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityHostPairCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityHostPairCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityHostPairCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
