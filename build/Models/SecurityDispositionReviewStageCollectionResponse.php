...
/**
 * Collection response for SecurityDispositionReviewStage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityDispositionReviewStageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityDispositionReviewStage[] $items
     * @return self
     */
    public function setValue(array|SecurityDispositionReviewStage $items, SecurityDispositionReviewStage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityDispositionReviewStage> $value
     * @return self
     ...
     * 
     * @param SecurityDispositionReviewStage $item
     * @return self
     */
    public function addValue(SecurityDispositionReviewStage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityDispositionReviewStage>
     */
