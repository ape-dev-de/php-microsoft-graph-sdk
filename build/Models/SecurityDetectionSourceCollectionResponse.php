...
/**
 * Collection response for SecurityDetectionSource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityDetectionSourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityDetectionSource[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityDetectionSource[]
     */
     ...
     * 
     * @param SecurityDetectionSource[] $items
     * @return self
     */
    public function setValue(array|SecurityDetectionSource $items, SecurityDetectionSource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityDetectionSource> $value
     * @return self
     ...
     * 
     * @param SecurityDetectionSource $item
     * @return self
     */
    public function addValue(SecurityDetectionSource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityDetectionSource|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityDetectionSource>
     */
