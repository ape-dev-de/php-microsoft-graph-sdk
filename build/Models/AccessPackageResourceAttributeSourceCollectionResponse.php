...
/**
 * Collection response for AccessPackageResourceAttributeSource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageResourceAttributeSourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageResourceAttributeSource[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageResourceAttributeSource[] $items
     * @return self
     */
    public function setValue(array|AccessPackageResourceAttributeSource $items, AccessPackageResourceAttributeSource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageResourceAttributeSource> $value
     * @return self
     ...
     * 
     * @param AccessPackageResourceAttributeSource $item
     * @return self
     */
    public function addValue(AccessPackageResourceAttributeSource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageResourceAttributeSource>
     */
