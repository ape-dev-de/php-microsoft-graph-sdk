...
/**
 * AccessPackageResourceAttributeSourceCollectionResponse - Collection response
 */
class AccessPackageResourceAttributeSourceCollectionResponse
{
    /**
     * @var array<int, AccessPackageResourceAttributeSource>
     */
    public array $value = [];
