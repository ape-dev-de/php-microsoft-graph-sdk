...
/**
 * Collection response for ScheduleChangeState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ScheduleChangeStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ScheduleChangeState[] $items
     * @return self
     */
    public function setValue(array|ScheduleChangeState $items, ScheduleChangeState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ScheduleChangeState> $value
     * @return self
     ...
     * 
     * @param ScheduleChangeState $item
     * @return self
     */
    public function addValue(ScheduleChangeState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ScheduleChangeState>
     */
