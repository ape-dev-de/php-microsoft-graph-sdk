...
/**
 * Collection response for AppLogCollectionRequestCollectionResponse
 */
class AppLogCollectionRequestCollectionResponseCollectionResponse
{
    /**
     * @var AppLogCollectionRequestCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AppLogCollectionRequestCollectionResponse ...$items Variable number of AppLogCollectionRequestCollectionResponse items
     * @return self
     */
    public function setValue(AppLogCollectionRequestCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AppLogCollectionRequestCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AppLogCollectionRequestCollectionResponse $item
     * @return self
     */
    public function addValue(AppLogCollectionRequestCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
