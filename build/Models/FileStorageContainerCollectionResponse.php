...
/**
 * Collection response for FileStorageContainer
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FileStorageContainerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param FileStorageContainer[] $items
     * @return self
     */
    public function setValue(array|FileStorageContainer $items, FileStorageContainer ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FileStorageContainer> $value
     * @return self
     ...
     * 
     * @param FileStorageContainer $item
     * @return self
     */
    public function addValue(FileStorageContainer $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FileStorageContainer>
     */
