...
/**
 * Collection response for TermStoreSet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TermStoreSetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TermStoreSet[]
     */
     ...
     * 
     * @param TermStoreSet[] $items
     * @return self
     */
    public function setValue(array|TermStoreSet $items, TermStoreSet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TermStoreSet> $value
     * @return self
     ...
     * 
     * @param TermStoreSet $item
     * @return self
     */
    public function addValue(TermStoreSet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TermStoreSet>
     */
