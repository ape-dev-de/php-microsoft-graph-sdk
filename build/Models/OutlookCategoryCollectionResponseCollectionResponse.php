...
/**
 * Collection response for OutlookCategoryCollectionResponse
 */
class OutlookCategoryCollectionResponseCollectionResponse
{
    /**
     * @var OutlookCategoryCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param OutlookCategoryCollectionResponse ...$items Variable number of OutlookCategoryCollectionResponse items
     * @return self
     */
    public function setValue(OutlookCategoryCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<OutlookCategoryCollectionResponse> $value
     * @return self
     ...
     * 
     * @param OutlookCategoryCollectionResponse $item
     * @return self
     */
    public function addValue(OutlookCategoryCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
