...
/**
 * Collection response for MailFolderCollectionResponse
 */
class MailFolderCollectionResponseCollectionResponse
{
    /**
     * @var MailFolderCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MailFolderCollectionResponse ...$items Variable number of MailFolderCollectionResponse items
     * @return self
     */
    public function setValue(MailFolderCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MailFolderCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MailFolderCollectionResponse $item
     * @return self
     */
    public function addValue(MailFolderCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
