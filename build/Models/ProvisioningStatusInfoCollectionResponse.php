 ...
 */
class ProvisioningStatusInfoCollectionResponse
{
    /**
     ...
     * 
     * @param ProvisioningStatusInfo ...$items Variable number of ProvisioningStatusInfo items
     * @return self
     */
    public function setValue(ProvisioningStatusInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
