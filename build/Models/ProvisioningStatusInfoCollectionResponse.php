...
/**
 * Collection response for ProvisioningStatusInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProvisioningStatusInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProvisioningStatusInfo[]
     */
    private array $value = [];
     ...
     * 
     * @param ProvisioningStatusInfo[] $items
     * @return self
     */
    public function setValue(array|ProvisioningStatusInfo $items, ProvisioningStatusInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProvisioningStatusInfo> $value
     * @return self
     ...
     * 
     * @param ProvisioningStatusInfo $item
     * @return self
     */
    public function addValue(ProvisioningStatusInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProvisioningStatusInfo>
     */
