...
/**
 * Collection response for RoutingMode
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RoutingModeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RoutingMode[]
     */
     ...
     * 
     * @param RoutingMode[] $items
     * @return self
     */
    public function setValue(array|RoutingMode $items, RoutingMode ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param RoutingMode $item
     * @return self
     */
    public function addValue(RoutingMode $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RoutingMode>
     */
