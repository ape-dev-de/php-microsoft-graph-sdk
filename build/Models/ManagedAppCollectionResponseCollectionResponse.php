...
/**
 * Collection response for ManagedAppCollectionResponse
 */
class ManagedAppCollectionResponseCollectionResponse
{
    /**
     * @var ManagedAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedAppCollectionResponse ...$items Variable number of ManagedAppCollectionResponse items
     * @return self
     */
    public function setValue(ManagedAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ManagedAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ManagedAppCollectionResponse $item
     * @return self
     */
    public function addValue(ManagedAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
