...
/**
 * Collection response for AgreementAcceptance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AgreementAcceptanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AgreementAcceptance[] $items
     * @return self
     */
    public function setValue(array|AgreementAcceptance $items, AgreementAcceptance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AgreementAcceptance> $value
     * @return self
     ...
     * 
     * @param AgreementAcceptance $item
     * @return self
     */
    public function addValue(AgreementAcceptance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AgreementAcceptance>
     */
