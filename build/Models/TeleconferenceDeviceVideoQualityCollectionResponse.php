 ...
 */
class TeleconferenceDeviceVideoQualityCollectionResponse
{
    /**
     ...
     * 
     * @param TeleconferenceDeviceVideoQuality ...$items Variable number of TeleconferenceDeviceVideoQuality items
     * @return self
     */
    public function setValue(TeleconferenceDeviceVideoQuality ...$items): self
    {
        $this->value = $items;
        return $this;
    }
