...
/**
 * Collection response for TeleconferenceDeviceVideoQuality
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeleconferenceDeviceVideoQualityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeleconferenceDeviceVideoQuality[]
     */
    private array $value = [];
     ...
     * 
     * @param TeleconferenceDeviceVideoQuality[] $items
     * @return self
     */
    public function setValue(array|TeleconferenceDeviceVideoQuality $items, TeleconferenceDeviceVideoQuality ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeleconferenceDeviceVideoQuality> $value
     * @return self
     ...
     * 
     * @param TeleconferenceDeviceVideoQuality $item
     * @return self
     */
    public function addValue(TeleconferenceDeviceVideoQuality $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TeleconferenceDeviceVideoQuality|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TeleconferenceDeviceVideoQuality>
     */
