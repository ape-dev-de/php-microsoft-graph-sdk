...
/**
 * Collection response for EducationGender
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationGenderCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationGender[]
     */
     ...
     * 
     * @param EducationGender[] $items
     * @return self
     */
    public function setValue(array|EducationGender $items, EducationGender ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationGender> $value
     * @return self
     ...
     * 
     * @param EducationGender $item
     * @return self
     */
    public function addValue(EducationGender $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationGender>
     */
