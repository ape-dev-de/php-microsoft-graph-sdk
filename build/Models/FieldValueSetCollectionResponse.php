...
/**
 * Collection response for FieldValueSet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FieldValueSetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FieldValueSet[]
     */
     ...
     * 
     * @param FieldValueSet[] $items
     * @return self
     */
    public function setValue(array|FieldValueSet $items, FieldValueSet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FieldValueSet> $value
     * @return self
     ...
     * 
     * @param FieldValueSet $item
     * @return self
     */
    public function addValue(FieldValueSet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FieldValueSet>
     */
