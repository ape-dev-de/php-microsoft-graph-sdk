...
/**
 * OnAttributeCollectionExternalUsersSelfServiceSignUpCollectionResponse - Collection response
 */
class OnAttributeCollectionExternalUsersSelfServiceSignUpCollectionResponse
{
    /**
     * @var array<int, OnAttributeCollectionExternalUsersSelfServiceSignUp>
     */
    public array $value = [];
