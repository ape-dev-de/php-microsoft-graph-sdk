...
/**
 * Collection response for OnAttributeCollectionExternalUsersSelfServiceSignUp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnAttributeCollectionExternalUsersSelfServiceSignUpCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnAttributeCollectionExternalUsersSelfServiceSignUp[]
     */
    private array $value = [];
     ...
     * 
     * @param OnAttributeCollectionExternalUsersSelfServiceSignUp[] $items
     * @return self
     */
    public function setValue(array|OnAttributeCollectionExternalUsersSelfServiceSignUp $items, OnAttributeCollectionExternalUsersSelfServiceSignUp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnAttributeCollectionExternalUsersSelfServiceSignUp> $value
     * @return self
     ...
     * 
     * @param OnAttributeCollectionExternalUsersSelfServiceSignUp $item
     * @return self
     */
    public function addValue(OnAttributeCollectionExternalUsersSelfServiceSignUp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnAttributeCollectionExternalUsersSelfServiceSignUp>
     */
