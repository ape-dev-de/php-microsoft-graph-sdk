...
/**
 * Collection response for PlayPromptOperationCollectionResponse
 */
class PlayPromptOperationCollectionResponseCollectionResponse
{
    /**
     * @var PlayPromptOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PlayPromptOperationCollectionResponse ...$items Variable number of PlayPromptOperationCollectionResponse items
     * @return self
     */
    public function setValue(PlayPromptOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PlayPromptOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PlayPromptOperationCollectionResponse $item
     * @return self
     */
    public function addValue(PlayPromptOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
