...
/**
 * Collection response for IosUpdateConfigurationCollectionResponse
 */
class IosUpdateConfigurationCollectionResponseCollectionResponse
{
    /**
     * @var IosUpdateConfigurationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IosUpdateConfigurationCollectionResponse ...$items Variable number of IosUpdateConfigurationCollectionResponse items
     * @return self
     */
    public function setValue(IosUpdateConfigurationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IosUpdateConfigurationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IosUpdateConfigurationCollectionResponse $item
     * @return self
     */
    public function addValue(IosUpdateConfigurationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
