...
/**
 * Collection response for UserSignIn
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserSignInCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserSignIn[]
     */
     ...
     * 
     * @param UserSignIn[] $items
     * @return self
     */
    public function setValue(array|UserSignIn $items, UserSignIn ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param UserSignIn $item
     * @return self
     */
    public function addValue(UserSignIn $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserSignIn>
     */
