...
/**
 * Collection response for WindowsHelloForBusinessAuthenticationMethod
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsHelloForBusinessAuthenticationMethodCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WindowsHelloForBusinessAuthenticationMethod[] $items
     * @return self
     */
    public function setValue(array|WindowsHelloForBusinessAuthenticationMethod $items, WindowsHelloForBusinessAuthenticationMethod ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsHelloForBusinessAuthenticationMethod> $value
     * @return self
     ...
     * 
     * @param WindowsHelloForBusinessAuthenticationMethod $item
     * @return self
     */
    public function addValue(WindowsHelloForBusinessAuthenticationMethod $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsHelloForBusinessAuthenticationMethod>
     */
