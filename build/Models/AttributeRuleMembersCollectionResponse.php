...
/**
 * Collection response for AttributeRuleMembers
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttributeRuleMembersCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AttributeRuleMembers[]
     */
    private array $value = [];
     ...
     * 
     * @param AttributeRuleMembers[] $items
     * @return self
     */
    public function setValue(array|AttributeRuleMembers $items, AttributeRuleMembers ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttributeRuleMembers> $value
     * @return self
     ...
     * 
     * @param AttributeRuleMembers $item
     * @return self
     */
    public function addValue(AttributeRuleMembers $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AttributeRuleMembers|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AttributeRuleMembers>
     */
