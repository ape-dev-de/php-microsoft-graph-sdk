 ...
 */
class AttributeRuleMembersCollectionResponse
{
    /**
     ...
     * 
     * @param AttributeRuleMembers ...$items Variable number of AttributeRuleMembers items
     * @return self
     */
    public function setValue(AttributeRuleMembers ...$items): self
    {
        $this->value = $items;
        return $this;
    }
