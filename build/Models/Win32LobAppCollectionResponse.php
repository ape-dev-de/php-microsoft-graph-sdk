...
/**
 * Collection response for Win32LobApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Win32LobAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Win32LobApp[]
     */
     ...
     * 
     * @param Win32LobApp[] $items
     * @return self
     */
    public function setValue(array|Win32LobApp $items, Win32LobApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param Win32LobApp $item
     * @return self
     */
    public function addValue(Win32LobApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Win32LobApp>
     */
