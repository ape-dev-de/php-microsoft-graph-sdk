...
/**
 * Collection response for SecurityHostComponentCollectionResponse
 */
class SecurityHostComponentCollectionResponseCollectionResponse
{
    /**
     * @var SecurityHostComponentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityHostComponentCollectionResponse ...$items Variable number of SecurityHostComponentCollectionResponse items
     * @return self
     */
    public function setValue(SecurityHostComponentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityHostComponentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityHostComponentCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityHostComponentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
