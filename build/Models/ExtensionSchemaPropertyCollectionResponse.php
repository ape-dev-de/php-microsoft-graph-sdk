...
/**
 * Collection response for ExtensionSchemaProperty
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExtensionSchemaPropertyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ExtensionSchemaProperty[] $items
     * @return self
     */
    public function setValue(array|ExtensionSchemaProperty $items, ExtensionSchemaProperty ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExtensionSchemaProperty> $value
     * @return self
     ...
     * 
     * @param ExtensionSchemaProperty $item
     * @return self
     */
    public function addValue(ExtensionSchemaProperty $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExtensionSchemaProperty|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExtensionSchemaProperty>
     */
