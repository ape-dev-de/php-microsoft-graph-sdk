...
/**
 * Collection response for ProcessContentResponse
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProcessContentResponseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProcessContentResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ProcessContentResponse[] $items
     * @return self
     */
    public function setValue(array|ProcessContentResponse $items, ProcessContentResponse ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProcessContentResponse> $value
     * @return self
     ...
     * 
     * @param ProcessContentResponse $item
     * @return self
     */
    public function addValue(ProcessContentResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProcessContentResponse>
     */
