 ...
 */
class ProcessContentResponseCollectionResponse
{
    /**
     ...
     * 
     * @param ProcessContentResponse ...$items Variable number of ProcessContentResponse items
     * @return self
     */
    public function setValue(ProcessContentResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
