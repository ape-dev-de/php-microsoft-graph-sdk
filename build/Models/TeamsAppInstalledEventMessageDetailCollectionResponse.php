...
/**
 * Collection response for TeamsAppInstalledEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamsAppInstalledEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamsAppInstalledEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamsAppInstalledEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|TeamsAppInstalledEventMessageDetail $items, TeamsAppInstalledEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamsAppInstalledEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param TeamsAppInstalledEventMessageDetail $item
     * @return self
     */
    public function addValue(TeamsAppInstalledEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TeamsAppInstalledEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TeamsAppInstalledEventMessageDetail>
     */
