 ...
 */
class TeamsAppInstalledEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param TeamsAppInstalledEventMessageDetail ...$items Variable number of TeamsAppInstalledEventMessageDetail items
     * @return self
     */
    public function setValue(TeamsAppInstalledEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
