...
class AudioConferencing
{
    ...
    public function getTollFreeNumbers(): ?string
    {
        return $this->tollFreeNumbers;
    }

    public function setTollFreeNumbers(?string $tollFreeNumbers): self
    {
    ...
    public function getTollNumbers(): ?string
    {
        return $this->tollNumbers;
    }

    public function setTollNumbers(?string $tollNumbers): self
    {
