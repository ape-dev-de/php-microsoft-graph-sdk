...
/**
 * Collection response for PartnersBillingUnbilledReconciliation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PartnersBillingUnbilledReconciliationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PartnersBillingUnbilledReconciliation[]
     */
    private array $value = [];
     ...
     * 
     * @param PartnersBillingUnbilledReconciliation[] $items
     * @return self
     */
    public function setValue(array|PartnersBillingUnbilledReconciliation $items, PartnersBillingUnbilledReconciliation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PartnersBillingUnbilledReconciliation> $value
     * @return self
     ...
     * 
     * @param PartnersBillingUnbilledReconciliation $item
     * @return self
     */
    public function addValue(PartnersBillingUnbilledReconciliation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PartnersBillingUnbilledReconciliation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PartnersBillingUnbilledReconciliation>
     */
