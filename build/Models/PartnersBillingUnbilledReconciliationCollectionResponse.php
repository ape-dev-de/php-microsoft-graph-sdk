...
/**
 * PartnersBillingUnbilledReconciliationCollectionResponse - Collection response
 */
class PartnersBillingUnbilledReconciliationCollectionResponse
{
    /**
     * @var array<int, PartnersBillingUnbilledReconciliation>
     */
    public array $value = [];
