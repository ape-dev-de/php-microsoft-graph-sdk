 ...
 */
class SecurityLabelsRootCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityLabelsRoot ...$items Variable number of SecurityLabelsRoot items
     * @return self
     */
    public function setValue(SecurityLabelsRoot ...$items): self
    {
        $this->value = $items;
        return $this;
    }
