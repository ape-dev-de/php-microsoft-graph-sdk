...
/**
 * Collection response for SecurityLabelsRoot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityLabelsRootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityLabelsRoot[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityLabelsRoot[] $items
     * @return self
     */
    public function setValue(array|SecurityLabelsRoot $items, SecurityLabelsRoot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityLabelsRoot> $value
     * @return self
     ...
     * 
     * @param SecurityLabelsRoot $item
     * @return self
     */
    public function addValue(SecurityLabelsRoot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityLabelsRoot>
     */
