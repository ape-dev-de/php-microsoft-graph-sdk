...
/**
 * Collection response for SearchAlterationOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SearchAlterationOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SearchAlterationOptions[]
     */
    private array $value = [];
     ...
     * 
     * @param SearchAlterationOptions[] $items
     * @return self
     */
    public function setValue(array|SearchAlterationOptions $items, SearchAlterationOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SearchAlterationOptions> $value
     * @return self
     ...
     * 
     * @param SearchAlterationOptions $item
     * @return self
     */
    public function addValue(SearchAlterationOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SearchAlterationOptions>
     */
