 ...
 */
class SearchAlterationOptionsCollectionResponse
{
    /**
     ...
     * 
     * @param SearchAlterationOptions ...$items Variable number of SearchAlterationOptions items
     * @return self
     */
    public function setValue(SearchAlterationOptions ...$items): self
    {
        $this->value = $items;
        return $this;
    }
