...
/**
 * Collection response for BuiltInIdentityProviderCollectionResponse
 */
class BuiltInIdentityProviderCollectionResponseCollectionResponse
{
    /**
     * @var BuiltInIdentityProviderCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BuiltInIdentityProviderCollectionResponse ...$items Variable number of BuiltInIdentityProviderCollectionResponse items
     * @return self
     */
    public function setValue(BuiltInIdentityProviderCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<BuiltInIdentityProviderCollectionResponse> $value
     * @return self
     ...
     * 
     * @param BuiltInIdentityProviderCollectionResponse $item
     * @return self
     */
    public function addValue(BuiltInIdentityProviderCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
