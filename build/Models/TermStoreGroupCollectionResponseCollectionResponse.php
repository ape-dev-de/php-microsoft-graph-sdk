...
/**
 * Collection response for TermStoreGroupCollectionResponse
 */
class TermStoreGroupCollectionResponseCollectionResponse
{
    /**
     * @var TermStoreGroupCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TermStoreGroupCollectionResponse ...$items Variable number of TermStoreGroupCollectionResponse items
     * @return self
     */
    public function setValue(TermStoreGroupCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TermStoreGroupCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TermStoreGroupCollectionResponse $item
     * @return self
     */
    public function addValue(TermStoreGroupCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
