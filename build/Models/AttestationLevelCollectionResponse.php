...
/**
 * Collection response for AttestationLevel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttestationLevelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AttestationLevel[] $items
     * @return self
     */
    public function setValue(array|AttestationLevel $items, AttestationLevel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttestationLevel> $value
     * @return self
     ...
     * 
     * @param AttestationLevel $item
     * @return self
     */
    public function addValue(AttestationLevel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AttestationLevel>
     */
