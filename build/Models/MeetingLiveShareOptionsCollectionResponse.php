...
/**
 * Collection response for MeetingLiveShareOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MeetingLiveShareOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MeetingLiveShareOptions[]
     */
    private array $value = [];
     ...
     * 
     * @param MeetingLiveShareOptions[] $items
     * @return self
     */
    public function setValue(array|MeetingLiveShareOptions $items, MeetingLiveShareOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MeetingLiveShareOptions> $value
     * @return self
     ...
     * 
     * @param MeetingLiveShareOptions $item
     * @return self
     */
    public function addValue(MeetingLiveShareOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MeetingLiveShareOptions>
     */
