...
/**
 * Collection response for SecurityHostPortComponentCollectionResponse
 */
class SecurityHostPortComponentCollectionResponseCollectionResponse
{
    /**
     * @var SecurityHostPortComponentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityHostPortComponentCollectionResponse[]
     */
     ...
     * 
     * @param SecurityHostPortComponentCollectionResponse ...$items Variable number of SecurityHostPortComponentCollectionResponse items
     * @return self
     */
    public function setValue(SecurityHostPortComponentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityHostPortComponentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityHostPortComponentCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityHostPortComponentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
