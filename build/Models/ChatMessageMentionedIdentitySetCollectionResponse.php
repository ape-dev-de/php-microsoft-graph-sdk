...
/**
 * Collection response for ChatMessageMentionedIdentitySet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatMessageMentionedIdentitySetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChatMessageMentionedIdentitySet[]
     */
    private array $value = [];
     ...
     * 
     * @param ChatMessageMentionedIdentitySet[] $items
     * @return self
     */
    public function setValue(array|ChatMessageMentionedIdentitySet $items, ChatMessageMentionedIdentitySet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChatMessageMentionedIdentitySet> $value
     * @return self
     ...
     * 
     * @param ChatMessageMentionedIdentitySet $item
     * @return self
     */
    public function addValue(ChatMessageMentionedIdentitySet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChatMessageMentionedIdentitySet>
     */
