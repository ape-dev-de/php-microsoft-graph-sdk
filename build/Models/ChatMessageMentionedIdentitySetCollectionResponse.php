 ...
 */
class ChatMessageMentionedIdentitySetCollectionResponse
{
    /**
     ...
     * 
     * @param ChatMessageMentionedIdentitySet ...$items Variable number of ChatMessageMentionedIdentitySet items
     * @return self
     */
    public function setValue(ChatMessageMentionedIdentitySet ...$items): self
    {
        $this->value = $items;
        return $this;
    }
