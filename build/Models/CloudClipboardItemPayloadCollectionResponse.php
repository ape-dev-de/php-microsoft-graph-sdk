...
/**
 * Collection response for CloudClipboardItemPayload
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudClipboardItemPayloadCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CloudClipboardItemPayload[] $items
     * @return self
     */
    public function setValue(array|CloudClipboardItemPayload $items, CloudClipboardItemPayload ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudClipboardItemPayload> $value
     * @return self
     ...
     * 
     * @param CloudClipboardItemPayload $item
     * @return self
     */
    public function addValue(CloudClipboardItemPayload $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CloudClipboardItemPayload|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CloudClipboardItemPayload>
     */
