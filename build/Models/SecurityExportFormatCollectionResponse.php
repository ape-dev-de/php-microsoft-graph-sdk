...
/**
 * Collection response for SecurityExportFormat
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityExportFormatCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityExportFormat[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityExportFormat[] $items
     * @return self
     */
    public function setValue(array|SecurityExportFormat $items, SecurityExportFormat ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityExportFormat> $value
     * @return self
     ...
     * 
     * @param SecurityExportFormat $item
     * @return self
     */
    public function addValue(SecurityExportFormat $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityExportFormat|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityExportFormat>
     */
