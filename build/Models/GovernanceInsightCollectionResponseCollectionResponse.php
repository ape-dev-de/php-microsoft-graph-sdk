...
/**
 * Collection response for GovernanceInsightCollectionResponse
 */
class GovernanceInsightCollectionResponseCollectionResponse
{
    /**
     * @var GovernanceInsightCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param GovernanceInsightCollectionResponse ...$items Variable number of GovernanceInsightCollectionResponse items
     * @return self
     */
    public function setValue(GovernanceInsightCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<GovernanceInsightCollectionResponse> $value
     * @return self
     ...
     * 
     * @param GovernanceInsightCollectionResponse $item
     * @return self
     */
    public function addValue(GovernanceInsightCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
