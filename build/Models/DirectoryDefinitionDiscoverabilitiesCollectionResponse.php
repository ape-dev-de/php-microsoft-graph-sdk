...
/**
 * DirectoryDefinitionDiscoverabilitiesCollectionResponse - Collection response
 */
class DirectoryDefinitionDiscoverabilitiesCollectionResponse
{
    /**
     * @var array<int, DirectoryDefinitionDiscoverabilities>
     */
    public array $value = [];
