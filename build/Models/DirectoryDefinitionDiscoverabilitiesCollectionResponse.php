...
/**
 * Collection response for DirectoryDefinitionDiscoverabilities
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DirectoryDefinitionDiscoverabilitiesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return DirectoryDefinitionDiscoverabilities[]
     */
     ...
     * 
     * @param DirectoryDefinitionDiscoverabilities[] $items
     * @return self
     */
    public function setValue(array|DirectoryDefinitionDiscoverabilities $items, DirectoryDefinitionDiscoverabilities ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DirectoryDefinitionDiscoverabilities> $value
     * @return self
     ...
     * 
     * @param DirectoryDefinitionDiscoverabilities $item
     * @return self
     */
    public function addValue(DirectoryDefinitionDiscoverabilities $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DirectoryDefinitionDiscoverabilities>
     */
