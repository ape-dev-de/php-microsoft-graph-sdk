...
/**
 * PrivilegedAccessGroupAssignmentTypeCollectionResponse - Collection response
 */
class PrivilegedAccessGroupAssignmentTypeCollectionResponse
{
    /**
     * @var array<int, PrivilegedAccessGroupAssignmentType>
     */
    public array $value = [];
