...
/**
 * Collection response for PrivilegedAccessGroupAssignmentType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrivilegedAccessGroupAssignmentTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrivilegedAccessGroupAssignmentType[]
     */
    private array $value = [];
     ...
     * 
     * @return PrivilegedAccessGroupAssignmentType[]
     */
     ...
     * 
     * @param PrivilegedAccessGroupAssignmentType[] $items
     * @return self
     */
    public function setValue(array|PrivilegedAccessGroupAssignmentType $items, PrivilegedAccessGroupAssignmentType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrivilegedAccessGroupAssignmentType> $value
     * @return self
     ...
     * 
     * @param PrivilegedAccessGroupAssignmentType $item
     * @return self
     */
    public function addValue(PrivilegedAccessGroupAssignmentType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrivilegedAccessGroupAssignmentType>
     */
