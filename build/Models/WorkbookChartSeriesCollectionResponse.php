...
/**
 * Collection response for WorkbookChartSeries
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookChartSeriesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WorkbookChartSeries[] $items
     * @return self
     */
    public function setValue(array|WorkbookChartSeries $items, WorkbookChartSeries ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookChartSeries> $value
     * @return self
     ...
     * 
     * @param WorkbookChartSeries $item
     * @return self
     */
    public function addValue(WorkbookChartSeries $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookChartSeries>
     */
