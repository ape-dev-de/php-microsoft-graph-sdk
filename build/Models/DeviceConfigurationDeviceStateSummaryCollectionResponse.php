 ...
 */
class DeviceConfigurationDeviceStateSummaryCollectionResponse
{
    /**
     ...
     * 
     * @param DeviceConfigurationDeviceStateSummary ...$items Variable number of DeviceConfigurationDeviceStateSummary items
     * @return self
     */
    public function setValue(DeviceConfigurationDeviceStateSummary ...$items): self
    {
        $this->value = $items;
        return $this;
    }
