...
/**
 * Collection response for DeviceConfigurationDeviceStateSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceConfigurationDeviceStateSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceConfigurationDeviceStateSummary[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceConfigurationDeviceStateSummary[] $items
     * @return self
     */
    public function setValue(array|DeviceConfigurationDeviceStateSummary $items, DeviceConfigurationDeviceStateSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceConfigurationDeviceStateSummary> $value
     * @return self
     ...
     * 
     * @param DeviceConfigurationDeviceStateSummary $item
     * @return self
     */
    public function addValue(DeviceConfigurationDeviceStateSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceConfigurationDeviceStateSummary>
     */
