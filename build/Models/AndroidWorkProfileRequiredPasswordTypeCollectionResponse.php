...
/**
 * Collection response for AndroidWorkProfileRequiredPasswordType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AndroidWorkProfileRequiredPasswordTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AndroidWorkProfileRequiredPasswordType[]
     */
    private array $value = [];
     ...
     * 
     * @return AndroidWorkProfileRequiredPasswordType[]
     */
     ...
     * 
     * @param AndroidWorkProfileRequiredPasswordType[] $items
     * @return self
     */
    public function setValue(array|AndroidWorkProfileRequiredPasswordType $items, AndroidWorkProfileRequiredPasswordType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AndroidWorkProfileRequiredPasswordType> $value
     * @return self
     ...
     * 
     * @param AndroidWorkProfileRequiredPasswordType $item
     * @return self
     */
    public function addValue(AndroidWorkProfileRequiredPasswordType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AndroidWorkProfileRequiredPasswordType>
     */
