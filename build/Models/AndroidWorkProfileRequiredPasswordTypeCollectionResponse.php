...
/**
 * AndroidWorkProfileRequiredPasswordTypeCollectionResponse - Collection response
 */
class AndroidWorkProfileRequiredPasswordTypeCollectionResponse
{
    /**
     * @var array<int, AndroidWorkProfileRequiredPasswordType>
     */
    public array $value = [];
