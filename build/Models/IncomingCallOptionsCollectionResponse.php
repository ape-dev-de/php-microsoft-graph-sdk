...
/**
 * Collection response for IncomingCallOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IncomingCallOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IncomingCallOptions[] $items
     * @return self
     */
    public function setValue(array|IncomingCallOptions $items, IncomingCallOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IncomingCallOptions> $value
     * @return self
     ...
     * 
     * @param IncomingCallOptions $item
     * @return self
     */
    public function addValue(IncomingCallOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IncomingCallOptions>
     */
