...
/**
 * Collection response for UpdateWindowsDeviceAccountActionParameter
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UpdateWindowsDeviceAccountActionParameterCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UpdateWindowsDeviceAccountActionParameter[]
     */
    private array $value = [];
     ...
     * 
     * @param UpdateWindowsDeviceAccountActionParameter[] $items
     * @return self
     */
    public function setValue(array|UpdateWindowsDeviceAccountActionParameter $items, UpdateWindowsDeviceAccountActionParameter ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UpdateWindowsDeviceAccountActionParameter> $value
     * @return self
     ...
     * 
     * @param UpdateWindowsDeviceAccountActionParameter $item
     * @return self
     */
    public function addValue(UpdateWindowsDeviceAccountActionParameter $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UpdateWindowsDeviceAccountActionParameter>
     */
