...
/**
 * Collection response for DeviceCategoryCollectionResponse
 */
class DeviceCategoryCollectionResponseCollectionResponse
{
    /**
     * @var DeviceCategoryCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceCategoryCollectionResponse ...$items Variable number of DeviceCategoryCollectionResponse items
     * @return self
     */
    public function setValue(DeviceCategoryCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeviceCategoryCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeviceCategoryCollectionResponse $item
     * @return self
     */
    public function addValue(DeviceCategoryCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
