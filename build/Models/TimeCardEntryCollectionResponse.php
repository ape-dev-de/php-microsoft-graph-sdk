 ...
 */
class TimeCardEntryCollectionResponse
{
    /**
     * @var TimeCardEntry[]
     */
     ...
     * 
     * @param TimeCardEntry ...$items Variable number of TimeCardEntry items
     * @return self
     */
    public function setValue(TimeCardEntry ...$items): self
    {
        $this->value = $items;
        return $this;
    }
