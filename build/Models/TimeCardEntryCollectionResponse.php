...
/**
 * Collection response for TimeCardEntry
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TimeCardEntryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TimeCardEntry[]
     */
     ...
     * 
     * @param TimeCardEntry[] $items
     * @return self
     */
    public function setValue(array|TimeCardEntry $items, TimeCardEntry ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TimeCardEntry> $value
     * @return self
     ...
     * 
     * @param TimeCardEntry $item
     * @return self
     */
    public function addValue(TimeCardEntry $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TimeCardEntry>
     */
