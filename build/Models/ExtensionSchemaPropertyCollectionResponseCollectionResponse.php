...
/**
 * Collection response for ExtensionSchemaPropertyCollectionResponse
 */
class ExtensionSchemaPropertyCollectionResponseCollectionResponse
{
    /**
     * @var ExtensionSchemaPropertyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ExtensionSchemaPropertyCollectionResponse ...$items Variable number of ExtensionSchemaPropertyCollectionResponse items
     * @return self
     */
    public function setValue(ExtensionSchemaPropertyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ExtensionSchemaPropertyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ExtensionSchemaPropertyCollectionResponse $item
     * @return self
     */
    public function addValue(ExtensionSchemaPropertyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
