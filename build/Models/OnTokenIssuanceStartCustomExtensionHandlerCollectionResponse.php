...
/**
 * Collection response for OnTokenIssuanceStartCustomExtensionHandler
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnTokenIssuanceStartCustomExtensionHandlerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnTokenIssuanceStartCustomExtensionHandler[]
     */
    private array $value = [];
     ...
     * 
     * @param OnTokenIssuanceStartCustomExtensionHandler[] $items
     * @return self
     */
    public function setValue(array|OnTokenIssuanceStartCustomExtensionHandler $items, OnTokenIssuanceStartCustomExtensionHandler ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnTokenIssuanceStartCustomExtensionHandler> $value
     * @return self
     ...
     * 
     * @param OnTokenIssuanceStartCustomExtensionHandler $item
     * @return self
     */
    public function addValue(OnTokenIssuanceStartCustomExtensionHandler $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OnTokenIssuanceStartCustomExtensionHandler|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OnTokenIssuanceStartCustomExtensionHandler>
     */
