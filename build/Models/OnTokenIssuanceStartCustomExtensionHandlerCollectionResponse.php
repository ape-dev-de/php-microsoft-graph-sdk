 ...
 */
class OnTokenIssuanceStartCustomExtensionHandlerCollectionResponse
{
    /**
     ...
     * 
     * @param OnTokenIssuanceStartCustomExtensionHandler ...$items Variable number of OnTokenIssuanceStartCustomExtensionHandler items
     * @return self
     */
    public function setValue(OnTokenIssuanceStartCustomExtensionHandler ...$items): self
    {
        $this->value = $items;
        return $this;
    }
