...
/**
 * Collection response for TeamworkCallEventType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamworkCallEventTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamworkCallEventType[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamworkCallEventType[] $items
     * @return self
     */
    public function setValue(array|TeamworkCallEventType $items, TeamworkCallEventType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamworkCallEventType> $value
     * @return self
     ...
     * 
     * @param TeamworkCallEventType $item
     * @return self
     */
    public function addValue(TeamworkCallEventType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamworkCallEventType>
     */
