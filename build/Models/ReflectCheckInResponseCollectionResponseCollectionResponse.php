...
/**
 * Collection response for ReflectCheckInResponseCollectionResponse
 */
class ReflectCheckInResponseCollectionResponseCollectionResponse
{
    /**
     * @var ReflectCheckInResponseCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ReflectCheckInResponseCollectionResponse ...$items Variable number of ReflectCheckInResponseCollectionResponse items
     * @return self
     */
    public function setValue(ReflectCheckInResponseCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ReflectCheckInResponseCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ReflectCheckInResponseCollectionResponse $item
     * @return self
     */
    public function addValue(ReflectCheckInResponseCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
