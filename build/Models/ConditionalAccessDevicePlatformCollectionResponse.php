...
/**
 * Collection response for ConditionalAccessDevicePlatform
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessDevicePlatformCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return ConditionalAccessDevicePlatform[]
     */
     ...
     * 
     * @param ConditionalAccessDevicePlatform[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessDevicePlatform $items, ConditionalAccessDevicePlatform ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessDevicePlatform> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessDevicePlatform $item
     * @return self
     */
    public function addValue(ConditionalAccessDevicePlatform $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessDevicePlatform>
     */
