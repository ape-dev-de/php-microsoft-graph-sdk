...
/**
 * ConditionalAccessDevicePlatformCollectionResponse - Collection response
 */
class ConditionalAccessDevicePlatformCollectionResponse
{
    /**
     * @var array<int, ConditionalAccessDevicePlatform>
     */
    public array $value = [];
