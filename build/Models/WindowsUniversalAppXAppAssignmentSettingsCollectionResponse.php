 ...
 */
class WindowsUniversalAppXAppAssignmentSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param WindowsUniversalAppXAppAssignmentSettings ...$items Variable number of WindowsUniversalAppXAppAssignmentSettings items
     * @return self
     */
    public function setValue(WindowsUniversalAppXAppAssignmentSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
