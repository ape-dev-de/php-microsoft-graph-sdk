...
/**
 * Collection response for WindowsUniversalAppXAppAssignmentSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsUniversalAppXAppAssignmentSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsUniversalAppXAppAssignmentSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsUniversalAppXAppAssignmentSettings[] $items
     * @return self
     */
    public function setValue(array|WindowsUniversalAppXAppAssignmentSettings $items, WindowsUniversalAppXAppAssignmentSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsUniversalAppXAppAssignmentSettings> $value
     * @return self
     ...
     * 
     * @param WindowsUniversalAppXAppAssignmentSettings $item
     * @return self
     */
    public function addValue(WindowsUniversalAppXAppAssignmentSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WindowsUniversalAppXAppAssignmentSettings|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WindowsUniversalAppXAppAssignmentSettings>
     */
