 ...
 */
class IosMobileAppIdentifierCollectionResponse
{
    /**
     ...
     * 
     * @param IosMobileAppIdentifier ...$items Variable number of IosMobileAppIdentifier items
     * @return self
     */
    public function setValue(IosMobileAppIdentifier ...$items): self
    {
        $this->value = $items;
        return $this;
    }
