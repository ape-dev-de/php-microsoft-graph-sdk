...
/**
 * Collection response for IosMobileAppIdentifier
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosMobileAppIdentifierCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IosMobileAppIdentifier[]
     */
    private array $value = [];
     ...
     * 
     * @param IosMobileAppIdentifier[] $items
     * @return self
     */
    public function setValue(array|IosMobileAppIdentifier $items, IosMobileAppIdentifier ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosMobileAppIdentifier> $value
     * @return self
     ...
     * 
     * @param IosMobileAppIdentifier $item
     * @return self
     */
    public function addValue(IosMobileAppIdentifier $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IosMobileAppIdentifier|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IosMobileAppIdentifier>
     */
