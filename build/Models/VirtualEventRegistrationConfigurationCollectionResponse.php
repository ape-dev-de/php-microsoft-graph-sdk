 ...
 */
class VirtualEventRegistrationConfigurationCollectionResponse
{
    /**
     ...
     * 
     * @param VirtualEventRegistrationConfiguration ...$items Variable number of VirtualEventRegistrationConfiguration items
     * @return self
     */
    public function setValue(VirtualEventRegistrationConfiguration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
