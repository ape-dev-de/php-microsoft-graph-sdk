...
/**
 * Collection response for VirtualEventRegistrationConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualEventRegistrationConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VirtualEventRegistrationConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param VirtualEventRegistrationConfiguration[] $items
     * @return self
     */
    public function setValue(array|VirtualEventRegistrationConfiguration $items, VirtualEventRegistrationConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualEventRegistrationConfiguration> $value
     * @return self
     ...
     * 
     * @param VirtualEventRegistrationConfiguration $item
     * @return self
     */
    public function addValue(VirtualEventRegistrationConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VirtualEventRegistrationConfiguration>
     */
