 ...
 */
class SecurityFilePlanDescriptorBaseCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityFilePlanDescriptorBase ...$items Variable number of SecurityFilePlanDescriptorBase items
     * @return self
     */
    public function setValue(SecurityFilePlanDescriptorBase ...$items): self
    {
        $this->value = $items;
        return $this;
    }
