...
/**
 * Collection response for SecurityFilePlanDescriptorBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityFilePlanDescriptorBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityFilePlanDescriptorBase[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityFilePlanDescriptorBase[]
     */
     ...
     * 
     * @param SecurityFilePlanDescriptorBase[] $items
     * @return self
     */
    public function setValue(array|SecurityFilePlanDescriptorBase $items, SecurityFilePlanDescriptorBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityFilePlanDescriptorBase> $value
     * @return self
     ...
     * 
     * @param SecurityFilePlanDescriptorBase $item
     * @return self
     */
    public function addValue(SecurityFilePlanDescriptorBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityFilePlanDescriptorBase|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityFilePlanDescriptorBase>
     */
