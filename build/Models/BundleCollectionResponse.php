...
/**
 * Collection response for Bundle
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BundleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Bundle[]
     */
     ...
     * @return self
     */
    public function setValue(array|Bundle $items, Bundle ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Bundle $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Bundle>
     */
