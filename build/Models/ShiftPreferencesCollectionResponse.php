 ...
 */
class ShiftPreferencesCollectionResponse
{
    /**
     ...
     * 
     * @param ShiftPreferences ...$items Variable number of ShiftPreferences items
     * @return self
     */
    public function setValue(ShiftPreferences ...$items): self
    {
        $this->value = $items;
        return $this;
    }
