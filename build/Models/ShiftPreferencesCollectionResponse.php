...
/**
 * Collection response for ShiftPreferences
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ShiftPreferencesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ShiftPreferences[] $items
     * @return self
     */
    public function setValue(array|ShiftPreferences $items, ShiftPreferences ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ShiftPreferences> $value
     * @return self
     ...
     * 
     * @param ShiftPreferences $item
     * @return self
     */
    public function addValue(ShiftPreferences $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ShiftPreferences>
     */
