...
/**
 * Collection response for EducationGradingCategoryCollectionResponse
 */
class EducationGradingCategoryCollectionResponseCollectionResponse
{
    /**
     * @var EducationGradingCategoryCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationGradingCategoryCollectionResponse ...$items Variable number of EducationGradingCategoryCollectionResponse items
     * @return self
     */
    public function setValue(EducationGradingCategoryCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EducationGradingCategoryCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EducationGradingCategoryCollectionResponse $item
     * @return self
     */
    public function addValue(EducationGradingCategoryCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
