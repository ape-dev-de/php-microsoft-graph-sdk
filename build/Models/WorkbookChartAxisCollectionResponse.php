 ...
 */
class WorkbookChartAxisCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookChartAxis ...$items Variable number of WorkbookChartAxis items
     * @return self
     */
    public function setValue(WorkbookChartAxis ...$items): self
    {
        $this->value = $items;
        return $this;
    }
