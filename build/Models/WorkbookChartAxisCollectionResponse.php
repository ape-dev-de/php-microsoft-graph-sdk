...
/**
 * Collection response for WorkbookChartAxis
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookChartAxisCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookChartAxis[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookChartAxis[] $items
     * @return self
     */
    public function setValue(array|WorkbookChartAxis $items, WorkbookChartAxis ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookChartAxis> $value
     * @return self
     ...
     * 
     * @param WorkbookChartAxis $item
     * @return self
     */
    public function addValue(WorkbookChartAxis $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookChartAxis>
     */
