...
/**
 * M365AppsInstallationOptionsCollectionResponse - Collection response
 */
class M365AppsInstallationOptionsCollectionResponse
{
    /**
     * @var array<int, M365AppsInstallationOptions>
     */
    public array $value = [];
