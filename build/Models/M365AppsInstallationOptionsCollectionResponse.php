...
/**
 * Collection response for M365AppsInstallationOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class M365AppsInstallationOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var M365AppsInstallationOptions[]
     */
    private array $value = [];
     ...
     * 
     * @param M365AppsInstallationOptions[] $items
     * @return self
     */
    public function setValue(array|M365AppsInstallationOptions $items, M365AppsInstallationOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<M365AppsInstallationOptions> $value
     * @return self
     ...
     * 
     * @param M365AppsInstallationOptions $item
     * @return self
     */
    public function addValue(M365AppsInstallationOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, M365AppsInstallationOptions>
     */
