 ...
 */
class SecurityFilePlanDescriptorCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityFilePlanDescriptor ...$items Variable number of SecurityFilePlanDescriptor items
     * @return self
     */
    public function setValue(SecurityFilePlanDescriptor ...$items): self
    {
        $this->value = $items;
        return $this;
    }
