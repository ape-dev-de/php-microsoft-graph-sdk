...
/**
 * Collection response for SecurityFilePlanDescriptor
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityFilePlanDescriptorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityFilePlanDescriptor[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityFilePlanDescriptor[] $items
     * @return self
     */
    public function setValue(array|SecurityFilePlanDescriptor $items, SecurityFilePlanDescriptor ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityFilePlanDescriptor> $value
     * @return self
     ...
     * 
     * @param SecurityFilePlanDescriptor $item
     * @return self
     */
    public function addValue(SecurityFilePlanDescriptor $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityFilePlanDescriptor|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityFilePlanDescriptor>
     */
