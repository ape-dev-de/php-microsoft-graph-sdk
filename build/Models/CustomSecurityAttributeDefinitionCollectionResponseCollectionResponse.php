...
/**
 * Collection response for CustomSecurityAttributeDefinitionCollectionResponse
 */
class CustomSecurityAttributeDefinitionCollectionResponseCollectionResponse
{
    /**
     * @var CustomSecurityAttributeDefinitionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CustomSecurityAttributeDefinitionCollectionResponse ...$items Variable number of CustomSecurityAttributeDefinitionCollectionResponse items
     * @return self
     */
    public function setValue(CustomSecurityAttributeDefinitionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CustomSecurityAttributeDefinitionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CustomSecurityAttributeDefinitionCollectionResponse $item
     * @return self
     */
    public function addValue(CustomSecurityAttributeDefinitionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
