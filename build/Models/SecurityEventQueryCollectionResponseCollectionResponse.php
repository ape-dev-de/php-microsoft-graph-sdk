...
/**
 * Collection response for SecurityEventQueryCollectionResponse
 */
class SecurityEventQueryCollectionResponseCollectionResponse
{
    /**
     * @var SecurityEventQueryCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityEventQueryCollectionResponse[]
     */
     ...
     * 
     * @param SecurityEventQueryCollectionResponse ...$items Variable number of SecurityEventQueryCollectionResponse items
     * @return self
     */
    public function setValue(SecurityEventQueryCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityEventQueryCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityEventQueryCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityEventQueryCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
