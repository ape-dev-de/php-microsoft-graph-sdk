...
/**
 * Collection response for SearchAnswerVariantCollectionResponse
 */
class SearchAnswerVariantCollectionResponseCollectionResponse
{
    /**
     * @var SearchAnswerVariantCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return SearchAnswerVariantCollectionResponse[]
     */
     ...
     * 
     * @param SearchAnswerVariantCollectionResponse ...$items Variable number of SearchAnswerVariantCollectionResponse items
     * @return self
     */
    public function setValue(SearchAnswerVariantCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SearchAnswerVariantCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SearchAnswerVariantCollectionResponse $item
     * @return self
     */
    public function addValue(SearchAnswerVariantCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
