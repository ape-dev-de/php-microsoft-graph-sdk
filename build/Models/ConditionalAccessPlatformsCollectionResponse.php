...
/**
 * Collection response for ConditionalAccessPlatforms
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessPlatformsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessPlatforms[]
     */
    private array $value = [];
     ...
     * 
     * @param ConditionalAccessPlatforms[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessPlatforms $items, ConditionalAccessPlatforms ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessPlatforms> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessPlatforms $item
     * @return self
     */
    public function addValue(ConditionalAccessPlatforms $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessPlatforms>
     */
