 ...
 */
class ConditionalAccessPlatformsCollectionResponse
{
    /**
     ...
     * 
     * @param ConditionalAccessPlatforms ...$items Variable number of ConditionalAccessPlatforms items
     * @return self
     */
    public function setValue(ConditionalAccessPlatforms ...$items): self
    {
        $this->value = $items;
        return $this;
    }
