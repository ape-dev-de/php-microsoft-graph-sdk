...
/**
 * DeviceManagementExchangeAccessStateCollectionResponse - Collection response
 */
class DeviceManagementExchangeAccessStateCollectionResponse
{
    /**
     * @var array<int, DeviceManagementExchangeAccessState>
     */
    public array $value = [];
