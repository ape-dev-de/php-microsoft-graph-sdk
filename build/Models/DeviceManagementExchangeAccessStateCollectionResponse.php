...
/**
 * Collection response for DeviceManagementExchangeAccessState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceManagementExchangeAccessStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return DeviceManagementExchangeAccessState[]
     */
     ...
     * 
     * @param DeviceManagementExchangeAccessState[] $items
     * @return self
     */
    public function setValue(array|DeviceManagementExchangeAccessState $items, DeviceManagementExchangeAccessState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceManagementExchangeAccessState> $value
     * @return self
     ...
     * 
     * @param DeviceManagementExchangeAccessState $item
     * @return self
     */
    public function addValue(DeviceManagementExchangeAccessState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceManagementExchangeAccessState>
     */
