...
class MultiTenantOrganizationJoinRequestTransitionDetailsCollectionResponse
{
     ...
     * 
     * @param MultiTenantOrganizationJoinRequestTransitionDetails ...$items Variable number of MultiTenantOrganizationJoinRequestTransitionDetails items
     * @return self
     */
    public function setValue(MultiTenantOrganizationJoinRequestTransitionDetails ...$items): self
    {
        $this->value = $items;
        return $this;
    }
