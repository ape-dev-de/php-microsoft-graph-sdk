...
/**
 * Collection response for TeamsTemplate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamsTemplateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamsTemplate[]
     */
     ...
     * 
     * @param TeamsTemplate[] $items
     * @return self
     */
    public function setValue(array|TeamsTemplate $items, TeamsTemplate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamsTemplate> $value
     * @return self
     ...
     * 
     * @param TeamsTemplate $item
     * @return self
     */
    public function addValue(TeamsTemplate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamsTemplate>
     */
