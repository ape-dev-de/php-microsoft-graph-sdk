...
/**
 * Collection response for ProtectionPolicyStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProtectionPolicyStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProtectionPolicyStatus[]
     */
    private array $value = [];
     ...
     * 
     * @param ProtectionPolicyStatus[] $items
     * @return self
     */
    public function setValue(array|ProtectionPolicyStatus $items, ProtectionPolicyStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProtectionPolicyStatus> $value
     * @return self
     ...
     * 
     * @param ProtectionPolicyStatus $item
     * @return self
     */
    public function addValue(ProtectionPolicyStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProtectionPolicyStatus>
     */
