...
/**
 * Collection response for MacOSLobAppCollectionResponse
 */
class MacOSLobAppCollectionResponseCollectionResponse
{
    /**
     * @var MacOSLobAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MacOSLobAppCollectionResponse ...$items Variable number of MacOSLobAppCollectionResponse items
     * @return self
     */
    public function setValue(MacOSLobAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MacOSLobAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MacOSLobAppCollectionResponse $item
     * @return self
     */
    public function addValue(MacOSLobAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
