...
/**
 * Collection response for SecuritySubdomain
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecuritySubdomainCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecuritySubdomain[] $items
     * @return self
     */
    public function setValue(array|SecuritySubdomain $items, SecuritySubdomain ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecuritySubdomain> $value
     * @return self
     ...
     * 
     * @param SecuritySubdomain $item
     * @return self
     */
    public function addValue(SecuritySubdomain $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecuritySubdomain>
     */
