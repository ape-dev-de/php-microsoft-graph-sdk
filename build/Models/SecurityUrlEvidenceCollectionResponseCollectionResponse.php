...
/**
 * Collection response for SecurityUrlEvidenceCollectionResponse
 */
class SecurityUrlEvidenceCollectionResponseCollectionResponse
{
    /**
     * @var SecurityUrlEvidenceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityUrlEvidenceCollectionResponse[]
     */
     ...
     * 
     * @param SecurityUrlEvidenceCollectionResponse ...$items Variable number of SecurityUrlEvidenceCollectionResponse items
     * @return self
     */
    public function setValue(SecurityUrlEvidenceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityUrlEvidenceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityUrlEvidenceCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityUrlEvidenceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
