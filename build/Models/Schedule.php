...
class Schedule
{
     ...
     */
    private ?string $workforceIntegrationIds;
    ...
    public function getWorkforceIntegrationIds(): ?string
    {
        return $this->workforceIntegrationIds;
    }

    public function setWorkforceIntegrationIds(?string $workforceIntegrationIds): self
    {
    ...
    public function getTimesOff(): ?string
    {
        return $this->timesOff;
    }

    public function setTimesOff(?string $timesOff): self
    {
