...
/**
 * Collection response for WebsiteCollectionResponse
 */
class WebsiteCollectionResponseCollectionResponse
{
    /**
     * @var WebsiteCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WebsiteCollectionResponse ...$items Variable number of WebsiteCollectionResponse items
     * @return self
     */
    public function setValue(WebsiteCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WebsiteCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WebsiteCollectionResponse $item
     * @return self
     */
    public function addValue(WebsiteCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
