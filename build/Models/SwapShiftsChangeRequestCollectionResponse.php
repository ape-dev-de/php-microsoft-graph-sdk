...
/**
 * Collection response for SwapShiftsChangeRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SwapShiftsChangeRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SwapShiftsChangeRequest[] $items
     * @return self
     */
    public function setValue(array|SwapShiftsChangeRequest $items, SwapShiftsChangeRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SwapShiftsChangeRequest> $value
     * @return self
     ...
     * 
     * @param SwapShiftsChangeRequest $item
     * @return self
     */
    public function addValue(SwapShiftsChangeRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SwapShiftsChangeRequest>
     */
