...
/**
 * Collection response for AppsInstallationOptionsForWindows
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppsInstallationOptionsForWindowsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AppsInstallationOptionsForWindows[]
     */
    private array $value = [];
     ...
     * 
     * @param AppsInstallationOptionsForWindows[] $items
     * @return self
     */
    public function setValue(array|AppsInstallationOptionsForWindows $items, AppsInstallationOptionsForWindows ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppsInstallationOptionsForWindows> $value
     * @return self
     ...
     * 
     * @param AppsInstallationOptionsForWindows $item
     * @return self
     */
    public function addValue(AppsInstallationOptionsForWindows $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AppsInstallationOptionsForWindows>
     */
