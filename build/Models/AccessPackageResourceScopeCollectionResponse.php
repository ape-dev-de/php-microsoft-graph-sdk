...
/**
 * Collection response for AccessPackageResourceScope
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageResourceScopeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessPackageResourceScope[] $items
     * @return self
     */
    public function setValue(array|AccessPackageResourceScope $items, AccessPackageResourceScope ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageResourceScope> $value
     * @return self
     ...
     * 
     * @param AccessPackageResourceScope $item
     * @return self
     */
    public function addValue(AccessPackageResourceScope $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageResourceScope>
     */
