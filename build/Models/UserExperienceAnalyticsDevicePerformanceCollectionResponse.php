...
/**
 * Collection response for UserExperienceAnalyticsDevicePerformance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsDevicePerformanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsDevicePerformance[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsDevicePerformance $items, UserExperienceAnalyticsDevicePerformance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsDevicePerformance> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsDevicePerformance $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsDevicePerformance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsDevicePerformance>
     */
