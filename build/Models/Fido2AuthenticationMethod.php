...
class Fido2AuthenticationMethod
{
     ...
     */
    private ?string $attestationCertificates;
    ...
    public function getAttestationCertificates(): ?string
    {
        return $this->attestationCertificates;
    }

    public function setAttestationCertificates(?string $attestationCertificates): self
    {
