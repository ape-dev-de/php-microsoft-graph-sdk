...
/**
 * Collection response for Domain
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DomainCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Domain[]
     */
     ...
     * @return self
     */
    public function setValue(array|Domain $items, Domain ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Domain $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Domain>
     */
