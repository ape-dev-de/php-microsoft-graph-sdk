 ...
 */
class CopilotAdminSettingCollectionResponse
{
    /**
     ...
     * 
     * @param CopilotAdminSetting ...$items Variable number of CopilotAdminSetting items
     * @return self
     */
    public function setValue(CopilotAdminSetting ...$items): self
    {
        $this->value = $items;
        return $this;
    }
