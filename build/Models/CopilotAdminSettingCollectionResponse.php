...
/**
 * Collection response for CopilotAdminSetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CopilotAdminSettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CopilotAdminSetting[]
     */
    private array $value = [];
     ...
     * 
     * @param CopilotAdminSetting[] $items
     * @return self
     */
    public function setValue(array|CopilotAdminSetting $items, CopilotAdminSetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CopilotAdminSetting> $value
     * @return self
     ...
     * 
     * @param CopilotAdminSetting $item
     * @return self
     */
    public function addValue(CopilotAdminSetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CopilotAdminSetting>
     */
