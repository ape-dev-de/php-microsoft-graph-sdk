...
/**
 * Collection response for MacOSMinimumOperatingSystem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MacOSMinimumOperatingSystemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MacOSMinimumOperatingSystem[]
     */
    private array $value = [];
     ...
     * 
     * @param MacOSMinimumOperatingSystem[] $items
     * @return self
     */
    public function setValue(array|MacOSMinimumOperatingSystem $items, MacOSMinimumOperatingSystem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MacOSMinimumOperatingSystem> $value
     * @return self
     ...
     * 
     * @param MacOSMinimumOperatingSystem $item
     * @return self
     */
    public function addValue(MacOSMinimumOperatingSystem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MacOSMinimumOperatingSystem>
     */
