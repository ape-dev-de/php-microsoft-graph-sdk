 ...
 */
class MacOSMinimumOperatingSystemCollectionResponse
{
    /**
     ...
     * 
     * @param MacOSMinimumOperatingSystem ...$items Variable number of MacOSMinimumOperatingSystem items
     * @return self
     */
    public function setValue(MacOSMinimumOperatingSystem ...$items): self
    {
        $this->value = $items;
        return $this;
    }
