...
/**
 * Collection response for IdentityGovernanceRunSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceRunSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceRunSummary[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceRunSummary[]
     */
     ...
     * 
     * @param IdentityGovernanceRunSummary[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceRunSummary $items, IdentityGovernanceRunSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceRunSummary> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceRunSummary $item
     * @return self
     */
    public function addValue(IdentityGovernanceRunSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceRunSummary|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceRunSummary>
     */
