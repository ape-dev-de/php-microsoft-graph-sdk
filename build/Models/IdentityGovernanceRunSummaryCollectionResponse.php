 ...
 */
class IdentityGovernanceRunSummaryCollectionResponse
{
    /**
     ...
     * 
     * @param IdentityGovernanceRunSummary ...$items Variable number of IdentityGovernanceRunSummary items
     * @return self
     */
    public function setValue(IdentityGovernanceRunSummary ...$items): self
    {
        $this->value = $items;
        return $this;
    }
