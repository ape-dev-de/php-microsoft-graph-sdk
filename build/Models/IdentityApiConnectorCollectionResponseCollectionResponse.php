...
/**
 * Collection response for IdentityApiConnectorCollectionResponse
 */
class IdentityApiConnectorCollectionResponseCollectionResponse
{
    /**
     * @var IdentityApiConnectorCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityApiConnectorCollectionResponse ...$items Variable number of IdentityApiConnectorCollectionResponse items
     * @return self
     */
    public function setValue(IdentityApiConnectorCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IdentityApiConnectorCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IdentityApiConnectorCollectionResponse $item
     * @return self
     */
    public function addValue(IdentityApiConnectorCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
