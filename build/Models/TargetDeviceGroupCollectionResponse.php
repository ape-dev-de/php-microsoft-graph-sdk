...
/**
 * Collection response for TargetDeviceGroup
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TargetDeviceGroupCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TargetDeviceGroup[] $items
     * @return self
     */
    public function setValue(array|TargetDeviceGroup $items, TargetDeviceGroup ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TargetDeviceGroup> $value
     * @return self
     ...
     * 
     * @param TargetDeviceGroup $item
     * @return self
     */
    public function addValue(TargetDeviceGroup $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TargetDeviceGroup>
     */
