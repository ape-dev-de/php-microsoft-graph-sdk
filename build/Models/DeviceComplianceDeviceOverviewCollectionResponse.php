...
/**
 * Collection response for DeviceComplianceDeviceOverview
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceComplianceDeviceOverviewCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceComplianceDeviceOverview[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceComplianceDeviceOverview[] $items
     * @return self
     */
    public function setValue(array|DeviceComplianceDeviceOverview $items, DeviceComplianceDeviceOverview ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceComplianceDeviceOverview> $value
     * @return self
     ...
     * 
     * @param DeviceComplianceDeviceOverview $item
     * @return self
     */
    public function addValue(DeviceComplianceDeviceOverview $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceComplianceDeviceOverview>
     */
