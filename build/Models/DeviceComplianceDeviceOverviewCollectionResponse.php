 ...
 */
class DeviceComplianceDeviceOverviewCollectionResponse
{
    /**
     ...
     * 
     * @param DeviceComplianceDeviceOverview ...$items Variable number of DeviceComplianceDeviceOverview items
     * @return self
     */
    public function setValue(DeviceComplianceDeviceOverview ...$items): self
    {
        $this->value = $items;
        return $this;
    }
