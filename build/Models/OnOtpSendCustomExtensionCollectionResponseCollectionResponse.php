...
/**
 * Collection response for OnOtpSendCustomExtensionCollectionResponse
 */
class OnOtpSendCustomExtensionCollectionResponseCollectionResponse
{
    /**
     * @var OnOtpSendCustomExtensionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return OnOtpSendCustomExtensionCollectionResponse[]
     */
     ...
     * 
     * @param OnOtpSendCustomExtensionCollectionResponse ...$items Variable number of OnOtpSendCustomExtensionCollectionResponse items
     * @return self
     */
    public function setValue(OnOtpSendCustomExtensionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<OnOtpSendCustomExtensionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param OnOtpSendCustomExtensionCollectionResponse $item
     * @return self
     */
    public function addValue(OnOtpSendCustomExtensionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
