...
/**
 * Collection response for MobileAppCategory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MobileAppCategoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MobileAppCategory[] $items
     * @return self
     */
    public function setValue(array|MobileAppCategory $items, MobileAppCategory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MobileAppCategory> $value
     * @return self
     ...
     * 
     * @param MobileAppCategory $item
     * @return self
     */
    public function addValue(MobileAppCategory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MobileAppCategory>
     */
