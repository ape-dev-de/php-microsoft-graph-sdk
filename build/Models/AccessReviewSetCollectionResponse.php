...
/**
 * Collection response for AccessReviewSet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewSetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessReviewSet[]
     */
     ...
     * 
     * @param AccessReviewSet[] $items
     * @return self
     */
    public function setValue(array|AccessReviewSet $items, AccessReviewSet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewSet> $value
     * @return self
     ...
     * 
     * @param AccessReviewSet $item
     * @return self
     */
    public function addValue(AccessReviewSet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewSet>
     */
