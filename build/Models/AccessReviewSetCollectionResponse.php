 ...
 */
class AccessReviewSetCollectionResponse
{
    /**
     * @var AccessReviewSet[]
     */
     ...
     * 
     * @param AccessReviewSet ...$items Variable number of AccessReviewSet items
     * @return self
     */
    public function setValue(AccessReviewSet ...$items): self
    {
        $this->value = $items;
        return $this;
    }
