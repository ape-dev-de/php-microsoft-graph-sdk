...
/**
 * Collection response for AccessPackageTextInputQuestion
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageTextInputQuestionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageTextInputQuestion[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageTextInputQuestion[] $items
     * @return self
     */
    public function setValue(array|AccessPackageTextInputQuestion $items, AccessPackageTextInputQuestion ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageTextInputQuestion> $value
     * @return self
     ...
     * 
     * @param AccessPackageTextInputQuestion $item
     * @return self
     */
    public function addValue(AccessPackageTextInputQuestion $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessPackageTextInputQuestion|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageTextInputQuestion>
     */
