...
/**
 * Collection response for WorkbookChartAxisTitle
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookChartAxisTitleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookChartAxisTitle[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookChartAxisTitle[] $items
     * @return self
     */
    public function setValue(array|WorkbookChartAxisTitle $items, WorkbookChartAxisTitle ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookChartAxisTitle> $value
     * @return self
     ...
     * 
     * @param WorkbookChartAxisTitle $item
     * @return self
     */
    public function addValue(WorkbookChartAxisTitle $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookChartAxisTitle>
     */
