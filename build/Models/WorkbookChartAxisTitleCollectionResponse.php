 ...
 */
class WorkbookChartAxisTitleCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookChartAxisTitle ...$items Variable number of WorkbookChartAxisTitle items
     * @return self
     */
    public function setValue(WorkbookChartAxisTitle ...$items): self
    {
        $this->value = $items;
        return $this;
    }
