...
/**
 * Collection response for RecycleBinCollectionResponse
 */
class RecycleBinCollectionResponseCollectionResponse
{
    /**
     * @var RecycleBinCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return RecycleBinCollectionResponse[]
     */
     ...
     * 
     * @param RecycleBinCollectionResponse ...$items Variable number of RecycleBinCollectionResponse items
     * @return self
     */
    public function setValue(RecycleBinCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RecycleBinCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RecycleBinCollectionResponse $item
     * @return self
     */
    public function addValue(RecycleBinCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
