...
/**
 * ExternalConnectorsRuleOperationCollectionResponse - Collection response
 */
class ExternalConnectorsRuleOperationCollectionResponse
{
    /**
     * @var array<int, ExternalConnectorsRuleOperation>
     */
    public array $value = [];
