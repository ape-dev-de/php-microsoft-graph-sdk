...
/**
 * Collection response for ExternalConnectorsRuleOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsRuleOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalConnectorsRuleOperation[]
     */
    private array $value = [];
     ...
     * 
     * @return ExternalConnectorsRuleOperation[]
     */
     ...
     * 
     * @param ExternalConnectorsRuleOperation[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsRuleOperation $items, ExternalConnectorsRuleOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsRuleOperation> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsRuleOperation $item
     * @return self
     */
    public function addValue(ExternalConnectorsRuleOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalConnectorsRuleOperation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsRuleOperation>
     */
