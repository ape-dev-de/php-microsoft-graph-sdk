...
/**
 * Collection response for DirectoryRole
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DirectoryRoleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DirectoryRole[]
     */
     ...
     * 
     * @param DirectoryRole[] $items
     * @return self
     */
    public function setValue(array|DirectoryRole $items, DirectoryRole ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DirectoryRole> $value
     * @return self
     ...
     * 
     * @param DirectoryRole $item
     * @return self
     */
    public function addValue(DirectoryRole $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DirectoryRole>
     */
