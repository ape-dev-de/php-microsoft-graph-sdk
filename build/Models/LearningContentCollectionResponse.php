...
/**
 * Collection response for LearningContent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LearningContentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var LearningContent[]
     */
     ...
     * 
     * @param LearningContent[] $items
     * @return self
     */
    public function setValue(array|LearningContent $items, LearningContent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LearningContent> $value
     * @return self
     ...
     * 
     * @param LearningContent $item
     * @return self
     */
    public function addValue(LearningContent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LearningContent>
     */
