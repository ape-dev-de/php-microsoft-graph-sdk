...
/**
 * Collection response for TodoTask
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TodoTaskCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TodoTask[]
     */
     ...
     * @return self
     */
    public function setValue(array|TodoTask $items, TodoTask ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(TodoTask $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TodoTask>
     */
