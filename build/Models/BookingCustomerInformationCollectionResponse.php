...
/**
 * Collection response for BookingCustomerInformation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingCustomerInformationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BookingCustomerInformation[]
     */
    private array $value = [];
     ...
     * 
     * @param BookingCustomerInformation[] $items
     * @return self
     */
    public function setValue(array|BookingCustomerInformation $items, BookingCustomerInformation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingCustomerInformation> $value
     * @return self
     ...
     * 
     * @param BookingCustomerInformation $item
     * @return self
     */
    public function addValue(BookingCustomerInformation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return BookingCustomerInformation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, BookingCustomerInformation>
     */
