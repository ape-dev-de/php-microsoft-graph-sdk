 ...
 */
class BookingCustomerInformationCollectionResponse
{
    /**
     ...
     * 
     * @param BookingCustomerInformation ...$items Variable number of BookingCustomerInformation items
     * @return self
     */
    public function setValue(BookingCustomerInformation ...$items): self
    {
        $this->value = $items;
        return $this;
    }
