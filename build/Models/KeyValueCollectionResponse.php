...
/**
 * Collection response for KeyValue
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class KeyValueCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var KeyValue[]
     */
     ...
     * @return self
     */
    public function setValue(array|KeyValue $items, KeyValue ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(KeyValue $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, KeyValue>
     */
