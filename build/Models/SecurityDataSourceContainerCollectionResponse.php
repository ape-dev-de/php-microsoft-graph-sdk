 ...
 */
class SecurityDataSourceContainerCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityDataSourceContainer ...$items Variable number of SecurityDataSourceContainer items
     * @return self
     */
    public function setValue(SecurityDataSourceContainer ...$items): self
    {
        $this->value = $items;
        return $this;
    }
