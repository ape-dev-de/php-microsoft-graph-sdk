...
/**
 * Collection response for SecurityDataSourceContainer
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityDataSourceContainerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityDataSourceContainer[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityDataSourceContainer[]
     */
     ...
     * 
     * @param SecurityDataSourceContainer[] $items
     * @return self
     */
    public function setValue(array|SecurityDataSourceContainer $items, SecurityDataSourceContainer ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityDataSourceContainer> $value
     * @return self
     ...
     * 
     * @param SecurityDataSourceContainer $item
     * @return self
     */
    public function addValue(SecurityDataSourceContainer $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityDataSourceContainer|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityDataSourceContainer>
     */
