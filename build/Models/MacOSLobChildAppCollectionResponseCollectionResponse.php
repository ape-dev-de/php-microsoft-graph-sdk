...
/**
 * Collection response for MacOSLobChildAppCollectionResponse
 */
class MacOSLobChildAppCollectionResponseCollectionResponse
{
    /**
     * @var MacOSLobChildAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MacOSLobChildAppCollectionResponse ...$items Variable number of MacOSLobChildAppCollectionResponse items
     * @return self
     */
    public function setValue(MacOSLobChildAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MacOSLobChildAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MacOSLobChildAppCollectionResponse $item
     * @return self
     */
    public function addValue(MacOSLobChildAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
