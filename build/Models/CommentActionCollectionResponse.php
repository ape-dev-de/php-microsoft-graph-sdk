 ...
 */
class CommentActionCollectionResponse
{
    /**
     * @var CommentAction[]
     */
     ...
     * 
     * @param CommentAction ...$items Variable number of CommentAction items
     * @return self
     */
    public function setValue(CommentAction ...$items): self
    {
        $this->value = $items;
        return $this;
    }
