...
/**
 * Collection response for CommentAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CommentActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CommentAction[]
     */
     ...
     * 
     * @param CommentAction[] $items
     * @return self
     */
    public function setValue(array|CommentAction $items, CommentAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CommentAction> $value
     * @return self
     ...
     * 
     * @param CommentAction $item
     * @return self
     */
    public function addValue(CommentAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CommentAction>
     */
