...
/**
 * Collection response for SecurityCloudAttachmentVersion
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityCloudAttachmentVersionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityCloudAttachmentVersion[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityCloudAttachmentVersion[]
     */
     ...
     * 
     * @param SecurityCloudAttachmentVersion[] $items
     * @return self
     */
    public function setValue(array|SecurityCloudAttachmentVersion $items, SecurityCloudAttachmentVersion ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityCloudAttachmentVersion> $value
     * @return self
     ...
     * 
     * @param SecurityCloudAttachmentVersion $item
     * @return self
     */
    public function addValue(SecurityCloudAttachmentVersion $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityCloudAttachmentVersion|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityCloudAttachmentVersion>
     */
