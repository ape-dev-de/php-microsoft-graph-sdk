...
/**
 * SecurityCloudAttachmentVersionCollectionResponse - Collection response
 */
class SecurityCloudAttachmentVersionCollectionResponse
{
    /**
     * @var array<int, SecurityCloudAttachmentVersion>
     */
    public array $value = [];
