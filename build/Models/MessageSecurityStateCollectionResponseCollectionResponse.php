...
/**
 * Collection response for MessageSecurityStateCollectionResponse
 */
class MessageSecurityStateCollectionResponseCollectionResponse
{
    /**
     * @var MessageSecurityStateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MessageSecurityStateCollectionResponse ...$items Variable number of MessageSecurityStateCollectionResponse items
     * @return self
     */
    public function setValue(MessageSecurityStateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MessageSecurityStateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MessageSecurityStateCollectionResponse $item
     * @return self
     */
    public function addValue(MessageSecurityStateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
