...
/**
 * Collection response for BookingCustomerBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingCustomerBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param BookingCustomerBase[] $items
     * @return self
     */
    public function setValue(array|BookingCustomerBase $items, BookingCustomerBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingCustomerBase> $value
     * @return self
     ...
     * 
     * @param BookingCustomerBase $item
     * @return self
     */
    public function addValue(BookingCustomerBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BookingCustomerBase>
     */
