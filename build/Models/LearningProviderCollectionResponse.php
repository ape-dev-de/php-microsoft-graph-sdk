...
/**
 * Collection response for LearningProvider
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LearningProviderCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param LearningProvider[] $items
     * @return self
     */
    public function setValue(array|LearningProvider $items, LearningProvider ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LearningProvider> $value
     * @return self
     ...
     * 
     * @param LearningProvider $item
     * @return self
     */
    public function addValue(LearningProvider $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LearningProvider>
     */
