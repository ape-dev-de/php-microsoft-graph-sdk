...
/**
 * Collection response for DriveCollectionResponse
 */
class DriveCollectionResponseCollectionResponse
{
    /**
     * @var DriveCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DriveCollectionResponse ...$items Variable number of DriveCollectionResponse items
     * @return self
     */
    public function setValue(DriveCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DriveCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DriveCollectionResponse $item
     * @return self
     */
    public function addValue(DriveCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
