...
/**
 * Collection response for PrinterLocation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrinterLocationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrinterLocation[]
     */
     ...
     * 
     * @param PrinterLocation[] $items
     * @return self
     */
    public function setValue(array|PrinterLocation $items, PrinterLocation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrinterLocation> $value
     * @return self
     ...
     * 
     * @param PrinterLocation $item
     * @return self
     */
    public function addValue(PrinterLocation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrinterLocation>
     */
