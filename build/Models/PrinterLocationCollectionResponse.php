 ...
 */
class PrinterLocationCollectionResponse
{
    /**
     * @var PrinterLocation[]
     */
     ...
     * 
     * @param PrinterLocation ...$items Variable number of PrinterLocation items
     * @return self
     */
    public function setValue(PrinterLocation ...$items): self
    {
        $this->value = $items;
        return $this;
    }
