...
/**
 * Collection response for ProvisioningObjectSummaryCollectionResponse
 */
class ProvisioningObjectSummaryCollectionResponseCollectionResponse
{
    /**
     * @var ProvisioningObjectSummaryCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ProvisioningObjectSummaryCollectionResponse ...$items Variable number of ProvisioningObjectSummaryCollectionResponse items
     * @return self
     */
    public function setValue(ProvisioningObjectSummaryCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ProvisioningObjectSummaryCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ProvisioningObjectSummaryCollectionResponse $item
     * @return self
     */
    public function addValue(ProvisioningObjectSummaryCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
