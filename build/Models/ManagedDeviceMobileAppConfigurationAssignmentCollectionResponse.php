...
/**
 * Collection response for ManagedDeviceMobileAppConfigurationAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedDeviceMobileAppConfigurationAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ManagedDeviceMobileAppConfigurationAssignment[] $items
     * @return self
     */
    public function setValue(array|ManagedDeviceMobileAppConfigurationAssignment $items, ManagedDeviceMobileAppConfigurationAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedDeviceMobileAppConfigurationAssignment> $value
     * @return self
     ...
     * 
     * @param ManagedDeviceMobileAppConfigurationAssignment $item
     * @return self
     */
    public function addValue(ManagedDeviceMobileAppConfigurationAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedDeviceMobileAppConfigurationAssignment>
     */
