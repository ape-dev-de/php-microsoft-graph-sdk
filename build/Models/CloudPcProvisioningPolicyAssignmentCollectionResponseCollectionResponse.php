...
/**
 * Collection response for CloudPcProvisioningPolicyAssignmentCollectionResponse
 */
class CloudPcProvisioningPolicyAssignmentCollectionResponseCollectionResponse
{
    /**
     * @var CloudPcProvisioningPolicyAssignmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudPcProvisioningPolicyAssignmentCollectionResponse ...$items Variable number of CloudPcProvisioningPolicyAssignmentCollectionResponse items
     * @return self
     */
    public function setValue(CloudPcProvisioningPolicyAssignmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CloudPcProvisioningPolicyAssignmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CloudPcProvisioningPolicyAssignmentCollectionResponse $item
     * @return self
     */
    public function addValue(CloudPcProvisioningPolicyAssignmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
