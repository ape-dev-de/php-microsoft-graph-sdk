...
/**
 * Collection response for OnEmailOtpSendListener
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnEmailOtpSendListenerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnEmailOtpSendListener[]
     */
    private array $value = [];
     ...
     * 
     * @param OnEmailOtpSendListener[] $items
     * @return self
     */
    public function setValue(array|OnEmailOtpSendListener $items, OnEmailOtpSendListener ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnEmailOtpSendListener> $value
     * @return self
     ...
     * 
     * @param OnEmailOtpSendListener $item
     * @return self
     */
    public function addValue(OnEmailOtpSendListener $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OnEmailOtpSendListener|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OnEmailOtpSendListener>
     */
