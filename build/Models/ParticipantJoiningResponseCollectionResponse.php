...
/**
 * ParticipantJoiningResponseCollectionResponse - Collection response
 */
class ParticipantJoiningResponseCollectionResponse
{
    /**
     * @var array<int, ParticipantJoiningResponse>
     */
    public array $value = [];
