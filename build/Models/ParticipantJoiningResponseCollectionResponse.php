...
/**
 * Collection response for ParticipantJoiningResponse
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ParticipantJoiningResponseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ParticipantJoiningResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return ParticipantJoiningResponse[]
     */
     ...
     * 
     * @param ParticipantJoiningResponse[] $items
     * @return self
     */
    public function setValue(array|ParticipantJoiningResponse $items, ParticipantJoiningResponse ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ParticipantJoiningResponse> $value
     * @return self
     ...
     * 
     * @param ParticipantJoiningResponse $item
     * @return self
     */
    public function addValue(ParticipantJoiningResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ParticipantJoiningResponse|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ParticipantJoiningResponse>
     */
