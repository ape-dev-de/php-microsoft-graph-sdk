...
/**
 * Collection response for AccessPackageCatalog
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageCatalogCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessPackageCatalog[] $items
     * @return self
     */
    public function setValue(array|AccessPackageCatalog $items, AccessPackageCatalog ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageCatalog> $value
     * @return self
     ...
     * 
     * @param AccessPackageCatalog $item
     * @return self
     */
    public function addValue(AccessPackageCatalog $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageCatalog>
     */
