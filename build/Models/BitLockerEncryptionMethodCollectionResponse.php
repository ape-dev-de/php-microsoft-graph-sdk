...
/**
 * Collection response for BitLockerEncryptionMethod
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BitLockerEncryptionMethodCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BitLockerEncryptionMethod[]
     */
    private array $value = [];
     ...
     * 
     * @return BitLockerEncryptionMethod[]
     */
     ...
     * 
     * @param BitLockerEncryptionMethod[] $items
     * @return self
     */
    public function setValue(array|BitLockerEncryptionMethod $items, BitLockerEncryptionMethod ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BitLockerEncryptionMethod> $value
     * @return self
     ...
     * 
     * @param BitLockerEncryptionMethod $item
     * @return self
     */
    public function addValue(BitLockerEncryptionMethod $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BitLockerEncryptionMethod>
     */
