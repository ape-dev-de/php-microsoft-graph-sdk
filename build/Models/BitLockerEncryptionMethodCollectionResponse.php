...
/**
 * BitLockerEncryptionMethodCollectionResponse - Collection response
 */
class BitLockerEncryptionMethodCollectionResponse
{
    /**
     * @var array<int, BitLockerEncryptionMethod>
     */
    public array $value = [];
