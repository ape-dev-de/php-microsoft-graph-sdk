...
/**
 * Collection response for RedirectUriSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RedirectUriSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param RedirectUriSettings[] $items
     * @return self
     */
    public function setValue(array|RedirectUriSettings $items, RedirectUriSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RedirectUriSettings> $value
     * @return self
     ...
     * 
     * @param RedirectUriSettings $item
     * @return self
     */
    public function addValue(RedirectUriSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return RedirectUriSettings|null
     */
     ...
     * 
     * @return \ArrayIterator<int, RedirectUriSettings>
     */
