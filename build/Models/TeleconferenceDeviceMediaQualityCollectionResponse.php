...
/**
 * Collection response for TeleconferenceDeviceMediaQuality
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeleconferenceDeviceMediaQualityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TeleconferenceDeviceMediaQuality[] $items
     * @return self
     */
    public function setValue(array|TeleconferenceDeviceMediaQuality $items, TeleconferenceDeviceMediaQuality ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeleconferenceDeviceMediaQuality> $value
     * @return self
     ...
     * 
     * @param TeleconferenceDeviceMediaQuality $item
     * @return self
     */
    public function addValue(TeleconferenceDeviceMediaQuality $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TeleconferenceDeviceMediaQuality|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TeleconferenceDeviceMediaQuality>
     */
