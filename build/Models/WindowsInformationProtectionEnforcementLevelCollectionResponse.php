...
/**
 * Collection response for WindowsInformationProtectionEnforcementLevel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsInformationProtectionEnforcementLevelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsInformationProtectionEnforcementLevel[]
     */
    private array $value = [];
     ...
     * 
     * @return WindowsInformationProtectionEnforcementLevel[]
     */
     ...
     * 
     * @param WindowsInformationProtectionEnforcementLevel[] $items
     * @return self
     */
    public function setValue(array|WindowsInformationProtectionEnforcementLevel $items, WindowsInformationProtectionEnforcementLevel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsInformationProtectionEnforcementLevel> $value
     * @return self
     ...
     * 
     * @param WindowsInformationProtectionEnforcementLevel $item
     * @return self
     */
    public function addValue(WindowsInformationProtectionEnforcementLevel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsInformationProtectionEnforcementLevel>
     */
