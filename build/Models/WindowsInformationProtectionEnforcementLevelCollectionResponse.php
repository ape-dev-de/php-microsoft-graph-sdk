...
/**
 * WindowsInformationProtectionEnforcementLevelCollectionResponse - Collection response
 */
class WindowsInformationProtectionEnforcementLevelCollectionResponse
{
    /**
     * @var array<int, WindowsInformationProtectionEnforcementLevel>
     */
    public array $value = [];
