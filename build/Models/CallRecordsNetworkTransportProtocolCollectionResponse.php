...
/**
 * Collection response for CallRecordsNetworkTransportProtocol
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsNetworkTransportProtocolCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsNetworkTransportProtocol[]
     */
    private array $value = [];
     ...
     * 
     * @return CallRecordsNetworkTransportProtocol[]
     */
     ...
     * 
     * @param CallRecordsNetworkTransportProtocol[] $items
     * @return self
     */
    public function setValue(array|CallRecordsNetworkTransportProtocol $items, CallRecordsNetworkTransportProtocol ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsNetworkTransportProtocol> $value
     * @return self
     ...
     * 
     * @param CallRecordsNetworkTransportProtocol $item
     * @return self
     */
    public function addValue(CallRecordsNetworkTransportProtocol $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsNetworkTransportProtocol|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsNetworkTransportProtocol>
     */
