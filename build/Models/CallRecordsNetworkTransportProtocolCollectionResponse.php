...
/**
 * CallRecordsNetworkTransportProtocolCollectionResponse - Collection response
 */
class CallRecordsNetworkTransportProtocolCollectionResponse
{
    /**
     * @var array<int, CallRecordsNetworkTransportProtocol>
     */
    public array $value = [];
