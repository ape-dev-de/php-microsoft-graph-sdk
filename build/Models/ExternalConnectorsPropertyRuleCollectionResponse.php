...
/**
 * Collection response for ExternalConnectorsPropertyRule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsPropertyRuleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return ExternalConnectorsPropertyRule[]
     */
     ...
     * 
     * @param ExternalConnectorsPropertyRule[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsPropertyRule $items, ExternalConnectorsPropertyRule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsPropertyRule> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsPropertyRule $item
     * @return self
     */
    public function addValue(ExternalConnectorsPropertyRule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalConnectorsPropertyRule|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsPropertyRule>
     */
