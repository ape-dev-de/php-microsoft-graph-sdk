...
/**
 * ExternalConnectorsPropertyRuleCollectionResponse - Collection response
 */
class ExternalConnectorsPropertyRuleCollectionResponse
{
    /**
     * @var array<int, ExternalConnectorsPropertyRule>
     */
    public array $value = [];
