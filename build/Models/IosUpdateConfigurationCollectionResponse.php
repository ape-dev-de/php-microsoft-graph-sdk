...
/**
 * Collection response for IosUpdateConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosUpdateConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IosUpdateConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param IosUpdateConfiguration[] $items
     * @return self
     */
    public function setValue(array|IosUpdateConfiguration $items, IosUpdateConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosUpdateConfiguration> $value
     * @return self
     ...
     * 
     * @param IosUpdateConfiguration $item
     * @return self
     */
    public function addValue(IosUpdateConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IosUpdateConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IosUpdateConfiguration>
     */
