...
/**
 * Collection response for SynchronizationJobCollectionResponse
 */
class SynchronizationJobCollectionResponseCollectionResponse
{
    /**
     * @var SynchronizationJobCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SynchronizationJobCollectionResponse ...$items Variable number of SynchronizationJobCollectionResponse items
     * @return self
     */
    public function setValue(SynchronizationJobCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SynchronizationJobCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SynchronizationJobCollectionResponse $item
     * @return self
     */
    public function addValue(SynchronizationJobCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
