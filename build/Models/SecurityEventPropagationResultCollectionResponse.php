...
/**
 * Collection response for SecurityEventPropagationResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityEventPropagationResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return SecurityEventPropagationResult[]
     */
     ...
     * 
     * @param SecurityEventPropagationResult[] $items
     * @return self
     */
    public function setValue(array|SecurityEventPropagationResult $items, SecurityEventPropagationResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityEventPropagationResult> $value
     * @return self
     ...
     * 
     * @param SecurityEventPropagationResult $item
     * @return self
     */
    public function addValue(SecurityEventPropagationResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityEventPropagationResult|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityEventPropagationResult>
     */
