...
/**
 * SecurityEventPropagationResultCollectionResponse - Collection response
 */
class SecurityEventPropagationResultCollectionResponse
{
    /**
     * @var array<int, SecurityEventPropagationResult>
     */
    public array $value = [];
