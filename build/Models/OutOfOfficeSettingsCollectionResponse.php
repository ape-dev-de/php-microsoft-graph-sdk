 ...
 */
class OutOfOfficeSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param OutOfOfficeSettings ...$items Variable number of OutOfOfficeSettings items
     * @return self
     */
    public function setValue(OutOfOfficeSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
