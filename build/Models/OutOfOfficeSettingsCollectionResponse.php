...
/**
 * Collection response for OutOfOfficeSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OutOfOfficeSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OutOfOfficeSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param OutOfOfficeSettings[] $items
     * @return self
     */
    public function setValue(array|OutOfOfficeSettings $items, OutOfOfficeSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OutOfOfficeSettings> $value
     * @return self
     ...
     * 
     * @param OutOfOfficeSettings $item
     * @return self
     */
    public function addValue(OutOfOfficeSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OutOfOfficeSettings>
     */
