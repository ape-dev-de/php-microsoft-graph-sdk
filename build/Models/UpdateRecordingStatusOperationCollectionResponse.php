...
/**
 * Collection response for UpdateRecordingStatusOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UpdateRecordingStatusOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UpdateRecordingStatusOperation[]
     */
    private array $value = [];
     ...
     * 
     * @param UpdateRecordingStatusOperation[] $items
     * @return self
     */
    public function setValue(array|UpdateRecordingStatusOperation $items, UpdateRecordingStatusOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UpdateRecordingStatusOperation> $value
     * @return self
     ...
     * 
     * @param UpdateRecordingStatusOperation $item
     * @return self
     */
    public function addValue(UpdateRecordingStatusOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UpdateRecordingStatusOperation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UpdateRecordingStatusOperation>
     */
