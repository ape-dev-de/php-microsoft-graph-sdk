...
/**
 * Collection response for SecurityTriggerTypesRoot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityTriggerTypesRootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityTriggerTypesRoot[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityTriggerTypesRoot[] $items
     * @return self
     */
    public function setValue(array|SecurityTriggerTypesRoot $items, SecurityTriggerTypesRoot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityTriggerTypesRoot> $value
     * @return self
     ...
     * 
     * @param SecurityTriggerTypesRoot $item
     * @return self
     */
    public function addValue(SecurityTriggerTypesRoot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityTriggerTypesRoot|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityTriggerTypesRoot>
     */
