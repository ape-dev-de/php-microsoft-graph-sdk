 ...
 */
class SecurityTriggerTypesRootCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityTriggerTypesRoot ...$items Variable number of SecurityTriggerTypesRoot items
     * @return self
     */
    public function setValue(SecurityTriggerTypesRoot ...$items): self
    {
        $this->value = $items;
        return $this;
    }
