 ...
 */
class StorageQuotaBreakdownCollectionResponse
{
    /**
     ...
     * 
     * @param StorageQuotaBreakdown ...$items Variable number of StorageQuotaBreakdown items
     * @return self
     */
    public function setValue(StorageQuotaBreakdown ...$items): self
    {
        $this->value = $items;
        return $this;
    }
