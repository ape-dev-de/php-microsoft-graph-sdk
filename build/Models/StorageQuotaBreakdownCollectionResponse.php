...
/**
 * Collection response for StorageQuotaBreakdown
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class StorageQuotaBreakdownCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var StorageQuotaBreakdown[]
     */
    private array $value = [];
     ...
     * 
     * @param StorageQuotaBreakdown[] $items
     * @return self
     */
    public function setValue(array|StorageQuotaBreakdown $items, StorageQuotaBreakdown ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<StorageQuotaBreakdown> $value
     * @return self
     ...
     * 
     * @param StorageQuotaBreakdown $item
     * @return self
     */
    public function addValue(StorageQuotaBreakdown $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return StorageQuotaBreakdown|null
     */
     ...
     * 
     * @return \ArrayIterator<int, StorageQuotaBreakdown>
     */
