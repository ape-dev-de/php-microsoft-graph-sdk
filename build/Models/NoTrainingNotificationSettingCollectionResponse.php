 ...
 */
class NoTrainingNotificationSettingCollectionResponse
{
    /**
     ...
     * 
     * @param NoTrainingNotificationSetting ...$items Variable number of NoTrainingNotificationSetting items
     * @return self
     */
    public function setValue(NoTrainingNotificationSetting ...$items): self
    {
        $this->value = $items;
        return $this;
    }
