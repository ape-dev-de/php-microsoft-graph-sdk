...
/**
 * Collection response for NoTrainingNotificationSetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class NoTrainingNotificationSettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var NoTrainingNotificationSetting[]
     */
    private array $value = [];
     ...
     * 
     * @param NoTrainingNotificationSetting[] $items
     * @return self
     */
    public function setValue(array|NoTrainingNotificationSetting $items, NoTrainingNotificationSetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<NoTrainingNotificationSetting> $value
     * @return self
     ...
     * 
     * @param NoTrainingNotificationSetting $item
     * @return self
     */
    public function addValue(NoTrainingNotificationSetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return NoTrainingNotificationSetting|null
     */
     ...
     * 
     * @return \ArrayIterator<int, NoTrainingNotificationSetting>
     */
