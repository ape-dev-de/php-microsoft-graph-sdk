...
class UnifiedRoleDefinition
{
     ...
     * @var string[]
     */
    private array $inheritsPermissionsFrom = [];
    ...
    /**
     * @param string[] $inheritsPermissionsFrom
     */
    public function setInheritsPermissionsFrom(array $inheritsPermissionsFrom): self
    {
