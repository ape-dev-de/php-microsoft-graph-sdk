...
/**
 * Collection response for WindowsMobileMSICollectionResponse
 */
class WindowsMobileMSICollectionResponseCollectionResponse
{
    /**
     * @var WindowsMobileMSICollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsMobileMSICollectionResponse ...$items Variable number of WindowsMobileMSICollectionResponse items
     * @return self
     */
    public function setValue(WindowsMobileMSICollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WindowsMobileMSICollectionResponse> $value
     * @return self
     ...
     * 
     * @param WindowsMobileMSICollectionResponse $item
     * @return self
     */
    public function addValue(WindowsMobileMSICollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
