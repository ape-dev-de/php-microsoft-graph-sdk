...
/**
 * Collection response for SecurityDeviceRiskScore
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityDeviceRiskScoreCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityDeviceRiskScore[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityDeviceRiskScore[]
     */
     ...
     * 
     * @param SecurityDeviceRiskScore[] $items
     * @return self
     */
    public function setValue(array|SecurityDeviceRiskScore $items, SecurityDeviceRiskScore ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityDeviceRiskScore> $value
     * @return self
     ...
     * 
     * @param SecurityDeviceRiskScore $item
     * @return self
     */
    public function addValue(SecurityDeviceRiskScore $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityDeviceRiskScore|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityDeviceRiskScore>
     */
