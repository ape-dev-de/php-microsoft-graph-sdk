...
/**
 * Collection response for AndroidManagedAppRegistration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AndroidManagedAppRegistrationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AndroidManagedAppRegistration[]
     */
    private array $value = [];
     ...
     * 
     * @param AndroidManagedAppRegistration[] $items
     * @return self
     */
    public function setValue(array|AndroidManagedAppRegistration $items, AndroidManagedAppRegistration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AndroidManagedAppRegistration> $value
     * @return self
     ...
     * 
     * @param AndroidManagedAppRegistration $item
     * @return self
     */
    public function addValue(AndroidManagedAppRegistration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AndroidManagedAppRegistration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AndroidManagedAppRegistration>
     */
