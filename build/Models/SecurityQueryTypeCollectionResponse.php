...
/**
 * Collection response for SecurityQueryType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityQueryTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityQueryType[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityQueryType[] $items
     * @return self
     */
    public function setValue(array|SecurityQueryType $items, SecurityQueryType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityQueryType> $value
     * @return self
     ...
     * 
     * @param SecurityQueryType $item
     * @return self
     */
    public function addValue(SecurityQueryType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityQueryType>
     */
