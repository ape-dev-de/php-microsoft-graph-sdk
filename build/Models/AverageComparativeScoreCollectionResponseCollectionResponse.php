...
/**
 * Collection response for AverageComparativeScoreCollectionResponse
 */
class AverageComparativeScoreCollectionResponseCollectionResponse
{
    /**
     * @var AverageComparativeScoreCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AverageComparativeScoreCollectionResponse ...$items Variable number of AverageComparativeScoreCollectionResponse items
     * @return self
     */
    public function setValue(AverageComparativeScoreCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AverageComparativeScoreCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AverageComparativeScoreCollectionResponse $item
     * @return self
     */
    public function addValue(AverageComparativeScoreCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
