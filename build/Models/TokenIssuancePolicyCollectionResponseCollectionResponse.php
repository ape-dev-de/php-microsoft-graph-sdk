...
/**
 * Collection response for TokenIssuancePolicyCollectionResponse
 */
class TokenIssuancePolicyCollectionResponseCollectionResponse
{
    /**
     * @var TokenIssuancePolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TokenIssuancePolicyCollectionResponse ...$items Variable number of TokenIssuancePolicyCollectionResponse items
     * @return self
     */
    public function setValue(TokenIssuancePolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TokenIssuancePolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TokenIssuancePolicyCollectionResponse $item
     * @return self
     */
    public function addValue(TokenIssuancePolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
