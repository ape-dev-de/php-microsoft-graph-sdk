...
/**
 * Collection response for UserExperienceAnalyticsMetricHistory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsMetricHistoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsMetricHistory[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsMetricHistory $items, UserExperienceAnalyticsMetricHistory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsMetricHistory> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsMetricHistory $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsMetricHistory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsMetricHistory>
     */
