...
/**
 * Collection response for MeetingMessageType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MeetingMessageTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MeetingMessageType[] $items
     * @return self
     */
    public function setValue(array|MeetingMessageType $items, MeetingMessageType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MeetingMessageType> $value
     * @return self
     ...
     * 
     * @param MeetingMessageType $item
     * @return self
     */
    public function addValue(MeetingMessageType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MeetingMessageType>
     */
