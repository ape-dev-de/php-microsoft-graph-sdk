 ...
 */
class SecurityKubernetesServiceEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityKubernetesServiceEvidence ...$items Variable number of SecurityKubernetesServiceEvidence items
     * @return self
     */
    public function setValue(SecurityKubernetesServiceEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
