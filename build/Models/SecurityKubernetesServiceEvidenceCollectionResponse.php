...
/**
 * Collection response for SecurityKubernetesServiceEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityKubernetesServiceEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityKubernetesServiceEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityKubernetesServiceEvidence[]
     */
     ...
     * 
     * @param SecurityKubernetesServiceEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityKubernetesServiceEvidence $items, SecurityKubernetesServiceEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityKubernetesServiceEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityKubernetesServiceEvidence $item
     * @return self
     */
    public function addValue(SecurityKubernetesServiceEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityKubernetesServiceEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityKubernetesServiceEvidence>
     */
