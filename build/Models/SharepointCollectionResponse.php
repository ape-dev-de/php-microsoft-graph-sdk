...
/**
 * Collection response for Sharepoint
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SharepointCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Sharepoint[]
     */
     ...
     * 
     * @param Sharepoint[] $items
     * @return self
     */
    public function setValue(array|Sharepoint $items, Sharepoint ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param Sharepoint $item
     * @return self
     */
    public function addValue(Sharepoint $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Sharepoint>
     */
