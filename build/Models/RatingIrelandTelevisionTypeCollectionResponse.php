...
/**
 * Collection response for RatingIrelandTelevisionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RatingIrelandTelevisionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RatingIrelandTelevisionType[]
     */
    private array $value = [];
     ...
     * 
     * @return RatingIrelandTelevisionType[]
     */
     ...
     * 
     * @param RatingIrelandTelevisionType[] $items
     * @return self
     */
    public function setValue(array|RatingIrelandTelevisionType $items, RatingIrelandTelevisionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RatingIrelandTelevisionType> $value
     * @return self
     ...
     * 
     * @param RatingIrelandTelevisionType $item
     * @return self
     */
    public function addValue(RatingIrelandTelevisionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RatingIrelandTelevisionType>
     */
