...
/**
 * RatingIrelandTelevisionTypeCollectionResponse - Collection response
 */
class RatingIrelandTelevisionTypeCollectionResponse
{
    /**
     * @var array<int, RatingIrelandTelevisionType>
     */
    public array $value = [];
