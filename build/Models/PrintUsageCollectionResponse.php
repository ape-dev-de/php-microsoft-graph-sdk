...
/**
 * Collection response for PrintUsage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintUsageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrintUsage[]
     */
     ...
     * 
     * @param PrintUsage[] $items
     * @return self
     */
    public function setValue(array|PrintUsage $items, PrintUsage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param PrintUsage $item
     * @return self
     */
    public function addValue(PrintUsage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintUsage>
     */
