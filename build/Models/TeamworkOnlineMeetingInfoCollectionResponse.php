...
/**
 * Collection response for TeamworkOnlineMeetingInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamworkOnlineMeetingInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamworkOnlineMeetingInfo[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamworkOnlineMeetingInfo[] $items
     * @return self
     */
    public function setValue(array|TeamworkOnlineMeetingInfo $items, TeamworkOnlineMeetingInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamworkOnlineMeetingInfo> $value
     * @return self
     ...
     * 
     * @param TeamworkOnlineMeetingInfo $item
     * @return self
     */
    public function addValue(TeamworkOnlineMeetingInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamworkOnlineMeetingInfo>
     */
