 ...
 */
class TeamworkOnlineMeetingInfoCollectionResponse
{
    /**
     ...
     * 
     * @param TeamworkOnlineMeetingInfo ...$items Variable number of TeamworkOnlineMeetingInfo items
     * @return self
     */
    public function setValue(TeamworkOnlineMeetingInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
