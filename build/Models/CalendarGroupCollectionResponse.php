...
/**
 * Collection response for CalendarGroup
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CalendarGroupCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CalendarGroup[]
     */
     ...
     * 
     * @param CalendarGroup[] $items
     * @return self
     */
    public function setValue(array|CalendarGroup $items, CalendarGroup ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CalendarGroup> $value
     * @return self
     ...
     * @return self
     */
    public function addValue(CalendarGroup $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CalendarGroup>
     */
