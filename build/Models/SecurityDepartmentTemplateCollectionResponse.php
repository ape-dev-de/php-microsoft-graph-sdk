...
/**
 * Collection response for SecurityDepartmentTemplate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityDepartmentTemplateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityDepartmentTemplate[] $items
     * @return self
     */
    public function setValue(array|SecurityDepartmentTemplate $items, SecurityDepartmentTemplate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityDepartmentTemplate> $value
     * @return self
     ...
     * 
     * @param SecurityDepartmentTemplate $item
     * @return self
     */
    public function addValue(SecurityDepartmentTemplate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityDepartmentTemplate>
     */
