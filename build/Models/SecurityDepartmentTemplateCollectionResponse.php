...
/**
 * SecurityDepartmentTemplateCollectionResponse - Collection response
 */
class SecurityDepartmentTemplateCollectionResponse
{
    /**
     * @var array<int, SecurityDepartmentTemplate>
     */
    public array $value = [];
