...
/**
 * Collection response for SecurityProcessEvidenceCollectionResponse
 */
class SecurityProcessEvidenceCollectionResponseCollectionResponse
{
    /**
     * @var SecurityProcessEvidenceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityProcessEvidenceCollectionResponse[]
     */
     ...
     * 
     * @param SecurityProcessEvidenceCollectionResponse ...$items Variable number of SecurityProcessEvidenceCollectionResponse items
     * @return self
     */
    public function setValue(SecurityProcessEvidenceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityProcessEvidenceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityProcessEvidenceCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityProcessEvidenceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
