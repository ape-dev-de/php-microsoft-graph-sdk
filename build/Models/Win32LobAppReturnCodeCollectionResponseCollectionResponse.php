...
/**
 * Collection response for Win32LobAppReturnCodeCollectionResponse
 */
class Win32LobAppReturnCodeCollectionResponseCollectionResponse
{
    /**
     * @var Win32LobAppReturnCodeCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param Win32LobAppReturnCodeCollectionResponse ...$items Variable number of Win32LobAppReturnCodeCollectionResponse items
     * @return self
     */
    public function setValue(Win32LobAppReturnCodeCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<Win32LobAppReturnCodeCollectionResponse> $value
     * @return self
     ...
     * 
     * @param Win32LobAppReturnCodeCollectionResponse $item
     * @return self
     */
    public function addValue(Win32LobAppReturnCodeCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
