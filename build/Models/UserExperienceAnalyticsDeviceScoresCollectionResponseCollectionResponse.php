...
/**
 * Collection response for UserExperienceAnalyticsDeviceScoresCollectionResponse
 */
class UserExperienceAnalyticsDeviceScoresCollectionResponseCollectionResponse
{
    /**
     * @var UserExperienceAnalyticsDeviceScoresCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UserExperienceAnalyticsDeviceScoresCollectionResponse ...$items Variable number of UserExperienceAnalyticsDeviceScoresCollectionResponse items
     * @return self
     */
    public function setValue(UserExperienceAnalyticsDeviceScoresCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UserExperienceAnalyticsDeviceScoresCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsDeviceScoresCollectionResponse $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsDeviceScoresCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
