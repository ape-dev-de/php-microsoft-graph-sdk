...
/**
 * Collection response for EmailAddress
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EmailAddressCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EmailAddress[]
     */
     ...
     * 
     * @param EmailAddress[] $items
     * @return self
     */
    public function setValue(array|EmailAddress $items, EmailAddress ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EmailAddress> $value
     * @return self
     ...
     * @return self
     */
    public function addValue(EmailAddress $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EmailAddress>
     */
