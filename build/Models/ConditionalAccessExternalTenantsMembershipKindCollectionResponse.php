...
/**
 * Collection response for ConditionalAccessExternalTenantsMembershipKind
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessExternalTenantsMembershipKindCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessExternalTenantsMembershipKind[]
     */
    private array $value = [];
     ...
     * 
     * @return ConditionalAccessExternalTenantsMembershipKind[]
     */
     ...
     * 
     * @param ConditionalAccessExternalTenantsMembershipKind[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessExternalTenantsMembershipKind $items, ConditionalAccessExternalTenantsMembershipKind ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessExternalTenantsMembershipKind> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessExternalTenantsMembershipKind $item
     * @return self
     */
    public function addValue(ConditionalAccessExternalTenantsMembershipKind $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessExternalTenantsMembershipKind>
     */
