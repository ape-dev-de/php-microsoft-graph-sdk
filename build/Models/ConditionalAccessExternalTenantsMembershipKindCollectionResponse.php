...
/**
 * ConditionalAccessExternalTenantsMembershipKindCollectionResponse - Collection response
 */
class ConditionalAccessExternalTenantsMembershipKindCollectionResponse
{
    /**
     * @var array<int, ConditionalAccessExternalTenantsMembershipKind>
     */
    public array $value = [];
