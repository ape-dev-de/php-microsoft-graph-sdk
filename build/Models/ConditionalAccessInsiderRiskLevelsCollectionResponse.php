...
/**
 * Collection response for ConditionalAccessInsiderRiskLevels
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessInsiderRiskLevelsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessInsiderRiskLevels[]
     */
    private array $value = [];
     ...
     * 
     * @return ConditionalAccessInsiderRiskLevels[]
     */
     ...
     * 
     * @param ConditionalAccessInsiderRiskLevels[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessInsiderRiskLevels $items, ConditionalAccessInsiderRiskLevels ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessInsiderRiskLevels> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessInsiderRiskLevels $item
     * @return self
     */
    public function addValue(ConditionalAccessInsiderRiskLevels $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessInsiderRiskLevels>
     */
