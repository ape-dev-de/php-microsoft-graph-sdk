...
/**
 * ConditionalAccessInsiderRiskLevelsCollectionResponse - Collection response
 */
class ConditionalAccessInsiderRiskLevelsCollectionResponse
{
    /**
     * @var array<int, ConditionalAccessInsiderRiskLevels>
     */
    public array $value = [];
