...
/**
 * Collection response for EducationRubricOutcomeCollectionResponse
 */
class EducationRubricOutcomeCollectionResponseCollectionResponse
{
    /**
     * @var EducationRubricOutcomeCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationRubricOutcomeCollectionResponse ...$items Variable number of EducationRubricOutcomeCollectionResponse items
     * @return self
     */
    public function setValue(EducationRubricOutcomeCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EducationRubricOutcomeCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EducationRubricOutcomeCollectionResponse $item
     * @return self
     */
    public function addValue(EducationRubricOutcomeCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
