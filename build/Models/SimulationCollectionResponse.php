...
/**
 * Collection response for Simulation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SimulationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Simulation[]
     */
     ...
     * 
     * @param Simulation[] $items
     * @return self
     */
    public function setValue(array|Simulation $items, Simulation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param Simulation $item
     * @return self
     */
    public function addValue(Simulation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Simulation>
     */
