...
/**
 * Collection response for UserScopeType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserScopeTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserScopeType[]
     */
     ...
     * 
     * @param UserScopeType[] $items
     * @return self
     */
    public function setValue(array|UserScopeType $items, UserScopeType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserScopeType> $value
     * @return self
     ...
     * 
     * @param UserScopeType $item
     * @return self
     */
    public function addValue(UserScopeType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserScopeType>
     */
