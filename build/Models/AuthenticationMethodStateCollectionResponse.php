...
/**
 * Collection response for AuthenticationMethodState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationMethodStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuthenticationMethodState[]
     */
    private array $value = [];
     ...
     * 
     * @return AuthenticationMethodState[]
     */
     ...
     * 
     * @param AuthenticationMethodState[] $items
     * @return self
     */
    public function setValue(array|AuthenticationMethodState $items, AuthenticationMethodState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationMethodState> $value
     * @return self
     ...
     * 
     * @param AuthenticationMethodState $item
     * @return self
     */
    public function addValue(AuthenticationMethodState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationMethodState>
     */
