...
/**
 * AuthenticationMethodStateCollectionResponse - Collection response
 */
class AuthenticationMethodStateCollectionResponse
{
    /**
     * @var array<int, AuthenticationMethodState>
     */
    public array $value = [];
