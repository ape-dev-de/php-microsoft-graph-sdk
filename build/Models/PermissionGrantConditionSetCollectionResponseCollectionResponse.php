...
/**
 * Collection response for PermissionGrantConditionSetCollectionResponse
 */
class PermissionGrantConditionSetCollectionResponseCollectionResponse
{
    /**
     * @var PermissionGrantConditionSetCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PermissionGrantConditionSetCollectionResponse ...$items Variable number of PermissionGrantConditionSetCollectionResponse items
     * @return self
     */
    public function setValue(PermissionGrantConditionSetCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PermissionGrantConditionSetCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PermissionGrantConditionSetCollectionResponse $item
     * @return self
     */
    public function addValue(PermissionGrantConditionSetCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
