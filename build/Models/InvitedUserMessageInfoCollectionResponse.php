...
/**
 * Collection response for InvitedUserMessageInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InvitedUserMessageInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param InvitedUserMessageInfo[] $items
     * @return self
     */
    public function setValue(array|InvitedUserMessageInfo $items, InvitedUserMessageInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InvitedUserMessageInfo> $value
     * @return self
     ...
     * 
     * @param InvitedUserMessageInfo $item
     * @return self
     */
    public function addValue(InvitedUserMessageInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, InvitedUserMessageInfo>
     */
