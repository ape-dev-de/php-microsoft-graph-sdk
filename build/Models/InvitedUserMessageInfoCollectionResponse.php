 ...
 */
class InvitedUserMessageInfoCollectionResponse
{
    /**
     ...
     * 
     * @param InvitedUserMessageInfo ...$items Variable number of InvitedUserMessageInfo items
     * @return self
     */
    public function setValue(InvitedUserMessageInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
