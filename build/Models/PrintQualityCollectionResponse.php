...
/**
 * Collection response for PrintQuality
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintQualityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrintQuality[]
     */
     ...
     * 
     * @param PrintQuality[] $items
     * @return self
     */
    public function setValue(array|PrintQuality $items, PrintQuality ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintQuality> $value
     * @return self
     ...
     * 
     * @param PrintQuality $item
     * @return self
     */
    public function addValue(PrintQuality $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintQuality>
     */
