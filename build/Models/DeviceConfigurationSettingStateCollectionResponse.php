...
/**
 * Collection response for DeviceConfigurationSettingState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceConfigurationSettingStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceConfigurationSettingState[] $items
     * @return self
     */
    public function setValue(array|DeviceConfigurationSettingState $items, DeviceConfigurationSettingState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceConfigurationSettingState> $value
     * @return self
     ...
     * 
     * @param DeviceConfigurationSettingState $item
     * @return self
     */
    public function addValue(DeviceConfigurationSettingState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return DeviceConfigurationSettingState|null
     */
     ...
     * 
     * @return \ArrayIterator<int, DeviceConfigurationSettingState>
     */
