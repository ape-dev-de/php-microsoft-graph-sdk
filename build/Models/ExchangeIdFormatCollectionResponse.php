...
/**
 * Collection response for ExchangeIdFormat
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExchangeIdFormatCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExchangeIdFormat[]
     */
    private array $value = [];
     ...
     * 
     * @param ExchangeIdFormat[] $items
     * @return self
     */
    public function setValue(array|ExchangeIdFormat $items, ExchangeIdFormat ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExchangeIdFormat> $value
     * @return self
     ...
     * 
     * @param ExchangeIdFormat $item
     * @return self
     */
    public function addValue(ExchangeIdFormat $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ExchangeIdFormat>
     */
