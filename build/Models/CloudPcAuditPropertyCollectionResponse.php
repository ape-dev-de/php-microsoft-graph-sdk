...
/**
 * Collection response for CloudPcAuditProperty
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcAuditPropertyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CloudPcAuditProperty[] $items
     * @return self
     */
    public function setValue(array|CloudPcAuditProperty $items, CloudPcAuditProperty ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcAuditProperty> $value
     * @return self
     ...
     * 
     * @param CloudPcAuditProperty $item
     * @return self
     */
    public function addValue(CloudPcAuditProperty $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CloudPcAuditProperty|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CloudPcAuditProperty>
     */
