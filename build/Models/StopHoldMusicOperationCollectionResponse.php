...
/**
 * Collection response for StopHoldMusicOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class StopHoldMusicOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var StopHoldMusicOperation[]
     */
    private array $value = [];
     ...
     * 
     * @param StopHoldMusicOperation[] $items
     * @return self
     */
    public function setValue(array|StopHoldMusicOperation $items, StopHoldMusicOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<StopHoldMusicOperation> $value
     * @return self
     ...
     * 
     * @param StopHoldMusicOperation $item
     * @return self
     */
    public function addValue(StopHoldMusicOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return StopHoldMusicOperation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, StopHoldMusicOperation>
     */
