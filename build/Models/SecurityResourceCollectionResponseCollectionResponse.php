...
/**
 * Collection response for SecurityResourceCollectionResponse
 */
class SecurityResourceCollectionResponseCollectionResponse
{
    /**
     * @var SecurityResourceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityResourceCollectionResponse ...$items Variable number of SecurityResourceCollectionResponse items
     * @return self
     */
    public function setValue(SecurityResourceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityResourceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityResourceCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityResourceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
