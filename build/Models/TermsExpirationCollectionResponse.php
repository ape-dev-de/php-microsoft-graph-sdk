...
/**
 * Collection response for TermsExpiration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TermsExpirationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TermsExpiration[]
     */
     ...
     * 
     * @param TermsExpiration[] $items
     * @return self
     */
    public function setValue(array|TermsExpiration $items, TermsExpiration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TermsExpiration> $value
     * @return self
     ...
     * 
     * @param TermsExpiration $item
     * @return self
     */
    public function addValue(TermsExpiration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TermsExpiration>
     */
