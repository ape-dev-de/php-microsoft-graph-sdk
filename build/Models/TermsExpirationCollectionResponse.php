 ...
 */
class TermsExpirationCollectionResponse
{
    /**
     * @var TermsExpiration[]
     */
     ...
     * 
     * @param TermsExpiration ...$items Variable number of TermsExpiration items
     * @return self
     */
    public function setValue(TermsExpiration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
