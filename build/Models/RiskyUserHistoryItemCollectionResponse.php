...
/**
 * Collection response for RiskyUserHistoryItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RiskyUserHistoryItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param RiskyUserHistoryItem[] $items
     * @return self
     */
    public function setValue(array|RiskyUserHistoryItem $items, RiskyUserHistoryItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RiskyUserHistoryItem> $value
     * @return self
     ...
     * 
     * @param RiskyUserHistoryItem $item
     * @return self
     */
    public function addValue(RiskyUserHistoryItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RiskyUserHistoryItem>
     */
