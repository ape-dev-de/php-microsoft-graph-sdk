...
/**
 * Collection response for ManagedDeviceOverview
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedDeviceOverviewCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ManagedDeviceOverview[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedDeviceOverview[] $items
     * @return self
     */
    public function setValue(array|ManagedDeviceOverview $items, ManagedDeviceOverview ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedDeviceOverview> $value
     * @return self
     ...
     * 
     * @param ManagedDeviceOverview $item
     * @return self
     */
    public function addValue(ManagedDeviceOverview $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedDeviceOverview>
     */
