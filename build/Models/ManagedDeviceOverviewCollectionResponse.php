 ...
 */
class ManagedDeviceOverviewCollectionResponse
{
    /**
     ...
     * 
     * @param ManagedDeviceOverview ...$items Variable number of ManagedDeviceOverview items
     * @return self
     */
    public function setValue(ManagedDeviceOverview ...$items): self
    {
        $this->value = $items;
        return $this;
    }
