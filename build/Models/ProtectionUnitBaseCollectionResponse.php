...
/**
 * Collection response for ProtectionUnitBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProtectionUnitBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ProtectionUnitBase[] $items
     * @return self
     */
    public function setValue(array|ProtectionUnitBase $items, ProtectionUnitBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProtectionUnitBase> $value
     * @return self
     ...
     * 
     * @param ProtectionUnitBase $item
     * @return self
     */
    public function addValue(ProtectionUnitBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProtectionUnitBase>
     */
