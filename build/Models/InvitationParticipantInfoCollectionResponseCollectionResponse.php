...
/**
 * Collection response for InvitationParticipantInfoCollectionResponse
 */
class InvitationParticipantInfoCollectionResponseCollectionResponse
{
    /**
     * @var InvitationParticipantInfoCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param InvitationParticipantInfoCollectionResponse ...$items Variable number of InvitationParticipantInfoCollectionResponse items
     * @return self
     */
    public function setValue(InvitationParticipantInfoCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<InvitationParticipantInfoCollectionResponse> $value
     * @return self
     ...
     * 
     * @param InvitationParticipantInfoCollectionResponse $item
     * @return self
     */
    public function addValue(InvitationParticipantInfoCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
