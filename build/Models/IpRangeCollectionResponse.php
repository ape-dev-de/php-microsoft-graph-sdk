...
/**
 * Collection response for IpRange
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IpRangeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IpRange[]
     */
     ...
     * @return self
     */
    public function setValue(array|IpRange $items, IpRange ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(IpRange $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IpRange>
     */
