 ...
 */
class AuditActivityInitiatorCollectionResponse
{
    /**
     ...
     * 
     * @param AuditActivityInitiator ...$items Variable number of AuditActivityInitiator items
     * @return self
     */
    public function setValue(AuditActivityInitiator ...$items): self
    {
        $this->value = $items;
        return $this;
    }
