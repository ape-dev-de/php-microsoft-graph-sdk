...
/**
 * Collection response for AuditActivityInitiator
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuditActivityInitiatorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AuditActivityInitiator[] $items
     * @return self
     */
    public function setValue(array|AuditActivityInitiator $items, AuditActivityInitiator ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuditActivityInitiator> $value
     * @return self
     ...
     * 
     * @param AuditActivityInitiator $item
     * @return self
     */
    public function addValue(AuditActivityInitiator $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuditActivityInitiator>
     */
