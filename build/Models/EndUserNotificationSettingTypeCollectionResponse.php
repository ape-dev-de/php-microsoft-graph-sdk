...
/**
 * Collection response for EndUserNotificationSettingType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EndUserNotificationSettingTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EndUserNotificationSettingType[]
     */
    private array $value = [];
     ...
     * 
     * @param EndUserNotificationSettingType[] $items
     * @return self
     */
    public function setValue(array|EndUserNotificationSettingType $items, EndUserNotificationSettingType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EndUserNotificationSettingType> $value
     * @return self
     ...
     * 
     * @param EndUserNotificationSettingType $item
     * @return self
     */
    public function addValue(EndUserNotificationSettingType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EndUserNotificationSettingType>
     */
