...
/**
 * EndUserNotificationSettingTypeCollectionResponse - Collection response
 */
class EndUserNotificationSettingTypeCollectionResponse
{
    /**
     * @var array<int, EndUserNotificationSettingType>
     */
    public array $value = [];
