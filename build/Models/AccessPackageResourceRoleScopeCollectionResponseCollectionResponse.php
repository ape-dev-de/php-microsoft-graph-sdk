...
/**
 * Collection response for AccessPackageResourceRoleScopeCollectionResponse
 */
class AccessPackageResourceRoleScopeCollectionResponseCollectionResponse
{
    /**
     * @var AccessPackageResourceRoleScopeCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageResourceRoleScopeCollectionResponse ...$items Variable number of AccessPackageResourceRoleScopeCollectionResponse items
     * @return self
     */
    public function setValue(AccessPackageResourceRoleScopeCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AccessPackageResourceRoleScopeCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AccessPackageResourceRoleScopeCollectionResponse $item
     * @return self
     */
    public function addValue(AccessPackageResourceRoleScopeCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
