...
/**
 * Collection response for WindowsDefenderScanActionResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsDefenderScanActionResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsDefenderScanActionResult[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsDefenderScanActionResult[] $items
     * @return self
     */
    public function setValue(array|WindowsDefenderScanActionResult $items, WindowsDefenderScanActionResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsDefenderScanActionResult> $value
     * @return self
     ...
     * 
     * @param WindowsDefenderScanActionResult $item
     * @return self
     */
    public function addValue(WindowsDefenderScanActionResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WindowsDefenderScanActionResult|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WindowsDefenderScanActionResult>
     */
