 ...
 */
class WindowsDefenderScanActionResultCollectionResponse
{
    /**
     ...
     * 
     * @param WindowsDefenderScanActionResult ...$items Variable number of WindowsDefenderScanActionResult items
     * @return self
     */
    public function setValue(WindowsDefenderScanActionResult ...$items): self
    {
        $this->value = $items;
        return $this;
    }
