...
/**
 * Collection response for SecurityCaseOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityCaseOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityCaseOperation[] $items
     * @return self
     */
    public function setValue(array|SecurityCaseOperation $items, SecurityCaseOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityCaseOperation> $value
     * @return self
     ...
     * 
     * @param SecurityCaseOperation $item
     * @return self
     */
    public function addValue(SecurityCaseOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityCaseOperation>
     */
