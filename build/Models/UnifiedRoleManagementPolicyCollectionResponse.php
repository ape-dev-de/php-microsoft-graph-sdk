...
/**
 * Collection response for UnifiedRoleManagementPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRoleManagementPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UnifiedRoleManagementPolicy[] $items
     * @return self
     */
    public function setValue(array|UnifiedRoleManagementPolicy $items, UnifiedRoleManagementPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRoleManagementPolicy> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleManagementPolicy $item
     * @return self
     */
    public function addValue(UnifiedRoleManagementPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRoleManagementPolicy>
     */
