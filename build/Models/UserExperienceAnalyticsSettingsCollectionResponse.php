 ...
 */
class UserExperienceAnalyticsSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsSettings ...$items Variable number of UserExperienceAnalyticsSettings items
     * @return self
     */
    public function setValue(UserExperienceAnalyticsSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
