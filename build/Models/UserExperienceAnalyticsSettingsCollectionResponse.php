...
/**
 * Collection response for UserExperienceAnalyticsSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserExperienceAnalyticsSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param UserExperienceAnalyticsSettings[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsSettings $items, UserExperienceAnalyticsSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsSettings> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsSettings $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsSettings>
     */
