...
/**
 * Collection response for AccessPackageSubject
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageSubjectCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageSubject[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageSubject[] $items
     * @return self
     */
    public function setValue(array|AccessPackageSubject $items, AccessPackageSubject ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageSubject> $value
     * @return self
     ...
     * 
     * @param AccessPackageSubject $item
     * @return self
     */
    public function addValue(AccessPackageSubject $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageSubject>
     */
