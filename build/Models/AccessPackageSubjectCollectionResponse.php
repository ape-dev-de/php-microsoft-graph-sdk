 ...
 */
class AccessPackageSubjectCollectionResponse
{
    /**
     ...
     * 
     * @param AccessPackageSubject ...$items Variable number of AccessPackageSubject items
     * @return self
     */
    public function setValue(AccessPackageSubject ...$items): self
    {
        $this->value = $items;
        return $this;
    }
