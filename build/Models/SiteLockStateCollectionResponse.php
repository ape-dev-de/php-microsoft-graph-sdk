...
/**
 * Collection response for SiteLockState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SiteLockStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SiteLockState[]
     */
     ...
     * 
     * @param SiteLockState[] $items
     * @return self
     */
    public function setValue(array|SiteLockState $items, SiteLockState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SiteLockState> $value
     * @return self
     ...
     * 
     * @param SiteLockState $item
     * @return self
     */
    public function addValue(SiteLockState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SiteLockState>
     */
