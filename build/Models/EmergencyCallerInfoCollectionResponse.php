 ...
 */
class EmergencyCallerInfoCollectionResponse
{
    /**
     ...
     * 
     * @param EmergencyCallerInfo ...$items Variable number of EmergencyCallerInfo items
     * @return self
     */
    public function setValue(EmergencyCallerInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
