...
/**
 * Collection response for EmergencyCallerInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EmergencyCallerInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EmergencyCallerInfo[]
     */
    private array $value = [];
     ...
     * 
     * @param EmergencyCallerInfo[] $items
     * @return self
     */
    public function setValue(array|EmergencyCallerInfo $items, EmergencyCallerInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EmergencyCallerInfo> $value
     * @return self
     ...
     * 
     * @param EmergencyCallerInfo $item
     * @return self
     */
    public function addValue(EmergencyCallerInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EmergencyCallerInfo>
     */
