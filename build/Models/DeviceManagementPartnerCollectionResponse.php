...
/**
 * Collection response for DeviceManagementPartner
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceManagementPartnerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceManagementPartner[] $items
     * @return self
     */
    public function setValue(array|DeviceManagementPartner $items, DeviceManagementPartner ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceManagementPartner> $value
     * @return self
     ...
     * 
     * @param DeviceManagementPartner $item
     * @return self
     */
    public function addValue(DeviceManagementPartner $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceManagementPartner>
     */
