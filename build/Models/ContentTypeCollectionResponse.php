...
/**
 * Collection response for ContentType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ContentTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ContentType[]
     */
     ...
     * 
     * @param ContentType[] $items
     * @return self
     */
    public function setValue(array|ContentType $items, ContentType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(ContentType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ContentType>
     */
