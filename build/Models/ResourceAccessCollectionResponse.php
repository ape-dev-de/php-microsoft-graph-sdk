...
/**
 * Collection response for ResourceAccess
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ResourceAccessCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ResourceAccess[]
     */
     ...
     * 
     * @param ResourceAccess[] $items
     * @return self
     */
    public function setValue(array|ResourceAccess $items, ResourceAccess ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ResourceAccess> $value
     * @return self
     ...
     * 
     * @param ResourceAccess $item
     * @return self
     */
    public function addValue(ResourceAccess $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ResourceAccess>
     */
