...
/**
 * Collection response for TargetManager
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TargetManagerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TargetManager[]
     */
     ...
     * 
     * @param TargetManager[] $items
     * @return self
     */
    public function setValue(array|TargetManager $items, TargetManager ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TargetManager> $value
     * @return self
     ...
     * 
     * @param TargetManager $item
     * @return self
     */
    public function addValue(TargetManager $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TargetManager>
     */
