 ...
 */
class TargetManagerCollectionResponse
{
    /**
     * @var TargetManager[]
     */
     ...
     * 
     * @param TargetManager ...$items Variable number of TargetManager items
     * @return self
     */
    public function setValue(TargetManager ...$items): self
    {
        $this->value = $items;
        return $this;
    }
