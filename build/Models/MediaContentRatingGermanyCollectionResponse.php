 ...
 */
class MediaContentRatingGermanyCollectionResponse
{
    /**
     ...
     * 
     * @param MediaContentRatingGermany ...$items Variable number of MediaContentRatingGermany items
     * @return self
     */
    public function setValue(MediaContentRatingGermany ...$items): self
    {
        $this->value = $items;
        return $this;
    }
