...
/**
 * Collection response for MediaContentRatingGermany
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MediaContentRatingGermanyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MediaContentRatingGermany[] $items
     * @return self
     */
    public function setValue(array|MediaContentRatingGermany $items, MediaContentRatingGermany ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MediaContentRatingGermany> $value
     * @return self
     ...
     * 
     * @param MediaContentRatingGermany $item
     * @return self
     */
    public function addValue(MediaContentRatingGermany $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MediaContentRatingGermany>
     */
