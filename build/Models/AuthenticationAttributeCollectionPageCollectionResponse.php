 ...
 */
class AuthenticationAttributeCollectionPageCollectionResponse
{
    /**
     ...
     * 
     * @param AuthenticationAttributeCollectionPage ...$items Variable number of AuthenticationAttributeCollectionPage items
     * @return self
     */
    public function setValue(AuthenticationAttributeCollectionPage ...$items): self
    {
        $this->value = $items;
        return $this;
    }
