...
/**
 * Collection response for AuthenticationAttributeCollectionPage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationAttributeCollectionPageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuthenticationAttributeCollectionPage[]
     */
    private array $value = [];
     ...
     * 
     * @param AuthenticationAttributeCollectionPage[] $items
     * @return self
     */
    public function setValue(array|AuthenticationAttributeCollectionPage $items, AuthenticationAttributeCollectionPage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationAttributeCollectionPage> $value
     * @return self
     ...
     * 
     * @param AuthenticationAttributeCollectionPage $item
     * @return self
     */
    public function addValue(AuthenticationAttributeCollectionPage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationAttributeCollectionPage>
     */
