...
/**
 * Collection response for DeviceActionResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceActionResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceActionResult[] $items
     * @return self
     */
    public function setValue(array|DeviceActionResult $items, DeviceActionResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceActionResult> $value
     * @return self
     ...
     * 
     * @param DeviceActionResult $item
     * @return self
     */
    public function addValue(DeviceActionResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return DeviceActionResult|null
     */
     ...
     * 
     * @return \ArrayIterator<int, DeviceActionResult>
     */
