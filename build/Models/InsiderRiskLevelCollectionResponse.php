...
/**
 * Collection response for InsiderRiskLevel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InsiderRiskLevelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var InsiderRiskLevel[]
     */
    private array $value = [];
     ...
     * 
     * @param InsiderRiskLevel[] $items
     * @return self
     */
    public function setValue(array|InsiderRiskLevel $items, InsiderRiskLevel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InsiderRiskLevel> $value
     * @return self
     ...
     * 
     * @param InsiderRiskLevel $item
     * @return self
     */
    public function addValue(InsiderRiskLevel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, InsiderRiskLevel>
     */
