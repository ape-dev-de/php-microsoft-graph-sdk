 ...
 */
class OmaSettingStringCollectionResponse
{
    /**
     ...
     * 
     * @param OmaSettingString ...$items Variable number of OmaSettingString items
     * @return self
     */
    public function setValue(OmaSettingString ...$items): self
    {
        $this->value = $items;
        return $this;
    }
