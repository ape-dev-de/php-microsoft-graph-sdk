...
/**
 * Collection response for OmaSettingString
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OmaSettingStringCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OmaSettingString[]
     */
    private array $value = [];
     ...
     * 
     * @param OmaSettingString[] $items
     * @return self
     */
    public function setValue(array|OmaSettingString $items, OmaSettingString ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OmaSettingString> $value
     * @return self
     ...
     * 
     * @param OmaSettingString $item
     * @return self
     */
    public function addValue(OmaSettingString $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OmaSettingString>
     */
