...
/**
 * Collection response for OnenoteSectionCollectionResponse
 */
class OnenoteSectionCollectionResponseCollectionResponse
{
    /**
     * @var OnenoteSectionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param OnenoteSectionCollectionResponse ...$items Variable number of OnenoteSectionCollectionResponse items
     * @return self
     */
    public function setValue(OnenoteSectionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<OnenoteSectionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param OnenoteSectionCollectionResponse $item
     * @return self
     */
    public function addValue(OnenoteSectionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
