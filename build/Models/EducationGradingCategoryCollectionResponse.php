...
/**
 * Collection response for EducationGradingCategory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationGradingCategoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param EducationGradingCategory[] $items
     * @return self
     */
    public function setValue(array|EducationGradingCategory $items, EducationGradingCategory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationGradingCategory> $value
     * @return self
     ...
     * 
     * @param EducationGradingCategory $item
     * @return self
     */
    public function addValue(EducationGradingCategory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationGradingCategory>
     */
