...
/**
 * Collection response for UserExperienceAnalyticsSummarizedBy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsSummarizedByCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserExperienceAnalyticsSummarizedBy[]
     */
    private array $value = [];
     ...
     * 
     * @return UserExperienceAnalyticsSummarizedBy[]
     */
     ...
     * 
     * @param UserExperienceAnalyticsSummarizedBy[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsSummarizedBy $items, UserExperienceAnalyticsSummarizedBy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsSummarizedBy> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsSummarizedBy $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsSummarizedBy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UserExperienceAnalyticsSummarizedBy|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsSummarizedBy>
     */
