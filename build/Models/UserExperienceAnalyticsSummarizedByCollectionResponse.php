...
/**
 * UserExperienceAnalyticsSummarizedByCollectionResponse - Collection response
 */
class UserExperienceAnalyticsSummarizedByCollectionResponse
{
    /**
     * @var array<int, UserExperienceAnalyticsSummarizedBy>
     */
    public array $value = [];
