...
/**
 * Collection response for UnifiedRoleManagementPolicyApprovalRule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRoleManagementPolicyApprovalRuleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UnifiedRoleManagementPolicyApprovalRule[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedRoleManagementPolicyApprovalRule[] $items
     * @return self
     */
    public function setValue(array|UnifiedRoleManagementPolicyApprovalRule $items, UnifiedRoleManagementPolicyApprovalRule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRoleManagementPolicyApprovalRule> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleManagementPolicyApprovalRule $item
     * @return self
     */
    public function addValue(UnifiedRoleManagementPolicyApprovalRule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UnifiedRoleManagementPolicyApprovalRule|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRoleManagementPolicyApprovalRule>
     */
