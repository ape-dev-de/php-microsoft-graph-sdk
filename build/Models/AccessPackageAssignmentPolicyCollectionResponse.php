...
/**
 * Collection response for AccessPackageAssignmentPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageAssignmentPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessPackageAssignmentPolicy[] $items
     * @return self
     */
    public function setValue(array|AccessPackageAssignmentPolicy $items, AccessPackageAssignmentPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageAssignmentPolicy> $value
     * @return self
     ...
     * 
     * @param AccessPackageAssignmentPolicy $item
     * @return self
     */
    public function addValue(AccessPackageAssignmentPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageAssignmentPolicy>
     */
