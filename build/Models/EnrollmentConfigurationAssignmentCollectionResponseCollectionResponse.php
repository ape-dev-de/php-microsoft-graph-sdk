...
/**
 * Collection response for EnrollmentConfigurationAssignmentCollectionResponse
 */
class EnrollmentConfigurationAssignmentCollectionResponseCollectionResponse
{
    /**
     * @var EnrollmentConfigurationAssignmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EnrollmentConfigurationAssignmentCollectionResponse ...$items Variable number of EnrollmentConfigurationAssignmentCollectionResponse items
     * @return self
     */
    public function setValue(EnrollmentConfigurationAssignmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EnrollmentConfigurationAssignmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EnrollmentConfigurationAssignmentCollectionResponse $item
     * @return self
     */
    public function addValue(EnrollmentConfigurationAssignmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
