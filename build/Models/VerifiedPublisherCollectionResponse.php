 ...
 */
class VerifiedPublisherCollectionResponse
{
    /**
     ...
     * 
     * @param VerifiedPublisher ...$items Variable number of VerifiedPublisher items
     * @return self
     */
    public function setValue(VerifiedPublisher ...$items): self
    {
        $this->value = $items;
        return $this;
    }
