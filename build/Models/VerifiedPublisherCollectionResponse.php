...
/**
 * Collection response for VerifiedPublisher
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VerifiedPublisherCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VerifiedPublisher[]
     */
    private array $value = [];
     ...
     * 
     * @param VerifiedPublisher[] $items
     * @return self
     */
    public function setValue(array|VerifiedPublisher $items, VerifiedPublisher ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VerifiedPublisher> $value
     * @return self
     ...
     * 
     * @param VerifiedPublisher $item
     * @return self
     */
    public function addValue(VerifiedPublisher $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VerifiedPublisher>
     */
