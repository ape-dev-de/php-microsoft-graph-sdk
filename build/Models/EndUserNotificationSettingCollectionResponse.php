 ...
 */
class EndUserNotificationSettingCollectionResponse
{
    /**
     ...
     * 
     * @param EndUserNotificationSetting ...$items Variable number of EndUserNotificationSetting items
     * @return self
     */
    public function setValue(EndUserNotificationSetting ...$items): self
    {
        $this->value = $items;
        return $this;
    }
