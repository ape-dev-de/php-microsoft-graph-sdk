...
/**
 * Collection response for EndUserNotificationSetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EndUserNotificationSettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EndUserNotificationSetting[]
     */
    private array $value = [];
     ...
     * 
     * @param EndUserNotificationSetting[] $items
     * @return self
     */
    public function setValue(array|EndUserNotificationSetting $items, EndUserNotificationSetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EndUserNotificationSetting> $value
     * @return self
     ...
     * 
     * @param EndUserNotificationSetting $item
     * @return self
     */
    public function addValue(EndUserNotificationSetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EndUserNotificationSetting>
     */
