...
/**
 * Collection response for IdentityProviderCollectionResponse
 */
class IdentityProviderCollectionResponseCollectionResponse
{
    /**
     * @var IdentityProviderCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityProviderCollectionResponse ...$items Variable number of IdentityProviderCollectionResponse items
     * @return self
     */
    public function setValue(IdentityProviderCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IdentityProviderCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IdentityProviderCollectionResponse $item
     * @return self
     */
    public function addValue(IdentityProviderCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
