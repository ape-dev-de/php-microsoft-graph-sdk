...
/**
 * Collection response for SoftwareOathAuthenticationMethod
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SoftwareOathAuthenticationMethodCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SoftwareOathAuthenticationMethod[] $items
     * @return self
     */
    public function setValue(array|SoftwareOathAuthenticationMethod $items, SoftwareOathAuthenticationMethod ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SoftwareOathAuthenticationMethod> $value
     * @return self
     ...
     * 
     * @param SoftwareOathAuthenticationMethod $item
     * @return self
     */
    public function addValue(SoftwareOathAuthenticationMethod $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SoftwareOathAuthenticationMethod>
     */
