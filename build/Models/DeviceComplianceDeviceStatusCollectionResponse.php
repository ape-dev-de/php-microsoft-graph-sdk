...
/**
 * Collection response for DeviceComplianceDeviceStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceComplianceDeviceStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceComplianceDeviceStatus[] $items
     * @return self
     */
    public function setValue(array|DeviceComplianceDeviceStatus $items, DeviceComplianceDeviceStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceComplianceDeviceStatus> $value
     * @return self
     ...
     * 
     * @param DeviceComplianceDeviceStatus $item
     * @return self
     */
    public function addValue(DeviceComplianceDeviceStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceComplianceDeviceStatus>
     */
