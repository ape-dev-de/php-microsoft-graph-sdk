...
/**
 * Collection response for RegistryValueType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RegistryValueTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param RegistryValueType[] $items
     * @return self
     */
    public function setValue(array|RegistryValueType $items, RegistryValueType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RegistryValueType> $value
     * @return self
     ...
     * 
     * @param RegistryValueType $item
     * @return self
     */
    public function addValue(RegistryValueType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RegistryValueType>
     */
