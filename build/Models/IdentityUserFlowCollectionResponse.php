 ...
 */
class IdentityUserFlowCollectionResponse
{
    /**
     ...
     * 
     * @param IdentityUserFlow ...$items Variable number of IdentityUserFlow items
     * @return self
     */
    public function setValue(IdentityUserFlow ...$items): self
    {
        $this->value = $items;
        return $this;
    }
