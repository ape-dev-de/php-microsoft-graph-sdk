...
/**
 * Collection response for IdentityUserFlow
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityUserFlowCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityUserFlow[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityUserFlow[] $items
     * @return self
     */
    public function setValue(array|IdentityUserFlow $items, IdentityUserFlow ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityUserFlow> $value
     * @return self
     ...
     * 
     * @param IdentityUserFlow $item
     * @return self
     */
    public function addValue(IdentityUserFlow $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityUserFlow>
     */
