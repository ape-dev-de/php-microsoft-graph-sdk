...
/**
 * Collection response for BackupServiceConsumer
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BackupServiceConsumerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BackupServiceConsumer[]
     */
    private array $value = [];
     ...
     * 
     * @param BackupServiceConsumer[] $items
     * @return self
     */
    public function setValue(array|BackupServiceConsumer $items, BackupServiceConsumer ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BackupServiceConsumer> $value
     * @return self
     ...
     * 
     * @param BackupServiceConsumer $item
     * @return self
     */
    public function addValue(BackupServiceConsumer $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BackupServiceConsumer>
     */
