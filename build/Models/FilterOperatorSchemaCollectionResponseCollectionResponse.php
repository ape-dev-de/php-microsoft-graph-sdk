...
/**
 * Collection response for FilterOperatorSchemaCollectionResponse
 */
class FilterOperatorSchemaCollectionResponseCollectionResponse
{
    /**
     * @var FilterOperatorSchemaCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param FilterOperatorSchemaCollectionResponse ...$items Variable number of FilterOperatorSchemaCollectionResponse items
     * @return self
     */
    public function setValue(FilterOperatorSchemaCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<FilterOperatorSchemaCollectionResponse> $value
     * @return self
     ...
     * 
     * @param FilterOperatorSchemaCollectionResponse $item
     * @return self
     */
    public function addValue(FilterOperatorSchemaCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
