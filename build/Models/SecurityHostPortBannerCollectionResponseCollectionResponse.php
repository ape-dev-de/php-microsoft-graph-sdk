...
/**
 * Collection response for SecurityHostPortBannerCollectionResponse
 */
class SecurityHostPortBannerCollectionResponseCollectionResponse
{
    /**
     * @var SecurityHostPortBannerCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityHostPortBannerCollectionResponse[]
     */
     ...
     * 
     * @param SecurityHostPortBannerCollectionResponse ...$items Variable number of SecurityHostPortBannerCollectionResponse items
     * @return self
     */
    public function setValue(SecurityHostPortBannerCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityHostPortBannerCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityHostPortBannerCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityHostPortBannerCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
