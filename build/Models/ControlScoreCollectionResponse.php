...
/**
 * Collection response for ControlScore
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ControlScoreCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ControlScore[]
     */
     ...
     * 
     * @param ControlScore[] $items
     * @return self
     */
    public function setValue(array|ControlScore $items, ControlScore ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ControlScore> $value
     * @return self
     ...
     * 
     * @param ControlScore $item
     * @return self
     */
    public function addValue(ControlScore $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ControlScore>
     */
