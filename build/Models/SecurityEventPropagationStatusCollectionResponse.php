...
/**
 * Collection response for SecurityEventPropagationStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityEventPropagationStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityEventPropagationStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityEventPropagationStatus[]
     */
     ...
     * 
     * @param SecurityEventPropagationStatus[] $items
     * @return self
     */
    public function setValue(array|SecurityEventPropagationStatus $items, SecurityEventPropagationStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityEventPropagationStatus> $value
     * @return self
     ...
     * 
     * @param SecurityEventPropagationStatus $item
     * @return self
     */
    public function addValue(SecurityEventPropagationStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityEventPropagationStatus|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityEventPropagationStatus>
     */
