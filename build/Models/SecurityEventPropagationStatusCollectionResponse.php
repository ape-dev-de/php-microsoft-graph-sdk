...
/**
 * SecurityEventPropagationStatusCollectionResponse - Collection response
 */
class SecurityEventPropagationStatusCollectionResponse
{
    /**
     * @var array<int, SecurityEventPropagationStatus>
     */
    public array $value = [];
