 ...
 */
class MultiTenantOrganizationMemberTransitionDetailsCollectionResponse
{
    /**
     ...
     * 
     * @param MultiTenantOrganizationMemberTransitionDetails ...$items Variable number of MultiTenantOrganizationMemberTransitionDetails items
     * @return self
     */
    public function setValue(MultiTenantOrganizationMemberTransitionDetails ...$items): self
    {
        $this->value = $items;
        return $this;
    }
