...
/**
 * Collection response for MultiTenantOrganizationMemberTransitionDetails
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MultiTenantOrganizationMemberTransitionDetailsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MultiTenantOrganizationMemberTransitionDetails[]
     */
    private array $value = [];
     ...
     * 
     * @param MultiTenantOrganizationMemberTransitionDetails[] $items
     * @return self
     */
    public function setValue(array|MultiTenantOrganizationMemberTransitionDetails $items, MultiTenantOrganizationMemberTransitionDetails ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MultiTenantOrganizationMemberTransitionDetails> $value
     * @return self
     ...
     * 
     * @param MultiTenantOrganizationMemberTransitionDetails $item
     * @return self
     */
    public function addValue(MultiTenantOrganizationMemberTransitionDetails $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MultiTenantOrganizationMemberTransitionDetails>
     */
