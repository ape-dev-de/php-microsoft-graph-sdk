...
/**
 * Collection response for DelegatedAdminCustomerCollectionResponse
 */
class DelegatedAdminCustomerCollectionResponseCollectionResponse
{
    /**
     * @var DelegatedAdminCustomerCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DelegatedAdminCustomerCollectionResponse ...$items Variable number of DelegatedAdminCustomerCollectionResponse items
     * @return self
     */
    public function setValue(DelegatedAdminCustomerCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DelegatedAdminCustomerCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DelegatedAdminCustomerCollectionResponse $item
     * @return self
     */
    public function addValue(DelegatedAdminCustomerCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
