...
/**
 * Collection response for SubjectRightsRequestEnumeratedSiteLocation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SubjectRightsRequestEnumeratedSiteLocationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SubjectRightsRequestEnumeratedSiteLocation[]
     */
    private array $value = [];
     ...
     * 
     * @param SubjectRightsRequestEnumeratedSiteLocation[] $items
     * @return self
     */
    public function setValue(array|SubjectRightsRequestEnumeratedSiteLocation $items, SubjectRightsRequestEnumeratedSiteLocation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SubjectRightsRequestEnumeratedSiteLocation> $value
     * @return self
     ...
     * 
     * @param SubjectRightsRequestEnumeratedSiteLocation $item
     * @return self
     */
    public function addValue(SubjectRightsRequestEnumeratedSiteLocation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SubjectRightsRequestEnumeratedSiteLocation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SubjectRightsRequestEnumeratedSiteLocation>
     */
