 ...
 */
class SubjectRightsRequestEnumeratedSiteLocationCollectionResponse
{
    /**
     ...
     * 
     * @param SubjectRightsRequestEnumeratedSiteLocation ...$items Variable number of SubjectRightsRequestEnumeratedSiteLocation items
     * @return self
     */
    public function setValue(SubjectRightsRequestEnumeratedSiteLocation ...$items): self
    {
        $this->value = $items;
        return $this;
    }
