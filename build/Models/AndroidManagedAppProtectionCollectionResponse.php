...
/**
 * Collection response for AndroidManagedAppProtection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AndroidManagedAppProtectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AndroidManagedAppProtection[] $items
     * @return self
     */
    public function setValue(array|AndroidManagedAppProtection $items, AndroidManagedAppProtection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AndroidManagedAppProtection> $value
     * @return self
     ...
     * 
     * @param AndroidManagedAppProtection $item
     * @return self
     */
    public function addValue(AndroidManagedAppProtection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AndroidManagedAppProtection>
     */
