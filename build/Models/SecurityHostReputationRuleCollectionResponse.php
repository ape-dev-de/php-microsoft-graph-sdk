...
/**
 * SecurityHostReputationRuleCollectionResponse - Collection response
 */
class SecurityHostReputationRuleCollectionResponse
{
    /**
     * @var array<int, SecurityHostReputationRule>
     */
    public array $value = [];
