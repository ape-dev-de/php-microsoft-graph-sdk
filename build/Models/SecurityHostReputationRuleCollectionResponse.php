...
/**
 * Collection response for SecurityHostReputationRule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHostReputationRuleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return SecurityHostReputationRule[]
     */
     ...
     * 
     * @param SecurityHostReputationRule[] $items
     * @return self
     */
    public function setValue(array|SecurityHostReputationRule $items, SecurityHostReputationRule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHostReputationRule> $value
     * @return self
     ...
     * 
     * @param SecurityHostReputationRule $item
     * @return self
     */
    public function addValue(SecurityHostReputationRule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityHostReputationRule|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityHostReputationRule>
     */
