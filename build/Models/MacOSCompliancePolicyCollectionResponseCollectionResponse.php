...
/**
 * Collection response for MacOSCompliancePolicyCollectionResponse
 */
class MacOSCompliancePolicyCollectionResponseCollectionResponse
{
    /**
     * @var MacOSCompliancePolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MacOSCompliancePolicyCollectionResponse ...$items Variable number of MacOSCompliancePolicyCollectionResponse items
     * @return self
     */
    public function setValue(MacOSCompliancePolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MacOSCompliancePolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MacOSCompliancePolicyCollectionResponse $item
     * @return self
     */
    public function addValue(MacOSCompliancePolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
