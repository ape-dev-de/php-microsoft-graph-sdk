...
/**
 * Collection response for Team
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Team[]
     */
     ...
     * @return self
     */
    public function setValue(array|Team $items, Team ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Team $item): self
    {
        $this->value[] = $item;
        return $this;
    }
