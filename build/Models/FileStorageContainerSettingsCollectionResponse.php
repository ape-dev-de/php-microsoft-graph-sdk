 ...
 */
class FileStorageContainerSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param FileStorageContainerSettings ...$items Variable number of FileStorageContainerSettings items
     * @return self
     */
    public function setValue(FileStorageContainerSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
