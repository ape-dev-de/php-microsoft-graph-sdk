...
/**
 * Collection response for FileStorageContainerSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FileStorageContainerSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FileStorageContainerSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param FileStorageContainerSettings[] $items
     * @return self
     */
    public function setValue(array|FileStorageContainerSettings $items, FileStorageContainerSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FileStorageContainerSettings> $value
     * @return self
     ...
     * 
     * @param FileStorageContainerSettings $item
     * @return self
     */
    public function addValue(FileStorageContainerSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FileStorageContainerSettings>
     */
