 ...
 */
class MediaContentRatingJapanCollectionResponse
{
    /**
     ...
     * 
     * @param MediaContentRatingJapan ...$items Variable number of MediaContentRatingJapan items
     * @return self
     */
    public function setValue(MediaContentRatingJapan ...$items): self
    {
        $this->value = $items;
        return $this;
    }
