...
/**
 * Collection response for MediaContentRatingJapan
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MediaContentRatingJapanCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MediaContentRatingJapan[] $items
     * @return self
     */
    public function setValue(array|MediaContentRatingJapan $items, MediaContentRatingJapan ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MediaContentRatingJapan> $value
     * @return self
     ...
     * 
     * @param MediaContentRatingJapan $item
     * @return self
     */
    public function addValue(MediaContentRatingJapan $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MediaContentRatingJapan>
     */
