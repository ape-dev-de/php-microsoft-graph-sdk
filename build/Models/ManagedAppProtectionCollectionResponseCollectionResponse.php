...
/**
 * Collection response for ManagedAppProtectionCollectionResponse
 */
class ManagedAppProtectionCollectionResponseCollectionResponse
{
    /**
     * @var ManagedAppProtectionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedAppProtectionCollectionResponse ...$items Variable number of ManagedAppProtectionCollectionResponse items
     * @return self
     */
    public function setValue(ManagedAppProtectionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ManagedAppProtectionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ManagedAppProtectionCollectionResponse $item
     * @return self
     */
    public function addValue(ManagedAppProtectionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
