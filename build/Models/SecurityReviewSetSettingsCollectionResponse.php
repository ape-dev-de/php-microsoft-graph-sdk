...
/**
 * Collection response for SecurityReviewSetSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityReviewSetSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityReviewSetSettings[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityReviewSetSettings[]
     */
     ...
     * 
     * @param SecurityReviewSetSettings[] $items
     * @return self
     */
    public function setValue(array|SecurityReviewSetSettings $items, SecurityReviewSetSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityReviewSetSettings> $value
     * @return self
     ...
     * 
     * @param SecurityReviewSetSettings $item
     * @return self
     */
    public function addValue(SecurityReviewSetSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityReviewSetSettings|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityReviewSetSettings>
     */
