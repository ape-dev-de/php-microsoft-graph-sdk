...
/**
 * SecurityReviewSetSettingsCollectionResponse - Collection response
 */
class SecurityReviewSetSettingsCollectionResponse
{
    /**
     * @var array<int, SecurityReviewSetSettings>
     */
    public array $value = [];
