...
/**
 * Collection response for TermStoreLocalizedLabelCollectionResponse
 */
class TermStoreLocalizedLabelCollectionResponseCollectionResponse
{
    /**
     * @var TermStoreLocalizedLabelCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return TermStoreLocalizedLabelCollectionResponse[]
     */
     ...
     * 
     * @param TermStoreLocalizedLabelCollectionResponse ...$items Variable number of TermStoreLocalizedLabelCollectionResponse items
     * @return self
     */
    public function setValue(TermStoreLocalizedLabelCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TermStoreLocalizedLabelCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TermStoreLocalizedLabelCollectionResponse $item
     * @return self
     */
    public function addValue(TermStoreLocalizedLabelCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
