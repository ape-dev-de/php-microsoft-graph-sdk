...
/**
 * Collection response for CollapsePropertyCollectionResponse
 */
class CollapsePropertyCollectionResponseCollectionResponse
{
    /**
     * @var CollapsePropertyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CollapsePropertyCollectionResponse ...$items Variable number of CollapsePropertyCollectionResponse items
     * @return self
     */
    public function setValue(CollapsePropertyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CollapsePropertyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CollapsePropertyCollectionResponse $item
     * @return self
     */
    public function addValue(CollapsePropertyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
