...
/**
 * Collection response for AccessPackageAssignmentRequestWorkflowExtension
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageAssignmentRequestWorkflowExtensionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageAssignmentRequestWorkflowExtension[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageAssignmentRequestWorkflowExtension[] $items
     * @return self
     */
    public function setValue(array|AccessPackageAssignmentRequestWorkflowExtension $items, AccessPackageAssignmentRequestWorkflowExtension ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageAssignmentRequestWorkflowExtension> $value
     * @return self
     ...
     * 
     * @param AccessPackageAssignmentRequestWorkflowExtension $item
     * @return self
     */
    public function addValue(AccessPackageAssignmentRequestWorkflowExtension $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessPackageAssignmentRequestWorkflowExtension|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageAssignmentRequestWorkflowExtension>
     */
