...
/**
 * Collection response for ItemBody
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ItemBodyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ItemBody[]
     */
     ...
     * 
     * @param ItemBody[] $items
     * @return self
     */
    public function setValue(array|ItemBody $items, ItemBody ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(ItemBody $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ItemBody>
     */
