...
/**
 * Collection response for BookingServiceCollectionResponse
 */
class BookingServiceCollectionResponseCollectionResponse
{
    /**
     * @var BookingServiceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BookingServiceCollectionResponse ...$items Variable number of BookingServiceCollectionResponse items
     * @return self
     */
    public function setValue(BookingServiceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<BookingServiceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param BookingServiceCollectionResponse $item
     * @return self
     */
    public function addValue(BookingServiceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
