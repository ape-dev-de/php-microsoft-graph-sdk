...
/**
 * Collection response for VirtualEventRegistrationCollectionResponse
 */
class VirtualEventRegistrationCollectionResponseCollectionResponse
{
    /**
     * @var VirtualEventRegistrationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param VirtualEventRegistrationCollectionResponse ...$items Variable number of VirtualEventRegistrationCollectionResponse items
     * @return self
     */
    public function setValue(VirtualEventRegistrationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<VirtualEventRegistrationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param VirtualEventRegistrationCollectionResponse $item
     * @return self
     */
    public function addValue(VirtualEventRegistrationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
