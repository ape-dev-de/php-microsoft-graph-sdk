...
/**
 * WindowsInformationProtectionStoreAppCollectionResponse - Collection response
 */
class WindowsInformationProtectionStoreAppCollectionResponse
{
    /**
     * @var array<int, WindowsInformationProtectionStoreApp>
     */
    public array $value = [];
