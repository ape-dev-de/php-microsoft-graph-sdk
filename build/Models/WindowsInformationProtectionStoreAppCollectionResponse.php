...
/**
 * Collection response for WindowsInformationProtectionStoreApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsInformationProtectionStoreAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsInformationProtectionStoreApp[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsInformationProtectionStoreApp[] $items
     * @return self
     */
    public function setValue(array|WindowsInformationProtectionStoreApp $items, WindowsInformationProtectionStoreApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsInformationProtectionStoreApp> $value
     * @return self
     ...
     * 
     * @param WindowsInformationProtectionStoreApp $item
     * @return self
     */
    public function addValue(WindowsInformationProtectionStoreApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WindowsInformationProtectionStoreApp|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WindowsInformationProtectionStoreApp>
     */
