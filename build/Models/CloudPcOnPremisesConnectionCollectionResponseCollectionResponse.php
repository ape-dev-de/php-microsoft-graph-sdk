...
/**
 * Collection response for CloudPcOnPremisesConnectionCollectionResponse
 */
class CloudPcOnPremisesConnectionCollectionResponseCollectionResponse
{
    /**
     * @var CloudPcOnPremisesConnectionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudPcOnPremisesConnectionCollectionResponse ...$items Variable number of CloudPcOnPremisesConnectionCollectionResponse items
     * @return self
     */
    public function setValue(CloudPcOnPremisesConnectionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CloudPcOnPremisesConnectionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CloudPcOnPremisesConnectionCollectionResponse $item
     * @return self
     */
    public function addValue(CloudPcOnPremisesConnectionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
