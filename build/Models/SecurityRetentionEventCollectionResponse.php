...
/**
 * Collection response for SecurityRetentionEvent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityRetentionEventCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityRetentionEvent[] $items
     * @return self
     */
    public function setValue(array|SecurityRetentionEvent $items, SecurityRetentionEvent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityRetentionEvent> $value
     * @return self
     ...
     * 
     * @param SecurityRetentionEvent $item
     * @return self
     */
    public function addValue(SecurityRetentionEvent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityRetentionEvent>
     */
