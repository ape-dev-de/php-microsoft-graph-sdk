...
/**
 * Collection response for TeamworkTagMemberCollectionResponse
 */
class TeamworkTagMemberCollectionResponseCollectionResponse
{
    /**
     * @var TeamworkTagMemberCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamworkTagMemberCollectionResponse ...$items Variable number of TeamworkTagMemberCollectionResponse items
     * @return self
     */
    public function setValue(TeamworkTagMemberCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TeamworkTagMemberCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TeamworkTagMemberCollectionResponse $item
     * @return self
     */
    public function addValue(TeamworkTagMemberCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
