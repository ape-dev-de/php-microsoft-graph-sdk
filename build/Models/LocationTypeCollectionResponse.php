...
/**
 * Collection response for LocationType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LocationTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var LocationType[]
     */
     ...
     * 
     * @param LocationType[] $items
     * @return self
     */
    public function setValue(array|LocationType $items, LocationType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LocationType> $value
     * @return self
     ...
     * @return self
     */
    public function addValue(LocationType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LocationType>
     */
