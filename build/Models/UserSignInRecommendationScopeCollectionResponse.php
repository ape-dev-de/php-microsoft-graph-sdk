...
/**
 * UserSignInRecommendationScopeCollectionResponse - Collection response
 */
class UserSignInRecommendationScopeCollectionResponse
{
    /**
     * @var array<int, UserSignInRecommendationScope>
     */
    public array $value = [];
