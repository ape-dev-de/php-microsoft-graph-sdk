...
/**
 * Collection response for UserSignInRecommendationScope
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserSignInRecommendationScopeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserSignInRecommendationScope[]
     */
    private array $value = [];
     ...
     * 
     * @return UserSignInRecommendationScope[]
     */
     ...
     * 
     * @param UserSignInRecommendationScope[] $items
     * @return self
     */
    public function setValue(array|UserSignInRecommendationScope $items, UserSignInRecommendationScope ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserSignInRecommendationScope> $value
     * @return self
     ...
     * 
     * @param UserSignInRecommendationScope $item
     * @return self
     */
    public function addValue(UserSignInRecommendationScope $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserSignInRecommendationScope>
     */
