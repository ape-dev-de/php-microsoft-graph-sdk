...
/**
 * Collection response for SecurityHostTracker
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHostTrackerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityHostTracker[] $items
     * @return self
     */
    public function setValue(array|SecurityHostTracker $items, SecurityHostTracker ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHostTracker> $value
     * @return self
     ...
     * 
     * @param SecurityHostTracker $item
     * @return self
     */
    public function addValue(SecurityHostTracker $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityHostTracker>
     */
