...
/**
 * Collection response for AppConfigurationSettingItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppConfigurationSettingItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AppConfigurationSettingItem[]
     */
    private array $value = [];
     ...
     * 
     * @param AppConfigurationSettingItem[] $items
     * @return self
     */
    public function setValue(array|AppConfigurationSettingItem $items, AppConfigurationSettingItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppConfigurationSettingItem> $value
     * @return self
     ...
     * 
     * @param AppConfigurationSettingItem $item
     * @return self
     */
    public function addValue(AppConfigurationSettingItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AppConfigurationSettingItem|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AppConfigurationSettingItem>
     */
