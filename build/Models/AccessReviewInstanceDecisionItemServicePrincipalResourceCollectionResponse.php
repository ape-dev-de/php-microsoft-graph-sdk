...
/**
 * AccessReviewInstanceDecisionItemServicePrincipalResourceCollectionResponse - Collection response
 */
class AccessReviewInstanceDecisionItemServicePrincipalResourceCollectionResponse
{
    /**
     * @var array<int, AccessReviewInstanceDecisionItemServicePrincipalResource>
     */
    public array $value = [];
