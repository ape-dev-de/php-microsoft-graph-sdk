...
/**
 * Collection response for AccessReviewInstanceDecisionItemServicePrincipalResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewInstanceDecisionItemServicePrincipalResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessReviewInstanceDecisionItemServicePrincipalResource[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessReviewInstanceDecisionItemServicePrincipalResource[] $items
     * @return self
     */
    public function setValue(array|AccessReviewInstanceDecisionItemServicePrincipalResource $items, AccessReviewInstanceDecisionItemServicePrincipalResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewInstanceDecisionItemServicePrincipalResource> $value
     * @return self
     ...
     * 
     * @param AccessReviewInstanceDecisionItemServicePrincipalResource $item
     * @return self
     */
    public function addValue(AccessReviewInstanceDecisionItemServicePrincipalResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessReviewInstanceDecisionItemServicePrincipalResource|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewInstanceDecisionItemServicePrincipalResource>
     */
