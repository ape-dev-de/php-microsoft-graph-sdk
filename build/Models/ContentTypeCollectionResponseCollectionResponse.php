...
/**
 * Collection response for ContentTypeCollectionResponse
 */
class ContentTypeCollectionResponseCollectionResponse
{
    /**
     * @var ContentTypeCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ContentTypeCollectionResponse ...$items Variable number of ContentTypeCollectionResponse items
     * @return self
     */
    public function setValue(ContentTypeCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ContentTypeCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ContentTypeCollectionResponse $item
     * @return self
     */
    public function addValue(ContentTypeCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
