...
/**
 * Collection response for TrainingLanguageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TrainingLanguageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TrainingLanguageDetail[] $items
     * @return self
     */
    public function setValue(array|TrainingLanguageDetail $items, TrainingLanguageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TrainingLanguageDetail> $value
     * @return self
     ...
     * 
     * @param TrainingLanguageDetail $item
     * @return self
     */
    public function addValue(TrainingLanguageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TrainingLanguageDetail>
     */
