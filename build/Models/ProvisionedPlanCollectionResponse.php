...
/**
 * Collection response for ProvisionedPlan
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProvisionedPlanCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProvisionedPlan[]
     */
     ...
     * 
     * @param ProvisionedPlan[] $items
     * @return self
     */
    public function setValue(array|ProvisionedPlan $items, ProvisionedPlan ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProvisionedPlan> $value
     * @return self
     ...
     * 
     * @param ProvisionedPlan $item
     * @return self
     */
    public function addValue(ProvisionedPlan $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProvisionedPlan>
     */
