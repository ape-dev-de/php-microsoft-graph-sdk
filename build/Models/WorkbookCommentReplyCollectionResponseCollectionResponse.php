...
/**
 * Collection response for WorkbookCommentReplyCollectionResponse
 */
class WorkbookCommentReplyCollectionResponseCollectionResponse
{
    /**
     * @var WorkbookCommentReplyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookCommentReplyCollectionResponse ...$items Variable number of WorkbookCommentReplyCollectionResponse items
     * @return self
     */
    public function setValue(WorkbookCommentReplyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WorkbookCommentReplyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WorkbookCommentReplyCollectionResponse $item
     * @return self
     */
    public function addValue(WorkbookCommentReplyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
