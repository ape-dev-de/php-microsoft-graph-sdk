...
/**
 * Collection response for BrowserSiteMergeType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BrowserSiteMergeTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BrowserSiteMergeType[]
     */
    private array $value = [];
     ...
     * 
     * @param BrowserSiteMergeType[] $items
     * @return self
     */
    public function setValue(array|BrowserSiteMergeType $items, BrowserSiteMergeType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BrowserSiteMergeType> $value
     * @return self
     ...
     * 
     * @param BrowserSiteMergeType $item
     * @return self
     */
    public function addValue(BrowserSiteMergeType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BrowserSiteMergeType>
     */
