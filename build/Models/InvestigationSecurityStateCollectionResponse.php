...
/**
 * Collection response for InvestigationSecurityState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InvestigationSecurityStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var InvestigationSecurityState[]
     */
    private array $value = [];
     ...
     * 
     * @param InvestigationSecurityState[] $items
     * @return self
     */
    public function setValue(array|InvestigationSecurityState $items, InvestigationSecurityState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InvestigationSecurityState> $value
     * @return self
     ...
     * 
     * @param InvestigationSecurityState $item
     * @return self
     */
    public function addValue(InvestigationSecurityState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return InvestigationSecurityState|null
     */
     ...
     * 
     * @return \ArrayIterator<int, InvestigationSecurityState>
     */
