...
/**
 * Collection response for AiInteractionPluginCollectionResponse
 */
class AiInteractionPluginCollectionResponseCollectionResponse
{
    /**
     * @var AiInteractionPluginCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return AiInteractionPluginCollectionResponse[]
     */
     ...
     * 
     * @param AiInteractionPluginCollectionResponse ...$items Variable number of AiInteractionPluginCollectionResponse items
     * @return self
     */
    public function setValue(AiInteractionPluginCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AiInteractionPluginCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AiInteractionPluginCollectionResponse $item
     * @return self
     */
    public function addValue(AiInteractionPluginCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
