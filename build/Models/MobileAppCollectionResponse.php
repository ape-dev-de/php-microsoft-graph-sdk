...
/**
 * Collection response for MobileApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MobileAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MobileApp[]
     */
     ...
     * 
     * @param MobileApp[] $items
     * @return self
     */
    public function setValue(array|MobileApp $items, MobileApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param MobileApp $item
     * @return self
     */
    public function addValue(MobileApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MobileApp>
     */
