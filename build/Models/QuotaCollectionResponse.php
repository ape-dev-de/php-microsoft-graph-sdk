...
/**
 * Collection response for Quota
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class QuotaCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Quota[]
     */
     ...
     * @return self
     */
    public function setValue(array|Quota $items, Quota ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Quota $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Quota>
     */
