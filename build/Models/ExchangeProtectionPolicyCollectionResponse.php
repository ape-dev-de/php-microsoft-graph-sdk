...
/**
 * Collection response for ExchangeProtectionPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExchangeProtectionPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ExchangeProtectionPolicy[] $items
     * @return self
     */
    public function setValue(array|ExchangeProtectionPolicy $items, ExchangeProtectionPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExchangeProtectionPolicy> $value
     * @return self
     ...
     * 
     * @param ExchangeProtectionPolicy $item
     * @return self
     */
    public function addValue(ExchangeProtectionPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ExchangeProtectionPolicy>
     */
