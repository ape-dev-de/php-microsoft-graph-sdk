...
/**
 * Collection response for AttributeSetCollectionResponse
 */
class AttributeSetCollectionResponseCollectionResponse
{
    /**
     * @var AttributeSetCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AttributeSetCollectionResponse ...$items Variable number of AttributeSetCollectionResponse items
     * @return self
     */
    public function setValue(AttributeSetCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AttributeSetCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AttributeSetCollectionResponse $item
     * @return self
     */
    public function addValue(AttributeSetCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
