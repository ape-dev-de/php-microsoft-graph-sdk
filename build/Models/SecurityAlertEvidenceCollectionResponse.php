...
/**
 * Collection response for SecurityAlertEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityAlertEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityAlertEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityAlertEvidence $items, SecurityAlertEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityAlertEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityAlertEvidence $item
     * @return self
     */
    public function addValue(SecurityAlertEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityAlertEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityAlertEvidence>
     */
