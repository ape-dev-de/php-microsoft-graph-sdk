...
class AuthenticationStrengthPolicy
{
     ...
     * @var string[]
     */
    private array $combinationConfigurations = [];
    ...
    /**
     * @param string[] $combinationConfigurations
     */
    public function setCombinationConfigurations(array $combinationConfigurations): self
    {
