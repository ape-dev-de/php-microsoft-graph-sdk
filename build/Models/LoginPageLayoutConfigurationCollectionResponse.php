 ...
 */
class LoginPageLayoutConfigurationCollectionResponse
{
    /**
     ...
     * 
     * @param LoginPageLayoutConfiguration ...$items Variable number of LoginPageLayoutConfiguration items
     * @return self
     */
    public function setValue(LoginPageLayoutConfiguration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
