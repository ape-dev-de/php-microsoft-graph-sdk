...
/**
 * Collection response for LoginPageLayoutConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LoginPageLayoutConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var LoginPageLayoutConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param LoginPageLayoutConfiguration[] $items
     * @return self
     */
    public function setValue(array|LoginPageLayoutConfiguration $items, LoginPageLayoutConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LoginPageLayoutConfiguration> $value
     * @return self
     ...
     * 
     * @param LoginPageLayoutConfiguration $item
     * @return self
     */
    public function addValue(LoginPageLayoutConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LoginPageLayoutConfiguration>
     */
