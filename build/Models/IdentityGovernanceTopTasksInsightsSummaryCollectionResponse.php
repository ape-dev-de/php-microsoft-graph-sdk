...
/**
 * Collection response for IdentityGovernanceTopTasksInsightsSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceTopTasksInsightsSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceTopTasksInsightsSummary[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceTopTasksInsightsSummary[]
     */
     ...
     * 
     * @param IdentityGovernanceTopTasksInsightsSummary[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceTopTasksInsightsSummary $items, IdentityGovernanceTopTasksInsightsSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceTopTasksInsightsSummary> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceTopTasksInsightsSummary $item
     * @return self
     */
    public function addValue(IdentityGovernanceTopTasksInsightsSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceTopTasksInsightsSummary|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceTopTasksInsightsSummary>
     */
