 ...
 */
class IdentityGovernanceTopTasksInsightsSummaryCollectionResponse
{
    /**
     ...
     * 
     * @param IdentityGovernanceTopTasksInsightsSummary ...$items Variable number of IdentityGovernanceTopTasksInsightsSummary items
     * @return self
     */
    public function setValue(IdentityGovernanceTopTasksInsightsSummary ...$items): self
    {
        $this->value = $items;
        return $this;
    }
