...
/**
 * Collection response for UnifiedRoleDefinition
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRoleDefinitionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UnifiedRoleDefinition[] $items
     * @return self
     */
    public function setValue(array|UnifiedRoleDefinition $items, UnifiedRoleDefinition ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRoleDefinition> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleDefinition $item
     * @return self
     */
    public function addValue(UnifiedRoleDefinition $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRoleDefinition>
     */
