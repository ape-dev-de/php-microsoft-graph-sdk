...
/**
 * Collection response for PrintJobProcessingState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintJobProcessingStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return PrintJobProcessingState[]
     */
     ...
     * 
     * @param PrintJobProcessingState[] $items
     * @return self
     */
    public function setValue(array|PrintJobProcessingState $items, PrintJobProcessingState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintJobProcessingState> $value
     * @return self
     ...
     * 
     * @param PrintJobProcessingState $item
     * @return self
     */
    public function addValue(PrintJobProcessingState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintJobProcessingState>
     */
