...
class DefaultUserRolePermissions
{
     ...
     * @var string[]
     */
    private array $permissionGrantPoliciesAssigned = [];
    ...
    /**
     * @param string[] $permissionGrantPoliciesAssigned
     */
    public function setPermissionGrantPoliciesAssigned(array $permissionGrantPoliciesAssigned): self
    {
