...
/**
 * Collection response for MessageUnpinnedEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MessageUnpinnedEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MessageUnpinnedEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param MessageUnpinnedEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|MessageUnpinnedEventMessageDetail $items, MessageUnpinnedEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MessageUnpinnedEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param MessageUnpinnedEventMessageDetail $item
     * @return self
     */
    public function addValue(MessageUnpinnedEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MessageUnpinnedEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MessageUnpinnedEventMessageDetail>
     */
