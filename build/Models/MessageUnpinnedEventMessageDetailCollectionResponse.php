 ...
 */
class MessageUnpinnedEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param MessageUnpinnedEventMessageDetail ...$items Variable number of MessageUnpinnedEventMessageDetail items
     * @return self
     */
    public function setValue(MessageUnpinnedEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
