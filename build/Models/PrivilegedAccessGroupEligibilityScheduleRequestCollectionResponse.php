...
/**
 * Collection response for PrivilegedAccessGroupEligibilityScheduleRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrivilegedAccessGroupEligibilityScheduleRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PrivilegedAccessGroupEligibilityScheduleRequest[] $items
     * @return self
     */
    public function setValue(array|PrivilegedAccessGroupEligibilityScheduleRequest $items, PrivilegedAccessGroupEligibilityScheduleRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrivilegedAccessGroupEligibilityScheduleRequest> $value
     * @return self
     ...
     * 
     * @param PrivilegedAccessGroupEligibilityScheduleRequest $item
     * @return self
     */
    public function addValue(PrivilegedAccessGroupEligibilityScheduleRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrivilegedAccessGroupEligibilityScheduleRequest>
     */
