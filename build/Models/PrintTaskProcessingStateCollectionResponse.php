...
/**
 * Collection response for PrintTaskProcessingState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintTaskProcessingStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return PrintTaskProcessingState[]
     */
     ...
     * 
     * @param PrintTaskProcessingState[] $items
     * @return self
     */
    public function setValue(array|PrintTaskProcessingState $items, PrintTaskProcessingState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintTaskProcessingState> $value
     * @return self
     ...
     * 
     * @param PrintTaskProcessingState $item
     * @return self
     */
    public function addValue(PrintTaskProcessingState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintTaskProcessingState>
     */
