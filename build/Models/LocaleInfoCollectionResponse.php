...
/**
 * Collection response for LocaleInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LocaleInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var LocaleInfo[]
     */
     ...
     * 
     * @param LocaleInfo[] $items
     * @return self
     */
    public function setValue(array|LocaleInfo $items, LocaleInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param LocaleInfo $item
     * @return self
     */
    public function addValue(LocaleInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LocaleInfo>
     */
