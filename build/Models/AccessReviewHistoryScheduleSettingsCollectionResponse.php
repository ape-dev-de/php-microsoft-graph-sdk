...
/**
 * Collection response for AccessReviewHistoryScheduleSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewHistoryScheduleSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessReviewHistoryScheduleSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessReviewHistoryScheduleSettings[] $items
     * @return self
     */
    public function setValue(array|AccessReviewHistoryScheduleSettings $items, AccessReviewHistoryScheduleSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewHistoryScheduleSettings> $value
     * @return self
     ...
     * 
     * @param AccessReviewHistoryScheduleSettings $item
     * @return self
     */
    public function addValue(AccessReviewHistoryScheduleSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewHistoryScheduleSettings>
     */
