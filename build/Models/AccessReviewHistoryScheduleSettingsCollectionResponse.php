 ...
 */
class AccessReviewHistoryScheduleSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param AccessReviewHistoryScheduleSettings ...$items Variable number of AccessReviewHistoryScheduleSettings items
     * @return self
     */
    public function setValue(AccessReviewHistoryScheduleSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
