...
/**
 * Collection response for SectionGroup
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SectionGroupCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SectionGroup[]
     */
     ...
     * 
     * @param SectionGroup[] $items
     * @return self
     */
    public function setValue(array|SectionGroup $items, SectionGroup ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SectionGroup> $value
     * @return self
     ...
     * 
     * @param SectionGroup $item
     * @return self
     */
    public function addValue(SectionGroup $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SectionGroup>
     */
