...
/**
 * Collection response for SharePointRestoreSession
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SharePointRestoreSessionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SharePointRestoreSession[] $items
     * @return self
     */
    public function setValue(array|SharePointRestoreSession $items, SharePointRestoreSession ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SharePointRestoreSession> $value
     * @return self
     ...
     * 
     * @param SharePointRestoreSession $item
     * @return self
     */
    public function addValue(SharePointRestoreSession $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SharePointRestoreSession>
     */
