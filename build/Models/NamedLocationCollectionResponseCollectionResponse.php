...
/**
 * Collection response for NamedLocationCollectionResponse
 */
class NamedLocationCollectionResponseCollectionResponse
{
    /**
     * @var NamedLocationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param NamedLocationCollectionResponse ...$items Variable number of NamedLocationCollectionResponse items
     * @return self
     */
    public function setValue(NamedLocationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<NamedLocationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param NamedLocationCollectionResponse $item
     * @return self
     */
    public function addValue(NamedLocationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
