...
/**
 * Collection response for WorkbookTableRowCollectionResponse
 */
class WorkbookTableRowCollectionResponseCollectionResponse
{
    /**
     * @var WorkbookTableRowCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookTableRowCollectionResponse ...$items Variable number of WorkbookTableRowCollectionResponse items
     * @return self
     */
    public function setValue(WorkbookTableRowCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WorkbookTableRowCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WorkbookTableRowCollectionResponse $item
     * @return self
     */
    public function addValue(WorkbookTableRowCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
