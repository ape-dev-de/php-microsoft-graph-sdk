...
/**
 * Collection response for OnAuthenticationMethodLoadStartExternalUsersSelfServiceSignUp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnAuthenticationMethodLoadStartExternalUsersSelfServiceSignUpCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnAuthenticationMethodLoadStartExternalUsersSelfServiceSignUp[]
     */
    private array $value = [];
     ...
     * 
     * @param OnAuthenticationMethodLoadStartExternalUsersSelfServiceSignUp[] $items
     * @return self
     */
    public function setValue(array|OnAuthenticationMethodLoadStartExternalUsersSelfServiceSignUp $items, OnAuthenticationMethodLoadStartExternalUsersSelfServiceSignUp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnAuthenticationMethodLoadStartExternalUsersSelfServiceSignUp> $value
     * @return self
     ...
     * 
     * @param OnAuthenticationMethodLoadStartExternalUsersSelfServiceSignUp $item
     * @return self
     */
    public function addValue(OnAuthenticationMethodLoadStartExternalUsersSelfServiceSignUp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnAuthenticationMethodLoadStartExternalUsersSelfServiceSignUp>
     */
