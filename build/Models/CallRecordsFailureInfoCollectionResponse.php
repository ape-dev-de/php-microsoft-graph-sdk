 ...
 */
class CallRecordsFailureInfoCollectionResponse
{
    /**
     ...
     * 
     * @param CallRecordsFailureInfo ...$items Variable number of CallRecordsFailureInfo items
     * @return self
     */
    public function setValue(CallRecordsFailureInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
