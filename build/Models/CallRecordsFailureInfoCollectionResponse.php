...
/**
 * Collection response for CallRecordsFailureInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsFailureInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsFailureInfo[]
     */
    private array $value = [];
     ...
     * 
     * @param CallRecordsFailureInfo[] $items
     * @return self
     */
    public function setValue(array|CallRecordsFailureInfo $items, CallRecordsFailureInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsFailureInfo> $value
     * @return self
     ...
     * 
     * @param CallRecordsFailureInfo $item
     * @return self
     */
    public function addValue(CallRecordsFailureInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsFailureInfo|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsFailureInfo>
     */
