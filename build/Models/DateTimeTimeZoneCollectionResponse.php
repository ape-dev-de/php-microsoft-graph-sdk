 ...
 */
class DateTimeTimeZoneCollectionResponse
{
    /**
     ...
     * 
     * @param DateTimeTimeZone ...$items Variable number of DateTimeTimeZone items
     * @return self
     */
    public function setValue(DateTimeTimeZone ...$items): self
    {
        $this->value = $items;
        return $this;
    }
