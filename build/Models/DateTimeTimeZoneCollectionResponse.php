...
/**
 * Collection response for DateTimeTimeZone
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DateTimeTimeZoneCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DateTimeTimeZone[] $items
     * @return self
     */
    public function setValue(array|DateTimeTimeZone $items, DateTimeTimeZone ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DateTimeTimeZone> $value
     * @return self
     ...
     * 
     * @param DateTimeTimeZone $item
     * @return self
     */
    public function addValue(DateTimeTimeZone $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DateTimeTimeZone>
     */
