...
/**
 * Collection response for WindowsPhone81CustomConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsPhone81CustomConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WindowsPhone81CustomConfiguration[] $items
     * @return self
     */
    public function setValue(array|WindowsPhone81CustomConfiguration $items, WindowsPhone81CustomConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsPhone81CustomConfiguration> $value
     * @return self
     ...
     * 
     * @param WindowsPhone81CustomConfiguration $item
     * @return self
     */
    public function addValue(WindowsPhone81CustomConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WindowsPhone81CustomConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WindowsPhone81CustomConfiguration>
     */
