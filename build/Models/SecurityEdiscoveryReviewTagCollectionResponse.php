...
/**
 * SecurityEdiscoveryReviewTagCollectionResponse - Collection response
 */
class SecurityEdiscoveryReviewTagCollectionResponse
{
    /**
     * @var array<int, SecurityEdiscoveryReviewTag>
     */
    public array $value = [];
