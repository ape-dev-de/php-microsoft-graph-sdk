...
/**
 * Collection response for SecurityEdiscoveryReviewTag
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityEdiscoveryReviewTagCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityEdiscoveryReviewTag[] $items
     * @return self
     */
    public function setValue(array|SecurityEdiscoveryReviewTag $items, SecurityEdiscoveryReviewTag ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityEdiscoveryReviewTag> $value
     * @return self
     ...
     * 
     * @param SecurityEdiscoveryReviewTag $item
     * @return self
     */
    public function addValue(SecurityEdiscoveryReviewTag $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityEdiscoveryReviewTag>
     */
