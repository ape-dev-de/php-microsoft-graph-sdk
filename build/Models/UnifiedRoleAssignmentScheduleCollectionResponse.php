...
/**
 * Collection response for UnifiedRoleAssignmentSchedule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRoleAssignmentScheduleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UnifiedRoleAssignmentSchedule[] $items
     * @return self
     */
    public function setValue(array|UnifiedRoleAssignmentSchedule $items, UnifiedRoleAssignmentSchedule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRoleAssignmentSchedule> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleAssignmentSchedule $item
     * @return self
     */
    public function addValue(UnifiedRoleAssignmentSchedule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRoleAssignmentSchedule>
     */
