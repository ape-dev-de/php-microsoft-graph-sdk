 ...
 */
class DeviceAndAppManagementDataCollectionResponse
{
    /**
     ...
     * 
     * @param DeviceAndAppManagementData ...$items Variable number of DeviceAndAppManagementData items
     * @return self
     */
    public function setValue(DeviceAndAppManagementData ...$items): self
    {
        $this->value = $items;
        return $this;
    }
