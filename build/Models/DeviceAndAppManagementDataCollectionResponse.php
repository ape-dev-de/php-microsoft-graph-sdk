...
/**
 * Collection response for DeviceAndAppManagementData
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceAndAppManagementDataCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceAndAppManagementData[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceAndAppManagementData[] $items
     * @return self
     */
    public function setValue(array|DeviceAndAppManagementData $items, DeviceAndAppManagementData ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceAndAppManagementData> $value
     * @return self
     ...
     * 
     * @param DeviceAndAppManagementData $item
     * @return self
     */
    public function addValue(DeviceAndAppManagementData $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return DeviceAndAppManagementData|null
     */
     ...
     * 
     * @return \ArrayIterator<int, DeviceAndAppManagementData>
     */
