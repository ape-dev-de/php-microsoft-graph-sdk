...
/**
 * Collection response for MobileLobAppCollectionResponse
 */
class MobileLobAppCollectionResponseCollectionResponse
{
    /**
     * @var MobileLobAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MobileLobAppCollectionResponse ...$items Variable number of MobileLobAppCollectionResponse items
     * @return self
     */
    public function setValue(MobileLobAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MobileLobAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MobileLobAppCollectionResponse $item
     * @return self
     */
    public function addValue(MobileLobAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
