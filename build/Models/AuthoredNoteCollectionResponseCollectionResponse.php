...
/**
 * Collection response for AuthoredNoteCollectionResponse
 */
class AuthoredNoteCollectionResponseCollectionResponse
{
    /**
     * @var AuthoredNoteCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AuthoredNoteCollectionResponse ...$items Variable number of AuthoredNoteCollectionResponse items
     * @return self
     */
    public function setValue(AuthoredNoteCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AuthoredNoteCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AuthoredNoteCollectionResponse $item
     * @return self
     */
    public function addValue(AuthoredNoteCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
