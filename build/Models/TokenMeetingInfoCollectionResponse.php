...
/**
 * Collection response for TokenMeetingInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TokenMeetingInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TokenMeetingInfo[]
     */
    private array $value = [];
     ...
     * 
     * @param TokenMeetingInfo[] $items
     * @return self
     */
    public function setValue(array|TokenMeetingInfo $items, TokenMeetingInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TokenMeetingInfo> $value
     * @return self
     ...
     * 
     * @param TokenMeetingInfo $item
     * @return self
     */
    public function addValue(TokenMeetingInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TokenMeetingInfo>
     */
