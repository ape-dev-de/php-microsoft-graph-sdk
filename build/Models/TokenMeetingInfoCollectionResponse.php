 ...
 */
class TokenMeetingInfoCollectionResponse
{
    /**
     ...
     * 
     * @param TokenMeetingInfo ...$items Variable number of TokenMeetingInfo items
     * @return self
     */
    public function setValue(TokenMeetingInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
