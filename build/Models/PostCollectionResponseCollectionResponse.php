...
/**
 * Collection response for PostCollectionResponse
 */
class PostCollectionResponseCollectionResponse
{
    /**
     ...
     * 
     * @param PostCollectionResponse ...$items Variable number of PostCollectionResponse items
     * @return self
     */
    public function setValue(PostCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PostCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PostCollectionResponse $item
     * @return self
     */
    public function addValue(PostCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
