...
/**
 * Collection response for MimeContent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MimeContentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MimeContent[]
     */
     ...
     * 
     * @param MimeContent[] $items
     * @return self
     */
    public function setValue(array|MimeContent $items, MimeContent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param MimeContent $item
     * @return self
     */
    public function addValue(MimeContent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MimeContent>
     */
