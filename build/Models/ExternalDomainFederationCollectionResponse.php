 ...
 */
class ExternalDomainFederationCollectionResponse
{
    /**
     ...
     * 
     * @param ExternalDomainFederation ...$items Variable number of ExternalDomainFederation items
     * @return self
     */
    public function setValue(ExternalDomainFederation ...$items): self
    {
        $this->value = $items;
        return $this;
    }
