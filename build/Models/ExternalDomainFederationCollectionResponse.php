...
/**
 * Collection response for ExternalDomainFederation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalDomainFederationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalDomainFederation[]
     */
    private array $value = [];
     ...
     * 
     * @param ExternalDomainFederation[] $items
     * @return self
     */
    public function setValue(array|ExternalDomainFederation $items, ExternalDomainFederation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalDomainFederation> $value
     * @return self
     ...
     * 
     * @param ExternalDomainFederation $item
     * @return self
     */
    public function addValue(ExternalDomainFederation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalDomainFederation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalDomainFederation>
     */
