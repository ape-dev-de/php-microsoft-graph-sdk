...
/**
 * Collection response for SecurityGitHubOrganizationEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityGitHubOrganizationEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityGitHubOrganizationEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityGitHubOrganizationEvidence[]
     */
     ...
     * 
     * @param SecurityGitHubOrganizationEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityGitHubOrganizationEvidence $items, SecurityGitHubOrganizationEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityGitHubOrganizationEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityGitHubOrganizationEvidence $item
     * @return self
     */
    public function addValue(SecurityGitHubOrganizationEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityGitHubOrganizationEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityGitHubOrganizationEvidence>
     */
