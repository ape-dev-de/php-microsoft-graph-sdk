 ...
 */
class SecurityGitHubOrganizationEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityGitHubOrganizationEvidence ...$items Variable number of SecurityGitHubOrganizationEvidence items
     * @return self
     */
    public function setValue(SecurityGitHubOrganizationEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
