...
/**
 * Collection response for IosHomeScreenAppCollectionResponse
 */
class IosHomeScreenAppCollectionResponseCollectionResponse
{
    /**
     * @var IosHomeScreenAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IosHomeScreenAppCollectionResponse ...$items Variable number of IosHomeScreenAppCollectionResponse items
     * @return self
     */
    public function setValue(IosHomeScreenAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IosHomeScreenAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IosHomeScreenAppCollectionResponse $item
     * @return self
     */
    public function addValue(IosHomeScreenAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
