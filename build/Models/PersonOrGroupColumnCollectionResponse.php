 ...
 */
class PersonOrGroupColumnCollectionResponse
{
    /**
     ...
     * 
     * @param PersonOrGroupColumn ...$items Variable number of PersonOrGroupColumn items
     * @return self
     */
    public function setValue(PersonOrGroupColumn ...$items): self
    {
        $this->value = $items;
        return $this;
    }
