...
/**
 * Collection response for PersonOrGroupColumn
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PersonOrGroupColumnCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PersonOrGroupColumn[] $items
     * @return self
     */
    public function setValue(array|PersonOrGroupColumn $items, PersonOrGroupColumn ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PersonOrGroupColumn> $value
     * @return self
     ...
     * 
     * @param PersonOrGroupColumn $item
     * @return self
     */
    public function addValue(PersonOrGroupColumn $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PersonOrGroupColumn>
     */
