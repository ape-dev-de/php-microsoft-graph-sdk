...
/**
 * Collection response for ChatCollectionResponse
 */
class ChatCollectionResponseCollectionResponse
{
    /**
     * @var ChatCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ChatCollectionResponse ...$items Variable number of ChatCollectionResponse items
     * @return self
     */
    public function setValue(ChatCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ChatCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ChatCollectionResponse $item
     * @return self
     */
    public function addValue(ChatCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
