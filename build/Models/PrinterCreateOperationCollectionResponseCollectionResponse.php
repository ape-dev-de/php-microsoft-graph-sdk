...
/**
 * Collection response for PrinterCreateOperationCollectionResponse
 */
class PrinterCreateOperationCollectionResponseCollectionResponse
{
    /**
     * @var PrinterCreateOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PrinterCreateOperationCollectionResponse ...$items Variable number of PrinterCreateOperationCollectionResponse items
     * @return self
     */
    public function setValue(PrinterCreateOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PrinterCreateOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PrinterCreateOperationCollectionResponse $item
     * @return self
     */
    public function addValue(PrinterCreateOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
