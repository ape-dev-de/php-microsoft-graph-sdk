...
/**
 * Collection response for AttributeFlowType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttributeFlowTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AttributeFlowType[] $items
     * @return self
     */
    public function setValue(array|AttributeFlowType $items, AttributeFlowType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttributeFlowType> $value
     * @return self
     ...
     * 
     * @param AttributeFlowType $item
     * @return self
     */
    public function addValue(AttributeFlowType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AttributeFlowType>
     */
