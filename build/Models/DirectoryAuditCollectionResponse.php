...
/**
 * Collection response for DirectoryAudit
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DirectoryAuditCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DirectoryAudit[]
     */
     ...
     * 
     * @param DirectoryAudit[] $items
     * @return self
     */
    public function setValue(array|DirectoryAudit $items, DirectoryAudit ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DirectoryAudit> $value
     * @return self
     ...
     * 
     * @param DirectoryAudit $item
     * @return self
     */
    public function addValue(DirectoryAudit $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DirectoryAudit>
     */
