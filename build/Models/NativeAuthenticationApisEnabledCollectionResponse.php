...
/**
 * Collection response for NativeAuthenticationApisEnabled
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class NativeAuthenticationApisEnabledCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var NativeAuthenticationApisEnabled[]
     */
    private array $value = [];
     ...
     * 
     * @return NativeAuthenticationApisEnabled[]
     */
     ...
     * 
     * @param NativeAuthenticationApisEnabled[] $items
     * @return self
     */
    public function setValue(array|NativeAuthenticationApisEnabled $items, NativeAuthenticationApisEnabled ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<NativeAuthenticationApisEnabled> $value
     * @return self
     ...
     * 
     * @param NativeAuthenticationApisEnabled $item
     * @return self
     */
    public function addValue(NativeAuthenticationApisEnabled $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, NativeAuthenticationApisEnabled>
     */
