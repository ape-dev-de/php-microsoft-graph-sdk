...
/**
 * NativeAuthenticationApisEnabledCollectionResponse - Collection response
 */
class NativeAuthenticationApisEnabledCollectionResponse
{
    /**
     * @var array<int, NativeAuthenticationApisEnabled>
     */
    public array $value = [];
