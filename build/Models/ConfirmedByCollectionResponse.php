...
/**
 * Collection response for ConfirmedBy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConfirmedByCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConfirmedBy[]
     */
     ...
     * 
     * @param ConfirmedBy[] $items
     * @return self
     */
    public function setValue(array|ConfirmedBy $items, ConfirmedBy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param ConfirmedBy $item
     * @return self
     */
    public function addValue(ConfirmedBy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConfirmedBy>
     */
