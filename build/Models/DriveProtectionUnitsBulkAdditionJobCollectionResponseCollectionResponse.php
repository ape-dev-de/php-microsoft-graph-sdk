...
/**
 * Collection response for DriveProtectionUnitsBulkAdditionJobCollectionResponse
 */
class DriveProtectionUnitsBulkAdditionJobCollectionResponseCollectionResponse
{
    /**
     * @var DriveProtectionUnitsBulkAdditionJobCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DriveProtectionUnitsBulkAdditionJobCollectionResponse ...$items Variable number of DriveProtectionUnitsBulkAdditionJobCollectionResponse items
     * @return self
     */
    public function setValue(DriveProtectionUnitsBulkAdditionJobCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DriveProtectionUnitsBulkAdditionJobCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DriveProtectionUnitsBulkAdditionJobCollectionResponse $item
     * @return self
     */
    public function addValue(DriveProtectionUnitsBulkAdditionJobCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
