...
/**
 * Collection response for RubricQualityFeedbackModel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RubricQualityFeedbackModelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param RubricQualityFeedbackModel[] $items
     * @return self
     */
    public function setValue(array|RubricQualityFeedbackModel $items, RubricQualityFeedbackModel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RubricQualityFeedbackModel> $value
     * @return self
     ...
     * 
     * @param RubricQualityFeedbackModel $item
     * @return self
     */
    public function addValue(RubricQualityFeedbackModel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return RubricQualityFeedbackModel|null
     */
     ...
     * 
     * @return \ArrayIterator<int, RubricQualityFeedbackModel>
     */
