 ...
 */
class EmailIdentityCollectionResponse
{
    /**
     * @var EmailIdentity[]
     */
     ...
     * 
     * @param EmailIdentity ...$items Variable number of EmailIdentity items
     * @return self
     */
    public function setValue(EmailIdentity ...$items): self
    {
        $this->value = $items;
        return $this;
    }
