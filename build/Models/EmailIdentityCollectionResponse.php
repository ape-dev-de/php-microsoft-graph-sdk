...
/**
 * Collection response for EmailIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EmailIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EmailIdentity[]
     */
     ...
     * 
     * @param EmailIdentity[] $items
     * @return self
     */
    public function setValue(array|EmailIdentity $items, EmailIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EmailIdentity> $value
     * @return self
     ...
     * 
     * @param EmailIdentity $item
     * @return self
     */
    public function addValue(EmailIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EmailIdentity>
     */
