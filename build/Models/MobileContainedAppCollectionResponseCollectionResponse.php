...
/**
 * Collection response for MobileContainedAppCollectionResponse
 */
class MobileContainedAppCollectionResponseCollectionResponse
{
    /**
     * @var MobileContainedAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MobileContainedAppCollectionResponse ...$items Variable number of MobileContainedAppCollectionResponse items
     * @return self
     */
    public function setValue(MobileContainedAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MobileContainedAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MobileContainedAppCollectionResponse $item
     * @return self
     */
    public function addValue(MobileContainedAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
