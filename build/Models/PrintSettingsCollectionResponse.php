...
/**
 * Collection response for PrintSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrintSettings[]
     */
     ...
     * 
     * @param PrintSettings[] $items
     * @return self
     */
    public function setValue(array|PrintSettings $items, PrintSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintSettings> $value
     * @return self
     ...
     * 
     * @param PrintSettings $item
     * @return self
     */
    public function addValue(PrintSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintSettings>
     */
