 ...
 */
class PrintSettingsCollectionResponse
{
    /**
     * @var PrintSettings[]
     */
     ...
     * 
     * @param PrintSettings ...$items Variable number of PrintSettings items
     * @return self
     */
    public function setValue(PrintSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
