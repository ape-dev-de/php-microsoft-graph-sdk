...
/**
 * Collection response for EducationAssignmentGradeType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationAssignmentGradeTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationAssignmentGradeType[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationAssignmentGradeType[] $items
     * @return self
     */
    public function setValue(array|EducationAssignmentGradeType $items, EducationAssignmentGradeType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationAssignmentGradeType> $value
     * @return self
     ...
     * 
     * @param EducationAssignmentGradeType $item
     * @return self
     */
    public function addValue(EducationAssignmentGradeType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationAssignmentGradeType>
     */
