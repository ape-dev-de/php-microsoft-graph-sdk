...
/**
 * EducationAssignmentGradeTypeCollectionResponse - Collection response
 */
class EducationAssignmentGradeTypeCollectionResponse
{
    /**
     * @var array<int, EducationAssignmentGradeType>
     */
    public array $value = [];
