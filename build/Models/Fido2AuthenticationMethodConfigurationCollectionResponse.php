...
/**
 * Collection response for Fido2AuthenticationMethodConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Fido2AuthenticationMethodConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param Fido2AuthenticationMethodConfiguration[] $items
     * @return self
     */
    public function setValue(array|Fido2AuthenticationMethodConfiguration $items, Fido2AuthenticationMethodConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Fido2AuthenticationMethodConfiguration> $value
     * @return self
     ...
     * 
     * @param Fido2AuthenticationMethodConfiguration $item
     * @return self
     */
    public function addValue(Fido2AuthenticationMethodConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return Fido2AuthenticationMethodConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, Fido2AuthenticationMethodConfiguration>
     */
