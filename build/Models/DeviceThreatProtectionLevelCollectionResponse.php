...
/**
 * DeviceThreatProtectionLevelCollectionResponse - Collection response
 */
class DeviceThreatProtectionLevelCollectionResponse
{
    /**
     * @var array<int, DeviceThreatProtectionLevel>
     */
    public array $value = [];
