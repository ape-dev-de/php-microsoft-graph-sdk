...
/**
 * Collection response for DeviceThreatProtectionLevel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceThreatProtectionLevelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceThreatProtectionLevel[]
     */
    private array $value = [];
     ...
     * 
     * @return DeviceThreatProtectionLevel[]
     */
     ...
     * 
     * @param DeviceThreatProtectionLevel[] $items
     * @return self
     */
    public function setValue(array|DeviceThreatProtectionLevel $items, DeviceThreatProtectionLevel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceThreatProtectionLevel> $value
     * @return self
     ...
     * 
     * @param DeviceThreatProtectionLevel $item
     * @return self
     */
    public function addValue(DeviceThreatProtectionLevel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceThreatProtectionLevel>
     */
