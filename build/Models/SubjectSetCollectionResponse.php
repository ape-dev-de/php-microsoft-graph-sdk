...
/**
 * Collection response for SubjectSet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SubjectSetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SubjectSet[]
     */
     ...
     * 
     * @param SubjectSet[] $items
     * @return self
     */
    public function setValue(array|SubjectSet $items, SubjectSet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param SubjectSet $item
     * @return self
     */
    public function addValue(SubjectSet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SubjectSet>
     */
