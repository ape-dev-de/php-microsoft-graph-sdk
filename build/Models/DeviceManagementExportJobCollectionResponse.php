...
/**
 * Collection response for DeviceManagementExportJob
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceManagementExportJobCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceManagementExportJob[] $items
     * @return self
     */
    public function setValue(array|DeviceManagementExportJob $items, DeviceManagementExportJob ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceManagementExportJob> $value
     * @return self
     ...
     * 
     * @param DeviceManagementExportJob $item
     * @return self
     */
    public function addValue(DeviceManagementExportJob $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceManagementExportJob>
     */
