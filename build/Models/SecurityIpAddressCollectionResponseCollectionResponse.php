...
/**
 * Collection response for SecurityIpAddressCollectionResponse
 */
class SecurityIpAddressCollectionResponseCollectionResponse
{
    /**
     * @var SecurityIpAddressCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityIpAddressCollectionResponse[]
     */
     ...
     * 
     * @param SecurityIpAddressCollectionResponse ...$items Variable number of SecurityIpAddressCollectionResponse items
     * @return self
     */
    public function setValue(SecurityIpAddressCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityIpAddressCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityIpAddressCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityIpAddressCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
