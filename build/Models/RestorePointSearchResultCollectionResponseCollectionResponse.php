...
/**
 * Collection response for RestorePointSearchResultCollectionResponse
 */
class RestorePointSearchResultCollectionResponseCollectionResponse
{
    /**
     * @var RestorePointSearchResultCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return RestorePointSearchResultCollectionResponse[]
     */
     ...
     * 
     * @param RestorePointSearchResultCollectionResponse ...$items Variable number of RestorePointSearchResultCollectionResponse items
     * @return self
     */
    public function setValue(RestorePointSearchResultCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RestorePointSearchResultCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RestorePointSearchResultCollectionResponse $item
     * @return self
     */
    public function addValue(RestorePointSearchResultCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
