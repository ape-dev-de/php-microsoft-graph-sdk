...
/**
 * Collection response for AttendeeAvailabilityCollectionResponse
 */
class AttendeeAvailabilityCollectionResponseCollectionResponse
{
    /**
     * @var AttendeeAvailabilityCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AttendeeAvailabilityCollectionResponse ...$items Variable number of AttendeeAvailabilityCollectionResponse items
     * @return self
     */
    public function setValue(AttendeeAvailabilityCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AttendeeAvailabilityCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AttendeeAvailabilityCollectionResponse $item
     * @return self
     */
    public function addValue(AttendeeAvailabilityCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
