...
/**
 * Collection response for SecurityWhoisHistoryRecord
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityWhoisHistoryRecordCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityWhoisHistoryRecord[] $items
     * @return self
     */
    public function setValue(array|SecurityWhoisHistoryRecord $items, SecurityWhoisHistoryRecord ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityWhoisHistoryRecord> $value
     * @return self
     ...
     * 
     * @param SecurityWhoisHistoryRecord $item
     * @return self
     */
    public function addValue(SecurityWhoisHistoryRecord $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityWhoisHistoryRecord>
     */
