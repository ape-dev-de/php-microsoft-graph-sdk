...
/**
 * SecurityWhoisHistoryRecordCollectionResponse - Collection response
 */
class SecurityWhoisHistoryRecordCollectionResponse
{
    /**
     * @var array<int, SecurityWhoisHistoryRecord>
     */
    public array $value = [];
