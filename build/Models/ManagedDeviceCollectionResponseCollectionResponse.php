...
/**
 * Collection response for ManagedDeviceCollectionResponse
 */
class ManagedDeviceCollectionResponseCollectionResponse
{
    /**
     * @var ManagedDeviceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedDeviceCollectionResponse ...$items Variable number of ManagedDeviceCollectionResponse items
     * @return self
     */
    public function setValue(ManagedDeviceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ManagedDeviceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ManagedDeviceCollectionResponse $item
     * @return self
     */
    public function addValue(ManagedDeviceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
