...
/**
 * Collection response for PlannerPreviewType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerPreviewTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PlannerPreviewType[] $items
     * @return self
     */
    public function setValue(array|PlannerPreviewType $items, PlannerPreviewType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PlannerPreviewType> $value
     * @return self
     ...
     * 
     * @param PlannerPreviewType $item
     * @return self
     */
    public function addValue(PlannerPreviewType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PlannerPreviewType>
     */
