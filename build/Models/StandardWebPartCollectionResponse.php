...
/**
 * Collection response for StandardWebPart
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class StandardWebPartCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var StandardWebPart[]
     */
     ...
     * 
     * @param StandardWebPart[] $items
     * @return self
     */
    public function setValue(array|StandardWebPart $items, StandardWebPart ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<StandardWebPart> $value
     * @return self
     ...
     * 
     * @param StandardWebPart $item
     * @return self
     */
    public function addValue(StandardWebPart $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, StandardWebPart>
     */
