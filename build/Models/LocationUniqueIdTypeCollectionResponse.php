...
/**
 * Collection response for LocationUniqueIdType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LocationUniqueIdTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param LocationUniqueIdType[] $items
     * @return self
     */
    public function setValue(array|LocationUniqueIdType $items, LocationUniqueIdType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LocationUniqueIdType> $value
     * @return self
     ...
     * 
     * @param LocationUniqueIdType $item
     * @return self
     */
    public function addValue(LocationUniqueIdType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LocationUniqueIdType>
     */
