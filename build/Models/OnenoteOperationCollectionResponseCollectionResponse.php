...
/**
 * Collection response for OnenoteOperationCollectionResponse
 */
class OnenoteOperationCollectionResponseCollectionResponse
{
    /**
     * @var OnenoteOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param OnenoteOperationCollectionResponse ...$items Variable number of OnenoteOperationCollectionResponse items
     * @return self
     */
    public function setValue(OnenoteOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<OnenoteOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param OnenoteOperationCollectionResponse $item
     * @return self
     */
    public function addValue(OnenoteOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
