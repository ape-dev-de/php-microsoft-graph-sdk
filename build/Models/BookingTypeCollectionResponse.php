...
/**
 * Collection response for BookingType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BookingType[]
     */
     ...
     * 
     * @param BookingType[] $items
     * @return self
     */
    public function setValue(array|BookingType $items, BookingType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param BookingType $item
     * @return self
     */
    public function addValue(BookingType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BookingType>
     */
