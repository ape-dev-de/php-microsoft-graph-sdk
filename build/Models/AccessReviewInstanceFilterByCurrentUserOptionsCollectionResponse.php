...
/**
 * AccessReviewInstanceFilterByCurrentUserOptionsCollectionResponse - Collection response
 */
class AccessReviewInstanceFilterByCurrentUserOptionsCollectionResponse
{
    /**
     * @var array<int, AccessReviewInstanceFilterByCurrentUserOptions>
     */
    public array $value = [];
