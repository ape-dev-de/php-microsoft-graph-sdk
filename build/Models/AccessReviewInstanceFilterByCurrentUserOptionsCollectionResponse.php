...
/**
 * Collection response for AccessReviewInstanceFilterByCurrentUserOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewInstanceFilterByCurrentUserOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessReviewInstanceFilterByCurrentUserOptions[]
     */
    private array $value = [];
     ...
     * 
     * @return AccessReviewInstanceFilterByCurrentUserOptions[]
     */
     ...
     * 
     * @param AccessReviewInstanceFilterByCurrentUserOptions[] $items
     * @return self
     */
    public function setValue(array|AccessReviewInstanceFilterByCurrentUserOptions $items, AccessReviewInstanceFilterByCurrentUserOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewInstanceFilterByCurrentUserOptions> $value
     * @return self
     ...
     * 
     * @param AccessReviewInstanceFilterByCurrentUserOptions $item
     * @return self
     */
    public function addValue(AccessReviewInstanceFilterByCurrentUserOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessReviewInstanceFilterByCurrentUserOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewInstanceFilterByCurrentUserOptions>
     */
