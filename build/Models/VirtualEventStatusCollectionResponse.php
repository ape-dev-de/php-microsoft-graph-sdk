...
/**
 * Collection response for VirtualEventStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualEventStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VirtualEventStatus[]
     */
    private array $value = [];
     ...
     * 
     * @param VirtualEventStatus[] $items
     * @return self
     */
    public function setValue(array|VirtualEventStatus $items, VirtualEventStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualEventStatus> $value
     * @return self
     ...
     * 
     * @param VirtualEventStatus $item
     * @return self
     */
    public function addValue(VirtualEventStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VirtualEventStatus>
     */
