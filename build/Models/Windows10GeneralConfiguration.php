...
class Windows10GeneralConfiguration
{
     ...
     * @var string[]
     */
    private array $bluetoothAllowedServices = [];
     ...
     * @var string[]
     */
    private array $defenderFileExtensionsToExclude = [];

    /**
     * Files and folder to exclude from scans and real time protection.
     * @var string[]
     */
    private array $defenderFilesAndFoldersToExclude = [];
     ...
     * @var string[]
     */
    private array $defenderProcessesToExclude = [];
     ...
     * @var string[]
     */
    private array $edgeHomepageUrls = [];
    ...
    /**
     * @param string[] $bluetoothAllowedServices
     */
    public function setBluetoothAllowedServices(array $bluetoothAllowedServices): self
    {
    ...
    /**
     * @param string[] $defenderFileExtensionsToExclude
     */
    public function setDefenderFileExtensionsToExclude(array $defenderFileExtensionsToExclude): self
    {
    ...
    /**
     * @param string[] $defenderFilesAndFoldersToExclude
     */
    public function setDefenderFilesAndFoldersToExclude(array $defenderFilesAndFoldersToExclude): self
    {
    ...
    /**
     * @param string[] $defenderProcessesToExclude
     */
    public function setDefenderProcessesToExclude(array $defenderProcessesToExclude): self
    {
    ...
    /**
     * @param string[] $edgeHomepageUrls
     */
    public function setEdgeHomepageUrls(array $edgeHomepageUrls): self
    {
