...
/**
 * Collection response for StandardTimeZoneOffset
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class StandardTimeZoneOffsetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param StandardTimeZoneOffset[] $items
     * @return self
     */
    public function setValue(array|StandardTimeZoneOffset $items, StandardTimeZoneOffset ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<StandardTimeZoneOffset> $value
     * @return self
     ...
     * 
     * @param StandardTimeZoneOffset $item
     * @return self
     */
    public function addValue(StandardTimeZoneOffset $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, StandardTimeZoneOffset>
     */
