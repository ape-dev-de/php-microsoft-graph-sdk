 ...
 */
class StandardTimeZoneOffsetCollectionResponse
{
    /**
     ...
     * 
     * @param StandardTimeZoneOffset ...$items Variable number of StandardTimeZoneOffset items
     * @return self
     */
    public function setValue(StandardTimeZoneOffset ...$items): self
    {
        $this->value = $items;
        return $this;
    }
