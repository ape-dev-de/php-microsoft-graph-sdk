...
/**
 * Collection response for RemoteAssistancePartner
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RemoteAssistancePartnerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param RemoteAssistancePartner[] $items
     * @return self
     */
    public function setValue(array|RemoteAssistancePartner $items, RemoteAssistancePartner ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RemoteAssistancePartner> $value
     * @return self
     ...
     * 
     * @param RemoteAssistancePartner $item
     * @return self
     */
    public function addValue(RemoteAssistancePartner $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RemoteAssistancePartner>
     */
