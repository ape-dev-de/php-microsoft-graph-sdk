...
/**
 * Collection response for TokenLifetimePolicyCollectionResponse
 */
class TokenLifetimePolicyCollectionResponseCollectionResponse
{
    /**
     * @var TokenLifetimePolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TokenLifetimePolicyCollectionResponse ...$items Variable number of TokenLifetimePolicyCollectionResponse items
     * @return self
     */
    public function setValue(TokenLifetimePolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TokenLifetimePolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TokenLifetimePolicyCollectionResponse $item
     * @return self
     */
    public function addValue(TokenLifetimePolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
