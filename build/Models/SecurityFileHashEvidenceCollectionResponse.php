...
/**
 * Collection response for SecurityFileHashEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityFileHashEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityFileHashEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityFileHashEvidence[]
     */
     ...
     * 
     * @param SecurityFileHashEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityFileHashEvidence $items, SecurityFileHashEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityFileHashEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityFileHashEvidence $item
     * @return self
     */
    public function addValue(SecurityFileHashEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityFileHashEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityFileHashEvidence>
     */
