 ...
 */
class SecurityFileHashEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityFileHashEvidence ...$items Variable number of SecurityFileHashEvidence items
     * @return self
     */
    public function setValue(SecurityFileHashEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
