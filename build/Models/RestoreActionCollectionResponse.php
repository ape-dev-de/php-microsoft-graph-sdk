...
/**
 * Collection response for RestoreAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RestoreActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RestoreAction[]
     */
     ...
     * 
     * @param RestoreAction[] $items
     * @return self
     */
    public function setValue(array|RestoreAction $items, RestoreAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RestoreAction> $value
     * @return self
     ...
     * 
     * @param RestoreAction $item
     * @return self
     */
    public function addValue(RestoreAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RestoreAction>
     */
