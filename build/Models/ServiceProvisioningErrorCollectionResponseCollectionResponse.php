...
/**
 * Collection response for ServiceProvisioningErrorCollectionResponse
 */
class ServiceProvisioningErrorCollectionResponseCollectionResponse
{
    /**
     * @var ServiceProvisioningErrorCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ServiceProvisioningErrorCollectionResponse ...$items Variable number of ServiceProvisioningErrorCollectionResponse items
     * @return self
     */
    public function setValue(ServiceProvisioningErrorCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ServiceProvisioningErrorCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ServiceProvisioningErrorCollectionResponse $item
     * @return self
     */
    public function addValue(ServiceProvisioningErrorCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
