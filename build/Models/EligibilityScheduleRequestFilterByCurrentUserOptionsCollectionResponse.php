...
/**
 * Collection response for EligibilityScheduleRequestFilterByCurrentUserOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EligibilityScheduleRequestFilterByCurrentUserOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EligibilityScheduleRequestFilterByCurrentUserOptions[]
     */
    private array $value = [];
     ...
     * 
     * @return EligibilityScheduleRequestFilterByCurrentUserOptions[]
     */
     ...
     * 
     * @param EligibilityScheduleRequestFilterByCurrentUserOptions[] $items
     * @return self
     */
    public function setValue(array|EligibilityScheduleRequestFilterByCurrentUserOptions $items, EligibilityScheduleRequestFilterByCurrentUserOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EligibilityScheduleRequestFilterByCurrentUserOptions> $value
     * @return self
     ...
     * 
     * @param EligibilityScheduleRequestFilterByCurrentUserOptions $item
     * @return self
     */
    public function addValue(EligibilityScheduleRequestFilterByCurrentUserOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EligibilityScheduleRequestFilterByCurrentUserOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EligibilityScheduleRequestFilterByCurrentUserOptions>
     */
