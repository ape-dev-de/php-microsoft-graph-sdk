...
/**
 * EligibilityScheduleRequestFilterByCurrentUserOptionsCollectionResponse - Collection response
 */
class EligibilityScheduleRequestFilterByCurrentUserOptionsCollectionResponse
{
    /**
     * @var array<int, EligibilityScheduleRequestFilterByCurrentUserOptions>
     */
    public array $value = [];
