...
/**
 * Collection response for OutlookUser
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OutlookUserCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OutlookUser[]
     */
     ...
     * 
     * @param OutlookUser[] $items
     * @return self
     */
    public function setValue(array|OutlookUser $items, OutlookUser ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param OutlookUser $item
     * @return self
     */
    public function addValue(OutlookUser $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OutlookUser>
     */
