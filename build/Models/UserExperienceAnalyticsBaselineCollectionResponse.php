...
/**
 * Collection response for UserExperienceAnalyticsBaseline
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsBaselineCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsBaseline[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsBaseline $items, UserExperienceAnalyticsBaseline ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsBaseline> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsBaseline $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsBaseline $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsBaseline>
     */
