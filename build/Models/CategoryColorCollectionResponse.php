...
/**
 * Collection response for CategoryColor
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CategoryColorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CategoryColor[]
     */
     ...
     * 
     * @param CategoryColor[] $items
     * @return self
     */
    public function setValue(array|CategoryColor $items, CategoryColor ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CategoryColor> $value
     * @return self
     ...
     * 
     * @param CategoryColor $item
     * @return self
     */
    public function addValue(CategoryColor $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CategoryColor>
     */
