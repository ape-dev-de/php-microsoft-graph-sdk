...
/**
 * SecurityEdiscoveryReviewSetQueryCollectionResponse - Collection response
 */
class SecurityEdiscoveryReviewSetQueryCollectionResponse
{
    /**
     * @var array<int, SecurityEdiscoveryReviewSetQuery>
     */
    public array $value = [];
