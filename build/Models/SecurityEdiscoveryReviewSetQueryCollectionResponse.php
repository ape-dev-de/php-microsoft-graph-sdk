...
/**
 * Collection response for SecurityEdiscoveryReviewSetQuery
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityEdiscoveryReviewSetQueryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityEdiscoveryReviewSetQuery[] $items
     * @return self
     */
    public function setValue(array|SecurityEdiscoveryReviewSetQuery $items, SecurityEdiscoveryReviewSetQuery ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityEdiscoveryReviewSetQuery> $value
     * @return self
     ...
     * 
     * @param SecurityEdiscoveryReviewSetQuery $item
     * @return self
     */
    public function addValue(SecurityEdiscoveryReviewSetQuery $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityEdiscoveryReviewSetQuery>
     */
