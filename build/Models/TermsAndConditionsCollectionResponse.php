...
/**
 * Collection response for TermsAndConditions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TermsAndConditionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TermsAndConditions[] $items
     * @return self
     */
    public function setValue(array|TermsAndConditions $items, TermsAndConditions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TermsAndConditions> $value
     * @return self
     ...
     * 
     * @param TermsAndConditions $item
     * @return self
     */
    public function addValue(TermsAndConditions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TermsAndConditions>
     */
