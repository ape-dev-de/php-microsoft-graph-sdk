...
/**
 * Collection response for RoleDefinition
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RoleDefinitionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RoleDefinition[]
     */
     ...
     * 
     * @param RoleDefinition[] $items
     * @return self
     */
    public function setValue(array|RoleDefinition $items, RoleDefinition ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RoleDefinition> $value
     * @return self
     ...
     * 
     * @param RoleDefinition $item
     * @return self
     */
    public function addValue(RoleDefinition $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RoleDefinition>
     */
