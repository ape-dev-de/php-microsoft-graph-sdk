...
/**
 * Collection response for VirtualEventTownhall
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualEventTownhallCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param VirtualEventTownhall[] $items
     * @return self
     */
    public function setValue(array|VirtualEventTownhall $items, VirtualEventTownhall ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualEventTownhall> $value
     * @return self
     ...
     * 
     * @param VirtualEventTownhall $item
     * @return self
     */
    public function addValue(VirtualEventTownhall $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VirtualEventTownhall>
     */
