...
/**
 * Collection response for SecurityLoggedOnUserCollectionResponse
 */
class SecurityLoggedOnUserCollectionResponseCollectionResponse
{
    /**
     * @var SecurityLoggedOnUserCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityLoggedOnUserCollectionResponse[]
     */
     ...
     * 
     * @param SecurityLoggedOnUserCollectionResponse ...$items Variable number of SecurityLoggedOnUserCollectionResponse items
     * @return self
     */
    public function setValue(SecurityLoggedOnUserCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityLoggedOnUserCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityLoggedOnUserCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityLoggedOnUserCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
