...
/**
 * Collection response for PhysicalOfficeAddressCollectionResponse
 */
class PhysicalOfficeAddressCollectionResponseCollectionResponse
{
    /**
     * @var PhysicalOfficeAddressCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PhysicalOfficeAddressCollectionResponse ...$items Variable number of PhysicalOfficeAddressCollectionResponse items
     * @return self
     */
    public function setValue(PhysicalOfficeAddressCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PhysicalOfficeAddressCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PhysicalOfficeAddressCollectionResponse $item
     * @return self
     */
    public function addValue(PhysicalOfficeAddressCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
