...
/**
 * Collection response for DomainDnsMxRecord
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DomainDnsMxRecordCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DomainDnsMxRecord[]
     */
    private array $value = [];
     ...
     * 
     * @param DomainDnsMxRecord[] $items
     * @return self
     */
    public function setValue(array|DomainDnsMxRecord $items, DomainDnsMxRecord ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DomainDnsMxRecord> $value
     * @return self
     ...
     * 
     * @param DomainDnsMxRecord $item
     * @return self
     */
    public function addValue(DomainDnsMxRecord $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DomainDnsMxRecord>
     */
