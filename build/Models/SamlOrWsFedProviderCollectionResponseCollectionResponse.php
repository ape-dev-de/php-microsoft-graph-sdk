...
/**
 * Collection response for SamlOrWsFedProviderCollectionResponse
 */
class SamlOrWsFedProviderCollectionResponseCollectionResponse
{
    /**
     * @var SamlOrWsFedProviderCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SamlOrWsFedProviderCollectionResponse ...$items Variable number of SamlOrWsFedProviderCollectionResponse items
     * @return self
     */
    public function setValue(SamlOrWsFedProviderCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SamlOrWsFedProviderCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SamlOrWsFedProviderCollectionResponse $item
     * @return self
     */
    public function addValue(SamlOrWsFedProviderCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
