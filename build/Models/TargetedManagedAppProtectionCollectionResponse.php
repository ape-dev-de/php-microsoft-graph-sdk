...
/**
 * Collection response for TargetedManagedAppProtection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TargetedManagedAppProtectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TargetedManagedAppProtection[]
     */
    private array $value = [];
     ...
     * 
     * @param TargetedManagedAppProtection[] $items
     * @return self
     */
    public function setValue(array|TargetedManagedAppProtection $items, TargetedManagedAppProtection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TargetedManagedAppProtection> $value
     * @return self
     ...
     * 
     * @param TargetedManagedAppProtection $item
     * @return self
     */
    public function addValue(TargetedManagedAppProtection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TargetedManagedAppProtection|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TargetedManagedAppProtection>
     */
