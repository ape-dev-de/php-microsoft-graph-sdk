...
/**
 * Collection response for TeamsAppDefinition
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamsAppDefinitionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TeamsAppDefinition[] $items
     * @return self
     */
    public function setValue(array|TeamsAppDefinition $items, TeamsAppDefinition ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamsAppDefinition> $value
     * @return self
     ...
     * 
     * @param TeamsAppDefinition $item
     * @return self
     */
    public function addValue(TeamsAppDefinition $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamsAppDefinition>
     */
