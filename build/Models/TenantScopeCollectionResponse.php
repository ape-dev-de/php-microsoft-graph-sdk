...
/**
 * Collection response for TenantScope
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TenantScopeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TenantScope[]
     */
     ...
     * 
     * @param TenantScope[] $items
     * @return self
     */
    public function setValue(array|TenantScope $items, TenantScope ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param TenantScope $item
     * @return self
     */
    public function addValue(TenantScope $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TenantScope>
     */
