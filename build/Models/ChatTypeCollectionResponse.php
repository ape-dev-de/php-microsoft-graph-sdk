...
/**
 * Collection response for ChatType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChatType[]
     */
     ...
     * 
     * @param ChatType[] $items
     * @return self
     */
    public function setValue(array|ChatType $items, ChatType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(ChatType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChatType>
     */
