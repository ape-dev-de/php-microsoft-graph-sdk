...
/**
 * Collection response for SecurityWhoisRecord
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityWhoisRecordCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityWhoisRecord[] $items
     * @return self
     */
    public function setValue(array|SecurityWhoisRecord $items, SecurityWhoisRecord ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityWhoisRecord> $value
     * @return self
     ...
     * 
     * @param SecurityWhoisRecord $item
     * @return self
     */
    public function addValue(SecurityWhoisRecord $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityWhoisRecord>
     */
