...
/**
 * Collection response for SecurityHostCookieCollectionResponse
 */
class SecurityHostCookieCollectionResponseCollectionResponse
{
    /**
     * @var SecurityHostCookieCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityHostCookieCollectionResponse ...$items Variable number of SecurityHostCookieCollectionResponse items
     * @return self
     */
    public function setValue(SecurityHostCookieCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityHostCookieCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityHostCookieCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityHostCookieCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
