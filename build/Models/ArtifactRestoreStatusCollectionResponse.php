...
/**
 * Collection response for ArtifactRestoreStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ArtifactRestoreStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ArtifactRestoreStatus[] $items
     * @return self
     */
    public function setValue(array|ArtifactRestoreStatus $items, ArtifactRestoreStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ArtifactRestoreStatus> $value
     * @return self
     ...
     * 
     * @param ArtifactRestoreStatus $item
     * @return self
     */
    public function addValue(ArtifactRestoreStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ArtifactRestoreStatus>
     */
