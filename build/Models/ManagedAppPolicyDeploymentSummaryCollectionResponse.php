 ...
 */
class ManagedAppPolicyDeploymentSummaryCollectionResponse
{
    /**
     ...
     * 
     * @param ManagedAppPolicyDeploymentSummary ...$items Variable number of ManagedAppPolicyDeploymentSummary items
     * @return self
     */
    public function setValue(ManagedAppPolicyDeploymentSummary ...$items): self
    {
        $this->value = $items;
        return $this;
    }
