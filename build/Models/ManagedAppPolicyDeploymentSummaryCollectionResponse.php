...
/**
 * Collection response for ManagedAppPolicyDeploymentSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedAppPolicyDeploymentSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ManagedAppPolicyDeploymentSummary[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedAppPolicyDeploymentSummary[] $items
     * @return self
     */
    public function setValue(array|ManagedAppPolicyDeploymentSummary $items, ManagedAppPolicyDeploymentSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedAppPolicyDeploymentSummary> $value
     * @return self
     ...
     * 
     * @param ManagedAppPolicyDeploymentSummary $item
     * @return self
     */
    public function addValue(ManagedAppPolicyDeploymentSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedAppPolicyDeploymentSummary>
     */
