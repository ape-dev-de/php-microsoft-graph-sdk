...
/**
 * Collection response for FileAttachment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FileAttachmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FileAttachment[]
     */
     ...
     * 
     * @param FileAttachment[] $items
     * @return self
     */
    public function setValue(array|FileAttachment $items, FileAttachment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FileAttachment> $value
     * @return self
     ...
     * 
     * @param FileAttachment $item
     * @return self
     */
    public function addValue(FileAttachment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FileAttachment>
     */
