...
/**
 * PolicyLocationApplicationCollectionResponse - Collection response
 */
class PolicyLocationApplicationCollectionResponse
{
    /**
     * @var array<int, PolicyLocationApplication>
     */
    public array $value = [];
