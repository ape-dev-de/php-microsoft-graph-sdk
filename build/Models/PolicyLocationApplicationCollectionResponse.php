...
/**
 * Collection response for PolicyLocationApplication
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PolicyLocationApplicationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PolicyLocationApplication[]
     */
    private array $value = [];
     ...
     * 
     * @param PolicyLocationApplication[] $items
     * @return self
     */
    public function setValue(array|PolicyLocationApplication $items, PolicyLocationApplication ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PolicyLocationApplication> $value
     * @return self
     ...
     * 
     * @param PolicyLocationApplication $item
     * @return self
     */
    public function addValue(PolicyLocationApplication $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PolicyLocationApplication|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PolicyLocationApplication>
     */
