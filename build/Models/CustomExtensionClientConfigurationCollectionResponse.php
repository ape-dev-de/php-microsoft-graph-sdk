...
/**
 * Collection response for CustomExtensionClientConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CustomExtensionClientConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CustomExtensionClientConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param CustomExtensionClientConfiguration[] $items
     * @return self
     */
    public function setValue(array|CustomExtensionClientConfiguration $items, CustomExtensionClientConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CustomExtensionClientConfiguration> $value
     * @return self
     ...
     * 
     * @param CustomExtensionClientConfiguration $item
     * @return self
     */
    public function addValue(CustomExtensionClientConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CustomExtensionClientConfiguration>
     */
