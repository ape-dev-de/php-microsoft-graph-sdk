 ...
 */
class CustomExtensionClientConfigurationCollectionResponse
{
    /**
     ...
     * 
     * @param CustomExtensionClientConfiguration ...$items Variable number of CustomExtensionClientConfiguration items
     * @return self
     */
    public function setValue(CustomExtensionClientConfiguration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
