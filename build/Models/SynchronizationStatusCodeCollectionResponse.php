...
/**
 * SynchronizationStatusCodeCollectionResponse - Collection response
 */
class SynchronizationStatusCodeCollectionResponse
{
    /**
     * @var array<int, SynchronizationStatusCode>
     */
    public array $value = [];
