...
/**
 * Collection response for SynchronizationStatusCode
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationStatusCodeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SynchronizationStatusCode[] $items
     * @return self
     */
    public function setValue(array|SynchronizationStatusCode $items, SynchronizationStatusCode ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SynchronizationStatusCode> $value
     * @return self
     ...
     * 
     * @param SynchronizationStatusCode $item
     * @return self
     */
    public function addValue(SynchronizationStatusCode $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SynchronizationStatusCode>
     */
