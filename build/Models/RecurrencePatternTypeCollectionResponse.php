...
/**
 * Collection response for RecurrencePatternType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RecurrencePatternTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param RecurrencePatternType[] $items
     * @return self
     */
    public function setValue(array|RecurrencePatternType $items, RecurrencePatternType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RecurrencePatternType> $value
     * @return self
     ...
     * 
     * @param RecurrencePatternType $item
     * @return self
     */
    public function addValue(RecurrencePatternType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RecurrencePatternType>
     */
