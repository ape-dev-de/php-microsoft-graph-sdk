...
/**
 * Collection response for DelegatedAdminAccessDetails
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DelegatedAdminAccessDetailsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DelegatedAdminAccessDetails[]
     */
    private array $value = [];
     ...
     * 
     * @param DelegatedAdminAccessDetails[] $items
     * @return self
     */
    public function setValue(array|DelegatedAdminAccessDetails $items, DelegatedAdminAccessDetails ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DelegatedAdminAccessDetails> $value
     * @return self
     ...
     * 
     * @param DelegatedAdminAccessDetails $item
     * @return self
     */
    public function addValue(DelegatedAdminAccessDetails $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DelegatedAdminAccessDetails>
     */
