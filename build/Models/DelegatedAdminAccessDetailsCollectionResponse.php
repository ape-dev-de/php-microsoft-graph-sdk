 ...
 */
class DelegatedAdminAccessDetailsCollectionResponse
{
    /**
     ...
     * 
     * @param DelegatedAdminAccessDetails ...$items Variable number of DelegatedAdminAccessDetails items
     * @return self
     */
    public function setValue(DelegatedAdminAccessDetails ...$items): self
    {
        $this->value = $items;
        return $this;
    }
