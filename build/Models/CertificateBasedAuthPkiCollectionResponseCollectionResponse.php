...
/**
 * Collection response for CertificateBasedAuthPkiCollectionResponse
 */
class CertificateBasedAuthPkiCollectionResponseCollectionResponse
{
    /**
     * @var CertificateBasedAuthPkiCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CertificateBasedAuthPkiCollectionResponse ...$items Variable number of CertificateBasedAuthPkiCollectionResponse items
     * @return self
     */
    public function setValue(CertificateBasedAuthPkiCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CertificateBasedAuthPkiCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CertificateBasedAuthPkiCollectionResponse $item
     * @return self
     */
    public function addValue(CertificateBasedAuthPkiCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
