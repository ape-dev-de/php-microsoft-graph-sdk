...
/**
 * Collection response for ChatMessageHistoryItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatMessageHistoryItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ChatMessageHistoryItem[] $items
     * @return self
     */
    public function setValue(array|ChatMessageHistoryItem $items, ChatMessageHistoryItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChatMessageHistoryItem> $value
     * @return self
     ...
     * 
     * @param ChatMessageHistoryItem $item
     * @return self
     */
    public function addValue(ChatMessageHistoryItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ChatMessageHistoryItem|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ChatMessageHistoryItem>
     */
