...
/**
 * Collection response for OpenShiftItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OpenShiftItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OpenShiftItem[]
     */
     ...
     * 
     * @param OpenShiftItem[] $items
     * @return self
     */
    public function setValue(array|OpenShiftItem $items, OpenShiftItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OpenShiftItem> $value
     * @return self
     ...
     * 
     * @param OpenShiftItem $item
     * @return self
     */
    public function addValue(OpenShiftItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OpenShiftItem>
     */
