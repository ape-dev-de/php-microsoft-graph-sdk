 ...
 */
class OpenShiftItemCollectionResponse
{
    /**
     * @var OpenShiftItem[]
     */
     ...
     * 
     * @param OpenShiftItem ...$items Variable number of OpenShiftItem items
     * @return self
     */
    public function setValue(OpenShiftItem ...$items): self
    {
        $this->value = $items;
        return $this;
    }
