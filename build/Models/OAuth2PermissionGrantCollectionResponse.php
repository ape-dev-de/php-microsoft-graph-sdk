...
/**
 * Collection response for OAuth2PermissionGrant
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OAuth2PermissionGrantCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param OAuth2PermissionGrant[] $items
     * @return self
     */
    public function setValue(array|OAuth2PermissionGrant $items, OAuth2PermissionGrant ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OAuth2PermissionGrant> $value
     * @return self
     ...
     * 
     * @param OAuth2PermissionGrant $item
     * @return self
     */
    public function addValue(OAuth2PermissionGrant $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OAuth2PermissionGrant|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OAuth2PermissionGrant>
     */
