 ...
 */
class TeamRenamedEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param TeamRenamedEventMessageDetail ...$items Variable number of TeamRenamedEventMessageDetail items
     * @return self
     */
    public function setValue(TeamRenamedEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
