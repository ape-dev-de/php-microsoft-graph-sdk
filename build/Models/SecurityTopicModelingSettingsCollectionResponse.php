 ...
 */
class SecurityTopicModelingSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityTopicModelingSettings ...$items Variable number of SecurityTopicModelingSettings items
     * @return self
     */
    public function setValue(SecurityTopicModelingSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
