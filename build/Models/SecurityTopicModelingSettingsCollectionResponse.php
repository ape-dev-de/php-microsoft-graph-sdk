...
/**
 * Collection response for SecurityTopicModelingSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityTopicModelingSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityTopicModelingSettings[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityTopicModelingSettings[]
     */
     ...
     * 
     * @param SecurityTopicModelingSettings[] $items
     * @return self
     */
    public function setValue(array|SecurityTopicModelingSettings $items, SecurityTopicModelingSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityTopicModelingSettings> $value
     * @return self
     ...
     * 
     * @param SecurityTopicModelingSettings $item
     * @return self
     */
    public function addValue(SecurityTopicModelingSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityTopicModelingSettings|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityTopicModelingSettings>
     */
