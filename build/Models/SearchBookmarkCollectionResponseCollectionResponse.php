...
/**
 * Collection response for SearchBookmarkCollectionResponse
 */
class SearchBookmarkCollectionResponseCollectionResponse
{
    /**
     * @var SearchBookmarkCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SearchBookmarkCollectionResponse ...$items Variable number of SearchBookmarkCollectionResponse items
     * @return self
     */
    public function setValue(SearchBookmarkCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SearchBookmarkCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SearchBookmarkCollectionResponse $item
     * @return self
     */
    public function addValue(SearchBookmarkCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
