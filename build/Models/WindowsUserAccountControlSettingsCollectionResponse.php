...
/**
 * WindowsUserAccountControlSettingsCollectionResponse - Collection response
 */
class WindowsUserAccountControlSettingsCollectionResponse
{
    /**
     * @var array<int, WindowsUserAccountControlSettings>
     */
    public array $value = [];
