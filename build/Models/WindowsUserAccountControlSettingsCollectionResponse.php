...
/**
 * Collection response for WindowsUserAccountControlSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsUserAccountControlSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsUserAccountControlSettings[]
     */
    private array $value = [];
     ...
     * 
     * @return WindowsUserAccountControlSettings[]
     */
     ...
     * 
     * @param WindowsUserAccountControlSettings[] $items
     * @return self
     */
    public function setValue(array|WindowsUserAccountControlSettings $items, WindowsUserAccountControlSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsUserAccountControlSettings> $value
     * @return self
     ...
     * 
     * @param WindowsUserAccountControlSettings $item
     * @return self
     */
    public function addValue(WindowsUserAccountControlSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsUserAccountControlSettings>
     */
