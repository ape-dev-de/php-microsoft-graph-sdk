 ...
 */
class PasswordResetResponseCollectionResponse
{
    /**
     ...
     * 
     * @param PasswordResetResponse ...$items Variable number of PasswordResetResponse items
     * @return self
     */
    public function setValue(PasswordResetResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
