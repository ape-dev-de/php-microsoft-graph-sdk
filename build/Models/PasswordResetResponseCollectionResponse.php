...
/**
 * Collection response for PasswordResetResponse
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PasswordResetResponseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PasswordResetResponse[] $items
     * @return self
     */
    public function setValue(array|PasswordResetResponse $items, PasswordResetResponse ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PasswordResetResponse> $value
     * @return self
     ...
     * 
     * @param PasswordResetResponse $item
     * @return self
     */
    public function addValue(PasswordResetResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PasswordResetResponse>
     */
