...
/**
 * Collection response for CloudPcGalleryImage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcGalleryImageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CloudPcGalleryImage[] $items
     * @return self
     */
    public function setValue(array|CloudPcGalleryImage $items, CloudPcGalleryImage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcGalleryImage> $value
     * @return self
     ...
     * 
     * @param CloudPcGalleryImage $item
     * @return self
     */
    public function addValue(CloudPcGalleryImage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcGalleryImage>
     */
