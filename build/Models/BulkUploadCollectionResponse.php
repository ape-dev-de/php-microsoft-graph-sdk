...
/**
 * Collection response for BulkUpload
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BulkUploadCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BulkUpload[]
     */
     ...
     * 
     * @param BulkUpload[] $items
     * @return self
     */
    public function setValue(array|BulkUpload $items, BulkUpload ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param BulkUpload $item
     * @return self
     */
    public function addValue(BulkUpload $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BulkUpload>
     */
