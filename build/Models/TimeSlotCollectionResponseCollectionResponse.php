...
/**
 * Collection response for TimeSlotCollectionResponse
 */
class TimeSlotCollectionResponseCollectionResponse
{
    /**
     * @var TimeSlotCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TimeSlotCollectionResponse ...$items Variable number of TimeSlotCollectionResponse items
     * @return self
     */
    public function setValue(TimeSlotCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TimeSlotCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TimeSlotCollectionResponse $item
     * @return self
     */
    public function addValue(TimeSlotCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
