...
/**
 * Collection response for MembershipOutlierInsightCollectionResponse
 */
class MembershipOutlierInsightCollectionResponseCollectionResponse
{
    /**
     * @var MembershipOutlierInsightCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MembershipOutlierInsightCollectionResponse ...$items Variable number of MembershipOutlierInsightCollectionResponse items
     * @return self
     */
    public function setValue(MembershipOutlierInsightCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MembershipOutlierInsightCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MembershipOutlierInsightCollectionResponse $item
     * @return self
     */
    public function addValue(MembershipOutlierInsightCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
