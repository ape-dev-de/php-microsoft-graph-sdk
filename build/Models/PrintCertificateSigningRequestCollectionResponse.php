 ...
 */
class PrintCertificateSigningRequestCollectionResponse
{
    /**
     ...
     * 
     * @param PrintCertificateSigningRequest ...$items Variable number of PrintCertificateSigningRequest items
     * @return self
     */
    public function setValue(PrintCertificateSigningRequest ...$items): self
    {
        $this->value = $items;
        return $this;
    }
