...
/**
 * Collection response for PrintCertificateSigningRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintCertificateSigningRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrintCertificateSigningRequest[]
     */
    private array $value = [];
     ...
     * 
     * @param PrintCertificateSigningRequest[] $items
     * @return self
     */
    public function setValue(array|PrintCertificateSigningRequest $items, PrintCertificateSigningRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintCertificateSigningRequest> $value
     * @return self
     ...
     * 
     * @param PrintCertificateSigningRequest $item
     * @return self
     */
    public function addValue(PrintCertificateSigningRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintCertificateSigningRequest>
     */
