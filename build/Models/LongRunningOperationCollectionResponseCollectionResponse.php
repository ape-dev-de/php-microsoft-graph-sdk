...
/**
 * Collection response for LongRunningOperationCollectionResponse
 */
class LongRunningOperationCollectionResponseCollectionResponse
{
    /**
     * @var LongRunningOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param LongRunningOperationCollectionResponse ...$items Variable number of LongRunningOperationCollectionResponse items
     * @return self
     */
    public function setValue(LongRunningOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<LongRunningOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param LongRunningOperationCollectionResponse $item
     * @return self
     */
    public function addValue(LongRunningOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
