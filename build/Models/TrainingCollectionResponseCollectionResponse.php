...
/**
 * Collection response for TrainingCollectionResponse
 */
class TrainingCollectionResponseCollectionResponse
{
    /**
     * @var TrainingCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TrainingCollectionResponse ...$items Variable number of TrainingCollectionResponse items
     * @return self
     */
    public function setValue(TrainingCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TrainingCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TrainingCollectionResponse $item
     * @return self
     */
    public function addValue(TrainingCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
