...
/**
 * Collection response for Win32LobAppReturnCode
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Win32LobAppReturnCodeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param Win32LobAppReturnCode[] $items
     * @return self
     */
    public function setValue(array|Win32LobAppReturnCode $items, Win32LobAppReturnCode ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Win32LobAppReturnCode> $value
     * @return self
     ...
     * 
     * @param Win32LobAppReturnCode $item
     * @return self
     */
    public function addValue(Win32LobAppReturnCode $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return Win32LobAppReturnCode|null
     */
     ...
     * 
     * @return \ArrayIterator<int, Win32LobAppReturnCode>
     */
