...
/**
 * Collection response for MobileAppRelationship
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MobileAppRelationshipCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MobileAppRelationship[] $items
     * @return self
     */
    public function setValue(array|MobileAppRelationship $items, MobileAppRelationship ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MobileAppRelationship> $value
     * @return self
     ...
     * 
     * @param MobileAppRelationship $item
     * @return self
     */
    public function addValue(MobileAppRelationship $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MobileAppRelationship>
     */
