...
/**
 * Collection response for ODataErrorsErrorDetails
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ODataErrorsErrorDetailsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return ODataErrorsErrorDetails[]
     */
     ...
     * 
     * @param ODataErrorsErrorDetails[] $items
     * @return self
     */
    public function setValue(array|ODataErrorsErrorDetails $items, ODataErrorsErrorDetails ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ODataErrorsErrorDetails> $value
     * @return self
     ...
     * 
     * @param ODataErrorsErrorDetails $item
     * @return self
     */
    public function addValue(ODataErrorsErrorDetails $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ODataErrorsErrorDetails|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ODataErrorsErrorDetails>
     */
