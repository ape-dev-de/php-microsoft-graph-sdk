 ...
 */
class ODataErrorsErrorDetailsCollectionResponse
{
    /**
     ...
     * 
     * @param ODataErrorsErrorDetails ...$items Variable number of ODataErrorsErrorDetails items
     * @return self
     */
    public function setValue(ODataErrorsErrorDetails ...$items): self
    {
        $this->value = $items;
        return $this;
    }
