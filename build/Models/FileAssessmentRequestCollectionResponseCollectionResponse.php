...
/**
 * Collection response for FileAssessmentRequestCollectionResponse
 */
class FileAssessmentRequestCollectionResponseCollectionResponse
{
    /**
     * @var FileAssessmentRequestCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param FileAssessmentRequestCollectionResponse ...$items Variable number of FileAssessmentRequestCollectionResponse items
     * @return self
     */
    public function setValue(FileAssessmentRequestCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<FileAssessmentRequestCollectionResponse> $value
     * @return self
     ...
     * 
     * @param FileAssessmentRequestCollectionResponse $item
     * @return self
     */
    public function addValue(FileAssessmentRequestCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
