...
/**
 * Collection response for IdentityCollectionResponse
 */
class IdentityCollectionResponseCollectionResponse
{
    /**
     * @var IdentityCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityCollectionResponse ...$items Variable number of IdentityCollectionResponse items
     * @return self
     */
    public function setValue(IdentityCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IdentityCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IdentityCollectionResponse $item
     * @return self
     */
    public function addValue(IdentityCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
