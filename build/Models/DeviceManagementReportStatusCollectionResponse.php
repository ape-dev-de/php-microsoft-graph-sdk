...
/**
 * DeviceManagementReportStatusCollectionResponse - Collection response
 */
class DeviceManagementReportStatusCollectionResponse
{
    /**
     * @var array<int, DeviceManagementReportStatus>
     */
    public array $value = [];
