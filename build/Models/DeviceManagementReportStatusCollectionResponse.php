...
/**
 * Collection response for DeviceManagementReportStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceManagementReportStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceManagementReportStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return DeviceManagementReportStatus[]
     */
     ...
     * 
     * @param DeviceManagementReportStatus[] $items
     * @return self
     */
    public function setValue(array|DeviceManagementReportStatus $items, DeviceManagementReportStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceManagementReportStatus> $value
     * @return self
     ...
     * 
     * @param DeviceManagementReportStatus $item
     * @return self
     */
    public function addValue(DeviceManagementReportStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceManagementReportStatus>
     */
