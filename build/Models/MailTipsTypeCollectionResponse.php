...
/**
 * Collection response for MailTipsType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MailTipsTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MailTipsType[]
     */
     ...
     * 
     * @param MailTipsType[] $items
     * @return self
     */
    public function setValue(array|MailTipsType $items, MailTipsType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MailTipsType> $value
     * @return self
     ...
     * 
     * @param MailTipsType $item
     * @return self
     */
    public function addValue(MailTipsType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MailTipsType>
     */
