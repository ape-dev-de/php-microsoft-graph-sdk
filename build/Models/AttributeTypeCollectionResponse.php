...
/**
 * Collection response for AttributeType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttributeTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AttributeType[]
     */
     ...
     * 
     * @param AttributeType[] $items
     * @return self
     */
    public function setValue(array|AttributeType $items, AttributeType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttributeType> $value
     * @return self
     ...
     * @return self
     */
    public function addValue(AttributeType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AttributeType>
     */
