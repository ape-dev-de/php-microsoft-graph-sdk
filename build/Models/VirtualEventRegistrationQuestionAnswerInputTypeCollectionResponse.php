...
/**
 * Collection response for VirtualEventRegistrationQuestionAnswerInputType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualEventRegistrationQuestionAnswerInputTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VirtualEventRegistrationQuestionAnswerInputType[]
     */
    private array $value = [];
     ...
     * 
     * @return VirtualEventRegistrationQuestionAnswerInputType[]
     */
     ...
     * 
     * @param VirtualEventRegistrationQuestionAnswerInputType[] $items
     * @return self
     */
    public function setValue(array|VirtualEventRegistrationQuestionAnswerInputType $items, VirtualEventRegistrationQuestionAnswerInputType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualEventRegistrationQuestionAnswerInputType> $value
     * @return self
     ...
     * 
     * @param VirtualEventRegistrationQuestionAnswerInputType $item
     * @return self
     */
    public function addValue(VirtualEventRegistrationQuestionAnswerInputType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VirtualEventRegistrationQuestionAnswerInputType>
     */
