...
/**
 * VirtualEventRegistrationQuestionAnswerInputTypeCollectionResponse - Collection response
 */
class VirtualEventRegistrationQuestionAnswerInputTypeCollectionResponse
{
    /**
     * @var array<int, VirtualEventRegistrationQuestionAnswerInputType>
     */
    public array $value = [];
