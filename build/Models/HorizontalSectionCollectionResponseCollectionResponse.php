...
/**
 * Collection response for HorizontalSectionCollectionResponse
 */
class HorizontalSectionCollectionResponseCollectionResponse
{
    /**
     * @var HorizontalSectionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param HorizontalSectionCollectionResponse ...$items Variable number of HorizontalSectionCollectionResponse items
     * @return self
     */
    public function setValue(HorizontalSectionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<HorizontalSectionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param HorizontalSectionCollectionResponse $item
     * @return self
     */
    public function addValue(HorizontalSectionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
