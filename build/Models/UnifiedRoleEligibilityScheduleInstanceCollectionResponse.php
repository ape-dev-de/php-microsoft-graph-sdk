...
/**
 * Collection response for UnifiedRoleEligibilityScheduleInstance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRoleEligibilityScheduleInstanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UnifiedRoleEligibilityScheduleInstance[] $items
     * @return self
     */
    public function setValue(array|UnifiedRoleEligibilityScheduleInstance $items, UnifiedRoleEligibilityScheduleInstance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRoleEligibilityScheduleInstance> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleEligibilityScheduleInstance $item
     * @return self
     */
    public function addValue(UnifiedRoleEligibilityScheduleInstance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRoleEligibilityScheduleInstance>
     */
