...
/**
 * Collection response for AndroidWorkProfileGeneralDeviceConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AndroidWorkProfileGeneralDeviceConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AndroidWorkProfileGeneralDeviceConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param AndroidWorkProfileGeneralDeviceConfiguration[] $items
     * @return self
     */
    public function setValue(array|AndroidWorkProfileGeneralDeviceConfiguration $items, AndroidWorkProfileGeneralDeviceConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AndroidWorkProfileGeneralDeviceConfiguration> $value
     * @return self
     ...
     * 
     * @param AndroidWorkProfileGeneralDeviceConfiguration $item
     * @return self
     */
    public function addValue(AndroidWorkProfileGeneralDeviceConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AndroidWorkProfileGeneralDeviceConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AndroidWorkProfileGeneralDeviceConfiguration>
     */
