...
/**
 * Collection response for DeviceOperatingSystemSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceOperatingSystemSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceOperatingSystemSummary[] $items
     * @return self
     */
    public function setValue(array|DeviceOperatingSystemSummary $items, DeviceOperatingSystemSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceOperatingSystemSummary> $value
     * @return self
     ...
     * 
     * @param DeviceOperatingSystemSummary $item
     * @return self
     */
    public function addValue(DeviceOperatingSystemSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceOperatingSystemSummary>
     */
