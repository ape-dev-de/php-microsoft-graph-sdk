 ...
 */
class DeviceOperatingSystemSummaryCollectionResponse
{
    /**
     ...
     * 
     * @param DeviceOperatingSystemSummary ...$items Variable number of DeviceOperatingSystemSummary items
     * @return self
     */
    public function setValue(DeviceOperatingSystemSummary ...$items): self
    {
        $this->value = $items;
        return $this;
    }
