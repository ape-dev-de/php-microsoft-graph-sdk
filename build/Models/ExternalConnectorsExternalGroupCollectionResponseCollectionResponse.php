...
/**
 * Collection response for ExternalConnectorsExternalGroupCollectionResponse
 */
class ExternalConnectorsExternalGroupCollectionResponseCollectionResponse
{
    /**
     * @var ExternalConnectorsExternalGroupCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ExternalConnectorsExternalGroupCollectionResponse ...$items Variable number of ExternalConnectorsExternalGroupCollectionResponse items
     * @return self
     */
    public function setValue(ExternalConnectorsExternalGroupCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ExternalConnectorsExternalGroupCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsExternalGroupCollectionResponse $item
     * @return self
     */
    public function addValue(ExternalConnectorsExternalGroupCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
