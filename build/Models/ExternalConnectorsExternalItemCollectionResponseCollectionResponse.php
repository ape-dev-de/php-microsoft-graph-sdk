...
/**
 * Collection response for ExternalConnectorsExternalItemCollectionResponse
 */
class ExternalConnectorsExternalItemCollectionResponseCollectionResponse
{
    /**
     * @var ExternalConnectorsExternalItemCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ExternalConnectorsExternalItemCollectionResponse ...$items Variable number of ExternalConnectorsExternalItemCollectionResponse items
     * @return self
     */
    public function setValue(ExternalConnectorsExternalItemCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ExternalConnectorsExternalItemCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsExternalItemCollectionResponse $item
     * @return self
     */
    public function addValue(ExternalConnectorsExternalItemCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
