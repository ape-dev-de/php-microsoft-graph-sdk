 ...
 */
class SecurityFormattedContentCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityFormattedContent ...$items Variable number of SecurityFormattedContent items
     * @return self
     */
    public function setValue(SecurityFormattedContent ...$items): self
    {
        $this->value = $items;
        return $this;
    }
