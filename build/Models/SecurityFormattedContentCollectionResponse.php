...
/**
 * Collection response for SecurityFormattedContent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityFormattedContentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityFormattedContent[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityFormattedContent[]
     */
     ...
     * 
     * @param SecurityFormattedContent[] $items
     * @return self
     */
    public function setValue(array|SecurityFormattedContent $items, SecurityFormattedContent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityFormattedContent> $value
     * @return self
     ...
     * 
     * @param SecurityFormattedContent $item
     * @return self
     */
    public function addValue(SecurityFormattedContent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityFormattedContent|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityFormattedContent>
     */
