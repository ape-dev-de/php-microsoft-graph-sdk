...
/**
 * Collection response for MicrosoftAuthenticatorAuthenticationMethod
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MicrosoftAuthenticatorAuthenticationMethodCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MicrosoftAuthenticatorAuthenticationMethod[] $items
     * @return self
     */
    public function setValue(array|MicrosoftAuthenticatorAuthenticationMethod $items, MicrosoftAuthenticatorAuthenticationMethod ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MicrosoftAuthenticatorAuthenticationMethod> $value
     * @return self
     ...
     * 
     * @param MicrosoftAuthenticatorAuthenticationMethod $item
     * @return self
     */
    public function addValue(MicrosoftAuthenticatorAuthenticationMethod $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MicrosoftAuthenticatorAuthenticationMethod>
     */
