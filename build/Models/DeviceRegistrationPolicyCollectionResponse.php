...
/**
 * Collection response for DeviceRegistrationPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceRegistrationPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceRegistrationPolicy[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceRegistrationPolicy[] $items
     * @return self
     */
    public function setValue(array|DeviceRegistrationPolicy $items, DeviceRegistrationPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceRegistrationPolicy> $value
     * @return self
     ...
     * 
     * @param DeviceRegistrationPolicy $item
     * @return self
     */
    public function addValue(DeviceRegistrationPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceRegistrationPolicy>
     */
