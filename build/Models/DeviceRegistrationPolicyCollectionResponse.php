 ...
 */
class DeviceRegistrationPolicyCollectionResponse
{
    /**
     ...
     * 
     * @param DeviceRegistrationPolicy ...$items Variable number of DeviceRegistrationPolicy items
     * @return self
     */
    public function setValue(DeviceRegistrationPolicy ...$items): self
    {
        $this->value = $items;
        return $this;
    }
