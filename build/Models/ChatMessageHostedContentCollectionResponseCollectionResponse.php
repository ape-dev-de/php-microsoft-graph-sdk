...
/**
 * Collection response for ChatMessageHostedContentCollectionResponse
 */
class ChatMessageHostedContentCollectionResponseCollectionResponse
{
    /**
     * @var ChatMessageHostedContentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ChatMessageHostedContentCollectionResponse ...$items Variable number of ChatMessageHostedContentCollectionResponse items
     * @return self
     */
    public function setValue(ChatMessageHostedContentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ChatMessageHostedContentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ChatMessageHostedContentCollectionResponse $item
     * @return self
     */
    public function addValue(ChatMessageHostedContentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
