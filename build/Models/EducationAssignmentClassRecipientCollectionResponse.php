...
/**
 * EducationAssignmentClassRecipientCollectionResponse - Collection response
 */
class EducationAssignmentClassRecipientCollectionResponse
{
    /**
     * @var array<int, EducationAssignmentClassRecipient>
     */
    public array $value = [];
