...
/**
 * Collection response for EducationAssignmentClassRecipient
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationAssignmentClassRecipientCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationAssignmentClassRecipient[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationAssignmentClassRecipient[] $items
     * @return self
     */
    public function setValue(array|EducationAssignmentClassRecipient $items, EducationAssignmentClassRecipient ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationAssignmentClassRecipient> $value
     * @return self
     ...
     * 
     * @param EducationAssignmentClassRecipient $item
     * @return self
     */
    public function addValue(EducationAssignmentClassRecipient $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EducationAssignmentClassRecipient|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EducationAssignmentClassRecipient>
     */
