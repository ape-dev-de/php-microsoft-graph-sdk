...
/**
 * Collection response for DelegatedAdminAccessAssignmentCollectionResponse
 */
class DelegatedAdminAccessAssignmentCollectionResponseCollectionResponse
{
    /**
     * @var DelegatedAdminAccessAssignmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DelegatedAdminAccessAssignmentCollectionResponse ...$items Variable number of DelegatedAdminAccessAssignmentCollectionResponse items
     * @return self
     */
    public function setValue(DelegatedAdminAccessAssignmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DelegatedAdminAccessAssignmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DelegatedAdminAccessAssignmentCollectionResponse $item
     * @return self
     */
    public function addValue(DelegatedAdminAccessAssignmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
