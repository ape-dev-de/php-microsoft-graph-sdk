...
/**
 * Collection response for MediaContentRatingCanada
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MediaContentRatingCanadaCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MediaContentRatingCanada[] $items
     * @return self
     */
    public function setValue(array|MediaContentRatingCanada $items, MediaContentRatingCanada ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MediaContentRatingCanada> $value
     * @return self
     ...
     * 
     * @param MediaContentRatingCanada $item
     * @return self
     */
    public function addValue(MediaContentRatingCanada $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MediaContentRatingCanada>
     */
