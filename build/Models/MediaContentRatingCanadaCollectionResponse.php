 ...
 */
class MediaContentRatingCanadaCollectionResponse
{
    /**
     ...
     * 
     * @param MediaContentRatingCanada ...$items Variable number of MediaContentRatingCanada items
     * @return self
     */
    public function setValue(MediaContentRatingCanada ...$items): self
    {
        $this->value = $items;
        return $this;
    }
