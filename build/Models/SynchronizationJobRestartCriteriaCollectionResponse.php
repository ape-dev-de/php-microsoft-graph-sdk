...
/**
 * Collection response for SynchronizationJobRestartCriteria
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationJobRestartCriteriaCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SynchronizationJobRestartCriteria[]
     */
    private array $value = [];
     ...
     * 
     * @param SynchronizationJobRestartCriteria[] $items
     * @return self
     */
    public function setValue(array|SynchronizationJobRestartCriteria $items, SynchronizationJobRestartCriteria ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SynchronizationJobRestartCriteria> $value
     * @return self
     ...
     * 
     * @param SynchronizationJobRestartCriteria $item
     * @return self
     */
    public function addValue(SynchronizationJobRestartCriteria $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SynchronizationJobRestartCriteria>
     */
