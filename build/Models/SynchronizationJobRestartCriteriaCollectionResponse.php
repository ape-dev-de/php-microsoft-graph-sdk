 ...
 */
class SynchronizationJobRestartCriteriaCollectionResponse
{
    /**
     ...
     * 
     * @param SynchronizationJobRestartCriteria ...$items Variable number of SynchronizationJobRestartCriteria items
     * @return self
     */
    public function setValue(SynchronizationJobRestartCriteria ...$items): self
    {
        $this->value = $items;
        return $this;
    }
