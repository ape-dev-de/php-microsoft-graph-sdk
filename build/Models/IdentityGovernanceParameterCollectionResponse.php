...
/**
 * Collection response for IdentityGovernanceParameter
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceParameterCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return IdentityGovernanceParameter[]
     */
     ...
     * 
     * @param IdentityGovernanceParameter[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceParameter $items, IdentityGovernanceParameter ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceParameter> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceParameter $item
     * @return self
     */
    public function addValue(IdentityGovernanceParameter $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceParameter|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceParameter>
     */
