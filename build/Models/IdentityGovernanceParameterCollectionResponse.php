...
/**
 * IdentityGovernanceParameterCollectionResponse - Collection response
 */
class IdentityGovernanceParameterCollectionResponse
{
    /**
     * @var array<int, IdentityGovernanceParameter>
     */
    public array $value = [];
