...
/**
 * Collection response for AccessReviewStage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewStageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessReviewStage[] $items
     * @return self
     */
    public function setValue(array|AccessReviewStage $items, AccessReviewStage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewStage> $value
     * @return self
     ...
     * 
     * @param AccessReviewStage $item
     * @return self
     */
    public function addValue(AccessReviewStage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewStage>
     */
