...
/**
 * Collection response for ReadingAssignmentSubmission
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ReadingAssignmentSubmissionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ReadingAssignmentSubmission[] $items
     * @return self
     */
    public function setValue(array|ReadingAssignmentSubmission $items, ReadingAssignmentSubmission ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ReadingAssignmentSubmission> $value
     * @return self
     ...
     * 
     * @param ReadingAssignmentSubmission $item
     * @return self
     */
    public function addValue(ReadingAssignmentSubmission $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ReadingAssignmentSubmission>
     */
