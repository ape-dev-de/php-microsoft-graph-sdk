...
/**
 * ReadingAssignmentSubmissionCollectionResponse - Collection response
 */
class ReadingAssignmentSubmissionCollectionResponse
{
    /**
     * @var array<int, ReadingAssignmentSubmission>
     */
    public array $value = [];
