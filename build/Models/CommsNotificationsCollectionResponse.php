 ...
 */
class CommsNotificationsCollectionResponse
{
    /**
     ...
     * 
     * @param CommsNotifications ...$items Variable number of CommsNotifications items
     * @return self
     */
    public function setValue(CommsNotifications ...$items): self
    {
        $this->value = $items;
        return $this;
    }
