...
/**
 * Collection response for CommsNotifications
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CommsNotificationsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CommsNotifications[]
     */
    private array $value = [];
     ...
     * 
     * @param CommsNotifications[] $items
     * @return self
     */
    public function setValue(array|CommsNotifications $items, CommsNotifications ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CommsNotifications> $value
     * @return self
     ...
     * 
     * @param CommsNotifications $item
     * @return self
     */
    public function addValue(CommsNotifications $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CommsNotifications|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CommsNotifications>
     */
