...
/**
 * Collection response for ColumnTypes
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ColumnTypesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ColumnTypes[]
     */
     ...
     * 
     * @param ColumnTypes[] $items
     * @return self
     */
    public function setValue(array|ColumnTypes $items, ColumnTypes ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param ColumnTypes $item
     * @return self
     */
    public function addValue(ColumnTypes $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ColumnTypes>
     */
