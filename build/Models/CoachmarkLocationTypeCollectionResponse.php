...
/**
 * Collection response for CoachmarkLocationType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CoachmarkLocationTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CoachmarkLocationType[]
     */
    private array $value = [];
     ...
     * 
     * @param CoachmarkLocationType[] $items
     * @return self
     */
    public function setValue(array|CoachmarkLocationType $items, CoachmarkLocationType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CoachmarkLocationType> $value
     * @return self
     ...
     * 
     * @param CoachmarkLocationType $item
     * @return self
     */
    public function addValue(CoachmarkLocationType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CoachmarkLocationType>
     */
