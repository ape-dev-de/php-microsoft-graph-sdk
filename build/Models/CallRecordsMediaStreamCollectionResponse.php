...
/**
 * Collection response for CallRecordsMediaStream
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsMediaStreamCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CallRecordsMediaStream[] $items
     * @return self
     */
    public function setValue(array|CallRecordsMediaStream $items, CallRecordsMediaStream ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsMediaStream> $value
     * @return self
     ...
     * 
     * @param CallRecordsMediaStream $item
     * @return self
     */
    public function addValue(CallRecordsMediaStream $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsMediaStream|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsMediaStream>
     */
