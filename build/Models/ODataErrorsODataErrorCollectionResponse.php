...
/**
 * Collection response for ODataErrorsODataError
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ODataErrorsODataErrorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ODataErrorsODataError[]
     */
    private array $value = [];
     ...
     * 
     * @param ODataErrorsODataError[] $items
     * @return self
     */
    public function setValue(array|ODataErrorsODataError $items, ODataErrorsODataError ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ODataErrorsODataError> $value
     * @return self
     ...
     * 
     * @param ODataErrorsODataError $item
     * @return self
     */
    public function addValue(ODataErrorsODataError $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ODataErrorsODataError|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ODataErrorsODataError>
     */
