 ...
 */
class ODataErrorsODataErrorCollectionResponse
{
    /**
     ...
     * 
     * @param ODataErrorsODataError ...$items Variable number of ODataErrorsODataError items
     * @return self
     */
    public function setValue(ODataErrorsODataError ...$items): self
    {
        $this->value = $items;
        return $this;
    }
