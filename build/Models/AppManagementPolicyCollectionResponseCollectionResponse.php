...
/**
 * Collection response for AppManagementPolicyCollectionResponse
 */
class AppManagementPolicyCollectionResponseCollectionResponse
{
    /**
     * @var AppManagementPolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AppManagementPolicyCollectionResponse ...$items Variable number of AppManagementPolicyCollectionResponse items
     * @return self
     */
    public function setValue(AppManagementPolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AppManagementPolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AppManagementPolicyCollectionResponse $item
     * @return self
     */
    public function addValue(AppManagementPolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
