...
/**
 * Collection response for SharePointProtectionPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SharePointProtectionPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SharePointProtectionPolicy[] $items
     * @return self
     */
    public function setValue(array|SharePointProtectionPolicy $items, SharePointProtectionPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SharePointProtectionPolicy> $value
     * @return self
     ...
     * 
     * @param SharePointProtectionPolicy $item
     * @return self
     */
    public function addValue(SharePointProtectionPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SharePointProtectionPolicy>
     */
