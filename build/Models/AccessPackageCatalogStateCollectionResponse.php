...
/**
 * AccessPackageCatalogStateCollectionResponse - Collection response
 */
class AccessPackageCatalogStateCollectionResponse
{
    /**
     * @var array<int, AccessPackageCatalogState>
     */
    public array $value = [];
