...
/**
 * Collection response for AccessPackageCatalogState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageCatalogStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageCatalogState[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageCatalogState[] $items
     * @return self
     */
    public function setValue(array|AccessPackageCatalogState $items, AccessPackageCatalogState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageCatalogState> $value
     * @return self
     ...
     * 
     * @param AccessPackageCatalogState $item
     * @return self
     */
    public function addValue(AccessPackageCatalogState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageCatalogState>
     */
