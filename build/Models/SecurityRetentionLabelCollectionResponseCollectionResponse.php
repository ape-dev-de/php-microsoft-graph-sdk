...
/**
 * Collection response for SecurityRetentionLabelCollectionResponse
 */
class SecurityRetentionLabelCollectionResponseCollectionResponse
{
    /**
     * @var SecurityRetentionLabelCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityRetentionLabelCollectionResponse ...$items Variable number of SecurityRetentionLabelCollectionResponse items
     * @return self
     */
    public function setValue(SecurityRetentionLabelCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityRetentionLabelCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityRetentionLabelCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityRetentionLabelCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
