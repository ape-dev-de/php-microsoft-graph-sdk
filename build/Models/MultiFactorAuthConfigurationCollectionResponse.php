...
/**
 * MultiFactorAuthConfigurationCollectionResponse - Collection response
 */
class MultiFactorAuthConfigurationCollectionResponse
{
    /**
     * @var array<int, MultiFactorAuthConfiguration>
     */
    public array $value = [];
