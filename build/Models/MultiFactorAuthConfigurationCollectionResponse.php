...
/**
 * Collection response for MultiFactorAuthConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MultiFactorAuthConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return MultiFactorAuthConfiguration[]
     */
     ...
     * 
     * @param MultiFactorAuthConfiguration[] $items
     * @return self
     */
    public function setValue(array|MultiFactorAuthConfiguration $items, MultiFactorAuthConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MultiFactorAuthConfiguration> $value
     * @return self
     ...
     * 
     * @param MultiFactorAuthConfiguration $item
     * @return self
     */
    public function addValue(MultiFactorAuthConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MultiFactorAuthConfiguration>
     */
