...
/**
 * Collection response for BucketAggregationRange
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BucketAggregationRangeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param BucketAggregationRange[] $items
     * @return self
     */
    public function setValue(array|BucketAggregationRange $items, BucketAggregationRange ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BucketAggregationRange> $value
     * @return self
     ...
     * 
     * @param BucketAggregationRange $item
     * @return self
     */
    public function addValue(BucketAggregationRange $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return BucketAggregationRange|null
     */
     ...
     * 
     * @return \ArrayIterator<int, BucketAggregationRange>
     */
