...
/**
 * Collection response for DeviceActionResultCollectionResponse
 */
class DeviceActionResultCollectionResponseCollectionResponse
{
    /**
     * @var DeviceActionResultCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceActionResultCollectionResponse ...$items Variable number of DeviceActionResultCollectionResponse items
     * @return self
     */
    public function setValue(DeviceActionResultCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeviceActionResultCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeviceActionResultCollectionResponse $item
     * @return self
     */
    public function addValue(DeviceActionResultCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
