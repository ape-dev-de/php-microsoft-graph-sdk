...
/**
 * Collection response for ProcessingError
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProcessingErrorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProcessingError[]
     */
     ...
     * 
     * @param ProcessingError[] $items
     * @return self
     */
    public function setValue(array|ProcessingError $items, ProcessingError ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProcessingError> $value
     * @return self
     ...
     * 
     * @param ProcessingError $item
     * @return self
     */
    public function addValue(ProcessingError $item): self
    {
        $this->value[] = $item;
        return $this;
    }
