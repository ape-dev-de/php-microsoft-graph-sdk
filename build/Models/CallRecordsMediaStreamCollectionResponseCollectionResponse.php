...
/**
 * Collection response for CallRecordsMediaStreamCollectionResponse
 */
class CallRecordsMediaStreamCollectionResponseCollectionResponse
{
    /**
     * @var CallRecordsMediaStreamCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return CallRecordsMediaStreamCollectionResponse[]
     */
     ...
     * 
     * @param CallRecordsMediaStreamCollectionResponse ...$items Variable number of CallRecordsMediaStreamCollectionResponse items
     * @return self
     */
    public function setValue(CallRecordsMediaStreamCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CallRecordsMediaStreamCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CallRecordsMediaStreamCollectionResponse $item
     * @return self
     */
    public function addValue(CallRecordsMediaStreamCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
