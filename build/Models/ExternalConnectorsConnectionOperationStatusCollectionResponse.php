...
/**
 * ExternalConnectorsConnectionOperationStatusCollectionResponse - Collection response
 */
class ExternalConnectorsConnectionOperationStatusCollectionResponse
{
    /**
     * @var array<int, ExternalConnectorsConnectionOperationStatus>
     */
    public array $value = [];
