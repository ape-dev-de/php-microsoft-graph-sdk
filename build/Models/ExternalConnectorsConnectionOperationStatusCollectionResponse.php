...
/**
 * Collection response for ExternalConnectorsConnectionOperationStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsConnectionOperationStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalConnectorsConnectionOperationStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return ExternalConnectorsConnectionOperationStatus[]
     */
     ...
     * 
     * @param ExternalConnectorsConnectionOperationStatus[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsConnectionOperationStatus $items, ExternalConnectorsConnectionOperationStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsConnectionOperationStatus> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsConnectionOperationStatus $item
     * @return self
     */
    public function addValue(ExternalConnectorsConnectionOperationStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalConnectorsConnectionOperationStatus|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsConnectionOperationStatus>
     */
