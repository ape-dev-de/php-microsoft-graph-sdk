...
/**
 * Collection response for EducationOutcome
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationOutcomeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param EducationOutcome[] $items
     * @return self
     */
    public function setValue(array|EducationOutcome $items, EducationOutcome ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationOutcome> $value
     * @return self
     ...
     * 
     * @param EducationOutcome $item
     * @return self
     */
    public function addValue(EducationOutcome $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationOutcome>
     */
