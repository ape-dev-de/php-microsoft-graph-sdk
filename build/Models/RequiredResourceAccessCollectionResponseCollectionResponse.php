...
/**
 * Collection response for RequiredResourceAccessCollectionResponse
 */
class RequiredResourceAccessCollectionResponseCollectionResponse
{
    /**
     * @var RequiredResourceAccessCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RequiredResourceAccessCollectionResponse ...$items Variable number of RequiredResourceAccessCollectionResponse items
     * @return self
     */
    public function setValue(RequiredResourceAccessCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RequiredResourceAccessCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RequiredResourceAccessCollectionResponse $item
     * @return self
     */
    public function addValue(RequiredResourceAccessCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
