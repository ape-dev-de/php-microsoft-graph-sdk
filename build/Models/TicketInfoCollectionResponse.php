...
/**
 * Collection response for TicketInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TicketInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TicketInfo[]
     */
     ...
     * 
     * @param TicketInfo[] $items
     * @return self
     */
    public function setValue(array|TicketInfo $items, TicketInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param TicketInfo $item
     * @return self
     */
    public function addValue(TicketInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TicketInfo>
     */
