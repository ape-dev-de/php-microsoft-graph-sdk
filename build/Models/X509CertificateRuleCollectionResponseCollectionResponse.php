...
/**
 * Collection response for X509CertificateRuleCollectionResponse
 */
class X509CertificateRuleCollectionResponseCollectionResponse
{
    /**
     * @var X509CertificateRuleCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param X509CertificateRuleCollectionResponse ...$items Variable number of X509CertificateRuleCollectionResponse items
     * @return self
     */
    public function setValue(X509CertificateRuleCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<X509CertificateRuleCollectionResponse> $value
     * @return self
     ...
     * 
     * @param X509CertificateRuleCollectionResponse $item
     * @return self
     */
    public function addValue(X509CertificateRuleCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
