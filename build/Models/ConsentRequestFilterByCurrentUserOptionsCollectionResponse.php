...
/**
 * ConsentRequestFilterByCurrentUserOptionsCollectionResponse - Collection response
 */
class ConsentRequestFilterByCurrentUserOptionsCollectionResponse
{
    /**
     * @var array<int, ConsentRequestFilterByCurrentUserOptions>
     */
    public array $value = [];
