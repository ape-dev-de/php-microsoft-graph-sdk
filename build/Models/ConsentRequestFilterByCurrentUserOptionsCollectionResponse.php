...
/**
 * Collection response for ConsentRequestFilterByCurrentUserOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConsentRequestFilterByCurrentUserOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConsentRequestFilterByCurrentUserOptions[]
     */
    private array $value = [];
     ...
     * 
     * @return ConsentRequestFilterByCurrentUserOptions[]
     */
     ...
     * 
     * @param ConsentRequestFilterByCurrentUserOptions[] $items
     * @return self
     */
    public function setValue(array|ConsentRequestFilterByCurrentUserOptions $items, ConsentRequestFilterByCurrentUserOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConsentRequestFilterByCurrentUserOptions> $value
     * @return self
     ...
     * 
     * @param ConsentRequestFilterByCurrentUserOptions $item
     * @return self
     */
    public function addValue(ConsentRequestFilterByCurrentUserOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ConsentRequestFilterByCurrentUserOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ConsentRequestFilterByCurrentUserOptions>
     */
