...
/**
 * Collection response for WorkbookWorksheet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookWorksheetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WorkbookWorksheet[] $items
     * @return self
     */
    public function setValue(array|WorkbookWorksheet $items, WorkbookWorksheet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookWorksheet> $value
     * @return self
     ...
     * 
     * @param WorkbookWorksheet $item
     * @return self
     */
    public function addValue(WorkbookWorksheet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookWorksheet>
     */
