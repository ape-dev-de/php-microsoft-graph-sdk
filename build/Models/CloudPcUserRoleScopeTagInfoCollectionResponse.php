...
/**
 * Collection response for CloudPcUserRoleScopeTagInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcUserRoleScopeTagInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CloudPcUserRoleScopeTagInfo[] $items
     * @return self
     */
    public function setValue(array|CloudPcUserRoleScopeTagInfo $items, CloudPcUserRoleScopeTagInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcUserRoleScopeTagInfo> $value
     * @return self
     ...
     * 
     * @param CloudPcUserRoleScopeTagInfo $item
     * @return self
     */
    public function addValue(CloudPcUserRoleScopeTagInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CloudPcUserRoleScopeTagInfo|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CloudPcUserRoleScopeTagInfo>
     */
