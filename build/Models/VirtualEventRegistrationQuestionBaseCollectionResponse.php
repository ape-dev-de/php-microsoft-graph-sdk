...
/**
 * Collection response for VirtualEventRegistrationQuestionBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualEventRegistrationQuestionBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param VirtualEventRegistrationQuestionBase[] $items
     * @return self
     */
    public function setValue(array|VirtualEventRegistrationQuestionBase $items, VirtualEventRegistrationQuestionBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualEventRegistrationQuestionBase> $value
     * @return self
     ...
     * 
     * @param VirtualEventRegistrationQuestionBase $item
     * @return self
     */
    public function addValue(VirtualEventRegistrationQuestionBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VirtualEventRegistrationQuestionBase>
     */
