...
/**
 * Collection response for SwapShiftsChangeRequestCollectionResponse
 */
class SwapShiftsChangeRequestCollectionResponseCollectionResponse
{
    /**
     * @var SwapShiftsChangeRequestCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SwapShiftsChangeRequestCollectionResponse ...$items Variable number of SwapShiftsChangeRequestCollectionResponse items
     * @return self
     */
    public function setValue(SwapShiftsChangeRequestCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SwapShiftsChangeRequestCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SwapShiftsChangeRequestCollectionResponse $item
     * @return self
     */
    public function addValue(SwapShiftsChangeRequestCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
