...
/**
 * Collection response for AssignedLabel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AssignedLabelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AssignedLabel[]
     */
     ...
     * 
     * @param AssignedLabel[] $items
     * @return self
     */
    public function setValue(array|AssignedLabel $items, AssignedLabel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AssignedLabel> $value
     * @return self
     ...
     * 
     * @param AssignedLabel $item
     * @return self
     */
    public function addValue(AssignedLabel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AssignedLabel>
     */
