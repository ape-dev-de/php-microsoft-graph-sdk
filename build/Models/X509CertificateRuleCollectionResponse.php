...
/**
 * Collection response for X509CertificateRule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class X509CertificateRuleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param X509CertificateRule[] $items
     * @return self
     */
    public function setValue(array|X509CertificateRule $items, X509CertificateRule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<X509CertificateRule> $value
     * @return self
     ...
     * 
     * @param X509CertificateRule $item
     * @return self
     */
    public function addValue(X509CertificateRule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return X509CertificateRule|null
     */
     ...
     * 
     * @return \ArrayIterator<int, X509CertificateRule>
     */
