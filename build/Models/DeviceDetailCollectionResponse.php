 ...
 */
class DeviceDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceDetail[]
     */
     ...
     * 
     * @param DeviceDetail[] $items
     * @return self
     */
    public function setValue(array|DeviceDetail $items, DeviceDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @return \ArrayIterator<int, DeviceDetail>
     */
