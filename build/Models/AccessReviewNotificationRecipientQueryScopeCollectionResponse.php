...
/**
 * Collection response for AccessReviewNotificationRecipientQueryScope
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewNotificationRecipientQueryScopeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessReviewNotificationRecipientQueryScope[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessReviewNotificationRecipientQueryScope[] $items
     * @return self
     */
    public function setValue(array|AccessReviewNotificationRecipientQueryScope $items, AccessReviewNotificationRecipientQueryScope ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewNotificationRecipientQueryScope> $value
     * @return self
     ...
     * 
     * @param AccessReviewNotificationRecipientQueryScope $item
     * @return self
     */
    public function addValue(AccessReviewNotificationRecipientQueryScope $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessReviewNotificationRecipientQueryScope|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewNotificationRecipientQueryScope>
     */
