 ...
 */
class AccessReviewNotificationRecipientQueryScopeCollectionResponse
{
    /**
     ...
     * 
     * @param AccessReviewNotificationRecipientQueryScope ...$items Variable number of AccessReviewNotificationRecipientQueryScope items
     * @return self
     */
    public function setValue(AccessReviewNotificationRecipientQueryScope ...$items): self
    {
        $this->value = $items;
        return $this;
    }
