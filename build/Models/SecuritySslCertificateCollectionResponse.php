...
/**
 * Collection response for SecuritySslCertificate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecuritySslCertificateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecuritySslCertificate[] $items
     * @return self
     */
    public function setValue(array|SecuritySslCertificate $items, SecuritySslCertificate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecuritySslCertificate> $value
     * @return self
     ...
     * 
     * @param SecuritySslCertificate $item
     * @return self
     */
    public function addValue(SecuritySslCertificate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecuritySslCertificate>
     */
