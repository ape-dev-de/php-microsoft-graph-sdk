...
/**
 * Collection response for AssignmentType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AssignmentTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AssignmentType[]
     */
     ...
     * 
     * @param AssignmentType[] $items
     * @return self
     */
    public function setValue(array|AssignmentType $items, AssignmentType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AssignmentType> $value
     * @return self
     ...
     * 
     * @param AssignmentType $item
     * @return self
     */
    public function addValue(AssignmentType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AssignmentType>
     */
