...
/**
 * Collection response for SecurityChildSelectability
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityChildSelectabilityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityChildSelectability[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityChildSelectability[]
     */
     ...
     * 
     * @param SecurityChildSelectability[] $items
     * @return self
     */
    public function setValue(array|SecurityChildSelectability $items, SecurityChildSelectability ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityChildSelectability> $value
     * @return self
     ...
     * 
     * @param SecurityChildSelectability $item
     * @return self
     */
    public function addValue(SecurityChildSelectability $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityChildSelectability|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityChildSelectability>
     */
