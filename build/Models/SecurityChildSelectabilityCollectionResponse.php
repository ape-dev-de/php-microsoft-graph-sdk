...
/**
 * SecurityChildSelectabilityCollectionResponse - Collection response
 */
class SecurityChildSelectabilityCollectionResponse
{
    /**
     * @var array<int, SecurityChildSelectability>
     */
    public array $value = [];
