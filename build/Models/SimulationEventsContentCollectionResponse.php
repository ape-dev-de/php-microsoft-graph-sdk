 ...
 */
class SimulationEventsContentCollectionResponse
{
    /**
     ...
     * 
     * @param SimulationEventsContent ...$items Variable number of SimulationEventsContent items
     * @return self
     */
    public function setValue(SimulationEventsContent ...$items): self
    {
        $this->value = $items;
        return $this;
    }
