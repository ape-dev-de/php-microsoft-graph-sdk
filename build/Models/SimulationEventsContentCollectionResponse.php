...
/**
 * Collection response for SimulationEventsContent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SimulationEventsContentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SimulationEventsContent[]
     */
    private array $value = [];
     ...
     * 
     * @param SimulationEventsContent[] $items
     * @return self
     */
    public function setValue(array|SimulationEventsContent $items, SimulationEventsContent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SimulationEventsContent> $value
     * @return self
     ...
     * 
     * @param SimulationEventsContent $item
     * @return self
     */
    public function addValue(SimulationEventsContent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SimulationEventsContent>
     */
