...
/**
 * Collection response for IdentityGovernanceCustomTaskExtensionOperationStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceCustomTaskExtensionOperationStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceCustomTaskExtensionOperationStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceCustomTaskExtensionOperationStatus[]
     */
     ...
     * 
     * @param IdentityGovernanceCustomTaskExtensionOperationStatus[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceCustomTaskExtensionOperationStatus $items, IdentityGovernanceCustomTaskExtensionOperationStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceCustomTaskExtensionOperationStatus> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceCustomTaskExtensionOperationStatus $item
     * @return self
     */
    public function addValue(IdentityGovernanceCustomTaskExtensionOperationStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceCustomTaskExtensionOperationStatus|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceCustomTaskExtensionOperationStatus>
     */
