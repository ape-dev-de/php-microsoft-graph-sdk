...
/**
 * IdentityGovernanceCustomTaskExtensionOperationStatusCollectionResponse - Collection response
 */
class IdentityGovernanceCustomTaskExtensionOperationStatusCollectionResponse
{
    /**
     * @var array<int, IdentityGovernanceCustomTaskExtensionOperationStatus>
     */
    public array $value = [];
