...
/**
 * Collection response for KeyValuePairCollectionResponse
 */
class KeyValuePairCollectionResponseCollectionResponse
{
    /**
     * @var KeyValuePairCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param KeyValuePairCollectionResponse ...$items Variable number of KeyValuePairCollectionResponse items
     * @return self
     */
    public function setValue(KeyValuePairCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<KeyValuePairCollectionResponse> $value
     * @return self
     ...
     * 
     * @param KeyValuePairCollectionResponse $item
     * @return self
     */
    public function addValue(KeyValuePairCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
