...
/**
 * Collection response for VoiceAuthenticationMethodConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VoiceAuthenticationMethodConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VoiceAuthenticationMethodConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param VoiceAuthenticationMethodConfiguration[] $items
     * @return self
     */
    public function setValue(array|VoiceAuthenticationMethodConfiguration $items, VoiceAuthenticationMethodConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VoiceAuthenticationMethodConfiguration> $value
     * @return self
     ...
     * 
     * @param VoiceAuthenticationMethodConfiguration $item
     * @return self
     */
    public function addValue(VoiceAuthenticationMethodConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return VoiceAuthenticationMethodConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, VoiceAuthenticationMethodConfiguration>
     */
