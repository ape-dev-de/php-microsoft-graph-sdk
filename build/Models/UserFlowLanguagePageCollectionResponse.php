...
/**
 * Collection response for UserFlowLanguagePage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserFlowLanguagePageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserFlowLanguagePage[] $items
     * @return self
     */
    public function setValue(array|UserFlowLanguagePage $items, UserFlowLanguagePage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserFlowLanguagePage> $value
     * @return self
     ...
     * 
     * @param UserFlowLanguagePage $item
     * @return self
     */
    public function addValue(UserFlowLanguagePage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserFlowLanguagePage>
     */
