...
/**
 * SharedPCAllowedAccountTypeCollectionResponse - Collection response
 */
class SharedPCAllowedAccountTypeCollectionResponse
{
    /**
     * @var array<int, SharedPCAllowedAccountType>
     */
    public array $value = [];
