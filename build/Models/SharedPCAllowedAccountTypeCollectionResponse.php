...
/**
 * Collection response for SharedPCAllowedAccountType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SharedPCAllowedAccountTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SharedPCAllowedAccountType[]
     */
    private array $value = [];
     ...
     * 
     * @return SharedPCAllowedAccountType[]
     */
     ...
     * 
     * @param SharedPCAllowedAccountType[] $items
     * @return self
     */
    public function setValue(array|SharedPCAllowedAccountType $items, SharedPCAllowedAccountType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SharedPCAllowedAccountType> $value
     * @return self
     ...
     * 
     * @param SharedPCAllowedAccountType $item
     * @return self
     */
    public function addValue(SharedPCAllowedAccountType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SharedPCAllowedAccountType>
     */
