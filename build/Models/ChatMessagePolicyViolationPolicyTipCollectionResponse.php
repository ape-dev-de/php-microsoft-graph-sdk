 ...
 */
class ChatMessagePolicyViolationPolicyTipCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ChatMessagePolicyViolationPolicyTip[] $items
     * @return self
     */
    public function setValue(array|ChatMessagePolicyViolationPolicyTip $items, ChatMessagePolicyViolationPolicyTip ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @return \ArrayIterator<int, ChatMessagePolicyViolationPolicyTip>
     */
