...
/**
 * CustomExtensionAuthenticationConfigurationCollectionResponse - Collection response
 */
class CustomExtensionAuthenticationConfigurationCollectionResponse
{
    /**
     * @var array<int, CustomExtensionAuthenticationConfiguration>
     */
    public array $value = [];
