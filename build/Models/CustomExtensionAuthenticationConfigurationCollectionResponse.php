...
/**
 * Collection response for CustomExtensionAuthenticationConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CustomExtensionAuthenticationConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CustomExtensionAuthenticationConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param CustomExtensionAuthenticationConfiguration[] $items
     * @return self
     */
    public function setValue(array|CustomExtensionAuthenticationConfiguration $items, CustomExtensionAuthenticationConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CustomExtensionAuthenticationConfiguration> $value
     * @return self
     ...
     * 
     * @param CustomExtensionAuthenticationConfiguration $item
     * @return self
     */
    public function addValue(CustomExtensionAuthenticationConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CustomExtensionAuthenticationConfiguration>
     */
