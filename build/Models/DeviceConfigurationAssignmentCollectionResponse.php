...
/**
 * Collection response for DeviceConfigurationAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceConfigurationAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceConfigurationAssignment[] $items
     * @return self
     */
    public function setValue(array|DeviceConfigurationAssignment $items, DeviceConfigurationAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceConfigurationAssignment> $value
     * @return self
     ...
     * 
     * @param DeviceConfigurationAssignment $item
     * @return self
     */
    public function addValue(DeviceConfigurationAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceConfigurationAssignment>
     */
