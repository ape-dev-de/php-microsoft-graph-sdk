...
/**
 * Collection response for RestoreSessionStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RestoreSessionStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RestoreSessionStatus[]
     */
    private array $value = [];
     ...
     * 
     * @param RestoreSessionStatus[] $items
     * @return self
     */
    public function setValue(array|RestoreSessionStatus $items, RestoreSessionStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RestoreSessionStatus> $value
     * @return self
     ...
     * 
     * @param RestoreSessionStatus $item
     * @return self
     */
    public function addValue(RestoreSessionStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RestoreSessionStatus>
     */
