...
/**
 * Collection response for ScopeOperatorType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ScopeOperatorTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ScopeOperatorType[]
     */
    private array $value = [];
     ...
     * 
     * @param ScopeOperatorType[] $items
     * @return self
     */
    public function setValue(array|ScopeOperatorType $items, ScopeOperatorType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ScopeOperatorType> $value
     * @return self
     ...
     * 
     * @param ScopeOperatorType $item
     * @return self
     */
    public function addValue(ScopeOperatorType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ScopeOperatorType>
     */
