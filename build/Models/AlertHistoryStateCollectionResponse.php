...
/**
 * Collection response for AlertHistoryState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AlertHistoryStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AlertHistoryState[]
     */
    private array $value = [];
     ...
     * 
     * @param AlertHistoryState[] $items
     * @return self
     */
    public function setValue(array|AlertHistoryState $items, AlertHistoryState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AlertHistoryState> $value
     * @return self
     ...
     * 
     * @param AlertHistoryState $item
     * @return self
     */
    public function addValue(AlertHistoryState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AlertHistoryState>
     */
