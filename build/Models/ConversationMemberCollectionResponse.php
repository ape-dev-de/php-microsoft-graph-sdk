...
/**
 * Collection response for ConversationMember
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConversationMemberCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ConversationMember[] $items
     * @return self
     */
    public function setValue(array|ConversationMember $items, ConversationMember ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConversationMember> $value
     * @return self
     ...
     * 
     * @param ConversationMember $item
     * @return self
     */
    public function addValue(ConversationMember $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConversationMember>
     */
