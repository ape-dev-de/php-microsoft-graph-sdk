...
/**
 * Collection response for WindowsProtectionState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsProtectionStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsProtectionState[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsProtectionState[] $items
     * @return self
     */
    public function setValue(array|WindowsProtectionState $items, WindowsProtectionState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsProtectionState> $value
     * @return self
     ...
     * 
     * @param WindowsProtectionState $item
     * @return self
     */
    public function addValue(WindowsProtectionState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsProtectionState>
     */
