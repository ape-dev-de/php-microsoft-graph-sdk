 ...
 */
class WindowsProtectionStateCollectionResponse
{
    /**
     ...
     * 
     * @param WindowsProtectionState ...$items Variable number of WindowsProtectionState items
     * @return self
     */
    public function setValue(WindowsProtectionState ...$items): self
    {
        $this->value = $items;
        return $this;
    }
