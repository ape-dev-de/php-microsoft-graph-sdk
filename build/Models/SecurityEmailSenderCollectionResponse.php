 ...
 */
class SecurityEmailSenderCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityEmailSender ...$items Variable number of SecurityEmailSender items
     * @return self
     */
    public function setValue(SecurityEmailSender ...$items): self
    {
        $this->value = $items;
        return $this;
    }
