...
/**
 * Collection response for SecurityEmailSender
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityEmailSenderCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityEmailSender[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityEmailSender[] $items
     * @return self
     */
    public function setValue(array|SecurityEmailSender $items, SecurityEmailSender ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityEmailSender> $value
     * @return self
     ...
     * 
     * @param SecurityEmailSender $item
     * @return self
     */
    public function addValue(SecurityEmailSender $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityEmailSender|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityEmailSender>
     */
