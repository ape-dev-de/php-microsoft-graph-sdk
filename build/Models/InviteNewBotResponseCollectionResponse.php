 ...
 */
class InviteNewBotResponseCollectionResponse
{
    /**
     ...
     * 
     * @param InviteNewBotResponse ...$items Variable number of InviteNewBotResponse items
     * @return self
     */
    public function setValue(InviteNewBotResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
