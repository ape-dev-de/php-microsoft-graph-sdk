...
/**
 * Collection response for InviteNewBotResponse
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InviteNewBotResponseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var InviteNewBotResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param InviteNewBotResponse[] $items
     * @return self
     */
    public function setValue(array|InviteNewBotResponse $items, InviteNewBotResponse ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InviteNewBotResponse> $value
     * @return self
     ...
     * 
     * @param InviteNewBotResponse $item
     * @return self
     */
    public function addValue(InviteNewBotResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return InviteNewBotResponse|null
     */
     ...
     * 
     * @return \ArrayIterator<int, InviteNewBotResponse>
     */
