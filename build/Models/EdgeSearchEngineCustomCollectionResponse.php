 ...
 */
class EdgeSearchEngineCustomCollectionResponse
{
    /**
     ...
     * 
     * @param EdgeSearchEngineCustom ...$items Variable number of EdgeSearchEngineCustom items
     * @return self
     */
    public function setValue(EdgeSearchEngineCustom ...$items): self
    {
        $this->value = $items;
        return $this;
    }
