...
/**
 * Collection response for EdgeSearchEngineCustom
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EdgeSearchEngineCustomCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EdgeSearchEngineCustom[]
     */
    private array $value = [];
     ...
     * 
     * @param EdgeSearchEngineCustom[] $items
     * @return self
     */
    public function setValue(array|EdgeSearchEngineCustom $items, EdgeSearchEngineCustom ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EdgeSearchEngineCustom> $value
     * @return self
     ...
     * 
     * @param EdgeSearchEngineCustom $item
     * @return self
     */
    public function addValue(EdgeSearchEngineCustom $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EdgeSearchEngineCustom|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EdgeSearchEngineCustom>
     */
