...
/**
 * Collection response for BookingCustomerBaseCollectionResponse
 */
class BookingCustomerBaseCollectionResponseCollectionResponse
{
    /**
     * @var BookingCustomerBaseCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BookingCustomerBaseCollectionResponse ...$items Variable number of BookingCustomerBaseCollectionResponse items
     * @return self
     */
    public function setValue(BookingCustomerBaseCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<BookingCustomerBaseCollectionResponse> $value
     * @return self
     ...
     * 
     * @param BookingCustomerBaseCollectionResponse $item
     * @return self
     */
    public function addValue(BookingCustomerBaseCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
