 ...
 */
class AttributeMappingSourceCollectionResponse
{
    /**
     ...
     * 
     * @param AttributeMappingSource ...$items Variable number of AttributeMappingSource items
     * @return self
     */
    public function setValue(AttributeMappingSource ...$items): self
    {
        $this->value = $items;
        return $this;
    }
