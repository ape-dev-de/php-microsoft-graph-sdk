...
/**
 * Collection response for AttributeMappingSource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttributeMappingSourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AttributeMappingSource[]
     */
    private array $value = [];
     ...
     * 
     * @param AttributeMappingSource[] $items
     * @return self
     */
    public function setValue(array|AttributeMappingSource $items, AttributeMappingSource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttributeMappingSource> $value
     * @return self
     ...
     * 
     * @param AttributeMappingSource $item
     * @return self
     */
    public function addValue(AttributeMappingSource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AttributeMappingSource>
     */
