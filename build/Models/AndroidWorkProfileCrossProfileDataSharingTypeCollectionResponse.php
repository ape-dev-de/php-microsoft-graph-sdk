...
/**
 * Collection response for AndroidWorkProfileCrossProfileDataSharingType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AndroidWorkProfileCrossProfileDataSharingTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AndroidWorkProfileCrossProfileDataSharingType[]
     */
    private array $value = [];
     ...
     * 
     * @return AndroidWorkProfileCrossProfileDataSharingType[]
     */
     ...
     * 
     * @param AndroidWorkProfileCrossProfileDataSharingType[] $items
     * @return self
     */
    public function setValue(array|AndroidWorkProfileCrossProfileDataSharingType $items, AndroidWorkProfileCrossProfileDataSharingType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AndroidWorkProfileCrossProfileDataSharingType> $value
     * @return self
     ...
     * 
     * @param AndroidWorkProfileCrossProfileDataSharingType $item
     * @return self
     */
    public function addValue(AndroidWorkProfileCrossProfileDataSharingType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AndroidWorkProfileCrossProfileDataSharingType>
     */
