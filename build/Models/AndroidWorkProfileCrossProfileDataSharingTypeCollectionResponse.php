...
/**
 * AndroidWorkProfileCrossProfileDataSharingTypeCollectionResponse - Collection response
 */
class AndroidWorkProfileCrossProfileDataSharingTypeCollectionResponse
{
    /**
     * @var array<int, AndroidWorkProfileCrossProfileDataSharingType>
     */
    public array $value = [];
