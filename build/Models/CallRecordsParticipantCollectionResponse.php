...
/**
 * Collection response for CallRecordsParticipant
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsParticipantCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CallRecordsParticipant[] $items
     * @return self
     */
    public function setValue(array|CallRecordsParticipant $items, CallRecordsParticipant ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsParticipant> $value
     * @return self
     ...
     * 
     * @param CallRecordsParticipant $item
     * @return self
     */
    public function addValue(CallRecordsParticipant $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsParticipant>
     */
