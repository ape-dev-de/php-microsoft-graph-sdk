...
/**
 * Collection response for RolePermissionCollectionResponse
 */
class RolePermissionCollectionResponseCollectionResponse
{
    /**
     * @var RolePermissionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RolePermissionCollectionResponse ...$items Variable number of RolePermissionCollectionResponse items
     * @return self
     */
    public function setValue(RolePermissionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RolePermissionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RolePermissionCollectionResponse $item
     * @return self
     */
    public function addValue(RolePermissionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
