...
/**
 * Collection response for UnifiedRoleAssignmentScheduleInstance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRoleAssignmentScheduleInstanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UnifiedRoleAssignmentScheduleInstance[] $items
     * @return self
     */
    public function setValue(array|UnifiedRoleAssignmentScheduleInstance $items, UnifiedRoleAssignmentScheduleInstance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRoleAssignmentScheduleInstance> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleAssignmentScheduleInstance $item
     * @return self
     */
    public function addValue(UnifiedRoleAssignmentScheduleInstance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRoleAssignmentScheduleInstance>
     */
