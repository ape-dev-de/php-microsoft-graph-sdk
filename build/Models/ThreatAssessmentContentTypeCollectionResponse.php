...
/**
 * ThreatAssessmentContentTypeCollectionResponse - Collection response
 */
class ThreatAssessmentContentTypeCollectionResponse
{
    /**
     * @var array<int, ThreatAssessmentContentType>
     */
    public array $value = [];
