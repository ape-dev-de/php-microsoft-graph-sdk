...
/**
 * Collection response for ThreatAssessmentContentType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ThreatAssessmentContentTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return ThreatAssessmentContentType[]
     */
     ...
     * 
     * @param ThreatAssessmentContentType[] $items
     * @return self
     */
    public function setValue(array|ThreatAssessmentContentType $items, ThreatAssessmentContentType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ThreatAssessmentContentType> $value
     * @return self
     ...
     * 
     * @param ThreatAssessmentContentType $item
     * @return self
     */
    public function addValue(ThreatAssessmentContentType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ThreatAssessmentContentType>
     */
