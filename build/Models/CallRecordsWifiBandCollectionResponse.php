...
/**
 * Collection response for CallRecordsWifiBand
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsWifiBandCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsWifiBand[]
     */
    private array $value = [];
     ...
     * 
     * @param CallRecordsWifiBand[] $items
     * @return self
     */
    public function setValue(array|CallRecordsWifiBand $items, CallRecordsWifiBand ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsWifiBand> $value
     * @return self
     ...
     * 
     * @param CallRecordsWifiBand $item
     * @return self
     */
    public function addValue(CallRecordsWifiBand $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsWifiBand|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsWifiBand>
     */
