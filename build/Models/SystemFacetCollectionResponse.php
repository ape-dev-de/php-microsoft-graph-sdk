...
/**
 * Collection response for SystemFacet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SystemFacetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SystemFacet[]
     */
     ...
     * 
     * @param SystemFacet[] $items
     * @return self
     */
    public function setValue(array|SystemFacet $items, SystemFacet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param SystemFacet $item
     * @return self
     */
    public function addValue(SystemFacet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SystemFacet>
     */
