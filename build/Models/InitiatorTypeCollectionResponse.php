...
/**
 * Collection response for InitiatorType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InitiatorTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var InitiatorType[]
     */
     ...
     * 
     * @param InitiatorType[] $items
     * @return self
     */
    public function setValue(array|InitiatorType $items, InitiatorType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InitiatorType> $value
     * @return self
     ...
     * 
     * @param InitiatorType $item
     * @return self
     */
    public function addValue(InitiatorType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, InitiatorType>
     */
