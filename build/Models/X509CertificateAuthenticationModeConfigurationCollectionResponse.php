...
/**
 * Collection response for X509CertificateAuthenticationModeConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class X509CertificateAuthenticationModeConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var X509CertificateAuthenticationModeConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param X509CertificateAuthenticationModeConfiguration[] $items
     * @return self
     */
    public function setValue(array|X509CertificateAuthenticationModeConfiguration $items, X509CertificateAuthenticationModeConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<X509CertificateAuthenticationModeConfiguration> $value
     * @return self
     ...
     * 
     * @param X509CertificateAuthenticationModeConfiguration $item
     * @return self
     */
    public function addValue(X509CertificateAuthenticationModeConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, X509CertificateAuthenticationModeConfiguration>
     */
