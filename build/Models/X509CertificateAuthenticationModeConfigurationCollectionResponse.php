 ...
 */
class X509CertificateAuthenticationModeConfigurationCollectionResponse
{
    /**
     ...
     * 
     * @param X509CertificateAuthenticationModeConfiguration ...$items Variable number of X509CertificateAuthenticationModeConfiguration items
     * @return self
     */
    public function setValue(X509CertificateAuthenticationModeConfiguration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
