...
/**
 * Collection response for DeviceManagementExchangeAccessStateReason
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceManagementExchangeAccessStateReasonCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return DeviceManagementExchangeAccessStateReason[]
     */
     ...
     * 
     * @param DeviceManagementExchangeAccessStateReason[] $items
     * @return self
     */
    public function setValue(array|DeviceManagementExchangeAccessStateReason $items, DeviceManagementExchangeAccessStateReason ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceManagementExchangeAccessStateReason> $value
     * @return self
     ...
     * 
     * @param DeviceManagementExchangeAccessStateReason $item
     * @return self
     */
    public function addValue(DeviceManagementExchangeAccessStateReason $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceManagementExchangeAccessStateReason>
     */
