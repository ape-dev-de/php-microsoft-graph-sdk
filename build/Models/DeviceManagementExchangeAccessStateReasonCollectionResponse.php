...
/**
 * DeviceManagementExchangeAccessStateReasonCollectionResponse - Collection response
 */
class DeviceManagementExchangeAccessStateReasonCollectionResponse
{
    /**
     * @var array<int, DeviceManagementExchangeAccessStateReason>
     */
    public array $value = [];
