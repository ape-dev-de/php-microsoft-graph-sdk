...
/**
 * Collection response for AndroidWorkProfileDefaultAppPermissionPolicyType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AndroidWorkProfileDefaultAppPermissionPolicyTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AndroidWorkProfileDefaultAppPermissionPolicyType[]
     */
    private array $value = [];
     ...
     * 
     * @return AndroidWorkProfileDefaultAppPermissionPolicyType[]
     */
     ...
     * 
     * @param AndroidWorkProfileDefaultAppPermissionPolicyType[] $items
     * @return self
     */
    public function setValue(array|AndroidWorkProfileDefaultAppPermissionPolicyType $items, AndroidWorkProfileDefaultAppPermissionPolicyType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AndroidWorkProfileDefaultAppPermissionPolicyType> $value
     * @return self
     ...
     * 
     * @param AndroidWorkProfileDefaultAppPermissionPolicyType $item
     * @return self
     */
    public function addValue(AndroidWorkProfileDefaultAppPermissionPolicyType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AndroidWorkProfileDefaultAppPermissionPolicyType>
     */
