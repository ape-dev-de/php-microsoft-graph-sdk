...
/**
 * AndroidWorkProfileDefaultAppPermissionPolicyTypeCollectionResponse - Collection response
 */
class AndroidWorkProfileDefaultAppPermissionPolicyTypeCollectionResponse
{
    /**
     * @var array<int, AndroidWorkProfileDefaultAppPermissionPolicyType>
     */
    public array $value = [];
