...
/**
 * Collection response for ServiceHealthIssue
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServiceHealthIssueCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ServiceHealthIssue[] $items
     * @return self
     */
    public function setValue(array|ServiceHealthIssue $items, ServiceHealthIssue ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServiceHealthIssue> $value
     * @return self
     ...
     * 
     * @param ServiceHealthIssue $item
     * @return self
     */
    public function addValue(ServiceHealthIssue $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ServiceHealthIssue>
     */
