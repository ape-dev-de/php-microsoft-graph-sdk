...
/**
 * Collection response for ResourceActionCollectionResponse
 */
class ResourceActionCollectionResponseCollectionResponse
{
    /**
     * @var ResourceActionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ResourceActionCollectionResponse ...$items Variable number of ResourceActionCollectionResponse items
     * @return self
     */
    public function setValue(ResourceActionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ResourceActionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ResourceActionCollectionResponse $item
     * @return self
     */
    public function addValue(ResourceActionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
