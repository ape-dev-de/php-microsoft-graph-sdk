 ...
 */
class MediaContentRatingFranceCollectionResponse
{
    /**
     ...
     * 
     * @param MediaContentRatingFrance ...$items Variable number of MediaContentRatingFrance items
     * @return self
     */
    public function setValue(MediaContentRatingFrance ...$items): self
    {
        $this->value = $items;
        return $this;
    }
