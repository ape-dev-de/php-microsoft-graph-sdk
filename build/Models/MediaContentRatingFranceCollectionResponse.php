...
/**
 * Collection response for MediaContentRatingFrance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MediaContentRatingFranceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MediaContentRatingFrance[] $items
     * @return self
     */
    public function setValue(array|MediaContentRatingFrance $items, MediaContentRatingFrance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MediaContentRatingFrance> $value
     * @return self
     ...
     * 
     * @param MediaContentRatingFrance $item
     * @return self
     */
    public function addValue(MediaContentRatingFrance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MediaContentRatingFrance>
     */
