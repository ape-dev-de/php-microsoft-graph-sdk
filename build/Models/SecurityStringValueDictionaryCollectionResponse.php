...
/**
 * SecurityStringValueDictionaryCollectionResponse - Collection response
 */
class SecurityStringValueDictionaryCollectionResponse
{
    /**
     * @var array<int, SecurityStringValueDictionary>
     */
    public array $value = [];
