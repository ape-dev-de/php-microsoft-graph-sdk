...
/**
 * Collection response for SecurityStringValueDictionary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityStringValueDictionaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityStringValueDictionary[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityStringValueDictionary[]
     */
     ...
     * 
     * @param SecurityStringValueDictionary[] $items
     * @return self
     */
    public function setValue(array|SecurityStringValueDictionary $items, SecurityStringValueDictionary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityStringValueDictionary> $value
     * @return self
     ...
     * 
     * @param SecurityStringValueDictionary $item
     * @return self
     */
    public function addValue(SecurityStringValueDictionary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityStringValueDictionary|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityStringValueDictionary>
     */
