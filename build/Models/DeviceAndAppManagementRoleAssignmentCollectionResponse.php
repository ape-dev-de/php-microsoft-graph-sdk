...
/**
 * Collection response for DeviceAndAppManagementRoleAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceAndAppManagementRoleAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceAndAppManagementRoleAssignment[] $items
     * @return self
     */
    public function setValue(array|DeviceAndAppManagementRoleAssignment $items, DeviceAndAppManagementRoleAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceAndAppManagementRoleAssignment> $value
     * @return self
     ...
     * 
     * @param DeviceAndAppManagementRoleAssignment $item
     * @return self
     */
    public function addValue(DeviceAndAppManagementRoleAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceAndAppManagementRoleAssignment>
     */
