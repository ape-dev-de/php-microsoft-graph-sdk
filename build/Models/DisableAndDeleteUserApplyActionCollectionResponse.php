...
/**
 * DisableAndDeleteUserApplyActionCollectionResponse - Collection response
 */
class DisableAndDeleteUserApplyActionCollectionResponse
{
    /**
     * @var array<int, DisableAndDeleteUserApplyAction>
     */
    public array $value = [];
