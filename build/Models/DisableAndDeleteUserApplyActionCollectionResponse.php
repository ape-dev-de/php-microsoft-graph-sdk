...
/**
 * Collection response for DisableAndDeleteUserApplyAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DisableAndDeleteUserApplyActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DisableAndDeleteUserApplyAction[]
     */
    private array $value = [];
     ...
     * 
     * @param DisableAndDeleteUserApplyAction[] $items
     * @return self
     */
    public function setValue(array|DisableAndDeleteUserApplyAction $items, DisableAndDeleteUserApplyAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DisableAndDeleteUserApplyAction> $value
     * @return self
     ...
     * 
     * @param DisableAndDeleteUserApplyAction $item
     * @return self
     */
    public function addValue(DisableAndDeleteUserApplyAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return DisableAndDeleteUserApplyAction|null
     */
     ...
     * 
     * @return \ArrayIterator<int, DisableAndDeleteUserApplyAction>
     */
