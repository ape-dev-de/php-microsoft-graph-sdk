...
/**
 * Collection response for ConditionalAccessGuestOrExternalUserTypes
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessGuestOrExternalUserTypesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessGuestOrExternalUserTypes[]
     */
    private array $value = [];
     ...
     * 
     * @return ConditionalAccessGuestOrExternalUserTypes[]
     */
     ...
     * 
     * @param ConditionalAccessGuestOrExternalUserTypes[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessGuestOrExternalUserTypes $items, ConditionalAccessGuestOrExternalUserTypes ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessGuestOrExternalUserTypes> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessGuestOrExternalUserTypes $item
     * @return self
     */
    public function addValue(ConditionalAccessGuestOrExternalUserTypes $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessGuestOrExternalUserTypes>
     */
