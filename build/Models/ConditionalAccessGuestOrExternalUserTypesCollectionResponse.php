...
/**
 * ConditionalAccessGuestOrExternalUserTypesCollectionResponse - Collection response
 */
class ConditionalAccessGuestOrExternalUserTypesCollectionResponse
{
    /**
     * @var array<int, ConditionalAccessGuestOrExternalUserTypes>
     */
    public array $value = [];
