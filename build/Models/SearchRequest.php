...
class SearchRequest
{
     ...
     * @var string[]
     */
    private array $aggregationFilters = [];
    ...
    /**
     * @param string[] $aggregationFilters
     */
     ...
     */
    public function setContentSources(array $contentSources): self
    {
    ...
    /**
     * @param string[] $sortProperties
     */
    public function setSortProperties(array $sortProperties): self
    {
