...
/**
 * Collection response for MicrosoftAuthenticatorAuthenticationMethodTarget
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MicrosoftAuthenticatorAuthenticationMethodTargetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MicrosoftAuthenticatorAuthenticationMethodTarget[] $items
     * @return self
     */
    public function setValue(array|MicrosoftAuthenticatorAuthenticationMethodTarget $items, MicrosoftAuthenticatorAuthenticationMethodTarget ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MicrosoftAuthenticatorAuthenticationMethodTarget> $value
     * @return self
     ...
     * 
     * @param MicrosoftAuthenticatorAuthenticationMethodTarget $item
     * @return self
     */
    public function addValue(MicrosoftAuthenticatorAuthenticationMethodTarget $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MicrosoftAuthenticatorAuthenticationMethodTarget|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MicrosoftAuthenticatorAuthenticationMethodTarget>
     */
