...
/**
 * Collection response for UserSecurityStateCollectionResponse
 */
class UserSecurityStateCollectionResponseCollectionResponse
{
    /**
     * @var UserSecurityStateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UserSecurityStateCollectionResponse ...$items Variable number of UserSecurityStateCollectionResponse items
     * @return self
     */
    public function setValue(UserSecurityStateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UserSecurityStateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UserSecurityStateCollectionResponse $item
     * @return self
     */
    public function addValue(UserSecurityStateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
