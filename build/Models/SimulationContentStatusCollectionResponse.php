...
/**
 * Collection response for SimulationContentStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SimulationContentStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SimulationContentStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return SimulationContentStatus[]
     */
     ...
     * 
     * @param SimulationContentStatus[] $items
     * @return self
     */
    public function setValue(array|SimulationContentStatus $items, SimulationContentStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SimulationContentStatus> $value
     * @return self
     ...
     * 
     * @param SimulationContentStatus $item
     * @return self
     */
    public function addValue(SimulationContentStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SimulationContentStatus>
     */
