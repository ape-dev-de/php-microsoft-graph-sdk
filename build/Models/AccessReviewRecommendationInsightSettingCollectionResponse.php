...
/**
 * Collection response for AccessReviewRecommendationInsightSetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewRecommendationInsightSettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessReviewRecommendationInsightSetting[] $items
     * @return self
     */
    public function setValue(array|AccessReviewRecommendationInsightSetting $items, AccessReviewRecommendationInsightSetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewRecommendationInsightSetting> $value
     * @return self
     ...
     * 
     * @param AccessReviewRecommendationInsightSetting $item
     * @return self
     */
    public function addValue(AccessReviewRecommendationInsightSetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessReviewRecommendationInsightSetting|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewRecommendationInsightSetting>
     */
