 ...
 */
class Win32LobAppAutoUpdateSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param Win32LobAppAutoUpdateSettings ...$items Variable number of Win32LobAppAutoUpdateSettings items
     * @return self
     */
    public function setValue(Win32LobAppAutoUpdateSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
