...
/**
 * Collection response for Win32LobAppAutoUpdateSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Win32LobAppAutoUpdateSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Win32LobAppAutoUpdateSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param Win32LobAppAutoUpdateSettings[] $items
     * @return self
     */
    public function setValue(array|Win32LobAppAutoUpdateSettings $items, Win32LobAppAutoUpdateSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Win32LobAppAutoUpdateSettings> $value
     * @return self
     ...
     * 
     * @param Win32LobAppAutoUpdateSettings $item
     * @return self
     */
    public function addValue(Win32LobAppAutoUpdateSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Win32LobAppAutoUpdateSettings>
     */
