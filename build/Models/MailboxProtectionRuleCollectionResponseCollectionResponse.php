...
/**
 * Collection response for MailboxProtectionRuleCollectionResponse
 */
class MailboxProtectionRuleCollectionResponseCollectionResponse
{
    /**
     * @var MailboxProtectionRuleCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MailboxProtectionRuleCollectionResponse ...$items Variable number of MailboxProtectionRuleCollectionResponse items
     * @return self
     */
    public function setValue(MailboxProtectionRuleCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MailboxProtectionRuleCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MailboxProtectionRuleCollectionResponse $item
     * @return self
     */
    public function addValue(MailboxProtectionRuleCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
