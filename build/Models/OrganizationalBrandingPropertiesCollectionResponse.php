...
/**
 * Collection response for OrganizationalBrandingProperties
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OrganizationalBrandingPropertiesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OrganizationalBrandingProperties[]
     */
    private array $value = [];
     ...
     * 
     * @param OrganizationalBrandingProperties[] $items
     * @return self
     */
    public function setValue(array|OrganizationalBrandingProperties $items, OrganizationalBrandingProperties ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OrganizationalBrandingProperties> $value
     * @return self
     ...
     * 
     * @param OrganizationalBrandingProperties $item
     * @return self
     */
    public function addValue(OrganizationalBrandingProperties $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OrganizationalBrandingProperties|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OrganizationalBrandingProperties>
     */
