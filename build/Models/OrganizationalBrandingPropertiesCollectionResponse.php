 ...
 */
class OrganizationalBrandingPropertiesCollectionResponse
{
    /**
     ...
     * 
     * @param OrganizationalBrandingProperties ...$items Variable number of OrganizationalBrandingProperties items
     * @return self
     */
    public function setValue(OrganizationalBrandingProperties ...$items): self
    {
        $this->value = $items;
        return $this;
    }
