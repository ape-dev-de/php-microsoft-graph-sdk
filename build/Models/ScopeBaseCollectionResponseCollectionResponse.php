...
/**
 * Collection response for ScopeBaseCollectionResponse
 */
class ScopeBaseCollectionResponseCollectionResponse
{
    /**
     * @var ScopeBaseCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return ScopeBaseCollectionResponse[]
     */
     ...
     * 
     * @param ScopeBaseCollectionResponse ...$items Variable number of ScopeBaseCollectionResponse items
     * @return self
     */
    public function setValue(ScopeBaseCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ScopeBaseCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ScopeBaseCollectionResponse $item
     * @return self
     */
    public function addValue(ScopeBaseCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
