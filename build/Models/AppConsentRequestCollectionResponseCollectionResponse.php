...
/**
 * Collection response for AppConsentRequestCollectionResponse
 */
class AppConsentRequestCollectionResponseCollectionResponse
{
    /**
     * @var AppConsentRequestCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AppConsentRequestCollectionResponse ...$items Variable number of AppConsentRequestCollectionResponse items
     * @return self
     */
    public function setValue(AppConsentRequestCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AppConsentRequestCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AppConsentRequestCollectionResponse $item
     * @return self
     */
    public function addValue(AppConsentRequestCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
