...
/**
 * Collection response for UserExperienceAnalyticsCategory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsCategoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsCategory[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsCategory $items, UserExperienceAnalyticsCategory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsCategory> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsCategory $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsCategory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsCategory>
     */
