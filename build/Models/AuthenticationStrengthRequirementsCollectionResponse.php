...
/**
 * Collection response for AuthenticationStrengthRequirements
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationStrengthRequirementsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuthenticationStrengthRequirements[]
     */
    private array $value = [];
     ...
     * 
     * @return AuthenticationStrengthRequirements[]
     */
     ...
     * 
     * @param AuthenticationStrengthRequirements[] $items
     * @return self
     */
    public function setValue(array|AuthenticationStrengthRequirements $items, AuthenticationStrengthRequirements ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationStrengthRequirements> $value
     * @return self
     ...
     * 
     * @param AuthenticationStrengthRequirements $item
     * @return self
     */
    public function addValue(AuthenticationStrengthRequirements $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationStrengthRequirements>
     */
