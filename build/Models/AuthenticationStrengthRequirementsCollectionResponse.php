...
/**
 * AuthenticationStrengthRequirementsCollectionResponse - Collection response
 */
class AuthenticationStrengthRequirementsCollectionResponse
{
    /**
     * @var array<int, AuthenticationStrengthRequirements>
     */
    public array $value = [];
