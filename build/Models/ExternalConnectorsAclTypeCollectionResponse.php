...
/**
 * ExternalConnectorsAclTypeCollectionResponse - Collection response
 */
class ExternalConnectorsAclTypeCollectionResponse
{
    /**
     * @var array<int, ExternalConnectorsAclType>
     */
    public array $value = [];
