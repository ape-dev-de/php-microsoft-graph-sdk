...
/**
 * Collection response for ExternalConnectorsAclType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsAclTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalConnectorsAclType[]
     */
    private array $value = [];
     ...
     * 
     * @return ExternalConnectorsAclType[]
     */
     ...
     * 
     * @param ExternalConnectorsAclType[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsAclType $items, ExternalConnectorsAclType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsAclType> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsAclType $item
     * @return self
     */
    public function addValue(ExternalConnectorsAclType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalConnectorsAclType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsAclType>
     */
