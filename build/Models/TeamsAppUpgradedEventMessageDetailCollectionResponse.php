 ...
 */
class TeamsAppUpgradedEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param TeamsAppUpgradedEventMessageDetail ...$items Variable number of TeamsAppUpgradedEventMessageDetail items
     * @return self
     */
    public function setValue(TeamsAppUpgradedEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
