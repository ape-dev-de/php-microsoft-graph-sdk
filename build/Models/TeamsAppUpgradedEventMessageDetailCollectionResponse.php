...
/**
 * Collection response for TeamsAppUpgradedEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamsAppUpgradedEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamsAppUpgradedEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamsAppUpgradedEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|TeamsAppUpgradedEventMessageDetail $items, TeamsAppUpgradedEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamsAppUpgradedEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param TeamsAppUpgradedEventMessageDetail $item
     * @return self
     */
    public function addValue(TeamsAppUpgradedEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TeamsAppUpgradedEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TeamsAppUpgradedEventMessageDetail>
     */
