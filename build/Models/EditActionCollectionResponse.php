...
/**
 * Collection response for EditAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EditActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EditAction[]
     */
     ...
     * 
     * @param EditAction[] $items
     * @return self
     */
    public function setValue(array|EditAction $items, EditAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param EditAction $item
     * @return self
     */
    public function addValue(EditAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EditAction>
     */
