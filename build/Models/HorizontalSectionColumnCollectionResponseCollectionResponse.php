...
/**
 * Collection response for HorizontalSectionColumnCollectionResponse
 */
class HorizontalSectionColumnCollectionResponseCollectionResponse
{
    /**
     * @var HorizontalSectionColumnCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param HorizontalSectionColumnCollectionResponse ...$items Variable number of HorizontalSectionColumnCollectionResponse items
     * @return self
     */
    public function setValue(HorizontalSectionColumnCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<HorizontalSectionColumnCollectionResponse> $value
     * @return self
     ...
     * 
     * @param HorizontalSectionColumnCollectionResponse $item
     * @return self
     */
    public function addValue(HorizontalSectionColumnCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
