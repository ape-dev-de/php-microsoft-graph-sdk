...
/**
 * Collection response for AccessPackageCollectionResponse
 */
class AccessPackageCollectionResponseCollectionResponse
{
    /**
     * @var AccessPackageCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageCollectionResponse ...$items Variable number of AccessPackageCollectionResponse items
     * @return self
     */
    public function setValue(AccessPackageCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AccessPackageCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AccessPackageCollectionResponse $item
     * @return self
     */
    public function addValue(AccessPackageCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
