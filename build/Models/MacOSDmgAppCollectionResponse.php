...
/**
 * Collection response for MacOSDmgApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MacOSDmgAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MacOSDmgApp[]
     */
     ...
     * 
     * @param MacOSDmgApp[] $items
     * @return self
     */
    public function setValue(array|MacOSDmgApp $items, MacOSDmgApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param MacOSDmgApp $item
     * @return self
     */
    public function addValue(MacOSDmgApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MacOSDmgApp>
     */
