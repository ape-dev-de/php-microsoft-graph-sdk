...
/**
 * Collection response for SiteProtectionUnitCollectionResponse
 */
class SiteProtectionUnitCollectionResponseCollectionResponse
{
    /**
     * @var SiteProtectionUnitCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SiteProtectionUnitCollectionResponse ...$items Variable number of SiteProtectionUnitCollectionResponse items
     * @return self
     */
    public function setValue(SiteProtectionUnitCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SiteProtectionUnitCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SiteProtectionUnitCollectionResponse $item
     * @return self
     */
    public function addValue(SiteProtectionUnitCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
