...
/**
 * Collection response for DeviceConfigurationUserStatusCollectionResponse
 */
class DeviceConfigurationUserStatusCollectionResponseCollectionResponse
{
    /**
     * @var DeviceConfigurationUserStatusCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceConfigurationUserStatusCollectionResponse ...$items Variable number of DeviceConfigurationUserStatusCollectionResponse items
     * @return self
     */
    public function setValue(DeviceConfigurationUserStatusCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeviceConfigurationUserStatusCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeviceConfigurationUserStatusCollectionResponse $item
     * @return self
     */
    public function addValue(DeviceConfigurationUserStatusCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
