...
/**
 * Collection response for AvailabilityItemCollectionResponse
 */
class AvailabilityItemCollectionResponseCollectionResponse
{
    /**
     * @var AvailabilityItemCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AvailabilityItemCollectionResponse ...$items Variable number of AvailabilityItemCollectionResponse items
     * @return self
     */
    public function setValue(AvailabilityItemCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AvailabilityItemCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AvailabilityItemCollectionResponse $item
     * @return self
     */
    public function addValue(AvailabilityItemCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
