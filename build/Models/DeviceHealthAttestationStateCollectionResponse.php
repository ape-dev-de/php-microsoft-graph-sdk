 ...
 */
class DeviceHealthAttestationStateCollectionResponse
{
    /**
     ...
     * 
     * @param DeviceHealthAttestationState ...$items Variable number of DeviceHealthAttestationState items
     * @return self
     */
    public function setValue(DeviceHealthAttestationState ...$items): self
    {
        $this->value = $items;
        return $this;
    }
