...
/**
 * Collection response for DeviceHealthAttestationState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceHealthAttestationStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceHealthAttestationState[] $items
     * @return self
     */
    public function setValue(array|DeviceHealthAttestationState $items, DeviceHealthAttestationState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceHealthAttestationState> $value
     * @return self
     ...
     * 
     * @param DeviceHealthAttestationState $item
     * @return self
     */
    public function addValue(DeviceHealthAttestationState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceHealthAttestationState>
     */
