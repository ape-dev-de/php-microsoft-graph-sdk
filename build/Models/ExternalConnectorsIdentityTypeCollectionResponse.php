...
/**
 * ExternalConnectorsIdentityTypeCollectionResponse - Collection response
 */
class ExternalConnectorsIdentityTypeCollectionResponse
{
    /**
     * @var array<int, ExternalConnectorsIdentityType>
     */
    public array $value = [];
