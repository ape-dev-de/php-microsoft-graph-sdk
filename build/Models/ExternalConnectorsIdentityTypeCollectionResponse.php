...
/**
 * Collection response for ExternalConnectorsIdentityType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsIdentityTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalConnectorsIdentityType[]
     */
    private array $value = [];
     ...
     * 
     * @return ExternalConnectorsIdentityType[]
     */
     ...
     * 
     * @param ExternalConnectorsIdentityType[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsIdentityType $items, ExternalConnectorsIdentityType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsIdentityType> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsIdentityType $item
     * @return self
     */
    public function addValue(ExternalConnectorsIdentityType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalConnectorsIdentityType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsIdentityType>
     */
