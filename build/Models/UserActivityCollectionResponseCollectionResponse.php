...
/**
 * Collection response for UserActivityCollectionResponse
 */
class UserActivityCollectionResponseCollectionResponse
{
    /**
     * @var UserActivityCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UserActivityCollectionResponse ...$items Variable number of UserActivityCollectionResponse items
     * @return self
     */
    public function setValue(UserActivityCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UserActivityCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UserActivityCollectionResponse $item
     * @return self
     */
    public function addValue(UserActivityCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
