...
/**
 * Collection response for IdentityGovernanceCustomTaskExtensionCalloutData
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceCustomTaskExtensionCalloutDataCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceCustomTaskExtensionCalloutData[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceCustomTaskExtensionCalloutData[]
     */
     ...
     * 
     * @param IdentityGovernanceCustomTaskExtensionCalloutData[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceCustomTaskExtensionCalloutData $items, IdentityGovernanceCustomTaskExtensionCalloutData ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceCustomTaskExtensionCalloutData> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceCustomTaskExtensionCalloutData $item
     * @return self
     */
    public function addValue(IdentityGovernanceCustomTaskExtensionCalloutData $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceCustomTaskExtensionCalloutData|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceCustomTaskExtensionCalloutData>
     */
