...
/**
 * Collection response for OsVersionCountCollectionResponse
 */
class OsVersionCountCollectionResponseCollectionResponse
{
    /**
     * @var OsVersionCountCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param OsVersionCountCollectionResponse ...$items Variable number of OsVersionCountCollectionResponse items
     * @return self
     */
    public function setValue(OsVersionCountCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<OsVersionCountCollectionResponse> $value
     * @return self
     ...
     * 
     * @param OsVersionCountCollectionResponse $item
     * @return self
     */
    public function addValue(OsVersionCountCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
