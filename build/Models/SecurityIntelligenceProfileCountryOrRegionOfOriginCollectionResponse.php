...
/**
 * SecurityIntelligenceProfileCountryOrRegionOfOriginCollectionResponse - Collection response
 */
class SecurityIntelligenceProfileCountryOrRegionOfOriginCollectionResponse
{
    /**
     * @var array<int, SecurityIntelligenceProfileCountryOrRegionOfOrigin>
     */
    public array $value = [];
