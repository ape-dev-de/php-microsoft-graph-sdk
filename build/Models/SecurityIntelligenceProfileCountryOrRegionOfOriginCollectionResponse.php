...
/**
 * Collection response for SecurityIntelligenceProfileCountryOrRegionOfOrigin
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityIntelligenceProfileCountryOrRegionOfOriginCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return SecurityIntelligenceProfileCountryOrRegionOfOrigin[]
     */
     ...
     * 
     * @param SecurityIntelligenceProfileCountryOrRegionOfOrigin[] $items
     * @return self
     */
    public function setValue(array|SecurityIntelligenceProfileCountryOrRegionOfOrigin $items, SecurityIntelligenceProfileCountryOrRegionOfOrigin ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityIntelligenceProfileCountryOrRegionOfOrigin> $value
     * @return self
     ...
     * 
     * @param SecurityIntelligenceProfileCountryOrRegionOfOrigin $item
     * @return self
     */
    public function addValue(SecurityIntelligenceProfileCountryOrRegionOfOrigin $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityIntelligenceProfileCountryOrRegionOfOrigin|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityIntelligenceProfileCountryOrRegionOfOrigin>
     */
