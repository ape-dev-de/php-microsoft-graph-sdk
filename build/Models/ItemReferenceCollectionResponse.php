...
/**
 * Collection response for ItemReference
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ItemReferenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ItemReference[]
     */
     ...
     * 
     * @param ItemReference[] $items
     * @return self
     */
    public function setValue(array|ItemReference $items, ItemReference ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ItemReference> $value
     * @return self
     ...
     * @return self
     */
    public function addValue(ItemReference $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ItemReference>
     */
