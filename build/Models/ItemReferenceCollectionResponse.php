 ...
 */
class ItemReferenceCollectionResponse
{
    /**
     * @var ItemReference[]
     */
     ...
     * 
     * @param ItemReference ...$items Variable number of ItemReference items
     * @return self
     */
    public function setValue(ItemReference ...$items): self
    {
        $this->value = $items;
        return $this;
    }
