...
/**
 * Collection response for AgreementAcceptanceCollectionResponse
 */
class AgreementAcceptanceCollectionResponseCollectionResponse
{
    /**
     * @var AgreementAcceptanceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AgreementAcceptanceCollectionResponse ...$items Variable number of AgreementAcceptanceCollectionResponse items
     * @return self
     */
    public function setValue(AgreementAcceptanceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AgreementAcceptanceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AgreementAcceptanceCollectionResponse $item
     * @return self
     */
    public function addValue(AgreementAcceptanceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
