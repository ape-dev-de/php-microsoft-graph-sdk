...
/**
 * Collection response for ProcessContentMetadataBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProcessContentMetadataBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ProcessContentMetadataBase[] $items
     * @return self
     */
    public function setValue(array|ProcessContentMetadataBase $items, ProcessContentMetadataBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProcessContentMetadataBase> $value
     * @return self
     ...
     * 
     * @param ProcessContentMetadataBase $item
     * @return self
     */
    public function addValue(ProcessContentMetadataBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ProcessContentMetadataBase|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ProcessContentMetadataBase>
     */
