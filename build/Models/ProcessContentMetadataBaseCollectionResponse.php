...
/**
 * ProcessContentMetadataBaseCollectionResponse - Collection response
 */
class ProcessContentMetadataBaseCollectionResponse
{
    /**
     * @var array<int, ProcessContentMetadataBase>
     */
    public array $value = [];
