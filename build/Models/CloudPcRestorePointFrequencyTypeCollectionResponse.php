...
/**
 * CloudPcRestorePointFrequencyTypeCollectionResponse - Collection response
 */
class CloudPcRestorePointFrequencyTypeCollectionResponse
{
    /**
     * @var array<int, CloudPcRestorePointFrequencyType>
     */
    public array $value = [];
