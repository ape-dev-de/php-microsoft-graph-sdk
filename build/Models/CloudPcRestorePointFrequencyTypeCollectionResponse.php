...
/**
 * Collection response for CloudPcRestorePointFrequencyType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcRestorePointFrequencyTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudPcRestorePointFrequencyType[]
     */
    private array $value = [];
     ...
     * 
     * @return CloudPcRestorePointFrequencyType[]
     */
     ...
     * 
     * @param CloudPcRestorePointFrequencyType[] $items
     * @return self
     */
    public function setValue(array|CloudPcRestorePointFrequencyType $items, CloudPcRestorePointFrequencyType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcRestorePointFrequencyType> $value
     * @return self
     ...
     * 
     * @param CloudPcRestorePointFrequencyType $item
     * @return self
     */
    public function addValue(CloudPcRestorePointFrequencyType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcRestorePointFrequencyType>
     */
