...
/**
 * PrinterProcessingStateDetailCollectionResponse - Collection response
 */
class PrinterProcessingStateDetailCollectionResponse
{
    /**
     * @var array<int, PrinterProcessingStateDetail>
     */
    public array $value = [];
