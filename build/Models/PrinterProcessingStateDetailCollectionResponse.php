...
/**
 * Collection response for PrinterProcessingStateDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrinterProcessingStateDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return PrinterProcessingStateDetail[]
     */
     ...
     * 
     * @param PrinterProcessingStateDetail[] $items
     * @return self
     */
    public function setValue(array|PrinterProcessingStateDetail $items, PrinterProcessingStateDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrinterProcessingStateDetail> $value
     * @return self
     ...
     * 
     * @param PrinterProcessingStateDetail $item
     * @return self
     */
    public function addValue(PrinterProcessingStateDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PrinterProcessingStateDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PrinterProcessingStateDetail>
     */
