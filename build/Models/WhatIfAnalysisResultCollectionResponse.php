...
/**
 * Collection response for WhatIfAnalysisResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WhatIfAnalysisResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WhatIfAnalysisResult[]
     */
    private array $value = [];
     ...
     * 
     * @param WhatIfAnalysisResult[] $items
     * @return self
     */
    public function setValue(array|WhatIfAnalysisResult $items, WhatIfAnalysisResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WhatIfAnalysisResult> $value
     * @return self
     ...
     * 
     * @param WhatIfAnalysisResult $item
     * @return self
     */
    public function addValue(WhatIfAnalysisResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WhatIfAnalysisResult|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WhatIfAnalysisResult>
     */
