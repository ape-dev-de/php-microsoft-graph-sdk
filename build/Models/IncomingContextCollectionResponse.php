...
/**
 * Collection response for IncomingContext
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IncomingContextCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IncomingContext[]
     */
     ...
     * 
     * @param IncomingContext[] $items
     * @return self
     */
    public function setValue(array|IncomingContext $items, IncomingContext ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IncomingContext> $value
     * @return self
     ...
     * 
     * @param IncomingContext $item
     * @return self
     */
    public function addValue(IncomingContext $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IncomingContext>
     */
