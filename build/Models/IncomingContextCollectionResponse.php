 ...
 */
class IncomingContextCollectionResponse
{
    /**
     * @var IncomingContext[]
     */
     ...
     * 
     * @param IncomingContext ...$items Variable number of IncomingContext items
     * @return self
     */
    public function setValue(IncomingContext ...$items): self
    {
        $this->value = $items;
        return $this;
    }
