...
/**
 * Collection response for AiInteractionMentionedIdentitySet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AiInteractionMentionedIdentitySetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AiInteractionMentionedIdentitySet[]
     */
    private array $value = [];
     ...
     * 
     * @param AiInteractionMentionedIdentitySet[] $items
     * @return self
     */
    public function setValue(array|AiInteractionMentionedIdentitySet $items, AiInteractionMentionedIdentitySet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AiInteractionMentionedIdentitySet> $value
     * @return self
     ...
     * 
     * @param AiInteractionMentionedIdentitySet $item
     * @return self
     */
    public function addValue(AiInteractionMentionedIdentitySet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AiInteractionMentionedIdentitySet>
     */
