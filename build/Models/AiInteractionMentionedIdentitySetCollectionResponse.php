 ...
 */
class AiInteractionMentionedIdentitySetCollectionResponse
{
    /**
     ...
     * 
     * @param AiInteractionMentionedIdentitySet ...$items Variable number of AiInteractionMentionedIdentitySet items
     * @return self
     */
    public function setValue(AiInteractionMentionedIdentitySet ...$items): self
    {
        $this->value = $items;
        return $this;
    }
