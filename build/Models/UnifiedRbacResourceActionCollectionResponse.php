...
/**
 * Collection response for UnifiedRbacResourceAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRbacResourceActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UnifiedRbacResourceAction[] $items
     * @return self
     */
    public function setValue(array|UnifiedRbacResourceAction $items, UnifiedRbacResourceAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRbacResourceAction> $value
     * @return self
     ...
     * 
     * @param UnifiedRbacResourceAction $item
     * @return self
     */
    public function addValue(UnifiedRbacResourceAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRbacResourceAction>
     */
