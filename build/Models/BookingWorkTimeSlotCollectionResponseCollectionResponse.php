...
/**
 * Collection response for BookingWorkTimeSlotCollectionResponse
 */
class BookingWorkTimeSlotCollectionResponseCollectionResponse
{
    /**
     * @var BookingWorkTimeSlotCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BookingWorkTimeSlotCollectionResponse ...$items Variable number of BookingWorkTimeSlotCollectionResponse items
     * @return self
     */
    public function setValue(BookingWorkTimeSlotCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<BookingWorkTimeSlotCollectionResponse> $value
     * @return self
     ...
     * 
     * @param BookingWorkTimeSlotCollectionResponse $item
     * @return self
     */
    public function addValue(BookingWorkTimeSlotCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
