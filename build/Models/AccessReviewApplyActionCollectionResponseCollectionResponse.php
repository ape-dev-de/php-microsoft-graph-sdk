...
/**
 * Collection response for AccessReviewApplyActionCollectionResponse
 */
class AccessReviewApplyActionCollectionResponseCollectionResponse
{
    /**
     * @var AccessReviewApplyActionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessReviewApplyActionCollectionResponse ...$items Variable number of AccessReviewApplyActionCollectionResponse items
     * @return self
     */
    public function setValue(AccessReviewApplyActionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AccessReviewApplyActionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AccessReviewApplyActionCollectionResponse $item
     * @return self
     */
    public function addValue(AccessReviewApplyActionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
