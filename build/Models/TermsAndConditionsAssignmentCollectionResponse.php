...
/**
 * Collection response for TermsAndConditionsAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TermsAndConditionsAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TermsAndConditionsAssignment[] $items
     * @return self
     */
    public function setValue(array|TermsAndConditionsAssignment $items, TermsAndConditionsAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TermsAndConditionsAssignment> $value
     * @return self
     ...
     * 
     * @param TermsAndConditionsAssignment $item
     * @return self
     */
    public function addValue(TermsAndConditionsAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TermsAndConditionsAssignment>
     */
