...
/**
 * Collection response for Event
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EventCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Event[]
     */
     ...
     * @return self
     */
    public function setValue(array|Event $items, Event ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Event $item): self
    {
        $this->value[] = $item;
        return $this;
    }
