...
/**
 * Collection response for StopHoldMusicOperationCollectionResponse
 */
class StopHoldMusicOperationCollectionResponseCollectionResponse
{
    /**
     * @var StopHoldMusicOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param StopHoldMusicOperationCollectionResponse ...$items Variable number of StopHoldMusicOperationCollectionResponse items
     * @return self
     */
    public function setValue(StopHoldMusicOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<StopHoldMusicOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param StopHoldMusicOperationCollectionResponse $item
     * @return self
     */
    public function addValue(StopHoldMusicOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
