...
/**
 * Collection response for SecurityIpEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityIpEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityIpEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityIpEvidence $items, SecurityIpEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityIpEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityIpEvidence $item
     * @return self
     */
    public function addValue(SecurityIpEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityIpEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityIpEvidence>
     */
