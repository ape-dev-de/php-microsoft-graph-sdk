...
/**
 * Collection response for EscrowBehavior
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EscrowBehaviorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EscrowBehavior[]
     */
     ...
     * 
     * @param EscrowBehavior[] $items
     * @return self
     */
    public function setValue(array|EscrowBehavior $items, EscrowBehavior ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EscrowBehavior> $value
     * @return self
     ...
     * 
     * @param EscrowBehavior $item
     * @return self
     */
    public function addValue(EscrowBehavior $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EscrowBehavior>
     */
