...
/**
 * Collection response for IdentityCustomUserFlowAttribute
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityCustomUserFlowAttributeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityCustomUserFlowAttribute[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityCustomUserFlowAttribute[] $items
     * @return self
     */
    public function setValue(array|IdentityCustomUserFlowAttribute $items, IdentityCustomUserFlowAttribute ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityCustomUserFlowAttribute> $value
     * @return self
     ...
     * 
     * @param IdentityCustomUserFlowAttribute $item
     * @return self
     */
    public function addValue(IdentityCustomUserFlowAttribute $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityCustomUserFlowAttribute|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityCustomUserFlowAttribute>
     */
