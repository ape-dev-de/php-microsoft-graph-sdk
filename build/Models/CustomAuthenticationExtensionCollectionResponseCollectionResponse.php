...
/**
 * Collection response for CustomAuthenticationExtensionCollectionResponse
 */
class CustomAuthenticationExtensionCollectionResponseCollectionResponse
{
    /**
     * @var CustomAuthenticationExtensionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CustomAuthenticationExtensionCollectionResponse ...$items Variable number of CustomAuthenticationExtensionCollectionResponse items
     * @return self
     */
    public function setValue(CustomAuthenticationExtensionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CustomAuthenticationExtensionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CustomAuthenticationExtensionCollectionResponse $item
     * @return self
     */
    public function addValue(CustomAuthenticationExtensionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
