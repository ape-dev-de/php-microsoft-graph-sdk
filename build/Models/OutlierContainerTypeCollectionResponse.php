...
/**
 * Collection response for OutlierContainerType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OutlierContainerTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OutlierContainerType[]
     */
    private array $value = [];
     ...
     * 
     * @param OutlierContainerType[] $items
     * @return self
     */
    public function setValue(array|OutlierContainerType $items, OutlierContainerType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OutlierContainerType> $value
     * @return self
     ...
     * 
     * @param OutlierContainerType $item
     * @return self
     */
    public function addValue(OutlierContainerType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OutlierContainerType>
     */
