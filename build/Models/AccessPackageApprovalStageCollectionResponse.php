...
/**
 * Collection response for AccessPackageApprovalStage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageApprovalStageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessPackageApprovalStage[] $items
     * @return self
     */
    public function setValue(array|AccessPackageApprovalStage $items, AccessPackageApprovalStage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageApprovalStage> $value
     * @return self
     ...
     * 
     * @param AccessPackageApprovalStage $item
     * @return self
     */
    public function addValue(AccessPackageApprovalStage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageApprovalStage>
     */
