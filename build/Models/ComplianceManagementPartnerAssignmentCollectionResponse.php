...
/**
 * Collection response for ComplianceManagementPartnerAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ComplianceManagementPartnerAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ComplianceManagementPartnerAssignment[] $items
     * @return self
     */
    public function setValue(array|ComplianceManagementPartnerAssignment $items, ComplianceManagementPartnerAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ComplianceManagementPartnerAssignment> $value
     * @return self
     ...
     * 
     * @param ComplianceManagementPartnerAssignment $item
     * @return self
     */
    public function addValue(ComplianceManagementPartnerAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ComplianceManagementPartnerAssignment|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ComplianceManagementPartnerAssignment>
     */
