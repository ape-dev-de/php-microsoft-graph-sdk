...
/**
 * Collection response for ExpirationPatternType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExpirationPatternTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExpirationPatternType[]
     */
    private array $value = [];
     ...
     * 
     * @param ExpirationPatternType[] $items
     * @return self
     */
    public function setValue(array|ExpirationPatternType $items, ExpirationPatternType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExpirationPatternType> $value
     * @return self
     ...
     * 
     * @param ExpirationPatternType $item
     * @return self
     */
    public function addValue(ExpirationPatternType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ExpirationPatternType>
     */
