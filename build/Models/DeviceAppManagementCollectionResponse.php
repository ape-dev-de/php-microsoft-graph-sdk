...
/**
 * Collection response for DeviceAppManagement
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceAppManagementCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceAppManagement[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceAppManagement[] $items
     * @return self
     */
    public function setValue(array|DeviceAppManagement $items, DeviceAppManagement ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceAppManagement> $value
     * @return self
     ...
     * 
     * @param DeviceAppManagement $item
     * @return self
     */
    public function addValue(DeviceAppManagement $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceAppManagement>
     */
