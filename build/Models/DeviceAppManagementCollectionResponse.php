 ...
 */
class DeviceAppManagementCollectionResponse
{
    /**
     ...
     * 
     * @param DeviceAppManagement ...$items Variable number of DeviceAppManagement items
     * @return self
     */
    public function setValue(DeviceAppManagement ...$items): self
    {
        $this->value = $items;
        return $this;
    }
