...
/**
 * Collection response for AccessPackageRequestType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageRequestTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageRequestType[]
     */
    private array $value = [];
     ...
     * 
     * @return AccessPackageRequestType[]
     */
     ...
     * 
     * @param AccessPackageRequestType[] $items
     * @return self
     */
    public function setValue(array|AccessPackageRequestType $items, AccessPackageRequestType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageRequestType> $value
     * @return self
     ...
     * 
     * @param AccessPackageRequestType $item
     * @return self
     */
    public function addValue(AccessPackageRequestType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageRequestType>
     */
