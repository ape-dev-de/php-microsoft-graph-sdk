...
/**
 * Collection response for ServiceUpdateMessage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServiceUpdateMessageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ServiceUpdateMessage[] $items
     * @return self
     */
    public function setValue(array|ServiceUpdateMessage $items, ServiceUpdateMessage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServiceUpdateMessage> $value
     * @return self
     ...
     * 
     * @param ServiceUpdateMessage $item
     * @return self
     */
    public function addValue(ServiceUpdateMessage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ServiceUpdateMessage>
     */
