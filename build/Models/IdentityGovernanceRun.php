...
class IdentityGovernanceRun
{
     ...
     */
    private ?string $userProcessingResults;
    ...
    public function getUserProcessingResults(): ?string
    {
        return $this->userProcessingResults;
    }

    public function setUserProcessingResults(?string $userProcessingResults): self
    {
