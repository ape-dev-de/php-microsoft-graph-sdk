...
/**
 * Collection response for WindowsAutopilotDeploymentProfile
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsAutopilotDeploymentProfileCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsAutopilotDeploymentProfile[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsAutopilotDeploymentProfile[] $items
     * @return self
     */
    public function setValue(array|WindowsAutopilotDeploymentProfile $items, WindowsAutopilotDeploymentProfile ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsAutopilotDeploymentProfile> $value
     * @return self
     ...
     * 
     * @param WindowsAutopilotDeploymentProfile $item
     * @return self
     */
    public function addValue(WindowsAutopilotDeploymentProfile $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsAutopilotDeploymentProfile>
     */
