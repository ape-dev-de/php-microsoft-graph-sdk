 ...
 */
class WindowsAutopilotDeploymentProfileCollectionResponse
{
    /**
     ...
     * 
     * @param WindowsAutopilotDeploymentProfile ...$items Variable number of WindowsAutopilotDeploymentProfile items
     * @return self
     */
    public function setValue(WindowsAutopilotDeploymentProfile ...$items): self
    {
        $this->value = $items;
        return $this;
    }
