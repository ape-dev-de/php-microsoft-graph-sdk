...
/**
 * Collection response for ServiceProvisioningXmlError
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServiceProvisioningXmlErrorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ServiceProvisioningXmlError[]
     */
    private array $value = [];
     ...
     * 
     * @param ServiceProvisioningXmlError[] $items
     * @return self
     */
    public function setValue(array|ServiceProvisioningXmlError $items, ServiceProvisioningXmlError ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServiceProvisioningXmlError> $value
     * @return self
     ...
     * 
     * @param ServiceProvisioningXmlError $item
     * @return self
     */
    public function addValue(ServiceProvisioningXmlError $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ServiceProvisioningXmlError|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ServiceProvisioningXmlError>
     */
