 ...
 */
class ServiceProvisioningXmlErrorCollectionResponse
{
    /**
     ...
     * 
     * @param ServiceProvisioningXmlError ...$items Variable number of ServiceProvisioningXmlError items
     * @return self
     */
    public function setValue(ServiceProvisioningXmlError ...$items): self
    {
        $this->value = $items;
        return $this;
    }
