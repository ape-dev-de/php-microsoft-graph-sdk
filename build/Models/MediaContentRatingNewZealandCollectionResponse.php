...
/**
 * Collection response for MediaContentRatingNewZealand
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MediaContentRatingNewZealandCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MediaContentRatingNewZealand[] $items
     * @return self
     */
    public function setValue(array|MediaContentRatingNewZealand $items, MediaContentRatingNewZealand ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MediaContentRatingNewZealand> $value
     * @return self
     ...
     * 
     * @param MediaContentRatingNewZealand $item
     * @return self
     */
    public function addValue(MediaContentRatingNewZealand $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MediaContentRatingNewZealand>
     */
