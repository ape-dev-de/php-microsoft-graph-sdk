 ...
 */
class MediaContentRatingNewZealandCollectionResponse
{
    /**
     ...
     * 
     * @param MediaContentRatingNewZealand ...$items Variable number of MediaContentRatingNewZealand items
     * @return self
     */
    public function setValue(MediaContentRatingNewZealand ...$items): self
    {
        $this->value = $items;
        return $this;
    }
