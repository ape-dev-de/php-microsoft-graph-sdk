...
/**
 * Collection response for ServicePrincipalRiskDetectionCollectionResponse
 */
class ServicePrincipalRiskDetectionCollectionResponseCollectionResponse
{
    /**
     * @var ServicePrincipalRiskDetectionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ServicePrincipalRiskDetectionCollectionResponse ...$items Variable number of ServicePrincipalRiskDetectionCollectionResponse items
     * @return self
     */
    public function setValue(ServicePrincipalRiskDetectionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ServicePrincipalRiskDetectionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ServicePrincipalRiskDetectionCollectionResponse $item
     * @return self
     */
    public function addValue(ServicePrincipalRiskDetectionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
