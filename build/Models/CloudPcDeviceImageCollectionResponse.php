...
/**
 * Collection response for CloudPcDeviceImage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcDeviceImageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CloudPcDeviceImage[] $items
     * @return self
     */
    public function setValue(array|CloudPcDeviceImage $items, CloudPcDeviceImage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcDeviceImage> $value
     * @return self
     ...
     * 
     * @param CloudPcDeviceImage $item
     * @return self
     */
    public function addValue(CloudPcDeviceImage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcDeviceImage>
     */
