...
/**
 * Collection response for SettingTemplateValueCollectionResponse
 */
class SettingTemplateValueCollectionResponseCollectionResponse
{
    /**
     * @var SettingTemplateValueCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SettingTemplateValueCollectionResponse ...$items Variable number of SettingTemplateValueCollectionResponse items
     * @return self
     */
    public function setValue(SettingTemplateValueCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SettingTemplateValueCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SettingTemplateValueCollectionResponse $item
     * @return self
     */
    public function addValue(SettingTemplateValueCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
