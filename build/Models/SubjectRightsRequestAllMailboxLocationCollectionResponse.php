...
/**
 * SubjectRightsRequestAllMailboxLocationCollectionResponse - Collection response
 */
class SubjectRightsRequestAllMailboxLocationCollectionResponse
{
    /**
     * @var array<int, SubjectRightsRequestAllMailboxLocation>
     */
    public array $value = [];
