...
/**
 * Collection response for SubjectRightsRequestAllMailboxLocation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SubjectRightsRequestAllMailboxLocationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SubjectRightsRequestAllMailboxLocation[]
     */
    private array $value = [];
     ...
     * 
     * @param SubjectRightsRequestAllMailboxLocation[] $items
     * @return self
     */
    public function setValue(array|SubjectRightsRequestAllMailboxLocation $items, SubjectRightsRequestAllMailboxLocation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SubjectRightsRequestAllMailboxLocation> $value
     * @return self
     ...
     * 
     * @param SubjectRightsRequestAllMailboxLocation $item
     * @return self
     */
    public function addValue(SubjectRightsRequestAllMailboxLocation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SubjectRightsRequestAllMailboxLocation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SubjectRightsRequestAllMailboxLocation>
     */
