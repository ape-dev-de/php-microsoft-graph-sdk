...
/**
 * Collection response for OnAttributeCollectionStartHandler
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnAttributeCollectionStartHandlerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnAttributeCollectionStartHandler[]
     */
    private array $value = [];
     ...
     * 
     * @param OnAttributeCollectionStartHandler[] $items
     * @return self
     */
    public function setValue(array|OnAttributeCollectionStartHandler $items, OnAttributeCollectionStartHandler ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnAttributeCollectionStartHandler> $value
     * @return self
     ...
     * 
     * @param OnAttributeCollectionStartHandler $item
     * @return self
     */
    public function addValue(OnAttributeCollectionStartHandler $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnAttributeCollectionStartHandler>
     */
