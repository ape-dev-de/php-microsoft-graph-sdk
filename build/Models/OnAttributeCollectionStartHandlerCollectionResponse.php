...
/**
 * OnAttributeCollectionStartHandlerCollectionResponse - Collection response
 */
class OnAttributeCollectionStartHandlerCollectionResponse
{
    /**
     * @var array<int, OnAttributeCollectionStartHandler>
     */
    public array $value = [];
