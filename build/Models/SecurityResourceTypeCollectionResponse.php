...
/**
 * Collection response for SecurityResourceType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityResourceTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityResourceType[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityResourceType[] $items
     * @return self
     */
    public function setValue(array|SecurityResourceType $items, SecurityResourceType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityResourceType> $value
     * @return self
     ...
     * 
     * @param SecurityResourceType $item
     * @return self
     */
    public function addValue(SecurityResourceType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityResourceType>
     */
