...
/**
 * Collection response for TeamsAppPublishingState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamsAppPublishingStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return TeamsAppPublishingState[]
     */
     ...
     * 
     * @param TeamsAppPublishingState[] $items
     * @return self
     */
    public function setValue(array|TeamsAppPublishingState $items, TeamsAppPublishingState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamsAppPublishingState> $value
     * @return self
     ...
     * 
     * @param TeamsAppPublishingState $item
     * @return self
     */
    public function addValue(TeamsAppPublishingState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamsAppPublishingState>
     */
