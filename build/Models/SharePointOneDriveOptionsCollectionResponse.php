...
/**
 * Collection response for SharePointOneDriveOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SharePointOneDriveOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SharePointOneDriveOptions[]
     */
    private array $value = [];
     ...
     * 
     * @param SharePointOneDriveOptions[] $items
     * @return self
     */
    public function setValue(array|SharePointOneDriveOptions $items, SharePointOneDriveOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SharePointOneDriveOptions> $value
     * @return self
     ...
     * 
     * @param SharePointOneDriveOptions $item
     * @return self
     */
    public function addValue(SharePointOneDriveOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SharePointOneDriveOptions>
     */
