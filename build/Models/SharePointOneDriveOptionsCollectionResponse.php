 ...
 */
class SharePointOneDriveOptionsCollectionResponse
{
    /**
     ...
     * 
     * @param SharePointOneDriveOptions ...$items Variable number of SharePointOneDriveOptions items
     * @return self
     */
    public function setValue(SharePointOneDriveOptions ...$items): self
    {
        $this->value = $items;
        return $this;
    }
