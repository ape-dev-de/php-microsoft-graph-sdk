 ...
 */
class OnInteractiveAuthFlowStartExternalUsersSelfServiceSignUpCollectionResponse
{
    /**
     ...
     * 
     * @param OnInteractiveAuthFlowStartExternalUsersSelfServiceSignUp ...$items Variable number of OnInteractiveAuthFlowStartExternalUsersSelfServiceSignUp items
     * @return self
     */
    public function setValue(OnInteractiveAuthFlowStartExternalUsersSelfServiceSignUp ...$items): self
    {
        $this->value = $items;
        return $this;
    }
