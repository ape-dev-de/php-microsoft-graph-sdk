...
/**
 * Collection response for OnInteractiveAuthFlowStartExternalUsersSelfServiceSignUp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnInteractiveAuthFlowStartExternalUsersSelfServiceSignUpCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnInteractiveAuthFlowStartExternalUsersSelfServiceSignUp[]
     */
    private array $value = [];
     ...
     * 
     * @param OnInteractiveAuthFlowStartExternalUsersSelfServiceSignUp[] $items
     * @return self
     */
    public function setValue(array|OnInteractiveAuthFlowStartExternalUsersSelfServiceSignUp $items, OnInteractiveAuthFlowStartExternalUsersSelfServiceSignUp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnInteractiveAuthFlowStartExternalUsersSelfServiceSignUp> $value
     * @return self
     ...
     * 
     * @param OnInteractiveAuthFlowStartExternalUsersSelfServiceSignUp $item
     * @return self
     */
    public function addValue(OnInteractiveAuthFlowStartExternalUsersSelfServiceSignUp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OnInteractiveAuthFlowStartExternalUsersSelfServiceSignUp|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OnInteractiveAuthFlowStartExternalUsersSelfServiceSignUp>
     */
