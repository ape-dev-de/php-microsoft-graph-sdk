...
/**
 * OnInteractiveAuthFlowStartExternalUsersSelfServiceSignUpCollectionResponse - Collection response
 */
class OnInteractiveAuthFlowStartExternalUsersSelfServiceSignUpCollectionResponse
{
    /**
     * @var array<int, OnInteractiveAuthFlowStartExternalUsersSelfServiceSignUp>
     */
    public array $value = [];
