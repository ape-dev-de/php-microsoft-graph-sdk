...
/**
 * Collection response for SubscribeToToneOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SubscribeToToneOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SubscribeToToneOperation[] $items
     * @return self
     */
    public function setValue(array|SubscribeToToneOperation $items, SubscribeToToneOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SubscribeToToneOperation> $value
     * @return self
     ...
     * 
     * @param SubscribeToToneOperation $item
     * @return self
     */
    public function addValue(SubscribeToToneOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SubscribeToToneOperation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SubscribeToToneOperation>
     */
