...
/**
 * Collection response for UnifiedRoleAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRoleAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UnifiedRoleAssignment[] $items
     * @return self
     */
    public function setValue(array|UnifiedRoleAssignment $items, UnifiedRoleAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRoleAssignment> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleAssignment $item
     * @return self
     */
    public function addValue(UnifiedRoleAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRoleAssignment>
     */
