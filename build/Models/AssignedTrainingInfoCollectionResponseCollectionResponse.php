...
/**
 * Collection response for AssignedTrainingInfoCollectionResponse
 */
class AssignedTrainingInfoCollectionResponseCollectionResponse
{
    /**
     * @var AssignedTrainingInfoCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AssignedTrainingInfoCollectionResponse ...$items Variable number of AssignedTrainingInfoCollectionResponse items
     * @return self
     */
    public function setValue(AssignedTrainingInfoCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AssignedTrainingInfoCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AssignedTrainingInfoCollectionResponse $item
     * @return self
     */
    public function addValue(AssignedTrainingInfoCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
