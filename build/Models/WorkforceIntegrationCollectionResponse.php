...
/**
 * Collection response for WorkforceIntegration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkforceIntegrationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WorkforceIntegration[] $items
     * @return self
     */
    public function setValue(array|WorkforceIntegration $items, WorkforceIntegration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkforceIntegration> $value
     * @return self
     ...
     * 
     * @param WorkforceIntegration $item
     * @return self
     */
    public function addValue(WorkforceIntegration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkforceIntegration>
     */
