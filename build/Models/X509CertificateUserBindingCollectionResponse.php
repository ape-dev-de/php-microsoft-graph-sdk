...
/**
 * Collection response for X509CertificateUserBinding
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class X509CertificateUserBindingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param X509CertificateUserBinding[] $items
     * @return self
     */
    public function setValue(array|X509CertificateUserBinding $items, X509CertificateUserBinding ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<X509CertificateUserBinding> $value
     * @return self
     ...
     * 
     * @param X509CertificateUserBinding $item
     * @return self
     */
    public function addValue(X509CertificateUserBinding $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return X509CertificateUserBinding|null
     */
     ...
     * 
     * @return \ArrayIterator<int, X509CertificateUserBinding>
     */
