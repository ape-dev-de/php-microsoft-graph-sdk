...
/**
 * Collection response for Win32LobAppRegistryRuleOperationType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Win32LobAppRegistryRuleOperationTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Win32LobAppRegistryRuleOperationType[]
     */
    private array $value = [];
     ...
     * 
     * @return Win32LobAppRegistryRuleOperationType[]
     */
     ...
     * 
     * @param Win32LobAppRegistryRuleOperationType[] $items
     * @return self
     */
    public function setValue(array|Win32LobAppRegistryRuleOperationType $items, Win32LobAppRegistryRuleOperationType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Win32LobAppRegistryRuleOperationType> $value
     * @return self
     ...
     * 
     * @param Win32LobAppRegistryRuleOperationType $item
     * @return self
     */
    public function addValue(Win32LobAppRegistryRuleOperationType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Win32LobAppRegistryRuleOperationType>
     */
