...
/**
 * ProvisioningStatusErrorCategoryCollectionResponse - Collection response
 */
class ProvisioningStatusErrorCategoryCollectionResponse
{
    /**
     * @var array<int, ProvisioningStatusErrorCategory>
     */
    public array $value = [];
