...
/**
 * Collection response for ProvisioningStatusErrorCategory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProvisioningStatusErrorCategoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProvisioningStatusErrorCategory[]
     */
    private array $value = [];
     ...
     * 
     * @return ProvisioningStatusErrorCategory[]
     */
     ...
     * 
     * @param ProvisioningStatusErrorCategory[] $items
     * @return self
     */
    public function setValue(array|ProvisioningStatusErrorCategory $items, ProvisioningStatusErrorCategory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProvisioningStatusErrorCategory> $value
     * @return self
     ...
     * 
     * @param ProvisioningStatusErrorCategory $item
     * @return self
     */
    public function addValue(ProvisioningStatusErrorCategory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProvisioningStatusErrorCategory>
     */
