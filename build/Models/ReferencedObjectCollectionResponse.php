...
/**
 * Collection response for ReferencedObject
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ReferencedObjectCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ReferencedObject[] $items
     * @return self
     */
    public function setValue(array|ReferencedObject $items, ReferencedObject ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ReferencedObject> $value
     * @return self
     ...
     * 
     * @param ReferencedObject $item
     * @return self
     */
    public function addValue(ReferencedObject $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ReferencedObject>
     */
