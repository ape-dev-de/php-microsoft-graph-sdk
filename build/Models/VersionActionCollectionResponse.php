...
/**
 * Collection response for VersionAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VersionActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VersionAction[]
     */
     ...
     * 
     * @param VersionAction[] $items
     * @return self
     */
    public function setValue(array|VersionAction $items, VersionAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VersionAction> $value
     * @return self
     ...
     * 
     * @param VersionAction $item
     * @return self
     */
    public function addValue(VersionAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VersionAction>
     */
