 ...
 */
class VersionActionCollectionResponse
{
    /**
     * @var VersionAction[]
     */
     ...
     * 
     * @param VersionAction ...$items Variable number of VersionAction items
     * @return self
     */
    public function setValue(VersionAction ...$items): self
    {
        $this->value = $items;
        return $this;
    }
