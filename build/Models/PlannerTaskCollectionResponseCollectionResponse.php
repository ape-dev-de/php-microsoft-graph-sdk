...
/**
 * Collection response for PlannerTaskCollectionResponse
 */
class PlannerTaskCollectionResponseCollectionResponse
{
    /**
     * @var PlannerTaskCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PlannerTaskCollectionResponse ...$items Variable number of PlannerTaskCollectionResponse items
     * @return self
     */
    public function setValue(PlannerTaskCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PlannerTaskCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PlannerTaskCollectionResponse $item
     * @return self
     */
    public function addValue(PlannerTaskCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
