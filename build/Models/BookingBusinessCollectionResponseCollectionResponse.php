...
/**
 * Collection response for BookingBusinessCollectionResponse
 */
class BookingBusinessCollectionResponseCollectionResponse
{
    /**
     * @var BookingBusinessCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BookingBusinessCollectionResponse ...$items Variable number of BookingBusinessCollectionResponse items
     * @return self
     */
    public function setValue(BookingBusinessCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<BookingBusinessCollectionResponse> $value
     * @return self
     ...
     * 
     * @param BookingBusinessCollectionResponse $item
     * @return self
     */
    public function addValue(BookingBusinessCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
