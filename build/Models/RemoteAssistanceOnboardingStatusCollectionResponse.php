...
/**
 * RemoteAssistanceOnboardingStatusCollectionResponse - Collection response
 */
class RemoteAssistanceOnboardingStatusCollectionResponse
{
    /**
     * @var array<int, RemoteAssistanceOnboardingStatus>
     */
    public array $value = [];
