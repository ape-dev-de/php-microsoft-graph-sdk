...
/**
 * Collection response for RemoteAssistanceOnboardingStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RemoteAssistanceOnboardingStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RemoteAssistanceOnboardingStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return RemoteAssistanceOnboardingStatus[]
     */
     ...
     * 
     * @param RemoteAssistanceOnboardingStatus[] $items
     * @return self
     */
    public function setValue(array|RemoteAssistanceOnboardingStatus $items, RemoteAssistanceOnboardingStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RemoteAssistanceOnboardingStatus> $value
     * @return self
     ...
     * 
     * @param RemoteAssistanceOnboardingStatus $item
     * @return self
     */
    public function addValue(RemoteAssistanceOnboardingStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RemoteAssistanceOnboardingStatus>
     */
