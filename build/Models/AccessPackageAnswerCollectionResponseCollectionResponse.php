...
/**
 * Collection response for AccessPackageAnswerCollectionResponse
 */
class AccessPackageAnswerCollectionResponseCollectionResponse
{
    /**
     * @var AccessPackageAnswerCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageAnswerCollectionResponse ...$items Variable number of AccessPackageAnswerCollectionResponse items
     * @return self
     */
    public function setValue(AccessPackageAnswerCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AccessPackageAnswerCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AccessPackageAnswerCollectionResponse $item
     * @return self
     */
    public function addValue(AccessPackageAnswerCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
