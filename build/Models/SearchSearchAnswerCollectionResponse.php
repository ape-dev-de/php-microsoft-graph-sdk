...
/**
 * Collection response for SearchSearchAnswer
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SearchSearchAnswerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SearchSearchAnswer[]
     */
    private array $value = [];
     ...
     * 
     * @param SearchSearchAnswer[] $items
     * @return self
     */
    public function setValue(array|SearchSearchAnswer $items, SearchSearchAnswer ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SearchSearchAnswer> $value
     * @return self
     ...
     * 
     * @param SearchSearchAnswer $item
     * @return self
     */
    public function addValue(SearchSearchAnswer $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SearchSearchAnswer|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SearchSearchAnswer>
     */
