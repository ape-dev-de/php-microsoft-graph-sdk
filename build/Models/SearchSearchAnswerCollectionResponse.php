 ...
 */
class SearchSearchAnswerCollectionResponse
{
    /**
     ...
     * 
     * @param SearchSearchAnswer ...$items Variable number of SearchSearchAnswer items
     * @return self
     */
    public function setValue(SearchSearchAnswer ...$items): self
    {
        $this->value = $items;
        return $this;
    }
