...
/**
 * Collection response for ManagedAppStatusRawCollectionResponse
 */
class ManagedAppStatusRawCollectionResponseCollectionResponse
{
    /**
     * @var ManagedAppStatusRawCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedAppStatusRawCollectionResponse ...$items Variable number of ManagedAppStatusRawCollectionResponse items
     * @return self
     */
    public function setValue(ManagedAppStatusRawCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ManagedAppStatusRawCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ManagedAppStatusRawCollectionResponse $item
     * @return self
     */
    public function addValue(ManagedAppStatusRawCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
