...
/**
 * Collection response for UserExperienceAnalyticsDeviceStartupProcess
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsDeviceStartupProcessCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsDeviceStartupProcess[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsDeviceStartupProcess $items, UserExperienceAnalyticsDeviceStartupProcess ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsDeviceStartupProcess> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsDeviceStartupProcess $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsDeviceStartupProcess $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsDeviceStartupProcess>
     */
