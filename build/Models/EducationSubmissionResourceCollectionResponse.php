...
/**
 * Collection response for EducationSubmissionResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationSubmissionResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param EducationSubmissionResource[] $items
     * @return self
     */
    public function setValue(array|EducationSubmissionResource $items, EducationSubmissionResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationSubmissionResource> $value
     * @return self
     ...
     * 
     * @param EducationSubmissionResource $item
     * @return self
     */
    public function addValue(EducationSubmissionResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationSubmissionResource>
     */
