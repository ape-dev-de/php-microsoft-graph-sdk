...
/**
 * DelegateMeetingMessageDeliveryOptionsCollectionResponse - Collection response
 */
class DelegateMeetingMessageDeliveryOptionsCollectionResponse
{
    /**
     * @var array<int, DelegateMeetingMessageDeliveryOptions>
     */
    public array $value = [];
