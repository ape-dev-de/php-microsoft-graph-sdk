...
/**
 * Collection response for DelegateMeetingMessageDeliveryOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DelegateMeetingMessageDeliveryOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DelegateMeetingMessageDeliveryOptions[] $items
     * @return self
     */
    public function setValue(array|DelegateMeetingMessageDeliveryOptions $items, DelegateMeetingMessageDeliveryOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DelegateMeetingMessageDeliveryOptions> $value
     * @return self
     ...
     * 
     * @param DelegateMeetingMessageDeliveryOptions $item
     * @return self
     */
    public function addValue(DelegateMeetingMessageDeliveryOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DelegateMeetingMessageDeliveryOptions>
     */
