...
/**
 * Collection response for SecurityServiceSource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityServiceSourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityServiceSource[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityServiceSource[] $items
     * @return self
     */
    public function setValue(array|SecurityServiceSource $items, SecurityServiceSource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityServiceSource> $value
     * @return self
     ...
     * 
     * @param SecurityServiceSource $item
     * @return self
     */
    public function addValue(SecurityServiceSource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityServiceSource|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityServiceSource>
     */
