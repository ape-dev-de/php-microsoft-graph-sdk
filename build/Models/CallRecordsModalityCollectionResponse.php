...
/**
 * Collection response for CallRecordsModality
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsModalityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CallRecordsModality[] $items
     * @return self
     */
    public function setValue(array|CallRecordsModality $items, CallRecordsModality ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsModality> $value
     * @return self
     ...
     * 
     * @param CallRecordsModality $item
     * @return self
     */
    public function addValue(CallRecordsModality $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsModality|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsModality>
     */
