...
/**
 * Collection response for DeviceManagementTroubleshootingEvent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceManagementTroubleshootingEventCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceManagementTroubleshootingEvent[] $items
     * @return self
     */
    public function setValue(array|DeviceManagementTroubleshootingEvent $items, DeviceManagementTroubleshootingEvent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceManagementTroubleshootingEvent> $value
     * @return self
     ...
     * 
     * @param DeviceManagementTroubleshootingEvent $item
     * @return self
     */
    public function addValue(DeviceManagementTroubleshootingEvent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceManagementTroubleshootingEvent>
     */
