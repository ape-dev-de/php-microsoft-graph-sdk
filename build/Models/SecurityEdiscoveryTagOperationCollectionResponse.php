...
/**
 * SecurityEdiscoveryTagOperationCollectionResponse - Collection response
 */
class SecurityEdiscoveryTagOperationCollectionResponse
{
    /**
     * @var array<int, SecurityEdiscoveryTagOperation>
     */
    public array $value = [];
