...
/**
 * Collection response for SecurityEdiscoveryTagOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityEdiscoveryTagOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityEdiscoveryTagOperation[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityEdiscoveryTagOperation[]
     */
     ...
     * 
     * @param SecurityEdiscoveryTagOperation[] $items
     * @return self
     */
    public function setValue(array|SecurityEdiscoveryTagOperation $items, SecurityEdiscoveryTagOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityEdiscoveryTagOperation> $value
     * @return self
     ...
     * 
     * @param SecurityEdiscoveryTagOperation $item
     * @return self
     */
    public function addValue(SecurityEdiscoveryTagOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityEdiscoveryTagOperation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityEdiscoveryTagOperation>
     */
