...
/**
 * Collection response for AccessPackageAssignmentRequestCollectionResponse
 */
class AccessPackageAssignmentRequestCollectionResponseCollectionResponse
{
    /**
     * @var AccessPackageAssignmentRequestCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageAssignmentRequestCollectionResponse ...$items Variable number of AccessPackageAssignmentRequestCollectionResponse items
     * @return self
     */
    public function setValue(AccessPackageAssignmentRequestCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AccessPackageAssignmentRequestCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AccessPackageAssignmentRequestCollectionResponse $item
     * @return self
     */
    public function addValue(AccessPackageAssignmentRequestCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
