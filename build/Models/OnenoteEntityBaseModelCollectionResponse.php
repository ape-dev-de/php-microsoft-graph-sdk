 ...
 */
class OnenoteEntityBaseModelCollectionResponse
{
    /**
     ...
     * 
     * @param OnenoteEntityBaseModel ...$items Variable number of OnenoteEntityBaseModel items
     * @return self
     */
    public function setValue(OnenoteEntityBaseModel ...$items): self
    {
        $this->value = $items;
        return $this;
    }
