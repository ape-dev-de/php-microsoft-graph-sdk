...
/**
 * Collection response for OnenoteEntityBaseModel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnenoteEntityBaseModelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnenoteEntityBaseModel[]
     */
    private array $value = [];
     ...
     * 
     * @param OnenoteEntityBaseModel[] $items
     * @return self
     */
    public function setValue(array|OnenoteEntityBaseModel $items, OnenoteEntityBaseModel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnenoteEntityBaseModel> $value
     * @return self
     ...
     * 
     * @param OnenoteEntityBaseModel $item
     * @return self
     */
    public function addValue(OnenoteEntityBaseModel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OnenoteEntityBaseModel|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OnenoteEntityBaseModel>
     */
