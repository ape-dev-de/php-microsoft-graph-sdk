...
/**
 * Windows10EnterpriseModernAppManagementConfigurationCollectionResponse - Collection response
 */
class Windows10EnterpriseModernAppManagementConfigurationCollectionResponse
{
    /**
     * @var array<int, Windows10EnterpriseModernAppManagementConfiguration>
     */
    public array $value = [];
