...
/**
 * Collection response for Windows10EnterpriseModernAppManagementConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Windows10EnterpriseModernAppManagementConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Windows10EnterpriseModernAppManagementConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param Windows10EnterpriseModernAppManagementConfiguration[] $items
     * @return self
     */
    public function setValue(array|Windows10EnterpriseModernAppManagementConfiguration $items, Windows10EnterpriseModernAppManagementConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Windows10EnterpriseModernAppManagementConfiguration> $value
     * @return self
     ...
     * 
     * @param Windows10EnterpriseModernAppManagementConfiguration $item
     * @return self
     */
    public function addValue(Windows10EnterpriseModernAppManagementConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return Windows10EnterpriseModernAppManagementConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, Windows10EnterpriseModernAppManagementConfiguration>
     */
