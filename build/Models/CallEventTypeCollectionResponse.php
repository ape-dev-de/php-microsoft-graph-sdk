...
/**
 * Collection response for CallEventType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallEventTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallEventType[]
     */
     ...
     * 
     * @param CallEventType[] $items
     * @return self
     */
    public function setValue(array|CallEventType $items, CallEventType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallEventType> $value
     * @return self
     ...
     * 
     * @param CallEventType $item
     * @return self
     */
    public function addValue(CallEventType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CallEventType>
     */
