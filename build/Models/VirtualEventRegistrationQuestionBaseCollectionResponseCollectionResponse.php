...
/**
 * Collection response for VirtualEventRegistrationQuestionBaseCollectionResponse
 */
class VirtualEventRegistrationQuestionBaseCollectionResponseCollectionResponse
{
    /**
     * @var VirtualEventRegistrationQuestionBaseCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param VirtualEventRegistrationQuestionBaseCollectionResponse ...$items Variable number of VirtualEventRegistrationQuestionBaseCollectionResponse items
     * @return self
     */
    public function setValue(VirtualEventRegistrationQuestionBaseCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<VirtualEventRegistrationQuestionBaseCollectionResponse> $value
     * @return self
     ...
     * 
     * @param VirtualEventRegistrationQuestionBaseCollectionResponse $item
     * @return self
     */
    public function addValue(VirtualEventRegistrationQuestionBaseCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
