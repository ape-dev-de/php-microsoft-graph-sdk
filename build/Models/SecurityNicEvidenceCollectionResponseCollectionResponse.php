...
/**
 * Collection response for SecurityNicEvidenceCollectionResponse
 */
class SecurityNicEvidenceCollectionResponseCollectionResponse
{
    /**
     * @var SecurityNicEvidenceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityNicEvidenceCollectionResponse[]
     */
     ...
     * 
     * @param SecurityNicEvidenceCollectionResponse ...$items Variable number of SecurityNicEvidenceCollectionResponse items
     * @return self
     */
    public function setValue(SecurityNicEvidenceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityNicEvidenceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityNicEvidenceCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityNicEvidenceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
