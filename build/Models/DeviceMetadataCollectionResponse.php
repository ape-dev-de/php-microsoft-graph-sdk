...
/**
 * Collection response for DeviceMetadata
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceMetadataCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceMetadata[]
     */
     ...
     * 
     * @param DeviceMetadata[] $items
     * @return self
     */
    public function setValue(array|DeviceMetadata $items, DeviceMetadata ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceMetadata> $value
     * @return self
     ...
     * 
     * @param DeviceMetadata $item
     * @return self
     */
    public function addValue(DeviceMetadata $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceMetadata>
     */
