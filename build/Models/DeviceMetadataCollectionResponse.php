 ...
 */
class DeviceMetadataCollectionResponse
{
    /**
     * @var DeviceMetadata[]
     */
     ...
     * 
     * @param DeviceMetadata ...$items Variable number of DeviceMetadata items
     * @return self
     */
    public function setValue(DeviceMetadata ...$items): self
    {
        $this->value = $items;
        return $this;
    }
