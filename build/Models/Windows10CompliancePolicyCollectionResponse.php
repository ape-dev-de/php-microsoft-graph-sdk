...
/**
 * Collection response for Windows10CompliancePolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Windows10CompliancePolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Windows10CompliancePolicy[]
     */
    private array $value = [];
     ...
     * 
     * @param Windows10CompliancePolicy[] $items
     * @return self
     */
    public function setValue(array|Windows10CompliancePolicy $items, Windows10CompliancePolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Windows10CompliancePolicy> $value
     * @return self
     ...
     * 
     * @param Windows10CompliancePolicy $item
     * @return self
     */
    public function addValue(Windows10CompliancePolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return Windows10CompliancePolicy|null
     */
     ...
     * 
     * @return \ArrayIterator<int, Windows10CompliancePolicy>
     */
