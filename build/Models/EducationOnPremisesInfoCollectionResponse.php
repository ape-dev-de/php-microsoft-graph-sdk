 ...
 */
class EducationOnPremisesInfoCollectionResponse
{
    /**
     ...
     * 
     * @param EducationOnPremisesInfo ...$items Variable number of EducationOnPremisesInfo items
     * @return self
     */
    public function setValue(EducationOnPremisesInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
