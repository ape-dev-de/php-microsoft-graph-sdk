...
/**
 * Collection response for EducationOnPremisesInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationOnPremisesInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationOnPremisesInfo[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationOnPremisesInfo[] $items
     * @return self
     */
    public function setValue(array|EducationOnPremisesInfo $items, EducationOnPremisesInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationOnPremisesInfo> $value
     * @return self
     ...
     * 
     * @param EducationOnPremisesInfo $item
     * @return self
     */
    public function addValue(EducationOnPremisesInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationOnPremisesInfo>
     */
