...
/**
 * Collection response for SecurityIpEvidenceCollectionResponse
 */
class SecurityIpEvidenceCollectionResponseCollectionResponse
{
    /**
     * @var SecurityIpEvidenceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityIpEvidenceCollectionResponse[]
     */
     ...
     * 
     * @param SecurityIpEvidenceCollectionResponse ...$items Variable number of SecurityIpEvidenceCollectionResponse items
     * @return self
     */
    public function setValue(SecurityIpEvidenceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityIpEvidenceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityIpEvidenceCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityIpEvidenceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
