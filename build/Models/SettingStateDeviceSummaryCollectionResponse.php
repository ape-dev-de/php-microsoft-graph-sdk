...
/**
 * Collection response for SettingStateDeviceSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SettingStateDeviceSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SettingStateDeviceSummary[] $items
     * @return self
     */
    public function setValue(array|SettingStateDeviceSummary $items, SettingStateDeviceSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SettingStateDeviceSummary> $value
     * @return self
     ...
     * 
     * @param SettingStateDeviceSummary $item
     * @return self
     */
    public function addValue(SettingStateDeviceSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SettingStateDeviceSummary>
     */
