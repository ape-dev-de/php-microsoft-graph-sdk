...
/**
 * Collection response for AddInCollectionResponse
 */
class AddInCollectionResponseCollectionResponse
{
    /**
     * @var AddInCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AddInCollectionResponse ...$items Variable number of AddInCollectionResponse items
     * @return self
     */
    public function setValue(AddInCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AddInCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AddInCollectionResponse $item
     * @return self
     */
    public function addValue(AddInCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
