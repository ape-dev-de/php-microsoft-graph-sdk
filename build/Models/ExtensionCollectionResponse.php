...
/**
 * Collection response for Extension
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExtensionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Extension[]
     */
     ...
     * @return self
     */
    public function setValue(array|Extension $items, Extension ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Extension $item): self
    {
        $this->value[] = $item;
        return $this;
    }
