...
/**
 * Collection response for DeviceEnrollmentPlatformRestriction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceEnrollmentPlatformRestrictionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceEnrollmentPlatformRestriction[] $items
     * @return self
     */
    public function setValue(array|DeviceEnrollmentPlatformRestriction $items, DeviceEnrollmentPlatformRestriction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceEnrollmentPlatformRestriction> $value
     * @return self
     ...
     * 
     * @param DeviceEnrollmentPlatformRestriction $item
     * @return self
     */
    public function addValue(DeviceEnrollmentPlatformRestriction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceEnrollmentPlatformRestriction>
     */
