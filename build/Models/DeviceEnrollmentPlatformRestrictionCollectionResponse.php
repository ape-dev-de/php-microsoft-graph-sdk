 ...
 */
class DeviceEnrollmentPlatformRestrictionCollectionResponse
{
    /**
     ...
     * 
     * @param DeviceEnrollmentPlatformRestriction ...$items Variable number of DeviceEnrollmentPlatformRestriction items
     * @return self
     */
    public function setValue(DeviceEnrollmentPlatformRestriction ...$items): self
    {
        $this->value = $items;
        return $this;
    }
