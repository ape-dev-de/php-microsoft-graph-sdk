...
/**
 * Collection response for SimulationAutomationRunCollectionResponse
 */
class SimulationAutomationRunCollectionResponseCollectionResponse
{
    /**
     * @var SimulationAutomationRunCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SimulationAutomationRunCollectionResponse ...$items Variable number of SimulationAutomationRunCollectionResponse items
     * @return self
     */
    public function setValue(SimulationAutomationRunCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SimulationAutomationRunCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SimulationAutomationRunCollectionResponse $item
     * @return self
     */
    public function addValue(SimulationAutomationRunCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
