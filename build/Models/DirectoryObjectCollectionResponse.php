...
/**
 * Collection response for DirectoryObject
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DirectoryObjectCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DirectoryObject[]
     */
     ...
     * 
     * @param DirectoryObject[] $items
     * @return self
     */
    public function setValue(array|DirectoryObject $items, DirectoryObject ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DirectoryObject> $value
     * @return self
     ...
     * 
     * @param DirectoryObject $item
     * @return self
     */
    public function addValue(DirectoryObject $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DirectoryObject>
     */
