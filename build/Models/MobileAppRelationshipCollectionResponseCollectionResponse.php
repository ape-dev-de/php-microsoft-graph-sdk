...
/**
 * Collection response for MobileAppRelationshipCollectionResponse
 */
class MobileAppRelationshipCollectionResponseCollectionResponse
{
    /**
     * @var MobileAppRelationshipCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MobileAppRelationshipCollectionResponse ...$items Variable number of MobileAppRelationshipCollectionResponse items
     * @return self
     */
    public function setValue(MobileAppRelationshipCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MobileAppRelationshipCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MobileAppRelationshipCollectionResponse $item
     * @return self
     */
    public function addValue(MobileAppRelationshipCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
