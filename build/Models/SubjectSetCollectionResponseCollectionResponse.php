...
/**
 * Collection response for SubjectSetCollectionResponse
 */
class SubjectSetCollectionResponseCollectionResponse
{
    /**
     * @var SubjectSetCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SubjectSetCollectionResponse ...$items Variable number of SubjectSetCollectionResponse items
     * @return self
     */
    public function setValue(SubjectSetCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SubjectSetCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SubjectSetCollectionResponse $item
     * @return self
     */
    public function addValue(SubjectSetCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
