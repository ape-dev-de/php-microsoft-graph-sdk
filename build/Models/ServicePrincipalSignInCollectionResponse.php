...
/**
 * Collection response for ServicePrincipalSignIn
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServicePrincipalSignInCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ServicePrincipalSignIn[] $items
     * @return self
     */
    public function setValue(array|ServicePrincipalSignIn $items, ServicePrincipalSignIn ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServicePrincipalSignIn> $value
     * @return self
     ...
     * 
     * @param ServicePrincipalSignIn $item
     * @return self
     */
    public function addValue(ServicePrincipalSignIn $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ServicePrincipalSignIn|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ServicePrincipalSignIn>
     */
