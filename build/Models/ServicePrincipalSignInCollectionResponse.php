 ...
 */
class ServicePrincipalSignInCollectionResponse
{
    /**
     ...
     * 
     * @param ServicePrincipalSignIn ...$items Variable number of ServicePrincipalSignIn items
     * @return self
     */
    public function setValue(ServicePrincipalSignIn ...$items): self
    {
        $this->value = $items;
        return $this;
    }
