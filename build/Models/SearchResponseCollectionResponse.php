...
/**
 * Collection response for SearchResponse
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SearchResponseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SearchResponse[]
     */
     ...
     * @return self
     */
    public function setValue(array|SearchResponse $items, SearchResponse ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SearchResponse> $value
     * @return self
     ...
     * 
     * @param SearchResponse $item
     * @return self
     */
    public function addValue(SearchResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SearchResponse>
     */
