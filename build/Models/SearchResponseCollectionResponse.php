 ...
 */
class SearchResponseCollectionResponse
{
    /**
     * @var SearchResponse[]
     */
     ...
     * 
     * @param SearchResponse ...$items Variable number of SearchResponse items
     * @return self
     */
    public function setValue(SearchResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
