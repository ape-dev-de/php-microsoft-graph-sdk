...
/**
 * Collection response for PartnersBillingOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PartnersBillingOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PartnersBillingOperation[] $items
     * @return self
     */
    public function setValue(array|PartnersBillingOperation $items, PartnersBillingOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PartnersBillingOperation> $value
     * @return self
     ...
     * 
     * @param PartnersBillingOperation $item
     * @return self
     */
    public function addValue(PartnersBillingOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PartnersBillingOperation>
     */
