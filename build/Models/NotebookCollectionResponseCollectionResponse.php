...
/**
 * Collection response for NotebookCollectionResponse
 */
class NotebookCollectionResponseCollectionResponse
{
    /**
     * @var NotebookCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param NotebookCollectionResponse ...$items Variable number of NotebookCollectionResponse items
     * @return self
     */
    public function setValue(NotebookCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<NotebookCollectionResponse> $value
     * @return self
     ...
     * 
     * @param NotebookCollectionResponse $item
     * @return self
     */
    public function addValue(NotebookCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
