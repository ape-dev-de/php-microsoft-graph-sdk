...
/**
 * Collection response for EducationItemBody
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationItemBodyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationItemBody[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationItemBody[] $items
     * @return self
     */
    public function setValue(array|EducationItemBody $items, EducationItemBody ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationItemBody> $value
     * @return self
     ...
     * 
     * @param EducationItemBody $item
     * @return self
     */
    public function addValue(EducationItemBody $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationItemBody>
     */
