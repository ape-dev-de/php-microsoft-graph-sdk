 ...
 */
class EducationItemBodyCollectionResponse
{
    /**
     ...
     * 
     * @param EducationItemBody ...$items Variable number of EducationItemBody items
     * @return self
     */
    public function setValue(EducationItemBody ...$items): self
    {
        $this->value = $items;
        return $this;
    }
