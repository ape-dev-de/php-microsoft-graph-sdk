...
/**
 * Collection response for OpenShiftCollectionResponse
 */
class OpenShiftCollectionResponseCollectionResponse
{
    /**
     * @var OpenShiftCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param OpenShiftCollectionResponse ...$items Variable number of OpenShiftCollectionResponse items
     * @return self
     */
    public function setValue(OpenShiftCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<OpenShiftCollectionResponse> $value
     * @return self
     ...
     * 
     * @param OpenShiftCollectionResponse $item
     * @return self
     */
    public function addValue(OpenShiftCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
