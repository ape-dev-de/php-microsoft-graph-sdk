...
/**
 * Collection response for AuditLogRoot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuditLogRootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuditLogRoot[]
     */
     ...
     * 
     * @param AuditLogRoot[] $items
     * @return self
     */
    public function setValue(array|AuditLogRoot $items, AuditLogRoot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuditLogRoot> $value
     * @return self
     ...
     * 
     * @param AuditLogRoot $item
     * @return self
     */
    public function addValue(AuditLogRoot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuditLogRoot>
     */
