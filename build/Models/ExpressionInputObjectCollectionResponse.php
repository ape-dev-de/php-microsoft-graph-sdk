...
/**
 * Collection response for ExpressionInputObject
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExpressionInputObjectCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExpressionInputObject[]
     */
    private array $value = [];
     ...
     * 
     * @param ExpressionInputObject[] $items
     * @return self
     */
    public function setValue(array|ExpressionInputObject $items, ExpressionInputObject ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExpressionInputObject> $value
     * @return self
     ...
     * 
     * @param ExpressionInputObject $item
     * @return self
     */
    public function addValue(ExpressionInputObject $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ExpressionInputObject>
     */
