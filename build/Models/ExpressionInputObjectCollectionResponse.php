 ...
 */
class ExpressionInputObjectCollectionResponse
{
    /**
     ...
     * 
     * @param ExpressionInputObject ...$items Variable number of ExpressionInputObject items
     * @return self
     */
    public function setValue(ExpressionInputObject ...$items): self
    {
        $this->value = $items;
        return $this;
    }
