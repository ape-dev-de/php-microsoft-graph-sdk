...
/**
 * Collection response for SkypeForBusinessUserConversationMember
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SkypeForBusinessUserConversationMemberCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SkypeForBusinessUserConversationMember[]
     */
    private array $value = [];
     ...
     * 
     * @param SkypeForBusinessUserConversationMember[] $items
     * @return self
     */
    public function setValue(array|SkypeForBusinessUserConversationMember $items, SkypeForBusinessUserConversationMember ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SkypeForBusinessUserConversationMember> $value
     * @return self
     ...
     * 
     * @param SkypeForBusinessUserConversationMember $item
     * @return self
     */
    public function addValue(SkypeForBusinessUserConversationMember $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SkypeForBusinessUserConversationMember|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SkypeForBusinessUserConversationMember>
     */
