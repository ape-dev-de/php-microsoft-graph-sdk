...
/**
 * Collection response for AuditLogUserType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuditLogUserTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuditLogUserType[]
     */
    private array $value = [];
     ...
     * 
     * @param AuditLogUserType[] $items
     * @return self
     */
    public function setValue(array|AuditLogUserType $items, AuditLogUserType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuditLogUserType> $value
     * @return self
     ...
     * 
     * @param AuditLogUserType $item
     * @return self
     */
    public function addValue(AuditLogUserType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuditLogUserType>
     */
