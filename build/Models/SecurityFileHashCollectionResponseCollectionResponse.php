...
/**
 * Collection response for SecurityFileHashCollectionResponse
 */
class SecurityFileHashCollectionResponseCollectionResponse
{
    /**
     * @var SecurityFileHashCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityFileHashCollectionResponse[]
     */
     ...
     * 
     * @param SecurityFileHashCollectionResponse ...$items Variable number of SecurityFileHashCollectionResponse items
     * @return self
     */
    public function setValue(SecurityFileHashCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityFileHashCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityFileHashCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityFileHashCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
