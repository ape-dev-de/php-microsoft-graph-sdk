...
/**
 * Collection response for AttachmentCollectionResponse
 */
class AttachmentCollectionResponseCollectionResponse
{
    /**
     * @var AttachmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AttachmentCollectionResponse ...$items Variable number of AttachmentCollectionResponse items
     * @return self
     */
    public function setValue(AttachmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AttachmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AttachmentCollectionResponse $item
     * @return self
     */
    public function addValue(AttachmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
