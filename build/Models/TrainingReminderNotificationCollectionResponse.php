 ...
 */
class TrainingReminderNotificationCollectionResponse
{
    /**
     ...
     * 
     * @param TrainingReminderNotification ...$items Variable number of TrainingReminderNotification items
     * @return self
     */
    public function setValue(TrainingReminderNotification ...$items): self
    {
        $this->value = $items;
        return $this;
    }
