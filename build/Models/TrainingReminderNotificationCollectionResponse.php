...
/**
 * Collection response for TrainingReminderNotification
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TrainingReminderNotificationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TrainingReminderNotification[]
     */
    private array $value = [];
     ...
     * 
     * @param TrainingReminderNotification[] $items
     * @return self
     */
    public function setValue(array|TrainingReminderNotification $items, TrainingReminderNotification ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TrainingReminderNotification> $value
     * @return self
     ...
     * 
     * @param TrainingReminderNotification $item
     * @return self
     */
    public function addValue(TrainingReminderNotification $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TrainingReminderNotification>
     */
