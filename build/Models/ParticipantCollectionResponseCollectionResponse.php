...
/**
 * Collection response for ParticipantCollectionResponse
 */
class ParticipantCollectionResponseCollectionResponse
{
    /**
     * @var ParticipantCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ParticipantCollectionResponse ...$items Variable number of ParticipantCollectionResponse items
     * @return self
     */
    public function setValue(ParticipantCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ParticipantCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ParticipantCollectionResponse $item
     * @return self
     */
    public function addValue(ParticipantCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
