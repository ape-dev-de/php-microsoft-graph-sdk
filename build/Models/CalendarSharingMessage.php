...
class CalendarSharingMessage
{
     ...
     */
    public FollowupFlag|\stdClass|null $flag = null;

    /** 
     * The owner of the mailbox from which the message is sent. In most cases, this value is the same as the sender property, except for sharing or delegation scenarios. The value must correspond to the actual mailbox used. Find out more about setting the from and sender properties of a message.
     * @var Recipient|\stdClass|null
     */
    public Recipient|\stdClass|null $from = null;
     ...
     */
    public InferenceClassificationType|\stdClass|null $inferenceClassification = null;
     ...
     * @var ItemBody|\stdClass|null
     */
    public ItemBody|\stdClass|null $uniqueBody = null;
    ...
    /** 
     * 
     * @var CalendarSharingMessageAction|\stdClass|null
     */
    public CalendarSharingMessageAction|\stdClass|null $sharingMessageAction = null;
    ...
    public function __construct(array $data = [])
    {
        ...
        if (isset($data['canAccept'])) {
            $this->canAccept = is_bool($data['canAccept']) ? $data['canAccept'] : (bool)$data['canAccept'];
        }
        if (isset($data['sharingMessageAction'])) {
            $this->sharingMessageAction = is_array($data['sharingMessageAction']) ? new CalendarSharingMessageAction($data['sharingMessageAction']) : $data['sharingMessageAction'];
        }
        if (isset($data['sharingMessageActions'])) {
            $this->sharingMessageActions = $data['sharingMessageActions'];
        }
        if (isset($data['suggestedCalendarName'])) {
            $this->suggestedCalendarName = $data['suggestedCalendarName'];
        }
    }
