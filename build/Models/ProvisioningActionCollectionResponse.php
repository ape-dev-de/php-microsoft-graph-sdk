...
/**
 * Collection response for ProvisioningAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProvisioningActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ProvisioningAction[] $items
     * @return self
     */
    public function setValue(array|ProvisioningAction $items, ProvisioningAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProvisioningAction> $value
     * @return self
     ...
     * 
     * @param ProvisioningAction $item
     * @return self
     */
    public function addValue(ProvisioningAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProvisioningAction>
     */
