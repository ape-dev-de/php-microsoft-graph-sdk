...
/**
 * Collection response for BookingReminderCollectionResponse
 */
class BookingReminderCollectionResponseCollectionResponse
{
    /**
     * @var BookingReminderCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BookingReminderCollectionResponse ...$items Variable number of BookingReminderCollectionResponse items
     * @return self
     */
    public function setValue(BookingReminderCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<BookingReminderCollectionResponse> $value
     * @return self
     ...
     * 
     * @param BookingReminderCollectionResponse $item
     * @return self
     */
    public function addValue(BookingReminderCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
