...
/**
 * BookingsServiceAvailabilityTypeCollectionResponse - Collection response
 */
class BookingsServiceAvailabilityTypeCollectionResponse
{
    /**
     * @var array<int, BookingsServiceAvailabilityType>
     */
    public array $value = [];
