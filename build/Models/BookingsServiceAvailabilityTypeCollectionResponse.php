...
/**
 * Collection response for BookingsServiceAvailabilityType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingsServiceAvailabilityTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BookingsServiceAvailabilityType[]
     */
    private array $value = [];
     ...
     * 
     * @return BookingsServiceAvailabilityType[]
     */
     ...
     * 
     * @param BookingsServiceAvailabilityType[] $items
     * @return self
     */
    public function setValue(array|BookingsServiceAvailabilityType $items, BookingsServiceAvailabilityType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingsServiceAvailabilityType> $value
     * @return self
     ...
     * 
     * @param BookingsServiceAvailabilityType $item
     * @return self
     */
    public function addValue(BookingsServiceAvailabilityType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BookingsServiceAvailabilityType>
     */
