 ...
 */
class PrivacyProfileCollectionResponse
{
    /**
     * @var PrivacyProfile[]
     */
     ...
     * 
     * @param PrivacyProfile ...$items Variable number of PrivacyProfile items
     * @return self
     */
    public function setValue(PrivacyProfile ...$items): self
    {
        $this->value = $items;
        return $this;
    }
