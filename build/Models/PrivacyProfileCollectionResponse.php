...
/**
 * Collection response for PrivacyProfile
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrivacyProfileCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrivacyProfile[]
     */
     ...
     * 
     * @param PrivacyProfile[] $items
     * @return self
     */
    public function setValue(array|PrivacyProfile $items, PrivacyProfile ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrivacyProfile> $value
     * @return self
     ...
     * 
     * @param PrivacyProfile $item
     * @return self
     */
    public function addValue(PrivacyProfile $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrivacyProfile>
     */
