 ...
 */
class ScheduleInformationCollectionResponse
{
    /**
     ...
     * 
     * @param ScheduleInformation ...$items Variable number of ScheduleInformation items
     * @return self
     */
    public function setValue(ScheduleInformation ...$items): self
    {
        $this->value = $items;
        return $this;
    }
