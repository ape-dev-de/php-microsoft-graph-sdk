...
/**
 * Collection response for ScheduleInformation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ScheduleInformationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ScheduleInformation[] $items
     * @return self
     */
    public function setValue(array|ScheduleInformation $items, ScheduleInformation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ScheduleInformation> $value
     * @return self
     ...
     * 
     * @param ScheduleInformation $item
     * @return self
     */
    public function addValue(ScheduleInformation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ScheduleInformation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ScheduleInformation>
     */
