...
/**
 * Collection response for SecurityContainerEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityContainerEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return SecurityContainerEvidence[]
     */
     ...
     * 
     * @param SecurityContainerEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityContainerEvidence $items, SecurityContainerEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityContainerEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityContainerEvidence $item
     * @return self
     */
    public function addValue(SecurityContainerEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityContainerEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityContainerEvidence>
     */
