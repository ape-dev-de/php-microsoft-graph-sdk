...
/**
 * SecurityContainerEvidenceCollectionResponse - Collection response
 */
class SecurityContainerEvidenceCollectionResponse
{
    /**
     * @var array<int, SecurityContainerEvidence>
     */
    public array $value = [];
