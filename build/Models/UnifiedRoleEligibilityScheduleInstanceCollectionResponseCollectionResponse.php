...
/**
 * Collection response for UnifiedRoleEligibilityScheduleInstanceCollectionResponse
 */
class UnifiedRoleEligibilityScheduleInstanceCollectionResponseCollectionResponse
{
    /**
     * @var UnifiedRoleEligibilityScheduleInstanceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedRoleEligibilityScheduleInstanceCollectionResponse ...$items Variable number of UnifiedRoleEligibilityScheduleInstanceCollectionResponse items
     * @return self
     */
    public function setValue(UnifiedRoleEligibilityScheduleInstanceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UnifiedRoleEligibilityScheduleInstanceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleEligibilityScheduleInstanceCollectionResponse $item
     * @return self
     */
    public function addValue(UnifiedRoleEligibilityScheduleInstanceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
