...
/**
 * Collection response for SharedInsight
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SharedInsightCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SharedInsight[]
     */
     ...
     * 
     * @param SharedInsight[] $items
     * @return self
     */
    public function setValue(array|SharedInsight $items, SharedInsight ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SharedInsight> $value
     * @return self
     ...
     * 
     * @param SharedInsight $item
     * @return self
     */
    public function addValue(SharedInsight $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SharedInsight>
     */
