...
/**
 * Collection response for Win32LobAppRuleType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Win32LobAppRuleTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Win32LobAppRuleType[]
     */
    private array $value = [];
     ...
     * 
     * @param Win32LobAppRuleType[] $items
     * @return self
     */
    public function setValue(array|Win32LobAppRuleType $items, Win32LobAppRuleType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Win32LobAppRuleType> $value
     * @return self
     ...
     * 
     * @param Win32LobAppRuleType $item
     * @return self
     */
    public function addValue(Win32LobAppRuleType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Win32LobAppRuleType>
     */
