...
/**
 * CrossTenantAccessPolicyTargetConfigurationAccessTypeCollectionResponse - Collection response
 */
class CrossTenantAccessPolicyTargetConfigurationAccessTypeCollectionResponse
{
    /**
     * @var array<int, CrossTenantAccessPolicyTargetConfigurationAccessType>
     */
    public array $value = [];
