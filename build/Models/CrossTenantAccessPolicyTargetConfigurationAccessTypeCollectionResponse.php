...
/**
 * Collection response for CrossTenantAccessPolicyTargetConfigurationAccessType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CrossTenantAccessPolicyTargetConfigurationAccessTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CrossTenantAccessPolicyTargetConfigurationAccessType[]
     */
    private array $value = [];
     ...
     * 
     * @return CrossTenantAccessPolicyTargetConfigurationAccessType[]
     */
     ...
     * 
     * @param CrossTenantAccessPolicyTargetConfigurationAccessType[] $items
     * @return self
     */
    public function setValue(array|CrossTenantAccessPolicyTargetConfigurationAccessType $items, CrossTenantAccessPolicyTargetConfigurationAccessType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CrossTenantAccessPolicyTargetConfigurationAccessType> $value
     * @return self
     ...
     * 
     * @param CrossTenantAccessPolicyTargetConfigurationAccessType $item
     * @return self
     */
    public function addValue(CrossTenantAccessPolicyTargetConfigurationAccessType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CrossTenantAccessPolicyTargetConfigurationAccessType>
     */
