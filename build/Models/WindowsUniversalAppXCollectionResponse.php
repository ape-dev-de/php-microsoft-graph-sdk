...
/**
 * Collection response for WindowsUniversalAppX
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsUniversalAppXCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsUniversalAppX[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsUniversalAppX[] $items
     * @return self
     */
    public function setValue(array|WindowsUniversalAppX $items, WindowsUniversalAppX ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsUniversalAppX> $value
     * @return self
     ...
     * 
     * @param WindowsUniversalAppX $item
     * @return self
     */
    public function addValue(WindowsUniversalAppX $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsUniversalAppX>
     */
