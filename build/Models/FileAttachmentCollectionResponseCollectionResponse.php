...
/**
 * Collection response for FileAttachmentCollectionResponse
 */
class FileAttachmentCollectionResponseCollectionResponse
{
    /**
     * @var FileAttachmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param FileAttachmentCollectionResponse ...$items Variable number of FileAttachmentCollectionResponse items
     * @return self
     */
    public function setValue(FileAttachmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<FileAttachmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param FileAttachmentCollectionResponse $item
     * @return self
     */
    public function addValue(FileAttachmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
