...
/**
 * Collection response for PlayPromptOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlayPromptOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PlayPromptOperation[]
     */
    private array $value = [];
     ...
     * 
     * @param PlayPromptOperation[] $items
     * @return self
     */
    public function setValue(array|PlayPromptOperation $items, PlayPromptOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PlayPromptOperation> $value
     * @return self
     ...
     * 
     * @param PlayPromptOperation $item
     * @return self
     */
    public function addValue(PlayPromptOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PlayPromptOperation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PlayPromptOperation>
     */
