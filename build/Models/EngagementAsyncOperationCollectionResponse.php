...
/**
 * Collection response for EngagementAsyncOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EngagementAsyncOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param EngagementAsyncOperation[] $items
     * @return self
     */
    public function setValue(array|EngagementAsyncOperation $items, EngagementAsyncOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EngagementAsyncOperation> $value
     * @return self
     ...
     * 
     * @param EngagementAsyncOperation $item
     * @return self
     */
    public function addValue(EngagementAsyncOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EngagementAsyncOperation>
     */
