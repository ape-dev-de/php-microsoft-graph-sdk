...
/**
 * Collection response for UserExperienceAnalyticsMetric
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsMetricCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsMetric[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsMetric $items, UserExperienceAnalyticsMetric ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsMetric> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsMetric $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsMetric $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsMetric>
     */
