...
/**
 * Collection response for SecurityBlobContainerEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityBlobContainerEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityBlobContainerEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityBlobContainerEvidence[]
     */
     ...
     * 
     * @param SecurityBlobContainerEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityBlobContainerEvidence $items, SecurityBlobContainerEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityBlobContainerEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityBlobContainerEvidence $item
     * @return self
     */
    public function addValue(SecurityBlobContainerEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityBlobContainerEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityBlobContainerEvidence>
     */
