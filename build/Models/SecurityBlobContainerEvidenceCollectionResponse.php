 ...
 */
class SecurityBlobContainerEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityBlobContainerEvidence ...$items Variable number of SecurityBlobContainerEvidence items
     * @return self
     */
    public function setValue(SecurityBlobContainerEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
