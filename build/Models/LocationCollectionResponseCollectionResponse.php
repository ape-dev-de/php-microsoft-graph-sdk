...
/**
 * Collection response for LocationCollectionResponse
 */
class LocationCollectionResponseCollectionResponse
{
    /**
     ...
     * 
     * @param LocationCollectionResponse ...$items Variable number of LocationCollectionResponse items
     * @return self
     */
    public function setValue(LocationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<LocationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param LocationCollectionResponse $item
     * @return self
     */
    public function addValue(LocationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
