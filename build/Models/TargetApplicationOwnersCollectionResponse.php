...
/**
 * Collection response for TargetApplicationOwners
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TargetApplicationOwnersCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TargetApplicationOwners[]
     */
    private array $value = [];
     ...
     * 
     * @param TargetApplicationOwners[] $items
     * @return self
     */
    public function setValue(array|TargetApplicationOwners $items, TargetApplicationOwners ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TargetApplicationOwners> $value
     * @return self
     ...
     * 
     * @param TargetApplicationOwners $item
     * @return self
     */
    public function addValue(TargetApplicationOwners $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TargetApplicationOwners|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TargetApplicationOwners>
     */
