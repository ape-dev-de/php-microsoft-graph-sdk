...
/**
 * Collection response for BrowserSiteList
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BrowserSiteListCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BrowserSiteList[]
     */
     ...
     * 
     * @param BrowserSiteList[] $items
     * @return self
     */
    public function setValue(array|BrowserSiteList $items, BrowserSiteList ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BrowserSiteList> $value
     * @return self
     ...
     * 
     * @param BrowserSiteList $item
     * @return self
     */
    public function addValue(BrowserSiteList $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BrowserSiteList>
     */
