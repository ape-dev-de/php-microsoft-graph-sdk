...
/**
 * Collection response for ChatMessageActions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatMessageActionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ChatMessageActions[] $items
     * @return self
     */
    public function setValue(array|ChatMessageActions $items, ChatMessageActions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChatMessageActions> $value
     * @return self
     ...
     * 
     * @param ChatMessageActions $item
     * @return self
     */
    public function addValue(ChatMessageActions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChatMessageActions>
     */
