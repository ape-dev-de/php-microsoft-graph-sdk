...
/**
 * Collection response for ChatMessageMention
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatMessageMentionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ChatMessageMention[] $items
     * @return self
     */
    public function setValue(array|ChatMessageMention $items, ChatMessageMention ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChatMessageMention> $value
     * @return self
     ...
     * 
     * @param ChatMessageMention $item
     * @return self
     */
    public function addValue(ChatMessageMention $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ChatMessageMention|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ChatMessageMention>
     */
