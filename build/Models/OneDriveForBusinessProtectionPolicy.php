...
class OneDriveForBusinessProtectionPolicy
{
    ...
    /**
     */
    private ?string $driveProtectionUnitsBulkAdditionJobs;
    ...
    public function getDriveProtectionUnitsBulkAdditionJobs(): ?string
    {
        return $this->driveProtectionUnitsBulkAdditionJobs;
    }

    public function setDriveProtectionUnitsBulkAdditionJobs(?string $driveProtectionUnitsBulkAdditionJobs): self
    {
