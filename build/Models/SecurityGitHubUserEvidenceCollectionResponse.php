 ...
 */
class SecurityGitHubUserEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityGitHubUserEvidence ...$items Variable number of SecurityGitHubUserEvidence items
     * @return self
     */
    public function setValue(SecurityGitHubUserEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
