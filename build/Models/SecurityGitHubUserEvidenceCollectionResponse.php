...
/**
 * Collection response for SecurityGitHubUserEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityGitHubUserEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityGitHubUserEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityGitHubUserEvidence[]
     */
     ...
     * 
     * @param SecurityGitHubUserEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityGitHubUserEvidence $items, SecurityGitHubUserEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityGitHubUserEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityGitHubUserEvidence $item
     * @return self
     */
    public function addValue(SecurityGitHubUserEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityGitHubUserEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityGitHubUserEvidence>
     */
