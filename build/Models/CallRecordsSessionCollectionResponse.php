...
/**
 * Collection response for CallRecordsSession
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsSessionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CallRecordsSession[] $items
     * @return self
     */
    public function setValue(array|CallRecordsSession $items, CallRecordsSession ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsSession> $value
     * @return self
     ...
     * 
     * @param CallRecordsSession $item
     * @return self
     */
    public function addValue(CallRecordsSession $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsSession>
     */
