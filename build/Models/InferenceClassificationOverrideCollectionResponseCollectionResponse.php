...
/**
 * Collection response for InferenceClassificationOverrideCollectionResponse
 */
class InferenceClassificationOverrideCollectionResponseCollectionResponse
{
    /**
     * @var InferenceClassificationOverrideCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param InferenceClassificationOverrideCollectionResponse ...$items Variable number of InferenceClassificationOverrideCollectionResponse items
     * @return self
     */
    public function setValue(InferenceClassificationOverrideCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<InferenceClassificationOverrideCollectionResponse> $value
     * @return self
     ...
     * 
     * @param InferenceClassificationOverrideCollectionResponse $item
     * @return self
     */
    public function addValue(InferenceClassificationOverrideCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
