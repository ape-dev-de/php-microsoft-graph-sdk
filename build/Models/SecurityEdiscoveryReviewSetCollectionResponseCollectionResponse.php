...
/**
 * Collection response for SecurityEdiscoveryReviewSetCollectionResponse
 */
class SecurityEdiscoveryReviewSetCollectionResponseCollectionResponse
{
    /**
     * @var SecurityEdiscoveryReviewSetCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityEdiscoveryReviewSetCollectionResponse ...$items Variable number of SecurityEdiscoveryReviewSetCollectionResponse items
     * @return self
     */
    public function setValue(SecurityEdiscoveryReviewSetCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityEdiscoveryReviewSetCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityEdiscoveryReviewSetCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityEdiscoveryReviewSetCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
