 ...
 */
class UserTrainingContentEventInfoCollectionResponse
{
    /**
     ...
     * 
     * @param UserTrainingContentEventInfo ...$items Variable number of UserTrainingContentEventInfo items
     * @return self
     */
    public function setValue(UserTrainingContentEventInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
