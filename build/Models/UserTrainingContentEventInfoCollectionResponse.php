...
/**
 * Collection response for UserTrainingContentEventInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserTrainingContentEventInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserTrainingContentEventInfo[]
     */
    private array $value = [];
     ...
     * 
     * @param UserTrainingContentEventInfo[] $items
     * @return self
     */
    public function setValue(array|UserTrainingContentEventInfo $items, UserTrainingContentEventInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserTrainingContentEventInfo> $value
     * @return self
     ...
     * 
     * @param UserTrainingContentEventInfo $item
     * @return self
     */
    public function addValue(UserTrainingContentEventInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserTrainingContentEventInfo>
     */
