...
/**
 * Collection response for WorkbookChartFill
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookChartFillCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookChartFill[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookChartFill[] $items
     * @return self
     */
    public function setValue(array|WorkbookChartFill $items, WorkbookChartFill ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookChartFill> $value
     * @return self
     ...
     * 
     * @param WorkbookChartFill $item
     * @return self
     */
    public function addValue(WorkbookChartFill $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookChartFill>
     */
