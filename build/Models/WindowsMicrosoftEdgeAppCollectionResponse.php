...
/**
 * Collection response for WindowsMicrosoftEdgeApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsMicrosoftEdgeAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsMicrosoftEdgeApp[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsMicrosoftEdgeApp[] $items
     * @return self
     */
    public function setValue(array|WindowsMicrosoftEdgeApp $items, WindowsMicrosoftEdgeApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsMicrosoftEdgeApp> $value
     * @return self
     ...
     * 
     * @param WindowsMicrosoftEdgeApp $item
     * @return self
     */
    public function addValue(WindowsMicrosoftEdgeApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WindowsMicrosoftEdgeApp|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WindowsMicrosoftEdgeApp>
     */
