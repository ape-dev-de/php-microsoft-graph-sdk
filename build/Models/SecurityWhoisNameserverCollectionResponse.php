...
/**
 * Collection response for SecurityWhoisNameserver
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityWhoisNameserverCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return SecurityWhoisNameserver[]
     */
     ...
     * 
     * @param SecurityWhoisNameserver[] $items
     * @return self
     */
    public function setValue(array|SecurityWhoisNameserver $items, SecurityWhoisNameserver ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityWhoisNameserver> $value
     * @return self
     ...
     * 
     * @param SecurityWhoisNameserver $item
     * @return self
     */
    public function addValue(SecurityWhoisNameserver $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityWhoisNameserver|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityWhoisNameserver>
     */
