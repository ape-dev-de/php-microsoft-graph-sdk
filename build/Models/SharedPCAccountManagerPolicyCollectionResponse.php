 ...
 */
class SharedPCAccountManagerPolicyCollectionResponse
{
    /**
     ...
     * 
     * @param SharedPCAccountManagerPolicy ...$items Variable number of SharedPCAccountManagerPolicy items
     * @return self
     */
    public function setValue(SharedPCAccountManagerPolicy ...$items): self
    {
        $this->value = $items;
        return $this;
    }
