...
/**
 * Collection response for SharedPCAccountManagerPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SharedPCAccountManagerPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SharedPCAccountManagerPolicy[] $items
     * @return self
     */
    public function setValue(array|SharedPCAccountManagerPolicy $items, SharedPCAccountManagerPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SharedPCAccountManagerPolicy> $value
     * @return self
     ...
     * 
     * @param SharedPCAccountManagerPolicy $item
     * @return self
     */
    public function addValue(SharedPCAccountManagerPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SharedPCAccountManagerPolicy>
     */
