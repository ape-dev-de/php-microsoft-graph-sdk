...
/**
 * Collection response for TermsAndConditionsAcceptanceStatusCollectionResponse
 */
class TermsAndConditionsAcceptanceStatusCollectionResponseCollectionResponse
{
    /**
     * @var TermsAndConditionsAcceptanceStatusCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TermsAndConditionsAcceptanceStatusCollectionResponse ...$items Variable number of TermsAndConditionsAcceptanceStatusCollectionResponse items
     * @return self
     */
    public function setValue(TermsAndConditionsAcceptanceStatusCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TermsAndConditionsAcceptanceStatusCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TermsAndConditionsAcceptanceStatusCollectionResponse $item
     * @return self
     */
    public function addValue(TermsAndConditionsAcceptanceStatusCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
