...
/**
 * Collection response for IosNetworkUsageRule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosNetworkUsageRuleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IosNetworkUsageRule[] $items
     * @return self
     */
    public function setValue(array|IosNetworkUsageRule $items, IosNetworkUsageRule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosNetworkUsageRule> $value
     * @return self
     ...
     * 
     * @param IosNetworkUsageRule $item
     * @return self
     */
    public function addValue(IosNetworkUsageRule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IosNetworkUsageRule|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IosNetworkUsageRule>
     */
