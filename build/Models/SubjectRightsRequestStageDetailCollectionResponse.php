...
/**
 * Collection response for SubjectRightsRequestStageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SubjectRightsRequestStageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SubjectRightsRequestStageDetail[] $items
     * @return self
     */
    public function setValue(array|SubjectRightsRequestStageDetail $items, SubjectRightsRequestStageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SubjectRightsRequestStageDetail> $value
     * @return self
     ...
     * 
     * @param SubjectRightsRequestStageDetail $item
     * @return self
     */
    public function addValue(SubjectRightsRequestStageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SubjectRightsRequestStageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SubjectRightsRequestStageDetail>
     */
