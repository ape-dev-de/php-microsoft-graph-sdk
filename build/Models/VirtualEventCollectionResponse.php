...
/**
 * Collection response for VirtualEvent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualEventCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VirtualEvent[]
     */
     ...
     * 
     * @param VirtualEvent[] $items
     * @return self
     */
    public function setValue(array|VirtualEvent $items, VirtualEvent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualEvent> $value
     * @return self
     ...
     * 
     * @param VirtualEvent $item
     * @return self
     */
    public function addValue(VirtualEvent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VirtualEvent>
     */
