 ...
 */
class SecurityGeoLocationCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityGeoLocation ...$items Variable number of SecurityGeoLocation items
     * @return self
     */
    public function setValue(SecurityGeoLocation ...$items): self
    {
        $this->value = $items;
        return $this;
    }
