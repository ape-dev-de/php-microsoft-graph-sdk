...
/**
 * Collection response for SecurityGeoLocation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityGeoLocationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityGeoLocation[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityGeoLocation[] $items
     * @return self
     */
    public function setValue(array|SecurityGeoLocation $items, SecurityGeoLocation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityGeoLocation> $value
     * @return self
     ...
     * 
     * @param SecurityGeoLocation $item
     * @return self
     */
    public function addValue(SecurityGeoLocation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityGeoLocation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityGeoLocation>
     */
