...
/**
 * Collection response for MacOSCustomConfigurationCollectionResponse
 */
class MacOSCustomConfigurationCollectionResponseCollectionResponse
{
    /**
     * @var MacOSCustomConfigurationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MacOSCustomConfigurationCollectionResponse ...$items Variable number of MacOSCustomConfigurationCollectionResponse items
     * @return self
     */
    public function setValue(MacOSCustomConfigurationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MacOSCustomConfigurationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MacOSCustomConfigurationCollectionResponse $item
     * @return self
     */
    public function addValue(MacOSCustomConfigurationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
