 ...
 */
class TeamMessagingSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param TeamMessagingSettings ...$items Variable number of TeamMessagingSettings items
     * @return self
     */
    public function setValue(TeamMessagingSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
