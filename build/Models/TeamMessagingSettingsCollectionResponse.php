...
/**
 * Collection response for TeamMessagingSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamMessagingSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TeamMessagingSettings[] $items
     * @return self
     */
    public function setValue(array|TeamMessagingSettings $items, TeamMessagingSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamMessagingSettings> $value
     * @return self
     ...
     * 
     * @param TeamMessagingSettings $item
     * @return self
     */
    public function addValue(TeamMessagingSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamMessagingSettings>
     */
