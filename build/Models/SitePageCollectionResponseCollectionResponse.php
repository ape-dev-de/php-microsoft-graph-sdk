...
/**
 * Collection response for SitePageCollectionResponse
 */
class SitePageCollectionResponseCollectionResponse
{
    /**
     * @var SitePageCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SitePageCollectionResponse ...$items Variable number of SitePageCollectionResponse items
     * @return self
     */
    public function setValue(SitePageCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SitePageCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SitePageCollectionResponse $item
     * @return self
     */
    public function addValue(SitePageCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
