...
/**
 * Collection response for SafeSearchFilterType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SafeSearchFilterTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SafeSearchFilterType[]
     */
    private array $value = [];
     ...
     * 
     * @param SafeSearchFilterType[] $items
     * @return self
     */
    public function setValue(array|SafeSearchFilterType $items, SafeSearchFilterType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SafeSearchFilterType> $value
     * @return self
     ...
     * 
     * @param SafeSearchFilterType $item
     * @return self
     */
    public function addValue(SafeSearchFilterType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SafeSearchFilterType>
     */
