...
/**
 * WorkforceIntegrationEncryptionProtocolCollectionResponse - Collection response
 */
class WorkforceIntegrationEncryptionProtocolCollectionResponse
{
    /**
     * @var array<int, WorkforceIntegrationEncryptionProtocol>
     */
    public array $value = [];
