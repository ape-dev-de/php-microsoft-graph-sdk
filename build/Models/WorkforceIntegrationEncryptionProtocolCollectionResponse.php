...
/**
 * Collection response for WorkforceIntegrationEncryptionProtocol
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkforceIntegrationEncryptionProtocolCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkforceIntegrationEncryptionProtocol[]
     */
    private array $value = [];
     ...
     * 
     * @return WorkforceIntegrationEncryptionProtocol[]
     */
     ...
     * 
     * @param WorkforceIntegrationEncryptionProtocol[] $items
     * @return self
     */
    public function setValue(array|WorkforceIntegrationEncryptionProtocol $items, WorkforceIntegrationEncryptionProtocol ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkforceIntegrationEncryptionProtocol> $value
     * @return self
     ...
     * 
     * @param WorkforceIntegrationEncryptionProtocol $item
     * @return self
     */
    public function addValue(WorkforceIntegrationEncryptionProtocol $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkforceIntegrationEncryptionProtocol>
     */
