...
/**
 * Collection response for SynchronizationJobSubjectCollectionResponse
 */
class SynchronizationJobSubjectCollectionResponseCollectionResponse
{
    /**
     * @var SynchronizationJobSubjectCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SynchronizationJobSubjectCollectionResponse ...$items Variable number of SynchronizationJobSubjectCollectionResponse items
     * @return self
     */
    public function setValue(SynchronizationJobSubjectCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SynchronizationJobSubjectCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SynchronizationJobSubjectCollectionResponse $item
     * @return self
     */
    public function addValue(SynchronizationJobSubjectCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
