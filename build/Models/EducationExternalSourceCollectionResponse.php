...
/**
 * Collection response for EducationExternalSource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationExternalSourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationExternalSource[]
     */
    private array $value = [];
     ...
     * 
     * @return EducationExternalSource[]
     */
     ...
     * 
     * @param EducationExternalSource[] $items
     * @return self
     */
    public function setValue(array|EducationExternalSource $items, EducationExternalSource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationExternalSource> $value
     * @return self
     ...
     * 
     * @param EducationExternalSource $item
     * @return self
     */
    public function addValue(EducationExternalSource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationExternalSource>
     */
