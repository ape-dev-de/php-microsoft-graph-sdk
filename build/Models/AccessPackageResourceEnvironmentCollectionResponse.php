...
/**
 * Collection response for AccessPackageResourceEnvironment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageResourceEnvironmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessPackageResourceEnvironment[] $items
     * @return self
     */
    public function setValue(array|AccessPackageResourceEnvironment $items, AccessPackageResourceEnvironment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageResourceEnvironment> $value
     * @return self
     ...
     * 
     * @param AccessPackageResourceEnvironment $item
     * @return self
     */
    public function addValue(AccessPackageResourceEnvironment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageResourceEnvironment>
     */
