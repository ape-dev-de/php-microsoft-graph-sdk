...
/**
 * Collection response for EducationMediaResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationMediaResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationMediaResource[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationMediaResource[] $items
     * @return self
     */
    public function setValue(array|EducationMediaResource $items, EducationMediaResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationMediaResource> $value
     * @return self
     ...
     * 
     * @param EducationMediaResource $item
     * @return self
     */
    public function addValue(EducationMediaResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EducationMediaResource|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EducationMediaResource>
     */
