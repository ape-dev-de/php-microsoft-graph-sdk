 ...
 */
class EducationMediaResourceCollectionResponse
{
    /**
     ...
     * 
     * @param EducationMediaResource ...$items Variable number of EducationMediaResource items
     * @return self
     */
    public function setValue(EducationMediaResource ...$items): self
    {
        $this->value = $items;
        return $this;
    }
