...
/**
 * Collection response for ConditionalAccessTemplateCollectionResponse
 */
class ConditionalAccessTemplateCollectionResponseCollectionResponse
{
    /**
     * @var ConditionalAccessTemplateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ConditionalAccessTemplateCollectionResponse ...$items Variable number of ConditionalAccessTemplateCollectionResponse items
     * @return self
     */
    public function setValue(ConditionalAccessTemplateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ConditionalAccessTemplateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessTemplateCollectionResponse $item
     * @return self
     */
    public function addValue(ConditionalAccessTemplateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
