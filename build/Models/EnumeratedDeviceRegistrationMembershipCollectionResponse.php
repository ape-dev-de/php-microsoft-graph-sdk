...
/**
 * Collection response for EnumeratedDeviceRegistrationMembership
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EnumeratedDeviceRegistrationMembershipCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EnumeratedDeviceRegistrationMembership[]
     */
    private array $value = [];
     ...
     * 
     * @param EnumeratedDeviceRegistrationMembership[] $items
     * @return self
     */
    public function setValue(array|EnumeratedDeviceRegistrationMembership $items, EnumeratedDeviceRegistrationMembership ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EnumeratedDeviceRegistrationMembership> $value
     * @return self
     ...
     * 
     * @param EnumeratedDeviceRegistrationMembership $item
     * @return self
     */
    public function addValue(EnumeratedDeviceRegistrationMembership $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EnumeratedDeviceRegistrationMembership|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EnumeratedDeviceRegistrationMembership>
     */
