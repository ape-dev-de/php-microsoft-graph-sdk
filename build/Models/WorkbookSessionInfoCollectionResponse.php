 ...
 */
class WorkbookSessionInfoCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookSessionInfo ...$items Variable number of WorkbookSessionInfo items
     * @return self
     */
    public function setValue(WorkbookSessionInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
