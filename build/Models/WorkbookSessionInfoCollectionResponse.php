...
/**
 * Collection response for WorkbookSessionInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookSessionInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookSessionInfo[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookSessionInfo[] $items
     * @return self
     */
    public function setValue(array|WorkbookSessionInfo $items, WorkbookSessionInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookSessionInfo> $value
     * @return self
     ...
     * 
     * @param WorkbookSessionInfo $item
     * @return self
     */
    public function addValue(WorkbookSessionInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WorkbookSessionInfo|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WorkbookSessionInfo>
     */
