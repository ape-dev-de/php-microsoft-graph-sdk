 ...
 */
class PlannerAssignedToTaskBoardTaskFormatCollectionResponse
{
    /**
     ...
     * 
     * @param PlannerAssignedToTaskBoardTaskFormat ...$items Variable number of PlannerAssignedToTaskBoardTaskFormat items
     * @return self
     */
    public function setValue(PlannerAssignedToTaskBoardTaskFormat ...$items): self
    {
        $this->value = $items;
        return $this;
    }
