...
/**
 * Collection response for PlannerAssignedToTaskBoardTaskFormat
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerAssignedToTaskBoardTaskFormatCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PlannerAssignedToTaskBoardTaskFormat[]
     */
    private array $value = [];
     ...
     * 
     * @param PlannerAssignedToTaskBoardTaskFormat[] $items
     * @return self
     */
    public function setValue(array|PlannerAssignedToTaskBoardTaskFormat $items, PlannerAssignedToTaskBoardTaskFormat ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PlannerAssignedToTaskBoardTaskFormat> $value
     * @return self
     ...
     * 
     * @param PlannerAssignedToTaskBoardTaskFormat $item
     * @return self
     */
    public function addValue(PlannerAssignedToTaskBoardTaskFormat $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PlannerAssignedToTaskBoardTaskFormat>
     */
