...
/**
 * Collection response for InternalDomainFederationCollectionResponse
 */
class InternalDomainFederationCollectionResponseCollectionResponse
{
    /**
     * @var InternalDomainFederationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param InternalDomainFederationCollectionResponse ...$items Variable number of InternalDomainFederationCollectionResponse items
     * @return self
     */
    public function setValue(InternalDomainFederationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<InternalDomainFederationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param InternalDomainFederationCollectionResponse $item
     * @return self
     */
    public function addValue(InternalDomainFederationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
