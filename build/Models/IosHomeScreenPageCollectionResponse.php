...
/**
 * Collection response for IosHomeScreenPage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosHomeScreenPageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IosHomeScreenPage[] $items
     * @return self
     */
    public function setValue(array|IosHomeScreenPage $items, IosHomeScreenPage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosHomeScreenPage> $value
     * @return self
     ...
     * 
     * @param IosHomeScreenPage $item
     * @return self
     */
    public function addValue(IosHomeScreenPage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IosHomeScreenPage>
     */
