 ...
 */
class AuthenticationStrengthUsageCollectionResponse
{
    /**
     ...
     * 
     * @param AuthenticationStrengthUsage ...$items Variable number of AuthenticationStrengthUsage items
     * @return self
     */
    public function setValue(AuthenticationStrengthUsage ...$items): self
    {
        $this->value = $items;
        return $this;
    }
