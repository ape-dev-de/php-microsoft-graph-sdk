...
/**
 * Collection response for AuthenticationStrengthUsage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationStrengthUsageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuthenticationStrengthUsage[]
     */
    private array $value = [];
     ...
     * 
     * @param AuthenticationStrengthUsage[] $items
     * @return self
     */
    public function setValue(array|AuthenticationStrengthUsage $items, AuthenticationStrengthUsage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationStrengthUsage> $value
     * @return self
     ...
     * 
     * @param AuthenticationStrengthUsage $item
     * @return self
     */
    public function addValue(AuthenticationStrengthUsage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AuthenticationStrengthUsage|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationStrengthUsage>
     */
