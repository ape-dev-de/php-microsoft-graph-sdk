...
/**
 * Collection response for EducationModuleCollectionResponse
 */
class EducationModuleCollectionResponseCollectionResponse
{
    /**
     * @var EducationModuleCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationModuleCollectionResponse ...$items Variable number of EducationModuleCollectionResponse items
     * @return self
     */
    public function setValue(EducationModuleCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EducationModuleCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EducationModuleCollectionResponse $item
     * @return self
     */
    public function addValue(EducationModuleCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
