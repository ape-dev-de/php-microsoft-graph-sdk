...
/**
 * Collection response for ServiceApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServiceAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ServiceApp[]
     */
     ...
     * 
     * @param ServiceApp[] $items
     * @return self
     */
    public function setValue(array|ServiceApp $items, ServiceApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param ServiceApp $item
     * @return self
     */
    public function addValue(ServiceApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ServiceApp>
     */
