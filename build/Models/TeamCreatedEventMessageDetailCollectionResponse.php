...
/**
 * Collection response for TeamCreatedEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamCreatedEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamCreatedEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamCreatedEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|TeamCreatedEventMessageDetail $items, TeamCreatedEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamCreatedEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param TeamCreatedEventMessageDetail $item
     * @return self
     */
    public function addValue(TeamCreatedEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TeamCreatedEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TeamCreatedEventMessageDetail>
     */
