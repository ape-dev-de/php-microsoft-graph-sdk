 ...
 */
class TeamCreatedEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param TeamCreatedEventMessageDetail ...$items Variable number of TeamCreatedEventMessageDetail items
     * @return self
     */
    public function setValue(TeamCreatedEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
