...
/**
 * Collection response for SecurityAlertSeverity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityAlertSeverityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityAlertSeverity[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityAlertSeverity[] $items
     * @return self
     */
    public function setValue(array|SecurityAlertSeverity $items, SecurityAlertSeverity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityAlertSeverity> $value
     * @return self
     ...
     * 
     * @param SecurityAlertSeverity $item
     * @return self
     */
    public function addValue(SecurityAlertSeverity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityAlertSeverity>
     */
