...
/**
 * Collection response for EducationRubricOutcome
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationRubricOutcomeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationRubricOutcome[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationRubricOutcome[] $items
     * @return self
     */
    public function setValue(array|EducationRubricOutcome $items, EducationRubricOutcome ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationRubricOutcome> $value
     * @return self
     ...
     * 
     * @param EducationRubricOutcome $item
     * @return self
     */
    public function addValue(EducationRubricOutcome $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EducationRubricOutcome|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EducationRubricOutcome>
     */
