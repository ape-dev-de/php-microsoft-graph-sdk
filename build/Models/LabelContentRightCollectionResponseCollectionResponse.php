...
/**
 * Collection response for LabelContentRightCollectionResponse
 */
class LabelContentRightCollectionResponseCollectionResponse
{
    /**
     * @var LabelContentRightCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return LabelContentRightCollectionResponse[]
     */
     ...
     * 
     * @param LabelContentRightCollectionResponse ...$items Variable number of LabelContentRightCollectionResponse items
     * @return self
     */
    public function setValue(LabelContentRightCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<LabelContentRightCollectionResponse> $value
     * @return self
     ...
     * 
     * @param LabelContentRightCollectionResponse $item
     * @return self
     */
    public function addValue(LabelContentRightCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
