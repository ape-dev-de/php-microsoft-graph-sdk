...
/**
 * Collection response for Win32LobAppFileSystemRule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Win32LobAppFileSystemRuleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Win32LobAppFileSystemRule[]
     */
    private array $value = [];
     ...
     * 
     * @param Win32LobAppFileSystemRule[] $items
     * @return self
     */
    public function setValue(array|Win32LobAppFileSystemRule $items, Win32LobAppFileSystemRule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Win32LobAppFileSystemRule> $value
     * @return self
     ...
     * 
     * @param Win32LobAppFileSystemRule $item
     * @return self
     */
    public function addValue(Win32LobAppFileSystemRule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return Win32LobAppFileSystemRule|null
     */
     ...
     * 
     * @return \ArrayIterator<int, Win32LobAppFileSystemRule>
     */
