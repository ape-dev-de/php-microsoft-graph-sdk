 ...
 */
class Win32LobAppFileSystemRuleCollectionResponse
{
    /**
     ...
     * 
     * @param Win32LobAppFileSystemRule ...$items Variable number of Win32LobAppFileSystemRule items
     * @return self
     */
    public function setValue(Win32LobAppFileSystemRule ...$items): self
    {
        $this->value = $items;
        return $this;
    }
