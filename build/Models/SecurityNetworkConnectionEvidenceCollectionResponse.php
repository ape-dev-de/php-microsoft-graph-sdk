...
/**
 * Collection response for SecurityNetworkConnectionEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityNetworkConnectionEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityNetworkConnectionEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityNetworkConnectionEvidence[]
     */
     ...
     * 
     * @param SecurityNetworkConnectionEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityNetworkConnectionEvidence $items, SecurityNetworkConnectionEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityNetworkConnectionEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityNetworkConnectionEvidence $item
     * @return self
     */
    public function addValue(SecurityNetworkConnectionEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityNetworkConnectionEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityNetworkConnectionEvidence>
     */
