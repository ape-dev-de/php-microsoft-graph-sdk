 ...
 */
class SecurityNetworkConnectionEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityNetworkConnectionEvidence ...$items Variable number of SecurityNetworkConnectionEvidence items
     * @return self
     */
    public function setValue(SecurityNetworkConnectionEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
