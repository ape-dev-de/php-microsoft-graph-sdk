...
/**
 * DeviceManagementExportJobLocalizationTypeCollectionResponse - Collection response
 */
class DeviceManagementExportJobLocalizationTypeCollectionResponse
{
    /**
     * @var array<int, DeviceManagementExportJobLocalizationType>
     */
    public array $value = [];
