...
/**
 * Collection response for DeviceManagementExportJobLocalizationType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceManagementExportJobLocalizationTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceManagementExportJobLocalizationType[]
     */
    private array $value = [];
     ...
     * 
     * @return DeviceManagementExportJobLocalizationType[]
     */
     ...
     * 
     * @param DeviceManagementExportJobLocalizationType[] $items
     * @return self
     */
    public function setValue(array|DeviceManagementExportJobLocalizationType $items, DeviceManagementExportJobLocalizationType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceManagementExportJobLocalizationType> $value
     * @return self
     ...
     * 
     * @param DeviceManagementExportJobLocalizationType $item
     * @return self
     */
    public function addValue(DeviceManagementExportJobLocalizationType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceManagementExportJobLocalizationType>
     */
