...
/**
 * Collection response for DeviceCollectionResponse
 */
class DeviceCollectionResponseCollectionResponse
{
    /**
     * @var DeviceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceCollectionResponse ...$items Variable number of DeviceCollectionResponse items
     * @return self
     */
    public function setValue(DeviceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeviceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeviceCollectionResponse $item
     * @return self
     */
    public function addValue(DeviceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
