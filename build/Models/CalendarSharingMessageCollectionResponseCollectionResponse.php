...
/**
 * Collection response for CalendarSharingMessageCollectionResponse
 */
class CalendarSharingMessageCollectionResponseCollectionResponse
{
    /**
     * @var CalendarSharingMessageCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CalendarSharingMessageCollectionResponse ...$items Variable number of CalendarSharingMessageCollectionResponse items
     * @return self
     */
    public function setValue(CalendarSharingMessageCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CalendarSharingMessageCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CalendarSharingMessageCollectionResponse $item
     * @return self
     */
    public function addValue(CalendarSharingMessageCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
