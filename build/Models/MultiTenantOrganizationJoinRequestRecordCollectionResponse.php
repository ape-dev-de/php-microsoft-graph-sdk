...
/**
 * Collection response for MultiTenantOrganizationJoinRequestRecord
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MultiTenantOrganizationJoinRequestRecordCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MultiTenantOrganizationJoinRequestRecord[]
     */
    private array $value = [];
     ...
     * 
     * @param MultiTenantOrganizationJoinRequestRecord[] $items
     * @return self
     */
    public function setValue(array|MultiTenantOrganizationJoinRequestRecord $items, MultiTenantOrganizationJoinRequestRecord ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MultiTenantOrganizationJoinRequestRecord> $value
     * @return self
     ...
     * 
     * @param MultiTenantOrganizationJoinRequestRecord $item
     * @return self
     */
    public function addValue(MultiTenantOrganizationJoinRequestRecord $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MultiTenantOrganizationJoinRequestRecord>
     */
