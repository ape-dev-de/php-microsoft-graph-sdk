 ...
 */
class MultiTenantOrganizationJoinRequestRecordCollectionResponse
{
    /**
     ...
     * 
     * @param MultiTenantOrganizationJoinRequestRecord ...$items Variable number of MultiTenantOrganizationJoinRequestRecord items
     * @return self
     */
    public function setValue(MultiTenantOrganizationJoinRequestRecord ...$items): self
    {
        $this->value = $items;
        return $this;
    }
