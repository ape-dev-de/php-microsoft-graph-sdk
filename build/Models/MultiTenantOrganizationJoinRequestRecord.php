...
class MultiTenantOrganizationJoinRequestRecord
{
    public function __construct(
        ...
        public ?MultiTenantOrganizationMemberState $memberState = null,
        ...
        public ?MultiTenantOrganizationMemberRole $role = null,
        /** Details of the processing status for a tenant joining a multitenant organization. Read-only. */
        public ?MultiTenantOrganizationJoinRequestTransitionDetails $transitionDetails = null
    ) {}
}
