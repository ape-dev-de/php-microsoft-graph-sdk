...
/**
 * Collection response for VppTokenSyncStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VppTokenSyncStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VppTokenSyncStatus[]
     */
    private array $value = [];
     ...
     * 
     * @param VppTokenSyncStatus[] $items
     * @return self
     */
    public function setValue(array|VppTokenSyncStatus $items, VppTokenSyncStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VppTokenSyncStatus> $value
     * @return self
     ...
     * 
     * @param VppTokenSyncStatus $item
     * @return self
     */
    public function addValue(VppTokenSyncStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VppTokenSyncStatus>
     */
