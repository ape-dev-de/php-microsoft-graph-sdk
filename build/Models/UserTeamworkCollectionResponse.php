...
/**
 * Collection response for UserTeamwork
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserTeamworkCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserTeamwork[]
     */
     ...
     * 
     * @param UserTeamwork[] $items
     * @return self
     */
    public function setValue(array|UserTeamwork $items, UserTeamwork ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserTeamwork> $value
     * @return self
     ...
     * 
     * @param UserTeamwork $item
     * @return self
     */
    public function addValue(UserTeamwork $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserTeamwork>
     */
