...
/**
 * Collection response for TemplateApplicationLevel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TemplateApplicationLevelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TemplateApplicationLevel[]
     */
    private array $value = [];
     ...
     * 
     * @return TemplateApplicationLevel[]
     */
     ...
     * 
     * @param TemplateApplicationLevel[] $items
     * @return self
     */
    public function setValue(array|TemplateApplicationLevel $items, TemplateApplicationLevel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TemplateApplicationLevel> $value
     * @return self
     ...
     * 
     * @param TemplateApplicationLevel $item
     * @return self
     */
    public function addValue(TemplateApplicationLevel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TemplateApplicationLevel>
     */
