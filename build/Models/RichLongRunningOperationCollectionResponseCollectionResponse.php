...
/**
 * Collection response for RichLongRunningOperationCollectionResponse
 */
class RichLongRunningOperationCollectionResponseCollectionResponse
{
    /**
     * @var RichLongRunningOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RichLongRunningOperationCollectionResponse ...$items Variable number of RichLongRunningOperationCollectionResponse items
     * @return self
     */
    public function setValue(RichLongRunningOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RichLongRunningOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RichLongRunningOperationCollectionResponse $item
     * @return self
     */
    public function addValue(RichLongRunningOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
