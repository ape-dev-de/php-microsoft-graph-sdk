...
/**
 * Collection response for UserExperienceAnalyticsInsightValue
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsInsightValueCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsInsightValue[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsInsightValue $items, UserExperienceAnalyticsInsightValue ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsInsightValue> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsInsightValue $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsInsightValue $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UserExperienceAnalyticsInsightValue|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsInsightValue>
     */
