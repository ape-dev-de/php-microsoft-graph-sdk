...
/**
 * Collection response for SecurityHuntingRowResultCollectionResponse
 */
class SecurityHuntingRowResultCollectionResponseCollectionResponse
{
    /**
     * @var SecurityHuntingRowResultCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityHuntingRowResultCollectionResponse[]
     */
     ...
     * 
     * @param SecurityHuntingRowResultCollectionResponse ...$items Variable number of SecurityHuntingRowResultCollectionResponse items
     * @return self
     */
    public function setValue(SecurityHuntingRowResultCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityHuntingRowResultCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityHuntingRowResultCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityHuntingRowResultCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
