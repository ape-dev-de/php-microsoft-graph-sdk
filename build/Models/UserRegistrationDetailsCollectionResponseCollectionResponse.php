...
/**
 * Collection response for UserRegistrationDetailsCollectionResponse
 */
class UserRegistrationDetailsCollectionResponseCollectionResponse
{
    /**
     * @var UserRegistrationDetailsCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UserRegistrationDetailsCollectionResponse ...$items Variable number of UserRegistrationDetailsCollectionResponse items
     * @return self
     */
    public function setValue(UserRegistrationDetailsCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UserRegistrationDetailsCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UserRegistrationDetailsCollectionResponse $item
     * @return self
     */
    public function addValue(UserRegistrationDetailsCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
