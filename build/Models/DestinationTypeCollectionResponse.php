...
/**
 * Collection response for DestinationType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DestinationTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DestinationType[]
     */
     ...
     * 
     * @param DestinationType[] $items
     * @return self
     */
    public function setValue(array|DestinationType $items, DestinationType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DestinationType> $value
     * @return self
     ...
     * 
     * @param DestinationType $item
     * @return self
     */
    public function addValue(DestinationType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DestinationType>
     */
