...
/**
 * Collection response for PostType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PostTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PostType[]
     */
     ...
     * 
     * @param PostType[] $items
     * @return self
     */
    public function setValue(array|PostType $items, PostType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(PostType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PostType>
     */
