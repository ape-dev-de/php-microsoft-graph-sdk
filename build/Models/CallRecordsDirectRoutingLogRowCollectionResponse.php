 ...
 */
class CallRecordsDirectRoutingLogRowCollectionResponse
{
    /**
     ...
     * 
     * @param CallRecordsDirectRoutingLogRow ...$items Variable number of CallRecordsDirectRoutingLogRow items
     * @return self
     */
    public function setValue(CallRecordsDirectRoutingLogRow ...$items): self
    {
        $this->value = $items;
        return $this;
    }
