...
/**
 * Collection response for CallRecordsDirectRoutingLogRow
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsDirectRoutingLogRowCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsDirectRoutingLogRow[]
     */
    private array $value = [];
     ...
     * 
     * @return CallRecordsDirectRoutingLogRow[]
     */
     ...
     * 
     * @param CallRecordsDirectRoutingLogRow[] $items
     * @return self
     */
    public function setValue(array|CallRecordsDirectRoutingLogRow $items, CallRecordsDirectRoutingLogRow ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsDirectRoutingLogRow> $value
     * @return self
     ...
     * 
     * @param CallRecordsDirectRoutingLogRow $item
     * @return self
     */
    public function addValue(CallRecordsDirectRoutingLogRow $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsDirectRoutingLogRow|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsDirectRoutingLogRow>
     */
