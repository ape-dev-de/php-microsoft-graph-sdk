...
/**
 * Collection response for BookingsAvailabilityWindow
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingsAvailabilityWindowCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param BookingsAvailabilityWindow[] $items
     * @return self
     */
    public function setValue(array|BookingsAvailabilityWindow $items, BookingsAvailabilityWindow ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingsAvailabilityWindow> $value
     * @return self
     ...
     * 
     * @param BookingsAvailabilityWindow $item
     * @return self
     */
    public function addValue(BookingsAvailabilityWindow $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return BookingsAvailabilityWindow|null
     */
     ...
     * 
     * @return \ArrayIterator<int, BookingsAvailabilityWindow>
     */
