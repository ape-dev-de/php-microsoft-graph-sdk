...
/**
 * TemporaryAccessPassAuthenticationMethodConfigurationCollectionResponse - Collection response
 */
class TemporaryAccessPassAuthenticationMethodConfigurationCollectionResponse
{
    /**
     * @var array<int, TemporaryAccessPassAuthenticationMethodConfiguration>
     */
    public array $value = [];
