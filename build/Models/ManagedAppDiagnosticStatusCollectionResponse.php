 ...
 */
class ManagedAppDiagnosticStatusCollectionResponse
{
    /**
     ...
     * 
     * @param ManagedAppDiagnosticStatus ...$items Variable number of ManagedAppDiagnosticStatus items
     * @return self
     */
    public function setValue(ManagedAppDiagnosticStatus ...$items): self
    {
        $this->value = $items;
        return $this;
    }
