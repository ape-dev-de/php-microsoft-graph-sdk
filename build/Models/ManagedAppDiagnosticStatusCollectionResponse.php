...
/**
 * Collection response for ManagedAppDiagnosticStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedAppDiagnosticStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ManagedAppDiagnosticStatus[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedAppDiagnosticStatus[] $items
     * @return self
     */
    public function setValue(array|ManagedAppDiagnosticStatus $items, ManagedAppDiagnosticStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedAppDiagnosticStatus> $value
     * @return self
     ...
     * 
     * @param ManagedAppDiagnosticStatus $item
     * @return self
     */
    public function addValue(ManagedAppDiagnosticStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ManagedAppDiagnosticStatus|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ManagedAppDiagnosticStatus>
     */
