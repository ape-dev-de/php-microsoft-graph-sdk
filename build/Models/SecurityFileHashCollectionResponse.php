...
/**
 * Collection response for SecurityFileHash
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityFileHashCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityFileHash[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityFileHash[] $items
     * @return self
     */
    public function setValue(array|SecurityFileHash $items, SecurityFileHash ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityFileHash> $value
     * @return self
     ...
     * 
     * @param SecurityFileHash $item
     * @return self
     */
    public function addValue(SecurityFileHash $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityFileHash>
     */
