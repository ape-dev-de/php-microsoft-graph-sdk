...
/**
 * Collection response for WindowsInformationProtectionApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsInformationProtectionAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WindowsInformationProtectionApp[] $items
     * @return self
     */
    public function setValue(array|WindowsInformationProtectionApp $items, WindowsInformationProtectionApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsInformationProtectionApp> $value
     * @return self
     ...
     * 
     * @param WindowsInformationProtectionApp $item
     * @return self
     */
    public function addValue(WindowsInformationProtectionApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WindowsInformationProtectionApp|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WindowsInformationProtectionApp>
     */
