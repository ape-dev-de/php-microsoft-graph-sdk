...
/**
 * Collection response for CalendarColor
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CalendarColorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CalendarColor[]
     */
     ...
     * 
     * @param CalendarColor[] $items
     * @return self
     */
    public function setValue(array|CalendarColor $items, CalendarColor ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CalendarColor> $value
     * @return self
     ...
     * 
     * @param CalendarColor $item
     * @return self
     */
    public function addValue(CalendarColor $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CalendarColor>
     */
