 ...
 */
class SimulationReportOverviewCollectionResponse
{
    /**
     ...
     * 
     * @param SimulationReportOverview ...$items Variable number of SimulationReportOverview items
     * @return self
     */
    public function setValue(SimulationReportOverview ...$items): self
    {
        $this->value = $items;
        return $this;
    }
