...
/**
 * Collection response for SimulationReportOverview
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SimulationReportOverviewCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SimulationReportOverview[]
     */
    private array $value = [];
     ...
     * 
     * @param SimulationReportOverview[] $items
     * @return self
     */
    public function setValue(array|SimulationReportOverview $items, SimulationReportOverview ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SimulationReportOverview> $value
     * @return self
     ...
     * 
     * @param SimulationReportOverview $item
     * @return self
     */
    public function addValue(SimulationReportOverview $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SimulationReportOverview>
     */
