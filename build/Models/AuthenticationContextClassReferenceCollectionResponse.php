...
/**
 * Collection response for AuthenticationContextClassReference
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationContextClassReferenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AuthenticationContextClassReference[] $items
     * @return self
     */
    public function setValue(array|AuthenticationContextClassReference $items, AuthenticationContextClassReference ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationContextClassReference> $value
     * @return self
     ...
     * 
     * @param AuthenticationContextClassReference $item
     * @return self
     */
    public function addValue(AuthenticationContextClassReference $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationContextClassReference>
     */
