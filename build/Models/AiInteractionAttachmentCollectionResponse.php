...
/**
 * Collection response for AiInteractionAttachment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AiInteractionAttachmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AiInteractionAttachment[] $items
     * @return self
     */
    public function setValue(array|AiInteractionAttachment $items, AiInteractionAttachment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AiInteractionAttachment> $value
     * @return self
     ...
     * 
     * @param AiInteractionAttachment $item
     * @return self
     */
    public function addValue(AiInteractionAttachment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AiInteractionAttachment|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AiInteractionAttachment>
     */
