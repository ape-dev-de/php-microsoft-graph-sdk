...
/**
 * WindowsUpdateInstallScheduleTypeCollectionResponse - Collection response
 */
class WindowsUpdateInstallScheduleTypeCollectionResponse
{
    /**
     * @var array<int, WindowsUpdateInstallScheduleType>
     */
    public array $value = [];
