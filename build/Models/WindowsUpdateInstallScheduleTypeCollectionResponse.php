...
/**
 * Collection response for WindowsUpdateInstallScheduleType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsUpdateInstallScheduleTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WindowsUpdateInstallScheduleType[] $items
     * @return self
     */
    public function setValue(array|WindowsUpdateInstallScheduleType $items, WindowsUpdateInstallScheduleType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsUpdateInstallScheduleType> $value
     * @return self
     ...
     * 
     * @param WindowsUpdateInstallScheduleType $item
     * @return self
     */
    public function addValue(WindowsUpdateInstallScheduleType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsUpdateInstallScheduleType>
     */
