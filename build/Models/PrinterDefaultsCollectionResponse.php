 ...
 */
class PrinterDefaultsCollectionResponse
{
    /**
     * @var PrinterDefaults[]
     */
     ...
     * 
     * @param PrinterDefaults ...$items Variable number of PrinterDefaults items
     * @return self
     */
    public function setValue(PrinterDefaults ...$items): self
    {
        $this->value = $items;
        return $this;
    }
