...
/**
 * Collection response for PrinterDefaults
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrinterDefaultsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrinterDefaults[]
     */
     ...
     * 
     * @param PrinterDefaults[] $items
     * @return self
     */
    public function setValue(array|PrinterDefaults $items, PrinterDefaults ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrinterDefaults> $value
     * @return self
     ...
     * 
     * @param PrinterDefaults $item
     * @return self
     */
    public function addValue(PrinterDefaults $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrinterDefaults>
     */
