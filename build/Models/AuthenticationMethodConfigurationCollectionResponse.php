...
/**
 * Collection response for AuthenticationMethodConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationMethodConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AuthenticationMethodConfiguration[] $items
     * @return self
     */
    public function setValue(array|AuthenticationMethodConfiguration $items, AuthenticationMethodConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationMethodConfiguration> $value
     * @return self
     ...
     * 
     * @param AuthenticationMethodConfiguration $item
     * @return self
     */
    public function addValue(AuthenticationMethodConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationMethodConfiguration>
     */
