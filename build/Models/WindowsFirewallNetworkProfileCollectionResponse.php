...
/**
 * Collection response for WindowsFirewallNetworkProfile
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsFirewallNetworkProfileCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WindowsFirewallNetworkProfile[] $items
     * @return self
     */
    public function setValue(array|WindowsFirewallNetworkProfile $items, WindowsFirewallNetworkProfile ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsFirewallNetworkProfile> $value
     * @return self
     ...
     * 
     * @param WindowsFirewallNetworkProfile $item
     * @return self
     */
    public function addValue(WindowsFirewallNetworkProfile $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsFirewallNetworkProfile>
     */
