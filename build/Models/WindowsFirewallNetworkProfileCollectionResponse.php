 ...
 */
class WindowsFirewallNetworkProfileCollectionResponse
{
    /**
     ...
     * 
     * @param WindowsFirewallNetworkProfile ...$items Variable number of WindowsFirewallNetworkProfile items
     * @return self
     */
    public function setValue(WindowsFirewallNetworkProfile ...$items): self
    {
        $this->value = $items;
        return $this;
    }
