...
/**
 * Collection response for SiteProtectionUnitsBulkAdditionJobCollectionResponse
 */
class SiteProtectionUnitsBulkAdditionJobCollectionResponseCollectionResponse
{
    /**
     * @var SiteProtectionUnitsBulkAdditionJobCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SiteProtectionUnitsBulkAdditionJobCollectionResponse ...$items Variable number of SiteProtectionUnitsBulkAdditionJobCollectionResponse items
     * @return self
     */
    public function setValue(SiteProtectionUnitsBulkAdditionJobCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SiteProtectionUnitsBulkAdditionJobCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SiteProtectionUnitsBulkAdditionJobCollectionResponse $item
     * @return self
     */
    public function addValue(SiteProtectionUnitsBulkAdditionJobCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
