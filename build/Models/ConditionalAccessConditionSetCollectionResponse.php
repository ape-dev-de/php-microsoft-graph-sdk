...
/**
 * Collection response for ConditionalAccessConditionSet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessConditionSetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessConditionSet[]
     */
    private array $value = [];
     ...
     * 
     * @param ConditionalAccessConditionSet[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessConditionSet $items, ConditionalAccessConditionSet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessConditionSet> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessConditionSet $item
     * @return self
     */
    public function addValue(ConditionalAccessConditionSet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessConditionSet>
     */
