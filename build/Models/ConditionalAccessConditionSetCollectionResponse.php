 ...
 */
class ConditionalAccessConditionSetCollectionResponse
{
    /**
     ...
     * 
     * @param ConditionalAccessConditionSet ...$items Variable number of ConditionalAccessConditionSet items
     * @return self
     */
    public function setValue(ConditionalAccessConditionSet ...$items): self
    {
        $this->value = $items;
        return $this;
    }
