...
/**
 * Collection response for AccessReviewReviewer
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewReviewerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessReviewReviewer[] $items
     * @return self
     */
    public function setValue(array|AccessReviewReviewer $items, AccessReviewReviewer ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewReviewer> $value
     * @return self
     ...
     * 
     * @param AccessReviewReviewer $item
     * @return self
     */
    public function addValue(AccessReviewReviewer $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewReviewer>
     */
