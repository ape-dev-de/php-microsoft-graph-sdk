...
/**
 * Collection response for ManagedAppClipboardSharingLevel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedAppClipboardSharingLevelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ManagedAppClipboardSharingLevel[]
     */
    private array $value = [];
     ...
     * 
     * @return ManagedAppClipboardSharingLevel[]
     */
     ...
     * 
     * @param ManagedAppClipboardSharingLevel[] $items
     * @return self
     */
    public function setValue(array|ManagedAppClipboardSharingLevel $items, ManagedAppClipboardSharingLevel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedAppClipboardSharingLevel> $value
     * @return self
     ...
     * 
     * @param ManagedAppClipboardSharingLevel $item
     * @return self
     */
    public function addValue(ManagedAppClipboardSharingLevel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedAppClipboardSharingLevel>
     */
