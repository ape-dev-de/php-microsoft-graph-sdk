...
/**
 * ManagedAppClipboardSharingLevelCollectionResponse - Collection response
 */
class ManagedAppClipboardSharingLevelCollectionResponse
{
    /**
     * @var array<int, ManagedAppClipboardSharingLevel>
     */
    public array $value = [];
