...
/**
 * Collection response for ProcessContentBatchRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProcessContentBatchRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProcessContentBatchRequest[]
     */
    private array $value = [];
     ...
     * 
     * @param ProcessContentBatchRequest[] $items
     * @return self
     */
    public function setValue(array|ProcessContentBatchRequest $items, ProcessContentBatchRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProcessContentBatchRequest> $value
     * @return self
     ...
     * 
     * @param ProcessContentBatchRequest $item
     * @return self
     */
    public function addValue(ProcessContentBatchRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ProcessContentBatchRequest|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ProcessContentBatchRequest>
     */
