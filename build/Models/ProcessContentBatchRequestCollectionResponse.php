 ...
 */
class ProcessContentBatchRequestCollectionResponse
{
    /**
     ...
     * 
     * @param ProcessContentBatchRequest ...$items Variable number of ProcessContentBatchRequest items
     * @return self
     */
    public function setValue(ProcessContentBatchRequest ...$items): self
    {
        $this->value = $items;
        return $this;
    }
