...
/**
 * Collection response for AuditActor
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuditActorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuditActor[]
     */
     ...
     * 
     * @param AuditActor[] $items
     * @return self
     */
    public function setValue(array|AuditActor $items, AuditActor ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param AuditActor $item
     * @return self
     */
    public function addValue(AuditActor $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuditActor>
     */
