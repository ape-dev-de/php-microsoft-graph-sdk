...
/**
 * TeamsAsyncOperationStatusCollectionResponse - Collection response
 */
class TeamsAsyncOperationStatusCollectionResponse
{
    /**
     * @var array<int, TeamsAsyncOperationStatus>
     */
    public array $value = [];
