...
/**
 * Collection response for TeamsAsyncOperationStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamsAsyncOperationStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return TeamsAsyncOperationStatus[]
     */
     ...
     * 
     * @param TeamsAsyncOperationStatus[] $items
     * @return self
     */
    public function setValue(array|TeamsAsyncOperationStatus $items, TeamsAsyncOperationStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamsAsyncOperationStatus> $value
     * @return self
     ...
     * 
     * @param TeamsAsyncOperationStatus $item
     * @return self
     */
    public function addValue(TeamsAsyncOperationStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamsAsyncOperationStatus>
     */
