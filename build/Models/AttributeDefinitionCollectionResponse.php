...
/**
 * Collection response for AttributeDefinition
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttributeDefinitionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AttributeDefinition[] $items
     * @return self
     */
    public function setValue(array|AttributeDefinition $items, AttributeDefinition ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttributeDefinition> $value
     * @return self
     ...
     * @return self
     */
    public function addValue(AttributeDefinition $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AttributeDefinition>
     */
