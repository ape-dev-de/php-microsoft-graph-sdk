...
/**
 * SecurityDefaultRecordBehaviorCollectionResponse - Collection response
 */
class SecurityDefaultRecordBehaviorCollectionResponse
{
    /**
     * @var array<int, SecurityDefaultRecordBehavior>
     */
    public array $value = [];
