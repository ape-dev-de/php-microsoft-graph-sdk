...
/**
 * Collection response for SecurityDefaultRecordBehavior
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityDefaultRecordBehaviorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityDefaultRecordBehavior[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityDefaultRecordBehavior[]
     */
     ...
     * 
     * @param SecurityDefaultRecordBehavior[] $items
     * @return self
     */
    public function setValue(array|SecurityDefaultRecordBehavior $items, SecurityDefaultRecordBehavior ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityDefaultRecordBehavior> $value
     * @return self
     ...
     * 
     * @param SecurityDefaultRecordBehavior $item
     * @return self
     */
    public function addValue(SecurityDefaultRecordBehavior $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityDefaultRecordBehavior|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityDefaultRecordBehavior>
     */
