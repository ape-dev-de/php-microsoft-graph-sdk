...
/**
 * DelegatedAdminAccessAssignmentStatusCollectionResponse - Collection response
 */
class DelegatedAdminAccessAssignmentStatusCollectionResponse
{
    /**
     * @var array<int, DelegatedAdminAccessAssignmentStatus>
     */
    public array $value = [];
