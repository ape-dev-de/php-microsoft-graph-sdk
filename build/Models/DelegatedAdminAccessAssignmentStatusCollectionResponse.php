...
/**
 * Collection response for DelegatedAdminAccessAssignmentStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DelegatedAdminAccessAssignmentStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DelegatedAdminAccessAssignmentStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return DelegatedAdminAccessAssignmentStatus[]
     */
     ...
     * 
     * @param DelegatedAdminAccessAssignmentStatus[] $items
     * @return self
     */
    public function setValue(array|DelegatedAdminAccessAssignmentStatus $items, DelegatedAdminAccessAssignmentStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DelegatedAdminAccessAssignmentStatus> $value
     * @return self
     ...
     * 
     * @param DelegatedAdminAccessAssignmentStatus $item
     * @return self
     */
    public function addValue(DelegatedAdminAccessAssignmentStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DelegatedAdminAccessAssignmentStatus>
     */
