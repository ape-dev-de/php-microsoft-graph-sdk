...
/**
 * Collection response for SecurityHostComponent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHostComponentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityHostComponent[] $items
     * @return self
     */
    public function setValue(array|SecurityHostComponent $items, SecurityHostComponent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHostComponent> $value
     * @return self
     ...
     * 
     * @param SecurityHostComponent $item
     * @return self
     */
    public function addValue(SecurityHostComponent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityHostComponent>
     */
