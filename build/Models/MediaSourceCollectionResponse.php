...
/**
 * Collection response for MediaSource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MediaSourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MediaSource[]
     */
     ...
     * 
     * @param MediaSource[] $items
     * @return self
     */
    public function setValue(array|MediaSource $items, MediaSource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param MediaSource $item
     * @return self
     */
    public function addValue(MediaSource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MediaSource>
     */
