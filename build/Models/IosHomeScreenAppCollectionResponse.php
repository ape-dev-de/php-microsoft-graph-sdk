...
/**
 * Collection response for IosHomeScreenApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosHomeScreenAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IosHomeScreenApp[] $items
     * @return self
     */
    public function setValue(array|IosHomeScreenApp $items, IosHomeScreenApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosHomeScreenApp> $value
     * @return self
     ...
     * 
     * @param IosHomeScreenApp $item
     * @return self
     */
    public function addValue(IosHomeScreenApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IosHomeScreenApp>
     */
