...
/**
 * Collection response for LoginPageCollectionResponse
 */
class LoginPageCollectionResponseCollectionResponse
{
    /**
     * @var LoginPageCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param LoginPageCollectionResponse ...$items Variable number of LoginPageCollectionResponse items
     * @return self
     */
    public function setValue(LoginPageCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<LoginPageCollectionResponse> $value
     * @return self
     ...
     * 
     * @param LoginPageCollectionResponse $item
     * @return self
     */
    public function addValue(LoginPageCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
