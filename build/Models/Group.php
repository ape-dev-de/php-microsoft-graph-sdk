...
class Group
{
     ...
     * @var string[]
     */
    private array $transitiveMembers = [];
     ...
     */
    public function setGroupTypes(array $groupTypes): self
    {
    ...
    /**
     * @param string[] $transitiveMembers
     */
    public function setTransitiveMembers(array $transitiveMembers): self
    {
