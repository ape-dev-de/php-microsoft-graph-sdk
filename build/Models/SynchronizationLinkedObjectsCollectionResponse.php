...
/**
 * Collection response for SynchronizationLinkedObjects
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationLinkedObjectsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SynchronizationLinkedObjects[]
     */
    private array $value = [];
     ...
     * 
     * @param SynchronizationLinkedObjects[] $items
     * @return self
     */
    public function setValue(array|SynchronizationLinkedObjects $items, SynchronizationLinkedObjects ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SynchronizationLinkedObjects> $value
     * @return self
     ...
     * 
     * @param SynchronizationLinkedObjects $item
     * @return self
     */
    public function addValue(SynchronizationLinkedObjects $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SynchronizationLinkedObjects>
     */
