 ...
 */
class SynchronizationLinkedObjectsCollectionResponse
{
    /**
     ...
     * 
     * @param SynchronizationLinkedObjects ...$items Variable number of SynchronizationLinkedObjects items
     * @return self
     */
    public function setValue(SynchronizationLinkedObjects ...$items): self
    {
        $this->value = $items;
        return $this;
    }
