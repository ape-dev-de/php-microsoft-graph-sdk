...
/**
 * Collection response for SecuritySinglePropertySchema
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecuritySinglePropertySchemaCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return SecuritySinglePropertySchema[]
     */
     ...
     * 
     * @param SecuritySinglePropertySchema[] $items
     * @return self
     */
    public function setValue(array|SecuritySinglePropertySchema $items, SecuritySinglePropertySchema ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecuritySinglePropertySchema> $value
     * @return self
     ...
     * 
     * @param SecuritySinglePropertySchema $item
     * @return self
     */
    public function addValue(SecuritySinglePropertySchema $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecuritySinglePropertySchema|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecuritySinglePropertySchema>
     */
