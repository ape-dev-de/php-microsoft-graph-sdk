...
/**
 * SecuritySinglePropertySchemaCollectionResponse - Collection response
 */
class SecuritySinglePropertySchemaCollectionResponse
{
    /**
     * @var array<int, SecuritySinglePropertySchema>
     */
    public array $value = [];
