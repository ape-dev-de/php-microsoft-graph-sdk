 ...
 */
class BasicAuthenticationCollectionResponse
{
    /**
     ...
     * 
     * @param BasicAuthentication ...$items Variable number of BasicAuthentication items
     * @return self
     */
    public function setValue(BasicAuthentication ...$items): self
    {
        $this->value = $items;
        return $this;
    }
