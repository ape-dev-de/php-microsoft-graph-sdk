...
/**
 * Collection response for BasicAuthentication
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BasicAuthenticationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param BasicAuthentication[] $items
     * @return self
     */
    public function setValue(array|BasicAuthentication $items, BasicAuthentication ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BasicAuthentication> $value
     * @return self
     ...
     * 
     * @param BasicAuthentication $item
     * @return self
     */
    public function addValue(BasicAuthentication $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BasicAuthentication>
     */
