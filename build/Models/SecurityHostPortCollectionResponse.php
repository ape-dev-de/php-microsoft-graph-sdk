...
/**
 * Collection response for SecurityHostPort
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHostPortCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityHostPort[] $items
     * @return self
     */
    public function setValue(array|SecurityHostPort $items, SecurityHostPort ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHostPort> $value
     * @return self
     ...
     * 
     * @param SecurityHostPort $item
     * @return self
     */
    public function addValue(SecurityHostPort $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityHostPort>
     */
