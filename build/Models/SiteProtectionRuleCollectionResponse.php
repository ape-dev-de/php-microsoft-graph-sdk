...
/**
 * Collection response for SiteProtectionRule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SiteProtectionRuleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SiteProtectionRule[] $items
     * @return self
     */
    public function setValue(array|SiteProtectionRule $items, SiteProtectionRule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SiteProtectionRule> $value
     * @return self
     ...
     * 
     * @param SiteProtectionRule $item
     * @return self
     */
    public function addValue(SiteProtectionRule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SiteProtectionRule>
     */
