...
/**
 * Collection response for LinkedResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LinkedResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var LinkedResource[]
     */
     ...
     * 
     * @param LinkedResource[] $items
     * @return self
     */
    public function setValue(array|LinkedResource $items, LinkedResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LinkedResource> $value
     * @return self
     ...
     * 
     * @param LinkedResource $item
     * @return self
     */
    public function addValue(LinkedResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LinkedResource>
     */
