...
/**
 * Collection response for RestorePoint
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RestorePointCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RestorePoint[]
     */
     ...
     * 
     * @param RestorePoint[] $items
     * @return self
     */
    public function setValue(array|RestorePoint $items, RestorePoint ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RestorePoint> $value
     * @return self
     ...
     * 
     * @param RestorePoint $item
     * @return self
     */
    public function addValue(RestorePoint $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RestorePoint>
     */
