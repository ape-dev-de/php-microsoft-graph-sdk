 ...
 */
class AuthenticationConditionsApplicationsCollectionResponse
{
    /**
     ...
     * 
     * @param AuthenticationConditionsApplications ...$items Variable number of AuthenticationConditionsApplications items
     * @return self
     */
    public function setValue(AuthenticationConditionsApplications ...$items): self
    {
        $this->value = $items;
        return $this;
    }
