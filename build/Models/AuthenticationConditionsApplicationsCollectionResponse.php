...
/**
 * Collection response for AuthenticationConditionsApplications
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationConditionsApplicationsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuthenticationConditionsApplications[]
     */
    private array $value = [];
     ...
     * 
     * @param AuthenticationConditionsApplications[] $items
     * @return self
     */
    public function setValue(array|AuthenticationConditionsApplications $items, AuthenticationConditionsApplications ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationConditionsApplications> $value
     * @return self
     ...
     * 
     * @param AuthenticationConditionsApplications $item
     * @return self
     */
    public function addValue(AuthenticationConditionsApplications $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationConditionsApplications>
     */
