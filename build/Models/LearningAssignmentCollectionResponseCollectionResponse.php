...
/**
 * Collection response for LearningAssignmentCollectionResponse
 */
class LearningAssignmentCollectionResponseCollectionResponse
{
    /**
     * @var LearningAssignmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return LearningAssignmentCollectionResponse[]
     */
     ...
     * 
     * @param LearningAssignmentCollectionResponse ...$items Variable number of LearningAssignmentCollectionResponse items
     * @return self
     */
    public function setValue(LearningAssignmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<LearningAssignmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param LearningAssignmentCollectionResponse $item
     * @return self
     */
    public function addValue(LearningAssignmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
