...
/**
 * Collection response for ExternalConnectorsSchema
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsSchemaCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalConnectorsSchema[]
     */
    private array $value = [];
     ...
     * 
     * @param ExternalConnectorsSchema[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsSchema $items, ExternalConnectorsSchema ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsSchema> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsSchema $item
     * @return self
     */
    public function addValue(ExternalConnectorsSchema $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsSchema>
     */
