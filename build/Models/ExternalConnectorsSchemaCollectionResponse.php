 ...
 */
class ExternalConnectorsSchemaCollectionResponse
{
    /**
     ...
     * 
     * @param ExternalConnectorsSchema ...$items Variable number of ExternalConnectorsSchema items
     * @return self
     */
    public function setValue(ExternalConnectorsSchema ...$items): self
    {
        $this->value = $items;
        return $this;
    }
