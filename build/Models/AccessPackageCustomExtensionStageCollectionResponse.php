...
/**
 * Collection response for AccessPackageCustomExtensionStage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageCustomExtensionStageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageCustomExtensionStage[]
     */
    private array $value = [];
     ...
     * 
     * @return AccessPackageCustomExtensionStage[]
     */
     ...
     * 
     * @param AccessPackageCustomExtensionStage[] $items
     * @return self
     */
    public function setValue(array|AccessPackageCustomExtensionStage $items, AccessPackageCustomExtensionStage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageCustomExtensionStage> $value
     * @return self
     ...
     * 
     * @param AccessPackageCustomExtensionStage $item
     * @return self
     */
    public function addValue(AccessPackageCustomExtensionStage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageCustomExtensionStage>
     */
