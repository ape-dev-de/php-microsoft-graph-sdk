...
/**
 * AccessPackageCustomExtensionStageCollectionResponse - Collection response
 */
class AccessPackageCustomExtensionStageCollectionResponse
{
    /**
     * @var array<int, AccessPackageCustomExtensionStage>
     */
    public array $value = [];
