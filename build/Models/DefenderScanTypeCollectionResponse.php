...
/**
 * Collection response for DefenderScanType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DefenderScanTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DefenderScanType[]
     */
    private array $value = [];
     ...
     * 
     * @param DefenderScanType[] $items
     * @return self
     */
    public function setValue(array|DefenderScanType $items, DefenderScanType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DefenderScanType> $value
     * @return self
     ...
     * 
     * @param DefenderScanType $item
     * @return self
     */
    public function addValue(DefenderScanType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DefenderScanType>
     */
