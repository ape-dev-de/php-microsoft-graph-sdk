...
/**
 * Collection response for ChannelDescriptionUpdatedEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChannelDescriptionUpdatedEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChannelDescriptionUpdatedEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param ChannelDescriptionUpdatedEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|ChannelDescriptionUpdatedEventMessageDetail $items, ChannelDescriptionUpdatedEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChannelDescriptionUpdatedEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param ChannelDescriptionUpdatedEventMessageDetail $item
     * @return self
     */
    public function addValue(ChannelDescriptionUpdatedEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ChannelDescriptionUpdatedEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ChannelDescriptionUpdatedEventMessageDetail>
     */
