 ...
 */
class ChannelDescriptionUpdatedEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param ChannelDescriptionUpdatedEventMessageDetail ...$items Variable number of ChannelDescriptionUpdatedEventMessageDetail items
     * @return self
     */
    public function setValue(ChannelDescriptionUpdatedEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
