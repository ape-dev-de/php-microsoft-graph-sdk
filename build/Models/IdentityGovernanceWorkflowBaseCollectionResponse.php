...
/**
 * Collection response for IdentityGovernanceWorkflowBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceWorkflowBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceWorkflowBase[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceWorkflowBase[]
     */
     ...
     * 
     * @param IdentityGovernanceWorkflowBase[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceWorkflowBase $items, IdentityGovernanceWorkflowBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceWorkflowBase> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceWorkflowBase $item
     * @return self
     */
    public function addValue(IdentityGovernanceWorkflowBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceWorkflowBase|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceWorkflowBase>
     */
