 ...
 */
class IdentityGovernanceWorkflowBaseCollectionResponse
{
    /**
     ...
     * 
     * @param IdentityGovernanceWorkflowBase ...$items Variable number of IdentityGovernanceWorkflowBase items
     * @return self
     */
    public function setValue(IdentityGovernanceWorkflowBase ...$items): self
    {
        $this->value = $items;
        return $this;
    }
