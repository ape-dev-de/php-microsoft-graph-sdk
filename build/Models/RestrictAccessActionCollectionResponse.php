...
/**
 * Collection response for RestrictAccessAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RestrictAccessActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RestrictAccessAction[]
     */
    private array $value = [];
     ...
     * 
     * @param RestrictAccessAction[] $items
     * @return self
     */
    public function setValue(array|RestrictAccessAction $items, RestrictAccessAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RestrictAccessAction> $value
     * @return self
     ...
     * 
     * @param RestrictAccessAction $item
     * @return self
     */
    public function addValue(RestrictAccessAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return RestrictAccessAction|null
     */
     ...
     * 
     * @return \ArrayIterator<int, RestrictAccessAction>
     */
