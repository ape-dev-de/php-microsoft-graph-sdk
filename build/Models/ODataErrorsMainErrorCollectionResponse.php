...
/**
 * Collection response for ODataErrorsMainError
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ODataErrorsMainErrorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ODataErrorsMainError[]
     */
    private array $value = [];
     ...
     * 
     * @param ODataErrorsMainError[] $items
     * @return self
     */
    public function setValue(array|ODataErrorsMainError $items, ODataErrorsMainError ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ODataErrorsMainError> $value
     * @return self
     ...
     * 
     * @param ODataErrorsMainError $item
     * @return self
     */
    public function addValue(ODataErrorsMainError $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ODataErrorsMainError|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ODataErrorsMainError>
     */
