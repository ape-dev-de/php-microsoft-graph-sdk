 ...
 */
class ODataErrorsMainErrorCollectionResponse
{
    /**
     ...
     * 
     * @param ODataErrorsMainError ...$items Variable number of ODataErrorsMainError items
     * @return self
     */
    public function setValue(ODataErrorsMainError ...$items): self
    {
        $this->value = $items;
        return $this;
    }
