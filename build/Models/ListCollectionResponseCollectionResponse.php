...
/**
 * Collection response for ListCollectionResponse
 */
class ListCollectionResponseCollectionResponse
{
    /**
     * @var ListCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ListCollectionResponse ...$items Variable number of ListCollectionResponse items
     * @return self
     */
    public function setValue(ListCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ListCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ListCollectionResponse $item
     * @return self
     */
    public function addValue(ListCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
