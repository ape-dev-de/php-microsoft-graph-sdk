...
/**
 * Collection response for OnPremisesDirectorySynchronizationDeletionPreventionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnPremisesDirectorySynchronizationDeletionPreventionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnPremisesDirectorySynchronizationDeletionPreventionType[]
     */
    private array $value = [];
     ...
     * 
     * @return OnPremisesDirectorySynchronizationDeletionPreventionType[]
     */
     ...
     * 
     * @param OnPremisesDirectorySynchronizationDeletionPreventionType[] $items
     * @return self
     */
    public function setValue(array|OnPremisesDirectorySynchronizationDeletionPreventionType $items, OnPremisesDirectorySynchronizationDeletionPreventionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnPremisesDirectorySynchronizationDeletionPreventionType> $value
     * @return self
     ...
     * 
     * @param OnPremisesDirectorySynchronizationDeletionPreventionType $item
     * @return self
     */
    public function addValue(OnPremisesDirectorySynchronizationDeletionPreventionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnPremisesDirectorySynchronizationDeletionPreventionType>
     */
