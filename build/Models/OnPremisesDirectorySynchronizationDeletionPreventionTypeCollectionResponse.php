...
/**
 * OnPremisesDirectorySynchronizationDeletionPreventionTypeCollectionResponse - Collection response
 */
class OnPremisesDirectorySynchronizationDeletionPreventionTypeCollectionResponse
{
    /**
     * @var array<int, OnPremisesDirectorySynchronizationDeletionPreventionType>
     */
    public array $value = [];
