...
/**
 * Collection response for ConnectionStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConnectionStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ConnectionStatus[] $items
     * @return self
     */
    public function setValue(array|ConnectionStatus $items, ConnectionStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConnectionStatus> $value
     * @return self
     ...
     * 
     * @param ConnectionStatus $item
     * @return self
     */
    public function addValue(ConnectionStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConnectionStatus>
     */
