...
/**
 * Collection response for InferenceClassificationOverride
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InferenceClassificationOverrideCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param InferenceClassificationOverride[] $items
     * @return self
     */
    public function setValue(array|InferenceClassificationOverride $items, InferenceClassificationOverride ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InferenceClassificationOverride> $value
     * @return self
     ...
     * 
     * @param InferenceClassificationOverride $item
     * @return self
     */
    public function addValue(InferenceClassificationOverride $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, InferenceClassificationOverride>
     */
