...
/**
 * Collection response for VirtualEventCollectionResponse
 */
class VirtualEventCollectionResponseCollectionResponse
{
    /**
     * @var VirtualEventCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param VirtualEventCollectionResponse ...$items Variable number of VirtualEventCollectionResponse items
     * @return self
     */
    public function setValue(VirtualEventCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<VirtualEventCollectionResponse> $value
     * @return self
     ...
     * 
     * @param VirtualEventCollectionResponse $item
     * @return self
     */
    public function addValue(VirtualEventCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
