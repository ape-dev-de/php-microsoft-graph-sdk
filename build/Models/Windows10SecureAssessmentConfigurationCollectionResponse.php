...
/**
 * Collection response for Windows10SecureAssessmentConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Windows10SecureAssessmentConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param Windows10SecureAssessmentConfiguration[] $items
     * @return self
     */
    public function setValue(array|Windows10SecureAssessmentConfiguration $items, Windows10SecureAssessmentConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Windows10SecureAssessmentConfiguration> $value
     * @return self
     ...
     * 
     * @param Windows10SecureAssessmentConfiguration $item
     * @return self
     */
    public function addValue(Windows10SecureAssessmentConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return Windows10SecureAssessmentConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, Windows10SecureAssessmentConfiguration>
     */
