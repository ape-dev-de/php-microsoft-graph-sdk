 ...
 */
class RelyingPartyDetailedSummaryCollectionResponse
{
    /**
     ...
     * 
     * @param RelyingPartyDetailedSummary ...$items Variable number of RelyingPartyDetailedSummary items
     * @return self
     */
    public function setValue(RelyingPartyDetailedSummary ...$items): self
    {
        $this->value = $items;
        return $this;
    }
