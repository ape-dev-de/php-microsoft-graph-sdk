...
/**
 * Collection response for RelyingPartyDetailedSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RelyingPartyDetailedSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RelyingPartyDetailedSummary[]
     */
    private array $value = [];
     ...
     * 
     * @param RelyingPartyDetailedSummary[] $items
     * @return self
     */
    public function setValue(array|RelyingPartyDetailedSummary $items, RelyingPartyDetailedSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RelyingPartyDetailedSummary> $value
     * @return self
     ...
     * 
     * @param RelyingPartyDetailedSummary $item
     * @return self
     */
    public function addValue(RelyingPartyDetailedSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return RelyingPartyDetailedSummary|null
     */
     ...
     * 
     * @return \ArrayIterator<int, RelyingPartyDetailedSummary>
     */
