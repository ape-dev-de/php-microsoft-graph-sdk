...
/**
 * Collection response for UserScopeTeamsAppInstallationCollectionResponse
 */
class UserScopeTeamsAppInstallationCollectionResponseCollectionResponse
{
    /**
     * @var UserScopeTeamsAppInstallationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UserScopeTeamsAppInstallationCollectionResponse ...$items Variable number of UserScopeTeamsAppInstallationCollectionResponse items
     * @return self
     */
    public function setValue(UserScopeTeamsAppInstallationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UserScopeTeamsAppInstallationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UserScopeTeamsAppInstallationCollectionResponse $item
     * @return self
     */
    public function addValue(UserScopeTeamsAppInstallationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
