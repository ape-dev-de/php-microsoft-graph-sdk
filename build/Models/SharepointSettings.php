...
class SharepointSettings
{
     ...
     */
    private ?string $allowedDomainGuidsForSyncApp;

    /**
     * Collection of managed paths available for site creation. Read-only.
     */
    private ?string $availableManagedPathsForSiteCreation;
     ...
     */
    private ?string $excludedFileExtensionsForSyncApp;
    ...
    public function getAllowedDomainGuidsForSyncApp(): ?string
    {
        return $this->allowedDomainGuidsForSyncApp;
    }

    public function setAllowedDomainGuidsForSyncApp(?string $allowedDomainGuidsForSyncApp): self
    {
        $this->allowedDomainGuidsForSyncApp = $allowedDomainGuidsForSyncApp;
        return $this;
    }

    public function getAvailableManagedPathsForSiteCreation(): ?string
    {
        return $this->availableManagedPathsForSiteCreation;
    }

    public function setAvailableManagedPathsForSiteCreation(?string $availableManagedPathsForSiteCreation): self
    {
    ...
    public function getExcludedFileExtensionsForSyncApp(): ?string
    {
        return $this->excludedFileExtensionsForSyncApp;
    }

    public function setExcludedFileExtensionsForSyncApp(?string $excludedFileExtensionsForSyncApp): self
    {
    ...
    public function getSharingAllowedDomainList(): ?string
    {
        return $this->sharingAllowedDomainList;
    }

    public function setSharingAllowedDomainList(?string $sharingAllowedDomainList): self
    {
        $this->sharingAllowedDomainList = $sharingAllowedDomainList;
        return $this;
    }

    public function getSharingBlockedDomainList(): ?string
    {
        return $this->sharingBlockedDomainList;
    }

    public function setSharingBlockedDomainList(?string $sharingBlockedDomainList): self
    {
