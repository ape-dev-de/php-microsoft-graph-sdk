...
/**
 * Collection response for SiteProtectionRuleCollectionResponse
 */
class SiteProtectionRuleCollectionResponseCollectionResponse
{
    /**
     * @var SiteProtectionRuleCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SiteProtectionRuleCollectionResponse ...$items Variable number of SiteProtectionRuleCollectionResponse items
     * @return self
     */
    public function setValue(SiteProtectionRuleCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SiteProtectionRuleCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SiteProtectionRuleCollectionResponse $item
     * @return self
     */
    public function addValue(SiteProtectionRuleCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
