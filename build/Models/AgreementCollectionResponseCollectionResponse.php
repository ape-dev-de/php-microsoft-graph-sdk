...
/**
 * Collection response for AgreementCollectionResponse
 */
class AgreementCollectionResponseCollectionResponse
{
    /**
     * @var AgreementCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AgreementCollectionResponse ...$items Variable number of AgreementCollectionResponse items
     * @return self
     */
    public function setValue(AgreementCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AgreementCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AgreementCollectionResponse $item
     * @return self
     */
    public function addValue(AgreementCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
