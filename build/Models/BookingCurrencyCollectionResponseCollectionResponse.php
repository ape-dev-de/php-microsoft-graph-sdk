...
/**
 * Collection response for BookingCurrencyCollectionResponse
 */
class BookingCurrencyCollectionResponseCollectionResponse
{
    /**
     * @var BookingCurrencyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BookingCurrencyCollectionResponse ...$items Variable number of BookingCurrencyCollectionResponse items
     * @return self
     */
    public function setValue(BookingCurrencyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<BookingCurrencyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param BookingCurrencyCollectionResponse $item
     * @return self
     */
    public function addValue(BookingCurrencyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
