...
/**
 * Collection response for AuditResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuditResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuditResource[]
     */
     ...
     * 
     * @param AuditResource[] $items
     * @return self
     */
    public function setValue(array|AuditResource $items, AuditResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuditResource> $value
     * @return self
     ...
     * 
     * @param AuditResource $item
     * @return self
     */
    public function addValue(AuditResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuditResource>
     */
