...
/**
 * Collection response for Website
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WebsiteCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Website[]
     */
     ...
     * @return self
     */
    public function setValue(array|Website $items, Website ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Website $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Website>
     */
