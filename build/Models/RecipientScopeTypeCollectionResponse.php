...
/**
 * Collection response for RecipientScopeType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RecipientScopeTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RecipientScopeType[]
     */
    private array $value = [];
     ...
     * 
     * @param RecipientScopeType[] $items
     * @return self
     */
    public function setValue(array|RecipientScopeType $items, RecipientScopeType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RecipientScopeType> $value
     * @return self
     ...
     * 
     * @param RecipientScopeType $item
     * @return self
     */
    public function addValue(RecipientScopeType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RecipientScopeType>
     */
