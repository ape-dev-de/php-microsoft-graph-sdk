...
/**
 * Collection response for ReferenceNumeric
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ReferenceNumericCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ReferenceNumeric[]
     */
    private array $value = [];
     ...
     * 
     * @param ReferenceNumeric[] $items
     * @return self
     */
    public function setValue(array|ReferenceNumeric $items, ReferenceNumeric ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ReferenceNumeric> $value
     * @return self
     ...
     * 
     * @param ReferenceNumeric $item
     * @return self
     */
    public function addValue(ReferenceNumeric $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ReferenceNumeric>
     */
