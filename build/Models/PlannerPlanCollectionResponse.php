...
/**
 * Collection response for PlannerPlan
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerPlanCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PlannerPlan[]
     */
     ...
     * 
     * @param PlannerPlan[] $items
     * @return self
     */
    public function setValue(array|PlannerPlan $items, PlannerPlan ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param PlannerPlan $item
     * @return self
     */
    public function addValue(PlannerPlan $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PlannerPlan>
     */
