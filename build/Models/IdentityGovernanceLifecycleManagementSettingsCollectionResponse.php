 ...
 */
class IdentityGovernanceLifecycleManagementSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param IdentityGovernanceLifecycleManagementSettings ...$items Variable number of IdentityGovernanceLifecycleManagementSettings items
     * @return self
     */
    public function setValue(IdentityGovernanceLifecycleManagementSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
