...
/**
 * Collection response for IdentityGovernanceLifecycleManagementSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceLifecycleManagementSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceLifecycleManagementSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityGovernanceLifecycleManagementSettings[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceLifecycleManagementSettings $items, IdentityGovernanceLifecycleManagementSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceLifecycleManagementSettings> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceLifecycleManagementSettings $item
     * @return self
     */
    public function addValue(IdentityGovernanceLifecycleManagementSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceLifecycleManagementSettings>
     */
