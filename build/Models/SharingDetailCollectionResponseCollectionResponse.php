...
/**
 * Collection response for SharingDetailCollectionResponse
 */
class SharingDetailCollectionResponseCollectionResponse
{
    /**
     * @var SharingDetailCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SharingDetailCollectionResponse ...$items Variable number of SharingDetailCollectionResponse items
     * @return self
     */
    public function setValue(SharingDetailCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SharingDetailCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SharingDetailCollectionResponse $item
     * @return self
     */
    public function addValue(SharingDetailCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
