...
/**
 * Collection response for VirtualEventsRoot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualEventsRootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VirtualEventsRoot[]
     */
    private array $value = [];
     ...
     * 
     * @param VirtualEventsRoot[] $items
     * @return self
     */
    public function setValue(array|VirtualEventsRoot $items, VirtualEventsRoot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualEventsRoot> $value
     * @return self
     ...
     * 
     * @param VirtualEventsRoot $item
     * @return self
     */
    public function addValue(VirtualEventsRoot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VirtualEventsRoot>
     */
