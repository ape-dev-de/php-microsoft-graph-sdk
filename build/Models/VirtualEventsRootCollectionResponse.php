 ...
 */
class VirtualEventsRootCollectionResponse
{
    /**
     ...
     * 
     * @param VirtualEventsRoot ...$items Variable number of VirtualEventsRoot items
     * @return self
     */
    public function setValue(VirtualEventsRoot ...$items): self
    {
        $this->value = $items;
        return $this;
    }
