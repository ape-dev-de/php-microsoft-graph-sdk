...
/**
 * Collection response for CommunityCollectionResponse
 */
class CommunityCollectionResponseCollectionResponse
{
    /**
     * @var CommunityCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CommunityCollectionResponse ...$items Variable number of CommunityCollectionResponse items
     * @return self
     */
    public function setValue(CommunityCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CommunityCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CommunityCollectionResponse $item
     * @return self
     */
    public function addValue(CommunityCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
