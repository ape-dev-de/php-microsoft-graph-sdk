...
/**
 * Collection response for RunAsAccountType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RunAsAccountTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RunAsAccountType[]
     */
    private array $value = [];
     ...
     * 
     * @param RunAsAccountType[] $items
     * @return self
     */
    public function setValue(array|RunAsAccountType $items, RunAsAccountType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RunAsAccountType> $value
     * @return self
     ...
     * 
     * @param RunAsAccountType $item
     * @return self
     */
    public function addValue(RunAsAccountType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RunAsAccountType>
     */
