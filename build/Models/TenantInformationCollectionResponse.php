...
/**
 * Collection response for TenantInformation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TenantInformationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TenantInformation[] $items
     * @return self
     */
    public function setValue(array|TenantInformation $items, TenantInformation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TenantInformation> $value
     * @return self
     ...
     * 
     * @param TenantInformation $item
     * @return self
     */
    public function addValue(TenantInformation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TenantInformation>
     */
