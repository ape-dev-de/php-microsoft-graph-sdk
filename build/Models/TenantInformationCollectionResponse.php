 ...
 */
class TenantInformationCollectionResponse
{
    /**
     ...
     * 
     * @param TenantInformation ...$items Variable number of TenantInformation items
     * @return self
     */
    public function setValue(TenantInformation ...$items): self
    {
        $this->value = $items;
        return $this;
    }
