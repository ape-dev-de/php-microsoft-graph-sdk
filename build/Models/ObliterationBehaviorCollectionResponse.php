...
/**
 * Collection response for ObliterationBehavior
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ObliterationBehaviorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ObliterationBehavior[]
     */
    private array $value = [];
     ...
     * 
     * @param ObliterationBehavior[] $items
     * @return self
     */
    public function setValue(array|ObliterationBehavior $items, ObliterationBehavior ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ObliterationBehavior> $value
     * @return self
     ...
     * 
     * @param ObliterationBehavior $item
     * @return self
     */
    public function addValue(ObliterationBehavior $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ObliterationBehavior>
     */
