 ...
 */
class SecurityAmazonResourceEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityAmazonResourceEvidence ...$items Variable number of SecurityAmazonResourceEvidence items
     * @return self
     */
    public function setValue(SecurityAmazonResourceEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
