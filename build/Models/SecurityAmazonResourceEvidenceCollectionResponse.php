...
/**
 * Collection response for SecurityAmazonResourceEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityAmazonResourceEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityAmazonResourceEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityAmazonResourceEvidence[]
     */
     ...
     * 
     * @param SecurityAmazonResourceEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityAmazonResourceEvidence $items, SecurityAmazonResourceEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityAmazonResourceEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityAmazonResourceEvidence $item
     * @return self
     */
    public function addValue(SecurityAmazonResourceEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityAmazonResourceEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityAmazonResourceEvidence>
     */
