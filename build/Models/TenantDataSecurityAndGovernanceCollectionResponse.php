 ...
 */
class TenantDataSecurityAndGovernanceCollectionResponse
{
    /**
     ...
     * 
     * @param TenantDataSecurityAndGovernance ...$items Variable number of TenantDataSecurityAndGovernance items
     * @return self
     */
    public function setValue(TenantDataSecurityAndGovernance ...$items): self
    {
        $this->value = $items;
        return $this;
    }
