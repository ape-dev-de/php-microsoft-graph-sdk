...
/**
 * Collection response for TenantDataSecurityAndGovernance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TenantDataSecurityAndGovernanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TenantDataSecurityAndGovernance[]
     */
    private array $value = [];
     ...
     * 
     * @param TenantDataSecurityAndGovernance[] $items
     * @return self
     */
    public function setValue(array|TenantDataSecurityAndGovernance $items, TenantDataSecurityAndGovernance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TenantDataSecurityAndGovernance> $value
     * @return self
     ...
     * 
     * @param TenantDataSecurityAndGovernance $item
     * @return self
     */
    public function addValue(TenantDataSecurityAndGovernance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TenantDataSecurityAndGovernance>
     */
