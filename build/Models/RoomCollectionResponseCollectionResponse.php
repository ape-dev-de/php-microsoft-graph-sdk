...
/**
 * Collection response for RoomCollectionResponse
 */
class RoomCollectionResponseCollectionResponse
{
    /**
     * @var RoomCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RoomCollectionResponse ...$items Variable number of RoomCollectionResponse items
     * @return self
     */
    public function setValue(RoomCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RoomCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RoomCollectionResponse $item
     * @return self
     */
    public function addValue(RoomCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
