...
/**
 * Collection response for OnAuthenticationMethodLoadStartHandler
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnAuthenticationMethodLoadStartHandlerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param OnAuthenticationMethodLoadStartHandler[] $items
     * @return self
     */
    public function setValue(array|OnAuthenticationMethodLoadStartHandler $items, OnAuthenticationMethodLoadStartHandler ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnAuthenticationMethodLoadStartHandler> $value
     * @return self
     ...
     * 
     * @param OnAuthenticationMethodLoadStartHandler $item
     * @return self
     */
    public function addValue(OnAuthenticationMethodLoadStartHandler $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnAuthenticationMethodLoadStartHandler>
     */
