...
/**
 * OnAuthenticationMethodLoadStartHandlerCollectionResponse - Collection response
 */
class OnAuthenticationMethodLoadStartHandlerCollectionResponse
{
    /**
     * @var array<int, OnAuthenticationMethodLoadStartHandler>
     */
    public array $value = [];
