...
/**
 * Collection response for Root
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Root[]
     */
     ...
     * @return self
     */
    public function setValue(array|Root $items, Root ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Root $item): self
    {
        $this->value[] = $item;
        return $this;
    }
