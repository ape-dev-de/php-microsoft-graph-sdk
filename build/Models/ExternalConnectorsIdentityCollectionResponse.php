...
/**
 * Collection response for ExternalConnectorsIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ExternalConnectorsIdentity[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsIdentity $items, ExternalConnectorsIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsIdentity> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsIdentity $item
     * @return self
     */
    public function addValue(ExternalConnectorsIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsIdentity>
     */
