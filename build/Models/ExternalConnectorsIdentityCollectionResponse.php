...
/**
 * ExternalConnectorsIdentityCollectionResponse - Collection response
 */
class ExternalConnectorsIdentityCollectionResponse
{
    /**
     * @var array<int, ExternalConnectorsIdentity>
     */
    public array $value = [];
