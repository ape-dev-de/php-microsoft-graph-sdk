...
/**
 * Collection response for OneDriveForBusinessProtectionPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OneDriveForBusinessProtectionPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param OneDriveForBusinessProtectionPolicy[] $items
     * @return self
     */
    public function setValue(array|OneDriveForBusinessProtectionPolicy $items, OneDriveForBusinessProtectionPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OneDriveForBusinessProtectionPolicy> $value
     * @return self
     ...
     * 
     * @param OneDriveForBusinessProtectionPolicy $item
     * @return self
     */
    public function addValue(OneDriveForBusinessProtectionPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OneDriveForBusinessProtectionPolicy>
     */
