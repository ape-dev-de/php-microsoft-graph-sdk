...
/**
 * Collection response for WindowsSettingInstanceCollectionResponse
 */
class WindowsSettingInstanceCollectionResponseCollectionResponse
{
    /**
     * @var WindowsSettingInstanceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsSettingInstanceCollectionResponse ...$items Variable number of WindowsSettingInstanceCollectionResponse items
     * @return self
     */
    public function setValue(WindowsSettingInstanceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WindowsSettingInstanceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WindowsSettingInstanceCollectionResponse $item
     * @return self
     */
    public function addValue(WindowsSettingInstanceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
