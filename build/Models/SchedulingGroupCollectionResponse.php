...
/**
 * Collection response for SchedulingGroup
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SchedulingGroupCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SchedulingGroup[]
     */
     ...
     * 
     * @param SchedulingGroup[] $items
     * @return self
     */
    public function setValue(array|SchedulingGroup $items, SchedulingGroup ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SchedulingGroup> $value
     * @return self
     ...
     * 
     * @param SchedulingGroup $item
     * @return self
     */
    public function addValue(SchedulingGroup $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SchedulingGroup>
     */
