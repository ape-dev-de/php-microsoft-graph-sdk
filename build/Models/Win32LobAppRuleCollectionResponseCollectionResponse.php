...
/**
 * Collection response for Win32LobAppRuleCollectionResponse
 */
class Win32LobAppRuleCollectionResponseCollectionResponse
{
    /**
     * @var Win32LobAppRuleCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param Win32LobAppRuleCollectionResponse ...$items Variable number of Win32LobAppRuleCollectionResponse items
     * @return self
     */
    public function setValue(Win32LobAppRuleCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<Win32LobAppRuleCollectionResponse> $value
     * @return self
     ...
     * 
     * @param Win32LobAppRuleCollectionResponse $item
     * @return self
     */
    public function addValue(Win32LobAppRuleCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
