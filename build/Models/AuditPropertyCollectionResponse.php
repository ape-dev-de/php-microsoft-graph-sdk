...
/**
 * Collection response for AuditProperty
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuditPropertyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuditProperty[]
     */
     ...
     * 
     * @param AuditProperty[] $items
     * @return self
     */
    public function setValue(array|AuditProperty $items, AuditProperty ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuditProperty> $value
     * @return self
     ...
     * 
     * @param AuditProperty $item
     * @return self
     */
    public function addValue(AuditProperty $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuditProperty>
     */
