...
/**
 * Collection response for KeyCredential
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class KeyCredentialCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var KeyCredential[]
     */
     ...
     * 
     * @param KeyCredential[] $items
     * @return self
     */
    public function setValue(array|KeyCredential $items, KeyCredential ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<KeyCredential> $value
     * @return self
     ...
     * 
     * @param KeyCredential $item
     * @return self
     */
    public function addValue(KeyCredential $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, KeyCredential>
     */
