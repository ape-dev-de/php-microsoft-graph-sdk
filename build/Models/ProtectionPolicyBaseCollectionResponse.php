...
/**
 * Collection response for ProtectionPolicyBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProtectionPolicyBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ProtectionPolicyBase[] $items
     * @return self
     */
    public function setValue(array|ProtectionPolicyBase $items, ProtectionPolicyBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProtectionPolicyBase> $value
     * @return self
     ...
     * 
     * @param ProtectionPolicyBase $item
     * @return self
     */
    public function addValue(ProtectionPolicyBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProtectionPolicyBase>
     */
