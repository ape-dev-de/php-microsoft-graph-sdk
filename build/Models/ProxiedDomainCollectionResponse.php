...
/**
 * Collection response for ProxiedDomain
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProxiedDomainCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProxiedDomain[]
     */
     ...
     * 
     * @param ProxiedDomain[] $items
     * @return self
     */
    public function setValue(array|ProxiedDomain $items, ProxiedDomain ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProxiedDomain> $value
     * @return self
     ...
     * 
     * @param ProxiedDomain $item
     * @return self
     */
    public function addValue(ProxiedDomain $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProxiedDomain>
     */
