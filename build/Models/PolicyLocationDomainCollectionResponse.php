...
/**
 * Collection response for PolicyLocationDomain
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PolicyLocationDomainCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PolicyLocationDomain[]
     */
    private array $value = [];
     ...
     * 
     * @param PolicyLocationDomain[] $items
     * @return self
     */
    public function setValue(array|PolicyLocationDomain $items, PolicyLocationDomain ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PolicyLocationDomain> $value
     * @return self
     ...
     * 
     * @param PolicyLocationDomain $item
     * @return self
     */
    public function addValue(PolicyLocationDomain $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PolicyLocationDomain|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PolicyLocationDomain>
     */
