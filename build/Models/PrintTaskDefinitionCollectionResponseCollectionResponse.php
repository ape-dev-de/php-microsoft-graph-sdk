...
/**
 * Collection response for PrintTaskDefinitionCollectionResponse
 */
class PrintTaskDefinitionCollectionResponseCollectionResponse
{
    /**
     * @var PrintTaskDefinitionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PrintTaskDefinitionCollectionResponse ...$items Variable number of PrintTaskDefinitionCollectionResponse items
     * @return self
     */
    public function setValue(PrintTaskDefinitionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PrintTaskDefinitionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PrintTaskDefinitionCollectionResponse $item
     * @return self
     */
    public function addValue(PrintTaskDefinitionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
