...
/**
 * FirewallPreSharedKeyEncodingMethodTypeCollectionResponse - Collection response
 */
class FirewallPreSharedKeyEncodingMethodTypeCollectionResponse
{
    /**
     * @var array<int, FirewallPreSharedKeyEncodingMethodType>
     */
    public array $value = [];
