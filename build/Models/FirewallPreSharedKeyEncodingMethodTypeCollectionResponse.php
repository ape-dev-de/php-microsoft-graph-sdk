...
/**
 * Collection response for FirewallPreSharedKeyEncodingMethodType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FirewallPreSharedKeyEncodingMethodTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FirewallPreSharedKeyEncodingMethodType[]
     */
    private array $value = [];
     ...
     * 
     * @return FirewallPreSharedKeyEncodingMethodType[]
     */
     ...
     * 
     * @param FirewallPreSharedKeyEncodingMethodType[] $items
     * @return self
     */
    public function setValue(array|FirewallPreSharedKeyEncodingMethodType $items, FirewallPreSharedKeyEncodingMethodType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FirewallPreSharedKeyEncodingMethodType> $value
     * @return self
     ...
     * 
     * @param FirewallPreSharedKeyEncodingMethodType $item
     * @return self
     */
    public function addValue(FirewallPreSharedKeyEncodingMethodType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FirewallPreSharedKeyEncodingMethodType>
     */
