 ...
 */
class OmaSettingIntegerCollectionResponse
{
    /**
     ...
     * 
     * @param OmaSettingInteger ...$items Variable number of OmaSettingInteger items
     * @return self
     */
    public function setValue(OmaSettingInteger ...$items): self
    {
        $this->value = $items;
        return $this;
    }
