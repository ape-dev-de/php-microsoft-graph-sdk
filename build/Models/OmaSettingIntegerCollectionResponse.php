...
/**
 * Collection response for OmaSettingInteger
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OmaSettingIntegerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OmaSettingInteger[]
     */
    private array $value = [];
     ...
     * 
     * @param OmaSettingInteger[] $items
     * @return self
     */
    public function setValue(array|OmaSettingInteger $items, OmaSettingInteger ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OmaSettingInteger> $value
     * @return self
     ...
     * 
     * @param OmaSettingInteger $item
     * @return self
     */
    public function addValue(OmaSettingInteger $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OmaSettingInteger>
     */
