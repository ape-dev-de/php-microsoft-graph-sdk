...
/**
 * Collection response for CloudPcOnPremisesConnectionHealthCheck
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcOnPremisesConnectionHealthCheckCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CloudPcOnPremisesConnectionHealthCheck[] $items
     * @return self
     */
    public function setValue(array|CloudPcOnPremisesConnectionHealthCheck $items, CloudPcOnPremisesConnectionHealthCheck ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcOnPremisesConnectionHealthCheck> $value
     * @return self
     ...
     * 
     * @param CloudPcOnPremisesConnectionHealthCheck $item
     * @return self
     */
    public function addValue(CloudPcOnPremisesConnectionHealthCheck $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CloudPcOnPremisesConnectionHealthCheck|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CloudPcOnPremisesConnectionHealthCheck>
     */
