...
/**
 * Collection response for AiInteractionHistory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AiInteractionHistoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AiInteractionHistory[]
     */
    private array $value = [];
     ...
     * 
     * @param AiInteractionHistory[] $items
     * @return self
     */
    public function setValue(array|AiInteractionHistory $items, AiInteractionHistory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AiInteractionHistory> $value
     * @return self
     ...
     * 
     * @param AiInteractionHistory $item
     * @return self
     */
    public function addValue(AiInteractionHistory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AiInteractionHistory>
     */
