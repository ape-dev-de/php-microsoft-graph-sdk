 ...
 */
class IosDeviceTypeCollectionResponse
{
    /**
     * @var IosDeviceType[]
     */
     ...
     * 
     * @param IosDeviceType ...$items Variable number of IosDeviceType items
     * @return self
     */
    public function setValue(IosDeviceType ...$items): self
    {
        $this->value = $items;
        return $this;
    }
