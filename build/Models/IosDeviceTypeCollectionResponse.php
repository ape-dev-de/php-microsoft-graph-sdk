...
/**
 * Collection response for IosDeviceType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosDeviceTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IosDeviceType[]
     */
     ...
     * 
     * @param IosDeviceType[] $items
     * @return self
     */
    public function setValue(array|IosDeviceType $items, IosDeviceType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosDeviceType> $value
     * @return self
     ...
     * 
     * @param IosDeviceType $item
     * @return self
     */
    public function addValue(IosDeviceType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IosDeviceType>
     */
