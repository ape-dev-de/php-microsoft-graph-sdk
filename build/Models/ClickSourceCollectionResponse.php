...
/**
 * Collection response for ClickSource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ClickSourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ClickSource[]
     */
     ...
     * 
     * @param ClickSource[] $items
     * @return self
     */
    public function setValue(array|ClickSource $items, ClickSource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param ClickSource $item
     * @return self
     */
    public function addValue(ClickSource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ClickSource>
     */
