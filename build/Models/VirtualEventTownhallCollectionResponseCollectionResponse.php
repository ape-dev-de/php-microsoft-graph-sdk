...
/**
 * Collection response for VirtualEventTownhallCollectionResponse
 */
class VirtualEventTownhallCollectionResponseCollectionResponse
{
    /**
     * @var VirtualEventTownhallCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param VirtualEventTownhallCollectionResponse ...$items Variable number of VirtualEventTownhallCollectionResponse items
     * @return self
     */
    public function setValue(VirtualEventTownhallCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<VirtualEventTownhallCollectionResponse> $value
     * @return self
     ...
     * 
     * @param VirtualEventTownhallCollectionResponse $item
     * @return self
     */
    public function addValue(VirtualEventTownhallCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
