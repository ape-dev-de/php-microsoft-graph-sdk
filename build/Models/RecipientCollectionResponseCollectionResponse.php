...
/**
 * Collection response for RecipientCollectionResponse
 */
class RecipientCollectionResponseCollectionResponse
{
    /**
     * @var RecipientCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RecipientCollectionResponse ...$items Variable number of RecipientCollectionResponse items
     * @return self
     */
    public function setValue(RecipientCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RecipientCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RecipientCollectionResponse $item
     * @return self
     */
    public function addValue(RecipientCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
