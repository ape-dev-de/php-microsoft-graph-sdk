...
/**
 * Collection response for SecurityAlert
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityAlertCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityAlert[]
     */
     ...
     * 
     * @param SecurityAlert[] $items
     * @return self
     */
    public function setValue(array|SecurityAlert $items, SecurityAlert ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityAlert> $value
     * @return self
     ...
     * 
     * @param SecurityAlert $item
     * @return self
     */
    public function addValue(SecurityAlert $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityAlert>
     */
