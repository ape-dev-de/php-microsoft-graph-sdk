...
/**
 * Collection response for CallRecordsCallType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsCallTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsCallType[]
     */
    private array $value = [];
     ...
     * 
     * @param CallRecordsCallType[] $items
     * @return self
     */
    public function setValue(array|CallRecordsCallType $items, CallRecordsCallType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsCallType> $value
     * @return self
     ...
     * 
     * @param CallRecordsCallType $item
     * @return self
     */
    public function addValue(CallRecordsCallType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsCallType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsCallType>
     */
