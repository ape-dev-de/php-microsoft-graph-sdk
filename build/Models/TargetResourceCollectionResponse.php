...
/**
 * Collection response for TargetResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TargetResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TargetResource[]
     */
     ...
     * 
     * @param TargetResource[] $items
     * @return self
     */
    public function setValue(array|TargetResource $items, TargetResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TargetResource> $value
     * @return self
     ...
     * 
     * @param TargetResource $item
     * @return self
     */
    public function addValue(TargetResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TargetResource>
     */
