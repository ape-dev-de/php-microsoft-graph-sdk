...
/**
 * Collection response for DeviceLocalCredentialInfoCollectionResponse
 */
class DeviceLocalCredentialInfoCollectionResponseCollectionResponse
{
    /**
     * @var DeviceLocalCredentialInfoCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceLocalCredentialInfoCollectionResponse ...$items Variable number of DeviceLocalCredentialInfoCollectionResponse items
     * @return self
     */
    public function setValue(DeviceLocalCredentialInfoCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeviceLocalCredentialInfoCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeviceLocalCredentialInfoCollectionResponse $item
     * @return self
     */
    public function addValue(DeviceLocalCredentialInfoCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
