...
/**
 * Collection response for WindowsWebAppCollectionResponse
 */
class WindowsWebAppCollectionResponseCollectionResponse
{
    /**
     * @var WindowsWebAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsWebAppCollectionResponse ...$items Variable number of WindowsWebAppCollectionResponse items
     * @return self
     */
    public function setValue(WindowsWebAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WindowsWebAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WindowsWebAppCollectionResponse $item
     * @return self
     */
    public function addValue(WindowsWebAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
