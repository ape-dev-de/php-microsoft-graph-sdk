...
/**
 * Collection response for ManagedDeviceMobileAppConfigurationUserStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedDeviceMobileAppConfigurationUserStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ManagedDeviceMobileAppConfigurationUserStatus[] $items
     * @return self
     */
    public function setValue(array|ManagedDeviceMobileAppConfigurationUserStatus $items, ManagedDeviceMobileAppConfigurationUserStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedDeviceMobileAppConfigurationUserStatus> $value
     * @return self
     ...
     * 
     * @param ManagedDeviceMobileAppConfigurationUserStatus $item
     * @return self
     */
    public function addValue(ManagedDeviceMobileAppConfigurationUserStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedDeviceMobileAppConfigurationUserStatus>
     */
