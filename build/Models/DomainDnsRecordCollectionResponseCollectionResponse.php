...
/**
 * Collection response for DomainDnsRecordCollectionResponse
 */
class DomainDnsRecordCollectionResponseCollectionResponse
{
    /**
     * @var DomainDnsRecordCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DomainDnsRecordCollectionResponse ...$items Variable number of DomainDnsRecordCollectionResponse items
     * @return self
     */
    public function setValue(DomainDnsRecordCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DomainDnsRecordCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DomainDnsRecordCollectionResponse $item
     * @return self
     */
    public function addValue(DomainDnsRecordCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
