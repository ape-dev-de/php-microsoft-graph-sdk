...
/**
 * Collection response for WorkbookOperationCollectionResponse
 */
class WorkbookOperationCollectionResponseCollectionResponse
{
    /**
     * @var WorkbookOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookOperationCollectionResponse ...$items Variable number of WorkbookOperationCollectionResponse items
     * @return self
     */
    public function setValue(WorkbookOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WorkbookOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WorkbookOperationCollectionResponse $item
     * @return self
     */
    public function addValue(WorkbookOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
