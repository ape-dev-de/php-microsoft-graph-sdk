...
/**
 * Collection response for EligibilityScheduleInstanceFilterByCurrentUserOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EligibilityScheduleInstanceFilterByCurrentUserOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EligibilityScheduleInstanceFilterByCurrentUserOptions[]
     */
    private array $value = [];
     ...
     * 
     * @return EligibilityScheduleInstanceFilterByCurrentUserOptions[]
     */
     ...
     * 
     * @param EligibilityScheduleInstanceFilterByCurrentUserOptions[] $items
     * @return self
     */
    public function setValue(array|EligibilityScheduleInstanceFilterByCurrentUserOptions $items, EligibilityScheduleInstanceFilterByCurrentUserOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EligibilityScheduleInstanceFilterByCurrentUserOptions> $value
     * @return self
     ...
     * 
     * @param EligibilityScheduleInstanceFilterByCurrentUserOptions $item
     * @return self
     */
    public function addValue(EligibilityScheduleInstanceFilterByCurrentUserOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EligibilityScheduleInstanceFilterByCurrentUserOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EligibilityScheduleInstanceFilterByCurrentUserOptions>
     */
