...
/**
 * EligibilityScheduleInstanceFilterByCurrentUserOptionsCollectionResponse - Collection response
 */
class EligibilityScheduleInstanceFilterByCurrentUserOptionsCollectionResponse
{
    /**
     * @var array<int, EligibilityScheduleInstanceFilterByCurrentUserOptions>
     */
    public array $value = [];
