 ...
 */
class CallRecordsParticipantEndpointCollectionResponse
{
    /**
     ...
     * 
     * @param CallRecordsParticipantEndpoint ...$items Variable number of CallRecordsParticipantEndpoint items
     * @return self
     */
    public function setValue(CallRecordsParticipantEndpoint ...$items): self
    {
        $this->value = $items;
        return $this;
    }
