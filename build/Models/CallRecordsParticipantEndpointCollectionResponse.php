...
/**
 * Collection response for CallRecordsParticipantEndpoint
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsParticipantEndpointCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsParticipantEndpoint[]
     */
    private array $value = [];
     ...
     * 
     * @return CallRecordsParticipantEndpoint[]
     */
     ...
     * 
     * @param CallRecordsParticipantEndpoint[] $items
     * @return self
     */
    public function setValue(array|CallRecordsParticipantEndpoint $items, CallRecordsParticipantEndpoint ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsParticipantEndpoint> $value
     * @return self
     ...
     * 
     * @param CallRecordsParticipantEndpoint $item
     * @return self
     */
    public function addValue(CallRecordsParticipantEndpoint $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsParticipantEndpoint|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsParticipantEndpoint>
     */
