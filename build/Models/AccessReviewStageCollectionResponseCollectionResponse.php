...
/**
 * Collection response for AccessReviewStageCollectionResponse
 */
class AccessReviewStageCollectionResponseCollectionResponse
{
    /**
     * @var AccessReviewStageCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessReviewStageCollectionResponse ...$items Variable number of AccessReviewStageCollectionResponse items
     * @return self
     */
    public function setValue(AccessReviewStageCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AccessReviewStageCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AccessReviewStageCollectionResponse $item
     * @return self
     */
    public function addValue(AccessReviewStageCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
