...
/**
 * Collection response for SecurityCitationTemplate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityCitationTemplateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityCitationTemplate[] $items
     * @return self
     */
    public function setValue(array|SecurityCitationTemplate $items, SecurityCitationTemplate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityCitationTemplate> $value
     * @return self
     ...
     * 
     * @param SecurityCitationTemplate $item
     * @return self
     */
    public function addValue(SecurityCitationTemplate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityCitationTemplate>
     */
