...
/**
 * Collection response for AlertDetectionCollectionResponse
 */
class AlertDetectionCollectionResponseCollectionResponse
{
    /**
     * @var AlertDetectionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AlertDetectionCollectionResponse ...$items Variable number of AlertDetectionCollectionResponse items
     * @return self
     */
    public function setValue(AlertDetectionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AlertDetectionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AlertDetectionCollectionResponse $item
     * @return self
     */
    public function addValue(AlertDetectionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
