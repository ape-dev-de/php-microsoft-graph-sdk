 ...
 */
class SynchronizationSchemaCollectionResponse
{
    /**
     ...
     * 
     * @param SynchronizationSchema ...$items Variable number of SynchronizationSchema items
     * @return self
     */
    public function setValue(SynchronizationSchema ...$items): self
    {
        $this->value = $items;
        return $this;
    }
