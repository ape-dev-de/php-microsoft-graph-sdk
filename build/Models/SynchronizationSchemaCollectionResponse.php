...
/**
 * Collection response for SynchronizationSchema
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationSchemaCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SynchronizationSchema[]
     */
    private array $value = [];
     ...
     * 
     * @param SynchronizationSchema[] $items
     * @return self
     */
    public function setValue(array|SynchronizationSchema $items, SynchronizationSchema ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SynchronizationSchema> $value
     * @return self
     ...
     * 
     * @param SynchronizationSchema $item
     * @return self
     */
    public function addValue(SynchronizationSchema $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SynchronizationSchema>
     */
