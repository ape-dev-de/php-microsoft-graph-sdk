...
/**
 * Collection response for SecurityIpAddress
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityIpAddressCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityIpAddress[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityIpAddress[] $items
     * @return self
     */
    public function setValue(array|SecurityIpAddress $items, SecurityIpAddress ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityIpAddress> $value
     * @return self
     ...
     * 
     * @param SecurityIpAddress $item
     * @return self
     */
    public function addValue(SecurityIpAddress $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityIpAddress>
     */
