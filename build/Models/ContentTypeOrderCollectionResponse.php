...
/**
 * Collection response for ContentTypeOrder
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ContentTypeOrderCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ContentTypeOrder[] $items
     * @return self
     */
    public function setValue(array|ContentTypeOrder $items, ContentTypeOrder ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ContentTypeOrder> $value
     * @return self
     ...
     * 
     * @param ContentTypeOrder $item
     * @return self
     */
    public function addValue(ContentTypeOrder $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ContentTypeOrder>
     */
