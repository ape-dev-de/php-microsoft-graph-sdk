 ...
 */
class ContentTypeOrderCollectionResponse
{
    /**
     ...
     * 
     * @param ContentTypeOrder ...$items Variable number of ContentTypeOrder items
     * @return self
     */
    public function setValue(ContentTypeOrder ...$items): self
    {
        $this->value = $items;
        return $this;
    }
