...
/**
 * Collection response for AuthorizationPolicyCollectionResponse
 */
class AuthorizationPolicyCollectionResponseCollectionResponse
{
    /**
     * @var AuthorizationPolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AuthorizationPolicyCollectionResponse ...$items Variable number of AuthorizationPolicyCollectionResponse items
     * @return self
     */
    public function setValue(AuthorizationPolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AuthorizationPolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AuthorizationPolicyCollectionResponse $item
     * @return self
     */
    public function addValue(AuthorizationPolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
