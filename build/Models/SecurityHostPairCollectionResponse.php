...
/**
 * Collection response for SecurityHostPair
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHostPairCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityHostPair[] $items
     * @return self
     */
    public function setValue(array|SecurityHostPair $items, SecurityHostPair ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHostPair> $value
     * @return self
     ...
     * 
     * @param SecurityHostPair $item
     * @return self
     */
    public function addValue(SecurityHostPair $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityHostPair>
     */
