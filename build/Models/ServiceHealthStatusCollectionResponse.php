...
/**
 * Collection response for ServiceHealthStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServiceHealthStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ServiceHealthStatus[] $items
     * @return self
     */
    public function setValue(array|ServiceHealthStatus $items, ServiceHealthStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServiceHealthStatus> $value
     * @return self
     ...
     * 
     * @param ServiceHealthStatus $item
     * @return self
     */
    public function addValue(ServiceHealthStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ServiceHealthStatus>
     */
