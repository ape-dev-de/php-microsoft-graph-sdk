...
/**
 * Collection response for OnEmailOtpSendListenerCollectionResponse
 */
class OnEmailOtpSendListenerCollectionResponseCollectionResponse
{
    /**
     * @var OnEmailOtpSendListenerCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return OnEmailOtpSendListenerCollectionResponse[]
     */
     ...
     * 
     * @param OnEmailOtpSendListenerCollectionResponse ...$items Variable number of OnEmailOtpSendListenerCollectionResponse items
     * @return self
     */
    public function setValue(OnEmailOtpSendListenerCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<OnEmailOtpSendListenerCollectionResponse> $value
     * @return self
     ...
     * 
     * @param OnEmailOtpSendListenerCollectionResponse $item
     * @return self
     */
    public function addValue(OnEmailOtpSendListenerCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
