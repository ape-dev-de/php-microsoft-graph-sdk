...
/**
 * Collection response for MobileAppCategoryCollectionResponse
 */
class MobileAppCategoryCollectionResponseCollectionResponse
{
    /**
     * @var MobileAppCategoryCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MobileAppCategoryCollectionResponse ...$items Variable number of MobileAppCategoryCollectionResponse items
     * @return self
     */
    public function setValue(MobileAppCategoryCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MobileAppCategoryCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MobileAppCategoryCollectionResponse $item
     * @return self
     */
    public function addValue(MobileAppCategoryCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
