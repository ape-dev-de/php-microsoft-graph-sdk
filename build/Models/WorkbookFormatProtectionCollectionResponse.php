 ...
 */
class WorkbookFormatProtectionCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookFormatProtection ...$items Variable number of WorkbookFormatProtection items
     * @return self
     */
    public function setValue(WorkbookFormatProtection ...$items): self
    {
        $this->value = $items;
        return $this;
    }
