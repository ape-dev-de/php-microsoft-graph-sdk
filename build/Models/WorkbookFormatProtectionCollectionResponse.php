...
/**
 * Collection response for WorkbookFormatProtection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookFormatProtectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookFormatProtection[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookFormatProtection[] $items
     * @return self
     */
    public function setValue(array|WorkbookFormatProtection $items, WorkbookFormatProtection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookFormatProtection> $value
     * @return self
     ...
     * 
     * @param WorkbookFormatProtection $item
     * @return self
     */
    public function addValue(WorkbookFormatProtection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookFormatProtection>
     */
