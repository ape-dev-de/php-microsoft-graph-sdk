...
/**
 * Collection response for PrintJobStateDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintJobStateDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PrintJobStateDetail[] $items
     * @return self
     */
    public function setValue(array|PrintJobStateDetail $items, PrintJobStateDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintJobStateDetail> $value
     * @return self
     ...
     * 
     * @param PrintJobStateDetail $item
     * @return self
     */
    public function addValue(PrintJobStateDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PrintJobStateDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PrintJobStateDetail>
     */
