...
/**
 * Collection response for ContentActivityCollectionResponse
 */
class ContentActivityCollectionResponseCollectionResponse
{
    /**
     * @var ContentActivityCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ContentActivityCollectionResponse ...$items Variable number of ContentActivityCollectionResponse items
     * @return self
     */
    public function setValue(ContentActivityCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ContentActivityCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ContentActivityCollectionResponse $item
     * @return self
     */
    public function addValue(ContentActivityCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
