...
/**
 * Collection response for ServicePlanInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServicePlanInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ServicePlanInfo[]
     */
     ...
     * 
     * @param ServicePlanInfo[] $items
     * @return self
     */
    public function setValue(array|ServicePlanInfo $items, ServicePlanInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServicePlanInfo> $value
     * @return self
     ...
     * 
     * @param ServicePlanInfo $item
     * @return self
     */
    public function addValue(ServicePlanInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ServicePlanInfo>
     */
