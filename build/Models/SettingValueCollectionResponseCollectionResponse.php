...
/**
 * Collection response for SettingValueCollectionResponse
 */
class SettingValueCollectionResponseCollectionResponse
{
    /**
     * @var SettingValueCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SettingValueCollectionResponse ...$items Variable number of SettingValueCollectionResponse items
     * @return self
     */
    public function setValue(SettingValueCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SettingValueCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SettingValueCollectionResponse $item
     * @return self
     */
    public function addValue(SettingValueCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
