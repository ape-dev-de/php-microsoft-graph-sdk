...
/**
 * Collection response for DelegatedAdminServiceManagementDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DelegatedAdminServiceManagementDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DelegatedAdminServiceManagementDetail[] $items
     * @return self
     */
    public function setValue(array|DelegatedAdminServiceManagementDetail $items, DelegatedAdminServiceManagementDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DelegatedAdminServiceManagementDetail> $value
     * @return self
     ...
     * 
     * @param DelegatedAdminServiceManagementDetail $item
     * @return self
     */
    public function addValue(DelegatedAdminServiceManagementDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DelegatedAdminServiceManagementDetail>
     */
