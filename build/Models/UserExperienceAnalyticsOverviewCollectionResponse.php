...
/**
 * Collection response for UserExperienceAnalyticsOverview
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsOverviewCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserExperienceAnalyticsOverview[]
     */
    private array $value = [];
     ...
     * 
     * @param UserExperienceAnalyticsOverview[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsOverview $items, UserExperienceAnalyticsOverview ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsOverview> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsOverview $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsOverview $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsOverview>
     */
