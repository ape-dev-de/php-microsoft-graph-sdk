 ...
 */
class UserExperienceAnalyticsOverviewCollectionResponse
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsOverview ...$items Variable number of UserExperienceAnalyticsOverview items
     * @return self
     */
    public function setValue(UserExperienceAnalyticsOverview ...$items): self
    {
        $this->value = $items;
        return $this;
    }
