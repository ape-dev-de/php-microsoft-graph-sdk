...
/**
 * Collection response for UriClickSecurityState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UriClickSecurityStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UriClickSecurityState[]
     */
    private array $value = [];
     ...
     * 
     * @param UriClickSecurityState[] $items
     * @return self
     */
    public function setValue(array|UriClickSecurityState $items, UriClickSecurityState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UriClickSecurityState> $value
     * @return self
     ...
     * 
     * @param UriClickSecurityState $item
     * @return self
     */
    public function addValue(UriClickSecurityState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UriClickSecurityState|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UriClickSecurityState>
     */
