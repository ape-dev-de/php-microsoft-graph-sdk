 ...
 */
class RestoreSessionArtifactCountCollectionResponse
{
    /**
     ...
     * 
     * @param RestoreSessionArtifactCount ...$items Variable number of RestoreSessionArtifactCount items
     * @return self
     */
    public function setValue(RestoreSessionArtifactCount ...$items): self
    {
        $this->value = $items;
        return $this;
    }
