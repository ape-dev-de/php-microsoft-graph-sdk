...
/**
 * Collection response for RestoreSessionArtifactCount
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RestoreSessionArtifactCountCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RestoreSessionArtifactCount[]
     */
    private array $value = [];
     ...
     * 
     * @param RestoreSessionArtifactCount[] $items
     * @return self
     */
    public function setValue(array|RestoreSessionArtifactCount $items, RestoreSessionArtifactCount ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RestoreSessionArtifactCount> $value
     * @return self
     ...
     * 
     * @param RestoreSessionArtifactCount $item
     * @return self
     */
    public function addValue(RestoreSessionArtifactCount $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RestoreSessionArtifactCount>
     */
