...
/**
 * Collection response for CloudPcOnPremisesConnectionStatusDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcOnPremisesConnectionStatusDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudPcOnPremisesConnectionStatusDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudPcOnPremisesConnectionStatusDetail[] $items
     * @return self
     */
    public function setValue(array|CloudPcOnPremisesConnectionStatusDetail $items, CloudPcOnPremisesConnectionStatusDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcOnPremisesConnectionStatusDetail> $value
     * @return self
     ...
     * 
     * @param CloudPcOnPremisesConnectionStatusDetail $item
     * @return self
     */
    public function addValue(CloudPcOnPremisesConnectionStatusDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcOnPremisesConnectionStatusDetail>
     */
