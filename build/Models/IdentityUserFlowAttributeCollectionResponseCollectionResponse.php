...
/**
 * Collection response for IdentityUserFlowAttributeCollectionResponse
 */
class IdentityUserFlowAttributeCollectionResponseCollectionResponse
{
    /**
     * @var IdentityUserFlowAttributeCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityUserFlowAttributeCollectionResponse ...$items Variable number of IdentityUserFlowAttributeCollectionResponse items
     * @return self
     */
    public function setValue(IdentityUserFlowAttributeCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IdentityUserFlowAttributeCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IdentityUserFlowAttributeCollectionResponse $item
     * @return self
     */
    public function addValue(IdentityUserFlowAttributeCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
