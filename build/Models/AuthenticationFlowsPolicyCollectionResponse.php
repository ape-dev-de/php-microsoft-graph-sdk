...
/**
 * Collection response for AuthenticationFlowsPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationFlowsPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuthenticationFlowsPolicy[]
     */
    private array $value = [];
     ...
     * 
     * @param AuthenticationFlowsPolicy[] $items
     * @return self
     */
    public function setValue(array|AuthenticationFlowsPolicy $items, AuthenticationFlowsPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationFlowsPolicy> $value
     * @return self
     ...
     * 
     * @param AuthenticationFlowsPolicy $item
     * @return self
     */
    public function addValue(AuthenticationFlowsPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationFlowsPolicy>
     */
