 ...
 */
class AuthenticationFlowsPolicyCollectionResponse
{
    /**
     ...
     * 
     * @param AuthenticationFlowsPolicy ...$items Variable number of AuthenticationFlowsPolicy items
     * @return self
     */
    public function setValue(AuthenticationFlowsPolicy ...$items): self
    {
        $this->value = $items;
        return $this;
    }
