...
/**
 * Collection response for SecurityPurgeType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityPurgeTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityPurgeType[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityPurgeType[] $items
     * @return self
     */
    public function setValue(array|SecurityPurgeType $items, SecurityPurgeType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityPurgeType> $value
     * @return self
     ...
     * 
     * @param SecurityPurgeType $item
     * @return self
     */
    public function addValue(SecurityPurgeType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityPurgeType>
     */
