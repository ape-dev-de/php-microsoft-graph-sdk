...
/**
 * Collection response for MobileThreatDefenseConnector
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MobileThreatDefenseConnectorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MobileThreatDefenseConnector[] $items
     * @return self
     */
    public function setValue(array|MobileThreatDefenseConnector $items, MobileThreatDefenseConnector ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MobileThreatDefenseConnector> $value
     * @return self
     ...
     * 
     * @param MobileThreatDefenseConnector $item
     * @return self
     */
    public function addValue(MobileThreatDefenseConnector $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MobileThreatDefenseConnector>
     */
