...
/**
 * Collection response for EducationChannelResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationChannelResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationChannelResource[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationChannelResource[] $items
     * @return self
     */
    public function setValue(array|EducationChannelResource $items, EducationChannelResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationChannelResource> $value
     * @return self
     ...
     * 
     * @param EducationChannelResource $item
     * @return self
     */
    public function addValue(EducationChannelResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EducationChannelResource|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EducationChannelResource>
     */
