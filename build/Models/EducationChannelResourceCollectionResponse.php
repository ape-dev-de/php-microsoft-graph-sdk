 ...
 */
class EducationChannelResourceCollectionResponse
{
    /**
     ...
     * 
     * @param EducationChannelResource ...$items Variable number of EducationChannelResource items
     * @return self
     */
    public function setValue(EducationChannelResource ...$items): self
    {
        $this->value = $items;
        return $this;
    }
