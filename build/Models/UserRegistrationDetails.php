...
class UserRegistrationDetails
{
     ...
     * @var string[]
     */
    private array $methodsRegistered = [];
     ...
     * @var string[]
     */
    private array $systemPreferredAuthenticationMethods = [];
    ...
    /**
     * @param string[] $methodsRegistered
     */
    public function setMethodsRegistered(array $methodsRegistered): self
    {
    ...
    /**
     * @param string[] $systemPreferredAuthenticationMethods
     */
    public function setSystemPreferredAuthenticationMethods(array $systemPreferredAuthenticationMethods): self
    {
