...
/**
 * Collection response for SecuritySslCertificateEntity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecuritySslCertificateEntityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecuritySslCertificateEntity[]
     */
    private array $value = [];
     ...
     * 
     * @return SecuritySslCertificateEntity[]
     */
     ...
     * 
     * @param SecuritySslCertificateEntity[] $items
     * @return self
     */
    public function setValue(array|SecuritySslCertificateEntity $items, SecuritySslCertificateEntity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecuritySslCertificateEntity> $value
     * @return self
     ...
     * 
     * @param SecuritySslCertificateEntity $item
     * @return self
     */
    public function addValue(SecuritySslCertificateEntity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecuritySslCertificateEntity|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecuritySslCertificateEntity>
     */
