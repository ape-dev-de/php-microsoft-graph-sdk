 ...
 */
class SecuritySslCertificateEntityCollectionResponse
{
    /**
     ...
     * 
     * @param SecuritySslCertificateEntity ...$items Variable number of SecuritySslCertificateEntity items
     * @return self
     */
    public function setValue(SecuritySslCertificateEntity ...$items): self
    {
        $this->value = $items;
        return $this;
    }
