...
/**
 * Collection response for PlannerAssignments
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerAssignmentsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PlannerAssignments[] $items
     * @return self
     */
    public function setValue(array|PlannerAssignments $items, PlannerAssignments ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PlannerAssignments> $value
     * @return self
     ...
     * 
     * @param PlannerAssignments $item
     * @return self
     */
    public function addValue(PlannerAssignments $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PlannerAssignments>
     */
