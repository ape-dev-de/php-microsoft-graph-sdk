...
/**
 * Collection response for VolumeType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VolumeTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VolumeType[]
     */
     ...
     * 
     * @param VolumeType[] $items
     * @return self
     */
    public function setValue(array|VolumeType $items, VolumeType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param VolumeType $item
     * @return self
     */
    public function addValue(VolumeType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VolumeType>
     */
