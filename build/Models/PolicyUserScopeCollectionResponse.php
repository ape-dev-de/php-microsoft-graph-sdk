...
/**
 * Collection response for PolicyUserScope
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PolicyUserScopeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PolicyUserScope[]
     */
     ...
     * 
     * @param PolicyUserScope[] $items
     * @return self
     */
    public function setValue(array|PolicyUserScope $items, PolicyUserScope ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PolicyUserScope> $value
     * @return self
     ...
     * 
     * @param PolicyUserScope $item
     * @return self
     */
    public function addValue(PolicyUserScope $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PolicyUserScope>
     */
