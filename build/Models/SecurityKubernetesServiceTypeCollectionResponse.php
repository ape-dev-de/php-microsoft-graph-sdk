...
/**
 * Collection response for SecurityKubernetesServiceType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityKubernetesServiceTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityKubernetesServiceType[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityKubernetesServiceType[]
     */
     ...
     * 
     * @param SecurityKubernetesServiceType[] $items
     * @return self
     */
    public function setValue(array|SecurityKubernetesServiceType $items, SecurityKubernetesServiceType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityKubernetesServiceType> $value
     * @return self
     ...
     * 
     * @param SecurityKubernetesServiceType $item
     * @return self
     */
    public function addValue(SecurityKubernetesServiceType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityKubernetesServiceType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityKubernetesServiceType>
     */
