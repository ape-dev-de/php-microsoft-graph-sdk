...
/**
 * SecurityKubernetesServiceTypeCollectionResponse - Collection response
 */
class SecurityKubernetesServiceTypeCollectionResponse
{
    /**
     * @var array<int, SecurityKubernetesServiceType>
     */
    public array $value = [];
