...
/**
 * Collection response for TrainingNotificationSetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TrainingNotificationSettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TrainingNotificationSetting[]
     */
    private array $value = [];
     ...
     * 
     * @param TrainingNotificationSetting[] $items
     * @return self
     */
    public function setValue(array|TrainingNotificationSetting $items, TrainingNotificationSetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TrainingNotificationSetting> $value
     * @return self
     ...
     * 
     * @param TrainingNotificationSetting $item
     * @return self
     */
    public function addValue(TrainingNotificationSetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TrainingNotificationSetting|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TrainingNotificationSetting>
     */
