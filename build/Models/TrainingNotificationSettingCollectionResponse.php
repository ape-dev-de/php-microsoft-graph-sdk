 ...
 */
class TrainingNotificationSettingCollectionResponse
{
    /**
     ...
     * 
     * @param TrainingNotificationSetting ...$items Variable number of TrainingNotificationSetting items
     * @return self
     */
    public function setValue(TrainingNotificationSetting ...$items): self
    {
        $this->value = $items;
        return $this;
    }
