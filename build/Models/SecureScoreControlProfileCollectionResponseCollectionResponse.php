...
/**
 * Collection response for SecureScoreControlProfileCollectionResponse
 */
class SecureScoreControlProfileCollectionResponseCollectionResponse
{
    /**
     * @var SecureScoreControlProfileCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecureScoreControlProfileCollectionResponse ...$items Variable number of SecureScoreControlProfileCollectionResponse items
     * @return self
     */
    public function setValue(SecureScoreControlProfileCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecureScoreControlProfileCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecureScoreControlProfileCollectionResponse $item
     * @return self
     */
    public function addValue(SecureScoreControlProfileCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
