...
/**
 * Collection response for RatingNewZealandTelevisionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RatingNewZealandTelevisionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RatingNewZealandTelevisionType[]
     */
    private array $value = [];
     ...
     * 
     * @return RatingNewZealandTelevisionType[]
     */
     ...
     * 
     * @param RatingNewZealandTelevisionType[] $items
     * @return self
     */
    public function setValue(array|RatingNewZealandTelevisionType $items, RatingNewZealandTelevisionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RatingNewZealandTelevisionType> $value
     * @return self
     ...
     * 
     * @param RatingNewZealandTelevisionType $item
     * @return self
     */
    public function addValue(RatingNewZealandTelevisionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RatingNewZealandTelevisionType>
     */
