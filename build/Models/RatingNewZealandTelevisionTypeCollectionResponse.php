...
/**
 * RatingNewZealandTelevisionTypeCollectionResponse - Collection response
 */
class RatingNewZealandTelevisionTypeCollectionResponse
{
    /**
     * @var array<int, RatingNewZealandTelevisionType>
     */
    public array $value = [];
