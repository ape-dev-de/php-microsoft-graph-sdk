...
/**
 * Collection response for FreeBusyStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FreeBusyStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FreeBusyStatus[]
     */
     ...
     * 
     * @param FreeBusyStatus[] $items
     * @return self
     */
    public function setValue(array|FreeBusyStatus $items, FreeBusyStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FreeBusyStatus> $value
     * @return self
     ...
     * 
     * @param FreeBusyStatus $item
     * @return self
     */
    public function addValue(FreeBusyStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FreeBusyStatus>
     */
