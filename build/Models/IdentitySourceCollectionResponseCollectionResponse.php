...
/**
 * Collection response for IdentitySourceCollectionResponse
 */
class IdentitySourceCollectionResponseCollectionResponse
{
    /**
     * @var IdentitySourceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentitySourceCollectionResponse ...$items Variable number of IdentitySourceCollectionResponse items
     * @return self
     */
    public function setValue(IdentitySourceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IdentitySourceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IdentitySourceCollectionResponse $item
     * @return self
     */
    public function addValue(IdentitySourceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
