 ...
 */
class OutOfBoxExperienceSettingCollectionResponse
{
    /**
     ...
     * 
     * @param OutOfBoxExperienceSetting ...$items Variable number of OutOfBoxExperienceSetting items
     * @return self
     */
    public function setValue(OutOfBoxExperienceSetting ...$items): self
    {
        $this->value = $items;
        return $this;
    }
