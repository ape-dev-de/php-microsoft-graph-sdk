...
/**
 * Collection response for OutOfBoxExperienceSetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OutOfBoxExperienceSettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OutOfBoxExperienceSetting[]
     */
    private array $value = [];
     ...
     * 
     * @param OutOfBoxExperienceSetting[] $items
     * @return self
     */
    public function setValue(array|OutOfBoxExperienceSetting $items, OutOfBoxExperienceSetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OutOfBoxExperienceSetting> $value
     * @return self
     ...
     * 
     * @param OutOfBoxExperienceSetting $item
     * @return self
     */
    public function addValue(OutOfBoxExperienceSetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OutOfBoxExperienceSetting>
     */
