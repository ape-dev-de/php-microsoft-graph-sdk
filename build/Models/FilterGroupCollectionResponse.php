...
/**
 * Collection response for FilterGroup
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FilterGroupCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FilterGroup[]
     */
     ...
     * 
     * @param FilterGroup[] $items
     * @return self
     */
    public function setValue(array|FilterGroup $items, FilterGroup ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param FilterGroup $item
     * @return self
     */
    public function addValue(FilterGroup $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FilterGroup>
     */
