...
/**
 * Collection response for ManagedAppStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedAppStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ManagedAppStatus[] $items
     * @return self
     */
    public function setValue(array|ManagedAppStatus $items, ManagedAppStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedAppStatus> $value
     * @return self
     ...
     * 
     * @param ManagedAppStatus $item
     * @return self
     */
    public function addValue(ManagedAppStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedAppStatus>
     */
