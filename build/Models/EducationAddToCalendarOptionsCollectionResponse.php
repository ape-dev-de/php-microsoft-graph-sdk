...
/**
 * Collection response for EducationAddToCalendarOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationAddToCalendarOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationAddToCalendarOptions[]
     */
    private array $value = [];
     ...
     * 
     * @return EducationAddToCalendarOptions[]
     */
     ...
     * 
     * @param EducationAddToCalendarOptions[] $items
     * @return self
     */
    public function setValue(array|EducationAddToCalendarOptions $items, EducationAddToCalendarOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationAddToCalendarOptions> $value
     * @return self
     ...
     * 
     * @param EducationAddToCalendarOptions $item
     * @return self
     */
    public function addValue(EducationAddToCalendarOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationAddToCalendarOptions>
     */
