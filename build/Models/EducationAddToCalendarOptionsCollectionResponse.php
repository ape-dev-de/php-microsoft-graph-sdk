...
/**
 * EducationAddToCalendarOptionsCollectionResponse - Collection response
 */
class EducationAddToCalendarOptionsCollectionResponse
{
    /**
     * @var array<int, EducationAddToCalendarOptions>
     */
    public array $value = [];
