 ...
 */
class SecurityOcrSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityOcrSettings ...$items Variable number of SecurityOcrSettings items
     * @return self
     */
    public function setValue(SecurityOcrSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
