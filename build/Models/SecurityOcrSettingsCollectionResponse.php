...
/**
 * Collection response for SecurityOcrSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityOcrSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityOcrSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityOcrSettings[] $items
     * @return self
     */
    public function setValue(array|SecurityOcrSettings $items, SecurityOcrSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityOcrSettings> $value
     * @return self
     ...
     * 
     * @param SecurityOcrSettings $item
     * @return self
     */
    public function addValue(SecurityOcrSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityOcrSettings|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityOcrSettings>
     */
