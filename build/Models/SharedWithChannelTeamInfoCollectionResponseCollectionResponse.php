...
/**
 * Collection response for SharedWithChannelTeamInfoCollectionResponse
 */
class SharedWithChannelTeamInfoCollectionResponseCollectionResponse
{
    /**
     * @var SharedWithChannelTeamInfoCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SharedWithChannelTeamInfoCollectionResponse ...$items Variable number of SharedWithChannelTeamInfoCollectionResponse items
     * @return self
     */
    public function setValue(SharedWithChannelTeamInfoCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SharedWithChannelTeamInfoCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SharedWithChannelTeamInfoCollectionResponse $item
     * @return self
     */
    public function addValue(SharedWithChannelTeamInfoCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
