...
/**
 * Collection response for Workbook
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Workbook[]
     */
     ...
     * 
     * @param Workbook[] $items
     * @return self
     */
    public function setValue(array|Workbook $items, Workbook ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Workbook $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Workbook>
     */
