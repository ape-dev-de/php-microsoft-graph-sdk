...
/**
 * Collection response for CalendarCollectionResponse
 */
class CalendarCollectionResponseCollectionResponse
{
    /**
     * @var CalendarCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CalendarCollectionResponse ...$items Variable number of CalendarCollectionResponse items
     * @return self
     */
    public function setValue(CalendarCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CalendarCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CalendarCollectionResponse $item
     * @return self
     */
    public function addValue(CalendarCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
