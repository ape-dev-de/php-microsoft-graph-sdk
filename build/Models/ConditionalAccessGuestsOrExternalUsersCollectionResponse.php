...
/**
 * Collection response for ConditionalAccessGuestsOrExternalUsers
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessGuestsOrExternalUsersCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessGuestsOrExternalUsers[]
     */
    private array $value = [];
     ...
     * 
     * @param ConditionalAccessGuestsOrExternalUsers[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessGuestsOrExternalUsers $items, ConditionalAccessGuestsOrExternalUsers ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessGuestsOrExternalUsers> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessGuestsOrExternalUsers $item
     * @return self
     */
    public function addValue(ConditionalAccessGuestsOrExternalUsers $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessGuestsOrExternalUsers>
     */
