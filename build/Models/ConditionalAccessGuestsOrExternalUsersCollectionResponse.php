 ...
 */
class ConditionalAccessGuestsOrExternalUsersCollectionResponse
{
    /**
     ...
     * 
     * @param ConditionalAccessGuestsOrExternalUsers ...$items Variable number of ConditionalAccessGuestsOrExternalUsers items
     * @return self
     */
    public function setValue(ConditionalAccessGuestsOrExternalUsers ...$items): self
    {
        $this->value = $items;
        return $this;
    }
