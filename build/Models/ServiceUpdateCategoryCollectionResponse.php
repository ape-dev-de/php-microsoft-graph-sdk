...
/**
 * Collection response for ServiceUpdateCategory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServiceUpdateCategoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ServiceUpdateCategory[]
     */
    private array $value = [];
     ...
     * 
     * @param ServiceUpdateCategory[] $items
     * @return self
     */
    public function setValue(array|ServiceUpdateCategory $items, ServiceUpdateCategory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServiceUpdateCategory> $value
     * @return self
     ...
     * 
     * @param ServiceUpdateCategory $item
     * @return self
     */
    public function addValue(ServiceUpdateCategory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ServiceUpdateCategory>
     */
