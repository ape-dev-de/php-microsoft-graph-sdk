...
/**
 * ImportedWindowsAutopilotDeviceIdentityImportStatusCollectionResponse - Collection response
 */
class ImportedWindowsAutopilotDeviceIdentityImportStatusCollectionResponse
{
    /**
     * @var array<int, ImportedWindowsAutopilotDeviceIdentityImportStatus>
     */
    public array $value = [];
