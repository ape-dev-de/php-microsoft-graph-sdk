...
/**
 * Collection response for ImportedWindowsAutopilotDeviceIdentityImportStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ImportedWindowsAutopilotDeviceIdentityImportStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ImportedWindowsAutopilotDeviceIdentityImportStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return ImportedWindowsAutopilotDeviceIdentityImportStatus[]
     */
     ...
     * 
     * @param ImportedWindowsAutopilotDeviceIdentityImportStatus[] $items
     * @return self
     */
    public function setValue(array|ImportedWindowsAutopilotDeviceIdentityImportStatus $items, ImportedWindowsAutopilotDeviceIdentityImportStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ImportedWindowsAutopilotDeviceIdentityImportStatus> $value
     * @return self
     ...
     * 
     * @param ImportedWindowsAutopilotDeviceIdentityImportStatus $item
     * @return self
     */
    public function addValue(ImportedWindowsAutopilotDeviceIdentityImportStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ImportedWindowsAutopilotDeviceIdentityImportStatus>
     */
