...
/**
 * Collection response for OperationResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OperationResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OperationResult[]
     */
     ...
     * 
     * @param OperationResult[] $items
     * @return self
     */
    public function setValue(array|OperationResult $items, OperationResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OperationResult> $value
     * @return self
     ...
     * 
     * @param OperationResult $item
     * @return self
     */
    public function addValue(OperationResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OperationResult>
     */
