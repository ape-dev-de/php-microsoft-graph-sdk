...
/**
 * Collection response for PlannerBucketCollectionResponse
 */
class PlannerBucketCollectionResponseCollectionResponse
{
    /**
     * @var PlannerBucketCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PlannerBucketCollectionResponse ...$items Variable number of PlannerBucketCollectionResponse items
     * @return self
     */
    public function setValue(PlannerBucketCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PlannerBucketCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PlannerBucketCollectionResponse $item
     * @return self
     */
    public function addValue(PlannerBucketCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
