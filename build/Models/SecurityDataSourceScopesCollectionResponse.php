...
/**
 * Collection response for SecurityDataSourceScopes
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityDataSourceScopesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityDataSourceScopes[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityDataSourceScopes[]
     */
     ...
     * 
     * @param SecurityDataSourceScopes[] $items
     * @return self
     */
    public function setValue(array|SecurityDataSourceScopes $items, SecurityDataSourceScopes ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityDataSourceScopes> $value
     * @return self
     ...
     * 
     * @param SecurityDataSourceScopes $item
     * @return self
     */
    public function addValue(SecurityDataSourceScopes $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityDataSourceScopes|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityDataSourceScopes>
     */
