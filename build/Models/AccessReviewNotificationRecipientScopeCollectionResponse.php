...
/**
 * AccessReviewNotificationRecipientScopeCollectionResponse - Collection response
 */
class AccessReviewNotificationRecipientScopeCollectionResponse
{
    /**
     * @var array<int, AccessReviewNotificationRecipientScope>
     */
    public array $value = [];
