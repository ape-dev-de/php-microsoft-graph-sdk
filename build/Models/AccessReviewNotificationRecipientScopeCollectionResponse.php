...
/**
 * Collection response for AccessReviewNotificationRecipientScope
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewNotificationRecipientScopeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessReviewNotificationRecipientScope[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessReviewNotificationRecipientScope[] $items
     * @return self
     */
    public function setValue(array|AccessReviewNotificationRecipientScope $items, AccessReviewNotificationRecipientScope ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewNotificationRecipientScope> $value
     * @return self
     ...
     * 
     * @param AccessReviewNotificationRecipientScope $item
     * @return self
     */
    public function addValue(AccessReviewNotificationRecipientScope $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewNotificationRecipientScope>
     */
