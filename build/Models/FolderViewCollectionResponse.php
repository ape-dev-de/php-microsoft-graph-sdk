...
/**
 * Collection response for FolderView
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FolderViewCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FolderView[]
     */
     ...
     * 
     * @param FolderView[] $items
     * @return self
     */
    public function setValue(array|FolderView $items, FolderView ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param FolderView $item
     * @return self
     */
    public function addValue(FolderView $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FolderView>
     */
