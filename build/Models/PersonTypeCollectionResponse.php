...
/**
 * Collection response for PersonType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PersonTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PersonType[]
     */
     ...
     * 
     * @param PersonType[] $items
     * @return self
     */
    public function setValue(array|PersonType $items, PersonType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(PersonType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PersonType>
     */
