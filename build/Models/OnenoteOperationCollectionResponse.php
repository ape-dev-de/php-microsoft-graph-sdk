...
/**
 * Collection response for OnenoteOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnenoteOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param OnenoteOperation[] $items
     * @return self
     */
    public function setValue(array|OnenoteOperation $items, OnenoteOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnenoteOperation> $value
     * @return self
     ...
     * 
     * @param OnenoteOperation $item
     * @return self
     */
    public function addValue(OnenoteOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnenoteOperation>
     */
