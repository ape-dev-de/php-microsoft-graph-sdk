...
/**
 * Collection response for DomainDnsTxtRecord
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DomainDnsTxtRecordCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DomainDnsTxtRecord[]
     */
    private array $value = [];
     ...
     * 
     * @param DomainDnsTxtRecord[] $items
     * @return self
     */
    public function setValue(array|DomainDnsTxtRecord $items, DomainDnsTxtRecord ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DomainDnsTxtRecord> $value
     * @return self
     ...
     * 
     * @param DomainDnsTxtRecord $item
     * @return self
     */
    public function addValue(DomainDnsTxtRecord $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return DomainDnsTxtRecord|null
     */
     ...
     * 
     * @return \ArrayIterator<int, DomainDnsTxtRecord>
     */
