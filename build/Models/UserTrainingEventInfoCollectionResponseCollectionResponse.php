...
/**
 * Collection response for UserTrainingEventInfoCollectionResponse
 */
class UserTrainingEventInfoCollectionResponseCollectionResponse
{
    /**
     * @var UserTrainingEventInfoCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UserTrainingEventInfoCollectionResponse ...$items Variable number of UserTrainingEventInfoCollectionResponse items
     * @return self
     */
    public function setValue(UserTrainingEventInfoCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UserTrainingEventInfoCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UserTrainingEventInfoCollectionResponse $item
     * @return self
     */
    public function addValue(UserTrainingEventInfoCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
