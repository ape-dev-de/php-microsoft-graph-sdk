...
/**
 * Collection response for IdentityGovernanceTaskDefinitionCollectionResponse
 */
class IdentityGovernanceTaskDefinitionCollectionResponseCollectionResponse
{
    /**
     * @var IdentityGovernanceTaskDefinitionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityGovernanceTaskDefinitionCollectionResponse ...$items Variable number of IdentityGovernanceTaskDefinitionCollectionResponse items
     * @return self
     */
    public function setValue(IdentityGovernanceTaskDefinitionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IdentityGovernanceTaskDefinitionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceTaskDefinitionCollectionResponse $item
     * @return self
     */
    public function addValue(IdentityGovernanceTaskDefinitionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
