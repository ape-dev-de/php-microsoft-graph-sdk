...
/**
 * Collection response for DisplayNameLocalization
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DisplayNameLocalizationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DisplayNameLocalization[] $items
     * @return self
     */
    public function setValue(array|DisplayNameLocalization $items, DisplayNameLocalization ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DisplayNameLocalization> $value
     * @return self
     ...
     * 
     * @param DisplayNameLocalization $item
     * @return self
     */
    public function addValue(DisplayNameLocalization $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return DisplayNameLocalization|null
     */
     ...
     * 
     * @return \ArrayIterator<int, DisplayNameLocalization>
     */
