 ...
 */
class IntegratedApplicationMetadataCollectionResponse
{
    /**
     ...
     * 
     * @param IntegratedApplicationMetadata ...$items Variable number of IntegratedApplicationMetadata items
     * @return self
     */
    public function setValue(IntegratedApplicationMetadata ...$items): self
    {
        $this->value = $items;
        return $this;
    }
