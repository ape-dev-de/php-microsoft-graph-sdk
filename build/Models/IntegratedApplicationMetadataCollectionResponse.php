...
/**
 * Collection response for IntegratedApplicationMetadata
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IntegratedApplicationMetadataCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IntegratedApplicationMetadata[]
     */
    private array $value = [];
     ...
     * 
     * @param IntegratedApplicationMetadata[] $items
     * @return self
     */
    public function setValue(array|IntegratedApplicationMetadata $items, IntegratedApplicationMetadata ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IntegratedApplicationMetadata> $value
     * @return self
     ...
     * 
     * @param IntegratedApplicationMetadata $item
     * @return self
     */
    public function addValue(IntegratedApplicationMetadata $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IntegratedApplicationMetadata>
     */
