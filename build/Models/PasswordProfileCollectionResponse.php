...
/**
 * Collection response for PasswordProfile
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PasswordProfileCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PasswordProfile[]
     */
     ...
     * 
     * @param PasswordProfile[] $items
     * @return self
     */
    public function setValue(array|PasswordProfile $items, PasswordProfile ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PasswordProfile> $value
     * @return self
     ...
     * 
     * @param PasswordProfile $item
     * @return self
     */
    public function addValue(PasswordProfile $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PasswordProfile>
     */
