 ...
 */
class PasswordProfileCollectionResponse
{
    /**
     * @var PasswordProfile[]
     */
     ...
     * 
     * @param PasswordProfile ...$items Variable number of PasswordProfile items
     * @return self
     */
    public function setValue(PasswordProfile ...$items): self
    {
        $this->value = $items;
        return $this;
    }
