...
/**
 * Collection response for Admin
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AdminCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Admin[]
     */
     ...
     * @return self
     */
    public function setValue(array|Admin $items, Admin ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Admin $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Admin>
     */
