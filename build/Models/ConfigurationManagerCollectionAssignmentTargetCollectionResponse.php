...
/**
 * Collection response for ConfigurationManagerCollectionAssignmentTarget
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConfigurationManagerCollectionAssignmentTargetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConfigurationManagerCollectionAssignmentTarget[]
     */
    private array $value = [];
     ...
     * 
     * @param ConfigurationManagerCollectionAssignmentTarget[] $items
     * @return self
     */
    public function setValue(array|ConfigurationManagerCollectionAssignmentTarget $items, ConfigurationManagerCollectionAssignmentTarget ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConfigurationManagerCollectionAssignmentTarget> $value
     * @return self
     ...
     * 
     * @param ConfigurationManagerCollectionAssignmentTarget $item
     * @return self
     */
    public function addValue(ConfigurationManagerCollectionAssignmentTarget $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ConfigurationManagerCollectionAssignmentTarget|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ConfigurationManagerCollectionAssignmentTarget>
     */
