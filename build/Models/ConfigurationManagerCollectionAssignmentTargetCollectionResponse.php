 ...
 */
class ConfigurationManagerCollectionAssignmentTargetCollectionResponse
{
    /**
     ...
     * 
     * @param ConfigurationManagerCollectionAssignmentTarget ...$items Variable number of ConfigurationManagerCollectionAssignmentTarget items
     * @return self
     */
    public function setValue(ConfigurationManagerCollectionAssignmentTarget ...$items): self
    {
        $this->value = $items;
        return $this;
    }
