...
/**
 * Collection response for RelatedContact
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RelatedContactCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RelatedContact[]
     */
     ...
     * 
     * @param RelatedContact[] $items
     * @return self
     */
    public function setValue(array|RelatedContact $items, RelatedContact ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RelatedContact> $value
     * @return self
     ...
     * 
     * @param RelatedContact $item
     * @return self
     */
    public function addValue(RelatedContact $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RelatedContact>
     */
