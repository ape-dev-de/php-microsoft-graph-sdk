...
/**
 * Collection response for ConnectedOrganizationMembers
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConnectedOrganizationMembersCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConnectedOrganizationMembers[]
     */
    private array $value = [];
     ...
     * 
     * @param ConnectedOrganizationMembers[] $items
     * @return self
     */
    public function setValue(array|ConnectedOrganizationMembers $items, ConnectedOrganizationMembers ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConnectedOrganizationMembers> $value
     * @return self
     ...
     * 
     * @param ConnectedOrganizationMembers $item
     * @return self
     */
    public function addValue(ConnectedOrganizationMembers $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ConnectedOrganizationMembers|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ConnectedOrganizationMembers>
     */
