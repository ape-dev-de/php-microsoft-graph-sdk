 ...
 */
class ConnectedOrganizationMembersCollectionResponse
{
    /**
     ...
     * 
     * @param ConnectedOrganizationMembers ...$items Variable number of ConnectedOrganizationMembers items
     * @return self
     */
    public function setValue(ConnectedOrganizationMembers ...$items): self
    {
        $this->value = $items;
        return $this;
    }
