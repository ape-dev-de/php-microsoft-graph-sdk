...
/**
 * Collection response for ResponseFeedbackType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ResponseFeedbackTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ResponseFeedbackType[]
     */
    private array $value = [];
     ...
     * 
     * @param ResponseFeedbackType[] $items
     * @return self
     */
    public function setValue(array|ResponseFeedbackType $items, ResponseFeedbackType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ResponseFeedbackType> $value
     * @return self
     ...
     * 
     * @param ResponseFeedbackType $item
     * @return self
     */
    public function addValue(ResponseFeedbackType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ResponseFeedbackType>
     */
