...
/**
 * Collection response for AdministrativeUnit
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AdministrativeUnitCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AdministrativeUnit[] $items
     * @return self
     */
    public function setValue(array|AdministrativeUnit $items, AdministrativeUnit ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AdministrativeUnit> $value
     * @return self
     ...
     * 
     * @param AdministrativeUnit $item
     * @return self
     */
    public function addValue(AdministrativeUnit $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AdministrativeUnit>
     */
