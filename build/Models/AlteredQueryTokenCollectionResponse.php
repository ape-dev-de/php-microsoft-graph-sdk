...
/**
 * Collection response for AlteredQueryToken
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AlteredQueryTokenCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AlteredQueryToken[] $items
     * @return self
     */
    public function setValue(array|AlteredQueryToken $items, AlteredQueryToken ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AlteredQueryToken> $value
     * @return self
     ...
     * 
     * @param AlteredQueryToken $item
     * @return self
     */
    public function addValue(AlteredQueryToken $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AlteredQueryToken>
     */
