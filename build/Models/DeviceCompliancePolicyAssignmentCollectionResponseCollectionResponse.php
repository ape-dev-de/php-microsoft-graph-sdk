...
/**
 * Collection response for DeviceCompliancePolicyAssignmentCollectionResponse
 */
class DeviceCompliancePolicyAssignmentCollectionResponseCollectionResponse
{
    /**
     * @var DeviceCompliancePolicyAssignmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceCompliancePolicyAssignmentCollectionResponse ...$items Variable number of DeviceCompliancePolicyAssignmentCollectionResponse items
     * @return self
     */
    public function setValue(DeviceCompliancePolicyAssignmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeviceCompliancePolicyAssignmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeviceCompliancePolicyAssignmentCollectionResponse $item
     * @return self
     */
    public function addValue(DeviceCompliancePolicyAssignmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
