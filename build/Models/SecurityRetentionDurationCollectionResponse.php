...
/**
 * Collection response for SecurityRetentionDuration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityRetentionDurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityRetentionDuration[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityRetentionDuration[]
     */
     ...
     * 
     * @param SecurityRetentionDuration[] $items
     * @return self
     */
    public function setValue(array|SecurityRetentionDuration $items, SecurityRetentionDuration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityRetentionDuration> $value
     * @return self
     ...
     * 
     * @param SecurityRetentionDuration $item
     * @return self
     */
    public function addValue(SecurityRetentionDuration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityRetentionDuration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityRetentionDuration>
     */
