...
/**
 * SecurityRetentionDurationCollectionResponse - Collection response
 */
class SecurityRetentionDurationCollectionResponse
{
    /**
     * @var array<int, SecurityRetentionDuration>
     */
    public array $value = [];
