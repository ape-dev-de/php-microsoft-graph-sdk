 ...
 */
class PolicyScopeBaseCollectionResponse
{
    /**
     * @var PolicyScopeBase[]
     */
     ...
     * 
     * @param PolicyScopeBase ...$items Variable number of PolicyScopeBase items
     * @return self
     */
    public function setValue(PolicyScopeBase ...$items): self
    {
        $this->value = $items;
        return $this;
    }
