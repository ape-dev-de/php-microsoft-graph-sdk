...
/**
 * Collection response for PolicyScopeBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PolicyScopeBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PolicyScopeBase[]
     */
     ...
     * 
     * @param PolicyScopeBase[] $items
     * @return self
     */
    public function setValue(array|PolicyScopeBase $items, PolicyScopeBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PolicyScopeBase> $value
     * @return self
     ...
     * 
     * @param PolicyScopeBase $item
     * @return self
     */
    public function addValue(PolicyScopeBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PolicyScopeBase>
     */
