...
/**
 * Collection response for ChannelMembershipType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChannelMembershipTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ChannelMembershipType[] $items
     * @return self
     */
    public function setValue(array|ChannelMembershipType $items, ChannelMembershipType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChannelMembershipType> $value
     * @return self
     ...
     * 
     * @param ChannelMembershipType $item
     * @return self
     */
    public function addValue(ChannelMembershipType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChannelMembershipType>
     */
