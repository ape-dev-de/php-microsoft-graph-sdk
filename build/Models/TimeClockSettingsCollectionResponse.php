 ...
 */
class TimeClockSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param TimeClockSettings ...$items Variable number of TimeClockSettings items
     * @return self
     */
    public function setValue(TimeClockSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
