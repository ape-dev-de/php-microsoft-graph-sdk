...
/**
 * Collection response for TimeClockSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TimeClockSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TimeClockSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param TimeClockSettings[] $items
     * @return self
     */
    public function setValue(array|TimeClockSettings $items, TimeClockSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TimeClockSettings> $value
     * @return self
     ...
     * 
     * @param TimeClockSettings $item
     * @return self
     */
    public function addValue(TimeClockSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TimeClockSettings>
     */
