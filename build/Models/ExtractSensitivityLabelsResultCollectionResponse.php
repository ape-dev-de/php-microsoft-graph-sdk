 ...
 */
class ExtractSensitivityLabelsResultCollectionResponse
{
    /**
     ...
     * 
     * @param ExtractSensitivityLabelsResult ...$items Variable number of ExtractSensitivityLabelsResult items
     * @return self
     */
    public function setValue(ExtractSensitivityLabelsResult ...$items): self
    {
        $this->value = $items;
        return $this;
    }
