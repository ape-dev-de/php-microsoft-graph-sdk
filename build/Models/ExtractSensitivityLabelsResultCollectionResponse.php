...
/**
 * Collection response for ExtractSensitivityLabelsResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExtractSensitivityLabelsResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExtractSensitivityLabelsResult[]
     */
    private array $value = [];
     ...
     * 
     * @param ExtractSensitivityLabelsResult[] $items
     * @return self
     */
    public function setValue(array|ExtractSensitivityLabelsResult $items, ExtractSensitivityLabelsResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExtractSensitivityLabelsResult> $value
     * @return self
     ...
     * 
     * @param ExtractSensitivityLabelsResult $item
     * @return self
     */
    public function addValue(ExtractSensitivityLabelsResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExtractSensitivityLabelsResult|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExtractSensitivityLabelsResult>
     */
