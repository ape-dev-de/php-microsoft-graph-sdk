...
/**
 * Collection response for DriveItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DriveItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DriveItem[]
     */
     ...
     * 
     * @param DriveItem[] $items
     * @return self
     */
    public function setValue(array|DriveItem $items, DriveItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(DriveItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DriveItem>
     */
