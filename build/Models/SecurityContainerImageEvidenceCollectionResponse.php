 ...
 */
class SecurityContainerImageEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityContainerImageEvidence ...$items Variable number of SecurityContainerImageEvidence items
     * @return self
     */
    public function setValue(SecurityContainerImageEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
