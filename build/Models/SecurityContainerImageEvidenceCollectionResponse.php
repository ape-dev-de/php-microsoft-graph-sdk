...
/**
 * Collection response for SecurityContainerImageEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityContainerImageEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityContainerImageEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityContainerImageEvidence[]
     */
     ...
     * 
     * @param SecurityContainerImageEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityContainerImageEvidence $items, SecurityContainerImageEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityContainerImageEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityContainerImageEvidence $item
     * @return self
     */
    public function addValue(SecurityContainerImageEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityContainerImageEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityContainerImageEvidence>
     */
