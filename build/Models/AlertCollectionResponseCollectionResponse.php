...
/**
 * Collection response for AlertCollectionResponse
 */
class AlertCollectionResponseCollectionResponse
{
    /**
     * @var AlertCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AlertCollectionResponse ...$items Variable number of AlertCollectionResponse items
     * @return self
     */
    public function setValue(AlertCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AlertCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AlertCollectionResponse $item
     * @return self
     */
    public function addValue(AlertCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
