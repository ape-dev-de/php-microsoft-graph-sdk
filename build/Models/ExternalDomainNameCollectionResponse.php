...
/**
 * Collection response for ExternalDomainName
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalDomainNameCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ExternalDomainName[] $items
     * @return self
     */
    public function setValue(array|ExternalDomainName $items, ExternalDomainName ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalDomainName> $value
     * @return self
     ...
     * 
     * @param ExternalDomainName $item
     * @return self
     */
    public function addValue(ExternalDomainName $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalDomainName|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalDomainName>
     */
