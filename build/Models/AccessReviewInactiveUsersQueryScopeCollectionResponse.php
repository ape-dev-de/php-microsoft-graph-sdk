...
/**
 * Collection response for AccessReviewInactiveUsersQueryScope
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewInactiveUsersQueryScopeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessReviewInactiveUsersQueryScope[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessReviewInactiveUsersQueryScope[] $items
     * @return self
     */
    public function setValue(array|AccessReviewInactiveUsersQueryScope $items, AccessReviewInactiveUsersQueryScope ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewInactiveUsersQueryScope> $value
     * @return self
     ...
     * 
     * @param AccessReviewInactiveUsersQueryScope $item
     * @return self
     */
    public function addValue(AccessReviewInactiveUsersQueryScope $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessReviewInactiveUsersQueryScope|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewInactiveUsersQueryScope>
     */
