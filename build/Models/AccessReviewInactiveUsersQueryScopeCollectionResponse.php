 ...
 */
class AccessReviewInactiveUsersQueryScopeCollectionResponse
{
    /**
     ...
     * 
     * @param AccessReviewInactiveUsersQueryScope ...$items Variable number of AccessReviewInactiveUsersQueryScope items
     * @return self
     */
    public function setValue(AccessReviewInactiveUsersQueryScope ...$items): self
    {
        $this->value = $items;
        return $this;
    }
