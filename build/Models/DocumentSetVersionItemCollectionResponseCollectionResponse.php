...
/**
 * Collection response for DocumentSetVersionItemCollectionResponse
 */
class DocumentSetVersionItemCollectionResponseCollectionResponse
{
    /**
     * @var DocumentSetVersionItemCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DocumentSetVersionItemCollectionResponse ...$items Variable number of DocumentSetVersionItemCollectionResponse items
     * @return self
     */
    public function setValue(DocumentSetVersionItemCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DocumentSetVersionItemCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DocumentSetVersionItemCollectionResponse $item
     * @return self
     */
    public function addValue(DocumentSetVersionItemCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
