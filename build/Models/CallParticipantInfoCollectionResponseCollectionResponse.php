...
/**
 * Collection response for CallParticipantInfoCollectionResponse
 */
class CallParticipantInfoCollectionResponseCollectionResponse
{
    /**
     * @var CallParticipantInfoCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CallParticipantInfoCollectionResponse ...$items Variable number of CallParticipantInfoCollectionResponse items
     * @return self
     */
    public function setValue(CallParticipantInfoCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CallParticipantInfoCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CallParticipantInfoCollectionResponse $item
     * @return self
     */
    public function addValue(CallParticipantInfoCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
