...
/**
 * Collection response for InformationalUrl
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InformationalUrlCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param InformationalUrl[] $items
     * @return self
     */
    public function setValue(array|InformationalUrl $items, InformationalUrl ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InformationalUrl> $value
     * @return self
     ...
     * 
     * @param InformationalUrl $item
     * @return self
     */
    public function addValue(InformationalUrl $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, InformationalUrl>
     */
