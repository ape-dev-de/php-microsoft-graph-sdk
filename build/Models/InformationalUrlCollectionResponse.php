 ...
 */
class InformationalUrlCollectionResponse
{
    /**
     ...
     * 
     * @param InformationalUrl ...$items Variable number of InformationalUrl items
     * @return self
     */
    public function setValue(InformationalUrl ...$items): self
    {
        $this->value = $items;
        return $this;
    }
