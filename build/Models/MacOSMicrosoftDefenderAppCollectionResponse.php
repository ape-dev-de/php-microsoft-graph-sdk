...
/**
 * Collection response for MacOSMicrosoftDefenderApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MacOSMicrosoftDefenderAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MacOSMicrosoftDefenderApp[]
     */
    private array $value = [];
     ...
     * 
     * @param MacOSMicrosoftDefenderApp[] $items
     * @return self
     */
    public function setValue(array|MacOSMicrosoftDefenderApp $items, MacOSMicrosoftDefenderApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MacOSMicrosoftDefenderApp> $value
     * @return self
     ...
     * 
     * @param MacOSMicrosoftDefenderApp $item
     * @return self
     */
    public function addValue(MacOSMicrosoftDefenderApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MacOSMicrosoftDefenderApp|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MacOSMicrosoftDefenderApp>
     */
