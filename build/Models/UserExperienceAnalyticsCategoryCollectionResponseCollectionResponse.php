...
/**
 * Collection response for UserExperienceAnalyticsCategoryCollectionResponse
 */
class UserExperienceAnalyticsCategoryCollectionResponseCollectionResponse
{
    /**
     * @var UserExperienceAnalyticsCategoryCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UserExperienceAnalyticsCategoryCollectionResponse ...$items Variable number of UserExperienceAnalyticsCategoryCollectionResponse items
     * @return self
     */
    public function setValue(UserExperienceAnalyticsCategoryCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UserExperienceAnalyticsCategoryCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsCategoryCollectionResponse $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsCategoryCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
