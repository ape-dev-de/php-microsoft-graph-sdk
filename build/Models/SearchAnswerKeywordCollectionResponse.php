...
/**
 * Collection response for SearchAnswerKeyword
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SearchAnswerKeywordCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SearchAnswerKeyword[]
     */
    private array $value = [];
     ...
     * 
     * @param SearchAnswerKeyword[] $items
     * @return self
     */
    public function setValue(array|SearchAnswerKeyword $items, SearchAnswerKeyword ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SearchAnswerKeyword> $value
     * @return self
     ...
     * 
     * @param SearchAnswerKeyword $item
     * @return self
     */
    public function addValue(SearchAnswerKeyword $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SearchAnswerKeyword|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SearchAnswerKeyword>
     */
