 ...
 */
class SearchAnswerKeywordCollectionResponse
{
    /**
     ...
     * 
     * @param SearchAnswerKeyword ...$items Variable number of SearchAnswerKeyword items
     * @return self
     */
    public function setValue(SearchAnswerKeyword ...$items): self
    {
        $this->value = $items;
        return $this;
    }
