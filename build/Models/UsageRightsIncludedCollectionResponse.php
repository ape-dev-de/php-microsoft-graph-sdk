...
/**
 * Collection response for UsageRightsIncluded
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UsageRightsIncludedCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UsageRightsIncluded[]
     */
    private array $value = [];
     ...
     * 
     * @param UsageRightsIncluded[] $items
     * @return self
     */
    public function setValue(array|UsageRightsIncluded $items, UsageRightsIncluded ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UsageRightsIncluded> $value
     * @return self
     ...
     * 
     * @param UsageRightsIncluded $item
     * @return self
     */
    public function addValue(UsageRightsIncluded $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UsageRightsIncluded>
     */
