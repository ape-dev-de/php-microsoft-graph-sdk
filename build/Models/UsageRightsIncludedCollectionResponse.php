 ...
 */
class UsageRightsIncludedCollectionResponse
{
    /**
     ...
     * 
     * @param UsageRightsIncluded ...$items Variable number of UsageRightsIncluded items
     * @return self
     */
    public function setValue(UsageRightsIncluded ...$items): self
    {
        $this->value = $items;
        return $this;
    }
