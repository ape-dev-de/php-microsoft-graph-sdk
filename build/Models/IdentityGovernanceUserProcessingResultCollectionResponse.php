...
/**
 * Collection response for IdentityGovernanceUserProcessingResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceUserProcessingResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IdentityGovernanceUserProcessingResult[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceUserProcessingResult $items, IdentityGovernanceUserProcessingResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceUserProcessingResult> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceUserProcessingResult $item
     * @return self
     */
    public function addValue(IdentityGovernanceUserProcessingResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceUserProcessingResult>
     */
