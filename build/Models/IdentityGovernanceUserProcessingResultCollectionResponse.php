...
/**
 * IdentityGovernanceUserProcessingResultCollectionResponse - Collection response
 */
class IdentityGovernanceUserProcessingResultCollectionResponse
{
    /**
     * @var array<int, IdentityGovernanceUserProcessingResult>
     */
    public array $value = [];
