...
/**
 * AuthenticationMethodsRegistrationCampaignIncludeTargetCollectionResponse - Collection response
 */
class AuthenticationMethodsRegistrationCampaignIncludeTargetCollectionResponse
{
    /**
     * @var array<int, AuthenticationMethodsRegistrationCampaignIncludeTarget>
     */
    public array $value = [];
