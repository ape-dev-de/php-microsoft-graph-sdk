...
/**
 * Collection response for AuthenticationMethodsRegistrationCampaignIncludeTarget
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationMethodsRegistrationCampaignIncludeTargetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AuthenticationMethodsRegistrationCampaignIncludeTarget[] $items
     * @return self
     */
    public function setValue(array|AuthenticationMethodsRegistrationCampaignIncludeTarget $items, AuthenticationMethodsRegistrationCampaignIncludeTarget ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationMethodsRegistrationCampaignIncludeTarget> $value
     * @return self
     ...
     * 
     * @param AuthenticationMethodsRegistrationCampaignIncludeTarget $item
     * @return self
     */
    public function addValue(AuthenticationMethodsRegistrationCampaignIncludeTarget $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AuthenticationMethodsRegistrationCampaignIncludeTarget|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationMethodsRegistrationCampaignIncludeTarget>
     */
