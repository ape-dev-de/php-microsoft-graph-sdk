...
/**
 * Collection response for SynchronizationSchedule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationScheduleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SynchronizationSchedule[]
     */
    private array $value = [];
     ...
     * 
     * @param SynchronizationSchedule[] $items
     * @return self
     */
    public function setValue(array|SynchronizationSchedule $items, SynchronizationSchedule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SynchronizationSchedule> $value
     * @return self
     ...
     * 
     * @param SynchronizationSchedule $item
     * @return self
     */
    public function addValue(SynchronizationSchedule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SynchronizationSchedule>
     */
