 ...
 */
class SynchronizationScheduleCollectionResponse
{
    /**
     ...
     * 
     * @param SynchronizationSchedule ...$items Variable number of SynchronizationSchedule items
     * @return self
     */
    public function setValue(SynchronizationSchedule ...$items): self
    {
        $this->value = $items;
        return $this;
    }
