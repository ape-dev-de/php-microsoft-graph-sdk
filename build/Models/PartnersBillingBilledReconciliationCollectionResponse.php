...
/**
 * Collection response for PartnersBillingBilledReconciliation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PartnersBillingBilledReconciliationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PartnersBillingBilledReconciliation[]
     */
    private array $value = [];
     ...
     * 
     * @param PartnersBillingBilledReconciliation[] $items
     * @return self
     */
    public function setValue(array|PartnersBillingBilledReconciliation $items, PartnersBillingBilledReconciliation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PartnersBillingBilledReconciliation> $value
     * @return self
     ...
     * 
     * @param PartnersBillingBilledReconciliation $item
     * @return self
     */
    public function addValue(PartnersBillingBilledReconciliation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PartnersBillingBilledReconciliation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PartnersBillingBilledReconciliation>
     */
