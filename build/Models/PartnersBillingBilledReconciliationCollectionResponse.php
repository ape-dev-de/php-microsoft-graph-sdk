...
/**
 * PartnersBillingBilledReconciliationCollectionResponse - Collection response
 */
class PartnersBillingBilledReconciliationCollectionResponse
{
    /**
     * @var array<int, PartnersBillingBilledReconciliation>
     */
    public array $value = [];
