...
/**
 * Collection response for ExternalConnectorsExternalItemContentType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsExternalItemContentTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalConnectorsExternalItemContentType[]
     */
    private array $value = [];
     ...
     * 
     * @return ExternalConnectorsExternalItemContentType[]
     */
     ...
     * 
     * @param ExternalConnectorsExternalItemContentType[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsExternalItemContentType $items, ExternalConnectorsExternalItemContentType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsExternalItemContentType> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsExternalItemContentType $item
     * @return self
     */
    public function addValue(ExternalConnectorsExternalItemContentType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalConnectorsExternalItemContentType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsExternalItemContentType>
     */
