...
/**
 * ExternalConnectorsExternalItemContentTypeCollectionResponse - Collection response
 */
class ExternalConnectorsExternalItemContentTypeCollectionResponse
{
    /**
     * @var array<int, ExternalConnectorsExternalItemContentType>
     */
    public array $value = [];
