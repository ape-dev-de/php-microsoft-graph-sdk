...
/**
 * Collection response for SecurityContainerEvidenceCollectionResponse
 */
class SecurityContainerEvidenceCollectionResponseCollectionResponse
{
    /**
     * @var SecurityContainerEvidenceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityContainerEvidenceCollectionResponse[]
     */
     ...
     * 
     * @param SecurityContainerEvidenceCollectionResponse ...$items Variable number of SecurityContainerEvidenceCollectionResponse items
     * @return self
     */
    public function setValue(SecurityContainerEvidenceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityContainerEvidenceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityContainerEvidenceCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityContainerEvidenceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
