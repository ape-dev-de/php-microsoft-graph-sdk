...
/**
 * Collection response for EmailAddressCollectionResponse
 */
class EmailAddressCollectionResponseCollectionResponse
{
    /**
     * @var EmailAddressCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EmailAddressCollectionResponse ...$items Variable number of EmailAddressCollectionResponse items
     * @return self
     */
    public function setValue(EmailAddressCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EmailAddressCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EmailAddressCollectionResponse $item
     * @return self
     */
    public function addValue(EmailAddressCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
