...
class WindowsUniversalAppX
{
     ...
     */
    private ?string $committedContainedApps;
    ...
    public function getCommittedContainedApps(): ?string
    {
        return $this->committedContainedApps;
    }

    public function setCommittedContainedApps(?string $committedContainedApps): self
    {
