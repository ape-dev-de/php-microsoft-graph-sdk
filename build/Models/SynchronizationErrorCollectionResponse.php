...
/**
 * Collection response for SynchronizationError
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationErrorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SynchronizationError[] $items
     * @return self
     */
    public function setValue(array|SynchronizationError $items, SynchronizationError ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SynchronizationError> $value
     * @return self
     ...
     * 
     * @param SynchronizationError $item
     * @return self
     */
    public function addValue(SynchronizationError $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SynchronizationError>
     */
