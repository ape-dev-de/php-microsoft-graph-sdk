 ...
 */
class SynchronizationErrorCollectionResponse
{
    /**
     ...
     * 
     * @param SynchronizationError ...$items Variable number of SynchronizationError items
     * @return self
     */
    public function setValue(SynchronizationError ...$items): self
    {
        $this->value = $items;
        return $this;
    }
