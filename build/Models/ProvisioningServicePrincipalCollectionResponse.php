...
/**
 * Collection response for ProvisioningServicePrincipal
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProvisioningServicePrincipalCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProvisioningServicePrincipal[]
     */
    private array $value = [];
     ...
     * 
     * @param ProvisioningServicePrincipal[] $items
     * @return self
     */
    public function setValue(array|ProvisioningServicePrincipal $items, ProvisioningServicePrincipal ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProvisioningServicePrincipal> $value
     * @return self
     ...
     * 
     * @param ProvisioningServicePrincipal $item
     * @return self
     */
    public function addValue(ProvisioningServicePrincipal $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProvisioningServicePrincipal>
     */
