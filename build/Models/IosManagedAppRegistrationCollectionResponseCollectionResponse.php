...
/**
 * Collection response for IosManagedAppRegistrationCollectionResponse
 */
class IosManagedAppRegistrationCollectionResponseCollectionResponse
{
    /**
     * @var IosManagedAppRegistrationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IosManagedAppRegistrationCollectionResponse ...$items Variable number of IosManagedAppRegistrationCollectionResponse items
     * @return self
     */
    public function setValue(IosManagedAppRegistrationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IosManagedAppRegistrationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IosManagedAppRegistrationCollectionResponse $item
     * @return self
     */
    public function addValue(IosManagedAppRegistrationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
