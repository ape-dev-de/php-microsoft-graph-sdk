 ...
 */
class IosDdmLobAppAssignmentSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param IosDdmLobAppAssignmentSettings ...$items Variable number of IosDdmLobAppAssignmentSettings items
     * @return self
     */
    public function setValue(IosDdmLobAppAssignmentSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
