...
/**
 * Collection response for IosDdmLobAppAssignmentSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosDdmLobAppAssignmentSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IosDdmLobAppAssignmentSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param IosDdmLobAppAssignmentSettings[] $items
     * @return self
     */
    public function setValue(array|IosDdmLobAppAssignmentSettings $items, IosDdmLobAppAssignmentSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosDdmLobAppAssignmentSettings> $value
     * @return self
     ...
     * 
     * @param IosDdmLobAppAssignmentSettings $item
     * @return self
     */
    public function addValue(IosDdmLobAppAssignmentSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IosDdmLobAppAssignmentSettings|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IosDdmLobAppAssignmentSettings>
     */
