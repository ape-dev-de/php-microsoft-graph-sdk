...
/**
 * Collection response for UsageRights
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UsageRightsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UsageRights[]
     */
     ...
     * 
     * @param UsageRights[] $items
     * @return self
     */
    public function setValue(array|UsageRights $items, UsageRights ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param UsageRights $item
     * @return self
     */
    public function addValue(UsageRights $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UsageRights>
     */
