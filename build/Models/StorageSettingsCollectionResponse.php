 ...
 */
class StorageSettingsCollectionResponse
{
    /**
     * @var StorageSettings[]
     */
     ...
     * 
     * @param StorageSettings ...$items Variable number of StorageSettings items
     * @return self
     */
    public function setValue(StorageSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
