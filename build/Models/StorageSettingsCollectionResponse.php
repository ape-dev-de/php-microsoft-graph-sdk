...
/**
 * Collection response for StorageSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class StorageSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var StorageSettings[]
     */
     ...
     * 
     * @param StorageSettings[] $items
     * @return self
     */
    public function setValue(array|StorageSettings $items, StorageSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<StorageSettings> $value
     * @return self
     ...
     * 
     * @param StorageSettings $item
     * @return self
     */
    public function addValue(StorageSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, StorageSettings>
     */
