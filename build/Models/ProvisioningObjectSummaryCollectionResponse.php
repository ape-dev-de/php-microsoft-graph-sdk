...
/**
 * Collection response for ProvisioningObjectSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProvisioningObjectSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ProvisioningObjectSummary[] $items
     * @return self
     */
    public function setValue(array|ProvisioningObjectSummary $items, ProvisioningObjectSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProvisioningObjectSummary> $value
     * @return self
     ...
     * 
     * @param ProvisioningObjectSummary $item
     * @return self
     */
    public function addValue(ProvisioningObjectSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProvisioningObjectSummary>
     */
