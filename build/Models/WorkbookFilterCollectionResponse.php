 ...
 */
class WorkbookFilterCollectionResponse
{
    /**
     * @var WorkbookFilter[]
     */
     ...
     * 
     * @param WorkbookFilter ...$items Variable number of WorkbookFilter items
     * @return self
     */
    public function setValue(WorkbookFilter ...$items): self
    {
        $this->value = $items;
        return $this;
    }
