...
/**
 * Collection response for WorkbookFilter
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookFilterCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookFilter[]
     */
     ...
     * 
     * @param WorkbookFilter[] $items
     * @return self
     */
    public function setValue(array|WorkbookFilter $items, WorkbookFilter ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookFilter> $value
     * @return self
     ...
     * 
     * @param WorkbookFilter $item
     * @return self
     */
    public function addValue(WorkbookFilter $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookFilter>
     */
