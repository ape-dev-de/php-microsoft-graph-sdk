...
/**
 * Collection response for CallRecordsTraceRouteHop
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsTraceRouteHopCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return CallRecordsTraceRouteHop[]
     */
     ...
     * 
     * @param CallRecordsTraceRouteHop[] $items
     * @return self
     */
    public function setValue(array|CallRecordsTraceRouteHop $items, CallRecordsTraceRouteHop ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsTraceRouteHop> $value
     * @return self
     ...
     * 
     * @param CallRecordsTraceRouteHop $item
     * @return self
     */
    public function addValue(CallRecordsTraceRouteHop $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsTraceRouteHop|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsTraceRouteHop>
     */
