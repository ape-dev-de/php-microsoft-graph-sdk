...
/**
 * Collection response for DelegatedAdminRelationshipRequestAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DelegatedAdminRelationshipRequestActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DelegatedAdminRelationshipRequestAction[]
     */
    private array $value = [];
     ...
     * 
     * @return DelegatedAdminRelationshipRequestAction[]
     */
     ...
     * 
     * @param DelegatedAdminRelationshipRequestAction[] $items
     * @return self
     */
    public function setValue(array|DelegatedAdminRelationshipRequestAction $items, DelegatedAdminRelationshipRequestAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DelegatedAdminRelationshipRequestAction> $value
     * @return self
     ...
     * 
     * @param DelegatedAdminRelationshipRequestAction $item
     * @return self
     */
    public function addValue(DelegatedAdminRelationshipRequestAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DelegatedAdminRelationshipRequestAction>
     */
