...
/**
 * DelegatedAdminRelationshipRequestActionCollectionResponse - Collection response
 */
class DelegatedAdminRelationshipRequestActionCollectionResponse
{
    /**
     * @var array<int, DelegatedAdminRelationshipRequestAction>
     */
    public array $value = [];
