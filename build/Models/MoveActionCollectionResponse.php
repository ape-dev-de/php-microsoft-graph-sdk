...
/**
 * Collection response for MoveAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MoveActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MoveAction[]
     */
     ...
     * 
     * @param MoveAction[] $items
     * @return self
     */
    public function setValue(array|MoveAction $items, MoveAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param MoveAction $item
     * @return self
     */
    public function addValue(MoveAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MoveAction>
     */
