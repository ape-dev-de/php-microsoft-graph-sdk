...
/**
 * Collection response for ActionResultPart
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ActionResultPartCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ActionResultPart[]
     */
    private array $value = [];
     ...
     * 
     * @param ActionResultPart[] $items
     * @return self
     */
    public function setValue(array|ActionResultPart $items, ActionResultPart ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ActionResultPart> $value
     * @return self
     ...
     * 
     * @param ActionResultPart $item
     * @return self
     */
    public function addValue(ActionResultPart $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ActionResultPart>
     */
