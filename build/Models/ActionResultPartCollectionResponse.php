 ...
 */
class ActionResultPartCollectionResponse
{
    /**
     ...
     * 
     * @param ActionResultPart ...$items Variable number of ActionResultPart items
     * @return self
     */
    public function setValue(ActionResultPart ...$items): self
    {
        $this->value = $items;
        return $this;
    }
