 ...
 */
class VppLicensingTypeCollectionResponse
{
    /**
     ...
     * 
     * @param VppLicensingType ...$items Variable number of VppLicensingType items
     * @return self
     */
    public function setValue(VppLicensingType ...$items): self
    {
        $this->value = $items;
        return $this;
    }
