...
/**
 * Collection response for VppLicensingType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VppLicensingTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param VppLicensingType[] $items
     * @return self
     */
    public function setValue(array|VppLicensingType $items, VppLicensingType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VppLicensingType> $value
     * @return self
     ...
     * 
     * @param VppLicensingType $item
     * @return self
     */
    public function addValue(VppLicensingType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VppLicensingType>
     */
