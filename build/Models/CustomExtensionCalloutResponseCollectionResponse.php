 ...
 */
class CustomExtensionCalloutResponseCollectionResponse
{
    /**
     ...
     * 
     * @param CustomExtensionCalloutResponse ...$items Variable number of CustomExtensionCalloutResponse items
     * @return self
     */
    public function setValue(CustomExtensionCalloutResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
