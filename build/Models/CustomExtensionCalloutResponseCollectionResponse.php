...
/**
 * Collection response for CustomExtensionCalloutResponse
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CustomExtensionCalloutResponseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CustomExtensionCalloutResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CustomExtensionCalloutResponse[] $items
     * @return self
     */
    public function setValue(array|CustomExtensionCalloutResponse $items, CustomExtensionCalloutResponse ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CustomExtensionCalloutResponse> $value
     * @return self
     ...
     * 
     * @param CustomExtensionCalloutResponse $item
     * @return self
     */
    public function addValue(CustomExtensionCalloutResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CustomExtensionCalloutResponse|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CustomExtensionCalloutResponse>
     */
