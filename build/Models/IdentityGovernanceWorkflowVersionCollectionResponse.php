...
/**
 * IdentityGovernanceWorkflowVersionCollectionResponse - Collection response
 */
class IdentityGovernanceWorkflowVersionCollectionResponse
{
    /**
     * @var array<int, IdentityGovernanceWorkflowVersion>
     */
    public array $value = [];
