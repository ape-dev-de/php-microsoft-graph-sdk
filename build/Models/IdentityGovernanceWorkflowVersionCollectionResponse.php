...
/**
 * Collection response for IdentityGovernanceWorkflowVersion
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceWorkflowVersionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IdentityGovernanceWorkflowVersion[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceWorkflowVersion $items, IdentityGovernanceWorkflowVersion ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceWorkflowVersion> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceWorkflowVersion $item
     * @return self
     */
    public function addValue(IdentityGovernanceWorkflowVersion $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceWorkflowVersion>
     */
