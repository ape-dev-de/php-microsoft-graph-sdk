...
/**
 * Collection response for SecurityHostReputationRuleSeverity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHostReputationRuleSeverityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityHostReputationRuleSeverity[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityHostReputationRuleSeverity[]
     */
     ...
     * 
     * @param SecurityHostReputationRuleSeverity[] $items
     * @return self
     */
    public function setValue(array|SecurityHostReputationRuleSeverity $items, SecurityHostReputationRuleSeverity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHostReputationRuleSeverity> $value
     * @return self
     ...
     * 
     * @param SecurityHostReputationRuleSeverity $item
     * @return self
     */
    public function addValue(SecurityHostReputationRuleSeverity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityHostReputationRuleSeverity|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityHostReputationRuleSeverity>
     */
