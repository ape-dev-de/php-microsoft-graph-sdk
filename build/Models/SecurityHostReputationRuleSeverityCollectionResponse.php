...
/**
 * SecurityHostReputationRuleSeverityCollectionResponse - Collection response
 */
class SecurityHostReputationRuleSeverityCollectionResponse
{
    /**
     * @var array<int, SecurityHostReputationRuleSeverity>
     */
    public array $value = [];
