 ...
 */
class ResultTemplateCollectionResponse
{
    /**
     * @var ResultTemplate[]
     */
     ...
     * 
     * @param ResultTemplate ...$items Variable number of ResultTemplate items
     * @return self
     */
    public function setValue(ResultTemplate ...$items): self
    {
        $this->value = $items;
        return $this;
    }
