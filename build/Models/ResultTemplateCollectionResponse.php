...
/**
 * Collection response for ResultTemplate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ResultTemplateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ResultTemplate[]
     */
     ...
     * 
     * @param ResultTemplate[] $items
     * @return self
     */
    public function setValue(array|ResultTemplate $items, ResultTemplate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ResultTemplate> $value
     * @return self
     ...
     * 
     * @param ResultTemplate $item
     * @return self
     */
    public function addValue(ResultTemplate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ResultTemplate>
     */
