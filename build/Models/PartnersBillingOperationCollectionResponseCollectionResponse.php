...
/**
 * Collection response for PartnersBillingOperationCollectionResponse
 */
class PartnersBillingOperationCollectionResponseCollectionResponse
{
    /**
     * @var PartnersBillingOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PartnersBillingOperationCollectionResponse ...$items Variable number of PartnersBillingOperationCollectionResponse items
     * @return self
     */
    public function setValue(PartnersBillingOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PartnersBillingOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PartnersBillingOperationCollectionResponse $item
     * @return self
     */
    public function addValue(PartnersBillingOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
