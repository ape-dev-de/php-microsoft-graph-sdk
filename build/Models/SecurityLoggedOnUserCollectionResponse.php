...
/**
 * Collection response for SecurityLoggedOnUser
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityLoggedOnUserCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityLoggedOnUser[] $items
     * @return self
     */
    public function setValue(array|SecurityLoggedOnUser $items, SecurityLoggedOnUser ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityLoggedOnUser> $value
     * @return self
     ...
     * 
     * @param SecurityLoggedOnUser $item
     * @return self
     */
    public function addValue(SecurityLoggedOnUser $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityLoggedOnUser|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityLoggedOnUser>
     */
