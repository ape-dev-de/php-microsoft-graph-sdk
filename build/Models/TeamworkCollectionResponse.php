...
/**
 * Collection response for Teamwork
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamworkCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Teamwork[]
     */
     ...
     * 
     * @param Teamwork[] $items
     * @return self
     */
    public function setValue(array|Teamwork $items, Teamwork ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Teamwork $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Teamwork>
     */
