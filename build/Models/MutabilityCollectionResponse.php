...
/**
 * Collection response for Mutability
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MutabilityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Mutability[]
     */
     ...
     * 
     * @param Mutability[] $items
     * @return self
     */
    public function setValue(array|Mutability $items, Mutability ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param Mutability $item
     * @return self
     */
    public function addValue(Mutability $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Mutability>
     */
