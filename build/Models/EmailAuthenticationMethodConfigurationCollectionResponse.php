...
/**
 * Collection response for EmailAuthenticationMethodConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EmailAuthenticationMethodConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EmailAuthenticationMethodConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param EmailAuthenticationMethodConfiguration[] $items
     * @return self
     */
    public function setValue(array|EmailAuthenticationMethodConfiguration $items, EmailAuthenticationMethodConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EmailAuthenticationMethodConfiguration> $value
     * @return self
     ...
     * 
     * @param EmailAuthenticationMethodConfiguration $item
     * @return self
     */
    public function addValue(EmailAuthenticationMethodConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EmailAuthenticationMethodConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EmailAuthenticationMethodConfiguration>
     */
