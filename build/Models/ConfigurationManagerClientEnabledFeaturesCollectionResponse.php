 ...
 */
class ConfigurationManagerClientEnabledFeaturesCollectionResponse
{
    /**
     ...
     * 
     * @param ConfigurationManagerClientEnabledFeatures ...$items Variable number of ConfigurationManagerClientEnabledFeatures items
     * @return self
     */
    public function setValue(ConfigurationManagerClientEnabledFeatures ...$items): self
    {
        $this->value = $items;
        return $this;
    }
