...
/**
 * Collection response for ConfigurationManagerClientEnabledFeatures
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConfigurationManagerClientEnabledFeaturesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ConfigurationManagerClientEnabledFeatures[] $items
     * @return self
     */
    public function setValue(array|ConfigurationManagerClientEnabledFeatures $items, ConfigurationManagerClientEnabledFeatures ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConfigurationManagerClientEnabledFeatures> $value
     * @return self
     ...
     * 
     * @param ConfigurationManagerClientEnabledFeatures $item
     * @return self
     */
    public function addValue(ConfigurationManagerClientEnabledFeatures $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConfigurationManagerClientEnabledFeatures>
     */
