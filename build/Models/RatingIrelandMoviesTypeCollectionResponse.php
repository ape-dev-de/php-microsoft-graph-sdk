...
/**
 * Collection response for RatingIrelandMoviesType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RatingIrelandMoviesTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RatingIrelandMoviesType[]
     */
    private array $value = [];
     ...
     * 
     * @return RatingIrelandMoviesType[]
     */
     ...
     * 
     * @param RatingIrelandMoviesType[] $items
     * @return self
     */
    public function setValue(array|RatingIrelandMoviesType $items, RatingIrelandMoviesType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RatingIrelandMoviesType> $value
     * @return self
     ...
     * 
     * @param RatingIrelandMoviesType $item
     * @return self
     */
    public function addValue(RatingIrelandMoviesType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RatingIrelandMoviesType>
     */
