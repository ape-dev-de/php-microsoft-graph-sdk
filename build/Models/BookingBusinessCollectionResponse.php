...
/**
 * Collection response for BookingBusiness
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingBusinessCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BookingBusiness[]
     */
     ...
     * 
     * @param BookingBusiness[] $items
     * @return self
     */
    public function setValue(array|BookingBusiness $items, BookingBusiness ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingBusiness> $value
     * @return self
     ...
     * 
     * @param BookingBusiness $item
     * @return self
     */
    public function addValue(BookingBusiness $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BookingBusiness>
     */
