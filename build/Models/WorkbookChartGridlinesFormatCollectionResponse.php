...
class WorkbookChartGridlinesFormatCollectionResponse
{
     ...
     * 
     * @param WorkbookChartGridlinesFormat ...$items Variable number of WorkbookChartGridlinesFormat items
     * @return self
     */
    public function setValue(WorkbookChartGridlinesFormat ...$items): self
    {
        $this->value = $items;
        return $this;
    }
