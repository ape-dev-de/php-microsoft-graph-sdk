...
/**
 * WorkbookChartGridlinesFormatCollectionResponse - Collection response
 */
class WorkbookChartGridlinesFormatCollectionResponse
{
    /**
     * @var array<int, WorkbookChartGridlinesFormat>
     */
    public array $value = [];
