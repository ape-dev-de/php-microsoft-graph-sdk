...
/**
 * Collection response for WorkbookChartGridlinesFormat
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookChartGridlinesFormatCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookChartGridlinesFormat[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookChartGridlinesFormat[] $items
     * @return self
     */
    public function setValue(array|WorkbookChartGridlinesFormat $items, WorkbookChartGridlinesFormat ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookChartGridlinesFormat> $value
     * @return self
     ...
     * 
     * @param WorkbookChartGridlinesFormat $item
     * @return self
     */
    public function addValue(WorkbookChartGridlinesFormat $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookChartGridlinesFormat>
     */
