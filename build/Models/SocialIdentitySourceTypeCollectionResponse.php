...
/**
 * Collection response for SocialIdentitySourceType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SocialIdentitySourceTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SocialIdentitySourceType[]
     */
    private array $value = [];
     ...
     * 
     * @return SocialIdentitySourceType[]
     */
     ...
     * 
     * @param SocialIdentitySourceType[] $items
     * @return self
     */
    public function setValue(array|SocialIdentitySourceType $items, SocialIdentitySourceType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SocialIdentitySourceType> $value
     * @return self
     ...
     * 
     * @param SocialIdentitySourceType $item
     * @return self
     */
    public function addValue(SocialIdentitySourceType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SocialIdentitySourceType>
     */
