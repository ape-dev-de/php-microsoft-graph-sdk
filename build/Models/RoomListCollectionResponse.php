...
/**
 * Collection response for RoomList
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RoomListCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RoomList[]
     */
     ...
     * 
     * @param RoomList[] $items
     * @return self
     */
    public function setValue(array|RoomList $items, RoomList ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(RoomList $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RoomList>
     */
