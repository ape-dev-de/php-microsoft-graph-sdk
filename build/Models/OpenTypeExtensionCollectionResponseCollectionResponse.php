...
/**
 * Collection response for OpenTypeExtensionCollectionResponse
 */
class OpenTypeExtensionCollectionResponseCollectionResponse
{
    /**
     * @var OpenTypeExtensionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param OpenTypeExtensionCollectionResponse ...$items Variable number of OpenTypeExtensionCollectionResponse items
     * @return self
     */
    public function setValue(OpenTypeExtensionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<OpenTypeExtensionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param OpenTypeExtensionCollectionResponse $item
     * @return self
     */
    public function addValue(OpenTypeExtensionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
