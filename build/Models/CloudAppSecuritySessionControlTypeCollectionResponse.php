...
/**
 * CloudAppSecuritySessionControlTypeCollectionResponse - Collection response
 */
class CloudAppSecuritySessionControlTypeCollectionResponse
{
    /**
     * @var array<int, CloudAppSecuritySessionControlType>
     */
    public array $value = [];
