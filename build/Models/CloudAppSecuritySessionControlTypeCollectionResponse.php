...
/**
 * Collection response for CloudAppSecuritySessionControlType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudAppSecuritySessionControlTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudAppSecuritySessionControlType[]
     */
    private array $value = [];
     ...
     * 
     * @return CloudAppSecuritySessionControlType[]
     */
     ...
     * 
     * @param CloudAppSecuritySessionControlType[] $items
     * @return self
     */
    public function setValue(array|CloudAppSecuritySessionControlType $items, CloudAppSecuritySessionControlType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudAppSecuritySessionControlType> $value
     * @return self
     ...
     * 
     * @param CloudAppSecuritySessionControlType $item
     * @return self
     */
    public function addValue(CloudAppSecuritySessionControlType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudAppSecuritySessionControlType>
     */
