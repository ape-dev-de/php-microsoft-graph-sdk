...
/**
 * Collection response for MessageRule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MessageRuleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MessageRule[]
     */
     ...
     * 
     * @param MessageRule[] $items
     * @return self
     */
    public function setValue(array|MessageRule $items, MessageRule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param MessageRule $item
     * @return self
     */
    public function addValue(MessageRule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MessageRule>
     */
