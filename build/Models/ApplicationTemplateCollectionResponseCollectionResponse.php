...
/**
 * Collection response for ApplicationTemplateCollectionResponse
 */
class ApplicationTemplateCollectionResponseCollectionResponse
{
    /**
     * @var ApplicationTemplateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ApplicationTemplateCollectionResponse ...$items Variable number of ApplicationTemplateCollectionResponse items
     * @return self
     */
    public function setValue(ApplicationTemplateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ApplicationTemplateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ApplicationTemplateCollectionResponse $item
     * @return self
     */
    public function addValue(ApplicationTemplateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
