...
/**
 * PartnersBillingBilledUsageCollectionResponse - Collection response
 */
class PartnersBillingBilledUsageCollectionResponse
{
    /**
     * @var array<int, PartnersBillingBilledUsage>
     */
    public array $value = [];
