...
/**
 * Collection response for PartnersBillingBilledUsage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PartnersBillingBilledUsageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PartnersBillingBilledUsage[]
     */
    private array $value = [];
     ...
     * 
     * @param PartnersBillingBilledUsage[] $items
     * @return self
     */
    public function setValue(array|PartnersBillingBilledUsage $items, PartnersBillingBilledUsage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PartnersBillingBilledUsage> $value
     * @return self
     ...
     * 
     * @param PartnersBillingBilledUsage $item
     * @return self
     */
    public function addValue(PartnersBillingBilledUsage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PartnersBillingBilledUsage|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PartnersBillingBilledUsage>
     */
