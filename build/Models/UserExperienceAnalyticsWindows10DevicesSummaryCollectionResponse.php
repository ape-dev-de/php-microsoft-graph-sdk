...
/**
 * Collection response for UserExperienceAnalyticsWindows10DevicesSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsWindows10DevicesSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserExperienceAnalyticsWindows10DevicesSummary[]
     */
    private array $value = [];
     ...
     * 
     * @param UserExperienceAnalyticsWindows10DevicesSummary[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsWindows10DevicesSummary $items, UserExperienceAnalyticsWindows10DevicesSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsWindows10DevicesSummary> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsWindows10DevicesSummary $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsWindows10DevicesSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsWindows10DevicesSummary>
     */
