 ...
 */
class UserExperienceAnalyticsWindows10DevicesSummaryCollectionResponse
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsWindows10DevicesSummary ...$items Variable number of UserExperienceAnalyticsWindows10DevicesSummary items
     * @return self
     */
    public function setValue(UserExperienceAnalyticsWindows10DevicesSummary ...$items): self
    {
        $this->value = $items;
        return $this;
    }
