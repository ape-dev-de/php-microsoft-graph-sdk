...
/**
 * RestoreArtifactsBulkRequestStatusCollectionResponse - Collection response
 */
class RestoreArtifactsBulkRequestStatusCollectionResponse
{
    /**
     * @var array<int, RestoreArtifactsBulkRequestStatus>
     */
    public array $value = [];
