...
/**
 * Collection response for RestoreArtifactsBulkRequestStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RestoreArtifactsBulkRequestStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RestoreArtifactsBulkRequestStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return RestoreArtifactsBulkRequestStatus[]
     */
     ...
     * 
     * @param RestoreArtifactsBulkRequestStatus[] $items
     * @return self
     */
    public function setValue(array|RestoreArtifactsBulkRequestStatus $items, RestoreArtifactsBulkRequestStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RestoreArtifactsBulkRequestStatus> $value
     * @return self
     ...
     * 
     * @param RestoreArtifactsBulkRequestStatus $item
     * @return self
     */
    public function addValue(RestoreArtifactsBulkRequestStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RestoreArtifactsBulkRequestStatus>
     */
