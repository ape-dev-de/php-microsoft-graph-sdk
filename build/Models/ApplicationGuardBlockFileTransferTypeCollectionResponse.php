...
/**
 * Collection response for ApplicationGuardBlockFileTransferType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ApplicationGuardBlockFileTransferTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ApplicationGuardBlockFileTransferType[]
     */
    private array $value = [];
     ...
     * 
     * @return ApplicationGuardBlockFileTransferType[]
     */
     ...
     * 
     * @param ApplicationGuardBlockFileTransferType[] $items
     * @return self
     */
    public function setValue(array|ApplicationGuardBlockFileTransferType $items, ApplicationGuardBlockFileTransferType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ApplicationGuardBlockFileTransferType> $value
     * @return self
     ...
     * 
     * @param ApplicationGuardBlockFileTransferType $item
     * @return self
     */
    public function addValue(ApplicationGuardBlockFileTransferType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ApplicationGuardBlockFileTransferType>
     */
