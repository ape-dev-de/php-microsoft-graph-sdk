...
/**
 * ApplicationGuardBlockFileTransferTypeCollectionResponse - Collection response
 */
class ApplicationGuardBlockFileTransferTypeCollectionResponse
{
    /**
     * @var array<int, ApplicationGuardBlockFileTransferType>
     */
    public array $value = [];
