...
/**
 * Collection response for ObjectMappingMetadata
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ObjectMappingMetadataCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ObjectMappingMetadata[]
     */
    private array $value = [];
     ...
     * 
     * @param ObjectMappingMetadata[] $items
     * @return self
     */
    public function setValue(array|ObjectMappingMetadata $items, ObjectMappingMetadata ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ObjectMappingMetadata> $value
     * @return self
     ...
     * 
     * @param ObjectMappingMetadata $item
     * @return self
     */
    public function addValue(ObjectMappingMetadata $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ObjectMappingMetadata>
     */
