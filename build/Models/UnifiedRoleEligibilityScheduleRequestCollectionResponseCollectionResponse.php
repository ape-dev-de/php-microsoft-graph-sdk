...
/**
 * Collection response for UnifiedRoleEligibilityScheduleRequestCollectionResponse
 */
class UnifiedRoleEligibilityScheduleRequestCollectionResponseCollectionResponse
{
    /**
     * @var UnifiedRoleEligibilityScheduleRequestCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedRoleEligibilityScheduleRequestCollectionResponse ...$items Variable number of UnifiedRoleEligibilityScheduleRequestCollectionResponse items
     * @return self
     */
    public function setValue(UnifiedRoleEligibilityScheduleRequestCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UnifiedRoleEligibilityScheduleRequestCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleEligibilityScheduleRequestCollectionResponse $item
     * @return self
     */
    public function addValue(UnifiedRoleEligibilityScheduleRequestCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
