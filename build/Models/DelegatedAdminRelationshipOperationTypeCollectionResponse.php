...
/**
 * DelegatedAdminRelationshipOperationTypeCollectionResponse - Collection response
 */
class DelegatedAdminRelationshipOperationTypeCollectionResponse
{
    /**
     * @var array<int, DelegatedAdminRelationshipOperationType>
     */
    public array $value = [];
