...
/**
 * Collection response for DelegatedAdminRelationshipOperationType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DelegatedAdminRelationshipOperationTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DelegatedAdminRelationshipOperationType[]
     */
    private array $value = [];
     ...
     * 
     * @return DelegatedAdminRelationshipOperationType[]
     */
     ...
     * 
     * @param DelegatedAdminRelationshipOperationType[] $items
     * @return self
     */
    public function setValue(array|DelegatedAdminRelationshipOperationType $items, DelegatedAdminRelationshipOperationType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DelegatedAdminRelationshipOperationType> $value
     * @return self
     ...
     * 
     * @param DelegatedAdminRelationshipOperationType $item
     * @return self
     */
    public function addValue(DelegatedAdminRelationshipOperationType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DelegatedAdminRelationshipOperationType>
     */
