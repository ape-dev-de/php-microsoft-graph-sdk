...
/**
 * Collection response for SecurityFileDetails
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityFileDetailsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityFileDetails[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityFileDetails[] $items
     * @return self
     */
    public function setValue(array|SecurityFileDetails $items, SecurityFileDetails ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityFileDetails> $value
     * @return self
     ...
     * 
     * @param SecurityFileDetails $item
     * @return self
     */
    public function addValue(SecurityFileDetails $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityFileDetails|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityFileDetails>
     */
