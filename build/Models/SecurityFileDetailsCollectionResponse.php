 ...
 */
class SecurityFileDetailsCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityFileDetails ...$items Variable number of SecurityFileDetails items
     * @return self
     */
    public function setValue(SecurityFileDetails ...$items): self
    {
        $this->value = $items;
        return $this;
    }
