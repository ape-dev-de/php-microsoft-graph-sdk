...
/**
 * Collection response for CalendarSharingMessage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CalendarSharingMessageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CalendarSharingMessage[]
     */
    private array $value = [];
     ...
     * 
     * @param CalendarSharingMessage[] $items
     * @return self
     */
    public function setValue(array|CalendarSharingMessage $items, CalendarSharingMessage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CalendarSharingMessage> $value
     * @return self
     ...
     * 
     * @param CalendarSharingMessage $item
     * @return self
     */
    public function addValue(CalendarSharingMessage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CalendarSharingMessage|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CalendarSharingMessage>
     */
