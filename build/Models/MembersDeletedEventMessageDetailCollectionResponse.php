 ...
 */
class MembersDeletedEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param MembersDeletedEventMessageDetail ...$items Variable number of MembersDeletedEventMessageDetail items
     * @return self
     */
    public function setValue(MembersDeletedEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
