...
/**
 * Collection response for MembersDeletedEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MembersDeletedEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MembersDeletedEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param MembersDeletedEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|MembersDeletedEventMessageDetail $items, MembersDeletedEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MembersDeletedEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param MembersDeletedEventMessageDetail $item
     * @return self
     */
    public function addValue(MembersDeletedEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MembersDeletedEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MembersDeletedEventMessageDetail>
     */
