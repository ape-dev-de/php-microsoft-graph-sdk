...
/**
 * Collection response for Print
 */
class PrintCollectionResponse
{
    /**
     * @var Print[]
     */
     ...
     * 
     * @param Print ...$items Variable number of Print items
     * @return self
     */
    public function setValue(Print ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * @return self
     */
    public function addValue(Print $item): self
    {
        $this->value[] = $item;
        return $this;
    }
