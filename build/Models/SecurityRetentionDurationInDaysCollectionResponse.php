 ...
 */
class SecurityRetentionDurationInDaysCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityRetentionDurationInDays ...$items Variable number of SecurityRetentionDurationInDays items
     * @return self
     */
    public function setValue(SecurityRetentionDurationInDays ...$items): self
    {
        $this->value = $items;
        return $this;
    }
