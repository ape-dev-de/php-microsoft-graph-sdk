...
/**
 * Collection response for SecurityRetentionDurationInDays
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityRetentionDurationInDaysCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityRetentionDurationInDays[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityRetentionDurationInDays[]
     */
     ...
     * 
     * @param SecurityRetentionDurationInDays[] $items
     * @return self
     */
    public function setValue(array|SecurityRetentionDurationInDays $items, SecurityRetentionDurationInDays ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityRetentionDurationInDays> $value
     * @return self
     ...
     * 
     * @param SecurityRetentionDurationInDays $item
     * @return self
     */
    public function addValue(SecurityRetentionDurationInDays $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityRetentionDurationInDays|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityRetentionDurationInDays>
     */
