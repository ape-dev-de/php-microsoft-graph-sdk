...
/**
 * Collection response for DeleteAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeleteActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeleteAction[]
     */
     ...
     * 
     * @param DeleteAction[] $items
     * @return self
     */
    public function setValue(array|DeleteAction $items, DeleteAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeleteAction> $value
     * @return self
     ...
     * 
     * @param DeleteAction $item
     * @return self
     */
    public function addValue(DeleteAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeleteAction>
     */
