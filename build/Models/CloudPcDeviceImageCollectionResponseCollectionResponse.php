...
/**
 * Collection response for CloudPcDeviceImageCollectionResponse
 */
class CloudPcDeviceImageCollectionResponseCollectionResponse
{
    /**
     * @var CloudPcDeviceImageCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudPcDeviceImageCollectionResponse ...$items Variable number of CloudPcDeviceImageCollectionResponse items
     * @return self
     */
    public function setValue(CloudPcDeviceImageCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CloudPcDeviceImageCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CloudPcDeviceImageCollectionResponse $item
     * @return self
     */
    public function addValue(CloudPcDeviceImageCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
