...
/**
 * Collection response for MediaInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MediaInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MediaInfo[]
     */
     ...
     * 
     * @param MediaInfo[] $items
     * @return self
     */
    public function setValue(array|MediaInfo $items, MediaInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param MediaInfo $item
     * @return self
     */
    public function addValue(MediaInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MediaInfo>
     */
