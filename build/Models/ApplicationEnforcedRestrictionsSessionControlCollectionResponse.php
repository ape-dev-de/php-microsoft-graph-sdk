...
/**
 * Collection response for ApplicationEnforcedRestrictionsSessionControl
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ApplicationEnforcedRestrictionsSessionControlCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ApplicationEnforcedRestrictionsSessionControl[]
     */
    private array $value = [];
     ...
     * 
     * @param ApplicationEnforcedRestrictionsSessionControl[] $items
     * @return self
     */
    public function setValue(array|ApplicationEnforcedRestrictionsSessionControl $items, ApplicationEnforcedRestrictionsSessionControl ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ApplicationEnforcedRestrictionsSessionControl> $value
     * @return self
     ...
     * 
     * @param ApplicationEnforcedRestrictionsSessionControl $item
     * @return self
     */
    public function addValue(ApplicationEnforcedRestrictionsSessionControl $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ApplicationEnforcedRestrictionsSessionControl>
     */
