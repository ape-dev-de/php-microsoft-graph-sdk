...
/**
 * ApplicationEnforcedRestrictionsSessionControlCollectionResponse - Collection response
 */
class ApplicationEnforcedRestrictionsSessionControlCollectionResponse
{
    /**
     * @var array<int, ApplicationEnforcedRestrictionsSessionControl>
     */
    public array $value = [];
