...
/**
 * Collection response for ExternalConnectorsDisplayTemplate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsDisplayTemplateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return ExternalConnectorsDisplayTemplate[]
     */
     ...
     * 
     * @param ExternalConnectorsDisplayTemplate[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsDisplayTemplate $items, ExternalConnectorsDisplayTemplate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsDisplayTemplate> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsDisplayTemplate $item
     * @return self
     */
    public function addValue(ExternalConnectorsDisplayTemplate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalConnectorsDisplayTemplate|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsDisplayTemplate>
     */
