...
/**
 * Collection response for UserRegistrationMethodCount
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserRegistrationMethodCountCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserRegistrationMethodCount[] $items
     * @return self
     */
    public function setValue(array|UserRegistrationMethodCount $items, UserRegistrationMethodCount ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserRegistrationMethodCount> $value
     * @return self
     ...
     * 
     * @param UserRegistrationMethodCount $item
     * @return self
     */
    public function addValue(UserRegistrationMethodCount $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UserRegistrationMethodCount|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UserRegistrationMethodCount>
     */
