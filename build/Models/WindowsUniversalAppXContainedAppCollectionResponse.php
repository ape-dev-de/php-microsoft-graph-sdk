...
/**
 * Collection response for WindowsUniversalAppXContainedApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsUniversalAppXContainedAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WindowsUniversalAppXContainedApp[] $items
     * @return self
     */
    public function setValue(array|WindowsUniversalAppXContainedApp $items, WindowsUniversalAppXContainedApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsUniversalAppXContainedApp> $value
     * @return self
     ...
     * 
     * @param WindowsUniversalAppXContainedApp $item
     * @return self
     */
    public function addValue(WindowsUniversalAppXContainedApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WindowsUniversalAppXContainedApp|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WindowsUniversalAppXContainedApp>
     */
