...
/**
 * Collection response for HorizontalSectionColumn
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class HorizontalSectionColumnCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param HorizontalSectionColumn[] $items
     * @return self
     */
    public function setValue(array|HorizontalSectionColumn $items, HorizontalSectionColumn ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<HorizontalSectionColumn> $value
     * @return self
     ...
     * 
     * @param HorizontalSectionColumn $item
     * @return self
     */
    public function addValue(HorizontalSectionColumn $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, HorizontalSectionColumn>
     */
