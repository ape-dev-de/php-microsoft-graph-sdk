...
/**
 * Collection response for DirectoryRoleTemplateCollectionResponse
 */
class DirectoryRoleTemplateCollectionResponseCollectionResponse
{
    /**
     * @var DirectoryRoleTemplateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DirectoryRoleTemplateCollectionResponse ...$items Variable number of DirectoryRoleTemplateCollectionResponse items
     * @return self
     */
    public function setValue(DirectoryRoleTemplateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DirectoryRoleTemplateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DirectoryRoleTemplateCollectionResponse $item
     * @return self
     */
    public function addValue(DirectoryRoleTemplateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
