...
/**
 * Collection response for CustomExtensionStageSetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CustomExtensionStageSettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CustomExtensionStageSetting[] $items
     * @return self
     */
    public function setValue(array|CustomExtensionStageSetting $items, CustomExtensionStageSetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CustomExtensionStageSetting> $value
     * @return self
     ...
     * 
     * @param CustomExtensionStageSetting $item
     * @return self
     */
    public function addValue(CustomExtensionStageSetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CustomExtensionStageSetting>
     */
