...
/**
 * Collection response for WindowsDeviceUsageType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsDeviceUsageTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsDeviceUsageType[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsDeviceUsageType[] $items
     * @return self
     */
    public function setValue(array|WindowsDeviceUsageType $items, WindowsDeviceUsageType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsDeviceUsageType> $value
     * @return self
     ...
     * 
     * @param WindowsDeviceUsageType $item
     * @return self
     */
    public function addValue(WindowsDeviceUsageType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsDeviceUsageType>
     */
