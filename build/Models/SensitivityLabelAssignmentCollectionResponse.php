...
/**
 * Collection response for SensitivityLabelAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SensitivityLabelAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SensitivityLabelAssignment[] $items
     * @return self
     */
    public function setValue(array|SensitivityLabelAssignment $items, SensitivityLabelAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SensitivityLabelAssignment> $value
     * @return self
     ...
     * 
     * @param SensitivityLabelAssignment $item
     * @return self
     */
    public function addValue(SensitivityLabelAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SensitivityLabelAssignment>
     */
