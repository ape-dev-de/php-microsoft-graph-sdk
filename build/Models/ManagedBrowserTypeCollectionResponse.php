...
/**
 * Collection response for ManagedBrowserType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedBrowserTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ManagedBrowserType[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedBrowserType[] $items
     * @return self
     */
    public function setValue(array|ManagedBrowserType $items, ManagedBrowserType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedBrowserType> $value
     * @return self
     ...
     * 
     * @param ManagedBrowserType $item
     * @return self
     */
    public function addValue(ManagedBrowserType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedBrowserType>
     */
