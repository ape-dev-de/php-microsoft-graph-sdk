 ...
 */
class LogicAppTriggerEndpointConfigurationCollectionResponse
{
    /**
     ...
     * 
     * @param LogicAppTriggerEndpointConfiguration ...$items Variable number of LogicAppTriggerEndpointConfiguration items
     * @return self
     */
    public function setValue(LogicAppTriggerEndpointConfiguration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
