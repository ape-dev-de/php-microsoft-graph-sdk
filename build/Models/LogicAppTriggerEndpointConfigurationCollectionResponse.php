...
/**
 * Collection response for LogicAppTriggerEndpointConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LogicAppTriggerEndpointConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var LogicAppTriggerEndpointConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param LogicAppTriggerEndpointConfiguration[] $items
     * @return self
     */
    public function setValue(array|LogicAppTriggerEndpointConfiguration $items, LogicAppTriggerEndpointConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LogicAppTriggerEndpointConfiguration> $value
     * @return self
     ...
     * 
     * @param LogicAppTriggerEndpointConfiguration $item
     * @return self
     */
    public function addValue(LogicAppTriggerEndpointConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return LogicAppTriggerEndpointConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, LogicAppTriggerEndpointConfiguration>
     */
