...
/**
 * Collection response for IosVppEBookAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosVppEBookAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IosVppEBookAssignment[]
     */
    private array $value = [];
     ...
     * 
     * @param IosVppEBookAssignment[] $items
     * @return self
     */
    public function setValue(array|IosVppEBookAssignment $items, IosVppEBookAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosVppEBookAssignment> $value
     * @return self
     ...
     * 
     * @param IosVppEBookAssignment $item
     * @return self
     */
    public function addValue(IosVppEBookAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IosVppEBookAssignment|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IosVppEBookAssignment>
     */
