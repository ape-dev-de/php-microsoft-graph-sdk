...
/**
 * Collection response for AuthenticationMethodCollectionResponse
 */
class AuthenticationMethodCollectionResponseCollectionResponse
{
    /**
     * @var AuthenticationMethodCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AuthenticationMethodCollectionResponse ...$items Variable number of AuthenticationMethodCollectionResponse items
     * @return self
     */
    public function setValue(AuthenticationMethodCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AuthenticationMethodCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AuthenticationMethodCollectionResponse $item
     * @return self
     */
    public function addValue(AuthenticationMethodCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
