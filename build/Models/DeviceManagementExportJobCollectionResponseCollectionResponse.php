...
/**
 * Collection response for DeviceManagementExportJobCollectionResponse
 */
class DeviceManagementExportJobCollectionResponseCollectionResponse
{
    /**
     * @var DeviceManagementExportJobCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceManagementExportJobCollectionResponse ...$items Variable number of DeviceManagementExportJobCollectionResponse items
     * @return self
     */
    public function setValue(DeviceManagementExportJobCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeviceManagementExportJobCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeviceManagementExportJobCollectionResponse $item
     * @return self
     */
    public function addValue(DeviceManagementExportJobCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
