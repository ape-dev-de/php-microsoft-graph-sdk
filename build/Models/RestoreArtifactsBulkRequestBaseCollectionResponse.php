 ...
 */
class RestoreArtifactsBulkRequestBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param RestoreArtifactsBulkRequestBase[] $items
     * @return self
     */
    public function setValue(array|RestoreArtifactsBulkRequestBase $items, RestoreArtifactsBulkRequestBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param mixed $offset
     * @return RestoreArtifactsBulkRequestBase|null
     */
     ...
     * 
     * @return \ArrayIterator<int, RestoreArtifactsBulkRequestBase>
     */
