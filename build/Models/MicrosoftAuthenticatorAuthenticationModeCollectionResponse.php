...
/**
 * Collection response for MicrosoftAuthenticatorAuthenticationMode
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MicrosoftAuthenticatorAuthenticationModeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MicrosoftAuthenticatorAuthenticationMode[]
     */
    private array $value = [];
     ...
     * 
     * @return MicrosoftAuthenticatorAuthenticationMode[]
     */
     ...
     * 
     * @param MicrosoftAuthenticatorAuthenticationMode[] $items
     * @return self
     */
    public function setValue(array|MicrosoftAuthenticatorAuthenticationMode $items, MicrosoftAuthenticatorAuthenticationMode ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MicrosoftAuthenticatorAuthenticationMode> $value
     * @return self
     ...
     * 
     * @param MicrosoftAuthenticatorAuthenticationMode $item
     * @return self
     */
    public function addValue(MicrosoftAuthenticatorAuthenticationMode $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MicrosoftAuthenticatorAuthenticationMode>
     */
