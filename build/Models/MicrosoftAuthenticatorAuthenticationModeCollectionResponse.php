...
/**
 * MicrosoftAuthenticatorAuthenticationModeCollectionResponse - Collection response
 */
class MicrosoftAuthenticatorAuthenticationModeCollectionResponse
{
    /**
     * @var array<int, MicrosoftAuthenticatorAuthenticationMode>
     */
    public array $value = [];
