...
/**
 * Collection response for ResourceAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ResourceActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ResourceAction[]
     */
     ...
     * 
     * @param ResourceAction[] $items
     * @return self
     */
    public function setValue(array|ResourceAction $items, ResourceAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ResourceAction> $value
     * @return self
     ...
     * 
     * @param ResourceAction $item
     * @return self
     */
    public function addValue(ResourceAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ResourceAction>
     */
