...
/**
 * Collection response for ScreenSharingRole
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ScreenSharingRoleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ScreenSharingRole[]
     */
    private array $value = [];
     ...
     * 
     * @param ScreenSharingRole[] $items
     * @return self
     */
    public function setValue(array|ScreenSharingRole $items, ScreenSharingRole ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ScreenSharingRole> $value
     * @return self
     ...
     * 
     * @param ScreenSharingRole $item
     * @return self
     */
    public function addValue(ScreenSharingRole $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ScreenSharingRole>
     */
