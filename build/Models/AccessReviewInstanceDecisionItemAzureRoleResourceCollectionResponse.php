 ...
 */
class AccessReviewInstanceDecisionItemAzureRoleResourceCollectionResponse
{
    /**
     ...
     * 
     * @param AccessReviewInstanceDecisionItemAzureRoleResource ...$items Variable number of AccessReviewInstanceDecisionItemAzureRoleResource items
     * @return self
     */
    public function setValue(AccessReviewInstanceDecisionItemAzureRoleResource ...$items): self
    {
        $this->value = $items;
        return $this;
    }
