...
/**
 * Collection response for AccessReviewInstanceDecisionItemAzureRoleResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewInstanceDecisionItemAzureRoleResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessReviewInstanceDecisionItemAzureRoleResource[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessReviewInstanceDecisionItemAzureRoleResource[] $items
     * @return self
     */
    public function setValue(array|AccessReviewInstanceDecisionItemAzureRoleResource $items, AccessReviewInstanceDecisionItemAzureRoleResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewInstanceDecisionItemAzureRoleResource> $value
     * @return self
     ...
     * 
     * @param AccessReviewInstanceDecisionItemAzureRoleResource $item
     * @return self
     */
    public function addValue(AccessReviewInstanceDecisionItemAzureRoleResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessReviewInstanceDecisionItemAzureRoleResource|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewInstanceDecisionItemAzureRoleResource>
     */
