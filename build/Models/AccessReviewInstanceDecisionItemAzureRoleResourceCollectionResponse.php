...
/**
 * AccessReviewInstanceDecisionItemAzureRoleResourceCollectionResponse - Collection response
 */
class AccessReviewInstanceDecisionItemAzureRoleResourceCollectionResponse
{
    /**
     * @var array<int, AccessReviewInstanceDecisionItemAzureRoleResource>
     */
    public array $value = [];
