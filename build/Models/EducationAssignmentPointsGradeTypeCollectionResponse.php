...
/**
 * Collection response for EducationAssignmentPointsGradeType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationAssignmentPointsGradeTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationAssignmentPointsGradeType[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationAssignmentPointsGradeType[] $items
     * @return self
     */
    public function setValue(array|EducationAssignmentPointsGradeType $items, EducationAssignmentPointsGradeType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationAssignmentPointsGradeType> $value
     * @return self
     ...
     * 
     * @param EducationAssignmentPointsGradeType $item
     * @return self
     */
    public function addValue(EducationAssignmentPointsGradeType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EducationAssignmentPointsGradeType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EducationAssignmentPointsGradeType>
     */
