 ...
 */
class EducationAssignmentPointsGradeTypeCollectionResponse
{
    /**
     ...
     * 
     * @param EducationAssignmentPointsGradeType ...$items Variable number of EducationAssignmentPointsGradeType items
     * @return self
     */
    public function setValue(EducationAssignmentPointsGradeType ...$items): self
    {
        $this->value = $items;
        return $this;
    }
