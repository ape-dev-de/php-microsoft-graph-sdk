...
/**
 * AllDevicesAssignmentTargetCollectionResponse - Collection response
 */
class AllDevicesAssignmentTargetCollectionResponse
{
    /**
     * @var array<int, AllDevicesAssignmentTarget>
     */
    public array $value = [];
