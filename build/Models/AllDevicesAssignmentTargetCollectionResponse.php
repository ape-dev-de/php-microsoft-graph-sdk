...
/**
 * Collection response for AllDevicesAssignmentTarget
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AllDevicesAssignmentTargetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AllDevicesAssignmentTarget[]
     */
    private array $value = [];
     ...
     * 
     * @param AllDevicesAssignmentTarget[] $items
     * @return self
     */
    public function setValue(array|AllDevicesAssignmentTarget $items, AllDevicesAssignmentTarget ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AllDevicesAssignmentTarget> $value
     * @return self
     ...
     * 
     * @param AllDevicesAssignmentTarget $item
     * @return self
     */
    public function addValue(AllDevicesAssignmentTarget $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AllDevicesAssignmentTarget|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AllDevicesAssignmentTarget>
     */
