...
/**
 * Collection response for Filter
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FilterCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Filter[]
     */
     ...
     * @return self
     */
    public function setValue(array|Filter $items, Filter ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Filter $item): self
    {
        $this->value[] = $item;
        return $this;
    }
