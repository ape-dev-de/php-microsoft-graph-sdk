...
/**
 * Collection response for ManagedDeviceMobileAppConfigurationDeviceSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedDeviceMobileAppConfigurationDeviceSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ManagedDeviceMobileAppConfigurationDeviceSummary[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedDeviceMobileAppConfigurationDeviceSummary[] $items
     * @return self
     */
    public function setValue(array|ManagedDeviceMobileAppConfigurationDeviceSummary $items, ManagedDeviceMobileAppConfigurationDeviceSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedDeviceMobileAppConfigurationDeviceSummary> $value
     * @return self
     ...
     * 
     * @param ManagedDeviceMobileAppConfigurationDeviceSummary $item
     * @return self
     */
    public function addValue(ManagedDeviceMobileAppConfigurationDeviceSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedDeviceMobileAppConfigurationDeviceSummary>
     */
