 ...
 */
class ManagedDeviceMobileAppConfigurationDeviceSummaryCollectionResponse
{
    /**
     ...
     * 
     * @param ManagedDeviceMobileAppConfigurationDeviceSummary ...$items Variable number of ManagedDeviceMobileAppConfigurationDeviceSummary items
     * @return self
     */
    public function setValue(ManagedDeviceMobileAppConfigurationDeviceSummary ...$items): self
    {
        $this->value = $items;
        return $this;
    }
