...
/**
 * Collection response for ObjectIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ObjectIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ObjectIdentity[]
     */
     ...
     * 
     * @param ObjectIdentity[] $items
     * @return self
     */
    public function setValue(array|ObjectIdentity $items, ObjectIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ObjectIdentity> $value
     * @return self
     ...
     * 
     * @param ObjectIdentity $item
     * @return self
     */
    public function addValue(ObjectIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ObjectIdentity>
     */
