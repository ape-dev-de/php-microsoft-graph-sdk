...
/**
 * Collection response for WindowsSpotlightEnablementSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsSpotlightEnablementSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsSpotlightEnablementSettings[]
     */
    private array $value = [];
     ...
     * 
     * @return WindowsSpotlightEnablementSettings[]
     */
     ...
     * 
     * @param WindowsSpotlightEnablementSettings[] $items
     * @return self
     */
    public function setValue(array|WindowsSpotlightEnablementSettings $items, WindowsSpotlightEnablementSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsSpotlightEnablementSettings> $value
     * @return self
     ...
     * 
     * @param WindowsSpotlightEnablementSettings $item
     * @return self
     */
    public function addValue(WindowsSpotlightEnablementSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsSpotlightEnablementSettings>
     */
