...
/**
 * WindowsSpotlightEnablementSettingsCollectionResponse - Collection response
 */
class WindowsSpotlightEnablementSettingsCollectionResponse
{
    /**
     * @var array<int, WindowsSpotlightEnablementSettings>
     */
    public array $value = [];
