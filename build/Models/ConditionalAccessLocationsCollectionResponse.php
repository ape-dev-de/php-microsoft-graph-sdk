 ...
 */
class ConditionalAccessLocationsCollectionResponse
{
    /**
     ...
     * 
     * @param ConditionalAccessLocations ...$items Variable number of ConditionalAccessLocations items
     * @return self
     */
    public function setValue(ConditionalAccessLocations ...$items): self
    {
        $this->value = $items;
        return $this;
    }
