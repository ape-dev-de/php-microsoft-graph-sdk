...
/**
 * Collection response for ConditionalAccessLocations
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessLocationsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessLocations[]
     */
    private array $value = [];
     ...
     * 
     * @param ConditionalAccessLocations[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessLocations $items, ConditionalAccessLocations ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessLocations> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessLocations $item
     * @return self
     */
    public function addValue(ConditionalAccessLocations $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessLocations>
     */
