...
/**
 * Collection response for AttendanceRecord
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttendanceRecordCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AttendanceRecord[] $items
     * @return self
     */
    public function setValue(array|AttendanceRecord $items, AttendanceRecord ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttendanceRecord> $value
     * @return self
     ...
     * 
     * @param AttendanceRecord $item
     * @return self
     */
    public function addValue(AttendanceRecord $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AttendanceRecord>
     */
