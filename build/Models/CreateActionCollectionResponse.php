...
/**
 * Collection response for CreateAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CreateActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CreateAction[]
     */
     ...
     * 
     * @param CreateAction[] $items
     * @return self
     */
    public function setValue(array|CreateAction $items, CreateAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CreateAction> $value
     * @return self
     ...
     * 
     * @param CreateAction $item
     * @return self
     */
    public function addValue(CreateAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CreateAction>
     */
