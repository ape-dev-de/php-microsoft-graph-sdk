 ...
 */
class CallMediaStateCollectionResponse
{
    /**
     * @var CallMediaState[]
     */
     ...
     * 
     * @param CallMediaState ...$items Variable number of CallMediaState items
     * @return self
     */
    public function setValue(CallMediaState ...$items): self
    {
        $this->value = $items;
        return $this;
    }
