...
/**
 * Collection response for CallMediaState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallMediaStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallMediaState[]
     */
     ...
     * 
     * @param CallMediaState[] $items
     * @return self
     */
    public function setValue(array|CallMediaState $items, CallMediaState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallMediaState> $value
     * @return self
     ...
     * 
     * @param CallMediaState $item
     * @return self
     */
    public function addValue(CallMediaState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CallMediaState>
     */
