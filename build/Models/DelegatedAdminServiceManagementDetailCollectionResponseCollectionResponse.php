...
/**
 * Collection response for DelegatedAdminServiceManagementDetailCollectionResponse
 */
class DelegatedAdminServiceManagementDetailCollectionResponseCollectionResponse
{
    /**
     * @var DelegatedAdminServiceManagementDetailCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DelegatedAdminServiceManagementDetailCollectionResponse ...$items Variable number of DelegatedAdminServiceManagementDetailCollectionResponse items
     * @return self
     */
    public function setValue(DelegatedAdminServiceManagementDetailCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DelegatedAdminServiceManagementDetailCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DelegatedAdminServiceManagementDetailCollectionResponse $item
     * @return self
     */
    public function addValue(DelegatedAdminServiceManagementDetailCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
