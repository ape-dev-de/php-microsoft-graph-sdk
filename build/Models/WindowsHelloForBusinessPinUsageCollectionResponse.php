...
/**
 * WindowsHelloForBusinessPinUsageCollectionResponse - Collection response
 */
class WindowsHelloForBusinessPinUsageCollectionResponse
{
    /**
     * @var array<int, WindowsHelloForBusinessPinUsage>
     */
    public array $value = [];
