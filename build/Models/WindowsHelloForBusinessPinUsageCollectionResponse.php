...
/**
 * Collection response for WindowsHelloForBusinessPinUsage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsHelloForBusinessPinUsageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return WindowsHelloForBusinessPinUsage[]
     */
     ...
     * 
     * @param WindowsHelloForBusinessPinUsage[] $items
     * @return self
     */
    public function setValue(array|WindowsHelloForBusinessPinUsage $items, WindowsHelloForBusinessPinUsage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsHelloForBusinessPinUsage> $value
     * @return self
     ...
     * 
     * @param WindowsHelloForBusinessPinUsage $item
     * @return self
     */
    public function addValue(WindowsHelloForBusinessPinUsage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsHelloForBusinessPinUsage>
     */
