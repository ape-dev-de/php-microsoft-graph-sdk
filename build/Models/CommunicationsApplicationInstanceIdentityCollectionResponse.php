...
/**
 * Collection response for CommunicationsApplicationInstanceIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CommunicationsApplicationInstanceIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CommunicationsApplicationInstanceIdentity[]
     */
    private array $value = [];
     ...
     * 
     * @param CommunicationsApplicationInstanceIdentity[] $items
     * @return self
     */
    public function setValue(array|CommunicationsApplicationInstanceIdentity $items, CommunicationsApplicationInstanceIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CommunicationsApplicationInstanceIdentity> $value
     * @return self
     ...
     * 
     * @param CommunicationsApplicationInstanceIdentity $item
     * @return self
     */
    public function addValue(CommunicationsApplicationInstanceIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CommunicationsApplicationInstanceIdentity|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CommunicationsApplicationInstanceIdentity>
     */
