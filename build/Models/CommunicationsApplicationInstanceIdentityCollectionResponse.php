 ...
 */
class CommunicationsApplicationInstanceIdentityCollectionResponse
{
    /**
     ...
     * 
     * @param CommunicationsApplicationInstanceIdentity ...$items Variable number of CommunicationsApplicationInstanceIdentity items
     * @return self
     */
    public function setValue(CommunicationsApplicationInstanceIdentity ...$items): self
    {
        $this->value = $items;
        return $this;
    }
