...
/**
 * Collection response for ChatMessageAttachmentCollectionResponse
 */
class ChatMessageAttachmentCollectionResponseCollectionResponse
{
    /**
     * @var ChatMessageAttachmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ChatMessageAttachmentCollectionResponse ...$items Variable number of ChatMessageAttachmentCollectionResponse items
     * @return self
     */
    public function setValue(ChatMessageAttachmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ChatMessageAttachmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ChatMessageAttachmentCollectionResponse $item
     * @return self
     */
    public function addValue(ChatMessageAttachmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
