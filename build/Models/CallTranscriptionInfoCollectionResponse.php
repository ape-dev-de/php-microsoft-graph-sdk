 ...
 */
class CallTranscriptionInfoCollectionResponse
{
    /**
     ...
     * 
     * @param CallTranscriptionInfo ...$items Variable number of CallTranscriptionInfo items
     * @return self
     */
    public function setValue(CallTranscriptionInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
