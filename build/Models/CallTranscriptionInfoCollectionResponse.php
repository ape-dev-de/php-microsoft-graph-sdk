...
/**
 * Collection response for CallTranscriptionInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallTranscriptionInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallTranscriptionInfo[]
     */
    private array $value = [];
     ...
     * 
     * @param CallTranscriptionInfo[] $items
     * @return self
     */
    public function setValue(array|CallTranscriptionInfo $items, CallTranscriptionInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallTranscriptionInfo> $value
     * @return self
     ...
     * 
     * @param CallTranscriptionInfo $item
     * @return self
     */
    public function addValue(CallTranscriptionInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CallTranscriptionInfo>
     */
