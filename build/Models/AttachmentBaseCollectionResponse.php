...
/**
 * Collection response for AttachmentBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttachmentBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AttachmentBase[]
     */
     ...
     * 
     * @param AttachmentBase[] $items
     * @return self
     */
    public function setValue(array|AttachmentBase $items, AttachmentBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttachmentBase> $value
     * @return self
     ...
     * 
     * @param AttachmentBase $item
     * @return self
     */
    public function addValue(AttachmentBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AttachmentBase>
     */
