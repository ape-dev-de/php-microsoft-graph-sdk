...
/**
 * Collection response for ExcludeTarget
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExcludeTargetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExcludeTarget[]
     */
     ...
     * 
     * @param ExcludeTarget[] $items
     * @return self
     */
    public function setValue(array|ExcludeTarget $items, ExcludeTarget ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExcludeTarget> $value
     * @return self
     ...
     * 
     * @param ExcludeTarget $item
     * @return self
     */
    public function addValue(ExcludeTarget $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ExcludeTarget>
     */
