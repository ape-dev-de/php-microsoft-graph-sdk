...
/**
 * Collection response for ProvisioningStepType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProvisioningStepTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProvisioningStepType[]
     */
    private array $value = [];
     ...
     * 
     * @param ProvisioningStepType[] $items
     * @return self
     */
    public function setValue(array|ProvisioningStepType $items, ProvisioningStepType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProvisioningStepType> $value
     * @return self
     ...
     * 
     * @param ProvisioningStepType $item
     * @return self
     */
    public function addValue(ProvisioningStepType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProvisioningStepType>
     */
