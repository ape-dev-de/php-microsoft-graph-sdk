...
/**
 * Collection response for MacOSMicrosoftDefenderAppCollectionResponse
 */
class MacOSMicrosoftDefenderAppCollectionResponseCollectionResponse
{
    /**
     * @var MacOSMicrosoftDefenderAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MacOSMicrosoftDefenderAppCollectionResponse ...$items Variable number of MacOSMicrosoftDefenderAppCollectionResponse items
     * @return self
     */
    public function setValue(MacOSMicrosoftDefenderAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MacOSMicrosoftDefenderAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MacOSMicrosoftDefenderAppCollectionResponse $item
     * @return self
     */
    public function addValue(MacOSMicrosoftDefenderAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
