...
/**
 * Collection response for DriveProtectionUnit
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DriveProtectionUnitCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DriveProtectionUnit[] $items
     * @return self
     */
    public function setValue(array|DriveProtectionUnit $items, DriveProtectionUnit ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DriveProtectionUnit> $value
     * @return self
     ...
     * 
     * @param DriveProtectionUnit $item
     * @return self
     */
    public function addValue(DriveProtectionUnit $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DriveProtectionUnit>
     */
