...
/**
 * Collection response for ArtifactQuery
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ArtifactQueryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ArtifactQuery[]
     */
     ...
     * 
     * @param ArtifactQuery[] $items
     * @return self
     */
    public function setValue(array|ArtifactQuery $items, ArtifactQuery ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ArtifactQuery> $value
     * @return self
     ...
     * 
     * @param ArtifactQuery $item
     * @return self
     */
    public function addValue(ArtifactQuery $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ArtifactQuery>
     */
