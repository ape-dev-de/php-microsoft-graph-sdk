 ...
 */
class ArtifactQueryCollectionResponse
{
    /**
     * @var ArtifactQuery[]
     */
     ...
     * 
     * @param ArtifactQuery ...$items Variable number of ArtifactQuery items
     * @return self
     */
    public function setValue(ArtifactQuery ...$items): self
    {
        $this->value = $items;
        return $this;
    }
