...
/**
 * Collection response for StringCollectionResponse
 */
class StringCollectionResponseCollectionResponse
{
    /**
     * @var StringCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param StringCollectionResponse ...$items Variable number of StringCollectionResponse items
     * @return self
     */
    public function setValue(StringCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<StringCollectionResponse> $value
     * @return self
     ...
     * 
     * @param StringCollectionResponse $item
     * @return self
     */
    public function addValue(StringCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
