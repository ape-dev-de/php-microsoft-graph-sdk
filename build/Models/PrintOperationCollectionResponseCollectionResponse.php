...
/**
 * Collection response for PrintOperationCollectionResponse
 */
class PrintOperationCollectionResponseCollectionResponse
{
    /**
     * @var PrintOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PrintOperationCollectionResponse ...$items Variable number of PrintOperationCollectionResponse items
     * @return self
     */
    public function setValue(PrintOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PrintOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PrintOperationCollectionResponse $item
     * @return self
     */
    public function addValue(PrintOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
