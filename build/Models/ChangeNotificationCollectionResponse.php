...
/**
 * Collection response for ChangeNotification
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChangeNotificationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ChangeNotification[] $items
     * @return self
     */
    public function setValue(array|ChangeNotification $items, ChangeNotification ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChangeNotification> $value
     * @return self
     ...
     * 
     * @param ChangeNotification $item
     * @return self
     */
    public function addValue(ChangeNotification $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ChangeNotification|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ChangeNotification>
     */
