 ...
 */
class MessageRulePredicatesCollectionResponse
{
    /**
     ...
     * 
     * @param MessageRulePredicates ...$items Variable number of MessageRulePredicates items
     * @return self
     */
    public function setValue(MessageRulePredicates ...$items): self
    {
        $this->value = $items;
        return $this;
    }
