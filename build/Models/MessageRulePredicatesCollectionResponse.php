...
/**
 * Collection response for MessageRulePredicates
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MessageRulePredicatesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MessageRulePredicates[] $items
     * @return self
     */
    public function setValue(array|MessageRulePredicates $items, MessageRulePredicates ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MessageRulePredicates> $value
     * @return self
     ...
     * 
     * @param MessageRulePredicates $item
     * @return self
     */
    public function addValue(MessageRulePredicates $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MessageRulePredicates>
     */
