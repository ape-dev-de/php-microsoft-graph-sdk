...
/**
 * Collection response for TrendingCollectionResponse
 */
class TrendingCollectionResponseCollectionResponse
{
    /**
     * @var TrendingCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TrendingCollectionResponse ...$items Variable number of TrendingCollectionResponse items
     * @return self
     */
    public function setValue(TrendingCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TrendingCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TrendingCollectionResponse $item
     * @return self
     */
    public function addValue(TrendingCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
