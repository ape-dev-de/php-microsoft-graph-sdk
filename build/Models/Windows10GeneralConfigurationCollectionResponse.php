...
/**
 * Collection response for Windows10GeneralConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Windows10GeneralConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Windows10GeneralConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param Windows10GeneralConfiguration[] $items
     * @return self
     */
    public function setValue(array|Windows10GeneralConfiguration $items, Windows10GeneralConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Windows10GeneralConfiguration> $value
     * @return self
     ...
     * 
     * @param Windows10GeneralConfiguration $item
     * @return self
     */
    public function addValue(Windows10GeneralConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return Windows10GeneralConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, Windows10GeneralConfiguration>
     */
