...
/**
 * Collection response for TeamsAppResourceSpecificPermission
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamsAppResourceSpecificPermissionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TeamsAppResourceSpecificPermission[] $items
     * @return self
     */
    public function setValue(array|TeamsAppResourceSpecificPermission $items, TeamsAppResourceSpecificPermission ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamsAppResourceSpecificPermission> $value
     * @return self
     ...
     * 
     * @param TeamsAppResourceSpecificPermission $item
     * @return self
     */
    public function addValue(TeamsAppResourceSpecificPermission $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TeamsAppResourceSpecificPermission|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TeamsAppResourceSpecificPermission>
     */
