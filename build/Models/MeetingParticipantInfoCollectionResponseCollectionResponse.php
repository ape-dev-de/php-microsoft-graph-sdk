...
/**
 * Collection response for MeetingParticipantInfoCollectionResponse
 */
class MeetingParticipantInfoCollectionResponseCollectionResponse
{
    /**
     * @var MeetingParticipantInfoCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MeetingParticipantInfoCollectionResponse ...$items Variable number of MeetingParticipantInfoCollectionResponse items
     * @return self
     */
    public function setValue(MeetingParticipantInfoCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MeetingParticipantInfoCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MeetingParticipantInfoCollectionResponse $item
     * @return self
     */
    public function addValue(MeetingParticipantInfoCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
