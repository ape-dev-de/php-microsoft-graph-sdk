...
/**
 * Collection response for SocialIdentityProviderCollectionResponse
 */
class SocialIdentityProviderCollectionResponseCollectionResponse
{
    /**
     * @var SocialIdentityProviderCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SocialIdentityProviderCollectionResponse ...$items Variable number of SocialIdentityProviderCollectionResponse items
     * @return self
     */
    public function setValue(SocialIdentityProviderCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SocialIdentityProviderCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SocialIdentityProviderCollectionResponse $item
     * @return self
     */
    public function addValue(SocialIdentityProviderCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
