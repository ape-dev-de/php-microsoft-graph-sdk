...
/**
 * WindowsInformationProtectionNetworkLearningSummaryCollectionResponse - Collection response
 */
class WindowsInformationProtectionNetworkLearningSummaryCollectionResponse
{
    /**
     * @var array<int, WindowsInformationProtectionNetworkLearningSummary>
     */
    public array $value = [];
