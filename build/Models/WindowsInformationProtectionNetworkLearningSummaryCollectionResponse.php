...
/**
 * Collection response for WindowsInformationProtectionNetworkLearningSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsInformationProtectionNetworkLearningSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WindowsInformationProtectionNetworkLearningSummary[] $items
     * @return self
     */
    public function setValue(array|WindowsInformationProtectionNetworkLearningSummary $items, WindowsInformationProtectionNetworkLearningSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsInformationProtectionNetworkLearningSummary> $value
     * @return self
     ...
     * 
     * @param WindowsInformationProtectionNetworkLearningSummary $item
     * @return self
     */
    public function addValue(WindowsInformationProtectionNetworkLearningSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsInformationProtectionNetworkLearningSummary>
     */
