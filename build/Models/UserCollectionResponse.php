...
/**
 * Collection response for User
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var User[]
     */
     ...
     * @return self
     */
    public function setValue(array|User $items, User ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(User $item): self
    {
        $this->value[] = $item;
        return $this;
    }
