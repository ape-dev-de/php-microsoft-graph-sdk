...
/**
 * MobileAppContentFileUploadStateCollectionResponse - Collection response
 */
class MobileAppContentFileUploadStateCollectionResponse
{
    /**
     * @var array<int, MobileAppContentFileUploadState>
     */
    public array $value = [];
