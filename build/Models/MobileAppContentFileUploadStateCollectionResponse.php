...
/**
 * Collection response for MobileAppContentFileUploadState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MobileAppContentFileUploadStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MobileAppContentFileUploadState[]
     */
    private array $value = [];
     ...
     * 
     * @return MobileAppContentFileUploadState[]
     */
     ...
     * 
     * @param MobileAppContentFileUploadState[] $items
     * @return self
     */
    public function setValue(array|MobileAppContentFileUploadState $items, MobileAppContentFileUploadState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MobileAppContentFileUploadState> $value
     * @return self
     ...
     * 
     * @param MobileAppContentFileUploadState $item
     * @return self
     */
    public function addValue(MobileAppContentFileUploadState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MobileAppContentFileUploadState>
     */
