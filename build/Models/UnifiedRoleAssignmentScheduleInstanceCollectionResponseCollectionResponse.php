...
/**
 * Collection response for UnifiedRoleAssignmentScheduleInstanceCollectionResponse
 */
class UnifiedRoleAssignmentScheduleInstanceCollectionResponseCollectionResponse
{
    /**
     * @var UnifiedRoleAssignmentScheduleInstanceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedRoleAssignmentScheduleInstanceCollectionResponse ...$items Variable number of UnifiedRoleAssignmentScheduleInstanceCollectionResponse items
     * @return self
     */
    public function setValue(UnifiedRoleAssignmentScheduleInstanceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UnifiedRoleAssignmentScheduleInstanceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleAssignmentScheduleInstanceCollectionResponse $item
     * @return self
     */
    public function addValue(UnifiedRoleAssignmentScheduleInstanceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
