...
/**
 * Collection response for AuthenticationStrengthPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationStrengthPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AuthenticationStrengthPolicy[] $items
     * @return self
     */
    public function setValue(array|AuthenticationStrengthPolicy $items, AuthenticationStrengthPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationStrengthPolicy> $value
     * @return self
     ...
     * 
     * @param AuthenticationStrengthPolicy $item
     * @return self
     */
    public function addValue(AuthenticationStrengthPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationStrengthPolicy>
     */
