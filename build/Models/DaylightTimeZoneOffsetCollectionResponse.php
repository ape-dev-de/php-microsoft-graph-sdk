...
/**
 * Collection response for DaylightTimeZoneOffset
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DaylightTimeZoneOffsetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DaylightTimeZoneOffset[] $items
     * @return self
     */
    public function setValue(array|DaylightTimeZoneOffset $items, DaylightTimeZoneOffset ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DaylightTimeZoneOffset> $value
     * @return self
     ...
     * 
     * @param DaylightTimeZoneOffset $item
     * @return self
     */
    public function addValue(DaylightTimeZoneOffset $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DaylightTimeZoneOffset>
     */
