 ...
 */
class DaylightTimeZoneOffsetCollectionResponse
{
    /**
     ...
     * 
     * @param DaylightTimeZoneOffset ...$items Variable number of DaylightTimeZoneOffset items
     * @return self
     */
    public function setValue(DaylightTimeZoneOffset ...$items): self
    {
        $this->value = $items;
        return $this;
    }
