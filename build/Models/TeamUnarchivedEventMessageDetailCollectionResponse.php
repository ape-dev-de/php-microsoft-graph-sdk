 ...
 */
class TeamUnarchivedEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param TeamUnarchivedEventMessageDetail ...$items Variable number of TeamUnarchivedEventMessageDetail items
     * @return self
     */
    public function setValue(TeamUnarchivedEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
