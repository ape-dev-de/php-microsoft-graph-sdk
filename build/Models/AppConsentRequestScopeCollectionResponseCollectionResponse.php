...
/**
 * Collection response for AppConsentRequestScopeCollectionResponse
 */
class AppConsentRequestScopeCollectionResponseCollectionResponse
{
    /**
     * @var AppConsentRequestScopeCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AppConsentRequestScopeCollectionResponse ...$items Variable number of AppConsentRequestScopeCollectionResponse items
     * @return self
     */
    public function setValue(AppConsentRequestScopeCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AppConsentRequestScopeCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AppConsentRequestScopeCollectionResponse $item
     * @return self
     */
    public function addValue(AppConsentRequestScopeCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
