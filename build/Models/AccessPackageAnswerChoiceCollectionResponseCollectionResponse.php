...
/**
 * Collection response for AccessPackageAnswerChoiceCollectionResponse
 */
class AccessPackageAnswerChoiceCollectionResponseCollectionResponse
{
    /**
     * @var AccessPackageAnswerChoiceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageAnswerChoiceCollectionResponse ...$items Variable number of AccessPackageAnswerChoiceCollectionResponse items
     * @return self
     */
    public function setValue(AccessPackageAnswerChoiceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AccessPackageAnswerChoiceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AccessPackageAnswerChoiceCollectionResponse $item
     * @return self
     */
    public function addValue(AccessPackageAnswerChoiceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
