...
/**
 * Collection response for SingleValueLegacyExtendedProperty
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SingleValueLegacyExtendedPropertyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SingleValueLegacyExtendedProperty[] $items
     * @return self
     */
    public function setValue(array|SingleValueLegacyExtendedProperty $items, SingleValueLegacyExtendedProperty ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SingleValueLegacyExtendedProperty> $value
     * @return self
     ...
     * 
     * @param SingleValueLegacyExtendedProperty $item
     * @return self
     */
    public function addValue(SingleValueLegacyExtendedProperty $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SingleValueLegacyExtendedProperty>
     */
