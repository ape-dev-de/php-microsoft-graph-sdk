...
/**
 * Collection response for CopilotRoot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CopilotRootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CopilotRoot[]
     */
     ...
     * 
     * @param CopilotRoot[] $items
     * @return self
     */
    public function setValue(array|CopilotRoot $items, CopilotRoot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param CopilotRoot $item
     * @return self
     */
    public function addValue(CopilotRoot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CopilotRoot>
     */
