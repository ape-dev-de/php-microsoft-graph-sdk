...
/**
 * Collection response for SecurityEdiscoveryReviewTagCollectionResponse
 */
class SecurityEdiscoveryReviewTagCollectionResponseCollectionResponse
{
    /**
     * @var SecurityEdiscoveryReviewTagCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityEdiscoveryReviewTagCollectionResponse ...$items Variable number of SecurityEdiscoveryReviewTagCollectionResponse items
     * @return self
     */
    public function setValue(SecurityEdiscoveryReviewTagCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityEdiscoveryReviewTagCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityEdiscoveryReviewTagCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityEdiscoveryReviewTagCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
