...
/**
 * Collection response for CommsOperationCollectionResponse
 */
class CommsOperationCollectionResponseCollectionResponse
{
    /**
     * @var CommsOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CommsOperationCollectionResponse ...$items Variable number of CommsOperationCollectionResponse items
     * @return self
     */
    public function setValue(CommsOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CommsOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CommsOperationCollectionResponse $item
     * @return self
     */
    public function addValue(CommsOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
