...
/**
 * Collection response for TermStoreTermGroupScope
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TermStoreTermGroupScopeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TermStoreTermGroupScope[]
     */
    private array $value = [];
     ...
     * 
     * @return TermStoreTermGroupScope[]
     */
     ...
     * 
     * @param TermStoreTermGroupScope[] $items
     * @return self
     */
    public function setValue(array|TermStoreTermGroupScope $items, TermStoreTermGroupScope ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TermStoreTermGroupScope> $value
     * @return self
     ...
     * 
     * @param TermStoreTermGroupScope $item
     * @return self
     */
    public function addValue(TermStoreTermGroupScope $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TermStoreTermGroupScope|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TermStoreTermGroupScope>
     */
