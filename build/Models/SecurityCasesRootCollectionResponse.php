 ...
 */
class SecurityCasesRootCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityCasesRoot ...$items Variable number of SecurityCasesRoot items
     * @return self
     */
    public function setValue(SecurityCasesRoot ...$items): self
    {
        $this->value = $items;
        return $this;
    }
