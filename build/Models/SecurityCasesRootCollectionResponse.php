...
/**
 * Collection response for SecurityCasesRoot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityCasesRootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityCasesRoot[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityCasesRoot[] $items
     * @return self
     */
    public function setValue(array|SecurityCasesRoot $items, SecurityCasesRoot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityCasesRoot> $value
     * @return self
     ...
     * 
     * @param SecurityCasesRoot $item
     * @return self
     */
    public function addValue(SecurityCasesRoot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityCasesRoot>
     */
