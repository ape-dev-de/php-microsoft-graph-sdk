...
/**
 * AllDeviceRegistrationMembershipCollectionResponse - Collection response
 */
class AllDeviceRegistrationMembershipCollectionResponse
{
    /**
     * @var array<int, AllDeviceRegistrationMembership>
     */
    public array $value = [];
