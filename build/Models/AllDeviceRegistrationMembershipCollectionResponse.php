...
/**
 * Collection response for AllDeviceRegistrationMembership
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AllDeviceRegistrationMembershipCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AllDeviceRegistrationMembership[]
     */
    private array $value = [];
     ...
     * 
     * @param AllDeviceRegistrationMembership[] $items
     * @return self
     */
    public function setValue(array|AllDeviceRegistrationMembership $items, AllDeviceRegistrationMembership ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AllDeviceRegistrationMembership> $value
     * @return self
     ...
     * 
     * @param AllDeviceRegistrationMembership $item
     * @return self
     */
    public function addValue(AllDeviceRegistrationMembership $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AllDeviceRegistrationMembership|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AllDeviceRegistrationMembership>
     */
