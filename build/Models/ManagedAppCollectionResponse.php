...
/**
 * Collection response for ManagedApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ManagedApp[]
     */
     ...
     * 
     * @param ManagedApp[] $items
     * @return self
     */
    public function setValue(array|ManagedApp $items, ManagedApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param ManagedApp $item
     * @return self
     */
    public function addValue(ManagedApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedApp>
     */
