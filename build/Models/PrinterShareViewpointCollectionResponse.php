 ...
 */
class PrinterShareViewpointCollectionResponse
{
    /**
     ...
     * 
     * @param PrinterShareViewpoint ...$items Variable number of PrinterShareViewpoint items
     * @return self
     */
    public function setValue(PrinterShareViewpoint ...$items): self
    {
        $this->value = $items;
        return $this;
    }
