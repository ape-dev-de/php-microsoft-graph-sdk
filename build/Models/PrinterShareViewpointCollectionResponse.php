...
/**
 * Collection response for PrinterShareViewpoint
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrinterShareViewpointCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrinterShareViewpoint[]
     */
    private array $value = [];
     ...
     * 
     * @param PrinterShareViewpoint[] $items
     * @return self
     */
    public function setValue(array|PrinterShareViewpoint $items, PrinterShareViewpoint ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrinterShareViewpoint> $value
     * @return self
     ...
     * 
     * @param PrinterShareViewpoint $item
     * @return self
     */
    public function addValue(PrinterShareViewpoint $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrinterShareViewpoint>
     */
