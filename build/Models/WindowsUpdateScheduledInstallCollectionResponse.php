...
/**
 * Collection response for WindowsUpdateScheduledInstall
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsUpdateScheduledInstallCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsUpdateScheduledInstall[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsUpdateScheduledInstall[] $items
     * @return self
     */
    public function setValue(array|WindowsUpdateScheduledInstall $items, WindowsUpdateScheduledInstall ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsUpdateScheduledInstall> $value
     * @return self
     ...
     * 
     * @param WindowsUpdateScheduledInstall $item
     * @return self
     */
    public function addValue(WindowsUpdateScheduledInstall $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WindowsUpdateScheduledInstall|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WindowsUpdateScheduledInstall>
     */
