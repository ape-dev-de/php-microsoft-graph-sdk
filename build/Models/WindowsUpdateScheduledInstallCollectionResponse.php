 ...
 */
class WindowsUpdateScheduledInstallCollectionResponse
{
    /**
     ...
     * 
     * @param WindowsUpdateScheduledInstall ...$items Variable number of WindowsUpdateScheduledInstall items
     * @return self
     */
    public function setValue(WindowsUpdateScheduledInstall ...$items): self
    {
        $this->value = $items;
        return $this;
    }
