...
class MessageRulePredicates
{
     ...
     */
    public function setBodyContains(array $bodyContains): self
    {
    ...
    /**
     * @param string[] $bodyOrSubjectContains
     */
    public function setBodyOrSubjectContains(array $bodyOrSubjectContains): self
    {
    ...
    /**
     * @param string[] $headerContains
     */
    public function setHeaderContains(array $headerContains): self
    {
    ...
    /**
     * @param string[] $recipientContains
     */
    public function setRecipientContains(array $recipientContains): self
    {
    ...
    /**
     * @param string[] $senderContains
     */
    public function setSenderContains(array $senderContains): self
    {
     ...
     */
    public function setSubjectContains(array $subjectContains): self
    {
