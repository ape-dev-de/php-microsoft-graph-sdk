...
/**
 * Collection response for TemplateScenarios
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TemplateScenariosCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TemplateScenarios[]
     */
    private array $value = [];
     ...
     * 
     * @param TemplateScenarios[] $items
     * @return self
     */
    public function setValue(array|TemplateScenarios $items, TemplateScenarios ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TemplateScenarios> $value
     * @return self
     ...
     * 
     * @param TemplateScenarios $item
     * @return self
     */
    public function addValue(TemplateScenarios $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TemplateScenarios>
     */
