...
/**
 * IdentityGovernanceWorkflowExecutionTypeCollectionResponse - Collection response
 */
class IdentityGovernanceWorkflowExecutionTypeCollectionResponse
{
    /**
     * @var array<int, IdentityGovernanceWorkflowExecutionType>
     */
    public array $value = [];
