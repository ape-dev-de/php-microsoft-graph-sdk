...
/**
 * Collection response for IdentityGovernanceWorkflowExecutionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceWorkflowExecutionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceWorkflowExecutionType[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceWorkflowExecutionType[]
     */
     ...
     * 
     * @param IdentityGovernanceWorkflowExecutionType[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceWorkflowExecutionType $items, IdentityGovernanceWorkflowExecutionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceWorkflowExecutionType> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceWorkflowExecutionType $item
     * @return self
     */
    public function addValue(IdentityGovernanceWorkflowExecutionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceWorkflowExecutionType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceWorkflowExecutionType>
     */
