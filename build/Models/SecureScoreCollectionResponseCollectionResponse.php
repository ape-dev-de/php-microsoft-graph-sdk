...
/**
 * Collection response for SecureScoreCollectionResponse
 */
class SecureScoreCollectionResponseCollectionResponse
{
    /**
     * @var SecureScoreCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecureScoreCollectionResponse ...$items Variable number of SecureScoreCollectionResponse items
     * @return self
     */
    public function setValue(SecureScoreCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecureScoreCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecureScoreCollectionResponse $item
     * @return self
     */
    public function addValue(SecureScoreCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
