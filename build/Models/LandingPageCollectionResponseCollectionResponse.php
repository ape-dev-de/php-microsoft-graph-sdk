...
/**
 * Collection response for LandingPageCollectionResponse
 */
class LandingPageCollectionResponseCollectionResponse
{
    /**
     * @var LandingPageCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param LandingPageCollectionResponse ...$items Variable number of LandingPageCollectionResponse items
     * @return self
     */
    public function setValue(LandingPageCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<LandingPageCollectionResponse> $value
     * @return self
     ...
     * 
     * @param LandingPageCollectionResponse $item
     * @return self
     */
    public function addValue(LandingPageCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
