 ...
 */
class TimeZoneInformationCollectionResponse
{
    /**
     ...
     * 
     * @param TimeZoneInformation ...$items Variable number of TimeZoneInformation items
     * @return self
     */
    public function setValue(TimeZoneInformation ...$items): self
    {
        $this->value = $items;
        return $this;
    }
