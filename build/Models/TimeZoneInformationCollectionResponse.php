...
/**
 * Collection response for TimeZoneInformation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TimeZoneInformationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TimeZoneInformation[] $items
     * @return self
     */
    public function setValue(array|TimeZoneInformation $items, TimeZoneInformation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TimeZoneInformation> $value
     * @return self
     ...
     * 
     * @param TimeZoneInformation $item
     * @return self
     */
    public function addValue(TimeZoneInformation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TimeZoneInformation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TimeZoneInformation>
     */
