...
/**
 * Collection response for ServiceHealthCollectionResponse
 */
class ServiceHealthCollectionResponseCollectionResponse
{
    /**
     * @var ServiceHealthCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ServiceHealthCollectionResponse ...$items Variable number of ServiceHealthCollectionResponse items
     * @return self
     */
    public function setValue(ServiceHealthCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ServiceHealthCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ServiceHealthCollectionResponse $item
     * @return self
     */
    public function addValue(ServiceHealthCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
