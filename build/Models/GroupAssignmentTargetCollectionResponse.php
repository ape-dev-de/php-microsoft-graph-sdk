...
/**
 * Collection response for GroupAssignmentTarget
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class GroupAssignmentTargetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var GroupAssignmentTarget[]
     */
    private array $value = [];
     ...
     * 
     * @param GroupAssignmentTarget[] $items
     * @return self
     */
    public function setValue(array|GroupAssignmentTarget $items, GroupAssignmentTarget ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<GroupAssignmentTarget> $value
     * @return self
     ...
     * 
     * @param GroupAssignmentTarget $item
     * @return self
     */
    public function addValue(GroupAssignmentTarget $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return GroupAssignmentTarget|null
     */
     ...
     * 
     * @return \ArrayIterator<int, GroupAssignmentTarget>
     */
