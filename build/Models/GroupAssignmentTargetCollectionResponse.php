 ...
 */
class GroupAssignmentTargetCollectionResponse
{
    /**
     ...
     * 
     * @param GroupAssignmentTarget ...$items Variable number of GroupAssignmentTarget items
     * @return self
     */
    public function setValue(GroupAssignmentTarget ...$items): self
    {
        $this->value = $items;
        return $this;
    }
