 ...
 */
class TeamsAppSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param TeamsAppSettings ...$items Variable number of TeamsAppSettings items
     * @return self
     */
    public function setValue(TeamsAppSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
