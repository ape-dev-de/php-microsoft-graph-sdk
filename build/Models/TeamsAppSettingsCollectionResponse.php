...
/**
 * Collection response for TeamsAppSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamsAppSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamsAppSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamsAppSettings[] $items
     * @return self
     */
    public function setValue(array|TeamsAppSettings $items, TeamsAppSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamsAppSettings> $value
     * @return self
     ...
     * 
     * @param TeamsAppSettings $item
     * @return self
     */
    public function addValue(TeamsAppSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamsAppSettings>
     */
