...
/**
 * Collection response for DocumentSetVersionItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DocumentSetVersionItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DocumentSetVersionItem[] $items
     * @return self
     */
    public function setValue(array|DocumentSetVersionItem $items, DocumentSetVersionItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DocumentSetVersionItem> $value
     * @return self
     ...
     * 
     * @param DocumentSetVersionItem $item
     * @return self
     */
    public function addValue(DocumentSetVersionItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return DocumentSetVersionItem|null
     */
     ...
     * 
     * @return \ArrayIterator<int, DocumentSetVersionItem>
     */
