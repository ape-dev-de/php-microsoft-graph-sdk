...
/**
 * Collection response for TeamsAppInstallationCollectionResponse
 */
class TeamsAppInstallationCollectionResponseCollectionResponse
{
    /**
     * @var TeamsAppInstallationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamsAppInstallationCollectionResponse ...$items Variable number of TeamsAppInstallationCollectionResponse items
     * @return self
     */
    public function setValue(TeamsAppInstallationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TeamsAppInstallationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TeamsAppInstallationCollectionResponse $item
     * @return self
     */
    public function addValue(TeamsAppInstallationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
