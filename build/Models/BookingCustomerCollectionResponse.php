...
/**
 * Collection response for BookingCustomer
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingCustomerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BookingCustomer[]
     */
     ...
     * 
     * @param BookingCustomer[] $items
     * @return self
     */
    public function setValue(array|BookingCustomer $items, BookingCustomer ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingCustomer> $value
     * @return self
     ...
     * 
     * @param BookingCustomer $item
     * @return self
     */
    public function addValue(BookingCustomer $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BookingCustomer>
     */
