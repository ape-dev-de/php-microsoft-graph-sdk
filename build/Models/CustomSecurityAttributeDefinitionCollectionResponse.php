...
/**
 * Collection response for CustomSecurityAttributeDefinition
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CustomSecurityAttributeDefinitionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CustomSecurityAttributeDefinition[] $items
     * @return self
     */
    public function setValue(array|CustomSecurityAttributeDefinition $items, CustomSecurityAttributeDefinition ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CustomSecurityAttributeDefinition> $value
     * @return self
     ...
     * 
     * @param CustomSecurityAttributeDefinition $item
     * @return self
     */
    public function addValue(CustomSecurityAttributeDefinition $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CustomSecurityAttributeDefinition>
     */
