...
/**
 * Collection response for PresenceCollectionResponse
 */
class PresenceCollectionResponseCollectionResponse
{
    /**
     * @var PresenceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PresenceCollectionResponse ...$items Variable number of PresenceCollectionResponse items
     * @return self
     */
    public function setValue(PresenceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PresenceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PresenceCollectionResponse $item
     * @return self
     */
    public function addValue(PresenceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
