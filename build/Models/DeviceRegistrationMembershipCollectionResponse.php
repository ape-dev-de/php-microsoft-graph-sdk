...
/**
 * DeviceRegistrationMembershipCollectionResponse - Collection response
 */
class DeviceRegistrationMembershipCollectionResponse
{
    /**
     * @var array<int, DeviceRegistrationMembership>
     */
    public array $value = [];
