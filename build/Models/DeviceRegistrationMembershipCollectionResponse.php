...
/**
 * Collection response for DeviceRegistrationMembership
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceRegistrationMembershipCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceRegistrationMembership[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceRegistrationMembership[] $items
     * @return self
     */
    public function setValue(array|DeviceRegistrationMembership $items, DeviceRegistrationMembership ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceRegistrationMembership> $value
     * @return self
     ...
     * 
     * @param DeviceRegistrationMembership $item
     * @return self
     */
    public function addValue(DeviceRegistrationMembership $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceRegistrationMembership>
     */
