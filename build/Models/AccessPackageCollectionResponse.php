...
/**
 * Collection response for AccessPackage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackage[]
     */
     ...
     * 
     * @param AccessPackage[] $items
     * @return self
     */
    public function setValue(array|AccessPackage $items, AccessPackage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackage> $value
     * @return self
     ...
     * 
     * @param AccessPackage $item
     * @return self
     */
    public function addValue(AccessPackage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackage>
     */
