...
/**
 * Collection response for EducationUserCollectionResponse
 */
class EducationUserCollectionResponseCollectionResponse
{
    /**
     * @var EducationUserCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationUserCollectionResponse ...$items Variable number of EducationUserCollectionResponse items
     * @return self
     */
    public function setValue(EducationUserCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EducationUserCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EducationUserCollectionResponse $item
     * @return self
     */
    public function addValue(EducationUserCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
