...
/**
 * Collection response for SchemaExtensionCollectionResponse
 */
class SchemaExtensionCollectionResponseCollectionResponse
{
    /**
     * @var SchemaExtensionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SchemaExtensionCollectionResponse ...$items Variable number of SchemaExtensionCollectionResponse items
     * @return self
     */
    public function setValue(SchemaExtensionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SchemaExtensionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SchemaExtensionCollectionResponse $item
     * @return self
     */
    public function addValue(SchemaExtensionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
