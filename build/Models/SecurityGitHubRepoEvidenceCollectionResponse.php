 ...
 */
class SecurityGitHubRepoEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityGitHubRepoEvidence ...$items Variable number of SecurityGitHubRepoEvidence items
     * @return self
     */
    public function setValue(SecurityGitHubRepoEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
