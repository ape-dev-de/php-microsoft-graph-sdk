...
/**
 * Collection response for SecurityGitHubRepoEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityGitHubRepoEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityGitHubRepoEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityGitHubRepoEvidence[]
     */
     ...
     * 
     * @param SecurityGitHubRepoEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityGitHubRepoEvidence $items, SecurityGitHubRepoEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityGitHubRepoEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityGitHubRepoEvidence $item
     * @return self
     */
    public function addValue(SecurityGitHubRepoEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityGitHubRepoEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityGitHubRepoEvidence>
     */
