...
/**
 * Collection response for OnenoteEntitySchemaObjectModel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnenoteEntitySchemaObjectModelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnenoteEntitySchemaObjectModel[]
     */
    private array $value = [];
     ...
     * 
     * @param OnenoteEntitySchemaObjectModel[] $items
     * @return self
     */
    public function setValue(array|OnenoteEntitySchemaObjectModel $items, OnenoteEntitySchemaObjectModel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnenoteEntitySchemaObjectModel> $value
     * @return self
     ...
     * 
     * @param OnenoteEntitySchemaObjectModel $item
     * @return self
     */
    public function addValue(OnenoteEntitySchemaObjectModel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OnenoteEntitySchemaObjectModel|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OnenoteEntitySchemaObjectModel>
     */
