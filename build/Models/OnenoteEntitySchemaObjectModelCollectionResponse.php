 ...
 */
class OnenoteEntitySchemaObjectModelCollectionResponse
{
    /**
     ...
     * 
     * @param OnenoteEntitySchemaObjectModel ...$items Variable number of OnenoteEntitySchemaObjectModel items
     * @return self
     */
    public function setValue(OnenoteEntitySchemaObjectModel ...$items): self
    {
        $this->value = $items;
        return $this;
    }
