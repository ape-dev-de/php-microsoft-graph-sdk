 ...
 */
class ExternalConnectorsActivitySettingsCollectionResponse
{
    /**
     ...
     * 
     * @param ExternalConnectorsActivitySettings ...$items Variable number of ExternalConnectorsActivitySettings items
     * @return self
     */
    public function setValue(ExternalConnectorsActivitySettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
