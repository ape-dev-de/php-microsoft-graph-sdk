...
/**
 * Collection response for ExternalConnectorsActivitySettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsActivitySettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalConnectorsActivitySettings[]
     */
    private array $value = [];
     ...
     * 
     * @return ExternalConnectorsActivitySettings[]
     */
     ...
     * 
     * @param ExternalConnectorsActivitySettings[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsActivitySettings $items, ExternalConnectorsActivitySettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsActivitySettings> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsActivitySettings $item
     * @return self
     */
    public function addValue(ExternalConnectorsActivitySettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalConnectorsActivitySettings|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsActivitySettings>
     */
