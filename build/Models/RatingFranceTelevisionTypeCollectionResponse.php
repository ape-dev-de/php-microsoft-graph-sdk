...
/**
 * RatingFranceTelevisionTypeCollectionResponse - Collection response
 */
class RatingFranceTelevisionTypeCollectionResponse
{
    /**
     * @var array<int, RatingFranceTelevisionType>
     */
    public array $value = [];
