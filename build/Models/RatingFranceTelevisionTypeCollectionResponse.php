...
/**
 * Collection response for RatingFranceTelevisionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RatingFranceTelevisionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RatingFranceTelevisionType[]
     */
    private array $value = [];
     ...
     * 
     * @return RatingFranceTelevisionType[]
     */
     ...
     * 
     * @param RatingFranceTelevisionType[] $items
     * @return self
     */
    public function setValue(array|RatingFranceTelevisionType $items, RatingFranceTelevisionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RatingFranceTelevisionType> $value
     * @return self
     ...
     * 
     * @param RatingFranceTelevisionType $item
     * @return self
     */
    public function addValue(RatingFranceTelevisionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RatingFranceTelevisionType>
     */
