 ...
 */
class OrganizerMeetingInfoCollectionResponse
{
    /**
     ...
     * 
     * @param OrganizerMeetingInfo ...$items Variable number of OrganizerMeetingInfo items
     * @return self
     */
    public function setValue(OrganizerMeetingInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
