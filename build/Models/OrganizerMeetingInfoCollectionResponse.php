...
/**
 * Collection response for OrganizerMeetingInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OrganizerMeetingInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OrganizerMeetingInfo[]
     */
    private array $value = [];
     ...
     * 
     * @param OrganizerMeetingInfo[] $items
     * @return self
     */
    public function setValue(array|OrganizerMeetingInfo $items, OrganizerMeetingInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OrganizerMeetingInfo> $value
     * @return self
     ...
     * 
     * @param OrganizerMeetingInfo $item
     * @return self
     */
    public function addValue(OrganizerMeetingInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OrganizerMeetingInfo|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OrganizerMeetingInfo>
     */
