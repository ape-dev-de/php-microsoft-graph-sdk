...
/**
 * Collection response for LongRunningOperationStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LongRunningOperationStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param LongRunningOperationStatus[] $items
     * @return self
     */
    public function setValue(array|LongRunningOperationStatus $items, LongRunningOperationStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LongRunningOperationStatus> $value
     * @return self
     ...
     * 
     * @param LongRunningOperationStatus $item
     * @return self
     */
    public function addValue(LongRunningOperationStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LongRunningOperationStatus>
     */
