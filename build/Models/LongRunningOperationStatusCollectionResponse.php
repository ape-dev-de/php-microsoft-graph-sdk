...
/**
 * LongRunningOperationStatusCollectionResponse - Collection response
 */
class LongRunningOperationStatusCollectionResponse
{
    /**
     * @var array<int, LongRunningOperationStatus>
     */
    public array $value = [];
