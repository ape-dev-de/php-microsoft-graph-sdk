 ...
 */
class UserRegistrationFeatureSummaryCollectionResponse
{
    /**
     ...
     * 
     * @param UserRegistrationFeatureSummary ...$items Variable number of UserRegistrationFeatureSummary items
     * @return self
     */
    public function setValue(UserRegistrationFeatureSummary ...$items): self
    {
        $this->value = $items;
        return $this;
    }
