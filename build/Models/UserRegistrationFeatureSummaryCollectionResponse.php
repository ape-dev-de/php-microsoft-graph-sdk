...
/**
 * Collection response for UserRegistrationFeatureSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserRegistrationFeatureSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserRegistrationFeatureSummary[]
     */
    private array $value = [];
     ...
     * 
     * @param UserRegistrationFeatureSummary[] $items
     * @return self
     */
    public function setValue(array|UserRegistrationFeatureSummary $items, UserRegistrationFeatureSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserRegistrationFeatureSummary> $value
     * @return self
     ...
     * 
     * @param UserRegistrationFeatureSummary $item
     * @return self
     */
    public function addValue(UserRegistrationFeatureSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserRegistrationFeatureSummary>
     */
