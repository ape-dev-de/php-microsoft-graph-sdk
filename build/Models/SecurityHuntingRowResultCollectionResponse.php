...
/**
 * Collection response for SecurityHuntingRowResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHuntingRowResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return SecurityHuntingRowResult[]
     */
     ...
     * 
     * @param SecurityHuntingRowResult[] $items
     * @return self
     */
    public function setValue(array|SecurityHuntingRowResult $items, SecurityHuntingRowResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHuntingRowResult> $value
     * @return self
     ...
     * 
     * @param SecurityHuntingRowResult $item
     * @return self
     */
    public function addValue(SecurityHuntingRowResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityHuntingRowResult|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityHuntingRowResult>
     */
