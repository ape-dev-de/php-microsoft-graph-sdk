...
/**
 * Collection response for DetectedApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DetectedAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DetectedApp[]
     */
     ...
     * 
     * @param DetectedApp[] $items
     * @return self
     */
    public function setValue(array|DetectedApp $items, DetectedApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param DetectedApp $item
     * @return self
     */
    public function addValue(DetectedApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DetectedApp>
     */
