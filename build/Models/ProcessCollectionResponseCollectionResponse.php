...
/**
 * Collection response for ProcessCollectionResponse
 */
class ProcessCollectionResponseCollectionResponse
{
    /**
     * @var ProcessCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ProcessCollectionResponse ...$items Variable number of ProcessCollectionResponse items
     * @return self
     */
    public function setValue(ProcessCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ProcessCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ProcessCollectionResponse $item
     * @return self
     */
    public function addValue(ProcessCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
