...
/**
 * WindowsStartMenuAppListVisibilityTypeCollectionResponse - Collection response
 */
class WindowsStartMenuAppListVisibilityTypeCollectionResponse
{
    /**
     * @var array<int, WindowsStartMenuAppListVisibilityType>
     */
    public array $value = [];
