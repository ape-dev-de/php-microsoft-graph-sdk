...
/**
 * Collection response for WindowsStartMenuAppListVisibilityType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsStartMenuAppListVisibilityTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsStartMenuAppListVisibilityType[]
     */
    private array $value = [];
     ...
     * 
     * @return WindowsStartMenuAppListVisibilityType[]
     */
     ...
     * 
     * @param WindowsStartMenuAppListVisibilityType[] $items
     * @return self
     */
    public function setValue(array|WindowsStartMenuAppListVisibilityType $items, WindowsStartMenuAppListVisibilityType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsStartMenuAppListVisibilityType> $value
     * @return self
     ...
     * 
     * @param WindowsStartMenuAppListVisibilityType $item
     * @return self
     */
    public function addValue(WindowsStartMenuAppListVisibilityType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsStartMenuAppListVisibilityType>
     */
