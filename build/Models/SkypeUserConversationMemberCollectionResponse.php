...
/**
 * Collection response for SkypeUserConversationMember
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SkypeUserConversationMemberCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SkypeUserConversationMember[]
     */
    private array $value = [];
     ...
     * 
     * @param SkypeUserConversationMember[] $items
     * @return self
     */
    public function setValue(array|SkypeUserConversationMember $items, SkypeUserConversationMember ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SkypeUserConversationMember> $value
     * @return self
     ...
     * 
     * @param SkypeUserConversationMember $item
     * @return self
     */
    public function addValue(SkypeUserConversationMember $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SkypeUserConversationMember|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SkypeUserConversationMember>
     */
