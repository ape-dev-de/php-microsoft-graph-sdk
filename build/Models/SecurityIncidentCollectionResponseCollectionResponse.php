...
/**
 * Collection response for SecurityIncidentCollectionResponse
 */
class SecurityIncidentCollectionResponseCollectionResponse
{
    /**
     * @var SecurityIncidentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityIncidentCollectionResponse ...$items Variable number of SecurityIncidentCollectionResponse items
     * @return self
     */
    public function setValue(SecurityIncidentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityIncidentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityIncidentCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityIncidentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
