 ...
 */
class ExternalConnectorsUrlMatchInfoCollectionResponse
{
    /**
     ...
     * 
     * @param ExternalConnectorsUrlMatchInfo ...$items Variable number of ExternalConnectorsUrlMatchInfo items
     * @return self
     */
    public function setValue(ExternalConnectorsUrlMatchInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
