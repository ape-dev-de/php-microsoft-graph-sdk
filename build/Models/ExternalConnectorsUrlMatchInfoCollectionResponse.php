...
/**
 * Collection response for ExternalConnectorsUrlMatchInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsUrlMatchInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalConnectorsUrlMatchInfo[]
     */
    private array $value = [];
     ...
     * 
     * @return ExternalConnectorsUrlMatchInfo[]
     */
     ...
     * 
     * @param ExternalConnectorsUrlMatchInfo[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsUrlMatchInfo $items, ExternalConnectorsUrlMatchInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsUrlMatchInfo> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsUrlMatchInfo $item
     * @return self
     */
    public function addValue(ExternalConnectorsUrlMatchInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalConnectorsUrlMatchInfo|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsUrlMatchInfo>
     */
