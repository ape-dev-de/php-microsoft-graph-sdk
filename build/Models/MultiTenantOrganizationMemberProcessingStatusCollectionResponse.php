...
/**
 * Collection response for MultiTenantOrganizationMemberProcessingStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MultiTenantOrganizationMemberProcessingStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MultiTenantOrganizationMemberProcessingStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return MultiTenantOrganizationMemberProcessingStatus[]
     */
     ...
     * 
     * @param MultiTenantOrganizationMemberProcessingStatus[] $items
     * @return self
     */
    public function setValue(array|MultiTenantOrganizationMemberProcessingStatus $items, MultiTenantOrganizationMemberProcessingStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MultiTenantOrganizationMemberProcessingStatus> $value
     * @return self
     ...
     * 
     * @param MultiTenantOrganizationMemberProcessingStatus $item
     * @return self
     */
    public function addValue(MultiTenantOrganizationMemberProcessingStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MultiTenantOrganizationMemberProcessingStatus>
     */
