...
/**
 * MultiTenantOrganizationMemberProcessingStatusCollectionResponse - Collection response
 */
class MultiTenantOrganizationMemberProcessingStatusCollectionResponse
{
    /**
     * @var array<int, MultiTenantOrganizationMemberProcessingStatus>
     */
    public array $value = [];
