...
/**
 * Collection response for TextColumn
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TextColumnCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TextColumn[]
     */
     ...
     * 
     * @param TextColumn[] $items
     * @return self
     */
    public function setValue(array|TextColumn $items, TextColumn ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param TextColumn $item
     * @return self
     */
    public function addValue(TextColumn $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TextColumn>
     */
