...
/**
 * Collection response for TimeOffCollectionResponse
 */
class TimeOffCollectionResponseCollectionResponse
{
    /**
     * @var TimeOffCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TimeOffCollectionResponse ...$items Variable number of TimeOffCollectionResponse items
     * @return self
     */
    public function setValue(TimeOffCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TimeOffCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TimeOffCollectionResponse $item
     * @return self
     */
    public function addValue(TimeOffCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
