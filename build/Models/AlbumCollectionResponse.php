...
/**
 * Collection response for Album
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AlbumCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Album[]
     */
     ...
     * @return self
     */
    public function setValue(array|Album $items, Album ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Album $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Album>
     */
