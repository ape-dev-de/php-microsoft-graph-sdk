...
/**
 * Collection response for DeviceLocalCredentialCollectionResponse
 */
class DeviceLocalCredentialCollectionResponseCollectionResponse
{
    /**
     * @var DeviceLocalCredentialCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return DeviceLocalCredentialCollectionResponse[]
     */
     ...
     * 
     * @param DeviceLocalCredentialCollectionResponse ...$items Variable number of DeviceLocalCredentialCollectionResponse items
     * @return self
     */
    public function setValue(DeviceLocalCredentialCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeviceLocalCredentialCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeviceLocalCredentialCollectionResponse $item
     * @return self
     */
    public function addValue(DeviceLocalCredentialCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
