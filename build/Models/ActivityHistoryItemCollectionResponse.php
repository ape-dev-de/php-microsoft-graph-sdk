...
/**
 * Collection response for ActivityHistoryItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ActivityHistoryItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ActivityHistoryItem[] $items
     * @return self
     */
    public function setValue(array|ActivityHistoryItem $items, ActivityHistoryItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ActivityHistoryItem> $value
     * @return self
     ...
     * 
     * @param ActivityHistoryItem $item
     * @return self
     */
    public function addValue(ActivityHistoryItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ActivityHistoryItem>
     */
