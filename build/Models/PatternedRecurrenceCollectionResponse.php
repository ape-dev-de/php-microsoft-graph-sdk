...
/**
 * Collection response for PatternedRecurrence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PatternedRecurrenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PatternedRecurrence[] $items
     * @return self
     */
    public function setValue(array|PatternedRecurrence $items, PatternedRecurrence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PatternedRecurrence> $value
     * @return self
     ...
     * 
     * @param PatternedRecurrence $item
     * @return self
     */
    public function addValue(PatternedRecurrence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PatternedRecurrence>
     */
