 ...
 */
class PatternedRecurrenceCollectionResponse
{
    /**
     ...
     * 
     * @param PatternedRecurrence ...$items Variable number of PatternedRecurrence items
     * @return self
     */
    public function setValue(PatternedRecurrence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
