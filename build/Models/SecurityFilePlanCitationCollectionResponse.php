 ...
 */
class SecurityFilePlanCitationCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityFilePlanCitation ...$items Variable number of SecurityFilePlanCitation items
     * @return self
     */
    public function setValue(SecurityFilePlanCitation ...$items): self
    {
        $this->value = $items;
        return $this;
    }
