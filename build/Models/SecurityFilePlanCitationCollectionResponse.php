...
/**
 * Collection response for SecurityFilePlanCitation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityFilePlanCitationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityFilePlanCitation[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityFilePlanCitation[]
     */
     ...
     * 
     * @param SecurityFilePlanCitation[] $items
     * @return self
     */
    public function setValue(array|SecurityFilePlanCitation $items, SecurityFilePlanCitation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityFilePlanCitation> $value
     * @return self
     ...
     * 
     * @param SecurityFilePlanCitation $item
     * @return self
     */
    public function addValue(SecurityFilePlanCitation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityFilePlanCitation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityFilePlanCitation>
     */
