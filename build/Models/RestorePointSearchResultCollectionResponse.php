...
/**
 * Collection response for RestorePointSearchResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RestorePointSearchResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param RestorePointSearchResult[] $items
     * @return self
     */
    public function setValue(array|RestorePointSearchResult $items, RestorePointSearchResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RestorePointSearchResult> $value
     * @return self
     ...
     * 
     * @param RestorePointSearchResult $item
     * @return self
     */
    public function addValue(RestorePointSearchResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return RestorePointSearchResult|null
     */
     ...
     * 
     * @return \ArrayIterator<int, RestorePointSearchResult>
     */
