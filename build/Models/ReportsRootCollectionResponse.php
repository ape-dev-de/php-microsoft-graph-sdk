...
/**
 * Collection response for ReportsRoot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ReportsRootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ReportsRoot[]
     */
     ...
     * 
     * @param ReportsRoot[] $items
     * @return self
     */
    public function setValue(array|ReportsRoot $items, ReportsRoot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param ReportsRoot $item
     * @return self
     */
    public function addValue(ReportsRoot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ReportsRoot>
     */
