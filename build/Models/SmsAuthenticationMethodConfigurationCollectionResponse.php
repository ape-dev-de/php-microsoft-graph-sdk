...
/**
 * Collection response for SmsAuthenticationMethodConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SmsAuthenticationMethodConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SmsAuthenticationMethodConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param SmsAuthenticationMethodConfiguration[] $items
     * @return self
     */
    public function setValue(array|SmsAuthenticationMethodConfiguration $items, SmsAuthenticationMethodConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SmsAuthenticationMethodConfiguration> $value
     * @return self
     ...
     * 
     * @param SmsAuthenticationMethodConfiguration $item
     * @return self
     */
    public function addValue(SmsAuthenticationMethodConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SmsAuthenticationMethodConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SmsAuthenticationMethodConfiguration>
     */
