 ...
 */
class OutlookGeoCoordinatesCollectionResponse
{
    /**
     ...
     * 
     * @param OutlookGeoCoordinates ...$items Variable number of OutlookGeoCoordinates items
     * @return self
     */
    public function setValue(OutlookGeoCoordinates ...$items): self
    {
        $this->value = $items;
        return $this;
    }
