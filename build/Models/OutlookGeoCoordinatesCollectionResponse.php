...
/**
 * Collection response for OutlookGeoCoordinates
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OutlookGeoCoordinatesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param OutlookGeoCoordinates[] $items
     * @return self
     */
    public function setValue(array|OutlookGeoCoordinates $items, OutlookGeoCoordinates ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OutlookGeoCoordinates> $value
     * @return self
     ...
     * 
     * @param OutlookGeoCoordinates $item
     * @return self
     */
    public function addValue(OutlookGeoCoordinates $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OutlookGeoCoordinates>
     */
