...
/**
 * Collection response for DomainDnsSrvRecordCollectionResponse
 */
class DomainDnsSrvRecordCollectionResponseCollectionResponse
{
    /**
     * @var DomainDnsSrvRecordCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DomainDnsSrvRecordCollectionResponse ...$items Variable number of DomainDnsSrvRecordCollectionResponse items
     * @return self
     */
    public function setValue(DomainDnsSrvRecordCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DomainDnsSrvRecordCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DomainDnsSrvRecordCollectionResponse $item
     * @return self
     */
    public function addValue(DomainDnsSrvRecordCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
