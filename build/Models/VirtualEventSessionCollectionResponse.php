...
/**
 * Collection response for VirtualEventSession
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualEventSessionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param VirtualEventSession[] $items
     * @return self
     */
    public function setValue(array|VirtualEventSession $items, VirtualEventSession ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualEventSession> $value
     * @return self
     ...
     * 
     * @param VirtualEventSession $item
     * @return self
     */
    public function addValue(VirtualEventSession $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VirtualEventSession>
     */
