...
/**
 * Collection response for PageLinks
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PageLinksCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PageLinks[]
     */
     ...
     * 
     * @param PageLinks[] $items
     * @return self
     */
    public function setValue(array|PageLinks $items, PageLinks ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param PageLinks $item
     * @return self
     */
    public function addValue(PageLinks $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PageLinks>
     */
