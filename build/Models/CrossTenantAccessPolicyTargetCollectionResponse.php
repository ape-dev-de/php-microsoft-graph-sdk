...
/**
 * Collection response for CrossTenantAccessPolicyTarget
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CrossTenantAccessPolicyTargetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CrossTenantAccessPolicyTarget[] $items
     * @return self
     */
    public function setValue(array|CrossTenantAccessPolicyTarget $items, CrossTenantAccessPolicyTarget ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CrossTenantAccessPolicyTarget> $value
     * @return self
     ...
     * 
     * @param CrossTenantAccessPolicyTarget $item
     * @return self
     */
    public function addValue(CrossTenantAccessPolicyTarget $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CrossTenantAccessPolicyTarget|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CrossTenantAccessPolicyTarget>
     */
