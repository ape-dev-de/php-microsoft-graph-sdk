...
/**
 * Collection response for SettingSource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SettingSourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SettingSource[]
     */
     ...
     * 
     * @param SettingSource[] $items
     * @return self
     */
    public function setValue(array|SettingSource $items, SettingSource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SettingSource> $value
     * @return self
     ...
     * 
     * @param SettingSource $item
     * @return self
     */
    public function addValue(SettingSource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SettingSource>
     */
