...
/**
 * Collection response for WorkbookChartAxisFormat
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookChartAxisFormatCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookChartAxisFormat[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookChartAxisFormat[] $items
     * @return self
     */
    public function setValue(array|WorkbookChartAxisFormat $items, WorkbookChartAxisFormat ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookChartAxisFormat> $value
     * @return self
     ...
     * 
     * @param WorkbookChartAxisFormat $item
     * @return self
     */
    public function addValue(WorkbookChartAxisFormat $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookChartAxisFormat>
     */
