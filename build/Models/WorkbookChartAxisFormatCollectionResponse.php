 ...
 */
class WorkbookChartAxisFormatCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookChartAxisFormat ...$items Variable number of WorkbookChartAxisFormat items
     * @return self
     */
    public function setValue(WorkbookChartAxisFormat ...$items): self
    {
        $this->value = $items;
        return $this;
    }
