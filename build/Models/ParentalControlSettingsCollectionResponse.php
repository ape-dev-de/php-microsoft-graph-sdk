 ...
 */
class ParentalControlSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param ParentalControlSettings ...$items Variable number of ParentalControlSettings items
     * @return self
     */
    public function setValue(ParentalControlSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
