...
/**
 * Collection response for ParentalControlSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ParentalControlSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ParentalControlSettings[] $items
     * @return self
     */
    public function setValue(array|ParentalControlSettings $items, ParentalControlSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ParentalControlSettings> $value
     * @return self
     ...
     * 
     * @param ParentalControlSettings $item
     * @return self
     */
    public function addValue(ParentalControlSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ParentalControlSettings>
     */
