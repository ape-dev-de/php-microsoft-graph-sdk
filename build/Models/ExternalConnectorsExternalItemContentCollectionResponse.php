...
/**
 * Collection response for ExternalConnectorsExternalItemContent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsExternalItemContentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalConnectorsExternalItemContent[]
     */
    private array $value = [];
     ...
     * 
     * @return ExternalConnectorsExternalItemContent[]
     */
     ...
     * 
     * @param ExternalConnectorsExternalItemContent[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsExternalItemContent $items, ExternalConnectorsExternalItemContent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsExternalItemContent> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsExternalItemContent $item
     * @return self
     */
    public function addValue(ExternalConnectorsExternalItemContent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalConnectorsExternalItemContent|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsExternalItemContent>
     */
