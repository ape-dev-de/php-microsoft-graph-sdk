 ...
 */
class ExternalConnectorsExternalItemContentCollectionResponse
{
    /**
     ...
     * 
     * @param ExternalConnectorsExternalItemContent ...$items Variable number of ExternalConnectorsExternalItemContent items
     * @return self
     */
    public function setValue(ExternalConnectorsExternalItemContent ...$items): self
    {
        $this->value = $items;
        return $this;
    }
