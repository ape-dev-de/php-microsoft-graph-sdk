...
/**
 * Collection response for EducationAssignmentRecipient
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationAssignmentRecipientCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationAssignmentRecipient[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationAssignmentRecipient[] $items
     * @return self
     */
    public function setValue(array|EducationAssignmentRecipient $items, EducationAssignmentRecipient ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationAssignmentRecipient> $value
     * @return self
     ...
     * 
     * @param EducationAssignmentRecipient $item
     * @return self
     */
    public function addValue(EducationAssignmentRecipient $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationAssignmentRecipient>
     */
