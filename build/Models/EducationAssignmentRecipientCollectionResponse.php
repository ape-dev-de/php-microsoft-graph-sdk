...
/**
 * EducationAssignmentRecipientCollectionResponse - Collection response
 */
class EducationAssignmentRecipientCollectionResponse
{
    /**
     * @var array<int, EducationAssignmentRecipient>
     */
    public array $value = [];
