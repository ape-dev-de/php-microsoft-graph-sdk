...
/**
 * Collection response for AssociatedTeamInfoCollectionResponse
 */
class AssociatedTeamInfoCollectionResponseCollectionResponse
{
    /**
     * @var AssociatedTeamInfoCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AssociatedTeamInfoCollectionResponse ...$items Variable number of AssociatedTeamInfoCollectionResponse items
     * @return self
     */
    public function setValue(AssociatedTeamInfoCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AssociatedTeamInfoCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AssociatedTeamInfoCollectionResponse $item
     * @return self
     */
    public function addValue(AssociatedTeamInfoCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
