 ...
 */
class ChannelDeletedEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param ChannelDeletedEventMessageDetail ...$items Variable number of ChannelDeletedEventMessageDetail items
     * @return self
     */
    public function setValue(ChannelDeletedEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
