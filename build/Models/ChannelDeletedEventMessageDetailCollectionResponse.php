...
/**
 * Collection response for ChannelDeletedEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChannelDeletedEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChannelDeletedEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param ChannelDeletedEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|ChannelDeletedEventMessageDetail $items, ChannelDeletedEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChannelDeletedEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param ChannelDeletedEventMessageDetail $item
     * @return self
     */
    public function addValue(ChannelDeletedEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ChannelDeletedEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ChannelDeletedEventMessageDetail>
     */
