...
/**
 * Collection response for DlpActionInfoCollectionResponse
 */
class DlpActionInfoCollectionResponseCollectionResponse
{
    /**
     * @var DlpActionInfoCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DlpActionInfoCollectionResponse ...$items Variable number of DlpActionInfoCollectionResponse items
     * @return self
     */
    public function setValue(DlpActionInfoCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DlpActionInfoCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DlpActionInfoCollectionResponse $item
     * @return self
     */
    public function addValue(DlpActionInfoCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
