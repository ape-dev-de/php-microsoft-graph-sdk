...
/**
 * Collection response for BrowserSiteCollectionResponse
 */
class BrowserSiteCollectionResponseCollectionResponse
{
    /**
     * @var BrowserSiteCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BrowserSiteCollectionResponse ...$items Variable number of BrowserSiteCollectionResponse items
     * @return self
     */
    public function setValue(BrowserSiteCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<BrowserSiteCollectionResponse> $value
     * @return self
     ...
     * 
     * @param BrowserSiteCollectionResponse $item
     * @return self
     */
    public function addValue(BrowserSiteCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
