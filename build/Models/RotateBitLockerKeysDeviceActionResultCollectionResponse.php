 ...
 */
class RotateBitLockerKeysDeviceActionResultCollectionResponse
{
    /**
     ...
     * 
     * @param RotateBitLockerKeysDeviceActionResult ...$items Variable number of RotateBitLockerKeysDeviceActionResult items
     * @return self
     */
    public function setValue(RotateBitLockerKeysDeviceActionResult ...$items): self
    {
        $this->value = $items;
        return $this;
    }
