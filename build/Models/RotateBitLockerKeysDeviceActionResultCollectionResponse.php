...
/**
 * Collection response for RotateBitLockerKeysDeviceActionResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RotateBitLockerKeysDeviceActionResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RotateBitLockerKeysDeviceActionResult[]
     */
    private array $value = [];
     ...
     * 
     * @param RotateBitLockerKeysDeviceActionResult[] $items
     * @return self
     */
    public function setValue(array|RotateBitLockerKeysDeviceActionResult $items, RotateBitLockerKeysDeviceActionResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RotateBitLockerKeysDeviceActionResult> $value
     * @return self
     ...
     * 
     * @param RotateBitLockerKeysDeviceActionResult $item
     * @return self
     */
    public function addValue(RotateBitLockerKeysDeviceActionResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return RotateBitLockerKeysDeviceActionResult|null
     */
     ...
     * 
     * @return \ArrayIterator<int, RotateBitLockerKeysDeviceActionResult>
     */
