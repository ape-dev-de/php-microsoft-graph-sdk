...
/**
 * Collection response for WindowsInformationProtection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsInformationProtectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WindowsInformationProtection[] $items
     * @return self
     */
    public function setValue(array|WindowsInformationProtection $items, WindowsInformationProtection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsInformationProtection> $value
     * @return self
     ...
     * 
     * @param WindowsInformationProtection $item
     * @return self
     */
    public function addValue(WindowsInformationProtection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WindowsInformationProtection|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WindowsInformationProtection>
     */
