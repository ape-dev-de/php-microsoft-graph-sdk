...
/**
 * Collection response for Windows10SecureAssessmentConfigurationCollectionResponse
 */
class Windows10SecureAssessmentConfigurationCollectionResponseCollectionResponse
{
    /**
     * @var Windows10SecureAssessmentConfigurationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param Windows10SecureAssessmentConfigurationCollectionResponse ...$items Variable number of Windows10SecureAssessmentConfigurationCollectionResponse items
     * @return self
     */
    public function setValue(Windows10SecureAssessmentConfigurationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<Windows10SecureAssessmentConfigurationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param Windows10SecureAssessmentConfigurationCollectionResponse $item
     * @return self
     */
    public function addValue(Windows10SecureAssessmentConfigurationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
