...
/**
 * Collection response for IdentityGovernanceCustomTaskExtensionCollectionResponse
 */
class IdentityGovernanceCustomTaskExtensionCollectionResponseCollectionResponse
{
    /**
     * @var IdentityGovernanceCustomTaskExtensionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityGovernanceCustomTaskExtensionCollectionResponse ...$items Variable number of IdentityGovernanceCustomTaskExtensionCollectionResponse items
     * @return self
     */
    public function setValue(IdentityGovernanceCustomTaskExtensionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IdentityGovernanceCustomTaskExtensionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceCustomTaskExtensionCollectionResponse $item
     * @return self
     */
    public function addValue(IdentityGovernanceCustomTaskExtensionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
