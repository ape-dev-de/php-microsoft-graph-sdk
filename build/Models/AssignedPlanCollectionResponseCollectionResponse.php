...
/**
 * Collection response for AssignedPlanCollectionResponse
 */
class AssignedPlanCollectionResponseCollectionResponse
{
    /**
     * @var AssignedPlanCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AssignedPlanCollectionResponse ...$items Variable number of AssignedPlanCollectionResponse items
     * @return self
     */
    public function setValue(AssignedPlanCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AssignedPlanCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AssignedPlanCollectionResponse $item
     * @return self
     */
    public function addValue(AssignedPlanCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
