...
/**
 * Collection response for ServicePrincipalRiskDetection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServicePrincipalRiskDetectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ServicePrincipalRiskDetection[] $items
     * @return self
     */
    public function setValue(array|ServicePrincipalRiskDetection $items, ServicePrincipalRiskDetection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServicePrincipalRiskDetection> $value
     * @return self
     ...
     * 
     * @param ServicePrincipalRiskDetection $item
     * @return self
     */
    public function addValue(ServicePrincipalRiskDetection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ServicePrincipalRiskDetection>
     */
