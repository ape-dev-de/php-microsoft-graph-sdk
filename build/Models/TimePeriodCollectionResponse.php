...
/**
 * Collection response for TimePeriod
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TimePeriodCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TimePeriod[]
     */
     ...
     * 
     * @param TimePeriod[] $items
     * @return self
     */
    public function setValue(array|TimePeriod $items, TimePeriod ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param TimePeriod $item
     * @return self
     */
    public function addValue(TimePeriod $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TimePeriod>
     */
