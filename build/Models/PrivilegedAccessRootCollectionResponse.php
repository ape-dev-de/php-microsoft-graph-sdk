...
/**
 * Collection response for PrivilegedAccessRoot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrivilegedAccessRootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrivilegedAccessRoot[]
     */
    private array $value = [];
     ...
     * 
     * @param PrivilegedAccessRoot[] $items
     * @return self
     */
    public function setValue(array|PrivilegedAccessRoot $items, PrivilegedAccessRoot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrivilegedAccessRoot> $value
     * @return self
     ...
     * 
     * @param PrivilegedAccessRoot $item
     * @return self
     */
    public function addValue(PrivilegedAccessRoot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrivilegedAccessRoot>
     */
