 ...
 */
class PrivilegedAccessRootCollectionResponse
{
    /**
     ...
     * 
     * @param PrivilegedAccessRoot ...$items Variable number of PrivilegedAccessRoot items
     * @return self
     */
    public function setValue(PrivilegedAccessRoot ...$items): self
    {
        $this->value = $items;
        return $this;
    }
