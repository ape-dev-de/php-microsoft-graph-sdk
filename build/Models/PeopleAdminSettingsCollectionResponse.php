...
/**
 * Collection response for PeopleAdminSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PeopleAdminSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PeopleAdminSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param PeopleAdminSettings[] $items
     * @return self
     */
    public function setValue(array|PeopleAdminSettings $items, PeopleAdminSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PeopleAdminSettings> $value
     * @return self
     ...
     * 
     * @param PeopleAdminSettings $item
     * @return self
     */
    public function addValue(PeopleAdminSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PeopleAdminSettings>
     */
