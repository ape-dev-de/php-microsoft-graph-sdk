 ...
 */
class PeopleAdminSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param PeopleAdminSettings ...$items Variable number of PeopleAdminSettings items
     * @return self
     */
    public function setValue(PeopleAdminSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
