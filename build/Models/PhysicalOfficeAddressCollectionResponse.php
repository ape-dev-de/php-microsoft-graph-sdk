...
/**
 * Collection response for PhysicalOfficeAddress
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PhysicalOfficeAddressCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PhysicalOfficeAddress[] $items
     * @return self
     */
    public function setValue(array|PhysicalOfficeAddress $items, PhysicalOfficeAddress ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PhysicalOfficeAddress> $value
     * @return self
     ...
     * 
     * @param PhysicalOfficeAddress $item
     * @return self
     */
    public function addValue(PhysicalOfficeAddress $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PhysicalOfficeAddress>
     */
