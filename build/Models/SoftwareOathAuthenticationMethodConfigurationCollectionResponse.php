...
/**
 * Collection response for SoftwareOathAuthenticationMethodConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SoftwareOathAuthenticationMethodConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SoftwareOathAuthenticationMethodConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param SoftwareOathAuthenticationMethodConfiguration[] $items
     * @return self
     */
    public function setValue(array|SoftwareOathAuthenticationMethodConfiguration $items, SoftwareOathAuthenticationMethodConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SoftwareOathAuthenticationMethodConfiguration> $value
     * @return self
     ...
     * 
     * @param SoftwareOathAuthenticationMethodConfiguration $item
     * @return self
     */
    public function addValue(SoftwareOathAuthenticationMethodConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SoftwareOathAuthenticationMethodConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SoftwareOathAuthenticationMethodConfiguration>
     */
