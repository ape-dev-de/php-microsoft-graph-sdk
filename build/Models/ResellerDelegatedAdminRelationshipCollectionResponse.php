...
/**
 * Collection response for ResellerDelegatedAdminRelationship
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ResellerDelegatedAdminRelationshipCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ResellerDelegatedAdminRelationship[] $items
     * @return self
     */
    public function setValue(array|ResellerDelegatedAdminRelationship $items, ResellerDelegatedAdminRelationship ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ResellerDelegatedAdminRelationship> $value
     * @return self
     ...
     * 
     * @param ResellerDelegatedAdminRelationship $item
     * @return self
     */
    public function addValue(ResellerDelegatedAdminRelationship $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ResellerDelegatedAdminRelationship|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ResellerDelegatedAdminRelationship>
     */
