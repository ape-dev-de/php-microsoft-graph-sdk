...
/**
 * Collection response for TeamMembersNotificationRecipient
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamMembersNotificationRecipientCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamMembersNotificationRecipient[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamMembersNotificationRecipient[] $items
     * @return self
     */
    public function setValue(array|TeamMembersNotificationRecipient $items, TeamMembersNotificationRecipient ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamMembersNotificationRecipient> $value
     * @return self
     ...
     * 
     * @param TeamMembersNotificationRecipient $item
     * @return self
     */
    public function addValue(TeamMembersNotificationRecipient $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TeamMembersNotificationRecipient|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TeamMembersNotificationRecipient>
     */
