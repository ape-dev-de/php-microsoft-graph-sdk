 ...
 */
class TeamMembersNotificationRecipientCollectionResponse
{
    /**
     ...
     * 
     * @param TeamMembersNotificationRecipient ...$items Variable number of TeamMembersNotificationRecipient items
     * @return self
     */
    public function setValue(TeamMembersNotificationRecipient ...$items): self
    {
        $this->value = $items;
        return $this;
    }
