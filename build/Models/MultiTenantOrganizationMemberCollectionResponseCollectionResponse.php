...
/**
 * Collection response for MultiTenantOrganizationMemberCollectionResponse
 */
class MultiTenantOrganizationMemberCollectionResponseCollectionResponse
{
    /**
     * @var MultiTenantOrganizationMemberCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MultiTenantOrganizationMemberCollectionResponse ...$items Variable number of MultiTenantOrganizationMemberCollectionResponse items
     * @return self
     */
    public function setValue(MultiTenantOrganizationMemberCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MultiTenantOrganizationMemberCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MultiTenantOrganizationMemberCollectionResponse $item
     * @return self
     */
    public function addValue(MultiTenantOrganizationMemberCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
