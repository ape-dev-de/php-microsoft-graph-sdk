...
/**
 * Collection response for TextWebPartCollectionResponse
 */
class TextWebPartCollectionResponseCollectionResponse
{
    /**
     * @var TextWebPartCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TextWebPartCollectionResponse ...$items Variable number of TextWebPartCollectionResponse items
     * @return self
     */
    public function setValue(TextWebPartCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TextWebPartCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TextWebPartCollectionResponse $item
     * @return self
     */
    public function addValue(TextWebPartCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
