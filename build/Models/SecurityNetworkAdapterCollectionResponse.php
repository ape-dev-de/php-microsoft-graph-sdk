...
/**
 * Collection response for SecurityNetworkAdapter
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityNetworkAdapterCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityNetworkAdapter[] $items
     * @return self
     */
    public function setValue(array|SecurityNetworkAdapter $items, SecurityNetworkAdapter ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityNetworkAdapter> $value
     * @return self
     ...
     * 
     * @param SecurityNetworkAdapter $item
     * @return self
     */
    public function addValue(SecurityNetworkAdapter $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityNetworkAdapter|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityNetworkAdapter>
     */
