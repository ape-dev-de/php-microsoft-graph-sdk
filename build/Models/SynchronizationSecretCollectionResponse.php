...
/**
 * Collection response for SynchronizationSecret
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationSecretCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SynchronizationSecret[] $items
     * @return self
     */
    public function setValue(array|SynchronizationSecret $items, SynchronizationSecret ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SynchronizationSecret> $value
     * @return self
     ...
     * 
     * @param SynchronizationSecret $item
     * @return self
     */
    public function addValue(SynchronizationSecret $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SynchronizationSecret>
     */
