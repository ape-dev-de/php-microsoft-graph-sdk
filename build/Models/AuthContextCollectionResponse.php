...
/**
 * Collection response for AuthContext
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthContextCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuthContext[]
     */
     ...
     * 
     * @param AuthContext[] $items
     * @return self
     */
    public function setValue(array|AuthContext $items, AuthContext ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param AuthContext $item
     * @return self
     */
    public function addValue(AuthContext $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthContext>
     */
