...
/**
 * Collection response for EventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param EventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|EventMessageDetail $items, EventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EventMessageDetail> $value
     * @return self
     ...
     * 
     * @param EventMessageDetail $item
     * @return self
     */
    public function addValue(EventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EventMessageDetail>
     */
