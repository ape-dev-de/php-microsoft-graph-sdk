 ...
 */
class EnterpriseCodeSigningCertificateCollectionResponse
{
    /**
     ...
     * 
     * @param EnterpriseCodeSigningCertificate ...$items Variable number of EnterpriseCodeSigningCertificate items
     * @return self
     */
    public function setValue(EnterpriseCodeSigningCertificate ...$items): self
    {
        $this->value = $items;
        return $this;
    }
