...
/**
 * Collection response for EnterpriseCodeSigningCertificate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EnterpriseCodeSigningCertificateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EnterpriseCodeSigningCertificate[]
     */
    private array $value = [];
     ...
     * 
     * @param EnterpriseCodeSigningCertificate[] $items
     * @return self
     */
    public function setValue(array|EnterpriseCodeSigningCertificate $items, EnterpriseCodeSigningCertificate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EnterpriseCodeSigningCertificate> $value
     * @return self
     ...
     * 
     * @param EnterpriseCodeSigningCertificate $item
     * @return self
     */
    public function addValue(EnterpriseCodeSigningCertificate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EnterpriseCodeSigningCertificate|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EnterpriseCodeSigningCertificate>
     */
