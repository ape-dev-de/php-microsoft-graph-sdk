...
/**
 * Collection response for EducationModuleResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationModuleResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param EducationModuleResource[] $items
     * @return self
     */
    public function setValue(array|EducationModuleResource $items, EducationModuleResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationModuleResource> $value
     * @return self
     ...
     * 
     * @param EducationModuleResource $item
     * @return self
     */
    public function addValue(EducationModuleResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationModuleResource>
     */
