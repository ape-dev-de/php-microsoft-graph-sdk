...
/**
 * Collection response for SecurityServicePrincipalEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityServicePrincipalEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityServicePrincipalEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityServicePrincipalEvidence[]
     */
     ...
     * 
     * @param SecurityServicePrincipalEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityServicePrincipalEvidence $items, SecurityServicePrincipalEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityServicePrincipalEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityServicePrincipalEvidence $item
     * @return self
     */
    public function addValue(SecurityServicePrincipalEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityServicePrincipalEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityServicePrincipalEvidence>
     */
