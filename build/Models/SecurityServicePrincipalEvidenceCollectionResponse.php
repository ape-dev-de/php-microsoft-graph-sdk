 ...
 */
class SecurityServicePrincipalEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityServicePrincipalEvidence ...$items Variable number of SecurityServicePrincipalEvidence items
     * @return self
     */
    public function setValue(SecurityServicePrincipalEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
