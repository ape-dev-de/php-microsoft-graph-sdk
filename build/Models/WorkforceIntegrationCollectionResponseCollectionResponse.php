...
/**
 * Collection response for WorkforceIntegrationCollectionResponse
 */
class WorkforceIntegrationCollectionResponseCollectionResponse
{
    /**
     * @var WorkforceIntegrationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkforceIntegrationCollectionResponse ...$items Variable number of WorkforceIntegrationCollectionResponse items
     * @return self
     */
    public function setValue(WorkforceIntegrationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WorkforceIntegrationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WorkforceIntegrationCollectionResponse $item
     * @return self
     */
    public function addValue(WorkforceIntegrationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
