...
/**
 * PersistentBrowserSessionModeCollectionResponse - Collection response
 */
class PersistentBrowserSessionModeCollectionResponse
{
    /**
     * @var array<int, PersistentBrowserSessionMode>
     */
    public array $value = [];
