...
/**
 * Collection response for PersistentBrowserSessionMode
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PersistentBrowserSessionModeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PersistentBrowserSessionMode[]
     */
    private array $value = [];
     ...
     * 
     * @return PersistentBrowserSessionMode[]
     */
     ...
     * 
     * @param PersistentBrowserSessionMode[] $items
     * @return self
     */
    public function setValue(array|PersistentBrowserSessionMode $items, PersistentBrowserSessionMode ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PersistentBrowserSessionMode> $value
     * @return self
     ...
     * 
     * @param PersistentBrowserSessionMode $item
     * @return self
     */
    public function addValue(PersistentBrowserSessionMode $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PersistentBrowserSessionMode>
     */
