...
/**
 * Collection response for PartnersBillingBlobCollectionResponse
 */
class PartnersBillingBlobCollectionResponseCollectionResponse
{
    /**
     * @var PartnersBillingBlobCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return PartnersBillingBlobCollectionResponse[]
     */
     ...
     * 
     * @param PartnersBillingBlobCollectionResponse ...$items Variable number of PartnersBillingBlobCollectionResponse items
     * @return self
     */
    public function setValue(PartnersBillingBlobCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PartnersBillingBlobCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PartnersBillingBlobCollectionResponse $item
     * @return self
     */
    public function addValue(PartnersBillingBlobCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
