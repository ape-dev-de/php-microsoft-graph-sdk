...
/**
 * Collection response for PolicyPlatformType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PolicyPlatformTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PolicyPlatformType[] $items
     * @return self
     */
    public function setValue(array|PolicyPlatformType $items, PolicyPlatformType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PolicyPlatformType> $value
     * @return self
     ...
     * 
     * @param PolicyPlatformType $item
     * @return self
     */
    public function addValue(PolicyPlatformType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PolicyPlatformType>
     */
