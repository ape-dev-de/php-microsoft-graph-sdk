...
/**
 * Collection response for SearchQuery
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SearchQueryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SearchQuery[]
     */
     ...
     * 
     * @param SearchQuery[] $items
     * @return self
     */
    public function setValue(array|SearchQuery $items, SearchQuery ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param SearchQuery $item
     * @return self
     */
    public function addValue(SearchQuery $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SearchQuery>
     */
