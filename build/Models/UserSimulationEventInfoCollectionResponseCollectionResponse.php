...
/**
 * Collection response for UserSimulationEventInfoCollectionResponse
 */
class UserSimulationEventInfoCollectionResponseCollectionResponse
{
    /**
     * @var UserSimulationEventInfoCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UserSimulationEventInfoCollectionResponse ...$items Variable number of UserSimulationEventInfoCollectionResponse items
     * @return self
     */
    public function setValue(UserSimulationEventInfoCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UserSimulationEventInfoCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UserSimulationEventInfoCollectionResponse $item
     * @return self
     */
    public function addValue(UserSimulationEventInfoCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
