...
/**
 * Collection response for BookingService
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingServiceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BookingService[]
     */
     ...
     * 
     * @param BookingService[] $items
     * @return self
     */
    public function setValue(array|BookingService $items, BookingService ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingService> $value
     * @return self
     ...
     * 
     * @param BookingService $item
     * @return self
     */
    public function addValue(BookingService $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BookingService>
     */
