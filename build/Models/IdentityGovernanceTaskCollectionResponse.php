...
/**
 * Collection response for IdentityGovernanceTask
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceTaskCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IdentityGovernanceTask[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceTask $items, IdentityGovernanceTask ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceTask> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceTask $item
     * @return self
     */
    public function addValue(IdentityGovernanceTask $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceTask>
     */
