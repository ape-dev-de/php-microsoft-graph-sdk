 ...
 */
class OnenoteOperationErrorCollectionResponse
{
    /**
     ...
     * 
     * @param OnenoteOperationError ...$items Variable number of OnenoteOperationError items
     * @return self
     */
    public function setValue(OnenoteOperationError ...$items): self
    {
        $this->value = $items;
        return $this;
    }
