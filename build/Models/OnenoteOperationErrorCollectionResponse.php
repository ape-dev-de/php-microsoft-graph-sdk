...
/**
 * Collection response for OnenoteOperationError
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnenoteOperationErrorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param OnenoteOperationError[] $items
     * @return self
     */
    public function setValue(array|OnenoteOperationError $items, OnenoteOperationError ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnenoteOperationError> $value
     * @return self
     ...
     * 
     * @param OnenoteOperationError $item
     * @return self
     */
    public function addValue(OnenoteOperationError $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnenoteOperationError>
     */
