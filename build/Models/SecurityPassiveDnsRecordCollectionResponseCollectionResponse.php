...
/**
 * Collection response for SecurityPassiveDnsRecordCollectionResponse
 */
class SecurityPassiveDnsRecordCollectionResponseCollectionResponse
{
    /**
     * @var SecurityPassiveDnsRecordCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityPassiveDnsRecordCollectionResponse ...$items Variable number of SecurityPassiveDnsRecordCollectionResponse items
     * @return self
     */
    public function setValue(SecurityPassiveDnsRecordCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityPassiveDnsRecordCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityPassiveDnsRecordCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityPassiveDnsRecordCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
