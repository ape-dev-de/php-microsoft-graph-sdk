...
/**
 * Collection response for SecuritySensorHealthStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecuritySensorHealthStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecuritySensorHealthStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return SecuritySensorHealthStatus[]
     */
     ...
     * 
     * @param SecuritySensorHealthStatus[] $items
     * @return self
     */
    public function setValue(array|SecuritySensorHealthStatus $items, SecuritySensorHealthStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecuritySensorHealthStatus> $value
     * @return self
     ...
     * 
     * @param SecuritySensorHealthStatus $item
     * @return self
     */
    public function addValue(SecuritySensorHealthStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecuritySensorHealthStatus|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecuritySensorHealthStatus>
     */
