...
/**
 * SecuritySensorHealthStatusCollectionResponse - Collection response
 */
class SecuritySensorHealthStatusCollectionResponse
{
    /**
     * @var array<int, SecuritySensorHealthStatus>
     */
    public array $value = [];
