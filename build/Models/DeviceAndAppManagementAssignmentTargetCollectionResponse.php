...
/**
 * DeviceAndAppManagementAssignmentTargetCollectionResponse - Collection response
 */
class DeviceAndAppManagementAssignmentTargetCollectionResponse
{
    /**
     * @var array<int, DeviceAndAppManagementAssignmentTarget>
     */
    public array $value = [];
