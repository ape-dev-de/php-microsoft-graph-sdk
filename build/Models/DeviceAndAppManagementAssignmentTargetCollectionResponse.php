...
/**
 * Collection response for DeviceAndAppManagementAssignmentTarget
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceAndAppManagementAssignmentTargetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceAndAppManagementAssignmentTarget[] $items
     * @return self
     */
    public function setValue(array|DeviceAndAppManagementAssignmentTarget $items, DeviceAndAppManagementAssignmentTarget ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceAndAppManagementAssignmentTarget> $value
     * @return self
     ...
     * 
     * @param DeviceAndAppManagementAssignmentTarget $item
     * @return self
     */
    public function addValue(DeviceAndAppManagementAssignmentTarget $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceAndAppManagementAssignmentTarget>
     */
