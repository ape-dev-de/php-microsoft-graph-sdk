...
/**
 * Collection response for Win32LobAutoUpdateSupersededAppsState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Win32LobAutoUpdateSupersededAppsStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Win32LobAutoUpdateSupersededAppsState[]
     */
    private array $value = [];
     ...
     * 
     * @return Win32LobAutoUpdateSupersededAppsState[]
     */
     ...
     * 
     * @param Win32LobAutoUpdateSupersededAppsState[] $items
     * @return self
     */
    public function setValue(array|Win32LobAutoUpdateSupersededAppsState $items, Win32LobAutoUpdateSupersededAppsState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Win32LobAutoUpdateSupersededAppsState> $value
     * @return self
     ...
     * 
     * @param Win32LobAutoUpdateSupersededAppsState $item
     * @return self
     */
    public function addValue(Win32LobAutoUpdateSupersededAppsState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Win32LobAutoUpdateSupersededAppsState>
     */
