...
/**
 * Collection response for ManagedDeviceOwnerType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedDeviceOwnerTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ManagedDeviceOwnerType[] $items
     * @return self
     */
    public function setValue(array|ManagedDeviceOwnerType $items, ManagedDeviceOwnerType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedDeviceOwnerType> $value
     * @return self
     ...
     * 
     * @param ManagedDeviceOwnerType $item
     * @return self
     */
    public function addValue(ManagedDeviceOwnerType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedDeviceOwnerType>
     */
