...
/**
 * Collection response for UploadSession
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UploadSessionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UploadSession[]
     */
     ...
     * 
     * @param UploadSession[] $items
     * @return self
     */
    public function setValue(array|UploadSession $items, UploadSession ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UploadSession> $value
     * @return self
     ...
     * 
     * @param UploadSession $item
     * @return self
     */
    public function addValue(UploadSession $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UploadSession>
     */
