 ...
 */
class UploadSessionCollectionResponse
{
    /**
     * @var UploadSession[]
     */
     ...
     * 
     * @param UploadSession ...$items Variable number of UploadSession items
     * @return self
     */
    public function setValue(UploadSession ...$items): self
    {
        $this->value = $items;
        return $this;
    }
