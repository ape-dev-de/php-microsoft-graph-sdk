...
class ExchangeRestoreSession
{
     ...
     */
    private ?string $mailboxRestoreArtifactsBulkAdditionRequests;
    ...
    public function getMailboxRestoreArtifactsBulkAdditionRequests(): ?string
    {
        return $this->mailboxRestoreArtifactsBulkAdditionRequests;
    }

    public function setMailboxRestoreArtifactsBulkAdditionRequests(?string $mailboxRestoreArtifactsBulkAdditionRequests): self
    {
