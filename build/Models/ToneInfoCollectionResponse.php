...
/**
 * Collection response for ToneInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ToneInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ToneInfo[]
     */
     ...
     * 
     * @param ToneInfo[] $items
     * @return self
     */
    public function setValue(array|ToneInfo $items, ToneInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(ToneInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ToneInfo>
     */
