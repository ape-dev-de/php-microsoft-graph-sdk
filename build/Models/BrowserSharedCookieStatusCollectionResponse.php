...
/**
 * Collection response for BrowserSharedCookieStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BrowserSharedCookieStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BrowserSharedCookieStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return BrowserSharedCookieStatus[]
     */
     ...
     * 
     * @param BrowserSharedCookieStatus[] $items
     * @return self
     */
    public function setValue(array|BrowserSharedCookieStatus $items, BrowserSharedCookieStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BrowserSharedCookieStatus> $value
     * @return self
     ...
     * 
     * @param BrowserSharedCookieStatus $item
     * @return self
     */
    public function addValue(BrowserSharedCookieStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BrowserSharedCookieStatus>
     */
