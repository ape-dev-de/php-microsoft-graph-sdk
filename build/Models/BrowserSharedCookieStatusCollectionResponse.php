...
/**
 * BrowserSharedCookieStatusCollectionResponse - Collection response
 */
class BrowserSharedCookieStatusCollectionResponse
{
    /**
     * @var array<int, BrowserSharedCookieStatus>
     */
    public array $value = [];
