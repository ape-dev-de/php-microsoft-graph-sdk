...
/**
 * Collection response for MobileAppContent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MobileAppContentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MobileAppContent[] $items
     * @return self
     */
    public function setValue(array|MobileAppContent $items, MobileAppContent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MobileAppContent> $value
     * @return self
     ...
     * 
     * @param MobileAppContent $item
     * @return self
     */
    public function addValue(MobileAppContent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MobileAppContent>
     */
