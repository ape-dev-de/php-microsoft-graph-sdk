...
/**
 * Collection response for ActionState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ActionStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ActionState[]
     */
     ...
     * 
     * @param ActionState[] $items
     * @return self
     */
    public function setValue(array|ActionState $items, ActionState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param ActionState $item
     * @return self
     */
    public function addValue(ActionState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ActionState>
     */
