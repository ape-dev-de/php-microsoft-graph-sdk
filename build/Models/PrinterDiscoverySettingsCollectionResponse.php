...
/**
 * Collection response for PrinterDiscoverySettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrinterDiscoverySettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrinterDiscoverySettings[]
     */
    private array $value = [];
     ...
     * 
     * @param PrinterDiscoverySettings[] $items
     * @return self
     */
    public function setValue(array|PrinterDiscoverySettings $items, PrinterDiscoverySettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrinterDiscoverySettings> $value
     * @return self
     ...
     * 
     * @param PrinterDiscoverySettings $item
     * @return self
     */
    public function addValue(PrinterDiscoverySettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrinterDiscoverySettings>
     */
