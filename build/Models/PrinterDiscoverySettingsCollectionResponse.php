 ...
 */
class PrinterDiscoverySettingsCollectionResponse
{
    /**
     ...
     * 
     * @param PrinterDiscoverySettings ...$items Variable number of PrinterDiscoverySettings items
     * @return self
     */
    public function setValue(PrinterDiscoverySettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
