...
/**
 * Collection response for SecurityCitationTemplateCollectionResponse
 */
class SecurityCitationTemplateCollectionResponseCollectionResponse
{
    /**
     * @var SecurityCitationTemplateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityCitationTemplateCollectionResponse ...$items Variable number of SecurityCitationTemplateCollectionResponse items
     * @return self
     */
    public function setValue(SecurityCitationTemplateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityCitationTemplateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityCitationTemplateCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityCitationTemplateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
