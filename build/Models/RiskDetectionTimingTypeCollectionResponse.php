...
/**
 * Collection response for RiskDetectionTimingType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RiskDetectionTimingTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RiskDetectionTimingType[]
     */
    private array $value = [];
     ...
     * 
     * @param RiskDetectionTimingType[] $items
     * @return self
     */
    public function setValue(array|RiskDetectionTimingType $items, RiskDetectionTimingType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RiskDetectionTimingType> $value
     * @return self
     ...
     * 
     * @param RiskDetectionTimingType $item
     * @return self
     */
    public function addValue(RiskDetectionTimingType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RiskDetectionTimingType>
     */
