...
/**
 * Collection response for SecuritySourceType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecuritySourceTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecuritySourceType[]
     */
    private array $value = [];
     ...
     * 
     * @param SecuritySourceType[] $items
     * @return self
     */
    public function setValue(array|SecuritySourceType $items, SecuritySourceType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecuritySourceType> $value
     * @return self
     ...
     * 
     * @param SecuritySourceType $item
     * @return self
     */
    public function addValue(SecuritySourceType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecuritySourceType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecuritySourceType>
     */
