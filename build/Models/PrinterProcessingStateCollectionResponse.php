...
/**
 * Collection response for PrinterProcessingState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrinterProcessingStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PrinterProcessingState[] $items
     * @return self
     */
    public function setValue(array|PrinterProcessingState $items, PrinterProcessingState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrinterProcessingState> $value
     * @return self
     ...
     * 
     * @param PrinterProcessingState $item
     * @return self
     */
    public function addValue(PrinterProcessingState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrinterProcessingState>
     */
