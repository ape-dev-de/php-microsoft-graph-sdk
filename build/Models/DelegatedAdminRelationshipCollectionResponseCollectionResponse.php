...
/**
 * Collection response for DelegatedAdminRelationshipCollectionResponse
 */
class DelegatedAdminRelationshipCollectionResponseCollectionResponse
{
    /**
     * @var DelegatedAdminRelationshipCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DelegatedAdminRelationshipCollectionResponse ...$items Variable number of DelegatedAdminRelationshipCollectionResponse items
     * @return self
     */
    public function setValue(DelegatedAdminRelationshipCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DelegatedAdminRelationshipCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DelegatedAdminRelationshipCollectionResponse $item
     * @return self
     */
    public function addValue(DelegatedAdminRelationshipCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
