...
/**
 * Collection response for FileHashType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FileHashTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FileHashType[]
     */
     ...
     * 
     * @param FileHashType[] $items
     * @return self
     */
    public function setValue(array|FileHashType $items, FileHashType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FileHashType> $value
     * @return self
     ...
     * 
     * @param FileHashType $item
     * @return self
     */
    public function addValue(FileHashType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FileHashType>
     */
