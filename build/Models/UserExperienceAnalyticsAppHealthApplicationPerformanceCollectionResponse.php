...
/**
 * Collection response for UserExperienceAnalyticsAppHealthApplicationPerformance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsAppHealthApplicationPerformanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsAppHealthApplicationPerformance[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsAppHealthApplicationPerformance $items, UserExperienceAnalyticsAppHealthApplicationPerformance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsAppHealthApplicationPerformance> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsAppHealthApplicationPerformance $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsAppHealthApplicationPerformance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsAppHealthApplicationPerformance>
     */
