...
/**
 * UserExperienceAnalyticsAppHealthApplicationPerformanceCollectionResponse - Collection response
 */
class UserExperienceAnalyticsAppHealthApplicationPerformanceCollectionResponse
{
    /**
     * @var array<int, UserExperienceAnalyticsAppHealthApplicationPerformance>
     */
    public array $value = [];
