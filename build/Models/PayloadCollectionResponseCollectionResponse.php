...
/**
 * Collection response for PayloadCollectionResponse
 */
class PayloadCollectionResponseCollectionResponse
{
    /**
     * @var PayloadCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PayloadCollectionResponse ...$items Variable number of PayloadCollectionResponse items
     * @return self
     */
    public function setValue(PayloadCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PayloadCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PayloadCollectionResponse $item
     * @return self
     */
    public function addValue(PayloadCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
