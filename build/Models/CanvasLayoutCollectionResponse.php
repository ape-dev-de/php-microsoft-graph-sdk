...
/**
 * Collection response for CanvasLayout
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CanvasLayoutCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CanvasLayout[]
     */
     ...
     * 
     * @param CanvasLayout[] $items
     * @return self
     */
    public function setValue(array|CanvasLayout $items, CanvasLayout ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CanvasLayout> $value
     * @return self
     ...
     * 
     * @param CanvasLayout $item
     * @return self
     */
    public function addValue(CanvasLayout $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CanvasLayout>
     */
