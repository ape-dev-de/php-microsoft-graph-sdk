 ...
 */
class ConditionalAccessClientApplicationsCollectionResponse
{
    /**
     ...
     * 
     * @param ConditionalAccessClientApplications ...$items Variable number of ConditionalAccessClientApplications items
     * @return self
     */
    public function setValue(ConditionalAccessClientApplications ...$items): self
    {
        $this->value = $items;
        return $this;
    }
