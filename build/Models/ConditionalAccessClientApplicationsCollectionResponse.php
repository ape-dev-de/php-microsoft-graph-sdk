...
/**
 * Collection response for ConditionalAccessClientApplications
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessClientApplicationsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessClientApplications[]
     */
    private array $value = [];
     ...
     * 
     * @param ConditionalAccessClientApplications[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessClientApplications $items, ConditionalAccessClientApplications ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessClientApplications> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessClientApplications $item
     * @return self
     */
    public function addValue(ConditionalAccessClientApplications $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessClientApplications>
     */
