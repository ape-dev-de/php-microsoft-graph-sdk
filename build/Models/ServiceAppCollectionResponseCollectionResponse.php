...
/**
 * Collection response for ServiceAppCollectionResponse
 */
class ServiceAppCollectionResponseCollectionResponse
{
    /**
     * @var ServiceAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ServiceAppCollectionResponse ...$items Variable number of ServiceAppCollectionResponse items
     * @return self
     */
    public function setValue(ServiceAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ServiceAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ServiceAppCollectionResponse $item
     * @return self
     */
    public function addValue(ServiceAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
