...
/**
 * Collection response for EnrollmentConfigurationAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EnrollmentConfigurationAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param EnrollmentConfigurationAssignment[] $items
     * @return self
     */
    public function setValue(array|EnrollmentConfigurationAssignment $items, EnrollmentConfigurationAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EnrollmentConfigurationAssignment> $value
     * @return self
     ...
     * 
     * @param EnrollmentConfigurationAssignment $item
     * @return self
     */
    public function addValue(EnrollmentConfigurationAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EnrollmentConfigurationAssignment>
     */
