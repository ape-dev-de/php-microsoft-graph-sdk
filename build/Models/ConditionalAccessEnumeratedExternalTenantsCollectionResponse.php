...
/**
 * Collection response for ConditionalAccessEnumeratedExternalTenants
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessEnumeratedExternalTenantsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessEnumeratedExternalTenants[]
     */
    private array $value = [];
     ...
     * 
     * @param ConditionalAccessEnumeratedExternalTenants[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessEnumeratedExternalTenants $items, ConditionalAccessEnumeratedExternalTenants ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessEnumeratedExternalTenants> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessEnumeratedExternalTenants $item
     * @return self
     */
    public function addValue(ConditionalAccessEnumeratedExternalTenants $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ConditionalAccessEnumeratedExternalTenants|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessEnumeratedExternalTenants>
     */
