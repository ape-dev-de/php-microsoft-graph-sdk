 ...
 */
class ConditionalAccessEnumeratedExternalTenantsCollectionResponse
{
    /**
     ...
     * 
     * @param ConditionalAccessEnumeratedExternalTenants ...$items Variable number of ConditionalAccessEnumeratedExternalTenants items
     * @return self
     */
    public function setValue(ConditionalAccessEnumeratedExternalTenants ...$items): self
    {
        $this->value = $items;
        return $this;
    }
