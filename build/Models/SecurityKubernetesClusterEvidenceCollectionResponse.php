...
/**
 * Collection response for SecurityKubernetesClusterEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityKubernetesClusterEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityKubernetesClusterEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityKubernetesClusterEvidence[]
     */
     ...
     * 
     * @param SecurityKubernetesClusterEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityKubernetesClusterEvidence $items, SecurityKubernetesClusterEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityKubernetesClusterEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityKubernetesClusterEvidence $item
     * @return self
     */
    public function addValue(SecurityKubernetesClusterEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityKubernetesClusterEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityKubernetesClusterEvidence>
     */
