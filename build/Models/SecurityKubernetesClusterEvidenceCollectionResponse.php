 ...
 */
class SecurityKubernetesClusterEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityKubernetesClusterEvidence ...$items Variable number of SecurityKubernetesClusterEvidence items
     * @return self
     */
    public function setValue(SecurityKubernetesClusterEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
