...
/**
 * Collection response for ChatMessageReaction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatMessageReactionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ChatMessageReaction[] $items
     * @return self
     */
    public function setValue(array|ChatMessageReaction $items, ChatMessageReaction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChatMessageReaction> $value
     * @return self
     ...
     * 
     * @param ChatMessageReaction $item
     * @return self
     */
    public function addValue(ChatMessageReaction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChatMessageReaction>
     */
