...
/**
 * Collection response for TeamDescriptionUpdatedEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamDescriptionUpdatedEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamDescriptionUpdatedEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamDescriptionUpdatedEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|TeamDescriptionUpdatedEventMessageDetail $items, TeamDescriptionUpdatedEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamDescriptionUpdatedEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param TeamDescriptionUpdatedEventMessageDetail $item
     * @return self
     */
    public function addValue(TeamDescriptionUpdatedEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TeamDescriptionUpdatedEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TeamDescriptionUpdatedEventMessageDetail>
     */
