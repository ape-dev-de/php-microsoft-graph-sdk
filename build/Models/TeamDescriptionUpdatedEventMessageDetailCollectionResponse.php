 ...
 */
class TeamDescriptionUpdatedEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param TeamDescriptionUpdatedEventMessageDetail ...$items Variable number of TeamDescriptionUpdatedEventMessageDetail items
     * @return self
     */
    public function setValue(TeamDescriptionUpdatedEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
