...
/**
 * Collection response for AppConsentRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppConsentRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AppConsentRequest[] $items
     * @return self
     */
    public function setValue(array|AppConsentRequest $items, AppConsentRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppConsentRequest> $value
     * @return self
     ...
     * 
     * @param AppConsentRequest $item
     * @return self
     */
    public function addValue(AppConsentRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AppConsentRequest>
     */
