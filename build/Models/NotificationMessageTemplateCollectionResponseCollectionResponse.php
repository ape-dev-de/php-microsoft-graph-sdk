...
/**
 * Collection response for NotificationMessageTemplateCollectionResponse
 */
class NotificationMessageTemplateCollectionResponseCollectionResponse
{
    /**
     * @var NotificationMessageTemplateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param NotificationMessageTemplateCollectionResponse ...$items Variable number of NotificationMessageTemplateCollectionResponse items
     * @return self
     */
    public function setValue(NotificationMessageTemplateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<NotificationMessageTemplateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param NotificationMessageTemplateCollectionResponse $item
     * @return self
     */
    public function addValue(NotificationMessageTemplateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
