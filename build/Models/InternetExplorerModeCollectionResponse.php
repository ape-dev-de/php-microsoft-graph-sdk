...
/**
 * Collection response for InternetExplorerMode
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InternetExplorerModeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var InternetExplorerMode[]
     */
    private array $value = [];
     ...
     * 
     * @param InternetExplorerMode[] $items
     * @return self
     */
    public function setValue(array|InternetExplorerMode $items, InternetExplorerMode ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InternetExplorerMode> $value
     * @return self
     ...
     * 
     * @param InternetExplorerMode $item
     * @return self
     */
    public function addValue(InternetExplorerMode $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, InternetExplorerMode>
     */
