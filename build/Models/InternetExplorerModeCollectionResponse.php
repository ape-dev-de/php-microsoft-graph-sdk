 ...
 */
class InternetExplorerModeCollectionResponse
{
    /**
     ...
     * 
     * @param InternetExplorerMode ...$items Variable number of InternetExplorerMode items
     * @return self
     */
    public function setValue(InternetExplorerMode ...$items): self
    {
        $this->value = $items;
        return $this;
    }
