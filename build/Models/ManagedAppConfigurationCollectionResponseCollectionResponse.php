...
/**
 * Collection response for ManagedAppConfigurationCollectionResponse
 */
class ManagedAppConfigurationCollectionResponseCollectionResponse
{
    /**
     * @var ManagedAppConfigurationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedAppConfigurationCollectionResponse ...$items Variable number of ManagedAppConfigurationCollectionResponse items
     * @return self
     */
    public function setValue(ManagedAppConfigurationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ManagedAppConfigurationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ManagedAppConfigurationCollectionResponse $item
     * @return self
     */
    public function addValue(ManagedAppConfigurationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
