...
/**
 * Collection response for PinnedChatMessageInfoCollectionResponse
 */
class PinnedChatMessageInfoCollectionResponseCollectionResponse
{
    /**
     * @var PinnedChatMessageInfoCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PinnedChatMessageInfoCollectionResponse ...$items Variable number of PinnedChatMessageInfoCollectionResponse items
     * @return self
     */
    public function setValue(PinnedChatMessageInfoCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PinnedChatMessageInfoCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PinnedChatMessageInfoCollectionResponse $item
     * @return self
     */
    public function addValue(PinnedChatMessageInfoCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
