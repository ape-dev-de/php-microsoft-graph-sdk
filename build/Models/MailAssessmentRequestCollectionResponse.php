...
/**
 * Collection response for MailAssessmentRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MailAssessmentRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MailAssessmentRequest[]
     */
    private array $value = [];
     ...
     * 
     * @param MailAssessmentRequest[] $items
     * @return self
     */
    public function setValue(array|MailAssessmentRequest $items, MailAssessmentRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MailAssessmentRequest> $value
     * @return self
     ...
     * 
     * @param MailAssessmentRequest $item
     * @return self
     */
    public function addValue(MailAssessmentRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MailAssessmentRequest|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MailAssessmentRequest>
     */
