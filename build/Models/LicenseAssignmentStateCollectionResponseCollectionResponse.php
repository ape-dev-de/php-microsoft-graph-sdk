...
/**
 * Collection response for LicenseAssignmentStateCollectionResponse
 */
class LicenseAssignmentStateCollectionResponseCollectionResponse
{
    /**
     * @var LicenseAssignmentStateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param LicenseAssignmentStateCollectionResponse ...$items Variable number of LicenseAssignmentStateCollectionResponse items
     * @return self
     */
    public function setValue(LicenseAssignmentStateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<LicenseAssignmentStateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param LicenseAssignmentStateCollectionResponse $item
     * @return self
     */
    public function addValue(LicenseAssignmentStateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
