...
/**
 * Collection response for BrowserSiteStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BrowserSiteStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BrowserSiteStatus[]
     */
    private array $value = [];
     ...
     * 
     * @param BrowserSiteStatus[] $items
     * @return self
     */
    public function setValue(array|BrowserSiteStatus $items, BrowserSiteStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BrowserSiteStatus> $value
     * @return self
     ...
     * 
     * @param BrowserSiteStatus $item
     * @return self
     */
    public function addValue(BrowserSiteStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BrowserSiteStatus>
     */
