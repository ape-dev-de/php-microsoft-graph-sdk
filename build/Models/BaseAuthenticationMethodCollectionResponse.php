...
/**
 * Collection response for BaseAuthenticationMethod
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BaseAuthenticationMethodCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BaseAuthenticationMethod[]
     */
    private array $value = [];
     ...
     * 
     * @return BaseAuthenticationMethod[]
     */
     ...
     * 
     * @param BaseAuthenticationMethod[] $items
     * @return self
     */
    public function setValue(array|BaseAuthenticationMethod $items, BaseAuthenticationMethod ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BaseAuthenticationMethod> $value
     * @return self
     ...
     * 
     * @param BaseAuthenticationMethod $item
     * @return self
     */
    public function addValue(BaseAuthenticationMethod $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BaseAuthenticationMethod>
     */
