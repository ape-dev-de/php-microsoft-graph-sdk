...
/**
 * Collection response for AuthenticationMethodFeature
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationMethodFeatureCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuthenticationMethodFeature[]
     */
    private array $value = [];
     ...
     * 
     * @return AuthenticationMethodFeature[]
     */
     ...
     * 
     * @param AuthenticationMethodFeature[] $items
     * @return self
     */
    public function setValue(array|AuthenticationMethodFeature $items, AuthenticationMethodFeature ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationMethodFeature> $value
     * @return self
     ...
     * 
     * @param AuthenticationMethodFeature $item
     * @return self
     */
    public function addValue(AuthenticationMethodFeature $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationMethodFeature>
     */
