...
/**
 * AuthenticationMethodFeatureCollectionResponse - Collection response
 */
class AuthenticationMethodFeatureCollectionResponse
{
    /**
     * @var array<int, AuthenticationMethodFeature>
     */
    public array $value = [];
