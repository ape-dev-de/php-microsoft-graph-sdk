...
/**
 * Collection response for SubscriptionCollectionResponse
 */
class SubscriptionCollectionResponseCollectionResponse
{
    /**
     * @var SubscriptionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SubscriptionCollectionResponse ...$items Variable number of SubscriptionCollectionResponse items
     * @return self
     */
    public function setValue(SubscriptionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SubscriptionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SubscriptionCollectionResponse $item
     * @return self
     */
    public function addValue(SubscriptionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
