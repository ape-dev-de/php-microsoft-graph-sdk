...
/**
 * OnAttributeCollectionStartCustomExtensionCollectionResponse - Collection response
 */
class OnAttributeCollectionStartCustomExtensionCollectionResponse
{
    /**
     * @var array<int, OnAttributeCollectionStartCustomExtension>
     */
    public array $value = [];
