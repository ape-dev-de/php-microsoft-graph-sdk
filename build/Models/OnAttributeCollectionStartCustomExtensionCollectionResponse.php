...
/**
 * Collection response for OnAttributeCollectionStartCustomExtension
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnAttributeCollectionStartCustomExtensionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnAttributeCollectionStartCustomExtension[]
     */
    private array $value = [];
     ...
     * 
     * @param OnAttributeCollectionStartCustomExtension[] $items
     * @return self
     */
    public function setValue(array|OnAttributeCollectionStartCustomExtension $items, OnAttributeCollectionStartCustomExtension ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnAttributeCollectionStartCustomExtension> $value
     * @return self
     ...
     * 
     * @param OnAttributeCollectionStartCustomExtension $item
     * @return self
     */
    public function addValue(OnAttributeCollectionStartCustomExtension $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnAttributeCollectionStartCustomExtension>
     */
