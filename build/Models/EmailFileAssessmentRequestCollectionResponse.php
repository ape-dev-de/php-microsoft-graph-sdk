...
/**
 * Collection response for EmailFileAssessmentRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EmailFileAssessmentRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EmailFileAssessmentRequest[]
     */
    private array $value = [];
     ...
     * 
     * @param EmailFileAssessmentRequest[] $items
     * @return self
     */
    public function setValue(array|EmailFileAssessmentRequest $items, EmailFileAssessmentRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EmailFileAssessmentRequest> $value
     * @return self
     ...
     * 
     * @param EmailFileAssessmentRequest $item
     * @return self
     */
    public function addValue(EmailFileAssessmentRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EmailFileAssessmentRequest|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EmailFileAssessmentRequest>
     */
