...
/**
 * Collection response for LinkedResourceCollectionResponse
 */
class LinkedResourceCollectionResponseCollectionResponse
{
    /**
     * @var LinkedResourceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param LinkedResourceCollectionResponse ...$items Variable number of LinkedResourceCollectionResponse items
     * @return self
     */
    public function setValue(LinkedResourceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<LinkedResourceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param LinkedResourceCollectionResponse $item
     * @return self
     */
    public function addValue(LinkedResourceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
