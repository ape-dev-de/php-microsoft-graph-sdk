...
/**
 * Collection response for ExternalConnectorsExternal
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsExternalCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalConnectorsExternal[]
     */
    private array $value = [];
     ...
     * 
     * @param ExternalConnectorsExternal[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsExternal $items, ExternalConnectorsExternal ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsExternal> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsExternal $item
     * @return self
     */
    public function addValue(ExternalConnectorsExternal $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsExternal>
     */
