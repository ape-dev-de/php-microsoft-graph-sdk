 ...
 */
class ExternalConnectorsExternalCollectionResponse
{
    /**
     ...
     * 
     * @param ExternalConnectorsExternal ...$items Variable number of ExternalConnectorsExternal items
     * @return self
     */
    public function setValue(ExternalConnectorsExternal ...$items): self
    {
        $this->value = $items;
        return $this;
    }
