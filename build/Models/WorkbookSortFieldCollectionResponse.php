...
/**
 * Collection response for WorkbookSortField
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookSortFieldCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WorkbookSortField[] $items
     * @return self
     */
    public function setValue(array|WorkbookSortField $items, WorkbookSortField ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookSortField> $value
     * @return self
     ...
     * 
     * @param WorkbookSortField $item
     * @return self
     */
    public function addValue(WorkbookSortField $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookSortField>
     */
