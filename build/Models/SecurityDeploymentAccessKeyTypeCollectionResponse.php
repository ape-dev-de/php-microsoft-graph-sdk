 ...
 */
class SecurityDeploymentAccessKeyTypeCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityDeploymentAccessKeyType ...$items Variable number of SecurityDeploymentAccessKeyType items
     * @return self
     */
    public function setValue(SecurityDeploymentAccessKeyType ...$items): self
    {
        $this->value = $items;
        return $this;
    }
