...
/**
 * Collection response for SecurityDeploymentAccessKeyType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityDeploymentAccessKeyTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityDeploymentAccessKeyType[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityDeploymentAccessKeyType[]
     */
     ...
     * 
     * @param SecurityDeploymentAccessKeyType[] $items
     * @return self
     */
    public function setValue(array|SecurityDeploymentAccessKeyType $items, SecurityDeploymentAccessKeyType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityDeploymentAccessKeyType> $value
     * @return self
     ...
     * 
     * @param SecurityDeploymentAccessKeyType $item
     * @return self
     */
    public function addValue(SecurityDeploymentAccessKeyType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityDeploymentAccessKeyType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityDeploymentAccessKeyType>
     */
