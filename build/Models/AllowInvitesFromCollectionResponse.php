...
/**
 * Collection response for AllowInvitesFrom
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AllowInvitesFromCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AllowInvitesFrom[]
     */
    private array $value = [];
     ...
     * 
     * @param AllowInvitesFrom[] $items
     * @return self
     */
    public function setValue(array|AllowInvitesFrom $items, AllowInvitesFrom ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AllowInvitesFrom> $value
     * @return self
     ...
     * 
     * @param AllowInvitesFrom $item
     * @return self
     */
    public function addValue(AllowInvitesFrom $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AllowInvitesFrom>
     */
