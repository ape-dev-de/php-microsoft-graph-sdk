...
/**
 * Collection response for UserExperienceAnalyticsModelScoresCollectionResponse
 */
class UserExperienceAnalyticsModelScoresCollectionResponseCollectionResponse
{
    /**
     * @var UserExperienceAnalyticsModelScoresCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UserExperienceAnalyticsModelScoresCollectionResponse ...$items Variable number of UserExperienceAnalyticsModelScoresCollectionResponse items
     * @return self
     */
    public function setValue(UserExperienceAnalyticsModelScoresCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UserExperienceAnalyticsModelScoresCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsModelScoresCollectionResponse $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsModelScoresCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
