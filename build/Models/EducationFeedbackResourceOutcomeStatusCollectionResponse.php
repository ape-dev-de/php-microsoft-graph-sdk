...
/**
 * EducationFeedbackResourceOutcomeStatusCollectionResponse - Collection response
 */
class EducationFeedbackResourceOutcomeStatusCollectionResponse
{
    /**
     * @var array<int, EducationFeedbackResourceOutcomeStatus>
     */
    public array $value = [];
