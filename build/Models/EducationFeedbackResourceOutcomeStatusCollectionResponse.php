...
/**
 * Collection response for EducationFeedbackResourceOutcomeStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationFeedbackResourceOutcomeStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationFeedbackResourceOutcomeStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return EducationFeedbackResourceOutcomeStatus[]
     */
     ...
     * 
     * @param EducationFeedbackResourceOutcomeStatus[] $items
     * @return self
     */
    public function setValue(array|EducationFeedbackResourceOutcomeStatus $items, EducationFeedbackResourceOutcomeStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationFeedbackResourceOutcomeStatus> $value
     * @return self
     ...
     * 
     * @param EducationFeedbackResourceOutcomeStatus $item
     * @return self
     */
    public function addValue(EducationFeedbackResourceOutcomeStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationFeedbackResourceOutcomeStatus>
     */
