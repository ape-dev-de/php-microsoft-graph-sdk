...
/**
 * Collection response for ProvisioningResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProvisioningResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ProvisioningResult[] $items
     * @return self
     */
    public function setValue(array|ProvisioningResult $items, ProvisioningResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProvisioningResult> $value
     * @return self
     ...
     * 
     * @param ProvisioningResult $item
     * @return self
     */
    public function addValue(ProvisioningResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProvisioningResult>
     */
