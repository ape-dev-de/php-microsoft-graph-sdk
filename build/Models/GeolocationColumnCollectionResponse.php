...
/**
 * Collection response for GeolocationColumn
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class GeolocationColumnCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var GeolocationColumn[]
     */
    private array $value = [];
     ...
     * 
     * @param GeolocationColumn[] $items
     * @return self
     */
    public function setValue(array|GeolocationColumn $items, GeolocationColumn ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<GeolocationColumn> $value
     * @return self
     ...
     * 
     * @param GeolocationColumn $item
     * @return self
     */
    public function addValue(GeolocationColumn $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, GeolocationColumn>
     */
