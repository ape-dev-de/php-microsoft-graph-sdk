...
/**
 * Collection response for MetaDataKeyValuePair
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MetaDataKeyValuePairCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MetaDataKeyValuePair[] $items
     * @return self
     */
    public function setValue(array|MetaDataKeyValuePair $items, MetaDataKeyValuePair ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MetaDataKeyValuePair> $value
     * @return self
     ...
     * 
     * @param MetaDataKeyValuePair $item
     * @return self
     */
    public function addValue(MetaDataKeyValuePair $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MetaDataKeyValuePair|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MetaDataKeyValuePair>
     */
