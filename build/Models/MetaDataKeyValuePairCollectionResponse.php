 ...
 */
class MetaDataKeyValuePairCollectionResponse
{
    /**
     ...
     * 
     * @param MetaDataKeyValuePair ...$items Variable number of MetaDataKeyValuePair items
     * @return self
     */
    public function setValue(MetaDataKeyValuePair ...$items): self
    {
        $this->value = $items;
        return $this;
    }
