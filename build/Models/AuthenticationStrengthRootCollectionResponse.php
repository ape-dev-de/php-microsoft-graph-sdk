...
/**
 * Collection response for AuthenticationStrengthRoot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationStrengthRootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuthenticationStrengthRoot[]
     */
    private array $value = [];
     ...
     * 
     * @param AuthenticationStrengthRoot[] $items
     * @return self
     */
    public function setValue(array|AuthenticationStrengthRoot $items, AuthenticationStrengthRoot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationStrengthRoot> $value
     * @return self
     ...
     * 
     * @param AuthenticationStrengthRoot $item
     * @return self
     */
    public function addValue(AuthenticationStrengthRoot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationStrengthRoot>
     */
