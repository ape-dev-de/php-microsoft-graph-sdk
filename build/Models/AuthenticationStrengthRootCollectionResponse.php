 ...
 */
class AuthenticationStrengthRootCollectionResponse
{
    /**
     ...
     * 
     * @param AuthenticationStrengthRoot ...$items Variable number of AuthenticationStrengthRoot items
     * @return self
     */
    public function setValue(AuthenticationStrengthRoot ...$items): self
    {
        $this->value = $items;
        return $this;
    }
