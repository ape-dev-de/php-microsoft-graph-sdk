...
/**
 * Collection response for UserActivityType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserActivityTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserActivityType[] $items
     * @return self
     */
    public function setValue(array|UserActivityType $items, UserActivityType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserActivityType> $value
     * @return self
     ...
     * 
     * @param UserActivityType $item
     * @return self
     */
    public function addValue(UserActivityType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserActivityType>
     */
