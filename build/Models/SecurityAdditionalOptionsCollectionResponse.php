...
/**
 * SecurityAdditionalOptionsCollectionResponse - Collection response
 */
class SecurityAdditionalOptionsCollectionResponse
{
    /**
     * @var array<int, SecurityAdditionalOptions>
     */
    public array $value = [];
