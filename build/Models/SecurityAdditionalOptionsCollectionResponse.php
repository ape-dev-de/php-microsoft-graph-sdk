...
/**
 * Collection response for SecurityAdditionalOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityAdditionalOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityAdditionalOptions[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityAdditionalOptions[]
     */
     ...
     * 
     * @param SecurityAdditionalOptions[] $items
     * @return self
     */
    public function setValue(array|SecurityAdditionalOptions $items, SecurityAdditionalOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityAdditionalOptions> $value
     * @return self
     ...
     * 
     * @param SecurityAdditionalOptions $item
     * @return self
     */
    public function addValue(SecurityAdditionalOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityAdditionalOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityAdditionalOptions>
     */
