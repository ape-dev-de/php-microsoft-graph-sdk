...
/**
 * Collection response for DeviceLogCollectionTemplateType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceLogCollectionTemplateTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceLogCollectionTemplateType[]
     */
    private array $value = [];
     ...
     * 
     * @return DeviceLogCollectionTemplateType[]
     */
     ...
     * 
     * @param DeviceLogCollectionTemplateType[] $items
     * @return self
     */
    public function setValue(array|DeviceLogCollectionTemplateType $items, DeviceLogCollectionTemplateType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceLogCollectionTemplateType> $value
     * @return self
     ...
     * 
     * @param DeviceLogCollectionTemplateType $item
     * @return self
     */
    public function addValue(DeviceLogCollectionTemplateType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceLogCollectionTemplateType>
     */
