...
/**
 * DeviceLogCollectionTemplateTypeCollectionResponse - Collection response
 */
class DeviceLogCollectionTemplateTypeCollectionResponse
{
    /**
     * @var array<int, DeviceLogCollectionTemplateType>
     */
    public array $value = [];
