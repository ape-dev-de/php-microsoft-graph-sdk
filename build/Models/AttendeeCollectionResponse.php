...
/**
 * Collection response for Attendee
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttendeeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Attendee[]
     */
     ...
     * @return self
     */
    public function setValue(array|Attendee $items, Attendee ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Attendee $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Attendee>
     */
