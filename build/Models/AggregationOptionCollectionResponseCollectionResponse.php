...
/**
 * Collection response for AggregationOptionCollectionResponse
 */
class AggregationOptionCollectionResponseCollectionResponse
{
    /**
     * @var AggregationOptionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AggregationOptionCollectionResponse ...$items Variable number of AggregationOptionCollectionResponse items
     * @return self
     */
    public function setValue(AggregationOptionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AggregationOptionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AggregationOptionCollectionResponse $item
     * @return self
     */
    public function addValue(AggregationOptionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
