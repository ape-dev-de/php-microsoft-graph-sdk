...
/**
 * Collection response for RestoreSessionBaseCollectionResponse
 */
class RestoreSessionBaseCollectionResponseCollectionResponse
{
    /**
     * @var RestoreSessionBaseCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RestoreSessionBaseCollectionResponse ...$items Variable number of RestoreSessionBaseCollectionResponse items
     * @return self
     */
    public function setValue(RestoreSessionBaseCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RestoreSessionBaseCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RestoreSessionBaseCollectionResponse $item
     * @return self
     */
    public function addValue(RestoreSessionBaseCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
