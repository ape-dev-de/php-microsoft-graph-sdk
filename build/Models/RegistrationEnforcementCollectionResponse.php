...
/**
 * Collection response for RegistrationEnforcement
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RegistrationEnforcementCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RegistrationEnforcement[]
     */
    private array $value = [];
     ...
     * 
     * @param RegistrationEnforcement[] $items
     * @return self
     */
    public function setValue(array|RegistrationEnforcement $items, RegistrationEnforcement ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RegistrationEnforcement> $value
     * @return self
     ...
     * 
     * @param RegistrationEnforcement $item
     * @return self
     */
    public function addValue(RegistrationEnforcement $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RegistrationEnforcement>
     */
