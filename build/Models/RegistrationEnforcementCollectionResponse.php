 ...
 */
class RegistrationEnforcementCollectionResponse
{
    /**
     ...
     * 
     * @param RegistrationEnforcement ...$items Variable number of RegistrationEnforcement items
     * @return self
     */
    public function setValue(RegistrationEnforcement ...$items): self
    {
        $this->value = $items;
        return $this;
    }
