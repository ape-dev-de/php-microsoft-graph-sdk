...
/**
 * Collection response for ShiftAvailability
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ShiftAvailabilityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ShiftAvailability[] $items
     * @return self
     */
    public function setValue(array|ShiftAvailability $items, ShiftAvailability ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ShiftAvailability> $value
     * @return self
     ...
     * 
     * @param ShiftAvailability $item
     * @return self
     */
    public function addValue(ShiftAvailability $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ShiftAvailability>
     */
