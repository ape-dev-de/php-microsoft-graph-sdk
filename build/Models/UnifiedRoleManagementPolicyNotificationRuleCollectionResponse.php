...
/**
 * Collection response for UnifiedRoleManagementPolicyNotificationRule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRoleManagementPolicyNotificationRuleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UnifiedRoleManagementPolicyNotificationRule[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedRoleManagementPolicyNotificationRule[] $items
     * @return self
     */
    public function setValue(array|UnifiedRoleManagementPolicyNotificationRule $items, UnifiedRoleManagementPolicyNotificationRule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRoleManagementPolicyNotificationRule> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleManagementPolicyNotificationRule $item
     * @return self
     */
    public function addValue(UnifiedRoleManagementPolicyNotificationRule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UnifiedRoleManagementPolicyNotificationRule|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRoleManagementPolicyNotificationRule>
     */
