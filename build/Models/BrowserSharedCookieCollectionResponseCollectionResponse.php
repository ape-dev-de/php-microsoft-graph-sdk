...
/**
 * Collection response for BrowserSharedCookieCollectionResponse
 */
class BrowserSharedCookieCollectionResponseCollectionResponse
{
    /**
     * @var BrowserSharedCookieCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BrowserSharedCookieCollectionResponse ...$items Variable number of BrowserSharedCookieCollectionResponse items
     * @return self
     */
    public function setValue(BrowserSharedCookieCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<BrowserSharedCookieCollectionResponse> $value
     * @return self
     ...
     * 
     * @param BrowserSharedCookieCollectionResponse $item
     * @return self
     */
    public function addValue(BrowserSharedCookieCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
