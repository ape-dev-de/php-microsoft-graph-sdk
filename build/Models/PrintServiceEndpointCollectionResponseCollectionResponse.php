...
/**
 * Collection response for PrintServiceEndpointCollectionResponse
 */
class PrintServiceEndpointCollectionResponseCollectionResponse
{
    /**
     * @var PrintServiceEndpointCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PrintServiceEndpointCollectionResponse ...$items Variable number of PrintServiceEndpointCollectionResponse items
     * @return self
     */
    public function setValue(PrintServiceEndpointCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PrintServiceEndpointCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PrintServiceEndpointCollectionResponse $item
     * @return self
     */
    public function addValue(PrintServiceEndpointCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
