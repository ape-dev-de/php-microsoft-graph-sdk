...
/**
 * Collection response for PlannerUser
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerUserCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PlannerUser[]
     */
     ...
     * 
     * @param PlannerUser[] $items
     * @return self
     */
    public function setValue(array|PlannerUser $items, PlannerUser ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param PlannerUser $item
     * @return self
     */
    public function addValue(PlannerUser $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PlannerUser>
     */
