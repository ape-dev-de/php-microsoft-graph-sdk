...
/**
 * Collection response for CallCollectionResponse
 */
class CallCollectionResponseCollectionResponse
{
    /**
     * @var CallCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CallCollectionResponse ...$items Variable number of CallCollectionResponse items
     * @return self
     */
    public function setValue(CallCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CallCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CallCollectionResponse $item
     * @return self
     */
    public function addValue(CallCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
