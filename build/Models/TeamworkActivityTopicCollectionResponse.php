...
/**
 * Collection response for TeamworkActivityTopic
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamworkActivityTopicCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamworkActivityTopic[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamworkActivityTopic[] $items
     * @return self
     */
    public function setValue(array|TeamworkActivityTopic $items, TeamworkActivityTopic ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamworkActivityTopic> $value
     * @return self
     ...
     * 
     * @param TeamworkActivityTopic $item
     * @return self
     */
    public function addValue(TeamworkActivityTopic $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamworkActivityTopic>
     */
