 ...
 */
class TeamworkActivityTopicCollectionResponse
{
    /**
     ...
     * 
     * @param TeamworkActivityTopic ...$items Variable number of TeamworkActivityTopic items
     * @return self
     */
    public function setValue(TeamworkActivityTopic ...$items): self
    {
        $this->value = $items;
        return $this;
    }
