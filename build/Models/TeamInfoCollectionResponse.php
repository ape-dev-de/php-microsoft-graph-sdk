...
/**
 * Collection response for TeamInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamInfo[]
     */
     ...
     * 
     * @param TeamInfo[] $items
     * @return self
     */
    public function setValue(array|TeamInfo $items, TeamInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(TeamInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamInfo>
     */
