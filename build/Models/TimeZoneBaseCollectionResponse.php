...
/**
 * Collection response for TimeZoneBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TimeZoneBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TimeZoneBase[]
     */
     ...
     * 
     * @param TimeZoneBase[] $items
     * @return self
     */
    public function setValue(array|TimeZoneBase $items, TimeZoneBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TimeZoneBase> $value
     * @return self
     ...
     * 
     * @param TimeZoneBase $item
     * @return self
     */
    public function addValue(TimeZoneBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TimeZoneBase>
     */
