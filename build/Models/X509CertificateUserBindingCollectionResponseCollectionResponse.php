...
/**
 * Collection response for X509CertificateUserBindingCollectionResponse
 */
class X509CertificateUserBindingCollectionResponseCollectionResponse
{
    /**
     * @var X509CertificateUserBindingCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param X509CertificateUserBindingCollectionResponse ...$items Variable number of X509CertificateUserBindingCollectionResponse items
     * @return self
     */
    public function setValue(X509CertificateUserBindingCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<X509CertificateUserBindingCollectionResponse> $value
     * @return self
     ...
     * 
     * @param X509CertificateUserBindingCollectionResponse $item
     * @return self
     */
    public function addValue(X509CertificateUserBindingCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
