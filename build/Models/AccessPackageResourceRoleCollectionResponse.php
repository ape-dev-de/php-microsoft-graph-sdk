...
/**
 * Collection response for AccessPackageResourceRole
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageResourceRoleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessPackageResourceRole[] $items
     * @return self
     */
    public function setValue(array|AccessPackageResourceRole $items, AccessPackageResourceRole ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageResourceRole> $value
     * @return self
     ...
     * 
     * @param AccessPackageResourceRole $item
     * @return self
     */
    public function addValue(AccessPackageResourceRole $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageResourceRole>
     */
