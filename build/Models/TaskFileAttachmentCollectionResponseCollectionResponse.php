...
/**
 * Collection response for TaskFileAttachmentCollectionResponse
 */
class TaskFileAttachmentCollectionResponseCollectionResponse
{
    /**
     * @var TaskFileAttachmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TaskFileAttachmentCollectionResponse ...$items Variable number of TaskFileAttachmentCollectionResponse items
     * @return self
     */
    public function setValue(TaskFileAttachmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TaskFileAttachmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TaskFileAttachmentCollectionResponse $item
     * @return self
     */
    public function addValue(TaskFileAttachmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
