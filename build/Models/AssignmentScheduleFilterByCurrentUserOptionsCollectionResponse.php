...
/**
 * AssignmentScheduleFilterByCurrentUserOptionsCollectionResponse - Collection response
 */
class AssignmentScheduleFilterByCurrentUserOptionsCollectionResponse
{
    /**
     * @var array<int, AssignmentScheduleFilterByCurrentUserOptions>
     */
    public array $value = [];
