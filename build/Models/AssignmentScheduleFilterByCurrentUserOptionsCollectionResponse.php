...
/**
 * Collection response for AssignmentScheduleFilterByCurrentUserOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AssignmentScheduleFilterByCurrentUserOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AssignmentScheduleFilterByCurrentUserOptions[]
     */
    private array $value = [];
     ...
     * 
     * @return AssignmentScheduleFilterByCurrentUserOptions[]
     */
     ...
     * 
     * @param AssignmentScheduleFilterByCurrentUserOptions[] $items
     * @return self
     */
    public function setValue(array|AssignmentScheduleFilterByCurrentUserOptions $items, AssignmentScheduleFilterByCurrentUserOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AssignmentScheduleFilterByCurrentUserOptions> $value
     * @return self
     ...
     * 
     * @param AssignmentScheduleFilterByCurrentUserOptions $item
     * @return self
     */
    public function addValue(AssignmentScheduleFilterByCurrentUserOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AssignmentScheduleFilterByCurrentUserOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AssignmentScheduleFilterByCurrentUserOptions>
     */
