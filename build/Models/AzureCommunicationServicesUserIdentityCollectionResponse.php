 ...
 */
class AzureCommunicationServicesUserIdentityCollectionResponse
{
    /**
     ...
     * 
     * @param AzureCommunicationServicesUserIdentity ...$items Variable number of AzureCommunicationServicesUserIdentity items
     * @return self
     */
    public function setValue(AzureCommunicationServicesUserIdentity ...$items): self
    {
        $this->value = $items;
        return $this;
    }
