...
/**
 * Collection response for AzureCommunicationServicesUserIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AzureCommunicationServicesUserIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AzureCommunicationServicesUserIdentity[]
     */
    private array $value = [];
     ...
     * 
     * @param AzureCommunicationServicesUserIdentity[] $items
     * @return self
     */
    public function setValue(array|AzureCommunicationServicesUserIdentity $items, AzureCommunicationServicesUserIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AzureCommunicationServicesUserIdentity> $value
     * @return self
     ...
     * 
     * @param AzureCommunicationServicesUserIdentity $item
     * @return self
     */
    public function addValue(AzureCommunicationServicesUserIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AzureCommunicationServicesUserIdentity|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AzureCommunicationServicesUserIdentity>
     */
