...
/**
 * Collection response for MeetingTimeSuggestionsResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MeetingTimeSuggestionsResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MeetingTimeSuggestionsResult[] $items
     * @return self
     */
    public function setValue(array|MeetingTimeSuggestionsResult $items, MeetingTimeSuggestionsResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MeetingTimeSuggestionsResult> $value
     * @return self
     ...
     * 
     * @param MeetingTimeSuggestionsResult $item
     * @return self
     */
    public function addValue(MeetingTimeSuggestionsResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MeetingTimeSuggestionsResult|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MeetingTimeSuggestionsResult>
     */
