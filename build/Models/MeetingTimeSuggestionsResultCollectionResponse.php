 ...
 */
class MeetingTimeSuggestionsResultCollectionResponse
{
    /**
     ...
     * 
     * @param MeetingTimeSuggestionsResult ...$items Variable number of MeetingTimeSuggestionsResult items
     * @return self
     */
    public function setValue(MeetingTimeSuggestionsResult ...$items): self
    {
        $this->value = $items;
        return $this;
    }
