...
/**
 * Collection response for IdentityGovernanceWorkflowsInsightsByCategory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceWorkflowsInsightsByCategoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceWorkflowsInsightsByCategory[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceWorkflowsInsightsByCategory[]
     */
     ...
     * 
     * @param IdentityGovernanceWorkflowsInsightsByCategory[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceWorkflowsInsightsByCategory $items, IdentityGovernanceWorkflowsInsightsByCategory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceWorkflowsInsightsByCategory> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceWorkflowsInsightsByCategory $item
     * @return self
     */
    public function addValue(IdentityGovernanceWorkflowsInsightsByCategory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceWorkflowsInsightsByCategory|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceWorkflowsInsightsByCategory>
     */
