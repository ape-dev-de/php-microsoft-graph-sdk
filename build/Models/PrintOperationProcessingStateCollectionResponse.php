...
/**
 * PrintOperationProcessingStateCollectionResponse - Collection response
 */
class PrintOperationProcessingStateCollectionResponse
{
    /**
     * @var array<int, PrintOperationProcessingState>
     */
    public array $value = [];
