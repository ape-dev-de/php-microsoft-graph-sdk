...
/**
 * Collection response for PrintOperationProcessingState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintOperationProcessingStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrintOperationProcessingState[]
     */
    private array $value = [];
     ...
     * 
     * @return PrintOperationProcessingState[]
     */
     ...
     * 
     * @param PrintOperationProcessingState[] $items
     * @return self
     */
    public function setValue(array|PrintOperationProcessingState $items, PrintOperationProcessingState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintOperationProcessingState> $value
     * @return self
     ...
     * 
     * @param PrintOperationProcessingState $item
     * @return self
     */
    public function addValue(PrintOperationProcessingState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintOperationProcessingState>
     */
