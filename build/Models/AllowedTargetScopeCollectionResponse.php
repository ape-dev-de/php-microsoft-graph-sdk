...
/**
 * Collection response for AllowedTargetScope
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AllowedTargetScopeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AllowedTargetScope[]
     */
    private array $value = [];
     ...
     * 
     * @param AllowedTargetScope[] $items
     * @return self
     */
    public function setValue(array|AllowedTargetScope $items, AllowedTargetScope ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AllowedTargetScope> $value
     * @return self
     ...
     * 
     * @param AllowedTargetScope $item
     * @return self
     */
    public function addValue(AllowedTargetScope $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AllowedTargetScope>
     */
