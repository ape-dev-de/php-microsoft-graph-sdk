...
/**
 * BaseCollectionPaginationCountResponseCollectionResponse - Collection response
 */
class BaseCollectionPaginationCountResponseCollectionResponse
{
    /**
     * @var array<int, BaseCollectionPaginationCountResponse>
     */
    public array $value = [];
