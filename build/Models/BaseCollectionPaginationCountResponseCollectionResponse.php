...
/**
 * Collection response for BaseCollectionPaginationCountResponse
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BaseCollectionPaginationCountResponseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BaseCollectionPaginationCountResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BaseCollectionPaginationCountResponse[] $items
     * @return self
     */
    public function setValue(array|BaseCollectionPaginationCountResponse $items, BaseCollectionPaginationCountResponse ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BaseCollectionPaginationCountResponse> $value
     * @return self
     ...
     * 
     * @param BaseCollectionPaginationCountResponse $item
     * @return self
     */
    public function addValue(BaseCollectionPaginationCountResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return BaseCollectionPaginationCountResponse|null
     */
     ...
     * 
     * @return \ArrayIterator<int, BaseCollectionPaginationCountResponse>
     */
