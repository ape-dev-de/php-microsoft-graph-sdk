...
/**
 * Collection response for SiteSecurityLevel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SiteSecurityLevelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SiteSecurityLevel[]
     */
    private array $value = [];
     ...
     * 
     * @param SiteSecurityLevel[] $items
     * @return self
     */
    public function setValue(array|SiteSecurityLevel $items, SiteSecurityLevel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SiteSecurityLevel> $value
     * @return self
     ...
     * 
     * @param SiteSecurityLevel $item
     * @return self
     */
    public function addValue(SiteSecurityLevel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SiteSecurityLevel>
     */
