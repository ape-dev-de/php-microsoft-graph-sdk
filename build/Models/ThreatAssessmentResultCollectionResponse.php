...
/**
 * Collection response for ThreatAssessmentResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ThreatAssessmentResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ThreatAssessmentResult[] $items
     * @return self
     */
    public function setValue(array|ThreatAssessmentResult $items, ThreatAssessmentResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ThreatAssessmentResult> $value
     * @return self
     ...
     * 
     * @param ThreatAssessmentResult $item
     * @return self
     */
    public function addValue(ThreatAssessmentResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ThreatAssessmentResult>
     */
