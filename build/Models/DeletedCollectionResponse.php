...
/**
 * Collection response for Deleted
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeletedCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Deleted[]
     */
     ...
     * @return self
     */
    public function setValue(array|Deleted $items, Deleted ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Deleted $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Deleted>
     */
