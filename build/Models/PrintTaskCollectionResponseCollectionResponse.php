...
/**
 * Collection response for PrintTaskCollectionResponse
 */
class PrintTaskCollectionResponseCollectionResponse
{
    /**
     * @var PrintTaskCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PrintTaskCollectionResponse ...$items Variable number of PrintTaskCollectionResponse items
     * @return self
     */
    public function setValue(PrintTaskCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PrintTaskCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PrintTaskCollectionResponse $item
     * @return self
     */
    public function addValue(PrintTaskCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
