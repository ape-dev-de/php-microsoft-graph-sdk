...
/**
 * Collection response for UserExperienceAnalyticsHealthState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsHealthStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserExperienceAnalyticsHealthState[]
     */
    private array $value = [];
     ...
     * 
     * @return UserExperienceAnalyticsHealthState[]
     */
     ...
     * 
     * @param UserExperienceAnalyticsHealthState[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsHealthState $items, UserExperienceAnalyticsHealthState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsHealthState> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsHealthState $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsHealthState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsHealthState>
     */
