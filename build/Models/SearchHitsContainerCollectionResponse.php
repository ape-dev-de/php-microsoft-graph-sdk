...
/**
 * Collection response for SearchHitsContainer
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SearchHitsContainerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SearchHitsContainer[] $items
     * @return self
     */
    public function setValue(array|SearchHitsContainer $items, SearchHitsContainer ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SearchHitsContainer> $value
     * @return self
     ...
     * 
     * @param SearchHitsContainer $item
     * @return self
     */
    public function addValue(SearchHitsContainer $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SearchHitsContainer|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SearchHitsContainer>
     */
