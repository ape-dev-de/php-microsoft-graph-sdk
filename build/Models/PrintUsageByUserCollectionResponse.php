...
/**
 * Collection response for PrintUsageByUser
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintUsageByUserCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PrintUsageByUser[] $items
     * @return self
     */
    public function setValue(array|PrintUsageByUser $items, PrintUsageByUser ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintUsageByUser> $value
     * @return self
     ...
     * 
     * @param PrintUsageByUser $item
     * @return self
     */
    public function addValue(PrintUsageByUser $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintUsageByUser>
     */
