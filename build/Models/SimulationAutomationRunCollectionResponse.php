...
/**
 * Collection response for SimulationAutomationRun
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SimulationAutomationRunCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SimulationAutomationRun[] $items
     * @return self
     */
    public function setValue(array|SimulationAutomationRun $items, SimulationAutomationRun ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SimulationAutomationRun> $value
     * @return self
     ...
     * 
     * @param SimulationAutomationRun $item
     * @return self
     */
    public function addValue(SimulationAutomationRun $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SimulationAutomationRun>
     */
