...
/**
 * Collection response for PartnersBillingBlob
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PartnersBillingBlobCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PartnersBillingBlob[] $items
     * @return self
     */
    public function setValue(array|PartnersBillingBlob $items, PartnersBillingBlob ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PartnersBillingBlob> $value
     * @return self
     ...
     * 
     * @param PartnersBillingBlob $item
     * @return self
     */
    public function addValue(PartnersBillingBlob $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PartnersBillingBlob|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PartnersBillingBlob>
     */
