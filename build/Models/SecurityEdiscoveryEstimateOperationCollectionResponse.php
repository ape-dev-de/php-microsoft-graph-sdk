...
/**
 * Collection response for SecurityEdiscoveryEstimateOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityEdiscoveryEstimateOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityEdiscoveryEstimateOperation[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityEdiscoveryEstimateOperation[] $items
     * @return self
     */
    public function setValue(array|SecurityEdiscoveryEstimateOperation $items, SecurityEdiscoveryEstimateOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityEdiscoveryEstimateOperation> $value
     * @return self
     ...
     * 
     * @param SecurityEdiscoveryEstimateOperation $item
     * @return self
     */
    public function addValue(SecurityEdiscoveryEstimateOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityEdiscoveryEstimateOperation>
     */
