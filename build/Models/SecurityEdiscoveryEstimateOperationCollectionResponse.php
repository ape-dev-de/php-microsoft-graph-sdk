...
/**
 * SecurityEdiscoveryEstimateOperationCollectionResponse - Collection response
 */
class SecurityEdiscoveryEstimateOperationCollectionResponse
{
    /**
     * @var array<int, SecurityEdiscoveryEstimateOperation>
     */
    public array $value = [];
