...
/**
 * Collection response for SecurityReportsRoot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityReportsRootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityReportsRoot[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityReportsRoot[] $items
     * @return self
     */
    public function setValue(array|SecurityReportsRoot $items, SecurityReportsRoot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityReportsRoot> $value
     * @return self
     ...
     * 
     * @param SecurityReportsRoot $item
     * @return self
     */
    public function addValue(SecurityReportsRoot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityReportsRoot>
     */
