...
/**
 * Collection response for CallRecordsWifiRadioType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsWifiRadioTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsWifiRadioType[]
     */
    private array $value = [];
     ...
     * 
     * @return CallRecordsWifiRadioType[]
     */
     ...
     * 
     * @param CallRecordsWifiRadioType[] $items
     * @return self
     */
    public function setValue(array|CallRecordsWifiRadioType $items, CallRecordsWifiRadioType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsWifiRadioType> $value
     * @return self
     ...
     * 
     * @param CallRecordsWifiRadioType $item
     * @return self
     */
    public function addValue(CallRecordsWifiRadioType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsWifiRadioType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsWifiRadioType>
     */
