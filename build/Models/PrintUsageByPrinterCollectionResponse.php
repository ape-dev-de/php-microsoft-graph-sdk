...
/**
 * Collection response for PrintUsageByPrinter
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintUsageByPrinterCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PrintUsageByPrinter[] $items
     * @return self
     */
    public function setValue(array|PrintUsageByPrinter $items, PrintUsageByPrinter ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintUsageByPrinter> $value
     * @return self
     ...
     * 
     * @param PrintUsageByPrinter $item
     * @return self
     */
    public function addValue(PrintUsageByPrinter $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintUsageByPrinter>
     */
