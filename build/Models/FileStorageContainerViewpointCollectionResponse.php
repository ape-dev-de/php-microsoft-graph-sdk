...
/**
 * Collection response for FileStorageContainerViewpoint
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FileStorageContainerViewpointCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FileStorageContainerViewpoint[]
     */
    private array $value = [];
     ...
     * 
     * @param FileStorageContainerViewpoint[] $items
     * @return self
     */
    public function setValue(array|FileStorageContainerViewpoint $items, FileStorageContainerViewpoint ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FileStorageContainerViewpoint> $value
     * @return self
     ...
     * 
     * @param FileStorageContainerViewpoint $item
     * @return self
     */
    public function addValue(FileStorageContainerViewpoint $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FileStorageContainerViewpoint>
     */
