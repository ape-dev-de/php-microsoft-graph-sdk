 ...
 */
class FileStorageContainerViewpointCollectionResponse
{
    /**
     ...
     * 
     * @param FileStorageContainerViewpoint ...$items Variable number of FileStorageContainerViewpoint items
     * @return self
     */
    public function setValue(FileStorageContainerViewpoint ...$items): self
    {
        $this->value = $items;
        return $this;
    }
