...
/**
 * Collection response for PartnersBillingManifestCollectionResponse
 */
class PartnersBillingManifestCollectionResponseCollectionResponse
{
    /**
     * @var PartnersBillingManifestCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PartnersBillingManifestCollectionResponse ...$items Variable number of PartnersBillingManifestCollectionResponse items
     * @return self
     */
    public function setValue(PartnersBillingManifestCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PartnersBillingManifestCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PartnersBillingManifestCollectionResponse $item
     * @return self
     */
    public function addValue(PartnersBillingManifestCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
