...
/**
 * Collection response for Fido2CombinationConfigurationCollectionResponse
 */
class Fido2CombinationConfigurationCollectionResponseCollectionResponse
{
    /**
     * @var Fido2CombinationConfigurationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param Fido2CombinationConfigurationCollectionResponse ...$items Variable number of Fido2CombinationConfigurationCollectionResponse items
     * @return self
     */
    public function setValue(Fido2CombinationConfigurationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<Fido2CombinationConfigurationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param Fido2CombinationConfigurationCollectionResponse $item
     * @return self
     */
    public function addValue(Fido2CombinationConfigurationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
