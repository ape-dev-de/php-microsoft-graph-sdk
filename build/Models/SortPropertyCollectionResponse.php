...
/**
 * Collection response for SortProperty
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SortPropertyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SortProperty[]
     */
     ...
     * 
     * @param SortProperty[] $items
     * @return self
     */
    public function setValue(array|SortProperty $items, SortProperty ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SortProperty> $value
     * @return self
     ...
     * 
     * @param SortProperty $item
     * @return self
     */
    public function addValue(SortProperty $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SortProperty>
     */
