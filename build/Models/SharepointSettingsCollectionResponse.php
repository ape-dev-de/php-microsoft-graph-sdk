...
/**
 * Collection response for SharepointSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SharepointSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SharepointSettings[] $items
     * @return self
     */
    public function setValue(array|SharepointSettings $items, SharepointSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SharepointSettings> $value
     * @return self
     ...
     * 
     * @param SharepointSettings $item
     * @return self
     */
    public function addValue(SharepointSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SharepointSettings>
     */
