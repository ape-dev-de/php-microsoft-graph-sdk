 ...
 */
class SharepointSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param SharepointSettings ...$items Variable number of SharepointSettings items
     * @return self
     */
    public function setValue(SharepointSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
