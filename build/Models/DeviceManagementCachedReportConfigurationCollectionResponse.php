...
/**
 * DeviceManagementCachedReportConfigurationCollectionResponse - Collection response
 */
class DeviceManagementCachedReportConfigurationCollectionResponse
{
    /**
     * @var array<int, DeviceManagementCachedReportConfiguration>
     */
    public array $value = [];
