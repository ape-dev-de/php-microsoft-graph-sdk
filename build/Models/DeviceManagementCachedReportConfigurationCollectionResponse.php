...
/**
 * Collection response for DeviceManagementCachedReportConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceManagementCachedReportConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceManagementCachedReportConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceManagementCachedReportConfiguration[] $items
     * @return self
     */
    public function setValue(array|DeviceManagementCachedReportConfiguration $items, DeviceManagementCachedReportConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceManagementCachedReportConfiguration> $value
     * @return self
     ...
     * 
     * @param DeviceManagementCachedReportConfiguration $item
     * @return self
     */
    public function addValue(DeviceManagementCachedReportConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return DeviceManagementCachedReportConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, DeviceManagementCachedReportConfiguration>
     */
