...
/**
 * Collection response for RestoreJobType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RestoreJobTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RestoreJobType[]
     */
     ...
     * 
     * @param RestoreJobType[] $items
     * @return self
     */
    public function setValue(array|RestoreJobType $items, RestoreJobType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RestoreJobType> $value
     * @return self
     ...
     * 
     * @param RestoreJobType $item
     * @return self
     */
    public function addValue(RestoreJobType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RestoreJobType>
     */
