...
/**
 * Collection response for SecurityEdiscoveryExportOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityEdiscoveryExportOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityEdiscoveryExportOperation[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityEdiscoveryExportOperation[]
     */
     ...
     * 
     * @param SecurityEdiscoveryExportOperation[] $items
     * @return self
     */
    public function setValue(array|SecurityEdiscoveryExportOperation $items, SecurityEdiscoveryExportOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityEdiscoveryExportOperation> $value
     * @return self
     ...
     * 
     * @param SecurityEdiscoveryExportOperation $item
     * @return self
     */
    public function addValue(SecurityEdiscoveryExportOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityEdiscoveryExportOperation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityEdiscoveryExportOperation>
     */
