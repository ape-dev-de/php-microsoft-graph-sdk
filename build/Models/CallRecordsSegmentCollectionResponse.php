...
/**
 * Collection response for CallRecordsSegment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsSegmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CallRecordsSegment[] $items
     * @return self
     */
    public function setValue(array|CallRecordsSegment $items, CallRecordsSegment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsSegment> $value
     * @return self
     ...
     * 
     * @param CallRecordsSegment $item
     * @return self
     */
    public function addValue(CallRecordsSegment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsSegment>
     */
