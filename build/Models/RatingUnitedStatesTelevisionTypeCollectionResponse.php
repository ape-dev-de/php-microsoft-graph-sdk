...
/**
 * RatingUnitedStatesTelevisionTypeCollectionResponse - Collection response
 */
class RatingUnitedStatesTelevisionTypeCollectionResponse
{
    /**
     * @var array<int, RatingUnitedStatesTelevisionType>
     */
    public array $value = [];
