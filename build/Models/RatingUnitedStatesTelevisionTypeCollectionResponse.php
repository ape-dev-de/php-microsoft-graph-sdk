...
/**
 * Collection response for RatingUnitedStatesTelevisionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RatingUnitedStatesTelevisionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RatingUnitedStatesTelevisionType[]
     */
    private array $value = [];
     ...
     * 
     * @return RatingUnitedStatesTelevisionType[]
     */
     ...
     * 
     * @param RatingUnitedStatesTelevisionType[] $items
     * @return self
     */
    public function setValue(array|RatingUnitedStatesTelevisionType $items, RatingUnitedStatesTelevisionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RatingUnitedStatesTelevisionType> $value
     * @return self
     ...
     * 
     * @param RatingUnitedStatesTelevisionType $item
     * @return self
     */
    public function addValue(RatingUnitedStatesTelevisionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RatingUnitedStatesTelevisionType>
     */
