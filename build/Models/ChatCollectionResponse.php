...
/**
 * Collection response for Chat
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Chat[]
     */
     ...
     * @return self
     */
    public function setValue(array|Chat $items, Chat ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Chat $item): self
    {
        $this->value[] = $item;
        return $this;
    }
