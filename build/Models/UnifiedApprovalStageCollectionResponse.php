...
/**
 * Collection response for UnifiedApprovalStage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedApprovalStageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UnifiedApprovalStage[] $items
     * @return self
     */
    public function setValue(array|UnifiedApprovalStage $items, UnifiedApprovalStage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedApprovalStage> $value
     * @return self
     ...
     * 
     * @param UnifiedApprovalStage $item
     * @return self
     */
    public function addValue(UnifiedApprovalStage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UnifiedApprovalStage|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UnifiedApprovalStage>
     */
