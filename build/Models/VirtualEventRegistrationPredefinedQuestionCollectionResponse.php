...
/**
 * Collection response for VirtualEventRegistrationPredefinedQuestion
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualEventRegistrationPredefinedQuestionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VirtualEventRegistrationPredefinedQuestion[]
     */
    private array $value = [];
     ...
     * 
     * @param VirtualEventRegistrationPredefinedQuestion[] $items
     * @return self
     */
    public function setValue(array|VirtualEventRegistrationPredefinedQuestion $items, VirtualEventRegistrationPredefinedQuestion ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualEventRegistrationPredefinedQuestion> $value
     * @return self
     ...
     * 
     * @param VirtualEventRegistrationPredefinedQuestion $item
     * @return self
     */
    public function addValue(VirtualEventRegistrationPredefinedQuestion $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return VirtualEventRegistrationPredefinedQuestion|null
     */
     ...
     * 
     * @return \ArrayIterator<int, VirtualEventRegistrationPredefinedQuestion>
     */
