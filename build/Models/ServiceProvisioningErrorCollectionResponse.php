...
/**
 * Collection response for ServiceProvisioningError
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServiceProvisioningErrorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ServiceProvisioningError[] $items
     * @return self
     */
    public function setValue(array|ServiceProvisioningError $items, ServiceProvisioningError ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServiceProvisioningError> $value
     * @return self
     ...
     * 
     * @param ServiceProvisioningError $item
     * @return self
     */
    public function addValue(ServiceProvisioningError $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ServiceProvisioningError|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ServiceProvisioningError>
     */
