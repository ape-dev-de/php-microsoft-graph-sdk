...
/**
 * Collection response for AndroidCustomConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AndroidCustomConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AndroidCustomConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param AndroidCustomConfiguration[] $items
     * @return self
     */
    public function setValue(array|AndroidCustomConfiguration $items, AndroidCustomConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AndroidCustomConfiguration> $value
     * @return self
     ...
     * 
     * @param AndroidCustomConfiguration $item
     * @return self
     */
    public function addValue(AndroidCustomConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AndroidCustomConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AndroidCustomConfiguration>
     */
