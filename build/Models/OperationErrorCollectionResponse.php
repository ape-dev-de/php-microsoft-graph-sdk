...
/**
 * Collection response for OperationError
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OperationErrorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OperationError[]
     */
     ...
     * 
     * @param OperationError[] $items
     * @return self
     */
    public function setValue(array|OperationError $items, OperationError ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OperationError> $value
     * @return self
     ...
     * 
     * @param OperationError $item
     * @return self
     */
    public function addValue(OperationError $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OperationError>
     */
