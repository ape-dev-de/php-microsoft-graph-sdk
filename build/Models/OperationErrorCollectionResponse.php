 ...
 */
class OperationErrorCollectionResponse
{
    /**
     * @var OperationError[]
     */
     ...
     * 
     * @param OperationError ...$items Variable number of OperationError items
     * @return self
     */
    public function setValue(OperationError ...$items): self
    {
        $this->value = $items;
        return $this;
    }
