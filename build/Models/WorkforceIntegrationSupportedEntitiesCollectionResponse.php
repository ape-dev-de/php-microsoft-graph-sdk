...
/**
 * WorkforceIntegrationSupportedEntitiesCollectionResponse - Collection response
 */
class WorkforceIntegrationSupportedEntitiesCollectionResponse
{
    /**
     * @var array<int, WorkforceIntegrationSupportedEntities>
     */
    public array $value = [];
