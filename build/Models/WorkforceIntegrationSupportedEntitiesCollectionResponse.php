...
/**
 * Collection response for WorkforceIntegrationSupportedEntities
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkforceIntegrationSupportedEntitiesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkforceIntegrationSupportedEntities[]
     */
    private array $value = [];
     ...
     * 
     * @return WorkforceIntegrationSupportedEntities[]
     */
     ...
     * 
     * @param WorkforceIntegrationSupportedEntities[] $items
     * @return self
     */
    public function setValue(array|WorkforceIntegrationSupportedEntities $items, WorkforceIntegrationSupportedEntities ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkforceIntegrationSupportedEntities> $value
     * @return self
     ...
     * 
     * @param WorkforceIntegrationSupportedEntities $item
     * @return self
     */
    public function addValue(WorkforceIntegrationSupportedEntities $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkforceIntegrationSupportedEntities>
     */
