 ...
 */
class SecurityContainerRegistryEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityContainerRegistryEvidence ...$items Variable number of SecurityContainerRegistryEvidence items
     * @return self
     */
    public function setValue(SecurityContainerRegistryEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
