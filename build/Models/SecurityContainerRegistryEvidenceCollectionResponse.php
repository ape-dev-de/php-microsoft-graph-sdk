...
/**
 * Collection response for SecurityContainerRegistryEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityContainerRegistryEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityContainerRegistryEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityContainerRegistryEvidence[]
     */
     ...
     * 
     * @param SecurityContainerRegistryEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityContainerRegistryEvidence $items, SecurityContainerRegistryEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityContainerRegistryEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityContainerRegistryEvidence $item
     * @return self
     */
    public function addValue(SecurityContainerRegistryEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityContainerRegistryEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityContainerRegistryEvidence>
     */
