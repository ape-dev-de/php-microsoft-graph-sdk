...
/**
 * Collection response for CalendarSharingActionImportance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CalendarSharingActionImportanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CalendarSharingActionImportance[]
     */
    private array $value = [];
     ...
     * 
     * @return CalendarSharingActionImportance[]
     */
     ...
     * 
     * @param CalendarSharingActionImportance[] $items
     * @return self
     */
    public function setValue(array|CalendarSharingActionImportance $items, CalendarSharingActionImportance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CalendarSharingActionImportance> $value
     * @return self
     ...
     * 
     * @param CalendarSharingActionImportance $item
     * @return self
     */
    public function addValue(CalendarSharingActionImportance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CalendarSharingActionImportance>
     */
