...
/**
 * CalendarSharingActionImportanceCollectionResponse - Collection response
 */
class CalendarSharingActionImportanceCollectionResponse
{
    /**
     * @var array<int, CalendarSharingActionImportance>
     */
    public array $value = [];
