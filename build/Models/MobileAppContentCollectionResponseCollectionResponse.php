...
/**
 * Collection response for MobileAppContentCollectionResponse
 */
class MobileAppContentCollectionResponseCollectionResponse
{
    /**
     * @var MobileAppContentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MobileAppContentCollectionResponse ...$items Variable number of MobileAppContentCollectionResponse items
     * @return self
     */
    public function setValue(MobileAppContentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MobileAppContentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MobileAppContentCollectionResponse $item
     * @return self
     */
    public function addValue(MobileAppContentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
