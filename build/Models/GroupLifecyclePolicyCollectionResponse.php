...
/**
 * Collection response for GroupLifecyclePolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class GroupLifecyclePolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param GroupLifecyclePolicy[] $items
     * @return self
     */
    public function setValue(array|GroupLifecyclePolicy $items, GroupLifecyclePolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<GroupLifecyclePolicy> $value
     * @return self
     ...
     * 
     * @param GroupLifecyclePolicy $item
     * @return self
     */
    public function addValue(GroupLifecyclePolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, GroupLifecyclePolicy>
     */
