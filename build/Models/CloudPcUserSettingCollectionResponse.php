...
/**
 * Collection response for CloudPcUserSetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcUserSettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CloudPcUserSetting[] $items
     * @return self
     */
    public function setValue(array|CloudPcUserSetting $items, CloudPcUserSetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcUserSetting> $value
     * @return self
     ...
     * 
     * @param CloudPcUserSetting $item
     * @return self
     */
    public function addValue(CloudPcUserSetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcUserSetting>
     */
