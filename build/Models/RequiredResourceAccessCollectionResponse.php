...
/**
 * Collection response for RequiredResourceAccess
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RequiredResourceAccessCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param RequiredResourceAccess[] $items
     * @return self
     */
    public function setValue(array|RequiredResourceAccess $items, RequiredResourceAccess ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RequiredResourceAccess> $value
     * @return self
     ...
     * 
     * @param RequiredResourceAccess $item
     * @return self
     */
    public function addValue(RequiredResourceAccess $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return RequiredResourceAccess|null
     */
     ...
     * 
     * @return \ArrayIterator<int, RequiredResourceAccess>
     */
