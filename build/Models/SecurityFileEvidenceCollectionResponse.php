...
/**
 * Collection response for SecurityFileEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityFileEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityFileEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityFileEvidence $items, SecurityFileEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityFileEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityFileEvidence $item
     * @return self
     */
    public function addValue(SecurityFileEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityFileEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityFileEvidence>
     */
