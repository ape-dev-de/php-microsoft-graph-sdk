...
/**
 * Collection response for MacOSGeneralDeviceConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MacOSGeneralDeviceConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MacOSGeneralDeviceConfiguration[] $items
     * @return self
     */
    public function setValue(array|MacOSGeneralDeviceConfiguration $items, MacOSGeneralDeviceConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MacOSGeneralDeviceConfiguration> $value
     * @return self
     ...
     * 
     * @param MacOSGeneralDeviceConfiguration $item
     * @return self
     */
    public function addValue(MacOSGeneralDeviceConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MacOSGeneralDeviceConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MacOSGeneralDeviceConfiguration>
     */
