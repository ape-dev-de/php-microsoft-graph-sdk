...
/**
 * Collection response for ListItemVersion
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ListItemVersionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ListItemVersion[]
     */
     ...
     * 
     * @param ListItemVersion[] $items
     * @return self
     */
    public function setValue(array|ListItemVersion $items, ListItemVersion ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ListItemVersion> $value
     * @return self
     ...
     * 
     * @param ListItemVersion $item
     * @return self
     */
    public function addValue(ListItemVersion $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ListItemVersion>
     */
