...
/**
 * Collection response for DirectoryRoleCollectionResponse
 */
class DirectoryRoleCollectionResponseCollectionResponse
{
    /**
     * @var DirectoryRoleCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DirectoryRoleCollectionResponse ...$items Variable number of DirectoryRoleCollectionResponse items
     * @return self
     */
    public function setValue(DirectoryRoleCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DirectoryRoleCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DirectoryRoleCollectionResponse $item
     * @return self
     */
    public function addValue(DirectoryRoleCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
