...
/**
 * Collection response for ServiceAppStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServiceAppStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ServiceAppStatus[]
     */
    private array $value = [];
     ...
     * 
     * @param ServiceAppStatus[] $items
     * @return self
     */
    public function setValue(array|ServiceAppStatus $items, ServiceAppStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServiceAppStatus> $value
     * @return self
     ...
     * 
     * @param ServiceAppStatus $item
     * @return self
     */
    public function addValue(ServiceAppStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ServiceAppStatus>
     */
