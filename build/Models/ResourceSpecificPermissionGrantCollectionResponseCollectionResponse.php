...
/**
 * Collection response for ResourceSpecificPermissionGrantCollectionResponse
 */
class ResourceSpecificPermissionGrantCollectionResponseCollectionResponse
{
    /**
     * @var ResourceSpecificPermissionGrantCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ResourceSpecificPermissionGrantCollectionResponse ...$items Variable number of ResourceSpecificPermissionGrantCollectionResponse items
     * @return self
     */
    public function setValue(ResourceSpecificPermissionGrantCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ResourceSpecificPermissionGrantCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ResourceSpecificPermissionGrantCollectionResponse $item
     * @return self
     */
    public function addValue(ResourceSpecificPermissionGrantCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
