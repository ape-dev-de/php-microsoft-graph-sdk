...
/**
 * Collection response for CallRecordingStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordingStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordingStatus[]
     */
    private array $value = [];
     ...
     * 
     * @param CallRecordingStatus[] $items
     * @return self
     */
    public function setValue(array|CallRecordingStatus $items, CallRecordingStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordingStatus> $value
     * @return self
     ...
     * 
     * @param CallRecordingStatus $item
     * @return self
     */
    public function addValue(CallRecordingStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CallRecordingStatus>
     */
