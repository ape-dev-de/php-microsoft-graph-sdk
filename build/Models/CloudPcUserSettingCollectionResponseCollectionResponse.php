...
/**
 * Collection response for CloudPcUserSettingCollectionResponse
 */
class CloudPcUserSettingCollectionResponseCollectionResponse
{
    /**
     * @var CloudPcUserSettingCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudPcUserSettingCollectionResponse ...$items Variable number of CloudPcUserSettingCollectionResponse items
     * @return self
     */
    public function setValue(CloudPcUserSettingCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CloudPcUserSettingCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CloudPcUserSettingCollectionResponse $item
     * @return self
     */
    public function addValue(CloudPcUserSettingCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
