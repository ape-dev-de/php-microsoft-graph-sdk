...
/**
 * Collection response for SecurityUserSource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityUserSourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityUserSource[] $items
     * @return self
     */
    public function setValue(array|SecurityUserSource $items, SecurityUserSource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityUserSource> $value
     * @return self
     ...
     * 
     * @param SecurityUserSource $item
     * @return self
     */
    public function addValue(SecurityUserSource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityUserSource>
     */
