...
/**
 * Collection response for RecommendedActionCollectionResponse
 */
class RecommendedActionCollectionResponseCollectionResponse
{
    /**
     * @var RecommendedActionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RecommendedActionCollectionResponse ...$items Variable number of RecommendedActionCollectionResponse items
     * @return self
     */
    public function setValue(RecommendedActionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RecommendedActionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RecommendedActionCollectionResponse $item
     * @return self
     */
    public function addValue(RecommendedActionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
