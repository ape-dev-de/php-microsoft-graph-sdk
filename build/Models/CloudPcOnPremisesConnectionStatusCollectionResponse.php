...
/**
 * CloudPcOnPremisesConnectionStatusCollectionResponse - Collection response
 */
class CloudPcOnPremisesConnectionStatusCollectionResponse
{
    /**
     * @var array<int, CloudPcOnPremisesConnectionStatus>
     */
    public array $value = [];
