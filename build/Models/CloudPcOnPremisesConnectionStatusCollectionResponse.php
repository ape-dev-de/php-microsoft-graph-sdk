...
/**
 * Collection response for CloudPcOnPremisesConnectionStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcOnPremisesConnectionStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudPcOnPremisesConnectionStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return CloudPcOnPremisesConnectionStatus[]
     */
     ...
     * 
     * @param CloudPcOnPremisesConnectionStatus[] $items
     * @return self
     */
    public function setValue(array|CloudPcOnPremisesConnectionStatus $items, CloudPcOnPremisesConnectionStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcOnPremisesConnectionStatus> $value
     * @return self
     ...
     * 
     * @param CloudPcOnPremisesConnectionStatus $item
     * @return self
     */
    public function addValue(CloudPcOnPremisesConnectionStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcOnPremisesConnectionStatus>
     */
