...
/**
 * Collection response for SynchronizationProgress
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationProgressCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SynchronizationProgress[] $items
     * @return self
     */
    public function setValue(array|SynchronizationProgress $items, SynchronizationProgress ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SynchronizationProgress> $value
     * @return self
     ...
     * 
     * @param SynchronizationProgress $item
     * @return self
     */
    public function addValue(SynchronizationProgress $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SynchronizationProgress|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SynchronizationProgress>
     */
