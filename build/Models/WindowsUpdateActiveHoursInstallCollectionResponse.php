...
/**
 * Collection response for WindowsUpdateActiveHoursInstall
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsUpdateActiveHoursInstallCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsUpdateActiveHoursInstall[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsUpdateActiveHoursInstall[] $items
     * @return self
     */
    public function setValue(array|WindowsUpdateActiveHoursInstall $items, WindowsUpdateActiveHoursInstall ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsUpdateActiveHoursInstall> $value
     * @return self
     ...
     * 
     * @param WindowsUpdateActiveHoursInstall $item
     * @return self
     */
    public function addValue(WindowsUpdateActiveHoursInstall $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WindowsUpdateActiveHoursInstall|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WindowsUpdateActiveHoursInstall>
     */
