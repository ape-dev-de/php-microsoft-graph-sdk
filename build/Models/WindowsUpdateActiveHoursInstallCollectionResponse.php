 ...
 */
class WindowsUpdateActiveHoursInstallCollectionResponse
{
    /**
     ...
     * 
     * @param WindowsUpdateActiveHoursInstall ...$items Variable number of WindowsUpdateActiveHoursInstall items
     * @return self
     */
    public function setValue(WindowsUpdateActiveHoursInstall ...$items): self
    {
        $this->value = $items;
        return $this;
    }
