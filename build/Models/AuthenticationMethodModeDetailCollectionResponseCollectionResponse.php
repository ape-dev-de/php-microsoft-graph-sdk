...
/**
 * Collection response for AuthenticationMethodModeDetailCollectionResponse
 */
class AuthenticationMethodModeDetailCollectionResponseCollectionResponse
{
    /**
     * @var AuthenticationMethodModeDetailCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AuthenticationMethodModeDetailCollectionResponse ...$items Variable number of AuthenticationMethodModeDetailCollectionResponse items
     * @return self
     */
    public function setValue(AuthenticationMethodModeDetailCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AuthenticationMethodModeDetailCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AuthenticationMethodModeDetailCollectionResponse $item
     * @return self
     */
    public function addValue(AuthenticationMethodModeDetailCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
