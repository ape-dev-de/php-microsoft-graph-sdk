...
/**
 * Collection response for TermStoreLocalizedDescription
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TermStoreLocalizedDescriptionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return TermStoreLocalizedDescription[]
     */
     ...
     * 
     * @param TermStoreLocalizedDescription[] $items
     * @return self
     */
    public function setValue(array|TermStoreLocalizedDescription $items, TermStoreLocalizedDescription ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TermStoreLocalizedDescription> $value
     * @return self
     ...
     * 
     * @param TermStoreLocalizedDescription $item
     * @return self
     */
    public function addValue(TermStoreLocalizedDescription $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TermStoreLocalizedDescription|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TermStoreLocalizedDescription>
     */
