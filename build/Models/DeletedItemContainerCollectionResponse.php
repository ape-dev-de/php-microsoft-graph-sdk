...
/**
 * Collection response for DeletedItemContainer
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeletedItemContainerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeletedItemContainer[]
     */
    private array $value = [];
     ...
     * 
     * @param DeletedItemContainer[] $items
     * @return self
     */
    public function setValue(array|DeletedItemContainer $items, DeletedItemContainer ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeletedItemContainer> $value
     * @return self
     ...
     * 
     * @param DeletedItemContainer $item
     * @return self
     */
    public function addValue(DeletedItemContainer $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeletedItemContainer>
     */
