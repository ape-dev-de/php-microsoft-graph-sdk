 ...
 */
class DeletedItemContainerCollectionResponse
{
    /**
     ...
     * 
     * @param DeletedItemContainer ...$items Variable number of DeletedItemContainer items
     * @return self
     */
    public function setValue(DeletedItemContainer ...$items): self
    {
        $this->value = $items;
        return $this;
    }
