...
/**
 * Collection response for TeamsTabCollectionResponse
 */
class TeamsTabCollectionResponseCollectionResponse
{
    /**
     * @var TeamsTabCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamsTabCollectionResponse ...$items Variable number of TeamsTabCollectionResponse items
     * @return self
     */
    public function setValue(TeamsTabCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TeamsTabCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TeamsTabCollectionResponse $item
     * @return self
     */
    public function addValue(TeamsTabCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
