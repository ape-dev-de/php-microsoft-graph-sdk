...
/**
 * Collection response for InsightValueInt
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InsightValueIntCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var InsightValueInt[]
     */
     ...
     * 
     * @param InsightValueInt[] $items
     * @return self
     */
    public function setValue(array|InsightValueInt $items, InsightValueInt ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InsightValueInt> $value
     * @return self
     ...
     * 
     * @param InsightValueInt $item
     * @return self
     */
    public function addValue(InsightValueInt $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, InsightValueInt>
     */
