 ...
 */
class InsightValueIntCollectionResponse
{
    /**
     * @var InsightValueInt[]
     */
     ...
     * 
     * @param InsightValueInt ...$items Variable number of InsightValueInt items
     * @return self
     */
    public function setValue(InsightValueInt ...$items): self
    {
        $this->value = $items;
        return $this;
    }
