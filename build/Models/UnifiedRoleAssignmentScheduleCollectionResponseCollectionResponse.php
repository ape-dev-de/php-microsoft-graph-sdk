...
/**
 * Collection response for UnifiedRoleAssignmentScheduleCollectionResponse
 */
class UnifiedRoleAssignmentScheduleCollectionResponseCollectionResponse
{
    /**
     * @var UnifiedRoleAssignmentScheduleCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedRoleAssignmentScheduleCollectionResponse ...$items Variable number of UnifiedRoleAssignmentScheduleCollectionResponse items
     * @return self
     */
    public function setValue(UnifiedRoleAssignmentScheduleCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UnifiedRoleAssignmentScheduleCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleAssignmentScheduleCollectionResponse $item
     * @return self
     */
    public function addValue(UnifiedRoleAssignmentScheduleCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
