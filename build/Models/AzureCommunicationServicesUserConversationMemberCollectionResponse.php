...
/**
 * Collection response for AzureCommunicationServicesUserConversationMember
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AzureCommunicationServicesUserConversationMemberCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AzureCommunicationServicesUserConversationMember[]
     */
    private array $value = [];
     ...
     * 
     * @param AzureCommunicationServicesUserConversationMember[] $items
     * @return self
     */
    public function setValue(array|AzureCommunicationServicesUserConversationMember $items, AzureCommunicationServicesUserConversationMember ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AzureCommunicationServicesUserConversationMember> $value
     * @return self
     ...
     * 
     * @param AzureCommunicationServicesUserConversationMember $item
     * @return self
     */
    public function addValue(AzureCommunicationServicesUserConversationMember $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AzureCommunicationServicesUserConversationMember|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AzureCommunicationServicesUserConversationMember>
     */
