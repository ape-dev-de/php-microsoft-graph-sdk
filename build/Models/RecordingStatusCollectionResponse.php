...
/**
 * Collection response for RecordingStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RecordingStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RecordingStatus[]
     */
     ...
     * 
     * @param RecordingStatus[] $items
     * @return self
     */
    public function setValue(array|RecordingStatus $items, RecordingStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RecordingStatus> $value
     * @return self
     ...
     * 
     * @param RecordingStatus $item
     * @return self
     */
    public function addValue(RecordingStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RecordingStatus>
     */
