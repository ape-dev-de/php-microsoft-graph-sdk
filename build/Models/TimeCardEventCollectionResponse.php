 ...
 */
class TimeCardEventCollectionResponse
{
    /**
     * @var TimeCardEvent[]
     */
     ...
     * 
     * @param TimeCardEvent ...$items Variable number of TimeCardEvent items
     * @return self
     */
    public function setValue(TimeCardEvent ...$items): self
    {
        $this->value = $items;
        return $this;
    }
