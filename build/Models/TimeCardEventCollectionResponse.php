...
/**
 * Collection response for TimeCardEvent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TimeCardEventCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TimeCardEvent[]
     */
     ...
     * 
     * @param TimeCardEvent[] $items
     * @return self
     */
    public function setValue(array|TimeCardEvent $items, TimeCardEvent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TimeCardEvent> $value
     * @return self
     ...
     * 
     * @param TimeCardEvent $item
     * @return self
     */
    public function addValue(TimeCardEvent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TimeCardEvent>
     */
