...
/**
 * Collection response for StartHoldMusicOperationCollectionResponse
 */
class StartHoldMusicOperationCollectionResponseCollectionResponse
{
    /**
     * @var StartHoldMusicOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param StartHoldMusicOperationCollectionResponse ...$items Variable number of StartHoldMusicOperationCollectionResponse items
     * @return self
     */
    public function setValue(StartHoldMusicOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<StartHoldMusicOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param StartHoldMusicOperationCollectionResponse $item
     * @return self
     */
    public function addValue(StartHoldMusicOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
