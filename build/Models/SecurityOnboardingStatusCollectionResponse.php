...
/**
 * Collection response for SecurityOnboardingStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityOnboardingStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityOnboardingStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityOnboardingStatus[]
     */
     ...
     * 
     * @param SecurityOnboardingStatus[] $items
     * @return self
     */
    public function setValue(array|SecurityOnboardingStatus $items, SecurityOnboardingStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityOnboardingStatus> $value
     * @return self
     ...
     * 
     * @param SecurityOnboardingStatus $item
     * @return self
     */
    public function addValue(SecurityOnboardingStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityOnboardingStatus|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityOnboardingStatus>
     */
