...
/**
 * Collection response for ExtensionProperty
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExtensionPropertyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ExtensionProperty[] $items
     * @return self
     */
    public function setValue(array|ExtensionProperty $items, ExtensionProperty ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExtensionProperty> $value
     * @return self
     ...
     * 
     * @param ExtensionProperty $item
     * @return self
     */
    public function addValue(ExtensionProperty $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ExtensionProperty>
     */
