...
/**
 * Collection response for SecurityEdiscoveryCaseSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityEdiscoveryCaseSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityEdiscoveryCaseSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityEdiscoveryCaseSettings[] $items
     * @return self
     */
    public function setValue(array|SecurityEdiscoveryCaseSettings $items, SecurityEdiscoveryCaseSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityEdiscoveryCaseSettings> $value
     * @return self
     ...
     * 
     * @param SecurityEdiscoveryCaseSettings $item
     * @return self
     */
    public function addValue(SecurityEdiscoveryCaseSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityEdiscoveryCaseSettings>
     */
