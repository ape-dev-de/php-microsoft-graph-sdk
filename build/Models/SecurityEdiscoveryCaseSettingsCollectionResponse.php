 ...
 */
class SecurityEdiscoveryCaseSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityEdiscoveryCaseSettings ...$items Variable number of SecurityEdiscoveryCaseSettings items
     * @return self
     */
    public function setValue(SecurityEdiscoveryCaseSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
