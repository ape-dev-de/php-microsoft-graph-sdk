 ...
 */
class OnPremisesAccidentalDeletionPreventionCollectionResponse
{
    /**
     ...
     * 
     * @param OnPremisesAccidentalDeletionPrevention ...$items Variable number of OnPremisesAccidentalDeletionPrevention items
     * @return self
     */
    public function setValue(OnPremisesAccidentalDeletionPrevention ...$items): self
    {
        $this->value = $items;
        return $this;
    }
