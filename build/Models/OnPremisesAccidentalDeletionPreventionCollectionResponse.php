...
/**
 * Collection response for OnPremisesAccidentalDeletionPrevention
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnPremisesAccidentalDeletionPreventionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnPremisesAccidentalDeletionPrevention[]
     */
    private array $value = [];
     ...
     * 
     * @param OnPremisesAccidentalDeletionPrevention[] $items
     * @return self
     */
    public function setValue(array|OnPremisesAccidentalDeletionPrevention $items, OnPremisesAccidentalDeletionPrevention ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnPremisesAccidentalDeletionPrevention> $value
     * @return self
     ...
     * 
     * @param OnPremisesAccidentalDeletionPrevention $item
     * @return self
     */
    public function addValue(OnPremisesAccidentalDeletionPrevention $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnPremisesAccidentalDeletionPrevention>
     */
