...
/**
 * Collection response for SecurityHostPortStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHostPortStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityHostPortStatus[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityHostPortStatus[] $items
     * @return self
     */
    public function setValue(array|SecurityHostPortStatus $items, SecurityHostPortStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHostPortStatus> $value
     * @return self
     ...
     * 
     * @param SecurityHostPortStatus $item
     * @return self
     */
    public function addValue(SecurityHostPortStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityHostPortStatus|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityHostPortStatus>
     */
