...
/**
 * Collection response for IpNamedLocationCollectionResponse
 */
class IpNamedLocationCollectionResponseCollectionResponse
{
    /**
     * @var IpNamedLocationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IpNamedLocationCollectionResponse ...$items Variable number of IpNamedLocationCollectionResponse items
     * @return self
     */
    public function setValue(IpNamedLocationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IpNamedLocationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IpNamedLocationCollectionResponse $item
     * @return self
     */
    public function addValue(IpNamedLocationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
