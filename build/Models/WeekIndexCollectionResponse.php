...
/**
 * Collection response for WeekIndex
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WeekIndexCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WeekIndex[]
     */
     ...
     * 
     * @param WeekIndex[] $items
     * @return self
     */
    public function setValue(array|WeekIndex $items, WeekIndex ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param WeekIndex $item
     * @return self
     */
    public function addValue(WeekIndex $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WeekIndex>
     */
