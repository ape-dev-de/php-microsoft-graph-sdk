...
/**
 * Collection response for WindowsInformationProtectionAppLearningSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsInformationProtectionAppLearningSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WindowsInformationProtectionAppLearningSummary[] $items
     * @return self
     */
    public function setValue(array|WindowsInformationProtectionAppLearningSummary $items, WindowsInformationProtectionAppLearningSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsInformationProtectionAppLearningSummary> $value
     * @return self
     ...
     * 
     * @param WindowsInformationProtectionAppLearningSummary $item
     * @return self
     */
    public function addValue(WindowsInformationProtectionAppLearningSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsInformationProtectionAppLearningSummary>
     */
