...
/**
 * Collection response for PrintTaskTrigger
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintTaskTriggerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PrintTaskTrigger[] $items
     * @return self
     */
    public function setValue(array|PrintTaskTrigger $items, PrintTaskTrigger ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintTaskTrigger> $value
     * @return self
     ...
     * 
     * @param PrintTaskTrigger $item
     * @return self
     */
    public function addValue(PrintTaskTrigger $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintTaskTrigger>
     */
