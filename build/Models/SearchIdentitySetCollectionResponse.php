...
/**
 * Collection response for SearchIdentitySet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SearchIdentitySetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SearchIdentitySet[]
     */
    private array $value = [];
     ...
     * 
     * @param SearchIdentitySet[] $items
     * @return self
     */
    public function setValue(array|SearchIdentitySet $items, SearchIdentitySet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SearchIdentitySet> $value
     * @return self
     ...
     * 
     * @param SearchIdentitySet $item
     * @return self
     */
    public function addValue(SearchIdentitySet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SearchIdentitySet>
     */
