 ...
 */
class SearchIdentitySetCollectionResponse
{
    /**
     ...
     * 
     * @param SearchIdentitySet ...$items Variable number of SearchIdentitySet items
     * @return self
     */
    public function setValue(SearchIdentitySet ...$items): self
    {
        $this->value = $items;
        return $this;
    }
