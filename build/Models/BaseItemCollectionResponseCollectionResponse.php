...
/**
 * Collection response for BaseItemCollectionResponse
 */
class BaseItemCollectionResponseCollectionResponse
{
    /**
     * @var BaseItemCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BaseItemCollectionResponse ...$items Variable number of BaseItemCollectionResponse items
     * @return self
     */
    public function setValue(BaseItemCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<BaseItemCollectionResponse> $value
     * @return self
     ...
     * 
     * @param BaseItemCollectionResponse $item
     * @return self
     */
    public function addValue(BaseItemCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
