...
/**
 * Collection response for ExternalConnectorsAccessType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsAccessTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalConnectorsAccessType[]
     */
    private array $value = [];
     ...
     * 
     * @return ExternalConnectorsAccessType[]
     */
     ...
     * 
     * @param ExternalConnectorsAccessType[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsAccessType $items, ExternalConnectorsAccessType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsAccessType> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsAccessType $item
     * @return self
     */
    public function addValue(ExternalConnectorsAccessType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalConnectorsAccessType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsAccessType>
     */
