...
/**
 * ExternalConnectorsAccessTypeCollectionResponse - Collection response
 */
class ExternalConnectorsAccessTypeCollectionResponse
{
    /**
     * @var array<int, ExternalConnectorsAccessType>
     */
    public array $value = [];
