...
/**
 * Collection response for WindowsUpdateType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsUpdateTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsUpdateType[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsUpdateType[] $items
     * @return self
     */
    public function setValue(array|WindowsUpdateType $items, WindowsUpdateType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsUpdateType> $value
     * @return self
     ...
     * 
     * @param WindowsUpdateType $item
     * @return self
     */
    public function addValue(WindowsUpdateType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsUpdateType>
     */
