...
/**
 * Collection response for EntitlementManagementSchedule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EntitlementManagementScheduleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EntitlementManagementSchedule[]
     */
    private array $value = [];
     ...
     * 
     * @param EntitlementManagementSchedule[] $items
     * @return self
     */
    public function setValue(array|EntitlementManagementSchedule $items, EntitlementManagementSchedule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EntitlementManagementSchedule> $value
     * @return self
     ...
     * 
     * @param EntitlementManagementSchedule $item
     * @return self
     */
    public function addValue(EntitlementManagementSchedule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EntitlementManagementSchedule>
     */
