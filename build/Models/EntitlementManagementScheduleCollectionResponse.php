 ...
 */
class EntitlementManagementScheduleCollectionResponse
{
    /**
     ...
     * 
     * @param EntitlementManagementSchedule ...$items Variable number of EntitlementManagementSchedule items
     * @return self
     */
    public function setValue(EntitlementManagementSchedule ...$items): self
    {
        $this->value = $items;
        return $this;
    }
