 ...
 */
class StaffAvailabilityItemCollectionResponse
{
    /**
     ...
     * 
     * @param StaffAvailabilityItem ...$items Variable number of StaffAvailabilityItem items
     * @return self
     */
    public function setValue(StaffAvailabilityItem ...$items): self
    {
        $this->value = $items;
        return $this;
    }
