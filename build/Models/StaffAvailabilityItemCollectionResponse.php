...
/**
 * Collection response for StaffAvailabilityItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class StaffAvailabilityItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var StaffAvailabilityItem[]
     */
    private array $value = [];
     ...
     * 
     * @param StaffAvailabilityItem[] $items
     * @return self
     */
    public function setValue(array|StaffAvailabilityItem $items, StaffAvailabilityItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<StaffAvailabilityItem> $value
     * @return self
     ...
     * 
     * @param StaffAvailabilityItem $item
     * @return self
     */
    public function addValue(StaffAvailabilityItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return StaffAvailabilityItem|null
     */
     ...
     * 
     * @return \ArrayIterator<int, StaffAvailabilityItem>
     */
