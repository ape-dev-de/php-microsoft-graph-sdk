...
/**
 * Collection response for SynchronizationJob
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationJobCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SynchronizationJob[] $items
     * @return self
     */
    public function setValue(array|SynchronizationJob $items, SynchronizationJob ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SynchronizationJob> $value
     * @return self
     ...
     * 
     * @param SynchronizationJob $item
     * @return self
     */
    public function addValue(SynchronizationJob $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SynchronizationJob>
     */
