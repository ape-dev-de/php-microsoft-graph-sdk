...
/**
 * Collection response for TermStoreStore
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TermStoreStoreCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TermStoreStore[]
     */
     ...
     * 
     * @param TermStoreStore[] $items
     * @return self
     */
    public function setValue(array|TermStoreStore $items, TermStoreStore ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TermStoreStore> $value
     * @return self
     ...
     * 
     * @param TermStoreStore $item
     * @return self
     */
    public function addValue(TermStoreStore $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TermStoreStore>
     */
