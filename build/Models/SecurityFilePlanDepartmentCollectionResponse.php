...
/**
 * Collection response for SecurityFilePlanDepartment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityFilePlanDepartmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityFilePlanDepartment[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityFilePlanDepartment[]
     */
     ...
     * 
     * @param SecurityFilePlanDepartment[] $items
     * @return self
     */
    public function setValue(array|SecurityFilePlanDepartment $items, SecurityFilePlanDepartment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityFilePlanDepartment> $value
     * @return self
     ...
     * 
     * @param SecurityFilePlanDepartment $item
     * @return self
     */
    public function addValue(SecurityFilePlanDepartment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityFilePlanDepartment|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityFilePlanDepartment>
     */
