...
/**
 * SecurityFilePlanDepartmentCollectionResponse - Collection response
 */
class SecurityFilePlanDepartmentCollectionResponse
{
    /**
     * @var array<int, SecurityFilePlanDepartment>
     */
    public array $value = [];
