...
/**
 * ChatMessagePolicyViolationVerdictDetailsTypesCollectionResponse - Collection response
 */
class ChatMessagePolicyViolationVerdictDetailsTypesCollectionResponse
{
    /**
     * @var array<int, ChatMessagePolicyViolationVerdictDetailsTypes>
     */
    public array $value = [];
