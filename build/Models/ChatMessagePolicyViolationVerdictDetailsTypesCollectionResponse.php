...
/**
 * Collection response for ChatMessagePolicyViolationVerdictDetailsTypes
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatMessagePolicyViolationVerdictDetailsTypesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return ChatMessagePolicyViolationVerdictDetailsTypes[]
     */
     ...
     * 
     * @param ChatMessagePolicyViolationVerdictDetailsTypes[] $items
     * @return self
     */
    public function setValue(array|ChatMessagePolicyViolationVerdictDetailsTypes $items, ChatMessagePolicyViolationVerdictDetailsTypes ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChatMessagePolicyViolationVerdictDetailsTypes> $value
     * @return self
     ...
     * 
     * @param ChatMessagePolicyViolationVerdictDetailsTypes $item
     * @return self
     */
    public function addValue(ChatMessagePolicyViolationVerdictDetailsTypes $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChatMessagePolicyViolationVerdictDetailsTypes>
     */
