...
/**
 * Collection response for AlertSeverity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AlertSeverityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AlertSeverity[]
     */
     ...
     * 
     * @param AlertSeverity[] $items
     * @return self
     */
    public function setValue(array|AlertSeverity $items, AlertSeverity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AlertSeverity> $value
     * @return self
     ...
     * 
     * @param AlertSeverity $item
     * @return self
     */
    public function addValue(AlertSeverity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AlertSeverity>
     */
