...
/**
 * Collection response for AuthenticationMethodTargetType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationMethodTargetTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuthenticationMethodTargetType[]
     */
    private array $value = [];
     ...
     * 
     * @return AuthenticationMethodTargetType[]
     */
     ...
     * 
     * @param AuthenticationMethodTargetType[] $items
     * @return self
     */
    public function setValue(array|AuthenticationMethodTargetType $items, AuthenticationMethodTargetType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationMethodTargetType> $value
     * @return self
     ...
     * 
     * @param AuthenticationMethodTargetType $item
     * @return self
     */
    public function addValue(AuthenticationMethodTargetType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationMethodTargetType>
     */
