...
/**
 * AuthenticationMethodTargetTypeCollectionResponse - Collection response
 */
class AuthenticationMethodTargetTypeCollectionResponse
{
    /**
     * @var array<int, AuthenticationMethodTargetType>
     */
    public array $value = [];
