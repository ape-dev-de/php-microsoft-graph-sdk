...
/**
 * DeviceEnrollmentPlatformRestrictionsConfigurationCollectionResponse - Collection response
 */
class DeviceEnrollmentPlatformRestrictionsConfigurationCollectionResponse
{
    /**
     * @var array<int, DeviceEnrollmentPlatformRestrictionsConfiguration>
     */
    public array $value = [];
