...
/**
 * Collection response for DeviceEnrollmentPlatformRestrictionsConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceEnrollmentPlatformRestrictionsConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceEnrollmentPlatformRestrictionsConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceEnrollmentPlatformRestrictionsConfiguration[] $items
     * @return self
     */
    public function setValue(array|DeviceEnrollmentPlatformRestrictionsConfiguration $items, DeviceEnrollmentPlatformRestrictionsConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceEnrollmentPlatformRestrictionsConfiguration> $value
     * @return self
     ...
     * 
     * @param DeviceEnrollmentPlatformRestrictionsConfiguration $item
     * @return self
     */
    public function addValue(DeviceEnrollmentPlatformRestrictionsConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return DeviceEnrollmentPlatformRestrictionsConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, DeviceEnrollmentPlatformRestrictionsConfiguration>
     */
