...
/**
 * Collection response for SecurityAzureResourceEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityAzureResourceEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityAzureResourceEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityAzureResourceEvidence[]
     */
     ...
     * 
     * @param SecurityAzureResourceEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityAzureResourceEvidence $items, SecurityAzureResourceEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityAzureResourceEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityAzureResourceEvidence $item
     * @return self
     */
    public function addValue(SecurityAzureResourceEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityAzureResourceEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityAzureResourceEvidence>
     */
