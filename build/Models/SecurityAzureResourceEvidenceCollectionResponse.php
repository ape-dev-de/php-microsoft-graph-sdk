 ...
 */
class SecurityAzureResourceEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityAzureResourceEvidence ...$items Variable number of SecurityAzureResourceEvidence items
     * @return self
     */
    public function setValue(SecurityAzureResourceEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
