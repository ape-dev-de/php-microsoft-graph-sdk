...
/**
 * PlatformCredentialAuthenticationMethodCollectionResponse - Collection response
 */
class PlatformCredentialAuthenticationMethodCollectionResponse
{
    /**
     * @var array<int, PlatformCredentialAuthenticationMethod>
     */
    public array $value = [];
