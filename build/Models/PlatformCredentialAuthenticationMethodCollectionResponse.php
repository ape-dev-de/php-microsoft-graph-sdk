...
/**
 * Collection response for PlatformCredentialAuthenticationMethod
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlatformCredentialAuthenticationMethodCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PlatformCredentialAuthenticationMethod[] $items
     * @return self
     */
    public function setValue(array|PlatformCredentialAuthenticationMethod $items, PlatformCredentialAuthenticationMethod ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PlatformCredentialAuthenticationMethod> $value
     * @return self
     ...
     * 
     * @param PlatformCredentialAuthenticationMethod $item
     * @return self
     */
    public function addValue(PlatformCredentialAuthenticationMethod $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PlatformCredentialAuthenticationMethod|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PlatformCredentialAuthenticationMethod>
     */
