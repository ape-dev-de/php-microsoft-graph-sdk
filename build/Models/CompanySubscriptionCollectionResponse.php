...
/**
 * Collection response for CompanySubscription
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CompanySubscriptionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CompanySubscription[] $items
     * @return self
     */
    public function setValue(array|CompanySubscription $items, CompanySubscription ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CompanySubscription> $value
     * @return self
     ...
     * 
     * @param CompanySubscription $item
     * @return self
     */
    public function addValue(CompanySubscription $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CompanySubscription>
     */
