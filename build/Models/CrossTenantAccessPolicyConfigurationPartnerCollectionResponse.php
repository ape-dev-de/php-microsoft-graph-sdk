...
/**
 * Collection response for CrossTenantAccessPolicyConfigurationPartner
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CrossTenantAccessPolicyConfigurationPartnerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CrossTenantAccessPolicyConfigurationPartner[] $items
     * @return self
     */
    public function setValue(array|CrossTenantAccessPolicyConfigurationPartner $items, CrossTenantAccessPolicyConfigurationPartner ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CrossTenantAccessPolicyConfigurationPartner> $value
     * @return self
     ...
     * 
     * @param CrossTenantAccessPolicyConfigurationPartner $item
     * @return self
     */
    public function addValue(CrossTenantAccessPolicyConfigurationPartner $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CrossTenantAccessPolicyConfigurationPartner>
     */
