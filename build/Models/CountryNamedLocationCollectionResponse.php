...
/**
 * Collection response for CountryNamedLocation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CountryNamedLocationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CountryNamedLocation[]
     */
    private array $value = [];
     ...
     * 
     * @param CountryNamedLocation[] $items
     * @return self
     */
    public function setValue(array|CountryNamedLocation $items, CountryNamedLocation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CountryNamedLocation> $value
     * @return self
     ...
     * 
     * @param CountryNamedLocation $item
     * @return self
     */
    public function addValue(CountryNamedLocation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CountryNamedLocation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CountryNamedLocation>
     */
