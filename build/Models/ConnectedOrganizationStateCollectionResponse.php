...
/**
 * Collection response for ConnectedOrganizationState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConnectedOrganizationStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConnectedOrganizationState[]
     */
    private array $value = [];
     ...
     * 
     * @return ConnectedOrganizationState[]
     */
     ...
     * 
     * @param ConnectedOrganizationState[] $items
     * @return self
     */
    public function setValue(array|ConnectedOrganizationState $items, ConnectedOrganizationState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConnectedOrganizationState> $value
     * @return self
     ...
     * 
     * @param ConnectedOrganizationState $item
     * @return self
     */
    public function addValue(ConnectedOrganizationState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConnectedOrganizationState>
     */
