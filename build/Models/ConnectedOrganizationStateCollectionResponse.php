...
/**
 * ConnectedOrganizationStateCollectionResponse - Collection response
 */
class ConnectedOrganizationStateCollectionResponse
{
    /**
     * @var array<int, ConnectedOrganizationState>
     */
    public array $value = [];
