...
/**
 * Collection response for AppListType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppListTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AppListType[]
     */
     ...
     * 
     * @param AppListType[] $items
     * @return self
     */
    public function setValue(array|AppListType $items, AppListType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param AppListType $item
     * @return self
     */
    public function addValue(AppListType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AppListType>
     */
