...
/**
 * Collection response for ServiceHealthIssuePostCollectionResponse
 */
class ServiceHealthIssuePostCollectionResponseCollectionResponse
{
    /**
     * @var ServiceHealthIssuePostCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ServiceHealthIssuePostCollectionResponse ...$items Variable number of ServiceHealthIssuePostCollectionResponse items
     * @return self
     */
    public function setValue(ServiceHealthIssuePostCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ServiceHealthIssuePostCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ServiceHealthIssuePostCollectionResponse $item
     * @return self
     */
    public function addValue(ServiceHealthIssuePostCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
