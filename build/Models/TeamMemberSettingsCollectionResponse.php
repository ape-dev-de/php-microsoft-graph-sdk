...
/**
 * Collection response for TeamMemberSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamMemberSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TeamMemberSettings[] $items
     * @return self
     */
    public function setValue(array|TeamMemberSettings $items, TeamMemberSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamMemberSettings> $value
     * @return self
     ...
     * 
     * @param TeamMemberSettings $item
     * @return self
     */
    public function addValue(TeamMemberSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamMemberSettings>
     */
