 ...
 */
class TeamMemberSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param TeamMemberSettings ...$items Variable number of TeamMemberSettings items
     * @return self
     */
    public function setValue(TeamMemberSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
