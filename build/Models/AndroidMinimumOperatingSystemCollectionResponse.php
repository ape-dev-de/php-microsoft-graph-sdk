...
/**
 * Collection response for AndroidMinimumOperatingSystem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AndroidMinimumOperatingSystemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AndroidMinimumOperatingSystem[] $items
     * @return self
     */
    public function setValue(array|AndroidMinimumOperatingSystem $items, AndroidMinimumOperatingSystem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AndroidMinimumOperatingSystem> $value
     * @return self
     ...
     * 
     * @param AndroidMinimumOperatingSystem $item
     * @return self
     */
    public function addValue(AndroidMinimumOperatingSystem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AndroidMinimumOperatingSystem>
     */
