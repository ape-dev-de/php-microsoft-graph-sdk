 ...
 */
class AndroidMinimumOperatingSystemCollectionResponse
{
    /**
     ...
     * 
     * @param AndroidMinimumOperatingSystem ...$items Variable number of AndroidMinimumOperatingSystem items
     * @return self
     */
    public function setValue(AndroidMinimumOperatingSystem ...$items): self
    {
        $this->value = $items;
        return $this;
    }
