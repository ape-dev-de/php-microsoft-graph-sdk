...
/**
 * Collection response for VirtualAppointmentMessageType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualAppointmentMessageTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VirtualAppointmentMessageType[]
     */
    private array $value = [];
     ...
     * 
     * @return VirtualAppointmentMessageType[]
     */
     ...
     * 
     * @param VirtualAppointmentMessageType[] $items
     * @return self
     */
    public function setValue(array|VirtualAppointmentMessageType $items, VirtualAppointmentMessageType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualAppointmentMessageType> $value
     * @return self
     ...
     * 
     * @param VirtualAppointmentMessageType $item
     * @return self
     */
    public function addValue(VirtualAppointmentMessageType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VirtualAppointmentMessageType>
     */
