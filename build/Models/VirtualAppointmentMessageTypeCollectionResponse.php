...
/**
 * VirtualAppointmentMessageTypeCollectionResponse - Collection response
 */
class VirtualAppointmentMessageTypeCollectionResponse
{
    /**
     * @var array<int, VirtualAppointmentMessageType>
     */
    public array $value = [];
