...
/**
 * Collection response for OAuthAppScope
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OAuthAppScopeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OAuthAppScope[]
     */
     ...
     * 
     * @param OAuthAppScope[] $items
     * @return self
     */
    public function setValue(array|OAuthAppScope $items, OAuthAppScope ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OAuthAppScope> $value
     * @return self
     ...
     * 
     * @param OAuthAppScope $item
     * @return self
     */
    public function addValue(OAuthAppScope $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OAuthAppScope>
     */
