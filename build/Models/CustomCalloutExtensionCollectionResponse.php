...
/**
 * Collection response for CustomCalloutExtension
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CustomCalloutExtensionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CustomCalloutExtension[] $items
     * @return self
     */
    public function setValue(array|CustomCalloutExtension $items, CustomCalloutExtension ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CustomCalloutExtension> $value
     * @return self
     ...
     * 
     * @param CustomCalloutExtension $item
     * @return self
     */
    public function addValue(CustomCalloutExtension $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CustomCalloutExtension>
     */
