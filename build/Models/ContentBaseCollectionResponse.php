...
/**
 * Collection response for ContentBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ContentBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ContentBase[]
     */
     ...
     * 
     * @param ContentBase[] $items
     * @return self
     */
    public function setValue(array|ContentBase $items, ContentBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(ContentBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ContentBase>
     */
