...
/**
 * MobileThreatPartnerTenantStateCollectionResponse - Collection response
 */
class MobileThreatPartnerTenantStateCollectionResponse
{
    /**
     * @var array<int, MobileThreatPartnerTenantState>
     */
    public array $value = [];
