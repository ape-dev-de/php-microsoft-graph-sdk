...
/**
 * Collection response for MobileThreatPartnerTenantState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MobileThreatPartnerTenantStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MobileThreatPartnerTenantState[]
     */
    private array $value = [];
     ...
     * 
     * @return MobileThreatPartnerTenantState[]
     */
     ...
     * 
     * @param MobileThreatPartnerTenantState[] $items
     * @return self
     */
    public function setValue(array|MobileThreatPartnerTenantState $items, MobileThreatPartnerTenantState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MobileThreatPartnerTenantState> $value
     * @return self
     ...
     * 
     * @param MobileThreatPartnerTenantState $item
     * @return self
     */
    public function addValue(MobileThreatPartnerTenantState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MobileThreatPartnerTenantState>
     */
