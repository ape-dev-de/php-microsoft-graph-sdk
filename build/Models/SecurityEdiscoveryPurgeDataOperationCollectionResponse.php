...
/**
 * SecurityEdiscoveryPurgeDataOperationCollectionResponse - Collection response
 */
class SecurityEdiscoveryPurgeDataOperationCollectionResponse
{
    /**
     * @var array<int, SecurityEdiscoveryPurgeDataOperation>
     */
    public array $value = [];
