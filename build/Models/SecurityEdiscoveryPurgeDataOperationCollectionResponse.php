...
/**
 * Collection response for SecurityEdiscoveryPurgeDataOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityEdiscoveryPurgeDataOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityEdiscoveryPurgeDataOperation[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityEdiscoveryPurgeDataOperation[]
     */
     ...
     * 
     * @param SecurityEdiscoveryPurgeDataOperation[] $items
     * @return self
     */
    public function setValue(array|SecurityEdiscoveryPurgeDataOperation $items, SecurityEdiscoveryPurgeDataOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityEdiscoveryPurgeDataOperation> $value
     * @return self
     ...
     * 
     * @param SecurityEdiscoveryPurgeDataOperation $item
     * @return self
     */
    public function addValue(SecurityEdiscoveryPurgeDataOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityEdiscoveryPurgeDataOperation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityEdiscoveryPurgeDataOperation>
     */
