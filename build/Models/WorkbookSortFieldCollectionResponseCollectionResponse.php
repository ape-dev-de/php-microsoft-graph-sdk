...
/**
 * Collection response for WorkbookSortFieldCollectionResponse
 */
class WorkbookSortFieldCollectionResponseCollectionResponse
{
    /**
     * @var WorkbookSortFieldCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookSortFieldCollectionResponse ...$items Variable number of WorkbookSortFieldCollectionResponse items
     * @return self
     */
    public function setValue(WorkbookSortFieldCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WorkbookSortFieldCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WorkbookSortFieldCollectionResponse $item
     * @return self
     */
    public function addValue(WorkbookSortFieldCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
