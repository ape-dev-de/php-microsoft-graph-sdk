...
/**
 * Collection response for IdentityProviderBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityProviderBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IdentityProviderBase[] $items
     * @return self
     */
    public function setValue(array|IdentityProviderBase $items, IdentityProviderBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityProviderBase> $value
     * @return self
     ...
     * 
     * @param IdentityProviderBase $item
     * @return self
     */
    public function addValue(IdentityProviderBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityProviderBase>
     */
