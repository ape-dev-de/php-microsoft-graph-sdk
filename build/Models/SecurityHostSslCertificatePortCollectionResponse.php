...
/**
 * Collection response for SecurityHostSslCertificatePort
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHostSslCertificatePortCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return SecurityHostSslCertificatePort[]
     */
     ...
     * 
     * @param SecurityHostSslCertificatePort[] $items
     * @return self
     */
    public function setValue(array|SecurityHostSslCertificatePort $items, SecurityHostSslCertificatePort ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHostSslCertificatePort> $value
     * @return self
     ...
     * 
     * @param SecurityHostSslCertificatePort $item
     * @return self
     */
    public function addValue(SecurityHostSslCertificatePort $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityHostSslCertificatePort|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityHostSslCertificatePort>
     */
