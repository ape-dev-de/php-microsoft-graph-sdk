...
/**
 * SecurityHostSslCertificatePortCollectionResponse - Collection response
 */
class SecurityHostSslCertificatePortCollectionResponse
{
    /**
     * @var array<int, SecurityHostSslCertificatePort>
     */
    public array $value = [];
