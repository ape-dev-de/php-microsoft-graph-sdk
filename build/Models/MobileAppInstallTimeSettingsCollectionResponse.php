 ...
 */
class MobileAppInstallTimeSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param MobileAppInstallTimeSettings ...$items Variable number of MobileAppInstallTimeSettings items
     * @return self
     */
    public function setValue(MobileAppInstallTimeSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
