...
/**
 * Collection response for MobileAppInstallTimeSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MobileAppInstallTimeSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MobileAppInstallTimeSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param MobileAppInstallTimeSettings[] $items
     * @return self
     */
    public function setValue(array|MobileAppInstallTimeSettings $items, MobileAppInstallTimeSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MobileAppInstallTimeSettings> $value
     * @return self
     ...
     * 
     * @param MobileAppInstallTimeSettings $item
     * @return self
     */
    public function addValue(MobileAppInstallTimeSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MobileAppInstallTimeSettings>
     */
