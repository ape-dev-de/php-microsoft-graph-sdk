...
/**
 * Collection response for OutlookCategory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OutlookCategoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OutlookCategory[]
     */
     ...
     * 
     * @param OutlookCategory[] $items
     * @return self
     */
    public function setValue(array|OutlookCategory $items, OutlookCategory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OutlookCategory> $value
     * @return self
     ...
     * 
     * @param OutlookCategory $item
     * @return self
     */
    public function addValue(OutlookCategory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OutlookCategory>
     */
