...
/**
 * Collection response for UnifiedRbacResourceNamespace
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRbacResourceNamespaceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UnifiedRbacResourceNamespace[] $items
     * @return self
     */
    public function setValue(array|UnifiedRbacResourceNamespace $items, UnifiedRbacResourceNamespace ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRbacResourceNamespace> $value
     * @return self
     ...
     * 
     * @param UnifiedRbacResourceNamespace $item
     * @return self
     */
    public function addValue(UnifiedRbacResourceNamespace $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRbacResourceNamespace>
     */
