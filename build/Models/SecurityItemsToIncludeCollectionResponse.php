...
/**
 * Collection response for SecurityItemsToInclude
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityItemsToIncludeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityItemsToInclude[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityItemsToInclude[] $items
     * @return self
     */
    public function setValue(array|SecurityItemsToInclude $items, SecurityItemsToInclude ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityItemsToInclude> $value
     * @return self
     ...
     * 
     * @param SecurityItemsToInclude $item
     * @return self
     */
    public function addValue(SecurityItemsToInclude $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityItemsToInclude|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityItemsToInclude>
     */
