...
/**
 * Collection response for SolutionsRoot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SolutionsRootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SolutionsRoot[]
     */
     ...
     * 
     * @param SolutionsRoot[] $items
     * @return self
     */
    public function setValue(array|SolutionsRoot $items, SolutionsRoot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SolutionsRoot> $value
     * @return self
     ...
     * 
     * @param SolutionsRoot $item
     * @return self
     */
    public function addValue(SolutionsRoot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SolutionsRoot>
     */
