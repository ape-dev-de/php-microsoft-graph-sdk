 ...
 */
class SolutionsRootCollectionResponse
{
    /**
     * @var SolutionsRoot[]
     */
     ...
     * 
     * @param SolutionsRoot ...$items Variable number of SolutionsRoot items
     * @return self
     */
    public function setValue(SolutionsRoot ...$items): self
    {
        $this->value = $items;
        return $this;
    }
