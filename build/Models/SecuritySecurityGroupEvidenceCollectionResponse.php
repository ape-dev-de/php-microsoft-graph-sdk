...
/**
 * Collection response for SecuritySecurityGroupEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecuritySecurityGroupEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecuritySecurityGroupEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecuritySecurityGroupEvidence[]
     */
     ...
     * 
     * @param SecuritySecurityGroupEvidence[] $items
     * @return self
     */
    public function setValue(array|SecuritySecurityGroupEvidence $items, SecuritySecurityGroupEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecuritySecurityGroupEvidence> $value
     * @return self
     ...
     * 
     * @param SecuritySecurityGroupEvidence $item
     * @return self
     */
    public function addValue(SecuritySecurityGroupEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecuritySecurityGroupEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecuritySecurityGroupEvidence>
     */
