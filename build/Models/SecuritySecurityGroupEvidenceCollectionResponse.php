 ...
 */
class SecuritySecurityGroupEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecuritySecurityGroupEvidence ...$items Variable number of SecuritySecurityGroupEvidence items
     * @return self
     */
    public function setValue(SecuritySecurityGroupEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
