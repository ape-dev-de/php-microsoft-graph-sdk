...
/**
 * Collection response for CallRecordsClientPlatform
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsClientPlatformCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsClientPlatform[]
     */
    private array $value = [];
     ...
     * 
     * @return CallRecordsClientPlatform[]
     */
     ...
     * 
     * @param CallRecordsClientPlatform[] $items
     * @return self
     */
    public function setValue(array|CallRecordsClientPlatform $items, CallRecordsClientPlatform ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsClientPlatform> $value
     * @return self
     ...
     * 
     * @param CallRecordsClientPlatform $item
     * @return self
     */
    public function addValue(CallRecordsClientPlatform $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsClientPlatform|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsClientPlatform>
     */
