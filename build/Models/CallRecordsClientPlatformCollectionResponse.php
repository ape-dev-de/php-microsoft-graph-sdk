...
/**
 * CallRecordsClientPlatformCollectionResponse - Collection response
 */
class CallRecordsClientPlatformCollectionResponse
{
    /**
     * @var array<int, CallRecordsClientPlatform>
     */
    public array $value = [];
