...
/**
 * Collection response for AcceptJoinResponse
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AcceptJoinResponseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AcceptJoinResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AcceptJoinResponse[] $items
     * @return self
     */
    public function setValue(array|AcceptJoinResponse $items, AcceptJoinResponse ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AcceptJoinResponse> $value
     * @return self
     ...
     * 
     * @param AcceptJoinResponse $item
     * @return self
     */
    public function addValue(AcceptJoinResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AcceptJoinResponse|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AcceptJoinResponse>
     */
