...
/**
 * Collection response for UnifiedRoleManagementPolicyRuleTarget
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRoleManagementPolicyRuleTargetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UnifiedRoleManagementPolicyRuleTarget[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedRoleManagementPolicyRuleTarget[] $items
     * @return self
     */
    public function setValue(array|UnifiedRoleManagementPolicyRuleTarget $items, UnifiedRoleManagementPolicyRuleTarget ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRoleManagementPolicyRuleTarget> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleManagementPolicyRuleTarget $item
     * @return self
     */
    public function addValue(UnifiedRoleManagementPolicyRuleTarget $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRoleManagementPolicyRuleTarget>
     */
