...
/**
 * Collection response for SecurityUserAccount
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityUserAccountCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityUserAccount[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityUserAccount[] $items
     * @return self
     */
    public function setValue(array|SecurityUserAccount $items, SecurityUserAccount ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityUserAccount> $value
     * @return self
     ...
     * 
     * @param SecurityUserAccount $item
     * @return self
     */
    public function addValue(SecurityUserAccount $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityUserAccount|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityUserAccount>
     */
