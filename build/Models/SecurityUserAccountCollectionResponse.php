 ...
 */
class SecurityUserAccountCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityUserAccount ...$items Variable number of SecurityUserAccount items
     * @return self
     */
    public function setValue(SecurityUserAccount ...$items): self
    {
        $this->value = $items;
        return $this;
    }
