...
/**
 * Collection response for LicenseDetailsCollectionResponse
 */
class LicenseDetailsCollectionResponseCollectionResponse
{
    /**
     * @var LicenseDetailsCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param LicenseDetailsCollectionResponse ...$items Variable number of LicenseDetailsCollectionResponse items
     * @return self
     */
    public function setValue(LicenseDetailsCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<LicenseDetailsCollectionResponse> $value
     * @return self
     ...
     * 
     * @param LicenseDetailsCollectionResponse $item
     * @return self
     */
    public function addValue(LicenseDetailsCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
