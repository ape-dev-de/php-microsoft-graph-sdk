...
/**
 * Collection response for RegistryKeyState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RegistryKeyStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RegistryKeyState[]
     */
    private array $value = [];
     ...
     * 
     * @param RegistryKeyState[] $items
     * @return self
     */
    public function setValue(array|RegistryKeyState $items, RegistryKeyState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RegistryKeyState> $value
     * @return self
     ...
     * 
     * @param RegistryKeyState $item
     * @return self
     */
    public function addValue(RegistryKeyState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RegistryKeyState>
     */
