...
/**
 * Collection response for TeamCollectionResponse
 */
class TeamCollectionResponseCollectionResponse
{
    /**
     * @var TeamCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamCollectionResponse ...$items Variable number of TeamCollectionResponse items
     * @return self
     */
    public function setValue(TeamCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TeamCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TeamCollectionResponse $item
     * @return self
     */
    public function addValue(TeamCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
