...
/**
 * Collection response for CallRecordsCallRecord
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsCallRecordCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CallRecordsCallRecord[] $items
     * @return self
     */
    public function setValue(array|CallRecordsCallRecord $items, CallRecordsCallRecord ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsCallRecord> $value
     * @return self
     ...
     * 
     * @param CallRecordsCallRecord $item
     * @return self
     */
    public function addValue(CallRecordsCallRecord $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsCallRecord>
     */
