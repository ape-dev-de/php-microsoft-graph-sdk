...
/**
 * Collection response for RestorePointSearchResponse
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RestorePointSearchResponseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RestorePointSearchResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RestorePointSearchResponse[] $items
     * @return self
     */
    public function setValue(array|RestorePointSearchResponse $items, RestorePointSearchResponse ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RestorePointSearchResponse> $value
     * @return self
     ...
     * 
     * @param RestorePointSearchResponse $item
     * @return self
     */
    public function addValue(RestorePointSearchResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return RestorePointSearchResponse|null
     */
     ...
     * 
     * @return \ArrayIterator<int, RestorePointSearchResponse>
     */
