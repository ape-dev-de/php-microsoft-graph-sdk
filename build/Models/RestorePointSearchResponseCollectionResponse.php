 ...
 */
class RestorePointSearchResponseCollectionResponse
{
    /**
     ...
     * 
     * @param RestorePointSearchResponse ...$items Variable number of RestorePointSearchResponse items
     * @return self
     */
    public function setValue(RestorePointSearchResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
