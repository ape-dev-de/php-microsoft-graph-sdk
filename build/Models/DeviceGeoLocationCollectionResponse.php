 ...
 */
class DeviceGeoLocationCollectionResponse
{
    /**
     ...
     * 
     * @param DeviceGeoLocation ...$items Variable number of DeviceGeoLocation items
     * @return self
     */
    public function setValue(DeviceGeoLocation ...$items): self
    {
        $this->value = $items;
        return $this;
    }
