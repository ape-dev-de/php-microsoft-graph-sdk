...
/**
 * Collection response for DeviceGeoLocation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceGeoLocationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceGeoLocation[] $items
     * @return self
     */
    public function setValue(array|DeviceGeoLocation $items, DeviceGeoLocation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceGeoLocation> $value
     * @return self
     ...
     * 
     * @param DeviceGeoLocation $item
     * @return self
     */
    public function addValue(DeviceGeoLocation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceGeoLocation>
     */
