...
/**
 * Collection response for CloudPcUserSettingAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcUserSettingAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CloudPcUserSettingAssignment[] $items
     * @return self
     */
    public function setValue(array|CloudPcUserSettingAssignment $items, CloudPcUserSettingAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcUserSettingAssignment> $value
     * @return self
     ...
     * 
     * @param CloudPcUserSettingAssignment $item
     * @return self
     */
    public function addValue(CloudPcUserSettingAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcUserSettingAssignment>
     */
