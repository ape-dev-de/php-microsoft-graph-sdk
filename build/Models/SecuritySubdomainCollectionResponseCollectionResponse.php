...
/**
 * Collection response for SecuritySubdomainCollectionResponse
 */
class SecuritySubdomainCollectionResponseCollectionResponse
{
    /**
     * @var SecuritySubdomainCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecuritySubdomainCollectionResponse ...$items Variable number of SecuritySubdomainCollectionResponse items
     * @return self
     */
    public function setValue(SecuritySubdomainCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecuritySubdomainCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecuritySubdomainCollectionResponse $item
     * @return self
     */
    public function addValue(SecuritySubdomainCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
