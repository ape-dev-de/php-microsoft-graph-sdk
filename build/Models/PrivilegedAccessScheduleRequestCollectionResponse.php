...
/**
 * Collection response for PrivilegedAccessScheduleRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrivilegedAccessScheduleRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrivilegedAccessScheduleRequest[]
     */
    private array $value = [];
     ...
     * 
     * @param PrivilegedAccessScheduleRequest[] $items
     * @return self
     */
    public function setValue(array|PrivilegedAccessScheduleRequest $items, PrivilegedAccessScheduleRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrivilegedAccessScheduleRequest> $value
     * @return self
     ...
     * 
     * @param PrivilegedAccessScheduleRequest $item
     * @return self
     */
    public function addValue(PrivilegedAccessScheduleRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PrivilegedAccessScheduleRequest|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PrivilegedAccessScheduleRequest>
     */
