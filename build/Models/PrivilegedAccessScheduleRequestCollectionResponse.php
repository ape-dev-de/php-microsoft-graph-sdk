 ...
 */
class PrivilegedAccessScheduleRequestCollectionResponse
{
    /**
     ...
     * 
     * @param PrivilegedAccessScheduleRequest ...$items Variable number of PrivilegedAccessScheduleRequest items
     * @return self
     */
    public function setValue(PrivilegedAccessScheduleRequest ...$items): self
    {
        $this->value = $items;
        return $this;
    }
