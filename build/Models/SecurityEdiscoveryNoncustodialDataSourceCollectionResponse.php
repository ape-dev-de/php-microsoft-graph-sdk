...
/**
 * SecurityEdiscoveryNoncustodialDataSourceCollectionResponse - Collection response
 */
class SecurityEdiscoveryNoncustodialDataSourceCollectionResponse
{
    /**
     * @var array<int, SecurityEdiscoveryNoncustodialDataSource>
     */
    public array $value = [];
