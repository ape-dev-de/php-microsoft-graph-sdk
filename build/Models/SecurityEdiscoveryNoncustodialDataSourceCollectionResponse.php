...
/**
 * Collection response for SecurityEdiscoveryNoncustodialDataSource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityEdiscoveryNoncustodialDataSourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityEdiscoveryNoncustodialDataSource[] $items
     * @return self
     */
    public function setValue(array|SecurityEdiscoveryNoncustodialDataSource $items, SecurityEdiscoveryNoncustodialDataSource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityEdiscoveryNoncustodialDataSource> $value
     * @return self
     ...
     * 
     * @param SecurityEdiscoveryNoncustodialDataSource $item
     * @return self
     */
    public function addValue(SecurityEdiscoveryNoncustodialDataSource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityEdiscoveryNoncustodialDataSource>
     */
