...
/**
 * Collection response for KeyCredentialConfigurationCollectionResponse
 */
class KeyCredentialConfigurationCollectionResponseCollectionResponse
{
    /**
     * @var KeyCredentialConfigurationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param KeyCredentialConfigurationCollectionResponse ...$items Variable number of KeyCredentialConfigurationCollectionResponse items
     * @return self
     */
    public function setValue(KeyCredentialConfigurationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<KeyCredentialConfigurationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param KeyCredentialConfigurationCollectionResponse $item
     * @return self
     */
    public function addValue(KeyCredentialConfigurationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
