 ...
 */
class SecurityWhoisContactCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityWhoisContact ...$items Variable number of SecurityWhoisContact items
     * @return self
     */
    public function setValue(SecurityWhoisContact ...$items): self
    {
        $this->value = $items;
        return $this;
    }
