...
/**
 * Collection response for SecurityWhoisContact
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityWhoisContactCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityWhoisContact[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityWhoisContact[] $items
     * @return self
     */
    public function setValue(array|SecurityWhoisContact $items, SecurityWhoisContact ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityWhoisContact> $value
     * @return self
     ...
     * 
     * @param SecurityWhoisContact $item
     * @return self
     */
    public function addValue(SecurityWhoisContact $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityWhoisContact|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityWhoisContact>
     */
