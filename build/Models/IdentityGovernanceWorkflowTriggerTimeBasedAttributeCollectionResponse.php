...
/**
 * Collection response for IdentityGovernanceWorkflowTriggerTimeBasedAttribute
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceWorkflowTriggerTimeBasedAttributeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceWorkflowTriggerTimeBasedAttribute[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceWorkflowTriggerTimeBasedAttribute[]
     */
     ...
     * 
     * @param IdentityGovernanceWorkflowTriggerTimeBasedAttribute[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceWorkflowTriggerTimeBasedAttribute $items, IdentityGovernanceWorkflowTriggerTimeBasedAttribute ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceWorkflowTriggerTimeBasedAttribute> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceWorkflowTriggerTimeBasedAttribute $item
     * @return self
     */
    public function addValue(IdentityGovernanceWorkflowTriggerTimeBasedAttribute $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceWorkflowTriggerTimeBasedAttribute|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceWorkflowTriggerTimeBasedAttribute>
     */
