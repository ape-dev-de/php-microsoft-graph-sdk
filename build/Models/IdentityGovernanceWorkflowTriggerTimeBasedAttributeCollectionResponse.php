...
/**
 * IdentityGovernanceWorkflowTriggerTimeBasedAttributeCollectionResponse - Collection response
 */
class IdentityGovernanceWorkflowTriggerTimeBasedAttributeCollectionResponse
{
    /**
     * @var array<int, IdentityGovernanceWorkflowTriggerTimeBasedAttribute>
     */
    public array $value = [];
