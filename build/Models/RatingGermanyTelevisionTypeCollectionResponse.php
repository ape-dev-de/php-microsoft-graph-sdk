...
/**
 * RatingGermanyTelevisionTypeCollectionResponse - Collection response
 */
class RatingGermanyTelevisionTypeCollectionResponse
{
    /**
     * @var array<int, RatingGermanyTelevisionType>
     */
    public array $value = [];
