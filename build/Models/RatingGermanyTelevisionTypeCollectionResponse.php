...
/**
 * Collection response for RatingGermanyTelevisionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RatingGermanyTelevisionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RatingGermanyTelevisionType[]
     */
    private array $value = [];
     ...
     * 
     * @return RatingGermanyTelevisionType[]
     */
     ...
     * 
     * @param RatingGermanyTelevisionType[] $items
     * @return self
     */
    public function setValue(array|RatingGermanyTelevisionType $items, RatingGermanyTelevisionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RatingGermanyTelevisionType> $value
     * @return self
     ...
     * 
     * @param RatingGermanyTelevisionType $item
     * @return self
     */
    public function addValue(RatingGermanyTelevisionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RatingGermanyTelevisionType>
     */
