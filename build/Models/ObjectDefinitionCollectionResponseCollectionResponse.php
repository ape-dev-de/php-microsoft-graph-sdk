...
/**
 * Collection response for ObjectDefinitionCollectionResponse
 */
class ObjectDefinitionCollectionResponseCollectionResponse
{
    /**
     * @var ObjectDefinitionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ObjectDefinitionCollectionResponse ...$items Variable number of ObjectDefinitionCollectionResponse items
     * @return self
     */
    public function setValue(ObjectDefinitionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ObjectDefinitionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ObjectDefinitionCollectionResponse $item
     * @return self
     */
    public function addValue(ObjectDefinitionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
