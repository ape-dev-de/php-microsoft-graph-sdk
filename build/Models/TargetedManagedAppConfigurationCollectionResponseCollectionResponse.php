...
/**
 * Collection response for TargetedManagedAppConfigurationCollectionResponse
 */
class TargetedManagedAppConfigurationCollectionResponseCollectionResponse
{
    /**
     * @var TargetedManagedAppConfigurationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TargetedManagedAppConfigurationCollectionResponse ...$items Variable number of TargetedManagedAppConfigurationCollectionResponse items
     * @return self
     */
    public function setValue(TargetedManagedAppConfigurationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TargetedManagedAppConfigurationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TargetedManagedAppConfigurationCollectionResponse $item
     * @return self
     */
    public function addValue(TargetedManagedAppConfigurationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
