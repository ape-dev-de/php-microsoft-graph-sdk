...
/**
 * Collection response for SharedDriveItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SharedDriveItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SharedDriveItem[]
     */
     ...
     * 
     * @param SharedDriveItem[] $items
     * @return self
     */
    public function setValue(array|SharedDriveItem $items, SharedDriveItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SharedDriveItem> $value
     * @return self
     ...
     * 
     * @param SharedDriveItem $item
     * @return self
     */
    public function addValue(SharedDriveItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SharedDriveItem>
     */
