...
/**
 * Collection response for ManagedAppOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedAppOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ManagedAppOperation[] $items
     * @return self
     */
    public function setValue(array|ManagedAppOperation $items, ManagedAppOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedAppOperation> $value
     * @return self
     ...
     * 
     * @param ManagedAppOperation $item
     * @return self
     */
    public function addValue(ManagedAppOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedAppOperation>
     */
