 ...
 */
class WorkbookTableSortCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookTableSort ...$items Variable number of WorkbookTableSort items
     * @return self
     */
    public function setValue(WorkbookTableSort ...$items): self
    {
        $this->value = $items;
        return $this;
    }
