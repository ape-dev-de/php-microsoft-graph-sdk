...
/**
 * Collection response for WorkbookTableSort
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookTableSortCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookTableSort[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookTableSort[] $items
     * @return self
     */
    public function setValue(array|WorkbookTableSort $items, WorkbookTableSort ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookTableSort> $value
     * @return self
     ...
     * 
     * @param WorkbookTableSort $item
     * @return self
     */
    public function addValue(WorkbookTableSort $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookTableSort>
     */
