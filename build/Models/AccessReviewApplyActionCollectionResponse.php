...
/**
 * Collection response for AccessReviewApplyAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewApplyActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessReviewApplyAction[] $items
     * @return self
     */
    public function setValue(array|AccessReviewApplyAction $items, AccessReviewApplyAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewApplyAction> $value
     * @return self
     ...
     * 
     * @param AccessReviewApplyAction $item
     * @return self
     */
    public function addValue(AccessReviewApplyAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessReviewApplyAction|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewApplyAction>
     */
