...
/**
 * Collection response for IosGeneralDeviceConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosGeneralDeviceConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IosGeneralDeviceConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param IosGeneralDeviceConfiguration[] $items
     * @return self
     */
    public function setValue(array|IosGeneralDeviceConfiguration $items, IosGeneralDeviceConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosGeneralDeviceConfiguration> $value
     * @return self
     ...
     * 
     * @param IosGeneralDeviceConfiguration $item
     * @return self
     */
    public function addValue(IosGeneralDeviceConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IosGeneralDeviceConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IosGeneralDeviceConfiguration>
     */
