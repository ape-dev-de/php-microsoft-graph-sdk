...
/**
 * Collection response for StsPolicyCollectionResponse
 */
class StsPolicyCollectionResponseCollectionResponse
{
    /**
     * @var StsPolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param StsPolicyCollectionResponse ...$items Variable number of StsPolicyCollectionResponse items
     * @return self
     */
    public function setValue(StsPolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<StsPolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param StsPolicyCollectionResponse $item
     * @return self
     */
    public function addValue(StsPolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
