...
/**
 * Collection response for Directory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DirectoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Directory[]
     */
     ...
     * @return self
     */
    public function setValue(array|Directory $items, Directory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Directory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Directory>
     */
