...
/**
 * Collection response for WindowsAutopilotDeviceIdentityCollectionResponse
 */
class WindowsAutopilotDeviceIdentityCollectionResponseCollectionResponse
{
    /**
     * @var WindowsAutopilotDeviceIdentityCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsAutopilotDeviceIdentityCollectionResponse ...$items Variable number of WindowsAutopilotDeviceIdentityCollectionResponse items
     * @return self
     */
    public function setValue(WindowsAutopilotDeviceIdentityCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WindowsAutopilotDeviceIdentityCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WindowsAutopilotDeviceIdentityCollectionResponse $item
     * @return self
     */
    public function addValue(WindowsAutopilotDeviceIdentityCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
