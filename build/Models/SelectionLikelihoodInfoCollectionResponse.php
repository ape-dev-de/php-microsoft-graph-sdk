...
/**
 * Collection response for SelectionLikelihoodInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SelectionLikelihoodInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SelectionLikelihoodInfo[]
     */
    private array $value = [];
     ...
     * 
     * @param SelectionLikelihoodInfo[] $items
     * @return self
     */
    public function setValue(array|SelectionLikelihoodInfo $items, SelectionLikelihoodInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SelectionLikelihoodInfo> $value
     * @return self
     ...
     * 
     * @param SelectionLikelihoodInfo $item
     * @return self
     */
    public function addValue(SelectionLikelihoodInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SelectionLikelihoodInfo>
     */
