...
/**
 * Collection response for ConnectionDirection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConnectionDirectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ConnectionDirection[] $items
     * @return self
     */
    public function setValue(array|ConnectionDirection $items, ConnectionDirection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConnectionDirection> $value
     * @return self
     ...
     * 
     * @param ConnectionDirection $item
     * @return self
     */
    public function addValue(ConnectionDirection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConnectionDirection>
     */
