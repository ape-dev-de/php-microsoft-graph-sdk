...
/**
 * Collection response for IosLobApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosLobAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IosLobApp[]
     */
     ...
     * 
     * @param IosLobApp[] $items
     * @return self
     */
    public function setValue(array|IosLobApp $items, IosLobApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param IosLobApp $item
     * @return self
     */
    public function addValue(IosLobApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IosLobApp>
     */
