...
/**
 * Collection response for ConditionalAccessGrantControls
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessGrantControlsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessGrantControls[]
     */
    private array $value = [];
     ...
     * 
     * @param ConditionalAccessGrantControls[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessGrantControls $items, ConditionalAccessGrantControls ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessGrantControls> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessGrantControls $item
     * @return self
     */
    public function addValue(ConditionalAccessGrantControls $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessGrantControls>
     */
