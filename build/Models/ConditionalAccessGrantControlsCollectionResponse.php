 ...
 */
class ConditionalAccessGrantControlsCollectionResponse
{
    /**
     ...
     * 
     * @param ConditionalAccessGrantControls ...$items Variable number of ConditionalAccessGrantControls items
     * @return self
     */
    public function setValue(ConditionalAccessGrantControls ...$items): self
    {
        $this->value = $items;
        return $this;
    }
