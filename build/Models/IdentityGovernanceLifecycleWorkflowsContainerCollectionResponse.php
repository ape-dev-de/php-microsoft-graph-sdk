...
/**
 * Collection response for IdentityGovernanceLifecycleWorkflowsContainer
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceLifecycleWorkflowsContainerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceLifecycleWorkflowsContainer[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityGovernanceLifecycleWorkflowsContainer[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceLifecycleWorkflowsContainer $items, IdentityGovernanceLifecycleWorkflowsContainer ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceLifecycleWorkflowsContainer> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceLifecycleWorkflowsContainer $item
     * @return self
     */
    public function addValue(IdentityGovernanceLifecycleWorkflowsContainer $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceLifecycleWorkflowsContainer>
     */
