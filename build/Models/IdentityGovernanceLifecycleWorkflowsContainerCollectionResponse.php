 ...
 */
class IdentityGovernanceLifecycleWorkflowsContainerCollectionResponse
{
    /**
     ...
     * 
     * @param IdentityGovernanceLifecycleWorkflowsContainer ...$items Variable number of IdentityGovernanceLifecycleWorkflowsContainer items
     * @return self
     */
    public function setValue(IdentityGovernanceLifecycleWorkflowsContainer ...$items): self
    {
        $this->value = $items;
        return $this;
    }
