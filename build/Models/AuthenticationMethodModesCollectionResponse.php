...
/**
 * AuthenticationMethodModesCollectionResponse - Collection response
 */
class AuthenticationMethodModesCollectionResponse
{
    /**
     * @var array<int, AuthenticationMethodModes>
     */
    public array $value = [];
