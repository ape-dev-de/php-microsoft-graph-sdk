...
/**
 * Collection response for AuthenticationMethodModes
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationMethodModesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return AuthenticationMethodModes[]
     */
     ...
     * 
     * @param AuthenticationMethodModes[] $items
     * @return self
     */
    public function setValue(array|AuthenticationMethodModes $items, AuthenticationMethodModes ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationMethodModes> $value
     * @return self
     ...
     * 
     * @param AuthenticationMethodModes $item
     * @return self
     */
    public function addValue(AuthenticationMethodModes $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AuthenticationMethodModes|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationMethodModes>
     */
