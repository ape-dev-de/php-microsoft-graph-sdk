...
/**
 * Collection response for Diagnostic
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DiagnosticCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Diagnostic[]
     */
     ...
     * @return self
     */
    public function setValue(array|Diagnostic $items, Diagnostic ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Diagnostic $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Diagnostic>
     */
