...
/**
 * Collection response for VirtualEventWebinarCollectionResponse
 */
class VirtualEventWebinarCollectionResponseCollectionResponse
{
    /**
     * @var VirtualEventWebinarCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param VirtualEventWebinarCollectionResponse ...$items Variable number of VirtualEventWebinarCollectionResponse items
     * @return self
     */
    public function setValue(VirtualEventWebinarCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<VirtualEventWebinarCollectionResponse> $value
     * @return self
     ...
     * 
     * @param VirtualEventWebinarCollectionResponse $item
     * @return self
     */
    public function addValue(VirtualEventWebinarCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
