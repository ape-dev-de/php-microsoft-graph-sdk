...
/**
 * Collection response for Video
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VideoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Video[]
     */
     ...
     * @return self
     */
    public function setValue(array|Video $items, Video ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Video $item): self
    {
        $this->value[] = $item;
        return $this;
    }
