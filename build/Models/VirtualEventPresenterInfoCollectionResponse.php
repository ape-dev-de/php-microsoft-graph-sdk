...
/**
 * Collection response for VirtualEventPresenterInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualEventPresenterInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VirtualEventPresenterInfo[]
     */
    private array $value = [];
     ...
     * 
     * @param VirtualEventPresenterInfo[] $items
     * @return self
     */
    public function setValue(array|VirtualEventPresenterInfo $items, VirtualEventPresenterInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualEventPresenterInfo> $value
     * @return self
     ...
     * 
     * @param VirtualEventPresenterInfo $item
     * @return self
     */
    public function addValue(VirtualEventPresenterInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return VirtualEventPresenterInfo|null
     */
     ...
     * 
     * @return \ArrayIterator<int, VirtualEventPresenterInfo>
     */
