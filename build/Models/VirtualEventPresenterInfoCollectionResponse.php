 ...
 */
class VirtualEventPresenterInfoCollectionResponse
{
    /**
     ...
     * 
     * @param VirtualEventPresenterInfo ...$items Variable number of VirtualEventPresenterInfo items
     * @return self
     */
    public function setValue(VirtualEventPresenterInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
