...
/**
 * Collection response for AccessReviewInstanceDecisionItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewInstanceDecisionItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessReviewInstanceDecisionItem[] $items
     * @return self
     */
    public function setValue(array|AccessReviewInstanceDecisionItem $items, AccessReviewInstanceDecisionItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewInstanceDecisionItem> $value
     * @return self
     ...
     * 
     * @param AccessReviewInstanceDecisionItem $item
     * @return self
     */
    public function addValue(AccessReviewInstanceDecisionItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewInstanceDecisionItem>
     */
