...
/**
 * Collection response for WorkbookPivotTable
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookPivotTableCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WorkbookPivotTable[] $items
     * @return self
     */
    public function setValue(array|WorkbookPivotTable $items, WorkbookPivotTable ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookPivotTable> $value
     * @return self
     ...
     * 
     * @param WorkbookPivotTable $item
     * @return self
     */
    public function addValue(WorkbookPivotTable $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookPivotTable>
     */
