...
/**
 * Collection response for AndroidGeneralDeviceConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AndroidGeneralDeviceConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AndroidGeneralDeviceConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param AndroidGeneralDeviceConfiguration[] $items
     * @return self
     */
    public function setValue(array|AndroidGeneralDeviceConfiguration $items, AndroidGeneralDeviceConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AndroidGeneralDeviceConfiguration> $value
     * @return self
     ...
     * 
     * @param AndroidGeneralDeviceConfiguration $item
     * @return self
     */
    public function addValue(AndroidGeneralDeviceConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AndroidGeneralDeviceConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AndroidGeneralDeviceConfiguration>
     */
