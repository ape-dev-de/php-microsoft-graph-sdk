...
/**
 * Collection response for RatingJapanMoviesType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RatingJapanMoviesTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RatingJapanMoviesType[]
     */
    private array $value = [];
     ...
     * 
     * @param RatingJapanMoviesType[] $items
     * @return self
     */
    public function setValue(array|RatingJapanMoviesType $items, RatingJapanMoviesType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RatingJapanMoviesType> $value
     * @return self
     ...
     * 
     * @param RatingJapanMoviesType $item
     * @return self
     */
    public function addValue(RatingJapanMoviesType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RatingJapanMoviesType>
     */
