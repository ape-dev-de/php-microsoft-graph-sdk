...
/**
 * Collection response for SearchBookmark
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SearchBookmarkCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SearchBookmark[]
     */
     ...
     * 
     * @param SearchBookmark[] $items
     * @return self
     */
    public function setValue(array|SearchBookmark $items, SearchBookmark ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SearchBookmark> $value
     * @return self
     ...
     * 
     * @param SearchBookmark $item
     * @return self
     */
    public function addValue(SearchBookmark $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SearchBookmark>
     */
