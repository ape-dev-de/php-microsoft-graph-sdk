...
/**
 * Collection response for WorkbookTableColumnCollectionResponse
 */
class WorkbookTableColumnCollectionResponseCollectionResponse
{
    /**
     * @var WorkbookTableColumnCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookTableColumnCollectionResponse ...$items Variable number of WorkbookTableColumnCollectionResponse items
     * @return self
     */
    public function setValue(WorkbookTableColumnCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WorkbookTableColumnCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WorkbookTableColumnCollectionResponse $item
     * @return self
     */
    public function addValue(WorkbookTableColumnCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
