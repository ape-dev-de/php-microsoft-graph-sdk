 ...
 */
class AppHostedMediaConfigCollectionResponse
{
    /**
     ...
     * 
     * @param AppHostedMediaConfig ...$items Variable number of AppHostedMediaConfig items
     * @return self
     */
    public function setValue(AppHostedMediaConfig ...$items): self
    {
        $this->value = $items;
        return $this;
    }
