...
/**
 * Collection response for AppHostedMediaConfig
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppHostedMediaConfigCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AppHostedMediaConfig[]
     */
    private array $value = [];
     ...
     * 
     * @param AppHostedMediaConfig[] $items
     * @return self
     */
    public function setValue(array|AppHostedMediaConfig $items, AppHostedMediaConfig ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppHostedMediaConfig> $value
     * @return self
     ...
     * 
     * @param AppHostedMediaConfig $item
     * @return self
     */
    public function addValue(AppHostedMediaConfig $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AppHostedMediaConfig|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AppHostedMediaConfig>
     */
