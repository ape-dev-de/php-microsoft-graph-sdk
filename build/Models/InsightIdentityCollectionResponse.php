 ...
 */
class InsightIdentityCollectionResponse
{
    /**
     * @var InsightIdentity[]
     */
     ...
     * 
     * @param InsightIdentity ...$items Variable number of InsightIdentity items
     * @return self
     */
    public function setValue(InsightIdentity ...$items): self
    {
        $this->value = $items;
        return $this;
    }
