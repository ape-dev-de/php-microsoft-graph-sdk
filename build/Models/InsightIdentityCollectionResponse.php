...
/**
 * Collection response for InsightIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InsightIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var InsightIdentity[]
     */
     ...
     * 
     * @param InsightIdentity[] $items
     * @return self
     */
    public function setValue(array|InsightIdentity $items, InsightIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InsightIdentity> $value
     * @return self
     ...
     * 
     * @param InsightIdentity $item
     * @return self
     */
    public function addValue(InsightIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, InsightIdentity>
     */
