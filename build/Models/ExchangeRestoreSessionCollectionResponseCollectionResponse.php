...
/**
 * Collection response for ExchangeRestoreSessionCollectionResponse
 */
class ExchangeRestoreSessionCollectionResponseCollectionResponse
{
    /**
     * @var ExchangeRestoreSessionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ExchangeRestoreSessionCollectionResponse ...$items Variable number of ExchangeRestoreSessionCollectionResponse items
     * @return self
     */
    public function setValue(ExchangeRestoreSessionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ExchangeRestoreSessionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ExchangeRestoreSessionCollectionResponse $item
     * @return self
     */
    public function addValue(ExchangeRestoreSessionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
