...
/**
 * Collection response for ConversationThread
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConversationThreadCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ConversationThread[] $items
     * @return self
     */
    public function setValue(array|ConversationThread $items, ConversationThread ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConversationThread> $value
     * @return self
     ...
     * 
     * @param ConversationThread $item
     * @return self
     */
    public function addValue(ConversationThread $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConversationThread>
     */
