...
/**
 * Collection response for SignInContext
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SignInContextCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SignInContext[]
     */
     ...
     * 
     * @param SignInContext[] $items
     * @return self
     */
    public function setValue(array|SignInContext $items, SignInContext ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SignInContext> $value
     * @return self
     ...
     * 
     * @param SignInContext $item
     * @return self
     */
    public function addValue(SignInContext $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SignInContext>
     */
