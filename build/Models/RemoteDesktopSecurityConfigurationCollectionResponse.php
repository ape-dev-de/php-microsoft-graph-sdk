 ...
 */
class RemoteDesktopSecurityConfigurationCollectionResponse
{
    /**
     ...
     * 
     * @param RemoteDesktopSecurityConfiguration ...$items Variable number of RemoteDesktopSecurityConfiguration items
     * @return self
     */
    public function setValue(RemoteDesktopSecurityConfiguration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
