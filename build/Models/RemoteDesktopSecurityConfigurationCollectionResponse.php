...
/**
 * Collection response for RemoteDesktopSecurityConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RemoteDesktopSecurityConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RemoteDesktopSecurityConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param RemoteDesktopSecurityConfiguration[] $items
     * @return self
     */
    public function setValue(array|RemoteDesktopSecurityConfiguration $items, RemoteDesktopSecurityConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RemoteDesktopSecurityConfiguration> $value
     * @return self
     ...
     * 
     * @param RemoteDesktopSecurityConfiguration $item
     * @return self
     */
    public function addValue(RemoteDesktopSecurityConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RemoteDesktopSecurityConfiguration>
     */
