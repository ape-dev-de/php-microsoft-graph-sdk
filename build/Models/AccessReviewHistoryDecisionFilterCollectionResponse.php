...
/**
 * Collection response for AccessReviewHistoryDecisionFilter
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewHistoryDecisionFilterCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return AccessReviewHistoryDecisionFilter[]
     */
     ...
     * 
     * @param AccessReviewHistoryDecisionFilter[] $items
     * @return self
     */
    public function setValue(array|AccessReviewHistoryDecisionFilter $items, AccessReviewHistoryDecisionFilter ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewHistoryDecisionFilter> $value
     * @return self
     ...
     * 
     * @param AccessReviewHistoryDecisionFilter $item
     * @return self
     */
    public function addValue(AccessReviewHistoryDecisionFilter $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessReviewHistoryDecisionFilter|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewHistoryDecisionFilter>
     */
