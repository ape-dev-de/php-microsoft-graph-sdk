...
/**
 * AccessReviewHistoryDecisionFilterCollectionResponse - Collection response
 */
class AccessReviewHistoryDecisionFilterCollectionResponse
{
    /**
     * @var array<int, AccessReviewHistoryDecisionFilter>
     */
    public array $value = [];
