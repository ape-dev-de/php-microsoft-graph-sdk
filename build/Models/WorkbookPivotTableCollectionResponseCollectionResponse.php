...
/**
 * Collection response for WorkbookPivotTableCollectionResponse
 */
class WorkbookPivotTableCollectionResponseCollectionResponse
{
    /**
     * @var WorkbookPivotTableCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookPivotTableCollectionResponse ...$items Variable number of WorkbookPivotTableCollectionResponse items
     * @return self
     */
    public function setValue(WorkbookPivotTableCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WorkbookPivotTableCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WorkbookPivotTableCollectionResponse $item
     * @return self
     */
    public function addValue(WorkbookPivotTableCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
