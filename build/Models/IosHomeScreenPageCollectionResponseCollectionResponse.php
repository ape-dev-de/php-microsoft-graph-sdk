...
/**
 * Collection response for IosHomeScreenPageCollectionResponse
 */
class IosHomeScreenPageCollectionResponseCollectionResponse
{
    /**
     * @var IosHomeScreenPageCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IosHomeScreenPageCollectionResponse ...$items Variable number of IosHomeScreenPageCollectionResponse items
     * @return self
     */
    public function setValue(IosHomeScreenPageCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IosHomeScreenPageCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IosHomeScreenPageCollectionResponse $item
     * @return self
     */
    public function addValue(IosHomeScreenPageCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
