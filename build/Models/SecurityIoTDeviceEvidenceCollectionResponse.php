...
/**
 * Collection response for SecurityIoTDeviceEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityIoTDeviceEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityIoTDeviceEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityIoTDeviceEvidence[]
     */
     ...
     * 
     * @param SecurityIoTDeviceEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityIoTDeviceEvidence $items, SecurityIoTDeviceEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityIoTDeviceEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityIoTDeviceEvidence $item
     * @return self
     */
    public function addValue(SecurityIoTDeviceEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityIoTDeviceEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityIoTDeviceEvidence>
     */
