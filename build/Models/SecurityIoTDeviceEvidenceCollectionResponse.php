 ...
 */
class SecurityIoTDeviceEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityIoTDeviceEvidence ...$items Variable number of SecurityIoTDeviceEvidence items
     * @return self
     */
    public function setValue(SecurityIoTDeviceEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
