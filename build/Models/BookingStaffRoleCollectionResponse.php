...
/**
 * Collection response for BookingStaffRole
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingStaffRoleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BookingStaffRole[]
     */
    private array $value = [];
     ...
     * 
     * @param BookingStaffRole[] $items
     * @return self
     */
    public function setValue(array|BookingStaffRole $items, BookingStaffRole ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingStaffRole> $value
     * @return self
     ...
     * 
     * @param BookingStaffRole $item
     * @return self
     */
    public function addValue(BookingStaffRole $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BookingStaffRole>
     */
