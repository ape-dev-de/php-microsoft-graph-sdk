...
/**
 * Collection response for SecurityAlertCollectionResponse
 */
class SecurityAlertCollectionResponseCollectionResponse
{
    /**
     * @var SecurityAlertCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityAlertCollectionResponse ...$items Variable number of SecurityAlertCollectionResponse items
     * @return self
     */
    public function setValue(SecurityAlertCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityAlertCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityAlertCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityAlertCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
