...
class CrossTenantAccessPolicyB2BSettingCollectionResponse
{
     ...
     * 
     * @param CrossTenantAccessPolicyB2BSetting ...$items Variable number of CrossTenantAccessPolicyB2BSetting items
     * @return self
     */
    public function setValue(CrossTenantAccessPolicyB2BSetting ...$items): self
    {
        $this->value = $items;
        return $this;
    }
