...
/**
 * Collection response for CrossTenantAccessPolicyB2BSetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CrossTenantAccessPolicyB2BSettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CrossTenantAccessPolicyB2BSetting[]
     */
    private array $value = [];
     ...
     * 
     * @param CrossTenantAccessPolicyB2BSetting[] $items
     * @return self
     */
    public function setValue(array|CrossTenantAccessPolicyB2BSetting $items, CrossTenantAccessPolicyB2BSetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CrossTenantAccessPolicyB2BSetting> $value
     * @return self
     ...
     * 
     * @param CrossTenantAccessPolicyB2BSetting $item
     * @return self
     */
    public function addValue(CrossTenantAccessPolicyB2BSetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CrossTenantAccessPolicyB2BSetting>
     */
