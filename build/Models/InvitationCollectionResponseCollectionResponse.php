...
/**
 * Collection response for InvitationCollectionResponse
 */
class InvitationCollectionResponseCollectionResponse
{
    /**
     * @var InvitationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param InvitationCollectionResponse ...$items Variable number of InvitationCollectionResponse items
     * @return self
     */
    public function setValue(InvitationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<InvitationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param InvitationCollectionResponse $item
     * @return self
     */
    public function addValue(InvitationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
