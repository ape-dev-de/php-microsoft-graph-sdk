...
/**
 * Collection response for AlertTrigger
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AlertTriggerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AlertTrigger[]
     */
     ...
     * 
     * @param AlertTrigger[] $items
     * @return self
     */
    public function setValue(array|AlertTrigger $items, AlertTrigger ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AlertTrigger> $value
     * @return self
     ...
     * 
     * @param AlertTrigger $item
     * @return self
     */
    public function addValue(AlertTrigger $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AlertTrigger>
     */
