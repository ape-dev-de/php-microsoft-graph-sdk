...
/**
 * Collection response for CallRecordsNetworkConnectionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsNetworkConnectionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsNetworkConnectionType[]
     */
    private array $value = [];
     ...
     * 
     * @return CallRecordsNetworkConnectionType[]
     */
     ...
     * 
     * @param CallRecordsNetworkConnectionType[] $items
     * @return self
     */
    public function setValue(array|CallRecordsNetworkConnectionType $items, CallRecordsNetworkConnectionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsNetworkConnectionType> $value
     * @return self
     ...
     * 
     * @param CallRecordsNetworkConnectionType $item
     * @return self
     */
    public function addValue(CallRecordsNetworkConnectionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsNetworkConnectionType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsNetworkConnectionType>
     */
