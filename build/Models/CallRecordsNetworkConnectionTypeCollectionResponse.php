...
/**
 * CallRecordsNetworkConnectionTypeCollectionResponse - Collection response
 */
class CallRecordsNetworkConnectionTypeCollectionResponse
{
    /**
     * @var array<int, CallRecordsNetworkConnectionType>
     */
    public array $value = [];
