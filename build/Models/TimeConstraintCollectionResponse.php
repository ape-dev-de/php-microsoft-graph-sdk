 ...
 */
class TimeConstraintCollectionResponse
{
    /**
     * @var TimeConstraint[]
     */
     ...
     * 
     * @param TimeConstraint ...$items Variable number of TimeConstraint items
     * @return self
     */
    public function setValue(TimeConstraint ...$items): self
    {
        $this->value = $items;
        return $this;
    }
