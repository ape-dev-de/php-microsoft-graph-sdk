...
/**
 * Collection response for TimeConstraint
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TimeConstraintCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TimeConstraint[]
     */
     ...
     * 
     * @param TimeConstraint[] $items
     * @return self
     */
    public function setValue(array|TimeConstraint $items, TimeConstraint ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TimeConstraint> $value
     * @return self
     ...
     * 
     * @param TimeConstraint $item
     * @return self
     */
    public function addValue(TimeConstraint $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TimeConstraint>
     */
