...
/**
 * Collection response for BookingAppointment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingAppointmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param BookingAppointment[] $items
     * @return self
     */
    public function setValue(array|BookingAppointment $items, BookingAppointment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingAppointment> $value
     * @return self
     ...
     * 
     * @param BookingAppointment $item
     * @return self
     */
    public function addValue(BookingAppointment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BookingAppointment>
     */
