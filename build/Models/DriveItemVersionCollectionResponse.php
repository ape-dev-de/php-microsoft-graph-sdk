...
/**
 * Collection response for DriveItemVersion
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DriveItemVersionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DriveItemVersion[] $items
     * @return self
     */
    public function setValue(array|DriveItemVersion $items, DriveItemVersion ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DriveItemVersion> $value
     * @return self
     ...
     * 
     * @param DriveItemVersion $item
     * @return self
     */
    public function addValue(DriveItemVersion $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DriveItemVersion>
     */
