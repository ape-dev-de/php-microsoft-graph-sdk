...
/**
 * Collection response for CommunicationsApplicationIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CommunicationsApplicationIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CommunicationsApplicationIdentity[]
     */
    private array $value = [];
     ...
     * 
     * @param CommunicationsApplicationIdentity[] $items
     * @return self
     */
    public function setValue(array|CommunicationsApplicationIdentity $items, CommunicationsApplicationIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CommunicationsApplicationIdentity> $value
     * @return self
     ...
     * 
     * @param CommunicationsApplicationIdentity $item
     * @return self
     */
    public function addValue(CommunicationsApplicationIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CommunicationsApplicationIdentity|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CommunicationsApplicationIdentity>
     */
