 ...
 */
class CommunicationsApplicationIdentityCollectionResponse
{
    /**
     ...
     * 
     * @param CommunicationsApplicationIdentity ...$items Variable number of CommunicationsApplicationIdentity items
     * @return self
     */
    public function setValue(CommunicationsApplicationIdentity ...$items): self
    {
        $this->value = $items;
        return $this;
    }
