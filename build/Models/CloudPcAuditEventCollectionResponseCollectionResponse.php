...
/**
 * Collection response for CloudPcAuditEventCollectionResponse
 */
class CloudPcAuditEventCollectionResponseCollectionResponse
{
    /**
     * @var CloudPcAuditEventCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudPcAuditEventCollectionResponse ...$items Variable number of CloudPcAuditEventCollectionResponse items
     * @return self
     */
    public function setValue(CloudPcAuditEventCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CloudPcAuditEventCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CloudPcAuditEventCollectionResponse $item
     * @return self
     */
    public function addValue(CloudPcAuditEventCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
