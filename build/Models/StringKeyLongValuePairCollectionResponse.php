...
/**
 * Collection response for StringKeyLongValuePair
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class StringKeyLongValuePairCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param StringKeyLongValuePair[] $items
     * @return self
     */
    public function setValue(array|StringKeyLongValuePair $items, StringKeyLongValuePair ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<StringKeyLongValuePair> $value
     * @return self
     ...
     * 
     * @param StringKeyLongValuePair $item
     * @return self
     */
    public function addValue(StringKeyLongValuePair $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return StringKeyLongValuePair|null
     */
     ...
     * 
     * @return \ArrayIterator<int, StringKeyLongValuePair>
     */
