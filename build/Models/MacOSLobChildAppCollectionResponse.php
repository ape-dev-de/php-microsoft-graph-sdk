...
/**
 * Collection response for MacOSLobChildApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MacOSLobChildAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MacOSLobChildApp[] $items
     * @return self
     */
    public function setValue(array|MacOSLobChildApp $items, MacOSLobChildApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MacOSLobChildApp> $value
     * @return self
     ...
     * 
     * @param MacOSLobChildApp $item
     * @return self
     */
    public function addValue(MacOSLobChildApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MacOSLobChildApp>
     */
