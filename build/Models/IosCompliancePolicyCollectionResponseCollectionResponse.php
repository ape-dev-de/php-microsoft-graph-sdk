...
/**
 * Collection response for IosCompliancePolicyCollectionResponse
 */
class IosCompliancePolicyCollectionResponseCollectionResponse
{
    /**
     * @var IosCompliancePolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IosCompliancePolicyCollectionResponse ...$items Variable number of IosCompliancePolicyCollectionResponse items
     * @return self
     */
    public function setValue(IosCompliancePolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IosCompliancePolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IosCompliancePolicyCollectionResponse $item
     * @return self
     */
    public function addValue(IosCompliancePolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
