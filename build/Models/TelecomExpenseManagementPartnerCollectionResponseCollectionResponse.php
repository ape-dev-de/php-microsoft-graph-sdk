...
/**
 * Collection response for TelecomExpenseManagementPartnerCollectionResponse
 */
class TelecomExpenseManagementPartnerCollectionResponseCollectionResponse
{
    /**
     * @var TelecomExpenseManagementPartnerCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TelecomExpenseManagementPartnerCollectionResponse ...$items Variable number of TelecomExpenseManagementPartnerCollectionResponse items
     * @return self
     */
    public function setValue(TelecomExpenseManagementPartnerCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TelecomExpenseManagementPartnerCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TelecomExpenseManagementPartnerCollectionResponse $item
     * @return self
     */
    public function addValue(TelecomExpenseManagementPartnerCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
