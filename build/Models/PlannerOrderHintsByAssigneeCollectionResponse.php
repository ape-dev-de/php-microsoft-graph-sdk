...
/**
 * Collection response for PlannerOrderHintsByAssignee
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerOrderHintsByAssigneeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PlannerOrderHintsByAssignee[] $items
     * @return self
     */
    public function setValue(array|PlannerOrderHintsByAssignee $items, PlannerOrderHintsByAssignee ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PlannerOrderHintsByAssignee> $value
     * @return self
     ...
     * 
     * @param PlannerOrderHintsByAssignee $item
     * @return self
     */
    public function addValue(PlannerOrderHintsByAssignee $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PlannerOrderHintsByAssignee>
     */
