...
/**
 * PlannerOrderHintsByAssigneeCollectionResponse - Collection response
 */
class PlannerOrderHintsByAssigneeCollectionResponse
{
    /**
     * @var array<int, PlannerOrderHintsByAssignee>
     */
    public array $value = [];
