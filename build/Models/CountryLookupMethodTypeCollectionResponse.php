...
/**
 * Collection response for CountryLookupMethodType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CountryLookupMethodTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CountryLookupMethodType[]
     */
    private array $value = [];
     ...
     * 
     * @return CountryLookupMethodType[]
     */
     ...
     * 
     * @param CountryLookupMethodType[] $items
     * @return self
     */
    public function setValue(array|CountryLookupMethodType $items, CountryLookupMethodType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CountryLookupMethodType> $value
     * @return self
     ...
     * 
     * @param CountryLookupMethodType $item
     * @return self
     */
    public function addValue(CountryLookupMethodType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CountryLookupMethodType>
     */
