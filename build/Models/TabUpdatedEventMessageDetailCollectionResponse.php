...
/**
 * Collection response for TabUpdatedEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TabUpdatedEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TabUpdatedEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param TabUpdatedEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|TabUpdatedEventMessageDetail $items, TabUpdatedEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TabUpdatedEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param TabUpdatedEventMessageDetail $item
     * @return self
     */
    public function addValue(TabUpdatedEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TabUpdatedEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TabUpdatedEventMessageDetail>
     */
