 ...
 */
class TabUpdatedEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param TabUpdatedEventMessageDetail ...$items Variable number of TabUpdatedEventMessageDetail items
     * @return self
     */
    public function setValue(TabUpdatedEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
