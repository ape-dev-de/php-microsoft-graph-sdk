 ...
 */
class CallRecordsParticipantBaseCollectionResponse
{
    /**
     ...
     * 
     * @param CallRecordsParticipantBase ...$items Variable number of CallRecordsParticipantBase items
     * @return self
     */
    public function setValue(CallRecordsParticipantBase ...$items): self
    {
        $this->value = $items;
        return $this;
    }
