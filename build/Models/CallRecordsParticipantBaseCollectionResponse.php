...
/**
 * Collection response for CallRecordsParticipantBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsParticipantBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsParticipantBase[]
     */
    private array $value = [];
     ...
     * 
     * @return CallRecordsParticipantBase[]
     */
     ...
     * 
     * @param CallRecordsParticipantBase[] $items
     * @return self
     */
    public function setValue(array|CallRecordsParticipantBase $items, CallRecordsParticipantBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsParticipantBase> $value
     * @return self
     ...
     * 
     * @param CallRecordsParticipantBase $item
     * @return self
     */
    public function addValue(CallRecordsParticipantBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsParticipantBase|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsParticipantBase>
     */
