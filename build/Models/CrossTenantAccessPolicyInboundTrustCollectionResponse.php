...
/**
 * Collection response for CrossTenantAccessPolicyInboundTrust
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CrossTenantAccessPolicyInboundTrustCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CrossTenantAccessPolicyInboundTrust[]
     */
    private array $value = [];
     ...
     * 
     * @param CrossTenantAccessPolicyInboundTrust[] $items
     * @return self
     */
    public function setValue(array|CrossTenantAccessPolicyInboundTrust $items, CrossTenantAccessPolicyInboundTrust ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CrossTenantAccessPolicyInboundTrust> $value
     * @return self
     ...
     * 
     * @param CrossTenantAccessPolicyInboundTrust $item
     * @return self
     */
    public function addValue(CrossTenantAccessPolicyInboundTrust $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CrossTenantAccessPolicyInboundTrust>
     */
