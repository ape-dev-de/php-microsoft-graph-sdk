 ...
 */
class CrossTenantAccessPolicyInboundTrustCollectionResponse
{
    /**
     ...
     * 
     * @param CrossTenantAccessPolicyInboundTrust ...$items Variable number of CrossTenantAccessPolicyInboundTrust items
     * @return self
     */
    public function setValue(CrossTenantAccessPolicyInboundTrust ...$items): self
    {
        $this->value = $items;
        return $this;
    }
