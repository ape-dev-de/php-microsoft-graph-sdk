...
/**
 * Collection response for SigninFrequencyType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SigninFrequencyTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SigninFrequencyType[]
     */
    private array $value = [];
     ...
     * 
     * @param SigninFrequencyType[] $items
     * @return self
     */
    public function setValue(array|SigninFrequencyType $items, SigninFrequencyType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SigninFrequencyType> $value
     * @return self
     ...
     * 
     * @param SigninFrequencyType $item
     * @return self
     */
    public function addValue(SigninFrequencyType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SigninFrequencyType>
     */
