...
/**
 * Collection response for ContentCustomization
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ContentCustomizationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ContentCustomization[]
     */
    private array $value = [];
     ...
     * 
     * @param ContentCustomization[] $items
     * @return self
     */
    public function setValue(array|ContentCustomization $items, ContentCustomization ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ContentCustomization> $value
     * @return self
     ...
     * 
     * @param ContentCustomization $item
     * @return self
     */
    public function addValue(ContentCustomization $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ContentCustomization>
     */
