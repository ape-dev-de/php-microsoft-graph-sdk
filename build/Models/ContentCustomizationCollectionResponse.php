 ...
 */
class ContentCustomizationCollectionResponse
{
    /**
     ...
     * 
     * @param ContentCustomization ...$items Variable number of ContentCustomization items
     * @return self
     */
    public function setValue(ContentCustomization ...$items): self
    {
        $this->value = $items;
        return $this;
    }
