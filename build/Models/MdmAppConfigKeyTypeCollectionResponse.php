...
/**
 * Collection response for MdmAppConfigKeyType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MdmAppConfigKeyTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MdmAppConfigKeyType[]
     */
    private array $value = [];
     ...
     * 
     * @param MdmAppConfigKeyType[] $items
     * @return self
     */
    public function setValue(array|MdmAppConfigKeyType $items, MdmAppConfigKeyType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MdmAppConfigKeyType> $value
     * @return self
     ...
     * 
     * @param MdmAppConfigKeyType $item
     * @return self
     */
    public function addValue(MdmAppConfigKeyType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MdmAppConfigKeyType>
     */
