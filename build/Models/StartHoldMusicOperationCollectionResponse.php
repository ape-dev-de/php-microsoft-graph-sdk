...
/**
 * Collection response for StartHoldMusicOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class StartHoldMusicOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param StartHoldMusicOperation[] $items
     * @return self
     */
    public function setValue(array|StartHoldMusicOperation $items, StartHoldMusicOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<StartHoldMusicOperation> $value
     * @return self
     ...
     * 
     * @param StartHoldMusicOperation $item
     * @return self
     */
    public function addValue(StartHoldMusicOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return StartHoldMusicOperation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, StartHoldMusicOperation>
     */
