...
/**
 * Collection response for EducationUser
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationUserCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationUser[]
     */
     ...
     * 
     * @param EducationUser[] $items
     * @return self
     */
    public function setValue(array|EducationUser $items, EducationUser ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationUser> $value
     * @return self
     ...
     * 
     * @param EducationUser $item
     * @return self
     */
    public function addValue(EducationUser $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationUser>
     */
