...
/**
 * Collection response for SharingDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SharingDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SharingDetail[]
     */
     ...
     * 
     * @param SharingDetail[] $items
     * @return self
     */
    public function setValue(array|SharingDetail $items, SharingDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SharingDetail> $value
     * @return self
     ...
     * 
     * @param SharingDetail $item
     * @return self
     */
    public function addValue(SharingDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SharingDetail>
     */
