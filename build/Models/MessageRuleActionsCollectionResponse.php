...
/**
 * Collection response for MessageRuleActions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MessageRuleActionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MessageRuleActions[] $items
     * @return self
     */
    public function setValue(array|MessageRuleActions $items, MessageRuleActions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MessageRuleActions> $value
     * @return self
     ...
     * 
     * @param MessageRuleActions $item
     * @return self
     */
    public function addValue(MessageRuleActions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MessageRuleActions>
     */
