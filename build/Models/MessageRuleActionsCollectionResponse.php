 ...
 */
class MessageRuleActionsCollectionResponse
{
    /**
     ...
     * 
     * @param MessageRuleActions ...$items Variable number of MessageRuleActions items
     * @return self
     */
    public function setValue(MessageRuleActions ...$items): self
    {
        $this->value = $items;
        return $this;
    }
