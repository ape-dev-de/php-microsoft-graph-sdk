...
/**
 * Collection response for EducationFeedbackOutcomeCollectionResponse
 */
class EducationFeedbackOutcomeCollectionResponseCollectionResponse
{
    /**
     * @var EducationFeedbackOutcomeCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationFeedbackOutcomeCollectionResponse ...$items Variable number of EducationFeedbackOutcomeCollectionResponse items
     * @return self
     */
    public function setValue(EducationFeedbackOutcomeCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EducationFeedbackOutcomeCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EducationFeedbackOutcomeCollectionResponse $item
     * @return self
     */
    public function addValue(EducationFeedbackOutcomeCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
