...
/**
 * Collection response for CommsNotificationCollectionResponse
 */
class CommsNotificationCollectionResponseCollectionResponse
{
    /**
     * @var CommsNotificationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CommsNotificationCollectionResponse ...$items Variable number of CommsNotificationCollectionResponse items
     * @return self
     */
    public function setValue(CommsNotificationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CommsNotificationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CommsNotificationCollectionResponse $item
     * @return self
     */
    public function addValue(CommsNotificationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
