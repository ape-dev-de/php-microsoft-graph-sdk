...
/**
 * Collection response for AttackSimulationTrainingUserCoverage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttackSimulationTrainingUserCoverageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AttackSimulationTrainingUserCoverage[]
     */
    private array $value = [];
     ...
     * 
     * @param AttackSimulationTrainingUserCoverage[] $items
     * @return self
     */
    public function setValue(array|AttackSimulationTrainingUserCoverage $items, AttackSimulationTrainingUserCoverage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttackSimulationTrainingUserCoverage> $value
     * @return self
     ...
     * 
     * @param AttackSimulationTrainingUserCoverage $item
     * @return self
     */
    public function addValue(AttackSimulationTrainingUserCoverage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AttackSimulationTrainingUserCoverage|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AttackSimulationTrainingUserCoverage>
     */
