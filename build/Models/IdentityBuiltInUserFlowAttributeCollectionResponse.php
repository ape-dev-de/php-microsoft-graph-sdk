...
/**
 * Collection response for IdentityBuiltInUserFlowAttribute
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityBuiltInUserFlowAttributeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityBuiltInUserFlowAttribute[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityBuiltInUserFlowAttribute[] $items
     * @return self
     */
    public function setValue(array|IdentityBuiltInUserFlowAttribute $items, IdentityBuiltInUserFlowAttribute ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityBuiltInUserFlowAttribute> $value
     * @return self
     ...
     * 
     * @param IdentityBuiltInUserFlowAttribute $item
     * @return self
     */
    public function addValue(IdentityBuiltInUserFlowAttribute $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityBuiltInUserFlowAttribute|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityBuiltInUserFlowAttribute>
     */
