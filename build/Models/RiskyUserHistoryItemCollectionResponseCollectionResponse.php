...
/**
 * Collection response for RiskyUserHistoryItemCollectionResponse
 */
class RiskyUserHistoryItemCollectionResponseCollectionResponse
{
    /**
     * @var RiskyUserHistoryItemCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RiskyUserHistoryItemCollectionResponse ...$items Variable number of RiskyUserHistoryItemCollectionResponse items
     * @return self
     */
    public function setValue(RiskyUserHistoryItemCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RiskyUserHistoryItemCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RiskyUserHistoryItemCollectionResponse $item
     * @return self
     */
    public function addValue(RiskyUserHistoryItemCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
