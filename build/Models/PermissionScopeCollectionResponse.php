...
/**
 * Collection response for PermissionScope
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PermissionScopeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PermissionScope[]
     */
     ...
     * 
     * @param PermissionScope[] $items
     * @return self
     */
    public function setValue(array|PermissionScope $items, PermissionScope ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PermissionScope> $value
     * @return self
     ...
     * 
     * @param PermissionScope $item
     * @return self
     */
    public function addValue(PermissionScope $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PermissionScope>
     */
