...
/**
 * Collection response for CloudPcAuditEvent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcAuditEventCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CloudPcAuditEvent[] $items
     * @return self
     */
    public function setValue(array|CloudPcAuditEvent $items, CloudPcAuditEvent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcAuditEvent> $value
     * @return self
     ...
     * 
     * @param CloudPcAuditEvent $item
     * @return self
     */
    public function addValue(CloudPcAuditEvent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcAuditEvent>
     */
