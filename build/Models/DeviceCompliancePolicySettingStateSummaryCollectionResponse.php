...
/**
 * Collection response for DeviceCompliancePolicySettingStateSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceCompliancePolicySettingStateSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceCompliancePolicySettingStateSummary[] $items
     * @return self
     */
    public function setValue(array|DeviceCompliancePolicySettingStateSummary $items, DeviceCompliancePolicySettingStateSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceCompliancePolicySettingStateSummary> $value
     * @return self
     ...
     * 
     * @param DeviceCompliancePolicySettingStateSummary $item
     * @return self
     */
    public function addValue(DeviceCompliancePolicySettingStateSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceCompliancePolicySettingStateSummary>
     */
