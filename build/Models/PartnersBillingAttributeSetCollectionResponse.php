...
/**
 * PartnersBillingAttributeSetCollectionResponse - Collection response
 */
class PartnersBillingAttributeSetCollectionResponse
{
    /**
     * @var array<int, PartnersBillingAttributeSet>
     */
    public array $value = [];
