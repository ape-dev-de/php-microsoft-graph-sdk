...
/**
 * Collection response for PartnersBillingAttributeSet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PartnersBillingAttributeSetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PartnersBillingAttributeSet[]
     */
    private array $value = [];
     ...
     * 
     * @return PartnersBillingAttributeSet[]
     */
     ...
     * 
     * @param PartnersBillingAttributeSet[] $items
     * @return self
     */
    public function setValue(array|PartnersBillingAttributeSet $items, PartnersBillingAttributeSet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PartnersBillingAttributeSet> $value
     * @return self
     ...
     * 
     * @param PartnersBillingAttributeSet $item
     * @return self
     */
    public function addValue(PartnersBillingAttributeSet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PartnersBillingAttributeSet|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PartnersBillingAttributeSet>
     */
