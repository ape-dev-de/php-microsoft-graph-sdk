...
/**
 * Collection response for IPv6Range
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IPv6RangeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IPv6Range[]
     */
     ...
     * 
     * @param IPv6Range[] $items
     * @return self
     */
    public function setValue(array|IPv6Range $items, IPv6Range ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param IPv6Range $item
     * @return self
     */
    public function addValue(IPv6Range $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IPv6Range>
     */
