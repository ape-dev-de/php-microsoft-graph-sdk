...
/**
 * Collection response for ChangeNotificationCollectionResponse
 */
class ChangeNotificationCollectionResponseCollectionResponse
{
    /**
     * @var ChangeNotificationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ChangeNotificationCollectionResponse ...$items Variable number of ChangeNotificationCollectionResponse items
     * @return self
     */
    public function setValue(ChangeNotificationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ChangeNotificationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ChangeNotificationCollectionResponse $item
     * @return self
     */
    public function addValue(ChangeNotificationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
