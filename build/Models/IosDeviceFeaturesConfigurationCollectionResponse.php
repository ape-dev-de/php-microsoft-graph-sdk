...
/**
 * Collection response for IosDeviceFeaturesConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosDeviceFeaturesConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IosDeviceFeaturesConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param IosDeviceFeaturesConfiguration[] $items
     * @return self
     */
    public function setValue(array|IosDeviceFeaturesConfiguration $items, IosDeviceFeaturesConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosDeviceFeaturesConfiguration> $value
     * @return self
     ...
     * 
     * @param IosDeviceFeaturesConfiguration $item
     * @return self
     */
    public function addValue(IosDeviceFeaturesConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IosDeviceFeaturesConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IosDeviceFeaturesConfiguration>
     */
