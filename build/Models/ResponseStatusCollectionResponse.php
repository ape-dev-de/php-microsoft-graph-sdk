 ...
 */
class ResponseStatusCollectionResponse
{
    /**
     * @var ResponseStatus[]
     */
     ...
     * 
     * @param ResponseStatus ...$items Variable number of ResponseStatus items
     * @return self
     */
    public function setValue(ResponseStatus ...$items): self
    {
        $this->value = $items;
        return $this;
    }
