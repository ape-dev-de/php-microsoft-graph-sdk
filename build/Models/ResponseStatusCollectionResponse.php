...
/**
 * Collection response for ResponseStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ResponseStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ResponseStatus[]
     */
     ...
     * 
     * @param ResponseStatus[] $items
     * @return self
     */
    public function setValue(array|ResponseStatus $items, ResponseStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ResponseStatus> $value
     * @return self
     ...
     * 
     * @param ResponseStatus $item
     * @return self
     */
    public function addValue(ResponseStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ResponseStatus>
     */
