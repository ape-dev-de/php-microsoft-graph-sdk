...
/**
 * Collection response for DeviceInstallStateCollectionResponse
 */
class DeviceInstallStateCollectionResponseCollectionResponse
{
    /**
     * @var DeviceInstallStateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceInstallStateCollectionResponse ...$items Variable number of DeviceInstallStateCollectionResponse items
     * @return self
     */
    public function setValue(DeviceInstallStateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeviceInstallStateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeviceInstallStateCollectionResponse $item
     * @return self
     */
    public function addValue(DeviceInstallStateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
