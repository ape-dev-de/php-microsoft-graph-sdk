...
/**
 * SecurityActionAfterRetentionPeriodCollectionResponse - Collection response
 */
class SecurityActionAfterRetentionPeriodCollectionResponse
{
    /**
     * @var array<int, SecurityActionAfterRetentionPeriod>
     */
    public array $value = [];
