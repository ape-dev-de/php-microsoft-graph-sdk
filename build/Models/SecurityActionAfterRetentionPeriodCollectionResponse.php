...
/**
 * Collection response for SecurityActionAfterRetentionPeriod
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityActionAfterRetentionPeriodCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityActionAfterRetentionPeriod[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityActionAfterRetentionPeriod[]
     */
     ...
     * 
     * @param SecurityActionAfterRetentionPeriod[] $items
     * @return self
     */
    public function setValue(array|SecurityActionAfterRetentionPeriod $items, SecurityActionAfterRetentionPeriod ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityActionAfterRetentionPeriod> $value
     * @return self
     ...
     * 
     * @param SecurityActionAfterRetentionPeriod $item
     * @return self
     */
    public function addValue(SecurityActionAfterRetentionPeriod $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityActionAfterRetentionPeriod|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityActionAfterRetentionPeriod>
     */
