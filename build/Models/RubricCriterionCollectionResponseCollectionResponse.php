...
/**
 * Collection response for RubricCriterionCollectionResponse
 */
class RubricCriterionCollectionResponseCollectionResponse
{
    /**
     * @var RubricCriterionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RubricCriterionCollectionResponse ...$items Variable number of RubricCriterionCollectionResponse items
     * @return self
     */
    public function setValue(RubricCriterionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RubricCriterionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RubricCriterionCollectionResponse $item
     * @return self
     */
    public function addValue(RubricCriterionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
