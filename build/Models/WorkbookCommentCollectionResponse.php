...
/**
 * Collection response for WorkbookComment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookCommentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookComment[]
     */
     ...
     * 
     * @param WorkbookComment[] $items
     * @return self
     */
    public function setValue(array|WorkbookComment $items, WorkbookComment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookComment> $value
     * @return self
     ...
     * 
     * @param WorkbookComment $item
     * @return self
     */
    public function addValue(WorkbookComment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookComment>
     */
