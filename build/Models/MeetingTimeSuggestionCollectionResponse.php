...
/**
 * Collection response for MeetingTimeSuggestion
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MeetingTimeSuggestionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MeetingTimeSuggestion[] $items
     * @return self
     */
    public function setValue(array|MeetingTimeSuggestion $items, MeetingTimeSuggestion ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MeetingTimeSuggestion> $value
     * @return self
     ...
     * 
     * @param MeetingTimeSuggestion $item
     * @return self
     */
    public function addValue(MeetingTimeSuggestion $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MeetingTimeSuggestion|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MeetingTimeSuggestion>
     */
