...
/**
 * Collection response for ObjectIdentityCollectionResponse
 */
class ObjectIdentityCollectionResponseCollectionResponse
{
    /**
     * @var ObjectIdentityCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ObjectIdentityCollectionResponse ...$items Variable number of ObjectIdentityCollectionResponse items
     * @return self
     */
    public function setValue(ObjectIdentityCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ObjectIdentityCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ObjectIdentityCollectionResponse $item
     * @return self
     */
    public function addValue(ObjectIdentityCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
