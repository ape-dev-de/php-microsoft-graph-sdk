...
/**
 * Collection response for ScopedRoleMembershipCollectionResponse
 */
class ScopedRoleMembershipCollectionResponseCollectionResponse
{
    /**
     * @var ScopedRoleMembershipCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ScopedRoleMembershipCollectionResponse ...$items Variable number of ScopedRoleMembershipCollectionResponse items
     * @return self
     */
    public function setValue(ScopedRoleMembershipCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ScopedRoleMembershipCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ScopedRoleMembershipCollectionResponse $item
     * @return self
     */
    public function addValue(ScopedRoleMembershipCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
