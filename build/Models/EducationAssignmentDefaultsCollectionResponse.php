...
/**
 * Collection response for EducationAssignmentDefaults
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationAssignmentDefaultsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationAssignmentDefaults[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationAssignmentDefaults[] $items
     * @return self
     */
    public function setValue(array|EducationAssignmentDefaults $items, EducationAssignmentDefaults ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationAssignmentDefaults> $value
     * @return self
     ...
     * 
     * @param EducationAssignmentDefaults $item
     * @return self
     */
    public function addValue(EducationAssignmentDefaults $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationAssignmentDefaults>
     */
