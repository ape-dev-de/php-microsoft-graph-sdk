 ...
 */
class EducationAssignmentDefaultsCollectionResponse
{
    /**
     ...
     * 
     * @param EducationAssignmentDefaults ...$items Variable number of EducationAssignmentDefaults items
     * @return self
     */
    public function setValue(EducationAssignmentDefaults ...$items): self
    {
        $this->value = $items;
        return $this;
    }
