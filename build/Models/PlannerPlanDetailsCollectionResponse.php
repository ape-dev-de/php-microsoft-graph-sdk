...
/**
 * Collection response for PlannerPlanDetails
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerPlanDetailsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PlannerPlanDetails[]
     */
    private array $value = [];
     ...
     * 
     * @param PlannerPlanDetails[] $items
     * @return self
     */
    public function setValue(array|PlannerPlanDetails $items, PlannerPlanDetails ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PlannerPlanDetails> $value
     * @return self
     ...
     * 
     * @param PlannerPlanDetails $item
     * @return self
     */
    public function addValue(PlannerPlanDetails $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PlannerPlanDetails>
     */
