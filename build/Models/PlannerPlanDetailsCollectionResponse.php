 ...
 */
class PlannerPlanDetailsCollectionResponse
{
    /**
     ...
     * 
     * @param PlannerPlanDetails ...$items Variable number of PlannerPlanDetails items
     * @return self
     */
    public function setValue(PlannerPlanDetails ...$items): self
    {
        $this->value = $items;
        return $this;
    }
