...
/**
 * Collection response for SynchronizationJobApplicationParameters
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationJobApplicationParametersCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SynchronizationJobApplicationParameters[]
     */
    private array $value = [];
     ...
     * 
     * @param SynchronizationJobApplicationParameters[] $items
     * @return self
     */
    public function setValue(array|SynchronizationJobApplicationParameters $items, SynchronizationJobApplicationParameters ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SynchronizationJobApplicationParameters> $value
     * @return self
     ...
     * 
     * @param SynchronizationJobApplicationParameters $item
     * @return self
     */
    public function addValue(SynchronizationJobApplicationParameters $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SynchronizationJobApplicationParameters|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SynchronizationJobApplicationParameters>
     */
