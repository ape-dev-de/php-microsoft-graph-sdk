 ...
 */
class SynchronizationJobApplicationParametersCollectionResponse
{
    /**
     ...
     * 
     * @param SynchronizationJobApplicationParameters ...$items Variable number of SynchronizationJobApplicationParameters items
     * @return self
     */
    public function setValue(SynchronizationJobApplicationParameters ...$items): self
    {
        $this->value = $items;
        return $this;
    }
