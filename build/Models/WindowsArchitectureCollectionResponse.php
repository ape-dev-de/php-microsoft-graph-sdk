...
/**
 * Collection response for WindowsArchitecture
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsArchitectureCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WindowsArchitecture[] $items
     * @return self
     */
    public function setValue(array|WindowsArchitecture $items, WindowsArchitecture ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsArchitecture> $value
     * @return self
     ...
     * 
     * @param WindowsArchitecture $item
     * @return self
     */
    public function addValue(WindowsArchitecture $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsArchitecture>
     */
