...
/**
 * SecurityFilePlanReferenceCollectionResponse - Collection response
 */
class SecurityFilePlanReferenceCollectionResponse
{
    /**
     * @var array<int, SecurityFilePlanReference>
     */
    public array $value = [];
