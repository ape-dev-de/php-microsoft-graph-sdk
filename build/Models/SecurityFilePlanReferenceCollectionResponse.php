...
/**
 * Collection response for SecurityFilePlanReference
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityFilePlanReferenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityFilePlanReference[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityFilePlanReference[]
     */
     ...
     * 
     * @param SecurityFilePlanReference[] $items
     * @return self
     */
    public function setValue(array|SecurityFilePlanReference $items, SecurityFilePlanReference ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityFilePlanReference> $value
     * @return self
     ...
     * 
     * @param SecurityFilePlanReference $item
     * @return self
     */
    public function addValue(SecurityFilePlanReference $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityFilePlanReference|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityFilePlanReference>
     */
