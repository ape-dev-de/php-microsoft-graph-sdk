...
/**
 * Collection response for MembersJoinedEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MembersJoinedEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MembersJoinedEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param MembersJoinedEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|MembersJoinedEventMessageDetail $items, MembersJoinedEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MembersJoinedEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param MembersJoinedEventMessageDetail $item
     * @return self
     */
    public function addValue(MembersJoinedEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MembersJoinedEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MembersJoinedEventMessageDetail>
     */
