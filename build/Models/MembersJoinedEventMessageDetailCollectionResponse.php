 ...
 */
class MembersJoinedEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param MembersJoinedEventMessageDetail ...$items Variable number of MembersJoinedEventMessageDetail items
     * @return self
     */
    public function setValue(MembersJoinedEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
