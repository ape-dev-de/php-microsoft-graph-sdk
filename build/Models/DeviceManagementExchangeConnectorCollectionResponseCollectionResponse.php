...
/**
 * Collection response for DeviceManagementExchangeConnectorCollectionResponse
 */
class DeviceManagementExchangeConnectorCollectionResponseCollectionResponse
{
    /**
     * @var DeviceManagementExchangeConnectorCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceManagementExchangeConnectorCollectionResponse ...$items Variable number of DeviceManagementExchangeConnectorCollectionResponse items
     * @return self
     */
    public function setValue(DeviceManagementExchangeConnectorCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeviceManagementExchangeConnectorCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeviceManagementExchangeConnectorCollectionResponse $item
     * @return self
     */
    public function addValue(DeviceManagementExchangeConnectorCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
