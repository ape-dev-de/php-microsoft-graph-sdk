...
/**
 * Collection response for EducationFileResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationFileResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationFileResource[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationFileResource[] $items
     * @return self
     */
    public function setValue(array|EducationFileResource $items, EducationFileResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationFileResource> $value
     * @return self
     ...
     * 
     * @param EducationFileResource $item
     * @return self
     */
    public function addValue(EducationFileResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EducationFileResource|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EducationFileResource>
     */
