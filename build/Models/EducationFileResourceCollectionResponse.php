 ...
 */
class EducationFileResourceCollectionResponse
{
    /**
     ...
     * 
     * @param EducationFileResource ...$items Variable number of EducationFileResource items
     * @return self
     */
    public function setValue(EducationFileResource ...$items): self
    {
        $this->value = $items;
        return $this;
    }
