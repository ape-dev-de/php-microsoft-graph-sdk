...
/**
 * Collection response for WorkbookChartLegend
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookChartLegendCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookChartLegend[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookChartLegend[] $items
     * @return self
     */
    public function setValue(array|WorkbookChartLegend $items, WorkbookChartLegend ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookChartLegend> $value
     * @return self
     ...
     * 
     * @param WorkbookChartLegend $item
     * @return self
     */
    public function addValue(WorkbookChartLegend $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookChartLegend>
     */
