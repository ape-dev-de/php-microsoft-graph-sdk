 ...
 */
class WorkbookChartLegendCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookChartLegend ...$items Variable number of WorkbookChartLegend items
     * @return self
     */
    public function setValue(WorkbookChartLegend ...$items): self
    {
        $this->value = $items;
        return $this;
    }
