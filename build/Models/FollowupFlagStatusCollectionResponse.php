...
/**
 * Collection response for FollowupFlagStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FollowupFlagStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param FollowupFlagStatus[] $items
     * @return self
     */
    public function setValue(array|FollowupFlagStatus $items, FollowupFlagStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FollowupFlagStatus> $value
     * @return self
     ...
     * 
     * @param FollowupFlagStatus $item
     * @return self
     */
    public function addValue(FollowupFlagStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FollowupFlagStatus>
     */
