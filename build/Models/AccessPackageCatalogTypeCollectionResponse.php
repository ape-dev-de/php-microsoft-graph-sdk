...
/**
 * Collection response for AccessPackageCatalogType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageCatalogTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageCatalogType[]
     */
    private array $value = [];
     ...
     * 
     * @return AccessPackageCatalogType[]
     */
     ...
     * 
     * @param AccessPackageCatalogType[] $items
     * @return self
     */
    public function setValue(array|AccessPackageCatalogType $items, AccessPackageCatalogType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageCatalogType> $value
     * @return self
     ...
     * 
     * @param AccessPackageCatalogType $item
     * @return self
     */
    public function addValue(AccessPackageCatalogType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageCatalogType>
     */
