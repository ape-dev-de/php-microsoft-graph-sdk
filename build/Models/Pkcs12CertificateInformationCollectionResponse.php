...
/**
 * Collection response for Pkcs12CertificateInformation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Pkcs12CertificateInformationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param Pkcs12CertificateInformation[] $items
     * @return self
     */
    public function setValue(array|Pkcs12CertificateInformation $items, Pkcs12CertificateInformation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Pkcs12CertificateInformation> $value
     * @return self
     ...
     * 
     * @param Pkcs12CertificateInformation $item
     * @return self
     */
    public function addValue(Pkcs12CertificateInformation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return Pkcs12CertificateInformation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, Pkcs12CertificateInformation>
     */
