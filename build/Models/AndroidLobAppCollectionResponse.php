...
/**
 * Collection response for AndroidLobApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AndroidLobAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AndroidLobApp[]
     */
     ...
     * 
     * @param AndroidLobApp[] $items
     * @return self
     */
    public function setValue(array|AndroidLobApp $items, AndroidLobApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AndroidLobApp> $value
     * @return self
     ...
     * 
     * @param AndroidLobApp $item
     * @return self
     */
    public function addValue(AndroidLobApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AndroidLobApp>
     */
