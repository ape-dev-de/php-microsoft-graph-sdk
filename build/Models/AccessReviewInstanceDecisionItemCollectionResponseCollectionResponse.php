...
/**
 * Collection response for AccessReviewInstanceDecisionItemCollectionResponse
 */
class AccessReviewInstanceDecisionItemCollectionResponseCollectionResponse
{
    /**
     * @var AccessReviewInstanceDecisionItemCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessReviewInstanceDecisionItemCollectionResponse ...$items Variable number of AccessReviewInstanceDecisionItemCollectionResponse items
     * @return self
     */
    public function setValue(AccessReviewInstanceDecisionItemCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AccessReviewInstanceDecisionItemCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AccessReviewInstanceDecisionItemCollectionResponse $item
     * @return self
     */
    public function addValue(AccessReviewInstanceDecisionItemCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
