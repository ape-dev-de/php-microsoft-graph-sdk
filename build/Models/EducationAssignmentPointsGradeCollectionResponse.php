...
/**
 * Collection response for EducationAssignmentPointsGrade
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationAssignmentPointsGradeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationAssignmentPointsGrade[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationAssignmentPointsGrade[] $items
     * @return self
     */
    public function setValue(array|EducationAssignmentPointsGrade $items, EducationAssignmentPointsGrade ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationAssignmentPointsGrade> $value
     * @return self
     ...
     * 
     * @param EducationAssignmentPointsGrade $item
     * @return self
     */
    public function addValue(EducationAssignmentPointsGrade $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationAssignmentPointsGrade>
     */
