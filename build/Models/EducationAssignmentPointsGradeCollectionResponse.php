 ...
 */
class EducationAssignmentPointsGradeCollectionResponse
{
    /**
     ...
     * 
     * @param EducationAssignmentPointsGrade ...$items Variable number of EducationAssignmentPointsGrade items
     * @return self
     */
    public function setValue(EducationAssignmentPointsGrade ...$items): self
    {
        $this->value = $items;
        return $this;
    }
