...
/**
 * Collection response for ChatMessage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatMessageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChatMessage[]
     */
     ...
     * @return self
     */
    public function setValue(array|ChatMessage $items, ChatMessage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param ChatMessage $item
     * @return self
     */
    public function addValue(ChatMessage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChatMessage>
     */
