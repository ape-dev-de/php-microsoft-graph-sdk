...
/**
 * Collection response for IdentityGovernanceTriggerAndScopeBasedConditions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceTriggerAndScopeBasedConditionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceTriggerAndScopeBasedConditions[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceTriggerAndScopeBasedConditions[]
     */
     ...
     * 
     * @param IdentityGovernanceTriggerAndScopeBasedConditions[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceTriggerAndScopeBasedConditions $items, IdentityGovernanceTriggerAndScopeBasedConditions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceTriggerAndScopeBasedConditions> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceTriggerAndScopeBasedConditions $item
     * @return self
     */
    public function addValue(IdentityGovernanceTriggerAndScopeBasedConditions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceTriggerAndScopeBasedConditions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceTriggerAndScopeBasedConditions>
     */
