...
/**
 * Collection response for IosNotificationSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosNotificationSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IosNotificationSettings[] $items
     * @return self
     */
    public function setValue(array|IosNotificationSettings $items, IosNotificationSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosNotificationSettings> $value
     * @return self
     ...
     * 
     * @param IosNotificationSettings $item
     * @return self
     */
    public function addValue(IosNotificationSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IosNotificationSettings|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IosNotificationSettings>
     */
