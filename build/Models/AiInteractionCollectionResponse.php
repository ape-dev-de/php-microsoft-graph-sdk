 ...
 */
class AiInteractionCollectionResponse
{
    /**
     * @var AiInteraction[]
     */
     ...
     * 
     * @param AiInteraction ...$items Variable number of AiInteraction items
     * @return self
     */
    public function setValue(AiInteraction ...$items): self
    {
        $this->value = $items;
        return $this;
    }
