...
/**
 * Collection response for AiInteraction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AiInteractionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AiInteraction[]
     */
     ...
     * 
     * @param AiInteraction[] $items
     * @return self
     */
    public function setValue(array|AiInteraction $items, AiInteraction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AiInteraction> $value
     * @return self
     ...
     * 
     * @param AiInteraction $item
     * @return self
     */
    public function addValue(AiInteraction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AiInteraction>
     */
