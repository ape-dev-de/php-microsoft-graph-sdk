...
/**
 * Collection response for BookingReminder
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingReminderCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BookingReminder[]
     */
     ...
     * 
     * @param BookingReminder[] $items
     * @return self
     */
    public function setValue(array|BookingReminder $items, BookingReminder ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingReminder> $value
     * @return self
     ...
     * 
     * @param BookingReminder $item
     * @return self
     */
    public function addValue(BookingReminder $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BookingReminder>
     */
