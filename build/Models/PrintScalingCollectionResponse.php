...
/**
 * Collection response for PrintScaling
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintScalingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrintScaling[]
     */
     ...
     * 
     * @param PrintScaling[] $items
     * @return self
     */
    public function setValue(array|PrintScaling $items, PrintScaling ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintScaling> $value
     * @return self
     ...
     * 
     * @param PrintScaling $item
     * @return self
     */
    public function addValue(PrintScaling $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintScaling>
     */
