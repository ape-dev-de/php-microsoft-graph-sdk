...
/**
 * Collection response for SettingStateDeviceSummaryCollectionResponse
 */
class SettingStateDeviceSummaryCollectionResponseCollectionResponse
{
    /**
     * @var SettingStateDeviceSummaryCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SettingStateDeviceSummaryCollectionResponse ...$items Variable number of SettingStateDeviceSummaryCollectionResponse items
     * @return self
     */
    public function setValue(SettingStateDeviceSummaryCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SettingStateDeviceSummaryCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SettingStateDeviceSummaryCollectionResponse $item
     * @return self
     */
    public function addValue(SettingStateDeviceSummaryCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
