...
/**
 * Collection response for CloudClipboardItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudClipboardItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CloudClipboardItem[] $items
     * @return self
     */
    public function setValue(array|CloudClipboardItem $items, CloudClipboardItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudClipboardItem> $value
     * @return self
     ...
     * 
     * @param CloudClipboardItem $item
     * @return self
     */
    public function addValue(CloudClipboardItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudClipboardItem>
     */
