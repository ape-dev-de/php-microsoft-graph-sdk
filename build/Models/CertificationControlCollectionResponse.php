...
/**
 * Collection response for CertificationControl
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CertificationControlCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CertificationControl[] $items
     * @return self
     */
    public function setValue(array|CertificationControl $items, CertificationControl ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CertificationControl> $value
     * @return self
     ...
     * 
     * @param CertificationControl $item
     * @return self
     */
    public function addValue(CertificationControl $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CertificationControl|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CertificationControl>
     */
