...
/**
 * Collection response for AuthoredNote
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthoredNoteCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuthoredNote[]
     */
     ...
     * 
     * @param AuthoredNote[] $items
     * @return self
     */
    public function setValue(array|AuthoredNote $items, AuthoredNote ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthoredNote> $value
     * @return self
     ...
     * 
     * @param AuthoredNote $item
     * @return self
     */
    public function addValue(AuthoredNote $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthoredNote>
     */
