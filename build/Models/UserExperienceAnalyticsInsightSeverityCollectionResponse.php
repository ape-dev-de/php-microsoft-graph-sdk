...
/**
 * UserExperienceAnalyticsInsightSeverityCollectionResponse - Collection response
 */
class UserExperienceAnalyticsInsightSeverityCollectionResponse
{
    /**
     * @var array<int, UserExperienceAnalyticsInsightSeverity>
     */
    public array $value = [];
