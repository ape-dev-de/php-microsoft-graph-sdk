...
/**
 * Collection response for UserExperienceAnalyticsInsightSeverity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsInsightSeverityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserExperienceAnalyticsInsightSeverity[]
     */
    private array $value = [];
     ...
     * 
     * @return UserExperienceAnalyticsInsightSeverity[]
     */
     ...
     * 
     * @param UserExperienceAnalyticsInsightSeverity[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsInsightSeverity $items, UserExperienceAnalyticsInsightSeverity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsInsightSeverity> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsInsightSeverity $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsInsightSeverity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsInsightSeverity>
     */
