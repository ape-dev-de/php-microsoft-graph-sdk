...
/**
 * Collection response for RecycleBinItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RecycleBinItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RecycleBinItem[]
     */
     ...
     * 
     * @param RecycleBinItem[] $items
     * @return self
     */
    public function setValue(array|RecycleBinItem $items, RecycleBinItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RecycleBinItem> $value
     * @return self
     ...
     * 
     * @param RecycleBinItem $item
     * @return self
     */
    public function addValue(RecycleBinItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RecycleBinItem>
     */
