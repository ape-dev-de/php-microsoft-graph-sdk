...
/**
 * Collection response for BucketAggregationDefinition
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BucketAggregationDefinitionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BucketAggregationDefinition[]
     */
    private array $value = [];
     ...
     * 
     * @param BucketAggregationDefinition[] $items
     * @return self
     */
    public function setValue(array|BucketAggregationDefinition $items, BucketAggregationDefinition ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BucketAggregationDefinition> $value
     * @return self
     ...
     * 
     * @param BucketAggregationDefinition $item
     * @return self
     */
    public function addValue(BucketAggregationDefinition $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BucketAggregationDefinition>
     */
