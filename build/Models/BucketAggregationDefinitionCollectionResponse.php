 ...
 */
class BucketAggregationDefinitionCollectionResponse
{
    /**
     ...
     * 
     * @param BucketAggregationDefinition ...$items Variable number of BucketAggregationDefinition items
     * @return self
     */
    public function setValue(BucketAggregationDefinition ...$items): self
    {
        $this->value = $items;
        return $this;
    }
