...
/**
 * Collection response for CertificateBasedAuthPki
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CertificateBasedAuthPkiCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CertificateBasedAuthPki[] $items
     * @return self
     */
    public function setValue(array|CertificateBasedAuthPki $items, CertificateBasedAuthPki ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CertificateBasedAuthPki> $value
     * @return self
     ...
     * 
     * @param CertificateBasedAuthPki $item
     * @return self
     */
    public function addValue(CertificateBasedAuthPki $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CertificateBasedAuthPki>
     */
