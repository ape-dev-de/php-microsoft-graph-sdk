...
/**
 * Collection response for InternetMessageHeaderCollectionResponse
 */
class InternetMessageHeaderCollectionResponseCollectionResponse
{
    /**
     * @var InternetMessageHeaderCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param InternetMessageHeaderCollectionResponse ...$items Variable number of InternetMessageHeaderCollectionResponse items
     * @return self
     */
    public function setValue(InternetMessageHeaderCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<InternetMessageHeaderCollectionResponse> $value
     * @return self
     ...
     * 
     * @param InternetMessageHeaderCollectionResponse $item
     * @return self
     */
    public function addValue(InternetMessageHeaderCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
