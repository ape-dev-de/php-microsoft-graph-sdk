...
/**
 * VirtualEventAttendeeRegistrationStatusCollectionResponse - Collection response
 */
class VirtualEventAttendeeRegistrationStatusCollectionResponse
{
    /**
     * @var array<int, VirtualEventAttendeeRegistrationStatus>
     */
    public array $value = [];
