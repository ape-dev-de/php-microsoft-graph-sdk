...
/**
 * Collection response for VirtualEventAttendeeRegistrationStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualEventAttendeeRegistrationStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VirtualEventAttendeeRegistrationStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return VirtualEventAttendeeRegistrationStatus[]
     */
     ...
     * 
     * @param VirtualEventAttendeeRegistrationStatus[] $items
     * @return self
     */
    public function setValue(array|VirtualEventAttendeeRegistrationStatus $items, VirtualEventAttendeeRegistrationStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualEventAttendeeRegistrationStatus> $value
     * @return self
     ...
     * 
     * @param VirtualEventAttendeeRegistrationStatus $item
     * @return self
     */
    public function addValue(VirtualEventAttendeeRegistrationStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VirtualEventAttendeeRegistrationStatus>
     */
