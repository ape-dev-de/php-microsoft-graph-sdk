...
/**
 * TeamsAppResourceSpecificPermissionTypeCollectionResponse - Collection response
 */
class TeamsAppResourceSpecificPermissionTypeCollectionResponse
{
    /**
     * @var array<int, TeamsAppResourceSpecificPermissionType>
     */
    public array $value = [];
