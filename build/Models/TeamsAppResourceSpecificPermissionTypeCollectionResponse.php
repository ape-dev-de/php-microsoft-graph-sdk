...
/**
 * Collection response for TeamsAppResourceSpecificPermissionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamsAppResourceSpecificPermissionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamsAppResourceSpecificPermissionType[]
     */
    private array $value = [];
     ...
     * 
     * @return TeamsAppResourceSpecificPermissionType[]
     */
     ...
     * 
     * @param TeamsAppResourceSpecificPermissionType[] $items
     * @return self
     */
    public function setValue(array|TeamsAppResourceSpecificPermissionType $items, TeamsAppResourceSpecificPermissionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamsAppResourceSpecificPermissionType> $value
     * @return self
     ...
     * 
     * @param TeamsAppResourceSpecificPermissionType $item
     * @return self
     */
    public function addValue(TeamsAppResourceSpecificPermissionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamsAppResourceSpecificPermissionType>
     */
