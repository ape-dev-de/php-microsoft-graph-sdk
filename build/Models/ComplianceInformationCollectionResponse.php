...
/**
 * Collection response for ComplianceInformation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ComplianceInformationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ComplianceInformation[] $items
     * @return self
     */
    public function setValue(array|ComplianceInformation $items, ComplianceInformation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ComplianceInformation> $value
     * @return self
     ...
     * 
     * @param ComplianceInformation $item
     * @return self
     */
    public function addValue(ComplianceInformation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ComplianceInformation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ComplianceInformation>
     */
