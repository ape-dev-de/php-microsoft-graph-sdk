...
class AutomaticRepliesMailTips
{
     ...
     */
    public LocaleInfo|\stdClass|null $messageLanguage = null;

    /** 
     * The date and time that automatic replies are set to end.
     * @var DateTimeTimeZone|\stdClass|null
     */
    public DateTimeTimeZone|\stdClass|null $scheduledEndTime = null;

    /** 
     * The date and time that automatic replies are set to begin.
     * @var DateTimeTimeZone|\stdClass|null
     */
    public DateTimeTimeZone|\stdClass|null $scheduledStartTime = null;
