...
/**
 * Collection response for ExternalConnectorsProperties
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsPropertiesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalConnectorsProperties[]
     */
    private array $value = [];
     ...
     * 
     * @return ExternalConnectorsProperties[]
     */
     ...
     * 
     * @param ExternalConnectorsProperties[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsProperties $items, ExternalConnectorsProperties ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsProperties> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsProperties $item
     * @return self
     */
    public function addValue(ExternalConnectorsProperties $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalConnectorsProperties|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsProperties>
     */
