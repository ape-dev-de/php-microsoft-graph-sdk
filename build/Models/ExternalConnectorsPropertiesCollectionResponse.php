...
/**
 * ExternalConnectorsPropertiesCollectionResponse - Collection response
 */
class ExternalConnectorsPropertiesCollectionResponse
{
    /**
     * @var array<int, ExternalConnectorsProperties>
     */
    public array $value = [];
