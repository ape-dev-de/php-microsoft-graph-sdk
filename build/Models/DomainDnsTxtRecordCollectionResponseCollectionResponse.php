...
/**
 * Collection response for DomainDnsTxtRecordCollectionResponse
 */
class DomainDnsTxtRecordCollectionResponseCollectionResponse
{
    /**
     * @var DomainDnsTxtRecordCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DomainDnsTxtRecordCollectionResponse ...$items Variable number of DomainDnsTxtRecordCollectionResponse items
     * @return self
     */
    public function setValue(DomainDnsTxtRecordCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DomainDnsTxtRecordCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DomainDnsTxtRecordCollectionResponse $item
     * @return self
     */
    public function addValue(DomainDnsTxtRecordCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
