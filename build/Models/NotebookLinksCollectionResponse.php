...
/**
 * Collection response for NotebookLinks
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class NotebookLinksCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var NotebookLinks[]
     */
     ...
     * 
     * @param NotebookLinks[] $items
     * @return self
     */
    public function setValue(array|NotebookLinks $items, NotebookLinks ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<NotebookLinks> $value
     * @return self
     ...
     * 
     * @param NotebookLinks $item
     * @return self
     */
    public function addValue(NotebookLinks $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, NotebookLinks>
     */
