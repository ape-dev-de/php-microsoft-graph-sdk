...
/**
 * Collection response for SynchronizationTaskExecutionResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationTaskExecutionResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return SynchronizationTaskExecutionResult[]
     */
     ...
     * 
     * @param SynchronizationTaskExecutionResult[] $items
     * @return self
     */
    public function setValue(array|SynchronizationTaskExecutionResult $items, SynchronizationTaskExecutionResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SynchronizationTaskExecutionResult> $value
     * @return self
     ...
     * 
     * @param SynchronizationTaskExecutionResult $item
     * @return self
     */
    public function addValue(SynchronizationTaskExecutionResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SynchronizationTaskExecutionResult>
     */
