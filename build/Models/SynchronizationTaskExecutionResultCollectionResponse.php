...
/**
 * SynchronizationTaskExecutionResultCollectionResponse - Collection response
 */
class SynchronizationTaskExecutionResultCollectionResponse
{
    /**
     * @var array<int, SynchronizationTaskExecutionResult>
     */
    public array $value = [];
