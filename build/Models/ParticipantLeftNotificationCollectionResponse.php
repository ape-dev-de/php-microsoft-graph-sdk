...
/**
 * Collection response for ParticipantLeftNotification
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ParticipantLeftNotificationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ParticipantLeftNotification[]
     */
    private array $value = [];
     ...
     * 
     * @param ParticipantLeftNotification[] $items
     * @return self
     */
    public function setValue(array|ParticipantLeftNotification $items, ParticipantLeftNotification ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ParticipantLeftNotification> $value
     * @return self
     ...
     * 
     * @param ParticipantLeftNotification $item
     * @return self
     */
    public function addValue(ParticipantLeftNotification $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ParticipantLeftNotification|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ParticipantLeftNotification>
     */
