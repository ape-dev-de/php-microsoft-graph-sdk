 ...
 */
class ParticipantLeftNotificationCollectionResponse
{
    /**
     ...
     * 
     * @param ParticipantLeftNotification ...$items Variable number of ParticipantLeftNotification items
     * @return self
     */
    public function setValue(ParticipantLeftNotification ...$items): self
    {
        $this->value = $items;
        return $this;
    }
