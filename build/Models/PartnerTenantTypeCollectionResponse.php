...
/**
 * Collection response for PartnerTenantType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PartnerTenantTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PartnerTenantType[]
     */
    private array $value = [];
     ...
     * 
     * @param PartnerTenantType[] $items
     * @return self
     */
    public function setValue(array|PartnerTenantType $items, PartnerTenantType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PartnerTenantType> $value
     * @return self
     ...
     * 
     * @param PartnerTenantType $item
     * @return self
     */
    public function addValue(PartnerTenantType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PartnerTenantType>
     */
