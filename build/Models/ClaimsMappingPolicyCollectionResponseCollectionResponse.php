...
/**
 * Collection response for ClaimsMappingPolicyCollectionResponse
 */
class ClaimsMappingPolicyCollectionResponseCollectionResponse
{
    /**
     * @var ClaimsMappingPolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ClaimsMappingPolicyCollectionResponse ...$items Variable number of ClaimsMappingPolicyCollectionResponse items
     * @return self
     */
    public function setValue(ClaimsMappingPolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ClaimsMappingPolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ClaimsMappingPolicyCollectionResponse $item
     * @return self
     */
    public function addValue(ClaimsMappingPolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
