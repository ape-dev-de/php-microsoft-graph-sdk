...
/**
 * Collection response for WorkbookWorksheetProtectionOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookWorksheetProtectionOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WorkbookWorksheetProtectionOptions[] $items
     * @return self
     */
    public function setValue(array|WorkbookWorksheetProtectionOptions $items, WorkbookWorksheetProtectionOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookWorksheetProtectionOptions> $value
     * @return self
     ...
     * 
     * @param WorkbookWorksheetProtectionOptions $item
     * @return self
     */
    public function addValue(WorkbookWorksheetProtectionOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookWorksheetProtectionOptions>
     */
