 ...
 */
class WorkbookWorksheetProtectionOptionsCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookWorksheetProtectionOptions ...$items Variable number of WorkbookWorksheetProtectionOptions items
     * @return self
     */
    public function setValue(WorkbookWorksheetProtectionOptions ...$items): self
    {
        $this->value = $items;
        return $this;
    }
