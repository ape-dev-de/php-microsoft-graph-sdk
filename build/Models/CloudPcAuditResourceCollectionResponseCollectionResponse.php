...
/**
 * Collection response for CloudPcAuditResourceCollectionResponse
 */
class CloudPcAuditResourceCollectionResponseCollectionResponse
{
    /**
     * @var CloudPcAuditResourceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudPcAuditResourceCollectionResponse ...$items Variable number of CloudPcAuditResourceCollectionResponse items
     * @return self
     */
    public function setValue(CloudPcAuditResourceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CloudPcAuditResourceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CloudPcAuditResourceCollectionResponse $item
     * @return self
     */
    public function addValue(CloudPcAuditResourceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
