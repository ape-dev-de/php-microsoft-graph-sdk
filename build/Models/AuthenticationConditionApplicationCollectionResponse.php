...
/**
 * Collection response for AuthenticationConditionApplication
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationConditionApplicationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AuthenticationConditionApplication[] $items
     * @return self
     */
    public function setValue(array|AuthenticationConditionApplication $items, AuthenticationConditionApplication ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationConditionApplication> $value
     * @return self
     ...
     * 
     * @param AuthenticationConditionApplication $item
     * @return self
     */
    public function addValue(AuthenticationConditionApplication $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationConditionApplication>
     */
