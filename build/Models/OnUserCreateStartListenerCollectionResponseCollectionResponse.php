...
/**
 * Collection response for OnUserCreateStartListenerCollectionResponse
 */
class OnUserCreateStartListenerCollectionResponseCollectionResponse
{
    /**
     * @var OnUserCreateStartListenerCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return OnUserCreateStartListenerCollectionResponse[]
     */
     ...
     * 
     * @param OnUserCreateStartListenerCollectionResponse ...$items Variable number of OnUserCreateStartListenerCollectionResponse items
     * @return self
     */
    public function setValue(OnUserCreateStartListenerCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<OnUserCreateStartListenerCollectionResponse> $value
     * @return self
     ...
     * 
     * @param OnUserCreateStartListenerCollectionResponse $item
     * @return self
     */
    public function addValue(OnUserCreateStartListenerCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
