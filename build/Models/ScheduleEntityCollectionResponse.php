...
/**
 * Collection response for ScheduleEntity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ScheduleEntityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ScheduleEntity[]
     */
     ...
     * 
     * @param ScheduleEntity[] $items
     * @return self
     */
    public function setValue(array|ScheduleEntity $items, ScheduleEntity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ScheduleEntity> $value
     * @return self
     ...
     * 
     * @param ScheduleEntity $item
     * @return self
     */
    public function addValue(ScheduleEntity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ScheduleEntity>
     */
