 ...
 */
class ScheduleEntityCollectionResponse
{
    /**
     * @var ScheduleEntity[]
     */
     ...
     * 
     * @param ScheduleEntity ...$items Variable number of ScheduleEntity items
     * @return self
     */
    public function setValue(ScheduleEntity ...$items): self
    {
        $this->value = $items;
        return $this;
    }
