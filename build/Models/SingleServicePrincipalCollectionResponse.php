 ...
 */
class SingleServicePrincipalCollectionResponse
{
    /**
     ...
     * 
     * @param SingleServicePrincipal ...$items Variable number of SingleServicePrincipal items
     * @return self
     */
    public function setValue(SingleServicePrincipal ...$items): self
    {
        $this->value = $items;
        return $this;
    }
