...
/**
 * Collection response for SingleServicePrincipal
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SingleServicePrincipalCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SingleServicePrincipal[]
     */
    private array $value = [];
     ...
     * 
     * @param SingleServicePrincipal[] $items
     * @return self
     */
    public function setValue(array|SingleServicePrincipal $items, SingleServicePrincipal ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SingleServicePrincipal> $value
     * @return self
     ...
     * 
     * @param SingleServicePrincipal $item
     * @return self
     */
    public function addValue(SingleServicePrincipal $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SingleServicePrincipal|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SingleServicePrincipal>
     */
