...
/**
 * Collection response for WindowsAppX
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsAppXCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsAppX[]
     */
     ...
     * 
     * @param WindowsAppX[] $items
     * @return self
     */
    public function setValue(array|WindowsAppX $items, WindowsAppX ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param WindowsAppX $item
     * @return self
     */
    public function addValue(WindowsAppX $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsAppX>
     */
