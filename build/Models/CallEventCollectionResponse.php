...
/**
 * Collection response for CallEvent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallEventCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallEvent[]
     */
     ...
     * 
     * @param CallEvent[] $items
     * @return self
     */
    public function setValue(array|CallEvent $items, CallEvent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param CallEvent $item
     * @return self
     */
    public function addValue(CallEvent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CallEvent>
     */
