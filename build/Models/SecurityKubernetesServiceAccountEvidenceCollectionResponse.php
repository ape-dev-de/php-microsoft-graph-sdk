...
/**
 * Collection response for SecurityKubernetesServiceAccountEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityKubernetesServiceAccountEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityKubernetesServiceAccountEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityKubernetesServiceAccountEvidence[]
     */
     ...
     * 
     * @param SecurityKubernetesServiceAccountEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityKubernetesServiceAccountEvidence $items, SecurityKubernetesServiceAccountEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityKubernetesServiceAccountEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityKubernetesServiceAccountEvidence $item
     * @return self
     */
    public function addValue(SecurityKubernetesServiceAccountEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityKubernetesServiceAccountEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityKubernetesServiceAccountEvidence>
     */
