 ...
 */
class SecurityKubernetesServiceAccountEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityKubernetesServiceAccountEvidence ...$items Variable number of SecurityKubernetesServiceAccountEvidence items
     * @return self
     */
    public function setValue(SecurityKubernetesServiceAccountEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
