...
/**
 * Collection response for AccessReviewStageSettingsCollectionResponse
 */
class AccessReviewStageSettingsCollectionResponseCollectionResponse
{
    /**
     * @var AccessReviewStageSettingsCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessReviewStageSettingsCollectionResponse ...$items Variable number of AccessReviewStageSettingsCollectionResponse items
     * @return self
     */
    public function setValue(AccessReviewStageSettingsCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AccessReviewStageSettingsCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AccessReviewStageSettingsCollectionResponse $item
     * @return self
     */
    public function addValue(AccessReviewStageSettingsCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
