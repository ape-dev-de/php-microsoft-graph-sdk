...
/**
 * Collection response for CommsOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CommsOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CommsOperation[]
     */
     ...
     * 
     * @param CommsOperation[] $items
     * @return self
     */
    public function setValue(array|CommsOperation $items, CommsOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CommsOperation> $value
     * @return self
     ...
     * 
     * @param CommsOperation $item
     * @return self
     */
    public function addValue(CommsOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CommsOperation>
     */
