 ...
 */
class IdentityProtectionRootCollectionResponse
{
    /**
     ...
     * 
     * @param IdentityProtectionRoot ...$items Variable number of IdentityProtectionRoot items
     * @return self
     */
    public function setValue(IdentityProtectionRoot ...$items): self
    {
        $this->value = $items;
        return $this;
    }
