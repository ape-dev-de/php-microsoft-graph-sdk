...
/**
 * Collection response for IdentityProtectionRoot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityProtectionRootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityProtectionRoot[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityProtectionRoot[] $items
     * @return self
     */
    public function setValue(array|IdentityProtectionRoot $items, IdentityProtectionRoot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityProtectionRoot> $value
     * @return self
     ...
     * 
     * @param IdentityProtectionRoot $item
     * @return self
     */
    public function addValue(IdentityProtectionRoot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityProtectionRoot>
     */
