...
/**
 * Collection response for TeamworkBot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamworkBotCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamworkBot[]
     */
     ...
     * 
     * @param TeamworkBot[] $items
     * @return self
     */
    public function setValue(array|TeamworkBot $items, TeamworkBot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param TeamworkBot $item
     * @return self
     */
    public function addValue(TeamworkBot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamworkBot>
     */
