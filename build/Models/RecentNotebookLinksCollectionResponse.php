 ...
 */
class RecentNotebookLinksCollectionResponse
{
    /**
     ...
     * 
     * @param RecentNotebookLinks ...$items Variable number of RecentNotebookLinks items
     * @return self
     */
    public function setValue(RecentNotebookLinks ...$items): self
    {
        $this->value = $items;
        return $this;
    }
