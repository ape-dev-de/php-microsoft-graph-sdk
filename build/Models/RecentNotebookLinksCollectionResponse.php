...
/**
 * Collection response for RecentNotebookLinks
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RecentNotebookLinksCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param RecentNotebookLinks[] $items
     * @return self
     */
    public function setValue(array|RecentNotebookLinks $items, RecentNotebookLinks ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RecentNotebookLinks> $value
     * @return self
     ...
     * 
     * @param RecentNotebookLinks $item
     * @return self
     */
    public function addValue(RecentNotebookLinks $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RecentNotebookLinks>
     */
