...
/**
 * Collection response for EducationOutcomeCollectionResponse
 */
class EducationOutcomeCollectionResponseCollectionResponse
{
    /**
     * @var EducationOutcomeCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationOutcomeCollectionResponse ...$items Variable number of EducationOutcomeCollectionResponse items
     * @return self
     */
    public function setValue(EducationOutcomeCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EducationOutcomeCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EducationOutcomeCollectionResponse $item
     * @return self
     */
    public function addValue(EducationOutcomeCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
