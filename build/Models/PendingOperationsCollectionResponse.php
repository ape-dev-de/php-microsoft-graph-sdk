...
/**
 * Collection response for PendingOperations
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PendingOperationsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PendingOperations[] $items
     * @return self
     */
    public function setValue(array|PendingOperations $items, PendingOperations ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PendingOperations> $value
     * @return self
     ...
     * 
     * @param PendingOperations $item
     * @return self
     */
    public function addValue(PendingOperations $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PendingOperations>
     */
