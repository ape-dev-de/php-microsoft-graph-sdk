 ...
 */
class PendingOperationsCollectionResponse
{
    /**
     ...
     * 
     * @param PendingOperations ...$items Variable number of PendingOperations items
     * @return self
     */
    public function setValue(PendingOperations ...$items): self
    {
        $this->value = $items;
        return $this;
    }
