...
/**
 * Collection response for IdentityUserFlowAttributeAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityUserFlowAttributeAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IdentityUserFlowAttributeAssignment[] $items
     * @return self
     */
    public function setValue(array|IdentityUserFlowAttributeAssignment $items, IdentityUserFlowAttributeAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityUserFlowAttributeAssignment> $value
     * @return self
     ...
     * 
     * @param IdentityUserFlowAttributeAssignment $item
     * @return self
     */
    public function addValue(IdentityUserFlowAttributeAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityUserFlowAttributeAssignment>
     */
