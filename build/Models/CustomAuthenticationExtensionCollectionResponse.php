...
/**
 * Collection response for CustomAuthenticationExtension
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CustomAuthenticationExtensionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CustomAuthenticationExtension[] $items
     * @return self
     */
    public function setValue(array|CustomAuthenticationExtension $items, CustomAuthenticationExtension ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CustomAuthenticationExtension> $value
     * @return self
     ...
     * 
     * @param CustomAuthenticationExtension $item
     * @return self
     */
    public function addValue(CustomAuthenticationExtension $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CustomAuthenticationExtension>
     */
