...
/**
 * Collection response for ManagedMobileLobAppCollectionResponse
 */
class ManagedMobileLobAppCollectionResponseCollectionResponse
{
    /**
     * @var ManagedMobileLobAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedMobileLobAppCollectionResponse ...$items Variable number of ManagedMobileLobAppCollectionResponse items
     * @return self
     */
    public function setValue(ManagedMobileLobAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ManagedMobileLobAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ManagedMobileLobAppCollectionResponse $item
     * @return self
     */
    public function addValue(ManagedMobileLobAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
