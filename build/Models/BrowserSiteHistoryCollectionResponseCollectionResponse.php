...
/**
 * Collection response for BrowserSiteHistoryCollectionResponse
 */
class BrowserSiteHistoryCollectionResponseCollectionResponse
{
    /**
     * @var BrowserSiteHistoryCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BrowserSiteHistoryCollectionResponse ...$items Variable number of BrowserSiteHistoryCollectionResponse items
     * @return self
     */
    public function setValue(BrowserSiteHistoryCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<BrowserSiteHistoryCollectionResponse> $value
     * @return self
     ...
     * 
     * @param BrowserSiteHistoryCollectionResponse $item
     * @return self
     */
    public function addValue(BrowserSiteHistoryCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
