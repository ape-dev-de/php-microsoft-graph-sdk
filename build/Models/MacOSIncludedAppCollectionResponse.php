...
/**
 * Collection response for MacOSIncludedApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MacOSIncludedAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MacOSIncludedApp[] $items
     * @return self
     */
    public function setValue(array|MacOSIncludedApp $items, MacOSIncludedApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MacOSIncludedApp> $value
     * @return self
     ...
     * 
     * @param MacOSIncludedApp $item
     * @return self
     */
    public function addValue(MacOSIncludedApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MacOSIncludedApp>
     */
