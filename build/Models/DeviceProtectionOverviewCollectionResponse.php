 ...
 */
class DeviceProtectionOverviewCollectionResponse
{
    /**
     ...
     * 
     * @param DeviceProtectionOverview ...$items Variable number of DeviceProtectionOverview items
     * @return self
     */
    public function setValue(DeviceProtectionOverview ...$items): self
    {
        $this->value = $items;
        return $this;
    }
