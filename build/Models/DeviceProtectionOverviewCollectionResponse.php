...
/**
 * Collection response for DeviceProtectionOverview
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceProtectionOverviewCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceProtectionOverview[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceProtectionOverview[] $items
     * @return self
     */
    public function setValue(array|DeviceProtectionOverview $items, DeviceProtectionOverview ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceProtectionOverview> $value
     * @return self
     ...
     * 
     * @param DeviceProtectionOverview $item
     * @return self
     */
    public function addValue(DeviceProtectionOverview $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceProtectionOverview>
     */
