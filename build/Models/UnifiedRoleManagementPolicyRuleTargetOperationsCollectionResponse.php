...
/**
 * UnifiedRoleManagementPolicyRuleTargetOperationsCollectionResponse - Collection response
 */
class UnifiedRoleManagementPolicyRuleTargetOperationsCollectionResponse
{
    /**
     * @var array<int, UnifiedRoleManagementPolicyRuleTargetOperations>
     */
    public array $value = [];
