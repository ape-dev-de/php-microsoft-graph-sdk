...
/**
 * Collection response for UnifiedRoleManagementPolicyRuleTargetOperations
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRoleManagementPolicyRuleTargetOperationsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return UnifiedRoleManagementPolicyRuleTargetOperations[]
     */
     ...
     * 
     * @param UnifiedRoleManagementPolicyRuleTargetOperations[] $items
     * @return self
     */
    public function setValue(array|UnifiedRoleManagementPolicyRuleTargetOperations $items, UnifiedRoleManagementPolicyRuleTargetOperations ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRoleManagementPolicyRuleTargetOperations> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleManagementPolicyRuleTargetOperations $item
     * @return self
     */
    public function addValue(UnifiedRoleManagementPolicyRuleTargetOperations $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UnifiedRoleManagementPolicyRuleTargetOperations|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRoleManagementPolicyRuleTargetOperations>
     */
