...
/**
 * Collection response for IosCustomConfigurationCollectionResponse
 */
class IosCustomConfigurationCollectionResponseCollectionResponse
{
    /**
     * @var IosCustomConfigurationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IosCustomConfigurationCollectionResponse ...$items Variable number of IosCustomConfigurationCollectionResponse items
     * @return self
     */
    public function setValue(IosCustomConfigurationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IosCustomConfigurationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IosCustomConfigurationCollectionResponse $item
     * @return self
     */
    public function addValue(IosCustomConfigurationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
