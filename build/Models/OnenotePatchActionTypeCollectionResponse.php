...
/**
 * Collection response for OnenotePatchActionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnenotePatchActionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnenotePatchActionType[]
     */
    private array $value = [];
     ...
     * 
     * @param OnenotePatchActionType[] $items
     * @return self
     */
    public function setValue(array|OnenotePatchActionType $items, OnenotePatchActionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnenotePatchActionType> $value
     * @return self
     ...
     * 
     * @param OnenotePatchActionType $item
     * @return self
     */
    public function addValue(OnenotePatchActionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnenotePatchActionType>
     */
