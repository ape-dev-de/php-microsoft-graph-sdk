...
/**
 * Collection response for ProtectedApplicationMetadata
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProtectedApplicationMetadataCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProtectedApplicationMetadata[]
     */
    private array $value = [];
     ...
     * 
     * @param ProtectedApplicationMetadata[] $items
     * @return self
     */
    public function setValue(array|ProtectedApplicationMetadata $items, ProtectedApplicationMetadata ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProtectedApplicationMetadata> $value
     * @return self
     ...
     * 
     * @param ProtectedApplicationMetadata $item
     * @return self
     */
    public function addValue(ProtectedApplicationMetadata $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProtectedApplicationMetadata>
     */
