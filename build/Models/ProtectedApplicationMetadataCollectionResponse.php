 ...
 */
class ProtectedApplicationMetadataCollectionResponse
{
    /**
     ...
     * 
     * @param ProtectedApplicationMetadata ...$items Variable number of ProtectedApplicationMetadata items
     * @return self
     */
    public function setValue(ProtectedApplicationMetadata ...$items): self
    {
        $this->value = $items;
        return $this;
    }
