...
class DeviceComplianceActionItem
{
     ...
     */
    private ?string $notificationMessageCCList;
    ...
    public function getNotificationMessageCCList(): ?string
    {
        return $this->notificationMessageCCList;
    }

    public function setNotificationMessageCCList(?string $notificationMessageCCList): self
    {
