...
/**
 * FallbackToMicrosoftProviderOnErrorCollectionResponse - Collection response
 */
class FallbackToMicrosoftProviderOnErrorCollectionResponse
{
    /**
     * @var array<int, FallbackToMicrosoftProviderOnError>
     */
    public array $value = [];
