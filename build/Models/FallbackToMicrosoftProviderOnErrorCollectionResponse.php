...
/**
 * Collection response for FallbackToMicrosoftProviderOnError
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FallbackToMicrosoftProviderOnErrorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FallbackToMicrosoftProviderOnError[]
     */
    private array $value = [];
     ...
     * 
     * @param FallbackToMicrosoftProviderOnError[] $items
     * @return self
     */
    public function setValue(array|FallbackToMicrosoftProviderOnError $items, FallbackToMicrosoftProviderOnError ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FallbackToMicrosoftProviderOnError> $value
     * @return self
     ...
     * 
     * @param FallbackToMicrosoftProviderOnError $item
     * @return self
     */
    public function addValue(FallbackToMicrosoftProviderOnError $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return FallbackToMicrosoftProviderOnError|null
     */
     ...
     * 
     * @return \ArrayIterator<int, FallbackToMicrosoftProviderOnError>
     */
