...
/**
 * Collection response for AiInteractionLink
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AiInteractionLinkCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AiInteractionLink[] $items
     * @return self
     */
    public function setValue(array|AiInteractionLink $items, AiInteractionLink ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AiInteractionLink> $value
     * @return self
     ...
     * 
     * @param AiInteractionLink $item
     * @return self
     */
    public function addValue(AiInteractionLink $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AiInteractionLink>
     */
