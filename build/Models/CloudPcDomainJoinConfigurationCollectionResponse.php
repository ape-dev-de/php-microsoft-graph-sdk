...
/**
 * Collection response for CloudPcDomainJoinConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcDomainJoinConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CloudPcDomainJoinConfiguration[] $items
     * @return self
     */
    public function setValue(array|CloudPcDomainJoinConfiguration $items, CloudPcDomainJoinConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcDomainJoinConfiguration> $value
     * @return self
     ...
     * 
     * @param CloudPcDomainJoinConfiguration $item
     * @return self
     */
    public function addValue(CloudPcDomainJoinConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcDomainJoinConfiguration>
     */
