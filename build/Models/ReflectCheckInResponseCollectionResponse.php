...
/**
 * Collection response for ReflectCheckInResponse
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ReflectCheckInResponseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ReflectCheckInResponse[] $items
     * @return self
     */
    public function setValue(array|ReflectCheckInResponse $items, ReflectCheckInResponse ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ReflectCheckInResponse> $value
     * @return self
     ...
     * 
     * @param ReflectCheckInResponse $item
     * @return self
     */
    public function addValue(ReflectCheckInResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ReflectCheckInResponse>
     */
