...
/**
 * Collection response for PrivilegedAccessScheduleInstance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrivilegedAccessScheduleInstanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrivilegedAccessScheduleInstance[]
     */
    private array $value = [];
     ...
     * 
     * @param PrivilegedAccessScheduleInstance[] $items
     * @return self
     */
    public function setValue(array|PrivilegedAccessScheduleInstance $items, PrivilegedAccessScheduleInstance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrivilegedAccessScheduleInstance> $value
     * @return self
     ...
     * 
     * @param PrivilegedAccessScheduleInstance $item
     * @return self
     */
    public function addValue(PrivilegedAccessScheduleInstance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PrivilegedAccessScheduleInstance|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PrivilegedAccessScheduleInstance>
     */
