 ...
 */
class PrivilegedAccessScheduleInstanceCollectionResponse
{
    /**
     ...
     * 
     * @param PrivilegedAccessScheduleInstance ...$items Variable number of PrivilegedAccessScheduleInstance items
     * @return self
     */
    public function setValue(PrivilegedAccessScheduleInstance ...$items): self
    {
        $this->value = $items;
        return $this;
    }
