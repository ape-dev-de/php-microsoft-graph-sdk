...
/**
 * Collection response for ExternalConnectorsSearchSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsSearchSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalConnectorsSearchSettings[]
     */
    private array $value = [];
     ...
     * 
     * @return ExternalConnectorsSearchSettings[]
     */
     ...
     * 
     * @param ExternalConnectorsSearchSettings[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsSearchSettings $items, ExternalConnectorsSearchSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsSearchSettings> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsSearchSettings $item
     * @return self
     */
    public function addValue(ExternalConnectorsSearchSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalConnectorsSearchSettings|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsSearchSettings>
     */
