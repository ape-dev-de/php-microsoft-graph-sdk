 ...
 */
class ExternalConnectorsSearchSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param ExternalConnectorsSearchSettings ...$items Variable number of ExternalConnectorsSearchSettings items
     * @return self
     */
    public function setValue(ExternalConnectorsSearchSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
