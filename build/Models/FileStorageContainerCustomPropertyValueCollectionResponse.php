 ...
 */
class FileStorageContainerCustomPropertyValueCollectionResponse
{
    /**
     ...
     * 
     * @param FileStorageContainerCustomPropertyValue ...$items Variable number of FileStorageContainerCustomPropertyValue items
     * @return self
     */
    public function setValue(FileStorageContainerCustomPropertyValue ...$items): self
    {
        $this->value = $items;
        return $this;
    }
