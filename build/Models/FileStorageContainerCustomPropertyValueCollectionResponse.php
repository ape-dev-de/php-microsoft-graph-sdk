...
/**
 * Collection response for FileStorageContainerCustomPropertyValue
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FileStorageContainerCustomPropertyValueCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FileStorageContainerCustomPropertyValue[]
     */
    private array $value = [];
     ...
     * 
     * @param FileStorageContainerCustomPropertyValue[] $items
     * @return self
     */
    public function setValue(array|FileStorageContainerCustomPropertyValue $items, FileStorageContainerCustomPropertyValue ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FileStorageContainerCustomPropertyValue> $value
     * @return self
     ...
     * 
     * @param FileStorageContainerCustomPropertyValue $item
     * @return self
     */
    public function addValue(FileStorageContainerCustomPropertyValue $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return FileStorageContainerCustomPropertyValue|null
     */
     ...
     * 
     * @return \ArrayIterator<int, FileStorageContainerCustomPropertyValue>
     */
