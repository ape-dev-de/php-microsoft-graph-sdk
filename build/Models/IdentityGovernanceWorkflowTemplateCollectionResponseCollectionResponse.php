...
/**
 * Collection response for IdentityGovernanceWorkflowTemplateCollectionResponse
 */
class IdentityGovernanceWorkflowTemplateCollectionResponseCollectionResponse
{
    /**
     * @var IdentityGovernanceWorkflowTemplateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityGovernanceWorkflowTemplateCollectionResponse ...$items Variable number of IdentityGovernanceWorkflowTemplateCollectionResponse items
     * @return self
     */
    public function setValue(IdentityGovernanceWorkflowTemplateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IdentityGovernanceWorkflowTemplateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceWorkflowTemplateCollectionResponse $item
     * @return self
     */
    public function addValue(IdentityGovernanceWorkflowTemplateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
