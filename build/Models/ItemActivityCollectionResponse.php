...
/**
 * Collection response for ItemActivity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ItemActivityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ItemActivity[]
     */
     ...
     * 
     * @param ItemActivity[] $items
     * @return self
     */
    public function setValue(array|ItemActivity $items, ItemActivity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ItemActivity> $value
     * @return self
     ...
     * 
     * @param ItemActivity $item
     * @return self
     */
    public function addValue(ItemActivity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ItemActivity>
     */
