...
/**
 * Collection response for ChatMessageMentionCollectionResponse
 */
class ChatMessageMentionCollectionResponseCollectionResponse
{
    /**
     * @var ChatMessageMentionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ChatMessageMentionCollectionResponse ...$items Variable number of ChatMessageMentionCollectionResponse items
     * @return self
     */
    public function setValue(ChatMessageMentionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ChatMessageMentionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ChatMessageMentionCollectionResponse $item
     * @return self
     */
    public function addValue(ChatMessageMentionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
