...
/**
 * Collection response for PhoneCollectionResponse
 */
class PhoneCollectionResponseCollectionResponse
{
    /**
     * @var PhoneCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PhoneCollectionResponse ...$items Variable number of PhoneCollectionResponse items
     * @return self
     */
    public function setValue(PhoneCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PhoneCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PhoneCollectionResponse $item
     * @return self
     */
    public function addValue(PhoneCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
