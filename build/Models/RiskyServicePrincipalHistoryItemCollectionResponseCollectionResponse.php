...
/**
 * Collection response for RiskyServicePrincipalHistoryItemCollectionResponse
 */
class RiskyServicePrincipalHistoryItemCollectionResponseCollectionResponse
{
    /**
     * @var RiskyServicePrincipalHistoryItemCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RiskyServicePrincipalHistoryItemCollectionResponse ...$items Variable number of RiskyServicePrincipalHistoryItemCollectionResponse items
     * @return self
     */
    public function setValue(RiskyServicePrincipalHistoryItemCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RiskyServicePrincipalHistoryItemCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RiskyServicePrincipalHistoryItemCollectionResponse $item
     * @return self
     */
    public function addValue(RiskyServicePrincipalHistoryItemCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
