...
/**
 * RoleAssignmentScheduleInstanceFilterByCurrentUserOptionsCollectionResponse - Collection response
 */
class RoleAssignmentScheduleInstanceFilterByCurrentUserOptionsCollectionResponse
{
    /**
     * @var array<int, RoleAssignmentScheduleInstanceFilterByCurrentUserOptions>
     */
    public array $value = [];
