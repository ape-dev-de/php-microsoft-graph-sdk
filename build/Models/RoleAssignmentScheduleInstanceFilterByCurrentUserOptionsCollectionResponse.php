...
/**
 * Collection response for RoleAssignmentScheduleInstanceFilterByCurrentUserOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RoleAssignmentScheduleInstanceFilterByCurrentUserOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RoleAssignmentScheduleInstanceFilterByCurrentUserOptions[]
     */
    private array $value = [];
     ...
     * 
     * @return RoleAssignmentScheduleInstanceFilterByCurrentUserOptions[]
     */
     ...
     * 
     * @param RoleAssignmentScheduleInstanceFilterByCurrentUserOptions[] $items
     * @return self
     */
    public function setValue(array|RoleAssignmentScheduleInstanceFilterByCurrentUserOptions $items, RoleAssignmentScheduleInstanceFilterByCurrentUserOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RoleAssignmentScheduleInstanceFilterByCurrentUserOptions> $value
     * @return self
     ...
     * 
     * @param RoleAssignmentScheduleInstanceFilterByCurrentUserOptions $item
     * @return self
     */
    public function addValue(RoleAssignmentScheduleInstanceFilterByCurrentUserOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return RoleAssignmentScheduleInstanceFilterByCurrentUserOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, RoleAssignmentScheduleInstanceFilterByCurrentUserOptions>
     */
