...
/**
 * Collection response for AiInteractionMention
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AiInteractionMentionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AiInteractionMention[] $items
     * @return self
     */
    public function setValue(array|AiInteractionMention $items, AiInteractionMention ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AiInteractionMention> $value
     * @return self
     ...
     * 
     * @param AiInteractionMention $item
     * @return self
     */
    public function addValue(AiInteractionMention $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AiInteractionMention|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AiInteractionMention>
     */
