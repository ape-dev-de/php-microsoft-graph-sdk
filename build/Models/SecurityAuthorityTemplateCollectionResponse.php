...
/**
 * Collection response for SecurityAuthorityTemplate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityAuthorityTemplateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityAuthorityTemplate[] $items
     * @return self
     */
    public function setValue(array|SecurityAuthorityTemplate $items, SecurityAuthorityTemplate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityAuthorityTemplate> $value
     * @return self
     ...
     * 
     * @param SecurityAuthorityTemplate $item
     * @return self
     */
    public function addValue(SecurityAuthorityTemplate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityAuthorityTemplate>
     */
