...
/**
 * SecurityAuthorityTemplateCollectionResponse - Collection response
 */
class SecurityAuthorityTemplateCollectionResponse
{
    /**
     * @var array<int, SecurityAuthorityTemplate>
     */
    public array $value = [];
