...
/**
 * Collection response for SearchBucket
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SearchBucketCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SearchBucket[]
     */
     ...
     * 
     * @param SearchBucket[] $items
     * @return self
     */
    public function setValue(array|SearchBucket $items, SearchBucket ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SearchBucket> $value
     * @return self
     ...
     * 
     * @param SearchBucket $item
     * @return self
     */
    public function addValue(SearchBucket $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SearchBucket>
     */
