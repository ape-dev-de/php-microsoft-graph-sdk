 ...
 */
class SecuritySensorSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param SecuritySensorSettings ...$items Variable number of SecuritySensorSettings items
     * @return self
     */
    public function setValue(SecuritySensorSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
