...
/**
 * Collection response for SecuritySensorSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecuritySensorSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecuritySensorSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param SecuritySensorSettings[] $items
     * @return self
     */
    public function setValue(array|SecuritySensorSettings $items, SecuritySensorSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecuritySensorSettings> $value
     * @return self
     ...
     * 
     * @param SecuritySensorSettings $item
     * @return self
     */
    public function addValue(SecuritySensorSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecuritySensorSettings|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecuritySensorSettings>
     */
