...
/**
 * Collection response for ManagedDevicePartnerReportedHealthState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedDevicePartnerReportedHealthStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return ManagedDevicePartnerReportedHealthState[]
     */
     ...
     * 
     * @param ManagedDevicePartnerReportedHealthState[] $items
     * @return self
     */
    public function setValue(array|ManagedDevicePartnerReportedHealthState $items, ManagedDevicePartnerReportedHealthState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedDevicePartnerReportedHealthState> $value
     * @return self
     ...
     * 
     * @param ManagedDevicePartnerReportedHealthState $item
     * @return self
     */
    public function addValue(ManagedDevicePartnerReportedHealthState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedDevicePartnerReportedHealthState>
     */
