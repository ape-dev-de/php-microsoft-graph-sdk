...
/**
 * ManagedDevicePartnerReportedHealthStateCollectionResponse - Collection response
 */
class ManagedDevicePartnerReportedHealthStateCollectionResponse
{
    /**
     * @var array<int, ManagedDevicePartnerReportedHealthState>
     */
    public array $value = [];
