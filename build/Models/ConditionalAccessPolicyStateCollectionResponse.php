...
/**
 * Collection response for ConditionalAccessPolicyState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessPolicyStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessPolicyState[]
     */
    private array $value = [];
     ...
     * 
     * @param ConditionalAccessPolicyState[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessPolicyState $items, ConditionalAccessPolicyState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessPolicyState> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessPolicyState $item
     * @return self
     */
    public function addValue(ConditionalAccessPolicyState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessPolicyState>
     */
