...
/**
 * ConditionalAccessPolicyStateCollectionResponse - Collection response
 */
class ConditionalAccessPolicyStateCollectionResponse
{
    /**
     * @var array<int, ConditionalAccessPolicyState>
     */
    public array $value = [];
