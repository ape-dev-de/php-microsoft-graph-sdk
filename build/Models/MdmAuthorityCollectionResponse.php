...
/**
 * Collection response for MdmAuthority
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MdmAuthorityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MdmAuthority[]
     */
     ...
     * 
     * @param MdmAuthority[] $items
     * @return self
     */
    public function setValue(array|MdmAuthority $items, MdmAuthority ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MdmAuthority> $value
     * @return self
     ...
     * 
     * @param MdmAuthority $item
     * @return self
     */
    public function addValue(MdmAuthority $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MdmAuthority>
     */
