...
/**
 * Collection response for VerifiedDomainCollectionResponse
 */
class VerifiedDomainCollectionResponseCollectionResponse
{
    /**
     * @var VerifiedDomainCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param VerifiedDomainCollectionResponse ...$items Variable number of VerifiedDomainCollectionResponse items
     * @return self
     */
    public function setValue(VerifiedDomainCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<VerifiedDomainCollectionResponse> $value
     * @return self
     ...
     * 
     * @param VerifiedDomainCollectionResponse $item
     * @return self
     */
    public function addValue(VerifiedDomainCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
