 ...
 */
class SpecialFolderCollectionResponse
{
    /**
     * @var SpecialFolder[]
     */
     ...
     * 
     * @param SpecialFolder ...$items Variable number of SpecialFolder items
     * @return self
     */
    public function setValue(SpecialFolder ...$items): self
    {
        $this->value = $items;
        return $this;
    }
