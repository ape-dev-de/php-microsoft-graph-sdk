...
/**
 * Collection response for SpecialFolder
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SpecialFolderCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SpecialFolder[]
     */
     ...
     * 
     * @param SpecialFolder[] $items
     * @return self
     */
    public function setValue(array|SpecialFolder $items, SpecialFolder ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SpecialFolder> $value
     * @return self
     ...
     * 
     * @param SpecialFolder $item
     * @return self
     */
    public function addValue(SpecialFolder $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SpecialFolder>
     */
