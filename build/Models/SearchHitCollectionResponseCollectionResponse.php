...
/**
 * Collection response for SearchHitCollectionResponse
 */
class SearchHitCollectionResponseCollectionResponse
{
    /**
     * @var SearchHitCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SearchHitCollectionResponse ...$items Variable number of SearchHitCollectionResponse items
     * @return self
     */
    public function setValue(SearchHitCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SearchHitCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SearchHitCollectionResponse $item
     * @return self
     */
    public function addValue(SearchHitCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
