...
/**
 * Collection response for RoleDefinitionCollectionResponse
 */
class RoleDefinitionCollectionResponseCollectionResponse
{
    /**
     * @var RoleDefinitionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RoleDefinitionCollectionResponse ...$items Variable number of RoleDefinitionCollectionResponse items
     * @return self
     */
    public function setValue(RoleDefinitionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RoleDefinitionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RoleDefinitionCollectionResponse $item
     * @return self
     */
    public function addValue(RoleDefinitionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
