...
/**
 * Collection response for EducationModule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationModuleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationModule[]
     */
     ...
     * 
     * @param EducationModule[] $items
     * @return self
     */
    public function setValue(array|EducationModule $items, EducationModule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationModule> $value
     * @return self
     ...
     * 
     * @param EducationModule $item
     * @return self
     */
    public function addValue(EducationModule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationModule>
     */
