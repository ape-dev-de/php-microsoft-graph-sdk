...
/**
 * Collection response for ExternalConnectorsAclCollectionResponse
 */
class ExternalConnectorsAclCollectionResponseCollectionResponse
{
    /**
     * @var ExternalConnectorsAclCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return ExternalConnectorsAclCollectionResponse[]
     */
     ...
     * 
     * @param ExternalConnectorsAclCollectionResponse ...$items Variable number of ExternalConnectorsAclCollectionResponse items
     * @return self
     */
    public function setValue(ExternalConnectorsAclCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ExternalConnectorsAclCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsAclCollectionResponse $item
     * @return self
     */
    public function addValue(ExternalConnectorsAclCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
