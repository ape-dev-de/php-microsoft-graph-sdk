...
/**
 * Collection response for PartnersBillingBillingReconciliation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PartnersBillingBillingReconciliationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PartnersBillingBillingReconciliation[]
     */
    private array $value = [];
     ...
     * 
     * @param PartnersBillingBillingReconciliation[] $items
     * @return self
     */
    public function setValue(array|PartnersBillingBillingReconciliation $items, PartnersBillingBillingReconciliation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PartnersBillingBillingReconciliation> $value
     * @return self
     ...
     * 
     * @param PartnersBillingBillingReconciliation $item
     * @return self
     */
    public function addValue(PartnersBillingBillingReconciliation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PartnersBillingBillingReconciliation>
     */
