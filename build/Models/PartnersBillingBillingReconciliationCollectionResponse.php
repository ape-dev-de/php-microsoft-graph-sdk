 ...
 */
class PartnersBillingBillingReconciliationCollectionResponse
{
    /**
     ...
     * 
     * @param PartnersBillingBillingReconciliation ...$items Variable number of PartnersBillingBillingReconciliation items
     * @return self
     */
    public function setValue(PartnersBillingBillingReconciliation ...$items): self
    {
        $this->value = $items;
        return $this;
    }
