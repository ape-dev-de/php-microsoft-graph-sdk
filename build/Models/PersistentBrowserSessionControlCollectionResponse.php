...
/**
 * Collection response for PersistentBrowserSessionControl
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PersistentBrowserSessionControlCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PersistentBrowserSessionControl[]
     */
    private array $value = [];
     ...
     * 
     * @param PersistentBrowserSessionControl[] $items
     * @return self
     */
    public function setValue(array|PersistentBrowserSessionControl $items, PersistentBrowserSessionControl ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PersistentBrowserSessionControl> $value
     * @return self
     ...
     * 
     * @param PersistentBrowserSessionControl $item
     * @return self
     */
    public function addValue(PersistentBrowserSessionControl $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PersistentBrowserSessionControl>
     */
