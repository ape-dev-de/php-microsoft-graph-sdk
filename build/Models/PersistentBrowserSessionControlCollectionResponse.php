 ...
 */
class PersistentBrowserSessionControlCollectionResponse
{
    /**
     ...
     * 
     * @param PersistentBrowserSessionControl ...$items Variable number of PersistentBrowserSessionControl items
     * @return self
     */
    public function setValue(PersistentBrowserSessionControl ...$items): self
    {
        $this->value = $items;
        return $this;
    }
