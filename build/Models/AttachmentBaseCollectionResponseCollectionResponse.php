...
/**
 * Collection response for AttachmentBaseCollectionResponse
 */
class AttachmentBaseCollectionResponseCollectionResponse
{
    /**
     * @var AttachmentBaseCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AttachmentBaseCollectionResponse ...$items Variable number of AttachmentBaseCollectionResponse items
     * @return self
     */
    public function setValue(AttachmentBaseCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AttachmentBaseCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AttachmentBaseCollectionResponse $item
     * @return self
     */
    public function addValue(AttachmentBaseCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
