...
/**
 * Collection response for WindowsSettingInstance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsSettingInstanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WindowsSettingInstance[] $items
     * @return self
     */
    public function setValue(array|WindowsSettingInstance $items, WindowsSettingInstance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsSettingInstance> $value
     * @return self
     ...
     * 
     * @param WindowsSettingInstance $item
     * @return self
     */
    public function addValue(WindowsSettingInstance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsSettingInstance>
     */
