...
/**
 * Collection response for EndUserNotificationCollectionResponse
 */
class EndUserNotificationCollectionResponseCollectionResponse
{
    /**
     * @var EndUserNotificationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EndUserNotificationCollectionResponse ...$items Variable number of EndUserNotificationCollectionResponse items
     * @return self
     */
    public function setValue(EndUserNotificationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EndUserNotificationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EndUserNotificationCollectionResponse $item
     * @return self
     */
    public function addValue(EndUserNotificationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
