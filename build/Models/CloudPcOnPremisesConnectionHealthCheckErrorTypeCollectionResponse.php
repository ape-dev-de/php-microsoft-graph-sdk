...
/**
 * CloudPcOnPremisesConnectionHealthCheckErrorTypeCollectionResponse - Collection response
 */
class CloudPcOnPremisesConnectionHealthCheckErrorTypeCollectionResponse
{
    /**
     * @var array<int, CloudPcOnPremisesConnectionHealthCheckErrorType>
     */
    public array $value = [];
