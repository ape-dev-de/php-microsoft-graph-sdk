...
/**
 * Collection response for CloudPcOnPremisesConnectionHealthCheckErrorType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcOnPremisesConnectionHealthCheckErrorTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudPcOnPremisesConnectionHealthCheckErrorType[]
     */
    private array $value = [];
     ...
     * 
     * @return CloudPcOnPremisesConnectionHealthCheckErrorType[]
     */
     ...
     * 
     * @param CloudPcOnPremisesConnectionHealthCheckErrorType[] $items
     * @return self
     */
    public function setValue(array|CloudPcOnPremisesConnectionHealthCheckErrorType $items, CloudPcOnPremisesConnectionHealthCheckErrorType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcOnPremisesConnectionHealthCheckErrorType> $value
     * @return self
     ...
     * 
     * @param CloudPcOnPremisesConnectionHealthCheckErrorType $item
     * @return self
     */
    public function addValue(CloudPcOnPremisesConnectionHealthCheckErrorType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcOnPremisesConnectionHealthCheckErrorType>
     */
