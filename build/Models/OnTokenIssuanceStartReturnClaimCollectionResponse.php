...
/**
 * Collection response for OnTokenIssuanceStartReturnClaim
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnTokenIssuanceStartReturnClaimCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnTokenIssuanceStartReturnClaim[]
     */
    private array $value = [];
     ...
     * 
     * @param OnTokenIssuanceStartReturnClaim[] $items
     * @return self
     */
    public function setValue(array|OnTokenIssuanceStartReturnClaim $items, OnTokenIssuanceStartReturnClaim ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnTokenIssuanceStartReturnClaim> $value
     * @return self
     ...
     * 
     * @param OnTokenIssuanceStartReturnClaim $item
     * @return self
     */
    public function addValue(OnTokenIssuanceStartReturnClaim $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OnTokenIssuanceStartReturnClaim|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OnTokenIssuanceStartReturnClaim>
     */
