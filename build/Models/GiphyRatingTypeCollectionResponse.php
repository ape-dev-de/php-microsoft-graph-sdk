...
/**
 * Collection response for GiphyRatingType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class GiphyRatingTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var GiphyRatingType[]
     */
     ...
     * 
     * @param GiphyRatingType[] $items
     * @return self
     */
    public function setValue(array|GiphyRatingType $items, GiphyRatingType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<GiphyRatingType> $value
     * @return self
     ...
     * 
     * @param GiphyRatingType $item
     * @return self
     */
    public function addValue(GiphyRatingType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, GiphyRatingType>
     */
