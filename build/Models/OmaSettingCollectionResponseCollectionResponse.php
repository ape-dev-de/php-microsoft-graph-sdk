...
/**
 * Collection response for OmaSettingCollectionResponse
 */
class OmaSettingCollectionResponseCollectionResponse
{
    /**
     * @var OmaSettingCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param OmaSettingCollectionResponse ...$items Variable number of OmaSettingCollectionResponse items
     * @return self
     */
    public function setValue(OmaSettingCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<OmaSettingCollectionResponse> $value
     * @return self
     ...
     * 
     * @param OmaSettingCollectionResponse $item
     * @return self
     */
    public function addValue(OmaSettingCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
