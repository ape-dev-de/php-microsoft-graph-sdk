...
/**
 * Collection response for LongRunningOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LongRunningOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param LongRunningOperation[] $items
     * @return self
     */
    public function setValue(array|LongRunningOperation $items, LongRunningOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LongRunningOperation> $value
     * @return self
     ...
     * 
     * @param LongRunningOperation $item
     * @return self
     */
    public function addValue(LongRunningOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LongRunningOperation>
     */
