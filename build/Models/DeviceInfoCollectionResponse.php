...
/**
 * Collection response for DeviceInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceInfo[]
     */
     ...
     * 
     * @param DeviceInfo[] $items
     * @return self
     */
    public function setValue(array|DeviceInfo $items, DeviceInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param DeviceInfo $item
     * @return self
     */
    public function addValue(DeviceInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceInfo>
     */
