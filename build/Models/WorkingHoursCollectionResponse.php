...
/**
 * Collection response for WorkingHours
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkingHoursCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkingHours[]
     */
     ...
     * 
     * @param WorkingHours[] $items
     * @return self
     */
    public function setValue(array|WorkingHours $items, WorkingHours ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkingHours> $value
     * @return self
     ...
     * 
     * @param WorkingHours $item
     * @return self
     */
    public function addValue(WorkingHours $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkingHours>
     */
