...
/**
 * Collection response for Windows10MobileCompliancePolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Windows10MobileCompliancePolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param Windows10MobileCompliancePolicy[] $items
     * @return self
     */
    public function setValue(array|Windows10MobileCompliancePolicy $items, Windows10MobileCompliancePolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Windows10MobileCompliancePolicy> $value
     * @return self
     ...
     * 
     * @param Windows10MobileCompliancePolicy $item
     * @return self
     */
    public function addValue(Windows10MobileCompliancePolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return Windows10MobileCompliancePolicy|null
     */
     ...
     * 
     * @return \ArrayIterator<int, Windows10MobileCompliancePolicy>
     */
