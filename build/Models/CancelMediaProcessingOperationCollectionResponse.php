...
/**
 * Collection response for CancelMediaProcessingOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CancelMediaProcessingOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CancelMediaProcessingOperation[] $items
     * @return self
     */
    public function setValue(array|CancelMediaProcessingOperation $items, CancelMediaProcessingOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CancelMediaProcessingOperation> $value
     * @return self
     ...
     * 
     * @param CancelMediaProcessingOperation $item
     * @return self
     */
    public function addValue(CancelMediaProcessingOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CancelMediaProcessingOperation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CancelMediaProcessingOperation>
     */
