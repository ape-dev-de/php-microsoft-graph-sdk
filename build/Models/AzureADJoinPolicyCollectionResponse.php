...
/**
 * Collection response for AzureADJoinPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AzureADJoinPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AzureADJoinPolicy[]
     */
    private array $value = [];
     ...
     * 
     * @param AzureADJoinPolicy[] $items
     * @return self
     */
    public function setValue(array|AzureADJoinPolicy $items, AzureADJoinPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AzureADJoinPolicy> $value
     * @return self
     ...
     * 
     * @param AzureADJoinPolicy $item
     * @return self
     */
    public function addValue(AzureADJoinPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AzureADJoinPolicy>
     */
