 ...
 */
class AzureADJoinPolicyCollectionResponse
{
    /**
     ...
     * 
     * @param AzureADJoinPolicy ...$items Variable number of AzureADJoinPolicy items
     * @return self
     */
    public function setValue(AzureADJoinPolicy ...$items): self
    {
        $this->value = $items;
        return $this;
    }
