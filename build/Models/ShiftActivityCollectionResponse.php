...
/**
 * Collection response for ShiftActivity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ShiftActivityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ShiftActivity[]
     */
     ...
     * 
     * @param ShiftActivity[] $items
     * @return self
     */
    public function setValue(array|ShiftActivity $items, ShiftActivity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ShiftActivity> $value
     * @return self
     ...
     * 
     * @param ShiftActivity $item
     * @return self
     */
    public function addValue(ShiftActivity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ShiftActivity>
     */
