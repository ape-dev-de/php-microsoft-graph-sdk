...
/**
 * Collection response for ObjectDefinitionMetadataEntry
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ObjectDefinitionMetadataEntryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ObjectDefinitionMetadataEntry[] $items
     * @return self
     */
    public function setValue(array|ObjectDefinitionMetadataEntry $items, ObjectDefinitionMetadataEntry ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ObjectDefinitionMetadataEntry> $value
     * @return self
     ...
     * 
     * @param ObjectDefinitionMetadataEntry $item
     * @return self
     */
    public function addValue(ObjectDefinitionMetadataEntry $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ObjectDefinitionMetadataEntry|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ObjectDefinitionMetadataEntry>
     */
