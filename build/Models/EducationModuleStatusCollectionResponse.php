...
/**
 * Collection response for EducationModuleStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationModuleStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationModuleStatus[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationModuleStatus[] $items
     * @return self
     */
    public function setValue(array|EducationModuleStatus $items, EducationModuleStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationModuleStatus> $value
     * @return self
     ...
     * 
     * @param EducationModuleStatus $item
     * @return self
     */
    public function addValue(EducationModuleStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationModuleStatus>
     */
