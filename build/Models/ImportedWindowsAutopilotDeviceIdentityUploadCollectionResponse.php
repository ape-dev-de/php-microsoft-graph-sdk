...
/**
 * Collection response for ImportedWindowsAutopilotDeviceIdentityUpload
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ImportedWindowsAutopilotDeviceIdentityUploadCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ImportedWindowsAutopilotDeviceIdentityUpload[]
     */
    private array $value = [];
     ...
     * 
     * @param ImportedWindowsAutopilotDeviceIdentityUpload[] $items
     * @return self
     */
    public function setValue(array|ImportedWindowsAutopilotDeviceIdentityUpload $items, ImportedWindowsAutopilotDeviceIdentityUpload ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ImportedWindowsAutopilotDeviceIdentityUpload> $value
     * @return self
     ...
     * 
     * @param ImportedWindowsAutopilotDeviceIdentityUpload $item
     * @return self
     */
    public function addValue(ImportedWindowsAutopilotDeviceIdentityUpload $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ImportedWindowsAutopilotDeviceIdentityUpload|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ImportedWindowsAutopilotDeviceIdentityUpload>
     */
