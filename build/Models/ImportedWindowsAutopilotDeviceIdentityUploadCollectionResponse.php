 ...
 */
class ImportedWindowsAutopilotDeviceIdentityUploadCollectionResponse
{
    /**
     ...
     * 
     * @param ImportedWindowsAutopilotDeviceIdentityUpload ...$items Variable number of ImportedWindowsAutopilotDeviceIdentityUpload items
     * @return self
     */
    public function setValue(ImportedWindowsAutopilotDeviceIdentityUpload ...$items): self
    {
        $this->value = $items;
        return $this;
    }
