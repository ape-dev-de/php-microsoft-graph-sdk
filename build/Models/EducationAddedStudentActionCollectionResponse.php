...
/**
 * Collection response for EducationAddedStudentAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationAddedStudentActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationAddedStudentAction[]
     */
    private array $value = [];
     ...
     * 
     * @return EducationAddedStudentAction[]
     */
     ...
     * 
     * @param EducationAddedStudentAction[] $items
     * @return self
     */
    public function setValue(array|EducationAddedStudentAction $items, EducationAddedStudentAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationAddedStudentAction> $value
     * @return self
     ...
     * 
     * @param EducationAddedStudentAction $item
     * @return self
     */
    public function addValue(EducationAddedStudentAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationAddedStudentAction>
     */
