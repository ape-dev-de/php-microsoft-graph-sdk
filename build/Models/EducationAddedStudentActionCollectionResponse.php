...
/**
 * EducationAddedStudentActionCollectionResponse - Collection response
 */
class EducationAddedStudentActionCollectionResponse
{
    /**
     * @var array<int, EducationAddedStudentAction>
     */
    public array $value = [];
