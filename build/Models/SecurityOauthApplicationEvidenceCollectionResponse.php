 ...
 */
class SecurityOauthApplicationEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityOauthApplicationEvidence ...$items Variable number of SecurityOauthApplicationEvidence items
     * @return self
     */
    public function setValue(SecurityOauthApplicationEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
