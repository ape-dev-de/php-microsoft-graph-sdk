...
/**
 * Collection response for SecurityOauthApplicationEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityOauthApplicationEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityOauthApplicationEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityOauthApplicationEvidence[]
     */
     ...
     * 
     * @param SecurityOauthApplicationEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityOauthApplicationEvidence $items, SecurityOauthApplicationEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityOauthApplicationEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityOauthApplicationEvidence $item
     * @return self
     */
    public function addValue(SecurityOauthApplicationEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityOauthApplicationEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityOauthApplicationEvidence>
     */
