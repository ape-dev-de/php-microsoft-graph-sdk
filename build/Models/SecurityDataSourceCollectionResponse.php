...
/**
 * Collection response for SecurityDataSource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityDataSourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityDataSource[] $items
     * @return self
     */
    public function setValue(array|SecurityDataSource $items, SecurityDataSource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityDataSource> $value
     * @return self
     ...
     * 
     * @param SecurityDataSource $item
     * @return self
     */
    public function addValue(SecurityDataSource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityDataSource>
     */
