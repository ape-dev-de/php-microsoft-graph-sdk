...
/**
 * Collection response for TargettedUserType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TargettedUserTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TargettedUserType[]
     */
    private array $value = [];
     ...
     * 
     * @param TargettedUserType[] $items
     * @return self
     */
    public function setValue(array|TargettedUserType $items, TargettedUserType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TargettedUserType> $value
     * @return self
     ...
     * 
     * @param TargettedUserType $item
     * @return self
     */
    public function addValue(TargettedUserType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TargettedUserType>
     */
