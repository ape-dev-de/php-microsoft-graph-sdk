...
/**
 * Collection response for BooleanColumn
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BooleanColumnCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BooleanColumn[]
     */
     ...
     * 
     * @param BooleanColumn[] $items
     * @return self
     */
    public function setValue(array|BooleanColumn $items, BooleanColumn ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BooleanColumn> $value
     * @return self
     ...
     * 
     * @param BooleanColumn $item
     * @return self
     */
    public function addValue(BooleanColumn $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BooleanColumn>
     */
