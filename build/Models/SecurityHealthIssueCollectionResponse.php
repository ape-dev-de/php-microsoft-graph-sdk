...
/**
 * Collection response for SecurityHealthIssue
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHealthIssueCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityHealthIssue[] $items
     * @return self
     */
    public function setValue(array|SecurityHealthIssue $items, SecurityHealthIssue ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHealthIssue> $value
     * @return self
     ...
     * 
     * @param SecurityHealthIssue $item
     * @return self
     */
    public function addValue(SecurityHealthIssue $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityHealthIssue>
     */
