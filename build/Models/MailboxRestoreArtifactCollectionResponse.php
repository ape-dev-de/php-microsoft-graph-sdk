...
/**
 * Collection response for MailboxRestoreArtifact
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MailboxRestoreArtifactCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MailboxRestoreArtifact[] $items
     * @return self
     */
    public function setValue(array|MailboxRestoreArtifact $items, MailboxRestoreArtifact ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MailboxRestoreArtifact> $value
     * @return self
     ...
     * 
     * @param MailboxRestoreArtifact $item
     * @return self
     */
    public function addValue(MailboxRestoreArtifact $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MailboxRestoreArtifact>
     */
