...
/**
 * Collection response for RecordOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RecordOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RecordOperation[]
     */
     ...
     * 
     * @param RecordOperation[] $items
     * @return self
     */
    public function setValue(array|RecordOperation $items, RecordOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RecordOperation> $value
     * @return self
     ...
     * 
     * @param RecordOperation $item
     * @return self
     */
    public function addValue(RecordOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RecordOperation>
     */
