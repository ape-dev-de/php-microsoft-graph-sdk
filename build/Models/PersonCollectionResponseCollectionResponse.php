...
/**
 * Collection response for PersonCollectionResponse
 */
class PersonCollectionResponseCollectionResponse
{
    /**
     * @var PersonCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PersonCollectionResponse ...$items Variable number of PersonCollectionResponse items
     * @return self
     */
    public function setValue(PersonCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PersonCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PersonCollectionResponse $item
     * @return self
     */
    public function addValue(PersonCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
