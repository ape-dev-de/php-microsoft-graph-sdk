...
/**
 * Collection response for GroupPeerOutlierRecommendationInsightSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class GroupPeerOutlierRecommendationInsightSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var GroupPeerOutlierRecommendationInsightSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param GroupPeerOutlierRecommendationInsightSettings[] $items
     * @return self
     */
    public function setValue(array|GroupPeerOutlierRecommendationInsightSettings $items, GroupPeerOutlierRecommendationInsightSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<GroupPeerOutlierRecommendationInsightSettings> $value
     * @return self
     ...
     * 
     * @param GroupPeerOutlierRecommendationInsightSettings $item
     * @return self
     */
    public function addValue(GroupPeerOutlierRecommendationInsightSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return GroupPeerOutlierRecommendationInsightSettings|null
     */
     ...
     * 
     * @return \ArrayIterator<int, GroupPeerOutlierRecommendationInsightSettings>
     */
