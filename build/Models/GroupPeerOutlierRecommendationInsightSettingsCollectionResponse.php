...
/**
 * GroupPeerOutlierRecommendationInsightSettingsCollectionResponse - Collection response
 */
class GroupPeerOutlierRecommendationInsightSettingsCollectionResponse
{
    /**
     * @var array<int, GroupPeerOutlierRecommendationInsightSettings>
     */
    public array $value = [];
