 ...
 */
class UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric $items, UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric>
     */
