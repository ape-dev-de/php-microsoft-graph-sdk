...
/**
 * UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricCollectionResponse - Collection response
 */
class UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetricCollectionResponse
{
    /**
     * @var array<int, UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric>
     */
    public array $value = [];
