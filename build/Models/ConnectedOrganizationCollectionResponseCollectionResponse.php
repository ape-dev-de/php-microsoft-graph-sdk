...
/**
 * Collection response for ConnectedOrganizationCollectionResponse
 */
class ConnectedOrganizationCollectionResponseCollectionResponse
{
    /**
     * @var ConnectedOrganizationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ConnectedOrganizationCollectionResponse ...$items Variable number of ConnectedOrganizationCollectionResponse items
     * @return self
     */
    public function setValue(ConnectedOrganizationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ConnectedOrganizationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ConnectedOrganizationCollectionResponse $item
     * @return self
     */
    public function addValue(ConnectedOrganizationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
