...
/**
 * Collection response for DetectedAppPlatformType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DetectedAppPlatformTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return DetectedAppPlatformType[]
     */
     ...
     * 
     * @param DetectedAppPlatformType[] $items
     * @return self
     */
    public function setValue(array|DetectedAppPlatformType $items, DetectedAppPlatformType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DetectedAppPlatformType> $value
     * @return self
     ...
     * 
     * @param DetectedAppPlatformType $item
     * @return self
     */
    public function addValue(DetectedAppPlatformType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DetectedAppPlatformType>
     */
