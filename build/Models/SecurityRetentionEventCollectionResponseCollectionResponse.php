...
/**
 * Collection response for SecurityRetentionEventCollectionResponse
 */
class SecurityRetentionEventCollectionResponseCollectionResponse
{
    /**
     * @var SecurityRetentionEventCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityRetentionEventCollectionResponse ...$items Variable number of SecurityRetentionEventCollectionResponse items
     * @return self
     */
    public function setValue(SecurityRetentionEventCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityRetentionEventCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityRetentionEventCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityRetentionEventCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
