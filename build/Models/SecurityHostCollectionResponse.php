...
/**
 * Collection response for SecurityHost
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHostCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityHost[]
     */
     ...
     * 
     * @param SecurityHost[] $items
     * @return self
     */
    public function setValue(array|SecurityHost $items, SecurityHost ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHost> $value
     * @return self
     ...
     * 
     * @param SecurityHost $item
     * @return self
     */
    public function addValue(SecurityHost $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityHost>
     */
