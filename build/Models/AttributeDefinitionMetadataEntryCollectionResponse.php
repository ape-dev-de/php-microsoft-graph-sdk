...
/**
 * Collection response for AttributeDefinitionMetadataEntry
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttributeDefinitionMetadataEntryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AttributeDefinitionMetadataEntry[] $items
     * @return self
     */
    public function setValue(array|AttributeDefinitionMetadataEntry $items, AttributeDefinitionMetadataEntry ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttributeDefinitionMetadataEntry> $value
     * @return self
     ...
     * 
     * @param AttributeDefinitionMetadataEntry $item
     * @return self
     */
    public function addValue(AttributeDefinitionMetadataEntry $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AttributeDefinitionMetadataEntry|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AttributeDefinitionMetadataEntry>
     */
