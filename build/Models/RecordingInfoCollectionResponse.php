 ...
 */
class RecordingInfoCollectionResponse
{
    /**
     * @var RecordingInfo[]
     */
     ...
     * 
     * @param RecordingInfo ...$items Variable number of RecordingInfo items
     * @return self
     */
    public function setValue(RecordingInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
