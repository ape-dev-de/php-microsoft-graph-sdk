...
/**
 * Collection response for RecordingInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RecordingInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RecordingInfo[]
     */
     ...
     * 
     * @param RecordingInfo[] $items
     * @return self
     */
    public function setValue(array|RecordingInfo $items, RecordingInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RecordingInfo> $value
     * @return self
     ...
     * 
     * @param RecordingInfo $item
     * @return self
     */
    public function addValue(RecordingInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RecordingInfo>
     */
