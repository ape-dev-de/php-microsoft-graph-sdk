...
/**
 * Collection response for LocationConstraintItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LocationConstraintItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param LocationConstraintItem[] $items
     * @return self
     */
    public function setValue(array|LocationConstraintItem $items, LocationConstraintItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LocationConstraintItem> $value
     * @return self
     ...
     * 
     * @param LocationConstraintItem $item
     * @return self
     */
    public function addValue(LocationConstraintItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return LocationConstraintItem|null
     */
     ...
     * 
     * @return \ArrayIterator<int, LocationConstraintItem>
     */
