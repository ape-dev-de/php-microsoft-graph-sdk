...
/**
 * Collection response for SynchronizationMetadataEntry
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationMetadataEntryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SynchronizationMetadataEntry[] $items
     * @return self
     */
    public function setValue(array|SynchronizationMetadataEntry $items, SynchronizationMetadataEntry ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SynchronizationMetadataEntry> $value
     * @return self
     ...
     * 
     * @param SynchronizationMetadataEntry $item
     * @return self
     */
    public function addValue(SynchronizationMetadataEntry $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SynchronizationMetadataEntry|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SynchronizationMetadataEntry>
     */
