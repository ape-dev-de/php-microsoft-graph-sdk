...
/**
 * IdentityGovernanceCustomTaskExtensionCallbackDataCollectionResponse - Collection response
 */
class IdentityGovernanceCustomTaskExtensionCallbackDataCollectionResponse
{
    /**
     * @var array<int, IdentityGovernanceCustomTaskExtensionCallbackData>
     */
    public array $value = [];
