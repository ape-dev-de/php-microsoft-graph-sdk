...
/**
 * Collection response for IdentityGovernanceCustomTaskExtensionCallbackData
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceCustomTaskExtensionCallbackDataCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceCustomTaskExtensionCallbackData[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceCustomTaskExtensionCallbackData[]
     */
     ...
     * 
     * @param IdentityGovernanceCustomTaskExtensionCallbackData[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceCustomTaskExtensionCallbackData $items, IdentityGovernanceCustomTaskExtensionCallbackData ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceCustomTaskExtensionCallbackData> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceCustomTaskExtensionCallbackData $item
     * @return self
     */
    public function addValue(IdentityGovernanceCustomTaskExtensionCallbackData $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceCustomTaskExtensionCallbackData|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceCustomTaskExtensionCallbackData>
     */
