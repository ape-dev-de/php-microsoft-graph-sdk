...
/**
 * Collection response for AndroidWorkProfileCompliancePolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AndroidWorkProfileCompliancePolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AndroidWorkProfileCompliancePolicy[]
     */
    private array $value = [];
     ...
     * 
     * @param AndroidWorkProfileCompliancePolicy[] $items
     * @return self
     */
    public function setValue(array|AndroidWorkProfileCompliancePolicy $items, AndroidWorkProfileCompliancePolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AndroidWorkProfileCompliancePolicy> $value
     * @return self
     ...
     * 
     * @param AndroidWorkProfileCompliancePolicy $item
     * @return self
     */
    public function addValue(AndroidWorkProfileCompliancePolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AndroidWorkProfileCompliancePolicy|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AndroidWorkProfileCompliancePolicy>
     */
