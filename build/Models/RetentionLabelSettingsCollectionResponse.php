 ...
 */
class RetentionLabelSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param RetentionLabelSettings ...$items Variable number of RetentionLabelSettings items
     * @return self
     */
    public function setValue(RetentionLabelSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
