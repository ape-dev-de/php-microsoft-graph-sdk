...
/**
 * Collection response for RetentionLabelSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RetentionLabelSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RetentionLabelSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param RetentionLabelSettings[] $items
     * @return self
     */
    public function setValue(array|RetentionLabelSettings $items, RetentionLabelSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RetentionLabelSettings> $value
     * @return self
     ...
     * 
     * @param RetentionLabelSettings $item
     * @return self
     */
    public function addValue(RetentionLabelSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RetentionLabelSettings>
     */
