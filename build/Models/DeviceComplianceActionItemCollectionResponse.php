...
/**
 * Collection response for DeviceComplianceActionItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceComplianceActionItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceComplianceActionItem[] $items
     * @return self
     */
    public function setValue(array|DeviceComplianceActionItem $items, DeviceComplianceActionItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceComplianceActionItem> $value
     * @return self
     ...
     * 
     * @param DeviceComplianceActionItem $item
     * @return self
     */
    public function addValue(DeviceComplianceActionItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceComplianceActionItem>
     */
