 ...
 */
class SiteArchivalDetailsCollectionResponse
{
    /**
     ...
     * 
     * @param SiteArchivalDetails ...$items Variable number of SiteArchivalDetails items
     * @return self
     */
    public function setValue(SiteArchivalDetails ...$items): self
    {
        $this->value = $items;
        return $this;
    }
