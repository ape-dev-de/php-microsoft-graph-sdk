...
/**
 * Collection response for SiteArchivalDetails
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SiteArchivalDetailsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SiteArchivalDetails[]
     */
    private array $value = [];
     ...
     * 
     * @param SiteArchivalDetails[] $items
     * @return self
     */
    public function setValue(array|SiteArchivalDetails $items, SiteArchivalDetails ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SiteArchivalDetails> $value
     * @return self
     ...
     * 
     * @param SiteArchivalDetails $item
     * @return self
     */
    public function addValue(SiteArchivalDetails $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SiteArchivalDetails>
     */
