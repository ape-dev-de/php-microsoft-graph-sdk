...
/**
 * Collection response for SendDtmfTonesOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SendDtmfTonesOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SendDtmfTonesOperation[]
     */
    private array $value = [];
     ...
     * 
     * @param SendDtmfTonesOperation[] $items
     * @return self
     */
    public function setValue(array|SendDtmfTonesOperation $items, SendDtmfTonesOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SendDtmfTonesOperation> $value
     * @return self
     ...
     * 
     * @param SendDtmfTonesOperation $item
     * @return self
     */
    public function addValue(SendDtmfTonesOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SendDtmfTonesOperation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SendDtmfTonesOperation>
     */
