...
/**
 * Collection response for CommunicationsUserIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CommunicationsUserIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CommunicationsUserIdentity[] $items
     * @return self
     */
    public function setValue(array|CommunicationsUserIdentity $items, CommunicationsUserIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CommunicationsUserIdentity> $value
     * @return self
     ...
     * 
     * @param CommunicationsUserIdentity $item
     * @return self
     */
    public function addValue(CommunicationsUserIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CommunicationsUserIdentity>
     */
