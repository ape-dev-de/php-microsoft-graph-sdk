...
/**
 * Collection response for ResourcePermission
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ResourcePermissionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ResourcePermission[] $items
     * @return self
     */
    public function setValue(array|ResourcePermission $items, ResourcePermission ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ResourcePermission> $value
     * @return self
     ...
     * 
     * @param ResourcePermission $item
     * @return self
     */
    public function addValue(ResourcePermission $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ResourcePermission>
     */
