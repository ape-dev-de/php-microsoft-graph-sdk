...
/**
 * Collection response for OnTokenIssuanceStartHandler
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnTokenIssuanceStartHandlerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnTokenIssuanceStartHandler[]
     */
    private array $value = [];
     ...
     * 
     * @param OnTokenIssuanceStartHandler[] $items
     * @return self
     */
    public function setValue(array|OnTokenIssuanceStartHandler $items, OnTokenIssuanceStartHandler ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnTokenIssuanceStartHandler> $value
     * @return self
     ...
     * 
     * @param OnTokenIssuanceStartHandler $item
     * @return self
     */
    public function addValue(OnTokenIssuanceStartHandler $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnTokenIssuanceStartHandler>
     */
