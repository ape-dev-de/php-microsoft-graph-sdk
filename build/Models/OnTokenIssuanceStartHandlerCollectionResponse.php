...
/**
 * OnTokenIssuanceStartHandlerCollectionResponse - Collection response
 */
class OnTokenIssuanceStartHandlerCollectionResponse
{
    /**
     * @var array<int, OnTokenIssuanceStartHandler>
     */
    public array $value = [];
