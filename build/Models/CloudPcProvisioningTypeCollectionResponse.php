...
/**
 * Collection response for CloudPcProvisioningType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcProvisioningTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CloudPcProvisioningType[] $items
     * @return self
     */
    public function setValue(array|CloudPcProvisioningType $items, CloudPcProvisioningType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcProvisioningType> $value
     * @return self
     ...
     * 
     * @param CloudPcProvisioningType $item
     * @return self
     */
    public function addValue(CloudPcProvisioningType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcProvisioningType>
     */
