...
/**
 * Collection response for TeamsTemplateCollectionResponse
 */
class TeamsTemplateCollectionResponseCollectionResponse
{
    /**
     * @var TeamsTemplateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamsTemplateCollectionResponse ...$items Variable number of TeamsTemplateCollectionResponse items
     * @return self
     */
    public function setValue(TeamsTemplateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TeamsTemplateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TeamsTemplateCollectionResponse $item
     * @return self
     */
    public function addValue(TeamsTemplateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
