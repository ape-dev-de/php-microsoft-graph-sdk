...
/**
 * SecurityEdiscoverySearchExportOperationCollectionResponse - Collection response
 */
class SecurityEdiscoverySearchExportOperationCollectionResponse
{
    /**
     * @var array<int, SecurityEdiscoverySearchExportOperation>
     */
    public array $value = [];
