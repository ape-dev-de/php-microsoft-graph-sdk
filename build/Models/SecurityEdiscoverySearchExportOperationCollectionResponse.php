...
/**
 * Collection response for SecurityEdiscoverySearchExportOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityEdiscoverySearchExportOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityEdiscoverySearchExportOperation[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityEdiscoverySearchExportOperation[]
     */
     ...
     * 
     * @param SecurityEdiscoverySearchExportOperation[] $items
     * @return self
     */
    public function setValue(array|SecurityEdiscoverySearchExportOperation $items, SecurityEdiscoverySearchExportOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityEdiscoverySearchExportOperation> $value
     * @return self
     ...
     * 
     * @param SecurityEdiscoverySearchExportOperation $item
     * @return self
     */
    public function addValue(SecurityEdiscoverySearchExportOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityEdiscoverySearchExportOperation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityEdiscoverySearchExportOperation>
     */
