...
/**
 * Collection response for RoleManagement
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RoleManagementCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RoleManagement[]
     */
     ...
     * 
     * @param RoleManagement[] $items
     * @return self
     */
    public function setValue(array|RoleManagement $items, RoleManagement ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RoleManagement> $value
     * @return self
     ...
     * 
     * @param RoleManagement $item
     * @return self
     */
    public function addValue(RoleManagement $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RoleManagement>
     */
