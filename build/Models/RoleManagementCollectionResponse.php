 ...
 */
class RoleManagementCollectionResponse
{
    /**
     * @var RoleManagement[]
     */
     ...
     * 
     * @param RoleManagement ...$items Variable number of RoleManagement items
     * @return self
     */
    public function setValue(RoleManagement ...$items): self
    {
        $this->value = $items;
        return $this;
    }
