...
/**
 * Collection response for SecurityHostPortProtocol
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHostPortProtocolCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityHostPortProtocol[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityHostPortProtocol[]
     */
     ...
     * 
     * @param SecurityHostPortProtocol[] $items
     * @return self
     */
    public function setValue(array|SecurityHostPortProtocol $items, SecurityHostPortProtocol ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHostPortProtocol> $value
     * @return self
     ...
     * 
     * @param SecurityHostPortProtocol $item
     * @return self
     */
    public function addValue(SecurityHostPortProtocol $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityHostPortProtocol|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityHostPortProtocol>
     */
