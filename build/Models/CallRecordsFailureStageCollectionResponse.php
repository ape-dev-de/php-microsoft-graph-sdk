...
/**
 * Collection response for CallRecordsFailureStage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsFailureStageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsFailureStage[]
     */
    private array $value = [];
     ...
     * 
     * @return CallRecordsFailureStage[]
     */
     ...
     * 
     * @param CallRecordsFailureStage[] $items
     * @return self
     */
    public function setValue(array|CallRecordsFailureStage $items, CallRecordsFailureStage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsFailureStage> $value
     * @return self
     ...
     * 
     * @param CallRecordsFailureStage $item
     * @return self
     */
    public function addValue(CallRecordsFailureStage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsFailureStage|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsFailureStage>
     */
