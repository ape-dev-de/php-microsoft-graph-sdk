 ...
 */
class PositiveReinforcementNotificationCollectionResponse
{
    /**
     ...
     * 
     * @param PositiveReinforcementNotification ...$items Variable number of PositiveReinforcementNotification items
     * @return self
     */
    public function setValue(PositiveReinforcementNotification ...$items): self
    {
        $this->value = $items;
        return $this;
    }
