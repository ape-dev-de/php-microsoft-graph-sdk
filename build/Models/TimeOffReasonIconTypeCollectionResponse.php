...
/**
 * Collection response for TimeOffReasonIconType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TimeOffReasonIconTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TimeOffReasonIconType[] $items
     * @return self
     */
    public function setValue(array|TimeOffReasonIconType $items, TimeOffReasonIconType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TimeOffReasonIconType> $value
     * @return self
     ...
     * 
     * @param TimeOffReasonIconType $item
     * @return self
     */
    public function addValue(TimeOffReasonIconType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TimeOffReasonIconType>
     */
