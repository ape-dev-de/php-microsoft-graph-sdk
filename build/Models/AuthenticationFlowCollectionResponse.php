...
/**
 * Collection response for AuthenticationFlow
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationFlowCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AuthenticationFlow[] $items
     * @return self
     */
    public function setValue(array|AuthenticationFlow $items, AuthenticationFlow ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationFlow> $value
     * @return self
     ...
     * 
     * @param AuthenticationFlow $item
     * @return self
     */
    public function addValue(AuthenticationFlow $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationFlow>
     */
