 ...
 */
class AuthenticationFlowCollectionResponse
{
    /**
     ...
     * 
     * @param AuthenticationFlow ...$items Variable number of AuthenticationFlow items
     * @return self
     */
    public function setValue(AuthenticationFlow ...$items): self
    {
        $this->value = $items;
        return $this;
    }
