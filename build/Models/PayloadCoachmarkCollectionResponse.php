...
/**
 * Collection response for PayloadCoachmark
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PayloadCoachmarkCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PayloadCoachmark[] $items
     * @return self
     */
    public function setValue(array|PayloadCoachmark $items, PayloadCoachmark ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PayloadCoachmark> $value
     * @return self
     ...
     * 
     * @param PayloadCoachmark $item
     * @return self
     */
    public function addValue(PayloadCoachmark $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PayloadCoachmark>
     */
