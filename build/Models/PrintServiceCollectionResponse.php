...
/**
 * Collection response for PrintService
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintServiceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrintService[]
     */
     ...
     * 
     * @param PrintService[] $items
     * @return self
     */
    public function setValue(array|PrintService $items, PrintService ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintService> $value
     * @return self
     ...
     * 
     * @param PrintService $item
     * @return self
     */
    public function addValue(PrintService $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintService>
     */
