...
/**
 * Collection response for WorkbookChartPointCollectionResponse
 */
class WorkbookChartPointCollectionResponseCollectionResponse
{
    /**
     * @var WorkbookChartPointCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookChartPointCollectionResponse ...$items Variable number of WorkbookChartPointCollectionResponse items
     * @return self
     */
    public function setValue(WorkbookChartPointCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WorkbookChartPointCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WorkbookChartPointCollectionResponse $item
     * @return self
     */
    public function addValue(WorkbookChartPointCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
