...
/**
 * Collection response for OnlineMeetingCollectionResponse
 */
class OnlineMeetingCollectionResponseCollectionResponse
{
    /**
     * @var OnlineMeetingCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param OnlineMeetingCollectionResponse ...$items Variable number of OnlineMeetingCollectionResponse items
     * @return self
     */
    public function setValue(OnlineMeetingCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<OnlineMeetingCollectionResponse> $value
     * @return self
     ...
     * 
     * @param OnlineMeetingCollectionResponse $item
     * @return self
     */
    public function addValue(OnlineMeetingCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
