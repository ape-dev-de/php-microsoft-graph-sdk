...
/**
 * Collection response for AttributeFlowBehavior
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttributeFlowBehaviorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AttributeFlowBehavior[] $items
     * @return self
     */
    public function setValue(array|AttributeFlowBehavior $items, AttributeFlowBehavior ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttributeFlowBehavior> $value
     * @return self
     ...
     * 
     * @param AttributeFlowBehavior $item
     * @return self
     */
    public function addValue(AttributeFlowBehavior $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AttributeFlowBehavior>
     */
