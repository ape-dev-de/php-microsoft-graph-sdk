...
/**
 * Collection response for AddIn
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AddInCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AddIn[]
     */
     ...
     * @return self
     */
    public function setValue(array|AddIn $items, AddIn ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(AddIn $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AddIn>
     */
