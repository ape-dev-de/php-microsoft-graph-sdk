...
/**
 * Collection response for EmailAuthenticationMethodCollectionResponse
 */
class EmailAuthenticationMethodCollectionResponseCollectionResponse
{
    /**
     * @var EmailAuthenticationMethodCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EmailAuthenticationMethodCollectionResponse ...$items Variable number of EmailAuthenticationMethodCollectionResponse items
     * @return self
     */
    public function setValue(EmailAuthenticationMethodCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EmailAuthenticationMethodCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EmailAuthenticationMethodCollectionResponse $item
     * @return self
     */
    public function addValue(EmailAuthenticationMethodCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
