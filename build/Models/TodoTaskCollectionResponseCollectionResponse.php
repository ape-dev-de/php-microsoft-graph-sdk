...
/**
 * Collection response for TodoTaskCollectionResponse
 */
class TodoTaskCollectionResponseCollectionResponse
{
    /**
     * @var TodoTaskCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TodoTaskCollectionResponse ...$items Variable number of TodoTaskCollectionResponse items
     * @return self
     */
    public function setValue(TodoTaskCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TodoTaskCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TodoTaskCollectionResponse $item
     * @return self
     */
    public function addValue(TodoTaskCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
