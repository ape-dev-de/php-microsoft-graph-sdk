 ...
 */
class JoinMeetingIdSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param JoinMeetingIdSettings ...$items Variable number of JoinMeetingIdSettings items
     * @return self
     */
    public function setValue(JoinMeetingIdSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
