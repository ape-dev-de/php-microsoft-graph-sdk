...
/**
 * Collection response for JoinMeetingIdSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class JoinMeetingIdSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var JoinMeetingIdSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param JoinMeetingIdSettings[] $items
     * @return self
     */
    public function setValue(array|JoinMeetingIdSettings $items, JoinMeetingIdSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<JoinMeetingIdSettings> $value
     * @return self
     ...
     * 
     * @param JoinMeetingIdSettings $item
     * @return self
     */
    public function addValue(JoinMeetingIdSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, JoinMeetingIdSettings>
     */
