...
/**
 * Collection response for SecurityKubernetesSecretEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityKubernetesSecretEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityKubernetesSecretEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityKubernetesSecretEvidence[]
     */
     ...
     * 
     * @param SecurityKubernetesSecretEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityKubernetesSecretEvidence $items, SecurityKubernetesSecretEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityKubernetesSecretEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityKubernetesSecretEvidence $item
     * @return self
     */
    public function addValue(SecurityKubernetesSecretEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityKubernetesSecretEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityKubernetesSecretEvidence>
     */
