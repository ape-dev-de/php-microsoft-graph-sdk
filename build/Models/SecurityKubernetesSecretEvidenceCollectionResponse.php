 ...
 */
class SecurityKubernetesSecretEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityKubernetesSecretEvidence ...$items Variable number of SecurityKubernetesSecretEvidence items
     * @return self
     */
    public function setValue(SecurityKubernetesSecretEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
