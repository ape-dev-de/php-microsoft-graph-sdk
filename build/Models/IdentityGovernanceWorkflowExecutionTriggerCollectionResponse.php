...
/**
 * Collection response for IdentityGovernanceWorkflowExecutionTrigger
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceWorkflowExecutionTriggerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceWorkflowExecutionTrigger[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceWorkflowExecutionTrigger[]
     */
     ...
     * 
     * @param IdentityGovernanceWorkflowExecutionTrigger[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceWorkflowExecutionTrigger $items, IdentityGovernanceWorkflowExecutionTrigger ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceWorkflowExecutionTrigger> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceWorkflowExecutionTrigger $item
     * @return self
     */
    public function addValue(IdentityGovernanceWorkflowExecutionTrigger $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceWorkflowExecutionTrigger|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceWorkflowExecutionTrigger>
     */
