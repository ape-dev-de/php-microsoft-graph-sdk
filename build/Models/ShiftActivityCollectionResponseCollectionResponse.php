...
/**
 * Collection response for ShiftActivityCollectionResponse
 */
class ShiftActivityCollectionResponseCollectionResponse
{
    /**
     * @var ShiftActivityCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ShiftActivityCollectionResponse ...$items Variable number of ShiftActivityCollectionResponse items
     * @return self
     */
    public function setValue(ShiftActivityCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ShiftActivityCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ShiftActivityCollectionResponse $item
     * @return self
     */
    public function addValue(ShiftActivityCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
