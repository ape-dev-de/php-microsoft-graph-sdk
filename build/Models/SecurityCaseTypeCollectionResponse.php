...
/**
 * Collection response for SecurityCaseType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityCaseTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityCaseType[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityCaseType[] $items
     * @return self
     */
    public function setValue(array|SecurityCaseType $items, SecurityCaseType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityCaseType> $value
     * @return self
     ...
     * 
     * @param SecurityCaseType $item
     * @return self
     */
    public function addValue(SecurityCaseType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityCaseType>
     */
