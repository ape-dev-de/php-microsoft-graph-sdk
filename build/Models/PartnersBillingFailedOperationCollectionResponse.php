...
/**
 * Collection response for PartnersBillingFailedOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PartnersBillingFailedOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return PartnersBillingFailedOperation[]
     */
     ...
     * 
     * @param PartnersBillingFailedOperation[] $items
     * @return self
     */
    public function setValue(array|PartnersBillingFailedOperation $items, PartnersBillingFailedOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PartnersBillingFailedOperation> $value
     * @return self
     ...
     * 
     * @param PartnersBillingFailedOperation $item
     * @return self
     */
    public function addValue(PartnersBillingFailedOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PartnersBillingFailedOperation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PartnersBillingFailedOperation>
     */
