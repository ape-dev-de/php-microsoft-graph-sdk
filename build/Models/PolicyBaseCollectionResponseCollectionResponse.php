...
/**
 * Collection response for PolicyBaseCollectionResponse
 */
class PolicyBaseCollectionResponseCollectionResponse
{
    /**
     * @var PolicyBaseCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PolicyBaseCollectionResponse ...$items Variable number of PolicyBaseCollectionResponse items
     * @return self
     */
    public function setValue(PolicyBaseCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PolicyBaseCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PolicyBaseCollectionResponse $item
     * @return self
     */
    public function addValue(PolicyBaseCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
