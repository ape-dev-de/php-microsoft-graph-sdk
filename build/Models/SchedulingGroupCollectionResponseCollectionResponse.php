...
/**
 * Collection response for SchedulingGroupCollectionResponse
 */
class SchedulingGroupCollectionResponseCollectionResponse
{
    /**
     * @var SchedulingGroupCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SchedulingGroupCollectionResponse ...$items Variable number of SchedulingGroupCollectionResponse items
     * @return self
     */
    public function setValue(SchedulingGroupCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SchedulingGroupCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SchedulingGroupCollectionResponse $item
     * @return self
     */
    public function addValue(SchedulingGroupCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
