...
/**
 * Collection response for UnifiedApprovalStageCollectionResponse
 */
class UnifiedApprovalStageCollectionResponseCollectionResponse
{
    /**
     * @var UnifiedApprovalStageCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedApprovalStageCollectionResponse ...$items Variable number of UnifiedApprovalStageCollectionResponse items
     * @return self
     */
    public function setValue(UnifiedApprovalStageCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UnifiedApprovalStageCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UnifiedApprovalStageCollectionResponse $item
     * @return self
     */
    public function addValue(UnifiedApprovalStageCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
