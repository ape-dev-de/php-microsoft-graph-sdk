...
/**
 * Collection response for Fido2CombinationConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Fido2CombinationConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Fido2CombinationConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param Fido2CombinationConfiguration[] $items
     * @return self
     */
    public function setValue(array|Fido2CombinationConfiguration $items, Fido2CombinationConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Fido2CombinationConfiguration> $value
     * @return self
     ...
     * 
     * @param Fido2CombinationConfiguration $item
     * @return self
     */
    public function addValue(Fido2CombinationConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return Fido2CombinationConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, Fido2CombinationConfiguration>
     */
