...
/**
 * SecurityExportFileStructureCollectionResponse - Collection response
 */
class SecurityExportFileStructureCollectionResponse
{
    /**
     * @var array<int, SecurityExportFileStructure>
     */
    public array $value = [];
