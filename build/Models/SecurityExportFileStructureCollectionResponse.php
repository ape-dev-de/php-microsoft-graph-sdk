...
/**
 * Collection response for SecurityExportFileStructure
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityExportFileStructureCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityExportFileStructure[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityExportFileStructure[]
     */
     ...
     * 
     * @param SecurityExportFileStructure[] $items
     * @return self
     */
    public function setValue(array|SecurityExportFileStructure $items, SecurityExportFileStructure ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityExportFileStructure> $value
     * @return self
     ...
     * 
     * @param SecurityExportFileStructure $item
     * @return self
     */
    public function addValue(SecurityExportFileStructure $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityExportFileStructure|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityExportFileStructure>
     */
