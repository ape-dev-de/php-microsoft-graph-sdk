...
/**
 * Collection response for AccessPackageAssignmentApprovalSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageAssignmentApprovalSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageAssignmentApprovalSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageAssignmentApprovalSettings[] $items
     * @return self
     */
    public function setValue(array|AccessPackageAssignmentApprovalSettings $items, AccessPackageAssignmentApprovalSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageAssignmentApprovalSettings> $value
     * @return self
     ...
     * 
     * @param AccessPackageAssignmentApprovalSettings $item
     * @return self
     */
    public function addValue(AccessPackageAssignmentApprovalSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageAssignmentApprovalSettings>
     */
