 ...
 */
class AccessPackageAssignmentApprovalSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param AccessPackageAssignmentApprovalSettings ...$items Variable number of AccessPackageAssignmentApprovalSettings items
     * @return self
     */
    public function setValue(AccessPackageAssignmentApprovalSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
