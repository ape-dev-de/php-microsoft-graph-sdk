...
/**
 * Collection response for AttributeMappingFunctionSchema
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttributeMappingFunctionSchemaCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AttributeMappingFunctionSchema[]
     */
    private array $value = [];
     ...
     * 
     * @param AttributeMappingFunctionSchema[] $items
     * @return self
     */
    public function setValue(array|AttributeMappingFunctionSchema $items, AttributeMappingFunctionSchema ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttributeMappingFunctionSchema> $value
     * @return self
     ...
     * 
     * @param AttributeMappingFunctionSchema $item
     * @return self
     */
    public function addValue(AttributeMappingFunctionSchema $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AttributeMappingFunctionSchema>
     */
