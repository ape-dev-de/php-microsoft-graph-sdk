...
/**
 * Collection response for TermStoreRelationType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TermStoreRelationTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TermStoreRelationType[]
     */
    private array $value = [];
     ...
     * 
     * @param TermStoreRelationType[] $items
     * @return self
     */
    public function setValue(array|TermStoreRelationType $items, TermStoreRelationType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TermStoreRelationType> $value
     * @return self
     ...
     * 
     * @param TermStoreRelationType $item
     * @return self
     */
    public function addValue(TermStoreRelationType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TermStoreRelationType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TermStoreRelationType>
     */
