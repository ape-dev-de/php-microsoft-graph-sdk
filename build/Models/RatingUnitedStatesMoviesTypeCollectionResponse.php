...
/**
 * RatingUnitedStatesMoviesTypeCollectionResponse - Collection response
 */
class RatingUnitedStatesMoviesTypeCollectionResponse
{
    /**
     * @var array<int, RatingUnitedStatesMoviesType>
     */
    public array $value = [];
