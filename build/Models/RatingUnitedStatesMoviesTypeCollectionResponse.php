...
/**
 * Collection response for RatingUnitedStatesMoviesType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RatingUnitedStatesMoviesTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RatingUnitedStatesMoviesType[]
     */
    private array $value = [];
     ...
     * 
     * @return RatingUnitedStatesMoviesType[]
     */
     ...
     * 
     * @param RatingUnitedStatesMoviesType[] $items
     * @return self
     */
    public function setValue(array|RatingUnitedStatesMoviesType $items, RatingUnitedStatesMoviesType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RatingUnitedStatesMoviesType> $value
     * @return self
     ...
     * 
     * @param RatingUnitedStatesMoviesType $item
     * @return self
     */
    public function addValue(RatingUnitedStatesMoviesType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RatingUnitedStatesMoviesType>
     */
