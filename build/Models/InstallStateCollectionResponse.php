...
/**
 * Collection response for InstallState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InstallStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var InstallState[]
     */
     ...
     * 
     * @param InstallState[] $items
     * @return self
     */
    public function setValue(array|InstallState $items, InstallState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InstallState> $value
     * @return self
     ...
     * 
     * @param InstallState $item
     * @return self
     */
    public function addValue(InstallState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, InstallState>
     */
