...
/**
 * Collection response for SecurityHostTrackerCollectionResponse
 */
class SecurityHostTrackerCollectionResponseCollectionResponse
{
    /**
     * @var SecurityHostTrackerCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityHostTrackerCollectionResponse ...$items Variable number of SecurityHostTrackerCollectionResponse items
     * @return self
     */
    public function setValue(SecurityHostTrackerCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityHostTrackerCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityHostTrackerCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityHostTrackerCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
