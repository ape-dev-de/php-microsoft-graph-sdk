...
/**
 * Collection response for DomainIdentitySource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DomainIdentitySourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DomainIdentitySource[]
     */
    private array $value = [];
     ...
     * 
     * @param DomainIdentitySource[] $items
     * @return self
     */
    public function setValue(array|DomainIdentitySource $items, DomainIdentitySource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DomainIdentitySource> $value
     * @return self
     ...
     * 
     * @param DomainIdentitySource $item
     * @return self
     */
    public function addValue(DomainIdentitySource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return DomainIdentitySource|null
     */
     ...
     * 
     * @return \ArrayIterator<int, DomainIdentitySource>
     */
