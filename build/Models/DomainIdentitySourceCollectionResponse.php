 ...
 */
class DomainIdentitySourceCollectionResponse
{
    /**
     ...
     * 
     * @param DomainIdentitySource ...$items Variable number of DomainIdentitySource items
     * @return self
     */
    public function setValue(DomainIdentitySource ...$items): self
    {
        $this->value = $items;
        return $this;
    }
