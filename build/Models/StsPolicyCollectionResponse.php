...
/**
 * Collection response for StsPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class StsPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var StsPolicy[]
     */
     ...
     * 
     * @param StsPolicy[] $items
     * @return self
     */
    public function setValue(array|StsPolicy $items, StsPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param StsPolicy $item
     * @return self
     */
    public function addValue(StsPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, StsPolicy>
     */
