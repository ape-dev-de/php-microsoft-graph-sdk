...
/**
 * Collection response for MailSearchFolder
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MailSearchFolderCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MailSearchFolder[]
     */
    private array $value = [];
     ...
     * 
     * @param MailSearchFolder[] $items
     * @return self
     */
    public function setValue(array|MailSearchFolder $items, MailSearchFolder ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MailSearchFolder> $value
     * @return self
     ...
     * 
     * @param MailSearchFolder $item
     * @return self
     */
    public function addValue(MailSearchFolder $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MailSearchFolder>
     */
