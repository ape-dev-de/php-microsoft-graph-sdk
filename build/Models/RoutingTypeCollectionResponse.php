...
/**
 * Collection response for RoutingType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RoutingTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RoutingType[]
     */
     ...
     * 
     * @param RoutingType[] $items
     * @return self
     */
    public function setValue(array|RoutingType $items, RoutingType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param RoutingType $item
     * @return self
     */
    public function addValue(RoutingType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RoutingType>
     */
