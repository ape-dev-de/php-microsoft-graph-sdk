 ...
 */
class SecurityCloudApplicationEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityCloudApplicationEvidence ...$items Variable number of SecurityCloudApplicationEvidence items
     * @return self
     */
    public function setValue(SecurityCloudApplicationEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
