...
/**
 * Collection response for SecurityCloudApplicationEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityCloudApplicationEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityCloudApplicationEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityCloudApplicationEvidence[]
     */
     ...
     * 
     * @param SecurityCloudApplicationEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityCloudApplicationEvidence $items, SecurityCloudApplicationEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityCloudApplicationEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityCloudApplicationEvidence $item
     * @return self
     */
    public function addValue(SecurityCloudApplicationEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityCloudApplicationEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityCloudApplicationEvidence>
     */
