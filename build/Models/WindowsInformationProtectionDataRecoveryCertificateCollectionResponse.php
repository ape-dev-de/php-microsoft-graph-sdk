 ...
 */
class WindowsInformationProtectionDataRecoveryCertificateCollectionResponse
{
    /**
     ...
     * 
     * @param WindowsInformationProtectionDataRecoveryCertificate ...$items Variable number of WindowsInformationProtectionDataRecoveryCertificate items
     * @return self
     */
    public function setValue(WindowsInformationProtectionDataRecoveryCertificate ...$items): self
    {
        $this->value = $items;
        return $this;
    }
