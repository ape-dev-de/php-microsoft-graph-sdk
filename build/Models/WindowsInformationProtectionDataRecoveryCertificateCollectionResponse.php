...
/**
 * Collection response for WindowsInformationProtectionDataRecoveryCertificate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsInformationProtectionDataRecoveryCertificateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WindowsInformationProtectionDataRecoveryCertificate[] $items
     * @return self
     */
    public function setValue(array|WindowsInformationProtectionDataRecoveryCertificate $items, WindowsInformationProtectionDataRecoveryCertificate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsInformationProtectionDataRecoveryCertificate> $value
     * @return self
     ...
     * 
     * @param WindowsInformationProtectionDataRecoveryCertificate $item
     * @return self
     */
    public function addValue(WindowsInformationProtectionDataRecoveryCertificate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsInformationProtectionDataRecoveryCertificate>
     */
