...
/**
 * WindowsInformationProtectionDataRecoveryCertificateCollectionResponse - Collection response
 */
class WindowsInformationProtectionDataRecoveryCertificateCollectionResponse
{
    /**
     * @var array<int, WindowsInformationProtectionDataRecoveryCertificate>
     */
    public array $value = [];
