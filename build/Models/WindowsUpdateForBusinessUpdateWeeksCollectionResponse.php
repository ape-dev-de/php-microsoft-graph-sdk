...
/**
 * Collection response for WindowsUpdateForBusinessUpdateWeeks
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsUpdateForBusinessUpdateWeeksCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return WindowsUpdateForBusinessUpdateWeeks[]
     */
     ...
     * 
     * @param WindowsUpdateForBusinessUpdateWeeks[] $items
     * @return self
     */
    public function setValue(array|WindowsUpdateForBusinessUpdateWeeks $items, WindowsUpdateForBusinessUpdateWeeks ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsUpdateForBusinessUpdateWeeks> $value
     * @return self
     ...
     * 
     * @param WindowsUpdateForBusinessUpdateWeeks $item
     * @return self
     */
    public function addValue(WindowsUpdateForBusinessUpdateWeeks $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsUpdateForBusinessUpdateWeeks>
     */
