...
/**
 * WindowsUpdateForBusinessUpdateWeeksCollectionResponse - Collection response
 */
class WindowsUpdateForBusinessUpdateWeeksCollectionResponse
{
    /**
     * @var array<int, WindowsUpdateForBusinessUpdateWeeks>
     */
    public array $value = [];
