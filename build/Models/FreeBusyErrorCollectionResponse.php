 ...
 */
class FreeBusyErrorCollectionResponse
{
    /**
     * @var FreeBusyError[]
     */
     ...
     * 
     * @param FreeBusyError ...$items Variable number of FreeBusyError items
     * @return self
     */
    public function setValue(FreeBusyError ...$items): self
    {
        $this->value = $items;
        return $this;
    }
