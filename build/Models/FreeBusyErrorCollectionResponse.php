...
/**
 * Collection response for FreeBusyError
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FreeBusyErrorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FreeBusyError[]
     */
     ...
     * 
     * @param FreeBusyError[] $items
     * @return self
     */
    public function setValue(array|FreeBusyError $items, FreeBusyError ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FreeBusyError> $value
     * @return self
     ...
     * 
     * @param FreeBusyError $item
     * @return self
     */
    public function addValue(FreeBusyError $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FreeBusyError>
     */
