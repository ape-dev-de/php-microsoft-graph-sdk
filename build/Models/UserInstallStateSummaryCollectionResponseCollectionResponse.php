...
/**
 * Collection response for UserInstallStateSummaryCollectionResponse
 */
class UserInstallStateSummaryCollectionResponseCollectionResponse
{
    /**
     * @var UserInstallStateSummaryCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UserInstallStateSummaryCollectionResponse ...$items Variable number of UserInstallStateSummaryCollectionResponse items
     * @return self
     */
    public function setValue(UserInstallStateSummaryCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UserInstallStateSummaryCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UserInstallStateSummaryCollectionResponse $item
     * @return self
     */
    public function addValue(UserInstallStateSummaryCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
