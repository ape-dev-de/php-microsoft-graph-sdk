...
/**
 * Collection response for MacOSMicrosoftEdgeApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MacOSMicrosoftEdgeAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MacOSMicrosoftEdgeApp[]
     */
    private array $value = [];
     ...
     * 
     * @param MacOSMicrosoftEdgeApp[] $items
     * @return self
     */
    public function setValue(array|MacOSMicrosoftEdgeApp $items, MacOSMicrosoftEdgeApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MacOSMicrosoftEdgeApp> $value
     * @return self
     ...
     * 
     * @param MacOSMicrosoftEdgeApp $item
     * @return self
     */
    public function addValue(MacOSMicrosoftEdgeApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MacOSMicrosoftEdgeApp|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MacOSMicrosoftEdgeApp>
     */
