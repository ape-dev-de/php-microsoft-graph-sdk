...
/**
 * FirewallCertificateRevocationListCheckMethodTypeCollectionResponse - Collection response
 */
class FirewallCertificateRevocationListCheckMethodTypeCollectionResponse
{
    /**
     * @var array<int, FirewallCertificateRevocationListCheckMethodType>
     */
    public array $value = [];
