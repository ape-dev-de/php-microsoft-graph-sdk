...
/**
 * Collection response for FirewallCertificateRevocationListCheckMethodType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FirewallCertificateRevocationListCheckMethodTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FirewallCertificateRevocationListCheckMethodType[]
     */
    private array $value = [];
     ...
     * 
     * @return FirewallCertificateRevocationListCheckMethodType[]
     */
     ...
     * 
     * @param FirewallCertificateRevocationListCheckMethodType[] $items
     * @return self
     */
    public function setValue(array|FirewallCertificateRevocationListCheckMethodType $items, FirewallCertificateRevocationListCheckMethodType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FirewallCertificateRevocationListCheckMethodType> $value
     * @return self
     ...
     * 
     * @param FirewallCertificateRevocationListCheckMethodType $item
     * @return self
     */
    public function addValue(FirewallCertificateRevocationListCheckMethodType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FirewallCertificateRevocationListCheckMethodType>
     */
