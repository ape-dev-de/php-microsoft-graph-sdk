...
/**
 * Collection response for SecuritySensorType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecuritySensorTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecuritySensorType[]
     */
    private array $value = [];
     ...
     * 
     * @param SecuritySensorType[] $items
     * @return self
     */
    public function setValue(array|SecuritySensorType $items, SecuritySensorType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecuritySensorType> $value
     * @return self
     ...
     * 
     * @param SecuritySensorType $item
     * @return self
     */
    public function addValue(SecuritySensorType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecuritySensorType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecuritySensorType>
     */
