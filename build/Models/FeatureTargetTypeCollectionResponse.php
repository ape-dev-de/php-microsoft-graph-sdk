...
/**
 * Collection response for FeatureTargetType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FeatureTargetTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FeatureTargetType[]
     */
    private array $value = [];
     ...
     * 
     * @param FeatureTargetType[] $items
     * @return self
     */
    public function setValue(array|FeatureTargetType $items, FeatureTargetType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FeatureTargetType> $value
     * @return self
     ...
     * 
     * @param FeatureTargetType $item
     * @return self
     */
    public function addValue(FeatureTargetType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FeatureTargetType>
     */
