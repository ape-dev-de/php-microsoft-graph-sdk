...
/**
 * Collection response for BrowserSharedCookie
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BrowserSharedCookieCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param BrowserSharedCookie[] $items
     * @return self
     */
    public function setValue(array|BrowserSharedCookie $items, BrowserSharedCookie ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BrowserSharedCookie> $value
     * @return self
     ...
     * 
     * @param BrowserSharedCookie $item
     * @return self
     */
    public function addValue(BrowserSharedCookie $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BrowserSharedCookie>
     */
