...
/**
 * Collection response for ApiAuthenticationConfigurationBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ApiAuthenticationConfigurationBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ApiAuthenticationConfigurationBase[]
     */
    private array $value = [];
     ...
     * 
     * @param ApiAuthenticationConfigurationBase[] $items
     * @return self
     */
    public function setValue(array|ApiAuthenticationConfigurationBase $items, ApiAuthenticationConfigurationBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ApiAuthenticationConfigurationBase> $value
     * @return self
     ...
     * 
     * @param ApiAuthenticationConfigurationBase $item
     * @return self
     */
    public function addValue(ApiAuthenticationConfigurationBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ApiAuthenticationConfigurationBase>
     */
