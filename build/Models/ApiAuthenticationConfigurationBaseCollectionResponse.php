...
/**
 * ApiAuthenticationConfigurationBaseCollectionResponse - Collection response
 */
class ApiAuthenticationConfigurationBaseCollectionResponse
{
    /**
     * @var array<int, ApiAuthenticationConfigurationBase>
     */
    public array $value = [];
