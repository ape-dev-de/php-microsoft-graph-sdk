...
/**
 * Collection response for WindowsSettingCollectionResponse
 */
class WindowsSettingCollectionResponseCollectionResponse
{
    /**
     * @var WindowsSettingCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsSettingCollectionResponse ...$items Variable number of WindowsSettingCollectionResponse items
     * @return self
     */
    public function setValue(WindowsSettingCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WindowsSettingCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WindowsSettingCollectionResponse $item
     * @return self
     */
    public function addValue(WindowsSettingCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
