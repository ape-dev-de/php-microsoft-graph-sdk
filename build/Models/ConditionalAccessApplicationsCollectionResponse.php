 ...
 */
class ConditionalAccessApplicationsCollectionResponse
{
    /**
     ...
     * 
     * @param ConditionalAccessApplications ...$items Variable number of ConditionalAccessApplications items
     * @return self
     */
    public function setValue(ConditionalAccessApplications ...$items): self
    {
        $this->value = $items;
        return $this;
    }
