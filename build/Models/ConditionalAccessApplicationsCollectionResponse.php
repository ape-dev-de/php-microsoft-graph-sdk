...
/**
 * Collection response for ConditionalAccessApplications
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessApplicationsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessApplications[]
     */
    private array $value = [];
     ...
     * 
     * @param ConditionalAccessApplications[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessApplications $items, ConditionalAccessApplications ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessApplications> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessApplications $item
     * @return self
     */
    public function addValue(ConditionalAccessApplications $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessApplications>
     */
