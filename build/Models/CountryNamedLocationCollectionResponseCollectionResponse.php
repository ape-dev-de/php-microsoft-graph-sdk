...
/**
 * Collection response for CountryNamedLocationCollectionResponse
 */
class CountryNamedLocationCollectionResponseCollectionResponse
{
    /**
     * @var CountryNamedLocationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CountryNamedLocationCollectionResponse ...$items Variable number of CountryNamedLocationCollectionResponse items
     * @return self
     */
    public function setValue(CountryNamedLocationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CountryNamedLocationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CountryNamedLocationCollectionResponse $item
     * @return self
     */
    public function addValue(CountryNamedLocationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
