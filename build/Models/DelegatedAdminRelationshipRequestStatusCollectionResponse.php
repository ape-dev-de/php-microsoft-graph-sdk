...
/**
 * DelegatedAdminRelationshipRequestStatusCollectionResponse - Collection response
 */
class DelegatedAdminRelationshipRequestStatusCollectionResponse
{
    /**
     * @var array<int, DelegatedAdminRelationshipRequestStatus>
     */
    public array $value = [];
