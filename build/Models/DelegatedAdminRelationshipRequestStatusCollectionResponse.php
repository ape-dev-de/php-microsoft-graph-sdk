...
/**
 * Collection response for DelegatedAdminRelationshipRequestStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DelegatedAdminRelationshipRequestStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DelegatedAdminRelationshipRequestStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return DelegatedAdminRelationshipRequestStatus[]
     */
     ...
     * 
     * @param DelegatedAdminRelationshipRequestStatus[] $items
     * @return self
     */
    public function setValue(array|DelegatedAdminRelationshipRequestStatus $items, DelegatedAdminRelationshipRequestStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DelegatedAdminRelationshipRequestStatus> $value
     * @return self
     ...
     * 
     * @param DelegatedAdminRelationshipRequestStatus $item
     * @return self
     */
    public function addValue(DelegatedAdminRelationshipRequestStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DelegatedAdminRelationshipRequestStatus>
     */
