...
/**
 * Collection response for IosVppApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosVppAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IosVppApp[]
     */
     ...
     * 
     * @param IosVppApp[] $items
     * @return self
     */
    public function setValue(array|IosVppApp $items, IosVppApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param IosVppApp $item
     * @return self
     */
    public function addValue(IosVppApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IosVppApp>
     */
