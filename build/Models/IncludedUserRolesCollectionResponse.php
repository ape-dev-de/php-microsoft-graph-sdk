...
/**
 * Collection response for IncludedUserRoles
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IncludedUserRolesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IncludedUserRoles[]
     */
    private array $value = [];
     ...
     * 
     * @param IncludedUserRoles[] $items
     * @return self
     */
    public function setValue(array|IncludedUserRoles $items, IncludedUserRoles ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IncludedUserRoles> $value
     * @return self
     ...
     * 
     * @param IncludedUserRoles $item
     * @return self
     */
    public function addValue(IncludedUserRoles $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IncludedUserRoles>
     */
