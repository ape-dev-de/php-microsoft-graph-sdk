...
/**
 * UserExperienceAnalyticsCloudIdentityDevicesSummaryCollectionResponse - Collection response
 */
class UserExperienceAnalyticsCloudIdentityDevicesSummaryCollectionResponse
{
    /**
     * @var array<int, UserExperienceAnalyticsCloudIdentityDevicesSummary>
     */
    public array $value = [];
