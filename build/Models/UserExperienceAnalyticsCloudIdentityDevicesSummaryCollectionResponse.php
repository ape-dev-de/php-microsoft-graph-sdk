...
/**
 * Collection response for UserExperienceAnalyticsCloudIdentityDevicesSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsCloudIdentityDevicesSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserExperienceAnalyticsCloudIdentityDevicesSummary[]
     */
    private array $value = [];
     ...
     * 
     * @param UserExperienceAnalyticsCloudIdentityDevicesSummary[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsCloudIdentityDevicesSummary $items, UserExperienceAnalyticsCloudIdentityDevicesSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsCloudIdentityDevicesSummary> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsCloudIdentityDevicesSummary $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsCloudIdentityDevicesSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsCloudIdentityDevicesSummary>
     */
