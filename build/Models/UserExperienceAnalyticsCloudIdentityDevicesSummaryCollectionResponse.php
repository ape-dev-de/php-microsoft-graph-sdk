 ...
 */
class UserExperienceAnalyticsCloudIdentityDevicesSummaryCollectionResponse
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsCloudIdentityDevicesSummary ...$items Variable number of UserExperienceAnalyticsCloudIdentityDevicesSummary items
     * @return self
     */
    public function setValue(UserExperienceAnalyticsCloudIdentityDevicesSummary ...$items): self
    {
        $this->value = $items;
        return $this;
    }
