...
/**
 * Collection response for ProtectionUnitBaseCollectionResponse
 */
class ProtectionUnitBaseCollectionResponseCollectionResponse
{
    /**
     * @var ProtectionUnitBaseCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ProtectionUnitBaseCollectionResponse ...$items Variable number of ProtectionUnitBaseCollectionResponse items
     * @return self
     */
    public function setValue(ProtectionUnitBaseCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ProtectionUnitBaseCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ProtectionUnitBaseCollectionResponse $item
     * @return self
     */
    public function addValue(ProtectionUnitBaseCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
