...
/**
 * Collection response for EmergencyCallEvent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EmergencyCallEventCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EmergencyCallEvent[]
     */
    private array $value = [];
     ...
     * 
     * @param EmergencyCallEvent[] $items
     * @return self
     */
    public function setValue(array|EmergencyCallEvent $items, EmergencyCallEvent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EmergencyCallEvent> $value
     * @return self
     ...
     * 
     * @param EmergencyCallEvent $item
     * @return self
     */
    public function addValue(EmergencyCallEvent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EmergencyCallEvent|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EmergencyCallEvent>
     */
