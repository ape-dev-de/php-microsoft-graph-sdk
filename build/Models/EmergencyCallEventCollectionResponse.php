 ...
 */
class EmergencyCallEventCollectionResponse
{
    /**
     ...
     * 
     * @param EmergencyCallEvent ...$items Variable number of EmergencyCallEvent items
     * @return self
     */
    public function setValue(EmergencyCallEvent ...$items): self
    {
        $this->value = $items;
        return $this;
    }
