...
/**
 * Collection response for ProcessContentRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProcessContentRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProcessContentRequest[]
     */
    private array $value = [];
     ...
     * 
     * @param ProcessContentRequest[] $items
     * @return self
     */
    public function setValue(array|ProcessContentRequest $items, ProcessContentRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProcessContentRequest> $value
     * @return self
     ...
     * 
     * @param ProcessContentRequest $item
     * @return self
     */
    public function addValue(ProcessContentRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProcessContentRequest>
     */
