 ...
 */
class ProcessContentRequestCollectionResponse
{
    /**
     ...
     * 
     * @param ProcessContentRequest ...$items Variable number of ProcessContentRequest items
     * @return self
     */
    public function setValue(ProcessContentRequest ...$items): self
    {
        $this->value = $items;
        return $this;
    }
