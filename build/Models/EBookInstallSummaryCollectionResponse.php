...
/**
 * Collection response for EBookInstallSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EBookInstallSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EBookInstallSummary[]
     */
    private array $value = [];
     ...
     * 
     * @param EBookInstallSummary[] $items
     * @return self
     */
    public function setValue(array|EBookInstallSummary $items, EBookInstallSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EBookInstallSummary> $value
     * @return self
     ...
     * 
     * @param EBookInstallSummary $item
     * @return self
     */
    public function addValue(EBookInstallSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EBookInstallSummary>
     */
