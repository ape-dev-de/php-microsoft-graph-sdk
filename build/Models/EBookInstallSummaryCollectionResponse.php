 ...
 */
class EBookInstallSummaryCollectionResponse
{
    /**
     ...
     * 
     * @param EBookInstallSummary ...$items Variable number of EBookInstallSummary items
     * @return self
     */
    public function setValue(EBookInstallSummary ...$items): self
    {
        $this->value = $items;
        return $this;
    }
