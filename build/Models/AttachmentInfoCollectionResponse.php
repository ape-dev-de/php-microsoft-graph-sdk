 ...
 */
class AttachmentInfoCollectionResponse
{
    /**
     * @var AttachmentInfo[]
     */
     ...
     * 
     * @param AttachmentInfo ...$items Variable number of AttachmentInfo items
     * @return self
     */
    public function setValue(AttachmentInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
