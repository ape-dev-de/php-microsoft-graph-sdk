...
/**
 * Collection response for AttachmentInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttachmentInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AttachmentInfo[]
     */
     ...
     * 
     * @param AttachmentInfo[] $items
     * @return self
     */
    public function setValue(array|AttachmentInfo $items, AttachmentInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttachmentInfo> $value
     * @return self
     ...
     * 
     * @param AttachmentInfo $item
     * @return self
     */
    public function addValue(AttachmentInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AttachmentInfo>
     */
