...
/**
 * Collection response for MacOSCompliancePolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MacOSCompliancePolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MacOSCompliancePolicy[]
     */
    private array $value = [];
     ...
     * 
     * @param MacOSCompliancePolicy[] $items
     * @return self
     */
    public function setValue(array|MacOSCompliancePolicy $items, MacOSCompliancePolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MacOSCompliancePolicy> $value
     * @return self
     ...
     * 
     * @param MacOSCompliancePolicy $item
     * @return self
     */
    public function addValue(MacOSCompliancePolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MacOSCompliancePolicy|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MacOSCompliancePolicy>
     */
