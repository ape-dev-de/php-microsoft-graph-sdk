...
/**
 * Collection response for LearningSelfInitiatedCourse
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LearningSelfInitiatedCourseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var LearningSelfInitiatedCourse[]
     */
    private array $value = [];
     ...
     * 
     * @param LearningSelfInitiatedCourse[] $items
     * @return self
     */
    public function setValue(array|LearningSelfInitiatedCourse $items, LearningSelfInitiatedCourse ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LearningSelfInitiatedCourse> $value
     * @return self
     ...
     * 
     * @param LearningSelfInitiatedCourse $item
     * @return self
     */
    public function addValue(LearningSelfInitiatedCourse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return LearningSelfInitiatedCourse|null
     */
     ...
     * 
     * @return \ArrayIterator<int, LearningSelfInitiatedCourse>
     */
