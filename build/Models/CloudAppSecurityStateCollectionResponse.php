...
/**
 * Collection response for CloudAppSecurityState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudAppSecurityStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudAppSecurityState[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudAppSecurityState[] $items
     * @return self
     */
    public function setValue(array|CloudAppSecurityState $items, CloudAppSecurityState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudAppSecurityState> $value
     * @return self
     ...
     * 
     * @param CloudAppSecurityState $item
     * @return self
     */
    public function addValue(CloudAppSecurityState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CloudAppSecurityState|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CloudAppSecurityState>
     */
