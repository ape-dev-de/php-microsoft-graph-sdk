...
/**
 * Collection response for ProfilePhotoCollectionResponse
 */
class ProfilePhotoCollectionResponseCollectionResponse
{
    /**
     * @var ProfilePhotoCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ProfilePhotoCollectionResponse ...$items Variable number of ProfilePhotoCollectionResponse items
     * @return self
     */
    public function setValue(ProfilePhotoCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ProfilePhotoCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ProfilePhotoCollectionResponse $item
     * @return self
     */
    public function addValue(ProfilePhotoCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
