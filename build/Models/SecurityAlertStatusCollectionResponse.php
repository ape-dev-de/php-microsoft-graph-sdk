...
/**
 * Collection response for SecurityAlertStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityAlertStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityAlertStatus[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityAlertStatus[] $items
     * @return self
     */
    public function setValue(array|SecurityAlertStatus $items, SecurityAlertStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityAlertStatus> $value
     * @return self
     ...
     * 
     * @param SecurityAlertStatus $item
     * @return self
     */
    public function addValue(SecurityAlertStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityAlertStatus>
     */
