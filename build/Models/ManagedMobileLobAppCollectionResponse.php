...
/**
 * Collection response for ManagedMobileLobApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedMobileLobAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ManagedMobileLobApp[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedMobileLobApp[] $items
     * @return self
     */
    public function setValue(array|ManagedMobileLobApp $items, ManagedMobileLobApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedMobileLobApp> $value
     * @return self
     ...
     * 
     * @param ManagedMobileLobApp $item
     * @return self
     */
    public function addValue(ManagedMobileLobApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedMobileLobApp>
     */
