...
/**
 * Collection response for DeviceManagementPartnerCollectionResponse
 */
class DeviceManagementPartnerCollectionResponseCollectionResponse
{
    /**
     * @var DeviceManagementPartnerCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceManagementPartnerCollectionResponse ...$items Variable number of DeviceManagementPartnerCollectionResponse items
     * @return self
     */
    public function setValue(DeviceManagementPartnerCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeviceManagementPartnerCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeviceManagementPartnerCollectionResponse $item
     * @return self
     */
    public function addValue(DeviceManagementPartnerCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
