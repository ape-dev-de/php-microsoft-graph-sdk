...
/**
 * OnlineMeetingProviderTypeCollectionResponse - Collection response
 */
class OnlineMeetingProviderTypeCollectionResponse
{
    /**
     * @var array<int, OnlineMeetingProviderType>
     */
    public array $value = [];
