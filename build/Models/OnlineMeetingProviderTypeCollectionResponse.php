...
/**
 * Collection response for OnlineMeetingProviderType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnlineMeetingProviderTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param OnlineMeetingProviderType[] $items
     * @return self
     */
    public function setValue(array|OnlineMeetingProviderType $items, OnlineMeetingProviderType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnlineMeetingProviderType> $value
     * @return self
     ...
     * 
     * @param OnlineMeetingProviderType $item
     * @return self
     */
    public function addValue(OnlineMeetingProviderType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnlineMeetingProviderType>
     */
