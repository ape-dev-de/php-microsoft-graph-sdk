...
/**
 * Collection response for CertificateBasedAuthConfigurationCollectionResponse
 */
class CertificateBasedAuthConfigurationCollectionResponseCollectionResponse
{
    /**
     * @var CertificateBasedAuthConfigurationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CertificateBasedAuthConfigurationCollectionResponse ...$items Variable number of CertificateBasedAuthConfigurationCollectionResponse items
     * @return self
     */
    public function setValue(CertificateBasedAuthConfigurationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CertificateBasedAuthConfigurationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CertificateBasedAuthConfigurationCollectionResponse $item
     * @return self
     */
    public function addValue(CertificateBasedAuthConfigurationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
