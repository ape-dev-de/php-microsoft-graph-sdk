...
/**
 * Collection response for Compliance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ComplianceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Compliance[]
     */
     ...
     * 
     * @param Compliance[] $items
     * @return self
     */
    public function setValue(array|Compliance $items, Compliance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param Compliance $item
     * @return self
     */
    public function addValue(Compliance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Compliance>
     */
