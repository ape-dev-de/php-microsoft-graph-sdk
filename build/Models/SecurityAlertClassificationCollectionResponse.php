...
/**
 * SecurityAlertClassificationCollectionResponse - Collection response
 */
class SecurityAlertClassificationCollectionResponse
{
    /**
     * @var array<int, SecurityAlertClassification>
     */
    public array $value = [];
