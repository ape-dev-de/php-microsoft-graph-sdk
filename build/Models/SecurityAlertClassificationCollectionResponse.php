...
/**
 * Collection response for SecurityAlertClassification
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityAlertClassificationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityAlertClassification[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityAlertClassification[]
     */
     ...
     * 
     * @param SecurityAlertClassification[] $items
     * @return self
     */
    public function setValue(array|SecurityAlertClassification $items, SecurityAlertClassification ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityAlertClassification> $value
     * @return self
     ...
     * 
     * @param SecurityAlertClassification $item
     * @return self
     */
    public function addValue(SecurityAlertClassification $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityAlertClassification|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityAlertClassification>
     */
