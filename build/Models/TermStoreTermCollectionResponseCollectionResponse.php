...
/**
 * Collection response for TermStoreTermCollectionResponse
 */
class TermStoreTermCollectionResponseCollectionResponse
{
    /**
     * @var TermStoreTermCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TermStoreTermCollectionResponse ...$items Variable number of TermStoreTermCollectionResponse items
     * @return self
     */
    public function setValue(TermStoreTermCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TermStoreTermCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TermStoreTermCollectionResponse $item
     * @return self
     */
    public function addValue(TermStoreTermCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
