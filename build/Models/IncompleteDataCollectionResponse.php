...
/**
 * Collection response for IncompleteData
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IncompleteDataCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IncompleteData[]
     */
     ...
     * 
     * @param IncompleteData[] $items
     * @return self
     */
    public function setValue(array|IncompleteData $items, IncompleteData ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IncompleteData> $value
     * @return self
     ...
     * 
     * @param IncompleteData $item
     * @return self
     */
    public function addValue(IncompleteData $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IncompleteData>
     */
