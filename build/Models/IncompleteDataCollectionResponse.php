 ...
 */
class IncompleteDataCollectionResponse
{
    /**
     * @var IncompleteData[]
     */
     ...
     * 
     * @param IncompleteData ...$items Variable number of IncompleteData items
     * @return self
     */
    public function setValue(IncompleteData ...$items): self
    {
        $this->value = $items;
        return $this;
    }
