...
/**
 * Collection response for B2xIdentityUserFlow
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class B2xIdentityUserFlowCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param B2xIdentityUserFlow[] $items
     * @return self
     */
    public function setValue(array|B2xIdentityUserFlow $items, B2xIdentityUserFlow ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<B2xIdentityUserFlow> $value
     * @return self
     ...
     * 
     * @param B2xIdentityUserFlow $item
     * @return self
     */
    public function addValue(B2xIdentityUserFlow $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, B2xIdentityUserFlow>
     */
