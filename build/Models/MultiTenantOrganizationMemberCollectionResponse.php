...
/**
 * Collection response for MultiTenantOrganizationMember
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MultiTenantOrganizationMemberCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MultiTenantOrganizationMember[] $items
     * @return self
     */
    public function setValue(array|MultiTenantOrganizationMember $items, MultiTenantOrganizationMember ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MultiTenantOrganizationMember> $value
     * @return self
     ...
     * 
     * @param MultiTenantOrganizationMember $item
     * @return self
     */
    public function addValue(MultiTenantOrganizationMember $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MultiTenantOrganizationMember>
     */
