...
/**
 * Collection response for SecurityFilePlanDescriptorTemplate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityFilePlanDescriptorTemplateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityFilePlanDescriptorTemplate[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityFilePlanDescriptorTemplate[]
     */
     ...
     * 
     * @param SecurityFilePlanDescriptorTemplate[] $items
     * @return self
     */
    public function setValue(array|SecurityFilePlanDescriptorTemplate $items, SecurityFilePlanDescriptorTemplate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityFilePlanDescriptorTemplate> $value
     * @return self
     ...
     * 
     * @param SecurityFilePlanDescriptorTemplate $item
     * @return self
     */
    public function addValue(SecurityFilePlanDescriptorTemplate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityFilePlanDescriptorTemplate|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityFilePlanDescriptorTemplate>
     */
