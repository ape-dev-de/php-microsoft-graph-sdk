 ...
 */
class SecurityFilePlanDescriptorTemplateCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityFilePlanDescriptorTemplate ...$items Variable number of SecurityFilePlanDescriptorTemplate items
     * @return self
     */
    public function setValue(SecurityFilePlanDescriptorTemplate ...$items): self
    {
        $this->value = $items;
        return $this;
    }
