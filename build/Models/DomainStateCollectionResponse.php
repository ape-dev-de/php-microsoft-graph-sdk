...
/**
 * Collection response for DomainState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DomainStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DomainState[]
     */
     ...
     * 
     * @param DomainState[] $items
     * @return self
     */
    public function setValue(array|DomainState $items, DomainState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param DomainState $item
     * @return self
     */
    public function addValue(DomainState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DomainState>
     */
