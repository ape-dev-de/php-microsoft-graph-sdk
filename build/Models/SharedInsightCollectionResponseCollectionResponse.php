...
/**
 * Collection response for SharedInsightCollectionResponse
 */
class SharedInsightCollectionResponseCollectionResponse
{
    /**
     * @var SharedInsightCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SharedInsightCollectionResponse ...$items Variable number of SharedInsightCollectionResponse items
     * @return self
     */
    public function setValue(SharedInsightCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SharedInsightCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SharedInsightCollectionResponse $item
     * @return self
     */
    public function addValue(SharedInsightCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
