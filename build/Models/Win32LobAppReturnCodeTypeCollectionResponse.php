...
/**
 * Collection response for Win32LobAppReturnCodeType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Win32LobAppReturnCodeTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Win32LobAppReturnCodeType[]
     */
    private array $value = [];
     ...
     * 
     * @return Win32LobAppReturnCodeType[]
     */
     ...
     * 
     * @param Win32LobAppReturnCodeType[] $items
     * @return self
     */
    public function setValue(array|Win32LobAppReturnCodeType $items, Win32LobAppReturnCodeType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Win32LobAppReturnCodeType> $value
     * @return self
     ...
     * 
     * @param Win32LobAppReturnCodeType $item
     * @return self
     */
    public function addValue(Win32LobAppReturnCodeType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Win32LobAppReturnCodeType>
     */
