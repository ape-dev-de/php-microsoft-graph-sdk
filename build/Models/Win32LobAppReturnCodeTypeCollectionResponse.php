...
/**
 * Win32LobAppReturnCodeTypeCollectionResponse - Collection response
 */
class Win32LobAppReturnCodeTypeCollectionResponse
{
    /**
     * @var array<int, Win32LobAppReturnCodeType>
     */
    public array $value = [];
