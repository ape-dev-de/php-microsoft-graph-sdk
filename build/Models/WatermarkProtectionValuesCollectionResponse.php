 ...
 */
class WatermarkProtectionValuesCollectionResponse
{
    /**
     ...
     * 
     * @param WatermarkProtectionValues ...$items Variable number of WatermarkProtectionValues items
     * @return self
     */
    public function setValue(WatermarkProtectionValues ...$items): self
    {
        $this->value = $items;
        return $this;
    }
