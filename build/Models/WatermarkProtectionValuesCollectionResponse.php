...
/**
 * Collection response for WatermarkProtectionValues
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WatermarkProtectionValuesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WatermarkProtectionValues[]
     */
    private array $value = [];
     ...
     * 
     * @param WatermarkProtectionValues[] $items
     * @return self
     */
    public function setValue(array|WatermarkProtectionValues $items, WatermarkProtectionValues ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WatermarkProtectionValues> $value
     * @return self
     ...
     * 
     * @param WatermarkProtectionValues $item
     * @return self
     */
    public function addValue(WatermarkProtectionValues $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WatermarkProtectionValues>
     */
