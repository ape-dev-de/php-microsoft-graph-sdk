...
/**
 * Collection response for WorkbookOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WorkbookOperation[] $items
     * @return self
     */
    public function setValue(array|WorkbookOperation $items, WorkbookOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookOperation> $value
     * @return self
     ...
     * 
     * @param WorkbookOperation $item
     * @return self
     */
    public function addValue(WorkbookOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookOperation>
     */
