...
/**
 * Collection response for Authentication
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Authentication[]
     */
     ...
     * 
     * @param Authentication[] $items
     * @return self
     */
    public function setValue(array|Authentication $items, Authentication ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Authentication> $value
     * @return self
     ...
     * 
     * @param Authentication $item
     * @return self
     */
    public function addValue(Authentication $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Authentication>
     */
