 ...
 */
class AuthenticationCollectionResponse
{
    /**
     * @var Authentication[]
     */
     ...
     * 
     * @param Authentication ...$items Variable number of Authentication items
     * @return self
     */
    public function setValue(Authentication ...$items): self
    {
        $this->value = $items;
        return $this;
    }
