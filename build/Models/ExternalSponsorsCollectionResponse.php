...
/**
 * Collection response for ExternalSponsors
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalSponsorsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalSponsors[]
     */
    private array $value = [];
     ...
     * 
     * @param ExternalSponsors[] $items
     * @return self
     */
    public function setValue(array|ExternalSponsors $items, ExternalSponsors ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalSponsors> $value
     * @return self
     ...
     * 
     * @param ExternalSponsors $item
     * @return self
     */
    public function addValue(ExternalSponsors $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ExternalSponsors>
     */
