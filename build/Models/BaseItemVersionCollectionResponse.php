...
/**
 * Collection response for BaseItemVersion
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BaseItemVersionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BaseItemVersion[]
     */
     ...
     * 
     * @param BaseItemVersion[] $items
     * @return self
     */
    public function setValue(array|BaseItemVersion $items, BaseItemVersion ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BaseItemVersion> $value
     * @return self
     ...
     * 
     * @param BaseItemVersion $item
     * @return self
     */
    public function addValue(BaseItemVersion $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BaseItemVersion>
     */
