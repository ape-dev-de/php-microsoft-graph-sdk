 ...
 */
class BaseItemVersionCollectionResponse
{
    /**
     * @var BaseItemVersion[]
     */
     ...
     * 
     * @param BaseItemVersion ...$items Variable number of BaseItemVersion items
     * @return self
     */
    public function setValue(BaseItemVersion ...$items): self
    {
        $this->value = $items;
        return $this;
    }
