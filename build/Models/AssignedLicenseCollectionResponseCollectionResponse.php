...
/**
 * Collection response for AssignedLicenseCollectionResponse
 */
class AssignedLicenseCollectionResponseCollectionResponse
{
    /**
     * @var AssignedLicenseCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AssignedLicenseCollectionResponse ...$items Variable number of AssignedLicenseCollectionResponse items
     * @return self
     */
    public function setValue(AssignedLicenseCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AssignedLicenseCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AssignedLicenseCollectionResponse $item
     * @return self
     */
    public function addValue(AssignedLicenseCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
