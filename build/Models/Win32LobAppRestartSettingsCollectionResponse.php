...
/**
 * Collection response for Win32LobAppRestartSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Win32LobAppRestartSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Win32LobAppRestartSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param Win32LobAppRestartSettings[] $items
     * @return self
     */
    public function setValue(array|Win32LobAppRestartSettings $items, Win32LobAppRestartSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Win32LobAppRestartSettings> $value
     * @return self
     ...
     * 
     * @param Win32LobAppRestartSettings $item
     * @return self
     */
    public function addValue(Win32LobAppRestartSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Win32LobAppRestartSettings>
     */
