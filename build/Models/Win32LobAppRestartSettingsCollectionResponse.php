 ...
 */
class Win32LobAppRestartSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param Win32LobAppRestartSettings ...$items Variable number of Win32LobAppRestartSettings items
     * @return self
     */
    public function setValue(Win32LobAppRestartSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
