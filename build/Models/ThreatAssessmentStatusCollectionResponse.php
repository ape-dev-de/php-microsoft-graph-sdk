...
/**
 * Collection response for ThreatAssessmentStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ThreatAssessmentStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ThreatAssessmentStatus[] $items
     * @return self
     */
    public function setValue(array|ThreatAssessmentStatus $items, ThreatAssessmentStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ThreatAssessmentStatus> $value
     * @return self
     ...
     * 
     * @param ThreatAssessmentStatus $item
     * @return self
     */
    public function addValue(ThreatAssessmentStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ThreatAssessmentStatus>
     */
