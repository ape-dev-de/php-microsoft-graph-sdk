...
/**
 * Collection response for SiteCollectionResponse
 */
class SiteCollectionResponseCollectionResponse
{
    /**
     * @var SiteCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SiteCollectionResponse ...$items Variable number of SiteCollectionResponse items
     * @return self
     */
    public function setValue(SiteCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SiteCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SiteCollectionResponse $item
     * @return self
     */
    public function addValue(SiteCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
