...
/**
 * Collection response for SecurityIncident
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityIncidentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityIncident[] $items
     * @return self
     */
    public function setValue(array|SecurityIncident $items, SecurityIncident ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityIncident> $value
     * @return self
     ...
     * 
     * @param SecurityIncident $item
     * @return self
     */
    public function addValue(SecurityIncident $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityIncident>
     */
