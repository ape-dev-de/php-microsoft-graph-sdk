...
/**
 * Collection response for WorkbookRangeBorderCollectionResponse
 */
class WorkbookRangeBorderCollectionResponseCollectionResponse
{
    /**
     * @var WorkbookRangeBorderCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookRangeBorderCollectionResponse ...$items Variable number of WorkbookRangeBorderCollectionResponse items
     * @return self
     */
    public function setValue(WorkbookRangeBorderCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WorkbookRangeBorderCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WorkbookRangeBorderCollectionResponse $item
     * @return self
     */
    public function addValue(WorkbookRangeBorderCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
