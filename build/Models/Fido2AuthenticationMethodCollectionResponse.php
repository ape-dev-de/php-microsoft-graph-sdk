...
/**
 * Collection response for Fido2AuthenticationMethod
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Fido2AuthenticationMethodCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param Fido2AuthenticationMethod[] $items
     * @return self
     */
    public function setValue(array|Fido2AuthenticationMethod $items, Fido2AuthenticationMethod ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Fido2AuthenticationMethod> $value
     * @return self
     ...
     * 
     * @param Fido2AuthenticationMethod $item
     * @return self
     */
    public function addValue(Fido2AuthenticationMethod $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Fido2AuthenticationMethod>
     */
