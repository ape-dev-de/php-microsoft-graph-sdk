...
/**
 * Collection response for MailboxProtectionUnit
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MailboxProtectionUnitCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MailboxProtectionUnit[] $items
     * @return self
     */
    public function setValue(array|MailboxProtectionUnit $items, MailboxProtectionUnit ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MailboxProtectionUnit> $value
     * @return self
     ...
     * 
     * @param MailboxProtectionUnit $item
     * @return self
     */
    public function addValue(MailboxProtectionUnit $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MailboxProtectionUnit>
     */
