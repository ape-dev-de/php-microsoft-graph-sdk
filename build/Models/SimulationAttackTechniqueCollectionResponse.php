...
/**
 * SimulationAttackTechniqueCollectionResponse - Collection response
 */
class SimulationAttackTechniqueCollectionResponse
{
    /**
     * @var array<int, SimulationAttackTechnique>
     */
    public array $value = [];
