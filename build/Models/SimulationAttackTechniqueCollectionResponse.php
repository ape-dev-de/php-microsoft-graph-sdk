...
/**
 * Collection response for SimulationAttackTechnique
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SimulationAttackTechniqueCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SimulationAttackTechnique[]
     */
    private array $value = [];
     ...
     * 
     * @return SimulationAttackTechnique[]
     */
     ...
     * 
     * @param SimulationAttackTechnique[] $items
     * @return self
     */
    public function setValue(array|SimulationAttackTechnique $items, SimulationAttackTechnique ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SimulationAttackTechnique> $value
     * @return self
     ...
     * 
     * @param SimulationAttackTechnique $item
     * @return self
     */
    public function addValue(SimulationAttackTechnique $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SimulationAttackTechnique>
     */
