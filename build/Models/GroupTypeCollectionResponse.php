...
/**
 * Collection response for GroupType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class GroupTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var GroupType[]
     */
     ...
     * 
     * @param GroupType[] $items
     * @return self
     */
    public function setValue(array|GroupType $items, GroupType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param GroupType $item
     * @return self
     */
    public function addValue(GroupType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, GroupType>
     */
