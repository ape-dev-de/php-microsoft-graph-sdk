...
/**
 * Win32LobAppMsiPackageTypeCollectionResponse - Collection response
 */
class Win32LobAppMsiPackageTypeCollectionResponse
{
    /**
     * @var array<int, Win32LobAppMsiPackageType>
     */
    public array $value = [];
