...
/**
 * Collection response for Win32LobAppMsiPackageType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Win32LobAppMsiPackageTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Win32LobAppMsiPackageType[]
     */
    private array $value = [];
     ...
     * 
     * @return Win32LobAppMsiPackageType[]
     */
     ...
     * 
     * @param Win32LobAppMsiPackageType[] $items
     * @return self
     */
    public function setValue(array|Win32LobAppMsiPackageType $items, Win32LobAppMsiPackageType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Win32LobAppMsiPackageType> $value
     * @return self
     ...
     * 
     * @param Win32LobAppMsiPackageType $item
     * @return self
     */
    public function addValue(Win32LobAppMsiPackageType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Win32LobAppMsiPackageType>
     */
