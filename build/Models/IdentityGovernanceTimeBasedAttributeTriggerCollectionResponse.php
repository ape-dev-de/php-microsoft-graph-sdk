...
/**
 * Collection response for IdentityGovernanceTimeBasedAttributeTrigger
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceTimeBasedAttributeTriggerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceTimeBasedAttributeTrigger[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceTimeBasedAttributeTrigger[]
     */
     ...
     * 
     * @param IdentityGovernanceTimeBasedAttributeTrigger[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceTimeBasedAttributeTrigger $items, IdentityGovernanceTimeBasedAttributeTrigger ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceTimeBasedAttributeTrigger> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceTimeBasedAttributeTrigger $item
     * @return self
     */
    public function addValue(IdentityGovernanceTimeBasedAttributeTrigger $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceTimeBasedAttributeTrigger|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceTimeBasedAttributeTrigger>
     */
