 ...
 */
class IdentityGovernanceTimeBasedAttributeTriggerCollectionResponse
{
    /**
     ...
     * 
     * @param IdentityGovernanceTimeBasedAttributeTrigger ...$items Variable number of IdentityGovernanceTimeBasedAttributeTrigger items
     * @return self
     */
    public function setValue(IdentityGovernanceTimeBasedAttributeTrigger ...$items): self
    {
        $this->value = $items;
        return $this;
    }
