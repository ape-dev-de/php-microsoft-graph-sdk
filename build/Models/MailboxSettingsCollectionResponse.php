...
/**
 * Collection response for MailboxSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MailboxSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MailboxSettings[]
     */
     ...
     * 
     * @param MailboxSettings[] $items
     * @return self
     */
    public function setValue(array|MailboxSettings $items, MailboxSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MailboxSettings> $value
     * @return self
     ...
     * 
     * @param MailboxSettings $item
     * @return self
     */
    public function addValue(MailboxSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MailboxSettings>
     */
