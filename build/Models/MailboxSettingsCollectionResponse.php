 ...
 */
class MailboxSettingsCollectionResponse
{
    /**
     * @var MailboxSettings[]
     */
     ...
     * 
     * @param MailboxSettings ...$items Variable number of MailboxSettings items
     * @return self
     */
    public function setValue(MailboxSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
