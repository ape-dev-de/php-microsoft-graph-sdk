...
/**
 * Collection response for IncompatiblePrinterSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IncompatiblePrinterSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IncompatiblePrinterSettings[]
     */
    private array $value = [];
     ...
     * 
     * @return IncompatiblePrinterSettings[]
     */
     ...
     * 
     * @param IncompatiblePrinterSettings[] $items
     * @return self
     */
    public function setValue(array|IncompatiblePrinterSettings $items, IncompatiblePrinterSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IncompatiblePrinterSettings> $value
     * @return self
     ...
     * 
     * @param IncompatiblePrinterSettings $item
     * @return self
     */
    public function addValue(IncompatiblePrinterSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IncompatiblePrinterSettings>
     */
