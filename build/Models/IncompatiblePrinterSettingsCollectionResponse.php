...
/**
 * IncompatiblePrinterSettingsCollectionResponse - Collection response
 */
class IncompatiblePrinterSettingsCollectionResponse
{
    /**
     * @var array<int, IncompatiblePrinterSettings>
     */
    public array $value = [];
