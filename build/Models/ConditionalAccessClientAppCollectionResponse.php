...
/**
 * Collection response for ConditionalAccessClientApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessClientAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return ConditionalAccessClientApp[]
     */
     ...
     * 
     * @param ConditionalAccessClientApp[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessClientApp $items, ConditionalAccessClientApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessClientApp> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessClientApp $item
     * @return self
     */
    public function addValue(ConditionalAccessClientApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessClientApp>
     */
