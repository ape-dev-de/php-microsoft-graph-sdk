...
/**
 * ConditionalAccessClientAppCollectionResponse - Collection response
 */
class ConditionalAccessClientAppCollectionResponse
{
    /**
     * @var array<int, ConditionalAccessClientApp>
     */
    public array $value = [];
