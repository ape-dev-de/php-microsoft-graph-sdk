...
/**
 * AttackSimulationOperationTypeCollectionResponse - Collection response
 */
class AttackSimulationOperationTypeCollectionResponse
{
    /**
     * @var array<int, AttackSimulationOperationType>
     */
    public array $value = [];
