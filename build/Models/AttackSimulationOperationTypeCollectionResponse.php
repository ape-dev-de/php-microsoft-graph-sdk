...
/**
 * Collection response for AttackSimulationOperationType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttackSimulationOperationTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AttackSimulationOperationType[]
     */
    private array $value = [];
     ...
     * 
     * @param AttackSimulationOperationType[] $items
     * @return self
     */
    public function setValue(array|AttackSimulationOperationType $items, AttackSimulationOperationType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttackSimulationOperationType> $value
     * @return self
     ...
     * 
     * @param AttackSimulationOperationType $item
     * @return self
     */
    public function addValue(AttackSimulationOperationType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AttackSimulationOperationType>
     */
