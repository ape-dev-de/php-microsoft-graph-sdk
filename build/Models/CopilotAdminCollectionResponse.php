...
/**
 * Collection response for CopilotAdmin
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CopilotAdminCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CopilotAdmin[]
     */
     ...
     * 
     * @param CopilotAdmin[] $items
     * @return self
     */
    public function setValue(array|CopilotAdmin $items, CopilotAdmin ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CopilotAdmin> $value
     * @return self
     ...
     * 
     * @param CopilotAdmin $item
     * @return self
     */
    public function addValue(CopilotAdmin $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CopilotAdmin>
     */
