...
/**
 * Collection response for CloudPcProvisioningPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcProvisioningPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CloudPcProvisioningPolicy[] $items
     * @return self
     */
    public function setValue(array|CloudPcProvisioningPolicy $items, CloudPcProvisioningPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcProvisioningPolicy> $value
     * @return self
     ...
     * 
     * @param CloudPcProvisioningPolicy $item
     * @return self
     */
    public function addValue(CloudPcProvisioningPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcProvisioningPolicy>
     */
