...
/**
 * Collection response for DeviceCompliancePolicyState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceCompliancePolicyStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceCompliancePolicyState[] $items
     * @return self
     */
    public function setValue(array|DeviceCompliancePolicyState $items, DeviceCompliancePolicyState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceCompliancePolicyState> $value
     * @return self
     ...
     * 
     * @param DeviceCompliancePolicyState $item
     * @return self
     */
    public function addValue(DeviceCompliancePolicyState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceCompliancePolicyState>
     */
