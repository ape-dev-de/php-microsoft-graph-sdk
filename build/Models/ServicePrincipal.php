...
class ServicePrincipal
{
    ...
    /** 
     * 
     * @var DelegatedPermissionClassification[]
     */
    ...
    public function __construct(array $data = [])
    {
        ...
        if (isset($data['alternativeNames'])) {
            $this->alternativeNames = $data['alternativeNames'];
        }
        if (isset($data['appDescription'])) {
        ...
        if (isset($data['appOwnerOrganizationId'])) {
        ...
        if (isset($data['notificationEmailAddresses'])) {
            $this->notificationEmailAddresses = $data['notificationEmailAddresses'];
        }
        ...
        if (isset($data['preferredSingleSignOnMode'])) {
            $this->preferredSingleSignOnMode = $data['preferredSingleSignOnMode'];
        }
        if (isset($data['preferredTokenSigningKeyThumbprint'])) {
            $this->preferredTokenSigningKeyThumbprint = $data['preferredTokenSigningKeyThumbprint'];
        }
        if (isset($data['replyUrls'])) {
            $this->replyUrls = $data['replyUrls'];
        }
        if (isset($data['resourceSpecificApplicationPermissions'])) {
        ...
        if (isset($data['appRoleAssignedTo'])) {
            $this->appRoleAssignedTo = $data['appRoleAssignedTo'];
        }
        ...
        if (isset($data['delegatedPermissionClassifications'])) {
            $this->delegatedPermissionClassifications = $data['delegatedPermissionClassifications'];
        }
