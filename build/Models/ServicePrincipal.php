...
class ServicePrincipal
{
     ...
     * @var string[]
     */
    private array $notificationEmailAddresses = [];
     ...
     * @var string[]
     */
    private array $servicePrincipalNames = [];
     ...
     */
    public function setNotificationEmailAddresses(array $notificationEmailAddresses): self
    {
    ...
    /**
     * @param string[] $servicePrincipalNames
     */
    public function setServicePrincipalNames(array $servicePrincipalNames): self
    {
