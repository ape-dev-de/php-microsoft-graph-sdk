...
/**
 * Collection response for ResponseEmotionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ResponseEmotionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ResponseEmotionType[]
     */
    private array $value = [];
     ...
     * 
     * @param ResponseEmotionType[] $items
     * @return self
     */
    public function setValue(array|ResponseEmotionType $items, ResponseEmotionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ResponseEmotionType> $value
     * @return self
     ...
     * 
     * @param ResponseEmotionType $item
     * @return self
     */
    public function addValue(ResponseEmotionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ResponseEmotionType>
     */
