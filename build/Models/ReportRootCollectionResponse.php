...
/**
 * Collection response for ReportRoot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ReportRootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ReportRoot[]
     */
     ...
     * 
     * @param ReportRoot[] $items
     * @return self
     */
    public function setValue(array|ReportRoot $items, ReportRoot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param ReportRoot $item
     * @return self
     */
    public function addValue(ReportRoot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ReportRoot>
     */
