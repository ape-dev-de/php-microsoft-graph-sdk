 ...
 */
class AuthorizationInfoCollectionResponse
{
    /**
     ...
     * 
     * @param AuthorizationInfo ...$items Variable number of AuthorizationInfo items
     * @return self
     */
    public function setValue(AuthorizationInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
