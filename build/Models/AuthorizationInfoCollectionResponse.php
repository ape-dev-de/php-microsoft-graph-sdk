...
/**
 * Collection response for AuthorizationInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthorizationInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AuthorizationInfo[] $items
     * @return self
     */
    public function setValue(array|AuthorizationInfo $items, AuthorizationInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthorizationInfo> $value
     * @return self
     ...
     * 
     * @param AuthorizationInfo $item
     * @return self
     */
    public function addValue(AuthorizationInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthorizationInfo>
     */
