...
/**
 * Collection response for AuthenticationEventsFlowCollectionResponse
 */
class AuthenticationEventsFlowCollectionResponseCollectionResponse
{
    /**
     * @var AuthenticationEventsFlowCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AuthenticationEventsFlowCollectionResponse ...$items Variable number of AuthenticationEventsFlowCollectionResponse items
     * @return self
     */
    public function setValue(AuthenticationEventsFlowCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AuthenticationEventsFlowCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AuthenticationEventsFlowCollectionResponse $item
     * @return self
     */
    public function addValue(AuthenticationEventsFlowCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
