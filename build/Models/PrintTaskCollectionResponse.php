...
/**
 * Collection response for PrintTask
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintTaskCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrintTask[]
     */
     ...
     * 
     * @param PrintTask[] $items
     * @return self
     */
    public function setValue(array|PrintTask $items, PrintTask ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param PrintTask $item
     * @return self
     */
    public function addValue(PrintTask $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintTask>
     */
