 ...
 */
class AccessPackageResourceAttributeQuestionCollectionResponse
{
    /**
     ...
     * 
     * @param AccessPackageResourceAttributeQuestion ...$items Variable number of AccessPackageResourceAttributeQuestion items
     * @return self
     */
    public function setValue(AccessPackageResourceAttributeQuestion ...$items): self
    {
        $this->value = $items;
        return $this;
    }
