...
/**
 * Collection response for AccessPackageResourceAttributeQuestion
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageResourceAttributeQuestionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageResourceAttributeQuestion[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageResourceAttributeQuestion[] $items
     * @return self
     */
    public function setValue(array|AccessPackageResourceAttributeQuestion $items, AccessPackageResourceAttributeQuestion ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageResourceAttributeQuestion> $value
     * @return self
     ...
     * 
     * @param AccessPackageResourceAttributeQuestion $item
     * @return self
     */
    public function addValue(AccessPackageResourceAttributeQuestion $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessPackageResourceAttributeQuestion|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageResourceAttributeQuestion>
     */
