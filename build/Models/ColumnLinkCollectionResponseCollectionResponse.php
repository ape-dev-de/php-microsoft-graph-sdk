...
/**
 * Collection response for ColumnLinkCollectionResponse
 */
class ColumnLinkCollectionResponseCollectionResponse
{
    /**
     * @var ColumnLinkCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ColumnLinkCollectionResponse ...$items Variable number of ColumnLinkCollectionResponse items
     * @return self
     */
    public function setValue(ColumnLinkCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ColumnLinkCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ColumnLinkCollectionResponse $item
     * @return self
     */
    public function addValue(ColumnLinkCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
