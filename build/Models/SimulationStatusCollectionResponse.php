...
/**
 * Collection response for SimulationStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SimulationStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SimulationStatus[] $items
     * @return self
     */
    public function setValue(array|SimulationStatus $items, SimulationStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SimulationStatus> $value
     * @return self
     ...
     * 
     * @param SimulationStatus $item
     * @return self
     */
    public function addValue(SimulationStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SimulationStatus>
     */
