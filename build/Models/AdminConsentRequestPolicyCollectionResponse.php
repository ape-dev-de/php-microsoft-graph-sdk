 ...
 */
class AdminConsentRequestPolicyCollectionResponse
{
    /**
     ...
     * 
     * @param AdminConsentRequestPolicy ...$items Variable number of AdminConsentRequestPolicy items
     * @return self
     */
    public function setValue(AdminConsentRequestPolicy ...$items): self
    {
        $this->value = $items;
        return $this;
    }
