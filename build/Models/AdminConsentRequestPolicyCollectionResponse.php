...
/**
 * Collection response for AdminConsentRequestPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AdminConsentRequestPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AdminConsentRequestPolicy[]
     */
    private array $value = [];
     ...
     * 
     * @param AdminConsentRequestPolicy[] $items
     * @return self
     */
    public function setValue(array|AdminConsentRequestPolicy $items, AdminConsentRequestPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AdminConsentRequestPolicy> $value
     * @return self
     ...
     * 
     * @param AdminConsentRequestPolicy $item
     * @return self
     */
    public function addValue(AdminConsentRequestPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AdminConsentRequestPolicy>
     */
