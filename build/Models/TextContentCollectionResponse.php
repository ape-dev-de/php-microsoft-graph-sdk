...
/**
 * Collection response for TextContent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TextContentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TextContent[]
     */
     ...
     * 
     * @param TextContent[] $items
     * @return self
     */
    public function setValue(array|TextContent $items, TextContent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param TextContent $item
     * @return self
     */
    public function addValue(TextContent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TextContent>
     */
