...
/**
 * Collection response for ProcessIntegrityLevel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProcessIntegrityLevelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProcessIntegrityLevel[]
     */
    private array $value = [];
     ...
     * 
     * @param ProcessIntegrityLevel[] $items
     * @return self
     */
    public function setValue(array|ProcessIntegrityLevel $items, ProcessIntegrityLevel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProcessIntegrityLevel> $value
     * @return self
     ...
     * 
     * @param ProcessIntegrityLevel $item
     * @return self
     */
    public function addValue(ProcessIntegrityLevel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProcessIntegrityLevel>
     */
