...
/**
 * Collection response for BookingsAvailability
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingsAvailabilityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BookingsAvailability[]
     */
    private array $value = [];
     ...
     * 
     * @param BookingsAvailability[] $items
     * @return self
     */
    public function setValue(array|BookingsAvailability $items, BookingsAvailability ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingsAvailability> $value
     * @return self
     ...
     * 
     * @param BookingsAvailability $item
     * @return self
     */
    public function addValue(BookingsAvailability $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BookingsAvailability>
     */
