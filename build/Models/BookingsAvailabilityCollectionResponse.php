 ...
 */
class BookingsAvailabilityCollectionResponse
{
    /**
     ...
     * 
     * @param BookingsAvailability ...$items Variable number of BookingsAvailability items
     * @return self
     */
    public function setValue(BookingsAvailability ...$items): self
    {
        $this->value = $items;
        return $this;
    }
