...
/**
 * Collection response for MobileThreatDefenseConnectorCollectionResponse
 */
class MobileThreatDefenseConnectorCollectionResponseCollectionResponse
{
    /**
     * @var MobileThreatDefenseConnectorCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MobileThreatDefenseConnectorCollectionResponse ...$items Variable number of MobileThreatDefenseConnectorCollectionResponse items
     * @return self
     */
    public function setValue(MobileThreatDefenseConnectorCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MobileThreatDefenseConnectorCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MobileThreatDefenseConnectorCollectionResponse $item
     * @return self
     */
    public function addValue(MobileThreatDefenseConnectorCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
