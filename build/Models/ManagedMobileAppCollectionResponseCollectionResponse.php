...
/**
 * Collection response for ManagedMobileAppCollectionResponse
 */
class ManagedMobileAppCollectionResponseCollectionResponse
{
    /**
     * @var ManagedMobileAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedMobileAppCollectionResponse ...$items Variable number of ManagedMobileAppCollectionResponse items
     * @return self
     */
    public function setValue(ManagedMobileAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ManagedMobileAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ManagedMobileAppCollectionResponse $item
     * @return self
     */
    public function addValue(ManagedMobileAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
