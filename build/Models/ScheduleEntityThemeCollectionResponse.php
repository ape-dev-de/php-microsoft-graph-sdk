...
/**
 * Collection response for ScheduleEntityTheme
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ScheduleEntityThemeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ScheduleEntityTheme[] $items
     * @return self
     */
    public function setValue(array|ScheduleEntityTheme $items, ScheduleEntityTheme ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ScheduleEntityTheme> $value
     * @return self
     ...
     * 
     * @param ScheduleEntityTheme $item
     * @return self
     */
    public function addValue(ScheduleEntityTheme $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ScheduleEntityTheme>
     */
