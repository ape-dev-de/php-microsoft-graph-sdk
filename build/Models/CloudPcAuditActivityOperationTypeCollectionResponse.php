...
/**
 * CloudPcAuditActivityOperationTypeCollectionResponse - Collection response
 */
class CloudPcAuditActivityOperationTypeCollectionResponse
{
    /**
     * @var array<int, CloudPcAuditActivityOperationType>
     */
    public array $value = [];
