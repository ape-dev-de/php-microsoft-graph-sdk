...
/**
 * Collection response for CloudPcAuditActivityOperationType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcAuditActivityOperationTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudPcAuditActivityOperationType[]
     */
    private array $value = [];
     ...
     * 
     * @return CloudPcAuditActivityOperationType[]
     */
     ...
     * 
     * @param CloudPcAuditActivityOperationType[] $items
     * @return self
     */
    public function setValue(array|CloudPcAuditActivityOperationType $items, CloudPcAuditActivityOperationType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcAuditActivityOperationType> $value
     * @return self
     ...
     * 
     * @param CloudPcAuditActivityOperationType $item
     * @return self
     */
    public function addValue(CloudPcAuditActivityOperationType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcAuditActivityOperationType>
     */
