...
/**
 * Collection response for CoachmarkLocation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CoachmarkLocationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CoachmarkLocation[]
     */
    private array $value = [];
     ...
     * 
     * @param CoachmarkLocation[] $items
     * @return self
     */
    public function setValue(array|CoachmarkLocation $items, CoachmarkLocation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CoachmarkLocation> $value
     * @return self
     ...
     * 
     * @param CoachmarkLocation $item
     * @return self
     */
    public function addValue(CoachmarkLocation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CoachmarkLocation>
     */
