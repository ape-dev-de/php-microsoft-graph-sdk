 ...
 */
class CoachmarkLocationCollectionResponse
{
    /**
     ...
     * 
     * @param CoachmarkLocation ...$items Variable number of CoachmarkLocation items
     * @return self
     */
    public function setValue(CoachmarkLocation ...$items): self
    {
        $this->value = $items;
        return $this;
    }
