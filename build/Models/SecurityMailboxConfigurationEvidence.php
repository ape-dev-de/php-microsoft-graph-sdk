...
class SecurityMailboxConfigurationEvidence
{
    ...
    public function __construct(array $data = [])
    {
        ...
        if (isset($data['externalDirectoryObjectId'])) {
            $this->externalDirectoryObjectId = $data['externalDirectoryObjectId'];
        }
        if (isset($data['mailboxPrimaryAddress'])) {
            $this->mailboxPrimaryAddress = $data['mailboxPrimaryAddress'];
        }
        if (isset($data['upn'])) {
            $this->upn = $data['upn'];
        }
