...
/**
 * Collection response for UserTrainingEventInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserTrainingEventInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserTrainingEventInfo[] $items
     * @return self
     */
    public function setValue(array|UserTrainingEventInfo $items, UserTrainingEventInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserTrainingEventInfo> $value
     * @return self
     ...
     * 
     * @param UserTrainingEventInfo $item
     * @return self
     */
    public function addValue(UserTrainingEventInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UserTrainingEventInfo|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UserTrainingEventInfo>
     */
