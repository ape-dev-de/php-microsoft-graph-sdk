...
/**
 * Collection response for SynchronizationRuleCollectionResponse
 */
class SynchronizationRuleCollectionResponseCollectionResponse
{
    /**
     * @var SynchronizationRuleCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SynchronizationRuleCollectionResponse ...$items Variable number of SynchronizationRuleCollectionResponse items
     * @return self
     */
    public function setValue(SynchronizationRuleCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SynchronizationRuleCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SynchronizationRuleCollectionResponse $item
     * @return self
     */
    public function addValue(SynchronizationRuleCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
