...
/**
 * Collection response for BookingCustomerInformationBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingCustomerInformationBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param BookingCustomerInformationBase[] $items
     * @return self
     */
    public function setValue(array|BookingCustomerInformationBase $items, BookingCustomerInformationBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingCustomerInformationBase> $value
     * @return self
     ...
     * 
     * @param BookingCustomerInformationBase $item
     * @return self
     */
    public function addValue(BookingCustomerInformationBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return BookingCustomerInformationBase|null
     */
     ...
     * 
     * @return \ArrayIterator<int, BookingCustomerInformationBase>
     */
