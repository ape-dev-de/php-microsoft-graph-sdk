...
/**
 * DeviceManagementExchangeConnectorTypeCollectionResponse - Collection response
 */
class DeviceManagementExchangeConnectorTypeCollectionResponse
{
    /**
     * @var array<int, DeviceManagementExchangeConnectorType>
     */
    public array $value = [];
