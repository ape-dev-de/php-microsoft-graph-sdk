...
/**
 * Collection response for DeviceManagementExchangeConnectorType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceManagementExchangeConnectorTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceManagementExchangeConnectorType[]
     */
    private array $value = [];
     ...
     * 
     * @return DeviceManagementExchangeConnectorType[]
     */
     ...
     * 
     * @param DeviceManagementExchangeConnectorType[] $items
     * @return self
     */
    public function setValue(array|DeviceManagementExchangeConnectorType $items, DeviceManagementExchangeConnectorType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceManagementExchangeConnectorType> $value
     * @return self
     ...
     * 
     * @param DeviceManagementExchangeConnectorType $item
     * @return self
     */
    public function addValue(DeviceManagementExchangeConnectorType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceManagementExchangeConnectorType>
     */
