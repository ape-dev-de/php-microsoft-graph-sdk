...
/**
 * Collection response for WorkbookChartCollectionResponse
 */
class WorkbookChartCollectionResponseCollectionResponse
{
    /**
     * @var WorkbookChartCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookChartCollectionResponse ...$items Variable number of WorkbookChartCollectionResponse items
     * @return self
     */
    public function setValue(WorkbookChartCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WorkbookChartCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WorkbookChartCollectionResponse $item
     * @return self
     */
    public function addValue(WorkbookChartCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
