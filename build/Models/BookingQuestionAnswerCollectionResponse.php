...
/**
 * Collection response for BookingQuestionAnswer
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingQuestionAnswerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param BookingQuestionAnswer[] $items
     * @return self
     */
    public function setValue(array|BookingQuestionAnswer $items, BookingQuestionAnswer ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingQuestionAnswer> $value
     * @return self
     ...
     * 
     * @param BookingQuestionAnswer $item
     * @return self
     */
    public function addValue(BookingQuestionAnswer $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return BookingQuestionAnswer|null
     */
     ...
     * 
     * @return \ArrayIterator<int, BookingQuestionAnswer>
     */
