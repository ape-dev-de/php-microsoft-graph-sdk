 ...
 */
class JoinMeetingIdMeetingInfoCollectionResponse
{
    /**
     ...
     * 
     * @param JoinMeetingIdMeetingInfo ...$items Variable number of JoinMeetingIdMeetingInfo items
     * @return self
     */
    public function setValue(JoinMeetingIdMeetingInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
