...
/**
 * Collection response for JoinMeetingIdMeetingInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class JoinMeetingIdMeetingInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var JoinMeetingIdMeetingInfo[]
     */
    private array $value = [];
     ...
     * 
     * @param JoinMeetingIdMeetingInfo[] $items
     * @return self
     */
    public function setValue(array|JoinMeetingIdMeetingInfo $items, JoinMeetingIdMeetingInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<JoinMeetingIdMeetingInfo> $value
     * @return self
     ...
     * 
     * @param JoinMeetingIdMeetingInfo $item
     * @return self
     */
    public function addValue(JoinMeetingIdMeetingInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return JoinMeetingIdMeetingInfo|null
     */
     ...
     * 
     * @return \ArrayIterator<int, JoinMeetingIdMeetingInfo>
     */
