...
/**
 * Collection response for DeviceConfigurationState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceConfigurationStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceConfigurationState[] $items
     * @return self
     */
    public function setValue(array|DeviceConfigurationState $items, DeviceConfigurationState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceConfigurationState> $value
     * @return self
     ...
     * 
     * @param DeviceConfigurationState $item
     * @return self
     */
    public function addValue(DeviceConfigurationState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceConfigurationState>
     */
