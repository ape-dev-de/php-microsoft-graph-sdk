...
/**
 * Collection response for LearningCourseActivity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LearningCourseActivityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param LearningCourseActivity[] $items
     * @return self
     */
    public function setValue(array|LearningCourseActivity $items, LearningCourseActivity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LearningCourseActivity> $value
     * @return self
     ...
     * 
     * @param LearningCourseActivity $item
     * @return self
     */
    public function addValue(LearningCourseActivity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LearningCourseActivity>
     */
