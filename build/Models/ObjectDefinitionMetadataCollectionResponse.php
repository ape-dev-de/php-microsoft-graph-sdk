...
/**
 * Collection response for ObjectDefinitionMetadata
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ObjectDefinitionMetadataCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ObjectDefinitionMetadata[]
     */
    private array $value = [];
     ...
     * 
     * @return ObjectDefinitionMetadata[]
     */
     ...
     * 
     * @param ObjectDefinitionMetadata[] $items
     * @return self
     */
    public function setValue(array|ObjectDefinitionMetadata $items, ObjectDefinitionMetadata ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ObjectDefinitionMetadata> $value
     * @return self
     ...
     * 
     * @param ObjectDefinitionMetadata $item
     * @return self
     */
    public function addValue(ObjectDefinitionMetadata $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ObjectDefinitionMetadata>
     */
