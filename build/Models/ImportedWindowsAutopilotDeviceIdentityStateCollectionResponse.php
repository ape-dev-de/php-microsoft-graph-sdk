 ...
 */
class ImportedWindowsAutopilotDeviceIdentityStateCollectionResponse
{
    /**
     ...
     * 
     * @param ImportedWindowsAutopilotDeviceIdentityState ...$items Variable number of ImportedWindowsAutopilotDeviceIdentityState items
     * @return self
     */
    public function setValue(ImportedWindowsAutopilotDeviceIdentityState ...$items): self
    {
        $this->value = $items;
        return $this;
    }
