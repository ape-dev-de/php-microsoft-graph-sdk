...
/**
 * Collection response for ImportedWindowsAutopilotDeviceIdentityState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ImportedWindowsAutopilotDeviceIdentityStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ImportedWindowsAutopilotDeviceIdentityState[]
     */
    private array $value = [];
     ...
     * 
     * @param ImportedWindowsAutopilotDeviceIdentityState[] $items
     * @return self
     */
    public function setValue(array|ImportedWindowsAutopilotDeviceIdentityState $items, ImportedWindowsAutopilotDeviceIdentityState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ImportedWindowsAutopilotDeviceIdentityState> $value
     * @return self
     ...
     * 
     * @param ImportedWindowsAutopilotDeviceIdentityState $item
     * @return self
     */
    public function addValue(ImportedWindowsAutopilotDeviceIdentityState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ImportedWindowsAutopilotDeviceIdentityState>
     */
