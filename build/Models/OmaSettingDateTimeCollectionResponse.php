 ...
 */
class OmaSettingDateTimeCollectionResponse
{
    /**
     ...
     * 
     * @param OmaSettingDateTime ...$items Variable number of OmaSettingDateTime items
     * @return self
     */
    public function setValue(OmaSettingDateTime ...$items): self
    {
        $this->value = $items;
        return $this;
    }
