...
/**
 * Collection response for OmaSettingDateTime
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OmaSettingDateTimeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OmaSettingDateTime[]
     */
    private array $value = [];
     ...
     * 
     * @param OmaSettingDateTime[] $items
     * @return self
     */
    public function setValue(array|OmaSettingDateTime $items, OmaSettingDateTime ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OmaSettingDateTime> $value
     * @return self
     ...
     * 
     * @param OmaSettingDateTime $item
     * @return self
     */
    public function addValue(OmaSettingDateTime $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OmaSettingDateTime|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OmaSettingDateTime>
     */
