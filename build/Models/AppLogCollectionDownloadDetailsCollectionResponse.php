 ...
 */
class AppLogCollectionDownloadDetailsCollectionResponse
{
    /**
     ...
     * 
     * @param AppLogCollectionDownloadDetails ...$items Variable number of AppLogCollectionDownloadDetails items
     * @return self
     */
    public function setValue(AppLogCollectionDownloadDetails ...$items): self
    {
        $this->value = $items;
        return $this;
    }
