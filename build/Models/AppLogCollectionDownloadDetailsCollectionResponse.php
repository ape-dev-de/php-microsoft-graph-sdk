...
/**
 * Collection response for AppLogCollectionDownloadDetails
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppLogCollectionDownloadDetailsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AppLogCollectionDownloadDetails[]
     */
    private array $value = [];
     ...
     * 
     * @param AppLogCollectionDownloadDetails[] $items
     * @return self
     */
    public function setValue(array|AppLogCollectionDownloadDetails $items, AppLogCollectionDownloadDetails ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppLogCollectionDownloadDetails> $value
     * @return self
     ...
     * 
     * @param AppLogCollectionDownloadDetails $item
     * @return self
     */
    public function addValue(AppLogCollectionDownloadDetails $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AppLogCollectionDownloadDetails|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AppLogCollectionDownloadDetails>
     */
