...
/**
 * Collection response for LocalizedNotificationMessageCollectionResponse
 */
class LocalizedNotificationMessageCollectionResponseCollectionResponse
{
    /**
     * @var LocalizedNotificationMessageCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param LocalizedNotificationMessageCollectionResponse ...$items Variable number of LocalizedNotificationMessageCollectionResponse items
     * @return self
     */
    public function setValue(LocalizedNotificationMessageCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<LocalizedNotificationMessageCollectionResponse> $value
     * @return self
     ...
     * 
     * @param LocalizedNotificationMessageCollectionResponse $item
     * @return self
     */
    public function addValue(LocalizedNotificationMessageCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
