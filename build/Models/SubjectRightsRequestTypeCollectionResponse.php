...
/**
 * Collection response for SubjectRightsRequestType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SubjectRightsRequestTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SubjectRightsRequestType[]
     */
    private array $value = [];
     ...
     * 
     * @return SubjectRightsRequestType[]
     */
     ...
     * 
     * @param SubjectRightsRequestType[] $items
     * @return self
     */
    public function setValue(array|SubjectRightsRequestType $items, SubjectRightsRequestType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SubjectRightsRequestType> $value
     * @return self
     ...
     * 
     * @param SubjectRightsRequestType $item
     * @return self
     */
    public function addValue(SubjectRightsRequestType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SubjectRightsRequestType>
     */
