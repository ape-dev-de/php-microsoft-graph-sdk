...
/**
 * Collection response for MicrosoftCustomTrainingSetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MicrosoftCustomTrainingSettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MicrosoftCustomTrainingSetting[]
     */
    private array $value = [];
     ...
     * 
     * @param MicrosoftCustomTrainingSetting[] $items
     * @return self
     */
    public function setValue(array|MicrosoftCustomTrainingSetting $items, MicrosoftCustomTrainingSetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MicrosoftCustomTrainingSetting> $value
     * @return self
     ...
     * 
     * @param MicrosoftCustomTrainingSetting $item
     * @return self
     */
    public function addValue(MicrosoftCustomTrainingSetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MicrosoftCustomTrainingSetting|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MicrosoftCustomTrainingSetting>
     */
