 ...
 */
class MicrosoftCustomTrainingSettingCollectionResponse
{
    /**
     ...
     * 
     * @param MicrosoftCustomTrainingSetting ...$items Variable number of MicrosoftCustomTrainingSetting items
     * @return self
     */
    public function setValue(MicrosoftCustomTrainingSetting ...$items): self
    {
        $this->value = $items;
        return $this;
    }
