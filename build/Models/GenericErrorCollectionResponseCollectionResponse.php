...
/**
 * Collection response for GenericErrorCollectionResponse
 */
class GenericErrorCollectionResponseCollectionResponse
{
    /**
     * @var GenericErrorCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param GenericErrorCollectionResponse ...$items Variable number of GenericErrorCollectionResponse items
     * @return self
     */
    public function setValue(GenericErrorCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<GenericErrorCollectionResponse> $value
     * @return self
     ...
     * 
     * @param GenericErrorCollectionResponse $item
     * @return self
     */
    public function addValue(GenericErrorCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
