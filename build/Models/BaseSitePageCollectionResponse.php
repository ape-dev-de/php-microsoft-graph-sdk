...
/**
 * Collection response for BaseSitePage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BaseSitePageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BaseSitePage[]
     */
     ...
     * 
     * @param BaseSitePage[] $items
     * @return self
     */
    public function setValue(array|BaseSitePage $items, BaseSitePage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BaseSitePage> $value
     * @return self
     ...
     * 
     * @param BaseSitePage $item
     * @return self
     */
    public function addValue(BaseSitePage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BaseSitePage>
     */
