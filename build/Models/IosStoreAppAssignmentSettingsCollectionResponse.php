 ...
 */
class IosStoreAppAssignmentSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param IosStoreAppAssignmentSettings ...$items Variable number of IosStoreAppAssignmentSettings items
     * @return self
     */
    public function setValue(IosStoreAppAssignmentSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
