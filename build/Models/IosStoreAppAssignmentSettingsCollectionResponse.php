...
/**
 * Collection response for IosStoreAppAssignmentSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosStoreAppAssignmentSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IosStoreAppAssignmentSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param IosStoreAppAssignmentSettings[] $items
     * @return self
     */
    public function setValue(array|IosStoreAppAssignmentSettings $items, IosStoreAppAssignmentSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosStoreAppAssignmentSettings> $value
     * @return self
     ...
     * 
     * @param IosStoreAppAssignmentSettings $item
     * @return self
     */
    public function addValue(IosStoreAppAssignmentSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IosStoreAppAssignmentSettings|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IosStoreAppAssignmentSettings>
     */
