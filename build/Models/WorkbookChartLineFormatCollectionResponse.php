...
/**
 * Collection response for WorkbookChartLineFormat
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookChartLineFormatCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookChartLineFormat[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookChartLineFormat[] $items
     * @return self
     */
    public function setValue(array|WorkbookChartLineFormat $items, WorkbookChartLineFormat ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookChartLineFormat> $value
     * @return self
     ...
     * 
     * @param WorkbookChartLineFormat $item
     * @return self
     */
    public function addValue(WorkbookChartLineFormat $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookChartLineFormat>
     */
