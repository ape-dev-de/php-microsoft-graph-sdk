 ...
 */
class WorkbookChartLineFormatCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookChartLineFormat ...$items Variable number of WorkbookChartLineFormat items
     * @return self
     */
    public function setValue(WorkbookChartLineFormat ...$items): self
    {
        $this->value = $items;
        return $this;
    }
