...
/**
 * DelegatedAdminAccessContainerTypeCollectionResponse - Collection response
 */
class DelegatedAdminAccessContainerTypeCollectionResponse
{
    /**
     * @var array<int, DelegatedAdminAccessContainerType>
     */
    public array $value = [];
