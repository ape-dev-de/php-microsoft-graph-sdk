...
/**
 * Collection response for DelegatedAdminAccessContainerType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DelegatedAdminAccessContainerTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DelegatedAdminAccessContainerType[]
     */
    private array $value = [];
     ...
     * 
     * @return DelegatedAdminAccessContainerType[]
     */
     ...
     * 
     * @param DelegatedAdminAccessContainerType[] $items
     * @return self
     */
    public function setValue(array|DelegatedAdminAccessContainerType $items, DelegatedAdminAccessContainerType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DelegatedAdminAccessContainerType> $value
     * @return self
     ...
     * 
     * @param DelegatedAdminAccessContainerType $item
     * @return self
     */
    public function addValue(DelegatedAdminAccessContainerType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DelegatedAdminAccessContainerType>
     */
