...
/**
 * Collection response for CertificateStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CertificateStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CertificateStatus[] $items
     * @return self
     */
    public function setValue(array|CertificateStatus $items, CertificateStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CertificateStatus> $value
     * @return self
     ...
     * 
     * @param CertificateStatus $item
     * @return self
     */
    public function addValue(CertificateStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CertificateStatus>
     */
