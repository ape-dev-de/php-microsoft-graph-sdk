...
/**
 * Collection response for Trending
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TrendingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Trending[]
     */
     ...
     * 
     * @param Trending[] $items
     * @return self
     */
    public function setValue(array|Trending $items, Trending ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Trending $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Trending>
     */
