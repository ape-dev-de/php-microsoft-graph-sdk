...
/**
 * Collection response for ControlScoreCollectionResponse
 */
class ControlScoreCollectionResponseCollectionResponse
{
    /**
     * @var ControlScoreCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ControlScoreCollectionResponse ...$items Variable number of ControlScoreCollectionResponse items
     * @return self
     */
    public function setValue(ControlScoreCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ControlScoreCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ControlScoreCollectionResponse $item
     * @return self
     */
    public function addValue(ControlScoreCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
