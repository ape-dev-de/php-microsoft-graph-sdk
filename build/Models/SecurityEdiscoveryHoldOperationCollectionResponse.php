...
/**
 * Collection response for SecurityEdiscoveryHoldOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityEdiscoveryHoldOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityEdiscoveryHoldOperation[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityEdiscoveryHoldOperation[]
     */
     ...
     * 
     * @param SecurityEdiscoveryHoldOperation[] $items
     * @return self
     */
    public function setValue(array|SecurityEdiscoveryHoldOperation $items, SecurityEdiscoveryHoldOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityEdiscoveryHoldOperation> $value
     * @return self
     ...
     * 
     * @param SecurityEdiscoveryHoldOperation $item
     * @return self
     */
    public function addValue(SecurityEdiscoveryHoldOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityEdiscoveryHoldOperation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityEdiscoveryHoldOperation>
     */
