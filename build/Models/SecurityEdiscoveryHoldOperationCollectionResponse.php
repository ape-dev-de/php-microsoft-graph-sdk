...
/**
 * SecurityEdiscoveryHoldOperationCollectionResponse - Collection response
 */
class SecurityEdiscoveryHoldOperationCollectionResponse
{
    /**
     * @var array<int, SecurityEdiscoveryHoldOperation>
     */
    public array $value = [];
