...
/**
 * Collection response for IosHomeScreenFolderPageCollectionResponse
 */
class IosHomeScreenFolderPageCollectionResponseCollectionResponse
{
    /**
     * @var IosHomeScreenFolderPageCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IosHomeScreenFolderPageCollectionResponse ...$items Variable number of IosHomeScreenFolderPageCollectionResponse items
     * @return self
     */
    public function setValue(IosHomeScreenFolderPageCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IosHomeScreenFolderPageCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IosHomeScreenFolderPageCollectionResponse $item
     * @return self
     */
    public function addValue(IosHomeScreenFolderPageCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
