...
/**
 * Collection response for ItemActivityStat
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ItemActivityStatCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ItemActivityStat[] $items
     * @return self
     */
    public function setValue(array|ItemActivityStat $items, ItemActivityStat ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ItemActivityStat> $value
     * @return self
     ...
     * 
     * @param ItemActivityStat $item
     * @return self
     */
    public function addValue(ItemActivityStat $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ItemActivityStat>
     */
