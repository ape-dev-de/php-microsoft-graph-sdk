...
/**
 * Collection response for BrowserSite
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BrowserSiteCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BrowserSite[]
     */
     ...
     * 
     * @param BrowserSite[] $items
     * @return self
     */
    public function setValue(array|BrowserSite $items, BrowserSite ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param BrowserSite $item
     * @return self
     */
    public function addValue(BrowserSite $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BrowserSite>
     */
