...
/**
 * Collection response for ResourceReference
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ResourceReferenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ResourceReference[] $items
     * @return self
     */
    public function setValue(array|ResourceReference $items, ResourceReference ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ResourceReference> $value
     * @return self
     ...
     * 
     * @param ResourceReference $item
     * @return self
     */
    public function addValue(ResourceReference $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ResourceReference>
     */
