 ...
 */
class ResourceReferenceCollectionResponse
{
    /**
     ...
     * 
     * @param ResourceReference ...$items Variable number of ResourceReference items
     * @return self
     */
    public function setValue(ResourceReference ...$items): self
    {
        $this->value = $items;
        return $this;
    }
