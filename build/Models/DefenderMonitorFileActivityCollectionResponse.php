...
/**
 * DefenderMonitorFileActivityCollectionResponse - Collection response
 */
class DefenderMonitorFileActivityCollectionResponse
{
    /**
     * @var array<int, DefenderMonitorFileActivity>
     */
    public array $value = [];
