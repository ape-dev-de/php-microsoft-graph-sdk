...
/**
 * Collection response for DefenderMonitorFileActivity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DefenderMonitorFileActivityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DefenderMonitorFileActivity[]
     */
    private array $value = [];
     ...
     * 
     * @return DefenderMonitorFileActivity[]
     */
     ...
     * 
     * @param DefenderMonitorFileActivity[] $items
     * @return self
     */
    public function setValue(array|DefenderMonitorFileActivity $items, DefenderMonitorFileActivity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DefenderMonitorFileActivity> $value
     * @return self
     ...
     * 
     * @param DefenderMonitorFileActivity $item
     * @return self
     */
    public function addValue(DefenderMonitorFileActivity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DefenderMonitorFileActivity>
     */
