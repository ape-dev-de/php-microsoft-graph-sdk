...
/**
 * Collection response for PrivilegedAccessGroupRelationships
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrivilegedAccessGroupRelationshipsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrivilegedAccessGroupRelationships[]
     */
    private array $value = [];
     ...
     * 
     * @return PrivilegedAccessGroupRelationships[]
     */
     ...
     * 
     * @param PrivilegedAccessGroupRelationships[] $items
     * @return self
     */
    public function setValue(array|PrivilegedAccessGroupRelationships $items, PrivilegedAccessGroupRelationships ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrivilegedAccessGroupRelationships> $value
     * @return self
     ...
     * 
     * @param PrivilegedAccessGroupRelationships $item
     * @return self
     */
    public function addValue(PrivilegedAccessGroupRelationships $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrivilegedAccessGroupRelationships>
     */
