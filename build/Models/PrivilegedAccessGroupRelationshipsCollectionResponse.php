...
/**
 * PrivilegedAccessGroupRelationshipsCollectionResponse - Collection response
 */
class PrivilegedAccessGroupRelationshipsCollectionResponse
{
    /**
     * @var array<int, PrivilegedAccessGroupRelationships>
     */
    public array $value = [];
