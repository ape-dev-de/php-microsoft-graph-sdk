...
/**
 * Collection response for DeviceLogCollectionResponseCollectionResponse
 */
class DeviceLogCollectionResponseCollectionResponseCollectionResponse
{
    /**
     * @var DeviceLogCollectionResponseCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceLogCollectionResponseCollectionResponse ...$items Variable number of DeviceLogCollectionResponseCollectionResponse items
     * @return self
     */
    public function setValue(DeviceLogCollectionResponseCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeviceLogCollectionResponseCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeviceLogCollectionResponseCollectionResponse $item
     * @return self
     */
    public function addValue(DeviceLogCollectionResponseCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
