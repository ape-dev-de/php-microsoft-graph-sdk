...
/**
 * Collection response for RegistryOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RegistryOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RegistryOperation[]
     */
    private array $value = [];
     ...
     * 
     * @param RegistryOperation[] $items
     * @return self
     */
    public function setValue(array|RegistryOperation $items, RegistryOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RegistryOperation> $value
     * @return self
     ...
     * 
     * @param RegistryOperation $item
     * @return self
     */
    public function addValue(RegistryOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RegistryOperation>
     */
