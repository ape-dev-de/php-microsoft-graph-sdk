...
/**
 * Collection response for TeamworkUserIdentityType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamworkUserIdentityTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return TeamworkUserIdentityType[]
     */
     ...
     * 
     * @param TeamworkUserIdentityType[] $items
     * @return self
     */
    public function setValue(array|TeamworkUserIdentityType $items, TeamworkUserIdentityType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamworkUserIdentityType> $value
     * @return self
     ...
     * 
     * @param TeamworkUserIdentityType $item
     * @return self
     */
    public function addValue(TeamworkUserIdentityType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamworkUserIdentityType>
     */
