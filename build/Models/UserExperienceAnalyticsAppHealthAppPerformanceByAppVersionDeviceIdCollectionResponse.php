...
/**
 * UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceIdCollectionResponse - Collection response
 */
class UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceIdCollectionResponse
{
    /**
     * @var array<int, UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceId>
     */
    public array $value = [];
