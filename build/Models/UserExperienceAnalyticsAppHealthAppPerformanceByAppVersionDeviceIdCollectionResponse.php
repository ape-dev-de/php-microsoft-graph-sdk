...
/**
 * Collection response for UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceId
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceIdCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceId[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceId $items, UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceId ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceId> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceId $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceId $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDeviceId>
     */
