...
/**
 * Collection response for SynchronizationRule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationRuleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SynchronizationRule[] $items
     * @return self
     */
    public function setValue(array|SynchronizationRule $items, SynchronizationRule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SynchronizationRule> $value
     * @return self
     ...
     * 
     * @param SynchronizationRule $item
     * @return self
     */
    public function addValue(SynchronizationRule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SynchronizationRule>
     */
