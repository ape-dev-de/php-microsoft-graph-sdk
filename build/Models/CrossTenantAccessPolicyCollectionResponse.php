...
/**
 * Collection response for CrossTenantAccessPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CrossTenantAccessPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CrossTenantAccessPolicy[]
     */
    private array $value = [];
     ...
     * 
     * @param CrossTenantAccessPolicy[] $items
     * @return self
     */
    public function setValue(array|CrossTenantAccessPolicy $items, CrossTenantAccessPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CrossTenantAccessPolicy> $value
     * @return self
     ...
     * 
     * @param CrossTenantAccessPolicy $item
     * @return self
     */
    public function addValue(CrossTenantAccessPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CrossTenantAccessPolicy>
     */
