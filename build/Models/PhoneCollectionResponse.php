...
/**
 * Collection response for Phone
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PhoneCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Phone[]
     */
     ...
     * @return self
     */
    public function setValue(array|Phone $items, Phone ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Phone $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Phone>
     */
