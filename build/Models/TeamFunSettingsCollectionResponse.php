 ...
 */
class TeamFunSettingsCollectionResponse
{
    /**
     * @var TeamFunSettings[]
     */
     ...
     * 
     * @param TeamFunSettings ...$items Variable number of TeamFunSettings items
     * @return self
     */
    public function setValue(TeamFunSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
