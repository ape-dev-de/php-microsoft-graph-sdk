...
/**
 * Collection response for TeamFunSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamFunSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamFunSettings[]
     */
     ...
     * 
     * @param TeamFunSettings[] $items
     * @return self
     */
    public function setValue(array|TeamFunSettings $items, TeamFunSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamFunSettings> $value
     * @return self
     ...
     * 
     * @param TeamFunSettings $item
     * @return self
     */
    public function addValue(TeamFunSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamFunSettings>
     */
