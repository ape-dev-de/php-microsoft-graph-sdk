...
/**
 * Collection response for PronounsSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PronounsSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PronounsSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param PronounsSettings[] $items
     * @return self
     */
    public function setValue(array|PronounsSettings $items, PronounsSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PronounsSettings> $value
     * @return self
     ...
     * 
     * @param PronounsSettings $item
     * @return self
     */
    public function addValue(PronounsSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PronounsSettings>
     */
