 ...
 */
class PronounsSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param PronounsSettings ...$items Variable number of PronounsSettings items
     * @return self
     */
    public function setValue(PronounsSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
