...
/**
 * Collection response for BrowserSiteListCollectionResponse
 */
class BrowserSiteListCollectionResponseCollectionResponse
{
    /**
     * @var BrowserSiteListCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BrowserSiteListCollectionResponse ...$items Variable number of BrowserSiteListCollectionResponse items
     * @return self
     */
    public function setValue(BrowserSiteListCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<BrowserSiteListCollectionResponse> $value
     * @return self
     ...
     * 
     * @param BrowserSiteListCollectionResponse $item
     * @return self
     */
    public function addValue(BrowserSiteListCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
