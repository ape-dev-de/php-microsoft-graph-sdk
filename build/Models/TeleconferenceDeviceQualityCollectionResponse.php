 ...
 */
class TeleconferenceDeviceQualityCollectionResponse
{
    /**
     ...
     * 
     * @param TeleconferenceDeviceQuality ...$items Variable number of TeleconferenceDeviceQuality items
     * @return self
     */
    public function setValue(TeleconferenceDeviceQuality ...$items): self
    {
        $this->value = $items;
        return $this;
    }
