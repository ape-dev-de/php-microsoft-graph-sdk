...
/**
 * Collection response for TeleconferenceDeviceQuality
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeleconferenceDeviceQualityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeleconferenceDeviceQuality[]
     */
    private array $value = [];
     ...
     * 
     * @param TeleconferenceDeviceQuality[] $items
     * @return self
     */
    public function setValue(array|TeleconferenceDeviceQuality $items, TeleconferenceDeviceQuality ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeleconferenceDeviceQuality> $value
     * @return self
     ...
     * 
     * @param TeleconferenceDeviceQuality $item
     * @return self
     */
    public function addValue(TeleconferenceDeviceQuality $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeleconferenceDeviceQuality>
     */
