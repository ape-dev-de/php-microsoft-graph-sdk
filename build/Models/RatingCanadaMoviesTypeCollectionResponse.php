...
/**
 * Collection response for RatingCanadaMoviesType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RatingCanadaMoviesTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RatingCanadaMoviesType[]
     */
    private array $value = [];
     ...
     * 
     * @param RatingCanadaMoviesType[] $items
     * @return self
     */
    public function setValue(array|RatingCanadaMoviesType $items, RatingCanadaMoviesType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RatingCanadaMoviesType> $value
     * @return self
     ...
     * 
     * @param RatingCanadaMoviesType $item
     * @return self
     */
    public function addValue(RatingCanadaMoviesType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RatingCanadaMoviesType>
     */
