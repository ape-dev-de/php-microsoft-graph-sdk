...
/**
 * Collection response for AgreementFileData
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AgreementFileDataCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AgreementFileData[]
     */
    private array $value = [];
     ...
     * 
     * @param AgreementFileData[] $items
     * @return self
     */
    public function setValue(array|AgreementFileData $items, AgreementFileData ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AgreementFileData> $value
     * @return self
     ...
     * 
     * @param AgreementFileData $item
     * @return self
     */
    public function addValue(AgreementFileData $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AgreementFileData>
     */
