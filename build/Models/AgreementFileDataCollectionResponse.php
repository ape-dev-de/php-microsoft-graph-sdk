 ...
 */
class AgreementFileDataCollectionResponse
{
    /**
     ...
     * 
     * @param AgreementFileData ...$items Variable number of AgreementFileData items
     * @return self
     */
    public function setValue(AgreementFileData ...$items): self
    {
        $this->value = $items;
        return $this;
    }
