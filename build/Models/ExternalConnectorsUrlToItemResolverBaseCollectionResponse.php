...
/**
 * ExternalConnectorsUrlToItemResolverBaseCollectionResponse - Collection response
 */
class ExternalConnectorsUrlToItemResolverBaseCollectionResponse
{
    /**
     * @var array<int, ExternalConnectorsUrlToItemResolverBase>
     */
    public array $value = [];
