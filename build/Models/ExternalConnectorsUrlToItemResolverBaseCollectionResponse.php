...
/**
 * Collection response for ExternalConnectorsUrlToItemResolverBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsUrlToItemResolverBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return ExternalConnectorsUrlToItemResolverBase[]
     */
     ...
     * 
     * @param ExternalConnectorsUrlToItemResolverBase[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsUrlToItemResolverBase $items, ExternalConnectorsUrlToItemResolverBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsUrlToItemResolverBase> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsUrlToItemResolverBase $item
     * @return self
     */
    public function addValue(ExternalConnectorsUrlToItemResolverBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalConnectorsUrlToItemResolverBase|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsUrlToItemResolverBase>
     */
