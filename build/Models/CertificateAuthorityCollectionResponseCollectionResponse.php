...
/**
 * Collection response for CertificateAuthorityCollectionResponse
 */
class CertificateAuthorityCollectionResponseCollectionResponse
{
    /**
     * @var CertificateAuthorityCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CertificateAuthorityCollectionResponse ...$items Variable number of CertificateAuthorityCollectionResponse items
     * @return self
     */
    public function setValue(CertificateAuthorityCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CertificateAuthorityCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CertificateAuthorityCollectionResponse $item
     * @return self
     */
    public function addValue(CertificateAuthorityCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
