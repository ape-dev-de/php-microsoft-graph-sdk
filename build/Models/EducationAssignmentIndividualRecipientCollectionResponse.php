 ...
 */
class EducationAssignmentIndividualRecipientCollectionResponse
{
    /**
     ...
     * 
     * @param EducationAssignmentIndividualRecipient ...$items Variable number of EducationAssignmentIndividualRecipient items
     * @return self
     */
    public function setValue(EducationAssignmentIndividualRecipient ...$items): self
    {
        $this->value = $items;
        return $this;
    }
