...
/**
 * Collection response for EducationAssignmentIndividualRecipient
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationAssignmentIndividualRecipientCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationAssignmentIndividualRecipient[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationAssignmentIndividualRecipient[] $items
     * @return self
     */
    public function setValue(array|EducationAssignmentIndividualRecipient $items, EducationAssignmentIndividualRecipient ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationAssignmentIndividualRecipient> $value
     * @return self
     ...
     * 
     * @param EducationAssignmentIndividualRecipient $item
     * @return self
     */
    public function addValue(EducationAssignmentIndividualRecipient $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EducationAssignmentIndividualRecipient|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EducationAssignmentIndividualRecipient>
     */
