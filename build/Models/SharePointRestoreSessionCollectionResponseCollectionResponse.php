...
/**
 * Collection response for SharePointRestoreSessionCollectionResponse
 */
class SharePointRestoreSessionCollectionResponseCollectionResponse
{
    /**
     * @var SharePointRestoreSessionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SharePointRestoreSessionCollectionResponse ...$items Variable number of SharePointRestoreSessionCollectionResponse items
     * @return self
     */
    public function setValue(SharePointRestoreSessionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SharePointRestoreSessionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SharePointRestoreSessionCollectionResponse $item
     * @return self
     */
    public function addValue(SharePointRestoreSessionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
