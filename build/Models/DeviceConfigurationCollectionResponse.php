...
/**
 * Collection response for DeviceConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceConfiguration[] $items
     * @return self
     */
    public function setValue(array|DeviceConfiguration $items, DeviceConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceConfiguration> $value
     * @return self
     ...
     * 
     * @param DeviceConfiguration $item
     * @return self
     */
    public function addValue(DeviceConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceConfiguration>
     */
