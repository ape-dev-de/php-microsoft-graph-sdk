...
/**
 * Collection response for MdmWindowsInformationProtectionPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MdmWindowsInformationProtectionPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MdmWindowsInformationProtectionPolicy[] $items
     * @return self
     */
    public function setValue(array|MdmWindowsInformationProtectionPolicy $items, MdmWindowsInformationProtectionPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MdmWindowsInformationProtectionPolicy> $value
     * @return self
     ...
     * 
     * @param MdmWindowsInformationProtectionPolicy $item
     * @return self
     */
    public function addValue(MdmWindowsInformationProtectionPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MdmWindowsInformationProtectionPolicy>
     */
