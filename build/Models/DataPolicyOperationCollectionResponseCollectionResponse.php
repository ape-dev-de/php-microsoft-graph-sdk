...
/**
 * Collection response for DataPolicyOperationCollectionResponse
 */
class DataPolicyOperationCollectionResponseCollectionResponse
{
    /**
     * @var DataPolicyOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DataPolicyOperationCollectionResponse ...$items Variable number of DataPolicyOperationCollectionResponse items
     * @return self
     */
    public function setValue(DataPolicyOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DataPolicyOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DataPolicyOperationCollectionResponse $item
     * @return self
     */
    public function addValue(DataPolicyOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
