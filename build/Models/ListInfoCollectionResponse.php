...
/**
 * Collection response for ListInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ListInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ListInfo[]
     */
     ...
     * 
     * @param ListInfo[] $items
     * @return self
     */
    public function setValue(array|ListInfo $items, ListInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(ListInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ListInfo>
     */
