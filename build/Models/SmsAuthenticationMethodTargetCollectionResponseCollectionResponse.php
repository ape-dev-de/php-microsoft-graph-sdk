...
/**
 * Collection response for SmsAuthenticationMethodTargetCollectionResponse
 */
class SmsAuthenticationMethodTargetCollectionResponseCollectionResponse
{
    /**
     * @var SmsAuthenticationMethodTargetCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SmsAuthenticationMethodTargetCollectionResponse ...$items Variable number of SmsAuthenticationMethodTargetCollectionResponse items
     * @return self
     */
    public function setValue(SmsAuthenticationMethodTargetCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SmsAuthenticationMethodTargetCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SmsAuthenticationMethodTargetCollectionResponse $item
     * @return self
     */
    public function addValue(SmsAuthenticationMethodTargetCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
