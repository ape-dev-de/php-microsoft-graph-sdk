...
/**
 * Collection response for ServiceUpdateMessageCollectionResponse
 */
class ServiceUpdateMessageCollectionResponseCollectionResponse
{
    /**
     * @var ServiceUpdateMessageCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ServiceUpdateMessageCollectionResponse ...$items Variable number of ServiceUpdateMessageCollectionResponse items
     * @return self
     */
    public function setValue(ServiceUpdateMessageCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ServiceUpdateMessageCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ServiceUpdateMessageCollectionResponse $item
     * @return self
     */
    public function addValue(ServiceUpdateMessageCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
