...
/**
 * Collection response for AppliedConditionalAccessPolicyResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppliedConditionalAccessPolicyResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AppliedConditionalAccessPolicyResult[]
     */
    private array $value = [];
     ...
     * 
     * @return AppliedConditionalAccessPolicyResult[]
     */
     ...
     * 
     * @param AppliedConditionalAccessPolicyResult[] $items
     * @return self
     */
    public function setValue(array|AppliedConditionalAccessPolicyResult $items, AppliedConditionalAccessPolicyResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppliedConditionalAccessPolicyResult> $value
     * @return self
     ...
     * 
     * @param AppliedConditionalAccessPolicyResult $item
     * @return self
     */
    public function addValue(AppliedConditionalAccessPolicyResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AppliedConditionalAccessPolicyResult>
     */
