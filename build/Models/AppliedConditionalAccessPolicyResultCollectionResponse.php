...
/**
 * AppliedConditionalAccessPolicyResultCollectionResponse - Collection response
 */
class AppliedConditionalAccessPolicyResultCollectionResponse
{
    /**
     * @var array<int, AppliedConditionalAccessPolicyResult>
     */
    public array $value = [];
