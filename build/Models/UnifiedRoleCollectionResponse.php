...
/**
 * Collection response for UnifiedRole
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRoleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UnifiedRole[]
     */
     ...
     * 
     * @param UnifiedRole[] $items
     * @return self
     */
    public function setValue(array|UnifiedRole $items, UnifiedRole ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param UnifiedRole $item
     * @return self
     */
    public function addValue(UnifiedRole $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRole>
     */
