...
/**
 * Collection response for MuteParticipantOperationCollectionResponse
 */
class MuteParticipantOperationCollectionResponseCollectionResponse
{
    /**
     * @var MuteParticipantOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MuteParticipantOperationCollectionResponse ...$items Variable number of MuteParticipantOperationCollectionResponse items
     * @return self
     */
    public function setValue(MuteParticipantOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MuteParticipantOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MuteParticipantOperationCollectionResponse $item
     * @return self
     */
    public function addValue(MuteParticipantOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
