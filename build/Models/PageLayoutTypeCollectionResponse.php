...
/**
 * Collection response for PageLayoutType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PageLayoutTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PageLayoutType[]
     */
     ...
     * 
     * @param PageLayoutType[] $items
     * @return self
     */
    public function setValue(array|PageLayoutType $items, PageLayoutType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PageLayoutType> $value
     * @return self
     ...
     * 
     * @param PageLayoutType $item
     * @return self
     */
    public function addValue(PageLayoutType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PageLayoutType>
     */
