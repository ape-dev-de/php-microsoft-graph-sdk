 ...
 */
class ChangeNotificationEncryptedContentCollectionResponse
{
    /**
     ...
     * 
     * @param ChangeNotificationEncryptedContent ...$items Variable number of ChangeNotificationEncryptedContent items
     * @return self
     */
    public function setValue(ChangeNotificationEncryptedContent ...$items): self
    {
        $this->value = $items;
        return $this;
    }
