...
/**
 * Collection response for ChangeNotificationEncryptedContent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChangeNotificationEncryptedContentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChangeNotificationEncryptedContent[]
     */
    private array $value = [];
     ...
     * 
     * @param ChangeNotificationEncryptedContent[] $items
     * @return self
     */
    public function setValue(array|ChangeNotificationEncryptedContent $items, ChangeNotificationEncryptedContent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChangeNotificationEncryptedContent> $value
     * @return self
     ...
     * 
     * @param ChangeNotificationEncryptedContent $item
     * @return self
     */
    public function addValue(ChangeNotificationEncryptedContent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChangeNotificationEncryptedContent>
     */
