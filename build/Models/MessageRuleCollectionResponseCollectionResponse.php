...
/**
 * Collection response for MessageRuleCollectionResponse
 */
class MessageRuleCollectionResponseCollectionResponse
{
    /**
     * @var MessageRuleCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MessageRuleCollectionResponse ...$items Variable number of MessageRuleCollectionResponse items
     * @return self
     */
    public function setValue(MessageRuleCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MessageRuleCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MessageRuleCollectionResponse $item
     * @return self
     */
    public function addValue(MessageRuleCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
