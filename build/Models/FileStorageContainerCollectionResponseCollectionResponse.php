...
/**
 * Collection response for FileStorageContainerCollectionResponse
 */
class FileStorageContainerCollectionResponseCollectionResponse
{
    /**
     * @var FileStorageContainerCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param FileStorageContainerCollectionResponse ...$items Variable number of FileStorageContainerCollectionResponse items
     * @return self
     */
    public function setValue(FileStorageContainerCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<FileStorageContainerCollectionResponse> $value
     * @return self
     ...
     * 
     * @param FileStorageContainerCollectionResponse $item
     * @return self
     */
    public function addValue(FileStorageContainerCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
