...
/**
 * Collection response for UnifiedRoleScheduleBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRoleScheduleBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UnifiedRoleScheduleBase[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedRoleScheduleBase[] $items
     * @return self
     */
    public function setValue(array|UnifiedRoleScheduleBase $items, UnifiedRoleScheduleBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRoleScheduleBase> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleScheduleBase $item
     * @return self
     */
    public function addValue(UnifiedRoleScheduleBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UnifiedRoleScheduleBase|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRoleScheduleBase>
     */
