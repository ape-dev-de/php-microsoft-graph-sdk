 ...
 */
class UnifiedRoleScheduleBaseCollectionResponse
{
    /**
     ...
     * 
     * @param UnifiedRoleScheduleBase ...$items Variable number of UnifiedRoleScheduleBase items
     * @return self
     */
    public function setValue(UnifiedRoleScheduleBase ...$items): self
    {
        $this->value = $items;
        return $this;
    }
