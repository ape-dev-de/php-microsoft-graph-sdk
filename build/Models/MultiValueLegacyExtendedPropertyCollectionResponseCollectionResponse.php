...
/**
 * Collection response for MultiValueLegacyExtendedPropertyCollectionResponse
 */
class MultiValueLegacyExtendedPropertyCollectionResponseCollectionResponse
{
    /**
     * @var MultiValueLegacyExtendedPropertyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MultiValueLegacyExtendedPropertyCollectionResponse ...$items Variable number of MultiValueLegacyExtendedPropertyCollectionResponse items
     * @return self
     */
    public function setValue(MultiValueLegacyExtendedPropertyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MultiValueLegacyExtendedPropertyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MultiValueLegacyExtendedPropertyCollectionResponse $item
     * @return self
     */
    public function addValue(MultiValueLegacyExtendedPropertyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
