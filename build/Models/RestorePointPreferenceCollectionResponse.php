...
/**
 * Collection response for RestorePointPreference
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RestorePointPreferenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RestorePointPreference[]
     */
    private array $value = [];
     ...
     * 
     * @param RestorePointPreference[] $items
     * @return self
     */
    public function setValue(array|RestorePointPreference $items, RestorePointPreference ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RestorePointPreference> $value
     * @return self
     ...
     * 
     * @param RestorePointPreference $item
     * @return self
     */
    public function addValue(RestorePointPreference $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RestorePointPreference>
     */
