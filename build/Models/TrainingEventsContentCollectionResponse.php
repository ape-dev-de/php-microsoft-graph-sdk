 ...
 */
class TrainingEventsContentCollectionResponse
{
    /**
     ...
     * 
     * @param TrainingEventsContent ...$items Variable number of TrainingEventsContent items
     * @return self
     */
    public function setValue(TrainingEventsContent ...$items): self
    {
        $this->value = $items;
        return $this;
    }
