...
/**
 * Collection response for TrainingEventsContent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TrainingEventsContentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TrainingEventsContent[]
     */
    private array $value = [];
     ...
     * 
     * @param TrainingEventsContent[] $items
     * @return self
     */
    public function setValue(array|TrainingEventsContent $items, TrainingEventsContent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TrainingEventsContent> $value
     * @return self
     ...
     * 
     * @param TrainingEventsContent $item
     * @return self
     */
    public function addValue(TrainingEventsContent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TrainingEventsContent>
     */
