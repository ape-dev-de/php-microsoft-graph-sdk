...
/**
 * Collection response for CloudPcProvisioningPolicyAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcProvisioningPolicyAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CloudPcProvisioningPolicyAssignment[] $items
     * @return self
     */
    public function setValue(array|CloudPcProvisioningPolicyAssignment $items, CloudPcProvisioningPolicyAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcProvisioningPolicyAssignment> $value
     * @return self
     ...
     * 
     * @param CloudPcProvisioningPolicyAssignment $item
     * @return self
     */
    public function addValue(CloudPcProvisioningPolicyAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcProvisioningPolicyAssignment>
     */
