...
/**
 * Collection response for UserDataSecurityAndGovernance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserDataSecurityAndGovernanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserDataSecurityAndGovernance[]
     */
    private array $value = [];
     ...
     * 
     * @param UserDataSecurityAndGovernance[] $items
     * @return self
     */
    public function setValue(array|UserDataSecurityAndGovernance $items, UserDataSecurityAndGovernance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserDataSecurityAndGovernance> $value
     * @return self
     ...
     * 
     * @param UserDataSecurityAndGovernance $item
     * @return self
     */
    public function addValue(UserDataSecurityAndGovernance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserDataSecurityAndGovernance>
     */
