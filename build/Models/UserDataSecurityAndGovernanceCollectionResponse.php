 ...
 */
class UserDataSecurityAndGovernanceCollectionResponse
{
    /**
     ...
     * 
     * @param UserDataSecurityAndGovernance ...$items Variable number of UserDataSecurityAndGovernance items
     * @return self
     */
    public function setValue(UserDataSecurityAndGovernance ...$items): self
    {
        $this->value = $items;
        return $this;
    }
