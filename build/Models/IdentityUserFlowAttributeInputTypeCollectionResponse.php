...
/**
 * IdentityUserFlowAttributeInputTypeCollectionResponse - Collection response
 */
class IdentityUserFlowAttributeInputTypeCollectionResponse
{
    /**
     * @var array<int, IdentityUserFlowAttributeInputType>
     */
    public array $value = [];
