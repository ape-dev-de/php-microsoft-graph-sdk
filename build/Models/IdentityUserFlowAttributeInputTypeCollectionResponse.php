...
/**
 * Collection response for IdentityUserFlowAttributeInputType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityUserFlowAttributeInputTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityUserFlowAttributeInputType[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityUserFlowAttributeInputType[]
     */
     ...
     * 
     * @param IdentityUserFlowAttributeInputType[] $items
     * @return self
     */
    public function setValue(array|IdentityUserFlowAttributeInputType $items, IdentityUserFlowAttributeInputType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityUserFlowAttributeInputType> $value
     * @return self
     ...
     * 
     * @param IdentityUserFlowAttributeInputType $item
     * @return self
     */
    public function addValue(IdentityUserFlowAttributeInputType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityUserFlowAttributeInputType>
     */
