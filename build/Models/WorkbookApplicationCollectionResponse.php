 ...
 */
class WorkbookApplicationCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookApplication ...$items Variable number of WorkbookApplication items
     * @return self
     */
    public function setValue(WorkbookApplication ...$items): self
    {
        $this->value = $items;
        return $this;
    }
