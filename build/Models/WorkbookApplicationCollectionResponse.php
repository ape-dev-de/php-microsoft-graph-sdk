...
/**
 * Collection response for WorkbookApplication
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookApplicationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookApplication[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookApplication[] $items
     * @return self
     */
    public function setValue(array|WorkbookApplication $items, WorkbookApplication ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookApplication> $value
     * @return self
     ...
     * 
     * @param WorkbookApplication $item
     * @return self
     */
    public function addValue(WorkbookApplication $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookApplication>
     */
