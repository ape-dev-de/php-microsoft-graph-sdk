...
/**
 * Collection response for ItemAttachment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ItemAttachmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ItemAttachment[]
     */
     ...
     * 
     * @param ItemAttachment[] $items
     * @return self
     */
    public function setValue(array|ItemAttachment $items, ItemAttachment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ItemAttachment> $value
     * @return self
     ...
     * 
     * @param ItemAttachment $item
     * @return self
     */
    public function addValue(ItemAttachment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ItemAttachment>
     */
