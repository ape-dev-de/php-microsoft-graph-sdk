...
/**
 * Collection response for PrintDuplexMode
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintDuplexModeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrintDuplexMode[]
     */
     ...
     * 
     * @param PrintDuplexMode[] $items
     * @return self
     */
    public function setValue(array|PrintDuplexMode $items, PrintDuplexMode ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintDuplexMode> $value
     * @return self
     ...
     * 
     * @param PrintDuplexMode $item
     * @return self
     */
    public function addValue(PrintDuplexMode $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintDuplexMode>
     */
