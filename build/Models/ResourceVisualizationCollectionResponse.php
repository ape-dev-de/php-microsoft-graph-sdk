...
/**
 * Collection response for ResourceVisualization
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ResourceVisualizationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ResourceVisualization[] $items
     * @return self
     */
    public function setValue(array|ResourceVisualization $items, ResourceVisualization ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ResourceVisualization> $value
     * @return self
     ...
     * 
     * @param ResourceVisualization $item
     * @return self
     */
    public function addValue(ResourceVisualization $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ResourceVisualization>
     */
