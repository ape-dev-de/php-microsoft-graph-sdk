 ...
 */
class ResourceVisualizationCollectionResponse
{
    /**
     ...
     * 
     * @param ResourceVisualization ...$items Variable number of ResourceVisualization items
     * @return self
     */
    public function setValue(ResourceVisualization ...$items): self
    {
        $this->value = $items;
        return $this;
    }
