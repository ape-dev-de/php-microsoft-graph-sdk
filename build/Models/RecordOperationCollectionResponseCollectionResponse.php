...
/**
 * Collection response for RecordOperationCollectionResponse
 */
class RecordOperationCollectionResponseCollectionResponse
{
    /**
     * @var RecordOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RecordOperationCollectionResponse ...$items Variable number of RecordOperationCollectionResponse items
     * @return self
     */
    public function setValue(RecordOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RecordOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RecordOperationCollectionResponse $item
     * @return self
     */
    public function addValue(RecordOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
