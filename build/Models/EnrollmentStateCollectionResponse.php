...
/**
 * Collection response for EnrollmentState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EnrollmentStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EnrollmentState[]
     */
     ...
     * 
     * @param EnrollmentState[] $items
     * @return self
     */
    public function setValue(array|EnrollmentState $items, EnrollmentState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EnrollmentState> $value
     * @return self
     ...
     * 
     * @param EnrollmentState $item
     * @return self
     */
    public function addValue(EnrollmentState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EnrollmentState>
     */
