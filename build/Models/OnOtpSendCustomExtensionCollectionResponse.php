...
/**
 * Collection response for OnOtpSendCustomExtension
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnOtpSendCustomExtensionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnOtpSendCustomExtension[]
     */
    private array $value = [];
     ...
     * 
     * @param OnOtpSendCustomExtension[] $items
     * @return self
     */
    public function setValue(array|OnOtpSendCustomExtension $items, OnOtpSendCustomExtension ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnOtpSendCustomExtension> $value
     * @return self
     ...
     * 
     * @param OnOtpSendCustomExtension $item
     * @return self
     */
    public function addValue(OnOtpSendCustomExtension $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnOtpSendCustomExtension>
     */
