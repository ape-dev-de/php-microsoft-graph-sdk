...
/**
 * Collection response for BookingStaffMemberBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingStaffMemberBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param BookingStaffMemberBase[] $items
     * @return self
     */
    public function setValue(array|BookingStaffMemberBase $items, BookingStaffMemberBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingStaffMemberBase> $value
     * @return self
     ...
     * 
     * @param BookingStaffMemberBase $item
     * @return self
     */
    public function addValue(BookingStaffMemberBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BookingStaffMemberBase>
     */
