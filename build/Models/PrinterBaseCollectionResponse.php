...
/**
 * Collection response for PrinterBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrinterBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrinterBase[]
     */
     ...
     * 
     * @param PrinterBase[] $items
     * @return self
     */
    public function setValue(array|PrinterBase $items, PrinterBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param PrinterBase $item
     * @return self
     */
    public function addValue(PrinterBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrinterBase>
     */
