...
/**
 * Collection response for TeamsLicensingDetails
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamsLicensingDetailsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamsLicensingDetails[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamsLicensingDetails[] $items
     * @return self
     */
    public function setValue(array|TeamsLicensingDetails $items, TeamsLicensingDetails ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamsLicensingDetails> $value
     * @return self
     ...
     * 
     * @param TeamsLicensingDetails $item
     * @return self
     */
    public function addValue(TeamsLicensingDetails $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TeamsLicensingDetails|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TeamsLicensingDetails>
     */
