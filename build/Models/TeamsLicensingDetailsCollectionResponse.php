 ...
 */
class TeamsLicensingDetailsCollectionResponse
{
    /**
     ...
     * 
     * @param TeamsLicensingDetails ...$items Variable number of TeamsLicensingDetails items
     * @return self
     */
    public function setValue(TeamsLicensingDetails ...$items): self
    {
        $this->value = $items;
        return $this;
    }
