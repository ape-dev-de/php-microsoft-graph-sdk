...
/**
 * Collection response for AccessReviewStageSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewStageSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessReviewStageSettings[] $items
     * @return self
     */
    public function setValue(array|AccessReviewStageSettings $items, AccessReviewStageSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewStageSettings> $value
     * @return self
     ...
     * 
     * @param AccessReviewStageSettings $item
     * @return self
     */
    public function addValue(AccessReviewStageSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessReviewStageSettings|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewStageSettings>
     */
