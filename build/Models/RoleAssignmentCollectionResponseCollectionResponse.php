...
/**
 * Collection response for RoleAssignmentCollectionResponse
 */
class RoleAssignmentCollectionResponseCollectionResponse
{
    /**
     * @var RoleAssignmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RoleAssignmentCollectionResponse ...$items Variable number of RoleAssignmentCollectionResponse items
     * @return self
     */
    public function setValue(RoleAssignmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RoleAssignmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RoleAssignmentCollectionResponse $item
     * @return self
     */
    public function addValue(RoleAssignmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
