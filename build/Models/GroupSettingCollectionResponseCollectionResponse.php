...
/**
 * Collection response for GroupSettingCollectionResponse
 */
class GroupSettingCollectionResponseCollectionResponse
{
    /**
     * @var GroupSettingCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param GroupSettingCollectionResponse ...$items Variable number of GroupSettingCollectionResponse items
     * @return self
     */
    public function setValue(GroupSettingCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<GroupSettingCollectionResponse> $value
     * @return self
     ...
     * 
     * @param GroupSettingCollectionResponse $item
     * @return self
     */
    public function addValue(GroupSettingCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
