...
/**
 * CustomExtensionEndpointConfigurationCollectionResponse - Collection response
 */
class CustomExtensionEndpointConfigurationCollectionResponse
{
    /**
     * @var array<int, CustomExtensionEndpointConfiguration>
     */
    public array $value = [];
