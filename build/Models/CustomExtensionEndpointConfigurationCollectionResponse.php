...
/**
 * Collection response for CustomExtensionEndpointConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CustomExtensionEndpointConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CustomExtensionEndpointConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param CustomExtensionEndpointConfiguration[] $items
     * @return self
     */
    public function setValue(array|CustomExtensionEndpointConfiguration $items, CustomExtensionEndpointConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CustomExtensionEndpointConfiguration> $value
     * @return self
     ...
     * 
     * @param CustomExtensionEndpointConfiguration $item
     * @return self
     */
    public function addValue(CustomExtensionEndpointConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CustomExtensionEndpointConfiguration>
     */
