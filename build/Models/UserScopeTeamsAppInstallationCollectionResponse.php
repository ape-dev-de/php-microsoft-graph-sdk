...
/**
 * Collection response for UserScopeTeamsAppInstallation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserScopeTeamsAppInstallationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserScopeTeamsAppInstallation[] $items
     * @return self
     */
    public function setValue(array|UserScopeTeamsAppInstallation $items, UserScopeTeamsAppInstallation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserScopeTeamsAppInstallation> $value
     * @return self
     ...
     * 
     * @param UserScopeTeamsAppInstallation $item
     * @return self
     */
    public function addValue(UserScopeTeamsAppInstallation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserScopeTeamsAppInstallation>
     */
