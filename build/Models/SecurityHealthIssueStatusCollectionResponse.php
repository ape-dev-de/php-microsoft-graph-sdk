...
/**
 * SecurityHealthIssueStatusCollectionResponse - Collection response
 */
class SecurityHealthIssueStatusCollectionResponse
{
    /**
     * @var array<int, SecurityHealthIssueStatus>
     */
    public array $value = [];
