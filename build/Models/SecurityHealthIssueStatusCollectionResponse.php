...
/**
 * Collection response for SecurityHealthIssueStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHealthIssueStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityHealthIssueStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityHealthIssueStatus[]
     */
     ...
     * 
     * @param SecurityHealthIssueStatus[] $items
     * @return self
     */
    public function setValue(array|SecurityHealthIssueStatus $items, SecurityHealthIssueStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHealthIssueStatus> $value
     * @return self
     ...
     * 
     * @param SecurityHealthIssueStatus $item
     * @return self
     */
    public function addValue(SecurityHealthIssueStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityHealthIssueStatus|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityHealthIssueStatus>
     */
