...
/**
 * IdentityGovernanceCustomTaskExtensionCollectionResponse - Collection response
 */
class IdentityGovernanceCustomTaskExtensionCollectionResponse
{
    /**
     * @var array<int, IdentityGovernanceCustomTaskExtension>
     */
    public array $value = [];
