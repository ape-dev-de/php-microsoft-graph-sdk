...
/**
 * Collection response for IdentityGovernanceCustomTaskExtension
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceCustomTaskExtensionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IdentityGovernanceCustomTaskExtension[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceCustomTaskExtension $items, IdentityGovernanceCustomTaskExtension ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceCustomTaskExtension> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceCustomTaskExtension $item
     * @return self
     */
    public function addValue(IdentityGovernanceCustomTaskExtension $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceCustomTaskExtension>
     */
