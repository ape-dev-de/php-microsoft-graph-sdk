...
/**
 * Collection response for CallRecordsVideoCodec
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsVideoCodecCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsVideoCodec[]
     */
    private array $value = [];
     ...
     * 
     * @param CallRecordsVideoCodec[] $items
     * @return self
     */
    public function setValue(array|CallRecordsVideoCodec $items, CallRecordsVideoCodec ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsVideoCodec> $value
     * @return self
     ...
     * 
     * @param CallRecordsVideoCodec $item
     * @return self
     */
    public function addValue(CallRecordsVideoCodec $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsVideoCodec|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsVideoCodec>
     */
