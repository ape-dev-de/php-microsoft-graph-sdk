...
/**
 * Collection response for AppConsentRequestScope
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppConsentRequestScopeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AppConsentRequestScope[] $items
     * @return self
     */
    public function setValue(array|AppConsentRequestScope $items, AppConsentRequestScope ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppConsentRequestScope> $value
     * @return self
     ...
     * 
     * @param AppConsentRequestScope $item
     * @return self
     */
    public function addValue(AppConsentRequestScope $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AppConsentRequestScope|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AppConsentRequestScope>
     */
