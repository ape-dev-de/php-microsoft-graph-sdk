 ...
 */
class WebPartPositionCollectionResponse
{
    /**
     * @var WebPartPosition[]
     */
     ...
     * 
     * @param WebPartPosition ...$items Variable number of WebPartPosition items
     * @return self
     */
    public function setValue(WebPartPosition ...$items): self
    {
        $this->value = $items;
        return $this;
    }
