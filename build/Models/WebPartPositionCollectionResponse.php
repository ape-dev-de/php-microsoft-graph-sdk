...
/**
 * Collection response for WebPartPosition
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WebPartPositionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WebPartPosition[]
     */
     ...
     * 
     * @param WebPartPosition[] $items
     * @return self
     */
    public function setValue(array|WebPartPosition $items, WebPartPosition ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WebPartPosition> $value
     * @return self
     ...
     * 
     * @param WebPartPosition $item
     * @return self
     */
    public function addValue(WebPartPosition $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WebPartPosition>
     */
