...
/**
 * Collection response for SecurityFilePlanAuthority
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityFilePlanAuthorityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityFilePlanAuthority[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityFilePlanAuthority[]
     */
     ...
     * 
     * @param SecurityFilePlanAuthority[] $items
     * @return self
     */
    public function setValue(array|SecurityFilePlanAuthority $items, SecurityFilePlanAuthority ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityFilePlanAuthority> $value
     * @return self
     ...
     * 
     * @param SecurityFilePlanAuthority $item
     * @return self
     */
    public function addValue(SecurityFilePlanAuthority $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityFilePlanAuthority|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityFilePlanAuthority>
     */
