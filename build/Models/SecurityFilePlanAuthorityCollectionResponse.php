...
/**
 * SecurityFilePlanAuthorityCollectionResponse - Collection response
 */
class SecurityFilePlanAuthorityCollectionResponse
{
    /**
     * @var array<int, SecurityFilePlanAuthority>
     */
    public array $value = [];
