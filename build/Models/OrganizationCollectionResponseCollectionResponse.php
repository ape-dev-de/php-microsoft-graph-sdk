...
/**
 * Collection response for OrganizationCollectionResponse
 */
class OrganizationCollectionResponseCollectionResponse
{
    /**
     * @var OrganizationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param OrganizationCollectionResponse ...$items Variable number of OrganizationCollectionResponse items
     * @return self
     */
    public function setValue(OrganizationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<OrganizationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param OrganizationCollectionResponse $item
     * @return self
     */
    public function addValue(OrganizationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
