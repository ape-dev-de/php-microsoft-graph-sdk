 ...
 */
class SignInConditionsCollectionResponse
{
    /**
     ...
     * 
     * @param SignInConditions ...$items Variable number of SignInConditions items
     * @return self
     */
    public function setValue(SignInConditions ...$items): self
    {
        $this->value = $items;
        return $this;
    }
