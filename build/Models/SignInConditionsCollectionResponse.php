...
/**
 * Collection response for SignInConditions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SignInConditionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SignInConditions[]
     */
    private array $value = [];
     ...
     * 
     * @param SignInConditions[] $items
     * @return self
     */
    public function setValue(array|SignInConditions $items, SignInConditions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SignInConditions> $value
     * @return self
     ...
     * 
     * @param SignInConditions $item
     * @return self
     */
    public function addValue(SignInConditions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SignInConditions>
     */
