...
/**
 * Collection response for IntegerRangeCollectionResponse
 */
class IntegerRangeCollectionResponseCollectionResponse
{
    /**
     * @var IntegerRangeCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IntegerRangeCollectionResponse ...$items Variable number of IntegerRangeCollectionResponse items
     * @return self
     */
    public function setValue(IntegerRangeCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IntegerRangeCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IntegerRangeCollectionResponse $item
     * @return self
     */
    public function addValue(IntegerRangeCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
