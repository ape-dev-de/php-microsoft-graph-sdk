 ...
 */
class ChannelUnsetAsFavoriteByDefaultEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param ChannelUnsetAsFavoriteByDefaultEventMessageDetail ...$items Variable number of ChannelUnsetAsFavoriteByDefaultEventMessageDetail items
     * @return self
     */
    public function setValue(ChannelUnsetAsFavoriteByDefaultEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
