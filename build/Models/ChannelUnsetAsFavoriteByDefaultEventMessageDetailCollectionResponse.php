...
/**
 * ChannelUnsetAsFavoriteByDefaultEventMessageDetailCollectionResponse - Collection response
 */
class ChannelUnsetAsFavoriteByDefaultEventMessageDetailCollectionResponse
{
    /**
     * @var array<int, ChannelUnsetAsFavoriteByDefaultEventMessageDetail>
     */
    public array $value = [];
