...
/**
 * Collection response for ChannelUnsetAsFavoriteByDefaultEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChannelUnsetAsFavoriteByDefaultEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChannelUnsetAsFavoriteByDefaultEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param ChannelUnsetAsFavoriteByDefaultEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|ChannelUnsetAsFavoriteByDefaultEventMessageDetail $items, ChannelUnsetAsFavoriteByDefaultEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChannelUnsetAsFavoriteByDefaultEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param ChannelUnsetAsFavoriteByDefaultEventMessageDetail $item
     * @return self
     */
    public function addValue(ChannelUnsetAsFavoriteByDefaultEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ChannelUnsetAsFavoriteByDefaultEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ChannelUnsetAsFavoriteByDefaultEventMessageDetail>
     */
