...
/**
 * Collection response for ProvisioningStep
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProvisioningStepCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ProvisioningStep[] $items
     * @return self
     */
    public function setValue(array|ProvisioningStep $items, ProvisioningStep ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProvisioningStep> $value
     * @return self
     ...
     * 
     * @param ProvisioningStep $item
     * @return self
     */
    public function addValue(ProvisioningStep $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProvisioningStep>
     */
