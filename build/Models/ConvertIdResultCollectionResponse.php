...
/**
 * Collection response for ConvertIdResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConvertIdResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConvertIdResult[]
     */
     ...
     * 
     * @param ConvertIdResult[] $items
     * @return self
     */
    public function setValue(array|ConvertIdResult $items, ConvertIdResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConvertIdResult> $value
     * @return self
     ...
     * 
     * @param ConvertIdResult $item
     * @return self
     */
    public function addValue(ConvertIdResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConvertIdResult>
     */
