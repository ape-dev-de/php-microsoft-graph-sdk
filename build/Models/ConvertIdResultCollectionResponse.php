 ...
 */
class ConvertIdResultCollectionResponse
{
    /**
     * @var ConvertIdResult[]
     */
     ...
     * 
     * @param ConvertIdResult ...$items Variable number of ConvertIdResult items
     * @return self
     */
    public function setValue(ConvertIdResult ...$items): self
    {
        $this->value = $items;
        return $this;
    }
