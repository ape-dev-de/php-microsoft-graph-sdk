...
/**
 * Collection response for UserSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserSettings[]
     */
     ...
     * 
     * @param UserSettings[] $items
     * @return self
     */
    public function setValue(array|UserSettings $items, UserSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserSettings> $value
     * @return self
     ...
     * @return self
     */
    public function addValue(UserSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserSettings>
     */
