...
/**
 * Collection response for ColumnLink
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ColumnLinkCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ColumnLink[]
     */
     ...
     * 
     * @param ColumnLink[] $items
     * @return self
     */
    public function setValue(array|ColumnLink $items, ColumnLink ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param ColumnLink $item
     * @return self
     */
    public function addValue(ColumnLink $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ColumnLink>
     */
