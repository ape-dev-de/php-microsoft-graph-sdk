...
/**
 * Collection response for AlertDetection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AlertDetectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AlertDetection[]
     */
     ...
     * 
     * @param AlertDetection[] $items
     * @return self
     */
    public function setValue(array|AlertDetection $items, AlertDetection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AlertDetection> $value
     * @return self
     ...
     * 
     * @param AlertDetection $item
     * @return self
     */
    public function addValue(AlertDetection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AlertDetection>
     */
