...
/**
 * UserProtectionScopeContainerCollectionResponse - Collection response
 */
class UserProtectionScopeContainerCollectionResponse
{
    /**
     * @var array<int, UserProtectionScopeContainer>
     */
    public array $value = [];
