...
/**
 * Collection response for UserProtectionScopeContainer
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserProtectionScopeContainerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserProtectionScopeContainer[]
     */
    private array $value = [];
     ...
     * 
     * @param UserProtectionScopeContainer[] $items
     * @return self
     */
    public function setValue(array|UserProtectionScopeContainer $items, UserProtectionScopeContainer ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserProtectionScopeContainer> $value
     * @return self
     ...
     * 
     * @param UserProtectionScopeContainer $item
     * @return self
     */
    public function addValue(UserProtectionScopeContainer $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserProtectionScopeContainer>
     */
