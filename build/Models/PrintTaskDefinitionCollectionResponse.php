...
/**
 * Collection response for PrintTaskDefinition
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintTaskDefinitionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PrintTaskDefinition[] $items
     * @return self
     */
    public function setValue(array|PrintTaskDefinition $items, PrintTaskDefinition ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintTaskDefinition> $value
     * @return self
     ...
     * 
     * @param PrintTaskDefinition $item
     * @return self
     */
    public function addValue(PrintTaskDefinition $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintTaskDefinition>
     */
