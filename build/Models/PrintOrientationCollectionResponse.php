...
/**
 * Collection response for PrintOrientation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintOrientationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PrintOrientation[] $items
     * @return self
     */
    public function setValue(array|PrintOrientation $items, PrintOrientation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintOrientation> $value
     * @return self
     ...
     * 
     * @param PrintOrientation $item
     * @return self
     */
    public function addValue(PrintOrientation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintOrientation>
     */
