...
/**
 * Collection response for HomeRealmDiscoveryPolicyCollectionResponse
 */
class HomeRealmDiscoveryPolicyCollectionResponseCollectionResponse
{
    /**
     * @var HomeRealmDiscoveryPolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param HomeRealmDiscoveryPolicyCollectionResponse ...$items Variable number of HomeRealmDiscoveryPolicyCollectionResponse items
     * @return self
     */
    public function setValue(HomeRealmDiscoveryPolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<HomeRealmDiscoveryPolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param HomeRealmDiscoveryPolicyCollectionResponse $item
     * @return self
     */
    public function addValue(HomeRealmDiscoveryPolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
