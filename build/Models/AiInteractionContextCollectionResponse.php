...
/**
 * Collection response for AiInteractionContext
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AiInteractionContextCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AiInteractionContext[] $items
     * @return self
     */
    public function setValue(array|AiInteractionContext $items, AiInteractionContext ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AiInteractionContext> $value
     * @return self
     ...
     * 
     * @param AiInteractionContext $item
     * @return self
     */
    public function addValue(AiInteractionContext $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AiInteractionContext|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AiInteractionContext>
     */
