...
/**
 * Collection response for SynchronizationMetadata
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationMetadataCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SynchronizationMetadata[]
     */
    private array $value = [];
     ...
     * 
     * @param SynchronizationMetadata[] $items
     * @return self
     */
    public function setValue(array|SynchronizationMetadata $items, SynchronizationMetadata ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SynchronizationMetadata> $value
     * @return self
     ...
     * 
     * @param SynchronizationMetadata $item
     * @return self
     */
    public function addValue(SynchronizationMetadata $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SynchronizationMetadata>
     */
