...
/**
 * Collection response for ChannelMembersNotificationRecipient
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChannelMembersNotificationRecipientCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChannelMembersNotificationRecipient[]
     */
    private array $value = [];
     ...
     * 
     * @param ChannelMembersNotificationRecipient[] $items
     * @return self
     */
    public function setValue(array|ChannelMembersNotificationRecipient $items, ChannelMembersNotificationRecipient ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChannelMembersNotificationRecipient> $value
     * @return self
     ...
     * 
     * @param ChannelMembersNotificationRecipient $item
     * @return self
     */
    public function addValue(ChannelMembersNotificationRecipient $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ChannelMembersNotificationRecipient|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ChannelMembersNotificationRecipient>
     */
