 ...
 */
class ChannelMembersNotificationRecipientCollectionResponse
{
    /**
     ...
     * 
     * @param ChannelMembersNotificationRecipient ...$items Variable number of ChannelMembersNotificationRecipient items
     * @return self
     */
    public function setValue(ChannelMembersNotificationRecipient ...$items): self
    {
        $this->value = $items;
        return $this;
    }
