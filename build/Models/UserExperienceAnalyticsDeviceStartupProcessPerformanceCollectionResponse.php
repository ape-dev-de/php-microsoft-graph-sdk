...
/**
 * Collection response for UserExperienceAnalyticsDeviceStartupProcessPerformance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsDeviceStartupProcessPerformanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsDeviceStartupProcessPerformance[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsDeviceStartupProcessPerformance $items, UserExperienceAnalyticsDeviceStartupProcessPerformance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsDeviceStartupProcessPerformance> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsDeviceStartupProcessPerformance $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsDeviceStartupProcessPerformance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsDeviceStartupProcessPerformance>
     */
