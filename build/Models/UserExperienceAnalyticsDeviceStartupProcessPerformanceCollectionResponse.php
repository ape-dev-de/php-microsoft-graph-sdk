...
/**
 * UserExperienceAnalyticsDeviceStartupProcessPerformanceCollectionResponse - Collection response
 */
class UserExperienceAnalyticsDeviceStartupProcessPerformanceCollectionResponse
{
    /**
     * @var array<int, UserExperienceAnalyticsDeviceStartupProcessPerformance>
     */
    public array $value = [];
