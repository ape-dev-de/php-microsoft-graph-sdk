 ...
 */
class CrossTenantUserSyncInboundCollectionResponse
{
    /**
     ...
     * 
     * @param CrossTenantUserSyncInbound ...$items Variable number of CrossTenantUserSyncInbound items
     * @return self
     */
    public function setValue(CrossTenantUserSyncInbound ...$items): self
    {
        $this->value = $items;
        return $this;
    }
