...
/**
 * Collection response for CrossTenantUserSyncInbound
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CrossTenantUserSyncInboundCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CrossTenantUserSyncInbound[]
     */
    private array $value = [];
     ...
     * 
     * @param CrossTenantUserSyncInbound[] $items
     * @return self
     */
    public function setValue(array|CrossTenantUserSyncInbound $items, CrossTenantUserSyncInbound ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CrossTenantUserSyncInbound> $value
     * @return self
     ...
     * 
     * @param CrossTenantUserSyncInbound $item
     * @return self
     */
    public function addValue(CrossTenantUserSyncInbound $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CrossTenantUserSyncInbound>
     */
