 ...
 */
class IdentityGovernanceMembershipChangeTriggerCollectionResponse
{
    /**
     ...
     * 
     * @param IdentityGovernanceMembershipChangeTrigger ...$items Variable number of IdentityGovernanceMembershipChangeTrigger items
     * @return self
     */
    public function setValue(IdentityGovernanceMembershipChangeTrigger ...$items): self
    {
        $this->value = $items;
        return $this;
    }
