...
/**
 * Collection response for IdentityGovernanceMembershipChangeTrigger
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceMembershipChangeTriggerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceMembershipChangeTrigger[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceMembershipChangeTrigger[]
     */
     ...
     * 
     * @param IdentityGovernanceMembershipChangeTrigger[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceMembershipChangeTrigger $items, IdentityGovernanceMembershipChangeTrigger ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceMembershipChangeTrigger> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceMembershipChangeTrigger $item
     * @return self
     */
    public function addValue(IdentityGovernanceMembershipChangeTrigger $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceMembershipChangeTrigger|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceMembershipChangeTrigger>
     */
