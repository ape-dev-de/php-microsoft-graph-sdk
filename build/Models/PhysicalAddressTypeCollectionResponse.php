...
/**
 * Collection response for PhysicalAddressType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PhysicalAddressTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PhysicalAddressType[] $items
     * @return self
     */
    public function setValue(array|PhysicalAddressType $items, PhysicalAddressType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PhysicalAddressType> $value
     * @return self
     ...
     * 
     * @param PhysicalAddressType $item
     * @return self
     */
    public function addValue(PhysicalAddressType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PhysicalAddressType>
     */
