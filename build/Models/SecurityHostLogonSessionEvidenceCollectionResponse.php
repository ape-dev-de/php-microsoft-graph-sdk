...
/**
 * Collection response for SecurityHostLogonSessionEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHostLogonSessionEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityHostLogonSessionEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityHostLogonSessionEvidence[]
     */
     ...
     * 
     * @param SecurityHostLogonSessionEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityHostLogonSessionEvidence $items, SecurityHostLogonSessionEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHostLogonSessionEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityHostLogonSessionEvidence $item
     * @return self
     */
    public function addValue(SecurityHostLogonSessionEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityHostLogonSessionEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityHostLogonSessionEvidence>
     */
