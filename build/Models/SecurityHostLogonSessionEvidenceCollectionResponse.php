 ...
 */
class SecurityHostLogonSessionEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityHostLogonSessionEvidence ...$items Variable number of SecurityHostLogonSessionEvidence items
     * @return self
     */
    public function setValue(SecurityHostLogonSessionEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
