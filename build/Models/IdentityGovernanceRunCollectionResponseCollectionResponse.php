...
/**
 * Collection response for IdentityGovernanceRunCollectionResponse
 */
class IdentityGovernanceRunCollectionResponseCollectionResponse
{
    /**
     * @var IdentityGovernanceRunCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityGovernanceRunCollectionResponse ...$items Variable number of IdentityGovernanceRunCollectionResponse items
     * @return self
     */
    public function setValue(IdentityGovernanceRunCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IdentityGovernanceRunCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceRunCollectionResponse $item
     * @return self
     */
    public function addValue(IdentityGovernanceRunCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
