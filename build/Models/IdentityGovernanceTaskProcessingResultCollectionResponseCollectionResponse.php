...
/**
 * Collection response for IdentityGovernanceTaskProcessingResultCollectionResponse
 */
class IdentityGovernanceTaskProcessingResultCollectionResponseCollectionResponse
{
    /**
     * @var IdentityGovernanceTaskProcessingResultCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityGovernanceTaskProcessingResultCollectionResponse ...$items Variable number of IdentityGovernanceTaskProcessingResultCollectionResponse items
     * @return self
     */
    public function setValue(IdentityGovernanceTaskProcessingResultCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IdentityGovernanceTaskProcessingResultCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceTaskProcessingResultCollectionResponse $item
     * @return self
     */
    public function addValue(IdentityGovernanceTaskProcessingResultCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
