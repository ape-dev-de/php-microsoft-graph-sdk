...
/**
 * Collection response for IosNotificationAlertType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosNotificationAlertTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IosNotificationAlertType[]
     */
    private array $value = [];
     ...
     * 
     * @return IosNotificationAlertType[]
     */
     ...
     * 
     * @param IosNotificationAlertType[] $items
     * @return self
     */
    public function setValue(array|IosNotificationAlertType $items, IosNotificationAlertType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosNotificationAlertType> $value
     * @return self
     ...
     * 
     * @param IosNotificationAlertType $item
     * @return self
     */
    public function addValue(IosNotificationAlertType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IosNotificationAlertType>
     */
