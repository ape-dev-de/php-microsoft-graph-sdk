...
/**
 * Collection response for Initiator
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InitiatorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Initiator[]
     */
     ...
     * 
     * @param Initiator[] $items
     * @return self
     */
    public function setValue(array|Initiator $items, Initiator ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param Initiator $item
     * @return self
     */
    public function addValue(Initiator $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Initiator>
     */
