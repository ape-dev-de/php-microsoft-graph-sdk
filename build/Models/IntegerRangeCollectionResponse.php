...
/**
 * Collection response for IntegerRange
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IntegerRangeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IntegerRange[]
     */
     ...
     * 
     * @param IntegerRange[] $items
     * @return self
     */
    public function setValue(array|IntegerRange $items, IntegerRange ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IntegerRange> $value
     * @return self
     ...
     * 
     * @param IntegerRange $item
     * @return self
     */
    public function addValue(IntegerRange $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IntegerRange>
     */
