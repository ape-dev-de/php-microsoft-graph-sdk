...
/**
 * Collection response for CustomExtensionBehaviorOnError
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CustomExtensionBehaviorOnErrorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CustomExtensionBehaviorOnError[]
     */
    private array $value = [];
     ...
     * 
     * @param CustomExtensionBehaviorOnError[] $items
     * @return self
     */
    public function setValue(array|CustomExtensionBehaviorOnError $items, CustomExtensionBehaviorOnError ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CustomExtensionBehaviorOnError> $value
     * @return self
     ...
     * 
     * @param CustomExtensionBehaviorOnError $item
     * @return self
     */
    public function addValue(CustomExtensionBehaviorOnError $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CustomExtensionBehaviorOnError>
     */
