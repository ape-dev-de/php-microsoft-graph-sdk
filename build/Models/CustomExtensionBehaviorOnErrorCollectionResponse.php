...
/**
 * CustomExtensionBehaviorOnErrorCollectionResponse - Collection response
 */
class CustomExtensionBehaviorOnErrorCollectionResponse
{
    /**
     * @var array<int, CustomExtensionBehaviorOnError>
     */
    public array $value = [];
