...
/**
 * AuthenticationAttributeCollectionInputTypeCollectionResponse - Collection response
 */
class AuthenticationAttributeCollectionInputTypeCollectionResponse
{
    /**
     * @var array<int, AuthenticationAttributeCollectionInputType>
     */
    public array $value = [];
