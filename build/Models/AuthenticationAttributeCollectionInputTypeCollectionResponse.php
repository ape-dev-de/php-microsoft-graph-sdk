...
/**
 * Collection response for AuthenticationAttributeCollectionInputType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationAttributeCollectionInputTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuthenticationAttributeCollectionInputType[]
     */
    private array $value = [];
     ...
     * 
     * @return AuthenticationAttributeCollectionInputType[]
     */
     ...
     * 
     * @param AuthenticationAttributeCollectionInputType[] $items
     * @return self
     */
    public function setValue(array|AuthenticationAttributeCollectionInputType $items, AuthenticationAttributeCollectionInputType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationAttributeCollectionInputType> $value
     * @return self
     ...
     * 
     * @param AuthenticationAttributeCollectionInputType $item
     * @return self
     */
    public function addValue(AuthenticationAttributeCollectionInputType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationAttributeCollectionInputType>
     */
