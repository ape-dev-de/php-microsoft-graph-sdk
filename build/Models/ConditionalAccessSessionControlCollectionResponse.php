 ...
 */
class ConditionalAccessSessionControlCollectionResponse
{
    /**
     ...
     * 
     * @param ConditionalAccessSessionControl ...$items Variable number of ConditionalAccessSessionControl items
     * @return self
     */
    public function setValue(ConditionalAccessSessionControl ...$items): self
    {
        $this->value = $items;
        return $this;
    }
