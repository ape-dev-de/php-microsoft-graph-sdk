...
/**
 * Collection response for ConditionalAccessSessionControl
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessSessionControlCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessSessionControl[]
     */
    private array $value = [];
     ...
     * 
     * @param ConditionalAccessSessionControl[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessSessionControl $items, ConditionalAccessSessionControl ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessSessionControl> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessSessionControl $item
     * @return self
     */
    public function addValue(ConditionalAccessSessionControl $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ConditionalAccessSessionControl|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessSessionControl>
     */
