 ...
 */
class WorkbookChartGridlinesCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookChartGridlines ...$items Variable number of WorkbookChartGridlines items
     * @return self
     */
    public function setValue(WorkbookChartGridlines ...$items): self
    {
        $this->value = $items;
        return $this;
    }
