...
/**
 * Collection response for WorkbookChartGridlines
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookChartGridlinesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookChartGridlines[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookChartGridlines[] $items
     * @return self
     */
    public function setValue(array|WorkbookChartGridlines $items, WorkbookChartGridlines ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookChartGridlines> $value
     * @return self
     ...
     * 
     * @param WorkbookChartGridlines $item
     * @return self
     */
    public function addValue(WorkbookChartGridlines $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookChartGridlines>
     */
