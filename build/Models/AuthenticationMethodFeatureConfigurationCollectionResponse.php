 ...
 */
class AuthenticationMethodFeatureConfigurationCollectionResponse
{
    /**
     ...
     * 
     * @param AuthenticationMethodFeatureConfiguration ...$items Variable number of AuthenticationMethodFeatureConfiguration items
     * @return self
     */
    public function setValue(AuthenticationMethodFeatureConfiguration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
