...
/**
 * Collection response for AuthenticationMethodFeatureConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationMethodFeatureConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuthenticationMethodFeatureConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param AuthenticationMethodFeatureConfiguration[] $items
     * @return self
     */
    public function setValue(array|AuthenticationMethodFeatureConfiguration $items, AuthenticationMethodFeatureConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationMethodFeatureConfiguration> $value
     * @return self
     ...
     * 
     * @param AuthenticationMethodFeatureConfiguration $item
     * @return self
     */
    public function addValue(AuthenticationMethodFeatureConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationMethodFeatureConfiguration>
     */
