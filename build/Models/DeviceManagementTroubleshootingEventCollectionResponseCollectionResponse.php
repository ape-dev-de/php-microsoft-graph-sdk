...
/**
 * Collection response for DeviceManagementTroubleshootingEventCollectionResponse
 */
class DeviceManagementTroubleshootingEventCollectionResponseCollectionResponse
{
    /**
     * @var DeviceManagementTroubleshootingEventCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceManagementTroubleshootingEventCollectionResponse ...$items Variable number of DeviceManagementTroubleshootingEventCollectionResponse items
     * @return self
     */
    public function setValue(DeviceManagementTroubleshootingEventCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeviceManagementTroubleshootingEventCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeviceManagementTroubleshootingEventCollectionResponse $item
     * @return self
     */
    public function addValue(DeviceManagementTroubleshootingEventCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
