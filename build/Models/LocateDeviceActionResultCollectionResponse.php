...
/**
 * Collection response for LocateDeviceActionResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LocateDeviceActionResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var LocateDeviceActionResult[]
     */
    private array $value = [];
     ...
     * 
     * @param LocateDeviceActionResult[] $items
     * @return self
     */
    public function setValue(array|LocateDeviceActionResult $items, LocateDeviceActionResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LocateDeviceActionResult> $value
     * @return self
     ...
     * 
     * @param LocateDeviceActionResult $item
     * @return self
     */
    public function addValue(LocateDeviceActionResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return LocateDeviceActionResult|null
     */
     ...
     * 
     * @return \ArrayIterator<int, LocateDeviceActionResult>
     */
