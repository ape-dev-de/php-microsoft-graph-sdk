 ...
 */
class LocateDeviceActionResultCollectionResponse
{
    /**
     ...
     * 
     * @param LocateDeviceActionResult ...$items Variable number of LocateDeviceActionResult items
     * @return self
     */
    public function setValue(LocateDeviceActionResult ...$items): self
    {
        $this->value = $items;
        return $this;
    }
