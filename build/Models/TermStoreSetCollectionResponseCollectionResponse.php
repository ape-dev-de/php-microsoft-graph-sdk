...
/**
 * Collection response for TermStoreSetCollectionResponse
 */
class TermStoreSetCollectionResponseCollectionResponse
{
    /**
     * @var TermStoreSetCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TermStoreSetCollectionResponse ...$items Variable number of TermStoreSetCollectionResponse items
     * @return self
     */
    public function setValue(TermStoreSetCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TermStoreSetCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TermStoreSetCollectionResponse $item
     * @return self
     */
    public function addValue(TermStoreSetCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
