...
/**
 * SharedPCAccountDeletionPolicyTypeCollectionResponse - Collection response
 */
class SharedPCAccountDeletionPolicyTypeCollectionResponse
{
    /**
     * @var array<int, SharedPCAccountDeletionPolicyType>
     */
    public array $value = [];
