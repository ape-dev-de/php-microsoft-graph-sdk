...
/**
 * Collection response for SharedPCAccountDeletionPolicyType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SharedPCAccountDeletionPolicyTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SharedPCAccountDeletionPolicyType[]
     */
    private array $value = [];
     ...
     * 
     * @return SharedPCAccountDeletionPolicyType[]
     */
     ...
     * 
     * @param SharedPCAccountDeletionPolicyType[] $items
     * @return self
     */
    public function setValue(array|SharedPCAccountDeletionPolicyType $items, SharedPCAccountDeletionPolicyType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SharedPCAccountDeletionPolicyType> $value
     * @return self
     ...
     * 
     * @param SharedPCAccountDeletionPolicyType $item
     * @return self
     */
    public function addValue(SharedPCAccountDeletionPolicyType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SharedPCAccountDeletionPolicyType>
     */
