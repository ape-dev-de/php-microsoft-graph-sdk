 ...
 */
class ChatMessageInfoCollectionResponse
{
    /**
     * @var ChatMessageInfo[]
     */
     ...
     * 
     * @param ChatMessageInfo ...$items Variable number of ChatMessageInfo items
     * @return self
     */
    public function setValue(ChatMessageInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
