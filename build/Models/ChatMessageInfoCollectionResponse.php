...
/**
 * Collection response for ChatMessageInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatMessageInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChatMessageInfo[]
     */
     ...
     * 
     * @param ChatMessageInfo[] $items
     * @return self
     */
    public function setValue(array|ChatMessageInfo $items, ChatMessageInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChatMessageInfo> $value
     * @return self
     ...
     * 
     * @param ChatMessageInfo $item
     * @return self
     */
    public function addValue(ChatMessageInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChatMessageInfo>
     */
