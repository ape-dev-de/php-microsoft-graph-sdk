...
/**
 * Collection response for WorkbookRange
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookRangeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookRange[]
     */
     ...
     * 
     * @param WorkbookRange[] $items
     * @return self
     */
    public function setValue(array|WorkbookRange $items, WorkbookRange ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookRange> $value
     * @return self
     ...
     * 
     * @param WorkbookRange $item
     * @return self
     */
    public function addValue(WorkbookRange $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookRange>
     */
