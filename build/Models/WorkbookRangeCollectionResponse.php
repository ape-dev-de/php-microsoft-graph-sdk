 ...
 */
class WorkbookRangeCollectionResponse
{
    /**
     * @var WorkbookRange[]
     */
     ...
     * 
     * @param WorkbookRange ...$items Variable number of WorkbookRange items
     * @return self
     */
    public function setValue(WorkbookRange ...$items): self
    {
        $this->value = $items;
        return $this;
    }
