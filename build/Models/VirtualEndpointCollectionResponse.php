...
/**
 * Collection response for VirtualEndpoint
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualEndpointCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VirtualEndpoint[]
     */
     ...
     * 
     * @param VirtualEndpoint[] $items
     * @return self
     */
    public function setValue(array|VirtualEndpoint $items, VirtualEndpoint ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualEndpoint> $value
     * @return self
     ...
     * 
     * @param VirtualEndpoint $item
     * @return self
     */
    public function addValue(VirtualEndpoint $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VirtualEndpoint>
     */
