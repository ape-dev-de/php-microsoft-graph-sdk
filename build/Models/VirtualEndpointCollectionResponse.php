 ...
 */
class VirtualEndpointCollectionResponse
{
    /**
     * @var VirtualEndpoint[]
     */
     ...
     * 
     * @param VirtualEndpoint ...$items Variable number of VirtualEndpoint items
     * @return self
     */
    public function setValue(VirtualEndpoint ...$items): self
    {
        $this->value = $items;
        return $this;
    }
