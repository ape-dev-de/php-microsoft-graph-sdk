...
/**
 * Collection response for AuditPropertyCollectionResponse
 */
class AuditPropertyCollectionResponseCollectionResponse
{
    /**
     * @var AuditPropertyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AuditPropertyCollectionResponse ...$items Variable number of AuditPropertyCollectionResponse items
     * @return self
     */
    public function setValue(AuditPropertyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AuditPropertyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AuditPropertyCollectionResponse $item
     * @return self
     */
    public function addValue(AuditPropertyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
