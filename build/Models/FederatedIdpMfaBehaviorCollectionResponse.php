...
/**
 * Collection response for FederatedIdpMfaBehavior
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FederatedIdpMfaBehaviorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FederatedIdpMfaBehavior[]
     */
    private array $value = [];
     ...
     * 
     * @return FederatedIdpMfaBehavior[]
     */
     ...
     * 
     * @param FederatedIdpMfaBehavior[] $items
     * @return self
     */
    public function setValue(array|FederatedIdpMfaBehavior $items, FederatedIdpMfaBehavior ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FederatedIdpMfaBehavior> $value
     * @return self
     ...
     * 
     * @param FederatedIdpMfaBehavior $item
     * @return self
     */
    public function addValue(FederatedIdpMfaBehavior $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FederatedIdpMfaBehavior>
     */
