...
/**
 * Collection response for WorkingTimeSchedule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkingTimeScheduleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkingTimeSchedule[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkingTimeSchedule[] $items
     * @return self
     */
    public function setValue(array|WorkingTimeSchedule $items, WorkingTimeSchedule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkingTimeSchedule> $value
     * @return self
     ...
     * 
     * @param WorkingTimeSchedule $item
     * @return self
     */
    public function addValue(WorkingTimeSchedule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkingTimeSchedule>
     */
