...
/**
 * Collection response for PlannerAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PlannerAssignment[] $items
     * @return self
     */
    public function setValue(array|PlannerAssignment $items, PlannerAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PlannerAssignment> $value
     * @return self
     ...
     * 
     * @param PlannerAssignment $item
     * @return self
     */
    public function addValue(PlannerAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PlannerAssignment>
     */
