 ...
 */
class PlannerAssignmentCollectionResponse
{
    /**
     ...
     * 
     * @param PlannerAssignment ...$items Variable number of PlannerAssignment items
     * @return self
     */
    public function setValue(PlannerAssignment ...$items): self
    {
        $this->value = $items;
        return $this;
    }
