...
/**
 * Collection response for DefaultColumnValue
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DefaultColumnValueCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DefaultColumnValue[] $items
     * @return self
     */
    public function setValue(array|DefaultColumnValue $items, DefaultColumnValue ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DefaultColumnValue> $value
     * @return self
     ...
     * 
     * @param DefaultColumnValue $item
     * @return self
     */
    public function addValue(DefaultColumnValue $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DefaultColumnValue>
     */
