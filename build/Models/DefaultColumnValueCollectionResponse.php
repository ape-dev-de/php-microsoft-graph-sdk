 ...
 */
class DefaultColumnValueCollectionResponse
{
    /**
     ...
     * 
     * @param DefaultColumnValue ...$items Variable number of DefaultColumnValue items
     * @return self
     */
    public function setValue(DefaultColumnValue ...$items): self
    {
        $this->value = $items;
        return $this;
    }
