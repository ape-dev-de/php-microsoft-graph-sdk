 ...
 */
class SocialIdentitySourceCollectionResponse
{
    /**
     ...
     * 
     * @param SocialIdentitySource ...$items Variable number of SocialIdentitySource items
     * @return self
     */
    public function setValue(SocialIdentitySource ...$items): self
    {
        $this->value = $items;
        return $this;
    }
