...
/**
 * Collection response for SocialIdentitySource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SocialIdentitySourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SocialIdentitySource[]
     */
    private array $value = [];
     ...
     * 
     * @param SocialIdentitySource[] $items
     * @return self
     */
    public function setValue(array|SocialIdentitySource $items, SocialIdentitySource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SocialIdentitySource> $value
     * @return self
     ...
     * 
     * @param SocialIdentitySource $item
     * @return self
     */
    public function addValue(SocialIdentitySource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SocialIdentitySource|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SocialIdentitySource>
     */
