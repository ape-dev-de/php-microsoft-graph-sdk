...
/**
 * Collection response for OnlineMeetingRestricted
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnlineMeetingRestrictedCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnlineMeetingRestricted[]
     */
    private array $value = [];
     ...
     * 
     * @param OnlineMeetingRestricted[] $items
     * @return self
     */
    public function setValue(array|OnlineMeetingRestricted $items, OnlineMeetingRestricted ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnlineMeetingRestricted> $value
     * @return self
     ...
     * 
     * @param OnlineMeetingRestricted $item
     * @return self
     */
    public function addValue(OnlineMeetingRestricted $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnlineMeetingRestricted>
     */
