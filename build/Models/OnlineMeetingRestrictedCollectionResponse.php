 ...
 */
class OnlineMeetingRestrictedCollectionResponse
{
    /**
     ...
     * 
     * @param OnlineMeetingRestricted ...$items Variable number of OnlineMeetingRestricted items
     * @return self
     */
    public function setValue(OnlineMeetingRestricted ...$items): self
    {
        $this->value = $items;
        return $this;
    }
