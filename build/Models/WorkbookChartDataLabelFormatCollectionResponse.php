...
/**
 * Collection response for WorkbookChartDataLabelFormat
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookChartDataLabelFormatCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookChartDataLabelFormat[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookChartDataLabelFormat[] $items
     * @return self
     */
    public function setValue(array|WorkbookChartDataLabelFormat $items, WorkbookChartDataLabelFormat ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookChartDataLabelFormat> $value
     * @return self
     ...
     * 
     * @param WorkbookChartDataLabelFormat $item
     * @return self
     */
    public function addValue(WorkbookChartDataLabelFormat $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookChartDataLabelFormat>
     */
