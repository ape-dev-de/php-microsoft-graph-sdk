 ...
 */
class WorkbookChartDataLabelFormatCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookChartDataLabelFormat ...$items Variable number of WorkbookChartDataLabelFormat items
     * @return self
     */
    public function setValue(WorkbookChartDataLabelFormat ...$items): self
    {
        $this->value = $items;
        return $this;
    }
