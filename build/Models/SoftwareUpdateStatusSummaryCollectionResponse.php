 ...
 */
class SoftwareUpdateStatusSummaryCollectionResponse
{
    /**
     ...
     * 
     * @param SoftwareUpdateStatusSummary ...$items Variable number of SoftwareUpdateStatusSummary items
     * @return self
     */
    public function setValue(SoftwareUpdateStatusSummary ...$items): self
    {
        $this->value = $items;
        return $this;
    }
