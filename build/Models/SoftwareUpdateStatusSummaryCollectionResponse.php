...
/**
 * Collection response for SoftwareUpdateStatusSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SoftwareUpdateStatusSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SoftwareUpdateStatusSummary[]
     */
    private array $value = [];
     ...
     * 
     * @param SoftwareUpdateStatusSummary[] $items
     * @return self
     */
    public function setValue(array|SoftwareUpdateStatusSummary $items, SoftwareUpdateStatusSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SoftwareUpdateStatusSummary> $value
     * @return self
     ...
     * 
     * @param SoftwareUpdateStatusSummary $item
     * @return self
     */
    public function addValue(SoftwareUpdateStatusSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SoftwareUpdateStatusSummary>
     */
