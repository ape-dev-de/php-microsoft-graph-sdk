...
/**
 * Collection response for SharingLink
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SharingLinkCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SharingLink[]
     */
     ...
     * 
     * @param SharingLink[] $items
     * @return self
     */
    public function setValue(array|SharingLink $items, SharingLink ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param SharingLink $item
     * @return self
     */
    public function addValue(SharingLink $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SharingLink>
     */
