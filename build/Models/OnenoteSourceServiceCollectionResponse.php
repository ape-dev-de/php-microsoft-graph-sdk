...
/**
 * Collection response for OnenoteSourceService
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnenoteSourceServiceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnenoteSourceService[]
     */
    private array $value = [];
     ...
     * 
     * @param OnenoteSourceService[] $items
     * @return self
     */
    public function setValue(array|OnenoteSourceService $items, OnenoteSourceService ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnenoteSourceService> $value
     * @return self
     ...
     * 
     * @param OnenoteSourceService $item
     * @return self
     */
    public function addValue(OnenoteSourceService $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnenoteSourceService>
     */
