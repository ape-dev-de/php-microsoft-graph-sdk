 ...
 */
class PlannerTaskDetailsCollectionResponse
{
    /**
     ...
     * 
     * @param PlannerTaskDetails ...$items Variable number of PlannerTaskDetails items
     * @return self
     */
    public function setValue(PlannerTaskDetails ...$items): self
    {
        $this->value = $items;
        return $this;
    }
