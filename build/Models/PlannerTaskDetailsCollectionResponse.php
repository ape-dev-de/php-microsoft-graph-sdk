...
/**
 * Collection response for PlannerTaskDetails
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerTaskDetailsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PlannerTaskDetails[]
     */
    private array $value = [];
     ...
     * 
     * @param PlannerTaskDetails[] $items
     * @return self
     */
    public function setValue(array|PlannerTaskDetails $items, PlannerTaskDetails ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PlannerTaskDetails> $value
     * @return self
     ...
     * 
     * @param PlannerTaskDetails $item
     * @return self
     */
    public function addValue(PlannerTaskDetails $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PlannerTaskDetails>
     */
