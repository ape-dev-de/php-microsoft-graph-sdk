...
/**
 * Collection response for UserExperienceAnalyticsWorkFromAnywhereMetric
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsWorkFromAnywhereMetricCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsWorkFromAnywhereMetric[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsWorkFromAnywhereMetric $items, UserExperienceAnalyticsWorkFromAnywhereMetric ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsWorkFromAnywhereMetric> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsWorkFromAnywhereMetric $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsWorkFromAnywhereMetric $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsWorkFromAnywhereMetric>
     */
