...
/**
 * Collection response for ChatInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChatInfo[]
     */
     ...
     * 
     * @param ChatInfo[] $items
     * @return self
     */
    public function setValue(array|ChatInfo $items, ChatInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(ChatInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChatInfo>
     */
