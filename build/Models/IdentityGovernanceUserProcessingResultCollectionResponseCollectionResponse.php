...
/**
 * Collection response for IdentityGovernanceUserProcessingResultCollectionResponse
 */
class IdentityGovernanceUserProcessingResultCollectionResponseCollectionResponse
{
    /**
     * @var IdentityGovernanceUserProcessingResultCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityGovernanceUserProcessingResultCollectionResponse ...$items Variable number of IdentityGovernanceUserProcessingResultCollectionResponse items
     * @return self
     */
    public function setValue(IdentityGovernanceUserProcessingResultCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IdentityGovernanceUserProcessingResultCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceUserProcessingResultCollectionResponse $item
     * @return self
     */
    public function addValue(IdentityGovernanceUserProcessingResultCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
