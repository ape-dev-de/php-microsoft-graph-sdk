...
/**
 * Collection response for PrinterShareCollectionResponse
 */
class PrinterShareCollectionResponseCollectionResponse
{
    /**
     * @var PrinterShareCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PrinterShareCollectionResponse ...$items Variable number of PrinterShareCollectionResponse items
     * @return self
     */
    public function setValue(PrinterShareCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PrinterShareCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PrinterShareCollectionResponse $item
     * @return self
     */
    public function addValue(PrinterShareCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
