...
/**
 * Collection response for UserStorage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserStorageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserStorage[]
     */
     ...
     * 
     * @param UserStorage[] $items
     * @return self
     */
    public function setValue(array|UserStorage $items, UserStorage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param UserStorage $item
     * @return self
     */
    public function addValue(UserStorage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserStorage>
     */
