...
/**
 * Collection response for ExchangeProtectionPolicyCollectionResponse
 */
class ExchangeProtectionPolicyCollectionResponseCollectionResponse
{
    /**
     * @var ExchangeProtectionPolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ExchangeProtectionPolicyCollectionResponse ...$items Variable number of ExchangeProtectionPolicyCollectionResponse items
     * @return self
     */
    public function setValue(ExchangeProtectionPolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ExchangeProtectionPolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ExchangeProtectionPolicyCollectionResponse $item
     * @return self
     */
    public function addValue(ExchangeProtectionPolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
