...
/**
 * Collection response for BookingsAvailabilityStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingsAvailabilityStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BookingsAvailabilityStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return BookingsAvailabilityStatus[]
     */
     ...
     * 
     * @param BookingsAvailabilityStatus[] $items
     * @return self
     */
    public function setValue(array|BookingsAvailabilityStatus $items, BookingsAvailabilityStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingsAvailabilityStatus> $value
     * @return self
     ...
     * 
     * @param BookingsAvailabilityStatus $item
     * @return self
     */
    public function addValue(BookingsAvailabilityStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BookingsAvailabilityStatus>
     */
