...
/**
 * BookingsAvailabilityStatusCollectionResponse - Collection response
 */
class BookingsAvailabilityStatusCollectionResponse
{
    /**
     * @var array<int, BookingsAvailabilityStatus>
     */
    public array $value = [];
