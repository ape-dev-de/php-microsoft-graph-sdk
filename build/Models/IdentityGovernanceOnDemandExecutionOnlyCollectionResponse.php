...
/**
 * Collection response for IdentityGovernanceOnDemandExecutionOnly
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceOnDemandExecutionOnlyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceOnDemandExecutionOnly[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceOnDemandExecutionOnly[]
     */
     ...
     * 
     * @param IdentityGovernanceOnDemandExecutionOnly[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceOnDemandExecutionOnly $items, IdentityGovernanceOnDemandExecutionOnly ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceOnDemandExecutionOnly> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceOnDemandExecutionOnly $item
     * @return self
     */
    public function addValue(IdentityGovernanceOnDemandExecutionOnly $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceOnDemandExecutionOnly|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceOnDemandExecutionOnly>
     */
