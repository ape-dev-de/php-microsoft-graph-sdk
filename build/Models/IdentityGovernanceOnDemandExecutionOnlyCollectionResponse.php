...
/**
 * IdentityGovernanceOnDemandExecutionOnlyCollectionResponse - Collection response
 */
class IdentityGovernanceOnDemandExecutionOnlyCollectionResponse
{
    /**
     * @var array<int, IdentityGovernanceOnDemandExecutionOnly>
     */
    public array $value = [];
