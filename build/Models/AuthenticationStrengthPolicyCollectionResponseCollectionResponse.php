...
/**
 * Collection response for AuthenticationStrengthPolicyCollectionResponse
 */
class AuthenticationStrengthPolicyCollectionResponseCollectionResponse
{
    /**
     * @var AuthenticationStrengthPolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AuthenticationStrengthPolicyCollectionResponse ...$items Variable number of AuthenticationStrengthPolicyCollectionResponse items
     * @return self
     */
    public function setValue(AuthenticationStrengthPolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AuthenticationStrengthPolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AuthenticationStrengthPolicyCollectionResponse $item
     * @return self
     */
    public function addValue(AuthenticationStrengthPolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
