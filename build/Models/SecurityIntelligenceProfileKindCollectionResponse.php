...
/**
 * SecurityIntelligenceProfileKindCollectionResponse - Collection response
 */
class SecurityIntelligenceProfileKindCollectionResponse
{
    /**
     * @var array<int, SecurityIntelligenceProfileKind>
     */
    public array $value = [];
