...
/**
 * Collection response for SecurityIntelligenceProfileKind
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityIntelligenceProfileKindCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityIntelligenceProfileKind[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityIntelligenceProfileKind[]
     */
     ...
     * 
     * @param SecurityIntelligenceProfileKind[] $items
     * @return self
     */
    public function setValue(array|SecurityIntelligenceProfileKind $items, SecurityIntelligenceProfileKind ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityIntelligenceProfileKind> $value
     * @return self
     ...
     * 
     * @param SecurityIntelligenceProfileKind $item
     * @return self
     */
    public function addValue(SecurityIntelligenceProfileKind $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityIntelligenceProfileKind|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityIntelligenceProfileKind>
     */
