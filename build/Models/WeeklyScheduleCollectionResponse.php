...
/**
 * Collection response for WeeklySchedule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WeeklyScheduleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WeeklySchedule[]
     */
     ...
     * 
     * @param WeeklySchedule[] $items
     * @return self
     */
    public function setValue(array|WeeklySchedule $items, WeeklySchedule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WeeklySchedule> $value
     * @return self
     ...
     * 
     * @param WeeklySchedule $item
     * @return self
     */
    public function addValue(WeeklySchedule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WeeklySchedule>
     */
