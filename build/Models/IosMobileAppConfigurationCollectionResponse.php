...
/**
 * Collection response for IosMobileAppConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosMobileAppConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IosMobileAppConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param IosMobileAppConfiguration[] $items
     * @return self
     */
    public function setValue(array|IosMobileAppConfiguration $items, IosMobileAppConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosMobileAppConfiguration> $value
     * @return self
     ...
     * 
     * @param IosMobileAppConfiguration $item
     * @return self
     */
    public function addValue(IosMobileAppConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IosMobileAppConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IosMobileAppConfiguration>
     */
