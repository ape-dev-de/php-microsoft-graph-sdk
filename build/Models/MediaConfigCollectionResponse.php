...
/**
 * Collection response for MediaConfig
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MediaConfigCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MediaConfig[]
     */
     ...
     * 
     * @param MediaConfig[] $items
     * @return self
     */
    public function setValue(array|MediaConfig $items, MediaConfig ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param MediaConfig $item
     * @return self
     */
    public function addValue(MediaConfig $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MediaConfig>
     */
