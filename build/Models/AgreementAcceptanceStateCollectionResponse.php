...
/**
 * Collection response for AgreementAcceptanceState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AgreementAcceptanceStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return AgreementAcceptanceState[]
     */
     ...
     * 
     * @param AgreementAcceptanceState[] $items
     * @return self
     */
    public function setValue(array|AgreementAcceptanceState $items, AgreementAcceptanceState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AgreementAcceptanceState> $value
     * @return self
     ...
     * 
     * @param AgreementAcceptanceState $item
     * @return self
     */
    public function addValue(AgreementAcceptanceState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AgreementAcceptanceState>
     */
