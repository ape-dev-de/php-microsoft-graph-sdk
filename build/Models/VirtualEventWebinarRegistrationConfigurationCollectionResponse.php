 ...
 */
class VirtualEventWebinarRegistrationConfigurationCollectionResponse
{
    /**
     ...
     * 
     * @param VirtualEventWebinarRegistrationConfiguration ...$items Variable number of VirtualEventWebinarRegistrationConfiguration items
     * @return self
     */
    public function setValue(VirtualEventWebinarRegistrationConfiguration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
