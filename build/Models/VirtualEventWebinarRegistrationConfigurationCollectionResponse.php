...
/**
 * Collection response for VirtualEventWebinarRegistrationConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualEventWebinarRegistrationConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VirtualEventWebinarRegistrationConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param VirtualEventWebinarRegistrationConfiguration[] $items
     * @return self
     */
    public function setValue(array|VirtualEventWebinarRegistrationConfiguration $items, VirtualEventWebinarRegistrationConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualEventWebinarRegistrationConfiguration> $value
     * @return self
     ...
     * 
     * @param VirtualEventWebinarRegistrationConfiguration $item
     * @return self
     */
    public function addValue(VirtualEventWebinarRegistrationConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VirtualEventWebinarRegistrationConfiguration>
     */
