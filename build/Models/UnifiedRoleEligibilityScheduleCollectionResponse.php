...
/**
 * Collection response for UnifiedRoleEligibilitySchedule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRoleEligibilityScheduleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UnifiedRoleEligibilitySchedule[] $items
     * @return self
     */
    public function setValue(array|UnifiedRoleEligibilitySchedule $items, UnifiedRoleEligibilitySchedule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRoleEligibilitySchedule> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleEligibilitySchedule $item
     * @return self
     */
    public function addValue(UnifiedRoleEligibilitySchedule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRoleEligibilitySchedule>
     */
