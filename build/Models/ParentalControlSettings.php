...
class ParentalControlSettings
{
     ...
     */
    private ?string $countriesBlockedForMinors;
    ...
    public function getCountriesBlockedForMinors(): ?string
    {
        return $this->countriesBlockedForMinors;
    }

    public function setCountriesBlockedForMinors(?string $countriesBlockedForMinors): self
    {
