...
/**
 * Collection response for CloudPcOnPremisesConnectionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcOnPremisesConnectionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudPcOnPremisesConnectionType[]
     */
    private array $value = [];
     ...
     * 
     * @return CloudPcOnPremisesConnectionType[]
     */
     ...
     * 
     * @param CloudPcOnPremisesConnectionType[] $items
     * @return self
     */
    public function setValue(array|CloudPcOnPremisesConnectionType $items, CloudPcOnPremisesConnectionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcOnPremisesConnectionType> $value
     * @return self
     ...
     * 
     * @param CloudPcOnPremisesConnectionType $item
     * @return self
     */
    public function addValue(CloudPcOnPremisesConnectionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcOnPremisesConnectionType>
     */
