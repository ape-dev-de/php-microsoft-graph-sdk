...
/**
 * CloudPcOnPremisesConnectionTypeCollectionResponse - Collection response
 */
class CloudPcOnPremisesConnectionTypeCollectionResponse
{
    /**
     * @var array<int, CloudPcOnPremisesConnectionType>
     */
    public array $value = [];
