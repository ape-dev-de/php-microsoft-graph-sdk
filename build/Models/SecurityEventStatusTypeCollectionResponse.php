...
/**
 * Collection response for SecurityEventStatusType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityEventStatusTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityEventStatusType[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityEventStatusType[]
     */
     ...
     * 
     * @param SecurityEventStatusType[] $items
     * @return self
     */
    public function setValue(array|SecurityEventStatusType $items, SecurityEventStatusType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityEventStatusType> $value
     * @return self
     ...
     * 
     * @param SecurityEventStatusType $item
     * @return self
     */
    public function addValue(SecurityEventStatusType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityEventStatusType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityEventStatusType>
     */
