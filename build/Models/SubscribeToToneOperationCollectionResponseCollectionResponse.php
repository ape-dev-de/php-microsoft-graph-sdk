...
/**
 * Collection response for SubscribeToToneOperationCollectionResponse
 */
class SubscribeToToneOperationCollectionResponseCollectionResponse
{
    /**
     * @var SubscribeToToneOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SubscribeToToneOperationCollectionResponse ...$items Variable number of SubscribeToToneOperationCollectionResponse items
     * @return self
     */
    public function setValue(SubscribeToToneOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SubscribeToToneOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SubscribeToToneOperationCollectionResponse $item
     * @return self
     */
    public function addValue(SubscribeToToneOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
