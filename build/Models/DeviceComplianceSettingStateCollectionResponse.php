...
/**
 * Collection response for DeviceComplianceSettingState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceComplianceSettingStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceComplianceSettingState[] $items
     * @return self
     */
    public function setValue(array|DeviceComplianceSettingState $items, DeviceComplianceSettingState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceComplianceSettingState> $value
     * @return self
     ...
     * 
     * @param DeviceComplianceSettingState $item
     * @return self
     */
    public function addValue(DeviceComplianceSettingState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceComplianceSettingState>
     */
