...
/**
 * Collection response for UserFlowLanguageConfigurationCollectionResponse
 */
class UserFlowLanguageConfigurationCollectionResponseCollectionResponse
{
    /**
     * @var UserFlowLanguageConfigurationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UserFlowLanguageConfigurationCollectionResponse ...$items Variable number of UserFlowLanguageConfigurationCollectionResponse items
     * @return self
     */
    public function setValue(UserFlowLanguageConfigurationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UserFlowLanguageConfigurationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UserFlowLanguageConfigurationCollectionResponse $item
     * @return self
     */
    public function addValue(UserFlowLanguageConfigurationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
