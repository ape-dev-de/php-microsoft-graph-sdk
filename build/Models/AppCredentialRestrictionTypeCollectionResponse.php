...
/**
 * Collection response for AppCredentialRestrictionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppCredentialRestrictionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return AppCredentialRestrictionType[]
     */
     ...
     * 
     * @param AppCredentialRestrictionType[] $items
     * @return self
     */
    public function setValue(array|AppCredentialRestrictionType $items, AppCredentialRestrictionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppCredentialRestrictionType> $value
     * @return self
     ...
     * 
     * @param AppCredentialRestrictionType $item
     * @return self
     */
    public function addValue(AppCredentialRestrictionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AppCredentialRestrictionType>
     */
