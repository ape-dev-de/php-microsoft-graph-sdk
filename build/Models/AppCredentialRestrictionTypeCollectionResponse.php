...
/**
 * AppCredentialRestrictionTypeCollectionResponse - Collection response
 */
class AppCredentialRestrictionTypeCollectionResponse
{
    /**
     * @var array<int, AppCredentialRestrictionType>
     */
    public array $value = [];
