 ...
 */
class CallRecordsPstnCallLogRowCollectionResponse
{
    /**
     ...
     * 
     * @param CallRecordsPstnCallLogRow ...$items Variable number of CallRecordsPstnCallLogRow items
     * @return self
     */
    public function setValue(CallRecordsPstnCallLogRow ...$items): self
    {
        $this->value = $items;
        return $this;
    }
