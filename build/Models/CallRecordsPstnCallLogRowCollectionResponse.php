...
/**
 * Collection response for CallRecordsPstnCallLogRow
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsPstnCallLogRowCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsPstnCallLogRow[]
     */
    private array $value = [];
     ...
     * 
     * @return CallRecordsPstnCallLogRow[]
     */
     ...
     * 
     * @param CallRecordsPstnCallLogRow[] $items
     * @return self
     */
    public function setValue(array|CallRecordsPstnCallLogRow $items, CallRecordsPstnCallLogRow ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsPstnCallLogRow> $value
     * @return self
     ...
     * 
     * @param CallRecordsPstnCallLogRow $item
     * @return self
     */
    public function addValue(CallRecordsPstnCallLogRow $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsPstnCallLogRow|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsPstnCallLogRow>
     */
