...
/**
 * Collection response for ManagementAgentType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagementAgentTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ManagementAgentType[] $items
     * @return self
     */
    public function setValue(array|ManagementAgentType $items, ManagementAgentType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagementAgentType> $value
     * @return self
     ...
     * 
     * @param ManagementAgentType $item
     * @return self
     */
    public function addValue(ManagementAgentType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagementAgentType>
     */
