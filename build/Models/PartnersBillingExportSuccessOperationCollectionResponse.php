...
/**
 * PartnersBillingExportSuccessOperationCollectionResponse - Collection response
 */
class PartnersBillingExportSuccessOperationCollectionResponse
{
    /**
     * @var array<int, PartnersBillingExportSuccessOperation>
     */
    public array $value = [];
