...
/**
 * Collection response for PartnersBillingExportSuccessOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PartnersBillingExportSuccessOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PartnersBillingExportSuccessOperation[]
     */
    private array $value = [];
     ...
     * 
     * @return PartnersBillingExportSuccessOperation[]
     */
     ...
     * 
     * @param PartnersBillingExportSuccessOperation[] $items
     * @return self
     */
    public function setValue(array|PartnersBillingExportSuccessOperation $items, PartnersBillingExportSuccessOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PartnersBillingExportSuccessOperation> $value
     * @return self
     ...
     * 
     * @param PartnersBillingExportSuccessOperation $item
     * @return self
     */
    public function addValue(PartnersBillingExportSuccessOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PartnersBillingExportSuccessOperation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PartnersBillingExportSuccessOperation>
     */
