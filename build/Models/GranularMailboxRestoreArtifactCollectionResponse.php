...
/**
 * Collection response for GranularMailboxRestoreArtifact
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class GranularMailboxRestoreArtifactCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param GranularMailboxRestoreArtifact[] $items
     * @return self
     */
    public function setValue(array|GranularMailboxRestoreArtifact $items, GranularMailboxRestoreArtifact ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<GranularMailboxRestoreArtifact> $value
     * @return self
     ...
     * 
     * @param GranularMailboxRestoreArtifact $item
     * @return self
     */
    public function addValue(GranularMailboxRestoreArtifact $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, GranularMailboxRestoreArtifact>
     */
