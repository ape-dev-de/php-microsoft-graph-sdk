 ...
 */
class CustomExtensionOverwriteConfigurationCollectionResponse
{
    /**
     ...
     * 
     * @param CustomExtensionOverwriteConfiguration ...$items Variable number of CustomExtensionOverwriteConfiguration items
     * @return self
     */
    public function setValue(CustomExtensionOverwriteConfiguration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
