...
/**
 * Collection response for CustomExtensionOverwriteConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CustomExtensionOverwriteConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CustomExtensionOverwriteConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param CustomExtensionOverwriteConfiguration[] $items
     * @return self
     */
    public function setValue(array|CustomExtensionOverwriteConfiguration $items, CustomExtensionOverwriteConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CustomExtensionOverwriteConfiguration> $value
     * @return self
     ...
     * 
     * @param CustomExtensionOverwriteConfiguration $item
     * @return self
     */
    public function addValue(CustomExtensionOverwriteConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CustomExtensionOverwriteConfiguration>
     */
