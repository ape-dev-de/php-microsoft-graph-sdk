...
/**
 * DeviceEnrollmentFailureReasonCollectionResponse - Collection response
 */
class DeviceEnrollmentFailureReasonCollectionResponse
{
    /**
     * @var array<int, DeviceEnrollmentFailureReason>
     */
    public array $value = [];
