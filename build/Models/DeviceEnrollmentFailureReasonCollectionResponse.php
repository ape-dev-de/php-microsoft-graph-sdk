...
/**
 * Collection response for DeviceEnrollmentFailureReason
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceEnrollmentFailureReasonCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceEnrollmentFailureReason[]
     */
    private array $value = [];
     ...
     * 
     * @return DeviceEnrollmentFailureReason[]
     */
     ...
     * 
     * @param DeviceEnrollmentFailureReason[] $items
     * @return self
     */
    public function setValue(array|DeviceEnrollmentFailureReason $items, DeviceEnrollmentFailureReason ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceEnrollmentFailureReason> $value
     * @return self
     ...
     * 
     * @param DeviceEnrollmentFailureReason $item
     * @return self
     */
    public function addValue(DeviceEnrollmentFailureReason $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceEnrollmentFailureReason>
     */
