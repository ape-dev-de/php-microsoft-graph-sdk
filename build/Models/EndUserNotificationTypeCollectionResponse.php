...
/**
 * Collection response for EndUserNotificationType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EndUserNotificationTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EndUserNotificationType[]
     */
    private array $value = [];
     ...
     * 
     * @return EndUserNotificationType[]
     */
     ...
     * 
     * @param EndUserNotificationType[] $items
     * @return self
     */
    public function setValue(array|EndUserNotificationType $items, EndUserNotificationType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EndUserNotificationType> $value
     * @return self
     ...
     * 
     * @param EndUserNotificationType $item
     * @return self
     */
    public function addValue(EndUserNotificationType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EndUserNotificationType>
     */
