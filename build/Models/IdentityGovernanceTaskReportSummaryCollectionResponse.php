...
/**
 * Collection response for IdentityGovernanceTaskReportSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceTaskReportSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceTaskReportSummary[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceTaskReportSummary[]
     */
     ...
     * 
     * @param IdentityGovernanceTaskReportSummary[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceTaskReportSummary $items, IdentityGovernanceTaskReportSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceTaskReportSummary> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceTaskReportSummary $item
     * @return self
     */
    public function addValue(IdentityGovernanceTaskReportSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceTaskReportSummary|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceTaskReportSummary>
     */
