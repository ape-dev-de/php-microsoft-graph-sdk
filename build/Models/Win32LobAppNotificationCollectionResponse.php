...
/**
 * Collection response for Win32LobAppNotification
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Win32LobAppNotificationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Win32LobAppNotification[]
     */
    private array $value = [];
     ...
     * 
     * @return Win32LobAppNotification[]
     */
     ...
     * 
     * @param Win32LobAppNotification[] $items
     * @return self
     */
    public function setValue(array|Win32LobAppNotification $items, Win32LobAppNotification ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Win32LobAppNotification> $value
     * @return self
     ...
     * 
     * @param Win32LobAppNotification $item
     * @return self
     */
    public function addValue(Win32LobAppNotification $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Win32LobAppNotification>
     */
