...
/**
 * Collection response for EducationSchool
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationSchoolCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationSchool[]
     */
     ...
     * 
     * @param EducationSchool[] $items
     * @return self
     */
    public function setValue(array|EducationSchool $items, EducationSchool ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationSchool> $value
     * @return self
     ...
     * 
     * @param EducationSchool $item
     * @return self
     */
    public function addValue(EducationSchool $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationSchool>
     */
