...
/**
 * Collection response for GroupCollectionResponse
 */
class GroupCollectionResponseCollectionResponse
{
    /**
     * @var GroupCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param GroupCollectionResponse ...$items Variable number of GroupCollectionResponse items
     * @return self
     */
    public function setValue(GroupCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<GroupCollectionResponse> $value
     * @return self
     ...
     * 
     * @param GroupCollectionResponse $item
     * @return self
     */
    public function addValue(GroupCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
