...
/**
 * Collection response for ScheduleItemCollectionResponse
 */
class ScheduleItemCollectionResponseCollectionResponse
{
    /**
     * @var ScheduleItemCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ScheduleItemCollectionResponse ...$items Variable number of ScheduleItemCollectionResponse items
     * @return self
     */
    public function setValue(ScheduleItemCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ScheduleItemCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ScheduleItemCollectionResponse $item
     * @return self
     */
    public function addValue(ScheduleItemCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
