...
/**
 * Collection response for ProvisioningSystem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProvisioningSystemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProvisioningSystem[]
     */
    private array $value = [];
     ...
     * 
     * @param ProvisioningSystem[] $items
     * @return self
     */
    public function setValue(array|ProvisioningSystem $items, ProvisioningSystem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProvisioningSystem> $value
     * @return self
     ...
     * 
     * @param ProvisioningSystem $item
     * @return self
     */
    public function addValue(ProvisioningSystem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProvisioningSystem>
     */
