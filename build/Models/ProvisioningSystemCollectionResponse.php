 ...
 */
class ProvisioningSystemCollectionResponse
{
    /**
     ...
     * 
     * @param ProvisioningSystem ...$items Variable number of ProvisioningSystem items
     * @return self
     */
    public function setValue(ProvisioningSystem ...$items): self
    {
        $this->value = $items;
        return $this;
    }
