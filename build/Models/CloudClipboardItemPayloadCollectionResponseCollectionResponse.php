...
/**
 * Collection response for CloudClipboardItemPayloadCollectionResponse
 */
class CloudClipboardItemPayloadCollectionResponseCollectionResponse
{
    /**
     * @var CloudClipboardItemPayloadCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return CloudClipboardItemPayloadCollectionResponse[]
     */
     ...
     * 
     * @param CloudClipboardItemPayloadCollectionResponse ...$items Variable number of CloudClipboardItemPayloadCollectionResponse items
     * @return self
     */
    public function setValue(CloudClipboardItemPayloadCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CloudClipboardItemPayloadCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CloudClipboardItemPayloadCollectionResponse $item
     * @return self
     */
    public function addValue(CloudClipboardItemPayloadCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
