...
/**
 * Collection response for CallParticipantInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallParticipantInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CallParticipantInfo[] $items
     * @return self
     */
    public function setValue(array|CallParticipantInfo $items, CallParticipantInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallParticipantInfo> $value
     * @return self
     ...
     * 
     * @param CallParticipantInfo $item
     * @return self
     */
    public function addValue(CallParticipantInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallParticipantInfo|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallParticipantInfo>
     */
