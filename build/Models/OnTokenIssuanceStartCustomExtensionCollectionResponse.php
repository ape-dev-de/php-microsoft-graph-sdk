...
/**
 * Collection response for OnTokenIssuanceStartCustomExtension
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnTokenIssuanceStartCustomExtensionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnTokenIssuanceStartCustomExtension[]
     */
    private array $value = [];
     ...
     * 
     * @param OnTokenIssuanceStartCustomExtension[] $items
     * @return self
     */
    public function setValue(array|OnTokenIssuanceStartCustomExtension $items, OnTokenIssuanceStartCustomExtension ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnTokenIssuanceStartCustomExtension> $value
     * @return self
     ...
     * 
     * @param OnTokenIssuanceStartCustomExtension $item
     * @return self
     */
    public function addValue(OnTokenIssuanceStartCustomExtension $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnTokenIssuanceStartCustomExtension>
     */
