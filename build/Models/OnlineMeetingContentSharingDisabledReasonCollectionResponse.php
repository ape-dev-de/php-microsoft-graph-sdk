...
/**
 * OnlineMeetingContentSharingDisabledReasonCollectionResponse - Collection response
 */
class OnlineMeetingContentSharingDisabledReasonCollectionResponse
{
    /**
     * @var array<int, OnlineMeetingContentSharingDisabledReason>
     */
    public array $value = [];
