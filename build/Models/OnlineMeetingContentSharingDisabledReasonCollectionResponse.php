...
/**
 * Collection response for OnlineMeetingContentSharingDisabledReason
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnlineMeetingContentSharingDisabledReasonCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnlineMeetingContentSharingDisabledReason[]
     */
    private array $value = [];
     ...
     * 
     * @return OnlineMeetingContentSharingDisabledReason[]
     */
     ...
     * 
     * @param OnlineMeetingContentSharingDisabledReason[] $items
     * @return self
     */
    public function setValue(array|OnlineMeetingContentSharingDisabledReason $items, OnlineMeetingContentSharingDisabledReason ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnlineMeetingContentSharingDisabledReason> $value
     * @return self
     ...
     * 
     * @param OnlineMeetingContentSharingDisabledReason $item
     * @return self
     */
    public function addValue(OnlineMeetingContentSharingDisabledReason $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnlineMeetingContentSharingDisabledReason>
     */
