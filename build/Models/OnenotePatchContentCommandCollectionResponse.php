...
/**
 * Collection response for OnenotePatchContentCommand
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnenotePatchContentCommandCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnenotePatchContentCommand[]
     */
    private array $value = [];
     ...
     * 
     * @param OnenotePatchContentCommand[] $items
     * @return self
     */
    public function setValue(array|OnenotePatchContentCommand $items, OnenotePatchContentCommand ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnenotePatchContentCommand> $value
     * @return self
     ...
     * 
     * @param OnenotePatchContentCommand $item
     * @return self
     */
    public function addValue(OnenotePatchContentCommand $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OnenotePatchContentCommand|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OnenotePatchContentCommand>
     */
