 ...
 */
class OnenotePatchContentCommandCollectionResponse
{
    /**
     ...
     * 
     * @param OnenotePatchContentCommand ...$items Variable number of OnenotePatchContentCommand items
     * @return self
     */
    public function setValue(OnenotePatchContentCommand ...$items): self
    {
        $this->value = $items;
        return $this;
    }
