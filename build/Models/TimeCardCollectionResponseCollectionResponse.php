...
/**
 * Collection response for TimeCardCollectionResponse
 */
class TimeCardCollectionResponseCollectionResponse
{
    /**
     * @var TimeCardCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TimeCardCollectionResponse ...$items Variable number of TimeCardCollectionResponse items
     * @return self
     */
    public function setValue(TimeCardCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TimeCardCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TimeCardCollectionResponse $item
     * @return self
     */
    public function addValue(TimeCardCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
