...
/**
 * Collection response for SecurityWhoisNameserverCollectionResponse
 */
class SecurityWhoisNameserverCollectionResponseCollectionResponse
{
    /**
     * @var SecurityWhoisNameserverCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityWhoisNameserverCollectionResponse[]
     */
     ...
     * 
     * @param SecurityWhoisNameserverCollectionResponse ...$items Variable number of SecurityWhoisNameserverCollectionResponse items
     * @return self
     */
    public function setValue(SecurityWhoisNameserverCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityWhoisNameserverCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityWhoisNameserverCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityWhoisNameserverCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
