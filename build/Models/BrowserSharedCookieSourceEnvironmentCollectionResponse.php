...
/**
 * BrowserSharedCookieSourceEnvironmentCollectionResponse - Collection response
 */
class BrowserSharedCookieSourceEnvironmentCollectionResponse
{
    /**
     * @var array<int, BrowserSharedCookieSourceEnvironment>
     */
    public array $value = [];
