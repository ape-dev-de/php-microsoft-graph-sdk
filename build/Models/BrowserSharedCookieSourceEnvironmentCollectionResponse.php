...
/**
 * Collection response for BrowserSharedCookieSourceEnvironment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BrowserSharedCookieSourceEnvironmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BrowserSharedCookieSourceEnvironment[]
     */
    private array $value = [];
     ...
     * 
     * @return BrowserSharedCookieSourceEnvironment[]
     */
     ...
     * 
     * @param BrowserSharedCookieSourceEnvironment[] $items
     * @return self
     */
    public function setValue(array|BrowserSharedCookieSourceEnvironment $items, BrowserSharedCookieSourceEnvironment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BrowserSharedCookieSourceEnvironment> $value
     * @return self
     ...
     * 
     * @param BrowserSharedCookieSourceEnvironment $item
     * @return self
     */
    public function addValue(BrowserSharedCookieSourceEnvironment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BrowserSharedCookieSourceEnvironment>
     */
