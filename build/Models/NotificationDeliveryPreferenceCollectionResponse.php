...
/**
 * Collection response for NotificationDeliveryPreference
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class NotificationDeliveryPreferenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var NotificationDeliveryPreference[]
     */
    private array $value = [];
     ...
     * 
     * @return NotificationDeliveryPreference[]
     */
     ...
     * 
     * @param NotificationDeliveryPreference[] $items
     * @return self
     */
    public function setValue(array|NotificationDeliveryPreference $items, NotificationDeliveryPreference ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<NotificationDeliveryPreference> $value
     * @return self
     ...
     * 
     * @param NotificationDeliveryPreference $item
     * @return self
     */
    public function addValue(NotificationDeliveryPreference $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, NotificationDeliveryPreference>
     */
