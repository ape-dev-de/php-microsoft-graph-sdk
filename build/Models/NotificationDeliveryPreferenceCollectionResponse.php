...
/**
 * NotificationDeliveryPreferenceCollectionResponse - Collection response
 */
class NotificationDeliveryPreferenceCollectionResponse
{
    /**
     * @var array<int, NotificationDeliveryPreference>
     */
    public array $value = [];
