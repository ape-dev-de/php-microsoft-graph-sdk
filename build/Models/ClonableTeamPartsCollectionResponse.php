...
/**
 * Collection response for ClonableTeamParts
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ClonableTeamPartsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ClonableTeamParts[]
     */
    private array $value = [];
     ...
     * 
     * @param ClonableTeamParts[] $items
     * @return self
     */
    public function setValue(array|ClonableTeamParts $items, ClonableTeamParts ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ClonableTeamParts> $value
     * @return self
     ...
     * 
     * @param ClonableTeamParts $item
     * @return self
     */
    public function addValue(ClonableTeamParts $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ClonableTeamParts>
     */
