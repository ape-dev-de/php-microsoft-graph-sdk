...
/**
 * Collection response for IosCertificateProfileCollectionResponse
 */
class IosCertificateProfileCollectionResponseCollectionResponse
{
    /**
     * @var IosCertificateProfileCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IosCertificateProfileCollectionResponse ...$items Variable number of IosCertificateProfileCollectionResponse items
     * @return self
     */
    public function setValue(IosCertificateProfileCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IosCertificateProfileCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IosCertificateProfileCollectionResponse $item
     * @return self
     */
    public function addValue(IosCertificateProfileCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
