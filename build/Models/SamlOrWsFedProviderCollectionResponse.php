...
/**
 * Collection response for SamlOrWsFedProvider
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SamlOrWsFedProviderCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SamlOrWsFedProvider[]
     */
    private array $value = [];
     ...
     * 
     * @param SamlOrWsFedProvider[] $items
     * @return self
     */
    public function setValue(array|SamlOrWsFedProvider $items, SamlOrWsFedProvider ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SamlOrWsFedProvider> $value
     * @return self
     ...
     * 
     * @param SamlOrWsFedProvider $item
     * @return self
     */
    public function addValue(SamlOrWsFedProvider $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SamlOrWsFedProvider|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SamlOrWsFedProvider>
     */
