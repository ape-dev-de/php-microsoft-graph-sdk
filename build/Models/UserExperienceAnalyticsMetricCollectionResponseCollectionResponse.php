...
/**
 * Collection response for UserExperienceAnalyticsMetricCollectionResponse
 */
class UserExperienceAnalyticsMetricCollectionResponseCollectionResponse
{
    /**
     * @var UserExperienceAnalyticsMetricCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UserExperienceAnalyticsMetricCollectionResponse ...$items Variable number of UserExperienceAnalyticsMetricCollectionResponse items
     * @return self
     */
    public function setValue(UserExperienceAnalyticsMetricCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UserExperienceAnalyticsMetricCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsMetricCollectionResponse $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsMetricCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
