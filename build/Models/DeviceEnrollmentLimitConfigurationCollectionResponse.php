...
/**
 * Collection response for DeviceEnrollmentLimitConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceEnrollmentLimitConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceEnrollmentLimitConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceEnrollmentLimitConfiguration[] $items
     * @return self
     */
    public function setValue(array|DeviceEnrollmentLimitConfiguration $items, DeviceEnrollmentLimitConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceEnrollmentLimitConfiguration> $value
     * @return self
     ...
     * 
     * @param DeviceEnrollmentLimitConfiguration $item
     * @return self
     */
    public function addValue(DeviceEnrollmentLimitConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return DeviceEnrollmentLimitConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, DeviceEnrollmentLimitConfiguration>
     */
