...
/**
 * Collection response for FileHash
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FileHashCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FileHash[]
     */
     ...
     * 
     * @param FileHash[] $items
     * @return self
     */
    public function setValue(array|FileHash $items, FileHash ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(FileHash $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FileHash>
     */
