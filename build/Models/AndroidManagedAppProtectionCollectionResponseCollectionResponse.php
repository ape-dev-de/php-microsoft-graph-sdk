...
/**
 * Collection response for AndroidManagedAppProtectionCollectionResponse
 */
class AndroidManagedAppProtectionCollectionResponseCollectionResponse
{
    /**
     * @var AndroidManagedAppProtectionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AndroidManagedAppProtectionCollectionResponse ...$items Variable number of AndroidManagedAppProtectionCollectionResponse items
     * @return self
     */
    public function setValue(AndroidManagedAppProtectionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AndroidManagedAppProtectionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AndroidManagedAppProtectionCollectionResponse $item
     * @return self
     */
    public function addValue(AndroidManagedAppProtectionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
