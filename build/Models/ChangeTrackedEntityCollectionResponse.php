...
/**
 * Collection response for ChangeTrackedEntity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChangeTrackedEntityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChangeTrackedEntity[]
     */
    private array $value = [];
     ...
     * 
     * @param ChangeTrackedEntity[] $items
     * @return self
     */
    public function setValue(array|ChangeTrackedEntity $items, ChangeTrackedEntity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChangeTrackedEntity> $value
     * @return self
     ...
     * 
     * @param ChangeTrackedEntity $item
     * @return self
     */
    public function addValue(ChangeTrackedEntity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ChangeTrackedEntity|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ChangeTrackedEntity>
     */
