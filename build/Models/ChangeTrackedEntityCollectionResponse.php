 ...
 */
class ChangeTrackedEntityCollectionResponse
{
    /**
     ...
     * 
     * @param ChangeTrackedEntity ...$items Variable number of ChangeTrackedEntity items
     * @return self
     */
    public function setValue(ChangeTrackedEntity ...$items): self
    {
        $this->value = $items;
        return $this;
    }
