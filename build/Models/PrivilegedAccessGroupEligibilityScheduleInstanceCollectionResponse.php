...
/**
 * Collection response for PrivilegedAccessGroupEligibilityScheduleInstance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrivilegedAccessGroupEligibilityScheduleInstanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PrivilegedAccessGroupEligibilityScheduleInstance[] $items
     * @return self
     */
    public function setValue(array|PrivilegedAccessGroupEligibilityScheduleInstance $items, PrivilegedAccessGroupEligibilityScheduleInstance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrivilegedAccessGroupEligibilityScheduleInstance> $value
     * @return self
     ...
     * 
     * @param PrivilegedAccessGroupEligibilityScheduleInstance $item
     * @return self
     */
    public function addValue(PrivilegedAccessGroupEligibilityScheduleInstance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrivilegedAccessGroupEligibilityScheduleInstance>
     */
