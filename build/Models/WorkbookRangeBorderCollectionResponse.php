...
/**
 * Collection response for WorkbookRangeBorder
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookRangeBorderCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WorkbookRangeBorder[] $items
     * @return self
     */
    public function setValue(array|WorkbookRangeBorder $items, WorkbookRangeBorder ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookRangeBorder> $value
     * @return self
     ...
     * 
     * @param WorkbookRangeBorder $item
     * @return self
     */
    public function addValue(WorkbookRangeBorder $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WorkbookRangeBorder|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WorkbookRangeBorder>
     */
