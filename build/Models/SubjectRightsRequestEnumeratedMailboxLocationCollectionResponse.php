 ...
 */
class SubjectRightsRequestEnumeratedMailboxLocationCollectionResponse
{
    /**
     ...
     * 
     * @param SubjectRightsRequestEnumeratedMailboxLocation ...$items Variable number of SubjectRightsRequestEnumeratedMailboxLocation items
     * @return self
     */
    public function setValue(SubjectRightsRequestEnumeratedMailboxLocation ...$items): self
    {
        $this->value = $items;
        return $this;
    }
