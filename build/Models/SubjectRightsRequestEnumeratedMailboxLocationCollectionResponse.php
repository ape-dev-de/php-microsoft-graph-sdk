...
/**
 * Collection response for SubjectRightsRequestEnumeratedMailboxLocation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SubjectRightsRequestEnumeratedMailboxLocationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SubjectRightsRequestEnumeratedMailboxLocation[]
     */
    private array $value = [];
     ...
     * 
     * @param SubjectRightsRequestEnumeratedMailboxLocation[] $items
     * @return self
     */
    public function setValue(array|SubjectRightsRequestEnumeratedMailboxLocation $items, SubjectRightsRequestEnumeratedMailboxLocation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SubjectRightsRequestEnumeratedMailboxLocation> $value
     * @return self
     ...
     * 
     * @param SubjectRightsRequestEnumeratedMailboxLocation $item
     * @return self
     */
    public function addValue(SubjectRightsRequestEnumeratedMailboxLocation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SubjectRightsRequestEnumeratedMailboxLocation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SubjectRightsRequestEnumeratedMailboxLocation>
     */
