...
/**
 * Collection response for AnonymousGuestConversationMember
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AnonymousGuestConversationMemberCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AnonymousGuestConversationMember[]
     */
    private array $value = [];
     ...
     * 
     * @param AnonymousGuestConversationMember[] $items
     * @return self
     */
    public function setValue(array|AnonymousGuestConversationMember $items, AnonymousGuestConversationMember ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AnonymousGuestConversationMember> $value
     * @return self
     ...
     * 
     * @param AnonymousGuestConversationMember $item
     * @return self
     */
    public function addValue(AnonymousGuestConversationMember $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AnonymousGuestConversationMember|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AnonymousGuestConversationMember>
     */
