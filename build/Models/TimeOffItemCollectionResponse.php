...
/**
 * Collection response for TimeOffItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TimeOffItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TimeOffItem[]
     */
     ...
     * 
     * @param TimeOffItem[] $items
     * @return self
     */
    public function setValue(array|TimeOffItem $items, TimeOffItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param TimeOffItem $item
     * @return self
     */
    public function addValue(TimeOffItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TimeOffItem>
     */
