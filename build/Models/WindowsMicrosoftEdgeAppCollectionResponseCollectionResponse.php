...
/**
 * Collection response for WindowsMicrosoftEdgeAppCollectionResponse
 */
class WindowsMicrosoftEdgeAppCollectionResponseCollectionResponse
{
    /**
     * @var WindowsMicrosoftEdgeAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsMicrosoftEdgeAppCollectionResponse ...$items Variable number of WindowsMicrosoftEdgeAppCollectionResponse items
     * @return self
     */
    public function setValue(WindowsMicrosoftEdgeAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WindowsMicrosoftEdgeAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WindowsMicrosoftEdgeAppCollectionResponse $item
     * @return self
     */
    public function addValue(WindowsMicrosoftEdgeAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
