 ...
 */
class ConditionalAccessSessionControlsCollectionResponse
{
    /**
     ...
     * 
     * @param ConditionalAccessSessionControls ...$items Variable number of ConditionalAccessSessionControls items
     * @return self
     */
    public function setValue(ConditionalAccessSessionControls ...$items): self
    {
        $this->value = $items;
        return $this;
    }
