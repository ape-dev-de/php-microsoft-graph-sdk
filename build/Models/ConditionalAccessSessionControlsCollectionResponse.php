...
/**
 * Collection response for ConditionalAccessSessionControls
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessSessionControlsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessSessionControls[]
     */
    private array $value = [];
     ...
     * 
     * @param ConditionalAccessSessionControls[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessSessionControls $items, ConditionalAccessSessionControls ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessSessionControls> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessSessionControls $item
     * @return self
     */
    public function addValue(ConditionalAccessSessionControls $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessSessionControls>
     */
