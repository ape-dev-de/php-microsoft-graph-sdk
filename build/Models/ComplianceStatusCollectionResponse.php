...
/**
 * Collection response for ComplianceStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ComplianceStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ComplianceStatus[] $items
     * @return self
     */
    public function setValue(array|ComplianceStatus $items, ComplianceStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ComplianceStatus> $value
     * @return self
     ...
     * 
     * @param ComplianceStatus $item
     * @return self
     */
    public function addValue(ComplianceStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ComplianceStatus>
     */
