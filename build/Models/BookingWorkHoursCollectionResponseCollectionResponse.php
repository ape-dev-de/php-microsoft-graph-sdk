...
/**
 * Collection response for BookingWorkHoursCollectionResponse
 */
class BookingWorkHoursCollectionResponseCollectionResponse
{
    /**
     * @var BookingWorkHoursCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BookingWorkHoursCollectionResponse ...$items Variable number of BookingWorkHoursCollectionResponse items
     * @return self
     */
    public function setValue(BookingWorkHoursCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<BookingWorkHoursCollectionResponse> $value
     * @return self
     ...
     * 
     * @param BookingWorkHoursCollectionResponse $item
     * @return self
     */
    public function addValue(BookingWorkHoursCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
