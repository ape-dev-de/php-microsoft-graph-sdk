 ...
 */
class CallRecordsDeviceInfoCollectionResponse
{
    /**
     ...
     * 
     * @param CallRecordsDeviceInfo ...$items Variable number of CallRecordsDeviceInfo items
     * @return self
     */
    public function setValue(CallRecordsDeviceInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
