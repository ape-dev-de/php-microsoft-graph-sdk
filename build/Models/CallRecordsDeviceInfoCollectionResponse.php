...
/**
 * Collection response for CallRecordsDeviceInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsDeviceInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsDeviceInfo[]
     */
    private array $value = [];
     ...
     * 
     * @param CallRecordsDeviceInfo[] $items
     * @return self
     */
    public function setValue(array|CallRecordsDeviceInfo $items, CallRecordsDeviceInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsDeviceInfo> $value
     * @return self
     ...
     * 
     * @param CallRecordsDeviceInfo $item
     * @return self
     */
    public function addValue(CallRecordsDeviceInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsDeviceInfo|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsDeviceInfo>
     */
