...
/**
 * Collection response for IosManagedAppProtection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosManagedAppProtectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IosManagedAppProtection[] $items
     * @return self
     */
    public function setValue(array|IosManagedAppProtection $items, IosManagedAppProtection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosManagedAppProtection> $value
     * @return self
     ...
     * 
     * @param IosManagedAppProtection $item
     * @return self
     */
    public function addValue(IosManagedAppProtection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IosManagedAppProtection>
     */
