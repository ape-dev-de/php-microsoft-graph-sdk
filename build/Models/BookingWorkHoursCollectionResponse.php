...
/**
 * Collection response for BookingWorkHours
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingWorkHoursCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param BookingWorkHours[] $items
     * @return self
     */
    public function setValue(array|BookingWorkHours $items, BookingWorkHours ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingWorkHours> $value
     * @return self
     ...
     * 
     * @param BookingWorkHours $item
     * @return self
     */
    public function addValue(BookingWorkHours $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BookingWorkHours>
     */
