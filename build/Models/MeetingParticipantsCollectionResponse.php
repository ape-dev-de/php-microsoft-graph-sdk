 ...
 */
class MeetingParticipantsCollectionResponse
{
    /**
     ...
     * 
     * @param MeetingParticipants ...$items Variable number of MeetingParticipants items
     * @return self
     */
    public function setValue(MeetingParticipants ...$items): self
    {
        $this->value = $items;
        return $this;
    }
