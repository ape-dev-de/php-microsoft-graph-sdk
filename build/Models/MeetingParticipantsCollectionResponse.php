...
/**
 * Collection response for MeetingParticipants
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MeetingParticipantsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MeetingParticipants[] $items
     * @return self
     */
    public function setValue(array|MeetingParticipants $items, MeetingParticipants ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MeetingParticipants> $value
     * @return self
     ...
     * 
     * @param MeetingParticipants $item
     * @return self
     */
    public function addValue(MeetingParticipants $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MeetingParticipants>
     */
