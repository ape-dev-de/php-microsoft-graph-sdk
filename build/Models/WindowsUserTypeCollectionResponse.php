...
/**
 * Collection response for WindowsUserType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsUserTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsUserType[]
     */
     ...
     * 
     * @param WindowsUserType[] $items
     * @return self
     */
    public function setValue(array|WindowsUserType $items, WindowsUserType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsUserType> $value
     * @return self
     ...
     * 
     * @param WindowsUserType $item
     * @return self
     */
    public function addValue(WindowsUserType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsUserType>
     */
