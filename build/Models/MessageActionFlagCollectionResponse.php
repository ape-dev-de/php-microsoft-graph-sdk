...
/**
 * Collection response for MessageActionFlag
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MessageActionFlagCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MessageActionFlag[] $items
     * @return self
     */
    public function setValue(array|MessageActionFlag $items, MessageActionFlag ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MessageActionFlag> $value
     * @return self
     ...
     * 
     * @param MessageActionFlag $item
     * @return self
     */
    public function addValue(MessageActionFlag $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MessageActionFlag>
     */
