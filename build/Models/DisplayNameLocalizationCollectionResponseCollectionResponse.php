...
/**
 * Collection response for DisplayNameLocalizationCollectionResponse
 */
class DisplayNameLocalizationCollectionResponseCollectionResponse
{
    /**
     * @var DisplayNameLocalizationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DisplayNameLocalizationCollectionResponse ...$items Variable number of DisplayNameLocalizationCollectionResponse items
     * @return self
     */
    public function setValue(DisplayNameLocalizationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DisplayNameLocalizationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DisplayNameLocalizationCollectionResponse $item
     * @return self
     */
    public function addValue(DisplayNameLocalizationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
