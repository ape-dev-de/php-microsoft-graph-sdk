...
/**
 * AuthenticationAttributeCollectionPageViewConfigurationCollectionResponse - Collection response
 */
class AuthenticationAttributeCollectionPageViewConfigurationCollectionResponse
{
    /**
     * @var array<int, AuthenticationAttributeCollectionPageViewConfiguration>
     */
    public array $value = [];
