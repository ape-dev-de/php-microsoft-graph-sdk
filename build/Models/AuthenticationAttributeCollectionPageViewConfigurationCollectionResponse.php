...
/**
 * Collection response for AuthenticationAttributeCollectionPageViewConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationAttributeCollectionPageViewConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AuthenticationAttributeCollectionPageViewConfiguration[] $items
     * @return self
     */
    public function setValue(array|AuthenticationAttributeCollectionPageViewConfiguration $items, AuthenticationAttributeCollectionPageViewConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationAttributeCollectionPageViewConfiguration> $value
     * @return self
     ...
     * 
     * @param AuthenticationAttributeCollectionPageViewConfiguration $item
     * @return self
     */
    public function addValue(AuthenticationAttributeCollectionPageViewConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AuthenticationAttributeCollectionPageViewConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationAttributeCollectionPageViewConfiguration>
     */
