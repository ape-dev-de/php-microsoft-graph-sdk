...
/**
 * Collection response for EndUserNotificationDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EndUserNotificationDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param EndUserNotificationDetail[] $items
     * @return self
     */
    public function setValue(array|EndUserNotificationDetail $items, EndUserNotificationDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EndUserNotificationDetail> $value
     * @return self
     ...
     * 
     * @param EndUserNotificationDetail $item
     * @return self
     */
    public function addValue(EndUserNotificationDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EndUserNotificationDetail>
     */
