...
/**
 * Collection response for MacOSMicrosoftEdgeAppCollectionResponse
 */
class MacOSMicrosoftEdgeAppCollectionResponseCollectionResponse
{
    /**
     * @var MacOSMicrosoftEdgeAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MacOSMicrosoftEdgeAppCollectionResponse ...$items Variable number of MacOSMicrosoftEdgeAppCollectionResponse items
     * @return self
     */
    public function setValue(MacOSMicrosoftEdgeAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MacOSMicrosoftEdgeAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MacOSMicrosoftEdgeAppCollectionResponse $item
     * @return self
     */
    public function addValue(MacOSMicrosoftEdgeAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
