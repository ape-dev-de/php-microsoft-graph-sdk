...
/**
 * Collection response for IdentityGovernanceUsersProcessingSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceUsersProcessingSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceUsersProcessingSummary[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceUsersProcessingSummary[]
     */
     ...
     * 
     * @param IdentityGovernanceUsersProcessingSummary[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceUsersProcessingSummary $items, IdentityGovernanceUsersProcessingSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceUsersProcessingSummary> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceUsersProcessingSummary $item
     * @return self
     */
    public function addValue(IdentityGovernanceUsersProcessingSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceUsersProcessingSummary|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceUsersProcessingSummary>
     */
