 ...
 */
class IdentityGovernanceUsersProcessingSummaryCollectionResponse
{
    /**
     ...
     * 
     * @param IdentityGovernanceUsersProcessingSummary ...$items Variable number of IdentityGovernanceUsersProcessingSummary items
     * @return self
     */
    public function setValue(IdentityGovernanceUsersProcessingSummary ...$items): self
    {
        $this->value = $items;
        return $this;
    }
