...
/**
 * Collection response for ManagedAppConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedAppConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ManagedAppConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedAppConfiguration[] $items
     * @return self
     */
    public function setValue(array|ManagedAppConfiguration $items, ManagedAppConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedAppConfiguration> $value
     * @return self
     ...
     * 
     * @param ManagedAppConfiguration $item
     * @return self
     */
    public function addValue(ManagedAppConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ManagedAppConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ManagedAppConfiguration>
     */
