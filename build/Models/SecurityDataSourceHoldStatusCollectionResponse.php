...
/**
 * Collection response for SecurityDataSourceHoldStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityDataSourceHoldStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityDataSourceHoldStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityDataSourceHoldStatus[]
     */
     ...
     * 
     * @param SecurityDataSourceHoldStatus[] $items
     * @return self
     */
    public function setValue(array|SecurityDataSourceHoldStatus $items, SecurityDataSourceHoldStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityDataSourceHoldStatus> $value
     * @return self
     ...
     * 
     * @param SecurityDataSourceHoldStatus $item
     * @return self
     */
    public function addValue(SecurityDataSourceHoldStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityDataSourceHoldStatus|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityDataSourceHoldStatus>
     */
