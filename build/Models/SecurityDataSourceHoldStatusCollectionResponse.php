...
/**
 * SecurityDataSourceHoldStatusCollectionResponse - Collection response
 */
class SecurityDataSourceHoldStatusCollectionResponse
{
    /**
     * @var array<int, SecurityDataSourceHoldStatus>
     */
    public array $value = [];
