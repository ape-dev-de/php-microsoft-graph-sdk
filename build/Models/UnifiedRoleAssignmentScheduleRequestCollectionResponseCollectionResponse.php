...
/**
 * Collection response for UnifiedRoleAssignmentScheduleRequestCollectionResponse
 */
class UnifiedRoleAssignmentScheduleRequestCollectionResponseCollectionResponse
{
    /**
     * @var UnifiedRoleAssignmentScheduleRequestCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedRoleAssignmentScheduleRequestCollectionResponse ...$items Variable number of UnifiedRoleAssignmentScheduleRequestCollectionResponse items
     * @return self
     */
    public function setValue(UnifiedRoleAssignmentScheduleRequestCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UnifiedRoleAssignmentScheduleRequestCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleAssignmentScheduleRequestCollectionResponse $item
     * @return self
     */
    public function addValue(UnifiedRoleAssignmentScheduleRequestCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
