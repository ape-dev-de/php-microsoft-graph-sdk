 ...
 */
class OnlineMeetingBaseCollectionResponse
{
    /**
     ...
     * 
     * @param OnlineMeetingBase ...$items Variable number of OnlineMeetingBase items
     * @return self
     */
    public function setValue(OnlineMeetingBase ...$items): self
    {
        $this->value = $items;
        return $this;
    }
