...
/**
 * Collection response for OnlineMeetingBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnlineMeetingBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnlineMeetingBase[]
     */
    private array $value = [];
     ...
     * 
     * @param OnlineMeetingBase[] $items
     * @return self
     */
    public function setValue(array|OnlineMeetingBase $items, OnlineMeetingBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnlineMeetingBase> $value
     * @return self
     ...
     * 
     * @param OnlineMeetingBase $item
     * @return self
     */
    public function addValue(OnlineMeetingBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnlineMeetingBase>
     */
