 ...
 */
class BroadcastMeetingSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param BroadcastMeetingSettings ...$items Variable number of BroadcastMeetingSettings items
     * @return self
     */
    public function setValue(BroadcastMeetingSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
