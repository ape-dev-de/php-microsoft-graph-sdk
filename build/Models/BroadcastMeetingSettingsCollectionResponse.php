...
/**
 * Collection response for BroadcastMeetingSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BroadcastMeetingSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BroadcastMeetingSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param BroadcastMeetingSettings[] $items
     * @return self
     */
    public function setValue(array|BroadcastMeetingSettings $items, BroadcastMeetingSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BroadcastMeetingSettings> $value
     * @return self
     ...
     * 
     * @param BroadcastMeetingSettings $item
     * @return self
     */
    public function addValue(BroadcastMeetingSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BroadcastMeetingSettings>
     */
