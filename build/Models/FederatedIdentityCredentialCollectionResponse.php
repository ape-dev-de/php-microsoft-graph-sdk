...
/**
 * Collection response for FederatedIdentityCredential
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FederatedIdentityCredentialCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param FederatedIdentityCredential[] $items
     * @return self
     */
    public function setValue(array|FederatedIdentityCredential $items, FederatedIdentityCredential ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FederatedIdentityCredential> $value
     * @return self
     ...
     * 
     * @param FederatedIdentityCredential $item
     * @return self
     */
    public function addValue(FederatedIdentityCredential $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FederatedIdentityCredential>
     */
