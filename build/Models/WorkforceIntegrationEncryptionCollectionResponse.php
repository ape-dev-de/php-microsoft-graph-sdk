...
/**
 * Collection response for WorkforceIntegrationEncryption
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkforceIntegrationEncryptionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WorkforceIntegrationEncryption[] $items
     * @return self
     */
    public function setValue(array|WorkforceIntegrationEncryption $items, WorkforceIntegrationEncryption ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkforceIntegrationEncryption> $value
     * @return self
     ...
     * 
     * @param WorkforceIntegrationEncryption $item
     * @return self
     */
    public function addValue(WorkforceIntegrationEncryption $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkforceIntegrationEncryption>
     */
