 ...
 */
class WorkforceIntegrationEncryptionCollectionResponse
{
    /**
     ...
     * 
     * @param WorkforceIntegrationEncryption ...$items Variable number of WorkforceIntegrationEncryption items
     * @return self
     */
    public function setValue(WorkforceIntegrationEncryption ...$items): self
    {
        $this->value = $items;
        return $this;
    }
