...
/**
 * Collection response for MobileAppIdentifier
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MobileAppIdentifierCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MobileAppIdentifier[] $items
     * @return self
     */
    public function setValue(array|MobileAppIdentifier $items, MobileAppIdentifier ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MobileAppIdentifier> $value
     * @return self
     ...
     * 
     * @param MobileAppIdentifier $item
     * @return self
     */
    public function addValue(MobileAppIdentifier $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MobileAppIdentifier>
     */
