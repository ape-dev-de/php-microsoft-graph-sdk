...
/**
 * Collection response for EntrySyncOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EntrySyncOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EntrySyncOperation[]
     */
    private array $value = [];
     ...
     * 
     * @param EntrySyncOperation[] $items
     * @return self
     */
    public function setValue(array|EntrySyncOperation $items, EntrySyncOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EntrySyncOperation> $value
     * @return self
     ...
     * 
     * @param EntrySyncOperation $item
     * @return self
     */
    public function addValue(EntrySyncOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EntrySyncOperation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EntrySyncOperation>
     */
