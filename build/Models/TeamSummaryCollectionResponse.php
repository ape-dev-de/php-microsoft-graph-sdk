...
/**
 * Collection response for TeamSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamSummary[]
     */
     ...
     * 
     * @param TeamSummary[] $items
     * @return self
     */
    public function setValue(array|TeamSummary $items, TeamSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param TeamSummary $item
     * @return self
     */
    public function addValue(TeamSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamSummary>
     */
