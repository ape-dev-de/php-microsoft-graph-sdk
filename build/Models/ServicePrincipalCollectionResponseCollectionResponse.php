...
/**
 * Collection response for ServicePrincipalCollectionResponse
 */
class ServicePrincipalCollectionResponseCollectionResponse
{
    /**
     * @var ServicePrincipalCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ServicePrincipalCollectionResponse ...$items Variable number of ServicePrincipalCollectionResponse items
     * @return self
     */
    public function setValue(ServicePrincipalCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ServicePrincipalCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ServicePrincipalCollectionResponse $item
     * @return self
     */
    public function addValue(ServicePrincipalCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
