...
/**
 * Collection response for MailTipsError
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MailTipsErrorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MailTipsError[]
     */
     ...
     * 
     * @param MailTipsError[] $items
     * @return self
     */
    public function setValue(array|MailTipsError $items, MailTipsError ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MailTipsError> $value
     * @return self
     ...
     * 
     * @param MailTipsError $item
     * @return self
     */
    public function addValue(MailTipsError $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MailTipsError>
     */
