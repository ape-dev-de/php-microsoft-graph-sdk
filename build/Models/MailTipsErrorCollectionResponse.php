 ...
 */
class MailTipsErrorCollectionResponse
{
    /**
     * @var MailTipsError[]
     */
     ...
     * 
     * @param MailTipsError ...$items Variable number of MailTipsError items
     * @return self
     */
    public function setValue(MailTipsError ...$items): self
    {
        $this->value = $items;
        return $this;
    }
