...
/**
 * Collection response for OnlineMeetingRole
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnlineMeetingRoleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param OnlineMeetingRole[] $items
     * @return self
     */
    public function setValue(array|OnlineMeetingRole $items, OnlineMeetingRole ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnlineMeetingRole> $value
     * @return self
     ...
     * 
     * @param OnlineMeetingRole $item
     * @return self
     */
    public function addValue(OnlineMeetingRole $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnlineMeetingRole>
     */
