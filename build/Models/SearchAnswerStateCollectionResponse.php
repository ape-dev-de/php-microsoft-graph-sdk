...
/**
 * Collection response for SearchAnswerState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SearchAnswerStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SearchAnswerState[]
     */
    private array $value = [];
     ...
     * 
     * @param SearchAnswerState[] $items
     * @return self
     */
    public function setValue(array|SearchAnswerState $items, SearchAnswerState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SearchAnswerState> $value
     * @return self
     ...
     * 
     * @param SearchAnswerState $item
     * @return self
     */
    public function addValue(SearchAnswerState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SearchAnswerState>
     */
