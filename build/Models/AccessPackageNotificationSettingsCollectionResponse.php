...
/**
 * Collection response for AccessPackageNotificationSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageNotificationSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageNotificationSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageNotificationSettings[] $items
     * @return self
     */
    public function setValue(array|AccessPackageNotificationSettings $items, AccessPackageNotificationSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageNotificationSettings> $value
     * @return self
     ...
     * 
     * @param AccessPackageNotificationSettings $item
     * @return self
     */
    public function addValue(AccessPackageNotificationSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageNotificationSettings>
     */
