 ...
 */
class AccessPackageNotificationSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param AccessPackageNotificationSettings ...$items Variable number of AccessPackageNotificationSettings items
     * @return self
     */
    public function setValue(AccessPackageNotificationSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
