...
/**
 * Collection response for TargetUserSponsors
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TargetUserSponsorsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TargetUserSponsors[]
     */
    private array $value = [];
     ...
     * 
     * @param TargetUserSponsors[] $items
     * @return self
     */
    public function setValue(array|TargetUserSponsors $items, TargetUserSponsors ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TargetUserSponsors> $value
     * @return self
     ...
     * 
     * @param TargetUserSponsors $item
     * @return self
     */
    public function addValue(TargetUserSponsors $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TargetUserSponsors|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TargetUserSponsors>
     */
