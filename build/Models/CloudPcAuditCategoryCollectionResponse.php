...
/**
 * Collection response for CloudPcAuditCategory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcAuditCategoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudPcAuditCategory[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudPcAuditCategory[] $items
     * @return self
     */
    public function setValue(array|CloudPcAuditCategory $items, CloudPcAuditCategory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcAuditCategory> $value
     * @return self
     ...
     * 
     * @param CloudPcAuditCategory $item
     * @return self
     */
    public function addValue(CloudPcAuditCategory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcAuditCategory>
     */
