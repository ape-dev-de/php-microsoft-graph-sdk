...
/**
 * Collection response for AccessPackageAnswerChoice
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageAnswerChoiceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessPackageAnswerChoice[] $items
     * @return self
     */
    public function setValue(array|AccessPackageAnswerChoice $items, AccessPackageAnswerChoice ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageAnswerChoice> $value
     * @return self
     ...
     * 
     * @param AccessPackageAnswerChoice $item
     * @return self
     */
    public function addValue(AccessPackageAnswerChoice $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessPackageAnswerChoice|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageAnswerChoice>
     */
