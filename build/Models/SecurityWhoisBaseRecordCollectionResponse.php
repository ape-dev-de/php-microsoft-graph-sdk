 ...
 */
class SecurityWhoisBaseRecordCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityWhoisBaseRecord ...$items Variable number of SecurityWhoisBaseRecord items
     * @return self
     */
    public function setValue(SecurityWhoisBaseRecord ...$items): self
    {
        $this->value = $items;
        return $this;
    }
