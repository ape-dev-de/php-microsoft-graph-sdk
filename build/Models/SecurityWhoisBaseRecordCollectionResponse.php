...
/**
 * Collection response for SecurityWhoisBaseRecord
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityWhoisBaseRecordCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityWhoisBaseRecord[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityWhoisBaseRecord[]
     */
     ...
     * 
     * @param SecurityWhoisBaseRecord[] $items
     * @return self
     */
    public function setValue(array|SecurityWhoisBaseRecord $items, SecurityWhoisBaseRecord ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityWhoisBaseRecord> $value
     * @return self
     ...
     * 
     * @param SecurityWhoisBaseRecord $item
     * @return self
     */
    public function addValue(SecurityWhoisBaseRecord $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityWhoisBaseRecord|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityWhoisBaseRecord>
     */
