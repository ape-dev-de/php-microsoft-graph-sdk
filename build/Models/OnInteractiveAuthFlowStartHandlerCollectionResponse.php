...
/**
 * OnInteractiveAuthFlowStartHandlerCollectionResponse - Collection response
 */
class OnInteractiveAuthFlowStartHandlerCollectionResponse
{
    /**
     * @var array<int, OnInteractiveAuthFlowStartHandler>
     */
    public array $value = [];
