...
/**
 * Collection response for OnInteractiveAuthFlowStartHandler
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnInteractiveAuthFlowStartHandlerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnInteractiveAuthFlowStartHandler[]
     */
    private array $value = [];
     ...
     * 
     * @param OnInteractiveAuthFlowStartHandler[] $items
     * @return self
     */
    public function setValue(array|OnInteractiveAuthFlowStartHandler $items, OnInteractiveAuthFlowStartHandler ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnInteractiveAuthFlowStartHandler> $value
     * @return self
     ...
     * 
     * @param OnInteractiveAuthFlowStartHandler $item
     * @return self
     */
    public function addValue(OnInteractiveAuthFlowStartHandler $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnInteractiveAuthFlowStartHandler>
     */
