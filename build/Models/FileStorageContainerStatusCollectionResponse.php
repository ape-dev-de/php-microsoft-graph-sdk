...
/**
 * FileStorageContainerStatusCollectionResponse - Collection response
 */
class FileStorageContainerStatusCollectionResponse
{
    /**
     * @var array<int, FileStorageContainerStatus>
     */
    public array $value = [];
