...
/**
 * Collection response for FileStorageContainerStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FileStorageContainerStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FileStorageContainerStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return FileStorageContainerStatus[]
     */
     ...
     * 
     * @param FileStorageContainerStatus[] $items
     * @return self
     */
    public function setValue(array|FileStorageContainerStatus $items, FileStorageContainerStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FileStorageContainerStatus> $value
     * @return self
     ...
     * 
     * @param FileStorageContainerStatus $item
     * @return self
     */
    public function addValue(FileStorageContainerStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FileStorageContainerStatus>
     */
