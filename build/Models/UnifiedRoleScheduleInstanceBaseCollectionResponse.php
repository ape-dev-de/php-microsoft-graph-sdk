...
/**
 * Collection response for UnifiedRoleScheduleInstanceBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRoleScheduleInstanceBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UnifiedRoleScheduleInstanceBase[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedRoleScheduleInstanceBase[] $items
     * @return self
     */
    public function setValue(array|UnifiedRoleScheduleInstanceBase $items, UnifiedRoleScheduleInstanceBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRoleScheduleInstanceBase> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleScheduleInstanceBase $item
     * @return self
     */
    public function addValue(UnifiedRoleScheduleInstanceBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UnifiedRoleScheduleInstanceBase|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRoleScheduleInstanceBase>
     */
