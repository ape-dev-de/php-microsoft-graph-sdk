 ...
 */
class UnifiedRoleScheduleInstanceBaseCollectionResponse
{
    /**
     ...
     * 
     * @param UnifiedRoleScheduleInstanceBase ...$items Variable number of UnifiedRoleScheduleInstanceBase items
     * @return self
     */
    public function setValue(UnifiedRoleScheduleInstanceBase ...$items): self
    {
        $this->value = $items;
        return $this;
    }
