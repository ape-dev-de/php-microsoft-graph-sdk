...
/**
 * Collection response for CallTranscriptCollectionResponse
 */
class CallTranscriptCollectionResponseCollectionResponse
{
    /**
     * @var CallTranscriptCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CallTranscriptCollectionResponse ...$items Variable number of CallTranscriptCollectionResponse items
     * @return self
     */
    public function setValue(CallTranscriptCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CallTranscriptCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CallTranscriptCollectionResponse $item
     * @return self
     */
    public function addValue(CallTranscriptCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
