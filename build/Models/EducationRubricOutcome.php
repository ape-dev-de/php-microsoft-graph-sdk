...
class EducationRubricOutcome
{
     ...
     */
    private ?string $rubricQualitySelectedLevels;
    ...
    public function getRubricQualitySelectedLevels(): ?string
    {
        return $this->rubricQualitySelectedLevels;
    }

    public function setRubricQualitySelectedLevels(?string $rubricQualitySelectedLevels): self
    {
