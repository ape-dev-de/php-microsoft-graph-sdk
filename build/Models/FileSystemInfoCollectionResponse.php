...
/**
 * Collection response for FileSystemInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FileSystemInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FileSystemInfo[]
     */
     ...
     * 
     * @param FileSystemInfo[] $items
     * @return self
     */
    public function setValue(array|FileSystemInfo $items, FileSystemInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FileSystemInfo> $value
     * @return self
     ...
     * 
     * @param FileSystemInfo $item
     * @return self
     */
    public function addValue(FileSystemInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FileSystemInfo>
     */
