 ...
 */
class FileSystemInfoCollectionResponse
{
    /**
     * @var FileSystemInfo[]
     */
     ...
     * 
     * @param FileSystemInfo ...$items Variable number of FileSystemInfo items
     * @return self
     */
    public function setValue(FileSystemInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
