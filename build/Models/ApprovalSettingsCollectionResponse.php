...
/**
 * Collection response for ApprovalSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ApprovalSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ApprovalSettings[] $items
     * @return self
     */
    public function setValue(array|ApprovalSettings $items, ApprovalSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ApprovalSettings> $value
     * @return self
     ...
     * 
     * @param ApprovalSettings $item
     * @return self
     */
    public function addValue(ApprovalSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ApprovalSettings>
     */
