 ...
 */
class ApprovalSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param ApprovalSettings ...$items Variable number of ApprovalSettings items
     * @return self
     */
    public function setValue(ApprovalSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
