...
/**
 * Collection response for ComplianceManagementPartner
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ComplianceManagementPartnerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ComplianceManagementPartner[] $items
     * @return self
     */
    public function setValue(array|ComplianceManagementPartner $items, ComplianceManagementPartner ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ComplianceManagementPartner> $value
     * @return self
     ...
     * 
     * @param ComplianceManagementPartner $item
     * @return self
     */
    public function addValue(ComplianceManagementPartner $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ComplianceManagementPartner>
     */
