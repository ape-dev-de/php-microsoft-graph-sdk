...
/**
 * Collection response for UserTrainingStatusInfoCollectionResponse
 */
class UserTrainingStatusInfoCollectionResponseCollectionResponse
{
    /**
     * @var UserTrainingStatusInfoCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UserTrainingStatusInfoCollectionResponse ...$items Variable number of UserTrainingStatusInfoCollectionResponse items
     * @return self
     */
    public function setValue(UserTrainingStatusInfoCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UserTrainingStatusInfoCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UserTrainingStatusInfoCollectionResponse $item
     * @return self
     */
    public function addValue(UserTrainingStatusInfoCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
