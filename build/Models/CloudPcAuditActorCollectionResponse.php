 ...
 */
class CloudPcAuditActorCollectionResponse
{
    /**
     ...
     * 
     * @param CloudPcAuditActor ...$items Variable number of CloudPcAuditActor items
     * @return self
     */
    public function setValue(CloudPcAuditActor ...$items): self
    {
        $this->value = $items;
        return $this;
    }
