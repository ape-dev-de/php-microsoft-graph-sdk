...
/**
 * Collection response for CloudPcAuditActor
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcAuditActorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudPcAuditActor[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudPcAuditActor[] $items
     * @return self
     */
    public function setValue(array|CloudPcAuditActor $items, CloudPcAuditActor ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcAuditActor> $value
     * @return self
     ...
     * 
     * @param CloudPcAuditActor $item
     * @return self
     */
    public function addValue(CloudPcAuditActor $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcAuditActor>
     */
