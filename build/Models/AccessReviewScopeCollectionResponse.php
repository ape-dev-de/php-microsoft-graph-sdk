...
/**
 * Collection response for AccessReviewScope
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewScopeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessReviewScope[] $items
     * @return self
     */
    public function setValue(array|AccessReviewScope $items, AccessReviewScope ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewScope> $value
     * @return self
     ...
     * 
     * @param AccessReviewScope $item
     * @return self
     */
    public function addValue(AccessReviewScope $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewScope>
     */
