...
/**
 * Collection response for AuthenticationMethodConfigurationCollectionResponse
 */
class AuthenticationMethodConfigurationCollectionResponseCollectionResponse
{
    /**
     * @var AuthenticationMethodConfigurationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AuthenticationMethodConfigurationCollectionResponse ...$items Variable number of AuthenticationMethodConfigurationCollectionResponse items
     * @return self
     */
    public function setValue(AuthenticationMethodConfigurationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AuthenticationMethodConfigurationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AuthenticationMethodConfigurationCollectionResponse $item
     * @return self
     */
    public function addValue(AuthenticationMethodConfigurationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
