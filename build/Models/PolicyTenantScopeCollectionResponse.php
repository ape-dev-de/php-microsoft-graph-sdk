...
/**
 * Collection response for PolicyTenantScope
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PolicyTenantScopeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PolicyTenantScope[]
     */
    private array $value = [];
     ...
     * 
     * @param PolicyTenantScope[] $items
     * @return self
     */
    public function setValue(array|PolicyTenantScope $items, PolicyTenantScope ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PolicyTenantScope> $value
     * @return self
     ...
     * 
     * @param PolicyTenantScope $item
     * @return self
     */
    public function addValue(PolicyTenantScope $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PolicyTenantScope>
     */
