 ...
 */
class PolicyTenantScopeCollectionResponse
{
    /**
     ...
     * 
     * @param PolicyTenantScope ...$items Variable number of PolicyTenantScope items
     * @return self
     */
    public function setValue(PolicyTenantScope ...$items): self
    {
        $this->value = $items;
        return $this;
    }
