...
/**
 * Collection response for AccessPackageAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessPackageAssignment[] $items
     * @return self
     */
    public function setValue(array|AccessPackageAssignment $items, AccessPackageAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageAssignment> $value
     * @return self
     ...
     * 
     * @param AccessPackageAssignment $item
     * @return self
     */
    public function addValue(AccessPackageAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageAssignment>
     */
