 ...
 */
class ProvisionChannelEmailResultCollectionResponse
{
    /**
     ...
     * 
     * @param ProvisionChannelEmailResult ...$items Variable number of ProvisionChannelEmailResult items
     * @return self
     */
    public function setValue(ProvisionChannelEmailResult ...$items): self
    {
        $this->value = $items;
        return $this;
    }
