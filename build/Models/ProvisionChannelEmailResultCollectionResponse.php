...
/**
 * Collection response for ProvisionChannelEmailResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProvisionChannelEmailResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProvisionChannelEmailResult[]
     */
    private array $value = [];
     ...
     * 
     * @param ProvisionChannelEmailResult[] $items
     * @return self
     */
    public function setValue(array|ProvisionChannelEmailResult $items, ProvisionChannelEmailResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProvisionChannelEmailResult> $value
     * @return self
     ...
     * 
     * @param ProvisionChannelEmailResult $item
     * @return self
     */
    public function addValue(ProvisionChannelEmailResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ProvisionChannelEmailResult|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ProvisionChannelEmailResult>
     */
