...
/**
 * Collection response for KeyCredentialConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class KeyCredentialConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param KeyCredentialConfiguration[] $items
     * @return self
     */
    public function setValue(array|KeyCredentialConfiguration $items, KeyCredentialConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<KeyCredentialConfiguration> $value
     * @return self
     ...
     * 
     * @param KeyCredentialConfiguration $item
     * @return self
     */
    public function addValue(KeyCredentialConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return KeyCredentialConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, KeyCredentialConfiguration>
     */
