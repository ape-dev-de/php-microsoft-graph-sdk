...
/**
 * Collection response for DiagnosticDataSubmissionMode
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DiagnosticDataSubmissionModeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DiagnosticDataSubmissionMode[]
     */
    private array $value = [];
     ...
     * 
     * @return DiagnosticDataSubmissionMode[]
     */
     ...
     * 
     * @param DiagnosticDataSubmissionMode[] $items
     * @return self
     */
    public function setValue(array|DiagnosticDataSubmissionMode $items, DiagnosticDataSubmissionMode ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DiagnosticDataSubmissionMode> $value
     * @return self
     ...
     * 
     * @param DiagnosticDataSubmissionMode $item
     * @return self
     */
    public function addValue(DiagnosticDataSubmissionMode $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DiagnosticDataSubmissionMode>
     */
