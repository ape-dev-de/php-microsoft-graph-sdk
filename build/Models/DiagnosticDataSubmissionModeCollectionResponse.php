...
/**
 * DiagnosticDataSubmissionModeCollectionResponse - Collection response
 */
class DiagnosticDataSubmissionModeCollectionResponse
{
    /**
     * @var array<int, DiagnosticDataSubmissionMode>
     */
    public array $value = [];
