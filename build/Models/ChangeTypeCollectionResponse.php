...
/**
 * Collection response for ChangeType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChangeTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChangeType[]
     */
     ...
     * 
     * @param ChangeType[] $items
     * @return self
     */
    public function setValue(array|ChangeType $items, ChangeType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param ChangeType $item
     * @return self
     */
    public function addValue(ChangeType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChangeType>
     */
