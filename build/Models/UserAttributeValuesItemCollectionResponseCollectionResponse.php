...
/**
 * Collection response for UserAttributeValuesItemCollectionResponse
 */
class UserAttributeValuesItemCollectionResponseCollectionResponse
{
    /**
     * @var UserAttributeValuesItemCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UserAttributeValuesItemCollectionResponse ...$items Variable number of UserAttributeValuesItemCollectionResponse items
     * @return self
     */
    public function setValue(UserAttributeValuesItemCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UserAttributeValuesItemCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UserAttributeValuesItemCollectionResponse $item
     * @return self
     */
    public function addValue(UserAttributeValuesItemCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
