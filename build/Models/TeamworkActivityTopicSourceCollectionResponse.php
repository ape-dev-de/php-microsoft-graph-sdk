...
/**
 * Collection response for TeamworkActivityTopicSource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamworkActivityTopicSourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamworkActivityTopicSource[]
     */
    private array $value = [];
     ...
     * 
     * @return TeamworkActivityTopicSource[]
     */
     ...
     * 
     * @param TeamworkActivityTopicSource[] $items
     * @return self
     */
    public function setValue(array|TeamworkActivityTopicSource $items, TeamworkActivityTopicSource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamworkActivityTopicSource> $value
     * @return self
     ...
     * 
     * @param TeamworkActivityTopicSource $item
     * @return self
     */
    public function addValue(TeamworkActivityTopicSource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamworkActivityTopicSource>
     */
