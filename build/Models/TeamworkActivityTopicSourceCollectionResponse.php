...
/**
 * TeamworkActivityTopicSourceCollectionResponse - Collection response
 */
class TeamworkActivityTopicSourceCollectionResponse
{
    /**
     * @var array<int, TeamworkActivityTopicSource>
     */
    public array $value = [];
