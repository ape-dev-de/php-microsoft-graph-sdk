 ...
 */
class OnenotePagePreviewLinksCollectionResponse
{
    /**
     ...
     * 
     * @param OnenotePagePreviewLinks ...$items Variable number of OnenotePagePreviewLinks items
     * @return self
     */
    public function setValue(OnenotePagePreviewLinks ...$items): self
    {
        $this->value = $items;
        return $this;
    }
