...
/**
 * Collection response for OnenotePagePreviewLinks
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnenotePagePreviewLinksCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param OnenotePagePreviewLinks[] $items
     * @return self
     */
    public function setValue(array|OnenotePagePreviewLinks $items, OnenotePagePreviewLinks ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnenotePagePreviewLinks> $value
     * @return self
     ...
     * 
     * @param OnenotePagePreviewLinks $item
     * @return self
     */
    public function addValue(OnenotePagePreviewLinks $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnenotePagePreviewLinks>
     */
