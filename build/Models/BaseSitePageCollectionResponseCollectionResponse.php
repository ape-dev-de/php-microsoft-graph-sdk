...
/**
 * Collection response for BaseSitePageCollectionResponse
 */
class BaseSitePageCollectionResponseCollectionResponse
{
    /**
     * @var BaseSitePageCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BaseSitePageCollectionResponse ...$items Variable number of BaseSitePageCollectionResponse items
     * @return self
     */
    public function setValue(BaseSitePageCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<BaseSitePageCollectionResponse> $value
     * @return self
     ...
     * 
     * @param BaseSitePageCollectionResponse $item
     * @return self
     */
    public function addValue(BaseSitePageCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
