...
/**
 * Collection response for AuthenticationMethodPlatform
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationMethodPlatformCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuthenticationMethodPlatform[]
     */
    private array $value = [];
     ...
     * 
     * @return AuthenticationMethodPlatform[]
     */
     ...
     * 
     * @param AuthenticationMethodPlatform[] $items
     * @return self
     */
    public function setValue(array|AuthenticationMethodPlatform $items, AuthenticationMethodPlatform ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationMethodPlatform> $value
     * @return self
     ...
     * 
     * @param AuthenticationMethodPlatform $item
     * @return self
     */
    public function addValue(AuthenticationMethodPlatform $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationMethodPlatform>
     */
