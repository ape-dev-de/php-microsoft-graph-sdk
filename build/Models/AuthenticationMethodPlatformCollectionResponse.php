...
/**
 * AuthenticationMethodPlatformCollectionResponse - Collection response
 */
class AuthenticationMethodPlatformCollectionResponse
{
    /**
     * @var array<int, AuthenticationMethodPlatform>
     */
    public array $value = [];
