 ...
 */
class ProcessContentResponsesCollectionResponse
{
    /**
     ...
     * 
     * @param ProcessContentResponses ...$items Variable number of ProcessContentResponses items
     * @return self
     */
    public function setValue(ProcessContentResponses ...$items): self
    {
        $this->value = $items;
        return $this;
    }
