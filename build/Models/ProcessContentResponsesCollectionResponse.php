...
/**
 * Collection response for ProcessContentResponses
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProcessContentResponsesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProcessContentResponses[]
     */
    private array $value = [];
     ...
     * 
     * @param ProcessContentResponses[] $items
     * @return self
     */
    public function setValue(array|ProcessContentResponses $items, ProcessContentResponses ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProcessContentResponses> $value
     * @return self
     ...
     * 
     * @param ProcessContentResponses $item
     * @return self
     */
    public function addValue(ProcessContentResponses $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ProcessContentResponses|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ProcessContentResponses>
     */
