...
/**
 * Collection response for X509CertificateAuthenticationMode
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class X509CertificateAuthenticationModeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var X509CertificateAuthenticationMode[]
     */
    private array $value = [];
     ...
     * 
     * @return X509CertificateAuthenticationMode[]
     */
     ...
     * 
     * @param X509CertificateAuthenticationMode[] $items
     * @return self
     */
    public function setValue(array|X509CertificateAuthenticationMode $items, X509CertificateAuthenticationMode ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<X509CertificateAuthenticationMode> $value
     * @return self
     ...
     * 
     * @param X509CertificateAuthenticationMode $item
     * @return self
     */
    public function addValue(X509CertificateAuthenticationMode $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, X509CertificateAuthenticationMode>
     */
