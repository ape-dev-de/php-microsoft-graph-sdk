...
/**
 * X509CertificateAuthenticationModeCollectionResponse - Collection response
 */
class X509CertificateAuthenticationModeCollectionResponse
{
    /**
     * @var array<int, X509CertificateAuthenticationMode>
     */
    public array $value = [];
