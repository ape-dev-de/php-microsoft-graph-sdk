...
/**
 * Collection response for BrowserSiteCompatibilityMode
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BrowserSiteCompatibilityModeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BrowserSiteCompatibilityMode[]
     */
    private array $value = [];
     ...
     * 
     * @return BrowserSiteCompatibilityMode[]
     */
     ...
     * 
     * @param BrowserSiteCompatibilityMode[] $items
     * @return self
     */
    public function setValue(array|BrowserSiteCompatibilityMode $items, BrowserSiteCompatibilityMode ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BrowserSiteCompatibilityMode> $value
     * @return self
     ...
     * 
     * @param BrowserSiteCompatibilityMode $item
     * @return self
     */
    public function addValue(BrowserSiteCompatibilityMode $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BrowserSiteCompatibilityMode>
     */
