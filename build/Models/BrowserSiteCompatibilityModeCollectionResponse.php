...
/**
 * BrowserSiteCompatibilityModeCollectionResponse - Collection response
 */
class BrowserSiteCompatibilityModeCollectionResponse
{
    /**
     * @var array<int, BrowserSiteCompatibilityMode>
     */
    public array $value = [];
