...
/**
 * Collection response for PrincipalResourceMembershipsScope
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrincipalResourceMembershipsScopeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrincipalResourceMembershipsScope[]
     */
    private array $value = [];
     ...
     * 
     * @param PrincipalResourceMembershipsScope[] $items
     * @return self
     */
    public function setValue(array|PrincipalResourceMembershipsScope $items, PrincipalResourceMembershipsScope ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrincipalResourceMembershipsScope> $value
     * @return self
     ...
     * 
     * @param PrincipalResourceMembershipsScope $item
     * @return self
     */
    public function addValue(PrincipalResourceMembershipsScope $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PrincipalResourceMembershipsScope|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PrincipalResourceMembershipsScope>
     */
