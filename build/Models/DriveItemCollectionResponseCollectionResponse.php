...
/**
 * Collection response for DriveItemCollectionResponse
 */
class DriveItemCollectionResponseCollectionResponse
{
    /**
     * @var DriveItemCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DriveItemCollectionResponse ...$items Variable number of DriveItemCollectionResponse items
     * @return self
     */
    public function setValue(DriveItemCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DriveItemCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DriveItemCollectionResponse $item
     * @return self
     */
    public function addValue(DriveItemCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
