...
/**
 * Collection response for PrintDocument
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintDocumentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrintDocument[]
     */
     ...
     * 
     * @param PrintDocument[] $items
     * @return self
     */
    public function setValue(array|PrintDocument $items, PrintDocument ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintDocument> $value
     * @return self
     ...
     * 
     * @param PrintDocument $item
     * @return self
     */
    public function addValue(PrintDocument $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintDocument>
     */
