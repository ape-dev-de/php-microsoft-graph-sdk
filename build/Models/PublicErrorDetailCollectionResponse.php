...
/**
 * Collection response for PublicErrorDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PublicErrorDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PublicErrorDetail[] $items
     * @return self
     */
    public function setValue(array|PublicErrorDetail $items, PublicErrorDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PublicErrorDetail> $value
     * @return self
     ...
     * 
     * @param PublicErrorDetail $item
     * @return self
     */
    public function addValue(PublicErrorDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PublicErrorDetail>
     */
