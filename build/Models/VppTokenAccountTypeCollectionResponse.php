...
/**
 * Collection response for VppTokenAccountType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VppTokenAccountTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VppTokenAccountType[]
     */
    private array $value = [];
     ...
     * 
     * @param VppTokenAccountType[] $items
     * @return self
     */
    public function setValue(array|VppTokenAccountType $items, VppTokenAccountType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VppTokenAccountType> $value
     * @return self
     ...
     * 
     * @param VppTokenAccountType $item
     * @return self
     */
    public function addValue(VppTokenAccountType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VppTokenAccountType>
     */
