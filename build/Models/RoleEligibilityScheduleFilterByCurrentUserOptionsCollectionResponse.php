...
/**
 * Collection response for RoleEligibilityScheduleFilterByCurrentUserOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RoleEligibilityScheduleFilterByCurrentUserOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RoleEligibilityScheduleFilterByCurrentUserOptions[]
     */
    private array $value = [];
     ...
     * 
     * @return RoleEligibilityScheduleFilterByCurrentUserOptions[]
     */
     ...
     * 
     * @param RoleEligibilityScheduleFilterByCurrentUserOptions[] $items
     * @return self
     */
    public function setValue(array|RoleEligibilityScheduleFilterByCurrentUserOptions $items, RoleEligibilityScheduleFilterByCurrentUserOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RoleEligibilityScheduleFilterByCurrentUserOptions> $value
     * @return self
     ...
     * 
     * @param RoleEligibilityScheduleFilterByCurrentUserOptions $item
     * @return self
     */
    public function addValue(RoleEligibilityScheduleFilterByCurrentUserOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return RoleEligibilityScheduleFilterByCurrentUserOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, RoleEligibilityScheduleFilterByCurrentUserOptions>
     */
