...
/**
 * RoleEligibilityScheduleFilterByCurrentUserOptionsCollectionResponse - Collection response
 */
class RoleEligibilityScheduleFilterByCurrentUserOptionsCollectionResponse
{
    /**
     * @var array<int, RoleEligibilityScheduleFilterByCurrentUserOptions>
     */
    public array $value = [];
