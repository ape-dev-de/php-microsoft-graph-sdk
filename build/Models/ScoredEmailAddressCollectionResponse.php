...
/**
 * Collection response for ScoredEmailAddress
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ScoredEmailAddressCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ScoredEmailAddress[] $items
     * @return self
     */
    public function setValue(array|ScoredEmailAddress $items, ScoredEmailAddress ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ScoredEmailAddress> $value
     * @return self
     ...
     * 
     * @param ScoredEmailAddress $item
     * @return self
     */
    public function addValue(ScoredEmailAddress $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ScoredEmailAddress|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ScoredEmailAddress>
     */
