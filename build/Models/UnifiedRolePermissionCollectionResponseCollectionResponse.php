...
/**
 * Collection response for UnifiedRolePermissionCollectionResponse
 */
class UnifiedRolePermissionCollectionResponseCollectionResponse
{
    /**
     * @var UnifiedRolePermissionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedRolePermissionCollectionResponse ...$items Variable number of UnifiedRolePermissionCollectionResponse items
     * @return self
     */
    public function setValue(UnifiedRolePermissionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UnifiedRolePermissionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UnifiedRolePermissionCollectionResponse $item
     * @return self
     */
    public function addValue(UnifiedRolePermissionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
