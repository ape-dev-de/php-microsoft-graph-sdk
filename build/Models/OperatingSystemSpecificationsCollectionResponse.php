 ...
 */
class OperatingSystemSpecificationsCollectionResponse
{
    /**
     ...
     * 
     * @param OperatingSystemSpecifications ...$items Variable number of OperatingSystemSpecifications items
     * @return self
     */
    public function setValue(OperatingSystemSpecifications ...$items): self
    {
        $this->value = $items;
        return $this;
    }
