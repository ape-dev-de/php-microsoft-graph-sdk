...
/**
 * Collection response for OperatingSystemSpecifications
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OperatingSystemSpecificationsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OperatingSystemSpecifications[]
     */
    private array $value = [];
     ...
     * 
     * @param OperatingSystemSpecifications[] $items
     * @return self
     */
    public function setValue(array|OperatingSystemSpecifications $items, OperatingSystemSpecifications ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OperatingSystemSpecifications> $value
     * @return self
     ...
     * 
     * @param OperatingSystemSpecifications $item
     * @return self
     */
    public function addValue(OperatingSystemSpecifications $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OperatingSystemSpecifications>
     */
