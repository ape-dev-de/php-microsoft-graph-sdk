...
/**
 * Collection response for ServiceHealthIssueCollectionResponse
 */
class ServiceHealthIssueCollectionResponseCollectionResponse
{
    /**
     * @var ServiceHealthIssueCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ServiceHealthIssueCollectionResponse ...$items Variable number of ServiceHealthIssueCollectionResponse items
     * @return self
     */
    public function setValue(ServiceHealthIssueCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ServiceHealthIssueCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ServiceHealthIssueCollectionResponse $item
     * @return self
     */
    public function addValue(ServiceHealthIssueCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
