...
/**
 * Collection response for PlannerChecklistItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerChecklistItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PlannerChecklistItem[]
     */
    private array $value = [];
     ...
     * 
     * @param PlannerChecklistItem[] $items
     * @return self
     */
    public function setValue(array|PlannerChecklistItem $items, PlannerChecklistItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PlannerChecklistItem> $value
     * @return self
     ...
     * 
     * @param PlannerChecklistItem $item
     * @return self
     */
    public function addValue(PlannerChecklistItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PlannerChecklistItem|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PlannerChecklistItem>
     */
