 ...
 */
class PlannerChecklistItemCollectionResponse
{
    /**
     ...
     * 
     * @param PlannerChecklistItem ...$items Variable number of PlannerChecklistItem items
     * @return self
     */
    public function setValue(PlannerChecklistItem ...$items): self
    {
        $this->value = $items;
        return $this;
    }
