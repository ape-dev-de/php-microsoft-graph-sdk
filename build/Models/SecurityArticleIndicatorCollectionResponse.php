...
/**
 * Collection response for SecurityArticleIndicator
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityArticleIndicatorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityArticleIndicator[] $items
     * @return self
     */
    public function setValue(array|SecurityArticleIndicator $items, SecurityArticleIndicator ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityArticleIndicator> $value
     * @return self
     ...
     * 
     * @param SecurityArticleIndicator $item
     * @return self
     */
    public function addValue(SecurityArticleIndicator $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityArticleIndicator>
     */
