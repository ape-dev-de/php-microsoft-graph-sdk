...
/**
 * Collection response for DefaultInvitationRedemptionIdentityProviderConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DefaultInvitationRedemptionIdentityProviderConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DefaultInvitationRedemptionIdentityProviderConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param DefaultInvitationRedemptionIdentityProviderConfiguration[] $items
     * @return self
     */
    public function setValue(array|DefaultInvitationRedemptionIdentityProviderConfiguration $items, DefaultInvitationRedemptionIdentityProviderConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DefaultInvitationRedemptionIdentityProviderConfiguration> $value
     * @return self
     ...
     * 
     * @param DefaultInvitationRedemptionIdentityProviderConfiguration $item
     * @return self
     */
    public function addValue(DefaultInvitationRedemptionIdentityProviderConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DefaultInvitationRedemptionIdentityProviderConfiguration>
     */
