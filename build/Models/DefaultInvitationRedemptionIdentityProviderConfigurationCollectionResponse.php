...
/**
 * DefaultInvitationRedemptionIdentityProviderConfigurationCollectionResponse - Collection response
 */
class DefaultInvitationRedemptionIdentityProviderConfigurationCollectionResponse
{
    /**
     * @var array<int, DefaultInvitationRedemptionIdentityProviderConfiguration>
     */
    public array $value = [];
