...
/**
 * Collection response for UnifiedRoleManagementPolicyAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRoleManagementPolicyAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UnifiedRoleManagementPolicyAssignment[] $items
     * @return self
     */
    public function setValue(array|UnifiedRoleManagementPolicyAssignment $items, UnifiedRoleManagementPolicyAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRoleManagementPolicyAssignment> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleManagementPolicyAssignment $item
     * @return self
     */
    public function addValue(UnifiedRoleManagementPolicyAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRoleManagementPolicyAssignment>
     */
