...
/**
 * Collection response for AddLargeGalleryViewOperationCollectionResponse
 */
class AddLargeGalleryViewOperationCollectionResponseCollectionResponse
{
    /**
     * @var AddLargeGalleryViewOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AddLargeGalleryViewOperationCollectionResponse ...$items Variable number of AddLargeGalleryViewOperationCollectionResponse items
     * @return self
     */
    public function setValue(AddLargeGalleryViewOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AddLargeGalleryViewOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AddLargeGalleryViewOperationCollectionResponse $item
     * @return self
     */
    public function addValue(AddLargeGalleryViewOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
