...
/**
 * Collection response for DefenderThreatAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DefenderThreatActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DefenderThreatAction[]
     */
    private array $value = [];
     ...
     * 
     * @param DefenderThreatAction[] $items
     * @return self
     */
    public function setValue(array|DefenderThreatAction $items, DefenderThreatAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DefenderThreatAction> $value
     * @return self
     ...
     * 
     * @param DefenderThreatAction $item
     * @return self
     */
    public function addValue(DefenderThreatAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DefenderThreatAction>
     */
