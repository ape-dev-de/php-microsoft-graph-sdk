...
/**
 * Collection response for NetworkConnectionCollectionResponse
 */
class NetworkConnectionCollectionResponseCollectionResponse
{
    /**
     * @var NetworkConnectionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param NetworkConnectionCollectionResponse ...$items Variable number of NetworkConnectionCollectionResponse items
     * @return self
     */
    public function setValue(NetworkConnectionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<NetworkConnectionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param NetworkConnectionCollectionResponse $item
     * @return self
     */
    public function addValue(NetworkConnectionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
