...
/**
 * Collection response for SelfServiceSignUpAuthenticationFlowConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SelfServiceSignUpAuthenticationFlowConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SelfServiceSignUpAuthenticationFlowConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param SelfServiceSignUpAuthenticationFlowConfiguration[] $items
     * @return self
     */
    public function setValue(array|SelfServiceSignUpAuthenticationFlowConfiguration $items, SelfServiceSignUpAuthenticationFlowConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SelfServiceSignUpAuthenticationFlowConfiguration> $value
     * @return self
     ...
     * 
     * @param SelfServiceSignUpAuthenticationFlowConfiguration $item
     * @return self
     */
    public function addValue(SelfServiceSignUpAuthenticationFlowConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SelfServiceSignUpAuthenticationFlowConfiguration>
     */
