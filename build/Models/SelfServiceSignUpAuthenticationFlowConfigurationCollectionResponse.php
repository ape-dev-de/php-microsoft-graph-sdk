 ...
 */
class SelfServiceSignUpAuthenticationFlowConfigurationCollectionResponse
{
    /**
     ...
     * 
     * @param SelfServiceSignUpAuthenticationFlowConfiguration ...$items Variable number of SelfServiceSignUpAuthenticationFlowConfiguration items
     * @return self
     */
    public function setValue(SelfServiceSignUpAuthenticationFlowConfiguration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
