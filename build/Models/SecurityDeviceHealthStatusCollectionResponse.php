...
/**
 * Collection response for SecurityDeviceHealthStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityDeviceHealthStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityDeviceHealthStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityDeviceHealthStatus[]
     */
     ...
     * 
     * @param SecurityDeviceHealthStatus[] $items
     * @return self
     */
    public function setValue(array|SecurityDeviceHealthStatus $items, SecurityDeviceHealthStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityDeviceHealthStatus> $value
     * @return self
     ...
     * 
     * @param SecurityDeviceHealthStatus $item
     * @return self
     */
    public function addValue(SecurityDeviceHealthStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityDeviceHealthStatus|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityDeviceHealthStatus>
     */
