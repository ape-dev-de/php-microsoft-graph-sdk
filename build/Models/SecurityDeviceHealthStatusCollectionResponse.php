...
/**
 * SecurityDeviceHealthStatusCollectionResponse - Collection response
 */
class SecurityDeviceHealthStatusCollectionResponse
{
    /**
     * @var array<int, SecurityDeviceHealthStatus>
     */
    public array $value = [];
