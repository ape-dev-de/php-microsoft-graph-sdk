...
/**
 * Collection response for OnenoteResourceCollectionResponse
 */
class OnenoteResourceCollectionResponseCollectionResponse
{
    /**
     * @var OnenoteResourceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param OnenoteResourceCollectionResponse ...$items Variable number of OnenoteResourceCollectionResponse items
     * @return self
     */
    public function setValue(OnenoteResourceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<OnenoteResourceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param OnenoteResourceCollectionResponse $item
     * @return self
     */
    public function addValue(OnenoteResourceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
