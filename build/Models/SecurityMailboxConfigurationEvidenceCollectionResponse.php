 ...
 */
class SecurityMailboxConfigurationEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityMailboxConfigurationEvidence ...$items Variable number of SecurityMailboxConfigurationEvidence items
     * @return self
     */
    public function setValue(SecurityMailboxConfigurationEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
