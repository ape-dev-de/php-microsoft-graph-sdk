...
/**
 * Collection response for SecurityMailboxConfigurationEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityMailboxConfigurationEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityMailboxConfigurationEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityMailboxConfigurationEvidence[]
     */
     ...
     * 
     * @param SecurityMailboxConfigurationEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityMailboxConfigurationEvidence $items, SecurityMailboxConfigurationEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityMailboxConfigurationEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityMailboxConfigurationEvidence $item
     * @return self
     */
    public function addValue(SecurityMailboxConfigurationEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityMailboxConfigurationEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityMailboxConfigurationEvidence>
     */
