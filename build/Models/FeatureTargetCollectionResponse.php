 ...
 */
class FeatureTargetCollectionResponse
{
    /**
     * @var FeatureTarget[]
     */
     ...
     * 
     * @param FeatureTarget ...$items Variable number of FeatureTarget items
     * @return self
     */
    public function setValue(FeatureTarget ...$items): self
    {
        $this->value = $items;
        return $this;
    }
