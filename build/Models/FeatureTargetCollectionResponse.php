...
/**
 * Collection response for FeatureTarget
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FeatureTargetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FeatureTarget[]
     */
     ...
     * 
     * @param FeatureTarget[] $items
     * @return self
     */
    public function setValue(array|FeatureTarget $items, FeatureTarget ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FeatureTarget> $value
     * @return self
     ...
     * 
     * @param FeatureTarget $item
     * @return self
     */
    public function addValue(FeatureTarget $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FeatureTarget>
     */
