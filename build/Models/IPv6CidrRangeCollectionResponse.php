...
/**
 * Collection response for IPv6CidrRange
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IPv6CidrRangeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IPv6CidrRange[]
     */
     ...
     * 
     * @param IPv6CidrRange[] $items
     * @return self
     */
    public function setValue(array|IPv6CidrRange $items, IPv6CidrRange ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IPv6CidrRange> $value
     * @return self
     ...
     * 
     * @param IPv6CidrRange $item
     * @return self
     */
    public function addValue(IPv6CidrRange $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IPv6CidrRange>
     */
