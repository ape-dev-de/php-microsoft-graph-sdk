 ...
 */
class IPv6CidrRangeCollectionResponse
{
    /**
     * @var IPv6CidrRange[]
     */
     ...
     * 
     * @param IPv6CidrRange ...$items Variable number of IPv6CidrRange items
     * @return self
     */
    public function setValue(IPv6CidrRange ...$items): self
    {
        $this->value = $items;
        return $this;
    }
