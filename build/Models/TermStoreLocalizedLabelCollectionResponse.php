...
/**
 * Collection response for TermStoreLocalizedLabel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TermStoreLocalizedLabelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return TermStoreLocalizedLabel[]
     */
     ...
     * 
     * @param TermStoreLocalizedLabel[] $items
     * @return self
     */
    public function setValue(array|TermStoreLocalizedLabel $items, TermStoreLocalizedLabel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TermStoreLocalizedLabel> $value
     * @return self
     ...
     * 
     * @param TermStoreLocalizedLabel $item
     * @return self
     */
    public function addValue(TermStoreLocalizedLabel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TermStoreLocalizedLabel|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TermStoreLocalizedLabel>
     */
