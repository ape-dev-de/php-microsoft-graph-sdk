...
/**
 * Collection response for SecurityProtocolType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityProtocolTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityProtocolType[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityProtocolType[] $items
     * @return self
     */
    public function setValue(array|SecurityProtocolType $items, SecurityProtocolType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityProtocolType> $value
     * @return self
     ...
     * 
     * @param SecurityProtocolType $item
     * @return self
     */
    public function addValue(SecurityProtocolType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityProtocolType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityProtocolType>
     */
