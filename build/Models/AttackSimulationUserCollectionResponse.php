...
/**
 * Collection response for AttackSimulationUser
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttackSimulationUserCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AttackSimulationUser[]
     */
    private array $value = [];
     ...
     * 
     * @param AttackSimulationUser[] $items
     * @return self
     */
    public function setValue(array|AttackSimulationUser $items, AttackSimulationUser ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttackSimulationUser> $value
     * @return self
     ...
     * 
     * @param AttackSimulationUser $item
     * @return self
     */
    public function addValue(AttackSimulationUser $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AttackSimulationUser>
     */
