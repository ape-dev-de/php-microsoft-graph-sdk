 ...
 */
class AttackSimulationUserCollectionResponse
{
    /**
     ...
     * 
     * @param AttackSimulationUser ...$items Variable number of AttackSimulationUser items
     * @return self
     */
    public function setValue(AttackSimulationUser ...$items): self
    {
        $this->value = $items;
        return $this;
    }
