...
/**
 * Collection response for WorkbookIcon
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookIconCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookIcon[]
     */
     ...
     * 
     * @param WorkbookIcon[] $items
     * @return self
     */
    public function setValue(array|WorkbookIcon $items, WorkbookIcon ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookIcon> $value
     * @return self
     ...
     * 
     * @param WorkbookIcon $item
     * @return self
     */
    public function addValue(WorkbookIcon $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookIcon>
     */
