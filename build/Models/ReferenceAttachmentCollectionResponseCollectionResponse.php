...
/**
 * Collection response for ReferenceAttachmentCollectionResponse
 */
class ReferenceAttachmentCollectionResponseCollectionResponse
{
    /**
     * @var ReferenceAttachmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ReferenceAttachmentCollectionResponse ...$items Variable number of ReferenceAttachmentCollectionResponse items
     * @return self
     */
    public function setValue(ReferenceAttachmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ReferenceAttachmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ReferenceAttachmentCollectionResponse $item
     * @return self
     */
    public function addValue(ReferenceAttachmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
