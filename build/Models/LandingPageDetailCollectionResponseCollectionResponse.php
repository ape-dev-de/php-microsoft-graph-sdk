...
/**
 * Collection response for LandingPageDetailCollectionResponse
 */
class LandingPageDetailCollectionResponseCollectionResponse
{
    /**
     * @var LandingPageDetailCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param LandingPageDetailCollectionResponse ...$items Variable number of LandingPageDetailCollectionResponse items
     * @return self
     */
    public function setValue(LandingPageDetailCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<LandingPageDetailCollectionResponse> $value
     * @return self
     ...
     * 
     * @param LandingPageDetailCollectionResponse $item
     * @return self
     */
    public function addValue(LandingPageDetailCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
