...
/**
 * Collection response for SiteProtectionUnitsBulkAdditionJob
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SiteProtectionUnitsBulkAdditionJobCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SiteProtectionUnitsBulkAdditionJob[] $items
     * @return self
     */
    public function setValue(array|SiteProtectionUnitsBulkAdditionJob $items, SiteProtectionUnitsBulkAdditionJob ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SiteProtectionUnitsBulkAdditionJob> $value
     * @return self
     ...
     * 
     * @param SiteProtectionUnitsBulkAdditionJob $item
     * @return self
     */
    public function addValue(SiteProtectionUnitsBulkAdditionJob $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SiteProtectionUnitsBulkAdditionJob>
     */
