...
/**
 * OnenotePatchInsertPositionCollectionResponse - Collection response
 */
class OnenotePatchInsertPositionCollectionResponse
{
    /**
     * @var array<int, OnenotePatchInsertPosition>
     */
    public array $value = [];
