...
/**
 * Collection response for OnenotePatchInsertPosition
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnenotePatchInsertPositionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnenotePatchInsertPosition[]
     */
    private array $value = [];
     ...
     * 
     * @return OnenotePatchInsertPosition[]
     */
     ...
     * 
     * @param OnenotePatchInsertPosition[] $items
     * @return self
     */
    public function setValue(array|OnenotePatchInsertPosition $items, OnenotePatchInsertPosition ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnenotePatchInsertPosition> $value
     * @return self
     ...
     * 
     * @param OnenotePatchInsertPosition $item
     * @return self
     */
    public function addValue(OnenotePatchInsertPosition $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnenotePatchInsertPosition>
     */
