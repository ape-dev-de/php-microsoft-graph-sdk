 ...
 */
class OrganizationalBrandingCollectionResponse
{
    /**
     ...
     * 
     * @param OrganizationalBranding ...$items Variable number of OrganizationalBranding items
     * @return self
     */
    public function setValue(OrganizationalBranding ...$items): self
    {
        $this->value = $items;
        return $this;
    }
