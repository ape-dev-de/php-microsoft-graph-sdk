...
/**
 * Collection response for OrganizationalBranding
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OrganizationalBrandingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OrganizationalBranding[]
     */
    private array $value = [];
     ...
     * 
     * @param OrganizationalBranding[] $items
     * @return self
     */
    public function setValue(array|OrganizationalBranding $items, OrganizationalBranding ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OrganizationalBranding> $value
     * @return self
     ...
     * 
     * @param OrganizationalBranding $item
     * @return self
     */
    public function addValue(OrganizationalBranding $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OrganizationalBranding>
     */
