...
/**
 * Collection response for PrintConnector
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintConnectorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrintConnector[]
     */
     ...
     * 
     * @param PrintConnector[] $items
     * @return self
     */
    public function setValue(array|PrintConnector $items, PrintConnector ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintConnector> $value
     * @return self
     ...
     * 
     * @param PrintConnector $item
     * @return self
     */
    public function addValue(PrintConnector $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintConnector>
     */
