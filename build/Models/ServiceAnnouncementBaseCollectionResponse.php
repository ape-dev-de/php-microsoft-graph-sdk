...
/**
 * Collection response for ServiceAnnouncementBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServiceAnnouncementBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ServiceAnnouncementBase[]
     */
    private array $value = [];
     ...
     * 
     * @param ServiceAnnouncementBase[] $items
     * @return self
     */
    public function setValue(array|ServiceAnnouncementBase $items, ServiceAnnouncementBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServiceAnnouncementBase> $value
     * @return self
     ...
     * 
     * @param ServiceAnnouncementBase $item
     * @return self
     */
    public function addValue(ServiceAnnouncementBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ServiceAnnouncementBase|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ServiceAnnouncementBase>
     */
