 ...
 */
class ServiceAnnouncementBaseCollectionResponse
{
    /**
     ...
     * 
     * @param ServiceAnnouncementBase ...$items Variable number of ServiceAnnouncementBase items
     * @return self
     */
    public function setValue(ServiceAnnouncementBase ...$items): self
    {
        $this->value = $items;
        return $this;
    }
