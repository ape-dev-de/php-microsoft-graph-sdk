...
/**
 * Collection response for SecurityCategoryTemplateCollectionResponse
 */
class SecurityCategoryTemplateCollectionResponseCollectionResponse
{
    /**
     * @var SecurityCategoryTemplateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityCategoryTemplateCollectionResponse[]
     */
     ...
     * 
     * @param SecurityCategoryTemplateCollectionResponse ...$items Variable number of SecurityCategoryTemplateCollectionResponse items
     * @return self
     */
    public function setValue(SecurityCategoryTemplateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityCategoryTemplateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityCategoryTemplateCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityCategoryTemplateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
