...
/**
 * Collection response for MediaContentRatingUnitedStates
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MediaContentRatingUnitedStatesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MediaContentRatingUnitedStates[] $items
     * @return self
     */
    public function setValue(array|MediaContentRatingUnitedStates $items, MediaContentRatingUnitedStates ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MediaContentRatingUnitedStates> $value
     * @return self
     ...
     * 
     * @param MediaContentRatingUnitedStates $item
     * @return self
     */
    public function addValue(MediaContentRatingUnitedStates $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MediaContentRatingUnitedStates>
     */
