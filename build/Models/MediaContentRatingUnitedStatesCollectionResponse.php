 ...
 */
class MediaContentRatingUnitedStatesCollectionResponse
{
    /**
     ...
     * 
     * @param MediaContentRatingUnitedStates ...$items Variable number of MediaContentRatingUnitedStates items
     * @return self
     */
    public function setValue(MediaContentRatingUnitedStates ...$items): self
    {
        $this->value = $items;
        return $this;
    }
