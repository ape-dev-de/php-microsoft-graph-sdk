...
/**
 * Collection response for ExternalUsersSelfServiceSignUpEventsFlow
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalUsersSelfServiceSignUpEventsFlowCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalUsersSelfServiceSignUpEventsFlow[]
     */
    private array $value = [];
     ...
     * 
     * @param ExternalUsersSelfServiceSignUpEventsFlow[] $items
     * @return self
     */
    public function setValue(array|ExternalUsersSelfServiceSignUpEventsFlow $items, ExternalUsersSelfServiceSignUpEventsFlow ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalUsersSelfServiceSignUpEventsFlow> $value
     * @return self
     ...
     * 
     * @param ExternalUsersSelfServiceSignUpEventsFlow $item
     * @return self
     */
    public function addValue(ExternalUsersSelfServiceSignUpEventsFlow $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ExternalUsersSelfServiceSignUpEventsFlow>
     */
