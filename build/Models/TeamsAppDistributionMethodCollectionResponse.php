...
/**
 * Collection response for TeamsAppDistributionMethod
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamsAppDistributionMethodCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return TeamsAppDistributionMethod[]
     */
     ...
     * 
     * @param TeamsAppDistributionMethod[] $items
     * @return self
     */
    public function setValue(array|TeamsAppDistributionMethod $items, TeamsAppDistributionMethod ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamsAppDistributionMethod> $value
     * @return self
     ...
     * 
     * @param TeamsAppDistributionMethod $item
     * @return self
     */
    public function addValue(TeamsAppDistributionMethod $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamsAppDistributionMethod>
     */
