...
/**
 * TeamsAppDistributionMethodCollectionResponse - Collection response
 */
class TeamsAppDistributionMethodCollectionResponse
{
    /**
     * @var array<int, TeamsAppDistributionMethod>
     */
    public array $value = [];
