...
/**
 * Collection response for RbacApplication
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RbacApplicationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RbacApplication[]
     */
     ...
     * 
     * @param RbacApplication[] $items
     * @return self
     */
    public function setValue(array|RbacApplication $items, RbacApplication ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RbacApplication> $value
     * @return self
     ...
     * 
     * @param RbacApplication $item
     * @return self
     */
    public function addValue(RbacApplication $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RbacApplication>
     */
