 ...
 */
class RbacApplicationCollectionResponse
{
    /**
     * @var RbacApplication[]
     */
     ...
     * 
     * @param RbacApplication ...$items Variable number of RbacApplication items
     * @return self
     */
    public function setValue(RbacApplication ...$items): self
    {
        $this->value = $items;
        return $this;
    }
