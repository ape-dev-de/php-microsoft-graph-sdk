...
class Event
{
     ...
     */
    private ?string $cancelledOccurrences;
    ...
    public function getCancelledOccurrences(): ?string
    {
        return $this->cancelledOccurrences;
    }

    public function setCancelledOccurrences(?string $cancelledOccurrences): self
    {
