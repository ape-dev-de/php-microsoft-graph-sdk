...
/**
 * Collection response for AzureAdTokenAuthentication
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AzureAdTokenAuthenticationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AzureAdTokenAuthentication[]
     */
    private array $value = [];
     ...
     * 
     * @param AzureAdTokenAuthentication[] $items
     * @return self
     */
    public function setValue(array|AzureAdTokenAuthentication $items, AzureAdTokenAuthentication ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AzureAdTokenAuthentication> $value
     * @return self
     ...
     * 
     * @param AzureAdTokenAuthentication $item
     * @return self
     */
    public function addValue(AzureAdTokenAuthentication $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AzureAdTokenAuthentication|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AzureAdTokenAuthentication>
     */
