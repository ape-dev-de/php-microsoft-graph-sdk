 ...
 */
class AzureAdTokenAuthenticationCollectionResponse
{
    /**
     ...
     * 
     * @param AzureAdTokenAuthentication ...$items Variable number of AzureAdTokenAuthentication items
     * @return self
     */
    public function setValue(AzureAdTokenAuthentication ...$items): self
    {
        $this->value = $items;
        return $this;
    }
