...
/**
 * Collection response for ShiftAvailabilityCollectionResponse
 */
class ShiftAvailabilityCollectionResponseCollectionResponse
{
    /**
     * @var ShiftAvailabilityCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ShiftAvailabilityCollectionResponse ...$items Variable number of ShiftAvailabilityCollectionResponse items
     * @return self
     */
    public function setValue(ShiftAvailabilityCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ShiftAvailabilityCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ShiftAvailabilityCollectionResponse $item
     * @return self
     */
    public function addValue(ShiftAvailabilityCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
