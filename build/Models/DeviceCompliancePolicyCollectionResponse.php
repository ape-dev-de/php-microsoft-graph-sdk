...
/**
 * Collection response for DeviceCompliancePolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceCompliancePolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceCompliancePolicy[] $items
     * @return self
     */
    public function setValue(array|DeviceCompliancePolicy $items, DeviceCompliancePolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceCompliancePolicy> $value
     * @return self
     ...
     * 
     * @param DeviceCompliancePolicy $item
     * @return self
     */
    public function addValue(DeviceCompliancePolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceCompliancePolicy>
     */
