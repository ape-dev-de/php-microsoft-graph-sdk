...
/**
 * Collection response for StringKeyStringValuePair
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class StringKeyStringValuePairCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param StringKeyStringValuePair[] $items
     * @return self
     */
    public function setValue(array|StringKeyStringValuePair $items, StringKeyStringValuePair ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<StringKeyStringValuePair> $value
     * @return self
     ...
     * 
     * @param StringKeyStringValuePair $item
     * @return self
     */
    public function addValue(StringKeyStringValuePair $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, StringKeyStringValuePair>
     */
