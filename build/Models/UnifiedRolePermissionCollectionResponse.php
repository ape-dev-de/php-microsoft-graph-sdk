...
/**
 * Collection response for UnifiedRolePermission
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRolePermissionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UnifiedRolePermission[] $items
     * @return self
     */
    public function setValue(array|UnifiedRolePermission $items, UnifiedRolePermission ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRolePermission> $value
     * @return self
     ...
     * 
     * @param UnifiedRolePermission $item
     * @return self
     */
    public function addValue(UnifiedRolePermission $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UnifiedRolePermission|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRolePermission>
     */
