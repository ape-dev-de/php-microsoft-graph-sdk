...
/**
 * Collection response for SecurityWhoisHistoryRecordCollectionResponse
 */
class SecurityWhoisHistoryRecordCollectionResponseCollectionResponse
{
    /**
     * @var SecurityWhoisHistoryRecordCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityWhoisHistoryRecordCollectionResponse ...$items Variable number of SecurityWhoisHistoryRecordCollectionResponse items
     * @return self
     */
    public function setValue(SecurityWhoisHistoryRecordCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityWhoisHistoryRecordCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityWhoisHistoryRecordCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityWhoisHistoryRecordCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
