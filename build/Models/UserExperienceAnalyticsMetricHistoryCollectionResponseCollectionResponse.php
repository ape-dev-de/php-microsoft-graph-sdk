...
/**
 * Collection response for UserExperienceAnalyticsMetricHistoryCollectionResponse
 */
class UserExperienceAnalyticsMetricHistoryCollectionResponseCollectionResponse
{
    /**
     * @var UserExperienceAnalyticsMetricHistoryCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UserExperienceAnalyticsMetricHistoryCollectionResponse ...$items Variable number of UserExperienceAnalyticsMetricHistoryCollectionResponse items
     * @return self
     */
    public function setValue(UserExperienceAnalyticsMetricHistoryCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UserExperienceAnalyticsMetricHistoryCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsMetricHistoryCollectionResponse $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsMetricHistoryCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
