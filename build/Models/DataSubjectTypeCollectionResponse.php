...
/**
 * Collection response for DataSubjectType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DataSubjectTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DataSubjectType[]
     */
     ...
     * 
     * @param DataSubjectType[] $items
     * @return self
     */
    public function setValue(array|DataSubjectType $items, DataSubjectType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DataSubjectType> $value
     * @return self
     ...
     * 
     * @param DataSubjectType $item
     * @return self
     */
    public function addValue(DataSubjectType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DataSubjectType>
     */
