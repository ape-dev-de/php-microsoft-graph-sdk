 ...
 */
class PendingContentUpdateCollectionResponse
{
    /**
     ...
     * 
     * @param PendingContentUpdate ...$items Variable number of PendingContentUpdate items
     * @return self
     */
    public function setValue(PendingContentUpdate ...$items): self
    {
        $this->value = $items;
        return $this;
    }
