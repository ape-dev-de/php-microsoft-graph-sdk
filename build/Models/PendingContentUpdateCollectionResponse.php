...
/**
 * Collection response for PendingContentUpdate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PendingContentUpdateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PendingContentUpdate[]
     */
    private array $value = [];
     ...
     * 
     * @param PendingContentUpdate[] $items
     * @return self
     */
    public function setValue(array|PendingContentUpdate $items, PendingContentUpdate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PendingContentUpdate> $value
     * @return self
     ...
     * 
     * @param PendingContentUpdate $item
     * @return self
     */
    public function addValue(PendingContentUpdate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PendingContentUpdate>
     */
