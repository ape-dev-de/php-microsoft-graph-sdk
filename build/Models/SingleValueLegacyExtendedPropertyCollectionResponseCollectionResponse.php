...
/**
 * Collection response for SingleValueLegacyExtendedPropertyCollectionResponse
 */
class SingleValueLegacyExtendedPropertyCollectionResponseCollectionResponse
{
    /**
     * @var SingleValueLegacyExtendedPropertyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SingleValueLegacyExtendedPropertyCollectionResponse ...$items Variable number of SingleValueLegacyExtendedPropertyCollectionResponse items
     * @return self
     */
    public function setValue(SingleValueLegacyExtendedPropertyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SingleValueLegacyExtendedPropertyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SingleValueLegacyExtendedPropertyCollectionResponse $item
     * @return self
     */
    public function addValue(SingleValueLegacyExtendedPropertyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
