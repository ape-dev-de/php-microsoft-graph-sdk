...
/**
 * Collection response for GroupLifecyclePolicyCollectionResponse
 */
class GroupLifecyclePolicyCollectionResponseCollectionResponse
{
    /**
     * @var GroupLifecyclePolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param GroupLifecyclePolicyCollectionResponse ...$items Variable number of GroupLifecyclePolicyCollectionResponse items
     * @return self
     */
    public function setValue(GroupLifecyclePolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<GroupLifecyclePolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param GroupLifecyclePolicyCollectionResponse $item
     * @return self
     */
    public function addValue(GroupLifecyclePolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
