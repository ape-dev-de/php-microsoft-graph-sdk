...
/**
 * Collection response for AudioConferencing
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AudioConferencingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AudioConferencing[] $items
     * @return self
     */
    public function setValue(array|AudioConferencing $items, AudioConferencing ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AudioConferencing> $value
     * @return self
     ...
     * 
     * @param AudioConferencing $item
     * @return self
     */
    public function addValue(AudioConferencing $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AudioConferencing>
     */
