 ...
 */
class AudioConferencingCollectionResponse
{
    /**
     ...
     * 
     * @param AudioConferencing ...$items Variable number of AudioConferencing items
     * @return self
     */
    public function setValue(AudioConferencing ...$items): self
    {
        $this->value = $items;
        return $this;
    }
