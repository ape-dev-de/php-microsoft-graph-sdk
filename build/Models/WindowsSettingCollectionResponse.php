...
/**
 * Collection response for WindowsSetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsSettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsSetting[]
     */
     ...
     * 
     * @param WindowsSetting[] $items
     * @return self
     */
    public function setValue(array|WindowsSetting $items, WindowsSetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsSetting> $value
     * @return self
     ...
     * 
     * @param WindowsSetting $item
     * @return self
     */
    public function addValue(WindowsSetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsSetting>
     */
