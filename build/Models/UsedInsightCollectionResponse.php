...
/**
 * Collection response for UsedInsight
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UsedInsightCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UsedInsight[]
     */
     ...
     * 
     * @param UsedInsight[] $items
     * @return self
     */
    public function setValue(array|UsedInsight $items, UsedInsight ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param UsedInsight $item
     * @return self
     */
    public function addValue(UsedInsight $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UsedInsight>
     */
