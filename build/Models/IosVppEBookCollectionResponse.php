...
/**
 * Collection response for IosVppEBook
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosVppEBookCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IosVppEBook[]
     */
     ...
     * 
     * @param IosVppEBook[] $items
     * @return self
     */
    public function setValue(array|IosVppEBook $items, IosVppEBook ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param IosVppEBook $item
     * @return self
     */
    public function addValue(IosVppEBook $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IosVppEBook>
     */
