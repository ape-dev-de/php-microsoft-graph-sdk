...
/**
 * Collection response for RecurrenceRangeType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RecurrenceRangeTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param RecurrenceRangeType[] $items
     * @return self
     */
    public function setValue(array|RecurrenceRangeType $items, RecurrenceRangeType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RecurrenceRangeType> $value
     * @return self
     ...
     * 
     * @param RecurrenceRangeType $item
     * @return self
     */
    public function addValue(RecurrenceRangeType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RecurrenceRangeType>
     */
