...
/**
 * Collection response for VirtualEventSessionCollectionResponse
 */
class VirtualEventSessionCollectionResponseCollectionResponse
{
    /**
     * @var VirtualEventSessionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param VirtualEventSessionCollectionResponse ...$items Variable number of VirtualEventSessionCollectionResponse items
     * @return self
     */
    public function setValue(VirtualEventSessionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<VirtualEventSessionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param VirtualEventSessionCollectionResponse $item
     * @return self
     */
    public function addValue(VirtualEventSessionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
