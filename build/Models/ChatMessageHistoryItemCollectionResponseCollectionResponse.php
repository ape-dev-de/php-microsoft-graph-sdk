...
/**
 * Collection response for ChatMessageHistoryItemCollectionResponse
 */
class ChatMessageHistoryItemCollectionResponseCollectionResponse
{
    /**
     * @var ChatMessageHistoryItemCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ChatMessageHistoryItemCollectionResponse ...$items Variable number of ChatMessageHistoryItemCollectionResponse items
     * @return self
     */
    public function setValue(ChatMessageHistoryItemCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ChatMessageHistoryItemCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ChatMessageHistoryItemCollectionResponse $item
     * @return self
     */
    public function addValue(ChatMessageHistoryItemCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
