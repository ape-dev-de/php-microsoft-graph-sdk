...
/**
 * Collection response for SecurityDeviceEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityDeviceEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityDeviceEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityDeviceEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityDeviceEvidence $items, SecurityDeviceEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityDeviceEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityDeviceEvidence $item
     * @return self
     */
    public function addValue(SecurityDeviceEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityDeviceEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityDeviceEvidence>
     */
