 ...
 */
class SecurityDeviceEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityDeviceEvidence ...$items Variable number of SecurityDeviceEvidence items
     * @return self
     */
    public function setValue(SecurityDeviceEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
