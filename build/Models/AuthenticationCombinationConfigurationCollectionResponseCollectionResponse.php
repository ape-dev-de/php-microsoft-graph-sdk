...
/**
 * Collection response for AuthenticationCombinationConfigurationCollectionResponse
 */
class AuthenticationCombinationConfigurationCollectionResponseCollectionResponse
{
    /**
     * @var AuthenticationCombinationConfigurationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AuthenticationCombinationConfigurationCollectionResponse ...$items Variable number of AuthenticationCombinationConfigurationCollectionResponse items
     * @return self
     */
    public function setValue(AuthenticationCombinationConfigurationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AuthenticationCombinationConfigurationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AuthenticationCombinationConfigurationCollectionResponse $item
     * @return self
     */
    public function addValue(AuthenticationCombinationConfigurationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
