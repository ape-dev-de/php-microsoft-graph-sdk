...
/**
 * SecurityHostReputationClassificationCollectionResponse - Collection response
 */
class SecurityHostReputationClassificationCollectionResponse
{
    /**
     * @var array<int, SecurityHostReputationClassification>
     */
    public array $value = [];
