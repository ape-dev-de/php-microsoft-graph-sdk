...
/**
 * Collection response for SecurityHostReputationClassification
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHostReputationClassificationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityHostReputationClassification[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityHostReputationClassification[]
     */
     ...
     * 
     * @param SecurityHostReputationClassification[] $items
     * @return self
     */
    public function setValue(array|SecurityHostReputationClassification $items, SecurityHostReputationClassification ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHostReputationClassification> $value
     * @return self
     ...
     * 
     * @param SecurityHostReputationClassification $item
     * @return self
     */
    public function addValue(SecurityHostReputationClassification $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityHostReputationClassification|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityHostReputationClassification>
     */
