...
class ApiApplication
{
     ...
     * @var string[]
     */
    private array $knownClientApplications = [];
    ...
    /**
     * @param string[] $knownClientApplications
     */
    public function setKnownClientApplications(array $knownClientApplications): self
    {
