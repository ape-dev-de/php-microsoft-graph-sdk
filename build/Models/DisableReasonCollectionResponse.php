...
/**
 * Collection response for DisableReason
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DisableReasonCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DisableReason[]
     */
     ...
     * 
     * @param DisableReason[] $items
     * @return self
     */
    public function setValue(array|DisableReason $items, DisableReason ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DisableReason> $value
     * @return self
     ...
     * 
     * @param DisableReason $item
     * @return self
     */
    public function addValue(DisableReason $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DisableReason>
     */
