 ...
 */
class UserSolutionRootCollectionResponse
{
    /**
     ...
     * 
     * @param UserSolutionRoot ...$items Variable number of UserSolutionRoot items
     * @return self
     */
    public function setValue(UserSolutionRoot ...$items): self
    {
        $this->value = $items;
        return $this;
    }
