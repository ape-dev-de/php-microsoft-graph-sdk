...
/**
 * Collection response for UserSolutionRoot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserSolutionRootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserSolutionRoot[]
     */
    private array $value = [];
     ...
     * 
     * @param UserSolutionRoot[] $items
     * @return self
     */
    public function setValue(array|UserSolutionRoot $items, UserSolutionRoot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserSolutionRoot> $value
     * @return self
     ...
     * 
     * @param UserSolutionRoot $item
     * @return self
     */
    public function addValue(UserSolutionRoot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserSolutionRoot>
     */
