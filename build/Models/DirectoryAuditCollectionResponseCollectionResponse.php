...
/**
 * Collection response for DirectoryAuditCollectionResponse
 */
class DirectoryAuditCollectionResponseCollectionResponse
{
    /**
     * @var DirectoryAuditCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DirectoryAuditCollectionResponse ...$items Variable number of DirectoryAuditCollectionResponse items
     * @return self
     */
    public function setValue(DirectoryAuditCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DirectoryAuditCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DirectoryAuditCollectionResponse $item
     * @return self
     */
    public function addValue(DirectoryAuditCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
