...
/**
 * Collection response for SecurityArtifact
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityArtifactCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityArtifact[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityArtifact[] $items
     * @return self
     */
    public function setValue(array|SecurityArtifact $items, SecurityArtifact ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityArtifact> $value
     * @return self
     ...
     * 
     * @param SecurityArtifact $item
     * @return self
     */
    public function addValue(SecurityArtifact $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityArtifact>
     */
