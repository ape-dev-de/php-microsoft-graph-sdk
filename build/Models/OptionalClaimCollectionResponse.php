...
/**
 * Collection response for OptionalClaim
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OptionalClaimCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OptionalClaim[]
     */
     ...
     * 
     * @param OptionalClaim[] $items
     * @return self
     */
    public function setValue(array|OptionalClaim $items, OptionalClaim ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OptionalClaim> $value
     * @return self
     ...
     * 
     * @param OptionalClaim $item
     * @return self
     */
    public function addValue(OptionalClaim $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OptionalClaim>
     */
