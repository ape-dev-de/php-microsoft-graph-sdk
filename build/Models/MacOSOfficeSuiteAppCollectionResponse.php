...
/**
 * Collection response for MacOSOfficeSuiteApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MacOSOfficeSuiteAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MacOSOfficeSuiteApp[]
     */
    private array $value = [];
     ...
     * 
     * @param MacOSOfficeSuiteApp[] $items
     * @return self
     */
    public function setValue(array|MacOSOfficeSuiteApp $items, MacOSOfficeSuiteApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MacOSOfficeSuiteApp> $value
     * @return self
     ...
     * 
     * @param MacOSOfficeSuiteApp $item
     * @return self
     */
    public function addValue(MacOSOfficeSuiteApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MacOSOfficeSuiteApp|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MacOSOfficeSuiteApp>
     */
