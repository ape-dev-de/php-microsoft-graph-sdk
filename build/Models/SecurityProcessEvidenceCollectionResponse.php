...
/**
 * Collection response for SecurityProcessEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityProcessEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityProcessEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityProcessEvidence[]
     */
     ...
     * 
     * @param SecurityProcessEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityProcessEvidence $items, SecurityProcessEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityProcessEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityProcessEvidence $item
     * @return self
     */
    public function addValue(SecurityProcessEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityProcessEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityProcessEvidence>
     */
