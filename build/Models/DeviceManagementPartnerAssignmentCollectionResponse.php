...
/**
 * Collection response for DeviceManagementPartnerAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceManagementPartnerAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceManagementPartnerAssignment[] $items
     * @return self
     */
    public function setValue(array|DeviceManagementPartnerAssignment $items, DeviceManagementPartnerAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceManagementPartnerAssignment> $value
     * @return self
     ...
     * 
     * @param DeviceManagementPartnerAssignment $item
     * @return self
     */
    public function addValue(DeviceManagementPartnerAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return DeviceManagementPartnerAssignment|null
     */
     ...
     * 
     * @return \ArrayIterator<int, DeviceManagementPartnerAssignment>
     */
