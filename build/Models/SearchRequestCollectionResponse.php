 ...
 */
class SearchRequestCollectionResponse
{
    /**
     * @var SearchRequest[]
     */
     ...
     * 
     * @param SearchRequest ...$items Variable number of SearchRequest items
     * @return self
     */
    public function setValue(SearchRequest ...$items): self
    {
        $this->value = $items;
        return $this;
    }
