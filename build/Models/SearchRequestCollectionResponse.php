...
/**
 * Collection response for SearchRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SearchRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SearchRequest[]
     */
     ...
     * 
     * @param SearchRequest[] $items
     * @return self
     */
    public function setValue(array|SearchRequest $items, SearchRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SearchRequest> $value
     * @return self
     ...
     * 
     * @param SearchRequest $item
     * @return self
     */
    public function addValue(SearchRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SearchRequest>
     */
