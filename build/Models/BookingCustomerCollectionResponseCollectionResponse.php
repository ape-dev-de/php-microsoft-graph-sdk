...
/**
 * Collection response for BookingCustomerCollectionResponse
 */
class BookingCustomerCollectionResponseCollectionResponse
{
    /**
     * @var BookingCustomerCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BookingCustomerCollectionResponse ...$items Variable number of BookingCustomerCollectionResponse items
     * @return self
     */
    public function setValue(BookingCustomerCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<BookingCustomerCollectionResponse> $value
     * @return self
     ...
     * 
     * @param BookingCustomerCollectionResponse $item
     * @return self
     */
    public function addValue(BookingCustomerCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
