...
/**
 * Collection response for SearchAlterationType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SearchAlterationTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SearchAlterationType[]
     */
    private array $value = [];
     ...
     * 
     * @param SearchAlterationType[] $items
     * @return self
     */
    public function setValue(array|SearchAlterationType $items, SearchAlterationType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SearchAlterationType> $value
     * @return self
     ...
     * 
     * @param SearchAlterationType $item
     * @return self
     */
    public function addValue(SearchAlterationType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SearchAlterationType>
     */
