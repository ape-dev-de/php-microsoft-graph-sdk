...
/**
 * Collection response for MobileAppCollectionResponse
 */
class MobileAppCollectionResponseCollectionResponse
{
    /**
     * @var MobileAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MobileAppCollectionResponse ...$items Variable number of MobileAppCollectionResponse items
     * @return self
     */
    public function setValue(MobileAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MobileAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MobileAppCollectionResponse $item
     * @return self
     */
    public function addValue(MobileAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
