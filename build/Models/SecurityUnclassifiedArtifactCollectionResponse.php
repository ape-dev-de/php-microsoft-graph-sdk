...
/**
 * Collection response for SecurityUnclassifiedArtifact
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityUnclassifiedArtifactCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityUnclassifiedArtifact[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityUnclassifiedArtifact[]
     */
     ...
     * 
     * @param SecurityUnclassifiedArtifact[] $items
     * @return self
     */
    public function setValue(array|SecurityUnclassifiedArtifact $items, SecurityUnclassifiedArtifact ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityUnclassifiedArtifact> $value
     * @return self
     ...
     * 
     * @param SecurityUnclassifiedArtifact $item
     * @return self
     */
    public function addValue(SecurityUnclassifiedArtifact $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityUnclassifiedArtifact|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityUnclassifiedArtifact>
     */
