 ...
 */
class SecurityUnclassifiedArtifactCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityUnclassifiedArtifact ...$items Variable number of SecurityUnclassifiedArtifact items
     * @return self
     */
    public function setValue(SecurityUnclassifiedArtifact ...$items): self
    {
        $this->value = $items;
        return $this;
    }
