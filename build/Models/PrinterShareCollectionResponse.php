...
/**
 * Collection response for PrinterShare
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrinterShareCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrinterShare[]
     */
     ...
     * 
     * @param PrinterShare[] $items
     * @return self
     */
    public function setValue(array|PrinterShare $items, PrinterShare ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrinterShare> $value
     * @return self
     ...
     * 
     * @param PrinterShare $item
     * @return self
     */
    public function addValue(PrinterShare $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrinterShare>
     */
