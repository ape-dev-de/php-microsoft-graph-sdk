...
/**
 * Collection response for AgreementFileLocalizationCollectionResponse
 */
class AgreementFileLocalizationCollectionResponseCollectionResponse
{
    /**
     * @var AgreementFileLocalizationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AgreementFileLocalizationCollectionResponse ...$items Variable number of AgreementFileLocalizationCollectionResponse items
     * @return self
     */
    public function setValue(AgreementFileLocalizationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AgreementFileLocalizationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AgreementFileLocalizationCollectionResponse $item
     * @return self
     */
    public function addValue(AgreementFileLocalizationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
