...
/**
 * Collection response for RgbColor
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RgbColorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RgbColor[]
     */
     ...
     * 
     * @param RgbColor[] $items
     * @return self
     */
    public function setValue(array|RgbColor $items, RgbColor ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(RgbColor $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RgbColor>
     */
