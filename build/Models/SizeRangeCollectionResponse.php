...
/**
 * Collection response for SizeRange
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SizeRangeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SizeRange[]
     */
     ...
     * 
     * @param SizeRange[] $items
     * @return self
     */
    public function setValue(array|SizeRange $items, SizeRange ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param SizeRange $item
     * @return self
     */
    public function addValue(SizeRange $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SizeRange>
     */
