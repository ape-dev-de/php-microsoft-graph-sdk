...
/**
 * Collection response for SecurityWhoisDomainStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityWhoisDomainStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityWhoisDomainStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityWhoisDomainStatus[]
     */
     ...
     * 
     * @param SecurityWhoisDomainStatus[] $items
     * @return self
     */
    public function setValue(array|SecurityWhoisDomainStatus $items, SecurityWhoisDomainStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityWhoisDomainStatus> $value
     * @return self
     ...
     * 
     * @param SecurityWhoisDomainStatus $item
     * @return self
     */
    public function addValue(SecurityWhoisDomainStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityWhoisDomainStatus|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityWhoisDomainStatus>
     */
