...
/**
 * SecurityWhoisDomainStatusCollectionResponse - Collection response
 */
class SecurityWhoisDomainStatusCollectionResponse
{
    /**
     * @var array<int, SecurityWhoisDomainStatus>
     */
    public array $value = [];
