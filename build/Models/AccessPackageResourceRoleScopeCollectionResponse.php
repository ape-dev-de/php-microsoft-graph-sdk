...
/**
 * Collection response for AccessPackageResourceRoleScope
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageResourceRoleScopeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessPackageResourceRoleScope[] $items
     * @return self
     */
    public function setValue(array|AccessPackageResourceRoleScope $items, AccessPackageResourceRoleScope ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageResourceRoleScope> $value
     * @return self
     ...
     * 
     * @param AccessPackageResourceRoleScope $item
     * @return self
     */
    public function addValue(AccessPackageResourceRoleScope $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageResourceRoleScope>
     */
