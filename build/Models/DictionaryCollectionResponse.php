...
/**
 * Collection response for Dictionary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DictionaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Dictionary[]
     */
     ...
     * @return self
     */
    public function setValue(array|Dictionary $items, Dictionary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Dictionary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Dictionary>
     */
