...
/**
 * Collection response for PlaceCollectionResponse
 */
class PlaceCollectionResponseCollectionResponse
{
    /**
     * @var PlaceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PlaceCollectionResponse ...$items Variable number of PlaceCollectionResponse items
     * @return self
     */
    public function setValue(PlaceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PlaceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PlaceCollectionResponse $item
     * @return self
     */
    public function addValue(PlaceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
