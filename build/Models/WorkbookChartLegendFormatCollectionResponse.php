 ...
 */
class WorkbookChartLegendFormatCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookChartLegendFormat ...$items Variable number of WorkbookChartLegendFormat items
     * @return self
     */
    public function setValue(WorkbookChartLegendFormat ...$items): self
    {
        $this->value = $items;
        return $this;
    }
