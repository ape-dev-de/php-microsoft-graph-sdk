...
/**
 * Collection response for WorkbookChartLegendFormat
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookChartLegendFormatCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookChartLegendFormat[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookChartLegendFormat[] $items
     * @return self
     */
    public function setValue(array|WorkbookChartLegendFormat $items, WorkbookChartLegendFormat ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookChartLegendFormat> $value
     * @return self
     ...
     * 
     * @param WorkbookChartLegendFormat $item
     * @return self
     */
    public function addValue(WorkbookChartLegendFormat $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookChartLegendFormat>
     */
