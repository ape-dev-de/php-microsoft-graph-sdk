...
/**
 * Collection response for StoragePlanInformation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class StoragePlanInformationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var StoragePlanInformation[]
     */
    private array $value = [];
     ...
     * 
     * @param StoragePlanInformation[] $items
     * @return self
     */
    public function setValue(array|StoragePlanInformation $items, StoragePlanInformation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<StoragePlanInformation> $value
     * @return self
     ...
     * 
     * @param StoragePlanInformation $item
     * @return self
     */
    public function addValue(StoragePlanInformation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, StoragePlanInformation>
     */
