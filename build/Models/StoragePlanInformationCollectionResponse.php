 ...
 */
class StoragePlanInformationCollectionResponse
{
    /**
     ...
     * 
     * @param StoragePlanInformation ...$items Variable number of StoragePlanInformation items
     * @return self
     */
    public function setValue(StoragePlanInformation ...$items): self
    {
        $this->value = $items;
        return $this;
    }
