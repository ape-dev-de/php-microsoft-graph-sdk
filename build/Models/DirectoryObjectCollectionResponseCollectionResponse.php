...
/**
 * Collection response for DirectoryObjectCollectionResponse
 */
class DirectoryObjectCollectionResponseCollectionResponse
{
    /**
     * @var DirectoryObjectCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DirectoryObjectCollectionResponse ...$items Variable number of DirectoryObjectCollectionResponse items
     * @return self
     */
    public function setValue(DirectoryObjectCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DirectoryObjectCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DirectoryObjectCollectionResponse $item
     * @return self
     */
    public function addValue(DirectoryObjectCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
