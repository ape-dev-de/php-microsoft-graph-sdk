...
/**
 * Collection response for ResourceData
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ResourceDataCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ResourceData[]
     */
     ...
     * @return self
     */
    public function setValue(array|ResourceData $items, ResourceData ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ResourceData> $value
     * @return self
     ...
     * 
     * @param ResourceData $item
     * @return self
     */
    public function addValue(ResourceData $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ResourceData>
     */
