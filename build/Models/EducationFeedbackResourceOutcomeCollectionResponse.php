...
/**
 * Collection response for EducationFeedbackResourceOutcome
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationFeedbackResourceOutcomeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationFeedbackResourceOutcome[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationFeedbackResourceOutcome[] $items
     * @return self
     */
    public function setValue(array|EducationFeedbackResourceOutcome $items, EducationFeedbackResourceOutcome ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationFeedbackResourceOutcome> $value
     * @return self
     ...
     * 
     * @param EducationFeedbackResourceOutcome $item
     * @return self
     */
    public function addValue(EducationFeedbackResourceOutcome $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EducationFeedbackResourceOutcome|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EducationFeedbackResourceOutcome>
     */
