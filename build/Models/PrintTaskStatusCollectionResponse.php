 ...
 */
class PrintTaskStatusCollectionResponse
{
    /**
     * @var PrintTaskStatus[]
     */
     ...
     * 
     * @param PrintTaskStatus ...$items Variable number of PrintTaskStatus items
     * @return self
     */
    public function setValue(PrintTaskStatus ...$items): self
    {
        $this->value = $items;
        return $this;
    }
