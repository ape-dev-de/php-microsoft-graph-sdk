...
/**
 * Collection response for PrintTaskStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintTaskStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrintTaskStatus[]
     */
     ...
     * 
     * @param PrintTaskStatus[] $items
     * @return self
     */
    public function setValue(array|PrintTaskStatus $items, PrintTaskStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintTaskStatus> $value
     * @return self
     ...
     * 
     * @param PrintTaskStatus $item
     * @return self
     */
    public function addValue(PrintTaskStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintTaskStatus>
     */
