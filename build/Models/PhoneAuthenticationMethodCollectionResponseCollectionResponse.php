...
/**
 * Collection response for PhoneAuthenticationMethodCollectionResponse
 */
class PhoneAuthenticationMethodCollectionResponseCollectionResponse
{
    /**
     * @var PhoneAuthenticationMethodCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PhoneAuthenticationMethodCollectionResponse ...$items Variable number of PhoneAuthenticationMethodCollectionResponse items
     * @return self
     */
    public function setValue(PhoneAuthenticationMethodCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PhoneAuthenticationMethodCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PhoneAuthenticationMethodCollectionResponse $item
     * @return self
     */
    public function addValue(PhoneAuthenticationMethodCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
