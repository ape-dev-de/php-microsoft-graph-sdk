...
/**
 * Collection response for BucketAggregationRangeCollectionResponse
 */
class BucketAggregationRangeCollectionResponseCollectionResponse
{
    /**
     * @var BucketAggregationRangeCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BucketAggregationRangeCollectionResponse ...$items Variable number of BucketAggregationRangeCollectionResponse items
     * @return self
     */
    public function setValue(BucketAggregationRangeCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<BucketAggregationRangeCollectionResponse> $value
     * @return self
     ...
     * 
     * @param BucketAggregationRangeCollectionResponse $item
     * @return self
     */
    public function addValue(BucketAggregationRangeCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
