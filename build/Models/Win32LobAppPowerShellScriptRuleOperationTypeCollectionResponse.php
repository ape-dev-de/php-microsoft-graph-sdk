...
/**
 * Collection response for Win32LobAppPowerShellScriptRuleOperationType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Win32LobAppPowerShellScriptRuleOperationTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Win32LobAppPowerShellScriptRuleOperationType[]
     */
    private array $value = [];
     ...
     * 
     * @return Win32LobAppPowerShellScriptRuleOperationType[]
     */
     ...
     * 
     * @param Win32LobAppPowerShellScriptRuleOperationType[] $items
     * @return self
     */
    public function setValue(array|Win32LobAppPowerShellScriptRuleOperationType $items, Win32LobAppPowerShellScriptRuleOperationType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Win32LobAppPowerShellScriptRuleOperationType> $value
     * @return self
     ...
     * 
     * @param Win32LobAppPowerShellScriptRuleOperationType $item
     * @return self
     */
    public function addValue(Win32LobAppPowerShellScriptRuleOperationType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Win32LobAppPowerShellScriptRuleOperationType>
     */
