 ...
 */
class ClassificationErrorCollectionResponse
{
    /**
     ...
     * 
     * @param ClassificationError ...$items Variable number of ClassificationError items
     * @return self
     */
    public function setValue(ClassificationError ...$items): self
    {
        $this->value = $items;
        return $this;
    }
