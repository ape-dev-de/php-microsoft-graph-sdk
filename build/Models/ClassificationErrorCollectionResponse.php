...
/**
 * Collection response for ClassificationError
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ClassificationErrorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ClassificationError[] $items
     * @return self
     */
    public function setValue(array|ClassificationError $items, ClassificationError ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ClassificationError> $value
     * @return self
     ...
     * 
     * @param ClassificationError $item
     * @return self
     */
    public function addValue(ClassificationError $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ClassificationError>
     */
