...
/**
 * Collection response for AttributeSet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttributeSetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AttributeSet[]
     */
     ...
     * 
     * @param AttributeSet[] $items
     * @return self
     */
    public function setValue(array|AttributeSet $items, AttributeSet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttributeSet> $value
     * @return self
     ...
     * @return self
     */
    public function addValue(AttributeSet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AttributeSet>
     */
