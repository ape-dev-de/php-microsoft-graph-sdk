...
/**
 * Collection response for Windows81GeneralConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Windows81GeneralConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Windows81GeneralConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param Windows81GeneralConfiguration[] $items
     * @return self
     */
    public function setValue(array|Windows81GeneralConfiguration $items, Windows81GeneralConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Windows81GeneralConfiguration> $value
     * @return self
     ...
     * 
     * @param Windows81GeneralConfiguration $item
     * @return self
     */
    public function addValue(Windows81GeneralConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return Windows81GeneralConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, Windows81GeneralConfiguration>
     */
