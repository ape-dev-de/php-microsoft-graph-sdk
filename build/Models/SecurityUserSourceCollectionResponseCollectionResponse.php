...
/**
 * Collection response for SecurityUserSourceCollectionResponse
 */
class SecurityUserSourceCollectionResponseCollectionResponse
{
    /**
     * @var SecurityUserSourceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityUserSourceCollectionResponse ...$items Variable number of SecurityUserSourceCollectionResponse items
     * @return self
     */
    public function setValue(SecurityUserSourceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityUserSourceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityUserSourceCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityUserSourceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
