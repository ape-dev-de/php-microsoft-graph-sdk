...
/**
 * Collection response for ServiceUpdateSeverity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServiceUpdateSeverityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ServiceUpdateSeverity[] $items
     * @return self
     */
    public function setValue(array|ServiceUpdateSeverity $items, ServiceUpdateSeverity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServiceUpdateSeverity> $value
     * @return self
     ...
     * 
     * @param ServiceUpdateSeverity $item
     * @return self
     */
    public function addValue(ServiceUpdateSeverity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ServiceUpdateSeverity>
     */
