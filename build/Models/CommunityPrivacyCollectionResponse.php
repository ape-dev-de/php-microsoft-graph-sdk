...
/**
 * Collection response for CommunityPrivacy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CommunityPrivacyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CommunityPrivacy[]
     */
    private array $value = [];
     ...
     * 
     * @param CommunityPrivacy[] $items
     * @return self
     */
    public function setValue(array|CommunityPrivacy $items, CommunityPrivacy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CommunityPrivacy> $value
     * @return self
     ...
     * 
     * @param CommunityPrivacy $item
     * @return self
     */
    public function addValue(CommunityPrivacy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CommunityPrivacy>
     */
