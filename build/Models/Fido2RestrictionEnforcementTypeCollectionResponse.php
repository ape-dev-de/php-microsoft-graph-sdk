...
/**
 * Collection response for Fido2RestrictionEnforcementType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Fido2RestrictionEnforcementTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Fido2RestrictionEnforcementType[]
     */
    private array $value = [];
     ...
     * 
     * @return Fido2RestrictionEnforcementType[]
     */
     ...
     * 
     * @param Fido2RestrictionEnforcementType[] $items
     * @return self
     */
    public function setValue(array|Fido2RestrictionEnforcementType $items, Fido2RestrictionEnforcementType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Fido2RestrictionEnforcementType> $value
     * @return self
     ...
     * 
     * @param Fido2RestrictionEnforcementType $item
     * @return self
     */
    public function addValue(Fido2RestrictionEnforcementType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Fido2RestrictionEnforcementType>
     */
