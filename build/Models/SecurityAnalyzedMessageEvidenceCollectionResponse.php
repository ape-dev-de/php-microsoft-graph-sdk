 ...
 */
class SecurityAnalyzedMessageEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityAnalyzedMessageEvidence ...$items Variable number of SecurityAnalyzedMessageEvidence items
     * @return self
     */
    public function setValue(SecurityAnalyzedMessageEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
