...
/**
 * Collection response for SecurityAnalyzedMessageEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityAnalyzedMessageEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityAnalyzedMessageEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityAnalyzedMessageEvidence[]
     */
     ...
     * 
     * @param SecurityAnalyzedMessageEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityAnalyzedMessageEvidence $items, SecurityAnalyzedMessageEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityAnalyzedMessageEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityAnalyzedMessageEvidence $item
     * @return self
     */
    public function addValue(SecurityAnalyzedMessageEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityAnalyzedMessageEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityAnalyzedMessageEvidence>
     */
