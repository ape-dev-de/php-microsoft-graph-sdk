...
/**
 * Collection response for SecurityCase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityCaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityCase[]
     */
     ...
     * 
     * @param SecurityCase[] $items
     * @return self
     */
    public function setValue(array|SecurityCase $items, SecurityCase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityCase> $value
     * @return self
     ...
     * 
     * @param SecurityCase $item
     * @return self
     */
    public function addValue(SecurityCase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityCase>
     */
