...
/**
 * Collection response for IosNetworkUsageRuleCollectionResponse
 */
class IosNetworkUsageRuleCollectionResponseCollectionResponse
{
    /**
     * @var IosNetworkUsageRuleCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IosNetworkUsageRuleCollectionResponse ...$items Variable number of IosNetworkUsageRuleCollectionResponse items
     * @return self
     */
    public function setValue(IosNetworkUsageRuleCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IosNetworkUsageRuleCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IosNetworkUsageRuleCollectionResponse $item
     * @return self
     */
    public function addValue(IosNetworkUsageRuleCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
