...
/**
 * Collection response for AuthenticationProtocol
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationProtocolCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AuthenticationProtocol[] $items
     * @return self
     */
    public function setValue(array|AuthenticationProtocol $items, AuthenticationProtocol ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationProtocol> $value
     * @return self
     ...
     * 
     * @param AuthenticationProtocol $item
     * @return self
     */
    public function addValue(AuthenticationProtocol $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationProtocol>
     */
