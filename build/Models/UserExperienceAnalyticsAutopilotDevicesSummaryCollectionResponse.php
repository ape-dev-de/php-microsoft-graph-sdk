...
/**
 * Collection response for UserExperienceAnalyticsAutopilotDevicesSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsAutopilotDevicesSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserExperienceAnalyticsAutopilotDevicesSummary[]
     */
    private array $value = [];
     ...
     * 
     * @param UserExperienceAnalyticsAutopilotDevicesSummary[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsAutopilotDevicesSummary $items, UserExperienceAnalyticsAutopilotDevicesSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsAutopilotDevicesSummary> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsAutopilotDevicesSummary $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsAutopilotDevicesSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsAutopilotDevicesSummary>
     */
