 ...
 */
class UserExperienceAnalyticsAutopilotDevicesSummaryCollectionResponse
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsAutopilotDevicesSummary ...$items Variable number of UserExperienceAnalyticsAutopilotDevicesSummary items
     * @return self
     */
    public function setValue(UserExperienceAnalyticsAutopilotDevicesSummary ...$items): self
    {
        $this->value = $items;
        return $this;
    }
