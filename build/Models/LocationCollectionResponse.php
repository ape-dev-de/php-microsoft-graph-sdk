...
/**
 * Collection response for Location
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LocationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Location[]
     */
     ...
     * @return self
     */
    public function setValue(array|Location $items, Location ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Location $item): self
    {
        $this->value[] = $item;
        return $this;
    }
