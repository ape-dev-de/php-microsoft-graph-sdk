...
class CloudPcRestorePointSettingCollectionResponse
{
     ...
     * 
     * @param CloudPcRestorePointSetting ...$items Variable number of CloudPcRestorePointSetting items
     * @return self
     */
    public function setValue(CloudPcRestorePointSetting ...$items): self
    {
        $this->value = $items;
        return $this;
    }
