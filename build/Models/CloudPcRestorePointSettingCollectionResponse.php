...
/**
 * Collection response for CloudPcRestorePointSetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcRestorePointSettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudPcRestorePointSetting[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudPcRestorePointSetting[] $items
     * @return self
     */
    public function setValue(array|CloudPcRestorePointSetting $items, CloudPcRestorePointSetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcRestorePointSetting> $value
     * @return self
     ...
     * 
     * @param CloudPcRestorePointSetting $item
     * @return self
     */
    public function addValue(CloudPcRestorePointSetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcRestorePointSetting>
     */
