...
/**
 * Collection response for IpNamedLocation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IpNamedLocationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IpNamedLocation[]
     */
     ...
     * 
     * @param IpNamedLocation[] $items
     * @return self
     */
    public function setValue(array|IpNamedLocation $items, IpNamedLocation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IpNamedLocation> $value
     * @return self
     ...
     * 
     * @param IpNamedLocation $item
     * @return self
     */
    public function addValue(IpNamedLocation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IpNamedLocation>
     */
