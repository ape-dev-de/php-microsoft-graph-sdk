...
/**
 * Collection response for IosMinimumOperatingSystem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosMinimumOperatingSystemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IosMinimumOperatingSystem[] $items
     * @return self
     */
    public function setValue(array|IosMinimumOperatingSystem $items, IosMinimumOperatingSystem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosMinimumOperatingSystem> $value
     * @return self
     ...
     * 
     * @param IosMinimumOperatingSystem $item
     * @return self
     */
    public function addValue(IosMinimumOperatingSystem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IosMinimumOperatingSystem>
     */
