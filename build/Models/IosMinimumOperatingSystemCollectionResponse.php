 ...
 */
class IosMinimumOperatingSystemCollectionResponse
{
    /**
     ...
     * 
     * @param IosMinimumOperatingSystem ...$items Variable number of IosMinimumOperatingSystem items
     * @return self
     */
    public function setValue(IosMinimumOperatingSystem ...$items): self
    {
        $this->value = $items;
        return $this;
    }
