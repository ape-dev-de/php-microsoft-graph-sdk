...
/**
 * Collection response for WorkbookTableRow
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookTableRowCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookTableRow[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookTableRow[] $items
     * @return self
     */
    public function setValue(array|WorkbookTableRow $items, WorkbookTableRow ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookTableRow> $value
     * @return self
     ...
     * 
     * @param WorkbookTableRow $item
     * @return self
     */
    public function addValue(WorkbookTableRow $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookTableRow>
     */
