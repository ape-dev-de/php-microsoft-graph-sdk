...
/**
 * Collection response for SecurityIntelligenceProfileIndicator
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityIntelligenceProfileIndicatorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityIntelligenceProfileIndicator[] $items
     * @return self
     */
    public function setValue(array|SecurityIntelligenceProfileIndicator $items, SecurityIntelligenceProfileIndicator ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityIntelligenceProfileIndicator> $value
     * @return self
     ...
     * 
     * @param SecurityIntelligenceProfileIndicator $item
     * @return self
     */
    public function addValue(SecurityIntelligenceProfileIndicator $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityIntelligenceProfileIndicator>
     */
