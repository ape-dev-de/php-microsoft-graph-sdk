...
/**
 * Collection response for AccessPackageAssignmentWorkflowExtension
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageAssignmentWorkflowExtensionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageAssignmentWorkflowExtension[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageAssignmentWorkflowExtension[] $items
     * @return self
     */
    public function setValue(array|AccessPackageAssignmentWorkflowExtension $items, AccessPackageAssignmentWorkflowExtension ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageAssignmentWorkflowExtension> $value
     * @return self
     ...
     * 
     * @param AccessPackageAssignmentWorkflowExtension $item
     * @return self
     */
    public function addValue(AccessPackageAssignmentWorkflowExtension $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessPackageAssignmentWorkflowExtension|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageAssignmentWorkflowExtension>
     */
