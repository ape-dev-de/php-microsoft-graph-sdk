...
/**
 * Collection response for VerticalSection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VerticalSectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VerticalSection[]
     */
     ...
     * 
     * @param VerticalSection[] $items
     * @return self
     */
    public function setValue(array|VerticalSection $items, VerticalSection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VerticalSection> $value
     * @return self
     ...
     * 
     * @param VerticalSection $item
     * @return self
     */
    public function addValue(VerticalSection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VerticalSection>
     */
