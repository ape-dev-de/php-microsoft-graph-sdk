 ...
 */
class VerticalSectionCollectionResponse
{
    /**
     * @var VerticalSection[]
     */
     ...
     * 
     * @param VerticalSection ...$items Variable number of VerticalSection items
     * @return self
     */
    public function setValue(VerticalSection ...$items): self
    {
        $this->value = $items;
        return $this;
    }
