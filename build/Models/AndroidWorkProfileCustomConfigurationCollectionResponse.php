...
/**
 * Collection response for AndroidWorkProfileCustomConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AndroidWorkProfileCustomConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AndroidWorkProfileCustomConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param AndroidWorkProfileCustomConfiguration[] $items
     * @return self
     */
    public function setValue(array|AndroidWorkProfileCustomConfiguration $items, AndroidWorkProfileCustomConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AndroidWorkProfileCustomConfiguration> $value
     * @return self
     ...
     * 
     * @param AndroidWorkProfileCustomConfiguration $item
     * @return self
     */
    public function addValue(AndroidWorkProfileCustomConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AndroidWorkProfileCustomConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AndroidWorkProfileCustomConfiguration>
     */
