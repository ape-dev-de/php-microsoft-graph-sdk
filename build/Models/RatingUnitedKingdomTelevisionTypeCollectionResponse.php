...
/**
 * RatingUnitedKingdomTelevisionTypeCollectionResponse - Collection response
 */
class RatingUnitedKingdomTelevisionTypeCollectionResponse
{
    /**
     * @var array<int, RatingUnitedKingdomTelevisionType>
     */
    public array $value = [];
