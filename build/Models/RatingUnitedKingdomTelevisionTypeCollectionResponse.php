...
/**
 * Collection response for RatingUnitedKingdomTelevisionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RatingUnitedKingdomTelevisionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RatingUnitedKingdomTelevisionType[]
     */
    private array $value = [];
     ...
     * 
     * @return RatingUnitedKingdomTelevisionType[]
     */
     ...
     * 
     * @param RatingUnitedKingdomTelevisionType[] $items
     * @return self
     */
    public function setValue(array|RatingUnitedKingdomTelevisionType $items, RatingUnitedKingdomTelevisionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RatingUnitedKingdomTelevisionType> $value
     * @return self
     ...
     * 
     * @param RatingUnitedKingdomTelevisionType $item
     * @return self
     */
    public function addValue(RatingUnitedKingdomTelevisionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RatingUnitedKingdomTelevisionType>
     */
