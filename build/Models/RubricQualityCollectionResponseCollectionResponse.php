...
/**
 * Collection response for RubricQualityCollectionResponse
 */
class RubricQualityCollectionResponseCollectionResponse
{
    /**
     * @var RubricQualityCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RubricQualityCollectionResponse ...$items Variable number of RubricQualityCollectionResponse items
     * @return self
     */
    public function setValue(RubricQualityCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RubricQualityCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RubricQualityCollectionResponse $item
     * @return self
     */
    public function addValue(RubricQualityCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
