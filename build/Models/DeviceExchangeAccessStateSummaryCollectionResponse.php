 ...
 */
class DeviceExchangeAccessStateSummaryCollectionResponse
{
    /**
     ...
     * 
     * @param DeviceExchangeAccessStateSummary ...$items Variable number of DeviceExchangeAccessStateSummary items
     * @return self
     */
    public function setValue(DeviceExchangeAccessStateSummary ...$items): self
    {
        $this->value = $items;
        return $this;
    }
