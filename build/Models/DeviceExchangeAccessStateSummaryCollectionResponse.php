...
/**
 * Collection response for DeviceExchangeAccessStateSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceExchangeAccessStateSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceExchangeAccessStateSummary[] $items
     * @return self
     */
    public function setValue(array|DeviceExchangeAccessStateSummary $items, DeviceExchangeAccessStateSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceExchangeAccessStateSummary> $value
     * @return self
     ...
     * 
     * @param DeviceExchangeAccessStateSummary $item
     * @return self
     */
    public function addValue(DeviceExchangeAccessStateSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceExchangeAccessStateSummary>
     */
