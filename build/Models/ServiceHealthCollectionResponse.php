...
/**
 * Collection response for ServiceHealth
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServiceHealthCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ServiceHealth[]
     */
     ...
     * 
     * @param ServiceHealth[] $items
     * @return self
     */
    public function setValue(array|ServiceHealth $items, ServiceHealth ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServiceHealth> $value
     * @return self
     ...
     * 
     * @param ServiceHealth $item
     * @return self
     */
    public function addValue(ServiceHealth $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ServiceHealth>
     */
