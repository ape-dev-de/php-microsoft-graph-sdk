...
/**
 * Collection response for ConditionalAccessPolicyCollectionResponse
 */
class ConditionalAccessPolicyCollectionResponseCollectionResponse
{
    /**
     * @var ConditionalAccessPolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ConditionalAccessPolicyCollectionResponse ...$items Variable number of ConditionalAccessPolicyCollectionResponse items
     * @return self
     */
    public function setValue(ConditionalAccessPolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ConditionalAccessPolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessPolicyCollectionResponse $item
     * @return self
     */
    public function addValue(ConditionalAccessPolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
