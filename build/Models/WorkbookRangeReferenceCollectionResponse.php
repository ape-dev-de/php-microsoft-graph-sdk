...
/**
 * Collection response for WorkbookRangeReference
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookRangeReferenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookRangeReference[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookRangeReference[] $items
     * @return self
     */
    public function setValue(array|WorkbookRangeReference $items, WorkbookRangeReference ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookRangeReference> $value
     * @return self
     ...
     * 
     * @param WorkbookRangeReference $item
     * @return self
     */
    public function addValue(WorkbookRangeReference $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WorkbookRangeReference|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WorkbookRangeReference>
     */
