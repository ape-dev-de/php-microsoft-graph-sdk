 ...
 */
class WorkbookRangeReferenceCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookRangeReference ...$items Variable number of WorkbookRangeReference items
     * @return self
     */
    public function setValue(WorkbookRangeReference ...$items): self
    {
        $this->value = $items;
        return $this;
    }
