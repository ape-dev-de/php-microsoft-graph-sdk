...
/**
 * Collection response for ChatMessageAttachment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatMessageAttachmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ChatMessageAttachment[] $items
     * @return self
     */
    public function setValue(array|ChatMessageAttachment $items, ChatMessageAttachment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChatMessageAttachment> $value
     * @return self
     ...
     * 
     * @param ChatMessageAttachment $item
     * @return self
     */
    public function addValue(ChatMessageAttachment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChatMessageAttachment>
     */
