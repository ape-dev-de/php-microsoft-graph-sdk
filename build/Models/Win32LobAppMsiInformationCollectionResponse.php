 ...
 */
class Win32LobAppMsiInformationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param Win32LobAppMsiInformation[] $items
     * @return self
     */
    public function setValue(array|Win32LobAppMsiInformation $items, Win32LobAppMsiInformation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @return \ArrayIterator<int, Win32LobAppMsiInformation>
     */
