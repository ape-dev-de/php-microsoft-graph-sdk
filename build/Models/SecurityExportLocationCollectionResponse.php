...
/**
 * Collection response for SecurityExportLocation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityExportLocationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityExportLocation[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityExportLocation[] $items
     * @return self
     */
    public function setValue(array|SecurityExportLocation $items, SecurityExportLocation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityExportLocation> $value
     * @return self
     ...
     * 
     * @param SecurityExportLocation $item
     * @return self
     */
    public function addValue(SecurityExportLocation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityExportLocation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityExportLocation>
     */
