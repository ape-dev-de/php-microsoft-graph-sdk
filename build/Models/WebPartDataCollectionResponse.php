...
/**
 * Collection response for WebPartData
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WebPartDataCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WebPartData[]
     */
     ...
     * 
     * @param WebPartData[] $items
     * @return self
     */
    public function setValue(array|WebPartData $items, WebPartData ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param WebPartData $item
     * @return self
     */
    public function addValue(WebPartData $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WebPartData>
     */
