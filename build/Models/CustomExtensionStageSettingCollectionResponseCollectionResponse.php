...
/**
 * Collection response for CustomExtensionStageSettingCollectionResponse
 */
class CustomExtensionStageSettingCollectionResponseCollectionResponse
{
    /**
     * @var CustomExtensionStageSettingCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CustomExtensionStageSettingCollectionResponse ...$items Variable number of CustomExtensionStageSettingCollectionResponse items
     * @return self
     */
    public function setValue(CustomExtensionStageSettingCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CustomExtensionStageSettingCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CustomExtensionStageSettingCollectionResponse $item
     * @return self
     */
    public function addValue(CustomExtensionStageSettingCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
