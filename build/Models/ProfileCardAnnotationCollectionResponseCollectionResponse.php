...
/**
 * Collection response for ProfileCardAnnotationCollectionResponse
 */
class ProfileCardAnnotationCollectionResponseCollectionResponse
{
    /**
     * @var ProfileCardAnnotationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ProfileCardAnnotationCollectionResponse ...$items Variable number of ProfileCardAnnotationCollectionResponse items
     * @return self
     */
    public function setValue(ProfileCardAnnotationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ProfileCardAnnotationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ProfileCardAnnotationCollectionResponse $item
     * @return self
     */
    public function addValue(ProfileCardAnnotationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
