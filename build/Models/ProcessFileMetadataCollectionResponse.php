...
/**
 * Collection response for ProcessFileMetadata
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProcessFileMetadataCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProcessFileMetadata[]
     */
    private array $value = [];
     ...
     * 
     * @param ProcessFileMetadata[] $items
     * @return self
     */
    public function setValue(array|ProcessFileMetadata $items, ProcessFileMetadata ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProcessFileMetadata> $value
     * @return self
     ...
     * 
     * @param ProcessFileMetadata $item
     * @return self
     */
    public function addValue(ProcessFileMetadata $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ProcessFileMetadata|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ProcessFileMetadata>
     */
