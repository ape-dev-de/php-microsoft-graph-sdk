 ...
 */
class ProcessFileMetadataCollectionResponse
{
    /**
     ...
     * 
     * @param ProcessFileMetadata ...$items Variable number of ProcessFileMetadata items
     * @return self
     */
    public function setValue(ProcessFileMetadata ...$items): self
    {
        $this->value = $items;
        return $this;
    }
