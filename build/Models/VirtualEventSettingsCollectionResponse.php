 ...
 */
class VirtualEventSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param VirtualEventSettings ...$items Variable number of VirtualEventSettings items
     * @return self
     */
    public function setValue(VirtualEventSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
