...
/**
 * Collection response for VirtualEventSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualEventSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VirtualEventSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param VirtualEventSettings[] $items
     * @return self
     */
    public function setValue(array|VirtualEventSettings $items, VirtualEventSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualEventSettings> $value
     * @return self
     ...
     * 
     * @param VirtualEventSettings $item
     * @return self
     */
    public function addValue(VirtualEventSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VirtualEventSettings>
     */
