...
/**
 * Collection response for ContactRelationship
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ContactRelationshipCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ContactRelationship[] $items
     * @return self
     */
    public function setValue(array|ContactRelationship $items, ContactRelationship ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ContactRelationship> $value
     * @return self
     ...
     * 
     * @param ContactRelationship $item
     * @return self
     */
    public function addValue(ContactRelationship $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ContactRelationship>
     */
