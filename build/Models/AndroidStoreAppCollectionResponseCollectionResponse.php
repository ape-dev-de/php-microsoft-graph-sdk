...
/**
 * Collection response for AndroidStoreAppCollectionResponse
 */
class AndroidStoreAppCollectionResponseCollectionResponse
{
    /**
     * @var AndroidStoreAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AndroidStoreAppCollectionResponse ...$items Variable number of AndroidStoreAppCollectionResponse items
     * @return self
     */
    public function setValue(AndroidStoreAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AndroidStoreAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AndroidStoreAppCollectionResponse $item
     * @return self
     */
    public function addValue(AndroidStoreAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
