...
/**
 * Collection response for AggregationOption
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AggregationOptionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AggregationOption[] $items
     * @return self
     */
    public function setValue(array|AggregationOption $items, AggregationOption ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AggregationOption> $value
     * @return self
     ...
     * 
     * @param AggregationOption $item
     * @return self
     */
    public function addValue(AggregationOption $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AggregationOption>
     */
