...
/**
 * Collection response for Package
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PackageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Package[]
     */
     ...
     * @return self
     */
    public function setValue(array|Package $items, Package ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Package $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Package>
     */
