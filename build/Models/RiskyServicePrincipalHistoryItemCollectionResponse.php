...
/**
 * Collection response for RiskyServicePrincipalHistoryItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RiskyServicePrincipalHistoryItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param RiskyServicePrincipalHistoryItem[] $items
     * @return self
     */
    public function setValue(array|RiskyServicePrincipalHistoryItem $items, RiskyServicePrincipalHistoryItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RiskyServicePrincipalHistoryItem> $value
     * @return self
     ...
     * 
     * @param RiskyServicePrincipalHistoryItem $item
     * @return self
     */
    public function addValue(RiskyServicePrincipalHistoryItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RiskyServicePrincipalHistoryItem>
     */
