...
/**
 * SecurityServicePrincipalTypeCollectionResponse - Collection response
 */
class SecurityServicePrincipalTypeCollectionResponse
{
    /**
     * @var array<int, SecurityServicePrincipalType>
     */
    public array $value = [];
