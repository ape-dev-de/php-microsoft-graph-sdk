...
/**
 * Collection response for SecurityServicePrincipalType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityServicePrincipalTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityServicePrincipalType[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityServicePrincipalType[]
     */
     ...
     * 
     * @param SecurityServicePrincipalType[] $items
     * @return self
     */
    public function setValue(array|SecurityServicePrincipalType $items, SecurityServicePrincipalType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityServicePrincipalType> $value
     * @return self
     ...
     * 
     * @param SecurityServicePrincipalType $item
     * @return self
     */
    public function addValue(SecurityServicePrincipalType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityServicePrincipalType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityServicePrincipalType>
     */
