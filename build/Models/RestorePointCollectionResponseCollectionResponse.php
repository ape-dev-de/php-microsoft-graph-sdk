...
/**
 * Collection response for RestorePointCollectionResponse
 */
class RestorePointCollectionResponseCollectionResponse
{
    /**
     * @var RestorePointCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RestorePointCollectionResponse ...$items Variable number of RestorePointCollectionResponse items
     * @return self
     */
    public function setValue(RestorePointCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RestorePointCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RestorePointCollectionResponse $item
     * @return self
     */
    public function addValue(RestorePointCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
