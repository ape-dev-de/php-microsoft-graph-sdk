...
/**
 * Collection response for AuthenticationMethod
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationMethodCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AuthenticationMethod[] $items
     * @return self
     */
    public function setValue(array|AuthenticationMethod $items, AuthenticationMethod ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationMethod> $value
     * @return self
     ...
     * 
     * @param AuthenticationMethod $item
     * @return self
     */
    public function addValue(AuthenticationMethod $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationMethod>
     */
