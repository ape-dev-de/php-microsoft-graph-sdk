...
/**
 * Collection response for AppRoleCollectionResponse
 */
class AppRoleCollectionResponseCollectionResponse
{
    /**
     * @var AppRoleCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AppRoleCollectionResponse ...$items Variable number of AppRoleCollectionResponse items
     * @return self
     */
    public function setValue(AppRoleCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AppRoleCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AppRoleCollectionResponse $item
     * @return self
     */
    public function addValue(AppRoleCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
