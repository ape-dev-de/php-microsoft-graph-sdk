 ...
 */
class SecurityTriggersRootCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityTriggersRoot ...$items Variable number of SecurityTriggersRoot items
     * @return self
     */
    public function setValue(SecurityTriggersRoot ...$items): self
    {
        $this->value = $items;
        return $this;
    }
