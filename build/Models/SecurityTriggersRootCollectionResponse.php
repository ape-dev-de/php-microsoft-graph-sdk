...
/**
 * Collection response for SecurityTriggersRoot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityTriggersRootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityTriggersRoot[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityTriggersRoot[] $items
     * @return self
     */
    public function setValue(array|SecurityTriggersRoot $items, SecurityTriggersRoot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityTriggersRoot> $value
     * @return self
     ...
     * 
     * @param SecurityTriggersRoot $item
     * @return self
     */
    public function addValue(SecurityTriggersRoot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityTriggersRoot>
     */
