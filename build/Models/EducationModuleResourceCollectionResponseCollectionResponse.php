...
/**
 * Collection response for EducationModuleResourceCollectionResponse
 */
class EducationModuleResourceCollectionResponseCollectionResponse
{
    /**
     * @var EducationModuleResourceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationModuleResourceCollectionResponse ...$items Variable number of EducationModuleResourceCollectionResponse items
     * @return self
     */
    public function setValue(EducationModuleResourceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EducationModuleResourceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EducationModuleResourceCollectionResponse $item
     * @return self
     */
    public function addValue(EducationModuleResourceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
