...
/**
 * Collection response for ScheduleRequestActions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ScheduleRequestActionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ScheduleRequestActions[]
     */
    private array $value = [];
     ...
     * 
     * @param ScheduleRequestActions[] $items
     * @return self
     */
    public function setValue(array|ScheduleRequestActions $items, ScheduleRequestActions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ScheduleRequestActions> $value
     * @return self
     ...
     * 
     * @param ScheduleRequestActions $item
     * @return self
     */
    public function addValue(ScheduleRequestActions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ScheduleRequestActions>
     */
