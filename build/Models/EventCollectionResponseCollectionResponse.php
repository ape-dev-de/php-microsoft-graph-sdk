...
/**
 * Collection response for EventCollectionResponse
 */
class EventCollectionResponseCollectionResponse
{
    /**
     * @var EventCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EventCollectionResponse ...$items Variable number of EventCollectionResponse items
     * @return self
     */
    public function setValue(EventCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EventCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EventCollectionResponse $item
     * @return self
     */
    public function addValue(EventCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
