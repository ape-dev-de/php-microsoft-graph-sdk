...
/**
 * Collection response for ContactFolderCollectionResponse
 */
class ContactFolderCollectionResponseCollectionResponse
{
    /**
     * @var ContactFolderCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ContactFolderCollectionResponse ...$items Variable number of ContactFolderCollectionResponse items
     * @return self
     */
    public function setValue(ContactFolderCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ContactFolderCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ContactFolderCollectionResponse $item
     * @return self
     */
    public function addValue(ContactFolderCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
