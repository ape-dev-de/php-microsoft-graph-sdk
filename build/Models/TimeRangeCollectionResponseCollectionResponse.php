...
/**
 * Collection response for TimeRangeCollectionResponse
 */
class TimeRangeCollectionResponseCollectionResponse
{
    /**
     * @var TimeRangeCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TimeRangeCollectionResponse ...$items Variable number of TimeRangeCollectionResponse items
     * @return self
     */
    public function setValue(TimeRangeCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TimeRangeCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TimeRangeCollectionResponse $item
     * @return self
     */
    public function addValue(TimeRangeCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
