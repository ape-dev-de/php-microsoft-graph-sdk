...
/**
 * Collection response for DeviceConfigurationDeviceStatusCollectionResponse
 */
class DeviceConfigurationDeviceStatusCollectionResponseCollectionResponse
{
    /**
     * @var DeviceConfigurationDeviceStatusCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceConfigurationDeviceStatusCollectionResponse ...$items Variable number of DeviceConfigurationDeviceStatusCollectionResponse items
     * @return self
     */
    public function setValue(DeviceConfigurationDeviceStatusCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeviceConfigurationDeviceStatusCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeviceConfigurationDeviceStatusCollectionResponse $item
     * @return self
     */
    public function addValue(DeviceConfigurationDeviceStatusCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
