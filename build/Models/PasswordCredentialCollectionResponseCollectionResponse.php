...
/**
 * Collection response for PasswordCredentialCollectionResponse
 */
class PasswordCredentialCollectionResponseCollectionResponse
{
    /**
     * @var PasswordCredentialCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PasswordCredentialCollectionResponse ...$items Variable number of PasswordCredentialCollectionResponse items
     * @return self
     */
    public function setValue(PasswordCredentialCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PasswordCredentialCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PasswordCredentialCollectionResponse $item
     * @return self
     */
    public function addValue(PasswordCredentialCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
