...
/**
 * Collection response for Subscription
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SubscriptionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Subscription[]
     */
     ...
     * @return self
     */
    public function setValue(array|Subscription $items, Subscription ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Subscription $item): self
    {
        $this->value[] = $item;
        return $this;
    }
