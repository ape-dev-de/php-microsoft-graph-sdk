...
class RiskyServicePrincipalHistoryItem
{
     ...
     * @var RiskServicePrincipalActivity|\stdClass|null
     */
    public RiskServicePrincipalActivity|\stdClass|null $activity = null;
    ...
    public function __construct(array $data = [])
    {
        ...
        if (isset($data['activity'])) {
            $this->activity = is_array($data['activity']) ? new RiskServicePrincipalActivity($data['activity']) : $data['activity'];
        }
