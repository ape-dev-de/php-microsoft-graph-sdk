...
/**
 * Collection response for SecurityIndicatorSource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityIndicatorSourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityIndicatorSource[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityIndicatorSource[]
     */
     ...
     * 
     * @param SecurityIndicatorSource[] $items
     * @return self
     */
    public function setValue(array|SecurityIndicatorSource $items, SecurityIndicatorSource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityIndicatorSource> $value
     * @return self
     ...
     * 
     * @param SecurityIndicatorSource $item
     * @return self
     */
    public function addValue(SecurityIndicatorSource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityIndicatorSource|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityIndicatorSource>
     */
