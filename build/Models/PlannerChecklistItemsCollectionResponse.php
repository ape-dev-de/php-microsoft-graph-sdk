...
/**
 * Collection response for PlannerChecklistItems
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerChecklistItemsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PlannerChecklistItems[] $items
     * @return self
     */
    public function setValue(array|PlannerChecklistItems $items, PlannerChecklistItems ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PlannerChecklistItems> $value
     * @return self
     ...
     * 
     * @param PlannerChecklistItems $item
     * @return self
     */
    public function addValue(PlannerChecklistItems $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PlannerChecklistItems>
     */
