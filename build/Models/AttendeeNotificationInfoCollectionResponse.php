 ...
 */
class AttendeeNotificationInfoCollectionResponse
{
    /**
     ...
     * 
     * @param AttendeeNotificationInfo ...$items Variable number of AttendeeNotificationInfo items
     * @return self
     */
    public function setValue(AttendeeNotificationInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
