...
/**
 * Collection response for AttendeeNotificationInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttendeeNotificationInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AttendeeNotificationInfo[]
     */
    private array $value = [];
     ...
     * 
     * @param AttendeeNotificationInfo[] $items
     * @return self
     */
    public function setValue(array|AttendeeNotificationInfo $items, AttendeeNotificationInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttendeeNotificationInfo> $value
     * @return self
     ...
     * 
     * @param AttendeeNotificationInfo $item
     * @return self
     */
    public function addValue(AttendeeNotificationInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AttendeeNotificationInfo|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AttendeeNotificationInfo>
     */
