...
class IdentityProtectionRoot
{
     ...
     */
    private ?string $servicePrincipalRiskDetections;
    ...
    public function getServicePrincipalRiskDetections(): ?string
    {
        return $this->servicePrincipalRiskDetections;
    }

    public function setServicePrincipalRiskDetections(?string $servicePrincipalRiskDetections): self
    {
