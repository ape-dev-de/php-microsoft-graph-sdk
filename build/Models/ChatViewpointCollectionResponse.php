...
/**
 * Collection response for ChatViewpoint
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatViewpointCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChatViewpoint[]
     */
     ...
     * 
     * @param ChatViewpoint[] $items
     * @return self
     */
    public function setValue(array|ChatViewpoint $items, ChatViewpoint ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChatViewpoint> $value
     * @return self
     ...
     * 
     * @param ChatViewpoint $item
     * @return self
     */
    public function addValue(ChatViewpoint $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChatViewpoint>
     */
