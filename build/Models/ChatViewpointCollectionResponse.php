 ...
 */
class ChatViewpointCollectionResponse
{
    /**
     * @var ChatViewpoint[]
     */
     ...
     * 
     * @param ChatViewpoint ...$items Variable number of ChatViewpoint items
     * @return self
     */
    public function setValue(ChatViewpoint ...$items): self
    {
        $this->value = $items;
        return $this;
    }
