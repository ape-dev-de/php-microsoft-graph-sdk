...
/**
 * Collection response for Modality
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ModalityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Modality[]
     */
     ...
     * 
     * @param Modality[] $items
     * @return self
     */
    public function setValue(array|Modality $items, Modality ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Modality $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Modality>
     */
