...
/**
 * Collection response for ItemActivityStatCollectionResponse
 */
class ItemActivityStatCollectionResponseCollectionResponse
{
    /**
     * @var ItemActivityStatCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ItemActivityStatCollectionResponse ...$items Variable number of ItemActivityStatCollectionResponse items
     * @return self
     */
    public function setValue(ItemActivityStatCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ItemActivityStatCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ItemActivityStatCollectionResponse $item
     * @return self
     */
    public function addValue(ItemActivityStatCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
