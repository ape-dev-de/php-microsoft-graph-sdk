 ...
 */
class ApplicationServicePrincipalCollectionResponse
{
    /**
     ...
     * 
     * @param ApplicationServicePrincipal ...$items Variable number of ApplicationServicePrincipal items
     * @return self
     */
    public function setValue(ApplicationServicePrincipal ...$items): self
    {
        $this->value = $items;
        return $this;
    }
