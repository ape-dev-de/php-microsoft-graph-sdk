...
/**
 * Collection response for ApplicationServicePrincipal
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ApplicationServicePrincipalCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ApplicationServicePrincipal[] $items
     * @return self
     */
    public function setValue(array|ApplicationServicePrincipal $items, ApplicationServicePrincipal ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ApplicationServicePrincipal> $value
     * @return self
     ...
     * 
     * @param ApplicationServicePrincipal $item
     * @return self
     */
    public function addValue(ApplicationServicePrincipal $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ApplicationServicePrincipal>
     */
