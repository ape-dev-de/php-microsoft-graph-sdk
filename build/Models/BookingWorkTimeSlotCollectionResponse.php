...
/**
 * Collection response for BookingWorkTimeSlot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingWorkTimeSlotCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param BookingWorkTimeSlot[] $items
     * @return self
     */
    public function setValue(array|BookingWorkTimeSlot $items, BookingWorkTimeSlot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingWorkTimeSlot> $value
     * @return self
     ...
     * 
     * @param BookingWorkTimeSlot $item
     * @return self
     */
    public function addValue(BookingWorkTimeSlot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return BookingWorkTimeSlot|null
     */
     ...
     * 
     * @return \ArrayIterator<int, BookingWorkTimeSlot>
     */
