...
/**
 * Collection response for PermissionClassificationType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PermissionClassificationTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return PermissionClassificationType[]
     */
     ...
     * 
     * @param PermissionClassificationType[] $items
     * @return self
     */
    public function setValue(array|PermissionClassificationType $items, PermissionClassificationType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PermissionClassificationType> $value
     * @return self
     ...
     * 
     * @param PermissionClassificationType $item
     * @return self
     */
    public function addValue(PermissionClassificationType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PermissionClassificationType>
     */
