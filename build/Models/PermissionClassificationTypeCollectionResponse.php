...
/**
 * PermissionClassificationTypeCollectionResponse - Collection response
 */
class PermissionClassificationTypeCollectionResponse
{
    /**
     * @var array<int, PermissionClassificationType>
     */
    public array $value = [];
