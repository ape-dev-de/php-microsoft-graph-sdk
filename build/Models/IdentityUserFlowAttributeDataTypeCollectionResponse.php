...
/**
 * IdentityUserFlowAttributeDataTypeCollectionResponse - Collection response
 */
class IdentityUserFlowAttributeDataTypeCollectionResponse
{
    /**
     * @var array<int, IdentityUserFlowAttributeDataType>
     */
    public array $value = [];
