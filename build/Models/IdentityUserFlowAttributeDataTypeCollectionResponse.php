...
/**
 * Collection response for IdentityUserFlowAttributeDataType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityUserFlowAttributeDataTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityUserFlowAttributeDataType[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityUserFlowAttributeDataType[]
     */
     ...
     * 
     * @param IdentityUserFlowAttributeDataType[] $items
     * @return self
     */
    public function setValue(array|IdentityUserFlowAttributeDataType $items, IdentityUserFlowAttributeDataType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityUserFlowAttributeDataType> $value
     * @return self
     ...
     * 
     * @param IdentityUserFlowAttributeDataType $item
     * @return self
     */
    public function addValue(IdentityUserFlowAttributeDataType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityUserFlowAttributeDataType>
     */
