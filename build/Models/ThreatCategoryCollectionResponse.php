...
/**
 * Collection response for ThreatCategory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ThreatCategoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ThreatCategory[]
     */
     ...
     * 
     * @param ThreatCategory[] $items
     * @return self
     */
    public function setValue(array|ThreatCategory $items, ThreatCategory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ThreatCategory> $value
     * @return self
     ...
     * 
     * @param ThreatCategory $item
     * @return self
     */
    public function addValue(ThreatCategory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ThreatCategory>
     */
