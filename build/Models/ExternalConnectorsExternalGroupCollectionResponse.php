...
/**
 * ExternalConnectorsExternalGroupCollectionResponse - Collection response
 */
class ExternalConnectorsExternalGroupCollectionResponse
{
    /**
     * @var array<int, ExternalConnectorsExternalGroup>
     */
    public array $value = [];
