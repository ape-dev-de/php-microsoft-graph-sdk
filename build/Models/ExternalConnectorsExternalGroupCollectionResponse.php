...
/**
 * Collection response for ExternalConnectorsExternalGroup
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsExternalGroupCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ExternalConnectorsExternalGroup[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsExternalGroup $items, ExternalConnectorsExternalGroup ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsExternalGroup> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsExternalGroup $item
     * @return self
     */
    public function addValue(ExternalConnectorsExternalGroup $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsExternalGroup>
     */
