...
/**
 * Collection response for LearningAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LearningAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var LearningAssignment[]
     */
    private array $value = [];
     ...
     * 
     * @param LearningAssignment[] $items
     * @return self
     */
    public function setValue(array|LearningAssignment $items, LearningAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LearningAssignment> $value
     * @return self
     ...
     * 
     * @param LearningAssignment $item
     * @return self
     */
    public function addValue(LearningAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return LearningAssignment|null
     */
     ...
     * 
     * @return \ArrayIterator<int, LearningAssignment>
     */
