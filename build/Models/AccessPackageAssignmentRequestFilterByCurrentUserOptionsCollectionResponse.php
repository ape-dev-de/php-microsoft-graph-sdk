...
/**
 * Collection response for AccessPackageAssignmentRequestFilterByCurrentUserOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageAssignmentRequestFilterByCurrentUserOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageAssignmentRequestFilterByCurrentUserOptions[]
     */
    private array $value = [];
     ...
     * 
     * @return AccessPackageAssignmentRequestFilterByCurrentUserOptions[]
     */
     ...
     * 
     * @param AccessPackageAssignmentRequestFilterByCurrentUserOptions[] $items
     * @return self
     */
    public function setValue(array|AccessPackageAssignmentRequestFilterByCurrentUserOptions $items, AccessPackageAssignmentRequestFilterByCurrentUserOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageAssignmentRequestFilterByCurrentUserOptions> $value
     * @return self
     ...
     * 
     * @param AccessPackageAssignmentRequestFilterByCurrentUserOptions $item
     * @return self
     */
    public function addValue(AccessPackageAssignmentRequestFilterByCurrentUserOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessPackageAssignmentRequestFilterByCurrentUserOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageAssignmentRequestFilterByCurrentUserOptions>
     */
