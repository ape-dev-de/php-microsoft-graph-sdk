...
/**
 * AccessPackageAssignmentRequestFilterByCurrentUserOptionsCollectionResponse - Collection response
 */
class AccessPackageAssignmentRequestFilterByCurrentUserOptionsCollectionResponse
{
    /**
     * @var array<int, AccessPackageAssignmentRequestFilterByCurrentUserOptions>
     */
    public array $value = [];
