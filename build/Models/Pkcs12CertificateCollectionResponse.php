 ...
 */
class Pkcs12CertificateCollectionResponse
{
    /**
     ...
     * 
     * @param Pkcs12Certificate ...$items Variable number of Pkcs12Certificate items
     * @return self
     */
    public function setValue(Pkcs12Certificate ...$items): self
    {
        $this->value = $items;
        return $this;
    }
