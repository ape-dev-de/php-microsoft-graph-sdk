...
/**
 * Collection response for Pkcs12Certificate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Pkcs12CertificateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Pkcs12Certificate[]
     */
    private array $value = [];
     ...
     * 
     * @param Pkcs12Certificate[] $items
     * @return self
     */
    public function setValue(array|Pkcs12Certificate $items, Pkcs12Certificate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Pkcs12Certificate> $value
     * @return self
     ...
     * 
     * @param Pkcs12Certificate $item
     * @return self
     */
    public function addValue(Pkcs12Certificate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Pkcs12Certificate>
     */
