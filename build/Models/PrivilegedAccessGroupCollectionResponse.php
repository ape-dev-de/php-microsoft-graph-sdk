 ...
 */
class PrivilegedAccessGroupCollectionResponse
{
    /**
     ...
     * 
     * @param PrivilegedAccessGroup ...$items Variable number of PrivilegedAccessGroup items
     * @return self
     */
    public function setValue(PrivilegedAccessGroup ...$items): self
    {
        $this->value = $items;
        return $this;
    }
