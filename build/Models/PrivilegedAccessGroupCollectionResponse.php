...
/**
 * Collection response for PrivilegedAccessGroup
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrivilegedAccessGroupCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrivilegedAccessGroup[]
     */
    private array $value = [];
     ...
     * 
     * @param PrivilegedAccessGroup[] $items
     * @return self
     */
    public function setValue(array|PrivilegedAccessGroup $items, PrivilegedAccessGroup ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrivilegedAccessGroup> $value
     * @return self
     ...
     * 
     * @param PrivilegedAccessGroup $item
     * @return self
     */
    public function addValue(PrivilegedAccessGroup $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrivilegedAccessGroup>
     */
