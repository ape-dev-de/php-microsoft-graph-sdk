...
/**
 * Collection response for PlannerPlanCollectionResponse
 */
class PlannerPlanCollectionResponseCollectionResponse
{
    /**
     * @var PlannerPlanCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PlannerPlanCollectionResponse ...$items Variable number of PlannerPlanCollectionResponse items
     * @return self
     */
    public function setValue(PlannerPlanCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PlannerPlanCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PlannerPlanCollectionResponse $item
     * @return self
     */
    public function addValue(PlannerPlanCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
