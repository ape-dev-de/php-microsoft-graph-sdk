...
/**
 * Collection response for WindowsDeliveryOptimizationMode
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsDeliveryOptimizationModeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return WindowsDeliveryOptimizationMode[]
     */
     ...
     * 
     * @param WindowsDeliveryOptimizationMode[] $items
     * @return self
     */
    public function setValue(array|WindowsDeliveryOptimizationMode $items, WindowsDeliveryOptimizationMode ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsDeliveryOptimizationMode> $value
     * @return self
     ...
     * 
     * @param WindowsDeliveryOptimizationMode $item
     * @return self
     */
    public function addValue(WindowsDeliveryOptimizationMode $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsDeliveryOptimizationMode>
     */
