...
/**
 * WindowsDeliveryOptimizationModeCollectionResponse - Collection response
 */
class WindowsDeliveryOptimizationModeCollectionResponse
{
    /**
     * @var array<int, WindowsDeliveryOptimizationMode>
     */
    public array $value = [];
