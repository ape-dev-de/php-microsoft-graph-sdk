...
/**
 * Collection response for DefenderCloudBlockLevelType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DefenderCloudBlockLevelTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DefenderCloudBlockLevelType[]
     */
    private array $value = [];
     ...
     * 
     * @return DefenderCloudBlockLevelType[]
     */
     ...
     * 
     * @param DefenderCloudBlockLevelType[] $items
     * @return self
     */
    public function setValue(array|DefenderCloudBlockLevelType $items, DefenderCloudBlockLevelType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DefenderCloudBlockLevelType> $value
     * @return self
     ...
     * 
     * @param DefenderCloudBlockLevelType $item
     * @return self
     */
    public function addValue(DefenderCloudBlockLevelType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DefenderCloudBlockLevelType>
     */
