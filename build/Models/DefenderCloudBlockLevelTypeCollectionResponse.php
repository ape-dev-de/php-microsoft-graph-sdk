...
/**
 * DefenderCloudBlockLevelTypeCollectionResponse - Collection response
 */
class DefenderCloudBlockLevelTypeCollectionResponse
{
    /**
     * @var array<int, DefenderCloudBlockLevelType>
     */
    public array $value = [];
