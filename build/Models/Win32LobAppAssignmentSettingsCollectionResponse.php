...
/**
 * Collection response for Win32LobAppAssignmentSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Win32LobAppAssignmentSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Win32LobAppAssignmentSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param Win32LobAppAssignmentSettings[] $items
     * @return self
     */
    public function setValue(array|Win32LobAppAssignmentSettings $items, Win32LobAppAssignmentSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Win32LobAppAssignmentSettings> $value
     * @return self
     ...
     * 
     * @param Win32LobAppAssignmentSettings $item
     * @return self
     */
    public function addValue(Win32LobAppAssignmentSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return Win32LobAppAssignmentSettings|null
     */
     ...
     * 
     * @return \ArrayIterator<int, Win32LobAppAssignmentSettings>
     */
