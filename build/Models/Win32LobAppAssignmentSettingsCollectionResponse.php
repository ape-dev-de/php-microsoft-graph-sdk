 ...
 */
class Win32LobAppAssignmentSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param Win32LobAppAssignmentSettings ...$items Variable number of Win32LobAppAssignmentSettings items
     * @return self
     */
    public function setValue(Win32LobAppAssignmentSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
