...
/**
 * Collection response for ContentActivity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ContentActivityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ContentActivity[]
     */
     ...
     * 
     * @param ContentActivity[] $items
     * @return self
     */
    public function setValue(array|ContentActivity $items, ContentActivity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ContentActivity> $value
     * @return self
     ...
     * 
     * @param ContentActivity $item
     * @return self
     */
    public function addValue(ContentActivity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ContentActivity>
     */
