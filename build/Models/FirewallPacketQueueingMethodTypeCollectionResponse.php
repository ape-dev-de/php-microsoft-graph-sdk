...
/**
 * FirewallPacketQueueingMethodTypeCollectionResponse - Collection response
 */
class FirewallPacketQueueingMethodTypeCollectionResponse
{
    /**
     * @var array<int, FirewallPacketQueueingMethodType>
     */
    public array $value = [];
