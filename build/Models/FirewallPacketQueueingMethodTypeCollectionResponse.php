...
/**
 * Collection response for FirewallPacketQueueingMethodType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FirewallPacketQueueingMethodTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FirewallPacketQueueingMethodType[]
     */
    private array $value = [];
     ...
     * 
     * @return FirewallPacketQueueingMethodType[]
     */
     ...
     * 
     * @param FirewallPacketQueueingMethodType[] $items
     * @return self
     */
    public function setValue(array|FirewallPacketQueueingMethodType $items, FirewallPacketQueueingMethodType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FirewallPacketQueueingMethodType> $value
     * @return self
     ...
     * 
     * @param FirewallPacketQueueingMethodType $item
     * @return self
     */
    public function addValue(FirewallPacketQueueingMethodType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FirewallPacketQueueingMethodType>
     */
