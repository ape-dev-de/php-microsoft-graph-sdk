...
/**
 * Collection response for SmsAuthenticationMethodTarget
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SmsAuthenticationMethodTargetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SmsAuthenticationMethodTarget[] $items
     * @return self
     */
    public function setValue(array|SmsAuthenticationMethodTarget $items, SmsAuthenticationMethodTarget ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SmsAuthenticationMethodTarget> $value
     * @return self
     ...
     * 
     * @param SmsAuthenticationMethodTarget $item
     * @return self
     */
    public function addValue(SmsAuthenticationMethodTarget $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SmsAuthenticationMethodTarget|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SmsAuthenticationMethodTarget>
     */
