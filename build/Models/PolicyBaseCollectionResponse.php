...
/**
 * Collection response for PolicyBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PolicyBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PolicyBase[]
     */
     ...
     * 
     * @param PolicyBase[] $items
     * @return self
     */
    public function setValue(array|PolicyBase $items, PolicyBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param PolicyBase $item
     * @return self
     */
    public function addValue(PolicyBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PolicyBase>
     */
