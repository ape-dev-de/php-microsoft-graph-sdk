...
/**
 * Collection response for CallState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallState[]
     */
     ...
     * 
     * @param CallState[] $items
     * @return self
     */
    public function setValue(array|CallState $items, CallState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param CallState $item
     * @return self
     */
    public function addValue(CallState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CallState>
     */
