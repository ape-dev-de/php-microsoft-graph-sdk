...
/**
 * Collection response for RecycleBin
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RecycleBinCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RecycleBin[]
     */
     ...
     * 
     * @param RecycleBin[] $items
     * @return self
     */
    public function setValue(array|RecycleBin $items, RecycleBin ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param RecycleBin $item
     * @return self
     */
    public function addValue(RecycleBin $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RecycleBin>
     */
