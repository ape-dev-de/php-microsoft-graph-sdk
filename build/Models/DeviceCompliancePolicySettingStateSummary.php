...
class DeviceCompliancePolicySettingStateSummary
{
     ...
     */
    private ?string $deviceComplianceSettingStates;
    ...
    public function getDeviceComplianceSettingStates(): ?string
    {
        return $this->deviceComplianceSettingStates;
    }

    public function setDeviceComplianceSettingStates(?string $deviceComplianceSettingStates): self
    {
