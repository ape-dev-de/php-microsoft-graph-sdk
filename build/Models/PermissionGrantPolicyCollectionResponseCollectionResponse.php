...
/**
 * Collection response for PermissionGrantPolicyCollectionResponse
 */
class PermissionGrantPolicyCollectionResponseCollectionResponse
{
    /**
     * @var PermissionGrantPolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PermissionGrantPolicyCollectionResponse ...$items Variable number of PermissionGrantPolicyCollectionResponse items
     * @return self
     */
    public function setValue(PermissionGrantPolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PermissionGrantPolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PermissionGrantPolicyCollectionResponse $item
     * @return self
     */
    public function addValue(PermissionGrantPolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
