...
/**
 * Collection response for MailAssessmentRequestCollectionResponse
 */
class MailAssessmentRequestCollectionResponseCollectionResponse
{
    /**
     * @var MailAssessmentRequestCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MailAssessmentRequestCollectionResponse ...$items Variable number of MailAssessmentRequestCollectionResponse items
     * @return self
     */
    public function setValue(MailAssessmentRequestCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MailAssessmentRequestCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MailAssessmentRequestCollectionResponse $item
     * @return self
     */
    public function addValue(MailAssessmentRequestCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
