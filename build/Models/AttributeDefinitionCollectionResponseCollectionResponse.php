...
/**
 * Collection response for AttributeDefinitionCollectionResponse
 */
class AttributeDefinitionCollectionResponseCollectionResponse
{
    /**
     * @var AttributeDefinitionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AttributeDefinitionCollectionResponse ...$items Variable number of AttributeDefinitionCollectionResponse items
     * @return self
     */
    public function setValue(AttributeDefinitionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AttributeDefinitionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AttributeDefinitionCollectionResponse $item
     * @return self
     */
    public function addValue(AttributeDefinitionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
