...
/**
 * Collection response for AccessPackageAssignmentCollectionResponse
 */
class AccessPackageAssignmentCollectionResponseCollectionResponse
{
    /**
     * @var AccessPackageAssignmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageAssignmentCollectionResponse ...$items Variable number of AccessPackageAssignmentCollectionResponse items
     * @return self
     */
    public function setValue(AccessPackageAssignmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AccessPackageAssignmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AccessPackageAssignmentCollectionResponse $item
     * @return self
     */
    public function addValue(AccessPackageAssignmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
