...
/**
 * Collection response for Importance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ImportanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Importance[]
     */
     ...
     * 
     * @param Importance[] $items
     * @return self
     */
    public function setValue(array|Importance $items, Importance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param Importance $item
     * @return self
     */
    public function addValue(Importance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Importance>
     */
