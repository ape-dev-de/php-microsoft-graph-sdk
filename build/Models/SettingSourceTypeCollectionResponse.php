...
/**
 * Collection response for SettingSourceType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SettingSourceTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SettingSourceType[] $items
     * @return self
     */
    public function setValue(array|SettingSourceType $items, SettingSourceType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SettingSourceType> $value
     * @return self
     ...
     * 
     * @param SettingSourceType $item
     * @return self
     */
    public function addValue(SettingSourceType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SettingSourceType>
     */
