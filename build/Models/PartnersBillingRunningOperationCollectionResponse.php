...
/**
 * Collection response for PartnersBillingRunningOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PartnersBillingRunningOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PartnersBillingRunningOperation[]
     */
    private array $value = [];
     ...
     * 
     * @return PartnersBillingRunningOperation[]
     */
     ...
     * 
     * @param PartnersBillingRunningOperation[] $items
     * @return self
     */
    public function setValue(array|PartnersBillingRunningOperation $items, PartnersBillingRunningOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PartnersBillingRunningOperation> $value
     * @return self
     ...
     * 
     * @param PartnersBillingRunningOperation $item
     * @return self
     */
    public function addValue(PartnersBillingRunningOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PartnersBillingRunningOperation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PartnersBillingRunningOperation>
     */
