...
/**
 * PartnersBillingRunningOperationCollectionResponse - Collection response
 */
class PartnersBillingRunningOperationCollectionResponse
{
    /**
     * @var array<int, PartnersBillingRunningOperation>
     */
    public array $value = [];
