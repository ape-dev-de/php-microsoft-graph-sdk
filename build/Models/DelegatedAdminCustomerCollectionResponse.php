...
/**
 * Collection response for DelegatedAdminCustomer
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DelegatedAdminCustomerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DelegatedAdminCustomer[] $items
     * @return self
     */
    public function setValue(array|DelegatedAdminCustomer $items, DelegatedAdminCustomer ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DelegatedAdminCustomer> $value
     * @return self
     ...
     * 
     * @param DelegatedAdminCustomer $item
     * @return self
     */
    public function addValue(DelegatedAdminCustomer $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DelegatedAdminCustomer>
     */
