...
/**
 * Collection response for PermissionScopeCollectionResponse
 */
class PermissionScopeCollectionResponseCollectionResponse
{
    /**
     * @var PermissionScopeCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PermissionScopeCollectionResponse ...$items Variable number of PermissionScopeCollectionResponse items
     * @return self
     */
    public function setValue(PermissionScopeCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PermissionScopeCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PermissionScopeCollectionResponse $item
     * @return self
     */
    public function addValue(PermissionScopeCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
