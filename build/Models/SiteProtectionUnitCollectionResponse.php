...
/**
 * Collection response for SiteProtectionUnit
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SiteProtectionUnitCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SiteProtectionUnit[] $items
     * @return self
     */
    public function setValue(array|SiteProtectionUnit $items, SiteProtectionUnit ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SiteProtectionUnit> $value
     * @return self
     ...
     * 
     * @param SiteProtectionUnit $item
     * @return self
     */
    public function addValue(SiteProtectionUnit $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SiteProtectionUnit>
     */
