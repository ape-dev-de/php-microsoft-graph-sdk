...
/**
 * Collection response for PermissionCollectionResponse
 */
class PermissionCollectionResponseCollectionResponse
{
    /**
     * @var PermissionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PermissionCollectionResponse ...$items Variable number of PermissionCollectionResponse items
     * @return self
     */
    public function setValue(PermissionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PermissionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PermissionCollectionResponse $item
     * @return self
     */
    public function addValue(PermissionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
