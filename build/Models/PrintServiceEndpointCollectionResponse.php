...
/**
 * Collection response for PrintServiceEndpoint
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintServiceEndpointCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PrintServiceEndpoint[] $items
     * @return self
     */
    public function setValue(array|PrintServiceEndpoint $items, PrintServiceEndpoint ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintServiceEndpoint> $value
     * @return self
     ...
     * 
     * @param PrintServiceEndpoint $item
     * @return self
     */
    public function addValue(PrintServiceEndpoint $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintServiceEndpoint>
     */
