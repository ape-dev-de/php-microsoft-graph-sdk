...
/**
 * SecurityBehaviorDuringRetentionPeriodCollectionResponse - Collection response
 */
class SecurityBehaviorDuringRetentionPeriodCollectionResponse
{
    /**
     * @var array<int, SecurityBehaviorDuringRetentionPeriod>
     */
    public array $value = [];
