...
/**
 * Collection response for SecurityBehaviorDuringRetentionPeriod
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityBehaviorDuringRetentionPeriodCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityBehaviorDuringRetentionPeriod[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityBehaviorDuringRetentionPeriod[]
     */
     ...
     * 
     * @param SecurityBehaviorDuringRetentionPeriod[] $items
     * @return self
     */
    public function setValue(array|SecurityBehaviorDuringRetentionPeriod $items, SecurityBehaviorDuringRetentionPeriod ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityBehaviorDuringRetentionPeriod> $value
     * @return self
     ...
     * 
     * @param SecurityBehaviorDuringRetentionPeriod $item
     * @return self
     */
    public function addValue(SecurityBehaviorDuringRetentionPeriod $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityBehaviorDuringRetentionPeriod|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityBehaviorDuringRetentionPeriod>
     */
