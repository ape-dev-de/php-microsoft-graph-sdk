...
/**
 * SecurityIntelligenceProfileCollectionResponse - Collection response
 */
class SecurityIntelligenceProfileCollectionResponse
{
    /**
     * @var array<int, SecurityIntelligenceProfile>
     */
    public array $value = [];
