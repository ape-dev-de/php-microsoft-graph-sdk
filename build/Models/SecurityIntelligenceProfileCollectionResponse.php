...
/**
 * Collection response for SecurityIntelligenceProfile
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityIntelligenceProfileCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityIntelligenceProfile[] $items
     * @return self
     */
    public function setValue(array|SecurityIntelligenceProfile $items, SecurityIntelligenceProfile ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityIntelligenceProfile> $value
     * @return self
     ...
     * 
     * @param SecurityIntelligenceProfile $item
     * @return self
     */
    public function addValue(SecurityIntelligenceProfile $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityIntelligenceProfile>
     */
