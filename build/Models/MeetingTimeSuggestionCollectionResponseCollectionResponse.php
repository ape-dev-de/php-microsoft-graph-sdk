...
/**
 * Collection response for MeetingTimeSuggestionCollectionResponse
 */
class MeetingTimeSuggestionCollectionResponseCollectionResponse
{
    /**
     * @var MeetingTimeSuggestionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MeetingTimeSuggestionCollectionResponse ...$items Variable number of MeetingTimeSuggestionCollectionResponse items
     * @return self
     */
    public function setValue(MeetingTimeSuggestionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MeetingTimeSuggestionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MeetingTimeSuggestionCollectionResponse $item
     * @return self
     */
    public function addValue(MeetingTimeSuggestionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
