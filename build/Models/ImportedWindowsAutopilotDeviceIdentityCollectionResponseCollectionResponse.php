...
/**
 * Collection response for ImportedWindowsAutopilotDeviceIdentityCollectionResponse
 */
class ImportedWindowsAutopilotDeviceIdentityCollectionResponseCollectionResponse
{
    /**
     * @var ImportedWindowsAutopilotDeviceIdentityCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ImportedWindowsAutopilotDeviceIdentityCollectionResponse ...$items Variable number of ImportedWindowsAutopilotDeviceIdentityCollectionResponse items
     * @return self
     */
    public function setValue(ImportedWindowsAutopilotDeviceIdentityCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ImportedWindowsAutopilotDeviceIdentityCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ImportedWindowsAutopilotDeviceIdentityCollectionResponse $item
     * @return self
     */
    public function addValue(ImportedWindowsAutopilotDeviceIdentityCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
