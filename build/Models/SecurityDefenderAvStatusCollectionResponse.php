...
/**
 * Collection response for SecurityDefenderAvStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityDefenderAvStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityDefenderAvStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityDefenderAvStatus[]
     */
     ...
     * 
     * @param SecurityDefenderAvStatus[] $items
     * @return self
     */
    public function setValue(array|SecurityDefenderAvStatus $items, SecurityDefenderAvStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityDefenderAvStatus> $value
     * @return self
     ...
     * 
     * @param SecurityDefenderAvStatus $item
     * @return self
     */
    public function addValue(SecurityDefenderAvStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityDefenderAvStatus|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityDefenderAvStatus>
     */
