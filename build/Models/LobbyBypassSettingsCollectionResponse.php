 ...
 */
class LobbyBypassSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param LobbyBypassSettings ...$items Variable number of LobbyBypassSettings items
     * @return self
     */
    public function setValue(LobbyBypassSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
