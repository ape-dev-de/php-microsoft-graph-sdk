...
/**
 * Collection response for LobbyBypassSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LobbyBypassSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var LobbyBypassSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param LobbyBypassSettings[] $items
     * @return self
     */
    public function setValue(array|LobbyBypassSettings $items, LobbyBypassSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LobbyBypassSettings> $value
     * @return self
     ...
     * 
     * @param LobbyBypassSettings $item
     * @return self
     */
    public function addValue(LobbyBypassSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LobbyBypassSettings>
     */
