...
/**
 * Collection response for ManagedAppPolicyDeploymentSummaryPerApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedAppPolicyDeploymentSummaryPerAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ManagedAppPolicyDeploymentSummaryPerApp[] $items
     * @return self
     */
    public function setValue(array|ManagedAppPolicyDeploymentSummaryPerApp $items, ManagedAppPolicyDeploymentSummaryPerApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedAppPolicyDeploymentSummaryPerApp> $value
     * @return self
     ...
     * 
     * @param ManagedAppPolicyDeploymentSummaryPerApp $item
     * @return self
     */
    public function addValue(ManagedAppPolicyDeploymentSummaryPerApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ManagedAppPolicyDeploymentSummaryPerApp|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ManagedAppPolicyDeploymentSummaryPerApp>
     */
