...
/**
 * Collection response for SharedPCConfigurationCollectionResponse
 */
class SharedPCConfigurationCollectionResponseCollectionResponse
{
    /**
     * @var SharedPCConfigurationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SharedPCConfigurationCollectionResponse ...$items Variable number of SharedPCConfigurationCollectionResponse items
     * @return self
     */
    public function setValue(SharedPCConfigurationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SharedPCConfigurationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SharedPCConfigurationCollectionResponse $item
     * @return self
     */
    public function addValue(SharedPCConfigurationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
