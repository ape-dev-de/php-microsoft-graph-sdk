...
/**
 * Collection response for OnOtpSendHandler
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnOtpSendHandlerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnOtpSendHandler[]
     */
    private array $value = [];
     ...
     * 
     * @param OnOtpSendHandler[] $items
     * @return self
     */
    public function setValue(array|OnOtpSendHandler $items, OnOtpSendHandler ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnOtpSendHandler> $value
     * @return self
     ...
     * 
     * @param OnOtpSendHandler $item
     * @return self
     */
    public function addValue(OnOtpSendHandler $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnOtpSendHandler>
     */
