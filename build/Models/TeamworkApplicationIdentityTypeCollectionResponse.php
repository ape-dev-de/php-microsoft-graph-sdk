...
/**
 * Collection response for TeamworkApplicationIdentityType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamworkApplicationIdentityTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamworkApplicationIdentityType[]
     */
    private array $value = [];
     ...
     * 
     * @return TeamworkApplicationIdentityType[]
     */
     ...
     * 
     * @param TeamworkApplicationIdentityType[] $items
     * @return self
     */
    public function setValue(array|TeamworkApplicationIdentityType $items, TeamworkApplicationIdentityType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamworkApplicationIdentityType> $value
     * @return self
     ...
     * 
     * @param TeamworkApplicationIdentityType $item
     * @return self
     */
    public function addValue(TeamworkApplicationIdentityType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamworkApplicationIdentityType>
     */
