...
/**
 * TeamworkApplicationIdentityTypeCollectionResponse - Collection response
 */
class TeamworkApplicationIdentityTypeCollectionResponse
{
    /**
     * @var array<int, TeamworkApplicationIdentityType>
     */
    public array $value = [];
