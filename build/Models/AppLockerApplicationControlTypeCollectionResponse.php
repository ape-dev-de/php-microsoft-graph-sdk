...
/**
 * AppLockerApplicationControlTypeCollectionResponse - Collection response
 */
class AppLockerApplicationControlTypeCollectionResponse
{
    /**
     * @var array<int, AppLockerApplicationControlType>
     */
    public array $value = [];
