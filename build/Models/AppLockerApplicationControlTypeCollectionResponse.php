...
/**
 * Collection response for AppLockerApplicationControlType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppLockerApplicationControlTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AppLockerApplicationControlType[]
     */
    private array $value = [];
     ...
     * 
     * @return AppLockerApplicationControlType[]
     */
     ...
     * 
     * @param AppLockerApplicationControlType[] $items
     * @return self
     */
    public function setValue(array|AppLockerApplicationControlType $items, AppLockerApplicationControlType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppLockerApplicationControlType> $value
     * @return self
     ...
     * 
     * @param AppLockerApplicationControlType $item
     * @return self
     */
    public function addValue(AppLockerApplicationControlType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AppLockerApplicationControlType>
     */
