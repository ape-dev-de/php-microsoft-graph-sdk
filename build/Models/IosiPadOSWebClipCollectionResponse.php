...
/**
 * Collection response for IosiPadOSWebClip
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosiPadOSWebClipCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IosiPadOSWebClip[]
     */
    private array $value = [];
     ...
     * 
     * @param IosiPadOSWebClip[] $items
     * @return self
     */
    public function setValue(array|IosiPadOSWebClip $items, IosiPadOSWebClip ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosiPadOSWebClip> $value
     * @return self
     ...
     * 
     * @param IosiPadOSWebClip $item
     * @return self
     */
    public function addValue(IosiPadOSWebClip $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IosiPadOSWebClip>
     */
