 ...
 */
class ComputeRightsAndInheritanceResultCollectionResponse
{
    /**
     ...
     * 
     * @param ComputeRightsAndInheritanceResult ...$items Variable number of ComputeRightsAndInheritanceResult items
     * @return self
     */
    public function setValue(ComputeRightsAndInheritanceResult ...$items): self
    {
        $this->value = $items;
        return $this;
    }
