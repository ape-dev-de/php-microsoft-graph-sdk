...
/**
 * Collection response for ComputeRightsAndInheritanceResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ComputeRightsAndInheritanceResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ComputeRightsAndInheritanceResult[]
     */
    private array $value = [];
     ...
     * 
     * @param ComputeRightsAndInheritanceResult[] $items
     * @return self
     */
    public function setValue(array|ComputeRightsAndInheritanceResult $items, ComputeRightsAndInheritanceResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ComputeRightsAndInheritanceResult> $value
     * @return self
     ...
     * 
     * @param ComputeRightsAndInheritanceResult $item
     * @return self
     */
    public function addValue(ComputeRightsAndInheritanceResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ComputeRightsAndInheritanceResult|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ComputeRightsAndInheritanceResult>
     */
