...
/**
 * ThreatAssessmentResultTypeCollectionResponse - Collection response
 */
class ThreatAssessmentResultTypeCollectionResponse
{
    /**
     * @var array<int, ThreatAssessmentResultType>
     */
    public array $value = [];
