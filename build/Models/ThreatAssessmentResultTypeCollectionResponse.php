...
/**
 * Collection response for ThreatAssessmentResultType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ThreatAssessmentResultTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return ThreatAssessmentResultType[]
     */
     ...
     * 
     * @param ThreatAssessmentResultType[] $items
     * @return self
     */
    public function setValue(array|ThreatAssessmentResultType $items, ThreatAssessmentResultType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ThreatAssessmentResultType> $value
     * @return self
     ...
     * 
     * @param ThreatAssessmentResultType $item
     * @return self
     */
    public function addValue(ThreatAssessmentResultType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ThreatAssessmentResultType>
     */
