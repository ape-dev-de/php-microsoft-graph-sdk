 ...
 */
class BinaryContentCollectionResponse
{
    /**
     * @var BinaryContent[]
     */
     ...
     * 
     * @param BinaryContent ...$items Variable number of BinaryContent items
     * @return self
     */
    public function setValue(BinaryContent ...$items): self
    {
        $this->value = $items;
        return $this;
    }
