...
/**
 * Collection response for BinaryContent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BinaryContentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BinaryContent[]
     */
     ...
     * 
     * @param BinaryContent[] $items
     * @return self
     */
    public function setValue(array|BinaryContent $items, BinaryContent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BinaryContent> $value
     * @return self
     ...
     * 
     * @param BinaryContent $item
     * @return self
     */
    public function addValue(BinaryContent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BinaryContent>
     */
