...
/**
 * Collection response for Partners
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PartnersCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Partners[]
     */
     ...
     * 
     * @param Partners[] $items
     * @return self
     */
    public function setValue(array|Partners $items, Partners ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Partners $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Partners>
     */
