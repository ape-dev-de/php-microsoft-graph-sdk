...
/**
 * Collection response for OnPremisesDirectorySynchronizationFeature
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnPremisesDirectorySynchronizationFeatureCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnPremisesDirectorySynchronizationFeature[]
     */
    private array $value = [];
     ...
     * 
     * @param OnPremisesDirectorySynchronizationFeature[] $items
     * @return self
     */
    public function setValue(array|OnPremisesDirectorySynchronizationFeature $items, OnPremisesDirectorySynchronizationFeature ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnPremisesDirectorySynchronizationFeature> $value
     * @return self
     ...
     * 
     * @param OnPremisesDirectorySynchronizationFeature $item
     * @return self
     */
    public function addValue(OnPremisesDirectorySynchronizationFeature $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnPremisesDirectorySynchronizationFeature>
     */
