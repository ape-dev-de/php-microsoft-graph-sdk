 ...
 */
class OnPremisesDirectorySynchronizationFeatureCollectionResponse
{
    /**
     ...
     * 
     * @param OnPremisesDirectorySynchronizationFeature ...$items Variable number of OnPremisesDirectorySynchronizationFeature items
     * @return self
     */
    public function setValue(OnPremisesDirectorySynchronizationFeature ...$items): self
    {
        $this->value = $items;
        return $this;
    }
