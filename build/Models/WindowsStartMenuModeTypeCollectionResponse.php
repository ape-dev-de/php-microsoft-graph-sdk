...
/**
 * Collection response for WindowsStartMenuModeType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsStartMenuModeTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsStartMenuModeType[]
     */
    private array $value = [];
     ...
     * 
     * @return WindowsStartMenuModeType[]
     */
     ...
     * 
     * @param WindowsStartMenuModeType[] $items
     * @return self
     */
    public function setValue(array|WindowsStartMenuModeType $items, WindowsStartMenuModeType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsStartMenuModeType> $value
     * @return self
     ...
     * 
     * @param WindowsStartMenuModeType $item
     * @return self
     */
    public function addValue(WindowsStartMenuModeType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsStartMenuModeType>
     */
