...
/**
 * Collection response for PrintOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrintOperation[]
     */
     ...
     * 
     * @param PrintOperation[] $items
     * @return self
     */
    public function setValue(array|PrintOperation $items, PrintOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintOperation> $value
     * @return self
     ...
     * 
     * @param PrintOperation $item
     * @return self
     */
    public function addValue(PrintOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintOperation>
     */
