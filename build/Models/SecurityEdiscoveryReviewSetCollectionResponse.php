...
/**
 * SecurityEdiscoveryReviewSetCollectionResponse - Collection response
 */
class SecurityEdiscoveryReviewSetCollectionResponse
{
    /**
     * @var array<int, SecurityEdiscoveryReviewSet>
     */
    public array $value = [];
