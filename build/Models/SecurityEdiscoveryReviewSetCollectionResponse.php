...
/**
 * Collection response for SecurityEdiscoveryReviewSet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityEdiscoveryReviewSetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityEdiscoveryReviewSet[] $items
     * @return self
     */
    public function setValue(array|SecurityEdiscoveryReviewSet $items, SecurityEdiscoveryReviewSet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityEdiscoveryReviewSet> $value
     * @return self
     ...
     * 
     * @param SecurityEdiscoveryReviewSet $item
     * @return self
     */
    public function addValue(SecurityEdiscoveryReviewSet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityEdiscoveryReviewSet>
     */
