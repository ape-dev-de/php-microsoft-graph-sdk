 ...
 */
class OnPremisesDirectorySynchronizationConfigurationCollectionResponse
{
    /**
     ...
     * 
     * @param OnPremisesDirectorySynchronizationConfiguration ...$items Variable number of OnPremisesDirectorySynchronizationConfiguration items
     * @return self
     */
    public function setValue(OnPremisesDirectorySynchronizationConfiguration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
