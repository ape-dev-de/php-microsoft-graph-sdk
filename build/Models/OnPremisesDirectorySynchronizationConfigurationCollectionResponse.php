...
/**
 * Collection response for OnPremisesDirectorySynchronizationConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnPremisesDirectorySynchronizationConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnPremisesDirectorySynchronizationConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param OnPremisesDirectorySynchronizationConfiguration[] $items
     * @return self
     */
    public function setValue(array|OnPremisesDirectorySynchronizationConfiguration $items, OnPremisesDirectorySynchronizationConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnPremisesDirectorySynchronizationConfiguration> $value
     * @return self
     ...
     * 
     * @param OnPremisesDirectorySynchronizationConfiguration $item
     * @return self
     */
    public function addValue(OnPremisesDirectorySynchronizationConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnPremisesDirectorySynchronizationConfiguration>
     */
