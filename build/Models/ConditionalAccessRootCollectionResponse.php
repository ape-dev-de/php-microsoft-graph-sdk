 ...
 */
class ConditionalAccessRootCollectionResponse
{
    /**
     ...
     * 
     * @param ConditionalAccessRoot ...$items Variable number of ConditionalAccessRoot items
     * @return self
     */
    public function setValue(ConditionalAccessRoot ...$items): self
    {
        $this->value = $items;
        return $this;
    }
