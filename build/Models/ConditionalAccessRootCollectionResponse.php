...
/**
 * Collection response for ConditionalAccessRoot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessRootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessRoot[]
     */
    private array $value = [];
     ...
     * 
     * @param ConditionalAccessRoot[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessRoot $items, ConditionalAccessRoot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessRoot> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessRoot $item
     * @return self
     */
    public function addValue(ConditionalAccessRoot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessRoot>
     */
