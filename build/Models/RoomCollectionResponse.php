...
/**
 * Collection response for Room
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RoomCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Room[]
     */
     ...
     * @return self
     */
    public function setValue(array|Room $items, Room ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Room $item): self
    {
        $this->value[] = $item;
        return $this;
    }
