...
/**
 * Collection response for EnrollmentTroubleshootingEvent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EnrollmentTroubleshootingEventCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EnrollmentTroubleshootingEvent[]
     */
    private array $value = [];
     ...
     * 
     * @param EnrollmentTroubleshootingEvent[] $items
     * @return self
     */
    public function setValue(array|EnrollmentTroubleshootingEvent $items, EnrollmentTroubleshootingEvent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EnrollmentTroubleshootingEvent> $value
     * @return self
     ...
     * 
     * @param EnrollmentTroubleshootingEvent $item
     * @return self
     */
    public function addValue(EnrollmentTroubleshootingEvent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EnrollmentTroubleshootingEvent|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EnrollmentTroubleshootingEvent>
     */
