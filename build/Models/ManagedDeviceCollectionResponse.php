...
/**
 * Collection response for ManagedDevice
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedDeviceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ManagedDevice[]
     */
     ...
     * 
     * @param ManagedDevice[] $items
     * @return self
     */
    public function setValue(array|ManagedDevice $items, ManagedDevice ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedDevice> $value
     * @return self
     ...
     * 
     * @param ManagedDevice $item
     * @return self
     */
    public function addValue(ManagedDevice $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedDevice>
     */
