...
/**
 * Collection response for DevicePlatformType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DevicePlatformTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DevicePlatformType[] $items
     * @return self
     */
    public function setValue(array|DevicePlatformType $items, DevicePlatformType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DevicePlatformType> $value
     * @return self
     ...
     * 
     * @param DevicePlatformType $item
     * @return self
     */
    public function addValue(DevicePlatformType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DevicePlatformType>
     */
