...
/**
 * Collection response for RatingJapanTelevisionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RatingJapanTelevisionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RatingJapanTelevisionType[]
     */
    private array $value = [];
     ...
     * 
     * @return RatingJapanTelevisionType[]
     */
     ...
     * 
     * @param RatingJapanTelevisionType[] $items
     * @return self
     */
    public function setValue(array|RatingJapanTelevisionType $items, RatingJapanTelevisionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RatingJapanTelevisionType> $value
     * @return self
     ...
     * 
     * @param RatingJapanTelevisionType $item
     * @return self
     */
    public function addValue(RatingJapanTelevisionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RatingJapanTelevisionType>
     */
