...
/**
 * RatingJapanTelevisionTypeCollectionResponse - Collection response
 */
class RatingJapanTelevisionTypeCollectionResponse
{
    /**
     * @var array<int, RatingJapanTelevisionType>
     */
    public array $value = [];
