 ...
 */
class ResetPasscodeActionResultCollectionResponse
{
    /**
     ...
     * 
     * @param ResetPasscodeActionResult ...$items Variable number of ResetPasscodeActionResult items
     * @return self
     */
    public function setValue(ResetPasscodeActionResult ...$items): self
    {
        $this->value = $items;
        return $this;
    }
