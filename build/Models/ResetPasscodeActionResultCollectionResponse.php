...
/**
 * Collection response for ResetPasscodeActionResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ResetPasscodeActionResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ResetPasscodeActionResult[]
     */
    private array $value = [];
     ...
     * 
     * @param ResetPasscodeActionResult[] $items
     * @return self
     */
    public function setValue(array|ResetPasscodeActionResult $items, ResetPasscodeActionResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ResetPasscodeActionResult> $value
     * @return self
     ...
     * 
     * @param ResetPasscodeActionResult $item
     * @return self
     */
    public function addValue(ResetPasscodeActionResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ResetPasscodeActionResult|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ResetPasscodeActionResult>
     */
