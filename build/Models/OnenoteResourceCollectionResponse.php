...
/**
 * Collection response for OnenoteResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnenoteResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnenoteResource[]
     */
     ...
     * 
     * @param OnenoteResource[] $items
     * @return self
     */
    public function setValue(array|OnenoteResource $items, OnenoteResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnenoteResource> $value
     * @return self
     ...
     * 
     * @param OnenoteResource $item
     * @return self
     */
    public function addValue(OnenoteResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnenoteResource>
     */
