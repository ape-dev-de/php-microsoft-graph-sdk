 ...
 */
class Win32LobAppProductCodeRuleCollectionResponse
{
    /**
     ...
     * 
     * @param Win32LobAppProductCodeRule ...$items Variable number of Win32LobAppProductCodeRule items
     * @return self
     */
    public function setValue(Win32LobAppProductCodeRule ...$items): self
    {
        $this->value = $items;
        return $this;
    }
