...
/**
 * Collection response for Win32LobAppProductCodeRule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Win32LobAppProductCodeRuleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Win32LobAppProductCodeRule[]
     */
    private array $value = [];
     ...
     * 
     * @param Win32LobAppProductCodeRule[] $items
     * @return self
     */
    public function setValue(array|Win32LobAppProductCodeRule $items, Win32LobAppProductCodeRule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Win32LobAppProductCodeRule> $value
     * @return self
     ...
     * 
     * @param Win32LobAppProductCodeRule $item
     * @return self
     */
    public function addValue(Win32LobAppProductCodeRule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return Win32LobAppProductCodeRule|null
     */
     ...
     * 
     * @return \ArrayIterator<int, Win32LobAppProductCodeRule>
     */
