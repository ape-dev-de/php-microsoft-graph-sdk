...
/**
 * Collection response for UserActivityTypes
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserActivityTypesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserActivityTypes[] $items
     * @return self
     */
    public function setValue(array|UserActivityTypes $items, UserActivityTypes ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserActivityTypes> $value
     * @return self
     ...
     * 
     * @param UserActivityTypes $item
     * @return self
     */
    public function addValue(UserActivityTypes $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserActivityTypes>
     */
