...
/**
 * Collection response for Call
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Call[]
     */
     ...
     * @return self
     */
    public function setValue(array|Call $items, Call ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Call $item): self
    {
        $this->value[] = $item;
        return $this;
    }
