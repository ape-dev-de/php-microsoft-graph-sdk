...
/**
 * Collection response for AttachmentType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttachmentTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AttachmentType[]
     */
     ...
     * 
     * @param AttachmentType[] $items
     * @return self
     */
    public function setValue(array|AttachmentType $items, AttachmentType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttachmentType> $value
     * @return self
     ...
     * @return self
     */
    public function addValue(AttachmentType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AttachmentType>
     */
