...
/**
 * Collection response for LobbyBypassScope
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LobbyBypassScopeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param LobbyBypassScope[] $items
     * @return self
     */
    public function setValue(array|LobbyBypassScope $items, LobbyBypassScope ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LobbyBypassScope> $value
     * @return self
     ...
     * 
     * @param LobbyBypassScope $item
     * @return self
     */
    public function addValue(LobbyBypassScope $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LobbyBypassScope>
     */
