...
/**
 * Collection response for WebBrowserCookieSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WebBrowserCookieSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WebBrowserCookieSettings[]
     */
    private array $value = [];
     ...
     * 
     * @return WebBrowserCookieSettings[]
     */
     ...
     * 
     * @param WebBrowserCookieSettings[] $items
     * @return self
     */
    public function setValue(array|WebBrowserCookieSettings $items, WebBrowserCookieSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WebBrowserCookieSettings> $value
     * @return self
     ...
     * 
     * @param WebBrowserCookieSettings $item
     * @return self
     */
    public function addValue(WebBrowserCookieSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WebBrowserCookieSettings>
     */
