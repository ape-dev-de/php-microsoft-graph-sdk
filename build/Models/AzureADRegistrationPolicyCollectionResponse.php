...
/**
 * Collection response for AzureADRegistrationPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AzureADRegistrationPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AzureADRegistrationPolicy[]
     */
    private array $value = [];
     ...
     * 
     * @param AzureADRegistrationPolicy[] $items
     * @return self
     */
    public function setValue(array|AzureADRegistrationPolicy $items, AzureADRegistrationPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AzureADRegistrationPolicy> $value
     * @return self
     ...
     * 
     * @param AzureADRegistrationPolicy $item
     * @return self
     */
    public function addValue(AzureADRegistrationPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AzureADRegistrationPolicy>
     */
