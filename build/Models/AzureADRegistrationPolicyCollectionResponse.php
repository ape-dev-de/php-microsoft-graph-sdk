 ...
 */
class AzureADRegistrationPolicyCollectionResponse
{
    /**
     ...
     * 
     * @param AzureADRegistrationPolicy ...$items Variable number of AzureADRegistrationPolicy items
     * @return self
     */
    public function setValue(AzureADRegistrationPolicy ...$items): self
    {
        $this->value = $items;
        return $this;
    }
