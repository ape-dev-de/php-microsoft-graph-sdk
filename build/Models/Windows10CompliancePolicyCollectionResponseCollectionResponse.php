...
/**
 * Collection response for Windows10CompliancePolicyCollectionResponse
 */
class Windows10CompliancePolicyCollectionResponseCollectionResponse
{
    /**
     * @var Windows10CompliancePolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param Windows10CompliancePolicyCollectionResponse ...$items Variable number of Windows10CompliancePolicyCollectionResponse items
     * @return self
     */
    public function setValue(Windows10CompliancePolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<Windows10CompliancePolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param Windows10CompliancePolicyCollectionResponse $item
     * @return self
     */
    public function addValue(Windows10CompliancePolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
