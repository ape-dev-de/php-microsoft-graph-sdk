...
/**
 * Collection response for SpaApplication
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SpaApplicationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SpaApplication[]
     */
     ...
     * 
     * @param SpaApplication[] $items
     * @return self
     */
    public function setValue(array|SpaApplication $items, SpaApplication ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SpaApplication> $value
     * @return self
     ...
     * 
     * @param SpaApplication $item
     * @return self
     */
    public function addValue(SpaApplication $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SpaApplication>
     */
