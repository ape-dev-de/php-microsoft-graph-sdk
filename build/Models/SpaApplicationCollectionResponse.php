 ...
 */
class SpaApplicationCollectionResponse
{
    /**
     * @var SpaApplication[]
     */
     ...
     * 
     * @param SpaApplication ...$items Variable number of SpaApplication items
     * @return self
     */
    public function setValue(SpaApplication ...$items): self
    {
        $this->value = $items;
        return $this;
    }
