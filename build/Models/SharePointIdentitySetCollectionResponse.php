...
/**
 * Collection response for SharePointIdentitySet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SharePointIdentitySetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SharePointIdentitySet[] $items
     * @return self
     */
    public function setValue(array|SharePointIdentitySet $items, SharePointIdentitySet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SharePointIdentitySet> $value
     * @return self
     ...
     * 
     * @param SharePointIdentitySet $item
     * @return self
     */
    public function addValue(SharePointIdentitySet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SharePointIdentitySet>
     */
