...
/**
 * Collection response for IdentityUserFlowAttribute
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityUserFlowAttributeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IdentityUserFlowAttribute[] $items
     * @return self
     */
    public function setValue(array|IdentityUserFlowAttribute $items, IdentityUserFlowAttribute ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityUserFlowAttribute> $value
     * @return self
     ...
     * 
     * @param IdentityUserFlowAttribute $item
     * @return self
     */
    public function addValue(IdentityUserFlowAttribute $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityUserFlowAttribute>
     */
