...
/**
 * DeviceManagementReportFileFormatCollectionResponse - Collection response
 */
class DeviceManagementReportFileFormatCollectionResponse
{
    /**
     * @var array<int, DeviceManagementReportFileFormat>
     */
    public array $value = [];
