...
/**
 * Collection response for DeviceManagementReportFileFormat
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceManagementReportFileFormatCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceManagementReportFileFormat[]
     */
    private array $value = [];
     ...
     * 
     * @return DeviceManagementReportFileFormat[]
     */
     ...
     * 
     * @param DeviceManagementReportFileFormat[] $items
     * @return self
     */
    public function setValue(array|DeviceManagementReportFileFormat $items, DeviceManagementReportFileFormat ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceManagementReportFileFormat> $value
     * @return self
     ...
     * 
     * @param DeviceManagementReportFileFormat $item
     * @return self
     */
    public function addValue(DeviceManagementReportFileFormat $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceManagementReportFileFormat>
     */
