...
/**
 * CommunicationsEncryptedIdentityCollectionResponse - Collection response
 */
class CommunicationsEncryptedIdentityCollectionResponse
{
    /**
     * @var array<int, CommunicationsEncryptedIdentity>
     */
    public array $value = [];
