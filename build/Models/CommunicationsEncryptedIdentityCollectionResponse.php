...
/**
 * Collection response for CommunicationsEncryptedIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CommunicationsEncryptedIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CommunicationsEncryptedIdentity[]
     */
    private array $value = [];
     ...
     * 
     * @param CommunicationsEncryptedIdentity[] $items
     * @return self
     */
    public function setValue(array|CommunicationsEncryptedIdentity $items, CommunicationsEncryptedIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CommunicationsEncryptedIdentity> $value
     * @return self
     ...
     * 
     * @param CommunicationsEncryptedIdentity $item
     * @return self
     */
    public function addValue(CommunicationsEncryptedIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CommunicationsEncryptedIdentity|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CommunicationsEncryptedIdentity>
     */
