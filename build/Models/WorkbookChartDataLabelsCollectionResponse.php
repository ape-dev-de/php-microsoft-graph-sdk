...
/**
 * Collection response for WorkbookChartDataLabels
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookChartDataLabelsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookChartDataLabels[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookChartDataLabels[] $items
     * @return self
     */
    public function setValue(array|WorkbookChartDataLabels $items, WorkbookChartDataLabels ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookChartDataLabels> $value
     * @return self
     ...
     * 
     * @param WorkbookChartDataLabels $item
     * @return self
     */
    public function addValue(WorkbookChartDataLabels $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookChartDataLabels>
     */
