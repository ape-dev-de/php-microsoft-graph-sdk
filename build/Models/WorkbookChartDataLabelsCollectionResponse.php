 ...
 */
class WorkbookChartDataLabelsCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookChartDataLabels ...$items Variable number of WorkbookChartDataLabels items
     * @return self
     */
    public function setValue(WorkbookChartDataLabels ...$items): self
    {
        $this->value = $items;
        return $this;
    }
