...
/**
 * Collection response for Windows10EditionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Windows10EditionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Windows10EditionType[]
     */
    private array $value = [];
     ...
     * 
     * @param Windows10EditionType[] $items
     * @return self
     */
    public function setValue(array|Windows10EditionType $items, Windows10EditionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Windows10EditionType> $value
     * @return self
     ...
     * 
     * @param Windows10EditionType $item
     * @return self
     */
    public function addValue(Windows10EditionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Windows10EditionType>
     */
