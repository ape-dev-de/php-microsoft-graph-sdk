...
/**
 * Collection response for IdentityApiConnector
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityApiConnectorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IdentityApiConnector[] $items
     * @return self
     */
    public function setValue(array|IdentityApiConnector $items, IdentityApiConnector ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityApiConnector> $value
     * @return self
     ...
     * 
     * @param IdentityApiConnector $item
     * @return self
     */
    public function addValue(IdentityApiConnector $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityApiConnector>
     */
