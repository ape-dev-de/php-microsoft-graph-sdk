...
/**
 * Collection response for SharedWithChannelTeamInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SharedWithChannelTeamInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SharedWithChannelTeamInfo[] $items
     * @return self
     */
    public function setValue(array|SharedWithChannelTeamInfo $items, SharedWithChannelTeamInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SharedWithChannelTeamInfo> $value
     * @return self
     ...
     * 
     * @param SharedWithChannelTeamInfo $item
     * @return self
     */
    public function addValue(SharedWithChannelTeamInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SharedWithChannelTeamInfo>
     */
