...
/**
 * Collection response for UnifiedRoleManagementPolicyCollectionResponse
 */
class UnifiedRoleManagementPolicyCollectionResponseCollectionResponse
{
    /**
     * @var UnifiedRoleManagementPolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedRoleManagementPolicyCollectionResponse ...$items Variable number of UnifiedRoleManagementPolicyCollectionResponse items
     * @return self
     */
    public function setValue(UnifiedRoleManagementPolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UnifiedRoleManagementPolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleManagementPolicyCollectionResponse $item
     * @return self
     */
    public function addValue(UnifiedRoleManagementPolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
