...
/**
 * Collection response for IncludedUserTypes
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IncludedUserTypesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IncludedUserTypes[]
     */
    private array $value = [];
     ...
     * 
     * @param IncludedUserTypes[] $items
     * @return self
     */
    public function setValue(array|IncludedUserTypes $items, IncludedUserTypes ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IncludedUserTypes> $value
     * @return self
     ...
     * 
     * @param IncludedUserTypes $item
     * @return self
     */
    public function addValue(IncludedUserTypes $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IncludedUserTypes>
     */
