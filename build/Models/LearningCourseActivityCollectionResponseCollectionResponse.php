...
/**
 * Collection response for LearningCourseActivityCollectionResponse
 */
class LearningCourseActivityCollectionResponseCollectionResponse
{
    /**
     * @var LearningCourseActivityCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param LearningCourseActivityCollectionResponse ...$items Variable number of LearningCourseActivityCollectionResponse items
     * @return self
     */
    public function setValue(LearningCourseActivityCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<LearningCourseActivityCollectionResponse> $value
     * @return self
     ...
     * 
     * @param LearningCourseActivityCollectionResponse $item
     * @return self
     */
    public function addValue(LearningCourseActivityCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
