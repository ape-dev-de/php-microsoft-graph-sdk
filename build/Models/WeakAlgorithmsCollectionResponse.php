...
/**
 * Collection response for WeakAlgorithms
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WeakAlgorithmsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WeakAlgorithms[]
     */
     ...
     * 
     * @param WeakAlgorithms[] $items
     * @return self
     */
    public function setValue(array|WeakAlgorithms $items, WeakAlgorithms ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WeakAlgorithms> $value
     * @return self
     ...
     * 
     * @param WeakAlgorithms $item
     * @return self
     */
    public function addValue(WeakAlgorithms $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WeakAlgorithms>
     */
