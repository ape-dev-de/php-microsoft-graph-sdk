...
/**
 * Collection response for MacOsLobAppAssignmentSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MacOsLobAppAssignmentSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MacOsLobAppAssignmentSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param MacOsLobAppAssignmentSettings[] $items
     * @return self
     */
    public function setValue(array|MacOsLobAppAssignmentSettings $items, MacOsLobAppAssignmentSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MacOsLobAppAssignmentSettings> $value
     * @return self
     ...
     * 
     * @param MacOsLobAppAssignmentSettings $item
     * @return self
     */
    public function addValue(MacOsLobAppAssignmentSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MacOsLobAppAssignmentSettings|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MacOsLobAppAssignmentSettings>
     */
