 ...
 */
class MacOsLobAppAssignmentSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param MacOsLobAppAssignmentSettings ...$items Variable number of MacOsLobAppAssignmentSettings items
     * @return self
     */
    public function setValue(MacOsLobAppAssignmentSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
