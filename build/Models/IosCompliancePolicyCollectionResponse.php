...
/**
 * Collection response for IosCompliancePolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosCompliancePolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IosCompliancePolicy[] $items
     * @return self
     */
    public function setValue(array|IosCompliancePolicy $items, IosCompliancePolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosCompliancePolicy> $value
     * @return self
     ...
     * 
     * @param IosCompliancePolicy $item
     * @return self
     */
    public function addValue(IosCompliancePolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IosCompliancePolicy|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IosCompliancePolicy>
     */
