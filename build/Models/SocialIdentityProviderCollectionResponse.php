...
/**
 * Collection response for SocialIdentityProvider
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SocialIdentityProviderCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SocialIdentityProvider[] $items
     * @return self
     */
    public function setValue(array|SocialIdentityProvider $items, SocialIdentityProvider ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SocialIdentityProvider> $value
     * @return self
     ...
     * 
     * @param SocialIdentityProvider $item
     * @return self
     */
    public function addValue(SocialIdentityProvider $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SocialIdentityProvider|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SocialIdentityProvider>
     */
