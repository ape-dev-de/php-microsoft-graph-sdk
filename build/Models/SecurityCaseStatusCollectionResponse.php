...
/**
 * Collection response for SecurityCaseStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityCaseStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityCaseStatus[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityCaseStatus[] $items
     * @return self
     */
    public function setValue(array|SecurityCaseStatus $items, SecurityCaseStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityCaseStatus> $value
     * @return self
     ...
     * 
     * @param SecurityCaseStatus $item
     * @return self
     */
    public function addValue(SecurityCaseStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityCaseStatus|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityCaseStatus>
     */
