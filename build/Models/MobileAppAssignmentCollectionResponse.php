...
/**
 * Collection response for MobileAppAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MobileAppAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MobileAppAssignment[] $items
     * @return self
     */
    public function setValue(array|MobileAppAssignment $items, MobileAppAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MobileAppAssignment> $value
     * @return self
     ...
     * 
     * @param MobileAppAssignment $item
     * @return self
     */
    public function addValue(MobileAppAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MobileAppAssignment>
     */
