 ...
 */
class SecurityUserEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityUserEvidence ...$items Variable number of SecurityUserEvidence items
     * @return self
     */
    public function setValue(SecurityUserEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
