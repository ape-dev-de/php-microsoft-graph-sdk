...
/**
 * Collection response for SecurityUserEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityUserEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityUserEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityUserEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityUserEvidence $items, SecurityUserEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityUserEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityUserEvidence $item
     * @return self
     */
    public function addValue(SecurityUserEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityUserEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityUserEvidence>
     */
