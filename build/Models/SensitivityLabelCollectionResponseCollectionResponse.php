...
/**
 * Collection response for SensitivityLabelCollectionResponse
 */
class SensitivityLabelCollectionResponseCollectionResponse
{
    /**
     * @var SensitivityLabelCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SensitivityLabelCollectionResponse ...$items Variable number of SensitivityLabelCollectionResponse items
     * @return self
     */
    public function setValue(SensitivityLabelCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SensitivityLabelCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SensitivityLabelCollectionResponse $item
     * @return self
     */
    public function addValue(SensitivityLabelCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
