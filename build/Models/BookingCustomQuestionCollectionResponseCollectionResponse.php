...
/**
 * Collection response for BookingCustomQuestionCollectionResponse
 */
class BookingCustomQuestionCollectionResponseCollectionResponse
{
    /**
     * @var BookingCustomQuestionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BookingCustomQuestionCollectionResponse ...$items Variable number of BookingCustomQuestionCollectionResponse items
     * @return self
     */
    public function setValue(BookingCustomQuestionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<BookingCustomQuestionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param BookingCustomQuestionCollectionResponse $item
     * @return self
     */
    public function addValue(BookingCustomQuestionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
