...
/**
 * Collection response for ObjectMapping
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ObjectMappingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ObjectMapping[]
     */
     ...
     * 
     * @param ObjectMapping[] $items
     * @return self
     */
    public function setValue(array|ObjectMapping $items, ObjectMapping ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ObjectMapping> $value
     * @return self
     ...
     * 
     * @param ObjectMapping $item
     * @return self
     */
    public function addValue(ObjectMapping $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ObjectMapping>
     */
