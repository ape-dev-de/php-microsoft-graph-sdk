...
/**
 * Collection response for UnifiedRoleManagementPolicyEnablementRule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRoleManagementPolicyEnablementRuleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UnifiedRoleManagementPolicyEnablementRule[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedRoleManagementPolicyEnablementRule[] $items
     * @return self
     */
    public function setValue(array|UnifiedRoleManagementPolicyEnablementRule $items, UnifiedRoleManagementPolicyEnablementRule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRoleManagementPolicyEnablementRule> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleManagementPolicyEnablementRule $item
     * @return self
     */
    public function addValue(UnifiedRoleManagementPolicyEnablementRule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UnifiedRoleManagementPolicyEnablementRule|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRoleManagementPolicyEnablementRule>
     */
