...
/**
 * Collection response for CallRecordsParticipantCollectionResponse
 */
class CallRecordsParticipantCollectionResponseCollectionResponse
{
    /**
     * @var CallRecordsParticipantCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CallRecordsParticipantCollectionResponse ...$items Variable number of CallRecordsParticipantCollectionResponse items
     * @return self
     */
    public function setValue(CallRecordsParticipantCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CallRecordsParticipantCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CallRecordsParticipantCollectionResponse $item
     * @return self
     */
    public function addValue(CallRecordsParticipantCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
