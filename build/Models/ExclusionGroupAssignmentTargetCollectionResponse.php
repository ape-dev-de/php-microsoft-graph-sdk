...
/**
 * ExclusionGroupAssignmentTargetCollectionResponse - Collection response
 */
class ExclusionGroupAssignmentTargetCollectionResponse
{
    /**
     * @var array<int, ExclusionGroupAssignmentTarget>
     */
    public array $value = [];
