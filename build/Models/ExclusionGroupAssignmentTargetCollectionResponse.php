...
/**
 * Collection response for ExclusionGroupAssignmentTarget
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExclusionGroupAssignmentTargetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExclusionGroupAssignmentTarget[]
     */
    private array $value = [];
     ...
     * 
     * @param ExclusionGroupAssignmentTarget[] $items
     * @return self
     */
    public function setValue(array|ExclusionGroupAssignmentTarget $items, ExclusionGroupAssignmentTarget ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExclusionGroupAssignmentTarget> $value
     * @return self
     ...
     * 
     * @param ExclusionGroupAssignmentTarget $item
     * @return self
     */
    public function addValue(ExclusionGroupAssignmentTarget $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExclusionGroupAssignmentTarget|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExclusionGroupAssignmentTarget>
     */
