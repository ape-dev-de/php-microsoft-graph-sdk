...
/**
 * Collection response for Enablement
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EnablementCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Enablement[]
     */
     ...
     * 
     * @param Enablement[] $items
     * @return self
     */
    public function setValue(array|Enablement $items, Enablement ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param Enablement $item
     * @return self
     */
    public function addValue(Enablement $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Enablement>
     */
