...
/**
 * Collection response for RoleAssignmentScheduleRequestFilterByCurrentUserOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RoleAssignmentScheduleRequestFilterByCurrentUserOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RoleAssignmentScheduleRequestFilterByCurrentUserOptions[]
     */
    private array $value = [];
     ...
     * 
     * @return RoleAssignmentScheduleRequestFilterByCurrentUserOptions[]
     */
     ...
     * 
     * @param RoleAssignmentScheduleRequestFilterByCurrentUserOptions[] $items
     * @return self
     */
    public function setValue(array|RoleAssignmentScheduleRequestFilterByCurrentUserOptions $items, RoleAssignmentScheduleRequestFilterByCurrentUserOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RoleAssignmentScheduleRequestFilterByCurrentUserOptions> $value
     * @return self
     ...
     * 
     * @param RoleAssignmentScheduleRequestFilterByCurrentUserOptions $item
     * @return self
     */
    public function addValue(RoleAssignmentScheduleRequestFilterByCurrentUserOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return RoleAssignmentScheduleRequestFilterByCurrentUserOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, RoleAssignmentScheduleRequestFilterByCurrentUserOptions>
     */
