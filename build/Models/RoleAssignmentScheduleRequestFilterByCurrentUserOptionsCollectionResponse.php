...
/**
 * RoleAssignmentScheduleRequestFilterByCurrentUserOptionsCollectionResponse - Collection response
 */
class RoleAssignmentScheduleRequestFilterByCurrentUserOptionsCollectionResponse
{
    /**
     * @var array<int, RoleAssignmentScheduleRequestFilterByCurrentUserOptions>
     */
    public array $value = [];
