...
/**
 * NotificationDeliveryFrequencyCollectionResponse - Collection response
 */
class NotificationDeliveryFrequencyCollectionResponse
{
    /**
     * @var array<int, NotificationDeliveryFrequency>
     */
    public array $value = [];
