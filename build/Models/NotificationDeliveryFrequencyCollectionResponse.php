...
/**
 * Collection response for NotificationDeliveryFrequency
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class NotificationDeliveryFrequencyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var NotificationDeliveryFrequency[]
     */
    private array $value = [];
     ...
     * 
     * @return NotificationDeliveryFrequency[]
     */
     ...
     * 
     * @param NotificationDeliveryFrequency[] $items
     * @return self
     */
    public function setValue(array|NotificationDeliveryFrequency $items, NotificationDeliveryFrequency ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<NotificationDeliveryFrequency> $value
     * @return self
     ...
     * 
     * @param NotificationDeliveryFrequency $item
     * @return self
     */
    public function addValue(NotificationDeliveryFrequency $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, NotificationDeliveryFrequency>
     */
