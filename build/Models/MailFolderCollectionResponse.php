...
/**
 * Collection response for MailFolder
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MailFolderCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MailFolder[]
     */
     ...
     * 
     * @param MailFolder[] $items
     * @return self
     */
    public function setValue(array|MailFolder $items, MailFolder ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param MailFolder $item
     * @return self
     */
    public function addValue(MailFolder $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MailFolder>
     */
