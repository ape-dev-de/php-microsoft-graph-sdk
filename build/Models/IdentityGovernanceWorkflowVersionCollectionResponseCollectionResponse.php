...
/**
 * Collection response for IdentityGovernanceWorkflowVersionCollectionResponse
 */
class IdentityGovernanceWorkflowVersionCollectionResponseCollectionResponse
{
    /**
     * @var IdentityGovernanceWorkflowVersionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityGovernanceWorkflowVersionCollectionResponse ...$items Variable number of IdentityGovernanceWorkflowVersionCollectionResponse items
     * @return self
     */
    public function setValue(IdentityGovernanceWorkflowVersionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IdentityGovernanceWorkflowVersionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceWorkflowVersionCollectionResponse $item
     * @return self
     */
    public function addValue(IdentityGovernanceWorkflowVersionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
