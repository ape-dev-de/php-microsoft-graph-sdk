...
/**
 * Collection response for NetworkConnection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class NetworkConnectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param NetworkConnection[] $items
     * @return self
     */
    public function setValue(array|NetworkConnection $items, NetworkConnection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<NetworkConnection> $value
     * @return self
     ...
     * 
     * @param NetworkConnection $item
     * @return self
     */
    public function addValue(NetworkConnection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, NetworkConnection>
     */
