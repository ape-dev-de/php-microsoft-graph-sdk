...
/**
 * Collection response for ChallengingWordCollectionResponse
 */
class ChallengingWordCollectionResponseCollectionResponse
{
    /**
     * @var ChallengingWordCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return ChallengingWordCollectionResponse[]
     */
     ...
     * 
     * @param ChallengingWordCollectionResponse ...$items Variable number of ChallengingWordCollectionResponse items
     * @return self
     */
    public function setValue(ChallengingWordCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ChallengingWordCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ChallengingWordCollectionResponse $item
     * @return self
     */
    public function addValue(ChallengingWordCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
