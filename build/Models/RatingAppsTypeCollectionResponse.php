...
/**
 * Collection response for RatingAppsType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RatingAppsTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RatingAppsType[]
     */
     ...
     * 
     * @param RatingAppsType[] $items
     * @return self
     */
    public function setValue(array|RatingAppsType $items, RatingAppsType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RatingAppsType> $value
     * @return self
     ...
     * 
     * @param RatingAppsType $item
     * @return self
     */
    public function addValue(RatingAppsType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RatingAppsType>
     */
