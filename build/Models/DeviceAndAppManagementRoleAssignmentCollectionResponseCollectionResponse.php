...
/**
 * Collection response for DeviceAndAppManagementRoleAssignmentCollectionResponse
 */
class DeviceAndAppManagementRoleAssignmentCollectionResponseCollectionResponse
{
    /**
     * @var DeviceAndAppManagementRoleAssignmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceAndAppManagementRoleAssignmentCollectionResponse ...$items Variable number of DeviceAndAppManagementRoleAssignmentCollectionResponse items
     * @return self
     */
    public function setValue(DeviceAndAppManagementRoleAssignmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeviceAndAppManagementRoleAssignmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeviceAndAppManagementRoleAssignmentCollectionResponse $item
     * @return self
     */
    public function addValue(DeviceAndAppManagementRoleAssignmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
