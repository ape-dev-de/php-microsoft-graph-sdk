...
/**
 * Collection response for MobileAppContentFileCollectionResponse
 */
class MobileAppContentFileCollectionResponseCollectionResponse
{
    /**
     * @var MobileAppContentFileCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MobileAppContentFileCollectionResponse ...$items Variable number of MobileAppContentFileCollectionResponse items
     * @return self
     */
    public function setValue(MobileAppContentFileCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MobileAppContentFileCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MobileAppContentFileCollectionResponse $item
     * @return self
     */
    public function addValue(MobileAppContentFileCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
