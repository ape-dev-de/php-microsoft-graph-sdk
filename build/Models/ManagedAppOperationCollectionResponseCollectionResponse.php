...
/**
 * Collection response for ManagedAppOperationCollectionResponse
 */
class ManagedAppOperationCollectionResponseCollectionResponse
{
    /**
     * @var ManagedAppOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedAppOperationCollectionResponse ...$items Variable number of ManagedAppOperationCollectionResponse items
     * @return self
     */
    public function setValue(ManagedAppOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ManagedAppOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ManagedAppOperationCollectionResponse $item
     * @return self
     */
    public function addValue(ManagedAppOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
