...
/**
 * ProtectionUnitsBulkJobStatusCollectionResponse - Collection response
 */
class ProtectionUnitsBulkJobStatusCollectionResponse
{
    /**
     * @var array<int, ProtectionUnitsBulkJobStatus>
     */
    public array $value = [];
