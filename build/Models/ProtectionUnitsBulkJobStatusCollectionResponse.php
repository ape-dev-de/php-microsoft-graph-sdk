...
/**
 * Collection response for ProtectionUnitsBulkJobStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProtectionUnitsBulkJobStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProtectionUnitsBulkJobStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return ProtectionUnitsBulkJobStatus[]
     */
     ...
     * 
     * @param ProtectionUnitsBulkJobStatus[] $items
     * @return self
     */
    public function setValue(array|ProtectionUnitsBulkJobStatus $items, ProtectionUnitsBulkJobStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProtectionUnitsBulkJobStatus> $value
     * @return self
     ...
     * 
     * @param ProtectionUnitsBulkJobStatus $item
     * @return self
     */
    public function addValue(ProtectionUnitsBulkJobStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProtectionUnitsBulkJobStatus>
     */
