...
/**
 * Collection response for OmaSettingBase64
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OmaSettingBase64CollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OmaSettingBase64[]
     */
    private array $value = [];
     ...
     * 
     * @param OmaSettingBase64[] $items
     * @return self
     */
    public function setValue(array|OmaSettingBase64 $items, OmaSettingBase64 ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OmaSettingBase64> $value
     * @return self
     ...
     * 
     * @param OmaSettingBase64 $item
     * @return self
     */
    public function addValue(OmaSettingBase64 $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OmaSettingBase64>
     */
