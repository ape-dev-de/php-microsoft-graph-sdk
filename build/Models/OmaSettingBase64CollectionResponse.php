 ...
 */
class OmaSettingBase64CollectionResponse
{
    /**
     ...
     * 
     * @param OmaSettingBase64 ...$items Variable number of OmaSettingBase64 items
     * @return self
     */
    public function setValue(OmaSettingBase64 ...$items): self
    {
        $this->value = $items;
        return $this;
    }
