 ...
 */
class EdgeSearchEngineCollectionResponse
{
    /**
     ...
     * 
     * @param EdgeSearchEngine ...$items Variable number of EdgeSearchEngine items
     * @return self
     */
    public function setValue(EdgeSearchEngine ...$items): self
    {
        $this->value = $items;
        return $this;
    }
