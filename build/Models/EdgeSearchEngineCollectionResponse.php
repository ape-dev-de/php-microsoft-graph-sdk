...
/**
 * Collection response for EdgeSearchEngine
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EdgeSearchEngineCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EdgeSearchEngine[]
     */
    private array $value = [];
     ...
     * 
     * @param EdgeSearchEngine[] $items
     * @return self
     */
    public function setValue(array|EdgeSearchEngine $items, EdgeSearchEngine ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EdgeSearchEngine> $value
     * @return self
     ...
     * 
     * @param EdgeSearchEngine $item
     * @return self
     */
    public function addValue(EdgeSearchEngine $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EdgeSearchEngine>
     */
