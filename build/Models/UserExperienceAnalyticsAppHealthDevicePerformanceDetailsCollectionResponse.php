...
/**
 * Collection response for UserExperienceAnalyticsAppHealthDevicePerformanceDetails
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsAppHealthDevicePerformanceDetailsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsAppHealthDevicePerformanceDetails[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsAppHealthDevicePerformanceDetails $items, UserExperienceAnalyticsAppHealthDevicePerformanceDetails ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsAppHealthDevicePerformanceDetails> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsAppHealthDevicePerformanceDetails $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsAppHealthDevicePerformanceDetails $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsAppHealthDevicePerformanceDetails>
     */
