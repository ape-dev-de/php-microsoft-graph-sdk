...
/**
 * UserExperienceAnalyticsAppHealthDevicePerformanceDetailsCollectionResponse - Collection response
 */
class UserExperienceAnalyticsAppHealthDevicePerformanceDetailsCollectionResponse
{
    /**
     * @var array<int, UserExperienceAnalyticsAppHealthDevicePerformanceDetails>
     */
    public array $value = [];
