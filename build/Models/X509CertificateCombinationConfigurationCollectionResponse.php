...
/**
 * Collection response for X509CertificateCombinationConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class X509CertificateCombinationConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var X509CertificateCombinationConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param X509CertificateCombinationConfiguration[] $items
     * @return self
     */
    public function setValue(array|X509CertificateCombinationConfiguration $items, X509CertificateCombinationConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<X509CertificateCombinationConfiguration> $value
     * @return self
     ...
     * 
     * @param X509CertificateCombinationConfiguration $item
     * @return self
     */
    public function addValue(X509CertificateCombinationConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return X509CertificateCombinationConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, X509CertificateCombinationConfiguration>
     */
