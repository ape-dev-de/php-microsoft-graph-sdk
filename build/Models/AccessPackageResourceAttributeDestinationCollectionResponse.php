...
/**
 * AccessPackageResourceAttributeDestinationCollectionResponse - Collection response
 */
class AccessPackageResourceAttributeDestinationCollectionResponse
{
    /**
     * @var array<int, AccessPackageResourceAttributeDestination>
     */
    public array $value = [];
