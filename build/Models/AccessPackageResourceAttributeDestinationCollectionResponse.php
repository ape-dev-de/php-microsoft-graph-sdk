...
/**
 * Collection response for AccessPackageResourceAttributeDestination
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageResourceAttributeDestinationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageResourceAttributeDestination[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageResourceAttributeDestination[] $items
     * @return self
     */
    public function setValue(array|AccessPackageResourceAttributeDestination $items, AccessPackageResourceAttributeDestination ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageResourceAttributeDestination> $value
     * @return self
     ...
     * 
     * @param AccessPackageResourceAttributeDestination $item
     * @return self
     */
    public function addValue(AccessPackageResourceAttributeDestination $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageResourceAttributeDestination>
     */
