 ...
 */
class SecurityFilePlanAppliedCategoryCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityFilePlanAppliedCategory ...$items Variable number of SecurityFilePlanAppliedCategory items
     * @return self
     */
    public function setValue(SecurityFilePlanAppliedCategory ...$items): self
    {
        $this->value = $items;
        return $this;
    }
