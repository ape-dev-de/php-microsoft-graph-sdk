...
/**
 * Collection response for SecurityFilePlanAppliedCategory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityFilePlanAppliedCategoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityFilePlanAppliedCategory[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityFilePlanAppliedCategory[]
     */
     ...
     * 
     * @param SecurityFilePlanAppliedCategory[] $items
     * @return self
     */
    public function setValue(array|SecurityFilePlanAppliedCategory $items, SecurityFilePlanAppliedCategory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityFilePlanAppliedCategory> $value
     * @return self
     ...
     * 
     * @param SecurityFilePlanAppliedCategory $item
     * @return self
     */
    public function addValue(SecurityFilePlanAppliedCategory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityFilePlanAppliedCategory|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityFilePlanAppliedCategory>
     */
