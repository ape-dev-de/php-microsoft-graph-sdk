 ...
 */
class ServiceAnnouncementCollectionResponse
{
    /**
     ...
     * 
     * @param ServiceAnnouncement ...$items Variable number of ServiceAnnouncement items
     * @return self
     */
    public function setValue(ServiceAnnouncement ...$items): self
    {
        $this->value = $items;
        return $this;
    }
