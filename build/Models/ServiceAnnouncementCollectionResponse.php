...
/**
 * Collection response for ServiceAnnouncement
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServiceAnnouncementCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ServiceAnnouncement[] $items
     * @return self
     */
    public function setValue(array|ServiceAnnouncement $items, ServiceAnnouncement ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServiceAnnouncement> $value
     * @return self
     ...
     * 
     * @param ServiceAnnouncement $item
     * @return self
     */
    public function addValue(ServiceAnnouncement $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ServiceAnnouncement>
     */
