...
/**
 * PartnersBillingBillingPeriodCollectionResponse - Collection response
 */
class PartnersBillingBillingPeriodCollectionResponse
{
    /**
     * @var array<int, PartnersBillingBillingPeriod>
     */
    public array $value = [];
