...
/**
 * Collection response for PartnersBillingBillingPeriod
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PartnersBillingBillingPeriodCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PartnersBillingBillingPeriod[]
     */
    private array $value = [];
     ...
     * 
     * @return PartnersBillingBillingPeriod[]
     */
     ...
     * 
     * @param PartnersBillingBillingPeriod[] $items
     * @return self
     */
    public function setValue(array|PartnersBillingBillingPeriod $items, PartnersBillingBillingPeriod ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PartnersBillingBillingPeriod> $value
     * @return self
     ...
     * 
     * @param PartnersBillingBillingPeriod $item
     * @return self
     */
    public function addValue(PartnersBillingBillingPeriod $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PartnersBillingBillingPeriod|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PartnersBillingBillingPeriod>
     */
