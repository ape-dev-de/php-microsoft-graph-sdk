...
/**
 * Collection response for StandardWebPartCollectionResponse
 */
class StandardWebPartCollectionResponseCollectionResponse
{
    /**
     * @var StandardWebPartCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param StandardWebPartCollectionResponse ...$items Variable number of StandardWebPartCollectionResponse items
     * @return self
     */
    public function setValue(StandardWebPartCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<StandardWebPartCollectionResponse> $value
     * @return self
     ...
     * 
     * @param StandardWebPartCollectionResponse $item
     * @return self
     */
    public function addValue(StandardWebPartCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
