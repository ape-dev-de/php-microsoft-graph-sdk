...
/**
 * Collection response for InvitationRedemptionIdentityProviderConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InvitationRedemptionIdentityProviderConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var InvitationRedemptionIdentityProviderConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param InvitationRedemptionIdentityProviderConfiguration[] $items
     * @return self
     */
    public function setValue(array|InvitationRedemptionIdentityProviderConfiguration $items, InvitationRedemptionIdentityProviderConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InvitationRedemptionIdentityProviderConfiguration> $value
     * @return self
     ...
     * 
     * @param InvitationRedemptionIdentityProviderConfiguration $item
     * @return self
     */
    public function addValue(InvitationRedemptionIdentityProviderConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return InvitationRedemptionIdentityProviderConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, InvitationRedemptionIdentityProviderConfiguration>
     */
