...
/**
 * InvitationRedemptionIdentityProviderConfigurationCollectionResponse - Collection response
 */
class InvitationRedemptionIdentityProviderConfigurationCollectionResponse
{
    /**
     * @var array<int, InvitationRedemptionIdentityProviderConfiguration>
     */
    public array $value = [];
