 ...
 */
class InvitationRedemptionIdentityProviderConfigurationCollectionResponse
{
    /**
     ...
     * 
     * @param InvitationRedemptionIdentityProviderConfiguration ...$items Variable number of InvitationRedemptionIdentityProviderConfiguration items
     * @return self
     */
    public function setValue(InvitationRedemptionIdentityProviderConfiguration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
