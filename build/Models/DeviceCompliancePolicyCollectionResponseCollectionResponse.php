...
/**
 * Collection response for DeviceCompliancePolicyCollectionResponse
 */
class DeviceCompliancePolicyCollectionResponseCollectionResponse
{
    /**
     * @var DeviceCompliancePolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceCompliancePolicyCollectionResponse ...$items Variable number of DeviceCompliancePolicyCollectionResponse items
     * @return self
     */
    public function setValue(DeviceCompliancePolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeviceCompliancePolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeviceCompliancePolicyCollectionResponse $item
     * @return self
     */
    public function addValue(DeviceCompliancePolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
