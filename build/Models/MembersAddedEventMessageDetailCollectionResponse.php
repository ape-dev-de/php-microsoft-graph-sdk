...
/**
 * Collection response for MembersAddedEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MembersAddedEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MembersAddedEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param MembersAddedEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|MembersAddedEventMessageDetail $items, MembersAddedEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MembersAddedEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param MembersAddedEventMessageDetail $item
     * @return self
     */
    public function addValue(MembersAddedEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MembersAddedEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MembersAddedEventMessageDetail>
     */
