 ...
 */
class MembersAddedEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param MembersAddedEventMessageDetail ...$items Variable number of MembersAddedEventMessageDetail items
     * @return self
     */
    public function setValue(MembersAddedEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
