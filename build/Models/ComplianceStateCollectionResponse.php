...
/**
 * Collection response for ComplianceState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ComplianceStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ComplianceState[]
     */
     ...
     * 
     * @param ComplianceState[] $items
     * @return self
     */
    public function setValue(array|ComplianceState $items, ComplianceState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ComplianceState> $value
     * @return self
     ...
     * 
     * @param ComplianceState $item
     * @return self
     */
    public function addValue(ComplianceState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ComplianceState>
     */
