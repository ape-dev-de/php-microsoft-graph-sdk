...
/**
 * MultiTenantOrganizationMemberRoleCollectionResponse - Collection response
 */
class MultiTenantOrganizationMemberRoleCollectionResponse
{
    /**
     * @var array<int, MultiTenantOrganizationMemberRole>
     */
    public array $value = [];
