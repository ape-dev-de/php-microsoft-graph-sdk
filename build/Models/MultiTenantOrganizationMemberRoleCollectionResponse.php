...
/**
 * Collection response for MultiTenantOrganizationMemberRole
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MultiTenantOrganizationMemberRoleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return MultiTenantOrganizationMemberRole[]
     */
     ...
     * 
     * @param MultiTenantOrganizationMemberRole[] $items
     * @return self
     */
    public function setValue(array|MultiTenantOrganizationMemberRole $items, MultiTenantOrganizationMemberRole ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MultiTenantOrganizationMemberRole> $value
     * @return self
     ...
     * 
     * @param MultiTenantOrganizationMemberRole $item
     * @return self
     */
    public function addValue(MultiTenantOrganizationMemberRole $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MultiTenantOrganizationMemberRole>
     */
