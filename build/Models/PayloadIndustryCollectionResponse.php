...
/**
 * Collection response for PayloadIndustry
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PayloadIndustryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PayloadIndustry[]
     */
     ...
     * 
     * @param PayloadIndustry[] $items
     * @return self
     */
    public function setValue(array|PayloadIndustry $items, PayloadIndustry ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PayloadIndustry> $value
     * @return self
     ...
     * 
     * @param PayloadIndustry $item
     * @return self
     */
    public function addValue(PayloadIndustry $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PayloadIndustry>
     */
