 ...
 */
class BaseEndUserNotificationCollectionResponse
{
    /**
     ...
     * 
     * @param BaseEndUserNotification ...$items Variable number of BaseEndUserNotification items
     * @return self
     */
    public function setValue(BaseEndUserNotification ...$items): self
    {
        $this->value = $items;
        return $this;
    }
