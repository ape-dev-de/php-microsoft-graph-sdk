...
/**
 * Collection response for BaseEndUserNotification
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BaseEndUserNotificationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BaseEndUserNotification[]
     */
    private array $value = [];
     ...
     * 
     * @param BaseEndUserNotification[] $items
     * @return self
     */
    public function setValue(array|BaseEndUserNotification $items, BaseEndUserNotification ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BaseEndUserNotification> $value
     * @return self
     ...
     * 
     * @param BaseEndUserNotification $item
     * @return self
     */
    public function addValue(BaseEndUserNotification $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BaseEndUserNotification>
     */
