...
/**
 * Collection response for ConditionalAccessPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ConditionalAccessPolicy[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessPolicy $items, ConditionalAccessPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessPolicy> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessPolicy $item
     * @return self
     */
    public function addValue(ConditionalAccessPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessPolicy>
     */
