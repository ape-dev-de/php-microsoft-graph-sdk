...
/**
 * Collection response for DriveRestoreArtifact
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DriveRestoreArtifactCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DriveRestoreArtifact[] $items
     * @return self
     */
    public function setValue(array|DriveRestoreArtifact $items, DriveRestoreArtifact ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DriveRestoreArtifact> $value
     * @return self
     ...
     * 
     * @param DriveRestoreArtifact $item
     * @return self
     */
    public function addValue(DriveRestoreArtifact $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DriveRestoreArtifact>
     */
