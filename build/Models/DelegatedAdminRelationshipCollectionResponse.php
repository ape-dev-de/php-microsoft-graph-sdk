...
/**
 * Collection response for DelegatedAdminRelationship
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DelegatedAdminRelationshipCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DelegatedAdminRelationship[] $items
     * @return self
     */
    public function setValue(array|DelegatedAdminRelationship $items, DelegatedAdminRelationship ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DelegatedAdminRelationship> $value
     * @return self
     ...
     * 
     * @param DelegatedAdminRelationship $item
     * @return self
     */
    public function addValue(DelegatedAdminRelationship $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DelegatedAdminRelationship>
     */
