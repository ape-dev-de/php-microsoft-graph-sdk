...
/**
 * Collection response for DeviceCompliancePolicyStateCollectionResponse
 */
class DeviceCompliancePolicyStateCollectionResponseCollectionResponse
{
    /**
     * @var DeviceCompliancePolicyStateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceCompliancePolicyStateCollectionResponse ...$items Variable number of DeviceCompliancePolicyStateCollectionResponse items
     * @return self
     */
    public function setValue(DeviceCompliancePolicyStateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeviceCompliancePolicyStateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeviceCompliancePolicyStateCollectionResponse $item
     * @return self
     */
    public function addValue(DeviceCompliancePolicyStateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
