...
/**
 * Collection response for AccessReviewScopeCollectionResponse
 */
class AccessReviewScopeCollectionResponseCollectionResponse
{
    /**
     * @var AccessReviewScopeCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessReviewScopeCollectionResponse ...$items Variable number of AccessReviewScopeCollectionResponse items
     * @return self
     */
    public function setValue(AccessReviewScopeCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AccessReviewScopeCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AccessReviewScopeCollectionResponse $item
     * @return self
     */
    public function addValue(AccessReviewScopeCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
