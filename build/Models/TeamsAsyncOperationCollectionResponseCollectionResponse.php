...
/**
 * Collection response for TeamsAsyncOperationCollectionResponse
 */
class TeamsAsyncOperationCollectionResponseCollectionResponse
{
    /**
     * @var TeamsAsyncOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamsAsyncOperationCollectionResponse ...$items Variable number of TeamsAsyncOperationCollectionResponse items
     * @return self
     */
    public function setValue(TeamsAsyncOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TeamsAsyncOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TeamsAsyncOperationCollectionResponse $item
     * @return self
     */
    public function addValue(TeamsAsyncOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
