...
/**
 * Collection response for Recipient
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RecipientCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Recipient[]
     */
     ...
     * 
     * @param Recipient[] $items
     * @return self
     */
    public function setValue(array|Recipient $items, Recipient ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Recipient $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Recipient>
     */
