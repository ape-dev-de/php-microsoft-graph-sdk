...
/**
 * Collection response for CrossTenantAccessPolicyTargetType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CrossTenantAccessPolicyTargetTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CrossTenantAccessPolicyTargetType[]
     */
    private array $value = [];
     ...
     * 
     * @return CrossTenantAccessPolicyTargetType[]
     */
     ...
     * 
     * @param CrossTenantAccessPolicyTargetType[] $items
     * @return self
     */
    public function setValue(array|CrossTenantAccessPolicyTargetType $items, CrossTenantAccessPolicyTargetType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CrossTenantAccessPolicyTargetType> $value
     * @return self
     ...
     * 
     * @param CrossTenantAccessPolicyTargetType $item
     * @return self
     */
    public function addValue(CrossTenantAccessPolicyTargetType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CrossTenantAccessPolicyTargetType>
     */
