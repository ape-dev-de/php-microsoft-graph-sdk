...
/**
 * CrossTenantAccessPolicyTargetTypeCollectionResponse - Collection response
 */
class CrossTenantAccessPolicyTargetTypeCollectionResponse
{
    /**
     * @var array<int, CrossTenantAccessPolicyTargetType>
     */
    public array $value = [];
