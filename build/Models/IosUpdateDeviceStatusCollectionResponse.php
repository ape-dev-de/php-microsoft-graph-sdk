...
/**
 * Collection response for IosUpdateDeviceStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosUpdateDeviceStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IosUpdateDeviceStatus[] $items
     * @return self
     */
    public function setValue(array|IosUpdateDeviceStatus $items, IosUpdateDeviceStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosUpdateDeviceStatus> $value
     * @return self
     ...
     * 
     * @param IosUpdateDeviceStatus $item
     * @return self
     */
    public function addValue(IosUpdateDeviceStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IosUpdateDeviceStatus>
     */
