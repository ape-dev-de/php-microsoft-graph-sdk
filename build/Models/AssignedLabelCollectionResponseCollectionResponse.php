...
/**
 * Collection response for AssignedLabelCollectionResponse
 */
class AssignedLabelCollectionResponseCollectionResponse
{
    /**
     * @var AssignedLabelCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AssignedLabelCollectionResponse ...$items Variable number of AssignedLabelCollectionResponse items
     * @return self
     */
    public function setValue(AssignedLabelCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AssignedLabelCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AssignedLabelCollectionResponse $item
     * @return self
     */
    public function addValue(AssignedLabelCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
