...
/**
 * Collection response for SharePointIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SharePointIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SharePointIdentity[]
     */
    private array $value = [];
     ...
     * 
     * @param SharePointIdentity[] $items
     * @return self
     */
    public function setValue(array|SharePointIdentity $items, SharePointIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SharePointIdentity> $value
     * @return self
     ...
     * 
     * @param SharePointIdentity $item
     * @return self
     */
    public function addValue(SharePointIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SharePointIdentity>
     */
