...
/**
 * Collection response for VppTokenState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VppTokenStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VppTokenState[]
     */
     ...
     * 
     * @param VppTokenState[] $items
     * @return self
     */
    public function setValue(array|VppTokenState $items, VppTokenState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VppTokenState> $value
     * @return self
     ...
     * 
     * @param VppTokenState $item
     * @return self
     */
    public function addValue(VppTokenState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VppTokenState>
     */
