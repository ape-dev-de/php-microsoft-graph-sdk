...
/**
 * Collection response for PrintJobStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintJobStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrintJobStatus[]
     */
     ...
     * 
     * @param PrintJobStatus[] $items
     * @return self
     */
    public function setValue(array|PrintJobStatus $items, PrintJobStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintJobStatus> $value
     * @return self
     ...
     * 
     * @param PrintJobStatus $item
     * @return self
     */
    public function addValue(PrintJobStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintJobStatus>
     */
