 ...
 */
class PrintJobStatusCollectionResponse
{
    /**
     * @var PrintJobStatus[]
     */
     ...
     * 
     * @param PrintJobStatus ...$items Variable number of PrintJobStatus items
     * @return self
     */
    public function setValue(PrintJobStatus ...$items): self
    {
        $this->value = $items;
        return $this;
    }
