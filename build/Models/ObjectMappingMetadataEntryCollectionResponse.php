...
/**
 * Collection response for ObjectMappingMetadataEntry
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ObjectMappingMetadataEntryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ObjectMappingMetadataEntry[] $items
     * @return self
     */
    public function setValue(array|ObjectMappingMetadataEntry $items, ObjectMappingMetadataEntry ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ObjectMappingMetadataEntry> $value
     * @return self
     ...
     * 
     * @param ObjectMappingMetadataEntry $item
     * @return self
     */
    public function addValue(ObjectMappingMetadataEntry $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ObjectMappingMetadataEntry|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ObjectMappingMetadataEntry>
     */
