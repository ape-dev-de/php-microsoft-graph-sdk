...
/**
 * Collection response for SearchResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SearchResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SearchResult[]
     */
     ...
     * @return self
     */
    public function setValue(array|SearchResult $items, SearchResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SearchResult> $value
     * @return self
     ...
     * @return self
     */
    public function addValue(SearchResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
