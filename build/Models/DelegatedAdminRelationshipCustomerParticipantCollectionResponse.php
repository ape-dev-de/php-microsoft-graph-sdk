 ...
 */
class DelegatedAdminRelationshipCustomerParticipantCollectionResponse
{
    /**
     ...
     * 
     * @param DelegatedAdminRelationshipCustomerParticipant ...$items Variable number of DelegatedAdminRelationshipCustomerParticipant items
     * @return self
     */
    public function setValue(DelegatedAdminRelationshipCustomerParticipant ...$items): self
    {
        $this->value = $items;
        return $this;
    }
