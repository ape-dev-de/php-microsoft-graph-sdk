...
/**
 * Collection response for DelegatedAdminRelationshipCustomerParticipant
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DelegatedAdminRelationshipCustomerParticipantCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DelegatedAdminRelationshipCustomerParticipant[]
     */
    private array $value = [];
     ...
     * 
     * @param DelegatedAdminRelationshipCustomerParticipant[] $items
     * @return self
     */
    public function setValue(array|DelegatedAdminRelationshipCustomerParticipant $items, DelegatedAdminRelationshipCustomerParticipant ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DelegatedAdminRelationshipCustomerParticipant> $value
     * @return self
     ...
     * 
     * @param DelegatedAdminRelationshipCustomerParticipant $item
     * @return self
     */
    public function addValue(DelegatedAdminRelationshipCustomerParticipant $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DelegatedAdminRelationshipCustomerParticipant>
     */
