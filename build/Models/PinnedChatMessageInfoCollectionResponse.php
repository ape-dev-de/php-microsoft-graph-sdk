...
/**
 * Collection response for PinnedChatMessageInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PinnedChatMessageInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PinnedChatMessageInfo[] $items
     * @return self
     */
    public function setValue(array|PinnedChatMessageInfo $items, PinnedChatMessageInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PinnedChatMessageInfo> $value
     * @return self
     ...
     * 
     * @param PinnedChatMessageInfo $item
     * @return self
     */
    public function addValue(PinnedChatMessageInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PinnedChatMessageInfo>
     */
