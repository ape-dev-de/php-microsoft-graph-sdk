...
/**
 * Collection response for UserSimulationDetails
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserSimulationDetailsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserSimulationDetails[] $items
     * @return self
     */
    public function setValue(array|UserSimulationDetails $items, UserSimulationDetails ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserSimulationDetails> $value
     * @return self
     ...
     * 
     * @param UserSimulationDetails $item
     * @return self
     */
    public function addValue(UserSimulationDetails $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UserSimulationDetails|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UserSimulationDetails>
     */
