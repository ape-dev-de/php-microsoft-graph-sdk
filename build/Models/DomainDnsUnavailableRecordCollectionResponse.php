...
/**
 * Collection response for DomainDnsUnavailableRecord
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DomainDnsUnavailableRecordCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DomainDnsUnavailableRecord[]
     */
    private array $value = [];
     ...
     * 
     * @param DomainDnsUnavailableRecord[] $items
     * @return self
     */
    public function setValue(array|DomainDnsUnavailableRecord $items, DomainDnsUnavailableRecord ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DomainDnsUnavailableRecord> $value
     * @return self
     ...
     * 
     * @param DomainDnsUnavailableRecord $item
     * @return self
     */
    public function addValue(DomainDnsUnavailableRecord $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return DomainDnsUnavailableRecord|null
     */
     ...
     * 
     * @return \ArrayIterator<int, DomainDnsUnavailableRecord>
     */
