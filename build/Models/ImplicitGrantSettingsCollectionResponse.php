 ...
 */
class ImplicitGrantSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param ImplicitGrantSettings ...$items Variable number of ImplicitGrantSettings items
     * @return self
     */
    public function setValue(ImplicitGrantSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
