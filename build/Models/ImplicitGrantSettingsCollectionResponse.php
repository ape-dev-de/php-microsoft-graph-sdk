...
/**
 * Collection response for ImplicitGrantSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ImplicitGrantSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ImplicitGrantSettings[] $items
     * @return self
     */
    public function setValue(array|ImplicitGrantSettings $items, ImplicitGrantSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ImplicitGrantSettings> $value
     * @return self
     ...
     * 
     * @param ImplicitGrantSettings $item
     * @return self
     */
    public function addValue(ImplicitGrantSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ImplicitGrantSettings>
     */
