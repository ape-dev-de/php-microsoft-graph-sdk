 ...
 */
class TeamsTabConfigurationCollectionResponse
{
    /**
     ...
     * 
     * @param TeamsTabConfiguration ...$items Variable number of TeamsTabConfiguration items
     * @return self
     */
    public function setValue(TeamsTabConfiguration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
