...
/**
 * Collection response for TeamsTabConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamsTabConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TeamsTabConfiguration[] $items
     * @return self
     */
    public function setValue(array|TeamsTabConfiguration $items, TeamsTabConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamsTabConfiguration> $value
     * @return self
     ...
     * 
     * @param TeamsTabConfiguration $item
     * @return self
     */
    public function addValue(TeamsTabConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamsTabConfiguration>
     */
