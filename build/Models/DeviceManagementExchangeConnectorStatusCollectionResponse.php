...
/**
 * Collection response for DeviceManagementExchangeConnectorStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceManagementExchangeConnectorStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceManagementExchangeConnectorStatus[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceManagementExchangeConnectorStatus[] $items
     * @return self
     */
    public function setValue(array|DeviceManagementExchangeConnectorStatus $items, DeviceManagementExchangeConnectorStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceManagementExchangeConnectorStatus> $value
     * @return self
     ...
     * 
     * @param DeviceManagementExchangeConnectorStatus $item
     * @return self
     */
    public function addValue(DeviceManagementExchangeConnectorStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceManagementExchangeConnectorStatus>
     */
