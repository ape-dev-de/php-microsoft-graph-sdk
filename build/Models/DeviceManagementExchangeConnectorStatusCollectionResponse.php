...
/**
 * DeviceManagementExchangeConnectorStatusCollectionResponse - Collection response
 */
class DeviceManagementExchangeConnectorStatusCollectionResponse
{
    /**
     * @var array<int, DeviceManagementExchangeConnectorStatus>
     */
    public array $value = [];
