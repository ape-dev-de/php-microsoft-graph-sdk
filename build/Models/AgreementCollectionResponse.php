...
/**
 * Collection response for Agreement
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AgreementCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Agreement[]
     */
     ...
     * 
     * @param Agreement[] $items
     * @return self
     */
    public function setValue(array|Agreement $items, Agreement ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param Agreement $item
     * @return self
     */
    public function addValue(Agreement $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Agreement>
     */
