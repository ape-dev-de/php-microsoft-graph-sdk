...
/**
 * Collection response for AppIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AppIdentity[]
     */
     ...
     * 
     * @param AppIdentity[] $items
     * @return self
     */
    public function setValue(array|AppIdentity $items, AppIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param AppIdentity $item
     * @return self
     */
    public function addValue(AppIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AppIdentity>
     */
