...
/**
 * Collection response for ThreatExpectedAssessment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ThreatExpectedAssessmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return ThreatExpectedAssessment[]
     */
     ...
     * 
     * @param ThreatExpectedAssessment[] $items
     * @return self
     */
    public function setValue(array|ThreatExpectedAssessment $items, ThreatExpectedAssessment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ThreatExpectedAssessment> $value
     * @return self
     ...
     * 
     * @param ThreatExpectedAssessment $item
     * @return self
     */
    public function addValue(ThreatExpectedAssessment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ThreatExpectedAssessment>
     */
