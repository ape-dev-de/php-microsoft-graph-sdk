...
/**
 * Collection response for Image
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ImageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Image[]
     */
     ...
     * @return self
     */
    public function setValue(array|Image $items, Image ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Image $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Image>
     */
