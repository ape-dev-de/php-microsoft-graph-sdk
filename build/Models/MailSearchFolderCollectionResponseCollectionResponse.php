...
/**
 * Collection response for MailSearchFolderCollectionResponse
 */
class MailSearchFolderCollectionResponseCollectionResponse
{
    /**
     * @var MailSearchFolderCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MailSearchFolderCollectionResponse ...$items Variable number of MailSearchFolderCollectionResponse items
     * @return self
     */
    public function setValue(MailSearchFolderCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MailSearchFolderCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MailSearchFolderCollectionResponse $item
     * @return self
     */
    public function addValue(MailSearchFolderCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
