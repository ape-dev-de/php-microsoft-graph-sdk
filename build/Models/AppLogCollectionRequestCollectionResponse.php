...
/**
 * Collection response for AppLogCollectionRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppLogCollectionRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AppLogCollectionRequest[] $items
     * @return self
     */
    public function setValue(array|AppLogCollectionRequest $items, AppLogCollectionRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppLogCollectionRequest> $value
     * @return self
     ...
     * 
     * @param AppLogCollectionRequest $item
     * @return self
     */
    public function addValue(AppLogCollectionRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AppLogCollectionRequest>
     */
