 ...
 */
class AndroidMobileAppIdentifierCollectionResponse
{
    /**
     ...
     * 
     * @param AndroidMobileAppIdentifier ...$items Variable number of AndroidMobileAppIdentifier items
     * @return self
     */
    public function setValue(AndroidMobileAppIdentifier ...$items): self
    {
        $this->value = $items;
        return $this;
    }
