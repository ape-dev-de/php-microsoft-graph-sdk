...
/**
 * Collection response for AndroidMobileAppIdentifier
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AndroidMobileAppIdentifierCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AndroidMobileAppIdentifier[]
     */
    private array $value = [];
     ...
     * 
     * @param AndroidMobileAppIdentifier[] $items
     * @return self
     */
    public function setValue(array|AndroidMobileAppIdentifier $items, AndroidMobileAppIdentifier ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AndroidMobileAppIdentifier> $value
     * @return self
     ...
     * 
     * @param AndroidMobileAppIdentifier $item
     * @return self
     */
    public function addValue(AndroidMobileAppIdentifier $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AndroidMobileAppIdentifier|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AndroidMobileAppIdentifier>
     */
