...
/**
 * Collection response for OpenShift
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OpenShiftCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OpenShift[]
     */
     ...
     * 
     * @param OpenShift[] $items
     * @return self
     */
    public function setValue(array|OpenShift $items, OpenShift ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param OpenShift $item
     * @return self
     */
    public function addValue(OpenShift $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OpenShift>
     */
