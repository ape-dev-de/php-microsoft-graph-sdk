...
/**
 * Collection response for ConditionalAccessStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return ConditionalAccessStatus[]
     */
     ...
     * 
     * @param ConditionalAccessStatus[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessStatus $items, ConditionalAccessStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessStatus> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessStatus $item
     * @return self
     */
    public function addValue(ConditionalAccessStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessStatus>
     */
