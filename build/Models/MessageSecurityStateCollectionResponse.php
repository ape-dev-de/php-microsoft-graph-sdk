...
/**
 * Collection response for MessageSecurityState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MessageSecurityStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MessageSecurityState[]
     */
    private array $value = [];
     ...
     * 
     * @param MessageSecurityState[] $items
     * @return self
     */
    public function setValue(array|MessageSecurityState $items, MessageSecurityState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MessageSecurityState> $value
     * @return self
     ...
     * 
     * @param MessageSecurityState $item
     * @return self
     */
    public function addValue(MessageSecurityState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MessageSecurityState|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MessageSecurityState>
     */
