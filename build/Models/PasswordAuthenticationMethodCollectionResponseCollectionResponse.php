...
/**
 * Collection response for PasswordAuthenticationMethodCollectionResponse
 */
class PasswordAuthenticationMethodCollectionResponseCollectionResponse
{
    /**
     * @var PasswordAuthenticationMethodCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PasswordAuthenticationMethodCollectionResponse ...$items Variable number of PasswordAuthenticationMethodCollectionResponse items
     * @return self
     */
    public function setValue(PasswordAuthenticationMethodCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PasswordAuthenticationMethodCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PasswordAuthenticationMethodCollectionResponse $item
     * @return self
     */
    public function addValue(PasswordAuthenticationMethodCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
