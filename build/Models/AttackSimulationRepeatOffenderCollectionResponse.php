...
/**
 * Collection response for AttackSimulationRepeatOffender
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttackSimulationRepeatOffenderCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AttackSimulationRepeatOffender[]
     */
    private array $value = [];
     ...
     * 
     * @param AttackSimulationRepeatOffender[] $items
     * @return self
     */
    public function setValue(array|AttackSimulationRepeatOffender $items, AttackSimulationRepeatOffender ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttackSimulationRepeatOffender> $value
     * @return self
     ...
     * 
     * @param AttackSimulationRepeatOffender $item
     * @return self
     */
    public function addValue(AttackSimulationRepeatOffender $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AttackSimulationRepeatOffender|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AttackSimulationRepeatOffender>
     */
