 ...
 */
class AttackSimulationRepeatOffenderCollectionResponse
{
    /**
     ...
     * 
     * @param AttackSimulationRepeatOffender ...$items Variable number of AttackSimulationRepeatOffender items
     * @return self
     */
    public function setValue(AttackSimulationRepeatOffender ...$items): self
    {
        $this->value = $items;
        return $this;
    }
