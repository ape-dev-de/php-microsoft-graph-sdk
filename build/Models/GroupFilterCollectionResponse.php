...
/**
 * Collection response for GroupFilter
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class GroupFilterCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var GroupFilter[]
     */
     ...
     * 
     * @param GroupFilter[] $items
     * @return self
     */
    public function setValue(array|GroupFilter $items, GroupFilter ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param GroupFilter $item
     * @return self
     */
    public function addValue(GroupFilter $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, GroupFilter>
     */
