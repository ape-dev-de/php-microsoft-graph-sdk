...
/**
 * Collection response for IosUpdateDeviceStatusCollectionResponse
 */
class IosUpdateDeviceStatusCollectionResponseCollectionResponse
{
    /**
     * @var IosUpdateDeviceStatusCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IosUpdateDeviceStatusCollectionResponse ...$items Variable number of IosUpdateDeviceStatusCollectionResponse items
     * @return self
     */
    public function setValue(IosUpdateDeviceStatusCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IosUpdateDeviceStatusCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IosUpdateDeviceStatusCollectionResponse $item
     * @return self
     */
    public function addValue(IosUpdateDeviceStatusCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
