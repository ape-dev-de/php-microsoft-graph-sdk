...
/**
 * Collection response for UserPurpose
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserPurposeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserPurpose[]
     */
     ...
     * 
     * @param UserPurpose[] $items
     * @return self
     */
    public function setValue(array|UserPurpose $items, UserPurpose ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param UserPurpose $item
     * @return self
     */
    public function addValue(UserPurpose $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserPurpose>
     */
