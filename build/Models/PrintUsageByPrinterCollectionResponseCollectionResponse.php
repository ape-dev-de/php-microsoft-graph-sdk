...
/**
 * Collection response for PrintUsageByPrinterCollectionResponse
 */
class PrintUsageByPrinterCollectionResponseCollectionResponse
{
    /**
     * @var PrintUsageByPrinterCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PrintUsageByPrinterCollectionResponse ...$items Variable number of PrintUsageByPrinterCollectionResponse items
     * @return self
     */
    public function setValue(PrintUsageByPrinterCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PrintUsageByPrinterCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PrintUsageByPrinterCollectionResponse $item
     * @return self
     */
    public function addValue(PrintUsageByPrinterCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
