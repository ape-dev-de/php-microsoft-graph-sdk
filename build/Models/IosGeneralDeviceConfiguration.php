...
class IosGeneralDeviceConfiguration
{
     ...
     */
    private ?string $safariManagedDomains;
     ...
     */
    private ?string $safariPasswordAutoFillDomains;
    ...
    public function getSafariManagedDomains(): ?string
    {
        return $this->safariManagedDomains;
    }

    public function setSafariManagedDomains(?string $safariManagedDomains): self
    {
        $this->safariManagedDomains = $safariManagedDomains;
        return $this;
    }

    public function getSafariPasswordAutoFillDomains(): ?string
    {
        return $this->safariPasswordAutoFillDomains;
    }

    public function setSafariPasswordAutoFillDomains(?string $safariPasswordAutoFillDomains): self
    {
