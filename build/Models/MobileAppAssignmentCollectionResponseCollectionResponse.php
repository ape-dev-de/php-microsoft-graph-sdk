...
/**
 * Collection response for MobileAppAssignmentCollectionResponse
 */
class MobileAppAssignmentCollectionResponseCollectionResponse
{
    /**
     * @var MobileAppAssignmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MobileAppAssignmentCollectionResponse ...$items Variable number of MobileAppAssignmentCollectionResponse items
     * @return self
     */
    public function setValue(MobileAppAssignmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MobileAppAssignmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MobileAppAssignmentCollectionResponse $item
     * @return self
     */
    public function addValue(MobileAppAssignmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
