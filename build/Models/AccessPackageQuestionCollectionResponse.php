...
/**
 * Collection response for AccessPackageQuestion
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageQuestionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessPackageQuestion[] $items
     * @return self
     */
    public function setValue(array|AccessPackageQuestion $items, AccessPackageQuestion ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageQuestion> $value
     * @return self
     ...
     * 
     * @param AccessPackageQuestion $item
     * @return self
     */
    public function addValue(AccessPackageQuestion $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageQuestion>
     */
