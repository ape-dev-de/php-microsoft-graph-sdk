...
/**
 * Collection response for WindowsDeviceHealthState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsDeviceHealthStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return WindowsDeviceHealthState[]
     */
     ...
     * 
     * @param WindowsDeviceHealthState[] $items
     * @return self
     */
    public function setValue(array|WindowsDeviceHealthState $items, WindowsDeviceHealthState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsDeviceHealthState> $value
     * @return self
     ...
     * 
     * @param WindowsDeviceHealthState $item
     * @return self
     */
    public function addValue(WindowsDeviceHealthState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsDeviceHealthState>
     */
