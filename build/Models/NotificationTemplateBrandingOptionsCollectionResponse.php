...
/**
 * NotificationTemplateBrandingOptionsCollectionResponse - Collection response
 */
class NotificationTemplateBrandingOptionsCollectionResponse
{
    /**
     * @var array<int, NotificationTemplateBrandingOptions>
     */
    public array $value = [];
