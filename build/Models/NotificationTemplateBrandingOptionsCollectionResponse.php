...
/**
 * Collection response for NotificationTemplateBrandingOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class NotificationTemplateBrandingOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var NotificationTemplateBrandingOptions[]
     */
    private array $value = [];
     ...
     * 
     * @param NotificationTemplateBrandingOptions[] $items
     * @return self
     */
    public function setValue(array|NotificationTemplateBrandingOptions $items, NotificationTemplateBrandingOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<NotificationTemplateBrandingOptions> $value
     * @return self
     ...
     * 
     * @param NotificationTemplateBrandingOptions $item
     * @return self
     */
    public function addValue(NotificationTemplateBrandingOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, NotificationTemplateBrandingOptions>
     */
