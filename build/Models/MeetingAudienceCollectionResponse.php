...
/**
 * Collection response for MeetingAudience
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MeetingAudienceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MeetingAudience[]
     */
     ...
     * 
     * @param MeetingAudience[] $items
     * @return self
     */
    public function setValue(array|MeetingAudience $items, MeetingAudience ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MeetingAudience> $value
     * @return self
     ...
     * 
     * @param MeetingAudience $item
     * @return self
     */
    public function addValue(MeetingAudience $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MeetingAudience>
     */
