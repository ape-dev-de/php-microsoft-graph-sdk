...
/**
 * Collection response for TimeOffReasonCollectionResponse
 */
class TimeOffReasonCollectionResponseCollectionResponse
{
    /**
     * @var TimeOffReasonCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TimeOffReasonCollectionResponse ...$items Variable number of TimeOffReasonCollectionResponse items
     * @return self
     */
    public function setValue(TimeOffReasonCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TimeOffReasonCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TimeOffReasonCollectionResponse $item
     * @return self
     */
    public function addValue(TimeOffReasonCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
