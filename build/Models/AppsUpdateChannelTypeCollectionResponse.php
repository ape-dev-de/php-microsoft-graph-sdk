...
/**
 * Collection response for AppsUpdateChannelType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppsUpdateChannelTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AppsUpdateChannelType[]
     */
    private array $value = [];
     ...
     * 
     * @param AppsUpdateChannelType[] $items
     * @return self
     */
    public function setValue(array|AppsUpdateChannelType $items, AppsUpdateChannelType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppsUpdateChannelType> $value
     * @return self
     ...
     * 
     * @param AppsUpdateChannelType $item
     * @return self
     */
    public function addValue(AppsUpdateChannelType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AppsUpdateChannelType>
     */
