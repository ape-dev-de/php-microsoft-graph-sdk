...
/**
 * Collection response for ItemActivityCollectionResponse
 */
class ItemActivityCollectionResponseCollectionResponse
{
    /**
     * @var ItemActivityCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ItemActivityCollectionResponse ...$items Variable number of ItemActivityCollectionResponse items
     * @return self
     */
    public function setValue(ItemActivityCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ItemActivityCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ItemActivityCollectionResponse $item
     * @return self
     */
    public function addValue(ItemActivityCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
