...
/**
 * Collection response for DeviceLocalCredential
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceLocalCredentialCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceLocalCredential[] $items
     * @return self
     */
    public function setValue(array|DeviceLocalCredential $items, DeviceLocalCredential ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceLocalCredential> $value
     * @return self
     ...
     * 
     * @param DeviceLocalCredential $item
     * @return self
     */
    public function addValue(DeviceLocalCredential $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return DeviceLocalCredential|null
     */
     ...
     * 
     * @return \ArrayIterator<int, DeviceLocalCredential>
     */
