...
/**
 * Collection response for CallRecordsServiceRole
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsServiceRoleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsServiceRole[]
     */
    private array $value = [];
     ...
     * 
     * @param CallRecordsServiceRole[] $items
     * @return self
     */
    public function setValue(array|CallRecordsServiceRole $items, CallRecordsServiceRole ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsServiceRole> $value
     * @return self
     ...
     * 
     * @param CallRecordsServiceRole $item
     * @return self
     */
    public function addValue(CallRecordsServiceRole $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsServiceRole|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsServiceRole>
     */
