...
/**
 * Collection response for SecurityRetentionLabel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityRetentionLabelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityRetentionLabel[] $items
     * @return self
     */
    public function setValue(array|SecurityRetentionLabel $items, SecurityRetentionLabel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityRetentionLabel> $value
     * @return self
     ...
     * 
     * @param SecurityRetentionLabel $item
     * @return self
     */
    public function addValue(SecurityRetentionLabel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityRetentionLabel>
     */
