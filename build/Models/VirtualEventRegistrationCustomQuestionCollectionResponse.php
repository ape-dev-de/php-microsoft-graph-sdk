...
/**
 * Collection response for VirtualEventRegistrationCustomQuestion
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualEventRegistrationCustomQuestionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VirtualEventRegistrationCustomQuestion[]
     */
    private array $value = [];
     ...
     * 
     * @param VirtualEventRegistrationCustomQuestion[] $items
     * @return self
     */
    public function setValue(array|VirtualEventRegistrationCustomQuestion $items, VirtualEventRegistrationCustomQuestion ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualEventRegistrationCustomQuestion> $value
     * @return self
     ...
     * 
     * @param VirtualEventRegistrationCustomQuestion $item
     * @return self
     */
    public function addValue(VirtualEventRegistrationCustomQuestion $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return VirtualEventRegistrationCustomQuestion|null
     */
     ...
     * 
     * @return \ArrayIterator<int, VirtualEventRegistrationCustomQuestion>
     */
