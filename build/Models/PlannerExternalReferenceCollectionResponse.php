...
/**
 * Collection response for PlannerExternalReference
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerExternalReferenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PlannerExternalReference[]
     */
    private array $value = [];
     ...
     * 
     * @param PlannerExternalReference[] $items
     * @return self
     */
    public function setValue(array|PlannerExternalReference $items, PlannerExternalReference ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PlannerExternalReference> $value
     * @return self
     ...
     * 
     * @param PlannerExternalReference $item
     * @return self
     */
    public function addValue(PlannerExternalReference $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PlannerExternalReference|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PlannerExternalReference>
     */
