 ...
 */
class PlannerExternalReferenceCollectionResponse
{
    /**
     ...
     * 
     * @param PlannerExternalReference ...$items Variable number of PlannerExternalReference items
     * @return self
     */
    public function setValue(PlannerExternalReference ...$items): self
    {
        $this->value = $items;
        return $this;
    }
