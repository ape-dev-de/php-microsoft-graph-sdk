...
/**
 * Collection response for ProvisionedPlanCollectionResponse
 */
class ProvisionedPlanCollectionResponseCollectionResponse
{
    /**
     * @var ProvisionedPlanCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ProvisionedPlanCollectionResponse ...$items Variable number of ProvisionedPlanCollectionResponse items
     * @return self
     */
    public function setValue(ProvisionedPlanCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ProvisionedPlanCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ProvisionedPlanCollectionResponse $item
     * @return self
     */
    public function addValue(ProvisionedPlanCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
