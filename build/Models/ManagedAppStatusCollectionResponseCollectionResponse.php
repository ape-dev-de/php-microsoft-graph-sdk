...
/**
 * Collection response for ManagedAppStatusCollectionResponse
 */
class ManagedAppStatusCollectionResponseCollectionResponse
{
    /**
     * @var ManagedAppStatusCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedAppStatusCollectionResponse ...$items Variable number of ManagedAppStatusCollectionResponse items
     * @return self
     */
    public function setValue(ManagedAppStatusCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ManagedAppStatusCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ManagedAppStatusCollectionResponse $item
     * @return self
     */
    public function addValue(ManagedAppStatusCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
