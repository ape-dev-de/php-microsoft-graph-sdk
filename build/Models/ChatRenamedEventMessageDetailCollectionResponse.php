...
/**
 * Collection response for ChatRenamedEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatRenamedEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChatRenamedEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param ChatRenamedEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|ChatRenamedEventMessageDetail $items, ChatRenamedEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChatRenamedEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param ChatRenamedEventMessageDetail $item
     * @return self
     */
    public function addValue(ChatRenamedEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ChatRenamedEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ChatRenamedEventMessageDetail>
     */
