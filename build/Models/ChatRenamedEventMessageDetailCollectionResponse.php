 ...
 */
class ChatRenamedEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param ChatRenamedEventMessageDetail ...$items Variable number of ChatRenamedEventMessageDetail items
     * @return self
     */
    public function setValue(ChatRenamedEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
