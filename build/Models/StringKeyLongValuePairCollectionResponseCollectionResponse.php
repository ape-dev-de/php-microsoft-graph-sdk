...
/**
 * Collection response for StringKeyLongValuePairCollectionResponse
 */
class StringKeyLongValuePairCollectionResponseCollectionResponse
{
    /**
     * @var StringKeyLongValuePairCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param StringKeyLongValuePairCollectionResponse ...$items Variable number of StringKeyLongValuePairCollectionResponse items
     * @return self
     */
    public function setValue(StringKeyLongValuePairCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<StringKeyLongValuePairCollectionResponse> $value
     * @return self
     ...
     * 
     * @param StringKeyLongValuePairCollectionResponse $item
     * @return self
     */
    public function addValue(StringKeyLongValuePairCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
