...
/**
 * Collection response for AgreementFileLocalization
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AgreementFileLocalizationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AgreementFileLocalization[] $items
     * @return self
     */
    public function setValue(array|AgreementFileLocalization $items, AgreementFileLocalization ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AgreementFileLocalization> $value
     * @return self
     ...
     * 
     * @param AgreementFileLocalization $item
     * @return self
     */
    public function addValue(AgreementFileLocalization $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AgreementFileLocalization>
     */
