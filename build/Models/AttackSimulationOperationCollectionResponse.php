...
/**
 * Collection response for AttackSimulationOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttackSimulationOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AttackSimulationOperation[] $items
     * @return self
     */
    public function setValue(array|AttackSimulationOperation $items, AttackSimulationOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttackSimulationOperation> $value
     * @return self
     ...
     * 
     * @param AttackSimulationOperation $item
     * @return self
     */
    public function addValue(AttackSimulationOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AttackSimulationOperation>
     */
