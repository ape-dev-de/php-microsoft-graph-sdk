...
/**
 * Collection response for PermissionGrantConditionSet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PermissionGrantConditionSetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PermissionGrantConditionSet[] $items
     * @return self
     */
    public function setValue(array|PermissionGrantConditionSet $items, PermissionGrantConditionSet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PermissionGrantConditionSet> $value
     * @return self
     ...
     * 
     * @param PermissionGrantConditionSet $item
     * @return self
     */
    public function addValue(PermissionGrantConditionSet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PermissionGrantConditionSet>
     */
