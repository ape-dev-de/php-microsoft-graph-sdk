...
/**
 * Collection response for UserAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserAction[]
     */
     ...
     * 
     * @param UserAction[] $items
     * @return self
     */
    public function setValue(array|UserAction $items, UserAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(UserAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserAction>
     */
