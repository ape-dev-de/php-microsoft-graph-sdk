...
/**
 * Collection response for Win32LobAppCollectionResponse
 */
class Win32LobAppCollectionResponseCollectionResponse
{
    /**
     * @var Win32LobAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param Win32LobAppCollectionResponse ...$items Variable number of Win32LobAppCollectionResponse items
     * @return self
     */
    public function setValue(Win32LobAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<Win32LobAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param Win32LobAppCollectionResponse $item
     * @return self
     */
    public function addValue(Win32LobAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
