...
/**
 * Collection response for MicrosoftStoreForBusinessApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MicrosoftStoreForBusinessAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MicrosoftStoreForBusinessApp[]
     */
    private array $value = [];
     ...
     * 
     * @param MicrosoftStoreForBusinessApp[] $items
     * @return self
     */
    public function setValue(array|MicrosoftStoreForBusinessApp $items, MicrosoftStoreForBusinessApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MicrosoftStoreForBusinessApp> $value
     * @return self
     ...
     * 
     * @param MicrosoftStoreForBusinessApp $item
     * @return self
     */
    public function addValue(MicrosoftStoreForBusinessApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MicrosoftStoreForBusinessApp|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MicrosoftStoreForBusinessApp>
     */
