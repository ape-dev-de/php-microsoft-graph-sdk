...
/**
 * Collection response for PlannerPlanContainer
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerPlanContainerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PlannerPlanContainer[]
     */
    private array $value = [];
     ...
     * 
     * @param PlannerPlanContainer[] $items
     * @return self
     */
    public function setValue(array|PlannerPlanContainer $items, PlannerPlanContainer ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PlannerPlanContainer> $value
     * @return self
     ...
     * 
     * @param PlannerPlanContainer $item
     * @return self
     */
    public function addValue(PlannerPlanContainer $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PlannerPlanContainer>
     */
