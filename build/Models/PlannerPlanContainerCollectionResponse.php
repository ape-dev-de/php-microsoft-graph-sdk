 ...
 */
class PlannerPlanContainerCollectionResponse
{
    /**
     ...
     * 
     * @param PlannerPlanContainer ...$items Variable number of PlannerPlanContainer items
     * @return self
     */
    public function setValue(PlannerPlanContainer ...$items): self
    {
        $this->value = $items;
        return $this;
    }
