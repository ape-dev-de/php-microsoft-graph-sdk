...
/**
 * Collection response for ManagedEBookAssignmentCollectionResponse
 */
class ManagedEBookAssignmentCollectionResponseCollectionResponse
{
    /**
     * @var ManagedEBookAssignmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedEBookAssignmentCollectionResponse ...$items Variable number of ManagedEBookAssignmentCollectionResponse items
     * @return self
     */
    public function setValue(ManagedEBookAssignmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ManagedEBookAssignmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ManagedEBookAssignmentCollectionResponse $item
     * @return self
     */
    public function addValue(ManagedEBookAssignmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
