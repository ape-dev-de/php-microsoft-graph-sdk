 ...
 */
class MicrosoftManagedTrainingSettingCollectionResponse
{
    /**
     ...
     * 
     * @param MicrosoftManagedTrainingSetting ...$items Variable number of MicrosoftManagedTrainingSetting items
     * @return self
     */
    public function setValue(MicrosoftManagedTrainingSetting ...$items): self
    {
        $this->value = $items;
        return $this;
    }
