...
/**
 * Collection response for MicrosoftManagedTrainingSetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MicrosoftManagedTrainingSettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MicrosoftManagedTrainingSetting[]
     */
    private array $value = [];
     ...
     * 
     * @param MicrosoftManagedTrainingSetting[] $items
     * @return self
     */
    public function setValue(array|MicrosoftManagedTrainingSetting $items, MicrosoftManagedTrainingSetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MicrosoftManagedTrainingSetting> $value
     * @return self
     ...
     * 
     * @param MicrosoftManagedTrainingSetting $item
     * @return self
     */
    public function addValue(MicrosoftManagedTrainingSetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MicrosoftManagedTrainingSetting|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MicrosoftManagedTrainingSetting>
     */
