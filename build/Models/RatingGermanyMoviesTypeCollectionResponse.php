...
/**
 * Collection response for RatingGermanyMoviesType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RatingGermanyMoviesTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RatingGermanyMoviesType[]
     */
    private array $value = [];
     ...
     * 
     * @return RatingGermanyMoviesType[]
     */
     ...
     * 
     * @param RatingGermanyMoviesType[] $items
     * @return self
     */
    public function setValue(array|RatingGermanyMoviesType $items, RatingGermanyMoviesType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RatingGermanyMoviesType> $value
     * @return self
     ...
     * 
     * @param RatingGermanyMoviesType $item
     * @return self
     */
    public function addValue(RatingGermanyMoviesType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RatingGermanyMoviesType>
     */
