...
/**
 * Collection response for WindowsInformationProtectionIPRangeCollection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsInformationProtectionIPRangeCollectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WindowsInformationProtectionIPRangeCollection[] $items
     * @return self
     */
    public function setValue(array|WindowsInformationProtectionIPRangeCollection $items, WindowsInformationProtectionIPRangeCollection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsInformationProtectionIPRangeCollection> $value
     * @return self
     ...
     * 
     * @param WindowsInformationProtectionIPRangeCollection $item
     * @return self
     */
    public function addValue(WindowsInformationProtectionIPRangeCollection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WindowsInformationProtectionIPRangeCollection|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WindowsInformationProtectionIPRangeCollection>
     */
