...
/**
 * Collection response for OnlineMeetingPresenters
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnlineMeetingPresentersCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param OnlineMeetingPresenters[] $items
     * @return self
     */
    public function setValue(array|OnlineMeetingPresenters $items, OnlineMeetingPresenters ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnlineMeetingPresenters> $value
     * @return self
     ...
     * 
     * @param OnlineMeetingPresenters $item
     * @return self
     */
    public function addValue(OnlineMeetingPresenters $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnlineMeetingPresenters>
     */
