 ...
 */
class WorkbookRangeFontCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookRangeFont ...$items Variable number of WorkbookRangeFont items
     * @return self
     */
    public function setValue(WorkbookRangeFont ...$items): self
    {
        $this->value = $items;
        return $this;
    }
