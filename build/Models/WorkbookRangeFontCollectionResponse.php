...
/**
 * Collection response for WorkbookRangeFont
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookRangeFontCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookRangeFont[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookRangeFont[] $items
     * @return self
     */
    public function setValue(array|WorkbookRangeFont $items, WorkbookRangeFont ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookRangeFont> $value
     * @return self
     ...
     * 
     * @param WorkbookRangeFont $item
     * @return self
     */
    public function addValue(WorkbookRangeFont $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookRangeFont>
     */
