...
/**
 * Collection response for PrinterFeedOrientation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrinterFeedOrientationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PrinterFeedOrientation[] $items
     * @return self
     */
    public function setValue(array|PrinterFeedOrientation $items, PrinterFeedOrientation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrinterFeedOrientation> $value
     * @return self
     ...
     * 
     * @param PrinterFeedOrientation $item
     * @return self
     */
    public function addValue(PrinterFeedOrientation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrinterFeedOrientation>
     */
