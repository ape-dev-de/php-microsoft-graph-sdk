...
/**
 * Collection response for EducationPointsOutcome
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationPointsOutcomeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationPointsOutcome[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationPointsOutcome[] $items
     * @return self
     */
    public function setValue(array|EducationPointsOutcome $items, EducationPointsOutcome ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationPointsOutcome> $value
     * @return self
     ...
     * 
     * @param EducationPointsOutcome $item
     * @return self
     */
    public function addValue(EducationPointsOutcome $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EducationPointsOutcome|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EducationPointsOutcome>
     */
