...
/**
 * Collection response for PrintTaskTriggerCollectionResponse
 */
class PrintTaskTriggerCollectionResponseCollectionResponse
{
    /**
     * @var PrintTaskTriggerCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PrintTaskTriggerCollectionResponse ...$items Variable number of PrintTaskTriggerCollectionResponse items
     * @return self
     */
    public function setValue(PrintTaskTriggerCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PrintTaskTriggerCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PrintTaskTriggerCollectionResponse $item
     * @return self
     */
    public function addValue(PrintTaskTriggerCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
