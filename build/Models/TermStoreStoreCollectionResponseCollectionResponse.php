...
/**
 * Collection response for TermStoreStoreCollectionResponse
 */
class TermStoreStoreCollectionResponseCollectionResponse
{
    /**
     * @var TermStoreStoreCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TermStoreStoreCollectionResponse ...$items Variable number of TermStoreStoreCollectionResponse items
     * @return self
     */
    public function setValue(TermStoreStoreCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TermStoreStoreCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TermStoreStoreCollectionResponse $item
     * @return self
     */
    public function addValue(TermStoreStoreCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
