...
/**
 * Collection response for LicenseAssignmentState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LicenseAssignmentStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param LicenseAssignmentState[] $items
     * @return self
     */
    public function setValue(array|LicenseAssignmentState $items, LicenseAssignmentState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LicenseAssignmentState> $value
     * @return self
     ...
     * 
     * @param LicenseAssignmentState $item
     * @return self
     */
    public function addValue(LicenseAssignmentState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return LicenseAssignmentState|null
     */
     ...
     * 
     * @return \ArrayIterator<int, LicenseAssignmentState>
     */
