...
/**
 * Collection response for SharePointIdentitySetCollectionResponse
 */
class SharePointIdentitySetCollectionResponseCollectionResponse
{
    /**
     * @var SharePointIdentitySetCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SharePointIdentitySetCollectionResponse ...$items Variable number of SharePointIdentitySetCollectionResponse items
     * @return self
     */
    public function setValue(SharePointIdentitySetCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SharePointIdentitySetCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SharePointIdentitySetCollectionResponse $item
     * @return self
     */
    public function addValue(SharePointIdentitySetCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
