...
/**
 * Collection response for WindowsDeviceAccount
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsDeviceAccountCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WindowsDeviceAccount[] $items
     * @return self
     */
    public function setValue(array|WindowsDeviceAccount $items, WindowsDeviceAccount ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsDeviceAccount> $value
     * @return self
     ...
     * 
     * @param WindowsDeviceAccount $item
     * @return self
     */
    public function addValue(WindowsDeviceAccount $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsDeviceAccount>
     */
