 ...
 */
class WindowsDeviceAccountCollectionResponse
{
    /**
     ...
     * 
     * @param WindowsDeviceAccount ...$items Variable number of WindowsDeviceAccount items
     * @return self
     */
    public function setValue(WindowsDeviceAccount ...$items): self
    {
        $this->value = $items;
        return $this;
    }
