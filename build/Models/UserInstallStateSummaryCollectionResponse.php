...
/**
 * Collection response for UserInstallStateSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserInstallStateSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserInstallStateSummary[] $items
     * @return self
     */
    public function setValue(array|UserInstallStateSummary $items, UserInstallStateSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserInstallStateSummary> $value
     * @return self
     ...
     * 
     * @param UserInstallStateSummary $item
     * @return self
     */
    public function addValue(UserInstallStateSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserInstallStateSummary>
     */
