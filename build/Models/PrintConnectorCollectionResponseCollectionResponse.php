...
/**
 * Collection response for PrintConnectorCollectionResponse
 */
class PrintConnectorCollectionResponseCollectionResponse
{
    /**
     * @var PrintConnectorCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PrintConnectorCollectionResponse ...$items Variable number of PrintConnectorCollectionResponse items
     * @return self
     */
    public function setValue(PrintConnectorCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PrintConnectorCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PrintConnectorCollectionResponse $item
     * @return self
     */
    public function addValue(PrintConnectorCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
