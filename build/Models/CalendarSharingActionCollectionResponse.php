...
/**
 * Collection response for CalendarSharingAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CalendarSharingActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CalendarSharingAction[]
     */
    private array $value = [];
     ...
     * 
     * @param CalendarSharingAction[] $items
     * @return self
     */
    public function setValue(array|CalendarSharingAction $items, CalendarSharingAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CalendarSharingAction> $value
     * @return self
     ...
     * 
     * @param CalendarSharingAction $item
     * @return self
     */
    public function addValue(CalendarSharingAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CalendarSharingAction>
     */
