...
/**
 * Collection response for WorkbookRangeViewCollectionResponse
 */
class WorkbookRangeViewCollectionResponseCollectionResponse
{
    /**
     * @var WorkbookRangeViewCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookRangeViewCollectionResponse ...$items Variable number of WorkbookRangeViewCollectionResponse items
     * @return self
     */
    public function setValue(WorkbookRangeViewCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WorkbookRangeViewCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WorkbookRangeViewCollectionResponse $item
     * @return self
     */
    public function addValue(WorkbookRangeViewCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
