...
/**
 * Collection response for MobileAppContentFile
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MobileAppContentFileCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MobileAppContentFile[] $items
     * @return self
     */
    public function setValue(array|MobileAppContentFile $items, MobileAppContentFile ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MobileAppContentFile> $value
     * @return self
     ...
     * 
     * @param MobileAppContentFile $item
     * @return self
     */
    public function addValue(MobileAppContentFile $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MobileAppContentFile>
     */
