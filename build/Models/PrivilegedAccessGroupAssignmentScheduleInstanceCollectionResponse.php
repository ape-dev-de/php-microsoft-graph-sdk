...
/**
 * Collection response for PrivilegedAccessGroupAssignmentScheduleInstance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrivilegedAccessGroupAssignmentScheduleInstanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PrivilegedAccessGroupAssignmentScheduleInstance[] $items
     * @return self
     */
    public function setValue(array|PrivilegedAccessGroupAssignmentScheduleInstance $items, PrivilegedAccessGroupAssignmentScheduleInstance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrivilegedAccessGroupAssignmentScheduleInstance> $value
     * @return self
     ...
     * 
     * @param PrivilegedAccessGroupAssignmentScheduleInstance $item
     * @return self
     */
    public function addValue(PrivilegedAccessGroupAssignmentScheduleInstance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrivilegedAccessGroupAssignmentScheduleInstance>
     */
