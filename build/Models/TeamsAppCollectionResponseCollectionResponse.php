...
/**
 * Collection response for TeamsAppCollectionResponse
 */
class TeamsAppCollectionResponseCollectionResponse
{
    /**
     * @var TeamsAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamsAppCollectionResponse ...$items Variable number of TeamsAppCollectionResponse items
     * @return self
     */
    public function setValue(TeamsAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TeamsAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TeamsAppCollectionResponse $item
     * @return self
     */
    public function addValue(TeamsAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
