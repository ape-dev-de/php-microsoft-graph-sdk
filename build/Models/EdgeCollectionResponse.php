...
/**
 * Collection response for Edge
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EdgeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Edge[]
     */
     ...
     * @return self
     */
    public function setValue(array|Edge $items, Edge ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Edge $item): self
    {
        $this->value[] = $item;
        return $this;
    }
