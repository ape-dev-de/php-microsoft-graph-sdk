...
/**
 * Collection response for MetaDataKeyStringPairCollectionResponse
 */
class MetaDataKeyStringPairCollectionResponseCollectionResponse
{
    /**
     * @var MetaDataKeyStringPairCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MetaDataKeyStringPairCollectionResponse ...$items Variable number of MetaDataKeyStringPairCollectionResponse items
     * @return self
     */
    public function setValue(MetaDataKeyStringPairCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MetaDataKeyStringPairCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MetaDataKeyStringPairCollectionResponse $item
     * @return self
     */
    public function addValue(MetaDataKeyStringPairCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
