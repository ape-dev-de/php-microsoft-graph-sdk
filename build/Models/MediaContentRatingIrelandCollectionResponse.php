 ...
 */
class MediaContentRatingIrelandCollectionResponse
{
    /**
     ...
     * 
     * @param MediaContentRatingIreland ...$items Variable number of MediaContentRatingIreland items
     * @return self
     */
    public function setValue(MediaContentRatingIreland ...$items): self
    {
        $this->value = $items;
        return $this;
    }
