...
/**
 * Collection response for MediaContentRatingIreland
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MediaContentRatingIrelandCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MediaContentRatingIreland[] $items
     * @return self
     */
    public function setValue(array|MediaContentRatingIreland $items, MediaContentRatingIreland ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MediaContentRatingIreland> $value
     * @return self
     ...
     * 
     * @param MediaContentRatingIreland $item
     * @return self
     */
    public function addValue(MediaContentRatingIreland $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MediaContentRatingIreland>
     */
