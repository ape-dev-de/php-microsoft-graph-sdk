...
/**
 * Collection response for SecuritySensorCollectionResponse
 */
class SecuritySensorCollectionResponseCollectionResponse
{
    /**
     * @var SecuritySensorCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecuritySensorCollectionResponse ...$items Variable number of SecuritySensorCollectionResponse items
     * @return self
     */
    public function setValue(SecuritySensorCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecuritySensorCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecuritySensorCollectionResponse $item
     * @return self
     */
    public function addValue(SecuritySensorCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
