...
/**
 * Collection response for AttendanceIntervalCollectionResponse
 */
class AttendanceIntervalCollectionResponseCollectionResponse
{
    /**
     * @var AttendanceIntervalCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AttendanceIntervalCollectionResponse ...$items Variable number of AttendanceIntervalCollectionResponse items
     * @return self
     */
    public function setValue(AttendanceIntervalCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AttendanceIntervalCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AttendanceIntervalCollectionResponse $item
     * @return self
     */
    public function addValue(AttendanceIntervalCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
