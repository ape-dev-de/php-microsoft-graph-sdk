...
/**
 * Collection response for VirtualEventWebinar
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualEventWebinarCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param VirtualEventWebinar[] $items
     * @return self
     */
    public function setValue(array|VirtualEventWebinar $items, VirtualEventWebinar ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualEventWebinar> $value
     * @return self
     ...
     * 
     * @param VirtualEventWebinar $item
     * @return self
     */
    public function addValue(VirtualEventWebinar $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VirtualEventWebinar>
     */
