 ...
 */
class DevicesFilterCollectionResponse
{
    /**
     * @var DevicesFilter[]
     */
     ...
     * 
     * @param DevicesFilter ...$items Variable number of DevicesFilter items
     * @return self
     */
    public function setValue(DevicesFilter ...$items): self
    {
        $this->value = $items;
        return $this;
    }
