...
/**
 * Collection response for DevicesFilter
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DevicesFilterCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DevicesFilter[]
     */
     ...
     * 
     * @param DevicesFilter[] $items
     * @return self
     */
    public function setValue(array|DevicesFilter $items, DevicesFilter ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DevicesFilter> $value
     * @return self
     ...
     * 
     * @param DevicesFilter $item
     * @return self
     */
    public function addValue(DevicesFilter $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DevicesFilter>
     */
