...
/**
 * Collection response for SecurityArticle
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityArticleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityArticle[]
     */
     ...
     * 
     * @param SecurityArticle[] $items
     * @return self
     */
    public function setValue(array|SecurityArticle $items, SecurityArticle ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityArticle> $value
     * @return self
     ...
     * 
     * @param SecurityArticle $item
     * @return self
     */
    public function addValue(SecurityArticle $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityArticle>
     */
