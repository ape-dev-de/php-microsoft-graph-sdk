 ...
 */
class WorkbookChartFontCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookChartFont ...$items Variable number of WorkbookChartFont items
     * @return self
     */
    public function setValue(WorkbookChartFont ...$items): self
    {
        $this->value = $items;
        return $this;
    }
