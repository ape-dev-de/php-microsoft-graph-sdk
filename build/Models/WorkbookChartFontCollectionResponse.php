...
/**
 * Collection response for WorkbookChartFont
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookChartFontCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookChartFont[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookChartFont[] $items
     * @return self
     */
    public function setValue(array|WorkbookChartFont $items, WorkbookChartFont ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookChartFont> $value
     * @return self
     ...
     * 
     * @param WorkbookChartFont $item
     * @return self
     */
    public function addValue(WorkbookChartFont $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookChartFont>
     */
