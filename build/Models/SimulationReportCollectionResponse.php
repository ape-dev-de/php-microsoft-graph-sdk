 ...
 */
class SimulationReportCollectionResponse
{
    /**
     ...
     * 
     * @param SimulationReport ...$items Variable number of SimulationReport items
     * @return self
     */
    public function setValue(SimulationReport ...$items): self
    {
        $this->value = $items;
        return $this;
    }
