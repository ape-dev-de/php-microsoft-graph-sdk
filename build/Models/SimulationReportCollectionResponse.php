...
/**
 * Collection response for SimulationReport
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SimulationReportCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SimulationReport[]
     */
    private array $value = [];
     ...
     * 
     * @param SimulationReport[] $items
     * @return self
     */
    public function setValue(array|SimulationReport $items, SimulationReport ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SimulationReport> $value
     * @return self
     ...
     * 
     * @param SimulationReport $item
     * @return self
     */
    public function addValue(SimulationReport $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SimulationReport>
     */
