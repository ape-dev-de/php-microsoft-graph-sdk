...
/**
 * Collection response for CrossCloudAzureActiveDirectoryTenant
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CrossCloudAzureActiveDirectoryTenantCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CrossCloudAzureActiveDirectoryTenant[]
     */
    private array $value = [];
     ...
     * 
     * @param CrossCloudAzureActiveDirectoryTenant[] $items
     * @return self
     */
    public function setValue(array|CrossCloudAzureActiveDirectoryTenant $items, CrossCloudAzureActiveDirectoryTenant ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CrossCloudAzureActiveDirectoryTenant> $value
     * @return self
     ...
     * 
     * @param CrossCloudAzureActiveDirectoryTenant $item
     * @return self
     */
    public function addValue(CrossCloudAzureActiveDirectoryTenant $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CrossCloudAzureActiveDirectoryTenant|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CrossCloudAzureActiveDirectoryTenant>
     */
