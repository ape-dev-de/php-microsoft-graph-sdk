 ...
 */
class CrossCloudAzureActiveDirectoryTenantCollectionResponse
{
    /**
     ...
     * 
     * @param CrossCloudAzureActiveDirectoryTenant ...$items Variable number of CrossCloudAzureActiveDirectoryTenant items
     * @return self
     */
    public function setValue(CrossCloudAzureActiveDirectoryTenant ...$items): self
    {
        $this->value = $items;
        return $this;
    }
