...
/**
 * Collection response for CalendarSharingMessageAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CalendarSharingMessageActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CalendarSharingMessageAction[] $items
     * @return self
     */
    public function setValue(array|CalendarSharingMessageAction $items, CalendarSharingMessageAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CalendarSharingMessageAction> $value
     * @return self
     ...
     * 
     * @param CalendarSharingMessageAction $item
     * @return self
     */
    public function addValue(CalendarSharingMessageAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CalendarSharingMessageAction>
     */
