...
/**
 * ServiceHealthClassificationTypeCollectionResponse - Collection response
 */
class ServiceHealthClassificationTypeCollectionResponse
{
    /**
     * @var array<int, ServiceHealthClassificationType>
     */
    public array $value = [];
