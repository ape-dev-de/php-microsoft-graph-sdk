...
/**
 * Collection response for ServiceHealthClassificationType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServiceHealthClassificationTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ServiceHealthClassificationType[]
     */
    private array $value = [];
     ...
     * 
     * @return ServiceHealthClassificationType[]
     */
     ...
     * 
     * @param ServiceHealthClassificationType[] $items
     * @return self
     */
    public function setValue(array|ServiceHealthClassificationType $items, ServiceHealthClassificationType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServiceHealthClassificationType> $value
     * @return self
     ...
     * 
     * @param ServiceHealthClassificationType $item
     * @return self
     */
    public function addValue(ServiceHealthClassificationType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ServiceHealthClassificationType>
     */
