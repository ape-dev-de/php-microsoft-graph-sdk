...
/**
 * Collection response for RestoreSessionBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RestoreSessionBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param RestoreSessionBase[] $items
     * @return self
     */
    public function setValue(array|RestoreSessionBase $items, RestoreSessionBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RestoreSessionBase> $value
     * @return self
     ...
     * 
     * @param RestoreSessionBase $item
     * @return self
     */
    public function addValue(RestoreSessionBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RestoreSessionBase>
     */
