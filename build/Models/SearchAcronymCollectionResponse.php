...
/**
 * Collection response for SearchAcronym
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SearchAcronymCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SearchAcronym[]
     */
     ...
     * 
     * @param SearchAcronym[] $items
     * @return self
     */
    public function setValue(array|SearchAcronym $items, SearchAcronym ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SearchAcronym> $value
     * @return self
     ...
     * 
     * @param SearchAcronym $item
     * @return self
     */
    public function addValue(SearchAcronym $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SearchAcronym>
     */
