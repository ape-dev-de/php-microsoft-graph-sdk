...
/**
 * Collection response for LearningProviderCollectionResponse
 */
class LearningProviderCollectionResponseCollectionResponse
{
    /**
     * @var LearningProviderCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param LearningProviderCollectionResponse ...$items Variable number of LearningProviderCollectionResponse items
     * @return self
     */
    public function setValue(LearningProviderCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<LearningProviderCollectionResponse> $value
     * @return self
     ...
     * 
     * @param LearningProviderCollectionResponse $item
     * @return self
     */
    public function addValue(LearningProviderCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
