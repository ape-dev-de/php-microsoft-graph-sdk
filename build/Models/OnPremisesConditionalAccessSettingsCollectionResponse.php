 ...
 */
class OnPremisesConditionalAccessSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param OnPremisesConditionalAccessSettings ...$items Variable number of OnPremisesConditionalAccessSettings items
     * @return self
     */
    public function setValue(OnPremisesConditionalAccessSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
