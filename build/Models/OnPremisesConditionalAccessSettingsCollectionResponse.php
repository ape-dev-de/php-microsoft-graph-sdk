...
/**
 * Collection response for OnPremisesConditionalAccessSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnPremisesConditionalAccessSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnPremisesConditionalAccessSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param OnPremisesConditionalAccessSettings[] $items
     * @return self
     */
    public function setValue(array|OnPremisesConditionalAccessSettings $items, OnPremisesConditionalAccessSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnPremisesConditionalAccessSettings> $value
     * @return self
     ...
     * 
     * @param OnPremisesConditionalAccessSettings $item
     * @return self
     */
    public function addValue(OnPremisesConditionalAccessSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnPremisesConditionalAccessSettings>
     */
