...
/**
 * Collection response for SecurityFileHashAlgorithm
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityFileHashAlgorithmCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityFileHashAlgorithm[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityFileHashAlgorithm[]
     */
     ...
     * 
     * @param SecurityFileHashAlgorithm[] $items
     * @return self
     */
    public function setValue(array|SecurityFileHashAlgorithm $items, SecurityFileHashAlgorithm ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityFileHashAlgorithm> $value
     * @return self
     ...
     * 
     * @param SecurityFileHashAlgorithm $item
     * @return self
     */
    public function addValue(SecurityFileHashAlgorithm $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityFileHashAlgorithm|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityFileHashAlgorithm>
     */
