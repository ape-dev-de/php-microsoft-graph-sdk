...
/**
 * SecurityFileHashAlgorithmCollectionResponse - Collection response
 */
class SecurityFileHashAlgorithmCollectionResponse
{
    /**
     * @var array<int, SecurityFileHashAlgorithm>
     */
    public array $value = [];
