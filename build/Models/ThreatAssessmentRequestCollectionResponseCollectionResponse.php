...
/**
 * Collection response for ThreatAssessmentRequestCollectionResponse
 */
class ThreatAssessmentRequestCollectionResponseCollectionResponse
{
    /**
     * @var ThreatAssessmentRequestCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ThreatAssessmentRequestCollectionResponse ...$items Variable number of ThreatAssessmentRequestCollectionResponse items
     * @return self
     */
    public function setValue(ThreatAssessmentRequestCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ThreatAssessmentRequestCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ThreatAssessmentRequestCollectionResponse $item
     * @return self
     */
    public function addValue(ThreatAssessmentRequestCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
