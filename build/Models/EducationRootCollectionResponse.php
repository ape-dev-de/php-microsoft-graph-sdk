 ...
 */
class EducationRootCollectionResponse
{
    /**
     * @var EducationRoot[]
     */
     ...
     * 
     * @param EducationRoot ...$items Variable number of EducationRoot items
     * @return self
     */
    public function setValue(EducationRoot ...$items): self
    {
        $this->value = $items;
        return $this;
    }
