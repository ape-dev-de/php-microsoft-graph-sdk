...
/**
 * Collection response for EducationRoot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationRootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationRoot[]
     */
     ...
     * 
     * @param EducationRoot[] $items
     * @return self
     */
    public function setValue(array|EducationRoot $items, EducationRoot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationRoot> $value
     * @return self
     ...
     * 
     * @param EducationRoot $item
     * @return self
     */
    public function addValue(EducationRoot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationRoot>
     */
