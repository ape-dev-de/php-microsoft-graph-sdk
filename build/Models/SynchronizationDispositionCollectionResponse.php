...
/**
 * Collection response for SynchronizationDisposition
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationDispositionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SynchronizationDisposition[]
     */
    private array $value = [];
     ...
     * 
     * @return SynchronizationDisposition[]
     */
     ...
     * 
     * @param SynchronizationDisposition[] $items
     * @return self
     */
    public function setValue(array|SynchronizationDisposition $items, SynchronizationDisposition ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SynchronizationDisposition> $value
     * @return self
     ...
     * 
     * @param SynchronizationDisposition $item
     * @return self
     */
    public function addValue(SynchronizationDisposition $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SynchronizationDisposition|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SynchronizationDisposition>
     */
