...
/**
 * SynchronizationDispositionCollectionResponse - Collection response
 */
class SynchronizationDispositionCollectionResponse
{
    /**
     * @var array<int, SynchronizationDisposition>
     */
    public array $value = [];
