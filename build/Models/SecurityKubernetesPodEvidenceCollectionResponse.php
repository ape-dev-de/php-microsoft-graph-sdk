 ...
 */
class SecurityKubernetesPodEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityKubernetesPodEvidence ...$items Variable number of SecurityKubernetesPodEvidence items
     * @return self
     */
    public function setValue(SecurityKubernetesPodEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
