...
/**
 * Collection response for SecurityKubernetesPodEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityKubernetesPodEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityKubernetesPodEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityKubernetesPodEvidence[]
     */
     ...
     * 
     * @param SecurityKubernetesPodEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityKubernetesPodEvidence $items, SecurityKubernetesPodEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityKubernetesPodEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityKubernetesPodEvidence $item
     * @return self
     */
    public function addValue(SecurityKubernetesPodEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityKubernetesPodEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityKubernetesPodEvidence>
     */
