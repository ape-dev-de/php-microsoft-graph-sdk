...
/**
 * Collection response for FileStorage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FileStorageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FileStorage[]
     */
     ...
     * 
     * @param FileStorage[] $items
     * @return self
     */
    public function setValue(array|FileStorage $items, FileStorage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param FileStorage $item
     * @return self
     */
    public function addValue(FileStorage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FileStorage>
     */
