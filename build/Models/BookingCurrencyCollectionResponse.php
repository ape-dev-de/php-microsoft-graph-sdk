...
/**
 * Collection response for BookingCurrency
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingCurrencyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BookingCurrency[]
     */
     ...
     * 
     * @param BookingCurrency[] $items
     * @return self
     */
    public function setValue(array|BookingCurrency $items, BookingCurrency ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingCurrency> $value
     * @return self
     ...
     * 
     * @param BookingCurrency $item
     * @return self
     */
    public function addValue(BookingCurrency $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BookingCurrency>
     */
