 ...
 */
class CalculatedColumnCollectionResponse
{
    /**
     ...
     * 
     * @param CalculatedColumn ...$items Variable number of CalculatedColumn items
     * @return self
     */
    public function setValue(CalculatedColumn ...$items): self
    {
        $this->value = $items;
        return $this;
    }
