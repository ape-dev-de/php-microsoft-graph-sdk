...
/**
 * Collection response for CalculatedColumn
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CalculatedColumnCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CalculatedColumn[] $items
     * @return self
     */
    public function setValue(array|CalculatedColumn $items, CalculatedColumn ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CalculatedColumn> $value
     * @return self
     ...
     * 
     * @param CalculatedColumn $item
     * @return self
     */
    public function addValue(CalculatedColumn $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CalculatedColumn>
     */
