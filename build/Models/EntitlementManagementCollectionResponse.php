...
/**
 * Collection response for EntitlementManagement
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EntitlementManagementCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EntitlementManagement[]
     */
    private array $value = [];
     ...
     * 
     * @param EntitlementManagement[] $items
     * @return self
     */
    public function setValue(array|EntitlementManagement $items, EntitlementManagement ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EntitlementManagement> $value
     * @return self
     ...
     * 
     * @param EntitlementManagement $item
     * @return self
     */
    public function addValue(EntitlementManagement $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EntitlementManagement>
     */
