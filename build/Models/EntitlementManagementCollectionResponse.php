 ...
 */
class EntitlementManagementCollectionResponse
{
    /**
     ...
     * 
     * @param EntitlementManagement ...$items Variable number of EntitlementManagement items
     * @return self
     */
    public function setValue(EntitlementManagement ...$items): self
    {
        $this->value = $items;
        return $this;
    }
