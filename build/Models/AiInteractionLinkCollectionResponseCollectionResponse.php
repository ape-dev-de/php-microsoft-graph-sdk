...
/**
 * Collection response for AiInteractionLinkCollectionResponse
 */
class AiInteractionLinkCollectionResponseCollectionResponse
{
    /**
     * @var AiInteractionLinkCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return AiInteractionLinkCollectionResponse[]
     */
     ...
     * 
     * @param AiInteractionLinkCollectionResponse ...$items Variable number of AiInteractionLinkCollectionResponse items
     * @return self
     */
    public function setValue(AiInteractionLinkCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AiInteractionLinkCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AiInteractionLinkCollectionResponse $item
     * @return self
     */
    public function addValue(AiInteractionLinkCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
