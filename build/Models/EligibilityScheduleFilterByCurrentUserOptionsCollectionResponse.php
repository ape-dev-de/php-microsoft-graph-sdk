...
/**
 * EligibilityScheduleFilterByCurrentUserOptionsCollectionResponse - Collection response
 */
class EligibilityScheduleFilterByCurrentUserOptionsCollectionResponse
{
    /**
     * @var array<int, EligibilityScheduleFilterByCurrentUserOptions>
     */
    public array $value = [];
