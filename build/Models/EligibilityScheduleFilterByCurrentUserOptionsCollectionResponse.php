...
/**
 * Collection response for EligibilityScheduleFilterByCurrentUserOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EligibilityScheduleFilterByCurrentUserOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EligibilityScheduleFilterByCurrentUserOptions[]
     */
    private array $value = [];
     ...
     * 
     * @return EligibilityScheduleFilterByCurrentUserOptions[]
     */
     ...
     * 
     * @param EligibilityScheduleFilterByCurrentUserOptions[] $items
     * @return self
     */
    public function setValue(array|EligibilityScheduleFilterByCurrentUserOptions $items, EligibilityScheduleFilterByCurrentUserOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EligibilityScheduleFilterByCurrentUserOptions> $value
     * @return self
     ...
     * 
     * @param EligibilityScheduleFilterByCurrentUserOptions $item
     * @return self
     */
    public function addValue(EligibilityScheduleFilterByCurrentUserOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EligibilityScheduleFilterByCurrentUserOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EligibilityScheduleFilterByCurrentUserOptions>
     */
