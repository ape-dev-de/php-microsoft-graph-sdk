...
/**
 * Collection response for TrainingStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TrainingStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TrainingStatus[]
     */
     ...
     * 
     * @param TrainingStatus[] $items
     * @return self
     */
    public function setValue(array|TrainingStatus $items, TrainingStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TrainingStatus> $value
     * @return self
     ...
     * 
     * @param TrainingStatus $item
     * @return self
     */
    public function addValue(TrainingStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TrainingStatus>
     */
