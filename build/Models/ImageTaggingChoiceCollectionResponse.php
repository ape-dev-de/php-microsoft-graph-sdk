...
/**
 * Collection response for ImageTaggingChoice
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ImageTaggingChoiceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ImageTaggingChoice[] $items
     * @return self
     */
    public function setValue(array|ImageTaggingChoice $items, ImageTaggingChoice ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ImageTaggingChoice> $value
     * @return self
     ...
     * 
     * @param ImageTaggingChoice $item
     * @return self
     */
    public function addValue(ImageTaggingChoice $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ImageTaggingChoice>
     */
