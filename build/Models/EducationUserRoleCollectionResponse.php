...
/**
 * Collection response for EducationUserRole
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationUserRoleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationUserRole[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationUserRole[] $items
     * @return self
     */
    public function setValue(array|EducationUserRole $items, EducationUserRole ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationUserRole> $value
     * @return self
     ...
     * 
     * @param EducationUserRole $item
     * @return self
     */
    public function addValue(EducationUserRole $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationUserRole>
     */
