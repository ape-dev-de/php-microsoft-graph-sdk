...
/**
 * Collection response for UserCollectionResponse
 */
class UserCollectionResponseCollectionResponse
{
    /**
     * @var UserCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UserCollectionResponse ...$items Variable number of UserCollectionResponse items
     * @return self
     */
    public function setValue(UserCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UserCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UserCollectionResponse $item
     * @return self
     */
    public function addValue(UserCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
