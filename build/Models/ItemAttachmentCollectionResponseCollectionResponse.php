...
/**
 * Collection response for ItemAttachmentCollectionResponse
 */
class ItemAttachmentCollectionResponseCollectionResponse
{
    /**
     * @var ItemAttachmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ItemAttachmentCollectionResponse ...$items Variable number of ItemAttachmentCollectionResponse items
     * @return self
     */
    public function setValue(ItemAttachmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ItemAttachmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ItemAttachmentCollectionResponse $item
     * @return self
     */
    public function addValue(ItemAttachmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
