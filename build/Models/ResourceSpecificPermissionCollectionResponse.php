...
/**
 * Collection response for ResourceSpecificPermission
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ResourceSpecificPermissionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ResourceSpecificPermission[] $items
     * @return self
     */
    public function setValue(array|ResourceSpecificPermission $items, ResourceSpecificPermission ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ResourceSpecificPermission> $value
     * @return self
     ...
     * 
     * @param ResourceSpecificPermission $item
     * @return self
     */
    public function addValue(ResourceSpecificPermission $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ResourceSpecificPermission|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ResourceSpecificPermission>
     */
