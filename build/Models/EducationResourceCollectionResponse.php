 ...
 */
class EducationResourceCollectionResponse
{
    /**
     ...
     * 
     * @param EducationResource ...$items Variable number of EducationResource items
     * @return self
     */
    public function setValue(EducationResource ...$items): self
    {
        $this->value = $items;
        return $this;
    }
