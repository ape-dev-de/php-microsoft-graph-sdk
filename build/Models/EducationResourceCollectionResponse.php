...
/**
 * Collection response for EducationResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationResource[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationResource[] $items
     * @return self
     */
    public function setValue(array|EducationResource $items, EducationResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationResource> $value
     * @return self
     ...
     * @return self
     */
    public function addValue(EducationResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationResource>
     */
