 ...
 */
class TeamworkHostedContentCollectionResponse
{
    /**
     ...
     * 
     * @param TeamworkHostedContent ...$items Variable number of TeamworkHostedContent items
     * @return self
     */
    public function setValue(TeamworkHostedContent ...$items): self
    {
        $this->value = $items;
        return $this;
    }
