...
/**
 * Collection response for TeamworkHostedContent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamworkHostedContentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamworkHostedContent[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamworkHostedContent[] $items
     * @return self
     */
    public function setValue(array|TeamworkHostedContent $items, TeamworkHostedContent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamworkHostedContent> $value
     * @return self
     ...
     * 
     * @param TeamworkHostedContent $item
     * @return self
     */
    public function addValue(TeamworkHostedContent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamworkHostedContent>
     */
