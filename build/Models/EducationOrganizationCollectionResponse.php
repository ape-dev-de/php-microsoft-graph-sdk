...
/**
 * Collection response for EducationOrganization
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationOrganizationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param EducationOrganization[] $items
     * @return self
     */
    public function setValue(array|EducationOrganization $items, EducationOrganization ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationOrganization> $value
     * @return self
     ...
     * 
     * @param EducationOrganization $item
     * @return self
     */
    public function addValue(EducationOrganization $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EducationOrganization|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EducationOrganization>
     */
