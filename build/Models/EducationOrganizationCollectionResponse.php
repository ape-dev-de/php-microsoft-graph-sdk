 ...
 */
class EducationOrganizationCollectionResponse
{
    /**
     ...
     * 
     * @param EducationOrganization ...$items Variable number of EducationOrganization items
     * @return self
     */
    public function setValue(EducationOrganization ...$items): self
    {
        $this->value = $items;
        return $this;
    }
