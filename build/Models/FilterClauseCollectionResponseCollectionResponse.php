...
/**
 * Collection response for FilterClauseCollectionResponse
 */
class FilterClauseCollectionResponseCollectionResponse
{
    /**
     * @var FilterClauseCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param FilterClauseCollectionResponse ...$items Variable number of FilterClauseCollectionResponse items
     * @return self
     */
    public function setValue(FilterClauseCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<FilterClauseCollectionResponse> $value
     * @return self
     ...
     * 
     * @param FilterClauseCollectionResponse $item
     * @return self
     */
    public function addValue(FilterClauseCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
