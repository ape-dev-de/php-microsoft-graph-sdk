...
/**
 * Collection response for WindowsInformationProtectionPolicyCollectionResponse
 */
class WindowsInformationProtectionPolicyCollectionResponseCollectionResponse
{
    /**
     * @var WindowsInformationProtectionPolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsInformationProtectionPolicyCollectionResponse ...$items Variable number of WindowsInformationProtectionPolicyCollectionResponse items
     * @return self
     */
    public function setValue(WindowsInformationProtectionPolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WindowsInformationProtectionPolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WindowsInformationProtectionPolicyCollectionResponse $item
     * @return self
     */
    public function addValue(WindowsInformationProtectionPolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
