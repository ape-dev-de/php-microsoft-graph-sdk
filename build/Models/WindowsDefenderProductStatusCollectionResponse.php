...
/**
 * WindowsDefenderProductStatusCollectionResponse - Collection response
 */
class WindowsDefenderProductStatusCollectionResponse
{
    /**
     * @var array<int, WindowsDefenderProductStatus>
     */
    public array $value = [];
