...
/**
 * Collection response for WindowsDefenderProductStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsDefenderProductStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return WindowsDefenderProductStatus[]
     */
     ...
     * 
     * @param WindowsDefenderProductStatus[] $items
     * @return self
     */
    public function setValue(array|WindowsDefenderProductStatus $items, WindowsDefenderProductStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsDefenderProductStatus> $value
     * @return self
     ...
     * 
     * @param WindowsDefenderProductStatus $item
     * @return self
     */
    public function addValue(WindowsDefenderProductStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsDefenderProductStatus>
     */
