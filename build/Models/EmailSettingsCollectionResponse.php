 ...
 */
class EmailSettingsCollectionResponse
{
    /**
     * @var EmailSettings[]
     */
     ...
     * 
     * @param EmailSettings ...$items Variable number of EmailSettings items
     * @return self
     */
    public function setValue(EmailSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
