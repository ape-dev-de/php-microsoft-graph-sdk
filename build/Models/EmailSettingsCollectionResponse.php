...
/**
 * Collection response for EmailSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EmailSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EmailSettings[]
     */
     ...
     * 
     * @param EmailSettings[] $items
     * @return self
     */
    public function setValue(array|EmailSettings $items, EmailSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EmailSettings> $value
     * @return self
     ...
     * 
     * @param EmailSettings $item
     * @return self
     */
    public function addValue(EmailSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EmailSettings>
     */
