...
/**
 * Collection response for SecuritySiteSourceCollectionResponse
 */
class SecuritySiteSourceCollectionResponseCollectionResponse
{
    /**
     * @var SecuritySiteSourceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecuritySiteSourceCollectionResponse ...$items Variable number of SecuritySiteSourceCollectionResponse items
     * @return self
     */
    public function setValue(SecuritySiteSourceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecuritySiteSourceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecuritySiteSourceCollectionResponse $item
     * @return self
     */
    public function addValue(SecuritySiteSourceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
