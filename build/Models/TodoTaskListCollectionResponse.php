...
/**
 * Collection response for TodoTaskList
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TodoTaskListCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TodoTaskList[]
     */
     ...
     * 
     * @param TodoTaskList[] $items
     * @return self
     */
    public function setValue(array|TodoTaskList $items, TodoTaskList ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TodoTaskList> $value
     * @return self
     ...
     * 
     * @param TodoTaskList $item
     * @return self
     */
    public function addValue(TodoTaskList $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TodoTaskList>
     */
