 ...
 */
class AadUserConversationMemberResultCollectionResponse
{
    /**
     ...
     * 
     * @param AadUserConversationMemberResult ...$items Variable number of AadUserConversationMemberResult items
     * @return self
     */
    public function setValue(AadUserConversationMemberResult ...$items): self
    {
        $this->value = $items;
        return $this;
    }
