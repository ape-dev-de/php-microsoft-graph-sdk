...
/**
 * Collection response for AadUserConversationMemberResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AadUserConversationMemberResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AadUserConversationMemberResult[]
     */
    private array $value = [];
     ...
     * 
     * @param AadUserConversationMemberResult[] $items
     * @return self
     */
    public function setValue(array|AadUserConversationMemberResult $items, AadUserConversationMemberResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AadUserConversationMemberResult> $value
     * @return self
     ...
     * 
     * @param AadUserConversationMemberResult $item
     * @return self
     */
    public function addValue(AadUserConversationMemberResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AadUserConversationMemberResult|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AadUserConversationMemberResult>
     */
