...
/**
 * Collection response for TermsAndConditionsCollectionResponse
 */
class TermsAndConditionsCollectionResponseCollectionResponse
{
    /**
     * @var TermsAndConditionsCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TermsAndConditionsCollectionResponse ...$items Variable number of TermsAndConditionsCollectionResponse items
     * @return self
     */
    public function setValue(TermsAndConditionsCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TermsAndConditionsCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TermsAndConditionsCollectionResponse $item
     * @return self
     */
    public function addValue(TermsAndConditionsCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
