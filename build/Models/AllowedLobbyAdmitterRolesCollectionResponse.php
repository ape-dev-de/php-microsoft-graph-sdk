...
/**
 * Collection response for AllowedLobbyAdmitterRoles
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AllowedLobbyAdmitterRolesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AllowedLobbyAdmitterRoles[]
     */
    private array $value = [];
     ...
     * 
     * @return AllowedLobbyAdmitterRoles[]
     */
     ...
     * 
     * @param AllowedLobbyAdmitterRoles[] $items
     * @return self
     */
    public function setValue(array|AllowedLobbyAdmitterRoles $items, AllowedLobbyAdmitterRoles ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AllowedLobbyAdmitterRoles> $value
     * @return self
     ...
     * 
     * @param AllowedLobbyAdmitterRoles $item
     * @return self
     */
    public function addValue(AllowedLobbyAdmitterRoles $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AllowedLobbyAdmitterRoles>
     */
