...
/**
 * AllowedLobbyAdmitterRolesCollectionResponse - Collection response
 */
class AllowedLobbyAdmitterRolesCollectionResponse
{
    /**
     * @var array<int, AllowedLobbyAdmitterRoles>
     */
    public array $value = [];
