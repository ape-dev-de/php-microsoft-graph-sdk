...
/**
 * Collection response for TrainingSettingType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TrainingSettingTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TrainingSettingType[]
     */
    private array $value = [];
     ...
     * 
     * @param TrainingSettingType[] $items
     * @return self
     */
    public function setValue(array|TrainingSettingType $items, TrainingSettingType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TrainingSettingType> $value
     * @return self
     ...
     * 
     * @param TrainingSettingType $item
     * @return self
     */
    public function addValue(TrainingSettingType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TrainingSettingType>
     */
