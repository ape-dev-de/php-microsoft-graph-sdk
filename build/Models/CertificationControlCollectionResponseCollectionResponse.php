...
/**
 * Collection response for CertificationControlCollectionResponse
 */
class CertificationControlCollectionResponseCollectionResponse
{
    /**
     * @var CertificationControlCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CertificationControlCollectionResponse ...$items Variable number of CertificationControlCollectionResponse items
     * @return self
     */
    public function setValue(CertificationControlCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CertificationControlCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CertificationControlCollectionResponse $item
     * @return self
     */
    public function addValue(CertificationControlCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
