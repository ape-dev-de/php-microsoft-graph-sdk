...
/**
 * Collection response for SiteRestoreArtifactCollectionResponse
 */
class SiteRestoreArtifactCollectionResponseCollectionResponse
{
    /**
     * @var SiteRestoreArtifactCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SiteRestoreArtifactCollectionResponse ...$items Variable number of SiteRestoreArtifactCollectionResponse items
     * @return self
     */
    public function setValue(SiteRestoreArtifactCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SiteRestoreArtifactCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SiteRestoreArtifactCollectionResponse $item
     * @return self
     */
    public function addValue(SiteRestoreArtifactCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
