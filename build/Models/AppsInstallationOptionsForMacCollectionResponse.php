 ...
 */
class AppsInstallationOptionsForMacCollectionResponse
{
    /**
     ...
     * 
     * @param AppsInstallationOptionsForMac ...$items Variable number of AppsInstallationOptionsForMac items
     * @return self
     */
    public function setValue(AppsInstallationOptionsForMac ...$items): self
    {
        $this->value = $items;
        return $this;
    }
