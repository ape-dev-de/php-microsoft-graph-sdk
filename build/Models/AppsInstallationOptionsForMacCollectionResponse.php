...
/**
 * Collection response for AppsInstallationOptionsForMac
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppsInstallationOptionsForMacCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AppsInstallationOptionsForMac[]
     */
    private array $value = [];
     ...
     * 
     * @param AppsInstallationOptionsForMac[] $items
     * @return self
     */
    public function setValue(array|AppsInstallationOptionsForMac $items, AppsInstallationOptionsForMac ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppsInstallationOptionsForMac> $value
     * @return self
     ...
     * 
     * @param AppsInstallationOptionsForMac $item
     * @return self
     */
    public function addValue(AppsInstallationOptionsForMac $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AppsInstallationOptionsForMac>
     */
