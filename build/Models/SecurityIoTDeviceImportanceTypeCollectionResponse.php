...
/**
 * SecurityIoTDeviceImportanceTypeCollectionResponse - Collection response
 */
class SecurityIoTDeviceImportanceTypeCollectionResponse
{
    /**
     * @var array<int, SecurityIoTDeviceImportanceType>
     */
    public array $value = [];
