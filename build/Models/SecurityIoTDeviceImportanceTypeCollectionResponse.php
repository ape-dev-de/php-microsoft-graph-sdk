...
/**
 * Collection response for SecurityIoTDeviceImportanceType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityIoTDeviceImportanceTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityIoTDeviceImportanceType[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityIoTDeviceImportanceType[]
     */
     ...
     * 
     * @param SecurityIoTDeviceImportanceType[] $items
     * @return self
     */
    public function setValue(array|SecurityIoTDeviceImportanceType $items, SecurityIoTDeviceImportanceType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityIoTDeviceImportanceType> $value
     * @return self
     ...
     * 
     * @param SecurityIoTDeviceImportanceType $item
     * @return self
     */
    public function addValue(SecurityIoTDeviceImportanceType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityIoTDeviceImportanceType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityIoTDeviceImportanceType>
     */
