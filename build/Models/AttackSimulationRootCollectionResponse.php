...
/**
 * Collection response for AttackSimulationRoot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttackSimulationRootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AttackSimulationRoot[]
     */
    private array $value = [];
     ...
     * 
     * @param AttackSimulationRoot[] $items
     * @return self
     */
    public function setValue(array|AttackSimulationRoot $items, AttackSimulationRoot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttackSimulationRoot> $value
     * @return self
     ...
     * 
     * @param AttackSimulationRoot $item
     * @return self
     */
    public function addValue(AttackSimulationRoot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AttackSimulationRoot>
     */
