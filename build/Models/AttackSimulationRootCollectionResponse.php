 ...
 */
class AttackSimulationRootCollectionResponse
{
    /**
     ...
     * 
     * @param AttackSimulationRoot ...$items Variable number of AttackSimulationRoot items
     * @return self
     */
    public function setValue(AttackSimulationRoot ...$items): self
    {
        $this->value = $items;
        return $this;
    }
