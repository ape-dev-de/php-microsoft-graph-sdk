...
/**
 * Collection response for PrintColorMode
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintColorModeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrintColorMode[]
     */
     ...
     * 
     * @param PrintColorMode[] $items
     * @return self
     */
    public function setValue(array|PrintColorMode $items, PrintColorMode ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintColorMode> $value
     * @return self
     ...
     * 
     * @param PrintColorMode $item
     * @return self
     */
    public function addValue(PrintColorMode $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintColorMode>
     */
