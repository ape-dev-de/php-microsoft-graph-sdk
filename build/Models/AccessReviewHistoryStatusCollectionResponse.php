...
/**
 * Collection response for AccessReviewHistoryStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewHistoryStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessReviewHistoryStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return AccessReviewHistoryStatus[]
     */
     ...
     * 
     * @param AccessReviewHistoryStatus[] $items
     * @return self
     */
    public function setValue(array|AccessReviewHistoryStatus $items, AccessReviewHistoryStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewHistoryStatus> $value
     * @return self
     ...
     * 
     * @param AccessReviewHistoryStatus $item
     * @return self
     */
    public function addValue(AccessReviewHistoryStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewHistoryStatus>
     */
