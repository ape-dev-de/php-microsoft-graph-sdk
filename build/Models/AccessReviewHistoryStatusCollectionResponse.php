...
/**
 * AccessReviewHistoryStatusCollectionResponse - Collection response
 */
class AccessReviewHistoryStatusCollectionResponse
{
    /**
     * @var array<int, AccessReviewHistoryStatus>
     */
    public array $value = [];
