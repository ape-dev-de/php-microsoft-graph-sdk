...
/**
 * Collection response for WorkbookTable
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookTableCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookTable[]
     */
     ...
     * 
     * @param WorkbookTable[] $items
     * @return self
     */
    public function setValue(array|WorkbookTable $items, WorkbookTable ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookTable> $value
     * @return self
     ...
     * 
     * @param WorkbookTable $item
     * @return self
     */
    public function addValue(WorkbookTable $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookTable>
     */
