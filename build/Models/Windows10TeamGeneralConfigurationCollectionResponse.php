...
/**
 * Collection response for Windows10TeamGeneralConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Windows10TeamGeneralConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Windows10TeamGeneralConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param Windows10TeamGeneralConfiguration[] $items
     * @return self
     */
    public function setValue(array|Windows10TeamGeneralConfiguration $items, Windows10TeamGeneralConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Windows10TeamGeneralConfiguration> $value
     * @return self
     ...
     * 
     * @param Windows10TeamGeneralConfiguration $item
     * @return self
     */
    public function addValue(Windows10TeamGeneralConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return Windows10TeamGeneralConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, Windows10TeamGeneralConfiguration>
     */
