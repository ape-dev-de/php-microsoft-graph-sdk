...
/**
 * Collection response for ChatMessageImportance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatMessageImportanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ChatMessageImportance[] $items
     * @return self
     */
    public function setValue(array|ChatMessageImportance $items, ChatMessageImportance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChatMessageImportance> $value
     * @return self
     ...
     * 
     * @param ChatMessageImportance $item
     * @return self
     */
    public function addValue(ChatMessageImportance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChatMessageImportance>
     */
