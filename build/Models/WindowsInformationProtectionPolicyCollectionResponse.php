...
/**
 * Collection response for WindowsInformationProtectionPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsInformationProtectionPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WindowsInformationProtectionPolicy[] $items
     * @return self
     */
    public function setValue(array|WindowsInformationProtectionPolicy $items, WindowsInformationProtectionPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsInformationProtectionPolicy> $value
     * @return self
     ...
     * 
     * @param WindowsInformationProtectionPolicy $item
     * @return self
     */
    public function addValue(WindowsInformationProtectionPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsInformationProtectionPolicy>
     */
