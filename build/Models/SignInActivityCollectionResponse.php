 ...
 */
class SignInActivityCollectionResponse
{
    /**
     * @var SignInActivity[]
     */
     ...
     * 
     * @param SignInActivity ...$items Variable number of SignInActivity items
     * @return self
     */
    public function setValue(SignInActivity ...$items): self
    {
        $this->value = $items;
        return $this;
    }
