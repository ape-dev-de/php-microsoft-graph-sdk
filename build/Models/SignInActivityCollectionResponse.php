...
/**
 * Collection response for SignInActivity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SignInActivityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SignInActivity[]
     */
     ...
     * 
     * @param SignInActivity[] $items
     * @return self
     */
    public function setValue(array|SignInActivity $items, SignInActivity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SignInActivity> $value
     * @return self
     ...
     * 
     * @param SignInActivity $item
     * @return self
     */
    public function addValue(SignInActivity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SignInActivity>
     */
