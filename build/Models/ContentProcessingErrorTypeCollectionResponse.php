...
/**
 * ContentProcessingErrorTypeCollectionResponse - Collection response
 */
class ContentProcessingErrorTypeCollectionResponse
{
    /**
     * @var array<int, ContentProcessingErrorType>
     */
    public array $value = [];
