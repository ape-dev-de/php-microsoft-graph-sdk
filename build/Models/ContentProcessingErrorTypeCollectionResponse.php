...
/**
 * Collection response for ContentProcessingErrorType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ContentProcessingErrorTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ContentProcessingErrorType[]
     */
    private array $value = [];
     ...
     * 
     * @return ContentProcessingErrorType[]
     */
     ...
     * 
     * @param ContentProcessingErrorType[] $items
     * @return self
     */
    public function setValue(array|ContentProcessingErrorType $items, ContentProcessingErrorType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ContentProcessingErrorType> $value
     * @return self
     ...
     * 
     * @param ContentProcessingErrorType $item
     * @return self
     */
    public function addValue(ContentProcessingErrorType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ContentProcessingErrorType>
     */
