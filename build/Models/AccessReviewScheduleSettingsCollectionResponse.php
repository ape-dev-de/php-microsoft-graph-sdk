 ...
 */
class AccessReviewScheduleSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param AccessReviewScheduleSettings ...$items Variable number of AccessReviewScheduleSettings items
     * @return self
     */
    public function setValue(AccessReviewScheduleSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
