...
/**
 * Collection response for AccessReviewScheduleSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewScheduleSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessReviewScheduleSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessReviewScheduleSettings[] $items
     * @return self
     */
    public function setValue(array|AccessReviewScheduleSettings $items, AccessReviewScheduleSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewScheduleSettings> $value
     * @return self
     ...
     * 
     * @param AccessReviewScheduleSettings $item
     * @return self
     */
    public function addValue(AccessReviewScheduleSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewScheduleSettings>
     */
