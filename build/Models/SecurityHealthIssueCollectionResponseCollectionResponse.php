...
/**
 * Collection response for SecurityHealthIssueCollectionResponse
 */
class SecurityHealthIssueCollectionResponseCollectionResponse
{
    /**
     * @var SecurityHealthIssueCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityHealthIssueCollectionResponse ...$items Variable number of SecurityHealthIssueCollectionResponse items
     * @return self
     */
    public function setValue(SecurityHealthIssueCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityHealthIssueCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityHealthIssueCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityHealthIssueCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
