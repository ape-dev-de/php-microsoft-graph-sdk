...
/**
 * Collection response for ChatMessageType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatMessageTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChatMessageType[]
     */
     ...
     * 
     * @param ChatMessageType[] $items
     * @return self
     */
    public function setValue(array|ChatMessageType $items, ChatMessageType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChatMessageType> $value
     * @return self
     ...
     * 
     * @param ChatMessageType $item
     * @return self
     */
    public function addValue(ChatMessageType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChatMessageType>
     */
