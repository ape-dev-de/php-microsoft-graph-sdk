...
/**
 * Collection response for BitlockerRecoveryKey
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BitlockerRecoveryKeyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param BitlockerRecoveryKey[] $items
     * @return self
     */
    public function setValue(array|BitlockerRecoveryKey $items, BitlockerRecoveryKey ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BitlockerRecoveryKey> $value
     * @return self
     ...
     * 
     * @param BitlockerRecoveryKey $item
     * @return self
     */
    public function addValue(BitlockerRecoveryKey $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BitlockerRecoveryKey>
     */
