...
/**
 * Collection response for ConditionalAccessTemplate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessTemplateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ConditionalAccessTemplate[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessTemplate $items, ConditionalAccessTemplate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessTemplate> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessTemplate $item
     * @return self
     */
    public function addValue(ConditionalAccessTemplate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessTemplate>
     */
