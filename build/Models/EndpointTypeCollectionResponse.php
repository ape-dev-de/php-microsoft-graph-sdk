...
/**
 * Collection response for EndpointType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EndpointTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EndpointType[]
     */
     ...
     * 
     * @param EndpointType[] $items
     * @return self
     */
    public function setValue(array|EndpointType $items, EndpointType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EndpointType> $value
     * @return self
     ...
     * 
     * @param EndpointType $item
     * @return self
     */
    public function addValue(EndpointType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EndpointType>
     */
