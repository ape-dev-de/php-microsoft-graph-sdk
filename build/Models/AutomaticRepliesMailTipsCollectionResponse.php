 ...
 */
class AutomaticRepliesMailTipsCollectionResponse
{
    /**
     ...
     * 
     * @param AutomaticRepliesMailTips ...$items Variable number of AutomaticRepliesMailTips items
     * @return self
     */
    public function setValue(AutomaticRepliesMailTips ...$items): self
    {
        $this->value = $items;
        return $this;
    }
