...
/**
 * Collection response for AutomaticRepliesMailTips
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AutomaticRepliesMailTipsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AutomaticRepliesMailTips[] $items
     * @return self
     */
    public function setValue(array|AutomaticRepliesMailTips $items, AutomaticRepliesMailTips ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AutomaticRepliesMailTips> $value
     * @return self
     ...
     * 
     * @param AutomaticRepliesMailTips $item
     * @return self
     */
    public function addValue(AutomaticRepliesMailTips $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AutomaticRepliesMailTips>
     */
