...
/**
 * Collection response for SecurityDepartmentTemplateCollectionResponse
 */
class SecurityDepartmentTemplateCollectionResponseCollectionResponse
{
    /**
     * @var SecurityDepartmentTemplateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityDepartmentTemplateCollectionResponse ...$items Variable number of SecurityDepartmentTemplateCollectionResponse items
     * @return self
     */
    public function setValue(SecurityDepartmentTemplateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityDepartmentTemplateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityDepartmentTemplateCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityDepartmentTemplateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
