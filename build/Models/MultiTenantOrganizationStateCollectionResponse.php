...
/**
 * MultiTenantOrganizationStateCollectionResponse - Collection response
 */
class MultiTenantOrganizationStateCollectionResponse
{
    /**
     * @var array<int, MultiTenantOrganizationState>
     */
    public array $value = [];
