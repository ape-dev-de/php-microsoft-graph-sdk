...
/**
 * Collection response for MultiTenantOrganizationState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MultiTenantOrganizationStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MultiTenantOrganizationState[]
     */
    private array $value = [];
     ...
     * 
     * @return MultiTenantOrganizationState[]
     */
     ...
     * 
     * @param MultiTenantOrganizationState[] $items
     * @return self
     */
    public function setValue(array|MultiTenantOrganizationState $items, MultiTenantOrganizationState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MultiTenantOrganizationState> $value
     * @return self
     ...
     * 
     * @param MultiTenantOrganizationState $item
     * @return self
     */
    public function addValue(MultiTenantOrganizationState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MultiTenantOrganizationState>
     */
