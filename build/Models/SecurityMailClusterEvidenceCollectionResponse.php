...
/**
 * Collection response for SecurityMailClusterEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityMailClusterEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityMailClusterEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityMailClusterEvidence[]
     */
     ...
     * 
     * @param SecurityMailClusterEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityMailClusterEvidence $items, SecurityMailClusterEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityMailClusterEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityMailClusterEvidence $item
     * @return self
     */
    public function addValue(SecurityMailClusterEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityMailClusterEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityMailClusterEvidence>
     */
