 ...
 */
class SecurityMailClusterEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityMailClusterEvidence ...$items Variable number of SecurityMailClusterEvidence items
     * @return self
     */
    public function setValue(SecurityMailClusterEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
