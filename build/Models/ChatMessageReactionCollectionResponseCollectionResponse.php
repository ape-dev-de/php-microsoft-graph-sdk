...
/**
 * Collection response for ChatMessageReactionCollectionResponse
 */
class ChatMessageReactionCollectionResponseCollectionResponse
{
    /**
     * @var ChatMessageReactionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ChatMessageReactionCollectionResponse ...$items Variable number of ChatMessageReactionCollectionResponse items
     * @return self
     */
    public function setValue(ChatMessageReactionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ChatMessageReactionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ChatMessageReactionCollectionResponse $item
     * @return self
     */
    public function addValue(ChatMessageReactionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
