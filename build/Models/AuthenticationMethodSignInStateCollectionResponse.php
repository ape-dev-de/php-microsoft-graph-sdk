...
/**
 * AuthenticationMethodSignInStateCollectionResponse - Collection response
 */
class AuthenticationMethodSignInStateCollectionResponse
{
    /**
     * @var array<int, AuthenticationMethodSignInState>
     */
    public array $value = [];
