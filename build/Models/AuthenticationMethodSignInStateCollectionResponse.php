...
/**
 * Collection response for AuthenticationMethodSignInState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationMethodSignInStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return AuthenticationMethodSignInState[]
     */
     ...
     * 
     * @param AuthenticationMethodSignInState[] $items
     * @return self
     */
    public function setValue(array|AuthenticationMethodSignInState $items, AuthenticationMethodSignInState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationMethodSignInState> $value
     * @return self
     ...
     * 
     * @param AuthenticationMethodSignInState $item
     * @return self
     */
    public function addValue(AuthenticationMethodSignInState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationMethodSignInState>
     */
