...
/**
 * Collection response for SecurityHuntingQueryResults
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHuntingQueryResultsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityHuntingQueryResults[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityHuntingQueryResults[]
     */
     ...
     * 
     * @param SecurityHuntingQueryResults[] $items
     * @return self
     */
    public function setValue(array|SecurityHuntingQueryResults $items, SecurityHuntingQueryResults ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHuntingQueryResults> $value
     * @return self
     ...
     * 
     * @param SecurityHuntingQueryResults $item
     * @return self
     */
    public function addValue(SecurityHuntingQueryResults $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityHuntingQueryResults|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityHuntingQueryResults>
     */
