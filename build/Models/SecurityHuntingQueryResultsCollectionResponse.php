 ...
 */
class SecurityHuntingQueryResultsCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityHuntingQueryResults ...$items Variable number of SecurityHuntingQueryResults items
     * @return self
     */
    public function setValue(SecurityHuntingQueryResults ...$items): self
    {
        $this->value = $items;
        return $this;
    }
