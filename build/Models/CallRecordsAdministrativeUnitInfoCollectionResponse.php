...
/**
 * Collection response for CallRecordsAdministrativeUnitInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsAdministrativeUnitInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return CallRecordsAdministrativeUnitInfo[]
     */
     ...
     * 
     * @param CallRecordsAdministrativeUnitInfo[] $items
     * @return self
     */
    public function setValue(array|CallRecordsAdministrativeUnitInfo $items, CallRecordsAdministrativeUnitInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsAdministrativeUnitInfo> $value
     * @return self
     ...
     * 
     * @param CallRecordsAdministrativeUnitInfo $item
     * @return self
     */
    public function addValue(CallRecordsAdministrativeUnitInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsAdministrativeUnitInfo|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsAdministrativeUnitInfo>
     */
