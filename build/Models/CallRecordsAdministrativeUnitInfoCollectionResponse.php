...
/**
 * CallRecordsAdministrativeUnitInfoCollectionResponse - Collection response
 */
class CallRecordsAdministrativeUnitInfoCollectionResponse
{
    /**
     * @var array<int, CallRecordsAdministrativeUnitInfo>
     */
    public array $value = [];
