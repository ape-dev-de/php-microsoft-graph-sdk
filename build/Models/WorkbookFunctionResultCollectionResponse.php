...
/**
 * Collection response for WorkbookFunctionResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookFunctionResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookFunctionResult[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookFunctionResult[] $items
     * @return self
     */
    public function setValue(array|WorkbookFunctionResult $items, WorkbookFunctionResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookFunctionResult> $value
     * @return self
     ...
     * 
     * @param WorkbookFunctionResult $item
     * @return self
     */
    public function addValue(WorkbookFunctionResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WorkbookFunctionResult|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WorkbookFunctionResult>
     */
