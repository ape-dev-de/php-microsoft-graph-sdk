 ...
 */
class WorkbookFunctionResultCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookFunctionResult ...$items Variable number of WorkbookFunctionResult items
     * @return self
     */
    public function setValue(WorkbookFunctionResult ...$items): self
    {
        $this->value = $items;
        return $this;
    }
