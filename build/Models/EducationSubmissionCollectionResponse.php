...
/**
 * Collection response for EducationSubmission
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationSubmissionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param EducationSubmission[] $items
     * @return self
     */
    public function setValue(array|EducationSubmission $items, EducationSubmission ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationSubmission> $value
     * @return self
     ...
     * 
     * @param EducationSubmission $item
     * @return self
     */
    public function addValue(EducationSubmission $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationSubmission>
     */
