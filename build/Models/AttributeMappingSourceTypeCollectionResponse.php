...
/**
 * Collection response for AttributeMappingSourceType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttributeMappingSourceTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return AttributeMappingSourceType[]
     */
     ...
     * 
     * @param AttributeMappingSourceType[] $items
     * @return self
     */
    public function setValue(array|AttributeMappingSourceType $items, AttributeMappingSourceType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttributeMappingSourceType> $value
     * @return self
     ...
     * 
     * @param AttributeMappingSourceType $item
     * @return self
     */
    public function addValue(AttributeMappingSourceType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AttributeMappingSourceType>
     */
