...
/**
 * AttributeMappingSourceTypeCollectionResponse - Collection response
 */
class AttributeMappingSourceTypeCollectionResponse
{
    /**
     * @var array<int, AttributeMappingSourceType>
     */
    public array $value = [];
