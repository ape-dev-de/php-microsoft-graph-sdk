...
/**
 * AttributeDefinitionMetadataCollectionResponse - Collection response
 */
class AttributeDefinitionMetadataCollectionResponse
{
    /**
     * @var array<int, AttributeDefinitionMetadata>
     */
    public array $value = [];
