...
/**
 * Collection response for AttributeDefinitionMetadata
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttributeDefinitionMetadataCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AttributeDefinitionMetadata[]
     */
    private array $value = [];
     ...
     * 
     * @return AttributeDefinitionMetadata[]
     */
     ...
     * 
     * @param AttributeDefinitionMetadata[] $items
     * @return self
     */
    public function setValue(array|AttributeDefinitionMetadata $items, AttributeDefinitionMetadata ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttributeDefinitionMetadata> $value
     * @return self
     ...
     * 
     * @param AttributeDefinitionMetadata $item
     * @return self
     */
    public function addValue(AttributeDefinitionMetadata $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AttributeDefinitionMetadata>
     */
