...
/**
 * Collection response for NumberColumn
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class NumberColumnCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var NumberColumn[]
     */
     ...
     * 
     * @param NumberColumn[] $items
     * @return self
     */
    public function setValue(array|NumberColumn $items, NumberColumn ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<NumberColumn> $value
     * @return self
     ...
     * 
     * @param NumberColumn $item
     * @return self
     */
    public function addValue(NumberColumn $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, NumberColumn>
     */
