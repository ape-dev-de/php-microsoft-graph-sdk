...
/**
 * Collection response for IosLobAppProvisioningConfigurationAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosLobAppProvisioningConfigurationAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IosLobAppProvisioningConfigurationAssignment[]
     */
    private array $value = [];
     ...
     * 
     * @param IosLobAppProvisioningConfigurationAssignment[] $items
     * @return self
     */
    public function setValue(array|IosLobAppProvisioningConfigurationAssignment $items, IosLobAppProvisioningConfigurationAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosLobAppProvisioningConfigurationAssignment> $value
     * @return self
     ...
     * 
     * @param IosLobAppProvisioningConfigurationAssignment $item
     * @return self
     */
    public function addValue(IosLobAppProvisioningConfigurationAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IosLobAppProvisioningConfigurationAssignment|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IosLobAppProvisioningConfigurationAssignment>
     */
