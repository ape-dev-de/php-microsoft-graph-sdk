 ...
 */
class IosLobAppProvisioningConfigurationAssignmentCollectionResponse
{
    /**
     ...
     * 
     * @param IosLobAppProvisioningConfigurationAssignment ...$items Variable number of IosLobAppProvisioningConfigurationAssignment items
     * @return self
     */
    public function setValue(IosLobAppProvisioningConfigurationAssignment ...$items): self
    {
        $this->value = $items;
        return $this;
    }
