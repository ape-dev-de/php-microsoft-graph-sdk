...
/**
 * Collection response for HorizontalSection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class HorizontalSectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param HorizontalSection[] $items
     * @return self
     */
    public function setValue(array|HorizontalSection $items, HorizontalSection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<HorizontalSection> $value
     * @return self
     ...
     * 
     * @param HorizontalSection $item
     * @return self
     */
    public function addValue(HorizontalSection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, HorizontalSection>
     */
