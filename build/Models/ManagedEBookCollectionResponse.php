...
/**
 * Collection response for ManagedEBook
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedEBookCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ManagedEBook[]
     */
     ...
     * 
     * @param ManagedEBook[] $items
     * @return self
     */
    public function setValue(array|ManagedEBook $items, ManagedEBook ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedEBook> $value
     * @return self
     ...
     * 
     * @param ManagedEBook $item
     * @return self
     */
    public function addValue(ManagedEBook $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedEBook>
     */
