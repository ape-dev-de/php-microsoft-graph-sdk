...
/**
 * Collection response for InternetMessageHeader
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InternetMessageHeaderCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param InternetMessageHeader[] $items
     * @return self
     */
    public function setValue(array|InternetMessageHeader $items, InternetMessageHeader ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InternetMessageHeader> $value
     * @return self
     ...
     * 
     * @param InternetMessageHeader $item
     * @return self
     */
    public function addValue(InternetMessageHeader $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, InternetMessageHeader>
     */
