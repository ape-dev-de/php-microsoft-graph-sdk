...
/**
 * Collection response for OsVersionCount
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OsVersionCountCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OsVersionCount[]
     */
     ...
     * 
     * @param OsVersionCount[] $items
     * @return self
     */
    public function setValue(array|OsVersionCount $items, OsVersionCount ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OsVersionCount> $value
     * @return self
     ...
     * 
     * @param OsVersionCount $item
     * @return self
     */
    public function addValue(OsVersionCount $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OsVersionCount>
     */
