...
/**
 * Collection response for OnPremisesProvisioningError
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnPremisesProvisioningErrorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param OnPremisesProvisioningError[] $items
     * @return self
     */
    public function setValue(array|OnPremisesProvisioningError $items, OnPremisesProvisioningError ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnPremisesProvisioningError> $value
     * @return self
     ...
     * 
     * @param OnPremisesProvisioningError $item
     * @return self
     */
    public function addValue(OnPremisesProvisioningError $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OnPremisesProvisioningError|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OnPremisesProvisioningError>
     */
