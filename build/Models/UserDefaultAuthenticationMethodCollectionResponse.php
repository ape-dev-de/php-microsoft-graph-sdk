...
/**
 * UserDefaultAuthenticationMethodCollectionResponse - Collection response
 */
class UserDefaultAuthenticationMethodCollectionResponse
{
    /**
     * @var array<int, UserDefaultAuthenticationMethod>
     */
    public array $value = [];
