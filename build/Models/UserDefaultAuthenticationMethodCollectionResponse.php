...
/**
 * Collection response for UserDefaultAuthenticationMethod
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserDefaultAuthenticationMethodCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserDefaultAuthenticationMethod[]
     */
    private array $value = [];
     ...
     * 
     * @return UserDefaultAuthenticationMethod[]
     */
     ...
     * 
     * @param UserDefaultAuthenticationMethod[] $items
     * @return self
     */
    public function setValue(array|UserDefaultAuthenticationMethod $items, UserDefaultAuthenticationMethod ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserDefaultAuthenticationMethod> $value
     * @return self
     ...
     * 
     * @param UserDefaultAuthenticationMethod $item
     * @return self
     */
    public function addValue(UserDefaultAuthenticationMethod $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserDefaultAuthenticationMethod>
     */
