...
/**
 * Collection response for LabelActionSource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LabelActionSourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var LabelActionSource[]
     */
    private array $value = [];
     ...
     * 
     * @param LabelActionSource[] $items
     * @return self
     */
    public function setValue(array|LabelActionSource $items, LabelActionSource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LabelActionSource> $value
     * @return self
     ...
     * 
     * @param LabelActionSource $item
     * @return self
     */
    public function addValue(LabelActionSource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LabelActionSource>
     */
