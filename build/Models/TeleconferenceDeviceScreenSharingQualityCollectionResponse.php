...
/**
 * Collection response for TeleconferenceDeviceScreenSharingQuality
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeleconferenceDeviceScreenSharingQualityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeleconferenceDeviceScreenSharingQuality[]
     */
    private array $value = [];
     ...
     * 
     * @param TeleconferenceDeviceScreenSharingQuality[] $items
     * @return self
     */
    public function setValue(array|TeleconferenceDeviceScreenSharingQuality $items, TeleconferenceDeviceScreenSharingQuality ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeleconferenceDeviceScreenSharingQuality> $value
     * @return self
     ...
     * 
     * @param TeleconferenceDeviceScreenSharingQuality $item
     * @return self
     */
    public function addValue(TeleconferenceDeviceScreenSharingQuality $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TeleconferenceDeviceScreenSharingQuality|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TeleconferenceDeviceScreenSharingQuality>
     */
