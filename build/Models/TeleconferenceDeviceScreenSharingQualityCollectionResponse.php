...
/**
 * TeleconferenceDeviceScreenSharingQualityCollectionResponse - Collection response
 */
class TeleconferenceDeviceScreenSharingQualityCollectionResponse
{
    /**
     * @var array<int, TeleconferenceDeviceScreenSharingQuality>
     */
    public array $value = [];
