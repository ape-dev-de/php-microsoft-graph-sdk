...
/**
 * Collection response for Place
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlaceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Place[]
     */
     ...
     * @return self
     */
    public function setValue(array|Place $items, Place ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Place $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Place>
     */
