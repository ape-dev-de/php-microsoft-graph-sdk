...
/**
 * Collection response for VerifiedDomain
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VerifiedDomainCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VerifiedDomain[]
     */
     ...
     * 
     * @param VerifiedDomain[] $items
     * @return self
     */
    public function setValue(array|VerifiedDomain $items, VerifiedDomain ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VerifiedDomain> $value
     * @return self
     ...
     * 
     * @param VerifiedDomain $item
     * @return self
     */
    public function addValue(VerifiedDomain $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VerifiedDomain>
     */
