...
/**
 * SecureSignInSessionControlCollectionResponse - Collection response
 */
class SecureSignInSessionControlCollectionResponse
{
    /**
     * @var array<int, SecureSignInSessionControl>
     */
    public array $value = [];
