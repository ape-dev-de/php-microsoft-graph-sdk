...
/**
 * Collection response for SecureSignInSessionControl
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecureSignInSessionControlCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecureSignInSessionControl[]
     */
    private array $value = [];
     ...
     * 
     * @param SecureSignInSessionControl[] $items
     * @return self
     */
    public function setValue(array|SecureSignInSessionControl $items, SecureSignInSessionControl ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecureSignInSessionControl> $value
     * @return self
     ...
     * 
     * @param SecureSignInSessionControl $item
     * @return self
     */
    public function addValue(SecureSignInSessionControl $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecureSignInSessionControl>
     */
