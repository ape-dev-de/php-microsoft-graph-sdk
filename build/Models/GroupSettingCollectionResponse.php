...
/**
 * Collection response for GroupSetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class GroupSettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var GroupSetting[]
     */
     ...
     * 
     * @param GroupSetting[] $items
     * @return self
     */
    public function setValue(array|GroupSetting $items, GroupSetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<GroupSetting> $value
     * @return self
     ...
     * 
     * @param GroupSetting $item
     * @return self
     */
    public function addValue(GroupSetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, GroupSetting>
     */
