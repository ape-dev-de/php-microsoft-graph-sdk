 ...
 */
class EmailPayloadDetailCollectionResponse
{
    /**
     ...
     * 
     * @param EmailPayloadDetail ...$items Variable number of EmailPayloadDetail items
     * @return self
     */
    public function setValue(EmailPayloadDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
