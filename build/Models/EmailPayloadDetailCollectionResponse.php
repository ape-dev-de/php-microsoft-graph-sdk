...
/**
 * Collection response for EmailPayloadDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EmailPayloadDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EmailPayloadDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param EmailPayloadDetail[] $items
     * @return self
     */
    public function setValue(array|EmailPayloadDetail $items, EmailPayloadDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EmailPayloadDetail> $value
     * @return self
     ...
     * 
     * @param EmailPayloadDetail $item
     * @return self
     */
    public function addValue(EmailPayloadDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EmailPayloadDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EmailPayloadDetail>
     */
