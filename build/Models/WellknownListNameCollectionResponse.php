...
/**
 * Collection response for WellknownListName
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WellknownListNameCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WellknownListName[] $items
     * @return self
     */
    public function setValue(array|WellknownListName $items, WellknownListName ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WellknownListName> $value
     * @return self
     ...
     * 
     * @param WellknownListName $item
     * @return self
     */
    public function addValue(WellknownListName $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WellknownListName>
     */
