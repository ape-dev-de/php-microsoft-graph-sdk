...
/**
 * Collection response for DeletedChat
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeletedChatCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeletedChat[]
     */
     ...
     * 
     * @param DeletedChat[] $items
     * @return self
     */
    public function setValue(array|DeletedChat $items, DeletedChat ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param DeletedChat $item
     * @return self
     */
    public function addValue(DeletedChat $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeletedChat>
     */
