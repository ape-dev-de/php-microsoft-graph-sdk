...
/**
 * CallRecordsPstnCallDurationSourceCollectionResponse - Collection response
 */
class CallRecordsPstnCallDurationSourceCollectionResponse
{
    /**
     * @var array<int, CallRecordsPstnCallDurationSource>
     */
    public array $value = [];
