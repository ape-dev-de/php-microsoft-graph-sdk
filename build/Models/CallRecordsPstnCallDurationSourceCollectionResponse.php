...
/**
 * Collection response for CallRecordsPstnCallDurationSource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsPstnCallDurationSourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsPstnCallDurationSource[]
     */
    private array $value = [];
     ...
     * 
     * @return CallRecordsPstnCallDurationSource[]
     */
     ...
     * 
     * @param CallRecordsPstnCallDurationSource[] $items
     * @return self
     */
    public function setValue(array|CallRecordsPstnCallDurationSource $items, CallRecordsPstnCallDurationSource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsPstnCallDurationSource> $value
     * @return self
     ...
     * 
     * @param CallRecordsPstnCallDurationSource $item
     * @return self
     */
    public function addValue(CallRecordsPstnCallDurationSource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsPstnCallDurationSource|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsPstnCallDurationSource>
     */
