...
/**
 * Collection response for SecuritySensorDeploymentPackage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecuritySensorDeploymentPackageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecuritySensorDeploymentPackage[]
     */
    private array $value = [];
     ...
     * 
     * @return SecuritySensorDeploymentPackage[]
     */
     ...
     * 
     * @param SecuritySensorDeploymentPackage[] $items
     * @return self
     */
    public function setValue(array|SecuritySensorDeploymentPackage $items, SecuritySensorDeploymentPackage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecuritySensorDeploymentPackage> $value
     * @return self
     ...
     * 
     * @param SecuritySensorDeploymentPackage $item
     * @return self
     */
    public function addValue(SecuritySensorDeploymentPackage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecuritySensorDeploymentPackage|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecuritySensorDeploymentPackage>
     */
