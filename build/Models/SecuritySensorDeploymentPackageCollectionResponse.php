 ...
 */
class SecuritySensorDeploymentPackageCollectionResponse
{
    /**
     ...
     * 
     * @param SecuritySensorDeploymentPackage ...$items Variable number of SecuritySensorDeploymentPackage items
     * @return self
     */
    public function setValue(SecuritySensorDeploymentPackage ...$items): self
    {
        $this->value = $items;
        return $this;
    }
