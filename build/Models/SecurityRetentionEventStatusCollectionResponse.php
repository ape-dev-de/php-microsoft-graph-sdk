 ...
 */
class SecurityRetentionEventStatusCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityRetentionEventStatus ...$items Variable number of SecurityRetentionEventStatus items
     * @return self
     */
    public function setValue(SecurityRetentionEventStatus ...$items): self
    {
        $this->value = $items;
        return $this;
    }
