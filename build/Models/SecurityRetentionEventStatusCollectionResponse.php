...
/**
 * Collection response for SecurityRetentionEventStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityRetentionEventStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityRetentionEventStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityRetentionEventStatus[]
     */
     ...
     * 
     * @param SecurityRetentionEventStatus[] $items
     * @return self
     */
    public function setValue(array|SecurityRetentionEventStatus $items, SecurityRetentionEventStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityRetentionEventStatus> $value
     * @return self
     ...
     * 
     * @param SecurityRetentionEventStatus $item
     * @return self
     */
    public function addValue(SecurityRetentionEventStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityRetentionEventStatus|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityRetentionEventStatus>
     */
