...
/**
 * Collection response for PasswordCredential
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PasswordCredentialCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PasswordCredential[] $items
     * @return self
     */
    public function setValue(array|PasswordCredential $items, PasswordCredential ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PasswordCredential> $value
     * @return self
     ...
     * 
     * @param PasswordCredential $item
     * @return self
     */
    public function addValue(PasswordCredential $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PasswordCredential>
     */
