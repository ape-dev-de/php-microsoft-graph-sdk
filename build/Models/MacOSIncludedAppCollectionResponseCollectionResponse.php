...
/**
 * Collection response for MacOSIncludedAppCollectionResponse
 */
class MacOSIncludedAppCollectionResponseCollectionResponse
{
    /**
     * @var MacOSIncludedAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MacOSIncludedAppCollectionResponse ...$items Variable number of MacOSIncludedAppCollectionResponse items
     * @return self
     */
    public function setValue(MacOSIncludedAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MacOSIncludedAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MacOSIncludedAppCollectionResponse $item
     * @return self
     */
    public function addValue(MacOSIncludedAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
