...
/**
 * Collection response for CloudPcManagementGroupAssignmentTarget
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcManagementGroupAssignmentTargetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudPcManagementGroupAssignmentTarget[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudPcManagementGroupAssignmentTarget[] $items
     * @return self
     */
    public function setValue(array|CloudPcManagementGroupAssignmentTarget $items, CloudPcManagementGroupAssignmentTarget ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcManagementGroupAssignmentTarget> $value
     * @return self
     ...
     * 
     * @param CloudPcManagementGroupAssignmentTarget $item
     * @return self
     */
    public function addValue(CloudPcManagementGroupAssignmentTarget $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CloudPcManagementGroupAssignmentTarget|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CloudPcManagementGroupAssignmentTarget>
     */
