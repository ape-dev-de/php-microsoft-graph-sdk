 ...
 */
class CloudPcManagementGroupAssignmentTargetCollectionResponse
{
    /**
     ...
     * 
     * @param CloudPcManagementGroupAssignmentTarget ...$items Variable number of CloudPcManagementGroupAssignmentTarget items
     * @return self
     */
    public function setValue(CloudPcManagementGroupAssignmentTarget ...$items): self
    {
        $this->value = $items;
        return $this;
    }
