...
/**
 * Collection response for SecurityEdiscoveryCaseCollectionResponse
 */
class SecurityEdiscoveryCaseCollectionResponseCollectionResponse
{
    /**
     * @var SecurityEdiscoveryCaseCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityEdiscoveryCaseCollectionResponse ...$items Variable number of SecurityEdiscoveryCaseCollectionResponse items
     * @return self
     */
    public function setValue(SecurityEdiscoveryCaseCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityEdiscoveryCaseCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityEdiscoveryCaseCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityEdiscoveryCaseCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
