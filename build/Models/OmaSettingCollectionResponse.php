...
/**
 * Collection response for OmaSetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OmaSettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OmaSetting[]
     */
     ...
     * 
     * @param OmaSetting[] $items
     * @return self
     */
    public function setValue(array|OmaSetting $items, OmaSetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param OmaSetting $item
     * @return self
     */
    public function addValue(OmaSetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OmaSetting>
     */
