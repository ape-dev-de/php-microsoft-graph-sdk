...
/**
 * Collection response for CalendarRoleType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CalendarRoleTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CalendarRoleType[] $items
     * @return self
     */
    public function setValue(array|CalendarRoleType $items, CalendarRoleType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CalendarRoleType> $value
     * @return self
     ...
     * 
     * @param CalendarRoleType $item
     * @return self
     */
    public function addValue(CalendarRoleType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CalendarRoleType>
     */
