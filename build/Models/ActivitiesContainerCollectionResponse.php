 ...
 */
class ActivitiesContainerCollectionResponse
{
    /**
     ...
     * 
     * @param ActivitiesContainer ...$items Variable number of ActivitiesContainer items
     * @return self
     */
    public function setValue(ActivitiesContainer ...$items): self
    {
        $this->value = $items;
        return $this;
    }
