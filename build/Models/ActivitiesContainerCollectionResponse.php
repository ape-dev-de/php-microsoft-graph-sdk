...
/**
 * Collection response for ActivitiesContainer
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ActivitiesContainerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ActivitiesContainer[] $items
     * @return self
     */
    public function setValue(array|ActivitiesContainer $items, ActivitiesContainer ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ActivitiesContainer> $value
     * @return self
     ...
     * 
     * @param ActivitiesContainer $item
     * @return self
     */
    public function addValue(ActivitiesContainer $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ActivitiesContainer>
     */
