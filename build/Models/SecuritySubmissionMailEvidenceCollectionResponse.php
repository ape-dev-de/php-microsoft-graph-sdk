 ...
 */
class SecuritySubmissionMailEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecuritySubmissionMailEvidence ...$items Variable number of SecuritySubmissionMailEvidence items
     * @return self
     */
    public function setValue(SecuritySubmissionMailEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
