...
/**
 * Collection response for SecuritySubmissionMailEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecuritySubmissionMailEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecuritySubmissionMailEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecuritySubmissionMailEvidence[]
     */
     ...
     * 
     * @param SecuritySubmissionMailEvidence[] $items
     * @return self
     */
    public function setValue(array|SecuritySubmissionMailEvidence $items, SecuritySubmissionMailEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecuritySubmissionMailEvidence> $value
     * @return self
     ...
     * 
     * @param SecuritySubmissionMailEvidence $item
     * @return self
     */
    public function addValue(SecuritySubmissionMailEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecuritySubmissionMailEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecuritySubmissionMailEvidence>
     */
