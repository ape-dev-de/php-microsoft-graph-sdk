...
/**
 * Collection response for AppleManagedIdentityProvider
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppleManagedIdentityProviderCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AppleManagedIdentityProvider[]
     */
    private array $value = [];
     ...
     * 
     * @param AppleManagedIdentityProvider[] $items
     * @return self
     */
    public function setValue(array|AppleManagedIdentityProvider $items, AppleManagedIdentityProvider ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppleManagedIdentityProvider> $value
     * @return self
     ...
     * 
     * @param AppleManagedIdentityProvider $item
     * @return self
     */
    public function addValue(AppleManagedIdentityProvider $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AppleManagedIdentityProvider|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AppleManagedIdentityProvider>
     */
