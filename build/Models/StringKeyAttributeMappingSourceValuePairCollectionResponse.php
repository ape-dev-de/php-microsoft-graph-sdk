...
/**
 * Collection response for StringKeyAttributeMappingSourceValuePair
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class StringKeyAttributeMappingSourceValuePairCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param StringKeyAttributeMappingSourceValuePair[] $items
     * @return self
     */
    public function setValue(array|StringKeyAttributeMappingSourceValuePair $items, StringKeyAttributeMappingSourceValuePair ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<StringKeyAttributeMappingSourceValuePair> $value
     * @return self
     ...
     * 
     * @param StringKeyAttributeMappingSourceValuePair $item
     * @return self
     */
    public function addValue(StringKeyAttributeMappingSourceValuePair $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return StringKeyAttributeMappingSourceValuePair|null
     */
     ...
     * 
     * @return \ArrayIterator<int, StringKeyAttributeMappingSourceValuePair>
     */
