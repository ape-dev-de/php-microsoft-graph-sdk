 ...
 */
class PrinterCapabilitiesCollectionResponse
{
    /**
     ...
     * 
     * @param PrinterCapabilities ...$items Variable number of PrinterCapabilities items
     * @return self
     */
    public function setValue(PrinterCapabilities ...$items): self
    {
        $this->value = $items;
        return $this;
    }
