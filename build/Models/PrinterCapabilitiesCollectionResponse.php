...
/**
 * Collection response for PrinterCapabilities
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrinterCapabilitiesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PrinterCapabilities[] $items
     * @return self
     */
    public function setValue(array|PrinterCapabilities $items, PrinterCapabilities ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrinterCapabilities> $value
     * @return self
     ...
     * 
     * @param PrinterCapabilities $item
     * @return self
     */
    public function addValue(PrinterCapabilities $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrinterCapabilities>
     */
