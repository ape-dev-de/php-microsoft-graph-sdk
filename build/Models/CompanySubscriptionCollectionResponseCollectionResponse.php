...
/**
 * Collection response for CompanySubscriptionCollectionResponse
 */
class CompanySubscriptionCollectionResponseCollectionResponse
{
    /**
     * @var CompanySubscriptionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CompanySubscriptionCollectionResponse ...$items Variable number of CompanySubscriptionCollectionResponse items
     * @return self
     */
    public function setValue(CompanySubscriptionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CompanySubscriptionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CompanySubscriptionCollectionResponse $item
     * @return self
     */
    public function addValue(CompanySubscriptionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
