...
/**
 * Collection response for HomeRealmDiscoveryPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class HomeRealmDiscoveryPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param HomeRealmDiscoveryPolicy[] $items
     * @return self
     */
    public function setValue(array|HomeRealmDiscoveryPolicy $items, HomeRealmDiscoveryPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<HomeRealmDiscoveryPolicy> $value
     * @return self
     ...
     * 
     * @param HomeRealmDiscoveryPolicy $item
     * @return self
     */
    public function addValue(HomeRealmDiscoveryPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, HomeRealmDiscoveryPolicy>
     */
