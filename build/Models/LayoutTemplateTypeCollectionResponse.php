...
/**
 * Collection response for LayoutTemplateType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LayoutTemplateTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var LayoutTemplateType[]
     */
    private array $value = [];
     ...
     * 
     * @param LayoutTemplateType[] $items
     * @return self
     */
    public function setValue(array|LayoutTemplateType $items, LayoutTemplateType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LayoutTemplateType> $value
     * @return self
     ...
     * 
     * @param LayoutTemplateType $item
     * @return self
     */
    public function addValue(LayoutTemplateType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LayoutTemplateType>
     */
