...
/**
 * Collection response for PrivilegedAccessGroupAssignmentScheduleRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrivilegedAccessGroupAssignmentScheduleRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PrivilegedAccessGroupAssignmentScheduleRequest[] $items
     * @return self
     */
    public function setValue(array|PrivilegedAccessGroupAssignmentScheduleRequest $items, PrivilegedAccessGroupAssignmentScheduleRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrivilegedAccessGroupAssignmentScheduleRequest> $value
     * @return self
     ...
     * 
     * @param PrivilegedAccessGroupAssignmentScheduleRequest $item
     * @return self
     */
    public function addValue(PrivilegedAccessGroupAssignmentScheduleRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrivilegedAccessGroupAssignmentScheduleRequest>
     */
