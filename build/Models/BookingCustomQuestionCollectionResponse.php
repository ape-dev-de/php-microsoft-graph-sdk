...
/**
 * Collection response for BookingCustomQuestion
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingCustomQuestionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param BookingCustomQuestion[] $items
     * @return self
     */
    public function setValue(array|BookingCustomQuestion $items, BookingCustomQuestion ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingCustomQuestion> $value
     * @return self
     ...
     * 
     * @param BookingCustomQuestion $item
     * @return self
     */
    public function addValue(BookingCustomQuestion $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BookingCustomQuestion>
     */
