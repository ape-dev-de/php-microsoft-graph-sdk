...
/**
 * Collection response for BookingStaffMemberBaseCollectionResponse
 */
class BookingStaffMemberBaseCollectionResponseCollectionResponse
{
    /**
     * @var BookingStaffMemberBaseCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BookingStaffMemberBaseCollectionResponse ...$items Variable number of BookingStaffMemberBaseCollectionResponse items
     * @return self
     */
    public function setValue(BookingStaffMemberBaseCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<BookingStaffMemberBaseCollectionResponse> $value
     * @return self
     ...
     * 
     * @param BookingStaffMemberBaseCollectionResponse $item
     * @return self
     */
    public function addValue(BookingStaffMemberBaseCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
