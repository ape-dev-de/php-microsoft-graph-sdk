...
/**
 * Collection response for Planner
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Planner[]
     */
     ...
     * @return self
     */
    public function setValue(array|Planner $items, Planner ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Planner $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Planner>
     */
