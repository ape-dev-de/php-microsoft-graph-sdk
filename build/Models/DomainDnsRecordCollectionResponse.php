...
/**
 * Collection response for DomainDnsRecord
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DomainDnsRecordCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DomainDnsRecord[]
     */
     ...
     * @return self
     */
    public function setValue(array|DomainDnsRecord $items, DomainDnsRecord ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DomainDnsRecord> $value
     * @return self
     ...
     * 
     * @param DomainDnsRecord $item
     * @return self
     */
    public function addValue(DomainDnsRecord $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DomainDnsRecord>
     */
