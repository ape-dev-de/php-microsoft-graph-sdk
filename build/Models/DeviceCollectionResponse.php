...
/**
 * Collection response for Device
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Device[]
     */
     ...
     * @return self
     */
    public function setValue(array|Device $items, Device ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Device $item): self
    {
        $this->value[] = $item;
        return $this;
    }
