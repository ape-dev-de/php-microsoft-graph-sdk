 ...
 */
class ApiApplicationCollectionResponse
{
    /**
     * @var ApiApplication[]
     */
     ...
     * 
     * @param ApiApplication ...$items Variable number of ApiApplication items
     * @return self
     */
    public function setValue(ApiApplication ...$items): self
    {
        $this->value = $items;
        return $this;
    }
