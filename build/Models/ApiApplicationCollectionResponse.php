...
/**
 * Collection response for ApiApplication
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ApiApplicationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ApiApplication[]
     */
     ...
     * 
     * @param ApiApplication[] $items
     * @return self
     */
    public function setValue(array|ApiApplication $items, ApiApplication ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ApiApplication> $value
     * @return self
     ...
     * 
     * @param ApiApplication $item
     * @return self
     */
    public function addValue(ApiApplication $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ApiApplication>
     */
