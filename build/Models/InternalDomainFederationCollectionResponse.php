...
/**
 * Collection response for InternalDomainFederation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InternalDomainFederationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param InternalDomainFederation[] $items
     * @return self
     */
    public function setValue(array|InternalDomainFederation $items, InternalDomainFederation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InternalDomainFederation> $value
     * @return self
     ...
     * 
     * @param InternalDomainFederation $item
     * @return self
     */
    public function addValue(InternalDomainFederation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, InternalDomainFederation>
     */
