...
/**
 * RatingUnitedKingdomMoviesTypeCollectionResponse - Collection response
 */
class RatingUnitedKingdomMoviesTypeCollectionResponse
{
    /**
     * @var array<int, RatingUnitedKingdomMoviesType>
     */
    public array $value = [];
