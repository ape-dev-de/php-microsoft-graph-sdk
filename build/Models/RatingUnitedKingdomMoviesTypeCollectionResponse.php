...
/**
 * Collection response for RatingUnitedKingdomMoviesType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RatingUnitedKingdomMoviesTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RatingUnitedKingdomMoviesType[]
     */
    private array $value = [];
     ...
     * 
     * @return RatingUnitedKingdomMoviesType[]
     */
     ...
     * 
     * @param RatingUnitedKingdomMoviesType[] $items
     * @return self
     */
    public function setValue(array|RatingUnitedKingdomMoviesType $items, RatingUnitedKingdomMoviesType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RatingUnitedKingdomMoviesType> $value
     * @return self
     ...
     * 
     * @param RatingUnitedKingdomMoviesType $item
     * @return self
     */
    public function addValue(RatingUnitedKingdomMoviesType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RatingUnitedKingdomMoviesType>
     */
