...
/**
 * Collection response for Participant
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ParticipantCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Participant[]
     */
     ...
     * 
     * @param Participant[] $items
     * @return self
     */
    public function setValue(array|Participant $items, Participant ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Participant $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Participant>
     */
