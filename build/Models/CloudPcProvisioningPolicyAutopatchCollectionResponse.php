...
/**
 * Collection response for CloudPcProvisioningPolicyAutopatch
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcProvisioningPolicyAutopatchCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudPcProvisioningPolicyAutopatch[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudPcProvisioningPolicyAutopatch[] $items
     * @return self
     */
    public function setValue(array|CloudPcProvisioningPolicyAutopatch $items, CloudPcProvisioningPolicyAutopatch ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcProvisioningPolicyAutopatch> $value
     * @return self
     ...
     * 
     * @param CloudPcProvisioningPolicyAutopatch $item
     * @return self
     */
    public function addValue(CloudPcProvisioningPolicyAutopatch $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcProvisioningPolicyAutopatch>
     */
