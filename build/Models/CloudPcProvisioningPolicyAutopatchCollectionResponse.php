 ...
 */
class CloudPcProvisioningPolicyAutopatchCollectionResponse
{
    /**
     ...
     * 
     * @param CloudPcProvisioningPolicyAutopatch ...$items Variable number of CloudPcProvisioningPolicyAutopatch items
     * @return self
     */
    public function setValue(CloudPcProvisioningPolicyAutopatch ...$items): self
    {
        $this->value = $items;
        return $this;
    }
