...
/**
 * Collection response for SecurityNicEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityNicEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityNicEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityNicEvidence $items, SecurityNicEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityNicEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityNicEvidence $item
     * @return self
     */
    public function addValue(SecurityNicEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityNicEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityNicEvidence>
     */
