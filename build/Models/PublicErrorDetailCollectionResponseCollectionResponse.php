...
/**
 * Collection response for PublicErrorDetailCollectionResponse
 */
class PublicErrorDetailCollectionResponseCollectionResponse
{
    /**
     * @var PublicErrorDetailCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PublicErrorDetailCollectionResponse ...$items Variable number of PublicErrorDetailCollectionResponse items
     * @return self
     */
    public function setValue(PublicErrorDetailCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PublicErrorDetailCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PublicErrorDetailCollectionResponse $item
     * @return self
     */
    public function addValue(PublicErrorDetailCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
