...
/**
 * Collection response for TeamsApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamsAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamsApp[]
     */
     ...
     * 
     * @param TeamsApp[] $items
     * @return self
     */
    public function setValue(array|TeamsApp $items, TeamsApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(TeamsApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamsApp>
     */
