...
/**
 * Collection response for MiracastChannel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MiracastChannelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MiracastChannel[]
     */
     ...
     * 
     * @param MiracastChannel[] $items
     * @return self
     */
    public function setValue(array|MiracastChannel $items, MiracastChannel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MiracastChannel> $value
     * @return self
     ...
     * 
     * @param MiracastChannel $item
     * @return self
     */
    public function addValue(MiracastChannel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MiracastChannel>
     */
