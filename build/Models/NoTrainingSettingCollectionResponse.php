...
/**
 * Collection response for NoTrainingSetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class NoTrainingSettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var NoTrainingSetting[]
     */
    private array $value = [];
     ...
     * 
     * @param NoTrainingSetting[] $items
     * @return self
     */
    public function setValue(array|NoTrainingSetting $items, NoTrainingSetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<NoTrainingSetting> $value
     * @return self
     ...
     * 
     * @param NoTrainingSetting $item
     * @return self
     */
    public function addValue(NoTrainingSetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, NoTrainingSetting>
     */
