...
/**
 * Collection response for PayloadCoachmarkCollectionResponse
 */
class PayloadCoachmarkCollectionResponseCollectionResponse
{
    /**
     * @var PayloadCoachmarkCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PayloadCoachmarkCollectionResponse ...$items Variable number of PayloadCoachmarkCollectionResponse items
     * @return self
     */
    public function setValue(PayloadCoachmarkCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PayloadCoachmarkCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PayloadCoachmarkCollectionResponse $item
     * @return self
     */
    public function addValue(PayloadCoachmarkCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
