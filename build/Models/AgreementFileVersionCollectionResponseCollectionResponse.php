...
/**
 * Collection response for AgreementFileVersionCollectionResponse
 */
class AgreementFileVersionCollectionResponseCollectionResponse
{
    /**
     * @var AgreementFileVersionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AgreementFileVersionCollectionResponse ...$items Variable number of AgreementFileVersionCollectionResponse items
     * @return self
     */
    public function setValue(AgreementFileVersionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AgreementFileVersionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AgreementFileVersionCollectionResponse $item
     * @return self
     */
    public function addValue(AgreementFileVersionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
