...
/**
 * Collection response for SensitivityLabel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SensitivityLabelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SensitivityLabel[] $items
     * @return self
     */
    public function setValue(array|SensitivityLabel $items, SensitivityLabel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SensitivityLabel> $value
     * @return self
     ...
     * 
     * @param SensitivityLabel $item
     * @return self
     */
    public function addValue(SensitivityLabel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SensitivityLabel>
     */
