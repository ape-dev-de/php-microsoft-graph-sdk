...
/**
 * Collection response for EducationAssignmentCollectionResponse
 */
class EducationAssignmentCollectionResponseCollectionResponse
{
    /**
     * @var EducationAssignmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationAssignmentCollectionResponse ...$items Variable number of EducationAssignmentCollectionResponse items
     * @return self
     */
    public function setValue(EducationAssignmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EducationAssignmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EducationAssignmentCollectionResponse $item
     * @return self
     */
    public function addValue(EducationAssignmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
