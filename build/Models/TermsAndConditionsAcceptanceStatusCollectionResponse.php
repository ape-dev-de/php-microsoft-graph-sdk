...
/**
 * Collection response for TermsAndConditionsAcceptanceStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TermsAndConditionsAcceptanceStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TermsAndConditionsAcceptanceStatus[] $items
     * @return self
     */
    public function setValue(array|TermsAndConditionsAcceptanceStatus $items, TermsAndConditionsAcceptanceStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TermsAndConditionsAcceptanceStatus> $value
     * @return self
     ...
     * 
     * @param TermsAndConditionsAcceptanceStatus $item
     * @return self
     */
    public function addValue(TermsAndConditionsAcceptanceStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TermsAndConditionsAcceptanceStatus>
     */
