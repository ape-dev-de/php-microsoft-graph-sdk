...
/**
 * Collection response for IdentitySecurityDefaultsEnforcementPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentitySecurityDefaultsEnforcementPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentitySecurityDefaultsEnforcementPolicy[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentitySecurityDefaultsEnforcementPolicy[] $items
     * @return self
     */
    public function setValue(array|IdentitySecurityDefaultsEnforcementPolicy $items, IdentitySecurityDefaultsEnforcementPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentitySecurityDefaultsEnforcementPolicy> $value
     * @return self
     ...
     * 
     * @param IdentitySecurityDefaultsEnforcementPolicy $item
     * @return self
     */
    public function addValue(IdentitySecurityDefaultsEnforcementPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentitySecurityDefaultsEnforcementPolicy>
     */
