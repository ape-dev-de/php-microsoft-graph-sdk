...
/**
 * Collection response for TermStoreTerm
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TermStoreTermCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TermStoreTerm[]
     */
     ...
     * 
     * @param TermStoreTerm[] $items
     * @return self
     */
    public function setValue(array|TermStoreTerm $items, TermStoreTerm ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TermStoreTerm> $value
     * @return self
     ...
     * 
     * @param TermStoreTerm $item
     * @return self
     */
    public function addValue(TermStoreTerm $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TermStoreTerm>
     */
