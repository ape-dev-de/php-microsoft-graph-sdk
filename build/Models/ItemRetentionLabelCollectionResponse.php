...
/**
 * Collection response for ItemRetentionLabel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ItemRetentionLabelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ItemRetentionLabel[]
     */
    private array $value = [];
     ...
     * 
     * @param ItemRetentionLabel[] $items
     * @return self
     */
    public function setValue(array|ItemRetentionLabel $items, ItemRetentionLabel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ItemRetentionLabel> $value
     * @return self
     ...
     * 
     * @param ItemRetentionLabel $item
     * @return self
     */
    public function addValue(ItemRetentionLabel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ItemRetentionLabel>
     */
