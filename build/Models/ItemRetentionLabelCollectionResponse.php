 ...
 */
class ItemRetentionLabelCollectionResponse
{
    /**
     ...
     * 
     * @param ItemRetentionLabel ...$items Variable number of ItemRetentionLabel items
     * @return self
     */
    public function setValue(ItemRetentionLabel ...$items): self
    {
        $this->value = $items;
        return $this;
    }
