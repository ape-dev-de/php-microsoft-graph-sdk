...
/**
 * Collection response for Presence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PresenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Presence[]
     */
     ...
     * 
     * @param Presence[] $items
     * @return self
     */
    public function setValue(array|Presence $items, Presence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Presence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Presence>
     */
