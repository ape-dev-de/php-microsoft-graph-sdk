...
/**
 * Collection response for DriveProtectionRuleCollectionResponse
 */
class DriveProtectionRuleCollectionResponseCollectionResponse
{
    /**
     * @var DriveProtectionRuleCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DriveProtectionRuleCollectionResponse ...$items Variable number of DriveProtectionRuleCollectionResponse items
     * @return self
     */
    public function setValue(DriveProtectionRuleCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DriveProtectionRuleCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DriveProtectionRuleCollectionResponse $item
     * @return self
     */
    public function addValue(DriveProtectionRuleCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
