...
/**
 * Collection response for GenericError
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class GenericErrorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var GenericError[]
     */
     ...
     * 
     * @param GenericError[] $items
     * @return self
     */
    public function setValue(array|GenericError $items, GenericError ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<GenericError> $value
     * @return self
     ...
     * 
     * @param GenericError $item
     * @return self
     */
    public function addValue(GenericError $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, GenericError>
     */
