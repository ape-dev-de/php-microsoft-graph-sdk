...
/**
 * Collection response for ContactFolder
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ContactFolderCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ContactFolder[]
     */
     ...
     * 
     * @param ContactFolder[] $items
     * @return self
     */
    public function setValue(array|ContactFolder $items, ContactFolder ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ContactFolder> $value
     * @return self
     ...
     * 
     * @param ContactFolder $item
     * @return self
     */
    public function addValue(ContactFolder $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ContactFolder>
     */
