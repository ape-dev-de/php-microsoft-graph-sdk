...
/**
 * Collection response for AirPrintSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AirPrintSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AirPrintSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param AirPrintSettings[] $items
     * @return self
     */
    public function setValue(array|AirPrintSettings $items, AirPrintSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AirPrintSettings> $value
     * @return self
     ...
     * 
     * @param AirPrintSettings $item
     * @return self
     */
    public function addValue(AirPrintSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AirPrintSettings>
     */
