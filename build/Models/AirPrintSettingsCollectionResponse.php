 ...
 */
class AirPrintSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param AirPrintSettings ...$items Variable number of AirPrintSettings items
     * @return self
     */
    public function setValue(AirPrintSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
