...
/**
 * EndUserNotificationPreferenceCollectionResponse - Collection response
 */
class EndUserNotificationPreferenceCollectionResponse
{
    /**
     * @var array<int, EndUserNotificationPreference>
     */
    public array $value = [];
