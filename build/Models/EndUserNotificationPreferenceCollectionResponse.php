...
/**
 * Collection response for EndUserNotificationPreference
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EndUserNotificationPreferenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EndUserNotificationPreference[]
     */
    private array $value = [];
     ...
     * 
     * @return EndUserNotificationPreference[]
     */
     ...
     * 
     * @param EndUserNotificationPreference[] $items
     * @return self
     */
    public function setValue(array|EndUserNotificationPreference $items, EndUserNotificationPreference ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EndUserNotificationPreference> $value
     * @return self
     ...
     * 
     * @param EndUserNotificationPreference $item
     * @return self
     */
    public function addValue(EndUserNotificationPreference $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EndUserNotificationPreference>
     */
