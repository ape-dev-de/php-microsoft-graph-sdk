...
/**
 * Collection response for MultiTenantOrganization
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MultiTenantOrganizationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MultiTenantOrganization[]
     */
    private array $value = [];
     ...
     * 
     * @param MultiTenantOrganization[] $items
     * @return self
     */
    public function setValue(array|MultiTenantOrganization $items, MultiTenantOrganization ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MultiTenantOrganization> $value
     * @return self
     ...
     * 
     * @param MultiTenantOrganization $item
     * @return self
     */
    public function addValue(MultiTenantOrganization $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MultiTenantOrganization>
     */
