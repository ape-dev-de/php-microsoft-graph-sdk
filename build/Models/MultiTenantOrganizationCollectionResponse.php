 ...
 */
class MultiTenantOrganizationCollectionResponse
{
    /**
     ...
     * 
     * @param MultiTenantOrganization ...$items Variable number of MultiTenantOrganization items
     * @return self
     */
    public function setValue(MultiTenantOrganization ...$items): self
    {
        $this->value = $items;
        return $this;
    }
