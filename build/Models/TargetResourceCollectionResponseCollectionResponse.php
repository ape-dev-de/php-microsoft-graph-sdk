...
/**
 * Collection response for TargetResourceCollectionResponse
 */
class TargetResourceCollectionResponseCollectionResponse
{
    /**
     * @var TargetResourceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TargetResourceCollectionResponse ...$items Variable number of TargetResourceCollectionResponse items
     * @return self
     */
    public function setValue(TargetResourceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TargetResourceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TargetResourceCollectionResponse $item
     * @return self
     */
    public function addValue(TargetResourceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
