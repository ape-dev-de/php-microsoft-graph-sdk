...
/**
 * Collection response for ResultInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ResultInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ResultInfo[]
     */
     ...
     * 
     * @param ResultInfo[] $items
     * @return self
     */
    public function setValue(array|ResultInfo $items, ResultInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param ResultInfo $item
     * @return self
     */
    public function addValue(ResultInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ResultInfo>
     */
