...
/**
 * Collection response for Synchronization
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Synchronization[]
     */
     ...
     * 
     * @param Synchronization[] $items
     * @return self
     */
    public function setValue(array|Synchronization $items, Synchronization ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Synchronization> $value
     * @return self
     ...
     * 
     * @param Synchronization $item
     * @return self
     */
    public function addValue(Synchronization $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Synchronization>
     */
