 ...
 */
class SynchronizationCollectionResponse
{
    /**
     * @var Synchronization[]
     */
     ...
     * 
     * @param Synchronization ...$items Variable number of Synchronization items
     * @return self
     */
    public function setValue(Synchronization ...$items): self
    {
        $this->value = $items;
        return $this;
    }
