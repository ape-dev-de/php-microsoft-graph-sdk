...
/**
 * Collection response for AccessPackageAutomaticRequestSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageAutomaticRequestSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageAutomaticRequestSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageAutomaticRequestSettings[] $items
     * @return self
     */
    public function setValue(array|AccessPackageAutomaticRequestSettings $items, AccessPackageAutomaticRequestSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageAutomaticRequestSettings> $value
     * @return self
     ...
     * 
     * @param AccessPackageAutomaticRequestSettings $item
     * @return self
     */
    public function addValue(AccessPackageAutomaticRequestSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageAutomaticRequestSettings>
     */
