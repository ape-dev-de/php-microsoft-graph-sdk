 ...
 */
class AccessPackageAutomaticRequestSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param AccessPackageAutomaticRequestSettings ...$items Variable number of AccessPackageAutomaticRequestSettings items
     * @return self
     */
    public function setValue(AccessPackageAutomaticRequestSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
