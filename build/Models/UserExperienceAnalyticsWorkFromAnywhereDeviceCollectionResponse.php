...
/**
 * Collection response for UserExperienceAnalyticsWorkFromAnywhereDevice
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsWorkFromAnywhereDeviceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsWorkFromAnywhereDevice[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsWorkFromAnywhereDevice $items, UserExperienceAnalyticsWorkFromAnywhereDevice ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsWorkFromAnywhereDevice> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsWorkFromAnywhereDevice $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsWorkFromAnywhereDevice $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsWorkFromAnywhereDevice>
     */
