...
/**
 * Collection response for UnifiedRoleDefinitionCollectionResponse
 */
class UnifiedRoleDefinitionCollectionResponseCollectionResponse
{
    /**
     * @var UnifiedRoleDefinitionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedRoleDefinitionCollectionResponse ...$items Variable number of UnifiedRoleDefinitionCollectionResponse items
     * @return self
     */
    public function setValue(UnifiedRoleDefinitionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UnifiedRoleDefinitionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleDefinitionCollectionResponse $item
     * @return self
     */
    public function addValue(UnifiedRoleDefinitionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
