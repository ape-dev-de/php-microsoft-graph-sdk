...
/**
 * Collection response for RiskyServicePrincipal
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RiskyServicePrincipalCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param RiskyServicePrincipal[] $items
     * @return self
     */
    public function setValue(array|RiskyServicePrincipal $items, RiskyServicePrincipal ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RiskyServicePrincipal> $value
     * @return self
     ...
     * 
     * @param RiskyServicePrincipal $item
     * @return self
     */
    public function addValue(RiskyServicePrincipal $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RiskyServicePrincipal>
     */
