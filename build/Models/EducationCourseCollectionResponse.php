...
/**
 * Collection response for EducationCourse
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationCourseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationCourse[]
     */
     ...
     * 
     * @param EducationCourse[] $items
     * @return self
     */
    public function setValue(array|EducationCourse $items, EducationCourse ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationCourse> $value
     * @return self
     ...
     * 
     * @param EducationCourse $item
     * @return self
     */
    public function addValue(EducationCourse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationCourse>
     */
