 ...
 */
class EducationCourseCollectionResponse
{
    /**
     * @var EducationCourse[]
     */
     ...
     * 
     * @param EducationCourse ...$items Variable number of EducationCourse items
     * @return self
     */
    public function setValue(EducationCourse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
