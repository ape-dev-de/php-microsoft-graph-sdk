...
/**
 * Collection response for ThumbnailSet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ThumbnailSetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ThumbnailSet[]
     */
     ...
     * 
     * @param ThumbnailSet[] $items
     * @return self
     */
    public function setValue(array|ThumbnailSet $items, ThumbnailSet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ThumbnailSet> $value
     * @return self
     ...
     * 
     * @param ThumbnailSet $item
     * @return self
     */
    public function addValue(ThumbnailSet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ThumbnailSet>
     */
