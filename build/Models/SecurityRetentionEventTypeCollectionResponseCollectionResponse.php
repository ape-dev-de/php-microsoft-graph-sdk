...
/**
 * Collection response for SecurityRetentionEventTypeCollectionResponse
 */
class SecurityRetentionEventTypeCollectionResponseCollectionResponse
{
    /**
     * @var SecurityRetentionEventTypeCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityRetentionEventTypeCollectionResponse ...$items Variable number of SecurityRetentionEventTypeCollectionResponse items
     * @return self
     */
    public function setValue(SecurityRetentionEventTypeCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityRetentionEventTypeCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityRetentionEventTypeCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityRetentionEventTypeCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
