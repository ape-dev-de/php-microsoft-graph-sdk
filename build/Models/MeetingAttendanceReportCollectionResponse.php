...
/**
 * Collection response for MeetingAttendanceReport
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MeetingAttendanceReportCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MeetingAttendanceReport[] $items
     * @return self
     */
    public function setValue(array|MeetingAttendanceReport $items, MeetingAttendanceReport ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MeetingAttendanceReport> $value
     * @return self
     ...
     * 
     * @param MeetingAttendanceReport $item
     * @return self
     */
    public function addValue(MeetingAttendanceReport $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MeetingAttendanceReport>
     */
