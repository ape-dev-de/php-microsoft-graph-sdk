...
class DeviceInfo
{
    ...
    public function getPhysicalIds(): ?string
    {
        return $this->physicalIds;
    }

    public function setPhysicalIds(?string $physicalIds): self
    {
    ...
    public function getSystemLabels(): ?string
    {
        return $this->systemLabels;
    }

    public function setSystemLabels(?string $systemLabels): self
    {
