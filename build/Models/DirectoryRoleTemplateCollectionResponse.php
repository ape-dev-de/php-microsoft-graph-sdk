...
/**
 * Collection response for DirectoryRoleTemplate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DirectoryRoleTemplateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DirectoryRoleTemplate[]
     */
    private array $value = [];
     ...
     * 
     * @param DirectoryRoleTemplate[] $items
     * @return self
     */
    public function setValue(array|DirectoryRoleTemplate $items, DirectoryRoleTemplate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DirectoryRoleTemplate> $value
     * @return self
     ...
     * 
     * @param DirectoryRoleTemplate $item
     * @return self
     */
    public function addValue(DirectoryRoleTemplate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DirectoryRoleTemplate>
     */
