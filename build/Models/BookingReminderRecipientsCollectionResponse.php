...
/**
 * BookingReminderRecipientsCollectionResponse - Collection response
 */
class BookingReminderRecipientsCollectionResponse
{
    /**
     * @var array<int, BookingReminderRecipients>
     */
    public array $value = [];
