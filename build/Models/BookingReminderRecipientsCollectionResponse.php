...
/**
 * Collection response for BookingReminderRecipients
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingReminderRecipientsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BookingReminderRecipients[]
     */
    private array $value = [];
     ...
     * 
     * @return BookingReminderRecipients[]
     */
     ...
     * 
     * @param BookingReminderRecipients[] $items
     * @return self
     */
    public function setValue(array|BookingReminderRecipients $items, BookingReminderRecipients ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingReminderRecipients> $value
     * @return self
     ...
     * 
     * @param BookingReminderRecipients $item
     * @return self
     */
    public function addValue(BookingReminderRecipients $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BookingReminderRecipients>
     */
