...
/**
 * Collection response for SecurityRegistryValueEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityRegistryValueEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityRegistryValueEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityRegistryValueEvidence[]
     */
     ...
     * 
     * @param SecurityRegistryValueEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityRegistryValueEvidence $items, SecurityRegistryValueEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityRegistryValueEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityRegistryValueEvidence $item
     * @return self
     */
    public function addValue(SecurityRegistryValueEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityRegistryValueEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityRegistryValueEvidence>
     */
