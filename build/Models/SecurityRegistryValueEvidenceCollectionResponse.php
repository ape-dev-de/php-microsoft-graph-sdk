 ...
 */
class SecurityRegistryValueEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityRegistryValueEvidence ...$items Variable number of SecurityRegistryValueEvidence items
     * @return self
     */
    public function setValue(SecurityRegistryValueEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
