...
/**
 * Collection response for BookingQuestionAnswerCollectionResponse
 */
class BookingQuestionAnswerCollectionResponseCollectionResponse
{
    /**
     * @var BookingQuestionAnswerCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BookingQuestionAnswerCollectionResponse ...$items Variable number of BookingQuestionAnswerCollectionResponse items
     * @return self
     */
    public function setValue(BookingQuestionAnswerCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<BookingQuestionAnswerCollectionResponse> $value
     * @return self
     ...
     * 
     * @param BookingQuestionAnswerCollectionResponse $item
     * @return self
     */
    public function addValue(BookingQuestionAnswerCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
