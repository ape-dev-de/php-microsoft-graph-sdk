...
/**
 * Collection response for OperationStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OperationStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OperationStatus[]
     */
     ...
     * 
     * @param OperationStatus[] $items
     * @return self
     */
    public function setValue(array|OperationStatus $items, OperationStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OperationStatus> $value
     * @return self
     ...
     * 
     * @param OperationStatus $item
     * @return self
     */
    public function addValue(OperationStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OperationStatus>
     */
