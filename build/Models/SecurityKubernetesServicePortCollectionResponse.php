...
/**
 * Collection response for SecurityKubernetesServicePort
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityKubernetesServicePortCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return SecurityKubernetesServicePort[]
     */
     ...
     * 
     * @param SecurityKubernetesServicePort[] $items
     * @return self
     */
    public function setValue(array|SecurityKubernetesServicePort $items, SecurityKubernetesServicePort ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityKubernetesServicePort> $value
     * @return self
     ...
     * 
     * @param SecurityKubernetesServicePort $item
     * @return self
     */
    public function addValue(SecurityKubernetesServicePort $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityKubernetesServicePort|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityKubernetesServicePort>
     */
