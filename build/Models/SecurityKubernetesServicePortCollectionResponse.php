...
/**
 * SecurityKubernetesServicePortCollectionResponse - Collection response
 */
class SecurityKubernetesServicePortCollectionResponse
{
    /**
     * @var array<int, SecurityKubernetesServicePort>
     */
    public array $value = [];
