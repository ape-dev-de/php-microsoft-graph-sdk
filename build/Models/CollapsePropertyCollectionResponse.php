...
/**
 * Collection response for CollapseProperty
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CollapsePropertyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CollapseProperty[] $items
     * @return self
     */
    public function setValue(array|CollapseProperty $items, CollapseProperty ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CollapseProperty> $value
     * @return self
     ...
     * 
     * @param CollapseProperty $item
     * @return self
     */
    public function addValue(CollapseProperty $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CollapseProperty>
     */
