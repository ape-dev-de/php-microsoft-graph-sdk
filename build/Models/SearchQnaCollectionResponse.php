...
/**
 * Collection response for SearchQna
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SearchQnaCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SearchQna[]
     */
     ...
     * 
     * @param SearchQna[] $items
     * @return self
     */
    public function setValue(array|SearchQna $items, SearchQna ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param SearchQna $item
     * @return self
     */
    public function addValue(SearchQna $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SearchQna>
     */
