...
/**
 * Collection response for AppRoleAssignmentCollectionResponse
 */
class AppRoleAssignmentCollectionResponseCollectionResponse
{
    /**
     * @var AppRoleAssignmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AppRoleAssignmentCollectionResponse ...$items Variable number of AppRoleAssignmentCollectionResponse items
     * @return self
     */
    public function setValue(AppRoleAssignmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AppRoleAssignmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AppRoleAssignmentCollectionResponse $item
     * @return self
     */
    public function addValue(AppRoleAssignmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
