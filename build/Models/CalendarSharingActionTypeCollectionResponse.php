...
/**
 * Collection response for CalendarSharingActionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CalendarSharingActionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CalendarSharingActionType[]
     */
    private array $value = [];
     ...
     * 
     * @return CalendarSharingActionType[]
     */
     ...
     * 
     * @param CalendarSharingActionType[] $items
     * @return self
     */
    public function setValue(array|CalendarSharingActionType $items, CalendarSharingActionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CalendarSharingActionType> $value
     * @return self
     ...
     * 
     * @param CalendarSharingActionType $item
     * @return self
     */
    public function addValue(CalendarSharingActionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CalendarSharingActionType>
     */
