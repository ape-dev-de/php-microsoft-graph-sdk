...
/**
 * CalendarSharingActionTypeCollectionResponse - Collection response
 */
class CalendarSharingActionTypeCollectionResponse
{
    /**
     * @var array<int, CalendarSharingActionType>
     */
    public array $value = [];
