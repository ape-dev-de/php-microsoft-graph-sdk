...
/**
 * Collection response for SecurityUnifiedGroupSource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityUnifiedGroupSourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityUnifiedGroupSource[] $items
     * @return self
     */
    public function setValue(array|SecurityUnifiedGroupSource $items, SecurityUnifiedGroupSource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityUnifiedGroupSource> $value
     * @return self
     ...
     * 
     * @param SecurityUnifiedGroupSource $item
     * @return self
     */
    public function addValue(SecurityUnifiedGroupSource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityUnifiedGroupSource>
     */
