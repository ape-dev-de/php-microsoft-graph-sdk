...
/**
 * SecurityUnifiedGroupSourceCollectionResponse - Collection response
 */
class SecurityUnifiedGroupSourceCollectionResponse
{
    /**
     * @var array<int, SecurityUnifiedGroupSource>
     */
    public array $value = [];
