...
/**
 * Collection response for AlertFeedback
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AlertFeedbackCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AlertFeedback[]
     */
     ...
     * 
     * @param AlertFeedback[] $items
     * @return self
     */
    public function setValue(array|AlertFeedback $items, AlertFeedback ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AlertFeedback> $value
     * @return self
     ...
     * 
     * @param AlertFeedback $item
     * @return self
     */
    public function addValue(AlertFeedback $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AlertFeedback>
     */
