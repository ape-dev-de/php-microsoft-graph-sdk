...
/**
 * Collection response for AttendanceRecordCollectionResponse
 */
class AttendanceRecordCollectionResponseCollectionResponse
{
    /**
     * @var AttendanceRecordCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AttendanceRecordCollectionResponse ...$items Variable number of AttendanceRecordCollectionResponse items
     * @return self
     */
    public function setValue(AttendanceRecordCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AttendanceRecordCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AttendanceRecordCollectionResponse $item
     * @return self
     */
    public function addValue(AttendanceRecordCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
