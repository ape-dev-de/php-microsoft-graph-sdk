...
/**
 * Collection response for AccessPackageResourceRoleCollectionResponse
 */
class AccessPackageResourceRoleCollectionResponseCollectionResponse
{
    /**
     * @var AccessPackageResourceRoleCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageResourceRoleCollectionResponse ...$items Variable number of AccessPackageResourceRoleCollectionResponse items
     * @return self
     */
    public function setValue(AccessPackageResourceRoleCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AccessPackageResourceRoleCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AccessPackageResourceRoleCollectionResponse $item
     * @return self
     */
    public function addValue(AccessPackageResourceRoleCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
