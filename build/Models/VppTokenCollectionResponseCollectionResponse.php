...
/**
 * Collection response for VppTokenCollectionResponse
 */
class VppTokenCollectionResponseCollectionResponse
{
    /**
     * @var VppTokenCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param VppTokenCollectionResponse ...$items Variable number of VppTokenCollectionResponse items
     * @return self
     */
    public function setValue(VppTokenCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<VppTokenCollectionResponse> $value
     * @return self
     ...
     * 
     * @param VppTokenCollectionResponse $item
     * @return self
     */
    public function addValue(VppTokenCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
