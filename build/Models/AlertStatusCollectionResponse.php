...
/**
 * Collection response for AlertStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AlertStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AlertStatus[]
     */
     ...
     * 
     * @param AlertStatus[] $items
     * @return self
     */
    public function setValue(array|AlertStatus $items, AlertStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param AlertStatus $item
     * @return self
     */
    public function addValue(AlertStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AlertStatus>
     */
