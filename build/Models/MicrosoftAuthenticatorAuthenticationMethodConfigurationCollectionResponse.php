...
/**
 * MicrosoftAuthenticatorAuthenticationMethodConfigurationCollectionResponse - Collection response
 */
class MicrosoftAuthenticatorAuthenticationMethodConfigurationCollectionResponse
{
    /**
     * @var array<int, MicrosoftAuthenticatorAuthenticationMethodConfiguration>
     */
    public array $value = [];
