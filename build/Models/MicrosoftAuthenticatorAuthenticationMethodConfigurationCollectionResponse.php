...
/**
 * Collection response for MicrosoftAuthenticatorAuthenticationMethodConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MicrosoftAuthenticatorAuthenticationMethodConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MicrosoftAuthenticatorAuthenticationMethodConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param MicrosoftAuthenticatorAuthenticationMethodConfiguration[] $items
     * @return self
     */
    public function setValue(array|MicrosoftAuthenticatorAuthenticationMethodConfiguration $items, MicrosoftAuthenticatorAuthenticationMethodConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MicrosoftAuthenticatorAuthenticationMethodConfiguration> $value
     * @return self
     ...
     * 
     * @param MicrosoftAuthenticatorAuthenticationMethodConfiguration $item
     * @return self
     */
    public function addValue(MicrosoftAuthenticatorAuthenticationMethodConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MicrosoftAuthenticatorAuthenticationMethodConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MicrosoftAuthenticatorAuthenticationMethodConfiguration>
     */
