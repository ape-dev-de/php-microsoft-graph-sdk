...
/**
 * Collection response for AuditEvent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuditEventCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuditEvent[]
     */
     ...
     * 
     * @param AuditEvent[] $items
     * @return self
     */
    public function setValue(array|AuditEvent $items, AuditEvent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param AuditEvent $item
     * @return self
     */
    public function addValue(AuditEvent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuditEvent>
     */
