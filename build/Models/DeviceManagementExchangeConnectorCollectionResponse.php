...
/**
 * Collection response for DeviceManagementExchangeConnector
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceManagementExchangeConnectorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceManagementExchangeConnector[] $items
     * @return self
     */
    public function setValue(array|DeviceManagementExchangeConnector $items, DeviceManagementExchangeConnector ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceManagementExchangeConnector> $value
     * @return self
     ...
     * 
     * @param DeviceManagementExchangeConnector $item
     * @return self
     */
    public function addValue(DeviceManagementExchangeConnector $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceManagementExchangeConnector>
     */
