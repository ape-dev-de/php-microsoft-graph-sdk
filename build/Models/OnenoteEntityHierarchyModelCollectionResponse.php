...
/**
 * Collection response for OnenoteEntityHierarchyModel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnenoteEntityHierarchyModelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnenoteEntityHierarchyModel[]
     */
    private array $value = [];
     ...
     * 
     * @param OnenoteEntityHierarchyModel[] $items
     * @return self
     */
    public function setValue(array|OnenoteEntityHierarchyModel $items, OnenoteEntityHierarchyModel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnenoteEntityHierarchyModel> $value
     * @return self
     ...
     * 
     * @param OnenoteEntityHierarchyModel $item
     * @return self
     */
    public function addValue(OnenoteEntityHierarchyModel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OnenoteEntityHierarchyModel|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OnenoteEntityHierarchyModel>
     */
