 ...
 */
class OnenoteEntityHierarchyModelCollectionResponse
{
    /**
     ...
     * 
     * @param OnenoteEntityHierarchyModel ...$items Variable number of OnenoteEntityHierarchyModel items
     * @return self
     */
    public function setValue(OnenoteEntityHierarchyModel ...$items): self
    {
        $this->value = $items;
        return $this;
    }
