...
/**
 * Collection response for ManagedAndroidLobApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedAndroidLobAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ManagedAndroidLobApp[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedAndroidLobApp[] $items
     * @return self
     */
    public function setValue(array|ManagedAndroidLobApp $items, ManagedAndroidLobApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedAndroidLobApp> $value
     * @return self
     ...
     * 
     * @param ManagedAndroidLobApp $item
     * @return self
     */
    public function addValue(ManagedAndroidLobApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedAndroidLobApp>
     */
