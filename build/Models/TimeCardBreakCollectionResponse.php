...
/**
 * Collection response for TimeCardBreak
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TimeCardBreakCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TimeCardBreak[]
     */
     ...
     * 
     * @param TimeCardBreak[] $items
     * @return self
     */
    public function setValue(array|TimeCardBreak $items, TimeCardBreak ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TimeCardBreak> $value
     * @return self
     ...
     * 
     * @param TimeCardBreak $item
     * @return self
     */
    public function addValue(TimeCardBreak $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TimeCardBreak>
     */
