 ...
 */
class CallRecordsClientUserAgentCollectionResponse
{
    /**
     ...
     * 
     * @param CallRecordsClientUserAgent ...$items Variable number of CallRecordsClientUserAgent items
     * @return self
     */
    public function setValue(CallRecordsClientUserAgent ...$items): self
    {
        $this->value = $items;
        return $this;
    }
