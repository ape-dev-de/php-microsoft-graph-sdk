...
/**
 * Collection response for CallRecordsClientUserAgent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsClientUserAgentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsClientUserAgent[]
     */
    private array $value = [];
     ...
     * 
     * @return CallRecordsClientUserAgent[]
     */
     ...
     * 
     * @param CallRecordsClientUserAgent[] $items
     * @return self
     */
    public function setValue(array|CallRecordsClientUserAgent $items, CallRecordsClientUserAgent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsClientUserAgent> $value
     * @return self
     ...
     * 
     * @param CallRecordsClientUserAgent $item
     * @return self
     */
    public function addValue(CallRecordsClientUserAgent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsClientUserAgent|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsClientUserAgent>
     */
