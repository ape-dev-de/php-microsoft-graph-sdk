...
/**
 * Collection response for InsightValueDouble
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InsightValueDoubleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var InsightValueDouble[]
     */
    private array $value = [];
     ...
     * 
     * @param InsightValueDouble[] $items
     * @return self
     */
    public function setValue(array|InsightValueDouble $items, InsightValueDouble ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InsightValueDouble> $value
     * @return self
     ...
     * 
     * @param InsightValueDouble $item
     * @return self
     */
    public function addValue(InsightValueDouble $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return InsightValueDouble|null
     */
     ...
     * 
     * @return \ArrayIterator<int, InsightValueDouble>
     */
