 ...
 */
class InsightValueDoubleCollectionResponse
{
    /**
     ...
     * 
     * @param InsightValueDouble ...$items Variable number of InsightValueDouble items
     * @return self
     */
    public function setValue(InsightValueDouble ...$items): self
    {
        $this->value = $items;
        return $this;
    }
