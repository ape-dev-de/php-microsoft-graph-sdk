...
/**
 * Collection response for SearchHitsContainerCollectionResponse
 */
class SearchHitsContainerCollectionResponseCollectionResponse
{
    /**
     * @var SearchHitsContainerCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SearchHitsContainerCollectionResponse ...$items Variable number of SearchHitsContainerCollectionResponse items
     * @return self
     */
    public function setValue(SearchHitsContainerCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SearchHitsContainerCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SearchHitsContainerCollectionResponse $item
     * @return self
     */
    public function addValue(SearchHitsContainerCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
