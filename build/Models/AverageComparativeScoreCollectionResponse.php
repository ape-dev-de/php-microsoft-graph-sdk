...
/**
 * Collection response for AverageComparativeScore
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AverageComparativeScoreCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AverageComparativeScore[] $items
     * @return self
     */
    public function setValue(array|AverageComparativeScore $items, AverageComparativeScore ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AverageComparativeScore> $value
     * @return self
     ...
     * 
     * @param AverageComparativeScore $item
     * @return self
     */
    public function addValue(AverageComparativeScore $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AverageComparativeScore|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AverageComparativeScore>
     */
