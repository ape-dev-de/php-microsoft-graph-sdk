...
/**
 * Collection response for SecurityBlobEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityBlobEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityBlobEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityBlobEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityBlobEvidence $items, SecurityBlobEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityBlobEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityBlobEvidence $item
     * @return self
     */
    public function addValue(SecurityBlobEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityBlobEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityBlobEvidence>
     */
