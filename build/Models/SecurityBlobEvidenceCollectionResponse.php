 ...
 */
class SecurityBlobEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityBlobEvidence ...$items Variable number of SecurityBlobEvidence items
     * @return self
     */
    public function setValue(SecurityBlobEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
