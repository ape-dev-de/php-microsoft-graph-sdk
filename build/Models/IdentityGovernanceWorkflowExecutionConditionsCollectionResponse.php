...
/**
 * Collection response for IdentityGovernanceWorkflowExecutionConditions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceWorkflowExecutionConditionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceWorkflowExecutionConditions[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceWorkflowExecutionConditions[]
     */
     ...
     * 
     * @param IdentityGovernanceWorkflowExecutionConditions[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceWorkflowExecutionConditions $items, IdentityGovernanceWorkflowExecutionConditions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceWorkflowExecutionConditions> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceWorkflowExecutionConditions $item
     * @return self
     */
    public function addValue(IdentityGovernanceWorkflowExecutionConditions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceWorkflowExecutionConditions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceWorkflowExecutionConditions>
     */
