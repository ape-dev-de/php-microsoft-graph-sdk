...
/**
 * IdentityGovernanceWorkflowExecutionConditionsCollectionResponse - Collection response
 */
class IdentityGovernanceWorkflowExecutionConditionsCollectionResponse
{
    /**
     * @var array<int, IdentityGovernanceWorkflowExecutionConditions>
     */
    public array $value = [];
