...
/**
 * SynchronizationScheduleStateCollectionResponse - Collection response
 */
class SynchronizationScheduleStateCollectionResponse
{
    /**
     * @var array<int, SynchronizationScheduleState>
     */
    public array $value = [];
