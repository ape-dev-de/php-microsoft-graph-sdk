...
/**
 * Collection response for SynchronizationScheduleState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationScheduleStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return SynchronizationScheduleState[]
     */
     ...
     * 
     * @param SynchronizationScheduleState[] $items
     * @return self
     */
    public function setValue(array|SynchronizationScheduleState $items, SynchronizationScheduleState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SynchronizationScheduleState> $value
     * @return self
     ...
     * 
     * @param SynchronizationScheduleState $item
     * @return self
     */
    public function addValue(SynchronizationScheduleState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SynchronizationScheduleState>
     */
