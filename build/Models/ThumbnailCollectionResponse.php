...
/**
 * Collection response for Thumbnail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ThumbnailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Thumbnail[]
     */
     ...
     * 
     * @param Thumbnail[] $items
     * @return self
     */
    public function setValue(array|Thumbnail $items, Thumbnail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Thumbnail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Thumbnail>
     */
