...
/**
 * Collection response for WebPartCollectionResponse
 */
class WebPartCollectionResponseCollectionResponse
{
    /**
     * @var WebPartCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WebPartCollectionResponse ...$items Variable number of WebPartCollectionResponse items
     * @return self
     */
    public function setValue(WebPartCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WebPartCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WebPartCollectionResponse $item
     * @return self
     */
    public function addValue(WebPartCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
