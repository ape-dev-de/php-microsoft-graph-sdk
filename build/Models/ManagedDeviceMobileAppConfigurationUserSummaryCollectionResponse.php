 ...
 */
class ManagedDeviceMobileAppConfigurationUserSummaryCollectionResponse
{
    /**
     ...
     * 
     * @param ManagedDeviceMobileAppConfigurationUserSummary ...$items Variable number of ManagedDeviceMobileAppConfigurationUserSummary items
     * @return self
     */
    public function setValue(ManagedDeviceMobileAppConfigurationUserSummary ...$items): self
    {
        $this->value = $items;
        return $this;
    }
