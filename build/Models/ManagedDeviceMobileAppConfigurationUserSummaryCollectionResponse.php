...
/**
 * Collection response for ManagedDeviceMobileAppConfigurationUserSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedDeviceMobileAppConfigurationUserSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ManagedDeviceMobileAppConfigurationUserSummary[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedDeviceMobileAppConfigurationUserSummary[] $items
     * @return self
     */
    public function setValue(array|ManagedDeviceMobileAppConfigurationUserSummary $items, ManagedDeviceMobileAppConfigurationUserSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedDeviceMobileAppConfigurationUserSummary> $value
     * @return self
     ...
     * 
     * @param ManagedDeviceMobileAppConfigurationUserSummary $item
     * @return self
     */
    public function addValue(ManagedDeviceMobileAppConfigurationUserSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedDeviceMobileAppConfigurationUserSummary>
     */
