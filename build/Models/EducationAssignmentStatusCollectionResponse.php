...
/**
 * Collection response for EducationAssignmentStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationAssignmentStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationAssignmentStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return EducationAssignmentStatus[]
     */
     ...
     * 
     * @param EducationAssignmentStatus[] $items
     * @return self
     */
    public function setValue(array|EducationAssignmentStatus $items, EducationAssignmentStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationAssignmentStatus> $value
     * @return self
     ...
     * 
     * @param EducationAssignmentStatus $item
     * @return self
     */
    public function addValue(EducationAssignmentStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationAssignmentStatus>
     */
