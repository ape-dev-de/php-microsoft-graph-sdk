...
/**
 * EducationAssignmentStatusCollectionResponse - Collection response
 */
class EducationAssignmentStatusCollectionResponse
{
    /**
     * @var array<int, EducationAssignmentStatus>
     */
    public array $value = [];
