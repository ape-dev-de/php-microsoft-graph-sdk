...
/**
 * Collection response for Win32LobAppRestartBehavior
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Win32LobAppRestartBehaviorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Win32LobAppRestartBehavior[]
     */
    private array $value = [];
     ...
     * 
     * @return Win32LobAppRestartBehavior[]
     */
     ...
     * 
     * @param Win32LobAppRestartBehavior[] $items
     * @return self
     */
    public function setValue(array|Win32LobAppRestartBehavior $items, Win32LobAppRestartBehavior ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Win32LobAppRestartBehavior> $value
     * @return self
     ...
     * 
     * @param Win32LobAppRestartBehavior $item
     * @return self
     */
    public function addValue(Win32LobAppRestartBehavior $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Win32LobAppRestartBehavior>
     */
