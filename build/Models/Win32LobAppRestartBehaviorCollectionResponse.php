...
/**
 * Win32LobAppRestartBehaviorCollectionResponse - Collection response
 */
class Win32LobAppRestartBehaviorCollectionResponse
{
    /**
     * @var array<int, Win32LobAppRestartBehavior>
     */
    public array $value = [];
