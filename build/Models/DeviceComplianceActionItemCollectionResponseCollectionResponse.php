...
/**
 * Collection response for DeviceComplianceActionItemCollectionResponse
 */
class DeviceComplianceActionItemCollectionResponseCollectionResponse
{
    /**
     * @var DeviceComplianceActionItemCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceComplianceActionItemCollectionResponse ...$items Variable number of DeviceComplianceActionItemCollectionResponse items
     * @return self
     */
    public function setValue(DeviceComplianceActionItemCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeviceComplianceActionItemCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeviceComplianceActionItemCollectionResponse $item
     * @return self
     */
    public function addValue(DeviceComplianceActionItemCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
