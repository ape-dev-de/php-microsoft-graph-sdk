...
/**
 * MailDestinationRoutingReasonCollectionResponse - Collection response
 */
class MailDestinationRoutingReasonCollectionResponse
{
    /**
     * @var array<int, MailDestinationRoutingReason>
     */
    public array $value = [];
