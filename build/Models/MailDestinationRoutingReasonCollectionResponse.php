...
/**
 * Collection response for MailDestinationRoutingReason
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MailDestinationRoutingReasonCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MailDestinationRoutingReason[] $items
     * @return self
     */
    public function setValue(array|MailDestinationRoutingReason $items, MailDestinationRoutingReason ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MailDestinationRoutingReason> $value
     * @return self
     ...
     * 
     * @param MailDestinationRoutingReason $item
     * @return self
     */
    public function addValue(MailDestinationRoutingReason $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MailDestinationRoutingReason>
     */
