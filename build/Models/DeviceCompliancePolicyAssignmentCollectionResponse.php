...
/**
 * Collection response for DeviceCompliancePolicyAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceCompliancePolicyAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceCompliancePolicyAssignment[] $items
     * @return self
     */
    public function setValue(array|DeviceCompliancePolicyAssignment $items, DeviceCompliancePolicyAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceCompliancePolicyAssignment> $value
     * @return self
     ...
     * 
     * @param DeviceCompliancePolicyAssignment $item
     * @return self
     */
    public function addValue(DeviceCompliancePolicyAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceCompliancePolicyAssignment>
     */
