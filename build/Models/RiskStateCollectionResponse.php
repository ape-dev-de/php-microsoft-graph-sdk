...
/**
 * Collection response for RiskState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RiskStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RiskState[]
     */
     ...
     * 
     * @param RiskState[] $items
     * @return self
     */
    public function setValue(array|RiskState $items, RiskState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param RiskState $item
     * @return self
     */
    public function addValue(RiskState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RiskState>
     */
