 ...
 */
class AuthenticationMethodsRegistrationCampaignCollectionResponse
{
    /**
     ...
     * 
     * @param AuthenticationMethodsRegistrationCampaign ...$items Variable number of AuthenticationMethodsRegistrationCampaign items
     * @return self
     */
    public function setValue(AuthenticationMethodsRegistrationCampaign ...$items): self
    {
        $this->value = $items;
        return $this;
    }
