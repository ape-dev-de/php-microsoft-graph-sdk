...
/**
 * Collection response for AuthenticationMethodsRegistrationCampaign
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationMethodsRegistrationCampaignCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuthenticationMethodsRegistrationCampaign[]
     */
    private array $value = [];
     ...
     * 
     * @param AuthenticationMethodsRegistrationCampaign[] $items
     * @return self
     */
    public function setValue(array|AuthenticationMethodsRegistrationCampaign $items, AuthenticationMethodsRegistrationCampaign ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationMethodsRegistrationCampaign> $value
     * @return self
     ...
     * 
     * @param AuthenticationMethodsRegistrationCampaign $item
     * @return self
     */
    public function addValue(AuthenticationMethodsRegistrationCampaign $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationMethodsRegistrationCampaign>
     */
