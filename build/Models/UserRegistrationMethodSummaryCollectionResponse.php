 ...
 */
class UserRegistrationMethodSummaryCollectionResponse
{
    /**
     ...
     * 
     * @param UserRegistrationMethodSummary ...$items Variable number of UserRegistrationMethodSummary items
     * @return self
     */
    public function setValue(UserRegistrationMethodSummary ...$items): self
    {
        $this->value = $items;
        return $this;
    }
