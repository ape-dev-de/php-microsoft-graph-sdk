...
/**
 * Collection response for UserRegistrationMethodSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserRegistrationMethodSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserRegistrationMethodSummary[]
     */
    private array $value = [];
     ...
     * 
     * @param UserRegistrationMethodSummary[] $items
     * @return self
     */
    public function setValue(array|UserRegistrationMethodSummary $items, UserRegistrationMethodSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserRegistrationMethodSummary> $value
     * @return self
     ...
     * 
     * @param UserRegistrationMethodSummary $item
     * @return self
     */
    public function addValue(UserRegistrationMethodSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserRegistrationMethodSummary>
     */
