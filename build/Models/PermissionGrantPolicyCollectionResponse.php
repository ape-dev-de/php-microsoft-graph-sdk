...
/**
 * Collection response for PermissionGrantPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PermissionGrantPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PermissionGrantPolicy[] $items
     * @return self
     */
    public function setValue(array|PermissionGrantPolicy $items, PermissionGrantPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PermissionGrantPolicy> $value
     * @return self
     ...
     * 
     * @param PermissionGrantPolicy $item
     * @return self
     */
    public function addValue(PermissionGrantPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PermissionGrantPolicy>
     */
