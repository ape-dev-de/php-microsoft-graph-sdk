...
/**
 * Collection response for DelegatedAdminRelationshipStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DelegatedAdminRelationshipStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DelegatedAdminRelationshipStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return DelegatedAdminRelationshipStatus[]
     */
     ...
     * 
     * @param DelegatedAdminRelationshipStatus[] $items
     * @return self
     */
    public function setValue(array|DelegatedAdminRelationshipStatus $items, DelegatedAdminRelationshipStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DelegatedAdminRelationshipStatus> $value
     * @return self
     ...
     * 
     * @param DelegatedAdminRelationshipStatus $item
     * @return self
     */
    public function addValue(DelegatedAdminRelationshipStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DelegatedAdminRelationshipStatus>
     */
