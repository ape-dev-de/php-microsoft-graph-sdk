...
/**
 * DelegatedAdminRelationshipStatusCollectionResponse - Collection response
 */
class DelegatedAdminRelationshipStatusCollectionResponse
{
    /**
     * @var array<int, DelegatedAdminRelationshipStatus>
     */
    public array $value = [];
