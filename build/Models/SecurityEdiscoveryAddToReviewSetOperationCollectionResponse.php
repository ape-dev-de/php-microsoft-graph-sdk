...
/**
 * Collection response for SecurityEdiscoveryAddToReviewSetOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityEdiscoveryAddToReviewSetOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityEdiscoveryAddToReviewSetOperation[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityEdiscoveryAddToReviewSetOperation[] $items
     * @return self
     */
    public function setValue(array|SecurityEdiscoveryAddToReviewSetOperation $items, SecurityEdiscoveryAddToReviewSetOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityEdiscoveryAddToReviewSetOperation> $value
     * @return self
     ...
     * 
     * @param SecurityEdiscoveryAddToReviewSetOperation $item
     * @return self
     */
    public function addValue(SecurityEdiscoveryAddToReviewSetOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityEdiscoveryAddToReviewSetOperation>
     */
