...
/**
 * SecurityEdiscoveryAddToReviewSetOperationCollectionResponse - Collection response
 */
class SecurityEdiscoveryAddToReviewSetOperationCollectionResponse
{
    /**
     * @var array<int, SecurityEdiscoveryAddToReviewSetOperation>
     */
    public array $value = [];
