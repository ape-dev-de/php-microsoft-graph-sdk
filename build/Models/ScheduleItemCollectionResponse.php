...
/**
 * Collection response for ScheduleItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ScheduleItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ScheduleItem[]
     */
     ...
     * @return self
     */
    public function setValue(array|ScheduleItem $items, ScheduleItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ScheduleItem> $value
     * @return self
     ...
     * @return self
     */
    public function addValue(ScheduleItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ScheduleItem>
     */
