...
/**
 * Collection response for TaskStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TaskStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TaskStatus[]
     */
     ...
     * 
     * @param TaskStatus[] $items
     * @return self
     */
    public function setValue(array|TaskStatus $items, TaskStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param TaskStatus $item
     * @return self
     */
    public function addValue(TaskStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TaskStatus>
     */
