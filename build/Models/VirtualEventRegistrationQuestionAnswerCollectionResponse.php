...
/**
 * Collection response for VirtualEventRegistrationQuestionAnswer
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualEventRegistrationQuestionAnswerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param VirtualEventRegistrationQuestionAnswer[] $items
     * @return self
     */
    public function setValue(array|VirtualEventRegistrationQuestionAnswer $items, VirtualEventRegistrationQuestionAnswer ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualEventRegistrationQuestionAnswer> $value
     * @return self
     ...
     * 
     * @param VirtualEventRegistrationQuestionAnswer $item
     * @return self
     */
    public function addValue(VirtualEventRegistrationQuestionAnswer $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return VirtualEventRegistrationQuestionAnswer|null
     */
     ...
     * 
     * @return \ArrayIterator<int, VirtualEventRegistrationQuestionAnswer>
     */
