...
/**
 * Collection response for IdentityProviderBaseCollectionResponse
 */
class IdentityProviderBaseCollectionResponseCollectionResponse
{
    /**
     * @var IdentityProviderBaseCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityProviderBaseCollectionResponse ...$items Variable number of IdentityProviderBaseCollectionResponse items
     * @return self
     */
    public function setValue(IdentityProviderBaseCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IdentityProviderBaseCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IdentityProviderBaseCollectionResponse $item
     * @return self
     */
    public function addValue(IdentityProviderBaseCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
