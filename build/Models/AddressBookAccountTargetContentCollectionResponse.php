...
/**
 * Collection response for AddressBookAccountTargetContent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AddressBookAccountTargetContentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AddressBookAccountTargetContent[]
     */
    private array $value = [];
     ...
     * 
     * @param AddressBookAccountTargetContent[] $items
     * @return self
     */
    public function setValue(array|AddressBookAccountTargetContent $items, AddressBookAccountTargetContent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AddressBookAccountTargetContent> $value
     * @return self
     ...
     * 
     * @param AddressBookAccountTargetContent $item
     * @return self
     */
    public function addValue(AddressBookAccountTargetContent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AddressBookAccountTargetContent|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AddressBookAccountTargetContent>
     */
