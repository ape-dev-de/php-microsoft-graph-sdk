 ...
 */
class AddressBookAccountTargetContentCollectionResponse
{
    /**
     ...
     * 
     * @param AddressBookAccountTargetContent ...$items Variable number of AddressBookAccountTargetContent items
     * @return self
     */
    public function setValue(AddressBookAccountTargetContent ...$items): self
    {
        $this->value = $items;
        return $this;
    }
