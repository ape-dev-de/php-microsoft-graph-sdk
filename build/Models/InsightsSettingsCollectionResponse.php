...
/**
 * Collection response for InsightsSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InsightsSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param InsightsSettings[] $items
     * @return self
     */
    public function setValue(array|InsightsSettings $items, InsightsSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InsightsSettings> $value
     * @return self
     ...
     * 
     * @param InsightsSettings $item
     * @return self
     */
    public function addValue(InsightsSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, InsightsSettings>
     */
