 ...
 */
class InsightsSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param InsightsSettings ...$items Variable number of InsightsSettings items
     * @return self
     */
    public function setValue(InsightsSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
