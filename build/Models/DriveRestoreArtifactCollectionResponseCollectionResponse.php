...
/**
 * Collection response for DriveRestoreArtifactCollectionResponse
 */
class DriveRestoreArtifactCollectionResponseCollectionResponse
{
    /**
     * @var DriveRestoreArtifactCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DriveRestoreArtifactCollectionResponse ...$items Variable number of DriveRestoreArtifactCollectionResponse items
     * @return self
     */
    public function setValue(DriveRestoreArtifactCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DriveRestoreArtifactCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DriveRestoreArtifactCollectionResponse $item
     * @return self
     */
    public function addValue(DriveRestoreArtifactCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
