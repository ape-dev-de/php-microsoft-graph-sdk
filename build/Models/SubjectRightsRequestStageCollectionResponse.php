...
/**
 * Collection response for SubjectRightsRequestStage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SubjectRightsRequestStageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SubjectRightsRequestStage[]
     */
    private array $value = [];
     ...
     * 
     * @return SubjectRightsRequestStage[]
     */
     ...
     * 
     * @param SubjectRightsRequestStage[] $items
     * @return self
     */
    public function setValue(array|SubjectRightsRequestStage $items, SubjectRightsRequestStage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SubjectRightsRequestStage> $value
     * @return self
     ...
     * 
     * @param SubjectRightsRequestStage $item
     * @return self
     */
    public function addValue(SubjectRightsRequestStage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SubjectRightsRequestStage>
     */
