...
/**
 * SubjectRightsRequestStageCollectionResponse - Collection response
 */
class SubjectRightsRequestStageCollectionResponse
{
    /**
     * @var array<int, SubjectRightsRequestStage>
     */
    public array $value = [];
