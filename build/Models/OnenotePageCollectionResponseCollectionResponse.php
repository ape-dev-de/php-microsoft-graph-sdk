...
/**
 * Collection response for OnenotePageCollectionResponse
 */
class OnenotePageCollectionResponseCollectionResponse
{
    /**
     * @var OnenotePageCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param OnenotePageCollectionResponse ...$items Variable number of OnenotePageCollectionResponse items
     * @return self
     */
    public function setValue(OnenotePageCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<OnenotePageCollectionResponse> $value
     * @return self
     ...
     * 
     * @param OnenotePageCollectionResponse $item
     * @return self
     */
    public function addValue(OnenotePageCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
