...
/**
 * Collection response for DriveProtectionUnitCollectionResponse
 */
class DriveProtectionUnitCollectionResponseCollectionResponse
{
    /**
     * @var DriveProtectionUnitCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DriveProtectionUnitCollectionResponse ...$items Variable number of DriveProtectionUnitCollectionResponse items
     * @return self
     */
    public function setValue(DriveProtectionUnitCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DriveProtectionUnitCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DriveProtectionUnitCollectionResponse $item
     * @return self
     */
    public function addValue(DriveProtectionUnitCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
