 ...
 */
class DeleteUserFromSharedAppleDeviceActionResultCollectionResponse
{
    /**
     ...
     * 
     * @param DeleteUserFromSharedAppleDeviceActionResult ...$items Variable number of DeleteUserFromSharedAppleDeviceActionResult items
     * @return self
     */
    public function setValue(DeleteUserFromSharedAppleDeviceActionResult ...$items): self
    {
        $this->value = $items;
        return $this;
    }
