...
/**
 * Collection response for DeleteUserFromSharedAppleDeviceActionResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeleteUserFromSharedAppleDeviceActionResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeleteUserFromSharedAppleDeviceActionResult[]
     */
    private array $value = [];
     ...
     * 
     * @param DeleteUserFromSharedAppleDeviceActionResult[] $items
     * @return self
     */
    public function setValue(array|DeleteUserFromSharedAppleDeviceActionResult $items, DeleteUserFromSharedAppleDeviceActionResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeleteUserFromSharedAppleDeviceActionResult> $value
     * @return self
     ...
     * 
     * @param DeleteUserFromSharedAppleDeviceActionResult $item
     * @return self
     */
    public function addValue(DeleteUserFromSharedAppleDeviceActionResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return DeleteUserFromSharedAppleDeviceActionResult|null
     */
     ...
     * 
     * @return \ArrayIterator<int, DeleteUserFromSharedAppleDeviceActionResult>
     */
