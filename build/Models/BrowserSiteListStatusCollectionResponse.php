...
/**
 * Collection response for BrowserSiteListStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BrowserSiteListStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BrowserSiteListStatus[]
     */
    private array $value = [];
     ...
     * 
     * @param BrowserSiteListStatus[] $items
     * @return self
     */
    public function setValue(array|BrowserSiteListStatus $items, BrowserSiteListStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BrowserSiteListStatus> $value
     * @return self
     ...
     * 
     * @param BrowserSiteListStatus $item
     * @return self
     */
    public function addValue(BrowserSiteListStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BrowserSiteListStatus>
     */
