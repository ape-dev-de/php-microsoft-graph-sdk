...
/**
 * Collection response for ConditionalAccessTransferMethods
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessTransferMethodsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessTransferMethods[]
     */
    private array $value = [];
     ...
     * 
     * @return ConditionalAccessTransferMethods[]
     */
     ...
     * 
     * @param ConditionalAccessTransferMethods[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessTransferMethods $items, ConditionalAccessTransferMethods ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessTransferMethods> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessTransferMethods $item
     * @return self
     */
    public function addValue(ConditionalAccessTransferMethods $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessTransferMethods>
     */
