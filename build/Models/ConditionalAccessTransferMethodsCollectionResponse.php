...
/**
 * ConditionalAccessTransferMethodsCollectionResponse - Collection response
 */
class ConditionalAccessTransferMethodsCollectionResponse
{
    /**
     * @var array<int, ConditionalAccessTransferMethods>
     */
    public array $value = [];
