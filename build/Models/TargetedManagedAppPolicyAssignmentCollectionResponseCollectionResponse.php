...
/**
 * Collection response for TargetedManagedAppPolicyAssignmentCollectionResponse
 */
class TargetedManagedAppPolicyAssignmentCollectionResponseCollectionResponse
{
    /**
     * @var TargetedManagedAppPolicyAssignmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TargetedManagedAppPolicyAssignmentCollectionResponse ...$items Variable number of TargetedManagedAppPolicyAssignmentCollectionResponse items
     * @return self
     */
    public function setValue(TargetedManagedAppPolicyAssignmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TargetedManagedAppPolicyAssignmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TargetedManagedAppPolicyAssignmentCollectionResponse $item
     * @return self
     */
    public function addValue(TargetedManagedAppPolicyAssignmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
