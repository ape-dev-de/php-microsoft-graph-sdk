...
/**
 * Collection response for IdentityGovernanceLifecycleTaskCategory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceLifecycleTaskCategoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceLifecycleTaskCategory[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceLifecycleTaskCategory[]
     */
     ...
     * 
     * @param IdentityGovernanceLifecycleTaskCategory[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceLifecycleTaskCategory $items, IdentityGovernanceLifecycleTaskCategory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceLifecycleTaskCategory> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceLifecycleTaskCategory $item
     * @return self
     */
    public function addValue(IdentityGovernanceLifecycleTaskCategory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceLifecycleTaskCategory|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceLifecycleTaskCategory>
     */
