...
/**
 * IdentityGovernanceLifecycleTaskCategoryCollectionResponse - Collection response
 */
class IdentityGovernanceLifecycleTaskCategoryCollectionResponse
{
    /**
     * @var array<int, IdentityGovernanceLifecycleTaskCategory>
     */
    public array $value = [];
