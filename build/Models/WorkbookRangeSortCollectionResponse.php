...
/**
 * Collection response for WorkbookRangeSort
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookRangeSortCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookRangeSort[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookRangeSort[] $items
     * @return self
     */
    public function setValue(array|WorkbookRangeSort $items, WorkbookRangeSort ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookRangeSort> $value
     * @return self
     ...
     * 
     * @param WorkbookRangeSort $item
     * @return self
     */
    public function addValue(WorkbookRangeSort $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookRangeSort>
     */
