 ...
 */
class PublicKeyInfrastructureRootCollectionResponse
{
    /**
     ...
     * 
     * @param PublicKeyInfrastructureRoot ...$items Variable number of PublicKeyInfrastructureRoot items
     * @return self
     */
    public function setValue(PublicKeyInfrastructureRoot ...$items): self
    {
        $this->value = $items;
        return $this;
    }
