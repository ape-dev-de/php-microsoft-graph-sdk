...
/**
 * Collection response for PublicKeyInfrastructureRoot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PublicKeyInfrastructureRootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PublicKeyInfrastructureRoot[]
     */
    private array $value = [];
     ...
     * 
     * @param PublicKeyInfrastructureRoot[] $items
     * @return self
     */
    public function setValue(array|PublicKeyInfrastructureRoot $items, PublicKeyInfrastructureRoot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PublicKeyInfrastructureRoot> $value
     * @return self
     ...
     * 
     * @param PublicKeyInfrastructureRoot $item
     * @return self
     */
    public function addValue(PublicKeyInfrastructureRoot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PublicKeyInfrastructureRoot>
     */
