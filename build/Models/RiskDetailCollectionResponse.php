...
/**
 * Collection response for RiskDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RiskDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RiskDetail[]
     */
     ...
     * 
     * @param RiskDetail[] $items
     * @return self
     */
    public function setValue(array|RiskDetail $items, RiskDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param RiskDetail $item
     * @return self
     */
    public function addValue(RiskDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RiskDetail>
     */
