...
/**
 * Collection response for BroadcastMeetingCaptionSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BroadcastMeetingCaptionSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BroadcastMeetingCaptionSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param BroadcastMeetingCaptionSettings[] $items
     * @return self
     */
    public function setValue(array|BroadcastMeetingCaptionSettings $items, BroadcastMeetingCaptionSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BroadcastMeetingCaptionSettings> $value
     * @return self
     ...
     * 
     * @param BroadcastMeetingCaptionSettings $item
     * @return self
     */
    public function addValue(BroadcastMeetingCaptionSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BroadcastMeetingCaptionSettings>
     */
