 ...
 */
class BroadcastMeetingCaptionSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param BroadcastMeetingCaptionSettings ...$items Variable number of BroadcastMeetingCaptionSettings items
     * @return self
     */
    public function setValue(BroadcastMeetingCaptionSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
