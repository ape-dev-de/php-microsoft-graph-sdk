...
/**
 * Collection response for RegistryHive
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RegistryHiveCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RegistryHive[]
     */
     ...
     * 
     * @param RegistryHive[] $items
     * @return self
     */
    public function setValue(array|RegistryHive $items, RegistryHive ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RegistryHive> $value
     * @return self
     ...
     * 
     * @param RegistryHive $item
     * @return self
     */
    public function addValue(RegistryHive $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RegistryHive>
     */
