 ...
 */
class PublicClientApplicationCollectionResponse
{
    /**
     ...
     * 
     * @param PublicClientApplication ...$items Variable number of PublicClientApplication items
     * @return self
     */
    public function setValue(PublicClientApplication ...$items): self
    {
        $this->value = $items;
        return $this;
    }
