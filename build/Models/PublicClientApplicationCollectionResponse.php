...
/**
 * Collection response for PublicClientApplication
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PublicClientApplicationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PublicClientApplication[] $items
     * @return self
     */
    public function setValue(array|PublicClientApplication $items, PublicClientApplication ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PublicClientApplication> $value
     * @return self
     ...
     * 
     * @param PublicClientApplication $item
     * @return self
     */
    public function addValue(PublicClientApplication $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PublicClientApplication>
     */
