...
/**
 * Collection response for CloudClipboardItemCollectionResponse
 */
class CloudClipboardItemCollectionResponseCollectionResponse
{
    /**
     * @var CloudClipboardItemCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudClipboardItemCollectionResponse ...$items Variable number of CloudClipboardItemCollectionResponse items
     * @return self
     */
    public function setValue(CloudClipboardItemCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CloudClipboardItemCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CloudClipboardItemCollectionResponse $item
     * @return self
     */
    public function addValue(CloudClipboardItemCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
