...
/**
 * Collection response for TeamsAppInstallation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamsAppInstallationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TeamsAppInstallation[] $items
     * @return self
     */
    public function setValue(array|TeamsAppInstallation $items, TeamsAppInstallation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamsAppInstallation> $value
     * @return self
     ...
     * 
     * @param TeamsAppInstallation $item
     * @return self
     */
    public function addValue(TeamsAppInstallation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamsAppInstallation>
     */
