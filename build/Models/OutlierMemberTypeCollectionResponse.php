...
/**
 * Collection response for OutlierMemberType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OutlierMemberTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OutlierMemberType[]
     */
    private array $value = [];
     ...
     * 
     * @param OutlierMemberType[] $items
     * @return self
     */
    public function setValue(array|OutlierMemberType $items, OutlierMemberType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OutlierMemberType> $value
     * @return self
     ...
     * 
     * @param OutlierMemberType $item
     * @return self
     */
    public function addValue(OutlierMemberType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OutlierMemberType>
     */
