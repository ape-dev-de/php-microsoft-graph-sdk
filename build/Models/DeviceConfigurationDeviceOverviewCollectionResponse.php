...
/**
 * Collection response for DeviceConfigurationDeviceOverview
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceConfigurationDeviceOverviewCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceConfigurationDeviceOverview[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceConfigurationDeviceOverview[] $items
     * @return self
     */
    public function setValue(array|DeviceConfigurationDeviceOverview $items, DeviceConfigurationDeviceOverview ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceConfigurationDeviceOverview> $value
     * @return self
     ...
     * 
     * @param DeviceConfigurationDeviceOverview $item
     * @return self
     */
    public function addValue(DeviceConfigurationDeviceOverview $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceConfigurationDeviceOverview>
     */
