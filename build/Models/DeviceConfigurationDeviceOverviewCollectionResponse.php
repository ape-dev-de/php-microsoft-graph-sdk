 ...
 */
class DeviceConfigurationDeviceOverviewCollectionResponse
{
    /**
     ...
     * 
     * @param DeviceConfigurationDeviceOverview ...$items Variable number of DeviceConfigurationDeviceOverview items
     * @return self
     */
    public function setValue(DeviceConfigurationDeviceOverview ...$items): self
    {
        $this->value = $items;
        return $this;
    }
