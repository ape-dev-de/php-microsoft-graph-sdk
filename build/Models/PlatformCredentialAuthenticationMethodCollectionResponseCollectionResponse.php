...
/**
 * Collection response for PlatformCredentialAuthenticationMethodCollectionResponse
 */
class PlatformCredentialAuthenticationMethodCollectionResponseCollectionResponse
{
    /**
     * @var PlatformCredentialAuthenticationMethodCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PlatformCredentialAuthenticationMethodCollectionResponse ...$items Variable number of PlatformCredentialAuthenticationMethodCollectionResponse items
     * @return self
     */
    public function setValue(PlatformCredentialAuthenticationMethodCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PlatformCredentialAuthenticationMethodCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PlatformCredentialAuthenticationMethodCollectionResponse $item
     * @return self
     */
    public function addValue(PlatformCredentialAuthenticationMethodCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
