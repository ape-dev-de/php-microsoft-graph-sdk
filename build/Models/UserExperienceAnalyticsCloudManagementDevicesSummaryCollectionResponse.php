...
/**
 * Collection response for UserExperienceAnalyticsCloudManagementDevicesSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsCloudManagementDevicesSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserExperienceAnalyticsCloudManagementDevicesSummary[]
     */
    private array $value = [];
     ...
     * 
     * @param UserExperienceAnalyticsCloudManagementDevicesSummary[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsCloudManagementDevicesSummary $items, UserExperienceAnalyticsCloudManagementDevicesSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsCloudManagementDevicesSummary> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsCloudManagementDevicesSummary $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsCloudManagementDevicesSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsCloudManagementDevicesSummary>
     */
