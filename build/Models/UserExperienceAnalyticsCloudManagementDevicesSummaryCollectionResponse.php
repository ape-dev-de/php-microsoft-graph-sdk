 ...
 */
class UserExperienceAnalyticsCloudManagementDevicesSummaryCollectionResponse
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsCloudManagementDevicesSummary ...$items Variable number of UserExperienceAnalyticsCloudManagementDevicesSummary items
     * @return self
     */
    public function setValue(UserExperienceAnalyticsCloudManagementDevicesSummary ...$items): self
    {
        $this->value = $items;
        return $this;
    }
