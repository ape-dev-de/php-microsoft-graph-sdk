...
/**
 * UserExperienceAnalyticsCloudManagementDevicesSummaryCollectionResponse - Collection response
 */
class UserExperienceAnalyticsCloudManagementDevicesSummaryCollectionResponse
{
    /**
     * @var array<int, UserExperienceAnalyticsCloudManagementDevicesSummary>
     */
    public array $value = [];
