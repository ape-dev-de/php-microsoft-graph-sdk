...
/**
 * Collection response for EducationAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param EducationAssignment[] $items
     * @return self
     */
    public function setValue(array|EducationAssignment $items, EducationAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationAssignment> $value
     * @return self
     ...
     * 
     * @param EducationAssignment $item
     * @return self
     */
    public function addValue(EducationAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationAssignment>
     */
