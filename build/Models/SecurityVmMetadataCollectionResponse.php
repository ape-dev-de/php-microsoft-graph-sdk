...
/**
 * Collection response for SecurityVmMetadata
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityVmMetadataCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityVmMetadata[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityVmMetadata[] $items
     * @return self
     */
    public function setValue(array|SecurityVmMetadata $items, SecurityVmMetadata ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityVmMetadata> $value
     * @return self
     ...
     * 
     * @param SecurityVmMetadata $item
     * @return self
     */
    public function addValue(SecurityVmMetadata $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityVmMetadata|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityVmMetadata>
     */
