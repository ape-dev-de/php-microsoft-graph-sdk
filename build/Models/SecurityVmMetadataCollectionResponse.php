 ...
 */
class SecurityVmMetadataCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityVmMetadata ...$items Variable number of SecurityVmMetadata items
     * @return self
     */
    public function setValue(SecurityVmMetadata ...$items): self
    {
        $this->value = $items;
        return $this;
    }
