...
/**
 * Collection response for ServiceUpdateMessageViewpoint
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServiceUpdateMessageViewpointCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ServiceUpdateMessageViewpoint[]
     */
    private array $value = [];
     ...
     * 
     * @param ServiceUpdateMessageViewpoint[] $items
     * @return self
     */
    public function setValue(array|ServiceUpdateMessageViewpoint $items, ServiceUpdateMessageViewpoint ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServiceUpdateMessageViewpoint> $value
     * @return self
     ...
     * 
     * @param ServiceUpdateMessageViewpoint $item
     * @return self
     */
    public function addValue(ServiceUpdateMessageViewpoint $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ServiceUpdateMessageViewpoint>
     */
