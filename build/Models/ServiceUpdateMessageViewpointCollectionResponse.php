 ...
 */
class ServiceUpdateMessageViewpointCollectionResponse
{
    /**
     ...
     * 
     * @param ServiceUpdateMessageViewpoint ...$items Variable number of ServiceUpdateMessageViewpoint items
     * @return self
     */
    public function setValue(ServiceUpdateMessageViewpoint ...$items): self
    {
        $this->value = $items;
        return $this;
    }
