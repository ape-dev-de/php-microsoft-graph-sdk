...
/**
 * Collection response for PolicyBinding
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PolicyBindingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PolicyBinding[]
     */
     ...
     * 
     * @param PolicyBinding[] $items
     * @return self
     */
    public function setValue(array|PolicyBinding $items, PolicyBinding ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PolicyBinding> $value
     * @return self
     ...
     * 
     * @param PolicyBinding $item
     * @return self
     */
    public function addValue(PolicyBinding $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PolicyBinding>
     */
