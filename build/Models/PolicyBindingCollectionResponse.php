 ...
 */
class PolicyBindingCollectionResponse
{
    /**
     * @var PolicyBinding[]
     */
     ...
     * 
     * @param PolicyBinding ...$items Variable number of PolicyBinding items
     * @return self
     */
    public function setValue(PolicyBinding ...$items): self
    {
        $this->value = $items;
        return $this;
    }
