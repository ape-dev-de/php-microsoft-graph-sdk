...
/**
 * Collection response for SecurityFilePlanSubcategory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityFilePlanSubcategoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityFilePlanSubcategory[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityFilePlanSubcategory[]
     */
     ...
     * 
     * @param SecurityFilePlanSubcategory[] $items
     * @return self
     */
    public function setValue(array|SecurityFilePlanSubcategory $items, SecurityFilePlanSubcategory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityFilePlanSubcategory> $value
     * @return self
     ...
     * 
     * @param SecurityFilePlanSubcategory $item
     * @return self
     */
    public function addValue(SecurityFilePlanSubcategory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityFilePlanSubcategory|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityFilePlanSubcategory>
     */
