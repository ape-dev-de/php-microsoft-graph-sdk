...
/**
 * SecurityFilePlanSubcategoryCollectionResponse - Collection response
 */
class SecurityFilePlanSubcategoryCollectionResponse
{
    /**
     * @var array<int, SecurityFilePlanSubcategory>
     */
    public array $value = [];
