...
/**
 * PartnersBillingUnbilledUsageCollectionResponse - Collection response
 */
class PartnersBillingUnbilledUsageCollectionResponse
{
    /**
     * @var array<int, PartnersBillingUnbilledUsage>
     */
    public array $value = [];
