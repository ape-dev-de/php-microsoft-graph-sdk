...
/**
 * Collection response for PartnersBillingUnbilledUsage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PartnersBillingUnbilledUsageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PartnersBillingUnbilledUsage[]
     */
    private array $value = [];
     ...
     * 
     * @return PartnersBillingUnbilledUsage[]
     */
     ...
     * 
     * @param PartnersBillingUnbilledUsage[] $items
     * @return self
     */
    public function setValue(array|PartnersBillingUnbilledUsage $items, PartnersBillingUnbilledUsage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PartnersBillingUnbilledUsage> $value
     * @return self
     ...
     * 
     * @param PartnersBillingUnbilledUsage $item
     * @return self
     */
    public function addValue(PartnersBillingUnbilledUsage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PartnersBillingUnbilledUsage>
     */
