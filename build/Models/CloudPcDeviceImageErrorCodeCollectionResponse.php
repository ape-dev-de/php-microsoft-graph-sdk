...
/**
 * Collection response for CloudPcDeviceImageErrorCode
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcDeviceImageErrorCodeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudPcDeviceImageErrorCode[]
     */
    private array $value = [];
     ...
     * 
     * @return CloudPcDeviceImageErrorCode[]
     */
     ...
     * 
     * @param CloudPcDeviceImageErrorCode[] $items
     * @return self
     */
    public function setValue(array|CloudPcDeviceImageErrorCode $items, CloudPcDeviceImageErrorCode ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcDeviceImageErrorCode> $value
     * @return self
     ...
     * 
     * @param CloudPcDeviceImageErrorCode $item
     * @return self
     */
    public function addValue(CloudPcDeviceImageErrorCode $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcDeviceImageErrorCode>
     */
