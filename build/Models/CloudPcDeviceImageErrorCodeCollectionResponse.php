...
/**
 * CloudPcDeviceImageErrorCodeCollectionResponse - Collection response
 */
class CloudPcDeviceImageErrorCodeCollectionResponse
{
    /**
     * @var array<int, CloudPcDeviceImageErrorCode>
     */
    public array $value = [];
