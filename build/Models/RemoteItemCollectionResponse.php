...
/**
 * Collection response for RemoteItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RemoteItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RemoteItem[]
     */
     ...
     * 
     * @param RemoteItem[] $items
     * @return self
     */
    public function setValue(array|RemoteItem $items, RemoteItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param RemoteItem $item
     * @return self
     */
    public function addValue(RemoteItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RemoteItem>
     */
