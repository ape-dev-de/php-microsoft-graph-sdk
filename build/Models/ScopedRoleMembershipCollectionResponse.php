...
/**
 * Collection response for ScopedRoleMembership
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ScopedRoleMembershipCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ScopedRoleMembership[] $items
     * @return self
     */
    public function setValue(array|ScopedRoleMembership $items, ScopedRoleMembership ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ScopedRoleMembership> $value
     * @return self
     ...
     * 
     * @param ScopedRoleMembership $item
     * @return self
     */
    public function addValue(ScopedRoleMembership $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ScopedRoleMembership>
     */
