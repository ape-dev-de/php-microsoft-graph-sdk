...
/**
 * Collection response for DeviceLocalCredentialInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceLocalCredentialInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceLocalCredentialInfo[] $items
     * @return self
     */
    public function setValue(array|DeviceLocalCredentialInfo $items, DeviceLocalCredentialInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceLocalCredentialInfo> $value
     * @return self
     ...
     * 
     * @param DeviceLocalCredentialInfo $item
     * @return self
     */
    public function addValue(DeviceLocalCredentialInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceLocalCredentialInfo>
     */
