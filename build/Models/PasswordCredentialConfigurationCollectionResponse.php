...
/**
 * Collection response for PasswordCredentialConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PasswordCredentialConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PasswordCredentialConfiguration[] $items
     * @return self
     */
    public function setValue(array|PasswordCredentialConfiguration $items, PasswordCredentialConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PasswordCredentialConfiguration> $value
     * @return self
     ...
     * 
     * @param PasswordCredentialConfiguration $item
     * @return self
     */
    public function addValue(PasswordCredentialConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PasswordCredentialConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PasswordCredentialConfiguration>
     */
