...
/**
 * Collection response for RoleAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RoleAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RoleAssignment[]
     */
     ...
     * @return self
     */
    public function setValue(array|RoleAssignment $items, RoleAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RoleAssignment> $value
     * @return self
     ...
     * 
     * @param RoleAssignment $item
     * @return self
     */
    public function addValue(RoleAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RoleAssignment>
     */
