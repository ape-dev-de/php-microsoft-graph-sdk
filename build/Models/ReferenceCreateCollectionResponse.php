...
/**
 * Collection response for ReferenceCreate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ReferenceCreateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ReferenceCreate[]
     */
     ...
     * 
     * @param ReferenceCreate[] $items
     * @return self
     */
    public function setValue(array|ReferenceCreate $items, ReferenceCreate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ReferenceCreate> $value
     * @return self
     ...
     * 
     * @param ReferenceCreate $item
     * @return self
     */
    public function addValue(ReferenceCreate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ReferenceCreate>
     */
