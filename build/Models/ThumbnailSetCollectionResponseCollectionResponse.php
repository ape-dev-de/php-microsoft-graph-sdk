...
/**
 * Collection response for ThumbnailSetCollectionResponse
 */
class ThumbnailSetCollectionResponseCollectionResponse
{
    /**
     * @var ThumbnailSetCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ThumbnailSetCollectionResponse ...$items Variable number of ThumbnailSetCollectionResponse items
     * @return self
     */
    public function setValue(ThumbnailSetCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ThumbnailSetCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ThumbnailSetCollectionResponse $item
     * @return self
     */
    public function addValue(ThumbnailSetCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
