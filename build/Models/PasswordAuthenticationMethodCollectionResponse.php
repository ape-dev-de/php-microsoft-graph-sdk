...
/**
 * Collection response for PasswordAuthenticationMethod
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PasswordAuthenticationMethodCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PasswordAuthenticationMethod[] $items
     * @return self
     */
    public function setValue(array|PasswordAuthenticationMethod $items, PasswordAuthenticationMethod ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PasswordAuthenticationMethod> $value
     * @return self
     ...
     * 
     * @param PasswordAuthenticationMethod $item
     * @return self
     */
    public function addValue(PasswordAuthenticationMethod $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PasswordAuthenticationMethod>
     */
