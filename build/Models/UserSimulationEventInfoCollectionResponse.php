...
/**
 * Collection response for UserSimulationEventInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserSimulationEventInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserSimulationEventInfo[] $items
     * @return self
     */
    public function setValue(array|UserSimulationEventInfo $items, UserSimulationEventInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserSimulationEventInfo> $value
     * @return self
     ...
     * 
     * @param UserSimulationEventInfo $item
     * @return self
     */
    public function addValue(UserSimulationEventInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UserSimulationEventInfo|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UserSimulationEventInfo>
     */
