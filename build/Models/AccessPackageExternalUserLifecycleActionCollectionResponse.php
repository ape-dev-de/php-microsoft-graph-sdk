...
/**
 * Collection response for AccessPackageExternalUserLifecycleAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageExternalUserLifecycleActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageExternalUserLifecycleAction[]
     */
    private array $value = [];
     ...
     * 
     * @return AccessPackageExternalUserLifecycleAction[]
     */
     ...
     * 
     * @param AccessPackageExternalUserLifecycleAction[] $items
     * @return self
     */
    public function setValue(array|AccessPackageExternalUserLifecycleAction $items, AccessPackageExternalUserLifecycleAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageExternalUserLifecycleAction> $value
     * @return self
     ...
     * 
     * @param AccessPackageExternalUserLifecycleAction $item
     * @return self
     */
    public function addValue(AccessPackageExternalUserLifecycleAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageExternalUserLifecycleAction>
     */
