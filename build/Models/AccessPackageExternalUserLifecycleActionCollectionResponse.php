...
/**
 * AccessPackageExternalUserLifecycleActionCollectionResponse - Collection response
 */
class AccessPackageExternalUserLifecycleActionCollectionResponse
{
    /**
     * @var array<int, AccessPackageExternalUserLifecycleAction>
     */
    public array $value = [];
