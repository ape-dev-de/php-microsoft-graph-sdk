 ...
 */
class TenantRelationshipCollectionResponse
{
    /**
     ...
     * 
     * @param TenantRelationship ...$items Variable number of TenantRelationship items
     * @return self
     */
    public function setValue(TenantRelationship ...$items): self
    {
        $this->value = $items;
        return $this;
    }
