...
/**
 * Collection response for TenantRelationship
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TenantRelationshipCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TenantRelationship[]
     */
    private array $value = [];
     ...
     * 
     * @param TenantRelationship[] $items
     * @return self
     */
    public function setValue(array|TenantRelationship $items, TenantRelationship ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TenantRelationship> $value
     * @return self
     ...
     * 
     * @param TenantRelationship $item
     * @return self
     */
    public function addValue(TenantRelationship $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TenantRelationship|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TenantRelationship>
     */
