...
/**
 * Collection response for ExternalConnectorsConnectionOperationCollectionResponse
 */
class ExternalConnectorsConnectionOperationCollectionResponseCollectionResponse
{
    /**
     * @var ExternalConnectorsConnectionOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ExternalConnectorsConnectionOperationCollectionResponse ...$items Variable number of ExternalConnectorsConnectionOperationCollectionResponse items
     * @return self
     */
    public function setValue(ExternalConnectorsConnectionOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ExternalConnectorsConnectionOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsConnectionOperationCollectionResponse $item
     * @return self
     */
    public function addValue(ExternalConnectorsConnectionOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
