...
/**
 * Collection response for ExternalDomainNameCollectionResponse
 */
class ExternalDomainNameCollectionResponseCollectionResponse
{
    /**
     * @var ExternalDomainNameCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ExternalDomainNameCollectionResponse ...$items Variable number of ExternalDomainNameCollectionResponse items
     * @return self
     */
    public function setValue(ExternalDomainNameCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ExternalDomainNameCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ExternalDomainNameCollectionResponse $item
     * @return self
     */
    public function addValue(ExternalDomainNameCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
