...
/**
 * Collection response for SortPropertyCollectionResponse
 */
class SortPropertyCollectionResponseCollectionResponse
{
    /**
     * @var SortPropertyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SortPropertyCollectionResponse ...$items Variable number of SortPropertyCollectionResponse items
     * @return self
     */
    public function setValue(SortPropertyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SortPropertyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SortPropertyCollectionResponse $item
     * @return self
     */
    public function addValue(SortPropertyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
