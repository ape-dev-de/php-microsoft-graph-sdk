...
/**
 * Collection response for CallRecordsMedia
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsMediaCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CallRecordsMedia[] $items
     * @return self
     */
    public function setValue(array|CallRecordsMedia $items, CallRecordsMedia ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsMedia> $value
     * @return self
     ...
     * 
     * @param CallRecordsMedia $item
     * @return self
     */
    public function addValue(CallRecordsMedia $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsMedia>
     */
