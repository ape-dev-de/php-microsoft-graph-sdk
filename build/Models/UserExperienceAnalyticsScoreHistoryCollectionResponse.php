...
/**
 * Collection response for UserExperienceAnalyticsScoreHistory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsScoreHistoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsScoreHistory[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsScoreHistory $items, UserExperienceAnalyticsScoreHistory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsScoreHistory> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsScoreHistory $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsScoreHistory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsScoreHistory>
     */
