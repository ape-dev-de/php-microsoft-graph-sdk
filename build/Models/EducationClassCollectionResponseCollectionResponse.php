...
/**
 * Collection response for EducationClassCollectionResponse
 */
class EducationClassCollectionResponseCollectionResponse
{
    /**
     * @var EducationClassCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationClassCollectionResponse ...$items Variable number of EducationClassCollectionResponse items
     * @return self
     */
    public function setValue(EducationClassCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EducationClassCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EducationClassCollectionResponse $item
     * @return self
     */
    public function addValue(EducationClassCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
