...
/**
 * Collection response for CallRecordsSessionCollectionResponse
 */
class CallRecordsSessionCollectionResponseCollectionResponse
{
    /**
     * @var CallRecordsSessionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CallRecordsSessionCollectionResponse ...$items Variable number of CallRecordsSessionCollectionResponse items
     * @return self
     */
    public function setValue(CallRecordsSessionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CallRecordsSessionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CallRecordsSessionCollectionResponse $item
     * @return self
     */
    public function addValue(CallRecordsSessionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
