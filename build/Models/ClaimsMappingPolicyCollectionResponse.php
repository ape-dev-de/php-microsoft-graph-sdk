...
/**
 * Collection response for ClaimsMappingPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ClaimsMappingPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ClaimsMappingPolicy[] $items
     * @return self
     */
    public function setValue(array|ClaimsMappingPolicy $items, ClaimsMappingPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ClaimsMappingPolicy> $value
     * @return self
     ...
     * 
     * @param ClaimsMappingPolicy $item
     * @return self
     */
    public function addValue(ClaimsMappingPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ClaimsMappingPolicy>
     */
