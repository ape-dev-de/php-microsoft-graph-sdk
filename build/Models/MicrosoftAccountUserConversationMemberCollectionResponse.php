...
/**
 * Collection response for MicrosoftAccountUserConversationMember
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MicrosoftAccountUserConversationMemberCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MicrosoftAccountUserConversationMember[]
     */
    private array $value = [];
     ...
     * 
     * @param MicrosoftAccountUserConversationMember[] $items
     * @return self
     */
    public function setValue(array|MicrosoftAccountUserConversationMember $items, MicrosoftAccountUserConversationMember ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MicrosoftAccountUserConversationMember> $value
     * @return self
     ...
     * 
     * @param MicrosoftAccountUserConversationMember $item
     * @return self
     */
    public function addValue(MicrosoftAccountUserConversationMember $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MicrosoftAccountUserConversationMember|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MicrosoftAccountUserConversationMember>
     */
