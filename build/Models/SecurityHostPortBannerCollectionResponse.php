...
/**
 * Collection response for SecurityHostPortBanner
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHostPortBannerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityHostPortBanner[] $items
     * @return self
     */
    public function setValue(array|SecurityHostPortBanner $items, SecurityHostPortBanner ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHostPortBanner> $value
     * @return self
     ...
     * 
     * @param SecurityHostPortBanner $item
     * @return self
     */
    public function addValue(SecurityHostPortBanner $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityHostPortBanner|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityHostPortBanner>
     */
