...
/**
 * Collection response for AccessReviewNotificationRecipientItemCollectionResponse
 */
class AccessReviewNotificationRecipientItemCollectionResponseCollectionResponse
{
    /**
     * @var AccessReviewNotificationRecipientItemCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessReviewNotificationRecipientItemCollectionResponse ...$items Variable number of AccessReviewNotificationRecipientItemCollectionResponse items
     * @return self
     */
    public function setValue(AccessReviewNotificationRecipientItemCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AccessReviewNotificationRecipientItemCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AccessReviewNotificationRecipientItemCollectionResponse $item
     * @return self
     */
    public function addValue(AccessReviewNotificationRecipientItemCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
