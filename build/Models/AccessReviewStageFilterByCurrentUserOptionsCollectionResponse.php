...
/**
 * AccessReviewStageFilterByCurrentUserOptionsCollectionResponse - Collection response
 */
class AccessReviewStageFilterByCurrentUserOptionsCollectionResponse
{
    /**
     * @var array<int, AccessReviewStageFilterByCurrentUserOptions>
     */
    public array $value = [];
