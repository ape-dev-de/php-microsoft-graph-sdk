...
/**
 * Collection response for AccessReviewStageFilterByCurrentUserOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewStageFilterByCurrentUserOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessReviewStageFilterByCurrentUserOptions[]
     */
    private array $value = [];
     ...
     * 
     * @return AccessReviewStageFilterByCurrentUserOptions[]
     */
     ...
     * 
     * @param AccessReviewStageFilterByCurrentUserOptions[] $items
     * @return self
     */
    public function setValue(array|AccessReviewStageFilterByCurrentUserOptions $items, AccessReviewStageFilterByCurrentUserOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewStageFilterByCurrentUserOptions> $value
     * @return self
     ...
     * 
     * @param AccessReviewStageFilterByCurrentUserOptions $item
     * @return self
     */
    public function addValue(AccessReviewStageFilterByCurrentUserOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessReviewStageFilterByCurrentUserOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewStageFilterByCurrentUserOptions>
     */
