...
/**
 * SecurityEdiscoveryCustodianCollectionResponse - Collection response
 */
class SecurityEdiscoveryCustodianCollectionResponse
{
    /**
     * @var array<int, SecurityEdiscoveryCustodian>
     */
    public array $value = [];
