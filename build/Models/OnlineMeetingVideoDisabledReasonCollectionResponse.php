...
/**
 * OnlineMeetingVideoDisabledReasonCollectionResponse - Collection response
 */
class OnlineMeetingVideoDisabledReasonCollectionResponse
{
    /**
     * @var array<int, OnlineMeetingVideoDisabledReason>
     */
    public array $value = [];
