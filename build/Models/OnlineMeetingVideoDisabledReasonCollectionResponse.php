...
/**
 * Collection response for OnlineMeetingVideoDisabledReason
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnlineMeetingVideoDisabledReasonCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnlineMeetingVideoDisabledReason[]
     */
    private array $value = [];
     ...
     * 
     * @return OnlineMeetingVideoDisabledReason[]
     */
     ...
     * 
     * @param OnlineMeetingVideoDisabledReason[] $items
     * @return self
     */
    public function setValue(array|OnlineMeetingVideoDisabledReason $items, OnlineMeetingVideoDisabledReason ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnlineMeetingVideoDisabledReason> $value
     * @return self
     ...
     * 
     * @param OnlineMeetingVideoDisabledReason $item
     * @return self
     */
    public function addValue(OnlineMeetingVideoDisabledReason $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnlineMeetingVideoDisabledReason>
     */
