...
/**
 * Collection response for TermStoreLocalizedNameCollectionResponse
 */
class TermStoreLocalizedNameCollectionResponseCollectionResponse
{
    /**
     * @var TermStoreLocalizedNameCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return TermStoreLocalizedNameCollectionResponse[]
     */
     ...
     * 
     * @param TermStoreLocalizedNameCollectionResponse ...$items Variable number of TermStoreLocalizedNameCollectionResponse items
     * @return self
     */
    public function setValue(TermStoreLocalizedNameCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TermStoreLocalizedNameCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TermStoreLocalizedNameCollectionResponse $item
     * @return self
     */
    public function addValue(TermStoreLocalizedNameCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
