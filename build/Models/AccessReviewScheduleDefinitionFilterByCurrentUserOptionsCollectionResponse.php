...
/**
 * AccessReviewScheduleDefinitionFilterByCurrentUserOptionsCollectionResponse - Collection response
 */
class AccessReviewScheduleDefinitionFilterByCurrentUserOptionsCollectionResponse
{
    /**
     * @var array<int, AccessReviewScheduleDefinitionFilterByCurrentUserOptions>
     */
    public array $value = [];
