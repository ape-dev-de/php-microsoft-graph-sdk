...
/**
 * Collection response for AccessReviewScheduleDefinitionFilterByCurrentUserOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewScheduleDefinitionFilterByCurrentUserOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessReviewScheduleDefinitionFilterByCurrentUserOptions[]
     */
    private array $value = [];
     ...
     * 
     * @return AccessReviewScheduleDefinitionFilterByCurrentUserOptions[]
     */
     ...
     * 
     * @param AccessReviewScheduleDefinitionFilterByCurrentUserOptions[] $items
     * @return self
     */
    public function setValue(array|AccessReviewScheduleDefinitionFilterByCurrentUserOptions $items, AccessReviewScheduleDefinitionFilterByCurrentUserOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewScheduleDefinitionFilterByCurrentUserOptions> $value
     * @return self
     ...
     * 
     * @param AccessReviewScheduleDefinitionFilterByCurrentUserOptions $item
     * @return self
     */
    public function addValue(AccessReviewScheduleDefinitionFilterByCurrentUserOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessReviewScheduleDefinitionFilterByCurrentUserOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewScheduleDefinitionFilterByCurrentUserOptions>
     */
