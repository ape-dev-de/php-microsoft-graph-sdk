...
/**
 * Collection response for AppListItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppListItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AppListItem[]
     */
     ...
     * 
     * @param AppListItem[] $items
     * @return self
     */
    public function setValue(array|AppListItem $items, AppListItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param AppListItem $item
     * @return self
     */
    public function addValue(AppListItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AppListItem>
     */
