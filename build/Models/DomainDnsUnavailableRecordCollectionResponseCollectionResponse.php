...
/**
 * Collection response for DomainDnsUnavailableRecordCollectionResponse
 */
class DomainDnsUnavailableRecordCollectionResponseCollectionResponse
{
    /**
     * @var DomainDnsUnavailableRecordCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DomainDnsUnavailableRecordCollectionResponse ...$items Variable number of DomainDnsUnavailableRecordCollectionResponse items
     * @return self
     */
    public function setValue(DomainDnsUnavailableRecordCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DomainDnsUnavailableRecordCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DomainDnsUnavailableRecordCollectionResponse $item
     * @return self
     */
    public function addValue(DomainDnsUnavailableRecordCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
