...
/**
 * Collection response for Invitation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InvitationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Invitation[]
     */
     ...
     * 
     * @param Invitation[] $items
     * @return self
     */
    public function setValue(array|Invitation $items, Invitation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Invitation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Invitation>
     */
