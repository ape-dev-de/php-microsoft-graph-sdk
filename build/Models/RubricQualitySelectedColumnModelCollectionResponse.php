...
/**
 * Collection response for RubricQualitySelectedColumnModel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RubricQualitySelectedColumnModelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param RubricQualitySelectedColumnModel[] $items
     * @return self
     */
    public function setValue(array|RubricQualitySelectedColumnModel $items, RubricQualitySelectedColumnModel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RubricQualitySelectedColumnModel> $value
     * @return self
     ...
     * 
     * @param RubricQualitySelectedColumnModel $item
     * @return self
     */
    public function addValue(RubricQualitySelectedColumnModel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return RubricQualitySelectedColumnModel|null
     */
     ...
     * 
     * @return \ArrayIterator<int, RubricQualitySelectedColumnModel>
     */
