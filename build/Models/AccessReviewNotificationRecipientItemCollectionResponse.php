...
/**
 * Collection response for AccessReviewNotificationRecipientItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewNotificationRecipientItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessReviewNotificationRecipientItem[] $items
     * @return self
     */
    public function setValue(array|AccessReviewNotificationRecipientItem $items, AccessReviewNotificationRecipientItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewNotificationRecipientItem> $value
     * @return self
     ...
     * 
     * @param AccessReviewNotificationRecipientItem $item
     * @return self
     */
    public function addValue(AccessReviewNotificationRecipientItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessReviewNotificationRecipientItem|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewNotificationRecipientItem>
     */
