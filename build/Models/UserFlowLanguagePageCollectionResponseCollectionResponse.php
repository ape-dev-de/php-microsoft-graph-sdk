...
/**
 * Collection response for UserFlowLanguagePageCollectionResponse
 */
class UserFlowLanguagePageCollectionResponseCollectionResponse
{
    /**
     * @var UserFlowLanguagePageCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UserFlowLanguagePageCollectionResponse ...$items Variable number of UserFlowLanguagePageCollectionResponse items
     * @return self
     */
    public function setValue(UserFlowLanguagePageCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UserFlowLanguagePageCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UserFlowLanguagePageCollectionResponse $item
     * @return self
     */
    public function addValue(UserFlowLanguagePageCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
