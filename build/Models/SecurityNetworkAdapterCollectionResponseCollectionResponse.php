...
/**
 * Collection response for SecurityNetworkAdapterCollectionResponse
 */
class SecurityNetworkAdapterCollectionResponseCollectionResponse
{
    /**
     * @var SecurityNetworkAdapterCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityNetworkAdapterCollectionResponse[]
     */
     ...
     * 
     * @param SecurityNetworkAdapterCollectionResponse ...$items Variable number of SecurityNetworkAdapterCollectionResponse items
     * @return self
     */
    public function setValue(SecurityNetworkAdapterCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityNetworkAdapterCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityNetworkAdapterCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityNetworkAdapterCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
