...
/**
 * Collection response for ChecklistItemCollectionResponse
 */
class ChecklistItemCollectionResponseCollectionResponse
{
    /**
     * @var ChecklistItemCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ChecklistItemCollectionResponse ...$items Variable number of ChecklistItemCollectionResponse items
     * @return self
     */
    public function setValue(ChecklistItemCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ChecklistItemCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ChecklistItemCollectionResponse $item
     * @return self
     */
    public function addValue(ChecklistItemCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
