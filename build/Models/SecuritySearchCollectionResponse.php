...
/**
 * Collection response for SecuritySearch
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecuritySearchCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecuritySearch[]
     */
     ...
     * 
     * @param SecuritySearch[] $items
     * @return self
     */
    public function setValue(array|SecuritySearch $items, SecuritySearch ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecuritySearch> $value
     * @return self
     ...
     * 
     * @param SecuritySearch $item
     * @return self
     */
    public function addValue(SecuritySearch $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecuritySearch>
     */
