 ...
 */
class SecuritySearchCollectionResponse
{
    /**
     * @var SecuritySearch[]
     */
     ...
     * 
     * @param SecuritySearch ...$items Variable number of SecuritySearch items
     * @return self
     */
    public function setValue(SecuritySearch ...$items): self
    {
        $this->value = $items;
        return $this;
    }
