...
/**
 * Collection response for DeviceCompliancePolicyDeviceStateSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceCompliancePolicyDeviceStateSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceCompliancePolicyDeviceStateSummary[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceCompliancePolicyDeviceStateSummary[] $items
     * @return self
     */
    public function setValue(array|DeviceCompliancePolicyDeviceStateSummary $items, DeviceCompliancePolicyDeviceStateSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceCompliancePolicyDeviceStateSummary> $value
     * @return self
     ...
     * 
     * @param DeviceCompliancePolicyDeviceStateSummary $item
     * @return self
     */
    public function addValue(DeviceCompliancePolicyDeviceStateSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceCompliancePolicyDeviceStateSummary>
     */
