 ...
 */
class DeviceCompliancePolicyDeviceStateSummaryCollectionResponse
{
    /**
     ...
     * 
     * @param DeviceCompliancePolicyDeviceStateSummary ...$items Variable number of DeviceCompliancePolicyDeviceStateSummary items
     * @return self
     */
    public function setValue(DeviceCompliancePolicyDeviceStateSummary ...$items): self
    {
        $this->value = $items;
        return $this;
    }
