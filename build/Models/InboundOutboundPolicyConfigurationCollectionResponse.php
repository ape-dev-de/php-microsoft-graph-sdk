 ...
 */
class InboundOutboundPolicyConfigurationCollectionResponse
{
    /**
     ...
     * 
     * @param InboundOutboundPolicyConfiguration ...$items Variable number of InboundOutboundPolicyConfiguration items
     * @return self
     */
    public function setValue(InboundOutboundPolicyConfiguration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
