...
/**
 * Collection response for InboundOutboundPolicyConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InboundOutboundPolicyConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var InboundOutboundPolicyConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param InboundOutboundPolicyConfiguration[] $items
     * @return self
     */
    public function setValue(array|InboundOutboundPolicyConfiguration $items, InboundOutboundPolicyConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InboundOutboundPolicyConfiguration> $value
     * @return self
     ...
     * 
     * @param InboundOutboundPolicyConfiguration $item
     * @return self
     */
    public function addValue(InboundOutboundPolicyConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, InboundOutboundPolicyConfiguration>
     */
