...
/**
 * Collection response for FeatureRolloutPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FeatureRolloutPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param FeatureRolloutPolicy[] $items
     * @return self
     */
    public function setValue(array|FeatureRolloutPolicy $items, FeatureRolloutPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FeatureRolloutPolicy> $value
     * @return self
     ...
     * 
     * @param FeatureRolloutPolicy $item
     * @return self
     */
    public function addValue(FeatureRolloutPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FeatureRolloutPolicy>
     */
