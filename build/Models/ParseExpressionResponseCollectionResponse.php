...
/**
 * Collection response for ParseExpressionResponse
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ParseExpressionResponseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ParseExpressionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ParseExpressionResponse[] $items
     * @return self
     */
    public function setValue(array|ParseExpressionResponse $items, ParseExpressionResponse ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ParseExpressionResponse> $value
     * @return self
     ...
     * 
     * @param ParseExpressionResponse $item
     * @return self
     */
    public function addValue(ParseExpressionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ParseExpressionResponse|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ParseExpressionResponse>
     */
