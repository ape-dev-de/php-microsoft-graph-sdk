 ...
 */
class ParseExpressionResponseCollectionResponse
{
    /**
     ...
     * 
     * @param ParseExpressionResponse ...$items Variable number of ParseExpressionResponse items
     * @return self
     */
    public function setValue(ParseExpressionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
