 ...
 */
class AccessPackageAnswerStringCollectionResponse
{
    /**
     ...
     * 
     * @param AccessPackageAnswerString ...$items Variable number of AccessPackageAnswerString items
     * @return self
     */
    public function setValue(AccessPackageAnswerString ...$items): self
    {
        $this->value = $items;
        return $this;
    }
