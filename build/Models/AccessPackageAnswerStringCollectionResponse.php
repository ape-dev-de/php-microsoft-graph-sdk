...
/**
 * Collection response for AccessPackageAnswerString
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageAnswerStringCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageAnswerString[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageAnswerString[] $items
     * @return self
     */
    public function setValue(array|AccessPackageAnswerString $items, AccessPackageAnswerString ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageAnswerString> $value
     * @return self
     ...
     * 
     * @param AccessPackageAnswerString $item
     * @return self
     */
    public function addValue(AccessPackageAnswerString $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessPackageAnswerString|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageAnswerString>
     */
