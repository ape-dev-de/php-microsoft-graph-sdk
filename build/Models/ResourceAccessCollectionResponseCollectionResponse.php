...
/**
 * Collection response for ResourceAccessCollectionResponse
 */
class ResourceAccessCollectionResponseCollectionResponse
{
    /**
     * @var ResourceAccessCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ResourceAccessCollectionResponse ...$items Variable number of ResourceAccessCollectionResponse items
     * @return self
     */
    public function setValue(ResourceAccessCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ResourceAccessCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ResourceAccessCollectionResponse $item
     * @return self
     */
    public function addValue(ResourceAccessCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
