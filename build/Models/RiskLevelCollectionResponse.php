...
/**
 * Collection response for RiskLevel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RiskLevelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RiskLevel[]
     */
     ...
     * 
     * @param RiskLevel[] $items
     * @return self
     */
    public function setValue(array|RiskLevel $items, RiskLevel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param RiskLevel $item
     * @return self
     */
    public function addValue(RiskLevel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RiskLevel>
     */
