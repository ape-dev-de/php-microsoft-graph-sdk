...
/**
 * Collection response for MuteParticipantOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MuteParticipantOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MuteParticipantOperation[]
     */
    private array $value = [];
     ...
     * 
     * @param MuteParticipantOperation[] $items
     * @return self
     */
    public function setValue(array|MuteParticipantOperation $items, MuteParticipantOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MuteParticipantOperation> $value
     * @return self
     ...
     * 
     * @param MuteParticipantOperation $item
     * @return self
     */
    public function addValue(MuteParticipantOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MuteParticipantOperation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MuteParticipantOperation>
     */
