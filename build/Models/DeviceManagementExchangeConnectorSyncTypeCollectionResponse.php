...
/**
 * DeviceManagementExchangeConnectorSyncTypeCollectionResponse - Collection response
 */
class DeviceManagementExchangeConnectorSyncTypeCollectionResponse
{
    /**
     * @var array<int, DeviceManagementExchangeConnectorSyncType>
     */
    public array $value = [];
