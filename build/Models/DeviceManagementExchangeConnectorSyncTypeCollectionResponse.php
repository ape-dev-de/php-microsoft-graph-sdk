...
/**
 * Collection response for DeviceManagementExchangeConnectorSyncType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceManagementExchangeConnectorSyncTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceManagementExchangeConnectorSyncType[]
     */
    private array $value = [];
     ...
     * 
     * @return DeviceManagementExchangeConnectorSyncType[]
     */
     ...
     * 
     * @param DeviceManagementExchangeConnectorSyncType[] $items
     * @return self
     */
    public function setValue(array|DeviceManagementExchangeConnectorSyncType $items, DeviceManagementExchangeConnectorSyncType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceManagementExchangeConnectorSyncType> $value
     * @return self
     ...
     * 
     * @param DeviceManagementExchangeConnectorSyncType $item
     * @return self
     */
    public function addValue(DeviceManagementExchangeConnectorSyncType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceManagementExchangeConnectorSyncType>
     */
