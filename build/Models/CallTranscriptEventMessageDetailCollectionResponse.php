 ...
 */
class CallTranscriptEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param CallTranscriptEventMessageDetail ...$items Variable number of CallTranscriptEventMessageDetail items
     * @return self
     */
    public function setValue(CallTranscriptEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
