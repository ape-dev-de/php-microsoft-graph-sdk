...
/**
 * Collection response for CallTranscriptEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallTranscriptEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallTranscriptEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param CallTranscriptEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|CallTranscriptEventMessageDetail $items, CallTranscriptEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallTranscriptEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param CallTranscriptEventMessageDetail $item
     * @return self
     */
    public function addValue(CallTranscriptEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallTranscriptEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallTranscriptEventMessageDetail>
     */
