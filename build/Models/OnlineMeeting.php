...
class OnlineMeeting
{
     ...
     * @var BroadcastMeetingSettings|\stdClass|null
     */
    public BroadcastMeetingSettings|\stdClass|null $broadcastSettings = null;
     ...
     * @var MeetingParticipants|\stdClass|null
     */
    public MeetingParticipants|\stdClass|null $participants = null;
    ...
    public function __construct(array $data = [])
    {
        ...
        if (isset($data['isBroadcast'])) {
            $this->isBroadcast = is_bool($data['isBroadcast']) ? $data['isBroadcast'] : (bool)$data['isBroadcast'];
        }
        if (isset($data['meetingTemplateId'])) {
