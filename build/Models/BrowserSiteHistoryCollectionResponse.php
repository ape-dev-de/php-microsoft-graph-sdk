...
/**
 * Collection response for BrowserSiteHistory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BrowserSiteHistoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param BrowserSiteHistory[] $items
     * @return self
     */
    public function setValue(array|BrowserSiteHistory $items, BrowserSiteHistory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BrowserSiteHistory> $value
     * @return self
     ...
     * 
     * @param BrowserSiteHistory $item
     * @return self
     */
    public function addValue(BrowserSiteHistory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return BrowserSiteHistory|null
     */
     ...
     * 
     * @return \ArrayIterator<int, BrowserSiteHistory>
     */
