...
/**
 * Collection response for PlannerTask
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerTaskCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PlannerTask[]
     */
     ...
     * 
     * @param PlannerTask[] $items
     * @return self
     */
    public function setValue(array|PlannerTask $items, PlannerTask ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param PlannerTask $item
     * @return self
     */
    public function addValue(PlannerTask $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PlannerTask>
     */
