...
/**
 * Collection response for AndroidCompliancePolicyCollectionResponse
 */
class AndroidCompliancePolicyCollectionResponseCollectionResponse
{
    /**
     * @var AndroidCompliancePolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AndroidCompliancePolicyCollectionResponse ...$items Variable number of AndroidCompliancePolicyCollectionResponse items
     * @return self
     */
    public function setValue(AndroidCompliancePolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AndroidCompliancePolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AndroidCompliancePolicyCollectionResponse $item
     * @return self
     */
    public function addValue(AndroidCompliancePolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
