...
/**
 * Collection response for AllowedValue
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AllowedValueCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AllowedValue[]
     */
     ...
     * 
     * @param AllowedValue[] $items
     * @return self
     */
    public function setValue(array|AllowedValue $items, AllowedValue ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AllowedValue> $value
     * @return self
     ...
     * 
     * @param AllowedValue $item
     * @return self
     */
    public function addValue(AllowedValue $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AllowedValue>
     */
