...
/**
 * Collection response for CloudPcDomainJoinType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcDomainJoinTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudPcDomainJoinType[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudPcDomainJoinType[] $items
     * @return self
     */
    public function setValue(array|CloudPcDomainJoinType $items, CloudPcDomainJoinType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcDomainJoinType> $value
     * @return self
     ...
     * 
     * @param CloudPcDomainJoinType $item
     * @return self
     */
    public function addValue(CloudPcDomainJoinType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcDomainJoinType>
     */
