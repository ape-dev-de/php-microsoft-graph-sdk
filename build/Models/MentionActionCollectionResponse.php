...
/**
 * Collection response for MentionAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MentionActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MentionAction[]
     */
     ...
     * 
     * @param MentionAction[] $items
     * @return self
     */
    public function setValue(array|MentionAction $items, MentionAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MentionAction> $value
     * @return self
     ...
     * @return self
     */
    public function addValue(MentionAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MentionAction>
     */
