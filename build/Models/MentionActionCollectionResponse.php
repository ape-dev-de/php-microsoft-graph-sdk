 ...
 */
class MentionActionCollectionResponse
{
    /**
     * @var MentionAction[]
     */
     ...
     * 
     * @param MentionAction ...$items Variable number of MentionAction items
     * @return self
     */
    public function setValue(MentionAction ...$items): self
    {
        $this->value = $items;
        return $this;
    }
