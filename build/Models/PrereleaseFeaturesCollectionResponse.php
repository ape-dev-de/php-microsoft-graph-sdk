...
/**
 * Collection response for PrereleaseFeatures
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrereleaseFeaturesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrereleaseFeatures[]
     */
    private array $value = [];
     ...
     * 
     * @param PrereleaseFeatures[] $items
     * @return self
     */
    public function setValue(array|PrereleaseFeatures $items, PrereleaseFeatures ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrereleaseFeatures> $value
     * @return self
     ...
     * 
     * @param PrereleaseFeatures $item
     * @return self
     */
    public function addValue(PrereleaseFeatures $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrereleaseFeatures>
     */
