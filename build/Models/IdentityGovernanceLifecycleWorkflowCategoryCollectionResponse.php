...
/**
 * IdentityGovernanceLifecycleWorkflowCategoryCollectionResponse - Collection response
 */
class IdentityGovernanceLifecycleWorkflowCategoryCollectionResponse
{
    /**
     * @var array<int, IdentityGovernanceLifecycleWorkflowCategory>
     */
    public array $value = [];
