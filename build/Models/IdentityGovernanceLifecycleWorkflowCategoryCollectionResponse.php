...
/**
 * Collection response for IdentityGovernanceLifecycleWorkflowCategory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceLifecycleWorkflowCategoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceLifecycleWorkflowCategory[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceLifecycleWorkflowCategory[]
     */
     ...
     * 
     * @param IdentityGovernanceLifecycleWorkflowCategory[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceLifecycleWorkflowCategory $items, IdentityGovernanceLifecycleWorkflowCategory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceLifecycleWorkflowCategory> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceLifecycleWorkflowCategory $item
     * @return self
     */
    public function addValue(IdentityGovernanceLifecycleWorkflowCategory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceLifecycleWorkflowCategory|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceLifecycleWorkflowCategory>
     */
