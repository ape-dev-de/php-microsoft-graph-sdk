...
/**
 * Collection response for TeamsAsyncOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamsAsyncOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TeamsAsyncOperation[] $items
     * @return self
     */
    public function setValue(array|TeamsAsyncOperation $items, TeamsAsyncOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamsAsyncOperation> $value
     * @return self
     ...
     * 
     * @param TeamsAsyncOperation $item
     * @return self
     */
    public function addValue(TeamsAsyncOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamsAsyncOperation>
     */
