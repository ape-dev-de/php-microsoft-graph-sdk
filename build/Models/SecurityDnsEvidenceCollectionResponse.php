 ...
 */
class SecurityDnsEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityDnsEvidence ...$items Variable number of SecurityDnsEvidence items
     * @return self
     */
    public function setValue(SecurityDnsEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
