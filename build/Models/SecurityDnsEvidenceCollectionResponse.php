...
/**
 * Collection response for SecurityDnsEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityDnsEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityDnsEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityDnsEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityDnsEvidence $items, SecurityDnsEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityDnsEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityDnsEvidence $item
     * @return self
     */
    public function addValue(SecurityDnsEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityDnsEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityDnsEvidence>
     */
