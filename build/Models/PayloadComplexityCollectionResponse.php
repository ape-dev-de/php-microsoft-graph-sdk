...
/**
 * Collection response for PayloadComplexity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PayloadComplexityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PayloadComplexity[]
     */
    private array $value = [];
     ...
     * 
     * @param PayloadComplexity[] $items
     * @return self
     */
    public function setValue(array|PayloadComplexity $items, PayloadComplexity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PayloadComplexity> $value
     * @return self
     ...
     * 
     * @param PayloadComplexity $item
     * @return self
     */
    public function addValue(PayloadComplexity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PayloadComplexity>
     */
