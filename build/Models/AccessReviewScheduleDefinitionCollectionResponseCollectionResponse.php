...
/**
 * Collection response for AccessReviewScheduleDefinitionCollectionResponse
 */
class AccessReviewScheduleDefinitionCollectionResponseCollectionResponse
{
    /**
     * @var AccessReviewScheduleDefinitionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessReviewScheduleDefinitionCollectionResponse ...$items Variable number of AccessReviewScheduleDefinitionCollectionResponse items
     * @return self
     */
    public function setValue(AccessReviewScheduleDefinitionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AccessReviewScheduleDefinitionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AccessReviewScheduleDefinitionCollectionResponse $item
     * @return self
     */
    public function addValue(AccessReviewScheduleDefinitionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
