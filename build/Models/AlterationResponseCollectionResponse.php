 ...
 */
class AlterationResponseCollectionResponse
{
    /**
     ...
     * 
     * @param AlterationResponse ...$items Variable number of AlterationResponse items
     * @return self
     */
    public function setValue(AlterationResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
