...
/**
 * Collection response for AlterationResponse
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AlterationResponseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AlterationResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AlterationResponse[] $items
     * @return self
     */
    public function setValue(array|AlterationResponse $items, AlterationResponse ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AlterationResponse> $value
     * @return self
     ...
     * 
     * @param AlterationResponse $item
     * @return self
     */
    public function addValue(AlterationResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AlterationResponse>
     */
