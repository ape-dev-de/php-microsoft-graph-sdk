...
/**
 * Collection response for Security
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Security[]
     */
     ...
     * 
     * @param Security[] $items
     * @return self
     */
    public function setValue(array|Security $items, Security ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Security $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Security>
     */
