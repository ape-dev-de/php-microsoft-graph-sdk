...
/**
 * Collection response for CertificateAuthorityDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CertificateAuthorityDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CertificateAuthorityDetail[] $items
     * @return self
     */
    public function setValue(array|CertificateAuthorityDetail $items, CertificateAuthorityDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CertificateAuthorityDetail> $value
     * @return self
     ...
     * 
     * @param CertificateAuthorityDetail $item
     * @return self
     */
    public function addValue(CertificateAuthorityDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CertificateAuthorityDetail>
     */
