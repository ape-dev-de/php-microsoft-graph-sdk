...
/**
 * CertificateAuthorityDetailCollectionResponse - Collection response
 */
class CertificateAuthorityDetailCollectionResponse
{
    /**
     * @var array<int, CertificateAuthorityDetail>
     */
    public array $value = [];
