...
/**
 * Collection response for AdvancedConfigState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AdvancedConfigStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AdvancedConfigState[]
     */
    private array $value = [];
     ...
     * 
     * @param AdvancedConfigState[] $items
     * @return self
     */
    public function setValue(array|AdvancedConfigState $items, AdvancedConfigState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AdvancedConfigState> $value
     * @return self
     ...
     * 
     * @param AdvancedConfigState $item
     * @return self
     */
    public function addValue(AdvancedConfigState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AdvancedConfigState>
     */
