...
/**
 * Collection response for IdentityUserFlowAttributeType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityUserFlowAttributeTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityUserFlowAttributeType[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityUserFlowAttributeType[]
     */
     ...
     * 
     * @param IdentityUserFlowAttributeType[] $items
     * @return self
     */
    public function setValue(array|IdentityUserFlowAttributeType $items, IdentityUserFlowAttributeType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityUserFlowAttributeType> $value
     * @return self
     ...
     * 
     * @param IdentityUserFlowAttributeType $item
     * @return self
     */
    public function addValue(IdentityUserFlowAttributeType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityUserFlowAttributeType>
     */
