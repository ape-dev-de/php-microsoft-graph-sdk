...
/**
 * IdentityUserFlowAttributeTypeCollectionResponse - Collection response
 */
class IdentityUserFlowAttributeTypeCollectionResponse
{
    /**
     * @var array<int, IdentityUserFlowAttributeType>
     */
    public array $value = [];
