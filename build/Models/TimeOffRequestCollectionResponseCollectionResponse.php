...
/**
 * Collection response for TimeOffRequestCollectionResponse
 */
class TimeOffRequestCollectionResponseCollectionResponse
{
    /**
     * @var TimeOffRequestCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TimeOffRequestCollectionResponse ...$items Variable number of TimeOffRequestCollectionResponse items
     * @return self
     */
    public function setValue(TimeOffRequestCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TimeOffRequestCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TimeOffRequestCollectionResponse $item
     * @return self
     */
    public function addValue(TimeOffRequestCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
