...
/**
 * Collection response for EdgeCookiePolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EdgeCookiePolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EdgeCookiePolicy[]
     */
    private array $value = [];
     ...
     * 
     * @param EdgeCookiePolicy[] $items
     * @return self
     */
    public function setValue(array|EdgeCookiePolicy $items, EdgeCookiePolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EdgeCookiePolicy> $value
     * @return self
     ...
     * 
     * @param EdgeCookiePolicy $item
     * @return self
     */
    public function addValue(EdgeCookiePolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EdgeCookiePolicy>
     */
