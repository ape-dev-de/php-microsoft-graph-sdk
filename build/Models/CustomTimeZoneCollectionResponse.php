...
/**
 * Collection response for CustomTimeZone
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CustomTimeZoneCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CustomTimeZone[]
     */
     ...
     * 
     * @param CustomTimeZone[] $items
     * @return self
     */
    public function setValue(array|CustomTimeZone $items, CustomTimeZone ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CustomTimeZone> $value
     * @return self
     ...
     * 
     * @param CustomTimeZone $item
     * @return self
     */
    public function addValue(CustomTimeZone $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CustomTimeZone>
     */
