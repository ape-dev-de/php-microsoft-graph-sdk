 ...
 */
class CustomTimeZoneCollectionResponse
{
    /**
     * @var CustomTimeZone[]
     */
     ...
     * 
     * @param CustomTimeZone ...$items Variable number of CustomTimeZone items
     * @return self
     */
    public function setValue(CustomTimeZone ...$items): self
    {
        $this->value = $items;
        return $this;
    }
