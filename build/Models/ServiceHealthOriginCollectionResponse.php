...
/**
 * Collection response for ServiceHealthOrigin
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServiceHealthOriginCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ServiceHealthOrigin[]
     */
    private array $value = [];
     ...
     * 
     * @param ServiceHealthOrigin[] $items
     * @return self
     */
    public function setValue(array|ServiceHealthOrigin $items, ServiceHealthOrigin ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServiceHealthOrigin> $value
     * @return self
     ...
     * 
     * @param ServiceHealthOrigin $item
     * @return self
     */
    public function addValue(ServiceHealthOrigin $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ServiceHealthOrigin>
     */
