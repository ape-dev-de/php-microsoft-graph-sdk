 ...
 */
class CustomExtensionCalloutRequestCollectionResponse
{
    /**
     ...
     * 
     * @param CustomExtensionCalloutRequest ...$items Variable number of CustomExtensionCalloutRequest items
     * @return self
     */
    public function setValue(CustomExtensionCalloutRequest ...$items): self
    {
        $this->value = $items;
        return $this;
    }
