...
/**
 * Collection response for CustomExtensionCalloutRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CustomExtensionCalloutRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CustomExtensionCalloutRequest[]
     */
    private array $value = [];
     ...
     * 
     * @param CustomExtensionCalloutRequest[] $items
     * @return self
     */
    public function setValue(array|CustomExtensionCalloutRequest $items, CustomExtensionCalloutRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CustomExtensionCalloutRequest> $value
     * @return self
     ...
     * 
     * @param CustomExtensionCalloutRequest $item
     * @return self
     */
    public function addValue(CustomExtensionCalloutRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CustomExtensionCalloutRequest|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CustomExtensionCalloutRequest>
     */
