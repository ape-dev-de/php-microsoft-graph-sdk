...
/**
 * ExternalConnectorsPropertyTypeCollectionResponse - Collection response
 */
class ExternalConnectorsPropertyTypeCollectionResponse
{
    /**
     * @var array<int, ExternalConnectorsPropertyType>
     */
    public array $value = [];
