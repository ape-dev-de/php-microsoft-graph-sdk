...
/**
 * Collection response for ExternalConnectorsPropertyType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsPropertyTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalConnectorsPropertyType[]
     */
    private array $value = [];
     ...
     * 
     * @return ExternalConnectorsPropertyType[]
     */
     ...
     * 
     * @param ExternalConnectorsPropertyType[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsPropertyType $items, ExternalConnectorsPropertyType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsPropertyType> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsPropertyType $item
     * @return self
     */
    public function addValue(ExternalConnectorsPropertyType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalConnectorsPropertyType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsPropertyType>
     */
