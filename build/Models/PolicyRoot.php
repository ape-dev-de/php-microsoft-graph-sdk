...
class PolicyRoot
{
    public function __construct(
        ...
        public ?AdminConsentRequestPolicy $adminConsentRequestPolicy = null,
        /** The policies that enforce app management restrictions for specific applications and service principals, overriding the defaultAppManagementPolicy. */
        public array $appManagementPolicies = [],
        /** The policy configuration of the self-service sign-up experience of external users. */
        public ?AuthenticationFlowsPolicy $authenticationFlowsPolicy = null,
        ...
        public ?AuthenticationMethodsPolicy $authenticationMethodsPolicy = null,
        ...
        public ?CrossTenantAccessPolicy $crossTenantAccessPolicy = null,
        /** The tenant-wide policy that enforces app management restrictions for all applications and service principals. */
        public ?TenantAppManagementPolicy $defaultAppManagementPolicy = null,
        /**  */
        public ?DeviceRegistrationPolicy $deviceRegistrationPolicy = null,
        ...
        public ?IdentitySecurityDefaultsEnforcementPolicy $identitySecurityDefaultsEnforcementPolicy = null,
