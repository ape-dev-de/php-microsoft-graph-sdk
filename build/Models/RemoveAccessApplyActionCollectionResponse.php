...
/**
 * Collection response for RemoveAccessApplyAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RemoveAccessApplyActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RemoveAccessApplyAction[]
     */
    private array $value = [];
     ...
     * 
     * @param RemoveAccessApplyAction[] $items
     * @return self
     */
    public function setValue(array|RemoveAccessApplyAction $items, RemoveAccessApplyAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RemoveAccessApplyAction> $value
     * @return self
     ...
     * 
     * @param RemoveAccessApplyAction $item
     * @return self
     */
    public function addValue(RemoveAccessApplyAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return RemoveAccessApplyAction|null
     */
     ...
     * 
     * @return \ArrayIterator<int, RemoveAccessApplyAction>
     */
