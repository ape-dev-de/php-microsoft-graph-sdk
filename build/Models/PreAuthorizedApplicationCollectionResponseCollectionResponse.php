...
/**
 * Collection response for PreAuthorizedApplicationCollectionResponse
 */
class PreAuthorizedApplicationCollectionResponseCollectionResponse
{
    /**
     * @var PreAuthorizedApplicationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PreAuthorizedApplicationCollectionResponse ...$items Variable number of PreAuthorizedApplicationCollectionResponse items
     * @return self
     */
    public function setValue(PreAuthorizedApplicationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PreAuthorizedApplicationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PreAuthorizedApplicationCollectionResponse $item
     * @return self
     */
    public function addValue(PreAuthorizedApplicationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
