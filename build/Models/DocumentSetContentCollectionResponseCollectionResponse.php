...
/**
 * Collection response for DocumentSetContentCollectionResponse
 */
class DocumentSetContentCollectionResponseCollectionResponse
{
    /**
     * @var DocumentSetContentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DocumentSetContentCollectionResponse ...$items Variable number of DocumentSetContentCollectionResponse items
     * @return self
     */
    public function setValue(DocumentSetContentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DocumentSetContentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DocumentSetContentCollectionResponse $item
     * @return self
     */
    public function addValue(DocumentSetContentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
