 ...
 */
class TrainingSettingCollectionResponse
{
    /**
     * @var TrainingSetting[]
     */
     ...
     * 
     * @param TrainingSetting ...$items Variable number of TrainingSetting items
     * @return self
     */
    public function setValue(TrainingSetting ...$items): self
    {
        $this->value = $items;
        return $this;
    }
