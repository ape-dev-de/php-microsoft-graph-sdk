...
/**
 * Collection response for TrainingSetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TrainingSettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TrainingSetting[]
     */
     ...
     * 
     * @param TrainingSetting[] $items
     * @return self
     */
    public function setValue(array|TrainingSetting $items, TrainingSetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TrainingSetting> $value
     * @return self
     ...
     * 
     * @param TrainingSetting $item
     * @return self
     */
    public function addValue(TrainingSetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TrainingSetting>
     */
