...
/**
 * Collection response for ResourcePermissionCollectionResponse
 */
class ResourcePermissionCollectionResponseCollectionResponse
{
    /**
     * @var ResourcePermissionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ResourcePermissionCollectionResponse ...$items Variable number of ResourcePermissionCollectionResponse items
     * @return self
     */
    public function setValue(ResourcePermissionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ResourcePermissionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ResourcePermissionCollectionResponse $item
     * @return self
     */
    public function addValue(ResourcePermissionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
