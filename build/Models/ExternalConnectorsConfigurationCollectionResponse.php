 ...
 */
class ExternalConnectorsConfigurationCollectionResponse
{
    /**
     ...
     * 
     * @param ExternalConnectorsConfiguration ...$items Variable number of ExternalConnectorsConfiguration items
     * @return self
     */
    public function setValue(ExternalConnectorsConfiguration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
