...
/**
 * Collection response for ExternalConnectorsConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalConnectorsConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @return ExternalConnectorsConfiguration[]
     */
     ...
     * 
     * @param ExternalConnectorsConfiguration[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsConfiguration $items, ExternalConnectorsConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsConfiguration> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsConfiguration $item
     * @return self
     */
    public function addValue(ExternalConnectorsConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalConnectorsConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsConfiguration>
     */
