...
/**
 * Collection response for IdentityGovernanceTriggerAttribute
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceTriggerAttributeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return IdentityGovernanceTriggerAttribute[]
     */
     ...
     * 
     * @param IdentityGovernanceTriggerAttribute[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceTriggerAttribute $items, IdentityGovernanceTriggerAttribute ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceTriggerAttribute> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceTriggerAttribute $item
     * @return self
     */
    public function addValue(IdentityGovernanceTriggerAttribute $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceTriggerAttribute|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceTriggerAttribute>
     */
