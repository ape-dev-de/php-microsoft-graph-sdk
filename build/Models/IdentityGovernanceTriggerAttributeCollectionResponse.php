...
/**
 * IdentityGovernanceTriggerAttributeCollectionResponse - Collection response
 */
class IdentityGovernanceTriggerAttributeCollectionResponse
{
    /**
     * @var array<int, IdentityGovernanceTriggerAttribute>
     */
    public array $value = [];
