...
/**
 * Collection response for AssignedLicense
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AssignedLicenseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AssignedLicense[]
     */
     ...
     * 
     * @param AssignedLicense[] $items
     * @return self
     */
    public function setValue(array|AssignedLicense $items, AssignedLicense ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AssignedLicense> $value
     * @return self
     ...
     * 
     * @param AssignedLicense $item
     * @return self
     */
    public function addValue(AssignedLicense $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AssignedLicense>
     */
