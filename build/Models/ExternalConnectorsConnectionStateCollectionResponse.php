...
/**
 * Collection response for ExternalConnectorsConnectionState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsConnectionStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalConnectorsConnectionState[]
     */
    private array $value = [];
     ...
     * 
     * @return ExternalConnectorsConnectionState[]
     */
     ...
     * 
     * @param ExternalConnectorsConnectionState[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsConnectionState $items, ExternalConnectorsConnectionState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsConnectionState> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsConnectionState $item
     * @return self
     */
    public function addValue(ExternalConnectorsConnectionState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalConnectorsConnectionState|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsConnectionState>
     */
