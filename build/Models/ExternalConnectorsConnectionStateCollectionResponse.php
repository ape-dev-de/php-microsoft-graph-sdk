...
/**
 * ExternalConnectorsConnectionStateCollectionResponse - Collection response
 */
class ExternalConnectorsConnectionStateCollectionResponse
{
    /**
     * @var array<int, ExternalConnectorsConnectionState>
     */
    public array $value = [];
