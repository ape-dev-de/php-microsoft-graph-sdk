...
/**
 * Collection response for SubjectRightsRequestSiteLocation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SubjectRightsRequestSiteLocationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SubjectRightsRequestSiteLocation[]
     */
    private array $value = [];
     ...
     * 
     * @param SubjectRightsRequestSiteLocation[] $items
     * @return self
     */
    public function setValue(array|SubjectRightsRequestSiteLocation $items, SubjectRightsRequestSiteLocation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SubjectRightsRequestSiteLocation> $value
     * @return self
     ...
     * 
     * @param SubjectRightsRequestSiteLocation $item
     * @return self
     */
    public function addValue(SubjectRightsRequestSiteLocation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SubjectRightsRequestSiteLocation>
     */
