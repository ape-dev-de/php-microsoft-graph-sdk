...
/**
 * SubjectRightsRequestSiteLocationCollectionResponse - Collection response
 */
class SubjectRightsRequestSiteLocationCollectionResponse
{
    /**
     * @var array<int, SubjectRightsRequestSiteLocation>
     */
    public array $value = [];
