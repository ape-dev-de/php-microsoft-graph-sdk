...
/**
 * Collection response for MobileAppAssignmentSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MobileAppAssignmentSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MobileAppAssignmentSettings[] $items
     * @return self
     */
    public function setValue(array|MobileAppAssignmentSettings $items, MobileAppAssignmentSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MobileAppAssignmentSettings> $value
     * @return self
     ...
     * 
     * @param MobileAppAssignmentSettings $item
     * @return self
     */
    public function addValue(MobileAppAssignmentSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MobileAppAssignmentSettings>
     */
