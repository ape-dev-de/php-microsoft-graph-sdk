...
/**
 * MobileAppAssignmentSettingsCollectionResponse - Collection response
 */
class MobileAppAssignmentSettingsCollectionResponse
{
    /**
     * @var array<int, MobileAppAssignmentSettings>
     */
    public array $value = [];
