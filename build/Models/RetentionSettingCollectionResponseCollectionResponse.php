...
/**
 * Collection response for RetentionSettingCollectionResponse
 */
class RetentionSettingCollectionResponseCollectionResponse
{
    /**
     * @var RetentionSettingCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return RetentionSettingCollectionResponse[]
     */
     ...
     * 
     * @param RetentionSettingCollectionResponse ...$items Variable number of RetentionSettingCollectionResponse items
     * @return self
     */
    public function setValue(RetentionSettingCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RetentionSettingCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RetentionSettingCollectionResponse $item
     * @return self
     */
    public function addValue(RetentionSettingCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
