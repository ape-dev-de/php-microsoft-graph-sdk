...
/**
 * Collection response for SecuritySubcategoryTemplate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecuritySubcategoryTemplateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecuritySubcategoryTemplate[] $items
     * @return self
     */
    public function setValue(array|SecuritySubcategoryTemplate $items, SecuritySubcategoryTemplate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecuritySubcategoryTemplate> $value
     * @return self
     ...
     * 
     * @param SecuritySubcategoryTemplate $item
     * @return self
     */
    public function addValue(SecuritySubcategoryTemplate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecuritySubcategoryTemplate>
     */
