...
/**
 * Collection response for BitLockerRemovableDrivePolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BitLockerRemovableDrivePolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param BitLockerRemovableDrivePolicy[] $items
     * @return self
     */
    public function setValue(array|BitLockerRemovableDrivePolicy $items, BitLockerRemovableDrivePolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BitLockerRemovableDrivePolicy> $value
     * @return self
     ...
     * 
     * @param BitLockerRemovableDrivePolicy $item
     * @return self
     */
    public function addValue(BitLockerRemovableDrivePolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BitLockerRemovableDrivePolicy>
     */
