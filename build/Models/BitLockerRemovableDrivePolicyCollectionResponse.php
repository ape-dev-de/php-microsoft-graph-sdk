 ...
 */
class BitLockerRemovableDrivePolicyCollectionResponse
{
    /**
     ...
     * 
     * @param BitLockerRemovableDrivePolicy ...$items Variable number of BitLockerRemovableDrivePolicy items
     * @return self
     */
    public function setValue(BitLockerRemovableDrivePolicy ...$items): self
    {
        $this->value = $items;
        return $this;
    }
