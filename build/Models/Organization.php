...
class Organization
{
     ...
     * @var string[]
     */
    private array $marketingNotificationEmails = [];
     ...
     * @var string[]
     */
    private array $securityComplianceNotificationMails = [];

    /**
     * Not nullable.
     * @var string[]
     */
    private array $securityComplianceNotificationPhones = [];
     ...
     * @var string[]
     */
    private array $technicalNotificationMails = [];
    ...
    /**
     * @param string[] $marketingNotificationEmails
     */
    public function setMarketingNotificationEmails(array $marketingNotificationEmails): self
    {
    ...
    /**
     * @param string[] $securityComplianceNotificationMails
     */
    public function setSecurityComplianceNotificationMails(array $securityComplianceNotificationMails): self
    {
    ...
    /**
     * @param string[] $securityComplianceNotificationPhones
     */
    public function setSecurityComplianceNotificationPhones(array $securityComplianceNotificationPhones): self
    {
    ...
    /**
     * @param string[] $technicalNotificationMails
     */
    public function setTechnicalNotificationMails(array $technicalNotificationMails): self
    {
