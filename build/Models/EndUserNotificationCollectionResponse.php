...
/**
 * Collection response for EndUserNotification
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EndUserNotificationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param EndUserNotification[] $items
     * @return self
     */
    public function setValue(array|EndUserNotification $items, EndUserNotification ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EndUserNotification> $value
     * @return self
     ...
     * 
     * @param EndUserNotification $item
     * @return self
     */
    public function addValue(EndUserNotification $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EndUserNotification>
     */
