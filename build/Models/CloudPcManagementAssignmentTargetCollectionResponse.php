...
/**
 * Collection response for CloudPcManagementAssignmentTarget
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcManagementAssignmentTargetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudPcManagementAssignmentTarget[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudPcManagementAssignmentTarget[] $items
     * @return self
     */
    public function setValue(array|CloudPcManagementAssignmentTarget $items, CloudPcManagementAssignmentTarget ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcManagementAssignmentTarget> $value
     * @return self
     ...
     * 
     * @param CloudPcManagementAssignmentTarget $item
     * @return self
     */
    public function addValue(CloudPcManagementAssignmentTarget $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcManagementAssignmentTarget>
     */
