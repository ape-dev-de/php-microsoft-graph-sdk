...
/**
 * CloudPcManagementAssignmentTargetCollectionResponse - Collection response
 */
class CloudPcManagementAssignmentTargetCollectionResponse
{
    /**
     * @var array<int, CloudPcManagementAssignmentTarget>
     */
    public array $value = [];
