 ...
 */
class ProcessConversationMetadataCollectionResponse
{
    /**
     ...
     * 
     * @param ProcessConversationMetadata ...$items Variable number of ProcessConversationMetadata items
     * @return self
     */
    public function setValue(ProcessConversationMetadata ...$items): self
    {
        $this->value = $items;
        return $this;
    }
