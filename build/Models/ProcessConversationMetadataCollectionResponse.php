...
/**
 * Collection response for ProcessConversationMetadata
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProcessConversationMetadataCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProcessConversationMetadata[]
     */
    private array $value = [];
     ...
     * 
     * @param ProcessConversationMetadata[] $items
     * @return self
     */
    public function setValue(array|ProcessConversationMetadata $items, ProcessConversationMetadata ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProcessConversationMetadata> $value
     * @return self
     ...
     * 
     * @param ProcessConversationMetadata $item
     * @return self
     */
    public function addValue(ProcessConversationMetadata $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ProcessConversationMetadata|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ProcessConversationMetadata>
     */
