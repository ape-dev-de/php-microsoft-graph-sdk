 ...
 */
class SimulationNotificationCollectionResponse
{
    /**
     ...
     * 
     * @param SimulationNotification ...$items Variable number of SimulationNotification items
     * @return self
     */
    public function setValue(SimulationNotification ...$items): self
    {
        $this->value = $items;
        return $this;
    }
