...
/**
 * Collection response for SimulationNotification
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SimulationNotificationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SimulationNotification[]
     */
    private array $value = [];
     ...
     * 
     * @param SimulationNotification[] $items
     * @return self
     */
    public function setValue(array|SimulationNotification $items, SimulationNotification ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SimulationNotification> $value
     * @return self
     ...
     * 
     * @param SimulationNotification $item
     * @return self
     */
    public function addValue(SimulationNotification $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SimulationNotification>
     */
