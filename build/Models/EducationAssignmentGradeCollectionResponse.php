 ...
 */
class EducationAssignmentGradeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param EducationAssignmentGrade[] $items
     * @return self
     */
    public function setValue(array|EducationAssignmentGrade $items, EducationAssignmentGrade ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param mixed $offset
     * @return EducationAssignmentGrade|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EducationAssignmentGrade>
     */
