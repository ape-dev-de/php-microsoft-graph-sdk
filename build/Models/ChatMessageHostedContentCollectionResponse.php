...
/**
 * Collection response for ChatMessageHostedContent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatMessageHostedContentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ChatMessageHostedContent[] $items
     * @return self
     */
    public function setValue(array|ChatMessageHostedContent $items, ChatMessageHostedContent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChatMessageHostedContent> $value
     * @return self
     ...
     * 
     * @param ChatMessageHostedContent $item
     * @return self
     */
    public function addValue(ChatMessageHostedContent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChatMessageHostedContent>
     */
