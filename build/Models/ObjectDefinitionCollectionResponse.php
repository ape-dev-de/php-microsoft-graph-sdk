...
/**
 * Collection response for ObjectDefinition
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ObjectDefinitionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ObjectDefinition[] $items
     * @return self
     */
    public function setValue(array|ObjectDefinition $items, ObjectDefinition ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ObjectDefinition> $value
     * @return self
     ...
     * 
     * @param ObjectDefinition $item
     * @return self
     */
    public function addValue(ObjectDefinition $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ObjectDefinition>
     */
