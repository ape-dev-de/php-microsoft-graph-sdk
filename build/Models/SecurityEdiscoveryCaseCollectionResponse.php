...
/**
 * Collection response for SecurityEdiscoveryCase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityEdiscoveryCaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityEdiscoveryCase[] $items
     * @return self
     */
    public function setValue(array|SecurityEdiscoveryCase $items, SecurityEdiscoveryCase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityEdiscoveryCase> $value
     * @return self
     ...
     * 
     * @param SecurityEdiscoveryCase $item
     * @return self
     */
    public function addValue(SecurityEdiscoveryCase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityEdiscoveryCase>
     */
