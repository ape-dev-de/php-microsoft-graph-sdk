...
/**
 * Collection response for AuthenticationMethodModeDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationMethodModeDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AuthenticationMethodModeDetail[] $items
     * @return self
     */
    public function setValue(array|AuthenticationMethodModeDetail $items, AuthenticationMethodModeDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationMethodModeDetail> $value
     * @return self
     ...
     * 
     * @param AuthenticationMethodModeDetail $item
     * @return self
     */
    public function addValue(AuthenticationMethodModeDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationMethodModeDetail>
     */
