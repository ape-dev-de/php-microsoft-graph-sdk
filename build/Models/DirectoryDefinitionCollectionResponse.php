...
/**
 * Collection response for DirectoryDefinition
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DirectoryDefinitionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DirectoryDefinition[] $items
     * @return self
     */
    public function setValue(array|DirectoryDefinition $items, DirectoryDefinition ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DirectoryDefinition> $value
     * @return self
     ...
     * 
     * @param DirectoryDefinition $item
     * @return self
     */
    public function addValue(DirectoryDefinition $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DirectoryDefinition>
     */
