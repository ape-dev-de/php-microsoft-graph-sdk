...
/**
 * Collection response for MediaStream
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MediaStreamCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MediaStream[]
     */
     ...
     * 
     * @param MediaStream[] $items
     * @return self
     */
    public function setValue(array|MediaStream $items, MediaStream ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param MediaStream $item
     * @return self
     */
    public function addValue(MediaStream $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MediaStream>
     */
