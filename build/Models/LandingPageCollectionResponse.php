...
/**
 * Collection response for LandingPage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LandingPageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var LandingPage[]
     */
     ...
     * 
     * @param LandingPage[] $items
     * @return self
     */
    public function setValue(array|LandingPage $items, LandingPage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param LandingPage $item
     * @return self
     */
    public function addValue(LandingPage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LandingPage>
     */
