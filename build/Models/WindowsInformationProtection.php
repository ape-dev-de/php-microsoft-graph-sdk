...
class WindowsInformationProtection
{
     ...
     * @var string[]
     */
    private array $protectedAppLockerFiles = [];
    ...
    /**
     * @param string[] $protectedAppLockerFiles
     */
    public function setProtectedAppLockerFiles(array $protectedAppLockerFiles): self
    {
