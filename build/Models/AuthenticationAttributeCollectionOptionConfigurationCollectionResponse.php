...
/**
 * Collection response for AuthenticationAttributeCollectionOptionConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationAttributeCollectionOptionConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AuthenticationAttributeCollectionOptionConfiguration[] $items
     * @return self
     */
    public function setValue(array|AuthenticationAttributeCollectionOptionConfiguration $items, AuthenticationAttributeCollectionOptionConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationAttributeCollectionOptionConfiguration> $value
     * @return self
     ...
     * 
     * @param AuthenticationAttributeCollectionOptionConfiguration $item
     * @return self
     */
    public function addValue(AuthenticationAttributeCollectionOptionConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AuthenticationAttributeCollectionOptionConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationAttributeCollectionOptionConfiguration>
     */
