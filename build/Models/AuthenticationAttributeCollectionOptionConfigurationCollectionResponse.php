...
/**
 * AuthenticationAttributeCollectionOptionConfigurationCollectionResponse - Collection response
 */
class AuthenticationAttributeCollectionOptionConfigurationCollectionResponse
{
    /**
     * @var array<int, AuthenticationAttributeCollectionOptionConfiguration>
     */
    public array $value = [];
