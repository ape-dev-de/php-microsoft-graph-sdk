...
/**
 * Collection response for DataSubject
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DataSubjectCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DataSubject[]
     */
     ...
     * 
     * @param DataSubject[] $items
     * @return self
     */
    public function setValue(array|DataSubject $items, DataSubject ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param DataSubject $item
     * @return self
     */
    public function addValue(DataSubject $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DataSubject>
     */
