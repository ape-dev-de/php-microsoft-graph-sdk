...
/**
 * Collection response for ManagedAppPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedAppPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ManagedAppPolicy[] $items
     * @return self
     */
    public function setValue(array|ManagedAppPolicy $items, ManagedAppPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedAppPolicy> $value
     * @return self
     ...
     * 
     * @param ManagedAppPolicy $item
     * @return self
     */
    public function addValue(ManagedAppPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedAppPolicy>
     */
