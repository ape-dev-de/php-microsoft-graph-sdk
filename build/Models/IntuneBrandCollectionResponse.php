...
/**
 * Collection response for IntuneBrand
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IntuneBrandCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IntuneBrand[]
     */
     ...
     * 
     * @param IntuneBrand[] $items
     * @return self
     */
    public function setValue(array|IntuneBrand $items, IntuneBrand ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param IntuneBrand $item
     * @return self
     */
    public function addValue(IntuneBrand $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IntuneBrand>
     */
