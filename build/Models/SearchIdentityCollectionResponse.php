...
/**
 * Collection response for SearchIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SearchIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SearchIdentity[]
     */
     ...
     * 
     * @param SearchIdentity[] $items
     * @return self
     */
    public function setValue(array|SearchIdentity $items, SearchIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SearchIdentity> $value
     * @return self
     ...
     * 
     * @param SearchIdentity $item
     * @return self
     */
    public function addValue(SearchIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SearchIdentity>
     */
