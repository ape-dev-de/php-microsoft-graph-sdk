 ...
 */
class SearchIdentityCollectionResponse
{
    /**
     * @var SearchIdentity[]
     */
     ...
     * 
     * @param SearchIdentity ...$items Variable number of SearchIdentity items
     * @return self
     */
    public function setValue(SearchIdentity ...$items): self
    {
        $this->value = $items;
        return $this;
    }
