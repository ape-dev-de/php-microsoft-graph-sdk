...
/**
 * ExternalConnectorsExternalConnectionCollectionResponse - Collection response
 */
class ExternalConnectorsExternalConnectionCollectionResponse
{
    /**
     * @var array<int, ExternalConnectorsExternalConnection>
     */
    public array $value = [];
