...
/**
 * Collection response for ExternalConnectorsExternalConnection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsExternalConnectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ExternalConnectorsExternalConnection[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsExternalConnection $items, ExternalConnectorsExternalConnection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsExternalConnection> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsExternalConnection $item
     * @return self
     */
    public function addValue(ExternalConnectorsExternalConnection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsExternalConnection>
     */
