...
/**
 * Collection response for TimeOffRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TimeOffRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TimeOffRequest[]
     */
     ...
     * 
     * @param TimeOffRequest[] $items
     * @return self
     */
    public function setValue(array|TimeOffRequest $items, TimeOffRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TimeOffRequest> $value
     * @return self
     ...
     * 
     * @param TimeOffRequest $item
     * @return self
     */
    public function addValue(TimeOffRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TimeOffRequest>
     */
