...
/**
 * Collection response for DeviceRegistrationState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceRegistrationStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceRegistrationState[] $items
     * @return self
     */
    public function setValue(array|DeviceRegistrationState $items, DeviceRegistrationState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceRegistrationState> $value
     * @return self
     ...
     * 
     * @param DeviceRegistrationState $item
     * @return self
     */
    public function addValue(DeviceRegistrationState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceRegistrationState>
     */
