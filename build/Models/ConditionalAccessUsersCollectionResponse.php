...
/**
 * Collection response for ConditionalAccessUsers
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessUsersCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessUsers[]
     */
    private array $value = [];
     ...
     * 
     * @param ConditionalAccessUsers[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessUsers $items, ConditionalAccessUsers ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessUsers> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessUsers $item
     * @return self
     */
    public function addValue(ConditionalAccessUsers $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessUsers>
     */
