 ...
 */
class ConditionalAccessUsersCollectionResponse
{
    /**
     ...
     * 
     * @param ConditionalAccessUsers ...$items Variable number of ConditionalAccessUsers items
     * @return self
     */
    public function setValue(ConditionalAccessUsers ...$items): self
    {
        $this->value = $items;
        return $this;
    }
