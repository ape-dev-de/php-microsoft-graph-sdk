...
/**
 * Collection response for NotificationMessageTemplate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class NotificationMessageTemplateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param NotificationMessageTemplate[] $items
     * @return self
     */
    public function setValue(array|NotificationMessageTemplate $items, NotificationMessageTemplate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<NotificationMessageTemplate> $value
     * @return self
     ...
     * 
     * @param NotificationMessageTemplate $item
     * @return self
     */
    public function addValue(NotificationMessageTemplate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, NotificationMessageTemplate>
     */
