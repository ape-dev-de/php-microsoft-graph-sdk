...
/**
 * Collection response for RejectReason
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RejectReasonCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RejectReason[]
     */
     ...
     * 
     * @param RejectReason[] $items
     * @return self
     */
    public function setValue(array|RejectReason $items, RejectReason ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RejectReason> $value
     * @return self
     ...
     * 
     * @param RejectReason $item
     * @return self
     */
    public function addValue(RejectReason $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RejectReason>
     */
