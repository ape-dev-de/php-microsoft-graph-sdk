...
/**
 * Collection response for ScopeBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ScopeBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ScopeBase[]
     */
     ...
     * 
     * @param ScopeBase[] $items
     * @return self
     */
    public function setValue(array|ScopeBase $items, ScopeBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param ScopeBase $item
     * @return self
     */
    public function addValue(ScopeBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ScopeBase>
     */
