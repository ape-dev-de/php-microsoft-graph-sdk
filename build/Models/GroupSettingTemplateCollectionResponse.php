...
/**
 * Collection response for GroupSettingTemplate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class GroupSettingTemplateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param GroupSettingTemplate[] $items
     * @return self
     */
    public function setValue(array|GroupSettingTemplate $items, GroupSettingTemplate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<GroupSettingTemplate> $value
     * @return self
     ...
     * 
     * @param GroupSettingTemplate $item
     * @return self
     */
    public function addValue(GroupSettingTemplate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, GroupSettingTemplate>
     */
