...
/**
 * Collection response for Shift
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ShiftCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Shift[]
     */
     ...
     * @return self
     */
    public function setValue(array|Shift $items, Shift ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Shift $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Shift>
     */
