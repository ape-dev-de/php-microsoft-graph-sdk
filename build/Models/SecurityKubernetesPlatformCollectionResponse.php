...
/**
 * Collection response for SecurityKubernetesPlatform
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityKubernetesPlatformCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityKubernetesPlatform[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityKubernetesPlatform[]
     */
     ...
     * 
     * @param SecurityKubernetesPlatform[] $items
     * @return self
     */
    public function setValue(array|SecurityKubernetesPlatform $items, SecurityKubernetesPlatform ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityKubernetesPlatform> $value
     * @return self
     ...
     * 
     * @param SecurityKubernetesPlatform $item
     * @return self
     */
    public function addValue(SecurityKubernetesPlatform $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityKubernetesPlatform|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityKubernetesPlatform>
     */
