...
/**
 * SecurityKubernetesPlatformCollectionResponse - Collection response
 */
class SecurityKubernetesPlatformCollectionResponse
{
    /**
     * @var array<int, SecurityKubernetesPlatform>
     */
    public array $value = [];
