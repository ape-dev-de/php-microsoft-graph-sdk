...
/**
 * Collection response for ApprovalStage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ApprovalStageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ApprovalStage[]
     */
     ...
     * 
     * @param ApprovalStage[] $items
     * @return self
     */
    public function setValue(array|ApprovalStage $items, ApprovalStage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ApprovalStage> $value
     * @return self
     ...
     * 
     * @param ApprovalStage $item
     * @return self
     */
    public function addValue(ApprovalStage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ApprovalStage>
     */
