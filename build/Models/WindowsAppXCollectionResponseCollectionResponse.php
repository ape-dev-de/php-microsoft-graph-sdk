...
/**
 * Collection response for WindowsAppXCollectionResponse
 */
class WindowsAppXCollectionResponseCollectionResponse
{
    /**
     * @var WindowsAppXCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsAppXCollectionResponse ...$items Variable number of WindowsAppXCollectionResponse items
     * @return self
     */
    public function setValue(WindowsAppXCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WindowsAppXCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WindowsAppXCollectionResponse $item
     * @return self
     */
    public function addValue(WindowsAppXCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
