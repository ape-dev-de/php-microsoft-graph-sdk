...
/**
 * Collection response for IosNotificationSettingsCollectionResponse
 */
class IosNotificationSettingsCollectionResponseCollectionResponse
{
    /**
     * @var IosNotificationSettingsCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IosNotificationSettingsCollectionResponse ...$items Variable number of IosNotificationSettingsCollectionResponse items
     * @return self
     */
    public function setValue(IosNotificationSettingsCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IosNotificationSettingsCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IosNotificationSettingsCollectionResponse $item
     * @return self
     */
    public function addValue(IosNotificationSettingsCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
