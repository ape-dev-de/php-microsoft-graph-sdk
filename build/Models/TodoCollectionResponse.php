...
/**
 * Collection response for Todo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TodoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Todo[]
     */
     ...
     * @return self
     */
    public function setValue(array|Todo $items, Todo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Todo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
