 ...
 */
class AccountTargetContentCollectionResponse
{
    /**
     ...
     * 
     * @param AccountTargetContent ...$items Variable number of AccountTargetContent items
     * @return self
     */
    public function setValue(AccountTargetContent ...$items): self
    {
        $this->value = $items;
        return $this;
    }
