...
/**
 * Collection response for AccountTargetContent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccountTargetContentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccountTargetContent[]
     */
    private array $value = [];
     ...
     * 
     * @param AccountTargetContent[] $items
     * @return self
     */
    public function setValue(array|AccountTargetContent $items, AccountTargetContent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccountTargetContent> $value
     * @return self
     ...
     * 
     * @param AccountTargetContent $item
     * @return self
     */
    public function addValue(AccountTargetContent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccountTargetContent>
     */
