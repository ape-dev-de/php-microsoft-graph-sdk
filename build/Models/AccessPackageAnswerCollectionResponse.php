...
/**
 * Collection response for AccessPackageAnswer
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageAnswerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessPackageAnswer[] $items
     * @return self
     */
    public function setValue(array|AccessPackageAnswer $items, AccessPackageAnswer ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageAnswer> $value
     * @return self
     ...
     * 
     * @param AccessPackageAnswer $item
     * @return self
     */
    public function addValue(AccessPackageAnswer $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessPackageAnswer|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageAnswer>
     */
