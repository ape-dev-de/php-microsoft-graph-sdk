...
/**
 * TrainingCompletionDurationCollectionResponse - Collection response
 */
class TrainingCompletionDurationCollectionResponse
{
    /**
     * @var array<int, TrainingCompletionDuration>
     */
    public array $value = [];
