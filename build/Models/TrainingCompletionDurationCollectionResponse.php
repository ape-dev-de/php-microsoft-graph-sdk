...
/**
 * Collection response for TrainingCompletionDuration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TrainingCompletionDurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TrainingCompletionDuration[]
     */
    private array $value = [];
     ...
     * 
     * @return TrainingCompletionDuration[]
     */
     ...
     * 
     * @param TrainingCompletionDuration[] $items
     * @return self
     */
    public function setValue(array|TrainingCompletionDuration $items, TrainingCompletionDuration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TrainingCompletionDuration> $value
     * @return self
     ...
     * 
     * @param TrainingCompletionDuration $item
     * @return self
     */
    public function addValue(TrainingCompletionDuration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TrainingCompletionDuration>
     */
