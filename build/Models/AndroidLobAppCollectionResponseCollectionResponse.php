...
/**
 * Collection response for AndroidLobAppCollectionResponse
 */
class AndroidLobAppCollectionResponseCollectionResponse
{
    /**
     * @var AndroidLobAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AndroidLobAppCollectionResponse ...$items Variable number of AndroidLobAppCollectionResponse items
     * @return self
     */
    public function setValue(AndroidLobAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AndroidLobAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AndroidLobAppCollectionResponse $item
     * @return self
     */
    public function addValue(AndroidLobAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
