...
/**
 * Collection response for MeetingInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MeetingInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MeetingInfo[]
     */
     ...
     * 
     * @param MeetingInfo[] $items
     * @return self
     */
    public function setValue(array|MeetingInfo $items, MeetingInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param MeetingInfo $item
     * @return self
     */
    public function addValue(MeetingInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MeetingInfo>
     */
