...
/**
 * AppKeyCredentialRestrictionTypeCollectionResponse - Collection response
 */
class AppKeyCredentialRestrictionTypeCollectionResponse
{
    /**
     * @var array<int, AppKeyCredentialRestrictionType>
     */
    public array $value = [];
