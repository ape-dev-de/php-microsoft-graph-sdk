...
/**
 * Collection response for AppKeyCredentialRestrictionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppKeyCredentialRestrictionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return AppKeyCredentialRestrictionType[]
     */
     ...
     * 
     * @param AppKeyCredentialRestrictionType[] $items
     * @return self
     */
    public function setValue(array|AppKeyCredentialRestrictionType $items, AppKeyCredentialRestrictionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppKeyCredentialRestrictionType> $value
     * @return self
     ...
     * 
     * @param AppKeyCredentialRestrictionType $item
     * @return self
     */
    public function addValue(AppKeyCredentialRestrictionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AppKeyCredentialRestrictionType>
     */
