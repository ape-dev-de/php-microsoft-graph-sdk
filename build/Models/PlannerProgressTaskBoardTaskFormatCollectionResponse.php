...
/**
 * Collection response for PlannerProgressTaskBoardTaskFormat
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerProgressTaskBoardTaskFormatCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PlannerProgressTaskBoardTaskFormat[]
     */
    private array $value = [];
     ...
     * 
     * @param PlannerProgressTaskBoardTaskFormat[] $items
     * @return self
     */
    public function setValue(array|PlannerProgressTaskBoardTaskFormat $items, PlannerProgressTaskBoardTaskFormat ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PlannerProgressTaskBoardTaskFormat> $value
     * @return self
     ...
     * 
     * @param PlannerProgressTaskBoardTaskFormat $item
     * @return self
     */
    public function addValue(PlannerProgressTaskBoardTaskFormat $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PlannerProgressTaskBoardTaskFormat>
     */
