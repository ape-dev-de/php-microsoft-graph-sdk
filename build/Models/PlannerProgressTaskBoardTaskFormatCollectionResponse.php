 ...
 */
class PlannerProgressTaskBoardTaskFormatCollectionResponse
{
    /**
     ...
     * 
     * @param PlannerProgressTaskBoardTaskFormat ...$items Variable number of PlannerProgressTaskBoardTaskFormat items
     * @return self
     */
    public function setValue(PlannerProgressTaskBoardTaskFormat ...$items): self
    {
        $this->value = $items;
        return $this;
    }
