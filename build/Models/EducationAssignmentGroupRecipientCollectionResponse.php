...
/**
 * EducationAssignmentGroupRecipientCollectionResponse - Collection response
 */
class EducationAssignmentGroupRecipientCollectionResponse
{
    /**
     * @var array<int, EducationAssignmentGroupRecipient>
     */
    public array $value = [];
