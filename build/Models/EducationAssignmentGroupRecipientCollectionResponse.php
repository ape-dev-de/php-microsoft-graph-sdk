...
/**
 * Collection response for EducationAssignmentGroupRecipient
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationAssignmentGroupRecipientCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationAssignmentGroupRecipient[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationAssignmentGroupRecipient[] $items
     * @return self
     */
    public function setValue(array|EducationAssignmentGroupRecipient $items, EducationAssignmentGroupRecipient ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationAssignmentGroupRecipient> $value
     * @return self
     ...
     * 
     * @param EducationAssignmentGroupRecipient $item
     * @return self
     */
    public function addValue(EducationAssignmentGroupRecipient $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EducationAssignmentGroupRecipient|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EducationAssignmentGroupRecipient>
     */
