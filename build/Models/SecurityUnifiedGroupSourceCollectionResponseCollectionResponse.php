...
/**
 * Collection response for SecurityUnifiedGroupSourceCollectionResponse
 */
class SecurityUnifiedGroupSourceCollectionResponseCollectionResponse
{
    /**
     * @var SecurityUnifiedGroupSourceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityUnifiedGroupSourceCollectionResponse ...$items Variable number of SecurityUnifiedGroupSourceCollectionResponse items
     * @return self
     */
    public function setValue(SecurityUnifiedGroupSourceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityUnifiedGroupSourceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityUnifiedGroupSourceCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityUnifiedGroupSourceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
