...
/**
 * Collection response for Audio
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AudioCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Audio[]
     */
     ...
     * @return self
     */
    public function setValue(array|Audio $items, Audio ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Audio $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Audio>
     */
