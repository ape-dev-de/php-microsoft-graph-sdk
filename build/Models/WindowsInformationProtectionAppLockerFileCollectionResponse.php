...
/**
 * Collection response for WindowsInformationProtectionAppLockerFile
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsInformationProtectionAppLockerFileCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WindowsInformationProtectionAppLockerFile[] $items
     * @return self
     */
    public function setValue(array|WindowsInformationProtectionAppLockerFile $items, WindowsInformationProtectionAppLockerFile ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsInformationProtectionAppLockerFile> $value
     * @return self
     ...
     * 
     * @param WindowsInformationProtectionAppLockerFile $item
     * @return self
     */
    public function addValue(WindowsInformationProtectionAppLockerFile $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsInformationProtectionAppLockerFile>
     */
