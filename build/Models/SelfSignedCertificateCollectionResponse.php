 ...
 */
class SelfSignedCertificateCollectionResponse
{
    /**
     ...
     * 
     * @param SelfSignedCertificate ...$items Variable number of SelfSignedCertificate items
     * @return self
     */
    public function setValue(SelfSignedCertificate ...$items): self
    {
        $this->value = $items;
        return $this;
    }
