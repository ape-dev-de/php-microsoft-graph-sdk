...
/**
 * Collection response for SelfSignedCertificate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SelfSignedCertificateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SelfSignedCertificate[] $items
     * @return self
     */
    public function setValue(array|SelfSignedCertificate $items, SelfSignedCertificate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SelfSignedCertificate> $value
     * @return self
     ...
     * 
     * @param SelfSignedCertificate $item
     * @return self
     */
    public function addValue(SelfSignedCertificate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SelfSignedCertificate>
     */
