...
/**
 * Collection response for EducationAssignmentResourceCollectionResponse
 */
class EducationAssignmentResourceCollectionResponseCollectionResponse
{
    /**
     * @var EducationAssignmentResourceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationAssignmentResourceCollectionResponse ...$items Variable number of EducationAssignmentResourceCollectionResponse items
     * @return self
     */
    public function setValue(EducationAssignmentResourceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EducationAssignmentResourceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EducationAssignmentResourceCollectionResponse $item
     * @return self
     */
    public function addValue(EducationAssignmentResourceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
