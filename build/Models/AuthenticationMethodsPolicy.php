...
class AuthenticationMethodsPolicy
{
     ...
     * @var string[]
     */
    private array $authenticationMethodConfigurations = [];
    ...
    /**
     * @param string[] $authenticationMethodConfigurations
     */
    public function setAuthenticationMethodConfigurations(array $authenticationMethodConfigurations): self
    {
