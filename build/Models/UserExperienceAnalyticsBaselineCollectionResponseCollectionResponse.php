...
/**
 * Collection response for UserExperienceAnalyticsBaselineCollectionResponse
 */
class UserExperienceAnalyticsBaselineCollectionResponseCollectionResponse
{
    /**
     * @var UserExperienceAnalyticsBaselineCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UserExperienceAnalyticsBaselineCollectionResponse ...$items Variable number of UserExperienceAnalyticsBaselineCollectionResponse items
     * @return self
     */
    public function setValue(UserExperienceAnalyticsBaselineCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UserExperienceAnalyticsBaselineCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsBaselineCollectionResponse $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsBaselineCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
