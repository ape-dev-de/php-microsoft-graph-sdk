...
/**
 * Collection response for OneDriveForBusinessProtectionPolicyCollectionResponse
 */
class OneDriveForBusinessProtectionPolicyCollectionResponseCollectionResponse
{
    /**
     * @var OneDriveForBusinessProtectionPolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param OneDriveForBusinessProtectionPolicyCollectionResponse ...$items Variable number of OneDriveForBusinessProtectionPolicyCollectionResponse items
     * @return self
     */
    public function setValue(OneDriveForBusinessProtectionPolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<OneDriveForBusinessProtectionPolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param OneDriveForBusinessProtectionPolicyCollectionResponse $item
     * @return self
     */
    public function addValue(OneDriveForBusinessProtectionPolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
