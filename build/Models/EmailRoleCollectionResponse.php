...
/**
 * Collection response for EmailRole
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EmailRoleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EmailRole[]
     */
     ...
     * 
     * @param EmailRole[] $items
     * @return self
     */
    public function setValue(array|EmailRole $items, EmailRole ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param EmailRole $item
     * @return self
     */
    public function addValue(EmailRole $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EmailRole>
     */
