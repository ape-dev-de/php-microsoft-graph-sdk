...
/**
 * Collection response for BookingQuestionAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingQuestionAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param BookingQuestionAssignment[] $items
     * @return self
     */
    public function setValue(array|BookingQuestionAssignment $items, BookingQuestionAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingQuestionAssignment> $value
     * @return self
     ...
     * 
     * @param BookingQuestionAssignment $item
     * @return self
     */
    public function addValue(BookingQuestionAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return BookingQuestionAssignment|null
     */
     ...
     * 
     * @return \ArrayIterator<int, BookingQuestionAssignment>
     */
