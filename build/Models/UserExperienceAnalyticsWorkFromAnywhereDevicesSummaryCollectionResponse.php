...
/**
 * Collection response for UserExperienceAnalyticsWorkFromAnywhereDevicesSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsWorkFromAnywhereDevicesSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserExperienceAnalyticsWorkFromAnywhereDevicesSummary[]
     */
    private array $value = [];
     ...
     * 
     * @param UserExperienceAnalyticsWorkFromAnywhereDevicesSummary[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsWorkFromAnywhereDevicesSummary $items, UserExperienceAnalyticsWorkFromAnywhereDevicesSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsWorkFromAnywhereDevicesSummary> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsWorkFromAnywhereDevicesSummary $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsWorkFromAnywhereDevicesSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UserExperienceAnalyticsWorkFromAnywhereDevicesSummary|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsWorkFromAnywhereDevicesSummary>
     */
