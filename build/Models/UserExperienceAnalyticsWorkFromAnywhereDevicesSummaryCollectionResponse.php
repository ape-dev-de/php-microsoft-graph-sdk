...
/**
 * UserExperienceAnalyticsWorkFromAnywhereDevicesSummaryCollectionResponse - Collection response
 */
class UserExperienceAnalyticsWorkFromAnywhereDevicesSummaryCollectionResponse
{
    /**
     * @var array<int, UserExperienceAnalyticsWorkFromAnywhereDevicesSummary>
     */
    public array $value = [];
