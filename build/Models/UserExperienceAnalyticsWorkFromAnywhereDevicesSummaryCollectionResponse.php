 ...
 */
class UserExperienceAnalyticsWorkFromAnywhereDevicesSummaryCollectionResponse
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsWorkFromAnywhereDevicesSummary ...$items Variable number of UserExperienceAnalyticsWorkFromAnywhereDevicesSummary items
     * @return self
     */
    public function setValue(UserExperienceAnalyticsWorkFromAnywhereDevicesSummary ...$items): self
    {
        $this->value = $items;
        return $this;
    }
