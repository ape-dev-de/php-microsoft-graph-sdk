...
/**
 * Collection response for MicrosoftStoreForBusinessAppAssignmentSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MicrosoftStoreForBusinessAppAssignmentSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MicrosoftStoreForBusinessAppAssignmentSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param MicrosoftStoreForBusinessAppAssignmentSettings[] $items
     * @return self
     */
    public function setValue(array|MicrosoftStoreForBusinessAppAssignmentSettings $items, MicrosoftStoreForBusinessAppAssignmentSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MicrosoftStoreForBusinessAppAssignmentSettings> $value
     * @return self
     ...
     * 
     * @param MicrosoftStoreForBusinessAppAssignmentSettings $item
     * @return self
     */
    public function addValue(MicrosoftStoreForBusinessAppAssignmentSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MicrosoftStoreForBusinessAppAssignmentSettings|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MicrosoftStoreForBusinessAppAssignmentSettings>
     */
