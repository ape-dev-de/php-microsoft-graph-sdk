 ...
 */
class MicrosoftStoreForBusinessAppAssignmentSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param MicrosoftStoreForBusinessAppAssignmentSettings ...$items Variable number of MicrosoftStoreForBusinessAppAssignmentSettings items
     * @return self
     */
    public function setValue(MicrosoftStoreForBusinessAppAssignmentSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
