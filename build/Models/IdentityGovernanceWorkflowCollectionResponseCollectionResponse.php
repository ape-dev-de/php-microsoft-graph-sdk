...
/**
 * Collection response for IdentityGovernanceWorkflowCollectionResponse
 */
class IdentityGovernanceWorkflowCollectionResponseCollectionResponse
{
    /**
     * @var IdentityGovernanceWorkflowCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityGovernanceWorkflowCollectionResponse ...$items Variable number of IdentityGovernanceWorkflowCollectionResponse items
     * @return self
     */
    public function setValue(IdentityGovernanceWorkflowCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IdentityGovernanceWorkflowCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceWorkflowCollectionResponse $item
     * @return self
     */
    public function addValue(IdentityGovernanceWorkflowCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
