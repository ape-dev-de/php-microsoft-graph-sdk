...
/**
 * Collection response for SecurityArticleIndicatorCollectionResponse
 */
class SecurityArticleIndicatorCollectionResponseCollectionResponse
{
    /**
     * @var SecurityArticleIndicatorCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityArticleIndicatorCollectionResponse ...$items Variable number of SecurityArticleIndicatorCollectionResponse items
     * @return self
     */
    public function setValue(SecurityArticleIndicatorCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityArticleIndicatorCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityArticleIndicatorCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityArticleIndicatorCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
