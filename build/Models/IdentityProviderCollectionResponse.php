...
/**
 * Collection response for IdentityProvider
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityProviderCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IdentityProvider[] $items
     * @return self
     */
    public function setValue(array|IdentityProvider $items, IdentityProvider ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityProvider> $value
     * @return self
     ...
     * 
     * @param IdentityProvider $item
     * @return self
     */
    public function addValue(IdentityProvider $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityProvider>
     */
