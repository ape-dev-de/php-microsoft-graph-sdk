...
/**
 * Collection response for SigningCertificateUpdateStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SigningCertificateUpdateStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SigningCertificateUpdateStatus[]
     */
    private array $value = [];
     ...
     * 
     * @param SigningCertificateUpdateStatus[] $items
     * @return self
     */
    public function setValue(array|SigningCertificateUpdateStatus $items, SigningCertificateUpdateStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SigningCertificateUpdateStatus> $value
     * @return self
     ...
     * 
     * @param SigningCertificateUpdateStatus $item
     * @return self
     */
    public function addValue(SigningCertificateUpdateStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SigningCertificateUpdateStatus>
     */
