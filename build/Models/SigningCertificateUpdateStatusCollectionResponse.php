 ...
 */
class SigningCertificateUpdateStatusCollectionResponse
{
    /**
     ...
     * 
     * @param SigningCertificateUpdateStatus ...$items Variable number of SigningCertificateUpdateStatus items
     * @return self
     */
    public function setValue(SigningCertificateUpdateStatus ...$items): self
    {
        $this->value = $items;
        return $this;
    }
