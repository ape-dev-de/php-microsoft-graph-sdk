...
/**
 * Collection response for ParticipantJoiningNotification
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ParticipantJoiningNotificationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ParticipantJoiningNotification[]
     */
    private array $value = [];
     ...
     * 
     * @param ParticipantJoiningNotification[] $items
     * @return self
     */
    public function setValue(array|ParticipantJoiningNotification $items, ParticipantJoiningNotification ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ParticipantJoiningNotification> $value
     * @return self
     ...
     * 
     * @param ParticipantJoiningNotification $item
     * @return self
     */
    public function addValue(ParticipantJoiningNotification $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ParticipantJoiningNotification|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ParticipantJoiningNotification>
     */
