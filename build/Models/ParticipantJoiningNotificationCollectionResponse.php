 ...
 */
class ParticipantJoiningNotificationCollectionResponse
{
    /**
     ...
     * 
     * @param ParticipantJoiningNotification ...$items Variable number of ParticipantJoiningNotification items
     * @return self
     */
    public function setValue(ParticipantJoiningNotification ...$items): self
    {
        $this->value = $items;
        return $this;
    }
