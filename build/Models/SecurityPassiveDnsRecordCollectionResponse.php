...
/**
 * Collection response for SecurityPassiveDnsRecord
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityPassiveDnsRecordCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityPassiveDnsRecord[] $items
     * @return self
     */
    public function setValue(array|SecurityPassiveDnsRecord $items, SecurityPassiveDnsRecord ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityPassiveDnsRecord> $value
     * @return self
     ...
     * 
     * @param SecurityPassiveDnsRecord $item
     * @return self
     */
    public function addValue(SecurityPassiveDnsRecord $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityPassiveDnsRecord>
     */
