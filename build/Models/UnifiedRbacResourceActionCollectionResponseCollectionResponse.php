...
/**
 * Collection response for UnifiedRbacResourceActionCollectionResponse
 */
class UnifiedRbacResourceActionCollectionResponseCollectionResponse
{
    /**
     * @var UnifiedRbacResourceActionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedRbacResourceActionCollectionResponse ...$items Variable number of UnifiedRbacResourceActionCollectionResponse items
     * @return self
     */
    public function setValue(UnifiedRbacResourceActionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UnifiedRbacResourceActionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UnifiedRbacResourceActionCollectionResponse $item
     * @return self
     */
    public function addValue(UnifiedRbacResourceActionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
