...
/**
 * Collection response for CurrencyColumn
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CurrencyColumnCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CurrencyColumn[]
     */
     ...
     * 
     * @param CurrencyColumn[] $items
     * @return self
     */
    public function setValue(array|CurrencyColumn $items, CurrencyColumn ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CurrencyColumn> $value
     * @return self
     ...
     * 
     * @param CurrencyColumn $item
     * @return self
     */
    public function addValue(CurrencyColumn $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CurrencyColumn>
     */
