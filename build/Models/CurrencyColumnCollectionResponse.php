 ...
 */
class CurrencyColumnCollectionResponse
{
    /**
     * @var CurrencyColumn[]
     */
     ...
     * 
     * @param CurrencyColumn ...$items Variable number of CurrencyColumn items
     * @return self
     */
    public function setValue(CurrencyColumn ...$items): self
    {
        $this->value = $items;
        return $this;
    }
