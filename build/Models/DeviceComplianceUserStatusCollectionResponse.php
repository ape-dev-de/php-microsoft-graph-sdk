...
/**
 * Collection response for DeviceComplianceUserStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceComplianceUserStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceComplianceUserStatus[] $items
     * @return self
     */
    public function setValue(array|DeviceComplianceUserStatus $items, DeviceComplianceUserStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceComplianceUserStatus> $value
     * @return self
     ...
     * 
     * @param DeviceComplianceUserStatus $item
     * @return self
     */
    public function addValue(DeviceComplianceUserStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceComplianceUserStatus>
     */
