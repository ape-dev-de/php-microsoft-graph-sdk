...
/**
 * Collection response for TeamworkTagCollectionResponse
 */
class TeamworkTagCollectionResponseCollectionResponse
{
    /**
     * @var TeamworkTagCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamworkTagCollectionResponse ...$items Variable number of TeamworkTagCollectionResponse items
     * @return self
     */
    public function setValue(TeamworkTagCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TeamworkTagCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TeamworkTagCollectionResponse $item
     * @return self
     */
    public function addValue(TeamworkTagCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
