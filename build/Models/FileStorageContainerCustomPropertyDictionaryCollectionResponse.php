...
/**
 * FileStorageContainerCustomPropertyDictionaryCollectionResponse - Collection response
 */
class FileStorageContainerCustomPropertyDictionaryCollectionResponse
{
    /**
     * @var array<int, FileStorageContainerCustomPropertyDictionary>
     */
    public array $value = [];
