...
/**
 * Collection response for FileStorageContainerCustomPropertyDictionary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FileStorageContainerCustomPropertyDictionaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FileStorageContainerCustomPropertyDictionary[]
     */
    private array $value = [];
     ...
     * 
     * @param FileStorageContainerCustomPropertyDictionary[] $items
     * @return self
     */
    public function setValue(array|FileStorageContainerCustomPropertyDictionary $items, FileStorageContainerCustomPropertyDictionary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FileStorageContainerCustomPropertyDictionary> $value
     * @return self
     ...
     * 
     * @param FileStorageContainerCustomPropertyDictionary $item
     * @return self
     */
    public function addValue(FileStorageContainerCustomPropertyDictionary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FileStorageContainerCustomPropertyDictionary>
     */
