 ...
 */
class EmployeeExperienceUserCollectionResponse
{
    /**
     ...
     * 
     * @param EmployeeExperienceUser ...$items Variable number of EmployeeExperienceUser items
     * @return self
     */
    public function setValue(EmployeeExperienceUser ...$items): self
    {
        $this->value = $items;
        return $this;
    }
