...
/**
 * Collection response for EmployeeExperienceUser
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EmployeeExperienceUserCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EmployeeExperienceUser[]
     */
    private array $value = [];
     ...
     * 
     * @param EmployeeExperienceUser[] $items
     * @return self
     */
    public function setValue(array|EmployeeExperienceUser $items, EmployeeExperienceUser ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EmployeeExperienceUser> $value
     * @return self
     ...
     * 
     * @param EmployeeExperienceUser $item
     * @return self
     */
    public function addValue(EmployeeExperienceUser $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EmployeeExperienceUser>
     */
