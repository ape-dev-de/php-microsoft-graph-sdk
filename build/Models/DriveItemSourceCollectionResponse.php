...
/**
 * Collection response for DriveItemSource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DriveItemSourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DriveItemSource[]
     */
     ...
     * 
     * @param DriveItemSource[] $items
     * @return self
     */
    public function setValue(array|DriveItemSource $items, DriveItemSource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DriveItemSource> $value
     * @return self
     ...
     * 
     * @param DriveItemSource $item
     * @return self
     */
    public function addValue(DriveItemSource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DriveItemSource>
     */
