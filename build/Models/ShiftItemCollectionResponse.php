...
/**
 * Collection response for ShiftItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ShiftItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ShiftItem[]
     */
     ...
     * 
     * @param ShiftItem[] $items
     * @return self
     */
    public function setValue(array|ShiftItem $items, ShiftItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param ShiftItem $item
     * @return self
     */
    public function addValue(ShiftItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ShiftItem>
     */
