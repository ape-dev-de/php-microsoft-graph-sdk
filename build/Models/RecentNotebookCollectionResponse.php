...
/**
 * Collection response for RecentNotebook
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RecentNotebookCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RecentNotebook[]
     */
     ...
     * 
     * @param RecentNotebook[] $items
     * @return self
     */
    public function setValue(array|RecentNotebook $items, RecentNotebook ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RecentNotebook> $value
     * @return self
     ...
     * 
     * @param RecentNotebook $item
     * @return self
     */
    public function addValue(RecentNotebook $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RecentNotebook>
     */
