 ...
 */
class RecentNotebookCollectionResponse
{
    /**
     * @var RecentNotebook[]
     */
     ...
     * 
     * @param RecentNotebook ...$items Variable number of RecentNotebook items
     * @return self
     */
    public function setValue(RecentNotebook ...$items): self
    {
        $this->value = $items;
        return $this;
    }
