...
/**
 * Collection response for UnmuteParticipantOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnmuteParticipantOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UnmuteParticipantOperation[] $items
     * @return self
     */
    public function setValue(array|UnmuteParticipantOperation $items, UnmuteParticipantOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnmuteParticipantOperation> $value
     * @return self
     ...
     * 
     * @param UnmuteParticipantOperation $item
     * @return self
     */
    public function addValue(UnmuteParticipantOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UnmuteParticipantOperation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UnmuteParticipantOperation>
     */
