...
/**
 * Collection response for RoleEligibilityScheduleRequestFilterByCurrentUserOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RoleEligibilityScheduleRequestFilterByCurrentUserOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RoleEligibilityScheduleRequestFilterByCurrentUserOptions[]
     */
    private array $value = [];
     ...
     * 
     * @return RoleEligibilityScheduleRequestFilterByCurrentUserOptions[]
     */
     ...
     * 
     * @param RoleEligibilityScheduleRequestFilterByCurrentUserOptions[] $items
     * @return self
     */
    public function setValue(array|RoleEligibilityScheduleRequestFilterByCurrentUserOptions $items, RoleEligibilityScheduleRequestFilterByCurrentUserOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RoleEligibilityScheduleRequestFilterByCurrentUserOptions> $value
     * @return self
     ...
     * 
     * @param RoleEligibilityScheduleRequestFilterByCurrentUserOptions $item
     * @return self
     */
    public function addValue(RoleEligibilityScheduleRequestFilterByCurrentUserOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return RoleEligibilityScheduleRequestFilterByCurrentUserOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, RoleEligibilityScheduleRequestFilterByCurrentUserOptions>
     */
