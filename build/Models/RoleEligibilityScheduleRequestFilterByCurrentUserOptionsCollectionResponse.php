...
/**
 * RoleEligibilityScheduleRequestFilterByCurrentUserOptionsCollectionResponse - Collection response
 */
class RoleEligibilityScheduleRequestFilterByCurrentUserOptionsCollectionResponse
{
    /**
     * @var array<int, RoleEligibilityScheduleRequestFilterByCurrentUserOptions>
     */
    public array $value = [];
