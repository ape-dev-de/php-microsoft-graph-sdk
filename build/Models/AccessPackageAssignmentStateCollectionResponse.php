...
/**
 * AccessPackageAssignmentStateCollectionResponse - Collection response
 */
class AccessPackageAssignmentStateCollectionResponse
{
    /**
     * @var array<int, AccessPackageAssignmentState>
     */
    public array $value = [];
