...
/**
 * Collection response for AccessPackageAssignmentState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageAssignmentStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageAssignmentState[]
     */
    private array $value = [];
     ...
     * 
     * @return AccessPackageAssignmentState[]
     */
     ...
     * 
     * @param AccessPackageAssignmentState[] $items
     * @return self
     */
    public function setValue(array|AccessPackageAssignmentState $items, AccessPackageAssignmentState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageAssignmentState> $value
     * @return self
     ...
     * 
     * @param AccessPackageAssignmentState $item
     * @return self
     */
    public function addValue(AccessPackageAssignmentState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageAssignmentState>
     */
