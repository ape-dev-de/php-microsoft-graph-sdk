...
/**
 * Collection response for TeamsTab
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamsTabCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamsTab[]
     */
     ...
     * 
     * @param TeamsTab[] $items
     * @return self
     */
    public function setValue(array|TeamsTab $items, TeamsTab ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(TeamsTab $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamsTab>
     */
