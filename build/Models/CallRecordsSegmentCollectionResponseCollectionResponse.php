...
/**
 * Collection response for CallRecordsSegmentCollectionResponse
 */
class CallRecordsSegmentCollectionResponseCollectionResponse
{
    /**
     * @var CallRecordsSegmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CallRecordsSegmentCollectionResponse ...$items Variable number of CallRecordsSegmentCollectionResponse items
     * @return self
     */
    public function setValue(CallRecordsSegmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CallRecordsSegmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CallRecordsSegmentCollectionResponse $item
     * @return self
     */
    public function addValue(CallRecordsSegmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
