...
/**
 * Collection response for CallRecordsUserAgent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsUserAgentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsUserAgent[]
     */
    private array $value = [];
     ...
     * 
     * @param CallRecordsUserAgent[] $items
     * @return self
     */
    public function setValue(array|CallRecordsUserAgent $items, CallRecordsUserAgent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsUserAgent> $value
     * @return self
     ...
     * 
     * @param CallRecordsUserAgent $item
     * @return self
     */
    public function addValue(CallRecordsUserAgent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsUserAgent|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsUserAgent>
     */
