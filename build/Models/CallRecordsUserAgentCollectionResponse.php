 ...
 */
class CallRecordsUserAgentCollectionResponse
{
    /**
     ...
     * 
     * @param CallRecordsUserAgent ...$items Variable number of CallRecordsUserAgent items
     * @return self
     */
    public function setValue(CallRecordsUserAgent ...$items): self
    {
        $this->value = $items;
        return $this;
    }
