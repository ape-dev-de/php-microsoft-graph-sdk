 ...
 */
class ExpirationPatternCollectionResponse
{
    /**
     ...
     * 
     * @param ExpirationPattern ...$items Variable number of ExpirationPattern items
     * @return self
     */
    public function setValue(ExpirationPattern ...$items): self
    {
        $this->value = $items;
        return $this;
    }
