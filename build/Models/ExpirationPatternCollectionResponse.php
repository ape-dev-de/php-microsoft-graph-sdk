...
/**
 * Collection response for ExpirationPattern
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExpirationPatternCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExpirationPattern[]
     */
    private array $value = [];
     ...
     * 
     * @param ExpirationPattern[] $items
     * @return self
     */
    public function setValue(array|ExpirationPattern $items, ExpirationPattern ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExpirationPattern> $value
     * @return self
     ...
     * 
     * @param ExpirationPattern $item
     * @return self
     */
    public function addValue(ExpirationPattern $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ExpirationPattern>
     */
