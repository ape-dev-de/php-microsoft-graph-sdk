...
/**
 * ChatMessagePolicyViolationUserActionTypesCollectionResponse - Collection response
 */
class ChatMessagePolicyViolationUserActionTypesCollectionResponse
{
    /**
     * @var array<int, ChatMessagePolicyViolationUserActionTypes>
     */
    public array $value = [];
