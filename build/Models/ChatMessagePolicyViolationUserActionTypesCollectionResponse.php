...
/**
 * Collection response for ChatMessagePolicyViolationUserActionTypes
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatMessagePolicyViolationUserActionTypesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ChatMessagePolicyViolationUserActionTypes[] $items
     * @return self
     */
    public function setValue(array|ChatMessagePolicyViolationUserActionTypes $items, ChatMessagePolicyViolationUserActionTypes ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChatMessagePolicyViolationUserActionTypes> $value
     * @return self
     ...
     * 
     * @param ChatMessagePolicyViolationUserActionTypes $item
     * @return self
     */
    public function addValue(ChatMessagePolicyViolationUserActionTypes $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChatMessagePolicyViolationUserActionTypes>
     */
