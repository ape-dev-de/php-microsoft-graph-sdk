 ...
 */
class LicenseProcessingStateCollectionResponse
{
    /**
     ...
     * 
     * @param LicenseProcessingState ...$items Variable number of LicenseProcessingState items
     * @return self
     */
    public function setValue(LicenseProcessingState ...$items): self
    {
        $this->value = $items;
        return $this;
    }
