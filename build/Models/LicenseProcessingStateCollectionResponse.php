...
/**
 * Collection response for LicenseProcessingState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LicenseProcessingStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param LicenseProcessingState[] $items
     * @return self
     */
    public function setValue(array|LicenseProcessingState $items, LicenseProcessingState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LicenseProcessingState> $value
     * @return self
     ...
     * 
     * @param LicenseProcessingState $item
     * @return self
     */
    public function addValue(LicenseProcessingState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LicenseProcessingState>
     */
