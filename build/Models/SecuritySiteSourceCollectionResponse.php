...
/**
 * Collection response for SecuritySiteSource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecuritySiteSourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecuritySiteSource[] $items
     * @return self
     */
    public function setValue(array|SecuritySiteSource $items, SecuritySiteSource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecuritySiteSource> $value
     * @return self
     ...
     * 
     * @param SecuritySiteSource $item
     * @return self
     */
    public function addValue(SecuritySiteSource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecuritySiteSource>
     */
