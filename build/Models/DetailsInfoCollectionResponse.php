...
/**
 * Collection response for DetailsInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DetailsInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DetailsInfo[]
     */
     ...
     * 
     * @param DetailsInfo[] $items
     * @return self
     */
    public function setValue(array|DetailsInfo $items, DetailsInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param DetailsInfo $item
     * @return self
     */
    public function addValue(DetailsInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DetailsInfo>
     */
