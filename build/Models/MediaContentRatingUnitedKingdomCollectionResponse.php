...
/**
 * Collection response for MediaContentRatingUnitedKingdom
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MediaContentRatingUnitedKingdomCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MediaContentRatingUnitedKingdom[] $items
     * @return self
     */
    public function setValue(array|MediaContentRatingUnitedKingdom $items, MediaContentRatingUnitedKingdom ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MediaContentRatingUnitedKingdom> $value
     * @return self
     ...
     * 
     * @param MediaContentRatingUnitedKingdom $item
     * @return self
     */
    public function addValue(MediaContentRatingUnitedKingdom $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MediaContentRatingUnitedKingdom>
     */
