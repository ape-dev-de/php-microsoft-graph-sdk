 ...
 */
class MediaContentRatingUnitedKingdomCollectionResponse
{
    /**
     ...
     * 
     * @param MediaContentRatingUnitedKingdom ...$items Variable number of MediaContentRatingUnitedKingdom items
     * @return self
     */
    public function setValue(MediaContentRatingUnitedKingdom ...$items): self
    {
        $this->value = $items;
        return $this;
    }
