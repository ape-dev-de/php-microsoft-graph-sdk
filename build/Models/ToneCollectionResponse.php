...
/**
 * Collection response for Tone
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ToneCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Tone[]
     */
     ...
     * @return self
     */
    public function setValue(array|Tone $items, Tone ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Tone $item): self
    {
        $this->value[] = $item;
        return $this;
    }
