...
/**
 * Collection response for RestrictionAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RestrictionActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RestrictionAction[]
     */
    private array $value = [];
     ...
     * 
     * @param RestrictionAction[] $items
     * @return self
     */
    public function setValue(array|RestrictionAction $items, RestrictionAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RestrictionAction> $value
     * @return self
     ...
     * 
     * @param RestrictionAction $item
     * @return self
     */
    public function addValue(RestrictionAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RestrictionAction>
     */
