...
/**
 * Collection response for ChannelRenamedEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChannelRenamedEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChannelRenamedEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param ChannelRenamedEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|ChannelRenamedEventMessageDetail $items, ChannelRenamedEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChannelRenamedEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param ChannelRenamedEventMessageDetail $item
     * @return self
     */
    public function addValue(ChannelRenamedEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ChannelRenamedEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ChannelRenamedEventMessageDetail>
     */
