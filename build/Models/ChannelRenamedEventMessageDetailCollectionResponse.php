 ...
 */
class ChannelRenamedEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param ChannelRenamedEventMessageDetail ...$items Variable number of ChannelRenamedEventMessageDetail items
     * @return self
     */
    public function setValue(ChannelRenamedEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
