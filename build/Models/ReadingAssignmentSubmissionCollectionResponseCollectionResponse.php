...
/**
 * Collection response for ReadingAssignmentSubmissionCollectionResponse
 */
class ReadingAssignmentSubmissionCollectionResponseCollectionResponse
{
    /**
     * @var ReadingAssignmentSubmissionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ReadingAssignmentSubmissionCollectionResponse ...$items Variable number of ReadingAssignmentSubmissionCollectionResponse items
     * @return self
     */
    public function setValue(ReadingAssignmentSubmissionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ReadingAssignmentSubmissionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ReadingAssignmentSubmissionCollectionResponse $item
     * @return self
     */
    public function addValue(ReadingAssignmentSubmissionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
