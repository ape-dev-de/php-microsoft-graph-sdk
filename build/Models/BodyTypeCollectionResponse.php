...
/**
 * Collection response for BodyType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BodyTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BodyType[]
     */
     ...
     * 
     * @param BodyType[] $items
     * @return self
     */
    public function setValue(array|BodyType $items, BodyType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(BodyType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BodyType>
     */
