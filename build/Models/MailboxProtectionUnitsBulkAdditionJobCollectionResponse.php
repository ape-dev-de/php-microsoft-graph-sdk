...
/**
 * MailboxProtectionUnitsBulkAdditionJobCollectionResponse - Collection response
 */
class MailboxProtectionUnitsBulkAdditionJobCollectionResponse
{
    /**
     * @var array<int, MailboxProtectionUnitsBulkAdditionJob>
     */
    public array $value = [];
