...
/**
 * Collection response for MailboxProtectionUnitsBulkAdditionJob
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MailboxProtectionUnitsBulkAdditionJobCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MailboxProtectionUnitsBulkAdditionJob[] $items
     * @return self
     */
    public function setValue(array|MailboxProtectionUnitsBulkAdditionJob $items, MailboxProtectionUnitsBulkAdditionJob ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MailboxProtectionUnitsBulkAdditionJob> $value
     * @return self
     ...
     * 
     * @param MailboxProtectionUnitsBulkAdditionJob $item
     * @return self
     */
    public function addValue(MailboxProtectionUnitsBulkAdditionJob $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MailboxProtectionUnitsBulkAdditionJob>
     */
