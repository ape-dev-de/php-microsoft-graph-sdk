...
/**
 * Collection response for ListItemCollectionResponse
 */
class ListItemCollectionResponseCollectionResponse
{
    /**
     ...
     * 
     * @param ListItemCollectionResponse ...$items Variable number of ListItemCollectionResponse items
     * @return self
     */
    public function setValue(ListItemCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ListItemCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ListItemCollectionResponse $item
     * @return self
     */
    public function addValue(ListItemCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
