...
/**
 * Collection response for SearchAggregationCollectionResponse
 */
class SearchAggregationCollectionResponseCollectionResponse
{
    /**
     * @var SearchAggregationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SearchAggregationCollectionResponse ...$items Variable number of SearchAggregationCollectionResponse items
     * @return self
     */
    public function setValue(SearchAggregationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SearchAggregationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SearchAggregationCollectionResponse $item
     * @return self
     */
    public function addValue(SearchAggregationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
