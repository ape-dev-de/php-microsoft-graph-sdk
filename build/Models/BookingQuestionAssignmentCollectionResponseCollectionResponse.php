...
/**
 * Collection response for BookingQuestionAssignmentCollectionResponse
 */
class BookingQuestionAssignmentCollectionResponseCollectionResponse
{
    /**
     * @var BookingQuestionAssignmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BookingQuestionAssignmentCollectionResponse ...$items Variable number of BookingQuestionAssignmentCollectionResponse items
     * @return self
     */
    public function setValue(BookingQuestionAssignmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<BookingQuestionAssignmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param BookingQuestionAssignmentCollectionResponse $item
     * @return self
     */
    public function addValue(BookingQuestionAssignmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
