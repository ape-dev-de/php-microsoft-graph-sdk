...
/**
 * Collection response for TeamworkUserIdentityCollectionResponse
 */
class TeamworkUserIdentityCollectionResponseCollectionResponse
{
    /**
     * @var TeamworkUserIdentityCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamworkUserIdentityCollectionResponse ...$items Variable number of TeamworkUserIdentityCollectionResponse items
     * @return self
     */
    public function setValue(TeamworkUserIdentityCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TeamworkUserIdentityCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TeamworkUserIdentityCollectionResponse $item
     * @return self
     */
    public function addValue(TeamworkUserIdentityCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
