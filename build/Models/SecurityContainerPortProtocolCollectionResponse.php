...
/**
 * SecurityContainerPortProtocolCollectionResponse - Collection response
 */
class SecurityContainerPortProtocolCollectionResponse
{
    /**
     * @var array<int, SecurityContainerPortProtocol>
     */
    public array $value = [];
