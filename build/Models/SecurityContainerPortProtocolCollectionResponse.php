...
/**
 * Collection response for SecurityContainerPortProtocol
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityContainerPortProtocolCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityContainerPortProtocol[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityContainerPortProtocol[]
     */
     ...
     * 
     * @param SecurityContainerPortProtocol[] $items
     * @return self
     */
    public function setValue(array|SecurityContainerPortProtocol $items, SecurityContainerPortProtocol ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityContainerPortProtocol> $value
     * @return self
     ...
     * 
     * @param SecurityContainerPortProtocol $item
     * @return self
     */
    public function addValue(SecurityContainerPortProtocol $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityContainerPortProtocol|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityContainerPortProtocol>
     */
