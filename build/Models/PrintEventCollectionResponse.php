...
/**
 * Collection response for PrintEvent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintEventCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrintEvent[]
     */
     ...
     * 
     * @param PrintEvent[] $items
     * @return self
     */
    public function setValue(array|PrintEvent $items, PrintEvent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param PrintEvent $item
     * @return self
     */
    public function addValue(PrintEvent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintEvent>
     */
