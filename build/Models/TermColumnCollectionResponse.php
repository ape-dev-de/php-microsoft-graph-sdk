...
/**
 * Collection response for TermColumn
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TermColumnCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TermColumn[]
     */
     ...
     * 
     * @param TermColumn[] $items
     * @return self
     */
    public function setValue(array|TermColumn $items, TermColumn ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param TermColumn $item
     * @return self
     */
    public function addValue(TermColumn $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TermColumn>
     */
