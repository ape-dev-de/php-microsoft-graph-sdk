...
/**
 * Collection response for KeyValueCollectionResponse
 */
class KeyValueCollectionResponseCollectionResponse
{
    /**
     * @var KeyValueCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param KeyValueCollectionResponse ...$items Variable number of KeyValueCollectionResponse items
     * @return self
     */
    public function setValue(KeyValueCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<KeyValueCollectionResponse> $value
     * @return self
     ...
     * 
     * @param KeyValueCollectionResponse $item
     * @return self
     */
    public function addValue(KeyValueCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
