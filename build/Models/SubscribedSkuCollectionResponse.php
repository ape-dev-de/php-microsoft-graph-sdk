...
/**
 * Collection response for SubscribedSku
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SubscribedSkuCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SubscribedSku[]
     */
     ...
     * 
     * @param SubscribedSku[] $items
     * @return self
     */
    public function setValue(array|SubscribedSku $items, SubscribedSku ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SubscribedSku> $value
     * @return self
     ...
     * 
     * @param SubscribedSku $item
     * @return self
     */
    public function addValue(SubscribedSku $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SubscribedSku>
     */
