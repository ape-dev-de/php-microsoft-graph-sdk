...
/**
 * Collection response for WorkbookWorksheetCollectionResponse
 */
class WorkbookWorksheetCollectionResponseCollectionResponse
{
    /**
     * @var WorkbookWorksheetCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookWorksheetCollectionResponse ...$items Variable number of WorkbookWorksheetCollectionResponse items
     * @return self
     */
    public function setValue(WorkbookWorksheetCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WorkbookWorksheetCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WorkbookWorksheetCollectionResponse $item
     * @return self
     */
    public function addValue(WorkbookWorksheetCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
