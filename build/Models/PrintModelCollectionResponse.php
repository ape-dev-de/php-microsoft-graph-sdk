...
/**
 * Collection response for PrintModel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintModelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrintModel[]
     */
     ...
     * 
     * @param PrintModel[] $items
     * @return self
     */
    public function setValue(array|PrintModel $items, PrintModel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param PrintModel $item
     * @return self
     */
    public function addValue(PrintModel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintModel>
     */
