...
/**
 * Collection response for DomainDnsMxRecordCollectionResponse
 */
class DomainDnsMxRecordCollectionResponseCollectionResponse
{
    /**
     * @var DomainDnsMxRecordCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DomainDnsMxRecordCollectionResponse ...$items Variable number of DomainDnsMxRecordCollectionResponse items
     * @return self
     */
    public function setValue(DomainDnsMxRecordCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DomainDnsMxRecordCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DomainDnsMxRecordCollectionResponse $item
     * @return self
     */
    public function addValue(DomainDnsMxRecordCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
