...
/**
 * Collection response for PhysicalAddressCollectionResponse
 */
class PhysicalAddressCollectionResponseCollectionResponse
{
    /**
     * @var PhysicalAddressCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PhysicalAddressCollectionResponse ...$items Variable number of PhysicalAddressCollectionResponse items
     * @return self
     */
    public function setValue(PhysicalAddressCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PhysicalAddressCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PhysicalAddressCollectionResponse $item
     * @return self
     */
    public function addValue(PhysicalAddressCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
