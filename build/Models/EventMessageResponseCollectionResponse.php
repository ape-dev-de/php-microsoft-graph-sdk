...
/**
 * Collection response for EventMessageResponse
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EventMessageResponseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EventMessageResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EventMessageResponse[] $items
     * @return self
     */
    public function setValue(array|EventMessageResponse $items, EventMessageResponse ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EventMessageResponse> $value
     * @return self
     ...
     * 
     * @param EventMessageResponse $item
     * @return self
     */
    public function addValue(EventMessageResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EventMessageResponse|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EventMessageResponse>
     */
