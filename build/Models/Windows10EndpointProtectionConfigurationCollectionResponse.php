...
/**
 * Collection response for Windows10EndpointProtectionConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Windows10EndpointProtectionConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Windows10EndpointProtectionConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param Windows10EndpointProtectionConfiguration[] $items
     * @return self
     */
    public function setValue(array|Windows10EndpointProtectionConfiguration $items, Windows10EndpointProtectionConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Windows10EndpointProtectionConfiguration> $value
     * @return self
     ...
     * 
     * @param Windows10EndpointProtectionConfiguration $item
     * @return self
     */
    public function addValue(Windows10EndpointProtectionConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return Windows10EndpointProtectionConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, Windows10EndpointProtectionConfiguration>
     */
