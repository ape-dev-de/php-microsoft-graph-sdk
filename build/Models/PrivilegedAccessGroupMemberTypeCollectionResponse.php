...
/**
 * PrivilegedAccessGroupMemberTypeCollectionResponse - Collection response
 */
class PrivilegedAccessGroupMemberTypeCollectionResponse
{
    /**
     * @var array<int, PrivilegedAccessGroupMemberType>
     */
    public array $value = [];
