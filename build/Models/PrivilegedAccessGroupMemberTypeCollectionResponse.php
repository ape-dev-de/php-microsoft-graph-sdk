...
/**
 * Collection response for PrivilegedAccessGroupMemberType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrivilegedAccessGroupMemberTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrivilegedAccessGroupMemberType[]
     */
    private array $value = [];
     ...
     * 
     * @return PrivilegedAccessGroupMemberType[]
     */
     ...
     * 
     * @param PrivilegedAccessGroupMemberType[] $items
     * @return self
     */
    public function setValue(array|PrivilegedAccessGroupMemberType $items, PrivilegedAccessGroupMemberType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrivilegedAccessGroupMemberType> $value
     * @return self
     ...
     * 
     * @param PrivilegedAccessGroupMemberType $item
     * @return self
     */
    public function addValue(PrivilegedAccessGroupMemberType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrivilegedAccessGroupMemberType>
     */
