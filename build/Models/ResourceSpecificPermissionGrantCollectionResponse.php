...
/**
 * Collection response for ResourceSpecificPermissionGrant
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ResourceSpecificPermissionGrantCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ResourceSpecificPermissionGrant[] $items
     * @return self
     */
    public function setValue(array|ResourceSpecificPermissionGrant $items, ResourceSpecificPermissionGrant ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ResourceSpecificPermissionGrant> $value
     * @return self
     ...
     * 
     * @param ResourceSpecificPermissionGrant $item
     * @return self
     */
    public function addValue(ResourceSpecificPermissionGrant $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ResourceSpecificPermissionGrant>
     */
