 ...
 */
class IdentityGovernanceCollectionResponse
{
    /**
     ...
     * 
     * @param IdentityGovernance ...$items Variable number of IdentityGovernance items
     * @return self
     */
    public function setValue(IdentityGovernance ...$items): self
    {
        $this->value = $items;
        return $this;
    }
