...
/**
 * Collection response for IdentityGovernance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernance[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityGovernance[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernance $items, IdentityGovernance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernance> $value
     * @return self
     ...
     * 
     * @param IdentityGovernance $item
     * @return self
     */
    public function addValue(IdentityGovernance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernance>
     */
