...
/**
 * Collection response for EducationAssignmentResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationAssignmentResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param EducationAssignmentResource[] $items
     * @return self
     */
    public function setValue(array|EducationAssignmentResource $items, EducationAssignmentResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationAssignmentResource> $value
     * @return self
     ...
     * 
     * @param EducationAssignmentResource $item
     * @return self
     */
    public function addValue(EducationAssignmentResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationAssignmentResource>
     */
