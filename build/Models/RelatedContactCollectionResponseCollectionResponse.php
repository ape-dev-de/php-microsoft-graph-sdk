...
/**
 * Collection response for RelatedContactCollectionResponse
 */
class RelatedContactCollectionResponseCollectionResponse
{
    /**
     * @var RelatedContactCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RelatedContactCollectionResponse ...$items Variable number of RelatedContactCollectionResponse items
     * @return self
     */
    public function setValue(RelatedContactCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RelatedContactCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RelatedContactCollectionResponse $item
     * @return self
     */
    public function addValue(RelatedContactCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
