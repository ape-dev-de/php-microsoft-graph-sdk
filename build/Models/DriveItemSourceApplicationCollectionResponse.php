...
/**
 * Collection response for DriveItemSourceApplication
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DriveItemSourceApplicationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return DriveItemSourceApplication[]
     */
     ...
     * 
     * @param DriveItemSourceApplication[] $items
     * @return self
     */
    public function setValue(array|DriveItemSourceApplication $items, DriveItemSourceApplication ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DriveItemSourceApplication> $value
     * @return self
     ...
     * 
     * @param DriveItemSourceApplication $item
     * @return self
     */
    public function addValue(DriveItemSourceApplication $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DriveItemSourceApplication>
     */
