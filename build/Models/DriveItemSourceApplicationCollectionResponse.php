...
/**
 * DriveItemSourceApplicationCollectionResponse - Collection response
 */
class DriveItemSourceApplicationCollectionResponse
{
    /**
     * @var array<int, DriveItemSourceApplication>
     */
    public array $value = [];
