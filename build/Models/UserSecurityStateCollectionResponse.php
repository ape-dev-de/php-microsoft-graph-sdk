...
/**
 * Collection response for UserSecurityState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserSecurityStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserSecurityState[]
     */
    private array $value = [];
     ...
     * 
     * @param UserSecurityState[] $items
     * @return self
     */
    public function setValue(array|UserSecurityState $items, UserSecurityState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserSecurityState> $value
     * @return self
     ...
     * 
     * @param UserSecurityState $item
     * @return self
     */
    public function addValue(UserSecurityState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserSecurityState>
     */
