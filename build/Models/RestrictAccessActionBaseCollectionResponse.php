...
/**
 * Collection response for RestrictAccessActionBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RestrictAccessActionBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RestrictAccessActionBase[]
     */
    private array $value = [];
     ...
     * 
     * @param RestrictAccessActionBase[] $items
     * @return self
     */
    public function setValue(array|RestrictAccessActionBase $items, RestrictAccessActionBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RestrictAccessActionBase> $value
     * @return self
     ...
     * 
     * @param RestrictAccessActionBase $item
     * @return self
     */
    public function addValue(RestrictAccessActionBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return RestrictAccessActionBase|null
     */
     ...
     * 
     * @return \ArrayIterator<int, RestrictAccessActionBase>
     */
