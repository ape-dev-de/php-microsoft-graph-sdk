 ...
 */
class RestrictAccessActionBaseCollectionResponse
{
    /**
     ...
     * 
     * @param RestrictAccessActionBase ...$items Variable number of RestrictAccessActionBase items
     * @return self
     */
    public function setValue(RestrictAccessActionBase ...$items): self
    {
        $this->value = $items;
        return $this;
    }
