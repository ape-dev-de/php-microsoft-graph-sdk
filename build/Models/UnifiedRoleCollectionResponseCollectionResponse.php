...
/**
 * Collection response for UnifiedRoleCollectionResponse
 */
class UnifiedRoleCollectionResponseCollectionResponse
{
    /**
     * @var UnifiedRoleCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedRoleCollectionResponse ...$items Variable number of UnifiedRoleCollectionResponse items
     * @return self
     */
    public function setValue(UnifiedRoleCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UnifiedRoleCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleCollectionResponse $item
     * @return self
     */
    public function addValue(UnifiedRoleCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
