...
/**
 * Collection response for BitlockerRecoveryKeyCollectionResponse
 */
class BitlockerRecoveryKeyCollectionResponseCollectionResponse
{
    /**
     * @var BitlockerRecoveryKeyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BitlockerRecoveryKeyCollectionResponse ...$items Variable number of BitlockerRecoveryKeyCollectionResponse items
     * @return self
     */
    public function setValue(BitlockerRecoveryKeyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<BitlockerRecoveryKeyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param BitlockerRecoveryKeyCollectionResponse $item
     * @return self
     */
    public function addValue(BitlockerRecoveryKeyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
