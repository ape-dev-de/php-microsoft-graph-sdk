 ...
 */
class DriveItemUploadablePropertiesCollectionResponse
{
    /**
     ...
     * 
     * @param DriveItemUploadableProperties ...$items Variable number of DriveItemUploadableProperties items
     * @return self
     */
    public function setValue(DriveItemUploadableProperties ...$items): self
    {
        $this->value = $items;
        return $this;
    }
