...
/**
 * Collection response for DriveItemUploadableProperties
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DriveItemUploadablePropertiesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DriveItemUploadableProperties[]
     */
    private array $value = [];
     ...
     * 
     * @param DriveItemUploadableProperties[] $items
     * @return self
     */
    public function setValue(array|DriveItemUploadableProperties $items, DriveItemUploadableProperties ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DriveItemUploadableProperties> $value
     * @return self
     ...
     * 
     * @param DriveItemUploadableProperties $item
     * @return self
     */
    public function addValue(DriveItemUploadableProperties $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DriveItemUploadableProperties>
     */
