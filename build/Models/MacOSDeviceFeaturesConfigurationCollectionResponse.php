...
/**
 * Collection response for MacOSDeviceFeaturesConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MacOSDeviceFeaturesConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MacOSDeviceFeaturesConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param MacOSDeviceFeaturesConfiguration[] $items
     * @return self
     */
    public function setValue(array|MacOSDeviceFeaturesConfiguration $items, MacOSDeviceFeaturesConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MacOSDeviceFeaturesConfiguration> $value
     * @return self
     ...
     * 
     * @param MacOSDeviceFeaturesConfiguration $item
     * @return self
     */
    public function addValue(MacOSDeviceFeaturesConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MacOSDeviceFeaturesConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MacOSDeviceFeaturesConfiguration>
     */
