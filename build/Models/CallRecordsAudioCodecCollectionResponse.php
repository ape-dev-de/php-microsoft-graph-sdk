...
/**
 * Collection response for CallRecordsAudioCodec
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsAudioCodecCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsAudioCodec[]
     */
    private array $value = [];
     ...
     * 
     * @param CallRecordsAudioCodec[] $items
     * @return self
     */
    public function setValue(array|CallRecordsAudioCodec $items, CallRecordsAudioCodec ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsAudioCodec> $value
     * @return self
     ...
     * 
     * @param CallRecordsAudioCodec $item
     * @return self
     */
    public function addValue(CallRecordsAudioCodec $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsAudioCodec|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsAudioCodec>
     */
