...
/**
 * Collection response for TeamsAppRemovedEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamsAppRemovedEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamsAppRemovedEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamsAppRemovedEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|TeamsAppRemovedEventMessageDetail $items, TeamsAppRemovedEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamsAppRemovedEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param TeamsAppRemovedEventMessageDetail $item
     * @return self
     */
    public function addValue(TeamsAppRemovedEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TeamsAppRemovedEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TeamsAppRemovedEventMessageDetail>
     */
