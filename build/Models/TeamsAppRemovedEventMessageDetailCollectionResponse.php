 ...
 */
class TeamsAppRemovedEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param TeamsAppRemovedEventMessageDetail ...$items Variable number of TeamsAppRemovedEventMessageDetail items
     * @return self
     */
    public function setValue(TeamsAppRemovedEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
