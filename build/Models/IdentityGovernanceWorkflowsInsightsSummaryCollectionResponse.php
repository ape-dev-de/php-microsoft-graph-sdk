...
/**
 * Collection response for IdentityGovernanceWorkflowsInsightsSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceWorkflowsInsightsSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceWorkflowsInsightsSummary[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceWorkflowsInsightsSummary[]
     */
     ...
     * 
     * @param IdentityGovernanceWorkflowsInsightsSummary[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceWorkflowsInsightsSummary $items, IdentityGovernanceWorkflowsInsightsSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceWorkflowsInsightsSummary> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceWorkflowsInsightsSummary $item
     * @return self
     */
    public function addValue(IdentityGovernanceWorkflowsInsightsSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceWorkflowsInsightsSummary|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceWorkflowsInsightsSummary>
     */
