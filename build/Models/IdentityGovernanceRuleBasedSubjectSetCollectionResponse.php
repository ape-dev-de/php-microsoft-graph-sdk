...
/**
 * Collection response for IdentityGovernanceRuleBasedSubjectSet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceRuleBasedSubjectSetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceRuleBasedSubjectSet[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceRuleBasedSubjectSet[]
     */
     ...
     * 
     * @param IdentityGovernanceRuleBasedSubjectSet[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceRuleBasedSubjectSet $items, IdentityGovernanceRuleBasedSubjectSet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceRuleBasedSubjectSet> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceRuleBasedSubjectSet $item
     * @return self
     */
    public function addValue(IdentityGovernanceRuleBasedSubjectSet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceRuleBasedSubjectSet|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceRuleBasedSubjectSet>
     */
