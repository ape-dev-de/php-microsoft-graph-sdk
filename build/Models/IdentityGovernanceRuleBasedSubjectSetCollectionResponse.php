 ...
 */
class IdentityGovernanceRuleBasedSubjectSetCollectionResponse
{
    /**
     ...
     * 
     * @param IdentityGovernanceRuleBasedSubjectSet ...$items Variable number of IdentityGovernanceRuleBasedSubjectSet items
     * @return self
     */
    public function setValue(IdentityGovernanceRuleBasedSubjectSet ...$items): self
    {
        $this->value = $items;
        return $this;
    }
