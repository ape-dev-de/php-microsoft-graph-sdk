...
/**
 * Collection response for ClassifcationErrorBaseCollectionResponse
 */
class ClassifcationErrorBaseCollectionResponseCollectionResponse
{
    /**
     * @var ClassifcationErrorBaseCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ClassifcationErrorBaseCollectionResponse ...$items Variable number of ClassifcationErrorBaseCollectionResponse items
     * @return self
     */
    public function setValue(ClassifcationErrorBaseCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ClassifcationErrorBaseCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ClassifcationErrorBaseCollectionResponse $item
     * @return self
     */
    public function addValue(ClassifcationErrorBaseCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
