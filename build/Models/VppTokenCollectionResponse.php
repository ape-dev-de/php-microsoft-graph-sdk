...
/**
 * Collection response for VppToken
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VppTokenCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VppToken[]
     */
     ...
     * 
     * @param VppToken[] $items
     * @return self
     */
    public function setValue(array|VppToken $items, VppToken ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(VppToken $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VppToken>
     */
