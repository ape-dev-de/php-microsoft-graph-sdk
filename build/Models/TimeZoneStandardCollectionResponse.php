...
/**
 * Collection response for TimeZoneStandard
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TimeZoneStandardCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TimeZoneStandard[] $items
     * @return self
     */
    public function setValue(array|TimeZoneStandard $items, TimeZoneStandard ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TimeZoneStandard> $value
     * @return self
     ...
     * 
     * @param TimeZoneStandard $item
     * @return self
     */
    public function addValue(TimeZoneStandard $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TimeZoneStandard>
     */
