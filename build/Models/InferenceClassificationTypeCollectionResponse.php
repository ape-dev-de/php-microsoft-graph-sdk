...
/**
 * Collection response for InferenceClassificationType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InferenceClassificationTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return InferenceClassificationType[]
     */
     ...
     * 
     * @param InferenceClassificationType[] $items
     * @return self
     */
    public function setValue(array|InferenceClassificationType $items, InferenceClassificationType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InferenceClassificationType> $value
     * @return self
     ...
     * 
     * @param InferenceClassificationType $item
     * @return self
     */
    public function addValue(InferenceClassificationType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, InferenceClassificationType>
     */
