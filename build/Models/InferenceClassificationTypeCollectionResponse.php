...
/**
 * InferenceClassificationTypeCollectionResponse - Collection response
 */
class InferenceClassificationTypeCollectionResponse
{
    /**
     * @var array<int, InferenceClassificationType>
     */
    public array $value = [];
