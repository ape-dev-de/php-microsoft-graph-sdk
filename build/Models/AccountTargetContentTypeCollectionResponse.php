...
/**
 * Collection response for AccountTargetContentType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccountTargetContentTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccountTargetContentType[]
     */
    private array $value = [];
     ...
     * 
     * @return AccountTargetContentType[]
     */
     ...
     * 
     * @param AccountTargetContentType[] $items
     * @return self
     */
    public function setValue(array|AccountTargetContentType $items, AccountTargetContentType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccountTargetContentType> $value
     * @return self
     ...
     * 
     * @param AccountTargetContentType $item
     * @return self
     */
    public function addValue(AccountTargetContentType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccountTargetContentType>
     */
