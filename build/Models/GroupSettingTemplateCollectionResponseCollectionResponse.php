...
/**
 * Collection response for GroupSettingTemplateCollectionResponse
 */
class GroupSettingTemplateCollectionResponseCollectionResponse
{
    /**
     * @var GroupSettingTemplateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param GroupSettingTemplateCollectionResponse ...$items Variable number of GroupSettingTemplateCollectionResponse items
     * @return self
     */
    public function setValue(GroupSettingTemplateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<GroupSettingTemplateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param GroupSettingTemplateCollectionResponse $item
     * @return self
     */
    public function addValue(GroupSettingTemplateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
