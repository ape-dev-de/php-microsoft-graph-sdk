...
/**
 * Collection response for RequiredPasswordType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RequiredPasswordTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RequiredPasswordType[]
     */
    private array $value = [];
     ...
     * 
     * @param RequiredPasswordType[] $items
     * @return self
     */
    public function setValue(array|RequiredPasswordType $items, RequiredPasswordType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RequiredPasswordType> $value
     * @return self
     ...
     * 
     * @param RequiredPasswordType $item
     * @return self
     */
    public function addValue(RequiredPasswordType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RequiredPasswordType>
     */
