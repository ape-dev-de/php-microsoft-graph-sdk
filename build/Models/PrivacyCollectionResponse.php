...
/**
 * Collection response for Privacy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrivacyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Privacy[]
     */
     ...
     * @return self
     */
    public function setValue(array|Privacy $items, Privacy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Privacy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Privacy>
     */
