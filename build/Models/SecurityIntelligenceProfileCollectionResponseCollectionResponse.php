...
/**
 * Collection response for SecurityIntelligenceProfileCollectionResponse
 */
class SecurityIntelligenceProfileCollectionResponseCollectionResponse
{
    /**
     * @var SecurityIntelligenceProfileCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityIntelligenceProfileCollectionResponse ...$items Variable number of SecurityIntelligenceProfileCollectionResponse items
     * @return self
     */
    public function setValue(SecurityIntelligenceProfileCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityIntelligenceProfileCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityIntelligenceProfileCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityIntelligenceProfileCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
