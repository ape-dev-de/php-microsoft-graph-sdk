...
/**
 * Collection response for ContentSharingSessionCollectionResponse
 */
class ContentSharingSessionCollectionResponseCollectionResponse
{
    /**
     * @var ContentSharingSessionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ContentSharingSessionCollectionResponse ...$items Variable number of ContentSharingSessionCollectionResponse items
     * @return self
     */
    public function setValue(ContentSharingSessionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ContentSharingSessionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ContentSharingSessionCollectionResponse $item
     * @return self
     */
    public function addValue(ContentSharingSessionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
