...
/**
 * Collection response for TokenLifetimePolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TokenLifetimePolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TokenLifetimePolicy[] $items
     * @return self
     */
    public function setValue(array|TokenLifetimePolicy $items, TokenLifetimePolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TokenLifetimePolicy> $value
     * @return self
     ...
     * 
     * @param TokenLifetimePolicy $item
     * @return self
     */
    public function addValue(TokenLifetimePolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TokenLifetimePolicy>
     */
