 ...
 */
class SecurityRedundancyDetectionSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityRedundancyDetectionSettings ...$items Variable number of SecurityRedundancyDetectionSettings items
     * @return self
     */
    public function setValue(SecurityRedundancyDetectionSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
