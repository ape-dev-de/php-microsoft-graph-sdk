...
/**
 * Collection response for SecurityRedundancyDetectionSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityRedundancyDetectionSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityRedundancyDetectionSettings[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityRedundancyDetectionSettings[]
     */
     ...
     * 
     * @param SecurityRedundancyDetectionSettings[] $items
     * @return self
     */
    public function setValue(array|SecurityRedundancyDetectionSettings $items, SecurityRedundancyDetectionSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityRedundancyDetectionSettings> $value
     * @return self
     ...
     * 
     * @param SecurityRedundancyDetectionSettings $item
     * @return self
     */
    public function addValue(SecurityRedundancyDetectionSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityRedundancyDetectionSettings|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityRedundancyDetectionSettings>
     */
