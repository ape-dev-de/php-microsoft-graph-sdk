...
/**
 * Collection response for MediaDirection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MediaDirectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MediaDirection[]
     */
     ...
     * 
     * @param MediaDirection[] $items
     * @return self
     */
    public function setValue(array|MediaDirection $items, MediaDirection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MediaDirection> $value
     * @return self
     ...
     * 
     * @param MediaDirection $item
     * @return self
     */
    public function addValue(MediaDirection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MediaDirection>
     */
