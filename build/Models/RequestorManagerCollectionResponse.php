...
/**
 * Collection response for RequestorManager
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RequestorManagerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param RequestorManager[] $items
     * @return self
     */
    public function setValue(array|RequestorManager $items, RequestorManager ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RequestorManager> $value
     * @return self
     ...
     * 
     * @param RequestorManager $item
     * @return self
     */
    public function addValue(RequestorManager $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RequestorManager>
     */
