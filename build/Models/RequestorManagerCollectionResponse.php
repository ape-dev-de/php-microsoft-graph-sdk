 ...
 */
class RequestorManagerCollectionResponse
{
    /**
     ...
     * 
     * @param RequestorManager ...$items Variable number of RequestorManager items
     * @return self
     */
    public function setValue(RequestorManager ...$items): self
    {
        $this->value = $items;
        return $this;
    }
