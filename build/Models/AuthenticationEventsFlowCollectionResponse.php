...
/**
 * Collection response for AuthenticationEventsFlow
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationEventsFlowCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AuthenticationEventsFlow[] $items
     * @return self
     */
    public function setValue(array|AuthenticationEventsFlow $items, AuthenticationEventsFlow ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationEventsFlow> $value
     * @return self
     ...
     * 
     * @param AuthenticationEventsFlow $item
     * @return self
     */
    public function addValue(AuthenticationEventsFlow $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationEventsFlow>
     */
