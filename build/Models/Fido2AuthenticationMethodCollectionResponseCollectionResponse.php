...
/**
 * Collection response for Fido2AuthenticationMethodCollectionResponse
 */
class Fido2AuthenticationMethodCollectionResponseCollectionResponse
{
    /**
     * @var Fido2AuthenticationMethodCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param Fido2AuthenticationMethodCollectionResponse ...$items Variable number of Fido2AuthenticationMethodCollectionResponse items
     * @return self
     */
    public function setValue(Fido2AuthenticationMethodCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<Fido2AuthenticationMethodCollectionResponse> $value
     * @return self
     ...
     * 
     * @param Fido2AuthenticationMethodCollectionResponse $item
     * @return self
     */
    public function addValue(Fido2AuthenticationMethodCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
