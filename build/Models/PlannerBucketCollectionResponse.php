...
/**
 * Collection response for PlannerBucket
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerBucketCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PlannerBucket[]
     */
     ...
     * 
     * @param PlannerBucket[] $items
     * @return self
     */
    public function setValue(array|PlannerBucket $items, PlannerBucket ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PlannerBucket> $value
     * @return self
     ...
     * 
     * @param PlannerBucket $item
     * @return self
     */
    public function addValue(PlannerBucket $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PlannerBucket>
     */
