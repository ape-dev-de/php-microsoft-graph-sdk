...
/**
 * Collection response for SecurityEventQuery
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityEventQueryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityEventQuery[] $items
     * @return self
     */
    public function setValue(array|SecurityEventQuery $items, SecurityEventQuery ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityEventQuery> $value
     * @return self
     ...
     * 
     * @param SecurityEventQuery $item
     * @return self
     */
    public function addValue(SecurityEventQuery $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityEventQuery|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityEventQuery>
     */
