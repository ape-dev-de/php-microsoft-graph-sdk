...
/**
 * Collection response for DocumentSetVersionCollectionResponse
 */
class DocumentSetVersionCollectionResponseCollectionResponse
{
    /**
     * @var DocumentSetVersionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DocumentSetVersionCollectionResponse ...$items Variable number of DocumentSetVersionCollectionResponse items
     * @return self
     */
    public function setValue(DocumentSetVersionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DocumentSetVersionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DocumentSetVersionCollectionResponse $item
     * @return self
     */
    public function addValue(DocumentSetVersionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
