...
/**
 * Collection response for NoDeviceRegistrationMembership
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class NoDeviceRegistrationMembershipCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var NoDeviceRegistrationMembership[]
     */
    private array $value = [];
     ...
     * 
     * @param NoDeviceRegistrationMembership[] $items
     * @return self
     */
    public function setValue(array|NoDeviceRegistrationMembership $items, NoDeviceRegistrationMembership ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<NoDeviceRegistrationMembership> $value
     * @return self
     ...
     * 
     * @param NoDeviceRegistrationMembership $item
     * @return self
     */
    public function addValue(NoDeviceRegistrationMembership $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return NoDeviceRegistrationMembership|null
     */
     ...
     * 
     * @return \ArrayIterator<int, NoDeviceRegistrationMembership>
     */
