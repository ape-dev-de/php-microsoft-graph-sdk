...
/**
 * NoDeviceRegistrationMembershipCollectionResponse - Collection response
 */
class NoDeviceRegistrationMembershipCollectionResponse
{
    /**
     * @var array<int, NoDeviceRegistrationMembership>
     */
    public array $value = [];
