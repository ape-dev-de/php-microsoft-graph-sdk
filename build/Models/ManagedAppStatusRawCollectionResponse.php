...
/**
 * Collection response for ManagedAppStatusRaw
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedAppStatusRawCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ManagedAppStatusRaw[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedAppStatusRaw[] $items
     * @return self
     */
    public function setValue(array|ManagedAppStatusRaw $items, ManagedAppStatusRaw ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedAppStatusRaw> $value
     * @return self
     ...
     * 
     * @param ManagedAppStatusRaw $item
     * @return self
     */
    public function addValue(ManagedAppStatusRaw $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ManagedAppStatusRaw|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ManagedAppStatusRaw>
     */
