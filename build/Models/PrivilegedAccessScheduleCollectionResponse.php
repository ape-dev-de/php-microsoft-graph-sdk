 ...
 */
class PrivilegedAccessScheduleCollectionResponse
{
    /**
     ...
     * 
     * @param PrivilegedAccessSchedule ...$items Variable number of PrivilegedAccessSchedule items
     * @return self
     */
    public function setValue(PrivilegedAccessSchedule ...$items): self
    {
        $this->value = $items;
        return $this;
    }
