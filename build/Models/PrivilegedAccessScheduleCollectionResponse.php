...
/**
 * Collection response for PrivilegedAccessSchedule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrivilegedAccessScheduleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrivilegedAccessSchedule[]
     */
    private array $value = [];
     ...
     * 
     * @param PrivilegedAccessSchedule[] $items
     * @return self
     */
    public function setValue(array|PrivilegedAccessSchedule $items, PrivilegedAccessSchedule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrivilegedAccessSchedule> $value
     * @return self
     ...
     * 
     * @param PrivilegedAccessSchedule $item
     * @return self
     */
    public function addValue(PrivilegedAccessSchedule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PrivilegedAccessSchedule|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PrivilegedAccessSchedule>
     */
