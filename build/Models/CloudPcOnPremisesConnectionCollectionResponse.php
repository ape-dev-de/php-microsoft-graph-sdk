...
/**
 * Collection response for CloudPcOnPremisesConnection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcOnPremisesConnectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CloudPcOnPremisesConnection[] $items
     * @return self
     */
    public function setValue(array|CloudPcOnPremisesConnection $items, CloudPcOnPremisesConnection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcOnPremisesConnection> $value
     * @return self
     ...
     * 
     * @param CloudPcOnPremisesConnection $item
     * @return self
     */
    public function addValue(CloudPcOnPremisesConnection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcOnPremisesConnection>
     */
