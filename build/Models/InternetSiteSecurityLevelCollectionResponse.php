...
/**
 * Collection response for InternetSiteSecurityLevel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InternetSiteSecurityLevelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var InternetSiteSecurityLevel[]
     */
    private array $value = [];
     ...
     * 
     * @return InternetSiteSecurityLevel[]
     */
     ...
     * 
     * @param InternetSiteSecurityLevel[] $items
     * @return self
     */
    public function setValue(array|InternetSiteSecurityLevel $items, InternetSiteSecurityLevel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InternetSiteSecurityLevel> $value
     * @return self
     ...
     * 
     * @param InternetSiteSecurityLevel $item
     * @return self
     */
    public function addValue(InternetSiteSecurityLevel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, InternetSiteSecurityLevel>
     */
