...
/**
 * InternetSiteSecurityLevelCollectionResponse - Collection response
 */
class InternetSiteSecurityLevelCollectionResponse
{
    /**
     * @var array<int, InternetSiteSecurityLevel>
     */
    public array $value = [];
