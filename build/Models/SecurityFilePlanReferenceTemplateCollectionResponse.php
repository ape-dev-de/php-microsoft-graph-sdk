...
/**
 * Collection response for SecurityFilePlanReferenceTemplate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityFilePlanReferenceTemplateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityFilePlanReferenceTemplate[] $items
     * @return self
     */
    public function setValue(array|SecurityFilePlanReferenceTemplate $items, SecurityFilePlanReferenceTemplate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityFilePlanReferenceTemplate> $value
     * @return self
     ...
     * 
     * @param SecurityFilePlanReferenceTemplate $item
     * @return self
     */
    public function addValue(SecurityFilePlanReferenceTemplate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityFilePlanReferenceTemplate>
     */
