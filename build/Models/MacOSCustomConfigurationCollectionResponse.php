...
/**
 * Collection response for MacOSCustomConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MacOSCustomConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MacOSCustomConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param MacOSCustomConfiguration[] $items
     * @return self
     */
    public function setValue(array|MacOSCustomConfiguration $items, MacOSCustomConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MacOSCustomConfiguration> $value
     * @return self
     ...
     * 
     * @param MacOSCustomConfiguration $item
     * @return self
     */
    public function addValue(MacOSCustomConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MacOSCustomConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MacOSCustomConfiguration>
     */
