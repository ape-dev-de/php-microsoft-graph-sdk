...
/**
 * Collection response for UserConsentRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserConsentRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserConsentRequest[] $items
     * @return self
     */
    public function setValue(array|UserConsentRequest $items, UserConsentRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserConsentRequest> $value
     * @return self
     ...
     * 
     * @param UserConsentRequest $item
     * @return self
     */
    public function addValue(UserConsentRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserConsentRequest>
     */
