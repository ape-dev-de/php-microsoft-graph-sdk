 ...
 */
class DriveRecipientCollectionResponse
{
    /**
     * @var DriveRecipient[]
     */
     ...
     * 
     * @param DriveRecipient ...$items Variable number of DriveRecipient items
     * @return self
     */
    public function setValue(DriveRecipient ...$items): self
    {
        $this->value = $items;
        return $this;
    }
