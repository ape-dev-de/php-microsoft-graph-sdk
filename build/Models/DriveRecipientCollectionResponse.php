...
/**
 * Collection response for DriveRecipient
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DriveRecipientCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DriveRecipient[]
     */
     ...
     * 
     * @param DriveRecipient[] $items
     * @return self
     */
    public function setValue(array|DriveRecipient $items, DriveRecipient ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DriveRecipient> $value
     * @return self
     ...
     * 
     * @param DriveRecipient $item
     * @return self
     */
    public function addValue(DriveRecipient $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DriveRecipient>
     */
