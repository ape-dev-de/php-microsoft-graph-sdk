...
/**
 * Collection response for EducationCategoryCollectionResponse
 */
class EducationCategoryCollectionResponseCollectionResponse
{
    /**
     * @var EducationCategoryCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationCategoryCollectionResponse ...$items Variable number of EducationCategoryCollectionResponse items
     * @return self
     */
    public function setValue(EducationCategoryCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EducationCategoryCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EducationCategoryCollectionResponse $item
     * @return self
     */
    public function addValue(EducationCategoryCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
