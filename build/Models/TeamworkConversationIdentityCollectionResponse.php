 ...
 */
class TeamworkConversationIdentityCollectionResponse
{
    /**
     ...
     * 
     * @param TeamworkConversationIdentity ...$items Variable number of TeamworkConversationIdentity items
     * @return self
     */
    public function setValue(TeamworkConversationIdentity ...$items): self
    {
        $this->value = $items;
        return $this;
    }
