...
/**
 * Collection response for TeamworkConversationIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamworkConversationIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamworkConversationIdentity[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamworkConversationIdentity[] $items
     * @return self
     */
    public function setValue(array|TeamworkConversationIdentity $items, TeamworkConversationIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamworkConversationIdentity> $value
     * @return self
     ...
     * 
     * @param TeamworkConversationIdentity $item
     * @return self
     */
    public function addValue(TeamworkConversationIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamworkConversationIdentity>
     */
