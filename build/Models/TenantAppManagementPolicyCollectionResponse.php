...
/**
 * Collection response for TenantAppManagementPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TenantAppManagementPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TenantAppManagementPolicy[]
     */
    private array $value = [];
     ...
     * 
     * @param TenantAppManagementPolicy[] $items
     * @return self
     */
    public function setValue(array|TenantAppManagementPolicy $items, TenantAppManagementPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TenantAppManagementPolicy> $value
     * @return self
     ...
     * 
     * @param TenantAppManagementPolicy $item
     * @return self
     */
    public function addValue(TenantAppManagementPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TenantAppManagementPolicy>
     */
