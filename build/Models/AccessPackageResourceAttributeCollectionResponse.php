...
/**
 * Collection response for AccessPackageResourceAttribute
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageResourceAttributeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessPackageResourceAttribute[] $items
     * @return self
     */
    public function setValue(array|AccessPackageResourceAttribute $items, AccessPackageResourceAttribute ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageResourceAttribute> $value
     * @return self
     ...
     * 
     * @param AccessPackageResourceAttribute $item
     * @return self
     */
    public function addValue(AccessPackageResourceAttribute $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessPackageResourceAttribute|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageResourceAttribute>
     */
