...
/**
 * Collection response for WorkbookChartTitle
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookChartTitleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookChartTitle[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookChartTitle[] $items
     * @return self
     */
    public function setValue(array|WorkbookChartTitle $items, WorkbookChartTitle ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookChartTitle> $value
     * @return self
     ...
     * 
     * @param WorkbookChartTitle $item
     * @return self
     */
    public function addValue(WorkbookChartTitle $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookChartTitle>
     */
