 ...
 */
class WorkbookChartTitleCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookChartTitle ...$items Variable number of WorkbookChartTitle items
     * @return self
     */
    public function setValue(WorkbookChartTitle ...$items): self
    {
        $this->value = $items;
        return $this;
    }
