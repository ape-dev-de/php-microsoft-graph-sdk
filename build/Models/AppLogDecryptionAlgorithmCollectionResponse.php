...
/**
 * Collection response for AppLogDecryptionAlgorithm
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppLogDecryptionAlgorithmCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AppLogDecryptionAlgorithm[]
     */
    private array $value = [];
     ...
     * 
     * @param AppLogDecryptionAlgorithm[] $items
     * @return self
     */
    public function setValue(array|AppLogDecryptionAlgorithm $items, AppLogDecryptionAlgorithm ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppLogDecryptionAlgorithm> $value
     * @return self
     ...
     * 
     * @param AppLogDecryptionAlgorithm $item
     * @return self
     */
    public function addValue(AppLogDecryptionAlgorithm $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AppLogDecryptionAlgorithm>
     */
