...
/**
 * AppLogDecryptionAlgorithmCollectionResponse - Collection response
 */
class AppLogDecryptionAlgorithmCollectionResponse
{
    /**
     * @var array<int, AppLogDecryptionAlgorithm>
     */
    public array $value = [];
