...
/**
 * Collection response for Shared
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SharedCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Shared[]
     */
     ...
     * @return self
     */
    public function setValue(array|Shared $items, Shared ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Shared $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Shared>
     */
