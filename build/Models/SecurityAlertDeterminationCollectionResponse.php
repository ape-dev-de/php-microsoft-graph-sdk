...
/**
 * Collection response for SecurityAlertDetermination
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityAlertDeterminationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityAlertDetermination[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityAlertDetermination[]
     */
     ...
     * 
     * @param SecurityAlertDetermination[] $items
     * @return self
     */
    public function setValue(array|SecurityAlertDetermination $items, SecurityAlertDetermination ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityAlertDetermination> $value
     * @return self
     ...
     * 
     * @param SecurityAlertDetermination $item
     * @return self
     */
    public function addValue(SecurityAlertDetermination $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityAlertDetermination|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityAlertDetermination>
     */
