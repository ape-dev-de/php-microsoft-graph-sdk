...
/**
 * SecurityAlertDeterminationCollectionResponse - Collection response
 */
class SecurityAlertDeterminationCollectionResponse
{
    /**
     * @var array<int, SecurityAlertDetermination>
     */
    public array $value = [];
