 ...
 */
class IosVppAppAssignmentSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param IosVppAppAssignmentSettings ...$items Variable number of IosVppAppAssignmentSettings items
     * @return self
     */
    public function setValue(IosVppAppAssignmentSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
