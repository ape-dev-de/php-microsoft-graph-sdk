...
/**
 * Collection response for IosVppAppAssignmentSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosVppAppAssignmentSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IosVppAppAssignmentSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param IosVppAppAssignmentSettings[] $items
     * @return self
     */
    public function setValue(array|IosVppAppAssignmentSettings $items, IosVppAppAssignmentSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosVppAppAssignmentSettings> $value
     * @return self
     ...
     * 
     * @param IosVppAppAssignmentSettings $item
     * @return self
     */
    public function addValue(IosVppAppAssignmentSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IosVppAppAssignmentSettings|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IosVppAppAssignmentSettings>
     */
