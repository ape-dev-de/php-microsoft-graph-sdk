...
/**
 * Collection response for CustomMetadataDictionary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CustomMetadataDictionaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CustomMetadataDictionary[]
     */
    private array $value = [];
     ...
     * 
     * @param CustomMetadataDictionary[] $items
     * @return self
     */
    public function setValue(array|CustomMetadataDictionary $items, CustomMetadataDictionary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CustomMetadataDictionary> $value
     * @return self
     ...
     * 
     * @param CustomMetadataDictionary $item
     * @return self
     */
    public function addValue(CustomMetadataDictionary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CustomMetadataDictionary>
     */
