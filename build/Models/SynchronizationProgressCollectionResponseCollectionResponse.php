...
/**
 * Collection response for SynchronizationProgressCollectionResponse
 */
class SynchronizationProgressCollectionResponseCollectionResponse
{
    /**
     * @var SynchronizationProgressCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SynchronizationProgressCollectionResponse ...$items Variable number of SynchronizationProgressCollectionResponse items
     * @return self
     */
    public function setValue(SynchronizationProgressCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SynchronizationProgressCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SynchronizationProgressCollectionResponse $item
     * @return self
     */
    public function addValue(SynchronizationProgressCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
