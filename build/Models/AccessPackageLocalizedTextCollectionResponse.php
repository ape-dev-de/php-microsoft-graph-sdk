...
/**
 * Collection response for AccessPackageLocalizedText
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageLocalizedTextCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessPackageLocalizedText[] $items
     * @return self
     */
    public function setValue(array|AccessPackageLocalizedText $items, AccessPackageLocalizedText ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageLocalizedText> $value
     * @return self
     ...
     * 
     * @param AccessPackageLocalizedText $item
     * @return self
     */
    public function addValue(AccessPackageLocalizedText $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessPackageLocalizedText|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageLocalizedText>
     */
