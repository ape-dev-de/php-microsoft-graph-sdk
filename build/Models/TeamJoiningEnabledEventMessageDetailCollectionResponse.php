 ...
 */
class TeamJoiningEnabledEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param TeamJoiningEnabledEventMessageDetail ...$items Variable number of TeamJoiningEnabledEventMessageDetail items
     * @return self
     */
    public function setValue(TeamJoiningEnabledEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
