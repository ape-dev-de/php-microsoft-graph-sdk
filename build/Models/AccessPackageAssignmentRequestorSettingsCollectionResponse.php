 ...
 */
class AccessPackageAssignmentRequestorSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param AccessPackageAssignmentRequestorSettings ...$items Variable number of AccessPackageAssignmentRequestorSettings items
     * @return self
     */
    public function setValue(AccessPackageAssignmentRequestorSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
