...
/**
 * Collection response for AccessPackageAssignmentRequestorSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageAssignmentRequestorSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageAssignmentRequestorSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageAssignmentRequestorSettings[] $items
     * @return self
     */
    public function setValue(array|AccessPackageAssignmentRequestorSettings $items, AccessPackageAssignmentRequestorSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageAssignmentRequestorSettings> $value
     * @return self
     ...
     * 
     * @param AccessPackageAssignmentRequestorSettings $item
     * @return self
     */
    public function addValue(AccessPackageAssignmentRequestorSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageAssignmentRequestorSettings>
     */
