...
/**
 * Collection response for UserSignInInsight
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserSignInInsightCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserSignInInsight[]
     */
    private array $value = [];
     ...
     * 
     * @param UserSignInInsight[] $items
     * @return self
     */
    public function setValue(array|UserSignInInsight $items, UserSignInInsight ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserSignInInsight> $value
     * @return self
     ...
     * 
     * @param UserSignInInsight $item
     * @return self
     */
    public function addValue(UserSignInInsight $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserSignInInsight>
     */
