...
/**
 * Collection response for SharedDriveItemCollectionResponse
 */
class SharedDriveItemCollectionResponseCollectionResponse
{
    /**
     * @var SharedDriveItemCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SharedDriveItemCollectionResponse ...$items Variable number of SharedDriveItemCollectionResponse items
     * @return self
     */
    public function setValue(SharedDriveItemCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SharedDriveItemCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SharedDriveItemCollectionResponse $item
     * @return self
     */
    public function addValue(SharedDriveItemCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
