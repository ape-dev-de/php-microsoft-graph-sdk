...
/**
 * Collection response for InvitationParticipantInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InvitationParticipantInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param InvitationParticipantInfo[] $items
     * @return self
     */
    public function setValue(array|InvitationParticipantInfo $items, InvitationParticipantInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InvitationParticipantInfo> $value
     * @return self
     ...
     * 
     * @param InvitationParticipantInfo $item
     * @return self
     */
    public function addValue(InvitationParticipantInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, InvitationParticipantInfo>
     */
