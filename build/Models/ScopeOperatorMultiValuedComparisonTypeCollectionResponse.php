...
/**
 * ScopeOperatorMultiValuedComparisonTypeCollectionResponse - Collection response
 */
class ScopeOperatorMultiValuedComparisonTypeCollectionResponse
{
    /**
     * @var array<int, ScopeOperatorMultiValuedComparisonType>
     */
    public array $value = [];
