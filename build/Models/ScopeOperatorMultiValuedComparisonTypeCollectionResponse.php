...
/**
 * Collection response for ScopeOperatorMultiValuedComparisonType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ScopeOperatorMultiValuedComparisonTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ScopeOperatorMultiValuedComparisonType[]
     */
    private array $value = [];
     ...
     * 
     * @return ScopeOperatorMultiValuedComparisonType[]
     */
     ...
     * 
     * @param ScopeOperatorMultiValuedComparisonType[] $items
     * @return self
     */
    public function setValue(array|ScopeOperatorMultiValuedComparisonType $items, ScopeOperatorMultiValuedComparisonType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ScopeOperatorMultiValuedComparisonType> $value
     * @return self
     ...
     * 
     * @param ScopeOperatorMultiValuedComparisonType $item
     * @return self
     */
    public function addValue(ScopeOperatorMultiValuedComparisonType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ScopeOperatorMultiValuedComparisonType>
     */
