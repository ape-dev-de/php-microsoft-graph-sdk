...
/**
 * Collection response for AiInteractionPlugin
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AiInteractionPluginCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AiInteractionPlugin[] $items
     * @return self
     */
    public function setValue(array|AiInteractionPlugin $items, AiInteractionPlugin ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AiInteractionPlugin> $value
     * @return self
     ...
     * 
     * @param AiInteractionPlugin $item
     * @return self
     */
    public function addValue(AiInteractionPlugin $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AiInteractionPlugin|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AiInteractionPlugin>
     */
