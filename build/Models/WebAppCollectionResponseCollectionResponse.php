...
/**
 * Collection response for WebAppCollectionResponse
 */
class WebAppCollectionResponseCollectionResponse
{
    /**
     * @var WebAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WebAppCollectionResponse ...$items Variable number of WebAppCollectionResponse items
     * @return self
     */
    public function setValue(WebAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WebAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WebAppCollectionResponse $item
     * @return self
     */
    public function addValue(WebAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
