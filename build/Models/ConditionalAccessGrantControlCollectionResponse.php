...
/**
 * Collection response for ConditionalAccessGrantControl
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessGrantControlCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return ConditionalAccessGrantControl[]
     */
     ...
     * 
     * @param ConditionalAccessGrantControl[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessGrantControl $items, ConditionalAccessGrantControl ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessGrantControl> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessGrantControl $item
     * @return self
     */
    public function addValue(ConditionalAccessGrantControl $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ConditionalAccessGrantControl|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessGrantControl>
     */
