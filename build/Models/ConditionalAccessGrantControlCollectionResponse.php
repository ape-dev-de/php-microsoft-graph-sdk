...
/**
 * ConditionalAccessGrantControlCollectionResponse - Collection response
 */
class ConditionalAccessGrantControlCollectionResponse
{
    /**
     * @var array<int, ConditionalAccessGrantControl>
     */
    public array $value = [];
