 ...
 */
class MicrosoftAuthenticatorFeatureSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param MicrosoftAuthenticatorFeatureSettings ...$items Variable number of MicrosoftAuthenticatorFeatureSettings items
     * @return self
     */
    public function setValue(MicrosoftAuthenticatorFeatureSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
