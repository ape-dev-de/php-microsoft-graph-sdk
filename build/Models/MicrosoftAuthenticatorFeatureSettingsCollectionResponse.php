...
/**
 * Collection response for MicrosoftAuthenticatorFeatureSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MicrosoftAuthenticatorFeatureSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MicrosoftAuthenticatorFeatureSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param MicrosoftAuthenticatorFeatureSettings[] $items
     * @return self
     */
    public function setValue(array|MicrosoftAuthenticatorFeatureSettings $items, MicrosoftAuthenticatorFeatureSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MicrosoftAuthenticatorFeatureSettings> $value
     * @return self
     ...
     * 
     * @param MicrosoftAuthenticatorFeatureSettings $item
     * @return self
     */
    public function addValue(MicrosoftAuthenticatorFeatureSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MicrosoftAuthenticatorFeatureSettings>
     */
