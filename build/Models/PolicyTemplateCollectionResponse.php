 ...
 */
class PolicyTemplateCollectionResponse
{
    /**
     * @var PolicyTemplate[]
     */
     ...
     * 
     * @param PolicyTemplate ...$items Variable number of PolicyTemplate items
     * @return self
     */
    public function setValue(PolicyTemplate ...$items): self
    {
        $this->value = $items;
        return $this;
    }
