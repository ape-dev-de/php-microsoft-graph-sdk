...
/**
 * Collection response for PolicyTemplate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PolicyTemplateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PolicyTemplate[]
     */
     ...
     * 
     * @param PolicyTemplate[] $items
     * @return self
     */
    public function setValue(array|PolicyTemplate $items, PolicyTemplate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PolicyTemplate> $value
     * @return self
     ...
     * 
     * @param PolicyTemplate $item
     * @return self
     */
    public function addValue(PolicyTemplate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PolicyTemplate>
     */
