...
/**
 * Collection response for ExternalConnectorsExternalConnectionCollectionResponse
 */
class ExternalConnectorsExternalConnectionCollectionResponseCollectionResponse
{
    /**
     * @var ExternalConnectorsExternalConnectionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ExternalConnectorsExternalConnectionCollectionResponse ...$items Variable number of ExternalConnectorsExternalConnectionCollectionResponse items
     * @return self
     */
    public function setValue(ExternalConnectorsExternalConnectionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ExternalConnectorsExternalConnectionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsExternalConnectionCollectionResponse $item
     * @return self
     */
    public function addValue(ExternalConnectorsExternalConnectionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
