...
/**
 * Collection response for OrganizationalBrandingLocalization
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OrganizationalBrandingLocalizationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param OrganizationalBrandingLocalization[] $items
     * @return self
     */
    public function setValue(array|OrganizationalBrandingLocalization $items, OrganizationalBrandingLocalization ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OrganizationalBrandingLocalization> $value
     * @return self
     ...
     * 
     * @param OrganizationalBrandingLocalization $item
     * @return self
     */
    public function addValue(OrganizationalBrandingLocalization $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OrganizationalBrandingLocalization>
     */
