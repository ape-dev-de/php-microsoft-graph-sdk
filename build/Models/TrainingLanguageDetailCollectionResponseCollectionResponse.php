...
/**
 * Collection response for TrainingLanguageDetailCollectionResponse
 */
class TrainingLanguageDetailCollectionResponseCollectionResponse
{
    /**
     * @var TrainingLanguageDetailCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TrainingLanguageDetailCollectionResponse ...$items Variable number of TrainingLanguageDetailCollectionResponse items
     * @return self
     */
    public function setValue(TrainingLanguageDetailCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TrainingLanguageDetailCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TrainingLanguageDetailCollectionResponse $item
     * @return self
     */
    public function addValue(TrainingLanguageDetailCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
