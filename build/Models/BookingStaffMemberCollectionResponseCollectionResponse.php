...
/**
 * Collection response for BookingStaffMemberCollectionResponse
 */
class BookingStaffMemberCollectionResponseCollectionResponse
{
    /**
     * @var BookingStaffMemberCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BookingStaffMemberCollectionResponse ...$items Variable number of BookingStaffMemberCollectionResponse items
     * @return self
     */
    public function setValue(BookingStaffMemberCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<BookingStaffMemberCollectionResponse> $value
     * @return self
     ...
     * 
     * @param BookingStaffMemberCollectionResponse $item
     * @return self
     */
    public function addValue(BookingStaffMemberCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
