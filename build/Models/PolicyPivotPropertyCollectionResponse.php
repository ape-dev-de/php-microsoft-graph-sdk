...
/**
 * Collection response for PolicyPivotProperty
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PolicyPivotPropertyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PolicyPivotProperty[]
     */
    private array $value = [];
     ...
     * 
     * @param PolicyPivotProperty[] $items
     * @return self
     */
    public function setValue(array|PolicyPivotProperty $items, PolicyPivotProperty ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PolicyPivotProperty> $value
     * @return self
     ...
     * 
     * @param PolicyPivotProperty $item
     * @return self
     */
    public function addValue(PolicyPivotProperty $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PolicyPivotProperty>
     */
