...
/**
 * Collection response for CallDirection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallDirectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallDirection[]
     */
     ...
     * 
     * @param CallDirection[] $items
     * @return self
     */
    public function setValue(array|CallDirection $items, CallDirection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallDirection> $value
     * @return self
     ...
     * 
     * @param CallDirection $item
     * @return self
     */
    public function addValue(CallDirection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CallDirection>
     */
