...
/**
 * Collection response for AccessPackageResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessPackageResource[] $items
     * @return self
     */
    public function setValue(array|AccessPackageResource $items, AccessPackageResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageResource> $value
     * @return self
     ...
     * 
     * @param AccessPackageResource $item
     * @return self
     */
    public function addValue(AccessPackageResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageResource>
     */
