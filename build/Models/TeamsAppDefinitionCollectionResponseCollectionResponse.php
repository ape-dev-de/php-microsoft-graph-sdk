...
/**
 * Collection response for TeamsAppDefinitionCollectionResponse
 */
class TeamsAppDefinitionCollectionResponseCollectionResponse
{
    /**
     * @var TeamsAppDefinitionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamsAppDefinitionCollectionResponse ...$items Variable number of TeamsAppDefinitionCollectionResponse items
     * @return self
     */
    public function setValue(TeamsAppDefinitionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TeamsAppDefinitionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TeamsAppDefinitionCollectionResponse $item
     * @return self
     */
    public function addValue(TeamsAppDefinitionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
