...
/**
 * Collection response for MicrosoftTrainingAssignmentMapping
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MicrosoftTrainingAssignmentMappingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MicrosoftTrainingAssignmentMapping[] $items
     * @return self
     */
    public function setValue(array|MicrosoftTrainingAssignmentMapping $items, MicrosoftTrainingAssignmentMapping ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MicrosoftTrainingAssignmentMapping> $value
     * @return self
     ...
     * 
     * @param MicrosoftTrainingAssignmentMapping $item
     * @return self
     */
    public function addValue(MicrosoftTrainingAssignmentMapping $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MicrosoftTrainingAssignmentMapping|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MicrosoftTrainingAssignmentMapping>
     */
