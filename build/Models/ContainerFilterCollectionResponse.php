...
/**
 * Collection response for ContainerFilter
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ContainerFilterCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ContainerFilter[]
     */
     ...
     * 
     * @param ContainerFilter[] $items
     * @return self
     */
    public function setValue(array|ContainerFilter $items, ContainerFilter ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ContainerFilter> $value
     * @return self
     ...
     * 
     * @param ContainerFilter $item
     * @return self
     */
    public function addValue(ContainerFilter $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ContainerFilter>
     */
