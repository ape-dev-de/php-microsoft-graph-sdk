 ...
 */
class ContainerFilterCollectionResponse
{
    /**
     * @var ContainerFilter[]
     */
     ...
     * 
     * @param ContainerFilter ...$items Variable number of ContainerFilter items
     * @return self
     */
    public function setValue(ContainerFilter ...$items): self
    {
        $this->value = $items;
        return $this;
    }
