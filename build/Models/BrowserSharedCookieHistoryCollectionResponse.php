...
/**
 * Collection response for BrowserSharedCookieHistory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BrowserSharedCookieHistoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param BrowserSharedCookieHistory[] $items
     * @return self
     */
    public function setValue(array|BrowserSharedCookieHistory $items, BrowserSharedCookieHistory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BrowserSharedCookieHistory> $value
     * @return self
     ...
     * 
     * @param BrowserSharedCookieHistory $item
     * @return self
     */
    public function addValue(BrowserSharedCookieHistory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return BrowserSharedCookieHistory|null
     */
     ...
     * 
     * @return \ArrayIterator<int, BrowserSharedCookieHistory>
     */
