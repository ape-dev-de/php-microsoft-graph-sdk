...
/**
 * Collection response for DiskType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DiskTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DiskType[]
     */
     ...
     * @return self
     */
    public function setValue(array|DiskType $items, DiskType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(DiskType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DiskType>
     */
