...
/**
 * Collection response for ManagedAppDataStorageLocation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedAppDataStorageLocationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return ManagedAppDataStorageLocation[]
     */
     ...
     * 
     * @param ManagedAppDataStorageLocation[] $items
     * @return self
     */
    public function setValue(array|ManagedAppDataStorageLocation $items, ManagedAppDataStorageLocation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedAppDataStorageLocation> $value
     * @return self
     ...
     * 
     * @param ManagedAppDataStorageLocation $item
     * @return self
     */
    public function addValue(ManagedAppDataStorageLocation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ManagedAppDataStorageLocation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ManagedAppDataStorageLocation>
     */
