...
/**
 * ManagedAppDataStorageLocationCollectionResponse - Collection response
 */
class ManagedAppDataStorageLocationCollectionResponse
{
    /**
     * @var array<int, ManagedAppDataStorageLocation>
     */
    public array $value = [];
