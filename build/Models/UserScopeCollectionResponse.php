...
/**
 * Collection response for UserScope
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserScopeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserScope[]
     */
     ...
     * 
     * @param UserScope[] $items
     * @return self
     */
    public function setValue(array|UserScope $items, UserScope ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param UserScope $item
     * @return self
     */
    public function addValue(UserScope $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserScope>
     */
