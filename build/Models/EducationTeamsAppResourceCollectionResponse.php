...
/**
 * Collection response for EducationTeamsAppResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationTeamsAppResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationTeamsAppResource[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationTeamsAppResource[] $items
     * @return self
     */
    public function setValue(array|EducationTeamsAppResource $items, EducationTeamsAppResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationTeamsAppResource> $value
     * @return self
     ...
     * 
     * @param EducationTeamsAppResource $item
     * @return self
     */
    public function addValue(EducationTeamsAppResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EducationTeamsAppResource|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EducationTeamsAppResource>
     */
