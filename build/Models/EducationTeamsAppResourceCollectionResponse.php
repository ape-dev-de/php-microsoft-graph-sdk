 ...
 */
class EducationTeamsAppResourceCollectionResponse
{
    /**
     ...
     * 
     * @param EducationTeamsAppResource ...$items Variable number of EducationTeamsAppResource items
     * @return self
     */
    public function setValue(EducationTeamsAppResource ...$items): self
    {
        $this->value = $items;
        return $this;
    }
