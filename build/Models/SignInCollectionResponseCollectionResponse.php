...
/**
 * Collection response for SignInCollectionResponse
 */
class SignInCollectionResponseCollectionResponse
{
    /**
     * @var SignInCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SignInCollectionResponse ...$items Variable number of SignInCollectionResponse items
     * @return self
     */
    public function setValue(SignInCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SignInCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SignInCollectionResponse $item
     * @return self
     */
    public function addValue(SignInCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
