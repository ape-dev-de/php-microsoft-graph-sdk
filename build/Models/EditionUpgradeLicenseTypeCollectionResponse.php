...
/**
 * Collection response for EditionUpgradeLicenseType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EditionUpgradeLicenseTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EditionUpgradeLicenseType[]
     */
    private array $value = [];
     ...
     * 
     * @return EditionUpgradeLicenseType[]
     */
     ...
     * 
     * @param EditionUpgradeLicenseType[] $items
     * @return self
     */
    public function setValue(array|EditionUpgradeLicenseType $items, EditionUpgradeLicenseType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EditionUpgradeLicenseType> $value
     * @return self
     ...
     * 
     * @param EditionUpgradeLicenseType $item
     * @return self
     */
    public function addValue(EditionUpgradeLicenseType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EditionUpgradeLicenseType>
     */
