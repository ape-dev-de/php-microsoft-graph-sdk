...
/**
 * EditionUpgradeLicenseTypeCollectionResponse - Collection response
 */
class EditionUpgradeLicenseTypeCollectionResponse
{
    /**
     * @var array<int, EditionUpgradeLicenseType>
     */
    public array $value = [];
