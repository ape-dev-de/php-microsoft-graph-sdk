...
/**
 * Collection response for UnifiedRoleManagementPolicyAuthenticationContextRule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRoleManagementPolicyAuthenticationContextRuleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UnifiedRoleManagementPolicyAuthenticationContextRule[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedRoleManagementPolicyAuthenticationContextRule[] $items
     * @return self
     */
    public function setValue(array|UnifiedRoleManagementPolicyAuthenticationContextRule $items, UnifiedRoleManagementPolicyAuthenticationContextRule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRoleManagementPolicyAuthenticationContextRule> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleManagementPolicyAuthenticationContextRule $item
     * @return self
     */
    public function addValue(UnifiedRoleManagementPolicyAuthenticationContextRule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UnifiedRoleManagementPolicyAuthenticationContextRule|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRoleManagementPolicyAuthenticationContextRule>
     */
