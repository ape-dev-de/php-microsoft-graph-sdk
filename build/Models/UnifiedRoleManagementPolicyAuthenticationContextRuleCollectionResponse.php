...
/**
 * UnifiedRoleManagementPolicyAuthenticationContextRuleCollectionResponse - Collection response
 */
class UnifiedRoleManagementPolicyAuthenticationContextRuleCollectionResponse
{
    /**
     * @var array<int, UnifiedRoleManagementPolicyAuthenticationContextRule>
     */
    public array $value = [];
