...
/**
 * Collection response for SubjectRightsRequestCollectionResponse
 */
class SubjectRightsRequestCollectionResponseCollectionResponse
{
    /**
     * @var SubjectRightsRequestCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SubjectRightsRequestCollectionResponse ...$items Variable number of SubjectRightsRequestCollectionResponse items
     * @return self
     */
    public function setValue(SubjectRightsRequestCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SubjectRightsRequestCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SubjectRightsRequestCollectionResponse $item
     * @return self
     */
    public function addValue(SubjectRightsRequestCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
