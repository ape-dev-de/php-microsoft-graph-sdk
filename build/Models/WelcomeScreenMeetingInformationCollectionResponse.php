...
/**
 * Collection response for WelcomeScreenMeetingInformation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WelcomeScreenMeetingInformationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WelcomeScreenMeetingInformation[]
     */
    private array $value = [];
     ...
     * 
     * @return WelcomeScreenMeetingInformation[]
     */
     ...
     * 
     * @param WelcomeScreenMeetingInformation[] $items
     * @return self
     */
    public function setValue(array|WelcomeScreenMeetingInformation $items, WelcomeScreenMeetingInformation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WelcomeScreenMeetingInformation> $value
     * @return self
     ...
     * 
     * @param WelcomeScreenMeetingInformation $item
     * @return self
     */
    public function addValue(WelcomeScreenMeetingInformation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WelcomeScreenMeetingInformation>
     */
