...
/**
 * WelcomeScreenMeetingInformationCollectionResponse - Collection response
 */
class WelcomeScreenMeetingInformationCollectionResponse
{
    /**
     * @var array<int, WelcomeScreenMeetingInformation>
     */
    public array $value = [];
