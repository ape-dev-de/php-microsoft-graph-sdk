...
class Domain
{
     ...
     * @var string[]
     */
    private array $verificationDnsRecords = [];
    ...
    /**
     * @param string[] $supportedServices
     */
    public function setSupportedServices(array $supportedServices): self
    {
    ...
    /**
     * @param string[] $verificationDnsRecords
     */
    public function setVerificationDnsRecords(array $verificationDnsRecords): self
    {
