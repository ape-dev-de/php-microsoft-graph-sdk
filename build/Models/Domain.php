...
class Domain
{
    public function __construct(
        ...
        /** @var string[] DNS records that the customer adds to the DNS zone file of the domain before the customer can complete domain ownership verification with Microsoft Entra ID. Read-only, Nullable. Doesn''t support $expand. */
