...
/**
 * Collection response for ProcessingErrorCollectionResponse
 */
class ProcessingErrorCollectionResponseCollectionResponse
{
    /**
     * @var ProcessingErrorCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return ProcessingErrorCollectionResponse[]
     */
     ...
     * 
     * @param ProcessingErrorCollectionResponse ...$items Variable number of ProcessingErrorCollectionResponse items
     * @return self
     */
    public function setValue(ProcessingErrorCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ProcessingErrorCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ProcessingErrorCollectionResponse $item
     * @return self
     */
    public function addValue(ProcessingErrorCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
