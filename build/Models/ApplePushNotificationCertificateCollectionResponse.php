...
/**
 * Collection response for ApplePushNotificationCertificate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ApplePushNotificationCertificateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ApplePushNotificationCertificate[]
     */
    private array $value = [];
     ...
     * 
     * @param ApplePushNotificationCertificate[] $items
     * @return self
     */
    public function setValue(array|ApplePushNotificationCertificate $items, ApplePushNotificationCertificate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ApplePushNotificationCertificate> $value
     * @return self
     ...
     * 
     * @param ApplePushNotificationCertificate $item
     * @return self
     */
    public function addValue(ApplePushNotificationCertificate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ApplePushNotificationCertificate>
     */
