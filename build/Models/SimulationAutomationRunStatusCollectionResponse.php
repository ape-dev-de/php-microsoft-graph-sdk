...
/**
 * Collection response for SimulationAutomationRunStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SimulationAutomationRunStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SimulationAutomationRunStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return SimulationAutomationRunStatus[]
     */
     ...
     * 
     * @param SimulationAutomationRunStatus[] $items
     * @return self
     */
    public function setValue(array|SimulationAutomationRunStatus $items, SimulationAutomationRunStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SimulationAutomationRunStatus> $value
     * @return self
     ...
     * 
     * @param SimulationAutomationRunStatus $item
     * @return self
     */
    public function addValue(SimulationAutomationRunStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SimulationAutomationRunStatus>
     */
