...
/**
 * SimulationAutomationRunStatusCollectionResponse - Collection response
 */
class SimulationAutomationRunStatusCollectionResponse
{
    /**
     * @var array<int, SimulationAutomationRunStatus>
     */
    public array $value = [];
