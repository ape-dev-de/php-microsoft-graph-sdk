...
/**
 * Collection response for ReferencedObjectCollectionResponse
 */
class ReferencedObjectCollectionResponseCollectionResponse
{
    /**
     * @var ReferencedObjectCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ReferencedObjectCollectionResponse ...$items Variable number of ReferencedObjectCollectionResponse items
     * @return self
     */
    public function setValue(ReferencedObjectCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ReferencedObjectCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ReferencedObjectCollectionResponse $item
     * @return self
     */
    public function addValue(ReferencedObjectCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
