 ...
 */
class IosLobAppAssignmentSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param IosLobAppAssignmentSettings ...$items Variable number of IosLobAppAssignmentSettings items
     * @return self
     */
    public function setValue(IosLobAppAssignmentSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
