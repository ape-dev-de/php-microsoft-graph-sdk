...
/**
 * Collection response for IosLobAppAssignmentSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosLobAppAssignmentSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IosLobAppAssignmentSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param IosLobAppAssignmentSettings[] $items
     * @return self
     */
    public function setValue(array|IosLobAppAssignmentSettings $items, IosLobAppAssignmentSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosLobAppAssignmentSettings> $value
     * @return self
     ...
     * 
     * @param IosLobAppAssignmentSettings $item
     * @return self
     */
    public function addValue(IosLobAppAssignmentSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IosLobAppAssignmentSettings|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IosLobAppAssignmentSettings>
     */
