...
/**
 * Collection response for CustomExtensionCalloutInstance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CustomExtensionCalloutInstanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CustomExtensionCalloutInstance[] $items
     * @return self
     */
    public function setValue(array|CustomExtensionCalloutInstance $items, CustomExtensionCalloutInstance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CustomExtensionCalloutInstance> $value
     * @return self
     ...
     * 
     * @param CustomExtensionCalloutInstance $item
     * @return self
     */
    public function addValue(CustomExtensionCalloutInstance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CustomExtensionCalloutInstance|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CustomExtensionCalloutInstance>
     */
