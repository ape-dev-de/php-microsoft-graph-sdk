...
/**
 * Collection response for DeviceConfigurationStateCollectionResponse
 */
class DeviceConfigurationStateCollectionResponseCollectionResponse
{
    /**
     * @var DeviceConfigurationStateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceConfigurationStateCollectionResponse ...$items Variable number of DeviceConfigurationStateCollectionResponse items
     * @return self
     */
    public function setValue(DeviceConfigurationStateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeviceConfigurationStateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeviceConfigurationStateCollectionResponse $item
     * @return self
     */
    public function addValue(DeviceConfigurationStateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
