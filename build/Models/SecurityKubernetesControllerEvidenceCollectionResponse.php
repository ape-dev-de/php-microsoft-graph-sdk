...
/**
 * Collection response for SecurityKubernetesControllerEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityKubernetesControllerEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityKubernetesControllerEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityKubernetesControllerEvidence[]
     */
     ...
     * 
     * @param SecurityKubernetesControllerEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityKubernetesControllerEvidence $items, SecurityKubernetesControllerEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityKubernetesControllerEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityKubernetesControllerEvidence $item
     * @return self
     */
    public function addValue(SecurityKubernetesControllerEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityKubernetesControllerEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityKubernetesControllerEvidence>
     */
