 ...
 */
class SecurityKubernetesControllerEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityKubernetesControllerEvidence ...$items Variable number of SecurityKubernetesControllerEvidence items
     * @return self
     */
    public function setValue(SecurityKubernetesControllerEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
