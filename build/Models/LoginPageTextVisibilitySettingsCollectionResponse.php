 ...
 */
class LoginPageTextVisibilitySettingsCollectionResponse
{
    /**
     ...
     * 
     * @param LoginPageTextVisibilitySettings ...$items Variable number of LoginPageTextVisibilitySettings items
     * @return self
     */
    public function setValue(LoginPageTextVisibilitySettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
