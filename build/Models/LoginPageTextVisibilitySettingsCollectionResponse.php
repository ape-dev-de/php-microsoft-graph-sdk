...
/**
 * Collection response for LoginPageTextVisibilitySettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LoginPageTextVisibilitySettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var LoginPageTextVisibilitySettings[]
     */
    private array $value = [];
     ...
     * 
     * @param LoginPageTextVisibilitySettings[] $items
     * @return self
     */
    public function setValue(array|LoginPageTextVisibilitySettings $items, LoginPageTextVisibilitySettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LoginPageTextVisibilitySettings> $value
     * @return self
     ...
     * 
     * @param LoginPageTextVisibilitySettings $item
     * @return self
     */
    public function addValue(LoginPageTextVisibilitySettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LoginPageTextVisibilitySettings>
     */
