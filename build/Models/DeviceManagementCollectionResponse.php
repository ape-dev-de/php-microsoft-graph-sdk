...
/**
 * Collection response for DeviceManagement
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceManagementCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceManagement[] $items
     * @return self
     */
    public function setValue(array|DeviceManagement $items, DeviceManagement ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceManagement> $value
     * @return self
     ...
     * 
     * @param DeviceManagement $item
     * @return self
     */
    public function addValue(DeviceManagement $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceManagement>
     */
