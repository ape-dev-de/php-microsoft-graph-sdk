 ...
 */
class DeviceManagementCollectionResponse
{
    /**
     ...
     * 
     * @param DeviceManagement ...$items Variable number of DeviceManagement items
     * @return self
     */
    public function setValue(DeviceManagement ...$items): self
    {
        $this->value = $items;
        return $this;
    }
