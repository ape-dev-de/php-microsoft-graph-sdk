...
/**
 * Collection response for UserExperienceAnalyticsAppHealthDeviceModelPerformance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsAppHealthDeviceModelPerformanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsAppHealthDeviceModelPerformance[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsAppHealthDeviceModelPerformance $items, UserExperienceAnalyticsAppHealthDeviceModelPerformance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsAppHealthDeviceModelPerformance> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsAppHealthDeviceModelPerformance $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsAppHealthDeviceModelPerformance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsAppHealthDeviceModelPerformance>
     */
