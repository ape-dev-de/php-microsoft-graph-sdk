...
/**
 * UserExperienceAnalyticsAppHealthDeviceModelPerformanceCollectionResponse - Collection response
 */
class UserExperienceAnalyticsAppHealthDeviceModelPerformanceCollectionResponse
{
    /**
     * @var array<int, UserExperienceAnalyticsAppHealthDeviceModelPerformance>
     */
    public array $value = [];
