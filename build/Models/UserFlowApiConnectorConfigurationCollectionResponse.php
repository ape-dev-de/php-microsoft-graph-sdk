 ...
 */
class UserFlowApiConnectorConfigurationCollectionResponse
{
    /**
     ...
     * 
     * @param UserFlowApiConnectorConfiguration ...$items Variable number of UserFlowApiConnectorConfiguration items
     * @return self
     */
    public function setValue(UserFlowApiConnectorConfiguration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
