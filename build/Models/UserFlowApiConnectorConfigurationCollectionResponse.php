...
/**
 * Collection response for UserFlowApiConnectorConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserFlowApiConnectorConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserFlowApiConnectorConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param UserFlowApiConnectorConfiguration[] $items
     * @return self
     */
    public function setValue(array|UserFlowApiConnectorConfiguration $items, UserFlowApiConnectorConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserFlowApiConnectorConfiguration> $value
     * @return self
     ...
     * 
     * @param UserFlowApiConnectorConfiguration $item
     * @return self
     */
    public function addValue(UserFlowApiConnectorConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserFlowApiConnectorConfiguration>
     */
