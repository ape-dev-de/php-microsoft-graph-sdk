...
/**
 * Collection response for MeetingAttendanceReportCollectionResponse
 */
class MeetingAttendanceReportCollectionResponseCollectionResponse
{
    /**
     * @var MeetingAttendanceReportCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MeetingAttendanceReportCollectionResponse ...$items Variable number of MeetingAttendanceReportCollectionResponse items
     * @return self
     */
    public function setValue(MeetingAttendanceReportCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MeetingAttendanceReportCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MeetingAttendanceReportCollectionResponse $item
     * @return self
     */
    public function addValue(MeetingAttendanceReportCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
