...
/**
 * Collection response for EducationExcelResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationExcelResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationExcelResource[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationExcelResource[] $items
     * @return self
     */
    public function setValue(array|EducationExcelResource $items, EducationExcelResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationExcelResource> $value
     * @return self
     ...
     * 
     * @param EducationExcelResource $item
     * @return self
     */
    public function addValue(EducationExcelResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EducationExcelResource|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EducationExcelResource>
     */
