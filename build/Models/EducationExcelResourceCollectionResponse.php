 ...
 */
class EducationExcelResourceCollectionResponse
{
    /**
     ...
     * 
     * @param EducationExcelResource ...$items Variable number of EducationExcelResource items
     * @return self
     */
    public function setValue(EducationExcelResource ...$items): self
    {
        $this->value = $items;
        return $this;
    }
