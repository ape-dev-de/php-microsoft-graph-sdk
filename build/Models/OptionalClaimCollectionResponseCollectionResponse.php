...
/**
 * Collection response for OptionalClaimCollectionResponse
 */
class OptionalClaimCollectionResponseCollectionResponse
{
    /**
     * @var OptionalClaimCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param OptionalClaimCollectionResponse ...$items Variable number of OptionalClaimCollectionResponse items
     * @return self
     */
    public function setValue(OptionalClaimCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<OptionalClaimCollectionResponse> $value
     * @return self
     ...
     * 
     * @param OptionalClaimCollectionResponse $item
     * @return self
     */
    public function addValue(OptionalClaimCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
