...
/**
 * Collection response for OnenotePage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnenotePageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnenotePage[]
     */
     ...
     * 
     * @param OnenotePage[] $items
     * @return self
     */
    public function setValue(array|OnenotePage $items, OnenotePage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param OnenotePage $item
     * @return self
     */
    public function addValue(OnenotePage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnenotePage>
     */
