...
/**
 * Collection response for DeviceEnrollmentConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceEnrollmentConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceEnrollmentConfiguration[] $items
     * @return self
     */
    public function setValue(array|DeviceEnrollmentConfiguration $items, DeviceEnrollmentConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceEnrollmentConfiguration> $value
     * @return self
     ...
     * 
     * @param DeviceEnrollmentConfiguration $item
     * @return self
     */
    public function addValue(DeviceEnrollmentConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceEnrollmentConfiguration>
     */
