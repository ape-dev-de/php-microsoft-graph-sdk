...
/**
 * Collection response for OnenotePagePreview
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnenotePagePreviewCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnenotePagePreview[]
     */
    private array $value = [];
     ...
     * 
     * @param OnenotePagePreview[] $items
     * @return self
     */
    public function setValue(array|OnenotePagePreview $items, OnenotePagePreview ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnenotePagePreview> $value
     * @return self
     ...
     * 
     * @param OnenotePagePreview $item
     * @return self
     */
    public function addValue(OnenotePagePreview $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OnenotePagePreview|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OnenotePagePreview>
     */
