 ...
 */
class OnenotePagePreviewCollectionResponse
{
    /**
     ...
     * 
     * @param OnenotePagePreview ...$items Variable number of OnenotePagePreview items
     * @return self
     */
    public function setValue(OnenotePagePreview ...$items): self
    {
        $this->value = $items;
        return $this;
    }
