...
/**
 * Collection response for WindowsUpdateForBusinessConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsUpdateForBusinessConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsUpdateForBusinessConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsUpdateForBusinessConfiguration[] $items
     * @return self
     */
    public function setValue(array|WindowsUpdateForBusinessConfiguration $items, WindowsUpdateForBusinessConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsUpdateForBusinessConfiguration> $value
     * @return self
     ...
     * 
     * @param WindowsUpdateForBusinessConfiguration $item
     * @return self
     */
    public function addValue(WindowsUpdateForBusinessConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WindowsUpdateForBusinessConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WindowsUpdateForBusinessConfiguration>
     */
