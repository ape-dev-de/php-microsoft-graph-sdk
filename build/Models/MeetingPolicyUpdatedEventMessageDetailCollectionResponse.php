...
/**
 * Collection response for MeetingPolicyUpdatedEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MeetingPolicyUpdatedEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MeetingPolicyUpdatedEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param MeetingPolicyUpdatedEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|MeetingPolicyUpdatedEventMessageDetail $items, MeetingPolicyUpdatedEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MeetingPolicyUpdatedEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param MeetingPolicyUpdatedEventMessageDetail $item
     * @return self
     */
    public function addValue(MeetingPolicyUpdatedEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MeetingPolicyUpdatedEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MeetingPolicyUpdatedEventMessageDetail>
     */
