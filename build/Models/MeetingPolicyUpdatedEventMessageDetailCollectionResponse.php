 ...
 */
class MeetingPolicyUpdatedEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param MeetingPolicyUpdatedEventMessageDetail ...$items Variable number of MeetingPolicyUpdatedEventMessageDetail items
     * @return self
     */
    public function setValue(MeetingPolicyUpdatedEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
