 ...
 */
class AadUserNotificationRecipientCollectionResponse
{
    /**
     ...
     * 
     * @param AadUserNotificationRecipient ...$items Variable number of AadUserNotificationRecipient items
     * @return self
     */
    public function setValue(AadUserNotificationRecipient ...$items): self
    {
        $this->value = $items;
        return $this;
    }
