...
/**
 * Collection response for AadUserNotificationRecipient
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AadUserNotificationRecipientCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AadUserNotificationRecipient[]
     */
    private array $value = [];
     ...
     * 
     * @param AadUserNotificationRecipient[] $items
     * @return self
     */
    public function setValue(array|AadUserNotificationRecipient $items, AadUserNotificationRecipient ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AadUserNotificationRecipient> $value
     * @return self
     ...
     * 
     * @param AadUserNotificationRecipient $item
     * @return self
     */
    public function addValue(AadUserNotificationRecipient $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AadUserNotificationRecipient|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AadUserNotificationRecipient>
     */
