...
/**
 * Collection response for SearchAggregation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SearchAggregationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SearchAggregation[] $items
     * @return self
     */
    public function setValue(array|SearchAggregation $items, SearchAggregation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SearchAggregation> $value
     * @return self
     ...
     * 
     * @param SearchAggregation $item
     * @return self
     */
    public function addValue(SearchAggregation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SearchAggregation>
     */
