 ...
 */
class TeamworkApplicationIdentityCollectionResponse
{
    /**
     ...
     * 
     * @param TeamworkApplicationIdentity ...$items Variable number of TeamworkApplicationIdentity items
     * @return self
     */
    public function setValue(TeamworkApplicationIdentity ...$items): self
    {
        $this->value = $items;
        return $this;
    }
