...
/**
 * Collection response for TeamworkApplicationIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamworkApplicationIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamworkApplicationIdentity[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamworkApplicationIdentity[] $items
     * @return self
     */
    public function setValue(array|TeamworkApplicationIdentity $items, TeamworkApplicationIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamworkApplicationIdentity> $value
     * @return self
     ...
     * 
     * @param TeamworkApplicationIdentity $item
     * @return self
     */
    public function addValue(TeamworkApplicationIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TeamworkApplicationIdentity|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TeamworkApplicationIdentity>
     */
