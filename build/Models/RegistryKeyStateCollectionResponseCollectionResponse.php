...
/**
 * Collection response for RegistryKeyStateCollectionResponse
 */
class RegistryKeyStateCollectionResponseCollectionResponse
{
    /**
     * @var RegistryKeyStateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RegistryKeyStateCollectionResponse ...$items Variable number of RegistryKeyStateCollectionResponse items
     * @return self
     */
    public function setValue(RegistryKeyStateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RegistryKeyStateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RegistryKeyStateCollectionResponse $item
     * @return self
     */
    public function addValue(RegistryKeyStateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
