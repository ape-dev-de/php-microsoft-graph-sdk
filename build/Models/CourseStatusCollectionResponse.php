...
/**
 * Collection response for CourseStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CourseStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CourseStatus[]
     */
     ...
     * 
     * @param CourseStatus[] $items
     * @return self
     */
    public function setValue(array|CourseStatus $items, CourseStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CourseStatus> $value
     * @return self
     ...
     * 
     * @param CourseStatus $item
     * @return self
     */
    public function addValue(CourseStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CourseStatus>
     */
