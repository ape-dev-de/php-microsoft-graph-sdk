...
/**
 * Collection response for AuthenticationCombinationConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationCombinationConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AuthenticationCombinationConfiguration[] $items
     * @return self
     */
    public function setValue(array|AuthenticationCombinationConfiguration $items, AuthenticationCombinationConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationCombinationConfiguration> $value
     * @return self
     ...
     * 
     * @param AuthenticationCombinationConfiguration $item
     * @return self
     */
    public function addValue(AuthenticationCombinationConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationCombinationConfiguration>
     */
