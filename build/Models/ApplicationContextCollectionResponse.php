 ...
 */
class ApplicationContextCollectionResponse
{
    /**
     ...
     * 
     * @param ApplicationContext ...$items Variable number of ApplicationContext items
     * @return self
     */
    public function setValue(ApplicationContext ...$items): self
    {
        $this->value = $items;
        return $this;
    }
