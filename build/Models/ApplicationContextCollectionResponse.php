...
/**
 * Collection response for ApplicationContext
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ApplicationContextCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ApplicationContext[] $items
     * @return self
     */
    public function setValue(array|ApplicationContext $items, ApplicationContext ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ApplicationContext> $value
     * @return self
     ...
     * 
     * @param ApplicationContext $item
     * @return self
     */
    public function addValue(ApplicationContext $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ApplicationContext>
     */
