...
/**
 * Collection response for DelegatedAdminRelationshipOperationCollectionResponse
 */
class DelegatedAdminRelationshipOperationCollectionResponseCollectionResponse
{
    /**
     * @var DelegatedAdminRelationshipOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DelegatedAdminRelationshipOperationCollectionResponse ...$items Variable number of DelegatedAdminRelationshipOperationCollectionResponse items
     * @return self
     */
    public function setValue(DelegatedAdminRelationshipOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DelegatedAdminRelationshipOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DelegatedAdminRelationshipOperationCollectionResponse $item
     * @return self
     */
    public function addValue(DelegatedAdminRelationshipOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
