...
/**
 * Collection response for CallRecordsCallRecordCollectionResponse
 */
class CallRecordsCallRecordCollectionResponseCollectionResponse
{
    /**
     * @var CallRecordsCallRecordCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CallRecordsCallRecordCollectionResponse ...$items Variable number of CallRecordsCallRecordCollectionResponse items
     * @return self
     */
    public function setValue(CallRecordsCallRecordCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CallRecordsCallRecordCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CallRecordsCallRecordCollectionResponse $item
     * @return self
     */
    public function addValue(CallRecordsCallRecordCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
