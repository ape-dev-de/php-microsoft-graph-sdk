...
/**
 * Collection response for VirtualEventRegistration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualEventRegistrationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param VirtualEventRegistration[] $items
     * @return self
     */
    public function setValue(array|VirtualEventRegistration $items, VirtualEventRegistration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualEventRegistration> $value
     * @return self
     ...
     * 
     * @param VirtualEventRegistration $item
     * @return self
     */
    public function addValue(VirtualEventRegistration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VirtualEventRegistration>
     */
