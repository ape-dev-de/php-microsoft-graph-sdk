...
/**
 * Collection response for SendDtmfCompletionReason
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SendDtmfCompletionReasonCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SendDtmfCompletionReason[]
     */
    private array $value = [];
     ...
     * 
     * @return SendDtmfCompletionReason[]
     */
     ...
     * 
     * @param SendDtmfCompletionReason[] $items
     * @return self
     */
    public function setValue(array|SendDtmfCompletionReason $items, SendDtmfCompletionReason ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SendDtmfCompletionReason> $value
     * @return self
     ...
     * 
     * @param SendDtmfCompletionReason $item
     * @return self
     */
    public function addValue(SendDtmfCompletionReason $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SendDtmfCompletionReason>
     */
