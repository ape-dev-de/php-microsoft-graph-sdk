...
/**
 * Collection response for DocumentSetContent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DocumentSetContentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DocumentSetContent[] $items
     * @return self
     */
    public function setValue(array|DocumentSetContent $items, DocumentSetContent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DocumentSetContent> $value
     * @return self
     ...
     * 
     * @param DocumentSetContent $item
     * @return self
     */
    public function addValue(DocumentSetContent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DocumentSetContent>
     */
