...
/**
 * Collection response for CallOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallOptions[]
     */
     ...
     * 
     * @param CallOptions[] $items
     * @return self
     */
    public function setValue(array|CallOptions $items, CallOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param CallOptions $item
     * @return self
     */
    public function addValue(CallOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CallOptions>
     */
