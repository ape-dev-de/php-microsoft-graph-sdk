...
/**
 * Collection response for TeamworkTag
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamworkTagCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamworkTag[]
     */
     ...
     * 
     * @param TeamworkTag[] $items
     * @return self
     */
    public function setValue(array|TeamworkTag $items, TeamworkTag ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param TeamworkTag $item
     * @return self
     */
    public function addValue(TeamworkTag $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamworkTag>
     */
