...
/**
 * Collection response for StringKeyObjectValuePairCollectionResponse
 */
class StringKeyObjectValuePairCollectionResponseCollectionResponse
{
    /**
     * @var StringKeyObjectValuePairCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param StringKeyObjectValuePairCollectionResponse ...$items Variable number of StringKeyObjectValuePairCollectionResponse items
     * @return self
     */
    public function setValue(StringKeyObjectValuePairCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<StringKeyObjectValuePairCollectionResponse> $value
     * @return self
     ...
     * 
     * @param StringKeyObjectValuePairCollectionResponse $item
     * @return self
     */
    public function addValue(StringKeyObjectValuePairCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
