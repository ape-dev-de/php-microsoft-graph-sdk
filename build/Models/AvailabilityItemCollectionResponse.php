...
/**
 * Collection response for AvailabilityItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AvailabilityItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AvailabilityItem[] $items
     * @return self
     */
    public function setValue(array|AvailabilityItem $items, AvailabilityItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AvailabilityItem> $value
     * @return self
     ...
     * 
     * @param AvailabilityItem $item
     * @return self
     */
    public function addValue(AvailabilityItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AvailabilityItem>
     */
