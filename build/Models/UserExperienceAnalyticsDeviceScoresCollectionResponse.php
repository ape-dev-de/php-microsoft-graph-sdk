...
/**
 * Collection response for UserExperienceAnalyticsDeviceScores
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsDeviceScoresCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsDeviceScores[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsDeviceScores $items, UserExperienceAnalyticsDeviceScores ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsDeviceScores> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsDeviceScores $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsDeviceScores $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsDeviceScores>
     */
