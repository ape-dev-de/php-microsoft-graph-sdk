...
/**
 * SubjectRightsRequestStageStatusCollectionResponse - Collection response
 */
class SubjectRightsRequestStageStatusCollectionResponse
{
    /**
     * @var array<int, SubjectRightsRequestStageStatus>
     */
    public array $value = [];
