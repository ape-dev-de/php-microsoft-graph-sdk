...
/**
 * Collection response for SubjectRightsRequestStageStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SubjectRightsRequestStageStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SubjectRightsRequestStageStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return SubjectRightsRequestStageStatus[]
     */
     ...
     * 
     * @param SubjectRightsRequestStageStatus[] $items
     * @return self
     */
    public function setValue(array|SubjectRightsRequestStageStatus $items, SubjectRightsRequestStageStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SubjectRightsRequestStageStatus> $value
     * @return self
     ...
     * 
     * @param SubjectRightsRequestStageStatus $item
     * @return self
     */
    public function addValue(SubjectRightsRequestStageStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SubjectRightsRequestStageStatus>
     */
