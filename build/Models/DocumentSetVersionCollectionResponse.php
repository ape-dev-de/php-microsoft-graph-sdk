...
/**
 * Collection response for DocumentSetVersion
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DocumentSetVersionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DocumentSetVersion[] $items
     * @return self
     */
    public function setValue(array|DocumentSetVersion $items, DocumentSetVersion ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DocumentSetVersion> $value
     * @return self
     ...
     * 
     * @param DocumentSetVersion $item
     * @return self
     */
    public function addValue(DocumentSetVersion $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DocumentSetVersion>
     */
