...
/**
 * Collection response for ActivityType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ActivityTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ActivityType[]
     */
     ...
     * 
     * @param ActivityType[] $items
     * @return self
     */
    public function setValue(array|ActivityType $items, ActivityType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ActivityType> $value
     * @return self
     ...
     * 
     * @param ActivityType $item
     * @return self
     */
    public function addValue(ActivityType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ActivityType>
     */
