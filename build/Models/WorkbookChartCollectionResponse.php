...
/**
 * Collection response for WorkbookChart
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookChartCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookChart[]
     */
     ...
     * 
     * @param WorkbookChart[] $items
     * @return self
     */
    public function setValue(array|WorkbookChart $items, WorkbookChart ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookChart> $value
     * @return self
     ...
     * 
     * @param WorkbookChart $item
     * @return self
     */
    public function addValue(WorkbookChart $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookChart>
     */
