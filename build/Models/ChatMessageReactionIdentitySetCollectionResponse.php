...
/**
 * Collection response for ChatMessageReactionIdentitySet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatMessageReactionIdentitySetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChatMessageReactionIdentitySet[]
     */
    private array $value = [];
     ...
     * 
     * @param ChatMessageReactionIdentitySet[] $items
     * @return self
     */
    public function setValue(array|ChatMessageReactionIdentitySet $items, ChatMessageReactionIdentitySet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChatMessageReactionIdentitySet> $value
     * @return self
     ...
     * 
     * @param ChatMessageReactionIdentitySet $item
     * @return self
     */
    public function addValue(ChatMessageReactionIdentitySet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChatMessageReactionIdentitySet>
     */
