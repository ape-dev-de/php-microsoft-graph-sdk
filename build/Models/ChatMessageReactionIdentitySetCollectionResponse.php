...
/**
 * ChatMessageReactionIdentitySetCollectionResponse - Collection response
 */
class ChatMessageReactionIdentitySetCollectionResponse
{
    /**
     * @var array<int, ChatMessageReactionIdentitySet>
     */
    public array $value = [];
