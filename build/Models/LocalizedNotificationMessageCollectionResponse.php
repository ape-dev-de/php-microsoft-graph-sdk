...
/**
 * Collection response for LocalizedNotificationMessage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LocalizedNotificationMessageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param LocalizedNotificationMessage[] $items
     * @return self
     */
    public function setValue(array|LocalizedNotificationMessage $items, LocalizedNotificationMessage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LocalizedNotificationMessage> $value
     * @return self
     ...
     * 
     * @param LocalizedNotificationMessage $item
     * @return self
     */
    public function addValue(LocalizedNotificationMessage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LocalizedNotificationMessage>
     */
