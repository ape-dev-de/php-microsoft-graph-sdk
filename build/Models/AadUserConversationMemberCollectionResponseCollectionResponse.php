...
/**
 * Collection response for AadUserConversationMemberCollectionResponse
 */
class AadUserConversationMemberCollectionResponseCollectionResponse
{
    /**
     * @var AadUserConversationMemberCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AadUserConversationMemberCollectionResponse ...$items Variable number of AadUserConversationMemberCollectionResponse items
     * @return self
     */
    public function setValue(AadUserConversationMemberCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AadUserConversationMemberCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AadUserConversationMemberCollectionResponse $item
     * @return self
     */
    public function addValue(AadUserConversationMemberCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
