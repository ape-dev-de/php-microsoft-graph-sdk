...
/**
 * Collection response for IdentityGovernanceTaskCollectionResponse
 */
class IdentityGovernanceTaskCollectionResponseCollectionResponse
{
    /**
     * @var IdentityGovernanceTaskCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityGovernanceTaskCollectionResponse ...$items Variable number of IdentityGovernanceTaskCollectionResponse items
     * @return self
     */
    public function setValue(IdentityGovernanceTaskCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IdentityGovernanceTaskCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceTaskCollectionResponse $item
     * @return self
     */
    public function addValue(IdentityGovernanceTaskCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
