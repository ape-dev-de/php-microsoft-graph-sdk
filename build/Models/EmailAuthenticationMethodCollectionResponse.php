...
/**
 * Collection response for EmailAuthenticationMethod
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EmailAuthenticationMethodCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param EmailAuthenticationMethod[] $items
     * @return self
     */
    public function setValue(array|EmailAuthenticationMethod $items, EmailAuthenticationMethod ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EmailAuthenticationMethod> $value
     * @return self
     ...
     * 
     * @param EmailAuthenticationMethod $item
     * @return self
     */
    public function addValue(EmailAuthenticationMethod $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EmailAuthenticationMethod>
     */
