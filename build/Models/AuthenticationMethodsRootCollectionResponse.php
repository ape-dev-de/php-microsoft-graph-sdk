...
/**
 * Collection response for AuthenticationMethodsRoot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationMethodsRootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuthenticationMethodsRoot[]
     */
    private array $value = [];
     ...
     * 
     * @param AuthenticationMethodsRoot[] $items
     * @return self
     */
    public function setValue(array|AuthenticationMethodsRoot $items, AuthenticationMethodsRoot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationMethodsRoot> $value
     * @return self
     ...
     * 
     * @param AuthenticationMethodsRoot $item
     * @return self
     */
    public function addValue(AuthenticationMethodsRoot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationMethodsRoot>
     */
