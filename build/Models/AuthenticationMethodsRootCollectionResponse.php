 ...
 */
class AuthenticationMethodsRootCollectionResponse
{
    /**
     ...
     * 
     * @param AuthenticationMethodsRoot ...$items Variable number of AuthenticationMethodsRoot items
     * @return self
     */
    public function setValue(AuthenticationMethodsRoot ...$items): self
    {
        $this->value = $items;
        return $this;
    }
