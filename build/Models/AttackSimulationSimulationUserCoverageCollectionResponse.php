...
/**
 * Collection response for AttackSimulationSimulationUserCoverage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttackSimulationSimulationUserCoverageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AttackSimulationSimulationUserCoverage[]
     */
    private array $value = [];
     ...
     * 
     * @param AttackSimulationSimulationUserCoverage[] $items
     * @return self
     */
    public function setValue(array|AttackSimulationSimulationUserCoverage $items, AttackSimulationSimulationUserCoverage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttackSimulationSimulationUserCoverage> $value
     * @return self
     ...
     * 
     * @param AttackSimulationSimulationUserCoverage $item
     * @return self
     */
    public function addValue(AttackSimulationSimulationUserCoverage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AttackSimulationSimulationUserCoverage|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AttackSimulationSimulationUserCoverage>
     */
