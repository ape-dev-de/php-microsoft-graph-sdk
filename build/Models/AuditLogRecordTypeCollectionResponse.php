...
/**
 * Collection response for AuditLogRecordType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuditLogRecordTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AuditLogRecordType[] $items
     * @return self
     */
    public function setValue(array|AuditLogRecordType $items, AuditLogRecordType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuditLogRecordType> $value
     * @return self
     ...
     * 
     * @param AuditLogRecordType $item
     * @return self
     */
    public function addValue(AuditLogRecordType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuditLogRecordType>
     */
