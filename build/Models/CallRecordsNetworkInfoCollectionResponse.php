 ...
 */
class CallRecordsNetworkInfoCollectionResponse
{
    /**
     ...
     * 
     * @param CallRecordsNetworkInfo ...$items Variable number of CallRecordsNetworkInfo items
     * @return self
     */
    public function setValue(CallRecordsNetworkInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
