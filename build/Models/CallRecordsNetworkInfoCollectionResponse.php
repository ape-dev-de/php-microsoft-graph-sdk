...
/**
 * Collection response for CallRecordsNetworkInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsNetworkInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsNetworkInfo[]
     */
    private array $value = [];
     ...
     * 
     * @param CallRecordsNetworkInfo[] $items
     * @return self
     */
    public function setValue(array|CallRecordsNetworkInfo $items, CallRecordsNetworkInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsNetworkInfo> $value
     * @return self
     ...
     * 
     * @param CallRecordsNetworkInfo $item
     * @return self
     */
    public function addValue(CallRecordsNetworkInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsNetworkInfo|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsNetworkInfo>
     */
