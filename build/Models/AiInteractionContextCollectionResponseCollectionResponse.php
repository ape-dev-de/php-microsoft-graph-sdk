...
/**
 * Collection response for AiInteractionContextCollectionResponse
 */
class AiInteractionContextCollectionResponseCollectionResponse
{
    /**
     * @var AiInteractionContextCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return AiInteractionContextCollectionResponse[]
     */
     ...
     * 
     * @param AiInteractionContextCollectionResponse ...$items Variable number of AiInteractionContextCollectionResponse items
     * @return self
     */
    public function setValue(AiInteractionContextCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AiInteractionContextCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AiInteractionContextCollectionResponse $item
     * @return self
     */
    public function addValue(AiInteractionContextCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
