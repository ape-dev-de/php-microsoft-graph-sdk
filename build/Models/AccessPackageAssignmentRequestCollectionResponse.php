...
/**
 * Collection response for AccessPackageAssignmentRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageAssignmentRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessPackageAssignmentRequest[] $items
     * @return self
     */
    public function setValue(array|AccessPackageAssignmentRequest $items, AccessPackageAssignmentRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageAssignmentRequest> $value
     * @return self
     ...
     * 
     * @param AccessPackageAssignmentRequest $item
     * @return self
     */
    public function addValue(AccessPackageAssignmentRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageAssignmentRequest>
     */
