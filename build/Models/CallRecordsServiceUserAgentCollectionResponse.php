 ...
 */
class CallRecordsServiceUserAgentCollectionResponse
{
    /**
     ...
     * 
     * @param CallRecordsServiceUserAgent ...$items Variable number of CallRecordsServiceUserAgent items
     * @return self
     */
    public function setValue(CallRecordsServiceUserAgent ...$items): self
    {
        $this->value = $items;
        return $this;
    }
