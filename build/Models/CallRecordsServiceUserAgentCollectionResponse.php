...
/**
 * Collection response for CallRecordsServiceUserAgent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsServiceUserAgentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsServiceUserAgent[]
     */
    private array $value = [];
     ...
     * 
     * @return CallRecordsServiceUserAgent[]
     */
     ...
     * 
     * @param CallRecordsServiceUserAgent[] $items
     * @return self
     */
    public function setValue(array|CallRecordsServiceUserAgent $items, CallRecordsServiceUserAgent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsServiceUserAgent> $value
     * @return self
     ...
     * 
     * @param CallRecordsServiceUserAgent $item
     * @return self
     */
    public function addValue(CallRecordsServiceUserAgent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsServiceUserAgent|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsServiceUserAgent>
     */
