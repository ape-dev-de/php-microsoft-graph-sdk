 ...
 */
class SecurityThreatIntelligenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityThreatIntelligence ...$items Variable number of SecurityThreatIntelligence items
     * @return self
     */
    public function setValue(SecurityThreatIntelligence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
