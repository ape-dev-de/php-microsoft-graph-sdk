...
/**
 * Collection response for SecurityThreatIntelligence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityThreatIntelligenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityThreatIntelligence[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityThreatIntelligence[] $items
     * @return self
     */
    public function setValue(array|SecurityThreatIntelligence $items, SecurityThreatIntelligence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityThreatIntelligence> $value
     * @return self
     ...
     * 
     * @param SecurityThreatIntelligence $item
     * @return self
     */
    public function addValue(SecurityThreatIntelligence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityThreatIntelligence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityThreatIntelligence>
     */
