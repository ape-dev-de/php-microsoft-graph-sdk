 ...
 */
class ChannelSummaryCollectionResponse
{
    /**
     * @var ChannelSummary[]
     */
     ...
     * 
     * @param ChannelSummary ...$items Variable number of ChannelSummary items
     * @return self
     */
    public function setValue(ChannelSummary ...$items): self
    {
        $this->value = $items;
        return $this;
    }
