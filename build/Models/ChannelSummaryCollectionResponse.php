...
/**
 * Collection response for ChannelSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChannelSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChannelSummary[]
     */
     ...
     * 
     * @param ChannelSummary[] $items
     * @return self
     */
    public function setValue(array|ChannelSummary $items, ChannelSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChannelSummary> $value
     * @return self
     ...
     * 
     * @param ChannelSummary $item
     * @return self
     */
    public function addValue(ChannelSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChannelSummary>
     */
