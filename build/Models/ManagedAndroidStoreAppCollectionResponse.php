...
/**
 * Collection response for ManagedAndroidStoreApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedAndroidStoreAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ManagedAndroidStoreApp[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedAndroidStoreApp[] $items
     * @return self
     */
    public function setValue(array|ManagedAndroidStoreApp $items, ManagedAndroidStoreApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedAndroidStoreApp> $value
     * @return self
     ...
     * 
     * @param ManagedAndroidStoreApp $item
     * @return self
     */
    public function addValue(ManagedAndroidStoreApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ManagedAndroidStoreApp|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ManagedAndroidStoreApp>
     */
