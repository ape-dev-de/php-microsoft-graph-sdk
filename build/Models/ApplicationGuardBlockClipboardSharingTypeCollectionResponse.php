...
/**
 * ApplicationGuardBlockClipboardSharingTypeCollectionResponse - Collection response
 */
class ApplicationGuardBlockClipboardSharingTypeCollectionResponse
{
    /**
     * @var array<int, ApplicationGuardBlockClipboardSharingType>
     */
    public array $value = [];
