...
/**
 * Collection response for ApplicationGuardBlockClipboardSharingType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ApplicationGuardBlockClipboardSharingTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ApplicationGuardBlockClipboardSharingType[]
     */
    private array $value = [];
     ...
     * 
     * @return ApplicationGuardBlockClipboardSharingType[]
     */
     ...
     * 
     * @param ApplicationGuardBlockClipboardSharingType[] $items
     * @return self
     */
    public function setValue(array|ApplicationGuardBlockClipboardSharingType $items, ApplicationGuardBlockClipboardSharingType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ApplicationGuardBlockClipboardSharingType> $value
     * @return self
     ...
     * 
     * @param ApplicationGuardBlockClipboardSharingType $item
     * @return self
     */
    public function addValue(ApplicationGuardBlockClipboardSharingType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ApplicationGuardBlockClipboardSharingType>
     */
