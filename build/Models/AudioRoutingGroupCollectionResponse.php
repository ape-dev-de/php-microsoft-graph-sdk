...
/**
 * Collection response for AudioRoutingGroup
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AudioRoutingGroupCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AudioRoutingGroup[] $items
     * @return self
     */
    public function setValue(array|AudioRoutingGroup $items, AudioRoutingGroup ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AudioRoutingGroup> $value
     * @return self
     ...
     * 
     * @param AudioRoutingGroup $item
     * @return self
     */
    public function addValue(AudioRoutingGroup $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AudioRoutingGroup>
     */
