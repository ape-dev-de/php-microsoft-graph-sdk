...
/**
 * Collection response for SiteArchiveStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SiteArchiveStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SiteArchiveStatus[]
     */
    private array $value = [];
     ...
     * 
     * @param SiteArchiveStatus[] $items
     * @return self
     */
    public function setValue(array|SiteArchiveStatus $items, SiteArchiveStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SiteArchiveStatus> $value
     * @return self
     ...
     * 
     * @param SiteArchiveStatus $item
     * @return self
     */
    public function addValue(SiteArchiveStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SiteArchiveStatus>
     */
