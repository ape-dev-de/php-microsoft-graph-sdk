...
/**
 * Collection response for AndroidStoreApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AndroidStoreAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AndroidStoreApp[]
     */
     ...
     * 
     * @param AndroidStoreApp[] $items
     * @return self
     */
    public function setValue(array|AndroidStoreApp $items, AndroidStoreApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AndroidStoreApp> $value
     * @return self
     ...
     * 
     * @param AndroidStoreApp $item
     * @return self
     */
    public function addValue(AndroidStoreApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AndroidStoreApp>
     */
