...
/**
 * Collection response for SecurityPurgeAreas
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityPurgeAreasCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityPurgeAreas[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityPurgeAreas[] $items
     * @return self
     */
    public function setValue(array|SecurityPurgeAreas $items, SecurityPurgeAreas ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityPurgeAreas> $value
     * @return self
     ...
     * 
     * @param SecurityPurgeAreas $item
     * @return self
     */
    public function addValue(SecurityPurgeAreas $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityPurgeAreas|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityPurgeAreas>
     */
