 ...
 */
class ChannelIdentityCollectionResponse
{
    /**
     * @var ChannelIdentity[]
     */
     ...
     * 
     * @param ChannelIdentity ...$items Variable number of ChannelIdentity items
     * @return self
     */
    public function setValue(ChannelIdentity ...$items): self
    {
        $this->value = $items;
        return $this;
    }
