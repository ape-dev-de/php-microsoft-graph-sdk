...
/**
 * Collection response for ChannelIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChannelIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChannelIdentity[]
     */
     ...
     * 
     * @param ChannelIdentity[] $items
     * @return self
     */
    public function setValue(array|ChannelIdentity $items, ChannelIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChannelIdentity> $value
     * @return self
     ...
     * 
     * @param ChannelIdentity $item
     * @return self
     */
    public function addValue(ChannelIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChannelIdentity>
     */
