...
/**
 * Collection response for DeviceManagementSubscriptionState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceManagementSubscriptionStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceManagementSubscriptionState[]
     */
    private array $value = [];
     ...
     * 
     * @return DeviceManagementSubscriptionState[]
     */
     ...
     * 
     * @param DeviceManagementSubscriptionState[] $items
     * @return self
     */
    public function setValue(array|DeviceManagementSubscriptionState $items, DeviceManagementSubscriptionState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceManagementSubscriptionState> $value
     * @return self
     ...
     * 
     * @param DeviceManagementSubscriptionState $item
     * @return self
     */
    public function addValue(DeviceManagementSubscriptionState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceManagementSubscriptionState>
     */
