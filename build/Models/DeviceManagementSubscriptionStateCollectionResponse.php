...
/**
 * DeviceManagementSubscriptionStateCollectionResponse - Collection response
 */
class DeviceManagementSubscriptionStateCollectionResponse
{
    /**
     * @var array<int, DeviceManagementSubscriptionState>
     */
    public array $value = [];
