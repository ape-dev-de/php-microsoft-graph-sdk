...
/**
 * Collection response for ManagedIOSStoreApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedIOSStoreAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ManagedIOSStoreApp[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedIOSStoreApp[] $items
     * @return self
     */
    public function setValue(array|ManagedIOSStoreApp $items, ManagedIOSStoreApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedIOSStoreApp> $value
     * @return self
     ...
     * 
     * @param ManagedIOSStoreApp $item
     * @return self
     */
    public function addValue(ManagedIOSStoreApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ManagedIOSStoreApp|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ManagedIOSStoreApp>
     */
