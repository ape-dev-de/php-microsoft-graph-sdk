...
/**
 * Collection response for UserExperienceAnalyticsOperatingSystemRestartCategory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsOperatingSystemRestartCategoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserExperienceAnalyticsOperatingSystemRestartCategory[]
     */
    private array $value = [];
     ...
     * 
     * @return UserExperienceAnalyticsOperatingSystemRestartCategory[]
     */
     ...
     * 
     * @param UserExperienceAnalyticsOperatingSystemRestartCategory[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsOperatingSystemRestartCategory $items, UserExperienceAnalyticsOperatingSystemRestartCategory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsOperatingSystemRestartCategory> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsOperatingSystemRestartCategory $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsOperatingSystemRestartCategory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsOperatingSystemRestartCategory>
     */
