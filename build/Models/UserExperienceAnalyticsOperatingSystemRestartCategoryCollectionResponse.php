...
/**
 * UserExperienceAnalyticsOperatingSystemRestartCategoryCollectionResponse - Collection response
 */
class UserExperienceAnalyticsOperatingSystemRestartCategoryCollectionResponse
{
    /**
     * @var array<int, UserExperienceAnalyticsOperatingSystemRestartCategory>
     */
    public array $value = [];
