...
/**
 * Collection response for UserActivity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserActivityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserActivity[]
     */
     ...
     * 
     * @param UserActivity[] $items
     * @return self
     */
    public function setValue(array|UserActivity $items, UserActivity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserActivity> $value
     * @return self
     ...
     * @return self
     */
    public function addValue(UserActivity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserActivity>
     */
