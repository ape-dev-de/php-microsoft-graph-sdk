...
/**
 * Collection response for EducationTeacher
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationTeacherCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param EducationTeacher[] $items
     * @return self
     */
    public function setValue(array|EducationTeacher $items, EducationTeacher ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationTeacher> $value
     * @return self
     ...
     * 
     * @param EducationTeacher $item
     * @return self
     */
    public function addValue(EducationTeacher $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationTeacher>
     */
