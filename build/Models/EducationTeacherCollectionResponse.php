 ...
 */
class EducationTeacherCollectionResponse
{
    /**
     ...
     * 
     * @param EducationTeacher ...$items Variable number of EducationTeacher items
     * @return self
     */
    public function setValue(EducationTeacher ...$items): self
    {
        $this->value = $items;
        return $this;
    }
