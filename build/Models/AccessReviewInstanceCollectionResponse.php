...
/**
 * Collection response for AccessReviewInstance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewInstanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessReviewInstance[] $items
     * @return self
     */
    public function setValue(array|AccessReviewInstance $items, AccessReviewInstance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewInstance> $value
     * @return self
     ...
     * 
     * @param AccessReviewInstance $item
     * @return self
     */
    public function addValue(AccessReviewInstance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewInstance>
     */
