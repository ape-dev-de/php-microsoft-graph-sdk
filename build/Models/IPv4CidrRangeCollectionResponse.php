 ...
 */
class IPv4CidrRangeCollectionResponse
{
    /**
     * @var IPv4CidrRange[]
     */
     ...
     * 
     * @param IPv4CidrRange ...$items Variable number of IPv4CidrRange items
     * @return self
     */
    public function setValue(IPv4CidrRange ...$items): self
    {
        $this->value = $items;
        return $this;
    }
