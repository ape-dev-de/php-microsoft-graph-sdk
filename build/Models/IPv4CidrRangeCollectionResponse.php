...
/**
 * Collection response for IPv4CidrRange
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IPv4CidrRangeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IPv4CidrRange[]
     */
     ...
     * 
     * @param IPv4CidrRange[] $items
     * @return self
     */
    public function setValue(array|IPv4CidrRange $items, IPv4CidrRange ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IPv4CidrRange> $value
     * @return self
     ...
     * 
     * @param IPv4CidrRange $item
     * @return self
     */
    public function addValue(IPv4CidrRange $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IPv4CidrRange>
     */
