 ...
 */
class LocalAdminPasswordSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param LocalAdminPasswordSettings ...$items Variable number of LocalAdminPasswordSettings items
     * @return self
     */
    public function setValue(LocalAdminPasswordSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
