...
/**
 * Collection response for LocalAdminPasswordSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LocalAdminPasswordSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var LocalAdminPasswordSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param LocalAdminPasswordSettings[] $items
     * @return self
     */
    public function setValue(array|LocalAdminPasswordSettings $items, LocalAdminPasswordSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LocalAdminPasswordSettings> $value
     * @return self
     ...
     * 
     * @param LocalAdminPasswordSettings $item
     * @return self
     */
    public function addValue(LocalAdminPasswordSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LocalAdminPasswordSettings>
     */
