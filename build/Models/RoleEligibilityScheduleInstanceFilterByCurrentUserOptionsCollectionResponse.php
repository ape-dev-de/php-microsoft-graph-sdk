...
/**
 * RoleEligibilityScheduleInstanceFilterByCurrentUserOptionsCollectionResponse - Collection response
 */
class RoleEligibilityScheduleInstanceFilterByCurrentUserOptionsCollectionResponse
{
    /**
     * @var array<int, RoleEligibilityScheduleInstanceFilterByCurrentUserOptions>
     */
    public array $value = [];
