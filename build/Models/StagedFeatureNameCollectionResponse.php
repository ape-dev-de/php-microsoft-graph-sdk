...
/**
 * Collection response for StagedFeatureName
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class StagedFeatureNameCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var StagedFeatureName[]
     */
    private array $value = [];
     ...
     * 
     * @param StagedFeatureName[] $items
     * @return self
     */
    public function setValue(array|StagedFeatureName $items, StagedFeatureName ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<StagedFeatureName> $value
     * @return self
     ...
     * 
     * @param StagedFeatureName $item
     * @return self
     */
    public function addValue(StagedFeatureName $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, StagedFeatureName>
     */
