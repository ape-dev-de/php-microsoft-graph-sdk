...
/**
 * Collection response for IosUpdatesInstallStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosUpdatesInstallStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IosUpdatesInstallStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return IosUpdatesInstallStatus[]
     */
     ...
     * 
     * @param IosUpdatesInstallStatus[] $items
     * @return self
     */
    public function setValue(array|IosUpdatesInstallStatus $items, IosUpdatesInstallStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosUpdatesInstallStatus> $value
     * @return self
     ...
     * 
     * @param IosUpdatesInstallStatus $item
     * @return self
     */
    public function addValue(IosUpdatesInstallStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IosUpdatesInstallStatus>
     */
