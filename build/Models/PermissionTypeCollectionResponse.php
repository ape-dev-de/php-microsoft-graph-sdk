...
/**
 * Collection response for PermissionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PermissionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PermissionType[]
     */
     ...
     * 
     * @param PermissionType[] $items
     * @return self
     */
    public function setValue(array|PermissionType $items, PermissionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PermissionType> $value
     * @return self
     ...
     * @return self
     */
    public function addValue(PermissionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PermissionType>
     */
