...
/**
 * Collection response for RemoteLockActionResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RemoteLockActionResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RemoteLockActionResult[]
     */
    private array $value = [];
     ...
     * 
     * @param RemoteLockActionResult[] $items
     * @return self
     */
    public function setValue(array|RemoteLockActionResult $items, RemoteLockActionResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RemoteLockActionResult> $value
     * @return self
     ...
     * 
     * @param RemoteLockActionResult $item
     * @return self
     */
    public function addValue(RemoteLockActionResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return RemoteLockActionResult|null
     */
     ...
     * 
     * @return \ArrayIterator<int, RemoteLockActionResult>
     */
