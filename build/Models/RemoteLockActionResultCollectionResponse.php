 ...
 */
class RemoteLockActionResultCollectionResponse
{
    /**
     ...
     * 
     * @param RemoteLockActionResult ...$items Variable number of RemoteLockActionResult items
     * @return self
     */
    public function setValue(RemoteLockActionResult ...$items): self
    {
        $this->value = $items;
        return $this;
    }
