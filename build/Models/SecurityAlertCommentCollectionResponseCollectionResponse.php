...
/**
 * Collection response for SecurityAlertCommentCollectionResponse
 */
class SecurityAlertCommentCollectionResponseCollectionResponse
{
    /**
     * @var SecurityAlertCommentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityAlertCommentCollectionResponse[]
     */
     ...
     * 
     * @param SecurityAlertCommentCollectionResponse ...$items Variable number of SecurityAlertCommentCollectionResponse items
     * @return self
     */
    public function setValue(SecurityAlertCommentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityAlertCommentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityAlertCommentCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityAlertCommentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
