...
/**
 * Collection response for AndroidCompliancePolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AndroidCompliancePolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AndroidCompliancePolicy[]
     */
    private array $value = [];
     ...
     * 
     * @param AndroidCompliancePolicy[] $items
     * @return self
     */
    public function setValue(array|AndroidCompliancePolicy $items, AndroidCompliancePolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AndroidCompliancePolicy> $value
     * @return self
     ...
     * 
     * @param AndroidCompliancePolicy $item
     * @return self
     */
    public function addValue(AndroidCompliancePolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AndroidCompliancePolicy|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AndroidCompliancePolicy>
     */
