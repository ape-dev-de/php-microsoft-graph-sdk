...
/**
 * Collection response for UserFlowLanguageConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserFlowLanguageConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserFlowLanguageConfiguration[] $items
     * @return self
     */
    public function setValue(array|UserFlowLanguageConfiguration $items, UserFlowLanguageConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserFlowLanguageConfiguration> $value
     * @return self
     ...
     * 
     * @param UserFlowLanguageConfiguration $item
     * @return self
     */
    public function addValue(UserFlowLanguageConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserFlowLanguageConfiguration>
     */
