...
/**
 * Collection response for Windows81CompliancePolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Windows81CompliancePolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param Windows81CompliancePolicy[] $items
     * @return self
     */
    public function setValue(array|Windows81CompliancePolicy $items, Windows81CompliancePolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Windows81CompliancePolicy> $value
     * @return self
     ...
     * 
     * @param Windows81CompliancePolicy $item
     * @return self
     */
    public function addValue(Windows81CompliancePolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return Windows81CompliancePolicy|null
     */
     ...
     * 
     * @return \ArrayIterator<int, Windows81CompliancePolicy>
     */
