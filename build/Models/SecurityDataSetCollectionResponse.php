...
/**
 * Collection response for SecurityDataSet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityDataSetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityDataSet[]
     */
     ...
     * 
     * @param SecurityDataSet[] $items
     * @return self
     */
    public function setValue(array|SecurityDataSet $items, SecurityDataSet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityDataSet> $value
     * @return self
     ...
     * 
     * @param SecurityDataSet $item
     * @return self
     */
    public function addValue(SecurityDataSet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityDataSet>
     */
