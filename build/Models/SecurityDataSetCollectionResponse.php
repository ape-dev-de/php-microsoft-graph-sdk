 ...
 */
class SecurityDataSetCollectionResponse
{
    /**
     * @var SecurityDataSet[]
     */
     ...
     * 
     * @param SecurityDataSet ...$items Variable number of SecurityDataSet items
     * @return self
     */
    public function setValue(SecurityDataSet ...$items): self
    {
        $this->value = $items;
        return $this;
    }
