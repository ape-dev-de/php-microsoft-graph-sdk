...
/**
 * Collection response for WorkbookCommentReply
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookCommentReplyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WorkbookCommentReply[] $items
     * @return self
     */
    public function setValue(array|WorkbookCommentReply $items, WorkbookCommentReply ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookCommentReply> $value
     * @return self
     ...
     * 
     * @param WorkbookCommentReply $item
     * @return self
     */
    public function addValue(WorkbookCommentReply $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookCommentReply>
     */
