...
/**
 * Collection response for CallRecordsServiceEndpoint
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsServiceEndpointCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsServiceEndpoint[]
     */
    private array $value = [];
     ...
     * 
     * @return CallRecordsServiceEndpoint[]
     */
     ...
     * 
     * @param CallRecordsServiceEndpoint[] $items
     * @return self
     */
    public function setValue(array|CallRecordsServiceEndpoint $items, CallRecordsServiceEndpoint ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsServiceEndpoint> $value
     * @return self
     ...
     * 
     * @param CallRecordsServiceEndpoint $item
     * @return self
     */
    public function addValue(CallRecordsServiceEndpoint $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsServiceEndpoint|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsServiceEndpoint>
     */
