...
/**
 * CallRecordsServiceEndpointCollectionResponse - Collection response
 */
class CallRecordsServiceEndpointCollectionResponse
{
    /**
     * @var array<int, CallRecordsServiceEndpoint>
     */
    public array $value = [];
