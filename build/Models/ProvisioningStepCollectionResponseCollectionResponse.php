...
/**
 * Collection response for ProvisioningStepCollectionResponse
 */
class ProvisioningStepCollectionResponseCollectionResponse
{
    /**
     * @var ProvisioningStepCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ProvisioningStepCollectionResponse ...$items Variable number of ProvisioningStepCollectionResponse items
     * @return self
     */
    public function setValue(ProvisioningStepCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ProvisioningStepCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ProvisioningStepCollectionResponse $item
     * @return self
     */
    public function addValue(ProvisioningStepCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
