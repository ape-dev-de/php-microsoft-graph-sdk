...
class OnAttributeCollectionListener
{
     ...
     */
    public OnAttributeCollectionHandler|\stdClass|null $handler = null;
    ...
    public function __construct(array $data = [])
    {
        ...
        if (isset($data['handler'])) {
            $this->handler = is_array($data['handler']) ? new OnAttributeCollectionHandler($data['handler']) : $data['handler'];
        }
    }
