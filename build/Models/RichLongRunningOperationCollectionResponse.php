...
/**
 * Collection response for RichLongRunningOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RichLongRunningOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param RichLongRunningOperation[] $items
     * @return self
     */
    public function setValue(array|RichLongRunningOperation $items, RichLongRunningOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RichLongRunningOperation> $value
     * @return self
     ...
     * 
     * @param RichLongRunningOperation $item
     * @return self
     */
    public function addValue(RichLongRunningOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RichLongRunningOperation>
     */
