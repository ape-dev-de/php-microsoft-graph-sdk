...
/**
 * Collection response for VirtualEventRegistrationPredefinedQuestionLabel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualEventRegistrationPredefinedQuestionLabelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VirtualEventRegistrationPredefinedQuestionLabel[]
     */
    private array $value = [];
     ...
     * 
     * @return VirtualEventRegistrationPredefinedQuestionLabel[]
     */
     ...
     * 
     * @param VirtualEventRegistrationPredefinedQuestionLabel[] $items
     * @return self
     */
    public function setValue(array|VirtualEventRegistrationPredefinedQuestionLabel $items, VirtualEventRegistrationPredefinedQuestionLabel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualEventRegistrationPredefinedQuestionLabel> $value
     * @return self
     ...
     * 
     * @param VirtualEventRegistrationPredefinedQuestionLabel $item
     * @return self
     */
    public function addValue(VirtualEventRegistrationPredefinedQuestionLabel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VirtualEventRegistrationPredefinedQuestionLabel>
     */
