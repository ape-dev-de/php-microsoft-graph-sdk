...
/**
 * VirtualEventRegistrationPredefinedQuestionLabelCollectionResponse - Collection response
 */
class VirtualEventRegistrationPredefinedQuestionLabelCollectionResponse
{
    /**
     * @var array<int, VirtualEventRegistrationPredefinedQuestionLabel>
     */
    public array $value = [];
