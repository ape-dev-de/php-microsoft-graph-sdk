...
/**
 * Collection response for SecurityCaseOperationStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityCaseOperationStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityCaseOperationStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityCaseOperationStatus[]
     */
     ...
     * 
     * @param SecurityCaseOperationStatus[] $items
     * @return self
     */
    public function setValue(array|SecurityCaseOperationStatus $items, SecurityCaseOperationStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityCaseOperationStatus> $value
     * @return self
     ...
     * 
     * @param SecurityCaseOperationStatus $item
     * @return self
     */
    public function addValue(SecurityCaseOperationStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityCaseOperationStatus|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityCaseOperationStatus>
     */
