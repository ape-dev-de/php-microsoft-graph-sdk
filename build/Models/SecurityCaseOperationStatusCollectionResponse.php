...
/**
 * SecurityCaseOperationStatusCollectionResponse - Collection response
 */
class SecurityCaseOperationStatusCollectionResponse
{
    /**
     * @var array<int, SecurityCaseOperationStatus>
     */
    public array $value = [];
