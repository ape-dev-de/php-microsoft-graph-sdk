...
/**
 * Collection response for SimulationCollectionResponse
 */
class SimulationCollectionResponseCollectionResponse
{
    /**
     * @var SimulationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SimulationCollectionResponse ...$items Variable number of SimulationCollectionResponse items
     * @return self
     */
    public function setValue(SimulationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SimulationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SimulationCollectionResponse $item
     * @return self
     */
    public function addValue(SimulationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
