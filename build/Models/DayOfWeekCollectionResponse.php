...
/**
 * Collection response for DayOfWeek
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DayOfWeekCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DayOfWeek[]
     */
     ...
     * 
     * @param DayOfWeek[] $items
     * @return self
     */
    public function setValue(array|DayOfWeek $items, DayOfWeek ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param DayOfWeek $item
     * @return self
     */
    public function addValue(DayOfWeek $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DayOfWeek>
     */
