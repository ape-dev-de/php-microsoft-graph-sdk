...
/**
 * ExternalConnectorsExternalItemCollectionResponse - Collection response
 */
class ExternalConnectorsExternalItemCollectionResponse
{
    /**
     * @var array<int, ExternalConnectorsExternalItem>
     */
    public array $value = [];
