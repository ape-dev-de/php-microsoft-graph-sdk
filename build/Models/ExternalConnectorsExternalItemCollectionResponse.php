...
/**
 * Collection response for ExternalConnectorsExternalItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsExternalItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ExternalConnectorsExternalItem[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsExternalItem $items, ExternalConnectorsExternalItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsExternalItem> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsExternalItem $item
     * @return self
     */
    public function addValue(ExternalConnectorsExternalItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsExternalItem>
     */
