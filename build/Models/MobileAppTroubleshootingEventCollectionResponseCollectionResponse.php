...
/**
 * Collection response for MobileAppTroubleshootingEventCollectionResponse
 */
class MobileAppTroubleshootingEventCollectionResponseCollectionResponse
{
    /**
     * @var MobileAppTroubleshootingEventCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MobileAppTroubleshootingEventCollectionResponse ...$items Variable number of MobileAppTroubleshootingEventCollectionResponse items
     * @return self
     */
    public function setValue(MobileAppTroubleshootingEventCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MobileAppTroubleshootingEventCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MobileAppTroubleshootingEventCollectionResponse $item
     * @return self
     */
    public function addValue(MobileAppTroubleshootingEventCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
