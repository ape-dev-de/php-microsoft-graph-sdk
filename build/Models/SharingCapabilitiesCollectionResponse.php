...
/**
 * Collection response for SharingCapabilities
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SharingCapabilitiesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SharingCapabilities[] $items
     * @return self
     */
    public function setValue(array|SharingCapabilities $items, SharingCapabilities ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SharingCapabilities> $value
     * @return self
     ...
     * 
     * @param SharingCapabilities $item
     * @return self
     */
    public function addValue(SharingCapabilities $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SharingCapabilities>
     */
