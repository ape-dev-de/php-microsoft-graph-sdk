...
/**
 * Collection response for WhatIfAnalysisReasons
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WhatIfAnalysisReasonsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WhatIfAnalysisReasons[]
     */
    private array $value = [];
     ...
     * 
     * @param WhatIfAnalysisReasons[] $items
     * @return self
     */
    public function setValue(array|WhatIfAnalysisReasons $items, WhatIfAnalysisReasons ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WhatIfAnalysisReasons> $value
     * @return self
     ...
     * 
     * @param WhatIfAnalysisReasons $item
     * @return self
     */
    public function addValue(WhatIfAnalysisReasons $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WhatIfAnalysisReasons>
     */
