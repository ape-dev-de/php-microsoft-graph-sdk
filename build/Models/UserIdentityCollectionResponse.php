 ...
 */
class UserIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserIdentity[]
     */
     ...
     * 
     * @param UserIdentity[] $items
     * @return self
     */
    public function setValue(array|UserIdentity $items, UserIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @return \ArrayIterator<int, UserIdentity>
     */
