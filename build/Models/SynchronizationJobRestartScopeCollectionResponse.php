...
/**
 * SynchronizationJobRestartScopeCollectionResponse - Collection response
 */
class SynchronizationJobRestartScopeCollectionResponse
{
    /**
     * @var array<int, SynchronizationJobRestartScope>
     */
    public array $value = [];
