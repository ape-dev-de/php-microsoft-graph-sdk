...
/**
 * Collection response for SynchronizationJobRestartScope
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationJobRestartScopeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SynchronizationJobRestartScope[]
     */
    private array $value = [];
     ...
     * 
     * @return SynchronizationJobRestartScope[]
     */
     ...
     * 
     * @param SynchronizationJobRestartScope[] $items
     * @return self
     */
    public function setValue(array|SynchronizationJobRestartScope $items, SynchronizationJobRestartScope ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SynchronizationJobRestartScope> $value
     * @return self
     ...
     * 
     * @param SynchronizationJobRestartScope $item
     * @return self
     */
    public function addValue(SynchronizationJobRestartScope $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SynchronizationJobRestartScope>
     */
