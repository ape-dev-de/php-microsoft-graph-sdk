...
/**
 * Collection response for Contract
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ContractCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Contract[]
     */
     ...
     * 
     * @param Contract[] $items
     * @return self
     */
    public function setValue(array|Contract $items, Contract ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Contract $item): self
    {
        $this->value[] = $item;
        return $this;
    }
