...
/**
 * Collection response for Message
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MessageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Message[]
     */
     ...
     * @return self
     */
    public function setValue(array|Message $items, Message ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Message $item): self
    {
        $this->value[] = $item;
        return $this;
    }
