...
/**
 * Collection response for PartnersBillingAzureUsage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PartnersBillingAzureUsageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PartnersBillingAzureUsage[]
     */
    private array $value = [];
     ...
     * 
     * @param PartnersBillingAzureUsage[] $items
     * @return self
     */
    public function setValue(array|PartnersBillingAzureUsage $items, PartnersBillingAzureUsage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PartnersBillingAzureUsage> $value
     * @return self
     ...
     * 
     * @param PartnersBillingAzureUsage $item
     * @return self
     */
    public function addValue(PartnersBillingAzureUsage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PartnersBillingAzureUsage|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PartnersBillingAzureUsage>
     */
