 ...
 */
class PartnersBillingAzureUsageCollectionResponse
{
    /**
     ...
     * 
     * @param PartnersBillingAzureUsage ...$items Variable number of PartnersBillingAzureUsage items
     * @return self
     */
    public function setValue(PartnersBillingAzureUsage ...$items): self
    {
        $this->value = $items;
        return $this;
    }
