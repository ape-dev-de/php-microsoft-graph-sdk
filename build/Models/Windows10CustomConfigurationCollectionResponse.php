...
/**
 * Collection response for Windows10CustomConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Windows10CustomConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Windows10CustomConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param Windows10CustomConfiguration[] $items
     * @return self
     */
    public function setValue(array|Windows10CustomConfiguration $items, Windows10CustomConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Windows10CustomConfiguration> $value
     * @return self
     ...
     * 
     * @param Windows10CustomConfiguration $item
     * @return self
     */
    public function addValue(Windows10CustomConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return Windows10CustomConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, Windows10CustomConfiguration>
     */
