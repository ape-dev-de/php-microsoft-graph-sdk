 ...
 */
class ScheduleChangeRequestCollectionResponse
{
    /**
     ...
     * 
     * @param ScheduleChangeRequest ...$items Variable number of ScheduleChangeRequest items
     * @return self
     */
    public function setValue(ScheduleChangeRequest ...$items): self
    {
        $this->value = $items;
        return $this;
    }
