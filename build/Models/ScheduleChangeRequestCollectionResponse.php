...
/**
 * Collection response for ScheduleChangeRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ScheduleChangeRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ScheduleChangeRequest[] $items
     * @return self
     */
    public function setValue(array|ScheduleChangeRequest $items, ScheduleChangeRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ScheduleChangeRequest> $value
     * @return self
     ...
     * 
     * @param ScheduleChangeRequest $item
     * @return self
     */
    public function addValue(ScheduleChangeRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ScheduleChangeRequest>
     */
