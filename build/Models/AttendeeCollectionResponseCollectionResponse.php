...
/**
 * Collection response for AttendeeCollectionResponse
 */
class AttendeeCollectionResponseCollectionResponse
{
    /**
     * @var AttendeeCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AttendeeCollectionResponse ...$items Variable number of AttendeeCollectionResponse items
     * @return self
     */
    public function setValue(AttendeeCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AttendeeCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AttendeeCollectionResponse $item
     * @return self
     */
    public function addValue(AttendeeCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
