...
/**
 * Collection response for OnPremisesDirectorySynchronization
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnPremisesDirectorySynchronizationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param OnPremisesDirectorySynchronization[] $items
     * @return self
     */
    public function setValue(array|OnPremisesDirectorySynchronization $items, OnPremisesDirectorySynchronization ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnPremisesDirectorySynchronization> $value
     * @return self
     ...
     * 
     * @param OnPremisesDirectorySynchronization $item
     * @return self
     */
    public function addValue(OnPremisesDirectorySynchronization $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnPremisesDirectorySynchronization>
     */
