...
/**
 * Collection response for SignInFrequencyInterval
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SignInFrequencyIntervalCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SignInFrequencyInterval[]
     */
    private array $value = [];
     ...
     * 
     * @return SignInFrequencyInterval[]
     */
     ...
     * 
     * @param SignInFrequencyInterval[] $items
     * @return self
     */
    public function setValue(array|SignInFrequencyInterval $items, SignInFrequencyInterval ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SignInFrequencyInterval> $value
     * @return self
     ...
     * 
     * @param SignInFrequencyInterval $item
     * @return self
     */
    public function addValue(SignInFrequencyInterval $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SignInFrequencyInterval>
     */
