...
/**
 * Collection response for OnUserCreateStartListener
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnUserCreateStartListenerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnUserCreateStartListener[]
     */
    private array $value = [];
     ...
     * 
     * @param OnUserCreateStartListener[] $items
     * @return self
     */
    public function setValue(array|OnUserCreateStartListener $items, OnUserCreateStartListener ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnUserCreateStartListener> $value
     * @return self
     ...
     * 
     * @param OnUserCreateStartListener $item
     * @return self
     */
    public function addValue(OnUserCreateStartListener $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OnUserCreateStartListener|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OnUserCreateStartListener>
     */
