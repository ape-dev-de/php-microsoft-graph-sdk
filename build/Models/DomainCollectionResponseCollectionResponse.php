...
/**
 * Collection response for DomainCollectionResponse
 */
class DomainCollectionResponseCollectionResponse
{
    /**
     * @var DomainCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DomainCollectionResponse ...$items Variable number of DomainCollectionResponse items
     * @return self
     */
    public function setValue(DomainCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DomainCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DomainCollectionResponse $item
     * @return self
     */
    public function addValue(DomainCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
