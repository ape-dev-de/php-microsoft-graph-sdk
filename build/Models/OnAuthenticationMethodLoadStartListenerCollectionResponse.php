...
/**
 * Collection response for OnAuthenticationMethodLoadStartListener
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnAuthenticationMethodLoadStartListenerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnAuthenticationMethodLoadStartListener[]
     */
    private array $value = [];
     ...
     * 
     * @param OnAuthenticationMethodLoadStartListener[] $items
     * @return self
     */
    public function setValue(array|OnAuthenticationMethodLoadStartListener $items, OnAuthenticationMethodLoadStartListener ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnAuthenticationMethodLoadStartListener> $value
     * @return self
     ...
     * 
     * @param OnAuthenticationMethodLoadStartListener $item
     * @return self
     */
    public function addValue(OnAuthenticationMethodLoadStartListener $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OnAuthenticationMethodLoadStartListener|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OnAuthenticationMethodLoadStartListener>
     */
