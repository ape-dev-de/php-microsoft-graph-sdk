...
/**
 * Collection response for ObjectMappingCollectionResponse
 */
class ObjectMappingCollectionResponseCollectionResponse
{
    /**
     * @var ObjectMappingCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ObjectMappingCollectionResponse ...$items Variable number of ObjectMappingCollectionResponse items
     * @return self
     */
    public function setValue(ObjectMappingCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ObjectMappingCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ObjectMappingCollectionResponse $item
     * @return self
     */
    public function addValue(ObjectMappingCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
