...
/**
 * Collection response for SettingValue
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SettingValueCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SettingValue[]
     */
     ...
     * 
     * @param SettingValue[] $items
     * @return self
     */
    public function setValue(array|SettingValue $items, SettingValue ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SettingValue> $value
     * @return self
     ...
     * @return self
     */
    public function addValue(SettingValue $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SettingValue>
     */
