...
/**
 * Collection response for ActivityDomain
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ActivityDomainCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ActivityDomain[]
     */
     ...
     * 
     * @param ActivityDomain[] $items
     * @return self
     */
    public function setValue(array|ActivityDomain $items, ActivityDomain ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ActivityDomain> $value
     * @return self
     ...
     * 
     * @param ActivityDomain $item
     * @return self
     */
    public function addValue(ActivityDomain $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ActivityDomain>
     */
