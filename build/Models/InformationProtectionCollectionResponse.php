 ...
 */
class InformationProtectionCollectionResponse
{
    /**
     ...
     * 
     * @param InformationProtection ...$items Variable number of InformationProtection items
     * @return self
     */
    public function setValue(InformationProtection ...$items): self
    {
        $this->value = $items;
        return $this;
    }
