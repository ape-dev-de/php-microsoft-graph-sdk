...
/**
 * Collection response for InformationProtection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InformationProtectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var InformationProtection[]
     */
    private array $value = [];
     ...
     * 
     * @param InformationProtection[] $items
     * @return self
     */
    public function setValue(array|InformationProtection $items, InformationProtection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InformationProtection> $value
     * @return self
     ...
     * 
     * @param InformationProtection $item
     * @return self
     */
    public function addValue(InformationProtection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, InformationProtection>
     */
