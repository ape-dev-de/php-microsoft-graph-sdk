...
/**
 * Collection response for SecurityAlertEvidenceCollectionResponse
 */
class SecurityAlertEvidenceCollectionResponseCollectionResponse
{
    /**
     * @var SecurityAlertEvidenceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityAlertEvidenceCollectionResponse[]
     */
     ...
     * 
     * @param SecurityAlertEvidenceCollectionResponse ...$items Variable number of SecurityAlertEvidenceCollectionResponse items
     * @return self
     */
    public function setValue(SecurityAlertEvidenceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityAlertEvidenceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityAlertEvidenceCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityAlertEvidenceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
