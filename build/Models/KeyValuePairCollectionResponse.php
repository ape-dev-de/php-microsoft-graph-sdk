...
/**
 * Collection response for KeyValuePair
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class KeyValuePairCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var KeyValuePair[]
     */
     ...
     * @return self
     */
    public function setValue(array|KeyValuePair $items, KeyValuePair ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<KeyValuePair> $value
     * @return self
     ...
     * @return self
     */
    public function addValue(KeyValuePair $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, KeyValuePair>
     */
