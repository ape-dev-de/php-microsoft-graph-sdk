...
/**
 * Collection response for TenantAppManagementPolicyCollectionResponse
 */
class TenantAppManagementPolicyCollectionResponseCollectionResponse
{
    /**
     * @var TenantAppManagementPolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TenantAppManagementPolicyCollectionResponse ...$items Variable number of TenantAppManagementPolicyCollectionResponse items
     * @return self
     */
    public function setValue(TenantAppManagementPolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TenantAppManagementPolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TenantAppManagementPolicyCollectionResponse $item
     * @return self
     */
    public function addValue(TenantAppManagementPolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
