...
/**
 * Collection response for AuthenticationMethodKeyStrength
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationMethodKeyStrengthCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return AuthenticationMethodKeyStrength[]
     */
     ...
     * 
     * @param AuthenticationMethodKeyStrength[] $items
     * @return self
     */
    public function setValue(array|AuthenticationMethodKeyStrength $items, AuthenticationMethodKeyStrength ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationMethodKeyStrength> $value
     * @return self
     ...
     * 
     * @param AuthenticationMethodKeyStrength $item
     * @return self
     */
    public function addValue(AuthenticationMethodKeyStrength $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationMethodKeyStrength>
     */
