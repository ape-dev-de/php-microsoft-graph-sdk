...
/**
 * AuthenticationMethodKeyStrengthCollectionResponse - Collection response
 */
class AuthenticationMethodKeyStrengthCollectionResponse
{
    /**
     * @var array<int, AuthenticationMethodKeyStrength>
     */
    public array $value = [];
