...
/**
 * Collection response for SecurityEvidenceRole
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityEvidenceRoleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityEvidenceRole[] $items
     * @return self
     */
    public function setValue(array|SecurityEvidenceRole $items, SecurityEvidenceRole ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityEvidenceRole> $value
     * @return self
     ...
     * 
     * @param SecurityEvidenceRole $item
     * @return self
     */
    public function addValue(SecurityEvidenceRole $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityEvidenceRole|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityEvidenceRole>
     */
