...
/**
 * Collection response for UsedInsightCollectionResponse
 */
class UsedInsightCollectionResponseCollectionResponse
{
    /**
     * @var UsedInsightCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UsedInsightCollectionResponse ...$items Variable number of UsedInsightCollectionResponse items
     * @return self
     */
    public function setValue(UsedInsightCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UsedInsightCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UsedInsightCollectionResponse $item
     * @return self
     */
    public function addValue(UsedInsightCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
