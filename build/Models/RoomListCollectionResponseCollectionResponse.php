...
/**
 * Collection response for RoomListCollectionResponse
 */
class RoomListCollectionResponseCollectionResponse
{
    /**
     * @var RoomListCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RoomListCollectionResponse ...$items Variable number of RoomListCollectionResponse items
     * @return self
     */
    public function setValue(RoomListCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RoomListCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RoomListCollectionResponse $item
     * @return self
     */
    public function addValue(RoomListCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
