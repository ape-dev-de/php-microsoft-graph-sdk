...
/**
 * Collection response for OrgContact
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OrgContactCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OrgContact[]
     */
     ...
     * 
     * @param OrgContact[] $items
     * @return self
     */
    public function setValue(array|OrgContact $items, OrgContact ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param OrgContact $item
     * @return self
     */
    public function addValue(OrgContact $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OrgContact>
     */
