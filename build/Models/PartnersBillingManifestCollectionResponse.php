...
/**
 * Collection response for PartnersBillingManifest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PartnersBillingManifestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PartnersBillingManifest[] $items
     * @return self
     */
    public function setValue(array|PartnersBillingManifest $items, PartnersBillingManifest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PartnersBillingManifest> $value
     * @return self
     ...
     * 
     * @param PartnersBillingManifest $item
     * @return self
     */
    public function addValue(PartnersBillingManifest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PartnersBillingManifest>
     */
