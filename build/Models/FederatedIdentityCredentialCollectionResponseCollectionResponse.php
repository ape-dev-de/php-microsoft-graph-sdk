...
/**
 * Collection response for FederatedIdentityCredentialCollectionResponse
 */
class FederatedIdentityCredentialCollectionResponseCollectionResponse
{
    /**
     * @var FederatedIdentityCredentialCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param FederatedIdentityCredentialCollectionResponse ...$items Variable number of FederatedIdentityCredentialCollectionResponse items
     * @return self
     */
    public function setValue(FederatedIdentityCredentialCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<FederatedIdentityCredentialCollectionResponse> $value
     * @return self
     ...
     * 
     * @param FederatedIdentityCredentialCollectionResponse $item
     * @return self
     */
    public function addValue(FederatedIdentityCredentialCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
