...
/**
 * Collection response for ApprovalCollectionResponse
 */
class ApprovalCollectionResponseCollectionResponse
{
    /**
     * @var ApprovalCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ApprovalCollectionResponse ...$items Variable number of ApprovalCollectionResponse items
     * @return self
     */
    public function setValue(ApprovalCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ApprovalCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ApprovalCollectionResponse $item
     * @return self
     */
    public function addValue(ApprovalCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
