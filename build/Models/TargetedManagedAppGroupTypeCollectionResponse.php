...
/**
 * Collection response for TargetedManagedAppGroupType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TargetedManagedAppGroupTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TargetedManagedAppGroupType[]
     */
    private array $value = [];
     ...
     * 
     * @return TargetedManagedAppGroupType[]
     */
     ...
     * 
     * @param TargetedManagedAppGroupType[] $items
     * @return self
     */
    public function setValue(array|TargetedManagedAppGroupType $items, TargetedManagedAppGroupType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TargetedManagedAppGroupType> $value
     * @return self
     ...
     * 
     * @param TargetedManagedAppGroupType $item
     * @return self
     */
    public function addValue(TargetedManagedAppGroupType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TargetedManagedAppGroupType>
     */
