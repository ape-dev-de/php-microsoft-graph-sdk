...
/**
 * TargetedManagedAppGroupTypeCollectionResponse - Collection response
 */
class TargetedManagedAppGroupTypeCollectionResponse
{
    /**
     * @var array<int, TargetedManagedAppGroupType>
     */
    public array $value = [];
