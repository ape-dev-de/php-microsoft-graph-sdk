 ...
 */
class ChatRestrictionsCollectionResponse
{
    /**
     ...
     * 
     * @param ChatRestrictions ...$items Variable number of ChatRestrictions items
     * @return self
     */
    public function setValue(ChatRestrictions ...$items): self
    {
        $this->value = $items;
        return $this;
    }
