...
/**
 * Collection response for ChatRestrictions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatRestrictionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChatRestrictions[]
     */
    private array $value = [];
     ...
     * 
     * @param ChatRestrictions[] $items
     * @return self
     */
    public function setValue(array|ChatRestrictions $items, ChatRestrictions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChatRestrictions> $value
     * @return self
     ...
     * 
     * @param ChatRestrictions $item
     * @return self
     */
    public function addValue(ChatRestrictions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChatRestrictions>
     */
