...
/**
 * Collection response for DefaultManagedAppProtection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DefaultManagedAppProtectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DefaultManagedAppProtection[] $items
     * @return self
     */
    public function setValue(array|DefaultManagedAppProtection $items, DefaultManagedAppProtection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DefaultManagedAppProtection> $value
     * @return self
     ...
     * 
     * @param DefaultManagedAppProtection $item
     * @return self
     */
    public function addValue(DefaultManagedAppProtection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DefaultManagedAppProtection>
     */
