...
/**
 * Collection response for BucketAggregationSortProperty
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BucketAggregationSortPropertyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BucketAggregationSortProperty[]
     */
    private array $value = [];
     ...
     * 
     * @return BucketAggregationSortProperty[]
     */
     ...
     * 
     * @param BucketAggregationSortProperty[] $items
     * @return self
     */
    public function setValue(array|BucketAggregationSortProperty $items, BucketAggregationSortProperty ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BucketAggregationSortProperty> $value
     * @return self
     ...
     * 
     * @param BucketAggregationSortProperty $item
     * @return self
     */
    public function addValue(BucketAggregationSortProperty $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BucketAggregationSortProperty>
     */
