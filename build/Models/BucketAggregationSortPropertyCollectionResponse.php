...
/**
 * BucketAggregationSortPropertyCollectionResponse - Collection response
 */
class BucketAggregationSortPropertyCollectionResponse
{
    /**
     * @var array<int, BucketAggregationSortProperty>
     */
    public array $value = [];
