...
/**
 * Collection response for CrossTenantAccessPolicyCollectionResponse
 */
class CrossTenantAccessPolicyCollectionResponseCollectionResponse
{
    /**
     * @var CrossTenantAccessPolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CrossTenantAccessPolicyCollectionResponse ...$items Variable number of CrossTenantAccessPolicyCollectionResponse items
     * @return self
     */
    public function setValue(CrossTenantAccessPolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CrossTenantAccessPolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CrossTenantAccessPolicyCollectionResponse $item
     * @return self
     */
    public function addValue(CrossTenantAccessPolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
