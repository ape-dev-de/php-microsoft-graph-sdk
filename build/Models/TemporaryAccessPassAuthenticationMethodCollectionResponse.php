...
/**
 * Collection response for TemporaryAccessPassAuthenticationMethod
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TemporaryAccessPassAuthenticationMethodCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TemporaryAccessPassAuthenticationMethod[] $items
     * @return self
     */
    public function setValue(array|TemporaryAccessPassAuthenticationMethod $items, TemporaryAccessPassAuthenticationMethod ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TemporaryAccessPassAuthenticationMethod> $value
     * @return self
     ...
     * 
     * @param TemporaryAccessPassAuthenticationMethod $item
     * @return self
     */
    public function addValue(TemporaryAccessPassAuthenticationMethod $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TemporaryAccessPassAuthenticationMethod>
     */
