...
/**
 * Collection response for EducationSubmissionCollectionResponse
 */
class EducationSubmissionCollectionResponseCollectionResponse
{
    /**
     * @var EducationSubmissionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationSubmissionCollectionResponse ...$items Variable number of EducationSubmissionCollectionResponse items
     * @return self
     */
    public function setValue(EducationSubmissionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EducationSubmissionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EducationSubmissionCollectionResponse $item
     * @return self
     */
    public function addValue(EducationSubmissionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
