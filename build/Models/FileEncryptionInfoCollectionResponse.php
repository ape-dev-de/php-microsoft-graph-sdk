...
/**
 * Collection response for FileEncryptionInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FileEncryptionInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FileEncryptionInfo[]
     */
    private array $value = [];
     ...
     * 
     * @param FileEncryptionInfo[] $items
     * @return self
     */
    public function setValue(array|FileEncryptionInfo $items, FileEncryptionInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FileEncryptionInfo> $value
     * @return self
     ...
     * 
     * @param FileEncryptionInfo $item
     * @return self
     */
    public function addValue(FileEncryptionInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FileEncryptionInfo>
     */
