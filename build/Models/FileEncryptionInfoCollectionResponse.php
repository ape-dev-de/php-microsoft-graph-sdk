 ...
 */
class FileEncryptionInfoCollectionResponse
{
    /**
     ...
     * 
     * @param FileEncryptionInfo ...$items Variable number of FileEncryptionInfo items
     * @return self
     */
    public function setValue(FileEncryptionInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
