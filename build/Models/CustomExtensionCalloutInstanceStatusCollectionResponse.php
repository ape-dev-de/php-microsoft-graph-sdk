...
/**
 * CustomExtensionCalloutInstanceStatusCollectionResponse - Collection response
 */
class CustomExtensionCalloutInstanceStatusCollectionResponse
{
    /**
     * @var array<int, CustomExtensionCalloutInstanceStatus>
     */
    public array $value = [];
