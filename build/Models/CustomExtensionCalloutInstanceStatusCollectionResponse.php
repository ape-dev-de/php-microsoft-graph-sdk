...
/**
 * Collection response for CustomExtensionCalloutInstanceStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CustomExtensionCalloutInstanceStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CustomExtensionCalloutInstanceStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return CustomExtensionCalloutInstanceStatus[]
     */
     ...
     * 
     * @param CustomExtensionCalloutInstanceStatus[] $items
     * @return self
     */
    public function setValue(array|CustomExtensionCalloutInstanceStatus $items, CustomExtensionCalloutInstanceStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CustomExtensionCalloutInstanceStatus> $value
     * @return self
     ...
     * 
     * @param CustomExtensionCalloutInstanceStatus $item
     * @return self
     */
    public function addValue(CustomExtensionCalloutInstanceStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CustomExtensionCalloutInstanceStatus>
     */
