...
/**
 * Collection response for KeyCredentialCollectionResponse
 */
class KeyCredentialCollectionResponseCollectionResponse
{
    /**
     * @var KeyCredentialCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param KeyCredentialCollectionResponse ...$items Variable number of KeyCredentialCollectionResponse items
     * @return self
     */
    public function setValue(KeyCredentialCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<KeyCredentialCollectionResponse> $value
     * @return self
     ...
     * 
     * @param KeyCredentialCollectionResponse $item
     * @return self
     */
    public function addValue(KeyCredentialCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
