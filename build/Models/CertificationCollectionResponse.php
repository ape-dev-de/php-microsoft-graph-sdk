 ...
 */
class CertificationCollectionResponse
{
    /**
     * @var Certification[]
     */
     ...
     * 
     * @param Certification ...$items Variable number of Certification items
     * @return self
     */
    public function setValue(Certification ...$items): self
    {
        $this->value = $items;
        return $this;
    }
