...
class Filter
{
     ...
     */
    private array $categoryFilterGroups = [];
     ...
     */
    private ?string $inputFilterGroups;
    ...
    public function setCategoryFilterGroups(array $categoryFilterGroups): self
    {
    ...
    public function getInputFilterGroups(): ?string
    {
        return $this->inputFilterGroups;
    }

    public function setInputFilterGroups(?string $inputFilterGroups): self
    {
