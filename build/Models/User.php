...
class User
{
    ...
    public function getImAddresses(): ?string
    {
        return $this->imAddresses;
    }

    public function setImAddresses(?string $imAddresses): self
    {
    ...
    public function getOtherMails(): ?string
    {
        return $this->otherMails;
    }

    public function setOtherMails(?string $otherMails): self
    {
    ...
    public function getPastProjects(): ?string
    {
        return $this->pastProjects;
    }

    public function setPastProjects(?string $pastProjects): self
    {
