...
/**
 * ExternalConnectorsExternalActivityTypeCollectionResponse - Collection response
 */
class ExternalConnectorsExternalActivityTypeCollectionResponse
{
    /**
     * @var array<int, ExternalConnectorsExternalActivityType>
     */
    public array $value = [];
