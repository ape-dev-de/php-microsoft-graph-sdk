...
/**
 * Collection response for ExternalConnectorsExternalActivityType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsExternalActivityTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExternalConnectorsExternalActivityType[]
     */
    private array $value = [];
     ...
     * 
     * @return ExternalConnectorsExternalActivityType[]
     */
     ...
     * 
     * @param ExternalConnectorsExternalActivityType[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsExternalActivityType $items, ExternalConnectorsExternalActivityType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsExternalActivityType> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsExternalActivityType $item
     * @return self
     */
    public function addValue(ExternalConnectorsExternalActivityType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalConnectorsExternalActivityType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsExternalActivityType>
     */
