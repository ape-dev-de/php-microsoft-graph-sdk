...
/**
 * Collection response for AgreementFileVersion
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AgreementFileVersionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AgreementFileVersion[]
     */
    private array $value = [];
     ...
     * 
     * @param AgreementFileVersion[] $items
     * @return self
     */
    public function setValue(array|AgreementFileVersion $items, AgreementFileVersion ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AgreementFileVersion> $value
     * @return self
     ...
     * 
     * @param AgreementFileVersion $item
     * @return self
     */
    public function addValue(AgreementFileVersion $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AgreementFileVersion>
     */
