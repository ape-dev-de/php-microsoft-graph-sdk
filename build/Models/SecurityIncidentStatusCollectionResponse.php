...
/**
 * Collection response for SecurityIncidentStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityIncidentStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityIncidentStatus[] $items
     * @return self
     */
    public function setValue(array|SecurityIncidentStatus $items, SecurityIncidentStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityIncidentStatus> $value
     * @return self
     ...
     * 
     * @param SecurityIncidentStatus $item
     * @return self
     */
    public function addValue(SecurityIncidentStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityIncidentStatus|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityIncidentStatus>
     */
