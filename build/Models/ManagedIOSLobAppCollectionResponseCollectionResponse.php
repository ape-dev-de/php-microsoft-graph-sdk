...
/**
 * Collection response for ManagedIOSLobAppCollectionResponse
 */
class ManagedIOSLobAppCollectionResponseCollectionResponse
{
    /**
     * @var ManagedIOSLobAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedIOSLobAppCollectionResponse ...$items Variable number of ManagedIOSLobAppCollectionResponse items
     * @return self
     */
    public function setValue(ManagedIOSLobAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ManagedIOSLobAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ManagedIOSLobAppCollectionResponse $item
     * @return self
     */
    public function addValue(ManagedIOSLobAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
