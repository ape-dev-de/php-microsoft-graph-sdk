...
/**
 * Collection response for AccessPackageCatalogCollectionResponse
 */
class AccessPackageCatalogCollectionResponseCollectionResponse
{
    /**
     * @var AccessPackageCatalogCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageCatalogCollectionResponse ...$items Variable number of AccessPackageCatalogCollectionResponse items
     * @return self
     */
    public function setValue(AccessPackageCatalogCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AccessPackageCatalogCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AccessPackageCatalogCollectionResponse $item
     * @return self
     */
    public function addValue(AccessPackageCatalogCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
