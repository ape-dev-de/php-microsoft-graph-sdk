...
/**
 * Collection response for IdentityGovernanceLifecycleWorkflowProcessingStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceLifecycleWorkflowProcessingStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceLifecycleWorkflowProcessingStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceLifecycleWorkflowProcessingStatus[]
     */
     ...
     * 
     * @param IdentityGovernanceLifecycleWorkflowProcessingStatus[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceLifecycleWorkflowProcessingStatus $items, IdentityGovernanceLifecycleWorkflowProcessingStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceLifecycleWorkflowProcessingStatus> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceLifecycleWorkflowProcessingStatus $item
     * @return self
     */
    public function addValue(IdentityGovernanceLifecycleWorkflowProcessingStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceLifecycleWorkflowProcessingStatus|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceLifecycleWorkflowProcessingStatus>
     */
