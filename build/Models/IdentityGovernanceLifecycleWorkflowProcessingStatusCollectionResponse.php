...
/**
 * IdentityGovernanceLifecycleWorkflowProcessingStatusCollectionResponse - Collection response
 */
class IdentityGovernanceLifecycleWorkflowProcessingStatusCollectionResponse
{
    /**
     * @var array<int, IdentityGovernanceLifecycleWorkflowProcessingStatus>
     */
    public array $value = [];
