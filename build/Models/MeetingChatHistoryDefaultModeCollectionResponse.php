...
/**
 * Collection response for MeetingChatHistoryDefaultMode
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MeetingChatHistoryDefaultModeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MeetingChatHistoryDefaultMode[]
     */
    private array $value = [];
     ...
     * 
     * @return MeetingChatHistoryDefaultMode[]
     */
     ...
     * 
     * @param MeetingChatHistoryDefaultMode[] $items
     * @return self
     */
    public function setValue(array|MeetingChatHistoryDefaultMode $items, MeetingChatHistoryDefaultMode ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MeetingChatHistoryDefaultMode> $value
     * @return self
     ...
     * 
     * @param MeetingChatHistoryDefaultMode $item
     * @return self
     */
    public function addValue(MeetingChatHistoryDefaultMode $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MeetingChatHistoryDefaultMode>
     */
