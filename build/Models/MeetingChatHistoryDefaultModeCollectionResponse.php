...
/**
 * MeetingChatHistoryDefaultModeCollectionResponse - Collection response
 */
class MeetingChatHistoryDefaultModeCollectionResponse
{
    /**
     * @var array<int, MeetingChatHistoryDefaultMode>
     */
    public array $value = [];
