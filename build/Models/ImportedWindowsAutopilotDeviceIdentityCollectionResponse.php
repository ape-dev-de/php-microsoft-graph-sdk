...
/**
 * Collection response for ImportedWindowsAutopilotDeviceIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ImportedWindowsAutopilotDeviceIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ImportedWindowsAutopilotDeviceIdentity[] $items
     * @return self
     */
    public function setValue(array|ImportedWindowsAutopilotDeviceIdentity $items, ImportedWindowsAutopilotDeviceIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ImportedWindowsAutopilotDeviceIdentity> $value
     * @return self
     ...
     * 
     * @param ImportedWindowsAutopilotDeviceIdentity $item
     * @return self
     */
    public function addValue(ImportedWindowsAutopilotDeviceIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ImportedWindowsAutopilotDeviceIdentity>
     */
