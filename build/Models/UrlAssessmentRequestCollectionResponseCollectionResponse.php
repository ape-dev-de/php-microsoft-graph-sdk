...
/**
 * Collection response for UrlAssessmentRequestCollectionResponse
 */
class UrlAssessmentRequestCollectionResponseCollectionResponse
{
    /**
     * @var UrlAssessmentRequestCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UrlAssessmentRequestCollectionResponse ...$items Variable number of UrlAssessmentRequestCollectionResponse items
     * @return self
     */
    public function setValue(UrlAssessmentRequestCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UrlAssessmentRequestCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UrlAssessmentRequestCollectionResponse $item
     * @return self
     */
    public function addValue(UrlAssessmentRequestCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
