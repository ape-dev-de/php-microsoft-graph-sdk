...
/**
 * Collection response for AttributeMappingParameterSchema
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttributeMappingParameterSchemaCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AttributeMappingParameterSchema[] $items
     * @return self
     */
    public function setValue(array|AttributeMappingParameterSchema $items, AttributeMappingParameterSchema ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttributeMappingParameterSchema> $value
     * @return self
     ...
     * 
     * @param AttributeMappingParameterSchema $item
     * @return self
     */
    public function addValue(AttributeMappingParameterSchema $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AttributeMappingParameterSchema|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AttributeMappingParameterSchema>
     */
