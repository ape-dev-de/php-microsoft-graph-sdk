...
/**
 * Collection response for WorkbookRangeView
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookRangeViewCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WorkbookRangeView[] $items
     * @return self
     */
    public function setValue(array|WorkbookRangeView $items, WorkbookRangeView ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookRangeView> $value
     * @return self
     ...
     * 
     * @param WorkbookRangeView $item
     * @return self
     */
    public function addValue(WorkbookRangeView $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookRangeView>
     */
