...
/**
 * Collection response for ProtectionRuleBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProtectionRuleBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProtectionRuleBase[]
     */
    private array $value = [];
     ...
     * 
     * @param ProtectionRuleBase[] $items
     * @return self
     */
    public function setValue(array|ProtectionRuleBase $items, ProtectionRuleBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProtectionRuleBase> $value
     * @return self
     ...
     * 
     * @param ProtectionRuleBase $item
     * @return self
     */
    public function addValue(ProtectionRuleBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ProtectionRuleBase|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ProtectionRuleBase>
     */
