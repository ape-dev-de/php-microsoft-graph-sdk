 ...
 */
class ProtectionRuleBaseCollectionResponse
{
    /**
     ...
     * 
     * @param ProtectionRuleBase ...$items Variable number of ProtectionRuleBase items
     * @return self
     */
    public function setValue(ProtectionRuleBase ...$items): self
    {
        $this->value = $items;
        return $this;
    }
