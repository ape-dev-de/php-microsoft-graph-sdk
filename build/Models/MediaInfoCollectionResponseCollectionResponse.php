...
/**
 * Collection response for MediaInfoCollectionResponse
 */
class MediaInfoCollectionResponseCollectionResponse
{
    /**
     * @var MediaInfoCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MediaInfoCollectionResponse ...$items Variable number of MediaInfoCollectionResponse items
     * @return self
     */
    public function setValue(MediaInfoCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MediaInfoCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MediaInfoCollectionResponse $item
     * @return self
     */
    public function addValue(MediaInfoCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
