...
/**
 * Collection response for ThreatAssessmentResultCollectionResponse
 */
class ThreatAssessmentResultCollectionResponseCollectionResponse
{
    /**
     * @var ThreatAssessmentResultCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ThreatAssessmentResultCollectionResponse ...$items Variable number of ThreatAssessmentResultCollectionResponse items
     * @return self
     */
    public function setValue(ThreatAssessmentResultCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ThreatAssessmentResultCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ThreatAssessmentResultCollectionResponse $item
     * @return self
     */
    public function addValue(ThreatAssessmentResultCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
