...
/**
 * Collection response for DeviceEnrollmentType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceEnrollmentTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceEnrollmentType[] $items
     * @return self
     */
    public function setValue(array|DeviceEnrollmentType $items, DeviceEnrollmentType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceEnrollmentType> $value
     * @return self
     ...
     * 
     * @param DeviceEnrollmentType $item
     * @return self
     */
    public function addValue(DeviceEnrollmentType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceEnrollmentType>
     */
