...
/**
 * Collection response for ManagedAppFlaggedReason
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedAppFlaggedReasonCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return ManagedAppFlaggedReason[]
     */
     ...
     * 
     * @param ManagedAppFlaggedReason[] $items
     * @return self
     */
    public function setValue(array|ManagedAppFlaggedReason $items, ManagedAppFlaggedReason ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedAppFlaggedReason> $value
     * @return self
     ...
     * 
     * @param ManagedAppFlaggedReason $item
     * @return self
     */
    public function addValue(ManagedAppFlaggedReason $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ManagedAppFlaggedReason|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ManagedAppFlaggedReason>
     */
