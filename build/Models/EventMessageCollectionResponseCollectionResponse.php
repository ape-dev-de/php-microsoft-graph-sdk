...
/**
 * Collection response for EventMessageCollectionResponse
 */
class EventMessageCollectionResponseCollectionResponse
{
    /**
     * @var EventMessageCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EventMessageCollectionResponse ...$items Variable number of EventMessageCollectionResponse items
     * @return self
     */
    public function setValue(EventMessageCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EventMessageCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EventMessageCollectionResponse $item
     * @return self
     */
    public function addValue(EventMessageCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
