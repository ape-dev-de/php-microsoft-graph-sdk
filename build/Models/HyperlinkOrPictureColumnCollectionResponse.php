...
/**
 * Collection response for HyperlinkOrPictureColumn
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class HyperlinkOrPictureColumnCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var HyperlinkOrPictureColumn[]
     */
    private array $value = [];
     ...
     * 
     * @param HyperlinkOrPictureColumn[] $items
     * @return self
     */
    public function setValue(array|HyperlinkOrPictureColumn $items, HyperlinkOrPictureColumn ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<HyperlinkOrPictureColumn> $value
     * @return self
     ...
     * 
     * @param HyperlinkOrPictureColumn $item
     * @return self
     */
    public function addValue(HyperlinkOrPictureColumn $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, HyperlinkOrPictureColumn>
     */
