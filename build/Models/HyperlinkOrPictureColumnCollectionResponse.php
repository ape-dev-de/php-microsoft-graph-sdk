 ...
 */
class HyperlinkOrPictureColumnCollectionResponse
{
    /**
     ...
     * 
     * @param HyperlinkOrPictureColumn ...$items Variable number of HyperlinkOrPictureColumn items
     * @return self
     */
    public function setValue(HyperlinkOrPictureColumn ...$items): self
    {
        $this->value = $items;
        return $this;
    }
