...
/**
 * Collection response for PrintServiceCollectionResponse
 */
class PrintServiceCollectionResponseCollectionResponse
{
    /**
     * @var PrintServiceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PrintServiceCollectionResponse ...$items Variable number of PrintServiceCollectionResponse items
     * @return self
     */
    public function setValue(PrintServiceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PrintServiceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PrintServiceCollectionResponse $item
     * @return self
     */
    public function addValue(PrintServiceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
