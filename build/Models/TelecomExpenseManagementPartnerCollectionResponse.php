...
/**
 * Collection response for TelecomExpenseManagementPartner
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TelecomExpenseManagementPartnerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TelecomExpenseManagementPartner[] $items
     * @return self
     */
    public function setValue(array|TelecomExpenseManagementPartner $items, TelecomExpenseManagementPartner ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TelecomExpenseManagementPartner> $value
     * @return self
     ...
     * 
     * @param TelecomExpenseManagementPartner $item
     * @return self
     */
    public function addValue(TelecomExpenseManagementPartner $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TelecomExpenseManagementPartner>
     */
