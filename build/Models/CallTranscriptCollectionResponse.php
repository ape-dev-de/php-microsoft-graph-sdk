...
/**
 * Collection response for CallTranscript
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallTranscriptCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallTranscript[]
     */
     ...
     * 
     * @param CallTranscript[] $items
     * @return self
     */
    public function setValue(array|CallTranscript $items, CallTranscript ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallTranscript> $value
     * @return self
     ...
     * 
     * @param CallTranscript $item
     * @return self
     */
    public function addValue(CallTranscript $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CallTranscript>
     */
