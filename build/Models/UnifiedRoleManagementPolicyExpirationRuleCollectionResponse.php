...
/**
 * Collection response for UnifiedRoleManagementPolicyExpirationRule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRoleManagementPolicyExpirationRuleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UnifiedRoleManagementPolicyExpirationRule[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedRoleManagementPolicyExpirationRule[] $items
     * @return self
     */
    public function setValue(array|UnifiedRoleManagementPolicyExpirationRule $items, UnifiedRoleManagementPolicyExpirationRule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRoleManagementPolicyExpirationRule> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleManagementPolicyExpirationRule $item
     * @return self
     */
    public function addValue(UnifiedRoleManagementPolicyExpirationRule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UnifiedRoleManagementPolicyExpirationRule|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRoleManagementPolicyExpirationRule>
     */
