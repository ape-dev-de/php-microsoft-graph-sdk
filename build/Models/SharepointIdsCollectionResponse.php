...
/**
 * Collection response for SharepointIds
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SharepointIdsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SharepointIds[]
     */
     ...
     * 
     * @param SharepointIds[] $items
     * @return self
     */
    public function setValue(array|SharepointIds $items, SharepointIds ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SharepointIds> $value
     * @return self
     ...
     * 
     * @param SharepointIds $item
     * @return self
     */
    public function addValue(SharepointIds $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SharepointIds>
     */
