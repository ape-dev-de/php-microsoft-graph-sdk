 ...
 */
class SharepointIdsCollectionResponse
{
    /**
     * @var SharepointIds[]
     */
     ...
     * 
     * @param SharepointIds ...$items Variable number of SharepointIds items
     * @return self
     */
    public function setValue(SharepointIds ...$items): self
    {
        $this->value = $items;
        return $this;
    }
