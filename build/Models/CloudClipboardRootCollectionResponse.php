...
/**
 * Collection response for CloudClipboardRoot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudClipboardRootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudClipboardRoot[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudClipboardRoot[] $items
     * @return self
     */
    public function setValue(array|CloudClipboardRoot $items, CloudClipboardRoot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudClipboardRoot> $value
     * @return self
     ...
     * 
     * @param CloudClipboardRoot $item
     * @return self
     */
    public function addValue(CloudClipboardRoot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudClipboardRoot>
     */
