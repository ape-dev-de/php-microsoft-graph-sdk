 ...
 */
class CloudClipboardRootCollectionResponse
{
    /**
     ...
     * 
     * @param CloudClipboardRoot ...$items Variable number of CloudClipboardRoot items
     * @return self
     */
    public function setValue(CloudClipboardRoot ...$items): self
    {
        $this->value = $items;
        return $this;
    }
