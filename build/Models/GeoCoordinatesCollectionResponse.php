 ...
 */
class GeoCoordinatesCollectionResponse
{
    /**
     * @var GeoCoordinates[]
     */
     ...
     * 
     * @param GeoCoordinates ...$items Variable number of GeoCoordinates items
     * @return self
     */
    public function setValue(GeoCoordinates ...$items): self
    {
        $this->value = $items;
        return $this;
    }
