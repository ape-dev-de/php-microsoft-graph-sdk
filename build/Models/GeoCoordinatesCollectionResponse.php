...
/**
 * Collection response for GeoCoordinates
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class GeoCoordinatesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var GeoCoordinates[]
     */
     ...
     * 
     * @param GeoCoordinates[] $items
     * @return self
     */
    public function setValue(array|GeoCoordinates $items, GeoCoordinates ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<GeoCoordinates> $value
     * @return self
     ...
     * 
     * @param GeoCoordinates $item
     * @return self
     */
    public function addValue(GeoCoordinates $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, GeoCoordinates>
     */
