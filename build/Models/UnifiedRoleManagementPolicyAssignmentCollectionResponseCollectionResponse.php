...
/**
 * Collection response for UnifiedRoleManagementPolicyAssignmentCollectionResponse
 */
class UnifiedRoleManagementPolicyAssignmentCollectionResponseCollectionResponse
{
    /**
     * @var UnifiedRoleManagementPolicyAssignmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedRoleManagementPolicyAssignmentCollectionResponse ...$items Variable number of UnifiedRoleManagementPolicyAssignmentCollectionResponse items
     * @return self
     */
    public function setValue(UnifiedRoleManagementPolicyAssignmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UnifiedRoleManagementPolicyAssignmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleManagementPolicyAssignmentCollectionResponse $item
     * @return self
     */
    public function addValue(UnifiedRoleManagementPolicyAssignmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
