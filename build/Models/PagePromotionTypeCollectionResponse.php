...
/**
 * Collection response for PagePromotionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PagePromotionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PagePromotionType[]
     */
    private array $value = [];
     ...
     * 
     * @param PagePromotionType[] $items
     * @return self
     */
    public function setValue(array|PagePromotionType $items, PagePromotionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PagePromotionType> $value
     * @return self
     ...
     * 
     * @param PagePromotionType $item
     * @return self
     */
    public function addValue(PagePromotionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PagePromotionType>
     */
