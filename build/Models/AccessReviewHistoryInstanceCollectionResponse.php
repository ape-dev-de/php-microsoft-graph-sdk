...
/**
 * Collection response for AccessReviewHistoryInstance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewHistoryInstanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessReviewHistoryInstance[] $items
     * @return self
     */
    public function setValue(array|AccessReviewHistoryInstance $items, AccessReviewHistoryInstance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewHistoryInstance> $value
     * @return self
     ...
     * 
     * @param AccessReviewHistoryInstance $item
     * @return self
     */
    public function addValue(AccessReviewHistoryInstance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewHistoryInstance>
     */
