...
/**
 * Collection response for SearchContent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SearchContentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SearchContent[]
     */
     ...
     * 
     * @param SearchContent[] $items
     * @return self
     */
    public function setValue(array|SearchContent $items, SearchContent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SearchContent> $value
     * @return self
     ...
     * 
     * @param SearchContent $item
     * @return self
     */
    public function addValue(SearchContent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SearchContent>
     */
