...
/**
 * Collection response for RecurrencePattern
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RecurrencePatternCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param RecurrencePattern[] $items
     * @return self
     */
    public function setValue(array|RecurrencePattern $items, RecurrencePattern ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RecurrencePattern> $value
     * @return self
     ...
     * 
     * @param RecurrencePattern $item
     * @return self
     */
    public function addValue(RecurrencePattern $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RecurrencePattern>
     */
