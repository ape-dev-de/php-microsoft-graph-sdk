 ...
 */
class RecurrencePatternCollectionResponse
{
    /**
     ...
     * 
     * @param RecurrencePattern ...$items Variable number of RecurrencePattern items
     * @return self
     */
    public function setValue(RecurrencePattern ...$items): self
    {
        $this->value = $items;
        return $this;
    }
