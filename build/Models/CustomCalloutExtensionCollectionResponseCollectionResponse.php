...
/**
 * Collection response for CustomCalloutExtensionCollectionResponse
 */
class CustomCalloutExtensionCollectionResponseCollectionResponse
{
    /**
     * @var CustomCalloutExtensionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CustomCalloutExtensionCollectionResponse ...$items Variable number of CustomCalloutExtensionCollectionResponse items
     * @return self
     */
    public function setValue(CustomCalloutExtensionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CustomCalloutExtensionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CustomCalloutExtensionCollectionResponse $item
     * @return self
     */
    public function addValue(CustomCalloutExtensionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
