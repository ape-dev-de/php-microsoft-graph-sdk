...
/**
 * Collection response for EntryExportStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EntryExportStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EntryExportStatus[]
     */
    private array $value = [];
     ...
     * 
     * @param EntryExportStatus[] $items
     * @return self
     */
    public function setValue(array|EntryExportStatus $items, EntryExportStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EntryExportStatus> $value
     * @return self
     ...
     * 
     * @param EntryExportStatus $item
     * @return self
     */
    public function addValue(EntryExportStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EntryExportStatus>
     */
