...
/**
 * Collection response for SectionEmphasisType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SectionEmphasisTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SectionEmphasisType[]
     */
    private array $value = [];
     ...
     * 
     * @param SectionEmphasisType[] $items
     * @return self
     */
    public function setValue(array|SectionEmphasisType $items, SectionEmphasisType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SectionEmphasisType> $value
     * @return self
     ...
     * 
     * @param SectionEmphasisType $item
     * @return self
     */
    public function addValue(SectionEmphasisType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SectionEmphasisType>
     */
