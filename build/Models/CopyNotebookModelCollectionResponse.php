...
/**
 * Collection response for CopyNotebookModel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CopyNotebookModelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CopyNotebookModel[]
     */
    private array $value = [];
     ...
     * 
     * @param CopyNotebookModel[] $items
     * @return self
     */
    public function setValue(array|CopyNotebookModel $items, CopyNotebookModel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CopyNotebookModel> $value
     * @return self
     ...
     * 
     * @param CopyNotebookModel $item
     * @return self
     */
    public function addValue(CopyNotebookModel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CopyNotebookModel>
     */
