 ...
 */
class CopyNotebookModelCollectionResponse
{
    /**
     ...
     * 
     * @param CopyNotebookModel ...$items Variable number of CopyNotebookModel items
     * @return self
     */
    public function setValue(CopyNotebookModel ...$items): self
    {
        $this->value = $items;
        return $this;
    }
