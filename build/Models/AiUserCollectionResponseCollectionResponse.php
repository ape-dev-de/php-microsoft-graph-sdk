...
/**
 * Collection response for AiUserCollectionResponse
 */
class AiUserCollectionResponseCollectionResponse
{
    /**
     * @var AiUserCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AiUserCollectionResponse ...$items Variable number of AiUserCollectionResponse items
     * @return self
     */
    public function setValue(AiUserCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AiUserCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AiUserCollectionResponse $item
     * @return self
     */
    public function addValue(AiUserCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
