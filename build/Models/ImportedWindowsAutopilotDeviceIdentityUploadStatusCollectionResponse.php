...
/**
 * ImportedWindowsAutopilotDeviceIdentityUploadStatusCollectionResponse - Collection response
 */
class ImportedWindowsAutopilotDeviceIdentityUploadStatusCollectionResponse
{
    /**
     * @var array<int, ImportedWindowsAutopilotDeviceIdentityUploadStatus>
     */
    public array $value = [];
