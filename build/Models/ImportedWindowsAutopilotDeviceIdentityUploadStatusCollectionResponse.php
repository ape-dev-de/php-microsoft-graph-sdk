...
/**
 * Collection response for ImportedWindowsAutopilotDeviceIdentityUploadStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ImportedWindowsAutopilotDeviceIdentityUploadStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ImportedWindowsAutopilotDeviceIdentityUploadStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return ImportedWindowsAutopilotDeviceIdentityUploadStatus[]
     */
     ...
     * 
     * @param ImportedWindowsAutopilotDeviceIdentityUploadStatus[] $items
     * @return self
     */
    public function setValue(array|ImportedWindowsAutopilotDeviceIdentityUploadStatus $items, ImportedWindowsAutopilotDeviceIdentityUploadStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ImportedWindowsAutopilotDeviceIdentityUploadStatus> $value
     * @return self
     ...
     * 
     * @param ImportedWindowsAutopilotDeviceIdentityUploadStatus $item
     * @return self
     */
    public function addValue(ImportedWindowsAutopilotDeviceIdentityUploadStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ImportedWindowsAutopilotDeviceIdentityUploadStatus>
     */
