...
/**
 * Collection response for SecurityFileEvidenceCollectionResponse
 */
class SecurityFileEvidenceCollectionResponseCollectionResponse
{
    /**
     * @var SecurityFileEvidenceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityFileEvidenceCollectionResponse[]
     */
     ...
     * 
     * @param SecurityFileEvidenceCollectionResponse ...$items Variable number of SecurityFileEvidenceCollectionResponse items
     * @return self
     */
    public function setValue(SecurityFileEvidenceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityFileEvidenceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityFileEvidenceCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityFileEvidenceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
