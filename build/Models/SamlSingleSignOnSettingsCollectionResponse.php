...
/**
 * Collection response for SamlSingleSignOnSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SamlSingleSignOnSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SamlSingleSignOnSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param SamlSingleSignOnSettings[] $items
     * @return self
     */
    public function setValue(array|SamlSingleSignOnSettings $items, SamlSingleSignOnSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SamlSingleSignOnSettings> $value
     * @return self
     ...
     * 
     * @param SamlSingleSignOnSettings $item
     * @return self
     */
    public function addValue(SamlSingleSignOnSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SamlSingleSignOnSettings>
     */
