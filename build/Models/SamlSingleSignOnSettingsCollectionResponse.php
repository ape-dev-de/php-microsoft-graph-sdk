 ...
 */
class SamlSingleSignOnSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param SamlSingleSignOnSettings ...$items Variable number of SamlSingleSignOnSettings items
     * @return self
     */
    public function setValue(SamlSingleSignOnSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
