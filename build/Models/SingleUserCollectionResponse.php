...
/**
 * Collection response for SingleUser
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SingleUserCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SingleUser[]
     */
     ...
     * 
     * @param SingleUser[] $items
     * @return self
     */
    public function setValue(array|SingleUser $items, SingleUser ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param SingleUser $item
     * @return self
     */
    public function addValue(SingleUser $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SingleUser>
     */
