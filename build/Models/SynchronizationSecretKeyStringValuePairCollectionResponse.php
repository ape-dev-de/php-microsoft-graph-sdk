...
/**
 * Collection response for SynchronizationSecretKeyStringValuePair
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationSecretKeyStringValuePairCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SynchronizationSecretKeyStringValuePair[] $items
     * @return self
     */
    public function setValue(array|SynchronizationSecretKeyStringValuePair $items, SynchronizationSecretKeyStringValuePair ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SynchronizationSecretKeyStringValuePair> $value
     * @return self
     ...
     * 
     * @param SynchronizationSecretKeyStringValuePair $item
     * @return self
     */
    public function addValue(SynchronizationSecretKeyStringValuePair $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SynchronizationSecretKeyStringValuePair|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SynchronizationSecretKeyStringValuePair>
     */
