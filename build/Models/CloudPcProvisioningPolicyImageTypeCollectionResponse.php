...
/**
 * CloudPcProvisioningPolicyImageTypeCollectionResponse - Collection response
 */
class CloudPcProvisioningPolicyImageTypeCollectionResponse
{
    /**
     * @var array<int, CloudPcProvisioningPolicyImageType>
     */
    public array $value = [];
