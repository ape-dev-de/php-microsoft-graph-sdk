...
/**
 * Collection response for CloudPcProvisioningPolicyImageType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcProvisioningPolicyImageTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudPcProvisioningPolicyImageType[]
     */
    private array $value = [];
     ...
     * 
     * @return CloudPcProvisioningPolicyImageType[]
     */
     ...
     * 
     * @param CloudPcProvisioningPolicyImageType[] $items
     * @return self
     */
    public function setValue(array|CloudPcProvisioningPolicyImageType $items, CloudPcProvisioningPolicyImageType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcProvisioningPolicyImageType> $value
     * @return self
     ...
     * 
     * @param CloudPcProvisioningPolicyImageType $item
     * @return self
     */
    public function addValue(CloudPcProvisioningPolicyImageType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcProvisioningPolicyImageType>
     */
