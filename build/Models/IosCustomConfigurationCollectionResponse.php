...
/**
 * Collection response for IosCustomConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosCustomConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IosCustomConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param IosCustomConfiguration[] $items
     * @return self
     */
    public function setValue(array|IosCustomConfiguration $items, IosCustomConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosCustomConfiguration> $value
     * @return self
     ...
     * 
     * @param IosCustomConfiguration $item
     * @return self
     */
    public function addValue(IosCustomConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IosCustomConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IosCustomConfiguration>
     */
