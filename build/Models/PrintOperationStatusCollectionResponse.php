...
/**
 * Collection response for PrintOperationStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintOperationStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrintOperationStatus[]
     */
    private array $value = [];
     ...
     * 
     * @param PrintOperationStatus[] $items
     * @return self
     */
    public function setValue(array|PrintOperationStatus $items, PrintOperationStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintOperationStatus> $value
     * @return self
     ...
     * 
     * @param PrintOperationStatus $item
     * @return self
     */
    public function addValue(PrintOperationStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintOperationStatus>
     */
