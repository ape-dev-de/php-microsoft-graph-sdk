 ...
 */
class PrintOperationStatusCollectionResponse
{
    /**
     ...
     * 
     * @param PrintOperationStatus ...$items Variable number of PrintOperationStatus items
     * @return self
     */
    public function setValue(PrintOperationStatus ...$items): self
    {
        $this->value = $items;
        return $this;
    }
