...
/**
 * Collection response for ExtensionCollectionResponse
 */
class ExtensionCollectionResponseCollectionResponse
{
    /**
     * @var ExtensionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ExtensionCollectionResponse ...$items Variable number of ExtensionCollectionResponse items
     * @return self
     */
    public function setValue(ExtensionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ExtensionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ExtensionCollectionResponse $item
     * @return self
     */
    public function addValue(ExtensionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
