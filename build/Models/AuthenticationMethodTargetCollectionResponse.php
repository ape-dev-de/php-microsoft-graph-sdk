...
/**
 * Collection response for AuthenticationMethodTarget
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationMethodTargetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AuthenticationMethodTarget[] $items
     * @return self
     */
    public function setValue(array|AuthenticationMethodTarget $items, AuthenticationMethodTarget ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationMethodTarget> $value
     * @return self
     ...
     * 
     * @param AuthenticationMethodTarget $item
     * @return self
     */
    public function addValue(AuthenticationMethodTarget $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AuthenticationMethodTarget|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationMethodTarget>
     */
