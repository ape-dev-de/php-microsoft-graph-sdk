...
/**
 * Collection response for ServiceHealthIssuePost
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServiceHealthIssuePostCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ServiceHealthIssuePost[] $items
     * @return self
     */
    public function setValue(array|ServiceHealthIssuePost $items, ServiceHealthIssuePost ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServiceHealthIssuePost> $value
     * @return self
     ...
     * 
     * @param ServiceHealthIssuePost $item
     * @return self
     */
    public function addValue(ServiceHealthIssuePost $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ServiceHealthIssuePost|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ServiceHealthIssuePost>
     */
