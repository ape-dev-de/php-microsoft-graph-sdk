...
/**
 * Collection response for UnifiedRoleAssignmentScheduleRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRoleAssignmentScheduleRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UnifiedRoleAssignmentScheduleRequest[] $items
     * @return self
     */
    public function setValue(array|UnifiedRoleAssignmentScheduleRequest $items, UnifiedRoleAssignmentScheduleRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRoleAssignmentScheduleRequest> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleAssignmentScheduleRequest $item
     * @return self
     */
    public function addValue(UnifiedRoleAssignmentScheduleRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRoleAssignmentScheduleRequest>
     */
