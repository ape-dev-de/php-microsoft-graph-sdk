...
/**
 * Collection response for RestoreArtifactBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RestoreArtifactBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RestoreArtifactBase[]
     */
    private array $value = [];
     ...
     * 
     * @param RestoreArtifactBase[] $items
     * @return self
     */
    public function setValue(array|RestoreArtifactBase $items, RestoreArtifactBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RestoreArtifactBase> $value
     * @return self
     ...
     * 
     * @param RestoreArtifactBase $item
     * @return self
     */
    public function addValue(RestoreArtifactBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return RestoreArtifactBase|null
     */
     ...
     * 
     * @return \ArrayIterator<int, RestoreArtifactBase>
     */
