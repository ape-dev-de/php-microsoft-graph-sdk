 ...
 */
class RestoreArtifactBaseCollectionResponse
{
    /**
     ...
     * 
     * @param RestoreArtifactBase ...$items Variable number of RestoreArtifactBase items
     * @return self
     */
    public function setValue(RestoreArtifactBase ...$items): self
    {
        $this->value = $items;
        return $this;
    }
