...
/**
 * Collection response for CustomExtensionData
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CustomExtensionDataCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CustomExtensionData[]
     */
    private array $value = [];
     ...
     * 
     * @param CustomExtensionData[] $items
     * @return self
     */
    public function setValue(array|CustomExtensionData $items, CustomExtensionData ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CustomExtensionData> $value
     * @return self
     ...
     * 
     * @param CustomExtensionData $item
     * @return self
     */
    public function addValue(CustomExtensionData $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CustomExtensionData>
     */
