...
/**
 * Collection response for FilterOperand
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FilterOperandCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FilterOperand[]
     */
     ...
     * 
     * @param FilterOperand[] $items
     * @return self
     */
    public function setValue(array|FilterOperand $items, FilterOperand ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FilterOperand> $value
     * @return self
     ...
     * 
     * @param FilterOperand $item
     * @return self
     */
    public function addValue(FilterOperand $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FilterOperand>
     */
