 ...
 */
class FilterOperandCollectionResponse
{
    /**
     * @var FilterOperand[]
     */
     ...
     * 
     * @param FilterOperand ...$items Variable number of FilterOperand items
     * @return self
     */
    public function setValue(FilterOperand ...$items): self
    {
        $this->value = $items;
        return $this;
    }
