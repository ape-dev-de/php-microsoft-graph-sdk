...
/**
 * Collection response for SimulationContentSource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SimulationContentSourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SimulationContentSource[]
     */
    private array $value = [];
     ...
     * 
     * @return SimulationContentSource[]
     */
     ...
     * 
     * @param SimulationContentSource[] $items
     * @return self
     */
    public function setValue(array|SimulationContentSource $items, SimulationContentSource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SimulationContentSource> $value
     * @return self
     ...
     * 
     * @param SimulationContentSource $item
     * @return self
     */
    public function addValue(SimulationContentSource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SimulationContentSource>
     */
