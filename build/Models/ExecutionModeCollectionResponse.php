...
/**
 * Collection response for ExecutionMode
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExecutionModeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ExecutionMode[]
     */
     ...
     * 
     * @param ExecutionMode[] $items
     * @return self
     */
    public function setValue(array|ExecutionMode $items, ExecutionMode ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExecutionMode> $value
     * @return self
     ...
     * 
     * @param ExecutionMode $item
     * @return self
     */
    public function addValue(ExecutionMode $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ExecutionMode>
     */
