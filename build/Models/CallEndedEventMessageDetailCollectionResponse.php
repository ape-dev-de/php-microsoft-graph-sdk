...
/**
 * Collection response for CallEndedEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallEndedEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallEndedEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param CallEndedEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|CallEndedEventMessageDetail $items, CallEndedEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallEndedEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param CallEndedEventMessageDetail $item
     * @return self
     */
    public function addValue(CallEndedEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallEndedEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallEndedEventMessageDetail>
     */
