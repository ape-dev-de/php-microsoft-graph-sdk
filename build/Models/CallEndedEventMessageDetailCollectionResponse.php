 ...
 */
class CallEndedEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param CallEndedEventMessageDetail ...$items Variable number of CallEndedEventMessageDetail items
     * @return self
     */
    public function setValue(CallEndedEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
