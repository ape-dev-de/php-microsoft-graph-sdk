...
/**
 * Collection response for DriveItemVersionCollectionResponse
 */
class DriveItemVersionCollectionResponseCollectionResponse
{
    /**
     * @var DriveItemVersionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DriveItemVersionCollectionResponse ...$items Variable number of DriveItemVersionCollectionResponse items
     * @return self
     */
    public function setValue(DriveItemVersionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DriveItemVersionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DriveItemVersionCollectionResponse $item
     * @return self
     */
    public function addValue(DriveItemVersionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
