...
/**
 * Collection response for StateManagementSetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class StateManagementSettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param StateManagementSetting[] $items
     * @return self
     */
    public function setValue(array|StateManagementSetting $items, StateManagementSetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<StateManagementSetting> $value
     * @return self
     ...
     * 
     * @param StateManagementSetting $item
     * @return self
     */
    public function addValue(StateManagementSetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, StateManagementSetting>
     */
