...
/**
 * Collection response for AppManagementApplicationConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppManagementApplicationConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AppManagementApplicationConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param AppManagementApplicationConfiguration[] $items
     * @return self
     */
    public function setValue(array|AppManagementApplicationConfiguration $items, AppManagementApplicationConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppManagementApplicationConfiguration> $value
     * @return self
     ...
     * 
     * @param AppManagementApplicationConfiguration $item
     * @return self
     */
    public function addValue(AppManagementApplicationConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AppManagementApplicationConfiguration>
     */
