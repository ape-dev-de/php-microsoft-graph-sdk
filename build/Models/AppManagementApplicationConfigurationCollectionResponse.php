...
/**
 * AppManagementApplicationConfigurationCollectionResponse - Collection response
 */
class AppManagementApplicationConfigurationCollectionResponse
{
    /**
     * @var array<int, AppManagementApplicationConfiguration>
     */
    public array $value = [];
