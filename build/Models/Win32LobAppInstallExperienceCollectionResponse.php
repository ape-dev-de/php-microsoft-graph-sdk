...
/**
 * Collection response for Win32LobAppInstallExperience
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Win32LobAppInstallExperienceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Win32LobAppInstallExperience[]
     */
    private array $value = [];
     ...
     * 
     * @param Win32LobAppInstallExperience[] $items
     * @return self
     */
    public function setValue(array|Win32LobAppInstallExperience $items, Win32LobAppInstallExperience ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Win32LobAppInstallExperience> $value
     * @return self
     ...
     * 
     * @param Win32LobAppInstallExperience $item
     * @return self
     */
    public function addValue(Win32LobAppInstallExperience $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Win32LobAppInstallExperience>
     */
