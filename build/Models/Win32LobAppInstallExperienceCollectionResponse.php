 ...
 */
class Win32LobAppInstallExperienceCollectionResponse
{
    /**
     ...
     * 
     * @param Win32LobAppInstallExperience ...$items Variable number of Win32LobAppInstallExperience items
     * @return self
     */
    public function setValue(Win32LobAppInstallExperience ...$items): self
    {
        $this->value = $items;
        return $this;
    }
