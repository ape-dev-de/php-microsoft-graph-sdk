...
/**
 * Collection response for HorizontalSectionLayoutType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class HorizontalSectionLayoutTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var HorizontalSectionLayoutType[]
     */
    private array $value = [];
     ...
     * 
     * @return HorizontalSectionLayoutType[]
     */
     ...
     * 
     * @param HorizontalSectionLayoutType[] $items
     * @return self
     */
    public function setValue(array|HorizontalSectionLayoutType $items, HorizontalSectionLayoutType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<HorizontalSectionLayoutType> $value
     * @return self
     ...
     * 
     * @param HorizontalSectionLayoutType $item
     * @return self
     */
    public function addValue(HorizontalSectionLayoutType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, HorizontalSectionLayoutType>
     */
