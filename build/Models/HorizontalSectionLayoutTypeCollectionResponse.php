...
/**
 * HorizontalSectionLayoutTypeCollectionResponse - Collection response
 */
class HorizontalSectionLayoutTypeCollectionResponse
{
    /**
     * @var array<int, HorizontalSectionLayoutType>
     */
    public array $value = [];
