...
/**
 * Collection response for Windows10GeneralConfigurationCollectionResponse
 */
class Windows10GeneralConfigurationCollectionResponseCollectionResponse
{
    /**
     * @var Windows10GeneralConfigurationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param Windows10GeneralConfigurationCollectionResponse ...$items Variable number of Windows10GeneralConfigurationCollectionResponse items
     * @return self
     */
    public function setValue(Windows10GeneralConfigurationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<Windows10GeneralConfigurationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param Windows10GeneralConfigurationCollectionResponse $item
     * @return self
     */
    public function addValue(Windows10GeneralConfigurationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
