...
/**
 * SecurityHostSslCertificateCollectionResponse - Collection response
 */
class SecurityHostSslCertificateCollectionResponse
{
    /**
     * @var array<int, SecurityHostSslCertificate>
     */
    public array $value = [];
