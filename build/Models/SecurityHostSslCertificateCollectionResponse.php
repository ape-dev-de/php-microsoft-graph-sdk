...
/**
 * Collection response for SecurityHostSslCertificate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHostSslCertificateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityHostSslCertificate[] $items
     * @return self
     */
    public function setValue(array|SecurityHostSslCertificate $items, SecurityHostSslCertificate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHostSslCertificate> $value
     * @return self
     ...
     * 
     * @param SecurityHostSslCertificate $item
     * @return self
     */
    public function addValue(SecurityHostSslCertificate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityHostSslCertificate>
     */
