...
/**
 * Collection response for ProvisionedIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProvisionedIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProvisionedIdentity[]
     */
    private array $value = [];
     ...
     * 
     * @param ProvisionedIdentity[] $items
     * @return self
     */
    public function setValue(array|ProvisionedIdentity $items, ProvisionedIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProvisionedIdentity> $value
     * @return self
     ...
     * 
     * @param ProvisionedIdentity $item
     * @return self
     */
    public function addValue(ProvisionedIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProvisionedIdentity>
     */
