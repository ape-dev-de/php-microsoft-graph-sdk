 ...
 */
class ProvisionedIdentityCollectionResponse
{
    /**
     ...
     * 
     * @param ProvisionedIdentity ...$items Variable number of ProvisionedIdentity items
     * @return self
     */
    public function setValue(ProvisionedIdentity ...$items): self
    {
        $this->value = $items;
        return $this;
    }
