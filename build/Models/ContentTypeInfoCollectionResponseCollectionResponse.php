...
/**
 * Collection response for ContentTypeInfoCollectionResponse
 */
class ContentTypeInfoCollectionResponseCollectionResponse
{
    /**
     * @var ContentTypeInfoCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ContentTypeInfoCollectionResponse ...$items Variable number of ContentTypeInfoCollectionResponse items
     * @return self
     */
    public function setValue(ContentTypeInfoCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ContentTypeInfoCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ContentTypeInfoCollectionResponse $item
     * @return self
     */
    public function addValue(ContentTypeInfoCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
