...
/**
 * Collection response for RemindBeforeTimeInMinutesType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RemindBeforeTimeInMinutesTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RemindBeforeTimeInMinutesType[]
     */
    private array $value = [];
     ...
     * 
     * @return RemindBeforeTimeInMinutesType[]
     */
     ...
     * 
     * @param RemindBeforeTimeInMinutesType[] $items
     * @return self
     */
    public function setValue(array|RemindBeforeTimeInMinutesType $items, RemindBeforeTimeInMinutesType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RemindBeforeTimeInMinutesType> $value
     * @return self
     ...
     * 
     * @param RemindBeforeTimeInMinutesType $item
     * @return self
     */
    public function addValue(RemindBeforeTimeInMinutesType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RemindBeforeTimeInMinutesType>
     */
