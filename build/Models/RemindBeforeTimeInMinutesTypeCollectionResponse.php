...
/**
 * RemindBeforeTimeInMinutesTypeCollectionResponse - Collection response
 */
class RemindBeforeTimeInMinutesTypeCollectionResponse
{
    /**
     * @var array<int, RemindBeforeTimeInMinutesType>
     */
    public array $value = [];
