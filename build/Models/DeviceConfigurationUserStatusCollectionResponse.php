...
/**
 * Collection response for DeviceConfigurationUserStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceConfigurationUserStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceConfigurationUserStatus[] $items
     * @return self
     */
    public function setValue(array|DeviceConfigurationUserStatus $items, DeviceConfigurationUserStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceConfigurationUserStatus> $value
     * @return self
     ...
     * 
     * @param DeviceConfigurationUserStatus $item
     * @return self
     */
    public function addValue(DeviceConfigurationUserStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceConfigurationUserStatus>
     */
