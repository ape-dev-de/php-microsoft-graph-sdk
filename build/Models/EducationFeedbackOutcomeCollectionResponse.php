...
/**
 * Collection response for EducationFeedbackOutcome
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationFeedbackOutcomeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationFeedbackOutcome[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationFeedbackOutcome[] $items
     * @return self
     */
    public function setValue(array|EducationFeedbackOutcome $items, EducationFeedbackOutcome ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationFeedbackOutcome> $value
     * @return self
     ...
     * 
     * @param EducationFeedbackOutcome $item
     * @return self
     */
    public function addValue(EducationFeedbackOutcome $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EducationFeedbackOutcome|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EducationFeedbackOutcome>
     */
