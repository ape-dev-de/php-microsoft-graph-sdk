 ...
 */
class UserInsightsSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param UserInsightsSettings ...$items Variable number of UserInsightsSettings items
     * @return self
     */
    public function setValue(UserInsightsSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
