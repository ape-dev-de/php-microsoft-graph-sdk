...
/**
 * Collection response for UserInsightsSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserInsightsSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserInsightsSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param UserInsightsSettings[] $items
     * @return self
     */
    public function setValue(array|UserInsightsSettings $items, UserInsightsSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserInsightsSettings> $value
     * @return self
     ...
     * 
     * @param UserInsightsSettings $item
     * @return self
     */
    public function addValue(UserInsightsSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserInsightsSettings>
     */
