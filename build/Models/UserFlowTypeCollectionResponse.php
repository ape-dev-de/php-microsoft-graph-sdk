...
/**
 * Collection response for UserFlowType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserFlowTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserFlowType[]
     */
     ...
     * 
     * @param UserFlowType[] $items
     * @return self
     */
    public function setValue(array|UserFlowType $items, UserFlowType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserFlowType> $value
     * @return self
     ...
     * 
     * @param UserFlowType $item
     * @return self
     */
    public function addValue(UserFlowType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserFlowType>
     */
