...
/**
 * Collection response for ColumnDefinition
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ColumnDefinitionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ColumnDefinition[] $items
     * @return self
     */
    public function setValue(array|ColumnDefinition $items, ColumnDefinition ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ColumnDefinition> $value
     * @return self
     ...
     * @return self
     */
    public function addValue(ColumnDefinition $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ColumnDefinition>
     */
