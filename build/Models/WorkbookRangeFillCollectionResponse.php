 ...
 */
class WorkbookRangeFillCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookRangeFill ...$items Variable number of WorkbookRangeFill items
     * @return self
     */
    public function setValue(WorkbookRangeFill ...$items): self
    {
        $this->value = $items;
        return $this;
    }
