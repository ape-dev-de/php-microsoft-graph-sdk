...
/**
 * Collection response for WorkbookRangeFill
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookRangeFillCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookRangeFill[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookRangeFill[] $items
     * @return self
     */
    public function setValue(array|WorkbookRangeFill $items, WorkbookRangeFill ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookRangeFill> $value
     * @return self
     ...
     * 
     * @param WorkbookRangeFill $item
     * @return self
     */
    public function addValue(WorkbookRangeFill $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookRangeFill>
     */
