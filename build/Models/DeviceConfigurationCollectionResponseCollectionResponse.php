...
/**
 * Collection response for DeviceConfigurationCollectionResponse
 */
class DeviceConfigurationCollectionResponseCollectionResponse
{
    /**
     * @var DeviceConfigurationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceConfigurationCollectionResponse ...$items Variable number of DeviceConfigurationCollectionResponse items
     * @return self
     */
    public function setValue(DeviceConfigurationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeviceConfigurationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeviceConfigurationCollectionResponse $item
     * @return self
     */
    public function addValue(DeviceConfigurationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
