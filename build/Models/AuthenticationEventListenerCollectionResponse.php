...
/**
 * Collection response for AuthenticationEventListener
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationEventListenerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AuthenticationEventListener[] $items
     * @return self
     */
    public function setValue(array|AuthenticationEventListener $items, AuthenticationEventListener ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationEventListener> $value
     * @return self
     ...
     * 
     * @param AuthenticationEventListener $item
     * @return self
     */
    public function addValue(AuthenticationEventListener $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationEventListener>
     */
