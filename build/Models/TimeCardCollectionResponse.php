...
/**
 * Collection response for TimeCard
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TimeCardCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TimeCard[]
     */
     ...
     * 
     * @param TimeCard[] $items
     * @return self
     */
    public function setValue(array|TimeCard $items, TimeCard ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(TimeCard $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TimeCard>
     */
