...
/**
 * Collection response for ImageInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ImageInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ImageInfo[]
     */
     ...
     * 
     * @param ImageInfo[] $items
     * @return self
     */
    public function setValue(array|ImageInfo $items, ImageInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(ImageInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ImageInfo>
     */
