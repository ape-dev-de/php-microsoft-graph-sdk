...
/**
 * Collection response for OfferShiftRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OfferShiftRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param OfferShiftRequest[] $items
     * @return self
     */
    public function setValue(array|OfferShiftRequest $items, OfferShiftRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OfferShiftRequest> $value
     * @return self
     ...
     * 
     * @param OfferShiftRequest $item
     * @return self
     */
    public function addValue(OfferShiftRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OfferShiftRequest>
     */
