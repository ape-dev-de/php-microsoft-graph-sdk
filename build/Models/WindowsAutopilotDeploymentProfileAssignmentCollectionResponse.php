...
/**
 * Collection response for WindowsAutopilotDeploymentProfileAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsAutopilotDeploymentProfileAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsAutopilotDeploymentProfileAssignment[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsAutopilotDeploymentProfileAssignment[] $items
     * @return self
     */
    public function setValue(array|WindowsAutopilotDeploymentProfileAssignment $items, WindowsAutopilotDeploymentProfileAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsAutopilotDeploymentProfileAssignment> $value
     * @return self
     ...
     * 
     * @param WindowsAutopilotDeploymentProfileAssignment $item
     * @return self
     */
    public function addValue(WindowsAutopilotDeploymentProfileAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WindowsAutopilotDeploymentProfileAssignment|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WindowsAutopilotDeploymentProfileAssignment>
     */
