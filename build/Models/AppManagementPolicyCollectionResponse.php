...
/**
 * Collection response for AppManagementPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppManagementPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AppManagementPolicy[] $items
     * @return self
     */
    public function setValue(array|AppManagementPolicy $items, AppManagementPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppManagementPolicy> $value
     * @return self
     ...
     * 
     * @param AppManagementPolicy $item
     * @return self
     */
    public function addValue(AppManagementPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AppManagementPolicy>
     */
