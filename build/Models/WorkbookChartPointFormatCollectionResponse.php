 ...
 */
class WorkbookChartPointFormatCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookChartPointFormat ...$items Variable number of WorkbookChartPointFormat items
     * @return self
     */
    public function setValue(WorkbookChartPointFormat ...$items): self
    {
        $this->value = $items;
        return $this;
    }
