...
/**
 * Collection response for WorkbookChartPointFormat
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookChartPointFormatCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookChartPointFormat[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookChartPointFormat[] $items
     * @return self
     */
    public function setValue(array|WorkbookChartPointFormat $items, WorkbookChartPointFormat ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookChartPointFormat> $value
     * @return self
     ...
     * 
     * @param WorkbookChartPointFormat $item
     * @return self
     */
    public function addValue(WorkbookChartPointFormat $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookChartPointFormat>
     */
