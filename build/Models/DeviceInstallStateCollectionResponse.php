...
/**
 * Collection response for DeviceInstallState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceInstallStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceInstallState[] $items
     * @return self
     */
    public function setValue(array|DeviceInstallState $items, DeviceInstallState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceInstallState> $value
     * @return self
     ...
     * 
     * @param DeviceInstallState $item
     * @return self
     */
    public function addValue(DeviceInstallState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceInstallState>
     */
