...
/**
 * Collection response for ManagedAppAvailability
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedAppAvailabilityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ManagedAppAvailability[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedAppAvailability[] $items
     * @return self
     */
    public function setValue(array|ManagedAppAvailability $items, ManagedAppAvailability ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedAppAvailability> $value
     * @return self
     ...
     * 
     * @param ManagedAppAvailability $item
     * @return self
     */
    public function addValue(ManagedAppAvailability $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedAppAvailability>
     */
