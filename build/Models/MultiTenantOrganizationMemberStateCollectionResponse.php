...
/**
 * Collection response for MultiTenantOrganizationMemberState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MultiTenantOrganizationMemberStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MultiTenantOrganizationMemberState[]
     */
    private array $value = [];
     ...
     * 
     * @return MultiTenantOrganizationMemberState[]
     */
     ...
     * 
     * @param MultiTenantOrganizationMemberState[] $items
     * @return self
     */
    public function setValue(array|MultiTenantOrganizationMemberState $items, MultiTenantOrganizationMemberState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MultiTenantOrganizationMemberState> $value
     * @return self
     ...
     * 
     * @param MultiTenantOrganizationMemberState $item
     * @return self
     */
    public function addValue(MultiTenantOrganizationMemberState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MultiTenantOrganizationMemberState>
     */
