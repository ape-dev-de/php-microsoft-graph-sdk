...
/**
 * MultiTenantOrganizationMemberStateCollectionResponse - Collection response
 */
class MultiTenantOrganizationMemberStateCollectionResponse
{
    /**
     * @var array<int, MultiTenantOrganizationMemberState>
     */
    public array $value = [];
