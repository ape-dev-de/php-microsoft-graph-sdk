 ...
 */
class AdminMicrosoft365AppsCollectionResponse
{
    /**
     ...
     * 
     * @param AdminMicrosoft365Apps ...$items Variable number of AdminMicrosoft365Apps items
     * @return self
     */
    public function setValue(AdminMicrosoft365Apps ...$items): self
    {
        $this->value = $items;
        return $this;
    }
