...
/**
 * Collection response for AdminMicrosoft365Apps
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AdminMicrosoft365AppsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AdminMicrosoft365Apps[]
     */
    private array $value = [];
     ...
     * 
     * @param AdminMicrosoft365Apps[] $items
     * @return self
     */
    public function setValue(array|AdminMicrosoft365Apps $items, AdminMicrosoft365Apps ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AdminMicrosoft365Apps> $value
     * @return self
     ...
     * 
     * @param AdminMicrosoft365Apps $item
     * @return self
     */
    public function addValue(AdminMicrosoft365Apps $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AdminMicrosoft365Apps>
     */
