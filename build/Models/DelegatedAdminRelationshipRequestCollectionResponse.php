...
/**
 * Collection response for DelegatedAdminRelationshipRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DelegatedAdminRelationshipRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DelegatedAdminRelationshipRequest[] $items
     * @return self
     */
    public function setValue(array|DelegatedAdminRelationshipRequest $items, DelegatedAdminRelationshipRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DelegatedAdminRelationshipRequest> $value
     * @return self
     ...
     * 
     * @param DelegatedAdminRelationshipRequest $item
     * @return self
     */
    public function addValue(DelegatedAdminRelationshipRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DelegatedAdminRelationshipRequest>
     */
