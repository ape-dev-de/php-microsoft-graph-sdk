...
/**
 * Collection response for AdministrativeUnitCollectionResponse
 */
class AdministrativeUnitCollectionResponseCollectionResponse
{
    /**
     * @var AdministrativeUnitCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AdministrativeUnitCollectionResponse ...$items Variable number of AdministrativeUnitCollectionResponse items
     * @return self
     */
    public function setValue(AdministrativeUnitCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AdministrativeUnitCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AdministrativeUnitCollectionResponse $item
     * @return self
     */
    public function addValue(AdministrativeUnitCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
