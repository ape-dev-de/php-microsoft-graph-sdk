...
/**
 * Collection response for ResponseType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ResponseTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ResponseType[]
     */
     ...
     * 
     * @param ResponseType[] $items
     * @return self
     */
    public function setValue(array|ResponseType $items, ResponseType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ResponseType> $value
     * @return self
     ...
     * 
     * @param ResponseType $item
     * @return self
     */
    public function addValue(ResponseType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ResponseType>
     */
