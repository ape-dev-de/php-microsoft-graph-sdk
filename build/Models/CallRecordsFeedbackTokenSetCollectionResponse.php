...
/**
 * Collection response for CallRecordsFeedbackTokenSet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsFeedbackTokenSetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsFeedbackTokenSet[]
     */
    private array $value = [];
     ...
     * 
     * @return CallRecordsFeedbackTokenSet[]
     */
     ...
     * 
     * @param CallRecordsFeedbackTokenSet[] $items
     * @return self
     */
    public function setValue(array|CallRecordsFeedbackTokenSet $items, CallRecordsFeedbackTokenSet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsFeedbackTokenSet> $value
     * @return self
     ...
     * 
     * @param CallRecordsFeedbackTokenSet $item
     * @return self
     */
    public function addValue(CallRecordsFeedbackTokenSet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsFeedbackTokenSet|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsFeedbackTokenSet>
     */
