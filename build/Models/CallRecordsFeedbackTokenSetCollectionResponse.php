...
/**
 * CallRecordsFeedbackTokenSetCollectionResponse - Collection response
 */
class CallRecordsFeedbackTokenSetCollectionResponse
{
    /**
     * @var array<int, CallRecordsFeedbackTokenSet>
     */
    public array $value = [];
