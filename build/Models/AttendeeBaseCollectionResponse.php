...
/**
 * Collection response for AttendeeBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttendeeBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AttendeeBase[]
     */
     ...
     * 
     * @param AttendeeBase[] $items
     * @return self
     */
    public function setValue(array|AttendeeBase $items, AttendeeBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttendeeBase> $value
     * @return self
     ...
     * 
     * @param AttendeeBase $item
     * @return self
     */
    public function addValue(AttendeeBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AttendeeBase>
     */
