...
/**
 * Collection response for RiskyUser
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RiskyUserCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RiskyUser[]
     */
     ...
     * 
     * @param RiskyUser[] $items
     * @return self
     */
    public function setValue(array|RiskyUser $items, RiskyUser ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param RiskyUser $item
     * @return self
     */
    public function addValue(RiskyUser $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RiskyUser>
     */
