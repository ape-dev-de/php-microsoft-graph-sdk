...
/**
 * SecurityAntispamTeamsDirectionCollectionResponse - Collection response
 */
class SecurityAntispamTeamsDirectionCollectionResponse
{
    /**
     * @var array<int, SecurityAntispamTeamsDirection>
     */
    public array $value = [];
