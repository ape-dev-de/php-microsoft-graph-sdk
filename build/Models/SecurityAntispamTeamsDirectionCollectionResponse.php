...
/**
 * Collection response for SecurityAntispamTeamsDirection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityAntispamTeamsDirectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityAntispamTeamsDirection[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityAntispamTeamsDirection[]
     */
     ...
     * 
     * @param SecurityAntispamTeamsDirection[] $items
     * @return self
     */
    public function setValue(array|SecurityAntispamTeamsDirection $items, SecurityAntispamTeamsDirection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityAntispamTeamsDirection> $value
     * @return self
     ...
     * 
     * @param SecurityAntispamTeamsDirection $item
     * @return self
     */
    public function addValue(SecurityAntispamTeamsDirection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityAntispamTeamsDirection|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityAntispamTeamsDirection>
     */
