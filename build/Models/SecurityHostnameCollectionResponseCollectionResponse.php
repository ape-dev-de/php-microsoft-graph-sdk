...
/**
 * Collection response for SecurityHostnameCollectionResponse
 */
class SecurityHostnameCollectionResponseCollectionResponse
{
    /**
     * @var SecurityHostnameCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityHostnameCollectionResponse[]
     */
     ...
     * 
     * @param SecurityHostnameCollectionResponse ...$items Variable number of SecurityHostnameCollectionResponse items
     * @return self
     */
    public function setValue(SecurityHostnameCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityHostnameCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityHostnameCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityHostnameCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
