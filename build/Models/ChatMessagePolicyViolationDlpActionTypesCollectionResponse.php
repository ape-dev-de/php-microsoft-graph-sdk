...
/**
 * Collection response for ChatMessagePolicyViolationDlpActionTypes
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatMessagePolicyViolationDlpActionTypesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return ChatMessagePolicyViolationDlpActionTypes[]
     */
     ...
     * 
     * @param ChatMessagePolicyViolationDlpActionTypes[] $items
     * @return self
     */
    public function setValue(array|ChatMessagePolicyViolationDlpActionTypes $items, ChatMessagePolicyViolationDlpActionTypes ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChatMessagePolicyViolationDlpActionTypes> $value
     * @return self
     ...
     * 
     * @param ChatMessagePolicyViolationDlpActionTypes $item
     * @return self
     */
    public function addValue(ChatMessagePolicyViolationDlpActionTypes $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChatMessagePolicyViolationDlpActionTypes>
     */
