...
/**
 * ChatMessagePolicyViolationDlpActionTypesCollectionResponse - Collection response
 */
class ChatMessagePolicyViolationDlpActionTypesCollectionResponse
{
    /**
     * @var array<int, ChatMessagePolicyViolationDlpActionTypes>
     */
    public array $value = [];
