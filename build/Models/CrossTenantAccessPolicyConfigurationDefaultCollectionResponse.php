 ...
 */
class CrossTenantAccessPolicyConfigurationDefaultCollectionResponse
{
    /**
     ...
     * 
     * @param CrossTenantAccessPolicyConfigurationDefault ...$items Variable number of CrossTenantAccessPolicyConfigurationDefault items
     * @return self
     */
    public function setValue(CrossTenantAccessPolicyConfigurationDefault ...$items): self
    {
        $this->value = $items;
        return $this;
    }
