...
/**
 * Collection response for CrossTenantAccessPolicyConfigurationDefault
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CrossTenantAccessPolicyConfigurationDefaultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CrossTenantAccessPolicyConfigurationDefault[]
     */
    private array $value = [];
     ...
     * 
     * @param CrossTenantAccessPolicyConfigurationDefault[] $items
     * @return self
     */
    public function setValue(array|CrossTenantAccessPolicyConfigurationDefault $items, CrossTenantAccessPolicyConfigurationDefault ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CrossTenantAccessPolicyConfigurationDefault> $value
     * @return self
     ...
     * 
     * @param CrossTenantAccessPolicyConfigurationDefault $item
     * @return self
     */
    public function addValue(CrossTenantAccessPolicyConfigurationDefault $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CrossTenantAccessPolicyConfigurationDefault>
     */
