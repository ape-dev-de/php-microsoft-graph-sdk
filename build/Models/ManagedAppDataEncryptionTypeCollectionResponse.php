...
/**
 * ManagedAppDataEncryptionTypeCollectionResponse - Collection response
 */
class ManagedAppDataEncryptionTypeCollectionResponse
{
    /**
     * @var array<int, ManagedAppDataEncryptionType>
     */
    public array $value = [];
