...
/**
 * Collection response for ManagedAppDataEncryptionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedAppDataEncryptionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ManagedAppDataEncryptionType[]
     */
    private array $value = [];
     ...
     * 
     * @return ManagedAppDataEncryptionType[]
     */
     ...
     * 
     * @param ManagedAppDataEncryptionType[] $items
     * @return self
     */
    public function setValue(array|ManagedAppDataEncryptionType $items, ManagedAppDataEncryptionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedAppDataEncryptionType> $value
     * @return self
     ...
     * 
     * @param ManagedAppDataEncryptionType $item
     * @return self
     */
    public function addValue(ManagedAppDataEncryptionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedAppDataEncryptionType>
     */
