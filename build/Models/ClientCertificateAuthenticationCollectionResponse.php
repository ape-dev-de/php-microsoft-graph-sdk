 ...
 */
class ClientCertificateAuthenticationCollectionResponse
{
    /**
     ...
     * 
     * @param ClientCertificateAuthentication ...$items Variable number of ClientCertificateAuthentication items
     * @return self
     */
    public function setValue(ClientCertificateAuthentication ...$items): self
    {
        $this->value = $items;
        return $this;
    }
