...
/**
 * Collection response for ClientCertificateAuthentication
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ClientCertificateAuthenticationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ClientCertificateAuthentication[]
     */
    private array $value = [];
     ...
     * 
     * @param ClientCertificateAuthentication[] $items
     * @return self
     */
    public function setValue(array|ClientCertificateAuthentication $items, ClientCertificateAuthentication ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ClientCertificateAuthentication> $value
     * @return self
     ...
     * 
     * @param ClientCertificateAuthentication $item
     * @return self
     */
    public function addValue(ClientCertificateAuthentication $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ClientCertificateAuthentication|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ClientCertificateAuthentication>
     */
