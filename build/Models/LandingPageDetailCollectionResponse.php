...
/**
 * Collection response for LandingPageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LandingPageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param LandingPageDetail[] $items
     * @return self
     */
    public function setValue(array|LandingPageDetail $items, LandingPageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LandingPageDetail> $value
     * @return self
     ...
     * 
     * @param LandingPageDetail $item
     * @return self
     */
    public function addValue(LandingPageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LandingPageDetail>
     */
