 ...
 */
class OnAttributeCollectionSubmitCustomExtensionHandlerCollectionResponse
{
    /**
     ...
     * 
     * @param OnAttributeCollectionSubmitCustomExtensionHandler ...$items Variable number of OnAttributeCollectionSubmitCustomExtensionHandler items
     * @return self
     */
    public function setValue(OnAttributeCollectionSubmitCustomExtensionHandler ...$items): self
    {
        $this->value = $items;
        return $this;
    }
