...
/**
 * Collection response for OnAttributeCollectionSubmitCustomExtensionHandler
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnAttributeCollectionSubmitCustomExtensionHandlerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnAttributeCollectionSubmitCustomExtensionHandler[]
     */
    private array $value = [];
     ...
     * 
     * @param OnAttributeCollectionSubmitCustomExtensionHandler[] $items
     * @return self
     */
    public function setValue(array|OnAttributeCollectionSubmitCustomExtensionHandler $items, OnAttributeCollectionSubmitCustomExtensionHandler ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnAttributeCollectionSubmitCustomExtensionHandler> $value
     * @return self
     ...
     * 
     * @param OnAttributeCollectionSubmitCustomExtensionHandler $item
     * @return self
     */
    public function addValue(OnAttributeCollectionSubmitCustomExtensionHandler $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OnAttributeCollectionSubmitCustomExtensionHandler|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OnAttributeCollectionSubmitCustomExtensionHandler>
     */
