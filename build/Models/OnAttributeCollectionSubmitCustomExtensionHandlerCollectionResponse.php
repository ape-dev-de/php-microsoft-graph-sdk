...
/**
 * OnAttributeCollectionSubmitCustomExtensionHandlerCollectionResponse - Collection response
 */
class OnAttributeCollectionSubmitCustomExtensionHandlerCollectionResponse
{
    /**
     * @var array<int, OnAttributeCollectionSubmitCustomExtensionHandler>
     */
    public array $value = [];
