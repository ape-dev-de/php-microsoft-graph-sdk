...
/**
 * Collection response for CustomTrainingSetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CustomTrainingSettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CustomTrainingSetting[]
     */
    private array $value = [];
     ...
     * 
     * @param CustomTrainingSetting[] $items
     * @return self
     */
    public function setValue(array|CustomTrainingSetting $items, CustomTrainingSetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CustomTrainingSetting> $value
     * @return self
     ...
     * 
     * @param CustomTrainingSetting $item
     * @return self
     */
    public function addValue(CustomTrainingSetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CustomTrainingSetting|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CustomTrainingSetting>
     */
