 ...
 */
class CustomTrainingSettingCollectionResponse
{
    /**
     ...
     * 
     * @param CustomTrainingSetting ...$items Variable number of CustomTrainingSetting items
     * @return self
     */
    public function setValue(CustomTrainingSetting ...$items): self
    {
        $this->value = $items;
        return $this;
    }
