...
/**
 * Collection response for UserPrint
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserPrintCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserPrint[]
     */
     ...
     * 
     * @param UserPrint[] $items
     * @return self
     */
    public function setValue(array|UserPrint $items, UserPrint ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param UserPrint $item
     * @return self
     */
    public function addValue(UserPrint $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserPrint>
     */
