...
/**
 * BookingStaffMembershipStatusCollectionResponse - Collection response
 */
class BookingStaffMembershipStatusCollectionResponse
{
    /**
     * @var array<int, BookingStaffMembershipStatus>
     */
    public array $value = [];
