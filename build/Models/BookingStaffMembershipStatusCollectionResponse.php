...
/**
 * Collection response for BookingStaffMembershipStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingStaffMembershipStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BookingStaffMembershipStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return BookingStaffMembershipStatus[]
     */
     ...
     * 
     * @param BookingStaffMembershipStatus[] $items
     * @return self
     */
    public function setValue(array|BookingStaffMembershipStatus $items, BookingStaffMembershipStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingStaffMembershipStatus> $value
     * @return self
     ...
     * 
     * @param BookingStaffMembershipStatus $item
     * @return self
     */
    public function addValue(BookingStaffMembershipStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BookingStaffMembershipStatus>
     */
