...
/**
 * Collection response for IosHomeScreenFolder
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosHomeScreenFolderCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IosHomeScreenFolder[]
     */
    private array $value = [];
     ...
     * 
     * @param IosHomeScreenFolder[] $items
     * @return self
     */
    public function setValue(array|IosHomeScreenFolder $items, IosHomeScreenFolder ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosHomeScreenFolder> $value
     * @return self
     ...
     * 
     * @param IosHomeScreenFolder $item
     * @return self
     */
    public function addValue(IosHomeScreenFolder $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IosHomeScreenFolder|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IosHomeScreenFolder>
     */
