 ...
 */
class IosHomeScreenFolderCollectionResponse
{
    /**
     ...
     * 
     * @param IosHomeScreenFolder ...$items Variable number of IosHomeScreenFolder items
     * @return self
     */
    public function setValue(IosHomeScreenFolder ...$items): self
    {
        $this->value = $items;
        return $this;
    }
