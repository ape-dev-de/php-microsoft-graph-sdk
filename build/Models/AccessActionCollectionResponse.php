...
/**
 * Collection response for AccessAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessAction[]
     */
     ...
     * 
     * @param AccessAction[] $items
     * @return self
     */
    public function setValue(array|AccessAction $items, AccessAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessAction> $value
     * @return self
     ...
     * 
     * @param AccessAction $item
     * @return self
     */
    public function addValue(AccessAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessAction>
     */
