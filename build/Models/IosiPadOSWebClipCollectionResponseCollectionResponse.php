...
/**
 * Collection response for IosiPadOSWebClipCollectionResponse
 */
class IosiPadOSWebClipCollectionResponseCollectionResponse
{
    /**
     * @var IosiPadOSWebClipCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IosiPadOSWebClipCollectionResponse ...$items Variable number of IosiPadOSWebClipCollectionResponse items
     * @return self
     */
    public function setValue(IosiPadOSWebClipCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IosiPadOSWebClipCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IosiPadOSWebClipCollectionResponse $item
     * @return self
     */
    public function addValue(IosiPadOSWebClipCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
