...
/**
 * Collection response for RubricLevel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RubricLevelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RubricLevel[]
     */
     ...
     * 
     * @param RubricLevel[] $items
     * @return self
     */
    public function setValue(array|RubricLevel $items, RubricLevel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param RubricLevel $item
     * @return self
     */
    public function addValue(RubricLevel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RubricLevel>
     */
