...
/**
 * Collection response for SecurityHostPortComponent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHostPortComponentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return SecurityHostPortComponent[]
     */
     ...
     * 
     * @param SecurityHostPortComponent[] $items
     * @return self
     */
    public function setValue(array|SecurityHostPortComponent $items, SecurityHostPortComponent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHostPortComponent> $value
     * @return self
     ...
     * 
     * @param SecurityHostPortComponent $item
     * @return self
     */
    public function addValue(SecurityHostPortComponent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityHostPortComponent|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityHostPortComponent>
     */
