...
/**
 * Collection response for IosVppEBookAssignmentCollectionResponse
 */
class IosVppEBookAssignmentCollectionResponseCollectionResponse
{
    /**
     * @var IosVppEBookAssignmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IosVppEBookAssignmentCollectionResponse ...$items Variable number of IosVppEBookAssignmentCollectionResponse items
     * @return self
     */
    public function setValue(IosVppEBookAssignmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IosVppEBookAssignmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IosVppEBookAssignmentCollectionResponse $item
     * @return self
     */
    public function addValue(IosVppEBookAssignmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
