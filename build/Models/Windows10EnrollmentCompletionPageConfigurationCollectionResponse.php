...
/**
 * Collection response for Windows10EnrollmentCompletionPageConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Windows10EnrollmentCompletionPageConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Windows10EnrollmentCompletionPageConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param Windows10EnrollmentCompletionPageConfiguration[] $items
     * @return self
     */
    public function setValue(array|Windows10EnrollmentCompletionPageConfiguration $items, Windows10EnrollmentCompletionPageConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Windows10EnrollmentCompletionPageConfiguration> $value
     * @return self
     ...
     * 
     * @param Windows10EnrollmentCompletionPageConfiguration $item
     * @return self
     */
    public function addValue(Windows10EnrollmentCompletionPageConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return Windows10EnrollmentCompletionPageConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, Windows10EnrollmentCompletionPageConfiguration>
     */
