 ...
 */
class ODataErrorsInnerErrorCollectionResponse
{
    /**
     ...
     * 
     * @param ODataErrorsInnerError ...$items Variable number of ODataErrorsInnerError items
     * @return self
     */
    public function setValue(ODataErrorsInnerError ...$items): self
    {
        $this->value = $items;
        return $this;
    }
