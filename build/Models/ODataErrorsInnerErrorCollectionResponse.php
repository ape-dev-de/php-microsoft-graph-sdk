...
/**
 * Collection response for ODataErrorsInnerError
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ODataErrorsInnerErrorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ODataErrorsInnerError[]
     */
    private array $value = [];
     ...
     * 
     * @param ODataErrorsInnerError[] $items
     * @return self
     */
    public function setValue(array|ODataErrorsInnerError $items, ODataErrorsInnerError ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ODataErrorsInnerError> $value
     * @return self
     ...
     * 
     * @param ODataErrorsInnerError $item
     * @return self
     */
    public function addValue(ODataErrorsInnerError $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ODataErrorsInnerError|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ODataErrorsInnerError>
     */
