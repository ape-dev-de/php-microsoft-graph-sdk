...
/**
 * Collection response for UnifiedRoleEligibilityScheduleRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRoleEligibilityScheduleRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UnifiedRoleEligibilityScheduleRequest[] $items
     * @return self
     */
    public function setValue(array|UnifiedRoleEligibilityScheduleRequest $items, UnifiedRoleEligibilityScheduleRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRoleEligibilityScheduleRequest> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleEligibilityScheduleRequest $item
     * @return self
     */
    public function addValue(UnifiedRoleEligibilityScheduleRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRoleEligibilityScheduleRequest>
     */
