...
/**
 * Collection response for EligibilityFilteringEnabledEntities
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EligibilityFilteringEnabledEntitiesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EligibilityFilteringEnabledEntities[]
     */
    private array $value = [];
     ...
     * 
     * @return EligibilityFilteringEnabledEntities[]
     */
     ...
     * 
     * @param EligibilityFilteringEnabledEntities[] $items
     * @return self
     */
    public function setValue(array|EligibilityFilteringEnabledEntities $items, EligibilityFilteringEnabledEntities ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EligibilityFilteringEnabledEntities> $value
     * @return self
     ...
     * 
     * @param EligibilityFilteringEnabledEntities $item
     * @return self
     */
    public function addValue(EligibilityFilteringEnabledEntities $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EligibilityFilteringEnabledEntities>
     */
