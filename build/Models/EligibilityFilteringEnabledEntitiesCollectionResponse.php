...
/**
 * EligibilityFilteringEnabledEntitiesCollectionResponse - Collection response
 */
class EligibilityFilteringEnabledEntitiesCollectionResponse
{
    /**
     * @var array<int, EligibilityFilteringEnabledEntities>
     */
    public array $value = [];
