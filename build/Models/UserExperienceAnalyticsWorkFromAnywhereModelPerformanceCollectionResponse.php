...
/**
 * Collection response for UserExperienceAnalyticsWorkFromAnywhereModelPerformance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsWorkFromAnywhereModelPerformanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsWorkFromAnywhereModelPerformance[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsWorkFromAnywhereModelPerformance $items, UserExperienceAnalyticsWorkFromAnywhereModelPerformance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsWorkFromAnywhereModelPerformance> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsWorkFromAnywhereModelPerformance $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsWorkFromAnywhereModelPerformance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsWorkFromAnywhereModelPerformance>
     */
