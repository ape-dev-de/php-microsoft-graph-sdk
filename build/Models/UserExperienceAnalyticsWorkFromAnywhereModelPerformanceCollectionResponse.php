...
/**
 * UserExperienceAnalyticsWorkFromAnywhereModelPerformanceCollectionResponse - Collection response
 */
class UserExperienceAnalyticsWorkFromAnywhereModelPerformanceCollectionResponse
{
    /**
     * @var array<int, UserExperienceAnalyticsWorkFromAnywhereModelPerformance>
     */
    public array $value = [];
