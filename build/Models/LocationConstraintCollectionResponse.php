 ...
 */
class LocationConstraintCollectionResponse
{
    /**
     ...
     * 
     * @param LocationConstraint ...$items Variable number of LocationConstraint items
     * @return self
     */
    public function setValue(LocationConstraint ...$items): self
    {
        $this->value = $items;
        return $this;
    }
