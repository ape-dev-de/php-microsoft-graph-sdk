...
/**
 * Collection response for LocationConstraint
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LocationConstraintCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param LocationConstraint[] $items
     * @return self
     */
    public function setValue(array|LocationConstraint $items, LocationConstraint ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LocationConstraint> $value
     * @return self
     ...
     * 
     * @param LocationConstraint $item
     * @return self
     */
    public function addValue(LocationConstraint $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LocationConstraint>
     */
