...
/**
 * Collection response for ManagedAppRegistrationCollectionResponse
 */
class ManagedAppRegistrationCollectionResponseCollectionResponse
{
    /**
     * @var ManagedAppRegistrationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedAppRegistrationCollectionResponse ...$items Variable number of ManagedAppRegistrationCollectionResponse items
     * @return self
     */
    public function setValue(ManagedAppRegistrationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ManagedAppRegistrationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ManagedAppRegistrationCollectionResponse $item
     * @return self
     */
    public function addValue(ManagedAppRegistrationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
