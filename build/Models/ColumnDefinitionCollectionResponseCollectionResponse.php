...
/**
 * Collection response for ColumnDefinitionCollectionResponse
 */
class ColumnDefinitionCollectionResponseCollectionResponse
{
    /**
     * @var ColumnDefinitionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ColumnDefinitionCollectionResponse ...$items Variable number of ColumnDefinitionCollectionResponse items
     * @return self
     */
    public function setValue(ColumnDefinitionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ColumnDefinitionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ColumnDefinitionCollectionResponse $item
     * @return self
     */
    public function addValue(ColumnDefinitionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
