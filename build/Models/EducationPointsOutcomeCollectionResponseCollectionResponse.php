...
/**
 * Collection response for EducationPointsOutcomeCollectionResponse
 */
class EducationPointsOutcomeCollectionResponseCollectionResponse
{
    /**
     * @var EducationPointsOutcomeCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationPointsOutcomeCollectionResponse ...$items Variable number of EducationPointsOutcomeCollectionResponse items
     * @return self
     */
    public function setValue(EducationPointsOutcomeCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EducationPointsOutcomeCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EducationPointsOutcomeCollectionResponse $item
     * @return self
     */
    public function addValue(EducationPointsOutcomeCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
