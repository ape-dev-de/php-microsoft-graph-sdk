...
/**
 * Collection response for PrintMargin
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintMarginCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrintMargin[]
     */
     ...
     * 
     * @param PrintMargin[] $items
     * @return self
     */
    public function setValue(array|PrintMargin $items, PrintMargin ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param PrintMargin $item
     * @return self
     */
    public function addValue(PrintMargin $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintMargin>
     */
