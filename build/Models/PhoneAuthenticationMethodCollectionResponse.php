...
/**
 * Collection response for PhoneAuthenticationMethod
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PhoneAuthenticationMethodCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PhoneAuthenticationMethod[] $items
     * @return self
     */
    public function setValue(array|PhoneAuthenticationMethod $items, PhoneAuthenticationMethod ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PhoneAuthenticationMethod> $value
     * @return self
     ...
     * 
     * @param PhoneAuthenticationMethod $item
     * @return self
     */
    public function addValue(PhoneAuthenticationMethod $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PhoneAuthenticationMethod>
     */
