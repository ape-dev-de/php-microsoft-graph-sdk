...
/**
 * Collection response for DlpActionInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DlpActionInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DlpActionInfo[]
     */
     ...
     * 
     * @param DlpActionInfo[] $items
     * @return self
     */
    public function setValue(array|DlpActionInfo $items, DlpActionInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DlpActionInfo> $value
     * @return self
     ...
     * 
     * @param DlpActionInfo $item
     * @return self
     */
    public function addValue(DlpActionInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DlpActionInfo>
     */
