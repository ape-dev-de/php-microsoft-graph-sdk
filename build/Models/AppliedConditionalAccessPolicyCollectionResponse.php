...
/**
 * Collection response for AppliedConditionalAccessPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppliedConditionalAccessPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AppliedConditionalAccessPolicy[] $items
     * @return self
     */
    public function setValue(array|AppliedConditionalAccessPolicy $items, AppliedConditionalAccessPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppliedConditionalAccessPolicy> $value
     * @return self
     ...
     * 
     * @param AppliedConditionalAccessPolicy $item
     * @return self
     */
    public function addValue(AppliedConditionalAccessPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AppliedConditionalAccessPolicy|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AppliedConditionalAccessPolicy>
     */
