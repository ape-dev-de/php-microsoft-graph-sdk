...
/**
 * Collection response for SecureScore
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecureScoreCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecureScore[]
     */
     ...
     * 
     * @param SecureScore[] $items
     * @return self
     */
    public function setValue(array|SecureScore $items, SecureScore ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param SecureScore $item
     * @return self
     */
    public function addValue(SecureScore $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecureScore>
     */
