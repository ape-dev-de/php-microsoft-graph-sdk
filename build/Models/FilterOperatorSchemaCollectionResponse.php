...
/**
 * Collection response for FilterOperatorSchema
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FilterOperatorSchemaCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param FilterOperatorSchema[] $items
     * @return self
     */
    public function setValue(array|FilterOperatorSchema $items, FilterOperatorSchema ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FilterOperatorSchema> $value
     * @return self
     ...
     * 
     * @param FilterOperatorSchema $item
     * @return self
     */
    public function addValue(FilterOperatorSchema $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FilterOperatorSchema>
     */
