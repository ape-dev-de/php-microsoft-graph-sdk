...
/**
 * Collection response for ManagedAppRegistration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedAppRegistrationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ManagedAppRegistration[] $items
     * @return self
     */
    public function setValue(array|ManagedAppRegistration $items, ManagedAppRegistration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedAppRegistration> $value
     * @return self
     ...
     * 
     * @param ManagedAppRegistration $item
     * @return self
     */
    public function addValue(ManagedAppRegistration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedAppRegistration>
     */
