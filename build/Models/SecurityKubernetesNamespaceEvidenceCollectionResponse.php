...
/**
 * Collection response for SecurityKubernetesNamespaceEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityKubernetesNamespaceEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityKubernetesNamespaceEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityKubernetesNamespaceEvidence[]
     */
     ...
     * 
     * @param SecurityKubernetesNamespaceEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityKubernetesNamespaceEvidence $items, SecurityKubernetesNamespaceEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityKubernetesNamespaceEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityKubernetesNamespaceEvidence $item
     * @return self
     */
    public function addValue(SecurityKubernetesNamespaceEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityKubernetesNamespaceEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityKubernetesNamespaceEvidence>
     */
