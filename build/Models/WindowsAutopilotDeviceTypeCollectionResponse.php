...
/**
 * WindowsAutopilotDeviceTypeCollectionResponse - Collection response
 */
class WindowsAutopilotDeviceTypeCollectionResponse
{
    /**
     * @var array<int, WindowsAutopilotDeviceType>
     */
    public array $value = [];
