...
/**
 * Collection response for WindowsAutopilotDeviceType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsAutopilotDeviceTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsAutopilotDeviceType[]
     */
    private array $value = [];
     ...
     * 
     * @return WindowsAutopilotDeviceType[]
     */
     ...
     * 
     * @param WindowsAutopilotDeviceType[] $items
     * @return self
     */
    public function setValue(array|WindowsAutopilotDeviceType $items, WindowsAutopilotDeviceType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsAutopilotDeviceType> $value
     * @return self
     ...
     * 
     * @param WindowsAutopilotDeviceType $item
     * @return self
     */
    public function addValue(WindowsAutopilotDeviceType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsAutopilotDeviceType>
     */
