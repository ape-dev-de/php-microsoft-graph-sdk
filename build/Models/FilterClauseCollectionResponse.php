...
/**
 * Collection response for FilterClause
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FilterClauseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FilterClause[]
     */
     ...
     * 
     * @param FilterClause[] $items
     * @return self
     */
    public function setValue(array|FilterClause $items, FilterClause ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FilterClause> $value
     * @return self
     ...
     * 
     * @param FilterClause $item
     * @return self
     */
    public function addValue(FilterClause $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FilterClause>
     */
