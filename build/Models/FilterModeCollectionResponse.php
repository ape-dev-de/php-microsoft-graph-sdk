...
/**
 * Collection response for FilterMode
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FilterModeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FilterMode[]
     */
     ...
     * 
     * @param FilterMode[] $items
     * @return self
     */
    public function setValue(array|FilterMode $items, FilterMode ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param FilterMode $item
     * @return self
     */
    public function addValue(FilterMode $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FilterMode>
     */
