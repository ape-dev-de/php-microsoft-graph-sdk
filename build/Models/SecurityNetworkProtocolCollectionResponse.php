...
/**
 * Collection response for SecurityNetworkProtocol
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityNetworkProtocolCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityNetworkProtocol[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityNetworkProtocol[]
     */
     ...
     * 
     * @param SecurityNetworkProtocol[] $items
     * @return self
     */
    public function setValue(array|SecurityNetworkProtocol $items, SecurityNetworkProtocol ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityNetworkProtocol> $value
     * @return self
     ...
     * 
     * @param SecurityNetworkProtocol $item
     * @return self
     */
    public function addValue(SecurityNetworkProtocol $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityNetworkProtocol>
     */
