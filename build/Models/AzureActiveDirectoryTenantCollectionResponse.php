 ...
 */
class AzureActiveDirectoryTenantCollectionResponse
{
    /**
     ...
     * 
     * @param AzureActiveDirectoryTenant ...$items Variable number of AzureActiveDirectoryTenant items
     * @return self
     */
    public function setValue(AzureActiveDirectoryTenant ...$items): self
    {
        $this->value = $items;
        return $this;
    }
