...
/**
 * Collection response for AzureActiveDirectoryTenant
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AzureActiveDirectoryTenantCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AzureActiveDirectoryTenant[]
     */
    private array $value = [];
     ...
     * 
     * @param AzureActiveDirectoryTenant[] $items
     * @return self
     */
    public function setValue(array|AzureActiveDirectoryTenant $items, AzureActiveDirectoryTenant ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AzureActiveDirectoryTenant> $value
     * @return self
     ...
     * 
     * @param AzureActiveDirectoryTenant $item
     * @return self
     */
    public function addValue(AzureActiveDirectoryTenant $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AzureActiveDirectoryTenant|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AzureActiveDirectoryTenant>
     */
