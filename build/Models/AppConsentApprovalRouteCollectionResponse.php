...
/**
 * Collection response for AppConsentApprovalRoute
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppConsentApprovalRouteCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AppConsentApprovalRoute[]
     */
    private array $value = [];
     ...
     * 
     * @param AppConsentApprovalRoute[] $items
     * @return self
     */
    public function setValue(array|AppConsentApprovalRoute $items, AppConsentApprovalRoute ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppConsentApprovalRoute> $value
     * @return self
     ...
     * 
     * @param AppConsentApprovalRoute $item
     * @return self
     */
    public function addValue(AppConsentApprovalRoute $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AppConsentApprovalRoute>
     */
