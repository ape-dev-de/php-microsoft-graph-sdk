 ...
 */
class AppConsentApprovalRouteCollectionResponse
{
    /**
     ...
     * 
     * @param AppConsentApprovalRoute ...$items Variable number of AppConsentApprovalRoute items
     * @return self
     */
    public function setValue(AppConsentApprovalRoute ...$items): self
    {
        $this->value = $items;
        return $this;
    }
