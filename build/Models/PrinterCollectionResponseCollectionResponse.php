...
/**
 * Collection response for PrinterCollectionResponse
 */
class PrinterCollectionResponseCollectionResponse
{
    /**
     * @var PrinterCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PrinterCollectionResponse ...$items Variable number of PrinterCollectionResponse items
     * @return self
     */
    public function setValue(PrinterCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PrinterCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PrinterCollectionResponse $item
     * @return self
     */
    public function addValue(PrinterCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
