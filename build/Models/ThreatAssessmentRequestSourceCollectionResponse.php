...
/**
 * Collection response for ThreatAssessmentRequestSource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ThreatAssessmentRequestSourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return ThreatAssessmentRequestSource[]
     */
     ...
     * 
     * @param ThreatAssessmentRequestSource[] $items
     * @return self
     */
    public function setValue(array|ThreatAssessmentRequestSource $items, ThreatAssessmentRequestSource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ThreatAssessmentRequestSource> $value
     * @return self
     ...
     * 
     * @param ThreatAssessmentRequestSource $item
     * @return self
     */
    public function addValue(ThreatAssessmentRequestSource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ThreatAssessmentRequestSource>
     */
