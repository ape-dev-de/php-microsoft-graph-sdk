...
/**
 * ThreatAssessmentRequestSourceCollectionResponse - Collection response
 */
class ThreatAssessmentRequestSourceCollectionResponse
{
    /**
     * @var array<int, ThreatAssessmentRequestSource>
     */
    public array $value = [];
