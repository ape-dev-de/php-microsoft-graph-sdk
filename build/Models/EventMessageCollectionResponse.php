...
/**
 * Collection response for EventMessage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EventMessageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EventMessage[]
     */
     ...
     * 
     * @param EventMessage[] $items
     * @return self
     */
    public function setValue(array|EventMessage $items, EventMessage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EventMessage> $value
     * @return self
     ...
     * 
     * @param EventMessage $item
     * @return self
     */
    public function addValue(EventMessage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EventMessage>
     */
