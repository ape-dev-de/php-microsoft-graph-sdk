...
/**
 * Collection response for Json
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class JsonCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Json[]
     */
     ...
     * @return self
     */
    public function setValue(array|Json $items, Json ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Json $item): self
    {
        $this->value[] = $item;
        return $this;
    }
