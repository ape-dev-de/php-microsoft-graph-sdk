...
/**
 * Collection response for ItemPreviewInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ItemPreviewInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ItemPreviewInfo[]
     */
     ...
     * 
     * @param ItemPreviewInfo[] $items
     * @return self
     */
    public function setValue(array|ItemPreviewInfo $items, ItemPreviewInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ItemPreviewInfo> $value
     * @return self
     ...
     * 
     * @param ItemPreviewInfo $item
     * @return self
     */
    public function addValue(ItemPreviewInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ItemPreviewInfo>
     */
