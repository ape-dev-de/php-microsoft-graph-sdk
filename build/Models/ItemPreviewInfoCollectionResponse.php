 ...
 */
class ItemPreviewInfoCollectionResponse
{
    /**
     * @var ItemPreviewInfo[]
     */
     ...
     * 
     * @param ItemPreviewInfo ...$items Variable number of ItemPreviewInfo items
     * @return self
     */
    public function setValue(ItemPreviewInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
