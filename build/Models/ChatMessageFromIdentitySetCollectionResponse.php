...
/**
 * Collection response for ChatMessageFromIdentitySet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatMessageFromIdentitySetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChatMessageFromIdentitySet[]
     */
    private array $value = [];
     ...
     * 
     * @param ChatMessageFromIdentitySet[] $items
     * @return self
     */
    public function setValue(array|ChatMessageFromIdentitySet $items, ChatMessageFromIdentitySet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChatMessageFromIdentitySet> $value
     * @return self
     ...
     * 
     * @param ChatMessageFromIdentitySet $item
     * @return self
     */
    public function addValue(ChatMessageFromIdentitySet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChatMessageFromIdentitySet>
     */
