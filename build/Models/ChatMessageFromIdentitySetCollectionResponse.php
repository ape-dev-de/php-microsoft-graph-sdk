...
/**
 * ChatMessageFromIdentitySetCollectionResponse - Collection response
 */
class ChatMessageFromIdentitySetCollectionResponse
{
    /**
     * @var array<int, ChatMessageFromIdentitySet>
     */
    public array $value = [];
