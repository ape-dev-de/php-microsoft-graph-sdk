...
/**
 * Collection response for UnifiedRoleManagementPolicyRuleCollectionResponse
 */
class UnifiedRoleManagementPolicyRuleCollectionResponseCollectionResponse
{
    /**
     * @var UnifiedRoleManagementPolicyRuleCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedRoleManagementPolicyRuleCollectionResponse ...$items Variable number of UnifiedRoleManagementPolicyRuleCollectionResponse items
     * @return self
     */
    public function setValue(UnifiedRoleManagementPolicyRuleCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UnifiedRoleManagementPolicyRuleCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleManagementPolicyRuleCollectionResponse $item
     * @return self
     */
    public function addValue(UnifiedRoleManagementPolicyRuleCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
