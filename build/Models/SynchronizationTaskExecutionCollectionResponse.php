 ...
 */
class SynchronizationTaskExecutionCollectionResponse
{
    /**
     ...
     * 
     * @param SynchronizationTaskExecution ...$items Variable number of SynchronizationTaskExecution items
     * @return self
     */
    public function setValue(SynchronizationTaskExecution ...$items): self
    {
        $this->value = $items;
        return $this;
    }
