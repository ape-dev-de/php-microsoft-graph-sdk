...
/**
 * Collection response for SynchronizationTaskExecution
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationTaskExecutionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SynchronizationTaskExecution[]
     */
    private array $value = [];
     ...
     * 
     * @param SynchronizationTaskExecution[] $items
     * @return self
     */
    public function setValue(array|SynchronizationTaskExecution $items, SynchronizationTaskExecution ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SynchronizationTaskExecution> $value
     * @return self
     ...
     * 
     * @param SynchronizationTaskExecution $item
     * @return self
     */
    public function addValue(SynchronizationTaskExecution $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SynchronizationTaskExecution>
     */
