...
/**
 * Collection response for FileSecurityStateCollectionResponse
 */
class FileSecurityStateCollectionResponseCollectionResponse
{
    /**
     * @var FileSecurityStateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param FileSecurityStateCollectionResponse ...$items Variable number of FileSecurityStateCollectionResponse items
     * @return self
     */
    public function setValue(FileSecurityStateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<FileSecurityStateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param FileSecurityStateCollectionResponse $item
     * @return self
     */
    public function addValue(FileSecurityStateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
