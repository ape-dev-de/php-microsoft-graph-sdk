...
/**
 * Collection response for CallRoute
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRouteCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRoute[]
     */
     ...
     * 
     * @param CallRoute[] $items
     * @return self
     */
    public function setValue(array|CallRoute $items, CallRoute ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param CallRoute $item
     * @return self
     */
    public function addValue(CallRoute $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CallRoute>
     */
