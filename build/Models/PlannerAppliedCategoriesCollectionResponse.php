...
/**
 * Collection response for PlannerAppliedCategories
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerAppliedCategoriesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PlannerAppliedCategories[] $items
     * @return self
     */
    public function setValue(array|PlannerAppliedCategories $items, PlannerAppliedCategories ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PlannerAppliedCategories> $value
     * @return self
     ...
     * 
     * @param PlannerAppliedCategories $item
     * @return self
     */
    public function addValue(PlannerAppliedCategories $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PlannerAppliedCategories>
     */
