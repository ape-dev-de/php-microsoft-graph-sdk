...
/**
 * Collection response for ModifiedPropertyCollectionResponse
 */
class ModifiedPropertyCollectionResponseCollectionResponse
{
    /**
     * @var ModifiedPropertyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ModifiedPropertyCollectionResponse ...$items Variable number of ModifiedPropertyCollectionResponse items
     * @return self
     */
    public function setValue(ModifiedPropertyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ModifiedPropertyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ModifiedPropertyCollectionResponse $item
     * @return self
     */
    public function addValue(ModifiedPropertyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
