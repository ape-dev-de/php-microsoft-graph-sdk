...
/**
 * ExternalConnectorsPropertyCollectionResponse - Collection response
 */
class ExternalConnectorsPropertyCollectionResponse
{
    /**
     * @var array<int, ExternalConnectorsProperty>
     */
    public array $value = [];
