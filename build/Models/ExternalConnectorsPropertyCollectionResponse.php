...
/**
 * Collection response for ExternalConnectorsProperty
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsPropertyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return ExternalConnectorsProperty[]
     */
     ...
     * 
     * @param ExternalConnectorsProperty[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsProperty $items, ExternalConnectorsProperty ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsProperty> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsProperty $item
     * @return self
     */
    public function addValue(ExternalConnectorsProperty $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalConnectorsProperty|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsProperty>
     */
