...
/**
 * Collection response for ChatMessagePolicyViolation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatMessagePolicyViolationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ChatMessagePolicyViolation[] $items
     * @return self
     */
    public function setValue(array|ChatMessagePolicyViolation $items, ChatMessagePolicyViolation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChatMessagePolicyViolation> $value
     * @return self
     ...
     * 
     * @param ChatMessagePolicyViolation $item
     * @return self
     */
    public function addValue(ChatMessagePolicyViolation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChatMessagePolicyViolation>
     */
