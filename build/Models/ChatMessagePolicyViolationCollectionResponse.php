 ...
 */
class ChatMessagePolicyViolationCollectionResponse
{
    /**
     ...
     * 
     * @param ChatMessagePolicyViolation ...$items Variable number of ChatMessagePolicyViolation items
     * @return self
     */
    public function setValue(ChatMessagePolicyViolation ...$items): self
    {
        $this->value = $items;
        return $this;
    }
