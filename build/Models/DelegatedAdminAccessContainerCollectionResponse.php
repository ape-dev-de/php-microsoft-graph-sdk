 ...
 */
class DelegatedAdminAccessContainerCollectionResponse
{
    /**
     ...
     * 
     * @param DelegatedAdminAccessContainer ...$items Variable number of DelegatedAdminAccessContainer items
     * @return self
     */
    public function setValue(DelegatedAdminAccessContainer ...$items): self
    {
        $this->value = $items;
        return $this;
    }
