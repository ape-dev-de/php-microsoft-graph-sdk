...
/**
 * Collection response for DelegatedAdminAccessContainer
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DelegatedAdminAccessContainerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DelegatedAdminAccessContainer[]
     */
    private array $value = [];
     ...
     * 
     * @param DelegatedAdminAccessContainer[] $items
     * @return self
     */
    public function setValue(array|DelegatedAdminAccessContainer $items, DelegatedAdminAccessContainer ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DelegatedAdminAccessContainer> $value
     * @return self
     ...
     * 
     * @param DelegatedAdminAccessContainer $item
     * @return self
     */
    public function addValue(DelegatedAdminAccessContainer $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DelegatedAdminAccessContainer>
     */
