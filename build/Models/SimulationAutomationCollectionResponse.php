...
/**
 * Collection response for SimulationAutomation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SimulationAutomationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SimulationAutomation[] $items
     * @return self
     */
    public function setValue(array|SimulationAutomation $items, SimulationAutomation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SimulationAutomation> $value
     * @return self
     ...
     * 
     * @param SimulationAutomation $item
     * @return self
     */
    public function addValue(SimulationAutomation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SimulationAutomation>
     */
