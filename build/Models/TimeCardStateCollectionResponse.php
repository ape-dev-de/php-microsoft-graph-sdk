...
/**
 * Collection response for TimeCardState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TimeCardStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TimeCardState[]
     */
     ...
     * 
     * @param TimeCardState[] $items
     * @return self
     */
    public function setValue(array|TimeCardState $items, TimeCardState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TimeCardState> $value
     * @return self
     ...
     * 
     * @param TimeCardState $item
     * @return self
     */
    public function addValue(TimeCardState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TimeCardState>
     */
