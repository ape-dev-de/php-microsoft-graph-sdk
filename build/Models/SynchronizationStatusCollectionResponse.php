...
/**
 * Collection response for SynchronizationStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SynchronizationStatus[] $items
     * @return self
     */
    public function setValue(array|SynchronizationStatus $items, SynchronizationStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SynchronizationStatus> $value
     * @return self
     ...
     * 
     * @param SynchronizationStatus $item
     * @return self
     */
    public function addValue(SynchronizationStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SynchronizationStatus>
     */
