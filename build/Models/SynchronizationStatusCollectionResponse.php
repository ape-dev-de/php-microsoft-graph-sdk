 ...
 */
class SynchronizationStatusCollectionResponse
{
    /**
     ...
     * 
     * @param SynchronizationStatus ...$items Variable number of SynchronizationStatus items
     * @return self
     */
    public function setValue(SynchronizationStatus ...$items): self
    {
        $this->value = $items;
        return $this;
    }
