...
/**
 * AssignmentScheduleRequestFilterByCurrentUserOptionsCollectionResponse - Collection response
 */
class AssignmentScheduleRequestFilterByCurrentUserOptionsCollectionResponse
{
    /**
     * @var array<int, AssignmentScheduleRequestFilterByCurrentUserOptions>
     */
    public array $value = [];
