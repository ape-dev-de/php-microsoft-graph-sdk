...
/**
 * Collection response for AssignmentScheduleRequestFilterByCurrentUserOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AssignmentScheduleRequestFilterByCurrentUserOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AssignmentScheduleRequestFilterByCurrentUserOptions[]
     */
    private array $value = [];
     ...
     * 
     * @return AssignmentScheduleRequestFilterByCurrentUserOptions[]
     */
     ...
     * 
     * @param AssignmentScheduleRequestFilterByCurrentUserOptions[] $items
     * @return self
     */
    public function setValue(array|AssignmentScheduleRequestFilterByCurrentUserOptions $items, AssignmentScheduleRequestFilterByCurrentUserOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AssignmentScheduleRequestFilterByCurrentUserOptions> $value
     * @return self
     ...
     * 
     * @param AssignmentScheduleRequestFilterByCurrentUserOptions $item
     * @return self
     */
    public function addValue(AssignmentScheduleRequestFilterByCurrentUserOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AssignmentScheduleRequestFilterByCurrentUserOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AssignmentScheduleRequestFilterByCurrentUserOptions>
     */
