...
/**
 * Collection response for CallRecordsOrganizer
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsOrganizerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsOrganizer[]
     */
    private array $value = [];
     ...
     * 
     * @param CallRecordsOrganizer[] $items
     * @return self
     */
    public function setValue(array|CallRecordsOrganizer $items, CallRecordsOrganizer ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsOrganizer> $value
     * @return self
     ...
     * 
     * @param CallRecordsOrganizer $item
     * @return self
     */
    public function addValue(CallRecordsOrganizer $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsOrganizer|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsOrganizer>
     */
