...
/**
 * Collection response for PayloadTheme
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PayloadThemeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PayloadTheme[]
     */
     ...
     * 
     * @param PayloadTheme[] $items
     * @return self
     */
    public function setValue(array|PayloadTheme $items, PayloadTheme ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PayloadTheme> $value
     * @return self
     ...
     * 
     * @param PayloadTheme $item
     * @return self
     */
    public function addValue(PayloadTheme $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PayloadTheme>
     */
