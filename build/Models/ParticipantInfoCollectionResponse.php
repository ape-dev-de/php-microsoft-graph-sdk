 ...
 */
class ParticipantInfoCollectionResponse
{
    /**
     * @var ParticipantInfo[]
     */
     ...
     * 
     * @param ParticipantInfo ...$items Variable number of ParticipantInfo items
     * @return self
     */
    public function setValue(ParticipantInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
