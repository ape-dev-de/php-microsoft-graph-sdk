...
/**
 * Collection response for ParticipantInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ParticipantInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ParticipantInfo[]
     */
     ...
     * 
     * @param ParticipantInfo[] $items
     * @return self
     */
    public function setValue(array|ParticipantInfo $items, ParticipantInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ParticipantInfo> $value
     * @return self
     ...
     * 
     * @param ParticipantInfo $item
     * @return self
     */
    public function addValue(ParticipantInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ParticipantInfo>
     */
