 ...
 */
class AssignmentOrderCollectionResponse
{
    /**
     * @var AssignmentOrder[]
     */
     ...
     * 
     * @param AssignmentOrder ...$items Variable number of AssignmentOrder items
     * @return self
     */
    public function setValue(AssignmentOrder ...$items): self
    {
        $this->value = $items;
        return $this;
    }
