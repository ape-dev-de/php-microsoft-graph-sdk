...
/**
 * Collection response for AssignmentOrder
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AssignmentOrderCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AssignmentOrder[]
     */
     ...
     * 
     * @param AssignmentOrder[] $items
     * @return self
     */
    public function setValue(array|AssignmentOrder $items, AssignmentOrder ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AssignmentOrder> $value
     * @return self
     ...
     * 
     * @param AssignmentOrder $item
     * @return self
     */
    public function addValue(AssignmentOrder $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AssignmentOrder>
     */
