...
/**
 * Collection response for AccessPackageUserDirectoryAttributeStore
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageUserDirectoryAttributeStoreCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageUserDirectoryAttributeStore[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageUserDirectoryAttributeStore[] $items
     * @return self
     */
    public function setValue(array|AccessPackageUserDirectoryAttributeStore $items, AccessPackageUserDirectoryAttributeStore ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageUserDirectoryAttributeStore> $value
     * @return self
     ...
     * 
     * @param AccessPackageUserDirectoryAttributeStore $item
     * @return self
     */
    public function addValue(AccessPackageUserDirectoryAttributeStore $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessPackageUserDirectoryAttributeStore|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageUserDirectoryAttributeStore>
     */
