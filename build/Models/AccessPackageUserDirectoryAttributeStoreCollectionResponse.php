...
/**
 * AccessPackageUserDirectoryAttributeStoreCollectionResponse - Collection response
 */
class AccessPackageUserDirectoryAttributeStoreCollectionResponse
{
    /**
     * @var array<int, AccessPackageUserDirectoryAttributeStore>
     */
    public array $value = [];
