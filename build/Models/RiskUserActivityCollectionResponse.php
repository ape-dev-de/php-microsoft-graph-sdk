 ...
 */
class RiskUserActivityCollectionResponse
{
    /**
     ...
     * 
     * @param RiskUserActivity ...$items Variable number of RiskUserActivity items
     * @return self
     */
    public function setValue(RiskUserActivity ...$items): self
    {
        $this->value = $items;
        return $this;
    }
