...
/**
 * Collection response for RiskUserActivity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RiskUserActivityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RiskUserActivity[]
     */
    private array $value = [];
     ...
     * 
     * @param RiskUserActivity[] $items
     * @return self
     */
    public function setValue(array|RiskUserActivity $items, RiskUserActivity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RiskUserActivity> $value
     * @return self
     ...
     * 
     * @param RiskUserActivity $item
     * @return self
     */
    public function addValue(RiskUserActivity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RiskUserActivity>
     */
