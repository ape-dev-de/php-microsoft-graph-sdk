...
/**
 * Collection response for SimulationAttackType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SimulationAttackTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SimulationAttackType[]
     */
    private array $value = [];
     ...
     * 
     * @param SimulationAttackType[] $items
     * @return self
     */
    public function setValue(array|SimulationAttackType $items, SimulationAttackType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SimulationAttackType> $value
     * @return self
     ...
     * 
     * @param SimulationAttackType $item
     * @return self
     */
    public function addValue(SimulationAttackType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SimulationAttackType>
     */
