...
/**
 * Collection response for ServiceStorageQuotaBreakdownCollectionResponse
 */
class ServiceStorageQuotaBreakdownCollectionResponseCollectionResponse
{
    /**
     * @var ServiceStorageQuotaBreakdownCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ServiceStorageQuotaBreakdownCollectionResponse ...$items Variable number of ServiceStorageQuotaBreakdownCollectionResponse items
     * @return self
     */
    public function setValue(ServiceStorageQuotaBreakdownCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ServiceStorageQuotaBreakdownCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ServiceStorageQuotaBreakdownCollectionResponse $item
     * @return self
     */
    public function addValue(ServiceStorageQuotaBreakdownCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
