...
/**
 * Collection response for EventMessageResponseCollectionResponse
 */
class EventMessageResponseCollectionResponseCollectionResponse
{
    /**
     * @var EventMessageResponseCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EventMessageResponseCollectionResponse ...$items Variable number of EventMessageResponseCollectionResponse items
     * @return self
     */
    public function setValue(EventMessageResponseCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EventMessageResponseCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EventMessageResponseCollectionResponse $item
     * @return self
     */
    public function addValue(EventMessageResponseCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
