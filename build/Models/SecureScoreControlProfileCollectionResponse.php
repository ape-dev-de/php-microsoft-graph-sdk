...
/**
 * Collection response for SecureScoreControlProfile
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecureScoreControlProfileCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecureScoreControlProfile[] $items
     * @return self
     */
    public function setValue(array|SecureScoreControlProfile $items, SecureScoreControlProfile ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecureScoreControlProfile> $value
     * @return self
     ...
     * 
     * @param SecureScoreControlProfile $item
     * @return self
     */
    public function addValue(SecureScoreControlProfile $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecureScoreControlProfile>
     */
