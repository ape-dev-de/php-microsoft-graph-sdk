...
/**
 * CustomAppManagementConfigurationCollectionResponse - Collection response
 */
class CustomAppManagementConfigurationCollectionResponse
{
    /**
     * @var array<int, CustomAppManagementConfiguration>
     */
    public array $value = [];
