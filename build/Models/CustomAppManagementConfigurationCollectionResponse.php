...
/**
 * Collection response for CustomAppManagementConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CustomAppManagementConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CustomAppManagementConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param CustomAppManagementConfiguration[] $items
     * @return self
     */
    public function setValue(array|CustomAppManagementConfiguration $items, CustomAppManagementConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CustomAppManagementConfiguration> $value
     * @return self
     ...
     * 
     * @param CustomAppManagementConfiguration $item
     * @return self
     */
    public function addValue(CustomAppManagementConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CustomAppManagementConfiguration>
     */
