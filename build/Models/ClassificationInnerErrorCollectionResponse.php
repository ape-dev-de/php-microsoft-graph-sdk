 ...
 */
class ClassificationInnerErrorCollectionResponse
{
    /**
     ...
     * 
     * @param ClassificationInnerError ...$items Variable number of ClassificationInnerError items
     * @return self
     */
    public function setValue(ClassificationInnerError ...$items): self
    {
        $this->value = $items;
        return $this;
    }
