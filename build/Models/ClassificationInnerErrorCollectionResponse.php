...
/**
 * Collection response for ClassificationInnerError
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ClassificationInnerErrorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ClassificationInnerError[]
     */
    private array $value = [];
     ...
     * 
     * @param ClassificationInnerError[] $items
     * @return self
     */
    public function setValue(array|ClassificationInnerError $items, ClassificationInnerError ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ClassificationInnerError> $value
     * @return self
     ...
     * 
     * @param ClassificationInnerError $item
     * @return self
     */
    public function addValue(ClassificationInnerError $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ClassificationInnerError>
     */
