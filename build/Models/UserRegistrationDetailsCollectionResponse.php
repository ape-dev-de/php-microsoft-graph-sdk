...
/**
 * Collection response for UserRegistrationDetails
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserRegistrationDetailsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserRegistrationDetails[] $items
     * @return self
     */
    public function setValue(array|UserRegistrationDetails $items, UserRegistrationDetails ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserRegistrationDetails> $value
     * @return self
     ...
     * 
     * @param UserRegistrationDetails $item
     * @return self
     */
    public function addValue(UserRegistrationDetails $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserRegistrationDetails>
     */
