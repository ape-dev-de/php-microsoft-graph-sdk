...
/**
 * Collection response for StringKeyObjectValuePair
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class StringKeyObjectValuePairCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param StringKeyObjectValuePair[] $items
     * @return self
     */
    public function setValue(array|StringKeyObjectValuePair $items, StringKeyObjectValuePair ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<StringKeyObjectValuePair> $value
     * @return self
     ...
     * 
     * @param StringKeyObjectValuePair $item
     * @return self
     */
    public function addValue(StringKeyObjectValuePair $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return StringKeyObjectValuePair|null
     */
     ...
     * 
     * @return \ArrayIterator<int, StringKeyObjectValuePair>
     */
