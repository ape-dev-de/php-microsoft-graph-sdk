...
/**
 * Collection response for CloudAppSecurityStateCollectionResponse
 */
class CloudAppSecurityStateCollectionResponseCollectionResponse
{
    /**
     * @var CloudAppSecurityStateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudAppSecurityStateCollectionResponse ...$items Variable number of CloudAppSecurityStateCollectionResponse items
     * @return self
     */
    public function setValue(CloudAppSecurityStateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CloudAppSecurityStateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CloudAppSecurityStateCollectionResponse $item
     * @return self
     */
    public function addValue(CloudAppSecurityStateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
