 ...
 */
class WindowsInformationProtectionDesktopAppCollectionResponse
{
    /**
     ...
     * 
     * @param WindowsInformationProtectionDesktopApp ...$items Variable number of WindowsInformationProtectionDesktopApp items
     * @return self
     */
    public function setValue(WindowsInformationProtectionDesktopApp ...$items): self
    {
        $this->value = $items;
        return $this;
    }
