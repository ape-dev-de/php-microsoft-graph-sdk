...
/**
 * Collection response for WindowsInformationProtectionDesktopApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsInformationProtectionDesktopAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsInformationProtectionDesktopApp[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsInformationProtectionDesktopApp[] $items
     * @return self
     */
    public function setValue(array|WindowsInformationProtectionDesktopApp $items, WindowsInformationProtectionDesktopApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsInformationProtectionDesktopApp> $value
     * @return self
     ...
     * 
     * @param WindowsInformationProtectionDesktopApp $item
     * @return self
     */
    public function addValue(WindowsInformationProtectionDesktopApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WindowsInformationProtectionDesktopApp|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WindowsInformationProtectionDesktopApp>
     */
