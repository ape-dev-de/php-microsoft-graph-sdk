...
/**
 * Collection response for IosCertificateProfile
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosCertificateProfileCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IosCertificateProfile[] $items
     * @return self
     */
    public function setValue(array|IosCertificateProfile $items, IosCertificateProfile ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosCertificateProfile> $value
     * @return self
     ...
     * 
     * @param IosCertificateProfile $item
     * @return self
     */
    public function addValue(IosCertificateProfile $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IosCertificateProfile>
     */
