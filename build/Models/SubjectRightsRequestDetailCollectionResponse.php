 ...
 */
class SubjectRightsRequestDetailCollectionResponse
{
    /**
     ...
     * 
     * @param SubjectRightsRequestDetail ...$items Variable number of SubjectRightsRequestDetail items
     * @return self
     */
    public function setValue(SubjectRightsRequestDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
