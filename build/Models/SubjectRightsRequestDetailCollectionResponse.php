...
/**
 * Collection response for SubjectRightsRequestDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SubjectRightsRequestDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SubjectRightsRequestDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param SubjectRightsRequestDetail[] $items
     * @return self
     */
    public function setValue(array|SubjectRightsRequestDetail $items, SubjectRightsRequestDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SubjectRightsRequestDetail> $value
     * @return self
     ...
     * 
     * @param SubjectRightsRequestDetail $item
     * @return self
     */
    public function addValue(SubjectRightsRequestDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SubjectRightsRequestDetail>
     */
