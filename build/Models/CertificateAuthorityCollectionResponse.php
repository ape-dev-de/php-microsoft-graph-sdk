...
/**
 * Collection response for CertificateAuthority
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CertificateAuthorityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CertificateAuthority[] $items
     * @return self
     */
    public function setValue(array|CertificateAuthority $items, CertificateAuthority ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CertificateAuthority> $value
     * @return self
     ...
     * 
     * @param CertificateAuthority $item
     * @return self
     */
    public function addValue(CertificateAuthority $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CertificateAuthority|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CertificateAuthority>
     */
