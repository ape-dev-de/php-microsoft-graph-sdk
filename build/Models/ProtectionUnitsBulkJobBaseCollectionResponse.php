 ...
 */
class ProtectionUnitsBulkJobBaseCollectionResponse
{
    /**
     ...
     * 
     * @param ProtectionUnitsBulkJobBase ...$items Variable number of ProtectionUnitsBulkJobBase items
     * @return self
     */
    public function setValue(ProtectionUnitsBulkJobBase ...$items): self
    {
        $this->value = $items;
        return $this;
    }
