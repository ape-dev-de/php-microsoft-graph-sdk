...
/**
 * Collection response for ProtectionUnitsBulkJobBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProtectionUnitsBulkJobBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProtectionUnitsBulkJobBase[]
     */
    private array $value = [];
     ...
     * 
     * @param ProtectionUnitsBulkJobBase[] $items
     * @return self
     */
    public function setValue(array|ProtectionUnitsBulkJobBase $items, ProtectionUnitsBulkJobBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProtectionUnitsBulkJobBase> $value
     * @return self
     ...
     * 
     * @param ProtectionUnitsBulkJobBase $item
     * @return self
     */
    public function addValue(ProtectionUnitsBulkJobBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ProtectionUnitsBulkJobBase|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ProtectionUnitsBulkJobBase>
     */
