...
/**
 * Collection response for ThumbnailColumn
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ThumbnailColumnCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ThumbnailColumn[]
     */
     ...
     * 
     * @param ThumbnailColumn[] $items
     * @return self
     */
    public function setValue(array|ThumbnailColumn $items, ThumbnailColumn ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ThumbnailColumn> $value
     * @return self
     ...
     * 
     * @param ThumbnailColumn $item
     * @return self
     */
    public function addValue(ThumbnailColumn $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ThumbnailColumn>
     */
