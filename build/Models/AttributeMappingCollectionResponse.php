...
/**
 * Collection response for AttributeMapping
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttributeMappingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AttributeMapping[] $items
     * @return self
     */
    public function setValue(array|AttributeMapping $items, AttributeMapping ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttributeMapping> $value
     * @return self
     ...
     * 
     * @param AttributeMapping $item
     * @return self
     */
    public function addValue(AttributeMapping $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AttributeMapping>
     */
