...
/**
 * Collection response for SearchHit
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SearchHitCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SearchHit[]
     */
     ...
     * 
     * @param SearchHit[] $items
     * @return self
     */
    public function setValue(array|SearchHit $items, SearchHit ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param SearchHit $item
     * @return self
     */
    public function addValue(SearchHit $item): self
    {
        $this->value[] = $item;
        return $this;
    }
