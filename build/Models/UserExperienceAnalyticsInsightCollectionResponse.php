...
/**
 * Collection response for UserExperienceAnalyticsInsight
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsInsightCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsInsight[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsInsight $items, UserExperienceAnalyticsInsight ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsInsight> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsInsight $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsInsight $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UserExperienceAnalyticsInsight|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsInsight>
     */
