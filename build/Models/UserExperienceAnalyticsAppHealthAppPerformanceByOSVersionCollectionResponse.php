...
/**
 * UserExperienceAnalyticsAppHealthAppPerformanceByOSVersionCollectionResponse - Collection response
 */
class UserExperienceAnalyticsAppHealthAppPerformanceByOSVersionCollectionResponse
{
    /**
     * @var array<int, UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion>
     */
    public array $value = [];
