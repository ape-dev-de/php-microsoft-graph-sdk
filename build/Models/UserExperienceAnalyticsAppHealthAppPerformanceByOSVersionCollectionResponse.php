...
/**
 * Collection response for UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsAppHealthAppPerformanceByOSVersionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion $items, UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion>
     */
