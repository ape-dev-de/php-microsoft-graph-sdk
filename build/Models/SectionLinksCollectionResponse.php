...
/**
 * Collection response for SectionLinks
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SectionLinksCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SectionLinks[]
     */
     ...
     * 
     * @param SectionLinks[] $items
     * @return self
     */
    public function setValue(array|SectionLinks $items, SectionLinks ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SectionLinks> $value
     * @return self
     ...
     * 
     * @param SectionLinks $item
     * @return self
     */
    public function addValue(SectionLinks $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SectionLinks>
     */
