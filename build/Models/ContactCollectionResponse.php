...
/**
 * Collection response for Contact
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ContactCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Contact[]
     */
     ...
     * @return self
     */
    public function setValue(array|Contact $items, Contact ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Contact $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Contact>
     */
