...
/**
 * Collection response for DriveRestoreArtifactsBulkAdditionRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DriveRestoreArtifactsBulkAdditionRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DriveRestoreArtifactsBulkAdditionRequest[] $items
     * @return self
     */
    public function setValue(array|DriveRestoreArtifactsBulkAdditionRequest $items, DriveRestoreArtifactsBulkAdditionRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DriveRestoreArtifactsBulkAdditionRequest> $value
     * @return self
     ...
     * 
     * @param DriveRestoreArtifactsBulkAdditionRequest $item
     * @return self
     */
    public function addValue(DriveRestoreArtifactsBulkAdditionRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DriveRestoreArtifactsBulkAdditionRequest>
     */
