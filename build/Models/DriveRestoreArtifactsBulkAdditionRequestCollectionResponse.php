...
/**
 * DriveRestoreArtifactsBulkAdditionRequestCollectionResponse - Collection response
 */
class DriveRestoreArtifactsBulkAdditionRequestCollectionResponse
{
    /**
     * @var array<int, DriveRestoreArtifactsBulkAdditionRequest>
     */
    public array $value = [];
