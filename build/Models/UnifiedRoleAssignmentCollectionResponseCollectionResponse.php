...
/**
 * Collection response for UnifiedRoleAssignmentCollectionResponse
 */
class UnifiedRoleAssignmentCollectionResponseCollectionResponse
{
    /**
     * @var UnifiedRoleAssignmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedRoleAssignmentCollectionResponse ...$items Variable number of UnifiedRoleAssignmentCollectionResponse items
     * @return self
     */
    public function setValue(UnifiedRoleAssignmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UnifiedRoleAssignmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleAssignmentCollectionResponse $item
     * @return self
     */
    public function addValue(UnifiedRoleAssignmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
