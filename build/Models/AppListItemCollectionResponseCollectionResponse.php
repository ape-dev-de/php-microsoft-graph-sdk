...
/**
 * Collection response for AppListItemCollectionResponse
 */
class AppListItemCollectionResponseCollectionResponse
{
    /**
     * @var AppListItemCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AppListItemCollectionResponse ...$items Variable number of AppListItemCollectionResponse items
     * @return self
     */
    public function setValue(AppListItemCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AppListItemCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AppListItemCollectionResponse $item
     * @return self
     */
    public function addValue(AppListItemCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
