...
/**
 * Collection response for CallRecordsMediaCollectionResponse
 */
class CallRecordsMediaCollectionResponseCollectionResponse
{
    /**
     * @var CallRecordsMediaCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return CallRecordsMediaCollectionResponse[]
     */
     ...
     * 
     * @param CallRecordsMediaCollectionResponse ...$items Variable number of CallRecordsMediaCollectionResponse items
     * @return self
     */
    public function setValue(CallRecordsMediaCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CallRecordsMediaCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CallRecordsMediaCollectionResponse $item
     * @return self
     */
    public function addValue(CallRecordsMediaCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
