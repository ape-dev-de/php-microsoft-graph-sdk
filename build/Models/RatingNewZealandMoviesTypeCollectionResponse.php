...
/**
 * RatingNewZealandMoviesTypeCollectionResponse - Collection response
 */
class RatingNewZealandMoviesTypeCollectionResponse
{
    /**
     * @var array<int, RatingNewZealandMoviesType>
     */
    public array $value = [];
