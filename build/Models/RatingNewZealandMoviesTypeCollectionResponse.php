...
/**
 * Collection response for RatingNewZealandMoviesType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RatingNewZealandMoviesTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RatingNewZealandMoviesType[]
     */
    private array $value = [];
     ...
     * 
     * @return RatingNewZealandMoviesType[]
     */
     ...
     * 
     * @param RatingNewZealandMoviesType[] $items
     * @return self
     */
    public function setValue(array|RatingNewZealandMoviesType $items, RatingNewZealandMoviesType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RatingNewZealandMoviesType> $value
     * @return self
     ...
     * 
     * @param RatingNewZealandMoviesType $item
     * @return self
     */
    public function addValue(RatingNewZealandMoviesType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RatingNewZealandMoviesType>
     */
