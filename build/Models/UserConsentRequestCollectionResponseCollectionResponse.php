...
/**
 * Collection response for UserConsentRequestCollectionResponse
 */
class UserConsentRequestCollectionResponseCollectionResponse
{
    /**
     * @var UserConsentRequestCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UserConsentRequestCollectionResponse ...$items Variable number of UserConsentRequestCollectionResponse items
     * @return self
     */
    public function setValue(UserConsentRequestCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UserConsentRequestCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UserConsentRequestCollectionResponse $item
     * @return self
     */
    public function addValue(UserConsentRequestCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
