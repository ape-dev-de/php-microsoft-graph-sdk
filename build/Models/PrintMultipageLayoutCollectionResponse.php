...
/**
 * Collection response for PrintMultipageLayout
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintMultipageLayoutCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PrintMultipageLayout[] $items
     * @return self
     */
    public function setValue(array|PrintMultipageLayout $items, PrintMultipageLayout ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintMultipageLayout> $value
     * @return self
     ...
     * 
     * @param PrintMultipageLayout $item
     * @return self
     */
    public function addValue(PrintMultipageLayout $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintMultipageLayout>
     */
