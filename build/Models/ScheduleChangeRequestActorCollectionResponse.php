...
/**
 * ScheduleChangeRequestActorCollectionResponse - Collection response
 */
class ScheduleChangeRequestActorCollectionResponse
{
    /**
     * @var array<int, ScheduleChangeRequestActor>
     */
    public array $value = [];
