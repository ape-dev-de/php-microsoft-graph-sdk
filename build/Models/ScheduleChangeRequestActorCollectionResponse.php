...
/**
 * Collection response for ScheduleChangeRequestActor
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ScheduleChangeRequestActorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return ScheduleChangeRequestActor[]
     */
     ...
     * 
     * @param ScheduleChangeRequestActor[] $items
     * @return self
     */
    public function setValue(array|ScheduleChangeRequestActor $items, ScheduleChangeRequestActor ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ScheduleChangeRequestActor> $value
     * @return self
     ...
     * 
     * @param ScheduleChangeRequestActor $item
     * @return self
     */
    public function addValue(ScheduleChangeRequestActor $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ScheduleChangeRequestActor>
     */
