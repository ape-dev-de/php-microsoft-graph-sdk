...
/**
 * Collection response for UnifiedRoleScheduleRequestActions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRoleScheduleRequestActionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UnifiedRoleScheduleRequestActions[]
     */
    private array $value = [];
     ...
     * 
     * @return UnifiedRoleScheduleRequestActions[]
     */
     ...
     * 
     * @param UnifiedRoleScheduleRequestActions[] $items
     * @return self
     */
    public function setValue(array|UnifiedRoleScheduleRequestActions $items, UnifiedRoleScheduleRequestActions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRoleScheduleRequestActions> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleScheduleRequestActions $item
     * @return self
     */
    public function addValue(UnifiedRoleScheduleRequestActions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRoleScheduleRequestActions>
     */
