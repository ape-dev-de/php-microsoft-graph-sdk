...
/**
 * UnifiedRoleScheduleRequestActionsCollectionResponse - Collection response
 */
class UnifiedRoleScheduleRequestActionsCollectionResponse
{
    /**
     * @var array<int, UnifiedRoleScheduleRequestActions>
     */
    public array $value = [];
