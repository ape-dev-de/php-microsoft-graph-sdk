...
/**
 * Collection response for SecurityEdiscoverySearchCollectionResponse
 */
class SecurityEdiscoverySearchCollectionResponseCollectionResponse
{
    /**
     * @var SecurityEdiscoverySearchCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityEdiscoverySearchCollectionResponse ...$items Variable number of SecurityEdiscoverySearchCollectionResponse items
     * @return self
     */
    public function setValue(SecurityEdiscoverySearchCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityEdiscoverySearchCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityEdiscoverySearchCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityEdiscoverySearchCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
