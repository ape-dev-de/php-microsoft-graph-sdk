...
/**
 * Collection response for CloudPcAuditResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcAuditResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CloudPcAuditResource[] $items
     * @return self
     */
    public function setValue(array|CloudPcAuditResource $items, CloudPcAuditResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcAuditResource> $value
     * @return self
     ...
     * 
     * @param CloudPcAuditResource $item
     * @return self
     */
    public function addValue(CloudPcAuditResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CloudPcAuditResource|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CloudPcAuditResource>
     */
