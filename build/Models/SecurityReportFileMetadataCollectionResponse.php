...
/**
 * Collection response for SecurityReportFileMetadata
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityReportFileMetadataCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return SecurityReportFileMetadata[]
     */
     ...
     * 
     * @param SecurityReportFileMetadata[] $items
     * @return self
     */
    public function setValue(array|SecurityReportFileMetadata $items, SecurityReportFileMetadata ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityReportFileMetadata> $value
     * @return self
     ...
     * 
     * @param SecurityReportFileMetadata $item
     * @return self
     */
    public function addValue(SecurityReportFileMetadata $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityReportFileMetadata|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityReportFileMetadata>
     */
