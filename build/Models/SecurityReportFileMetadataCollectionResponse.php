...
/**
 * SecurityReportFileMetadataCollectionResponse - Collection response
 */
class SecurityReportFileMetadataCollectionResponse
{
    /**
     * @var array<int, SecurityReportFileMetadata>
     */
    public array $value = [];
