 ...
 */
class ResultTemplateOptionCollectionResponse
{
    /**
     ...
     * 
     * @param ResultTemplateOption ...$items Variable number of ResultTemplateOption items
     * @return self
     */
    public function setValue(ResultTemplateOption ...$items): self
    {
        $this->value = $items;
        return $this;
    }
