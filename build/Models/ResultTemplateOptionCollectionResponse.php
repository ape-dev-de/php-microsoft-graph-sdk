...
/**
 * Collection response for ResultTemplateOption
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ResultTemplateOptionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ResultTemplateOption[]
     */
    private array $value = [];
     ...
     * 
     * @param ResultTemplateOption[] $items
     * @return self
     */
    public function setValue(array|ResultTemplateOption $items, ResultTemplateOption ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ResultTemplateOption> $value
     * @return self
     ...
     * 
     * @param ResultTemplateOption $item
     * @return self
     */
    public function addValue(ResultTemplateOption $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ResultTemplateOption>
     */
