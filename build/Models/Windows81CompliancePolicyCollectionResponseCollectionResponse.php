...
/**
 * Collection response for Windows81CompliancePolicyCollectionResponse
 */
class Windows81CompliancePolicyCollectionResponseCollectionResponse
{
    /**
     * @var Windows81CompliancePolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param Windows81CompliancePolicyCollectionResponse ...$items Variable number of Windows81CompliancePolicyCollectionResponse items
     * @return self
     */
    public function setValue(Windows81CompliancePolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<Windows81CompliancePolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param Windows81CompliancePolicyCollectionResponse $item
     * @return self
     */
    public function addValue(Windows81CompliancePolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
