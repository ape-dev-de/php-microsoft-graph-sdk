...
/**
 * Collection response for PolicyRoot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PolicyRootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PolicyRoot[]
     */
     ...
     * 
     * @param PolicyRoot[] $items
     * @return self
     */
    public function setValue(array|PolicyRoot $items, PolicyRoot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param PolicyRoot $item
     * @return self
     */
    public function addValue(PolicyRoot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PolicyRoot>
     */
