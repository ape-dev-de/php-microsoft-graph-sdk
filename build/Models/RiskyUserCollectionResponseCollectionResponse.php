...
/**
 * Collection response for RiskyUserCollectionResponse
 */
class RiskyUserCollectionResponseCollectionResponse
{
    /**
     * @var RiskyUserCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RiskyUserCollectionResponse ...$items Variable number of RiskyUserCollectionResponse items
     * @return self
     */
    public function setValue(RiskyUserCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RiskyUserCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RiskyUserCollectionResponse $item
     * @return self
     */
    public function addValue(RiskyUserCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
