...
/**
 * Collection response for PrivilegedAccessGroupEligibilitySchedule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrivilegedAccessGroupEligibilityScheduleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PrivilegedAccessGroupEligibilitySchedule[] $items
     * @return self
     */
    public function setValue(array|PrivilegedAccessGroupEligibilitySchedule $items, PrivilegedAccessGroupEligibilitySchedule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrivilegedAccessGroupEligibilitySchedule> $value
     * @return self
     ...
     * 
     * @param PrivilegedAccessGroupEligibilitySchedule $item
     * @return self
     */
    public function addValue(PrivilegedAccessGroupEligibilitySchedule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrivilegedAccessGroupEligibilitySchedule>
     */
