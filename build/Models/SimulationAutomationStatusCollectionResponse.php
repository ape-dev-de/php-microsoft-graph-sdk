...
/**
 * SimulationAutomationStatusCollectionResponse - Collection response
 */
class SimulationAutomationStatusCollectionResponse
{
    /**
     * @var array<int, SimulationAutomationStatus>
     */
    public array $value = [];
