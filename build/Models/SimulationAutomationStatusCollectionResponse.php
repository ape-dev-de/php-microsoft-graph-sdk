...
/**
 * Collection response for SimulationAutomationStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SimulationAutomationStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SimulationAutomationStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return SimulationAutomationStatus[]
     */
     ...
     * 
     * @param SimulationAutomationStatus[] $items
     * @return self
     */
    public function setValue(array|SimulationAutomationStatus $items, SimulationAutomationStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SimulationAutomationStatus> $value
     * @return self
     ...
     * 
     * @param SimulationAutomationStatus $item
     * @return self
     */
    public function addValue(SimulationAutomationStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SimulationAutomationStatus>
     */
