...
/**
 * Collection response for TeamworkUserIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamworkUserIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TeamworkUserIdentity[] $items
     * @return self
     */
    public function setValue(array|TeamworkUserIdentity $items, TeamworkUserIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamworkUserIdentity> $value
     * @return self
     ...
     * 
     * @param TeamworkUserIdentity $item
     * @return self
     */
    public function addValue(TeamworkUserIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamworkUserIdentity>
     */
