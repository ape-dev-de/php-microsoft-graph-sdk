...
/**
 * Collection response for SignInIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SignInIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SignInIdentity[]
     */
     ...
     * 
     * @param SignInIdentity[] $items
     * @return self
     */
    public function setValue(array|SignInIdentity $items, SignInIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SignInIdentity> $value
     * @return self
     ...
     * 
     * @param SignInIdentity $item
     * @return self
     */
    public function addValue(SignInIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SignInIdentity>
     */
