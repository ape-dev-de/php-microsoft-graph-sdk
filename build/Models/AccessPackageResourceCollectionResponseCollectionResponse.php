...
/**
 * Collection response for AccessPackageResourceCollectionResponse
 */
class AccessPackageResourceCollectionResponseCollectionResponse
{
    /**
     * @var AccessPackageResourceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageResourceCollectionResponse ...$items Variable number of AccessPackageResourceCollectionResponse items
     * @return self
     */
    public function setValue(AccessPackageResourceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AccessPackageResourceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AccessPackageResourceCollectionResponse $item
     * @return self
     */
    public function addValue(AccessPackageResourceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
