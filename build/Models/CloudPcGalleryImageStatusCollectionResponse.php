...
/**
 * Collection response for CloudPcGalleryImageStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcGalleryImageStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudPcGalleryImageStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return CloudPcGalleryImageStatus[]
     */
     ...
     * 
     * @param CloudPcGalleryImageStatus[] $items
     * @return self
     */
    public function setValue(array|CloudPcGalleryImageStatus $items, CloudPcGalleryImageStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcGalleryImageStatus> $value
     * @return self
     ...
     * 
     * @param CloudPcGalleryImageStatus $item
     * @return self
     */
    public function addValue(CloudPcGalleryImageStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcGalleryImageStatus>
     */
