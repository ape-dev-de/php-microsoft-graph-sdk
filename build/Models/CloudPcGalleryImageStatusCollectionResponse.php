...
/**
 * CloudPcGalleryImageStatusCollectionResponse - Collection response
 */
class CloudPcGalleryImageStatusCollectionResponse
{
    /**
     * @var array<int, CloudPcGalleryImageStatus>
     */
    public array $value = [];
