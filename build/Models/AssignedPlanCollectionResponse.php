...
/**
 * Collection response for AssignedPlan
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AssignedPlanCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AssignedPlan[]
     */
     ...
     * 
     * @param AssignedPlan[] $items
     * @return self
     */
    public function setValue(array|AssignedPlan $items, AssignedPlan ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AssignedPlan> $value
     * @return self
     ...
     * 
     * @param AssignedPlan $item
     * @return self
     */
    public function addValue(AssignedPlan $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AssignedPlan>
     */
