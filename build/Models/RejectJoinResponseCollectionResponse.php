...
/**
 * Collection response for RejectJoinResponse
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RejectJoinResponseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RejectJoinResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RejectJoinResponse[] $items
     * @return self
     */
    public function setValue(array|RejectJoinResponse $items, RejectJoinResponse ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RejectJoinResponse> $value
     * @return self
     ...
     * 
     * @param RejectJoinResponse $item
     * @return self
     */
    public function addValue(RejectJoinResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return RejectJoinResponse|null
     */
     ...
     * 
     * @return \ArrayIterator<int, RejectJoinResponse>
     */
