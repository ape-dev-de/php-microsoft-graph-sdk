 ...
 */
class RejectJoinResponseCollectionResponse
{
    /**
     ...
     * 
     * @param RejectJoinResponse ...$items Variable number of RejectJoinResponse items
     * @return self
     */
    public function setValue(RejectJoinResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
