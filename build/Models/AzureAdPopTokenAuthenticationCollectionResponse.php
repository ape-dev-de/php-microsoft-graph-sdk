...
/**
 * AzureAdPopTokenAuthenticationCollectionResponse - Collection response
 */
class AzureAdPopTokenAuthenticationCollectionResponse
{
    /**
     * @var array<int, AzureAdPopTokenAuthentication>
     */
    public array $value = [];
