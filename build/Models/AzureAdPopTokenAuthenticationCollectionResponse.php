...
/**
 * Collection response for AzureAdPopTokenAuthentication
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AzureAdPopTokenAuthenticationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AzureAdPopTokenAuthentication[]
     */
    private array $value = [];
     ...
     * 
     * @param AzureAdPopTokenAuthentication[] $items
     * @return self
     */
    public function setValue(array|AzureAdPopTokenAuthentication $items, AzureAdPopTokenAuthentication ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AzureAdPopTokenAuthentication> $value
     * @return self
     ...
     * 
     * @param AzureAdPopTokenAuthentication $item
     * @return self
     */
    public function addValue(AzureAdPopTokenAuthentication $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AzureAdPopTokenAuthentication|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AzureAdPopTokenAuthentication>
     */
