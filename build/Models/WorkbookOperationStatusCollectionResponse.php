...
/**
 * Collection response for WorkbookOperationStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookOperationStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return WorkbookOperationStatus[]
     */
     ...
     * 
     * @param WorkbookOperationStatus[] $items
     * @return self
     */
    public function setValue(array|WorkbookOperationStatus $items, WorkbookOperationStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookOperationStatus> $value
     * @return self
     ...
     * 
     * @param WorkbookOperationStatus $item
     * @return self
     */
    public function addValue(WorkbookOperationStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookOperationStatus>
     */
