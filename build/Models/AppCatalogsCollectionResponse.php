...
/**
 * Collection response for AppCatalogs
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppCatalogsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AppCatalogs[]
     */
     ...
     * 
     * @param AppCatalogs[] $items
     * @return self
     */
    public function setValue(array|AppCatalogs $items, AppCatalogs ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param AppCatalogs $item
     * @return self
     */
    public function addValue(AppCatalogs $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AppCatalogs>
     */
