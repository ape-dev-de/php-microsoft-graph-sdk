...
/**
 * Collection response for CalendarPermissionCollectionResponse
 */
class CalendarPermissionCollectionResponseCollectionResponse
{
    /**
     * @var CalendarPermissionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CalendarPermissionCollectionResponse ...$items Variable number of CalendarPermissionCollectionResponse items
     * @return self
     */
    public function setValue(CalendarPermissionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CalendarPermissionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CalendarPermissionCollectionResponse $item
     * @return self
     */
    public function addValue(CalendarPermissionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
