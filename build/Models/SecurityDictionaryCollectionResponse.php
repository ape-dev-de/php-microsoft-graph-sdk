...
/**
 * Collection response for SecurityDictionary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityDictionaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityDictionary[] $items
     * @return self
     */
    public function setValue(array|SecurityDictionary $items, SecurityDictionary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityDictionary> $value
     * @return self
     ...
     * 
     * @param SecurityDictionary $item
     * @return self
     */
    public function addValue(SecurityDictionary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityDictionary|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityDictionary>
     */
