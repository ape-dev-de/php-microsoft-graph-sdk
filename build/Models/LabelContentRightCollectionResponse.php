...
/**
 * Collection response for LabelContentRight
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LabelContentRightCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param LabelContentRight[] $items
     * @return self
     */
    public function setValue(array|LabelContentRight $items, LabelContentRight ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LabelContentRight> $value
     * @return self
     ...
     * 
     * @param LabelContentRight $item
     * @return self
     */
    public function addValue(LabelContentRight $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LabelContentRight>
     */
