...
/**
 * Collection response for ManagedEBookAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedEBookAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ManagedEBookAssignment[] $items
     * @return self
     */
    public function setValue(array|ManagedEBookAssignment $items, ManagedEBookAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedEBookAssignment> $value
     * @return self
     ...
     * 
     * @param ManagedEBookAssignment $item
     * @return self
     */
    public function addValue(ManagedEBookAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedEBookAssignment>
     */
