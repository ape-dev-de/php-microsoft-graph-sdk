...
/**
 * Collection response for CallRecordsEndpoint
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsEndpointCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsEndpoint[]
     */
    private array $value = [];
     ...
     * 
     * @param CallRecordsEndpoint[] $items
     * @return self
     */
    public function setValue(array|CallRecordsEndpoint $items, CallRecordsEndpoint ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsEndpoint> $value
     * @return self
     ...
     * 
     * @param CallRecordsEndpoint $item
     * @return self
     */
    public function addValue(CallRecordsEndpoint $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsEndpoint|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsEndpoint>
     */
