 ...
 */
class CallRecordsEndpointCollectionResponse
{
    /**
     ...
     * 
     * @param CallRecordsEndpoint ...$items Variable number of CallRecordsEndpoint items
     * @return self
     */
    public function setValue(CallRecordsEndpoint ...$items): self
    {
        $this->value = $items;
        return $this;
    }
