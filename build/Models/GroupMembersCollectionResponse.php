...
/**
 * Collection response for GroupMembers
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class GroupMembersCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var GroupMembers[]
     */
     ...
     * 
     * @param GroupMembers[] $items
     * @return self
     */
    public function setValue(array|GroupMembers $items, GroupMembers ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<GroupMembers> $value
     * @return self
     ...
     * @return self
     */
    public function addValue(GroupMembers $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, GroupMembers>
     */
