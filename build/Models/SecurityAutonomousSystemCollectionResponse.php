...
/**
 * Collection response for SecurityAutonomousSystem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityAutonomousSystemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityAutonomousSystem[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityAutonomousSystem[]
     */
     ...
     * 
     * @param SecurityAutonomousSystem[] $items
     * @return self
     */
    public function setValue(array|SecurityAutonomousSystem $items, SecurityAutonomousSystem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityAutonomousSystem> $value
     * @return self
     ...
     * 
     * @param SecurityAutonomousSystem $item
     * @return self
     */
    public function addValue(SecurityAutonomousSystem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityAutonomousSystem|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityAutonomousSystem>
     */
