 ...
 */
class SecurityAutonomousSystemCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityAutonomousSystem ...$items Variable number of SecurityAutonomousSystem items
     * @return self
     */
    public function setValue(SecurityAutonomousSystem ...$items): self
    {
        $this->value = $items;
        return $this;
    }
