...
/**
 * Collection response for SecurityDataSourceCollectionResponse
 */
class SecurityDataSourceCollectionResponseCollectionResponse
{
    /**
     * @var SecurityDataSourceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityDataSourceCollectionResponse ...$items Variable number of SecurityDataSourceCollectionResponse items
     * @return self
     */
    public function setValue(SecurityDataSourceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityDataSourceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityDataSourceCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityDataSourceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
