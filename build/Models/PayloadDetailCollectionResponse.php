...
/**
 * Collection response for PayloadDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PayloadDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PayloadDetail[]
     */
     ...
     * 
     * @param PayloadDetail[] $items
     * @return self
     */
    public function setValue(array|PayloadDetail $items, PayloadDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PayloadDetail> $value
     * @return self
     ...
     * 
     * @param PayloadDetail $item
     * @return self
     */
    public function addValue(PayloadDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PayloadDetail>
     */
