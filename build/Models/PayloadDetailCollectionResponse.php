 ...
 */
class PayloadDetailCollectionResponse
{
    /**
     * @var PayloadDetail[]
     */
     ...
     * 
     * @param PayloadDetail ...$items Variable number of PayloadDetail items
     * @return self
     */
    public function setValue(PayloadDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
