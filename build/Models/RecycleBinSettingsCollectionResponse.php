...
/**
 * Collection response for RecycleBinSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RecycleBinSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param RecycleBinSettings[] $items
     * @return self
     */
    public function setValue(array|RecycleBinSettings $items, RecycleBinSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RecycleBinSettings> $value
     * @return self
     ...
     * 
     * @param RecycleBinSettings $item
     * @return self
     */
    public function addValue(RecycleBinSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RecycleBinSettings>
     */
