 ...
 */
class RecycleBinSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param RecycleBinSettings ...$items Variable number of RecycleBinSettings items
     * @return self
     */
    public function setValue(RecycleBinSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
