...
/**
 * IdentityGovernanceWorkflowCollectionResponse - Collection response
 */
class IdentityGovernanceWorkflowCollectionResponse
{
    /**
     * @var array<int, IdentityGovernanceWorkflow>
     */
    public array $value = [];
