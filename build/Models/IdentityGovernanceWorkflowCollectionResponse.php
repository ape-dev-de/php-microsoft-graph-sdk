...
/**
 * Collection response for IdentityGovernanceWorkflow
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceWorkflowCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IdentityGovernanceWorkflow[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceWorkflow $items, IdentityGovernanceWorkflow ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceWorkflow> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceWorkflow $item
     * @return self
     */
    public function addValue(IdentityGovernanceWorkflow $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceWorkflow>
     */
