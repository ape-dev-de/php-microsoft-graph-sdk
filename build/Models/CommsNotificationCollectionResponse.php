...
/**
 * Collection response for CommsNotification
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CommsNotificationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CommsNotification[] $items
     * @return self
     */
    public function setValue(array|CommsNotification $items, CommsNotification ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CommsNotification> $value
     * @return self
     ...
     * 
     * @param CommsNotification $item
     * @return self
     */
    public function addValue(CommsNotification $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CommsNotification>
     */
