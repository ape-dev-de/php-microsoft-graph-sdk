...
/**
 * Collection response for TrainingAssignedTo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TrainingAssignedToCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TrainingAssignedTo[] $items
     * @return self
     */
    public function setValue(array|TrainingAssignedTo $items, TrainingAssignedTo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TrainingAssignedTo> $value
     * @return self
     ...
     * 
     * @param TrainingAssignedTo $item
     * @return self
     */
    public function addValue(TrainingAssignedTo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TrainingAssignedTo|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TrainingAssignedTo>
     */
