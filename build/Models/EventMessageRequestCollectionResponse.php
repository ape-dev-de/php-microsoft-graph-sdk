...
/**
 * Collection response for EventMessageRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EventMessageRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EventMessageRequest[]
     */
    private array $value = [];
     ...
     * 
     * @param EventMessageRequest[] $items
     * @return self
     */
    public function setValue(array|EventMessageRequest $items, EventMessageRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EventMessageRequest> $value
     * @return self
     ...
     * 
     * @param EventMessageRequest $item
     * @return self
     */
    public function addValue(EventMessageRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EventMessageRequest|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EventMessageRequest>
     */
