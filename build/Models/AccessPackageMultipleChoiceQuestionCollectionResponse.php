...
/**
 * Collection response for AccessPackageMultipleChoiceQuestion
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageMultipleChoiceQuestionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageMultipleChoiceQuestion[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageMultipleChoiceQuestion[] $items
     * @return self
     */
    public function setValue(array|AccessPackageMultipleChoiceQuestion $items, AccessPackageMultipleChoiceQuestion ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageMultipleChoiceQuestion> $value
     * @return self
     ...
     * 
     * @param AccessPackageMultipleChoiceQuestion $item
     * @return self
     */
    public function addValue(AccessPackageMultipleChoiceQuestion $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessPackageMultipleChoiceQuestion|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageMultipleChoiceQuestion>
     */
