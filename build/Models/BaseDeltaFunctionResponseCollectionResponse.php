...
/**
 * BaseDeltaFunctionResponseCollectionResponse - Collection response
 */
class BaseDeltaFunctionResponseCollectionResponse
{
    /**
     * @var array<int, BaseDeltaFunctionResponse>
     */
    public array $value = [];
