...
/**
 * Collection response for BaseDeltaFunctionResponse
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BaseDeltaFunctionResponseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BaseDeltaFunctionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BaseDeltaFunctionResponse[] $items
     * @return self
     */
    public function setValue(array|BaseDeltaFunctionResponse $items, BaseDeltaFunctionResponse ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BaseDeltaFunctionResponse> $value
     * @return self
     ...
     * 
     * @param BaseDeltaFunctionResponse $item
     * @return self
     */
    public function addValue(BaseDeltaFunctionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return BaseDeltaFunctionResponse|null
     */
     ...
     * 
     * @return \ArrayIterator<int, BaseDeltaFunctionResponse>
     */
