...
/**
 * Collection response for OfficeGraphInsights
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OfficeGraphInsightsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OfficeGraphInsights[]
     */
    private array $value = [];
     ...
     * 
     * @param OfficeGraphInsights[] $items
     * @return self
     */
    public function setValue(array|OfficeGraphInsights $items, OfficeGraphInsights ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OfficeGraphInsights> $value
     * @return self
     ...
     * 
     * @param OfficeGraphInsights $item
     * @return self
     */
    public function addValue(OfficeGraphInsights $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OfficeGraphInsights>
     */
