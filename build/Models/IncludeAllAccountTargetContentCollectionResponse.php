...
/**
 * Collection response for IncludeAllAccountTargetContent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IncludeAllAccountTargetContentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IncludeAllAccountTargetContent[]
     */
    private array $value = [];
     ...
     * 
     * @param IncludeAllAccountTargetContent[] $items
     * @return self
     */
    public function setValue(array|IncludeAllAccountTargetContent $items, IncludeAllAccountTargetContent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IncludeAllAccountTargetContent> $value
     * @return self
     ...
     * 
     * @param IncludeAllAccountTargetContent $item
     * @return self
     */
    public function addValue(IncludeAllAccountTargetContent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IncludeAllAccountTargetContent|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IncludeAllAccountTargetContent>
     */
