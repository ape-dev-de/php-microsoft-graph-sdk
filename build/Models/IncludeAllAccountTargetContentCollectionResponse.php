...
/**
 * IncludeAllAccountTargetContentCollectionResponse - Collection response
 */
class IncludeAllAccountTargetContentCollectionResponse
{
    /**
     * @var array<int, IncludeAllAccountTargetContent>
     */
    public array $value = [];
