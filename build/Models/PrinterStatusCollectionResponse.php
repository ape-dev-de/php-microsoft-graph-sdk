 ...
 */
class PrinterStatusCollectionResponse
{
    /**
     * @var PrinterStatus[]
     */
     ...
     * 
     * @param PrinterStatus ...$items Variable number of PrinterStatus items
     * @return self
     */
    public function setValue(PrinterStatus ...$items): self
    {
        $this->value = $items;
        return $this;
    }
