...
/**
 * Collection response for PrinterStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrinterStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrinterStatus[]
     */
     ...
     * 
     * @param PrinterStatus[] $items
     * @return self
     */
    public function setValue(array|PrinterStatus $items, PrinterStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrinterStatus> $value
     * @return self
     ...
     * 
     * @param PrinterStatus $item
     * @return self
     */
    public function addValue(PrinterStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrinterStatus>
     */
