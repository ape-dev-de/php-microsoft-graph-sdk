...
/**
 * Collection response for SecurityDocumentVersion
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityDocumentVersionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityDocumentVersion[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityDocumentVersion[] $items
     * @return self
     */
    public function setValue(array|SecurityDocumentVersion $items, SecurityDocumentVersion ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityDocumentVersion> $value
     * @return self
     ...
     * 
     * @param SecurityDocumentVersion $item
     * @return self
     */
    public function addValue(SecurityDocumentVersion $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityDocumentVersion|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityDocumentVersion>
     */
