...
/**
 * Collection response for EdgeSearchEngineBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EdgeSearchEngineBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param EdgeSearchEngineBase[] $items
     * @return self
     */
    public function setValue(array|EdgeSearchEngineBase $items, EdgeSearchEngineBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EdgeSearchEngineBase> $value
     * @return self
     ...
     * 
     * @param EdgeSearchEngineBase $item
     * @return self
     */
    public function addValue(EdgeSearchEngineBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EdgeSearchEngineBase>
     */
