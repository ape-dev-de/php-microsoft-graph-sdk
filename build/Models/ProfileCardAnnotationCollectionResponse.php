...
/**
 * Collection response for ProfileCardAnnotation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProfileCardAnnotationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProfileCardAnnotation[]
     */
    private array $value = [];
     ...
     * 
     * @param ProfileCardAnnotation[] $items
     * @return self
     */
    public function setValue(array|ProfileCardAnnotation $items, ProfileCardAnnotation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProfileCardAnnotation> $value
     * @return self
     ...
     * 
     * @param ProfileCardAnnotation $item
     * @return self
     */
    public function addValue(ProfileCardAnnotation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ProfileCardAnnotation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ProfileCardAnnotation>
     */
