...
/**
 * Collection response for WorkbookFilterDatetime
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookFilterDatetimeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookFilterDatetime[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookFilterDatetime[] $items
     * @return self
     */
    public function setValue(array|WorkbookFilterDatetime $items, WorkbookFilterDatetime ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookFilterDatetime> $value
     * @return self
     ...
     * 
     * @param WorkbookFilterDatetime $item
     * @return self
     */
    public function addValue(WorkbookFilterDatetime $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WorkbookFilterDatetime|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WorkbookFilterDatetime>
     */
