 ...
 */
class WorkbookFilterDatetimeCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookFilterDatetime ...$items Variable number of WorkbookFilterDatetime items
     * @return self
     */
    public function setValue(WorkbookFilterDatetime ...$items): self
    {
        $this->value = $items;
        return $this;
    }
