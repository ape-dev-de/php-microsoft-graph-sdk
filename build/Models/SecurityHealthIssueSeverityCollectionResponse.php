...
/**
 * Collection response for SecurityHealthIssueSeverity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHealthIssueSeverityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityHealthIssueSeverity[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityHealthIssueSeverity[]
     */
     ...
     * 
     * @param SecurityHealthIssueSeverity[] $items
     * @return self
     */
    public function setValue(array|SecurityHealthIssueSeverity $items, SecurityHealthIssueSeverity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHealthIssueSeverity> $value
     * @return self
     ...
     * 
     * @param SecurityHealthIssueSeverity $item
     * @return self
     */
    public function addValue(SecurityHealthIssueSeverity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityHealthIssueSeverity|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityHealthIssueSeverity>
     */
