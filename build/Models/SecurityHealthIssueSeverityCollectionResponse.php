...
/**
 * SecurityHealthIssueSeverityCollectionResponse - Collection response
 */
class SecurityHealthIssueSeverityCollectionResponse
{
    /**
     * @var array<int, SecurityHealthIssueSeverity>
     */
    public array $value = [];
