...
/**
 * ContentApprovalStatusColumnCollectionResponse - Collection response
 */
class ContentApprovalStatusColumnCollectionResponse
{
    /**
     * @var array<int, ContentApprovalStatusColumn>
     */
    public array $value = [];
