...
/**
 * Collection response for ContentApprovalStatusColumn
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ContentApprovalStatusColumnCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ContentApprovalStatusColumn[]
     */
    private array $value = [];
     ...
     * 
     * @param ContentApprovalStatusColumn[] $items
     * @return self
     */
    public function setValue(array|ContentApprovalStatusColumn $items, ContentApprovalStatusColumn ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ContentApprovalStatusColumn> $value
     * @return self
     ...
     * 
     * @param ContentApprovalStatusColumn $item
     * @return self
     */
    public function addValue(ContentApprovalStatusColumn $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ContentApprovalStatusColumn>
     */
