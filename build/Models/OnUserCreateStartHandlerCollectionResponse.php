...
/**
 * Collection response for OnUserCreateStartHandler
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnUserCreateStartHandlerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnUserCreateStartHandler[]
     */
    private array $value = [];
     ...
     * 
     * @param OnUserCreateStartHandler[] $items
     * @return self
     */
    public function setValue(array|OnUserCreateStartHandler $items, OnUserCreateStartHandler ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnUserCreateStartHandler> $value
     * @return self
     ...
     * 
     * @param OnUserCreateStartHandler $item
     * @return self
     */
    public function addValue(OnUserCreateStartHandler $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnUserCreateStartHandler>
     */
