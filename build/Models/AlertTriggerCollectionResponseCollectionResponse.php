...
/**
 * Collection response for AlertTriggerCollectionResponse
 */
class AlertTriggerCollectionResponseCollectionResponse
{
    /**
     * @var AlertTriggerCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AlertTriggerCollectionResponse ...$items Variable number of AlertTriggerCollectionResponse items
     * @return self
     */
    public function setValue(AlertTriggerCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AlertTriggerCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AlertTriggerCollectionResponse $item
     * @return self
     */
    public function addValue(AlertTriggerCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
