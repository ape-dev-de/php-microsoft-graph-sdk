...
/**
 * Collection response for ODataCountResponse
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ODataCountResponseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ODataCountResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ODataCountResponse[] $items
     * @return self
     */
    public function setValue(array|ODataCountResponse $items, ODataCountResponse ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ODataCountResponse> $value
     * @return self
     ...
     * 
     * @param ODataCountResponse $item
     * @return self
     */
    public function addValue(ODataCountResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ODataCountResponse|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ODataCountResponse>
     */
