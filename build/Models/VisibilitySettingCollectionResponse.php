...
/**
 * Collection response for VisibilitySetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VisibilitySettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param VisibilitySetting[] $items
     * @return self
     */
    public function setValue(array|VisibilitySetting $items, VisibilitySetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VisibilitySetting> $value
     * @return self
     ...
     * 
     * @param VisibilitySetting $item
     * @return self
     */
    public function addValue(VisibilitySetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VisibilitySetting>
     */
