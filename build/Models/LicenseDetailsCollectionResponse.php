...
/**
 * Collection response for LicenseDetails
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LicenseDetailsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var LicenseDetails[]
     */
     ...
     * 
     * @param LicenseDetails[] $items
     * @return self
     */
    public function setValue(array|LicenseDetails $items, LicenseDetails ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LicenseDetails> $value
     * @return self
     ...
     * 
     * @param LicenseDetails $item
     * @return self
     */
    public function addValue(LicenseDetails $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LicenseDetails>
     */
