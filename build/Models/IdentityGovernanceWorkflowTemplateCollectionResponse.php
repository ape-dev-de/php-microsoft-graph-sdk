...
/**
 * IdentityGovernanceWorkflowTemplateCollectionResponse - Collection response
 */
class IdentityGovernanceWorkflowTemplateCollectionResponse
{
    /**
     * @var array<int, IdentityGovernanceWorkflowTemplate>
     */
    public array $value = [];
