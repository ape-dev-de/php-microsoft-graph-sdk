...
/**
 * Collection response for IdentityGovernanceWorkflowTemplate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceWorkflowTemplateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IdentityGovernanceWorkflowTemplate[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceWorkflowTemplate $items, IdentityGovernanceWorkflowTemplate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceWorkflowTemplate> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceWorkflowTemplate $item
     * @return self
     */
    public function addValue(IdentityGovernanceWorkflowTemplate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceWorkflowTemplate>
     */
