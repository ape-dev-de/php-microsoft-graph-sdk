...
/**
 * Collection response for SecurityArticleCollectionResponse
 */
class SecurityArticleCollectionResponseCollectionResponse
{
    /**
     * @var SecurityArticleCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityArticleCollectionResponse ...$items Variable number of SecurityArticleCollectionResponse items
     * @return self
     */
    public function setValue(SecurityArticleCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityArticleCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityArticleCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityArticleCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
