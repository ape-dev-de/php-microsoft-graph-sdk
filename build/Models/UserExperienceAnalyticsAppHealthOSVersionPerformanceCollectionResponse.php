...
/**
 * UserExperienceAnalyticsAppHealthOSVersionPerformanceCollectionResponse - Collection response
 */
class UserExperienceAnalyticsAppHealthOSVersionPerformanceCollectionResponse
{
    /**
     * @var array<int, UserExperienceAnalyticsAppHealthOSVersionPerformance>
     */
    public array $value = [];
