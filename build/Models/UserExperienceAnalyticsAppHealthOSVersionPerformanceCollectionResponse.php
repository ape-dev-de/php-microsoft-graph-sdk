...
/**
 * Collection response for UserExperienceAnalyticsAppHealthOSVersionPerformance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsAppHealthOSVersionPerformanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsAppHealthOSVersionPerformance[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsAppHealthOSVersionPerformance $items, UserExperienceAnalyticsAppHealthOSVersionPerformance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsAppHealthOSVersionPerformance> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsAppHealthOSVersionPerformance $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsAppHealthOSVersionPerformance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsAppHealthOSVersionPerformance>
     */
