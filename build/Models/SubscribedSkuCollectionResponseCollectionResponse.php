...
/**
 * Collection response for SubscribedSkuCollectionResponse
 */
class SubscribedSkuCollectionResponseCollectionResponse
{
    /**
     * @var SubscribedSkuCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SubscribedSkuCollectionResponse ...$items Variable number of SubscribedSkuCollectionResponse items
     * @return self
     */
    public function setValue(SubscribedSkuCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SubscribedSkuCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SubscribedSkuCollectionResponse $item
     * @return self
     */
    public function addValue(SubscribedSkuCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
