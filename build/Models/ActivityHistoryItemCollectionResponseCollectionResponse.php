...
/**
 * Collection response for ActivityHistoryItemCollectionResponse
 */
class ActivityHistoryItemCollectionResponseCollectionResponse
{
    /**
     * @var ActivityHistoryItemCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ActivityHistoryItemCollectionResponse ...$items Variable number of ActivityHistoryItemCollectionResponse items
     * @return self
     */
    public function setValue(ActivityHistoryItemCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ActivityHistoryItemCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ActivityHistoryItemCollectionResponse $item
     * @return self
     */
    public function addValue(ActivityHistoryItemCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
