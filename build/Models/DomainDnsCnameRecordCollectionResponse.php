...
/**
 * Collection response for DomainDnsCnameRecord
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DomainDnsCnameRecordCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DomainDnsCnameRecord[]
     */
    private array $value = [];
     ...
     * 
     * @param DomainDnsCnameRecord[] $items
     * @return self
     */
    public function setValue(array|DomainDnsCnameRecord $items, DomainDnsCnameRecord ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DomainDnsCnameRecord> $value
     * @return self
     ...
     * 
     * @param DomainDnsCnameRecord $item
     * @return self
     */
    public function addValue(DomainDnsCnameRecord $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return DomainDnsCnameRecord|null
     */
     ...
     * 
     * @return \ArrayIterator<int, DomainDnsCnameRecord>
     */
