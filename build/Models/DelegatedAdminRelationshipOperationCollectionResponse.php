...
/**
 * Collection response for DelegatedAdminRelationshipOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DelegatedAdminRelationshipOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DelegatedAdminRelationshipOperation[] $items
     * @return self
     */
    public function setValue(array|DelegatedAdminRelationshipOperation $items, DelegatedAdminRelationshipOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DelegatedAdminRelationshipOperation> $value
     * @return self
     ...
     * 
     * @param DelegatedAdminRelationshipOperation $item
     * @return self
     */
    public function addValue(DelegatedAdminRelationshipOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DelegatedAdminRelationshipOperation>
     */
