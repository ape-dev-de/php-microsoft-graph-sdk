...
/**
 * Collection response for SubjectRightsRequestHistory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SubjectRightsRequestHistoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SubjectRightsRequestHistory[] $items
     * @return self
     */
    public function setValue(array|SubjectRightsRequestHistory $items, SubjectRightsRequestHistory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SubjectRightsRequestHistory> $value
     * @return self
     ...
     * 
     * @param SubjectRightsRequestHistory $item
     * @return self
     */
    public function addValue(SubjectRightsRequestHistory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SubjectRightsRequestHistory|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SubjectRightsRequestHistory>
     */
