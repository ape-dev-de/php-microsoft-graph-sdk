...
/**
 * Collection response for CertificateBasedAuthConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CertificateBasedAuthConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CertificateBasedAuthConfiguration[] $items
     * @return self
     */
    public function setValue(array|CertificateBasedAuthConfiguration $items, CertificateBasedAuthConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CertificateBasedAuthConfiguration> $value
     * @return self
     ...
     * 
     * @param CertificateBasedAuthConfiguration $item
     * @return self
     */
    public function addValue(CertificateBasedAuthConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CertificateBasedAuthConfiguration>
     */
