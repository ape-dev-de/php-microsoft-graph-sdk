...
/**
 * Collection response for ExternalConnectorsAcl
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsAclCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ExternalConnectorsAcl[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsAcl $items, ExternalConnectorsAcl ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsAcl> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsAcl $item
     * @return self
     */
    public function addValue(ExternalConnectorsAcl $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ExternalConnectorsAcl|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsAcl>
     */
