...
/**
 * Collection response for Person
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PersonCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Person[]
     */
     ...
     * @return self
     */
    public function setValue(array|Person $items, Person ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Person $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Person>
     */
