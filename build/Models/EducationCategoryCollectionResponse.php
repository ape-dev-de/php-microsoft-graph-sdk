...
/**
 * Collection response for EducationCategory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationCategoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param EducationCategory[] $items
     * @return self
     */
    public function setValue(array|EducationCategory $items, EducationCategory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationCategory> $value
     * @return self
     ...
     * 
     * @param EducationCategory $item
     * @return self
     */
    public function addValue(EducationCategory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationCategory>
     */
