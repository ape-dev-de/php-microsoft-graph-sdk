...
/**
 * Collection response for AppLogUploadState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppLogUploadStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AppLogUploadState[] $items
     * @return self
     */
    public function setValue(array|AppLogUploadState $items, AppLogUploadState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppLogUploadState> $value
     * @return self
     ...
     * 
     * @param AppLogUploadState $item
     * @return self
     */
    public function addValue(AppLogUploadState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AppLogUploadState>
     */
