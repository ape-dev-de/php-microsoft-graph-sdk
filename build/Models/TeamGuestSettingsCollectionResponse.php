 ...
 */
class TeamGuestSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param TeamGuestSettings ...$items Variable number of TeamGuestSettings items
     * @return self
     */
    public function setValue(TeamGuestSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
