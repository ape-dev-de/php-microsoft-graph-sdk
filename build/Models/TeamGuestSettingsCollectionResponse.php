...
/**
 * Collection response for TeamGuestSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamGuestSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TeamGuestSettings[] $items
     * @return self
     */
    public function setValue(array|TeamGuestSettings $items, TeamGuestSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamGuestSettings> $value
     * @return self
     ...
     * 
     * @param TeamGuestSettings $item
     * @return self
     */
    public function addValue(TeamGuestSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamGuestSettings>
     */
