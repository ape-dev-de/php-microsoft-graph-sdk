 ...
 */
class AccessPackageAssignmentReviewSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param AccessPackageAssignmentReviewSettings ...$items Variable number of AccessPackageAssignmentReviewSettings items
     * @return self
     */
    public function setValue(AccessPackageAssignmentReviewSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
