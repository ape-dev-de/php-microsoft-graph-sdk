...
/**
 * Collection response for AccessPackageAssignmentReviewSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageAssignmentReviewSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageAssignmentReviewSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageAssignmentReviewSettings[] $items
     * @return self
     */
    public function setValue(array|AccessPackageAssignmentReviewSettings $items, AccessPackageAssignmentReviewSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageAssignmentReviewSettings> $value
     * @return self
     ...
     * 
     * @param AccessPackageAssignmentReviewSettings $item
     * @return self
     */
    public function addValue(AccessPackageAssignmentReviewSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageAssignmentReviewSettings>
     */
