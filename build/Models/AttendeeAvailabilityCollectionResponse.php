...
/**
 * Collection response for AttendeeAvailability
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttendeeAvailabilityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AttendeeAvailability[] $items
     * @return self
     */
    public function setValue(array|AttendeeAvailability $items, AttendeeAvailability ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttendeeAvailability> $value
     * @return self
     ...
     * 
     * @param AttendeeAvailability $item
     * @return self
     */
    public function addValue(AttendeeAvailability $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AttendeeAvailability|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AttendeeAvailability>
     */
