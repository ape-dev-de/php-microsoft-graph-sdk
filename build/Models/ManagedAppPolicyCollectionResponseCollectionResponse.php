...
/**
 * Collection response for ManagedAppPolicyCollectionResponse
 */
class ManagedAppPolicyCollectionResponseCollectionResponse
{
    /**
     * @var ManagedAppPolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedAppPolicyCollectionResponse ...$items Variable number of ManagedAppPolicyCollectionResponse items
     * @return self
     */
    public function setValue(ManagedAppPolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ManagedAppPolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ManagedAppPolicyCollectionResponse $item
     * @return self
     */
    public function addValue(ManagedAppPolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
