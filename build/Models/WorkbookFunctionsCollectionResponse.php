...
/**
 * Collection response for WorkbookFunctions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookFunctionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookFunctions[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookFunctions[] $items
     * @return self
     */
    public function setValue(array|WorkbookFunctions $items, WorkbookFunctions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookFunctions> $value
     * @return self
     ...
     * 
     * @param WorkbookFunctions $item
     * @return self
     */
    public function addValue(WorkbookFunctions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookFunctions>
     */
