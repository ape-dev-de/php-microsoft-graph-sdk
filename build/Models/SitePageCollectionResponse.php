...
/**
 * Collection response for SitePage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SitePageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SitePage[]
     */
     ...
     * 
     * @param SitePage[] $items
     * @return self
     */
    public function setValue(array|SitePage $items, SitePage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(SitePage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SitePage>
     */
