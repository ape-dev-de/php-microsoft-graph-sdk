...
/**
 * Collection response for SignInUserType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SignInUserTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SignInUserType[]
     */
     ...
     * 
     * @param SignInUserType[] $items
     * @return self
     */
    public function setValue(array|SignInUserType $items, SignInUserType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SignInUserType> $value
     * @return self
     ...
     * 
     * @param SignInUserType $item
     * @return self
     */
    public function addValue(SignInUserType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SignInUserType>
     */
