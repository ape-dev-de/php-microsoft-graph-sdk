...
/**
 * Collection response for ProtectionPolicyBaseCollectionResponse
 */
class ProtectionPolicyBaseCollectionResponseCollectionResponse
{
    /**
     * @var ProtectionPolicyBaseCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ProtectionPolicyBaseCollectionResponse ...$items Variable number of ProtectionPolicyBaseCollectionResponse items
     * @return self
     */
    public function setValue(ProtectionPolicyBaseCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ProtectionPolicyBaseCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ProtectionPolicyBaseCollectionResponse $item
     * @return self
     */
    public function addValue(ProtectionPolicyBaseCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
