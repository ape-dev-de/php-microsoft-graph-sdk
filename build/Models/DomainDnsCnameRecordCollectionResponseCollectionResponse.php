...
/**
 * Collection response for DomainDnsCnameRecordCollectionResponse
 */
class DomainDnsCnameRecordCollectionResponseCollectionResponse
{
    /**
     * @var DomainDnsCnameRecordCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DomainDnsCnameRecordCollectionResponse ...$items Variable number of DomainDnsCnameRecordCollectionResponse items
     * @return self
     */
    public function setValue(DomainDnsCnameRecordCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DomainDnsCnameRecordCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DomainDnsCnameRecordCollectionResponse $item
     * @return self
     */
    public function addValue(DomainDnsCnameRecordCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
