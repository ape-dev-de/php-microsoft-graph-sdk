...
/**
 * Collection response for Approval
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ApprovalCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Approval[]
     */
     ...
     * @return self
     */
    public function setValue(array|Approval $items, Approval ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Approval $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Approval>
     */
