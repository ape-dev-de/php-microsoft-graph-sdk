...
/**
 * Collection response for TeamworkTagMember
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamworkTagMemberCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TeamworkTagMember[] $items
     * @return self
     */
    public function setValue(array|TeamworkTagMember $items, TeamworkTagMember ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamworkTagMember> $value
     * @return self
     ...
     * 
     * @param TeamworkTagMember $item
     * @return self
     */
    public function addValue(TeamworkTagMember $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamworkTagMember>
     */
