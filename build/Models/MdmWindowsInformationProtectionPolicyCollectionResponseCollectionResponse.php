...
/**
 * Collection response for MdmWindowsInformationProtectionPolicyCollectionResponse
 */
class MdmWindowsInformationProtectionPolicyCollectionResponseCollectionResponse
{
    /**
     * @var MdmWindowsInformationProtectionPolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MdmWindowsInformationProtectionPolicyCollectionResponse ...$items Variable number of MdmWindowsInformationProtectionPolicyCollectionResponse items
     * @return self
     */
    public function setValue(MdmWindowsInformationProtectionPolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MdmWindowsInformationProtectionPolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MdmWindowsInformationProtectionPolicyCollectionResponse $item
     * @return self
     */
    public function addValue(MdmWindowsInformationProtectionPolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
