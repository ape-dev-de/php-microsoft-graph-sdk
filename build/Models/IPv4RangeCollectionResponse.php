...
/**
 * Collection response for IPv4Range
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IPv4RangeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IPv4Range[]
     */
     ...
     * 
     * @param IPv4Range[] $items
     * @return self
     */
    public function setValue(array|IPv4Range $items, IPv4Range ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param IPv4Range $item
     * @return self
     */
    public function addValue(IPv4Range $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IPv4Range>
     */
