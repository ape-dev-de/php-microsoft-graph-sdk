...
/**
 * Collection response for SubjectRightsRequestAllSiteLocation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SubjectRightsRequestAllSiteLocationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SubjectRightsRequestAllSiteLocation[]
     */
    private array $value = [];
     ...
     * 
     * @param SubjectRightsRequestAllSiteLocation[] $items
     * @return self
     */
    public function setValue(array|SubjectRightsRequestAllSiteLocation $items, SubjectRightsRequestAllSiteLocation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SubjectRightsRequestAllSiteLocation> $value
     * @return self
     ...
     * 
     * @param SubjectRightsRequestAllSiteLocation $item
     * @return self
     */
    public function addValue(SubjectRightsRequestAllSiteLocation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SubjectRightsRequestAllSiteLocation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SubjectRightsRequestAllSiteLocation>
     */
