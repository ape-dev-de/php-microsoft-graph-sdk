...
/**
 * SubjectRightsRequestAllSiteLocationCollectionResponse - Collection response
 */
class SubjectRightsRequestAllSiteLocationCollectionResponse
{
    /**
     * @var array<int, SubjectRightsRequestAllSiteLocation>
     */
    public array $value = [];
