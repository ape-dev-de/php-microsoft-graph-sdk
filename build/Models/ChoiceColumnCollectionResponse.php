...
/**
 * Collection response for ChoiceColumn
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChoiceColumnCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChoiceColumn[]
     */
     ...
     * 
     * @param ChoiceColumn[] $items
     * @return self
     */
    public function setValue(array|ChoiceColumn $items, ChoiceColumn ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChoiceColumn> $value
     * @return self
     ...
     * 
     * @param ChoiceColumn $item
     * @return self
     */
    public function addValue(ChoiceColumn $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ChoiceColumn>
     */
