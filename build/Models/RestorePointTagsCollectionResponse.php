...
/**
 * Collection response for RestorePointTags
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RestorePointTagsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RestorePointTags[]
     */
    private array $value = [];
     ...
     * 
     * @param RestorePointTags[] $items
     * @return self
     */
    public function setValue(array|RestorePointTags $items, RestorePointTags ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RestorePointTags> $value
     * @return self
     ...
     * 
     * @param RestorePointTags $item
     * @return self
     */
    public function addValue(RestorePointTags $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RestorePointTags>
     */
