...
/**
 * Collection response for IdentityGovernanceUserSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceUserSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceUserSummary[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceUserSummary[]
     */
     ...
     * 
     * @param IdentityGovernanceUserSummary[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceUserSummary $items, IdentityGovernanceUserSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceUserSummary> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceUserSummary $item
     * @return self
     */
    public function addValue(IdentityGovernanceUserSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceUserSummary|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceUserSummary>
     */
