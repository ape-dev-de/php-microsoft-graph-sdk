 ...
 */
class IdentityGovernanceUserSummaryCollectionResponse
{
    /**
     ...
     * 
     * @param IdentityGovernanceUserSummary ...$items Variable number of IdentityGovernanceUserSummary items
     * @return self
     */
    public function setValue(IdentityGovernanceUserSummary ...$items): self
    {
        $this->value = $items;
        return $this;
    }
