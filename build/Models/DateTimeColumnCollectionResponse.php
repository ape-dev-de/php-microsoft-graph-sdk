...
/**
 * Collection response for DateTimeColumn
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DateTimeColumnCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DateTimeColumn[]
     */
     ...
     * 
     * @param DateTimeColumn[] $items
     * @return self
     */
    public function setValue(array|DateTimeColumn $items, DateTimeColumn ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DateTimeColumn> $value
     * @return self
     ...
     * 
     * @param DateTimeColumn $item
     * @return self
     */
    public function addValue(DateTimeColumn $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DateTimeColumn>
     */
