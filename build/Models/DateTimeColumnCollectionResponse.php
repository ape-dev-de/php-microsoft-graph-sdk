 ...
 */
class DateTimeColumnCollectionResponse
{
    /**
     * @var DateTimeColumn[]
     */
     ...
     * 
     * @param DateTimeColumn ...$items Variable number of DateTimeColumn items
     * @return self
     */
    public function setValue(DateTimeColumn ...$items): self
    {
        $this->value = $items;
        return $this;
    }
