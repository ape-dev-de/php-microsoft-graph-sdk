...
/**
 * Collection response for SettingTemplateValue
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SettingTemplateValueCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SettingTemplateValue[] $items
     * @return self
     */
    public function setValue(array|SettingTemplateValue $items, SettingTemplateValue ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SettingTemplateValue> $value
     * @return self
     ...
     * 
     * @param SettingTemplateValue $item
     * @return self
     */
    public function addValue(SettingTemplateValue $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SettingTemplateValue|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SettingTemplateValue>
     */
