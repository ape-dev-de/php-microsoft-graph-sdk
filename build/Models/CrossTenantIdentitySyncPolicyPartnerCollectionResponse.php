 ...
 */
class CrossTenantIdentitySyncPolicyPartnerCollectionResponse
{
    /**
     ...
     * 
     * @param CrossTenantIdentitySyncPolicyPartner ...$items Variable number of CrossTenantIdentitySyncPolicyPartner items
     * @return self
     */
    public function setValue(CrossTenantIdentitySyncPolicyPartner ...$items): self
    {
        $this->value = $items;
        return $this;
    }
