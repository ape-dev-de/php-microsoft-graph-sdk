...
/**
 * Collection response for CrossTenantIdentitySyncPolicyPartner
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CrossTenantIdentitySyncPolicyPartnerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CrossTenantIdentitySyncPolicyPartner[]
     */
    private array $value = [];
     ...
     * 
     * @param CrossTenantIdentitySyncPolicyPartner[] $items
     * @return self
     */
    public function setValue(array|CrossTenantIdentitySyncPolicyPartner $items, CrossTenantIdentitySyncPolicyPartner ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CrossTenantIdentitySyncPolicyPartner> $value
     * @return self
     ...
     * 
     * @param CrossTenantIdentitySyncPolicyPartner $item
     * @return self
     */
    public function addValue(CrossTenantIdentitySyncPolicyPartner $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CrossTenantIdentitySyncPolicyPartner>
     */
