...
/**
 * Collection response for PublicationFacet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PublicationFacetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PublicationFacet[] $items
     * @return self
     */
    public function setValue(array|PublicationFacet $items, PublicationFacet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PublicationFacet> $value
     * @return self
     ...
     * 
     * @param PublicationFacet $item
     * @return self
     */
    public function addValue(PublicationFacet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PublicationFacet>
     */
