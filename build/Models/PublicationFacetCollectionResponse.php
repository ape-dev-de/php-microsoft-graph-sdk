 ...
 */
class PublicationFacetCollectionResponse
{
    /**
     ...
     * 
     * @param PublicationFacet ...$items Variable number of PublicationFacet items
     * @return self
     */
    public function setValue(PublicationFacet ...$items): self
    {
        $this->value = $items;
        return $this;
    }
