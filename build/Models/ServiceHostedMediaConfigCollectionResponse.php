...
/**
 * Collection response for ServiceHostedMediaConfig
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServiceHostedMediaConfigCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ServiceHostedMediaConfig[] $items
     * @return self
     */
    public function setValue(array|ServiceHostedMediaConfig $items, ServiceHostedMediaConfig ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServiceHostedMediaConfig> $value
     * @return self
     ...
     * 
     * @param ServiceHostedMediaConfig $item
     * @return self
     */
    public function addValue(ServiceHostedMediaConfig $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ServiceHostedMediaConfig|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ServiceHostedMediaConfig>
     */
