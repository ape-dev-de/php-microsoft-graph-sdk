 ...
 */
class ServiceHostedMediaConfigCollectionResponse
{
    /**
     ...
     * 
     * @param ServiceHostedMediaConfig ...$items Variable number of ServiceHostedMediaConfig items
     * @return self
     */
    public function setValue(ServiceHostedMediaConfig ...$items): self
    {
        $this->value = $items;
        return $this;
    }
