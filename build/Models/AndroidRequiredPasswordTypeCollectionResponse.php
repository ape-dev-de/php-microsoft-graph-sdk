...
/**
 * Collection response for AndroidRequiredPasswordType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AndroidRequiredPasswordTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AndroidRequiredPasswordType[]
     */
    private array $value = [];
     ...
     * 
     * @return AndroidRequiredPasswordType[]
     */
     ...
     * 
     * @param AndroidRequiredPasswordType[] $items
     * @return self
     */
    public function setValue(array|AndroidRequiredPasswordType $items, AndroidRequiredPasswordType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AndroidRequiredPasswordType> $value
     * @return self
     ...
     * 
     * @param AndroidRequiredPasswordType $item
     * @return self
     */
    public function addValue(AndroidRequiredPasswordType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AndroidRequiredPasswordType>
     */
