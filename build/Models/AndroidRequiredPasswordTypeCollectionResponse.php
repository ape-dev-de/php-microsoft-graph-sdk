...
/**
 * AndroidRequiredPasswordTypeCollectionResponse - Collection response
 */
class AndroidRequiredPasswordTypeCollectionResponse
{
    /**
     * @var array<int, AndroidRequiredPasswordType>
     */
    public array $value = [];
