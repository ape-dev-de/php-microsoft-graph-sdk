...
/**
 * Collection response for CopilotAdminLimitedMode
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CopilotAdminLimitedModeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CopilotAdminLimitedMode[]
     */
    private array $value = [];
     ...
     * 
     * @param CopilotAdminLimitedMode[] $items
     * @return self
     */
    public function setValue(array|CopilotAdminLimitedMode $items, CopilotAdminLimitedMode ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CopilotAdminLimitedMode> $value
     * @return self
     ...
     * 
     * @param CopilotAdminLimitedMode $item
     * @return self
     */
    public function addValue(CopilotAdminLimitedMode $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CopilotAdminLimitedMode>
     */
