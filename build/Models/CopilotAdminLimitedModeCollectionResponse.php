 ...
 */
class CopilotAdminLimitedModeCollectionResponse
{
    /**
     ...
     * 
     * @param CopilotAdminLimitedMode ...$items Variable number of CopilotAdminLimitedMode items
     * @return self
     */
    public function setValue(CopilotAdminLimitedMode ...$items): self
    {
        $this->value = $items;
        return $this;
    }
