 ...
 */
class SynchronizationQuarantineCollectionResponse
{
    /**
     ...
     * 
     * @param SynchronizationQuarantine ...$items Variable number of SynchronizationQuarantine items
     * @return self
     */
    public function setValue(SynchronizationQuarantine ...$items): self
    {
        $this->value = $items;
        return $this;
    }
