...
/**
 * Collection response for SynchronizationQuarantine
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationQuarantineCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SynchronizationQuarantine[]
     */
    private array $value = [];
     ...
     * 
     * @param SynchronizationQuarantine[] $items
     * @return self
     */
    public function setValue(array|SynchronizationQuarantine $items, SynchronizationQuarantine ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SynchronizationQuarantine> $value
     * @return self
     ...
     * 
     * @param SynchronizationQuarantine $item
     * @return self
     */
    public function addValue(SynchronizationQuarantine $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SynchronizationQuarantine>
     */
