...
/**
 * Collection response for SecurityHyperlink
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHyperlinkCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityHyperlink[] $items
     * @return self
     */
    public function setValue(array|SecurityHyperlink $items, SecurityHyperlink ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHyperlink> $value
     * @return self
     ...
     * 
     * @param SecurityHyperlink $item
     * @return self
     */
    public function addValue(SecurityHyperlink $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityHyperlink>
     */
