...
/**
 * Collection response for EdgeSearchEngineType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EdgeSearchEngineTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EdgeSearchEngineType[]
     */
    private array $value = [];
     ...
     * 
     * @param EdgeSearchEngineType[] $items
     * @return self
     */
    public function setValue(array|EdgeSearchEngineType $items, EdgeSearchEngineType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EdgeSearchEngineType> $value
     * @return self
     ...
     * 
     * @param EdgeSearchEngineType $item
     * @return self
     */
    public function addValue(EdgeSearchEngineType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EdgeSearchEngineType>
     */
