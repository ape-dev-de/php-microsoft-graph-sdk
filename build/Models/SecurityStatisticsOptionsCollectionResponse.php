...
/**
 * SecurityStatisticsOptionsCollectionResponse - Collection response
 */
class SecurityStatisticsOptionsCollectionResponse
{
    /**
     * @var array<int, SecurityStatisticsOptions>
     */
    public array $value = [];
