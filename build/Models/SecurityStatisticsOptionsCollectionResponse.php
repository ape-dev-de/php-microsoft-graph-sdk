...
/**
 * Collection response for SecurityStatisticsOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityStatisticsOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityStatisticsOptions[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityStatisticsOptions[]
     */
     ...
     * 
     * @param SecurityStatisticsOptions[] $items
     * @return self
     */
    public function setValue(array|SecurityStatisticsOptions $items, SecurityStatisticsOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityStatisticsOptions> $value
     * @return self
     ...
     * 
     * @param SecurityStatisticsOptions $item
     * @return self
     */
    public function addValue(SecurityStatisticsOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityStatisticsOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityStatisticsOptions>
     */
