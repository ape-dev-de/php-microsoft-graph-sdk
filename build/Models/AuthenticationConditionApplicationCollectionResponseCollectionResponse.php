...
/**
 * Collection response for AuthenticationConditionApplicationCollectionResponse
 */
class AuthenticationConditionApplicationCollectionResponseCollectionResponse
{
    /**
     * @var AuthenticationConditionApplicationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AuthenticationConditionApplicationCollectionResponse ...$items Variable number of AuthenticationConditionApplicationCollectionResponse items
     * @return self
     */
    public function setValue(AuthenticationConditionApplicationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AuthenticationConditionApplicationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AuthenticationConditionApplicationCollectionResponse $item
     * @return self
     */
    public function addValue(AuthenticationConditionApplicationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
