...
/**
 * Collection response for ObjectFlowTypes
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ObjectFlowTypesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ObjectFlowTypes[]
     */
     ...
     * 
     * @param ObjectFlowTypes[] $items
     * @return self
     */
    public function setValue(array|ObjectFlowTypes $items, ObjectFlowTypes ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ObjectFlowTypes> $value
     * @return self
     ...
     * 
     * @param ObjectFlowTypes $item
     * @return self
     */
    public function addValue(ObjectFlowTypes $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ObjectFlowTypes>
     */
