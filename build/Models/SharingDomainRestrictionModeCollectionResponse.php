...
/**
 * Collection response for SharingDomainRestrictionMode
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SharingDomainRestrictionModeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SharingDomainRestrictionMode[] $items
     * @return self
     */
    public function setValue(array|SharingDomainRestrictionMode $items, SharingDomainRestrictionMode ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SharingDomainRestrictionMode> $value
     * @return self
     ...
     * 
     * @param SharingDomainRestrictionMode $item
     * @return self
     */
    public function addValue(SharingDomainRestrictionMode $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SharingDomainRestrictionMode>
     */
