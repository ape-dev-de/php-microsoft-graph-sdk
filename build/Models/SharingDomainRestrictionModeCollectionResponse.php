...
/**
 * SharingDomainRestrictionModeCollectionResponse - Collection response
 */
class SharingDomainRestrictionModeCollectionResponse
{
    /**
     * @var array<int, SharingDomainRestrictionMode>
     */
    public array $value = [];
