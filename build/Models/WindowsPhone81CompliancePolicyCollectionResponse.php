...
/**
 * Collection response for WindowsPhone81CompliancePolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsPhone81CompliancePolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WindowsPhone81CompliancePolicy[] $items
     * @return self
     */
    public function setValue(array|WindowsPhone81CompliancePolicy $items, WindowsPhone81CompliancePolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsPhone81CompliancePolicy> $value
     * @return self
     ...
     * 
     * @param WindowsPhone81CompliancePolicy $item
     * @return self
     */
    public function addValue(WindowsPhone81CompliancePolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WindowsPhone81CompliancePolicy|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WindowsPhone81CompliancePolicy>
     */
