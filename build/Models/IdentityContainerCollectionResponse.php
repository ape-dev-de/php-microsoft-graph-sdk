 ...
 */
class IdentityContainerCollectionResponse
{
    /**
     ...
     * 
     * @param IdentityContainer ...$items Variable number of IdentityContainer items
     * @return self
     */
    public function setValue(IdentityContainer ...$items): self
    {
        $this->value = $items;
        return $this;
    }
