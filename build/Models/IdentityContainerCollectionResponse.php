...
/**
 * Collection response for IdentityContainer
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityContainerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityContainer[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityContainer[] $items
     * @return self
     */
    public function setValue(array|IdentityContainer $items, IdentityContainer ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityContainer> $value
     * @return self
     ...
     * 
     * @param IdentityContainer $item
     * @return self
     */
    public function addValue(IdentityContainer $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityContainer>
     */
