...
/**
 * Collection response for PrinterCreateOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrinterCreateOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrinterCreateOperation[]
     */
    private array $value = [];
     ...
     * 
     * @param PrinterCreateOperation[] $items
     * @return self
     */
    public function setValue(array|PrinterCreateOperation $items, PrinterCreateOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrinterCreateOperation> $value
     * @return self
     ...
     * 
     * @param PrinterCreateOperation $item
     * @return self
     */
    public function addValue(PrinterCreateOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PrinterCreateOperation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PrinterCreateOperation>
     */
