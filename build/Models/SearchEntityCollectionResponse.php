...
/**
 * Collection response for SearchEntity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SearchEntityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SearchEntity[]
     */
     ...
     * 
     * @param SearchEntity[] $items
     * @return self
     */
    public function setValue(array|SearchEntity $items, SearchEntity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SearchEntity> $value
     * @return self
     ...
     * 
     * @param SearchEntity $item
     * @return self
     */
    public function addValue(SearchEntity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SearchEntity>
     */
