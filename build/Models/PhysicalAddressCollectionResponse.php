...
/**
 * Collection response for PhysicalAddress
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PhysicalAddressCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PhysicalAddress[]
     */
     ...
     * 
     * @param PhysicalAddress[] $items
     * @return self
     */
    public function setValue(array|PhysicalAddress $items, PhysicalAddress ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PhysicalAddress> $value
     * @return self
     ...
     * 
     * @param PhysicalAddress $item
     * @return self
     */
    public function addValue(PhysicalAddress $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PhysicalAddress>
     */
