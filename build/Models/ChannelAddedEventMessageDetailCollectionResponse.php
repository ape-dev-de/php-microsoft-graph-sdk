...
/**
 * Collection response for ChannelAddedEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChannelAddedEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChannelAddedEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param ChannelAddedEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|ChannelAddedEventMessageDetail $items, ChannelAddedEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChannelAddedEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param ChannelAddedEventMessageDetail $item
     * @return self
     */
    public function addValue(ChannelAddedEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ChannelAddedEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ChannelAddedEventMessageDetail>
     */
