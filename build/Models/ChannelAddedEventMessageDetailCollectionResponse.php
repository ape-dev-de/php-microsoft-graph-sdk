 ...
 */
class ChannelAddedEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param ChannelAddedEventMessageDetail ...$items Variable number of ChannelAddedEventMessageDetail items
     * @return self
     */
    public function setValue(ChannelAddedEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
