...
/**
 * Collection response for SecurityHostCollectionResponse
 */
class SecurityHostCollectionResponseCollectionResponse
{
    /**
     * @var SecurityHostCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityHostCollectionResponse ...$items Variable number of SecurityHostCollectionResponse items
     * @return self
     */
    public function setValue(SecurityHostCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityHostCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityHostCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityHostCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
