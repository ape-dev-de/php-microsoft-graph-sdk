...
/**
 * Collection response for FileSecurityState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FileSecurityStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FileSecurityState[]
     */
    private array $value = [];
     ...
     * 
     * @param FileSecurityState[] $items
     * @return self
     */
    public function setValue(array|FileSecurityState $items, FileSecurityState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FileSecurityState> $value
     * @return self
     ...
     * 
     * @param FileSecurityState $item
     * @return self
     */
    public function addValue(FileSecurityState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FileSecurityState>
     */
