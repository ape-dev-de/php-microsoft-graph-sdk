...
class Teamwork
{
    ...
    /**
     */
    private ?string $workforceIntegrations;
    ...
    public function getWorkforceIntegrations(): ?string
    {
        return $this->workforceIntegrations;
    }

    public function setWorkforceIntegrations(?string $workforceIntegrations): self
    {
