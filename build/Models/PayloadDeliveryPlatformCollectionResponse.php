...
/**
 * Collection response for PayloadDeliveryPlatform
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PayloadDeliveryPlatformCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PayloadDeliveryPlatform[]
     */
    private array $value = [];
     ...
     * 
     * @return PayloadDeliveryPlatform[]
     */
     ...
     * 
     * @param PayloadDeliveryPlatform[] $items
     * @return self
     */
    public function setValue(array|PayloadDeliveryPlatform $items, PayloadDeliveryPlatform ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PayloadDeliveryPlatform> $value
     * @return self
     ...
     * 
     * @param PayloadDeliveryPlatform $item
     * @return self
     */
    public function addValue(PayloadDeliveryPlatform $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PayloadDeliveryPlatform>
     */
