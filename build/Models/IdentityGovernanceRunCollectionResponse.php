...
/**
 * Collection response for IdentityGovernanceRun
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceRunCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IdentityGovernanceRun[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceRun $items, IdentityGovernanceRun ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceRun> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceRun $item
     * @return self
     */
    public function addValue(IdentityGovernanceRun $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceRun>
     */
