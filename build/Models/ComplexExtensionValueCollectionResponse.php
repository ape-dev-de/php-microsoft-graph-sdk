...
/**
 * Collection response for ComplexExtensionValue
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ComplexExtensionValueCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ComplexExtensionValue[]
     */
    private array $value = [];
     ...
     * 
     * @param ComplexExtensionValue[] $items
     * @return self
     */
    public function setValue(array|ComplexExtensionValue $items, ComplexExtensionValue ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ComplexExtensionValue> $value
     * @return self
     ...
     * 
     * @param ComplexExtensionValue $item
     * @return self
     */
    public function addValue(ComplexExtensionValue $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ComplexExtensionValue|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ComplexExtensionValue>
     */
