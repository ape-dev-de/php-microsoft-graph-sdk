...
/**
 * Collection response for DomainDnsSrvRecord
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DomainDnsSrvRecordCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DomainDnsSrvRecord[]
     */
    private array $value = [];
     ...
     * 
     * @param DomainDnsSrvRecord[] $items
     * @return self
     */
    public function setValue(array|DomainDnsSrvRecord $items, DomainDnsSrvRecord ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DomainDnsSrvRecord> $value
     * @return self
     ...
     * 
     * @param DomainDnsSrvRecord $item
     * @return self
     */
    public function addValue(DomainDnsSrvRecord $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return DomainDnsSrvRecord|null
     */
     ...
     * 
     * @return \ArrayIterator<int, DomainDnsSrvRecord>
     */
