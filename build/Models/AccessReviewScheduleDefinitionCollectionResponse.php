...
/**
 * Collection response for AccessReviewScheduleDefinition
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewScheduleDefinitionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessReviewScheduleDefinition[] $items
     * @return self
     */
    public function setValue(array|AccessReviewScheduleDefinition $items, AccessReviewScheduleDefinition ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewScheduleDefinition> $value
     * @return self
     ...
     * 
     * @param AccessReviewScheduleDefinition $item
     * @return self
     */
    public function addValue(AccessReviewScheduleDefinition $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewScheduleDefinition>
     */
