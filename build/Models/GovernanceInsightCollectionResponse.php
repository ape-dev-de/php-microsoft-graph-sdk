...
/**
 * Collection response for GovernanceInsight
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class GovernanceInsightCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param GovernanceInsight[] $items
     * @return self
     */
    public function setValue(array|GovernanceInsight $items, GovernanceInsight ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<GovernanceInsight> $value
     * @return self
     ...
     * 
     * @param GovernanceInsight $item
     * @return self
     */
    public function addValue(GovernanceInsight $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, GovernanceInsight>
     */
