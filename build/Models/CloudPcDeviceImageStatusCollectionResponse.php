...
/**
 * Collection response for CloudPcDeviceImageStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcDeviceImageStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudPcDeviceImageStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return CloudPcDeviceImageStatus[]
     */
     ...
     * 
     * @param CloudPcDeviceImageStatus[] $items
     * @return self
     */
    public function setValue(array|CloudPcDeviceImageStatus $items, CloudPcDeviceImageStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcDeviceImageStatus> $value
     * @return self
     ...
     * 
     * @param CloudPcDeviceImageStatus $item
     * @return self
     */
    public function addValue(CloudPcDeviceImageStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcDeviceImageStatus>
     */
