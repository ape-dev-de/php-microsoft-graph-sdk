...
/**
 * Collection response for CustomExtensionCallbackConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CustomExtensionCallbackConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CustomExtensionCallbackConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param CustomExtensionCallbackConfiguration[] $items
     * @return self
     */
    public function setValue(array|CustomExtensionCallbackConfiguration $items, CustomExtensionCallbackConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CustomExtensionCallbackConfiguration> $value
     * @return self
     ...
     * 
     * @param CustomExtensionCallbackConfiguration $item
     * @return self
     */
    public function addValue(CustomExtensionCallbackConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CustomExtensionCallbackConfiguration>
     */
