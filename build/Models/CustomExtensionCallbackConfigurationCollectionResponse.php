 ...
 */
class CustomExtensionCallbackConfigurationCollectionResponse
{
    /**
     ...
     * 
     * @param CustomExtensionCallbackConfiguration ...$items Variable number of CustomExtensionCallbackConfiguration items
     * @return self
     */
    public function setValue(CustomExtensionCallbackConfiguration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
