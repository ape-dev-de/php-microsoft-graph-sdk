...
class Windows10EndpointProtectionConfiguration
{
     ...
     * @var string[]
     */
    private array $defenderAdditionalGuardedFolders = [];

    /**
     * List of exe files and folders to be excluded from attack surface reduction rules
     * @var string[]
     */
    private array $defenderAttackSurfaceReductionExcludedPaths = [];
     ...
     * @var string[]
     */
    private array $defenderGuardedFoldersAllowedAppPaths = [];
    ...
    /**
     * @param string[] $defenderAdditionalGuardedFolders
     */
    public function setDefenderAdditionalGuardedFolders(array $defenderAdditionalGuardedFolders): self
    {
    ...
    /**
     * @param string[] $defenderAttackSurfaceReductionExcludedPaths
     */
    public function setDefenderAttackSurfaceReductionExcludedPaths(array $defenderAttackSurfaceReductionExcludedPaths): self
    {
    ...
    /**
     * @param string[] $defenderGuardedFoldersAllowedAppPaths
     */
    public function setDefenderGuardedFoldersAllowedAppPaths(array $defenderGuardedFoldersAllowedAppPaths): self
    {
