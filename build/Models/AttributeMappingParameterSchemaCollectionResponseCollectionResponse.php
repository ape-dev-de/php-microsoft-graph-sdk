...
/**
 * Collection response for AttributeMappingParameterSchemaCollectionResponse
 */
class AttributeMappingParameterSchemaCollectionResponseCollectionResponse
{
    /**
     * @var AttributeMappingParameterSchemaCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AttributeMappingParameterSchemaCollectionResponse ...$items Variable number of AttributeMappingParameterSchemaCollectionResponse items
     * @return self
     */
    public function setValue(AttributeMappingParameterSchemaCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AttributeMappingParameterSchemaCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AttributeMappingParameterSchemaCollectionResponse $item
     * @return self
     */
    public function addValue(AttributeMappingParameterSchemaCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
