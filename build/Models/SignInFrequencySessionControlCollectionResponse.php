...
/**
 * Collection response for SignInFrequencySessionControl
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SignInFrequencySessionControlCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SignInFrequencySessionControl[]
     */
    private array $value = [];
     ...
     * 
     * @param SignInFrequencySessionControl[] $items
     * @return self
     */
    public function setValue(array|SignInFrequencySessionControl $items, SignInFrequencySessionControl ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SignInFrequencySessionControl> $value
     * @return self
     ...
     * 
     * @param SignInFrequencySessionControl $item
     * @return self
     */
    public function addValue(SignInFrequencySessionControl $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SignInFrequencySessionControl>
     */
