 ...
 */
class SignInFrequencySessionControlCollectionResponse
{
    /**
     ...
     * 
     * @param SignInFrequencySessionControl ...$items Variable number of SignInFrequencySessionControl items
     * @return self
     */
    public function setValue(SignInFrequencySessionControl ...$items): self
    {
        $this->value = $items;
        return $this;
    }
