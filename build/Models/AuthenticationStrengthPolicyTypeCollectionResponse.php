...
/**
 * Collection response for AuthenticationStrengthPolicyType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationStrengthPolicyTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuthenticationStrengthPolicyType[]
     */
    private array $value = [];
     ...
     * 
     * @return AuthenticationStrengthPolicyType[]
     */
     ...
     * 
     * @param AuthenticationStrengthPolicyType[] $items
     * @return self
     */
    public function setValue(array|AuthenticationStrengthPolicyType $items, AuthenticationStrengthPolicyType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationStrengthPolicyType> $value
     * @return self
     ...
     * 
     * @param AuthenticationStrengthPolicyType $item
     * @return self
     */
    public function addValue(AuthenticationStrengthPolicyType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationStrengthPolicyType>
     */
