...
/**
 * AuthenticationStrengthPolicyTypeCollectionResponse - Collection response
 */
class AuthenticationStrengthPolicyTypeCollectionResponse
{
    /**
     * @var array<int, AuthenticationStrengthPolicyType>
     */
    public array $value = [];
