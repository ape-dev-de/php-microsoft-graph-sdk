...
/**
 * Collection response for TeamsAsyncOperationType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamsAsyncOperationTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return TeamsAsyncOperationType[]
     */
     ...
     * 
     * @param TeamsAsyncOperationType[] $items
     * @return self
     */
    public function setValue(array|TeamsAsyncOperationType $items, TeamsAsyncOperationType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamsAsyncOperationType> $value
     * @return self
     ...
     * 
     * @param TeamsAsyncOperationType $item
     * @return self
     */
    public function addValue(TeamsAsyncOperationType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamsAsyncOperationType>
     */
