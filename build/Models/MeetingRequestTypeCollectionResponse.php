...
/**
 * Collection response for MeetingRequestType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MeetingRequestTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MeetingRequestType[] $items
     * @return self
     */
    public function setValue(array|MeetingRequestType $items, MeetingRequestType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MeetingRequestType> $value
     * @return self
     ...
     * 
     * @param MeetingRequestType $item
     * @return self
     */
    public function addValue(MeetingRequestType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MeetingRequestType>
     */
