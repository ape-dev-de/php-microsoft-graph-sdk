...
/**
 * Collection response for WorkbookOperationError
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookOperationErrorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookOperationError[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookOperationError[] $items
     * @return self
     */
    public function setValue(array|WorkbookOperationError $items, WorkbookOperationError ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookOperationError> $value
     * @return self
     ...
     * 
     * @param WorkbookOperationError $item
     * @return self
     */
    public function addValue(WorkbookOperationError $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookOperationError>
     */
