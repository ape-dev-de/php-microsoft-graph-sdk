 ...
 */
class WorkbookOperationErrorCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookOperationError ...$items Variable number of WorkbookOperationError items
     * @return self
     */
    public function setValue(WorkbookOperationError ...$items): self
    {
        $this->value = $items;
        return $this;
    }
