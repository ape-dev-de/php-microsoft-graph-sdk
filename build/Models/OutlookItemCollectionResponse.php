...
/**
 * Collection response for OutlookItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OutlookItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OutlookItem[]
     */
     ...
     * 
     * @param OutlookItem[] $items
     * @return self
     */
    public function setValue(array|OutlookItem $items, OutlookItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param OutlookItem $item
     * @return self
     */
    public function addValue(OutlookItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OutlookItem>
     */
