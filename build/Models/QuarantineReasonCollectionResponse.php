...
/**
 * Collection response for QuarantineReason
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class QuarantineReasonCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param QuarantineReason[] $items
     * @return self
     */
    public function setValue(array|QuarantineReason $items, QuarantineReason ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<QuarantineReason> $value
     * @return self
     ...
     * 
     * @param QuarantineReason $item
     * @return self
     */
    public function addValue(QuarantineReason $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, QuarantineReason>
     */
