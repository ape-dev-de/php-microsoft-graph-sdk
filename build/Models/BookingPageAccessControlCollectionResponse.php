...
/**
 * Collection response for BookingPageAccessControl
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingPageAccessControlCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BookingPageAccessControl[]
     */
    private array $value = [];
     ...
     * 
     * @return BookingPageAccessControl[]
     */
     ...
     * 
     * @param BookingPageAccessControl[] $items
     * @return self
     */
    public function setValue(array|BookingPageAccessControl $items, BookingPageAccessControl ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingPageAccessControl> $value
     * @return self
     ...
     * 
     * @param BookingPageAccessControl $item
     * @return self
     */
    public function addValue(BookingPageAccessControl $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BookingPageAccessControl>
     */
