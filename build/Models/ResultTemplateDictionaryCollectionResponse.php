...
/**
 * Collection response for ResultTemplateDictionary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ResultTemplateDictionaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ResultTemplateDictionary[]
     */
    private array $value = [];
     ...
     * 
     * @param ResultTemplateDictionary[] $items
     * @return self
     */
    public function setValue(array|ResultTemplateDictionary $items, ResultTemplateDictionary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ResultTemplateDictionary> $value
     * @return self
     ...
     * 
     * @param ResultTemplateDictionary $item
     * @return self
     */
    public function addValue(ResultTemplateDictionary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ResultTemplateDictionary>
     */
