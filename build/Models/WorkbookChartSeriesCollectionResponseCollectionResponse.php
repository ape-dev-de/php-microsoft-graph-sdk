...
/**
 * Collection response for WorkbookChartSeriesCollectionResponse
 */
class WorkbookChartSeriesCollectionResponseCollectionResponse
{
    /**
     * @var WorkbookChartSeriesCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookChartSeriesCollectionResponse ...$items Variable number of WorkbookChartSeriesCollectionResponse items
     * @return self
     */
    public function setValue(WorkbookChartSeriesCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WorkbookChartSeriesCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WorkbookChartSeriesCollectionResponse $item
     * @return self
     */
    public function addValue(WorkbookChartSeriesCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
