...
/**
 * PlannerExternalReferencesCollectionResponse - Collection response
 */
class PlannerExternalReferencesCollectionResponse
{
    /**
     * @var array<int, PlannerExternalReferences>
     */
    public array $value = [];
