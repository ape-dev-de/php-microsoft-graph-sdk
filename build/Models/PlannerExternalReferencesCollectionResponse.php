...
/**
 * Collection response for PlannerExternalReferences
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerExternalReferencesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PlannerExternalReferences[] $items
     * @return self
     */
    public function setValue(array|PlannerExternalReferences $items, PlannerExternalReferences ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PlannerExternalReferences> $value
     * @return self
     ...
     * 
     * @param PlannerExternalReferences $item
     * @return self
     */
    public function addValue(PlannerExternalReferences $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PlannerExternalReferences>
     */
