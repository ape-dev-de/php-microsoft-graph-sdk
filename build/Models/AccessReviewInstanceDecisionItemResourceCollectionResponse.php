 ...
 */
class AccessReviewInstanceDecisionItemResourceCollectionResponse
{
    /**
     ...
     * 
     * @param AccessReviewInstanceDecisionItemResource ...$items Variable number of AccessReviewInstanceDecisionItemResource items
     * @return self
     */
    public function setValue(AccessReviewInstanceDecisionItemResource ...$items): self
    {
        $this->value = $items;
        return $this;
    }
