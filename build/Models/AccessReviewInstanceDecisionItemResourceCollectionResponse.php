...
/**
 * Collection response for AccessReviewInstanceDecisionItemResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewInstanceDecisionItemResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessReviewInstanceDecisionItemResource[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessReviewInstanceDecisionItemResource[] $items
     * @return self
     */
    public function setValue(array|AccessReviewInstanceDecisionItemResource $items, AccessReviewInstanceDecisionItemResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewInstanceDecisionItemResource> $value
     * @return self
     ...
     * 
     * @param AccessReviewInstanceDecisionItemResource $item
     * @return self
     */
    public function addValue(AccessReviewInstanceDecisionItemResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewInstanceDecisionItemResource>
     */
