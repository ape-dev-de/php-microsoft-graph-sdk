...
/**
 * Collection response for X509CertificateCRLValidationConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class X509CertificateCRLValidationConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var X509CertificateCRLValidationConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param X509CertificateCRLValidationConfiguration[] $items
     * @return self
     */
    public function setValue(array|X509CertificateCRLValidationConfiguration $items, X509CertificateCRLValidationConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<X509CertificateCRLValidationConfiguration> $value
     * @return self
     ...
     * 
     * @param X509CertificateCRLValidationConfiguration $item
     * @return self
     */
    public function addValue(X509CertificateCRLValidationConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, X509CertificateCRLValidationConfiguration>
     */
