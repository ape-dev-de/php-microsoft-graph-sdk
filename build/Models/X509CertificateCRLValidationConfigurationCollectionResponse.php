 ...
 */
class X509CertificateCRLValidationConfigurationCollectionResponse
{
    /**
     ...
     * 
     * @param X509CertificateCRLValidationConfiguration ...$items Variable number of X509CertificateCRLValidationConfiguration items
     * @return self
     */
    public function setValue(X509CertificateCRLValidationConfiguration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
