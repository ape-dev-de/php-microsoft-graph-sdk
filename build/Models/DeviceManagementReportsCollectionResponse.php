...
/**
 * Collection response for DeviceManagementReports
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceManagementReportsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceManagementReports[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceManagementReports[] $items
     * @return self
     */
    public function setValue(array|DeviceManagementReports $items, DeviceManagementReports ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceManagementReports> $value
     * @return self
     ...
     * 
     * @param DeviceManagementReports $item
     * @return self
     */
    public function addValue(DeviceManagementReports $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceManagementReports>
     */
