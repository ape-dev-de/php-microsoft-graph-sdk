 ...
 */
class DeviceManagementReportsCollectionResponse
{
    /**
     ...
     * 
     * @param DeviceManagementReports ...$items Variable number of DeviceManagementReports items
     * @return self
     */
    public function setValue(DeviceManagementReports ...$items): self
    {
        $this->value = $items;
        return $this;
    }
