...
/**
 * Collection response for UserExperienceAnalyticsModelScores
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsModelScoresCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsModelScores[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsModelScores $items, UserExperienceAnalyticsModelScores ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsModelScores> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsModelScores $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsModelScores $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsModelScores>
     */
