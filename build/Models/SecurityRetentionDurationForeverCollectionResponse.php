...
/**
 * Collection response for SecurityRetentionDurationForever
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityRetentionDurationForeverCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityRetentionDurationForever[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityRetentionDurationForever[]
     */
     ...
     * 
     * @param SecurityRetentionDurationForever[] $items
     * @return self
     */
    public function setValue(array|SecurityRetentionDurationForever $items, SecurityRetentionDurationForever ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityRetentionDurationForever> $value
     * @return self
     ...
     * 
     * @param SecurityRetentionDurationForever $item
     * @return self
     */
    public function addValue(SecurityRetentionDurationForever $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityRetentionDurationForever|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityRetentionDurationForever>
     */
