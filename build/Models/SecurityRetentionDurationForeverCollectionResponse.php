...
/**
 * SecurityRetentionDurationForeverCollectionResponse - Collection response
 */
class SecurityRetentionDurationForeverCollectionResponse
{
    /**
     * @var array<int, SecurityRetentionDurationForever>
     */
    public array $value = [];
