...
/**
 * Collection response for DeviceManagementPartnerTenantState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceManagementPartnerTenantStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceManagementPartnerTenantState[]
     */
    private array $value = [];
     ...
     * 
     * @return DeviceManagementPartnerTenantState[]
     */
     ...
     * 
     * @param DeviceManagementPartnerTenantState[] $items
     * @return self
     */
    public function setValue(array|DeviceManagementPartnerTenantState $items, DeviceManagementPartnerTenantState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceManagementPartnerTenantState> $value
     * @return self
     ...
     * 
     * @param DeviceManagementPartnerTenantState $item
     * @return self
     */
    public function addValue(DeviceManagementPartnerTenantState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceManagementPartnerTenantState>
     */
