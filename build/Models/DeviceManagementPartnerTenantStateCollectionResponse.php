...
/**
 * DeviceManagementPartnerTenantStateCollectionResponse - Collection response
 */
class DeviceManagementPartnerTenantStateCollectionResponse
{
    /**
     * @var array<int, DeviceManagementPartnerTenantState>
     */
    public array $value = [];
