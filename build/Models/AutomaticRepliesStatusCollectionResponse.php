...
/**
 * Collection response for AutomaticRepliesStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AutomaticRepliesStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AutomaticRepliesStatus[] $items
     * @return self
     */
    public function setValue(array|AutomaticRepliesStatus $items, AutomaticRepliesStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AutomaticRepliesStatus> $value
     * @return self
     ...
     * 
     * @param AutomaticRepliesStatus $item
     * @return self
     */
    public function addValue(AutomaticRepliesStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AutomaticRepliesStatus>
     */
