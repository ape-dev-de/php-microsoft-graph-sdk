...
class AccessReviewStageSettings
{
     ...
     */
    private ?string $decisionsThatWillMoveToNextStage;
    ...
    public function getDecisionsThatWillMoveToNextStage(): ?string
    {
        return $this->decisionsThatWillMoveToNextStage;
    }

    public function setDecisionsThatWillMoveToNextStage(?string $decisionsThatWillMoveToNextStage): self
    {
