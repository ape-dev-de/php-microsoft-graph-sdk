...
/**
 * Collection response for MicrosoftManagedDesktop
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MicrosoftManagedDesktopCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MicrosoftManagedDesktop[]
     */
    private array $value = [];
     ...
     * 
     * @param MicrosoftManagedDesktop[] $items
     * @return self
     */
    public function setValue(array|MicrosoftManagedDesktop $items, MicrosoftManagedDesktop ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MicrosoftManagedDesktop> $value
     * @return self
     ...
     * 
     * @param MicrosoftManagedDesktop $item
     * @return self
     */
    public function addValue(MicrosoftManagedDesktop $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MicrosoftManagedDesktop>
     */
