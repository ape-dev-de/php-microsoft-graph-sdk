 ...
 */
class MicrosoftManagedDesktopCollectionResponse
{
    /**
     ...
     * 
     * @param MicrosoftManagedDesktop ...$items Variable number of MicrosoftManagedDesktop items
     * @return self
     */
    public function setValue(MicrosoftManagedDesktop ...$items): self
    {
        $this->value = $items;
        return $this;
    }
