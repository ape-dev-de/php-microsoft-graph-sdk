...
/**
 * Collection response for SecurityContentFormat
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityContentFormatCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityContentFormat[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityContentFormat[] $items
     * @return self
     */
    public function setValue(array|SecurityContentFormat $items, SecurityContentFormat ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityContentFormat> $value
     * @return self
     ...
     * 
     * @param SecurityContentFormat $item
     * @return self
     */
    public function addValue(SecurityContentFormat $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityContentFormat|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityContentFormat>
     */
