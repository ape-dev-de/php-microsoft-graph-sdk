...
/**
 * Collection response for TeamVisibilityType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamVisibilityTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TeamVisibilityType[] $items
     * @return self
     */
    public function setValue(array|TeamVisibilityType $items, TeamVisibilityType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamVisibilityType> $value
     * @return self
     ...
     * 
     * @param TeamVisibilityType $item
     * @return self
     */
    public function addValue(TeamVisibilityType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamVisibilityType>
     */
