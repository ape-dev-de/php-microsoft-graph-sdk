...
/**
 * Collection response for PreAuthorizedApplication
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PreAuthorizedApplicationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PreAuthorizedApplication[] $items
     * @return self
     */
    public function setValue(array|PreAuthorizedApplication $items, PreAuthorizedApplication ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PreAuthorizedApplication> $value
     * @return self
     ...
     * 
     * @param PreAuthorizedApplication $item
     * @return self
     */
    public function addValue(PreAuthorizedApplication $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PreAuthorizedApplication|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PreAuthorizedApplication>
     */
