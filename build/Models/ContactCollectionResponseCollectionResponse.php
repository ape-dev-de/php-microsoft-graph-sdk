...
/**
 * Collection response for ContactCollectionResponse
 */
class ContactCollectionResponseCollectionResponse
{
    /**
     * @var ContactCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ContactCollectionResponse ...$items Variable number of ContactCollectionResponse items
     * @return self
     */
    public function setValue(ContactCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ContactCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ContactCollectionResponse $item
     * @return self
     */
    public function addValue(ContactCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
