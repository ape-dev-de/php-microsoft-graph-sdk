...
class CloudPcProvisioningPolicy
{
    public function __construct(
        ...
        public ?string $microsoftManagedDesktop = null,
        ...
        public ?string $windowsSetting = null,
        /** @var string[] A defined collection of provisioning policy assignments. Represents the set of Microsoft 365 groups and security groups in Microsoft Entra ID that have provisioning policy assigned. Returned only on $expand. For an example about how to get the assignments relationship, see Get cloudPcProvisioningPolicy. */
