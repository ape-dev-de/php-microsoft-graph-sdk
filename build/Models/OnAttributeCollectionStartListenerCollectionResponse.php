...
/**
 * Collection response for OnAttributeCollectionStartListener
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnAttributeCollectionStartListenerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param OnAttributeCollectionStartListener[] $items
     * @return self
     */
    public function setValue(array|OnAttributeCollectionStartListener $items, OnAttributeCollectionStartListener ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnAttributeCollectionStartListener> $value
     * @return self
     ...
     * 
     * @param OnAttributeCollectionStartListener $item
     * @return self
     */
    public function addValue(OnAttributeCollectionStartListener $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OnAttributeCollectionStartListener|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OnAttributeCollectionStartListener>
     */
