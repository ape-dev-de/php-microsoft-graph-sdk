 ...
 */
class RequestSignatureVerificationCollectionResponse
{
    /**
     ...
     * 
     * @param RequestSignatureVerification ...$items Variable number of RequestSignatureVerification items
     * @return self
     */
    public function setValue(RequestSignatureVerification ...$items): self
    {
        $this->value = $items;
        return $this;
    }
