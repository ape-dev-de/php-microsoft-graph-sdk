...
/**
 * Collection response for RequestSignatureVerification
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RequestSignatureVerificationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RequestSignatureVerification[]
     */
    private array $value = [];
     ...
     * 
     * @param RequestSignatureVerification[] $items
     * @return self
     */
    public function setValue(array|RequestSignatureVerification $items, RequestSignatureVerification ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RequestSignatureVerification> $value
     * @return self
     ...
     * 
     * @param RequestSignatureVerification $item
     * @return self
     */
    public function addValue(RequestSignatureVerification $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RequestSignatureVerification>
     */
