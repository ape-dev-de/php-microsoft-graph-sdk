 ...
 */
class ProvisioningErrorInfoCollectionResponse
{
    /**
     ...
     * 
     * @param ProvisioningErrorInfo ...$items Variable number of ProvisioningErrorInfo items
     * @return self
     */
    public function setValue(ProvisioningErrorInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
