...
/**
 * Collection response for ProvisioningErrorInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProvisioningErrorInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProvisioningErrorInfo[]
     */
    private array $value = [];
     ...
     * 
     * @param ProvisioningErrorInfo[] $items
     * @return self
     */
    public function setValue(array|ProvisioningErrorInfo $items, ProvisioningErrorInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProvisioningErrorInfo> $value
     * @return self
     ...
     * 
     * @param ProvisioningErrorInfo $item
     * @return self
     */
    public function addValue(ProvisioningErrorInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProvisioningErrorInfo>
     */
