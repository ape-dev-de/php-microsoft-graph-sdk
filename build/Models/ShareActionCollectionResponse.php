...
/**
 * Collection response for ShareAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ShareActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ShareAction[]
     */
     ...
     * 
     * @param ShareAction[] $items
     * @return self
     */
    public function setValue(array|ShareAction $items, ShareAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param ShareAction $item
     * @return self
     */
    public function addValue(ShareAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ShareAction>
     */
