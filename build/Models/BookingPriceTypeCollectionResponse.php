...
/**
 * Collection response for BookingPriceType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingPriceTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BookingPriceType[]
     */
    private array $value = [];
     ...
     * 
     * @param BookingPriceType[] $items
     * @return self
     */
    public function setValue(array|BookingPriceType $items, BookingPriceType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingPriceType> $value
     * @return self
     ...
     * 
     * @param BookingPriceType $item
     * @return self
     */
    public function addValue(BookingPriceType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BookingPriceType>
     */
