 ...
 */
class PublicInnerErrorCollectionResponse
{
    /**
     ...
     * 
     * @param PublicInnerError ...$items Variable number of PublicInnerError items
     * @return self
     */
    public function setValue(PublicInnerError ...$items): self
    {
        $this->value = $items;
        return $this;
    }
