...
/**
 * Collection response for PublicInnerError
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PublicInnerErrorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PublicInnerError[] $items
     * @return self
     */
    public function setValue(array|PublicInnerError $items, PublicInnerError ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PublicInnerError> $value
     * @return self
     ...
     * 
     * @param PublicInnerError $item
     * @return self
     */
    public function addValue(PublicInnerError $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PublicInnerError>
     */
