...
/**
 * Collection response for EducationExternalResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationExternalResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationExternalResource[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationExternalResource[] $items
     * @return self
     */
    public function setValue(array|EducationExternalResource $items, EducationExternalResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationExternalResource> $value
     * @return self
     ...
     * 
     * @param EducationExternalResource $item
     * @return self
     */
    public function addValue(EducationExternalResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EducationExternalResource|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EducationExternalResource>
     */
