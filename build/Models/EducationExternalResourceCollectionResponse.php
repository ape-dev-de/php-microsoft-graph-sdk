 ...
 */
class EducationExternalResourceCollectionResponse
{
    /**
     ...
     * 
     * @param EducationExternalResource ...$items Variable number of EducationExternalResource items
     * @return self
     */
    public function setValue(EducationExternalResource ...$items): self
    {
        $this->value = $items;
        return $this;
    }
