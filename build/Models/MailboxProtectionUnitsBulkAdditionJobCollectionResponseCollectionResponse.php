...
/**
 * Collection response for MailboxProtectionUnitsBulkAdditionJobCollectionResponse
 */
class MailboxProtectionUnitsBulkAdditionJobCollectionResponseCollectionResponse
{
    /**
     * @var MailboxProtectionUnitsBulkAdditionJobCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MailboxProtectionUnitsBulkAdditionJobCollectionResponse ...$items Variable number of MailboxProtectionUnitsBulkAdditionJobCollectionResponse items
     * @return self
     */
    public function setValue(MailboxProtectionUnitsBulkAdditionJobCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MailboxProtectionUnitsBulkAdditionJobCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MailboxProtectionUnitsBulkAdditionJobCollectionResponse $item
     * @return self
     */
    public function addValue(MailboxProtectionUnitsBulkAdditionJobCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
