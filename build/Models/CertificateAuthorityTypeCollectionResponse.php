...
/**
 * Collection response for CertificateAuthorityType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CertificateAuthorityTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param CertificateAuthorityType[] $items
     * @return self
     */
    public function setValue(array|CertificateAuthorityType $items, CertificateAuthorityType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CertificateAuthorityType> $value
     * @return self
     ...
     * 
     * @param CertificateAuthorityType $item
     * @return self
     */
    public function addValue(CertificateAuthorityType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CertificateAuthorityType>
     */
