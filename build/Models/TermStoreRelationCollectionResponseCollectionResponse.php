...
/**
 * Collection response for TermStoreRelationCollectionResponse
 */
class TermStoreRelationCollectionResponseCollectionResponse
{
    /**
     * @var TermStoreRelationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TermStoreRelationCollectionResponse ...$items Variable number of TermStoreRelationCollectionResponse items
     * @return self
     */
    public function setValue(TermStoreRelationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TermStoreRelationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TermStoreRelationCollectionResponse $item
     * @return self
     */
    public function addValue(TermStoreRelationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
