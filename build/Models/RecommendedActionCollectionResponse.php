...
/**
 * Collection response for RecommendedAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RecommendedActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param RecommendedAction[] $items
     * @return self
     */
    public function setValue(array|RecommendedAction $items, RecommendedAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RecommendedAction> $value
     * @return self
     ...
     * 
     * @param RecommendedAction $item
     * @return self
     */
    public function addValue(RecommendedAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RecommendedAction>
     */
