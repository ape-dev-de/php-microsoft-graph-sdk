...
/**
 * Collection response for UserRegistrationFeatureCount
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserRegistrationFeatureCountCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserRegistrationFeatureCount[] $items
     * @return self
     */
    public function setValue(array|UserRegistrationFeatureCount $items, UserRegistrationFeatureCount ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserRegistrationFeatureCount> $value
     * @return self
     ...
     * 
     * @param UserRegistrationFeatureCount $item
     * @return self
     */
    public function addValue(UserRegistrationFeatureCount $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UserRegistrationFeatureCount|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UserRegistrationFeatureCount>
     */
