...
/**
 * Collection response for Win32LobAppPowerShellScriptRule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Win32LobAppPowerShellScriptRuleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Win32LobAppPowerShellScriptRule[]
     */
    private array $value = [];
     ...
     * 
     * @param Win32LobAppPowerShellScriptRule[] $items
     * @return self
     */
    public function setValue(array|Win32LobAppPowerShellScriptRule $items, Win32LobAppPowerShellScriptRule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Win32LobAppPowerShellScriptRule> $value
     * @return self
     ...
     * 
     * @param Win32LobAppPowerShellScriptRule $item
     * @return self
     */
    public function addValue(Win32LobAppPowerShellScriptRule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return Win32LobAppPowerShellScriptRule|null
     */
     ...
     * 
     * @return \ArrayIterator<int, Win32LobAppPowerShellScriptRule>
     */
