 ...
 */
class Win32LobAppPowerShellScriptRuleCollectionResponse
{
    /**
     ...
     * 
     * @param Win32LobAppPowerShellScriptRule ...$items Variable number of Win32LobAppPowerShellScriptRule items
     * @return self
     */
    public function setValue(Win32LobAppPowerShellScriptRule ...$items): self
    {
        $this->value = $items;
        return $this;
    }
