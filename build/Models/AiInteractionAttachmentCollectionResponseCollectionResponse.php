...
/**
 * Collection response for AiInteractionAttachmentCollectionResponse
 */
class AiInteractionAttachmentCollectionResponseCollectionResponse
{
    /**
     * @var AiInteractionAttachmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return AiInteractionAttachmentCollectionResponse[]
     */
     ...
     * 
     * @param AiInteractionAttachmentCollectionResponse ...$items Variable number of AiInteractionAttachmentCollectionResponse items
     * @return self
     */
    public function setValue(AiInteractionAttachmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AiInteractionAttachmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AiInteractionAttachmentCollectionResponse $item
     * @return self
     */
    public function addValue(AiInteractionAttachmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
