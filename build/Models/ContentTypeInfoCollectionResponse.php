...
/**
 * Collection response for ContentTypeInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ContentTypeInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ContentTypeInfo[]
     */
     ...
     * 
     * @param ContentTypeInfo[] $items
     * @return self
     */
    public function setValue(array|ContentTypeInfo $items, ContentTypeInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ContentTypeInfo> $value
     * @return self
     ...
     * 
     * @param ContentTypeInfo $item
     * @return self
     */
    public function addValue(ContentTypeInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ContentTypeInfo>
     */
