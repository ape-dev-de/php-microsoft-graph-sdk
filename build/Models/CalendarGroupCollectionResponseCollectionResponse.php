...
/**
 * Collection response for CalendarGroupCollectionResponse
 */
class CalendarGroupCollectionResponseCollectionResponse
{
    /**
     * @var CalendarGroupCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CalendarGroupCollectionResponse ...$items Variable number of CalendarGroupCollectionResponse items
     * @return self
     */
    public function setValue(CalendarGroupCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CalendarGroupCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CalendarGroupCollectionResponse $item
     * @return self
     */
    public function addValue(CalendarGroupCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
