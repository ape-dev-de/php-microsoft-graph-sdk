...
/**
 * Collection response for DlpAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DlpActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DlpAction[]
     */
     ...
     * 
     * @param DlpAction[] $items
     * @return self
     */
    public function setValue(array|DlpAction $items, DlpAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param DlpAction $item
     * @return self
     */
    public function addValue(DlpAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DlpAction>
     */
