...
/**
 * Collection response for ProtectionUnitStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProtectionUnitStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProtectionUnitStatus[]
     */
    private array $value = [];
     ...
     * 
     * @param ProtectionUnitStatus[] $items
     * @return self
     */
    public function setValue(array|ProtectionUnitStatus $items, ProtectionUnitStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProtectionUnitStatus> $value
     * @return self
     ...
     * 
     * @param ProtectionUnitStatus $item
     * @return self
     */
    public function addValue(ProtectionUnitStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProtectionUnitStatus>
     */
