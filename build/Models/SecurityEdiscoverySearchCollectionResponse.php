...
/**
 * Collection response for SecurityEdiscoverySearch
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityEdiscoverySearchCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityEdiscoverySearch[] $items
     * @return self
     */
    public function setValue(array|SecurityEdiscoverySearch $items, SecurityEdiscoverySearch ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityEdiscoverySearch> $value
     * @return self
     ...
     * 
     * @param SecurityEdiscoverySearch $item
     * @return self
     */
    public function addValue(SecurityEdiscoverySearch $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityEdiscoverySearch>
     */
