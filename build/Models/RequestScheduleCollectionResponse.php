 ...
 */
class RequestScheduleCollectionResponse
{
    /**
     * @var RequestSchedule[]
     */
     ...
     * 
     * @param RequestSchedule ...$items Variable number of RequestSchedule items
     * @return self
     */
    public function setValue(RequestSchedule ...$items): self
    {
        $this->value = $items;
        return $this;
    }
