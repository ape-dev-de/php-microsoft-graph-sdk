...
/**
 * Collection response for RequestSchedule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RequestScheduleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RequestSchedule[]
     */
     ...
     * 
     * @param RequestSchedule[] $items
     * @return self
     */
    public function setValue(array|RequestSchedule $items, RequestSchedule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RequestSchedule> $value
     * @return self
     ...
     * 
     * @param RequestSchedule $item
     * @return self
     */
    public function addValue(RequestSchedule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RequestSchedule>
     */
