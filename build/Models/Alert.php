...
class Alert
{
     ...
     * @var string[]
     */
    private array $vulnerabilityStates = [];
     ...
     */
    public function setDetectionIds(array $detectionIds): self
    {
     ...
     */
    public function setIncidentIds(array $incidentIds): self
    {
    ...
    /**
     * @param string[] $sourceMaterials
     */
    public function setSourceMaterials(array $sourceMaterials): self
    {
    ...
    /**
     * @param string[] $vulnerabilityStates
     */
    public function setVulnerabilityStates(array $vulnerabilityStates): self
    {
