...
/**
 * PhoneUserConversationMemberCollectionResponse - Collection response
 */
class PhoneUserConversationMemberCollectionResponse
{
    /**
     * @var array<int, PhoneUserConversationMember>
     */
    public array $value = [];
