...
/**
 * Collection response for PhoneUserConversationMember
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PhoneUserConversationMemberCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PhoneUserConversationMember[]
     */
    private array $value = [];
     ...
     * 
     * @param PhoneUserConversationMember[] $items
     * @return self
     */
    public function setValue(array|PhoneUserConversationMember $items, PhoneUserConversationMember ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PhoneUserConversationMember> $value
     * @return self
     ...
     * 
     * @param PhoneUserConversationMember $item
     * @return self
     */
    public function addValue(PhoneUserConversationMember $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PhoneUserConversationMember|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PhoneUserConversationMember>
     */
