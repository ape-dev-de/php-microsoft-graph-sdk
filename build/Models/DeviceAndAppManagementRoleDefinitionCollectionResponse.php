...
/**
 * Collection response for DeviceAndAppManagementRoleDefinition
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceAndAppManagementRoleDefinitionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceAndAppManagementRoleDefinition[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceAndAppManagementRoleDefinition[] $items
     * @return self
     */
    public function setValue(array|DeviceAndAppManagementRoleDefinition $items, DeviceAndAppManagementRoleDefinition ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceAndAppManagementRoleDefinition> $value
     * @return self
     ...
     * 
     * @param DeviceAndAppManagementRoleDefinition $item
     * @return self
     */
    public function addValue(DeviceAndAppManagementRoleDefinition $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return DeviceAndAppManagementRoleDefinition|null
     */
     ...
     * 
     * @return \ArrayIterator<int, DeviceAndAppManagementRoleDefinition>
     */
