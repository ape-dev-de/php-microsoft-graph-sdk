...
/**
 * Collection response for FeatureType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FeatureTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FeatureType[]
     */
     ...
     * 
     * @param FeatureType[] $items
     * @return self
     */
    public function setValue(array|FeatureType $items, FeatureType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param FeatureType $item
     * @return self
     */
    public function addValue(FeatureType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, FeatureType>
     */
