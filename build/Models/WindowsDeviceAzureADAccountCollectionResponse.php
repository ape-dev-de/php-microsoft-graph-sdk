...
/**
 * Collection response for WindowsDeviceAzureADAccount
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsDeviceAzureADAccountCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsDeviceAzureADAccount[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsDeviceAzureADAccount[] $items
     * @return self
     */
    public function setValue(array|WindowsDeviceAzureADAccount $items, WindowsDeviceAzureADAccount ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsDeviceAzureADAccount> $value
     * @return self
     ...
     * 
     * @param WindowsDeviceAzureADAccount $item
     * @return self
     */
    public function addValue(WindowsDeviceAzureADAccount $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WindowsDeviceAzureADAccount|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WindowsDeviceAzureADAccount>
     */
