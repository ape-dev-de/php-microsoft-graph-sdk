 ...
 */
class WindowsDeviceAzureADAccountCollectionResponse
{
    /**
     ...
     * 
     * @param WindowsDeviceAzureADAccount ...$items Variable number of WindowsDeviceAzureADAccount items
     * @return self
     */
    public function setValue(WindowsDeviceAzureADAccount ...$items): self
    {
        $this->value = $items;
        return $this;
    }
