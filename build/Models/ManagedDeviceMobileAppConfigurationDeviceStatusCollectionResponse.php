...
/**
 * Collection response for ManagedDeviceMobileAppConfigurationDeviceStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedDeviceMobileAppConfigurationDeviceStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ManagedDeviceMobileAppConfigurationDeviceStatus[] $items
     * @return self
     */
    public function setValue(array|ManagedDeviceMobileAppConfigurationDeviceStatus $items, ManagedDeviceMobileAppConfigurationDeviceStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedDeviceMobileAppConfigurationDeviceStatus> $value
     * @return self
     ...
     * 
     * @param ManagedDeviceMobileAppConfigurationDeviceStatus $item
     * @return self
     */
    public function addValue(ManagedDeviceMobileAppConfigurationDeviceStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedDeviceMobileAppConfigurationDeviceStatus>
     */
