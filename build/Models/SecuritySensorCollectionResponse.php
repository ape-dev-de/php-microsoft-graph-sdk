...
/**
 * Collection response for SecuritySensor
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecuritySensorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecuritySensor[]
     */
     ...
     * 
     * @param SecuritySensor[] $items
     * @return self
     */
    public function setValue(array|SecuritySensor $items, SecuritySensor ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecuritySensor> $value
     * @return self
     ...
     * 
     * @param SecuritySensor $item
     * @return self
     */
    public function addValue(SecuritySensor $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecuritySensor>
     */
