...
/**
 * SecurityExportFileMetadataCollectionResponse - Collection response
 */
class SecurityExportFileMetadataCollectionResponse
{
    /**
     * @var array<int, SecurityExportFileMetadata>
     */
    public array $value = [];
