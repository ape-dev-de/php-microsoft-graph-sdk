...
/**
 * Collection response for SecurityExportFileMetadata
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityExportFileMetadataCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return SecurityExportFileMetadata[]
     */
     ...
     * 
     * @param SecurityExportFileMetadata[] $items
     * @return self
     */
    public function setValue(array|SecurityExportFileMetadata $items, SecurityExportFileMetadata ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityExportFileMetadata> $value
     * @return self
     ...
     * 
     * @param SecurityExportFileMetadata $item
     * @return self
     */
    public function addValue(SecurityExportFileMetadata $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityExportFileMetadata|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityExportFileMetadata>
     */
