...
/**
 * AssignmentScheduleInstanceFilterByCurrentUserOptionsCollectionResponse - Collection response
 */
class AssignmentScheduleInstanceFilterByCurrentUserOptionsCollectionResponse
{
    /**
     * @var array<int, AssignmentScheduleInstanceFilterByCurrentUserOptions>
     */
    public array $value = [];
