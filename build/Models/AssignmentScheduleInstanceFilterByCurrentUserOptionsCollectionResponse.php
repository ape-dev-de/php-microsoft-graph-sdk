...
/**
 * Collection response for AssignmentScheduleInstanceFilterByCurrentUserOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AssignmentScheduleInstanceFilterByCurrentUserOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AssignmentScheduleInstanceFilterByCurrentUserOptions[]
     */
    private array $value = [];
     ...
     * 
     * @return AssignmentScheduleInstanceFilterByCurrentUserOptions[]
     */
     ...
     * 
     * @param AssignmentScheduleInstanceFilterByCurrentUserOptions[] $items
     * @return self
     */
    public function setValue(array|AssignmentScheduleInstanceFilterByCurrentUserOptions $items, AssignmentScheduleInstanceFilterByCurrentUserOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AssignmentScheduleInstanceFilterByCurrentUserOptions> $value
     * @return self
     ...
     * 
     * @param AssignmentScheduleInstanceFilterByCurrentUserOptions $item
     * @return self
     */
    public function addValue(AssignmentScheduleInstanceFilterByCurrentUserOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AssignmentScheduleInstanceFilterByCurrentUserOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AssignmentScheduleInstanceFilterByCurrentUserOptions>
     */
