...
/**
 * Collection response for AttachmentSession
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttachmentSessionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AttachmentSession[] $items
     * @return self
     */
    public function setValue(array|AttachmentSession $items, AttachmentSession ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttachmentSession> $value
     * @return self
     ...
     * 
     * @param AttachmentSession $item
     * @return self
     */
    public function addValue(AttachmentSession $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AttachmentSession>
     */
