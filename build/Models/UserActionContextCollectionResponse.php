...
/**
 * Collection response for UserActionContext
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserActionContextCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserActionContext[]
     */
    private array $value = [];
     ...
     * 
     * @param UserActionContext[] $items
     * @return self
     */
    public function setValue(array|UserActionContext $items, UserActionContext ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserActionContext> $value
     * @return self
     ...
     * 
     * @param UserActionContext $item
     * @return self
     */
    public function addValue(UserActionContext $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserActionContext>
     */
