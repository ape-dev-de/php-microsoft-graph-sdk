 ...
 */
class UserActionContextCollectionResponse
{
    /**
     ...
     * 
     * @param UserActionContext ...$items Variable number of UserActionContext items
     * @return self
     */
    public function setValue(UserActionContext ...$items): self
    {
        $this->value = $items;
        return $this;
    }
