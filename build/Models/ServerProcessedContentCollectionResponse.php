...
/**
 * Collection response for ServerProcessedContent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServerProcessedContentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ServerProcessedContent[] $items
     * @return self
     */
    public function setValue(array|ServerProcessedContent $items, ServerProcessedContent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServerProcessedContent> $value
     * @return self
     ...
     * 
     * @param ServerProcessedContent $item
     * @return self
     */
    public function addValue(ServerProcessedContent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ServerProcessedContent>
     */
