 ...
 */
class ServerProcessedContentCollectionResponse
{
    /**
     ...
     * 
     * @param ServerProcessedContent ...$items Variable number of ServerProcessedContent items
     * @return self
     */
    public function setValue(ServerProcessedContent ...$items): self
    {
        $this->value = $items;
        return $this;
    }
