...
/**
 * Collection response for DataPolicyOperationStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DataPolicyOperationStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DataPolicyOperationStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return DataPolicyOperationStatus[]
     */
     ...
     * 
     * @param DataPolicyOperationStatus[] $items
     * @return self
     */
    public function setValue(array|DataPolicyOperationStatus $items, DataPolicyOperationStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DataPolicyOperationStatus> $value
     * @return self
     ...
     * 
     * @param DataPolicyOperationStatus $item
     * @return self
     */
    public function addValue(DataPolicyOperationStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DataPolicyOperationStatus>
     */
