...
/**
 * DataPolicyOperationStatusCollectionResponse - Collection response
 */
class DataPolicyOperationStatusCollectionResponse
{
    /**
     * @var array<int, DataPolicyOperationStatus>
     */
    public array $value = [];
