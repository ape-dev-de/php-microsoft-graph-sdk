 ...
 */
class TeamClassSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param TeamClassSettings ...$items Variable number of TeamClassSettings items
     * @return self
     */
    public function setValue(TeamClassSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
