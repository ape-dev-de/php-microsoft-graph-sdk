...
/**
 * Collection response for TeamClassSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamClassSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamClassSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamClassSettings[] $items
     * @return self
     */
    public function setValue(array|TeamClassSettings $items, TeamClassSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamClassSettings> $value
     * @return self
     ...
     * 
     * @param TeamClassSettings $item
     * @return self
     */
    public function addValue(TeamClassSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamClassSettings>
     */
