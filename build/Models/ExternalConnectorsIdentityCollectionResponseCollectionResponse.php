...
/**
 * Collection response for ExternalConnectorsIdentityCollectionResponse
 */
class ExternalConnectorsIdentityCollectionResponseCollectionResponse
{
    /**
     * @var ExternalConnectorsIdentityCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ExternalConnectorsIdentityCollectionResponse ...$items Variable number of ExternalConnectorsIdentityCollectionResponse items
     * @return self
     */
    public function setValue(ExternalConnectorsIdentityCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ExternalConnectorsIdentityCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsIdentityCollectionResponse $item
     * @return self
     */
    public function addValue(ExternalConnectorsIdentityCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
