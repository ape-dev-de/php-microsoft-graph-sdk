...
/**
 * Collection response for OnPremisesDirectorySynchronizationCollectionResponse
 */
class OnPremisesDirectorySynchronizationCollectionResponseCollectionResponse
{
    /**
     * @var OnPremisesDirectorySynchronizationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param OnPremisesDirectorySynchronizationCollectionResponse ...$items Variable number of OnPremisesDirectorySynchronizationCollectionResponse items
     * @return self
     */
    public function setValue(OnPremisesDirectorySynchronizationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<OnPremisesDirectorySynchronizationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param OnPremisesDirectorySynchronizationCollectionResponse $item
     * @return self
     */
    public function addValue(OnPremisesDirectorySynchronizationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
