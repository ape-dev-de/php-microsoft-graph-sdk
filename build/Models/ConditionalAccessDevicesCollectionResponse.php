 ...
 */
class ConditionalAccessDevicesCollectionResponse
{
    /**
     ...
     * 
     * @param ConditionalAccessDevices ...$items Variable number of ConditionalAccessDevices items
     * @return self
     */
    public function setValue(ConditionalAccessDevices ...$items): self
    {
        $this->value = $items;
        return $this;
    }
