...
/**
 * Collection response for ConditionalAccessDevices
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessDevicesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessDevices[]
     */
    private array $value = [];
     ...
     * 
     * @param ConditionalAccessDevices[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessDevices $items, ConditionalAccessDevices ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessDevices> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessDevices $item
     * @return self
     */
    public function addValue(ConditionalAccessDevices $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessDevices>
     */
