...
/**
 * Collection response for SamlOrWsFedExternalDomainFederation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SamlOrWsFedExternalDomainFederationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SamlOrWsFedExternalDomainFederation[]
     */
    private array $value = [];
     ...
     * 
     * @param SamlOrWsFedExternalDomainFederation[] $items
     * @return self
     */
    public function setValue(array|SamlOrWsFedExternalDomainFederation $items, SamlOrWsFedExternalDomainFederation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SamlOrWsFedExternalDomainFederation> $value
     * @return self
     ...
     * 
     * @param SamlOrWsFedExternalDomainFederation $item
     * @return self
     */
    public function addValue(SamlOrWsFedExternalDomainFederation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SamlOrWsFedExternalDomainFederation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SamlOrWsFedExternalDomainFederation>
     */
