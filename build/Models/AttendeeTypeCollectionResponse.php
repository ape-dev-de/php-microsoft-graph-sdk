...
/**
 * Collection response for AttendeeType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttendeeTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AttendeeType[]
     */
     ...
     * 
     * @param AttendeeType[] $items
     * @return self
     */
    public function setValue(array|AttendeeType $items, AttendeeType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttendeeType> $value
     * @return self
     ...
     * 
     * @param AttendeeType $item
     * @return self
     */
    public function addValue(AttendeeType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AttendeeType>
     */
