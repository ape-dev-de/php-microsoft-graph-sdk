...
/**
 * Collection response for SecurityIndicator
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityIndicatorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityIndicator[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityIndicator[] $items
     * @return self
     */
    public function setValue(array|SecurityIndicator $items, SecurityIndicator ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityIndicator> $value
     * @return self
     ...
     * 
     * @param SecurityIndicator $item
     * @return self
     */
    public function addValue(SecurityIndicator $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityIndicator>
     */
