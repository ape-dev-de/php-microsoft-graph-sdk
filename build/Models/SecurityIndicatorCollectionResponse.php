 ...
 */
class SecurityIndicatorCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityIndicator ...$items Variable number of SecurityIndicator items
     * @return self
     */
    public function setValue(SecurityIndicator ...$items): self
    {
        $this->value = $items;
        return $this;
    }
