...
/**
 * Collection response for ShiftCollectionResponse
 */
class ShiftCollectionResponseCollectionResponse
{
    /**
     * @var ShiftCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ShiftCollectionResponse ...$items Variable number of ShiftCollectionResponse items
     * @return self
     */
    public function setValue(ShiftCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ShiftCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ShiftCollectionResponse $item
     * @return self
     */
    public function addValue(ShiftCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
