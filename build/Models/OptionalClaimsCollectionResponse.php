 ...
 */
class OptionalClaimsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OptionalClaims[]
     */
     ...
     * 
     * @param OptionalClaims[] $items
     * @return self
     */
    public function setValue(array|OptionalClaims $items, OptionalClaims ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @return \ArrayIterator<int, OptionalClaims>
     */
