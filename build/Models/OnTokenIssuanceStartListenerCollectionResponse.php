...
/**
 * Collection response for OnTokenIssuanceStartListener
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnTokenIssuanceStartListenerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param OnTokenIssuanceStartListener[] $items
     * @return self
     */
    public function setValue(array|OnTokenIssuanceStartListener $items, OnTokenIssuanceStartListener ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnTokenIssuanceStartListener> $value
     * @return self
     ...
     * 
     * @param OnTokenIssuanceStartListener $item
     * @return self
     */
    public function addValue(OnTokenIssuanceStartListener $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OnTokenIssuanceStartListener|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OnTokenIssuanceStartListener>
     */
