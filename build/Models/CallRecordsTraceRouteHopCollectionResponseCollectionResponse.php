...
/**
 * Collection response for CallRecordsTraceRouteHopCollectionResponse
 */
class CallRecordsTraceRouteHopCollectionResponseCollectionResponse
{
    /**
     * @var CallRecordsTraceRouteHopCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return CallRecordsTraceRouteHopCollectionResponse[]
     */
     ...
     * 
     * @param CallRecordsTraceRouteHopCollectionResponse ...$items Variable number of CallRecordsTraceRouteHopCollectionResponse items
     * @return self
     */
    public function setValue(CallRecordsTraceRouteHopCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CallRecordsTraceRouteHopCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CallRecordsTraceRouteHopCollectionResponse $item
     * @return self
     */
    public function addValue(CallRecordsTraceRouteHopCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
