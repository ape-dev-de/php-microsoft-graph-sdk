 ...
 */
class EducationLinkedAssignmentResourceCollectionResponse
{
    /**
     ...
     * 
     * @param EducationLinkedAssignmentResource ...$items Variable number of EducationLinkedAssignmentResource items
     * @return self
     */
    public function setValue(EducationLinkedAssignmentResource ...$items): self
    {
        $this->value = $items;
        return $this;
    }
