...
/**
 * Collection response for EducationLinkedAssignmentResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationLinkedAssignmentResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationLinkedAssignmentResource[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationLinkedAssignmentResource[] $items
     * @return self
     */
    public function setValue(array|EducationLinkedAssignmentResource $items, EducationLinkedAssignmentResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationLinkedAssignmentResource> $value
     * @return self
     ...
     * 
     * @param EducationLinkedAssignmentResource $item
     * @return self
     */
    public function addValue(EducationLinkedAssignmentResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EducationLinkedAssignmentResource|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EducationLinkedAssignmentResource>
     */
