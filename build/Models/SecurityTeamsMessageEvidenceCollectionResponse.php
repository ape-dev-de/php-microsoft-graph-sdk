 ...
 */
class SecurityTeamsMessageEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityTeamsMessageEvidence ...$items Variable number of SecurityTeamsMessageEvidence items
     * @return self
     */
    public function setValue(SecurityTeamsMessageEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
