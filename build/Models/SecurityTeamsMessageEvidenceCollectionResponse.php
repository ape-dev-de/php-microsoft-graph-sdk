...
/**
 * Collection response for SecurityTeamsMessageEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityTeamsMessageEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityTeamsMessageEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityTeamsMessageEvidence[]
     */
     ...
     * 
     * @param SecurityTeamsMessageEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityTeamsMessageEvidence $items, SecurityTeamsMessageEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityTeamsMessageEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityTeamsMessageEvidence $item
     * @return self
     */
    public function addValue(SecurityTeamsMessageEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityTeamsMessageEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityTeamsMessageEvidence>
     */
