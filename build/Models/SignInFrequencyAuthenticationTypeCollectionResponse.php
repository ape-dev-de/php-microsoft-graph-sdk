...
/**
 * SignInFrequencyAuthenticationTypeCollectionResponse - Collection response
 */
class SignInFrequencyAuthenticationTypeCollectionResponse
{
    /**
     * @var array<int, SignInFrequencyAuthenticationType>
     */
    public array $value = [];
