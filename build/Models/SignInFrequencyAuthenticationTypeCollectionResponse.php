...
/**
 * Collection response for SignInFrequencyAuthenticationType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SignInFrequencyAuthenticationTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SignInFrequencyAuthenticationType[]
     */
    private array $value = [];
     ...
     * 
     * @param SignInFrequencyAuthenticationType[] $items
     * @return self
     */
    public function setValue(array|SignInFrequencyAuthenticationType $items, SignInFrequencyAuthenticationType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SignInFrequencyAuthenticationType> $value
     * @return self
     ...
     * 
     * @param SignInFrequencyAuthenticationType $item
     * @return self
     */
    public function addValue(SignInFrequencyAuthenticationType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SignInFrequencyAuthenticationType>
     */
