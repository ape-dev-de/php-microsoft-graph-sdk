...
/**
 * Collection response for TeamsAppAuthorization
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamsAppAuthorizationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamsAppAuthorization[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamsAppAuthorization[] $items
     * @return self
     */
    public function setValue(array|TeamsAppAuthorization $items, TeamsAppAuthorization ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamsAppAuthorization> $value
     * @return self
     ...
     * 
     * @param TeamsAppAuthorization $item
     * @return self
     */
    public function addValue(TeamsAppAuthorization $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamsAppAuthorization>
     */
