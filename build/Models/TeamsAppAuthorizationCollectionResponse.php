 ...
 */
class TeamsAppAuthorizationCollectionResponse
{
    /**
     ...
     * 
     * @param TeamsAppAuthorization ...$items Variable number of TeamsAppAuthorization items
     * @return self
     */
    public function setValue(TeamsAppAuthorization ...$items): self
    {
        $this->value = $items;
        return $this;
    }
