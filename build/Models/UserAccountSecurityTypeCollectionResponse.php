...
/**
 * Collection response for UserAccountSecurityType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserAccountSecurityTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UserAccountSecurityType[]
     */
    private array $value = [];
     ...
     * 
     * @return UserAccountSecurityType[]
     */
     ...
     * 
     * @param UserAccountSecurityType[] $items
     * @return self
     */
    public function setValue(array|UserAccountSecurityType $items, UserAccountSecurityType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserAccountSecurityType> $value
     * @return self
     ...
     * 
     * @param UserAccountSecurityType $item
     * @return self
     */
    public function addValue(UserAccountSecurityType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserAccountSecurityType>
     */
