...
/**
 * Collection response for Report
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ReportCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Report[]
     */
     ...
     * @return self
     */
    public function setValue(array|Report $items, Report ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Report $item): self
    {
        $this->value[] = $item;
        return $this;
    }
