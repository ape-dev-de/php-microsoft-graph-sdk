...
/**
 * Collection response for UpdateRecordingStatusOperationCollectionResponse
 */
class UpdateRecordingStatusOperationCollectionResponseCollectionResponse
{
    /**
     * @var UpdateRecordingStatusOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UpdateRecordingStatusOperationCollectionResponse ...$items Variable number of UpdateRecordingStatusOperationCollectionResponse items
     * @return self
     */
    public function setValue(UpdateRecordingStatusOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UpdateRecordingStatusOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UpdateRecordingStatusOperationCollectionResponse $item
     * @return self
     */
    public function addValue(UpdateRecordingStatusOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
