...
/**
 * Collection response for CrossTenantAccessPolicyTenantRestrictions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CrossTenantAccessPolicyTenantRestrictionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CrossTenantAccessPolicyTenantRestrictions[]
     */
    private array $value = [];
     ...
     * 
     * @param CrossTenantAccessPolicyTenantRestrictions[] $items
     * @return self
     */
    public function setValue(array|CrossTenantAccessPolicyTenantRestrictions $items, CrossTenantAccessPolicyTenantRestrictions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CrossTenantAccessPolicyTenantRestrictions> $value
     * @return self
     ...
     * 
     * @param CrossTenantAccessPolicyTenantRestrictions $item
     * @return self
     */
    public function addValue(CrossTenantAccessPolicyTenantRestrictions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CrossTenantAccessPolicyTenantRestrictions>
     */
