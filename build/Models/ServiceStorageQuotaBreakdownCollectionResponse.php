...
/**
 * Collection response for ServiceStorageQuotaBreakdown
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServiceStorageQuotaBreakdownCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ServiceStorageQuotaBreakdown[] $items
     * @return self
     */
    public function setValue(array|ServiceStorageQuotaBreakdown $items, ServiceStorageQuotaBreakdown ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServiceStorageQuotaBreakdown> $value
     * @return self
     ...
     * 
     * @param ServiceStorageQuotaBreakdown $item
     * @return self
     */
    public function addValue(ServiceStorageQuotaBreakdown $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ServiceStorageQuotaBreakdown>
     */
