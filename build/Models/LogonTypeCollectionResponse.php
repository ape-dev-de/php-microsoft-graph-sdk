...
/**
 * Collection response for LogonType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LogonTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var LogonType[]
     */
     ...
     * 
     * @param LogonType[] $items
     * @return self
     */
    public function setValue(array|LogonType $items, LogonType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param LogonType $item
     * @return self
     */
    public function addValue(LogonType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LogonType>
     */
