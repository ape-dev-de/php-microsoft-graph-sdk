...
/**
 * Collection response for UsageDetails
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UsageDetailsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UsageDetails[]
     */
     ...
     * 
     * @param UsageDetails[] $items
     * @return self
     */
    public function setValue(array|UsageDetails $items, UsageDetails ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UsageDetails> $value
     * @return self
     ...
     * 
     * @param UsageDetails $item
     * @return self
     */
    public function addValue(UsageDetails $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UsageDetails>
     */
