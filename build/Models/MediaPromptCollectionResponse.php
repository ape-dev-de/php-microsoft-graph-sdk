...
/**
 * Collection response for MediaPrompt
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MediaPromptCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MediaPrompt[]
     */
     ...
     * 
     * @param MediaPrompt[] $items
     * @return self
     */
    public function setValue(array|MediaPrompt $items, MediaPrompt ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param MediaPrompt $item
     * @return self
     */
    public function addValue(MediaPrompt $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MediaPrompt>
     */
