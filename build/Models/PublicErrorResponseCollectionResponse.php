 ...
 */
class PublicErrorResponseCollectionResponse
{
    /**
     ...
     * 
     * @param PublicErrorResponse ...$items Variable number of PublicErrorResponse items
     * @return self
     */
    public function setValue(PublicErrorResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
