...
/**
 * Collection response for PublicErrorResponse
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PublicErrorResponseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PublicErrorResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PublicErrorResponse[] $items
     * @return self
     */
    public function setValue(array|PublicErrorResponse $items, PublicErrorResponse ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PublicErrorResponse> $value
     * @return self
     ...
     * 
     * @param PublicErrorResponse $item
     * @return self
     */
    public function addValue(PublicErrorResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return PublicErrorResponse|null
     */
     ...
     * 
     * @return \ArrayIterator<int, PublicErrorResponse>
     */
