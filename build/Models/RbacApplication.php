...
class RbacApplication
{
     ...
     * @var string[]
     */
    private array $roleEligibilitySchedules = [];
    ...
    /**
     * @param string[] $roleEligibilitySchedules
     */
    public function setRoleEligibilitySchedules(array $roleEligibilitySchedules): self
    {
