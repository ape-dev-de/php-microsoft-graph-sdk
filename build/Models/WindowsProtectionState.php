...
class WindowsProtectionState
{
     ...
     */
    private ?string $detectedMalwareState;
    ...
    public function getDetectedMalwareState(): ?string
    {
        return $this->detectedMalwareState;
    }

    public function setDetectedMalwareState(?string $detectedMalwareState): self
    {
