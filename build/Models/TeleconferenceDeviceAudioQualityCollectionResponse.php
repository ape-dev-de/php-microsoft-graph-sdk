...
/**
 * Collection response for TeleconferenceDeviceAudioQuality
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeleconferenceDeviceAudioQualityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeleconferenceDeviceAudioQuality[]
     */
    private array $value = [];
     ...
     * 
     * @param TeleconferenceDeviceAudioQuality[] $items
     * @return self
     */
    public function setValue(array|TeleconferenceDeviceAudioQuality $items, TeleconferenceDeviceAudioQuality ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeleconferenceDeviceAudioQuality> $value
     * @return self
     ...
     * 
     * @param TeleconferenceDeviceAudioQuality $item
     * @return self
     */
    public function addValue(TeleconferenceDeviceAudioQuality $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TeleconferenceDeviceAudioQuality|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TeleconferenceDeviceAudioQuality>
     */
