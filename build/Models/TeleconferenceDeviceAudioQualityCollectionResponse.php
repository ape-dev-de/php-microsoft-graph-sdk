...
/**
 * TeleconferenceDeviceAudioQualityCollectionResponse - Collection response
 */
class TeleconferenceDeviceAudioQualityCollectionResponse
{
    /**
     * @var array<int, TeleconferenceDeviceAudioQuality>
     */
    public array $value = [];
