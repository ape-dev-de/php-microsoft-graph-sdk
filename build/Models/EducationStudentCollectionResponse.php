 ...
 */
class EducationStudentCollectionResponse
{
    /**
     ...
     * 
     * @param EducationStudent ...$items Variable number of EducationStudent items
     * @return self
     */
    public function setValue(EducationStudent ...$items): self
    {
        $this->value = $items;
        return $this;
    }
