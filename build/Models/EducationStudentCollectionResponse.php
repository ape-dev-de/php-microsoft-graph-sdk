...
/**
 * Collection response for EducationStudent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationStudentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param EducationStudent[] $items
     * @return self
     */
    public function setValue(array|EducationStudent $items, EducationStudent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationStudent> $value
     * @return self
     ...
     * 
     * @param EducationStudent $item
     * @return self
     */
    public function addValue(EducationStudent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationStudent>
     */
