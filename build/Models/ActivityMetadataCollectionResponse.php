 ...
 */
class ActivityMetadataCollectionResponse
{
    /**
     ...
     * 
     * @param ActivityMetadata ...$items Variable number of ActivityMetadata items
     * @return self
     */
    public function setValue(ActivityMetadata ...$items): self
    {
        $this->value = $items;
        return $this;
    }
