...
/**
 * Collection response for ActivityMetadata
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ActivityMetadataCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ActivityMetadata[] $items
     * @return self
     */
    public function setValue(array|ActivityMetadata $items, ActivityMetadata ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ActivityMetadata> $value
     * @return self
     ...
     * 
     * @param ActivityMetadata $item
     * @return self
     */
    public function addValue(ActivityMetadata $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ActivityMetadata>
     */
