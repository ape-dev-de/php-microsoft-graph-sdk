...
/**
 * Collection response for EducationTerm
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationTermCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationTerm[]
     */
     ...
     * 
     * @param EducationTerm[] $items
     * @return self
     */
    public function setValue(array|EducationTerm $items, EducationTerm ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationTerm> $value
     * @return self
     ...
     * 
     * @param EducationTerm $item
     * @return self
     */
    public function addValue(EducationTerm $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationTerm>
     */
