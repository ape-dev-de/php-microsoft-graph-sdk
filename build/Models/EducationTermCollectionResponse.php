 ...
 */
class EducationTermCollectionResponse
{
    /**
     * @var EducationTerm[]
     */
     ...
     * 
     * @param EducationTerm ...$items Variable number of EducationTerm items
     * @return self
     */
    public function setValue(EducationTerm ...$items): self
    {
        $this->value = $items;
        return $this;
    }
