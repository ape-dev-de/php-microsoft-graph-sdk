...
/**
 * Collection response for AuthenticationMethodsPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationMethodsPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuthenticationMethodsPolicy[]
     */
    private array $value = [];
     ...
     * 
     * @param AuthenticationMethodsPolicy[] $items
     * @return self
     */
    public function setValue(array|AuthenticationMethodsPolicy $items, AuthenticationMethodsPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationMethodsPolicy> $value
     * @return self
     ...
     * 
     * @param AuthenticationMethodsPolicy $item
     * @return self
     */
    public function addValue(AuthenticationMethodsPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationMethodsPolicy>
     */
