 ...
 */
class AuthenticationMethodsPolicyCollectionResponse
{
    /**
     ...
     * 
     * @param AuthenticationMethodsPolicy ...$items Variable number of AuthenticationMethodsPolicy items
     * @return self
     */
    public function setValue(AuthenticationMethodsPolicy ...$items): self
    {
        $this->value = $items;
        return $this;
    }
