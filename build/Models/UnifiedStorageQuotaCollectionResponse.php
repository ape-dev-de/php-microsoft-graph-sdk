...
/**
 * Collection response for UnifiedStorageQuota
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedStorageQuotaCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UnifiedStorageQuota[]
     */
    private array $value = [];
     ...
     * 
     * @param UnifiedStorageQuota[] $items
     * @return self
     */
    public function setValue(array|UnifiedStorageQuota $items, UnifiedStorageQuota ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedStorageQuota> $value
     * @return self
     ...
     * 
     * @param UnifiedStorageQuota $item
     * @return self
     */
    public function addValue(UnifiedStorageQuota $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UnifiedStorageQuota>
     */
