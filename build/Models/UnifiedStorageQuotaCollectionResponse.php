 ...
 */
class UnifiedStorageQuotaCollectionResponse
{
    /**
     ...
     * 
     * @param UnifiedStorageQuota ...$items Variable number of UnifiedStorageQuota items
     * @return self
     */
    public function setValue(UnifiedStorageQuota ...$items): self
    {
        $this->value = $items;
        return $this;
    }
