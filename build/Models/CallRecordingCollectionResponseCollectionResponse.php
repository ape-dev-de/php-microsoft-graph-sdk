...
/**
 * Collection response for CallRecordingCollectionResponse
 */
class CallRecordingCollectionResponseCollectionResponse
{
    /**
     * @var CallRecordingCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CallRecordingCollectionResponse ...$items Variable number of CallRecordingCollectionResponse items
     * @return self
     */
    public function setValue(CallRecordingCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CallRecordingCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CallRecordingCollectionResponse $item
     * @return self
     */
    public function addValue(CallRecordingCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
