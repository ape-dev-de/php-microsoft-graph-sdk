...
/**
 * Collection response for TeamSpecialization
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamSpecializationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TeamSpecialization[] $items
     * @return self
     */
    public function setValue(array|TeamSpecialization $items, TeamSpecialization ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamSpecialization> $value
     * @return self
     ...
     * 
     * @param TeamSpecialization $item
     * @return self
     */
    public function addValue(TeamSpecialization $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamSpecialization>
     */
