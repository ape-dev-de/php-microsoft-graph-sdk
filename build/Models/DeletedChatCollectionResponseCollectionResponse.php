...
/**
 * Collection response for DeletedChatCollectionResponse
 */
class DeletedChatCollectionResponseCollectionResponse
{
    /**
     * @var DeletedChatCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DeletedChatCollectionResponse ...$items Variable number of DeletedChatCollectionResponse items
     * @return self
     */
    public function setValue(DeletedChatCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeletedChatCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeletedChatCollectionResponse $item
     * @return self
     */
    public function addValue(DeletedChatCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
