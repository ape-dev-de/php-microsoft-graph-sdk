 ...
 */
class EducationLinkResourceCollectionResponse
{
    /**
     ...
     * 
     * @param EducationLinkResource ...$items Variable number of EducationLinkResource items
     * @return self
     */
    public function setValue(EducationLinkResource ...$items): self
    {
        $this->value = $items;
        return $this;
    }
