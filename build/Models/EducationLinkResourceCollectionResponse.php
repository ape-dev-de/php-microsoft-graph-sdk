...
/**
 * Collection response for EducationLinkResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationLinkResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationLinkResource[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationLinkResource[] $items
     * @return self
     */
    public function setValue(array|EducationLinkResource $items, EducationLinkResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationLinkResource> $value
     * @return self
     ...
     * 
     * @param EducationLinkResource $item
     * @return self
     */
    public function addValue(EducationLinkResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EducationLinkResource|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EducationLinkResource>
     */
