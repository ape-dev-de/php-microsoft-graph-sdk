...
/**
 * Collection response for SecurityMailboxEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityMailboxEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityMailboxEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityMailboxEvidence[]
     */
     ...
     * 
     * @param SecurityMailboxEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityMailboxEvidence $items, SecurityMailboxEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityMailboxEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityMailboxEvidence $item
     * @return self
     */
    public function addValue(SecurityMailboxEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityMailboxEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityMailboxEvidence>
     */
