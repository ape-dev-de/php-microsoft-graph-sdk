 ...
 */
class SecurityMailboxEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityMailboxEvidence ...$items Variable number of SecurityMailboxEvidence items
     * @return self
     */
    public function setValue(SecurityMailboxEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
