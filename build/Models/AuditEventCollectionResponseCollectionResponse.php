...
/**
 * Collection response for AuditEventCollectionResponse
 */
class AuditEventCollectionResponseCollectionResponse
{
    /**
     * @var AuditEventCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AuditEventCollectionResponse ...$items Variable number of AuditEventCollectionResponse items
     * @return self
     */
    public function setValue(AuditEventCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AuditEventCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AuditEventCollectionResponse $item
     * @return self
     */
    public function addValue(AuditEventCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
