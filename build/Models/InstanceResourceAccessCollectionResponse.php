 ...
 */
class InstanceResourceAccessCollectionResponse
{
    /**
     ...
     * 
     * @param InstanceResourceAccess ...$items Variable number of InstanceResourceAccess items
     * @return self
     */
    public function setValue(InstanceResourceAccess ...$items): self
    {
        $this->value = $items;
        return $this;
    }
