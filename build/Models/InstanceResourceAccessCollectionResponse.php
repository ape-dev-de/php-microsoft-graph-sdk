...
/**
 * Collection response for InstanceResourceAccess
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InstanceResourceAccessCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var InstanceResourceAccess[]
     */
    private array $value = [];
     ...
     * 
     * @param InstanceResourceAccess[] $items
     * @return self
     */
    public function setValue(array|InstanceResourceAccess $items, InstanceResourceAccess ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InstanceResourceAccess> $value
     * @return self
     ...
     * 
     * @param InstanceResourceAccess $item
     * @return self
     */
    public function addValue(InstanceResourceAccess $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return InstanceResourceAccess|null
     */
     ...
     * 
     * @return \ArrayIterator<int, InstanceResourceAccess>
     */
