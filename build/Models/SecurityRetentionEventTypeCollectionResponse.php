...
/**
 * Collection response for SecurityRetentionEventType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityRetentionEventTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityRetentionEventType[] $items
     * @return self
     */
    public function setValue(array|SecurityRetentionEventType $items, SecurityRetentionEventType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityRetentionEventType> $value
     * @return self
     ...
     * 
     * @param SecurityRetentionEventType $item
     * @return self
     */
    public function addValue(SecurityRetentionEventType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityRetentionEventType>
     */
