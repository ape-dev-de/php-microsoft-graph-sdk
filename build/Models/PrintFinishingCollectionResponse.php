...
/**
 * Collection response for PrintFinishing
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintFinishingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrintFinishing[]
     */
     ...
     * 
     * @param PrintFinishing[] $items
     * @return self
     */
    public function setValue(array|PrintFinishing $items, PrintFinishing ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintFinishing> $value
     * @return self
     ...
     * 
     * @param PrintFinishing $item
     * @return self
     */
    public function addValue(PrintFinishing $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintFinishing>
     */
