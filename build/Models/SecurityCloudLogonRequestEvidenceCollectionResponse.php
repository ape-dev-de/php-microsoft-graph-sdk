 ...
 */
class SecurityCloudLogonRequestEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityCloudLogonRequestEvidence ...$items Variable number of SecurityCloudLogonRequestEvidence items
     * @return self
     */
    public function setValue(SecurityCloudLogonRequestEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
