...
/**
 * Collection response for SecurityCloudLogonRequestEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityCloudLogonRequestEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityCloudLogonRequestEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityCloudLogonRequestEvidence[]
     */
     ...
     * 
     * @param SecurityCloudLogonRequestEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityCloudLogonRequestEvidence $items, SecurityCloudLogonRequestEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityCloudLogonRequestEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityCloudLogonRequestEvidence $item
     * @return self
     */
    public function addValue(SecurityCloudLogonRequestEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityCloudLogonRequestEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityCloudLogonRequestEvidence>
     */
