...
/**
 * Collection response for ExternalConnectorsExternalActivity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalConnectorsExternalActivityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ExternalConnectorsExternalActivity[] $items
     * @return self
     */
    public function setValue(array|ExternalConnectorsExternalActivity $items, ExternalConnectorsExternalActivity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalConnectorsExternalActivity> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsExternalActivity $item
     * @return self
     */
    public function addValue(ExternalConnectorsExternalActivity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ExternalConnectorsExternalActivity>
     */
