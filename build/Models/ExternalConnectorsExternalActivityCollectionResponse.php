...
/**
 * ExternalConnectorsExternalActivityCollectionResponse - Collection response
 */
class ExternalConnectorsExternalActivityCollectionResponse
{
    /**
     * @var array<int, ExternalConnectorsExternalActivity>
     */
    public array $value = [];
