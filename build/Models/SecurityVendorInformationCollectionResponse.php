...
/**
 * Collection response for SecurityVendorInformation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityVendorInformationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityVendorInformation[] $items
     * @return self
     */
    public function setValue(array|SecurityVendorInformation $items, SecurityVendorInformation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityVendorInformation> $value
     * @return self
     ...
     * 
     * @param SecurityVendorInformation $item
     * @return self
     */
    public function addValue(SecurityVendorInformation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityVendorInformation>
     */
