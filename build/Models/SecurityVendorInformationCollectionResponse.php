 ...
 */
class SecurityVendorInformationCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityVendorInformation ...$items Variable number of SecurityVendorInformation items
     * @return self
     */
    public function setValue(SecurityVendorInformation ...$items): self
    {
        $this->value = $items;
        return $this;
    }
