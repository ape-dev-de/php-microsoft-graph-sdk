...
/**
 * Collection response for LookupColumn
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LookupColumnCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var LookupColumn[]
     */
     ...
     * 
     * @param LookupColumn[] $items
     * @return self
     */
    public function setValue(array|LookupColumn $items, LookupColumn ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LookupColumn> $value
     * @return self
     ...
     * 
     * @param LookupColumn $item
     * @return self
     */
    public function addValue(LookupColumn $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LookupColumn>
     */
