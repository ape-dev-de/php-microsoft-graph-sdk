...
/**
 * Collection response for IdentityGovernanceValueType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceValueTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceValueType[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceValueType[]
     */
     ...
     * 
     * @param IdentityGovernanceValueType[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceValueType $items, IdentityGovernanceValueType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceValueType> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceValueType $item
     * @return self
     */
    public function addValue(IdentityGovernanceValueType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceValueType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceValueType>
     */
