...
/**
 * IdentityGovernanceValueTypeCollectionResponse - Collection response
 */
class IdentityGovernanceValueTypeCollectionResponse
{
    /**
     * @var array<int, IdentityGovernanceValueType>
     */
    public array $value = [];
