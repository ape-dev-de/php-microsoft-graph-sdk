...
/**
 * Collection response for UserAttributeValuesItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserAttributeValuesItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserAttributeValuesItem[] $items
     * @return self
     */
    public function setValue(array|UserAttributeValuesItem $items, UserAttributeValuesItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserAttributeValuesItem> $value
     * @return self
     ...
     * 
     * @param UserAttributeValuesItem $item
     * @return self
     */
    public function addValue(UserAttributeValuesItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UserAttributeValuesItem|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UserAttributeValuesItem>
     */
