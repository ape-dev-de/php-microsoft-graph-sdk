...
/**
 * Collection response for IosStoreAppCollectionResponse
 */
class IosStoreAppCollectionResponseCollectionResponse
{
    /**
     * @var IosStoreAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IosStoreAppCollectionResponse ...$items Variable number of IosStoreAppCollectionResponse items
     * @return self
     */
    public function setValue(IosStoreAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IosStoreAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IosStoreAppCollectionResponse $item
     * @return self
     */
    public function addValue(IosStoreAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
