...
/**
 * Collection response for DeviceComplianceScheduledActionForRuleCollectionResponse
 */
class DeviceComplianceScheduledActionForRuleCollectionResponseCollectionResponse
{
    /**
     * @var DeviceComplianceScheduledActionForRuleCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceComplianceScheduledActionForRuleCollectionResponse ...$items Variable number of DeviceComplianceScheduledActionForRuleCollectionResponse items
     * @return self
     */
    public function setValue(DeviceComplianceScheduledActionForRuleCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeviceComplianceScheduledActionForRuleCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeviceComplianceScheduledActionForRuleCollectionResponse $item
     * @return self
     */
    public function addValue(DeviceComplianceScheduledActionForRuleCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
