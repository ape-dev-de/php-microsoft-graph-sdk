...
/**
 * Collection response for OutgoingCallOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OutgoingCallOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OutgoingCallOptions[]
     */
    private array $value = [];
     ...
     * 
     * @param OutgoingCallOptions[] $items
     * @return self
     */
    public function setValue(array|OutgoingCallOptions $items, OutgoingCallOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OutgoingCallOptions> $value
     * @return self
     ...
     * 
     * @param OutgoingCallOptions $item
     * @return self
     */
    public function addValue(OutgoingCallOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OutgoingCallOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OutgoingCallOptions>
     */
