...
/**
 * Collection response for SimulationEventCollectionResponse
 */
class SimulationEventCollectionResponseCollectionResponse
{
    /**
     * @var SimulationEventCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SimulationEventCollectionResponse ...$items Variable number of SimulationEventCollectionResponse items
     * @return self
     */
    public function setValue(SimulationEventCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SimulationEventCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SimulationEventCollectionResponse $item
     * @return self
     */
    public function addValue(SimulationEventCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
