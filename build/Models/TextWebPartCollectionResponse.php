...
/**
 * Collection response for TextWebPart
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TextWebPartCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TextWebPart[]
     */
     ...
     * 
     * @param TextWebPart[] $items
     * @return self
     */
    public function setValue(array|TextWebPart $items, TextWebPart ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param TextWebPart $item
     * @return self
     */
    public function addValue(TextWebPart $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TextWebPart>
     */
