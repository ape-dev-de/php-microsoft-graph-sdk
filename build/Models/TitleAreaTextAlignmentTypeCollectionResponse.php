...
/**
 * TitleAreaTextAlignmentTypeCollectionResponse - Collection response
 */
class TitleAreaTextAlignmentTypeCollectionResponse
{
    /**
     * @var array<int, TitleAreaTextAlignmentType>
     */
    public array $value = [];
