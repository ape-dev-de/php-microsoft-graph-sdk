...
/**
 * Collection response for TitleAreaTextAlignmentType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TitleAreaTextAlignmentTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TitleAreaTextAlignmentType[]
     */
    private array $value = [];
     ...
     * 
     * @return TitleAreaTextAlignmentType[]
     */
     ...
     * 
     * @param TitleAreaTextAlignmentType[] $items
     * @return self
     */
    public function setValue(array|TitleAreaTextAlignmentType $items, TitleAreaTextAlignmentType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TitleAreaTextAlignmentType> $value
     * @return self
     ...
     * 
     * @param TitleAreaTextAlignmentType $item
     * @return self
     */
    public function addValue(TitleAreaTextAlignmentType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TitleAreaTextAlignmentType>
     */
