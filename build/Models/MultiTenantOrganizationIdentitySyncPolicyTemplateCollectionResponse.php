 ...
 */
class MultiTenantOrganizationIdentitySyncPolicyTemplateCollectionResponse
{
    /**
     ...
     * 
     * @param MultiTenantOrganizationIdentitySyncPolicyTemplate ...$items Variable number of MultiTenantOrganizationIdentitySyncPolicyTemplate items
     * @return self
     */
    public function setValue(MultiTenantOrganizationIdentitySyncPolicyTemplate ...$items): self
    {
        $this->value = $items;
        return $this;
    }
