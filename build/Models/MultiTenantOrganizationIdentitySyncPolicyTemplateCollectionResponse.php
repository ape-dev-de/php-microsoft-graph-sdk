...
/**
 * Collection response for MultiTenantOrganizationIdentitySyncPolicyTemplate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MultiTenantOrganizationIdentitySyncPolicyTemplateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MultiTenantOrganizationIdentitySyncPolicyTemplate[]
     */
    private array $value = [];
     ...
     * 
     * @param MultiTenantOrganizationIdentitySyncPolicyTemplate[] $items
     * @return self
     */
    public function setValue(array|MultiTenantOrganizationIdentitySyncPolicyTemplate $items, MultiTenantOrganizationIdentitySyncPolicyTemplate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MultiTenantOrganizationIdentitySyncPolicyTemplate> $value
     * @return self
     ...
     * 
     * @param MultiTenantOrganizationIdentitySyncPolicyTemplate $item
     * @return self
     */
    public function addValue(MultiTenantOrganizationIdentitySyncPolicyTemplate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MultiTenantOrganizationIdentitySyncPolicyTemplate>
     */
