...
/**
 * MultiTenantOrganizationIdentitySyncPolicyTemplateCollectionResponse - Collection response
 */
class MultiTenantOrganizationIdentitySyncPolicyTemplateCollectionResponse
{
    /**
     * @var array<int, MultiTenantOrganizationIdentitySyncPolicyTemplate>
     */
    public array $value = [];
