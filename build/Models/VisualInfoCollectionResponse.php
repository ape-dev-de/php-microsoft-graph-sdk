...
/**
 * Collection response for VisualInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VisualInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VisualInfo[]
     */
     ...
     * 
     * @param VisualInfo[] $items
     * @return self
     */
    public function setValue(array|VisualInfo $items, VisualInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param VisualInfo $item
     * @return self
     */
    public function addValue(VisualInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VisualInfo>
     */
