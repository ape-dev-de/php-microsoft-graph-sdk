...
/**
 * WindowsDefenderAdvancedThreatProtectionConfigurationCollectionResponse - Collection response
 */
class WindowsDefenderAdvancedThreatProtectionConfigurationCollectionResponse
{
    /**
     * @var array<int, WindowsDefenderAdvancedThreatProtectionConfiguration>
     */
    public array $value = [];
