...
/**
 * Collection response for WindowsDefenderAdvancedThreatProtectionConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsDefenderAdvancedThreatProtectionConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsDefenderAdvancedThreatProtectionConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsDefenderAdvancedThreatProtectionConfiguration[] $items
     * @return self
     */
    public function setValue(array|WindowsDefenderAdvancedThreatProtectionConfiguration $items, WindowsDefenderAdvancedThreatProtectionConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsDefenderAdvancedThreatProtectionConfiguration> $value
     * @return self
     ...
     * 
     * @param WindowsDefenderAdvancedThreatProtectionConfiguration $item
     * @return self
     */
    public function addValue(WindowsDefenderAdvancedThreatProtectionConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WindowsDefenderAdvancedThreatProtectionConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WindowsDefenderAdvancedThreatProtectionConfiguration>
     */
