...
/**
 * Collection response for IdentityGovernanceTaskProcessingResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceTaskProcessingResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IdentityGovernanceTaskProcessingResult[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceTaskProcessingResult $items, IdentityGovernanceTaskProcessingResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceTaskProcessingResult> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceTaskProcessingResult $item
     * @return self
     */
    public function addValue(IdentityGovernanceTaskProcessingResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceTaskProcessingResult>
     */
