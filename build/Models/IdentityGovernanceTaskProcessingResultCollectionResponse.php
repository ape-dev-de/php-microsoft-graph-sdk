...
/**
 * IdentityGovernanceTaskProcessingResultCollectionResponse - Collection response
 */
class IdentityGovernanceTaskProcessingResultCollectionResponse
{
    /**
     * @var array<int, IdentityGovernanceTaskProcessingResult>
     */
    public array $value = [];
