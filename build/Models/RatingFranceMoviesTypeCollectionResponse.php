...
/**
 * Collection response for RatingFranceMoviesType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RatingFranceMoviesTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RatingFranceMoviesType[]
     */
    private array $value = [];
     ...
     * 
     * @param RatingFranceMoviesType[] $items
     * @return self
     */
    public function setValue(array|RatingFranceMoviesType $items, RatingFranceMoviesType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RatingFranceMoviesType> $value
     * @return self
     ...
     * 
     * @param RatingFranceMoviesType $item
     * @return self
     */
    public function addValue(RatingFranceMoviesType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RatingFranceMoviesType>
     */
