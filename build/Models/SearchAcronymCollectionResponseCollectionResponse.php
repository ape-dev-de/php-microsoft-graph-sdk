...
/**
 * Collection response for SearchAcronymCollectionResponse
 */
class SearchAcronymCollectionResponseCollectionResponse
{
    /**
     * @var SearchAcronymCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SearchAcronymCollectionResponse ...$items Variable number of SearchAcronymCollectionResponse items
     * @return self
     */
    public function setValue(SearchAcronymCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SearchAcronymCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SearchAcronymCollectionResponse $item
     * @return self
     */
    public function addValue(SearchAcronymCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
