...
/**
 * Collection response for SubjectRightsRequestStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SubjectRightsRequestStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SubjectRightsRequestStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return SubjectRightsRequestStatus[]
     */
     ...
     * 
     * @param SubjectRightsRequestStatus[] $items
     * @return self
     */
    public function setValue(array|SubjectRightsRequestStatus $items, SubjectRightsRequestStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SubjectRightsRequestStatus> $value
     * @return self
     ...
     * 
     * @param SubjectRightsRequestStatus $item
     * @return self
     */
    public function addValue(SubjectRightsRequestStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SubjectRightsRequestStatus>
     */
