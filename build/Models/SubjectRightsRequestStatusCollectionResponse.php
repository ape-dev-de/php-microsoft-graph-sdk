...
/**
 * SubjectRightsRequestStatusCollectionResponse - Collection response
 */
class SubjectRightsRequestStatusCollectionResponse
{
    /**
     * @var array<int, SubjectRightsRequestStatus>
     */
    public array $value = [];
