...
/**
 * Collection response for WorkbookTableColumn
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookTableColumnCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookTableColumn[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookTableColumn[] $items
     * @return self
     */
    public function setValue(array|WorkbookTableColumn $items, WorkbookTableColumn ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookTableColumn> $value
     * @return self
     ...
     * 
     * @param WorkbookTableColumn $item
     * @return self
     */
    public function addValue(WorkbookTableColumn $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookTableColumn>
     */
