...
/**
 * Collection response for SecurityRegistryKeyEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityRegistryKeyEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityRegistryKeyEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityRegistryKeyEvidence[]
     */
     ...
     * 
     * @param SecurityRegistryKeyEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityRegistryKeyEvidence $items, SecurityRegistryKeyEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityRegistryKeyEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityRegistryKeyEvidence $item
     * @return self
     */
    public function addValue(SecurityRegistryKeyEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityRegistryKeyEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityRegistryKeyEvidence>
     */
