 ...
 */
class SecurityRegistryKeyEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityRegistryKeyEvidence ...$items Variable number of SecurityRegistryKeyEvidence items
     * @return self
     */
    public function setValue(SecurityRegistryKeyEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
