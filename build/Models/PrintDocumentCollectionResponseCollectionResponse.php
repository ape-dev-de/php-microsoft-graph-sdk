...
/**
 * Collection response for PrintDocumentCollectionResponse
 */
class PrintDocumentCollectionResponseCollectionResponse
{
    /**
     * @var PrintDocumentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PrintDocumentCollectionResponse ...$items Variable number of PrintDocumentCollectionResponse items
     * @return self
     */
    public function setValue(PrintDocumentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PrintDocumentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PrintDocumentCollectionResponse $item
     * @return self
     */
    public function addValue(PrintDocumentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
