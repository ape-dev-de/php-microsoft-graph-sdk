...
/**
 * Collection response for MessageCollectionResponse
 */
class MessageCollectionResponseCollectionResponse
{
    /**
     * @var MessageCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MessageCollectionResponse ...$items Variable number of MessageCollectionResponse items
     * @return self
     */
    public function setValue(MessageCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MessageCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MessageCollectionResponse $item
     * @return self
     */
    public function addValue(MessageCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
