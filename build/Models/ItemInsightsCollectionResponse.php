...
/**
 * Collection response for ItemInsights
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ItemInsightsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ItemInsights[]
     */
     ...
     * 
     * @param ItemInsights[] $items
     * @return self
     */
    public function setValue(array|ItemInsights $items, ItemInsights ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ItemInsights> $value
     * @return self
     ...
     * 
     * @param ItemInsights $item
     * @return self
     */
    public function addValue(ItemInsights $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ItemInsights>
     */
