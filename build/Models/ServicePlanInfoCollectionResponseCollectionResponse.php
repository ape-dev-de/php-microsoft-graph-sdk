...
/**
 * Collection response for ServicePlanInfoCollectionResponse
 */
class ServicePlanInfoCollectionResponseCollectionResponse
{
    /**
     * @var ServicePlanInfoCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ServicePlanInfoCollectionResponse ...$items Variable number of ServicePlanInfoCollectionResponse items
     * @return self
     */
    public function setValue(ServicePlanInfoCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ServicePlanInfoCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ServicePlanInfoCollectionResponse $item
     * @return self
     */
    public function addValue(ServicePlanInfoCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
