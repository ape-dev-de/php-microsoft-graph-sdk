...
/**
 * Collection response for MediaStreamCollectionResponse
 */
class MediaStreamCollectionResponseCollectionResponse
{
    /**
     * @var MediaStreamCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MediaStreamCollectionResponse ...$items Variable number of MediaStreamCollectionResponse items
     * @return self
     */
    public function setValue(MediaStreamCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MediaStreamCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MediaStreamCollectionResponse $item
     * @return self
     */
    public function addValue(MediaStreamCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
