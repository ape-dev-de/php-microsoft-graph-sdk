...
/**
 * Collection response for InferenceClassification
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InferenceClassificationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var InferenceClassification[]
     */
    private array $value = [];
     ...
     * 
     * @param InferenceClassification[] $items
     * @return self
     */
    public function setValue(array|InferenceClassification $items, InferenceClassification ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InferenceClassification> $value
     * @return self
     ...
     * 
     * @param InferenceClassification $item
     * @return self
     */
    public function addValue(InferenceClassification $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, InferenceClassification>
     */
