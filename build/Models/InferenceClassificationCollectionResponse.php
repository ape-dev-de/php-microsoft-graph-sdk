 ...
 */
class InferenceClassificationCollectionResponse
{
    /**
     ...
     * 
     * @param InferenceClassification ...$items Variable number of InferenceClassification items
     * @return self
     */
    public function setValue(InferenceClassification ...$items): self
    {
        $this->value = $items;
        return $this;
    }
