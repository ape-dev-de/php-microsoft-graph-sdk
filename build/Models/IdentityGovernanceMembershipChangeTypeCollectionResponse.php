...
/**
 * Collection response for IdentityGovernanceMembershipChangeType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceMembershipChangeTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceMembershipChangeType[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceMembershipChangeType[]
     */
     ...
     * 
     * @param IdentityGovernanceMembershipChangeType[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceMembershipChangeType $items, IdentityGovernanceMembershipChangeType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceMembershipChangeType> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceMembershipChangeType $item
     * @return self
     */
    public function addValue(IdentityGovernanceMembershipChangeType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceMembershipChangeType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceMembershipChangeType>
     */
