...
/**
 * IdentityGovernanceMembershipChangeTypeCollectionResponse - Collection response
 */
class IdentityGovernanceMembershipChangeTypeCollectionResponse
{
    /**
     * @var array<int, IdentityGovernanceMembershipChangeType>
     */
    public array $value = [];
