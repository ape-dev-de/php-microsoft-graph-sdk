...
/**
 * Collection response for ServiceAnnouncementAttachment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServiceAnnouncementAttachmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ServiceAnnouncementAttachment[] $items
     * @return self
     */
    public function setValue(array|ServiceAnnouncementAttachment $items, ServiceAnnouncementAttachment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServiceAnnouncementAttachment> $value
     * @return self
     ...
     * 
     * @param ServiceAnnouncementAttachment $item
     * @return self
     */
    public function addValue(ServiceAnnouncementAttachment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ServiceAnnouncementAttachment>
     */
