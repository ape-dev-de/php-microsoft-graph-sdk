...
/**
 * Collection response for Sensitivity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SensitivityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Sensitivity[]
     */
     ...
     * 
     * @param Sensitivity[] $items
     * @return self
     */
    public function setValue(array|Sensitivity $items, Sensitivity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param Sensitivity $item
     * @return self
     */
    public function addValue(Sensitivity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Sensitivity>
     */
