...
/**
 * Collection response for MigrationStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MigrationStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MigrationStatus[]
     */
     ...
     * 
     * @param MigrationStatus[] $items
     * @return self
     */
    public function setValue(array|MigrationStatus $items, MigrationStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MigrationStatus> $value
     * @return self
     ...
     * 
     * @param MigrationStatus $item
     * @return self
     */
    public function addValue(MigrationStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
