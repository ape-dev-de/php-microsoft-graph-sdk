...
/**
 * Collection response for RatingCanadaTelevisionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RatingCanadaTelevisionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RatingCanadaTelevisionType[]
     */
    private array $value = [];
     ...
     * 
     * @return RatingCanadaTelevisionType[]
     */
     ...
     * 
     * @param RatingCanadaTelevisionType[] $items
     * @return self
     */
    public function setValue(array|RatingCanadaTelevisionType $items, RatingCanadaTelevisionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RatingCanadaTelevisionType> $value
     * @return self
     ...
     * 
     * @param RatingCanadaTelevisionType $item
     * @return self
     */
    public function addValue(RatingCanadaTelevisionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RatingCanadaTelevisionType>
     */
