...
/**
 * RatingCanadaTelevisionTypeCollectionResponse - Collection response
 */
class RatingCanadaTelevisionTypeCollectionResponse
{
    /**
     * @var array<int, RatingCanadaTelevisionType>
     */
    public array $value = [];
