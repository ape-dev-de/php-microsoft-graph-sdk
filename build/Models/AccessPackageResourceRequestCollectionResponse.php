...
/**
 * Collection response for AccessPackageResourceRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageResourceRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessPackageResourceRequest[] $items
     * @return self
     */
    public function setValue(array|AccessPackageResourceRequest $items, AccessPackageResourceRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageResourceRequest> $value
     * @return self
     ...
     * 
     * @param AccessPackageResourceRequest $item
     * @return self
     */
    public function addValue(AccessPackageResourceRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageResourceRequest>
     */
