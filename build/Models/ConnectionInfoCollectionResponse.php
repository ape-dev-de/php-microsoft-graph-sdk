...
/**
 * Collection response for ConnectionInfo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConnectionInfoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConnectionInfo[]
     */
     ...
     * 
     * @param ConnectionInfo[] $items
     * @return self
     */
    public function setValue(array|ConnectionInfo $items, ConnectionInfo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConnectionInfo> $value
     * @return self
     ...
     * 
     * @param ConnectionInfo $item
     * @return self
     */
    public function addValue(ConnectionInfo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConnectionInfo>
     */
