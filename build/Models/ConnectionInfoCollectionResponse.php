 ...
 */
class ConnectionInfoCollectionResponse
{
    /**
     * @var ConnectionInfo[]
     */
     ...
     * 
     * @param ConnectionInfo ...$items Variable number of ConnectionInfo items
     * @return self
     */
    public function setValue(ConnectionInfo ...$items): self
    {
        $this->value = $items;
        return $this;
    }
