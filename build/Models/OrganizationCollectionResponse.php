...
/**
 * Collection response for Organization
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OrganizationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Organization[]
     */
     ...
     * @return self
     */
    public function setValue(array|Organization $items, Organization ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Organization $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Organization>
     */
