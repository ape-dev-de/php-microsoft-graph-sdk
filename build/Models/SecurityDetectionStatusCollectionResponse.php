...
/**
 * Collection response for SecurityDetectionStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityDetectionStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityDetectionStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityDetectionStatus[]
     */
     ...
     * 
     * @param SecurityDetectionStatus[] $items
     * @return self
     */
    public function setValue(array|SecurityDetectionStatus $items, SecurityDetectionStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityDetectionStatus> $value
     * @return self
     ...
     * 
     * @param SecurityDetectionStatus $item
     * @return self
     */
    public function addValue(SecurityDetectionStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityDetectionStatus|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityDetectionStatus>
     */
