 ...
 */
class ChatMembersNotificationRecipientCollectionResponse
{
    /**
     ...
     * 
     * @param ChatMembersNotificationRecipient ...$items Variable number of ChatMembersNotificationRecipient items
     * @return self
     */
    public function setValue(ChatMembersNotificationRecipient ...$items): self
    {
        $this->value = $items;
        return $this;
    }
