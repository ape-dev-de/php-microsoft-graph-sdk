...
/**
 * Collection response for ChatMembersNotificationRecipient
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChatMembersNotificationRecipientCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChatMembersNotificationRecipient[]
     */
    private array $value = [];
     ...
     * 
     * @param ChatMembersNotificationRecipient[] $items
     * @return self
     */
    public function setValue(array|ChatMembersNotificationRecipient $items, ChatMembersNotificationRecipient ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChatMembersNotificationRecipient> $value
     * @return self
     ...
     * 
     * @param ChatMembersNotificationRecipient $item
     * @return self
     */
    public function addValue(ChatMembersNotificationRecipient $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ChatMembersNotificationRecipient|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ChatMembersNotificationRecipient>
     */
