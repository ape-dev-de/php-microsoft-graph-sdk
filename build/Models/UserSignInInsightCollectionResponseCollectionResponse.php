...
/**
 * Collection response for UserSignInInsightCollectionResponse
 */
class UserSignInInsightCollectionResponseCollectionResponse
{
    /**
     * @var UserSignInInsightCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param UserSignInInsightCollectionResponse ...$items Variable number of UserSignInInsightCollectionResponse items
     * @return self
     */
    public function setValue(UserSignInInsightCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<UserSignInInsightCollectionResponse> $value
     * @return self
     ...
     * 
     * @param UserSignInInsightCollectionResponse $item
     * @return self
     */
    public function addValue(UserSignInInsightCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
