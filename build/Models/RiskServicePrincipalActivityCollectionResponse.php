...
/**
 * Collection response for RiskServicePrincipalActivity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RiskServicePrincipalActivityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RiskServicePrincipalActivity[]
     */
    private array $value = [];
     ...
     * 
     * @param RiskServicePrincipalActivity[] $items
     * @return self
     */
    public function setValue(array|RiskServicePrincipalActivity $items, RiskServicePrincipalActivity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RiskServicePrincipalActivity> $value
     * @return self
     ...
     * 
     * @param RiskServicePrincipalActivity $item
     * @return self
     */
    public function addValue(RiskServicePrincipalActivity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RiskServicePrincipalActivity>
     */
