 ...
 */
class RiskServicePrincipalActivityCollectionResponse
{
    /**
     ...
     * 
     * @param RiskServicePrincipalActivity ...$items Variable number of RiskServicePrincipalActivity items
     * @return self
     */
    public function setValue(RiskServicePrincipalActivity ...$items): self
    {
        $this->value = $items;
        return $this;
    }
