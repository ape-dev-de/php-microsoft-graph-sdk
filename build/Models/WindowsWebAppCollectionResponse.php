...
/**
 * Collection response for WindowsWebApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsWebAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsWebApp[]
     */
     ...
     * 
     * @param WindowsWebApp[] $items
     * @return self
     */
    public function setValue(array|WindowsWebApp $items, WindowsWebApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsWebApp> $value
     * @return self
     ...
     * 
     * @param WindowsWebApp $item
     * @return self
     */
    public function addValue(WindowsWebApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsWebApp>
     */
