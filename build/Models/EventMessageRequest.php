...
class EventMessageRequest
{
     ...
     */
    public MeetingMessageType|\stdClass|null $meetingMessageType = null;
     ...
     */
    public Event|\stdClass|null $event = null;
     ...
     */
    public MeetingRequestType|\stdClass|null $meetingRequestType = null;

    /** 
     * If the meeting update changes the meeting end time, this property specifies the previous meeting end time.
     * @var DateTimeTimeZone|\stdClass|null
     */
    public DateTimeTimeZone|\stdClass|null $previousEndDateTime = null;

    /** 
     * If the meeting update changes the meeting location, this property specifies the previous meeting location.
     * @var Location|\stdClass|null
     */
    public Location|\stdClass|null $previousLocation = null;

    /** 
     * If the meeting update changes the meeting start time, this property specifies the previous meeting start time.
     * @var DateTimeTimeZone|\stdClass|null
     */
    public DateTimeTimeZone|\stdClass|null $previousStartDateTime = null;
