...
class EventMessageRequest
{
    ...
    public function __construct(array $data = [])
    {
        ...
        if (isset($data['meetingRequestType'])) {
            $this->meetingRequestType = $data['meetingRequestType'];
        }
        if (isset($data['previousEndDateTime'])) {
            $this->previousEndDateTime = $data['previousEndDateTime'];
        }
        if (isset($data['previousLocation'])) {
            $this->previousLocation = $data['previousLocation'];
        }
        if (isset($data['previousStartDateTime'])) {
            $this->previousStartDateTime = $data['previousStartDateTime'];
        }
