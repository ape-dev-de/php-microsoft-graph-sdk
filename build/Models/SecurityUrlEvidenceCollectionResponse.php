...
/**
 * Collection response for SecurityUrlEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityUrlEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityUrlEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityUrlEvidence $items, SecurityUrlEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityUrlEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityUrlEvidence $item
     * @return self
     */
    public function addValue(SecurityUrlEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityUrlEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityUrlEvidence>
     */
