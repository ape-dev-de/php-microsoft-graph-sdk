...
/**
 * Collection response for SecurityHostReputation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHostReputationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityHostReputation[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityHostReputation[] $items
     * @return self
     */
    public function setValue(array|SecurityHostReputation $items, SecurityHostReputation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHostReputation> $value
     * @return self
     ...
     * 
     * @param SecurityHostReputation $item
     * @return self
     */
    public function addValue(SecurityHostReputation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityHostReputation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityHostReputation>
     */
