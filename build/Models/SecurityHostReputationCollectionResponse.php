 ...
 */
class SecurityHostReputationCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityHostReputation ...$items Variable number of SecurityHostReputation items
     * @return self
     */
    public function setValue(SecurityHostReputation ...$items): self
    {
        $this->value = $items;
        return $this;
    }
