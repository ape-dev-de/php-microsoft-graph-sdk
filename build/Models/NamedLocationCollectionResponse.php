...
/**
 * Collection response for NamedLocation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class NamedLocationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var NamedLocation[]
     */
     ...
     * 
     * @param NamedLocation[] $items
     * @return self
     */
    public function setValue(array|NamedLocation $items, NamedLocation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<NamedLocation> $value
     * @return self
     ...
     * 
     * @param NamedLocation $item
     * @return self
     */
    public function addValue(NamedLocation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, NamedLocation>
     */
