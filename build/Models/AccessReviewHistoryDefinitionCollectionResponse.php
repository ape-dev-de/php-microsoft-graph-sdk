...
/**
 * Collection response for AccessReviewHistoryDefinition
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewHistoryDefinitionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessReviewHistoryDefinition[] $items
     * @return self
     */
    public function setValue(array|AccessReviewHistoryDefinition $items, AccessReviewHistoryDefinition ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewHistoryDefinition> $value
     * @return self
     ...
     * 
     * @param AccessReviewHistoryDefinition $item
     * @return self
     */
    public function addValue(AccessReviewHistoryDefinition $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewHistoryDefinition>
     */
