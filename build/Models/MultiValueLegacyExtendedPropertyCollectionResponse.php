...
/**
 * Collection response for MultiValueLegacyExtendedProperty
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MultiValueLegacyExtendedPropertyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MultiValueLegacyExtendedProperty[] $items
     * @return self
     */
    public function setValue(array|MultiValueLegacyExtendedProperty $items, MultiValueLegacyExtendedProperty ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MultiValueLegacyExtendedProperty> $value
     * @return self
     ...
     * 
     * @param MultiValueLegacyExtendedProperty $item
     * @return self
     */
    public function addValue(MultiValueLegacyExtendedProperty $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MultiValueLegacyExtendedProperty>
     */
