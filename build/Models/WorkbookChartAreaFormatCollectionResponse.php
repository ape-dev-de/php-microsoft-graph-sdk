...
/**
 * Collection response for WorkbookChartAreaFormat
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookChartAreaFormatCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookChartAreaFormat[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookChartAreaFormat[] $items
     * @return self
     */
    public function setValue(array|WorkbookChartAreaFormat $items, WorkbookChartAreaFormat ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookChartAreaFormat> $value
     * @return self
     ...
     * 
     * @param WorkbookChartAreaFormat $item
     * @return self
     */
    public function addValue(WorkbookChartAreaFormat $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookChartAreaFormat>
     */
