 ...
 */
class WorkbookChartAreaFormatCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookChartAreaFormat ...$items Variable number of WorkbookChartAreaFormat items
     * @return self
     */
    public function setValue(WorkbookChartAreaFormat ...$items): self
    {
        $this->value = $items;
        return $this;
    }
