...
/**
 * Collection response for DelegatedPermissionClassification
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DelegatedPermissionClassificationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DelegatedPermissionClassification[] $items
     * @return self
     */
    public function setValue(array|DelegatedPermissionClassification $items, DelegatedPermissionClassification ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DelegatedPermissionClassification> $value
     * @return self
     ...
     * 
     * @param DelegatedPermissionClassification $item
     * @return self
     */
    public function addValue(DelegatedPermissionClassification $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DelegatedPermissionClassification>
     */
