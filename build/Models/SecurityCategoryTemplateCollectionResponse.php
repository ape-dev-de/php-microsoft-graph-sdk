...
/**
 * Collection response for SecurityCategoryTemplate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityCategoryTemplateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityCategoryTemplate[] $items
     * @return self
     */
    public function setValue(array|SecurityCategoryTemplate $items, SecurityCategoryTemplate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityCategoryTemplate> $value
     * @return self
     ...
     * 
     * @param SecurityCategoryTemplate $item
     * @return self
     */
    public function addValue(SecurityCategoryTemplate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityCategoryTemplate>
     */
