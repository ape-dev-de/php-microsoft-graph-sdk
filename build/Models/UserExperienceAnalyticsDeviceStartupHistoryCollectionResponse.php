...
/**
 * Collection response for UserExperienceAnalyticsDeviceStartupHistory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsDeviceStartupHistoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsDeviceStartupHistory[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsDeviceStartupHistory $items, UserExperienceAnalyticsDeviceStartupHistory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsDeviceStartupHistory> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsDeviceStartupHistory $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsDeviceStartupHistory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsDeviceStartupHistory>
     */
