...
class WindowsAutopilotDeploymentProfile
{
    ...
    /**  */
    public ?WindowsAutopilotDeviceType $deviceType = null;
    ...
    public function __construct(array $data = [])
    {
        ...
        if (isset($data['deviceNameTemplate'])) {
        ...
        if (isset($data['managementServiceAppId'])) {
        ...
        if (isset($data['assignedDevices'])) {
            $this->assignedDevices = $data['assignedDevices'];
        }
    }
