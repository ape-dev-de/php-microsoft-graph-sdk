...
/**
 * Collection response for PhoneType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PhoneTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PhoneType[]
     */
     ...
     * 
     * @param PhoneType[] $items
     * @return self
     */
    public function setValue(array|PhoneType $items, PhoneType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param PhoneType $item
     * @return self
     */
    public function addValue(PhoneType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PhoneType>
     */
