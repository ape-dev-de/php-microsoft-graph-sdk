...
/**
 * Collection response for TaskFileAttachment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TaskFileAttachmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TaskFileAttachment[]
     */
    private array $value = [];
     ...
     * 
     * @param TaskFileAttachment[] $items
     * @return self
     */
    public function setValue(array|TaskFileAttachment $items, TaskFileAttachment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TaskFileAttachment> $value
     * @return self
     ...
     * 
     * @param TaskFileAttachment $item
     * @return self
     */
    public function addValue(TaskFileAttachment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TaskFileAttachment|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TaskFileAttachment>
     */
