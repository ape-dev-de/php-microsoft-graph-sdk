...
/**
 * Collection response for AppManagementRestrictionState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppManagementRestrictionStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AppManagementRestrictionState[]
     */
    private array $value = [];
     ...
     * 
     * @return AppManagementRestrictionState[]
     */
     ...
     * 
     * @param AppManagementRestrictionState[] $items
     * @return self
     */
    public function setValue(array|AppManagementRestrictionState $items, AppManagementRestrictionState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppManagementRestrictionState> $value
     * @return self
     ...
     * 
     * @param AppManagementRestrictionState $item
     * @return self
     */
    public function addValue(AppManagementRestrictionState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AppManagementRestrictionState>
     */
