...
/**
 * AppManagementRestrictionStateCollectionResponse - Collection response
 */
class AppManagementRestrictionStateCollectionResponse
{
    /**
     * @var array<int, AppManagementRestrictionState>
     */
    public array $value = [];
