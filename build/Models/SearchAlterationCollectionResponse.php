 ...
 */
class SearchAlterationCollectionResponse
{
    /**
     ...
     * 
     * @param SearchAlteration ...$items Variable number of SearchAlteration items
     * @return self
     */
    public function setValue(SearchAlteration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
