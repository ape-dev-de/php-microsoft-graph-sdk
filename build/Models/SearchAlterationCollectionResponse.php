...
/**
 * Collection response for SearchAlteration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SearchAlterationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SearchAlteration[]
     */
    private array $value = [];
     ...
     * 
     * @param SearchAlteration[] $items
     * @return self
     */
    public function setValue(array|SearchAlteration $items, SearchAlteration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SearchAlteration> $value
     * @return self
     ...
     * 
     * @param SearchAlteration $item
     * @return self
     */
    public function addValue(SearchAlteration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SearchAlteration>
     */
