...
/**
 * Collection response for X509CertificateRuleType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class X509CertificateRuleTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var X509CertificateRuleType[]
     */
    private array $value = [];
     ...
     * 
     * @return X509CertificateRuleType[]
     */
     ...
     * 
     * @param X509CertificateRuleType[] $items
     * @return self
     */
    public function setValue(array|X509CertificateRuleType $items, X509CertificateRuleType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<X509CertificateRuleType> $value
     * @return self
     ...
     * 
     * @param X509CertificateRuleType $item
     * @return self
     */
    public function addValue(X509CertificateRuleType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, X509CertificateRuleType>
     */
