...
/**
 * Collection response for SharedPCConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SharedPCConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SharedPCConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param SharedPCConfiguration[] $items
     * @return self
     */
    public function setValue(array|SharedPCConfiguration $items, SharedPCConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SharedPCConfiguration> $value
     * @return self
     ...
     * 
     * @param SharedPCConfiguration $item
     * @return self
     */
    public function addValue(SharedPCConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SharedPCConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SharedPCConfiguration>
     */
