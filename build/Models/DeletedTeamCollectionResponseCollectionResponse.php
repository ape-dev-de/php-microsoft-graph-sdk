...
/**
 * Collection response for DeletedTeamCollectionResponse
 */
class DeletedTeamCollectionResponseCollectionResponse
{
    /**
     * @var DeletedTeamCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DeletedTeamCollectionResponse ...$items Variable number of DeletedTeamCollectionResponse items
     * @return self
     */
    public function setValue(DeletedTeamCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeletedTeamCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeletedTeamCollectionResponse $item
     * @return self
     */
    public function addValue(DeletedTeamCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
