...
/**
 * Collection response for AttachmentSessionCollectionResponse
 */
class AttachmentSessionCollectionResponseCollectionResponse
{
    /**
     * @var AttachmentSessionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AttachmentSessionCollectionResponse ...$items Variable number of AttachmentSessionCollectionResponse items
     * @return self
     */
    public function setValue(AttachmentSessionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AttachmentSessionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AttachmentSessionCollectionResponse $item
     * @return self
     */
    public function addValue(AttachmentSessionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
