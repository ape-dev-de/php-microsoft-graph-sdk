...
/**
 * Collection response for MicrosoftEdgeChannel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MicrosoftEdgeChannelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MicrosoftEdgeChannel[]
     */
    private array $value = [];
     ...
     * 
     * @param MicrosoftEdgeChannel[] $items
     * @return self
     */
    public function setValue(array|MicrosoftEdgeChannel $items, MicrosoftEdgeChannel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MicrosoftEdgeChannel> $value
     * @return self
     ...
     * 
     * @param MicrosoftEdgeChannel $item
     * @return self
     */
    public function addValue(MicrosoftEdgeChannel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MicrosoftEdgeChannel>
     */
