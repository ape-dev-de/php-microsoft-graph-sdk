...
/**
 * Collection response for RiskEventType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RiskEventTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RiskEventType[]
     */
     ...
     * 
     * @param RiskEventType[] $items
     * @return self
     */
    public function setValue(array|RiskEventType $items, RiskEventType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RiskEventType> $value
     * @return self
     ...
     * 
     * @param RiskEventType $item
     * @return self
     */
    public function addValue(RiskEventType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RiskEventType>
     */
