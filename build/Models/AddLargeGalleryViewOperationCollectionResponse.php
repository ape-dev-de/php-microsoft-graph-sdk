...
/**
 * Collection response for AddLargeGalleryViewOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AddLargeGalleryViewOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AddLargeGalleryViewOperation[]
     */
    private array $value = [];
     ...
     * 
     * @param AddLargeGalleryViewOperation[] $items
     * @return self
     */
    public function setValue(array|AddLargeGalleryViewOperation $items, AddLargeGalleryViewOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AddLargeGalleryViewOperation> $value
     * @return self
     ...
     * 
     * @param AddLargeGalleryViewOperation $item
     * @return self
     */
    public function addValue(AddLargeGalleryViewOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AddLargeGalleryViewOperation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AddLargeGalleryViewOperation>
     */
