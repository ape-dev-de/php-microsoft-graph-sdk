...
/**
 * Collection response for BackupServiceStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BackupServiceStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BackupServiceStatus[]
     */
    private array $value = [];
     ...
     * 
     * @param BackupServiceStatus[] $items
     * @return self
     */
    public function setValue(array|BackupServiceStatus $items, BackupServiceStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BackupServiceStatus> $value
     * @return self
     ...
     * 
     * @param BackupServiceStatus $item
     * @return self
     */
    public function addValue(BackupServiceStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BackupServiceStatus>
     */
