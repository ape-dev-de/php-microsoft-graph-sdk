 ...
 */
class PrintJobConfigurationCollectionResponse
{
    /**
     ...
     * 
     * @param PrintJobConfiguration ...$items Variable number of PrintJobConfiguration items
     * @return self
     */
    public function setValue(PrintJobConfiguration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
