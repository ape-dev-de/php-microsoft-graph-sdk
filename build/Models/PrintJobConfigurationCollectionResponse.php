...
/**
 * Collection response for PrintJobConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintJobConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrintJobConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param PrintJobConfiguration[] $items
     * @return self
     */
    public function setValue(array|PrintJobConfiguration $items, PrintJobConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintJobConfiguration> $value
     * @return self
     ...
     * 
     * @param PrintJobConfiguration $item
     * @return self
     */
    public function addValue(PrintJobConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintJobConfiguration>
     */
