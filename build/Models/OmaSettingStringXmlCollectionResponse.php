...
/**
 * Collection response for OmaSettingStringXml
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OmaSettingStringXmlCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OmaSettingStringXml[]
     */
    private array $value = [];
     ...
     * 
     * @param OmaSettingStringXml[] $items
     * @return self
     */
    public function setValue(array|OmaSettingStringXml $items, OmaSettingStringXml ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OmaSettingStringXml> $value
     * @return self
     ...
     * 
     * @param OmaSettingStringXml $item
     * @return self
     */
    public function addValue(OmaSettingStringXml $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OmaSettingStringXml|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OmaSettingStringXml>
     */
