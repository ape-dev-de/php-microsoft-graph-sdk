 ...
 */
class OmaSettingStringXmlCollectionResponse
{
    /**
     ...
     * 
     * @param OmaSettingStringXml ...$items Variable number of OmaSettingStringXml items
     * @return self
     */
    public function setValue(OmaSettingStringXml ...$items): self
    {
        $this->value = $items;
        return $this;
    }
