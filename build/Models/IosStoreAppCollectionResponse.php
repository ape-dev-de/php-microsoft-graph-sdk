...
/**
 * Collection response for IosStoreApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosStoreAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IosStoreApp[]
     */
     ...
     * 
     * @param IosStoreApp[] $items
     * @return self
     */
    public function setValue(array|IosStoreApp $items, IosStoreApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param IosStoreApp $item
     * @return self
     */
    public function addValue(IosStoreApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IosStoreApp>
     */
