 ...
 */
class WorkbookChartAxisTitleFormatCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookChartAxisTitleFormat ...$items Variable number of WorkbookChartAxisTitleFormat items
     * @return self
     */
    public function setValue(WorkbookChartAxisTitleFormat ...$items): self
    {
        $this->value = $items;
        return $this;
    }
