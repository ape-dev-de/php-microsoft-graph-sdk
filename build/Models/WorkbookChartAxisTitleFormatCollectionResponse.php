...
/**
 * Collection response for WorkbookChartAxisTitleFormat
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookChartAxisTitleFormatCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookChartAxisTitleFormat[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookChartAxisTitleFormat[] $items
     * @return self
     */
    public function setValue(array|WorkbookChartAxisTitleFormat $items, WorkbookChartAxisTitleFormat ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookChartAxisTitleFormat> $value
     * @return self
     ...
     * 
     * @param WorkbookChartAxisTitleFormat $item
     * @return self
     */
    public function addValue(WorkbookChartAxisTitleFormat $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookChartAxisTitleFormat>
     */
