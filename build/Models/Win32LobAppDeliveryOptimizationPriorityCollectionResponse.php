...
/**
 * Collection response for Win32LobAppDeliveryOptimizationPriority
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Win32LobAppDeliveryOptimizationPriorityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Win32LobAppDeliveryOptimizationPriority[]
     */
    private array $value = [];
     ...
     * 
     * @return Win32LobAppDeliveryOptimizationPriority[]
     */
     ...
     * 
     * @param Win32LobAppDeliveryOptimizationPriority[] $items
     * @return self
     */
    public function setValue(array|Win32LobAppDeliveryOptimizationPriority $items, Win32LobAppDeliveryOptimizationPriority ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Win32LobAppDeliveryOptimizationPriority> $value
     * @return self
     ...
     * 
     * @param Win32LobAppDeliveryOptimizationPriority $item
     * @return self
     */
    public function addValue(Win32LobAppDeliveryOptimizationPriority $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Win32LobAppDeliveryOptimizationPriority>
     */
