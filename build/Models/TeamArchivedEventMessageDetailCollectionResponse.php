 ...
 */
class TeamArchivedEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param TeamArchivedEventMessageDetail ...$items Variable number of TeamArchivedEventMessageDetail items
     * @return self
     */
    public function setValue(TeamArchivedEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
