...
/**
 * TeamworkConversationIdentityTypeCollectionResponse - Collection response
 */
class TeamworkConversationIdentityTypeCollectionResponse
{
    /**
     * @var array<int, TeamworkConversationIdentityType>
     */
    public array $value = [];
