...
/**
 * Collection response for TeamworkConversationIdentityType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamworkConversationIdentityTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return TeamworkConversationIdentityType[]
     */
     ...
     * 
     * @param TeamworkConversationIdentityType[] $items
     * @return self
     */
    public function setValue(array|TeamworkConversationIdentityType $items, TeamworkConversationIdentityType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamworkConversationIdentityType> $value
     * @return self
     ...
     * 
     * @param TeamworkConversationIdentityType $item
     * @return self
     */
    public function addValue(TeamworkConversationIdentityType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamworkConversationIdentityType>
     */
