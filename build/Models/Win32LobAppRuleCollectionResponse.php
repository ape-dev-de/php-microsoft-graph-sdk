...
/**
 * Collection response for Win32LobAppRule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Win32LobAppRuleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Win32LobAppRule[]
     */
     ...
     * 
     * @param Win32LobAppRule[] $items
     * @return self
     */
    public function setValue(array|Win32LobAppRule $items, Win32LobAppRule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Win32LobAppRule> $value
     * @return self
     ...
     * 
     * @param Win32LobAppRule $item
     * @return self
     */
    public function addValue(Win32LobAppRule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Win32LobAppRule>
     */
