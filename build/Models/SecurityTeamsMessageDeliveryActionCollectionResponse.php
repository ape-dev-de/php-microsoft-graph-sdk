...
/**
 * Collection response for SecurityTeamsMessageDeliveryAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityTeamsMessageDeliveryActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityTeamsMessageDeliveryAction[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityTeamsMessageDeliveryAction[]
     */
     ...
     * 
     * @param SecurityTeamsMessageDeliveryAction[] $items
     * @return self
     */
    public function setValue(array|SecurityTeamsMessageDeliveryAction $items, SecurityTeamsMessageDeliveryAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityTeamsMessageDeliveryAction> $value
     * @return self
     ...
     * 
     * @param SecurityTeamsMessageDeliveryAction $item
     * @return self
     */
    public function addValue(SecurityTeamsMessageDeliveryAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityTeamsMessageDeliveryAction|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityTeamsMessageDeliveryAction>
     */
