...
/**
 * SecurityTeamsMessageDeliveryActionCollectionResponse - Collection response
 */
class SecurityTeamsMessageDeliveryActionCollectionResponse
{
    /**
     * @var array<int, SecurityTeamsMessageDeliveryAction>
     */
    public array $value = [];
