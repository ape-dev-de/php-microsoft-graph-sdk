...
/**
 * Collection response for WindowsInformationProtectionResourceCollection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsInformationProtectionResourceCollectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WindowsInformationProtectionResourceCollection[] $items
     * @return self
     */
    public function setValue(array|WindowsInformationProtectionResourceCollection $items, WindowsInformationProtectionResourceCollection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsInformationProtectionResourceCollection> $value
     * @return self
     ...
     * 
     * @param WindowsInformationProtectionResourceCollection $item
     * @return self
     */
    public function addValue(WindowsInformationProtectionResourceCollection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WindowsInformationProtectionResourceCollection|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WindowsInformationProtectionResourceCollection>
     */
