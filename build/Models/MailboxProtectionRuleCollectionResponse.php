...
/**
 * Collection response for MailboxProtectionRule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MailboxProtectionRuleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MailboxProtectionRule[] $items
     * @return self
     */
    public function setValue(array|MailboxProtectionRule $items, MailboxProtectionRule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MailboxProtectionRule> $value
     * @return self
     ...
     * 
     * @param MailboxProtectionRule $item
     * @return self
     */
    public function addValue(MailboxProtectionRule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MailboxProtectionRule>
     */
