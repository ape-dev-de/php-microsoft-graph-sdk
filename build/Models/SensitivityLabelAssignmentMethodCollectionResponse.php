...
/**
 * Collection response for SensitivityLabelAssignmentMethod
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SensitivityLabelAssignmentMethodCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SensitivityLabelAssignmentMethod[]
     */
    private array $value = [];
     ...
     * 
     * @return SensitivityLabelAssignmentMethod[]
     */
     ...
     * 
     * @param SensitivityLabelAssignmentMethod[] $items
     * @return self
     */
    public function setValue(array|SensitivityLabelAssignmentMethod $items, SensitivityLabelAssignmentMethod ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SensitivityLabelAssignmentMethod> $value
     * @return self
     ...
     * 
     * @param SensitivityLabelAssignmentMethod $item
     * @return self
     */
    public function addValue(SensitivityLabelAssignmentMethod $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SensitivityLabelAssignmentMethod>
     */
