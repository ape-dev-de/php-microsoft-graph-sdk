...
/**
 * SensitivityLabelAssignmentMethodCollectionResponse - Collection response
 */
class SensitivityLabelAssignmentMethodCollectionResponse
{
    /**
     * @var array<int, SensitivityLabelAssignmentMethod>
     */
    public array $value = [];
