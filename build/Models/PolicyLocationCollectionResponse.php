...
/**
 * Collection response for PolicyLocation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PolicyLocationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PolicyLocation[]
     */
     ...
     * 
     * @param PolicyLocation[] $items
     * @return self
     */
    public function setValue(array|PolicyLocation $items, PolicyLocation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PolicyLocation> $value
     * @return self
     ...
     * 
     * @param PolicyLocation $item
     * @return self
     */
    public function addValue(PolicyLocation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PolicyLocation>
     */
