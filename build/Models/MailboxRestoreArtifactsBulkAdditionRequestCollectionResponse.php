...
/**
 * Collection response for MailboxRestoreArtifactsBulkAdditionRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MailboxRestoreArtifactsBulkAdditionRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MailboxRestoreArtifactsBulkAdditionRequest[] $items
     * @return self
     */
    public function setValue(array|MailboxRestoreArtifactsBulkAdditionRequest $items, MailboxRestoreArtifactsBulkAdditionRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MailboxRestoreArtifactsBulkAdditionRequest> $value
     * @return self
     ...
     * 
     * @param MailboxRestoreArtifactsBulkAdditionRequest $item
     * @return self
     */
    public function addValue(MailboxRestoreArtifactsBulkAdditionRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MailboxRestoreArtifactsBulkAdditionRequest>
     */
