...
/**
 * Collection response for ConditionalAccessAuthenticationFlows
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessAuthenticationFlowsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessAuthenticationFlows[]
     */
    private array $value = [];
     ...
     * 
     * @param ConditionalAccessAuthenticationFlows[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessAuthenticationFlows $items, ConditionalAccessAuthenticationFlows ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessAuthenticationFlows> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessAuthenticationFlows $item
     * @return self
     */
    public function addValue(ConditionalAccessAuthenticationFlows $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessAuthenticationFlows>
     */
