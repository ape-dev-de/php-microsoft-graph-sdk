 ...
 */
class ConditionalAccessAuthenticationFlowsCollectionResponse
{
    /**
     ...
     * 
     * @param ConditionalAccessAuthenticationFlows ...$items Variable number of ConditionalAccessAuthenticationFlows items
     * @return self
     */
    public function setValue(ConditionalAccessAuthenticationFlows ...$items): self
    {
        $this->value = $items;
        return $this;
    }
