...
/**
 * Collection response for WindowsSettingType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsSettingTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsSettingType[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsSettingType[] $items
     * @return self
     */
    public function setValue(array|WindowsSettingType $items, WindowsSettingType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsSettingType> $value
     * @return self
     ...
     * 
     * @param WindowsSettingType $item
     * @return self
     */
    public function addValue(WindowsSettingType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsSettingType>
     */
