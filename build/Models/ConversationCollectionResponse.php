...
/**
 * Collection response for Conversation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConversationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Conversation[]
     */
     ...
     * @return self
     */
    public function setValue(array|Conversation $items, Conversation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param Conversation $item
     * @return self
     */
    public function addValue(Conversation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Conversation>
     */
