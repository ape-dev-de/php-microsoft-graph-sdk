 ...
 */
class DeviceConfigurationUserOverviewCollectionResponse
{
    /**
     ...
     * 
     * @param DeviceConfigurationUserOverview ...$items Variable number of DeviceConfigurationUserOverview items
     * @return self
     */
    public function setValue(DeviceConfigurationUserOverview ...$items): self
    {
        $this->value = $items;
        return $this;
    }
