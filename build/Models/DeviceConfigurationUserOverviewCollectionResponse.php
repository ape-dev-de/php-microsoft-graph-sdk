...
/**
 * Collection response for DeviceConfigurationUserOverview
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceConfigurationUserOverviewCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceConfigurationUserOverview[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceConfigurationUserOverview[] $items
     * @return self
     */
    public function setValue(array|DeviceConfigurationUserOverview $items, DeviceConfigurationUserOverview ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceConfigurationUserOverview> $value
     * @return self
     ...
     * 
     * @param DeviceConfigurationUserOverview $item
     * @return self
     */
    public function addValue(DeviceConfigurationUserOverview $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceConfigurationUserOverview>
     */
