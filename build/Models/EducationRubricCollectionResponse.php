...
/**
 * Collection response for EducationRubric
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationRubricCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationRubric[]
     */
     ...
     * 
     * @param EducationRubric[] $items
     * @return self
     */
    public function setValue(array|EducationRubric $items, EducationRubric ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationRubric> $value
     * @return self
     ...
     * 
     * @param EducationRubric $item
     * @return self
     */
    public function addValue(EducationRubric $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EducationRubric>
     */
