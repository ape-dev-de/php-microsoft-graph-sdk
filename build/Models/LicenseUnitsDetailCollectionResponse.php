 ...
 */
class LicenseUnitsDetailCollectionResponse
{
    /**
     ...
     * 
     * @param LicenseUnitsDetail ...$items Variable number of LicenseUnitsDetail items
     * @return self
     */
    public function setValue(LicenseUnitsDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
