...
/**
 * Collection response for LicenseUnitsDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LicenseUnitsDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param LicenseUnitsDetail[] $items
     * @return self
     */
    public function setValue(array|LicenseUnitsDetail $items, LicenseUnitsDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LicenseUnitsDetail> $value
     * @return self
     ...
     * 
     * @param LicenseUnitsDetail $item
     * @return self
     */
    public function addValue(LicenseUnitsDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LicenseUnitsDetail>
     */
