...
/**
 * Collection response for Prompt
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PromptCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Prompt[]
     */
     ...
     * @return self
     */
    public function setValue(array|Prompt $items, Prompt ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Prompt $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Prompt>
     */
