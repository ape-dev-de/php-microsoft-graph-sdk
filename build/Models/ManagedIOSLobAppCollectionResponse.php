...
/**
 * Collection response for ManagedIOSLobApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedIOSLobAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ManagedIOSLobApp[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedIOSLobApp[] $items
     * @return self
     */
    public function setValue(array|ManagedIOSLobApp $items, ManagedIOSLobApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedIOSLobApp> $value
     * @return self
     ...
     * 
     * @param ManagedIOSLobApp $item
     * @return self
     */
    public function addValue(ManagedIOSLobApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedIOSLobApp>
     */
