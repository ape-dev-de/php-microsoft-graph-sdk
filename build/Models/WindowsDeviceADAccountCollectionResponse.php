...
/**
 * Collection response for WindowsDeviceADAccount
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsDeviceADAccountCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsDeviceADAccount[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsDeviceADAccount[] $items
     * @return self
     */
    public function setValue(array|WindowsDeviceADAccount $items, WindowsDeviceADAccount ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsDeviceADAccount> $value
     * @return self
     ...
     * 
     * @param WindowsDeviceADAccount $item
     * @return self
     */
    public function addValue(WindowsDeviceADAccount $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WindowsDeviceADAccount|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WindowsDeviceADAccount>
     */
