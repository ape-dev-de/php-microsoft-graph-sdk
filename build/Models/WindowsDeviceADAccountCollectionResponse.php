 ...
 */
class WindowsDeviceADAccountCollectionResponse
{
    /**
     ...
     * 
     * @param WindowsDeviceADAccount ...$items Variable number of WindowsDeviceADAccount items
     * @return self
     */
    public function setValue(WindowsDeviceADAccount ...$items): self
    {
        $this->value = $items;
        return $this;
    }
