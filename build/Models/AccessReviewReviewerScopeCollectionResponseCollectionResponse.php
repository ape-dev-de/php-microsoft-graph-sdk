...
/**
 * Collection response for AccessReviewReviewerScopeCollectionResponse
 */
class AccessReviewReviewerScopeCollectionResponseCollectionResponse
{
    /**
     * @var AccessReviewReviewerScopeCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessReviewReviewerScopeCollectionResponse ...$items Variable number of AccessReviewReviewerScopeCollectionResponse items
     * @return self
     */
    public function setValue(AccessReviewReviewerScopeCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AccessReviewReviewerScopeCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AccessReviewReviewerScopeCollectionResponse $item
     * @return self
     */
    public function addValue(AccessReviewReviewerScopeCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
