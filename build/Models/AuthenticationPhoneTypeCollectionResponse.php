...
/**
 * Collection response for AuthenticationPhoneType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationPhoneTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return AuthenticationPhoneType[]
     */
     ...
     * 
     * @param AuthenticationPhoneType[] $items
     * @return self
     */
    public function setValue(array|AuthenticationPhoneType $items, AuthenticationPhoneType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationPhoneType> $value
     * @return self
     ...
     * 
     * @param AuthenticationPhoneType $item
     * @return self
     */
    public function addValue(AuthenticationPhoneType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationPhoneType>
     */
