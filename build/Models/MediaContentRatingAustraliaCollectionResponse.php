...
/**
 * Collection response for MediaContentRatingAustralia
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MediaContentRatingAustraliaCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param MediaContentRatingAustralia[] $items
     * @return self
     */
    public function setValue(array|MediaContentRatingAustralia $items, MediaContentRatingAustralia ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MediaContentRatingAustralia> $value
     * @return self
     ...
     * 
     * @param MediaContentRatingAustralia $item
     * @return self
     */
    public function addValue(MediaContentRatingAustralia $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MediaContentRatingAustralia>
     */
