 ...
 */
class MediaContentRatingAustraliaCollectionResponse
{
    /**
     ...
     * 
     * @param MediaContentRatingAustralia ...$items Variable number of MediaContentRatingAustralia items
     * @return self
     */
    public function setValue(MediaContentRatingAustralia ...$items): self
    {
        $this->value = $items;
        return $this;
    }
