...
/**
 * Collection response for AccessPackageAssignmentRequestCallbackData
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageAssignmentRequestCallbackDataCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageAssignmentRequestCallbackData[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageAssignmentRequestCallbackData[] $items
     * @return self
     */
    public function setValue(array|AccessPackageAssignmentRequestCallbackData $items, AccessPackageAssignmentRequestCallbackData ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageAssignmentRequestCallbackData> $value
     * @return self
     ...
     * 
     * @param AccessPackageAssignmentRequestCallbackData $item
     * @return self
     */
    public function addValue(AccessPackageAssignmentRequestCallbackData $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessPackageAssignmentRequestCallbackData|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageAssignmentRequestCallbackData>
     */
