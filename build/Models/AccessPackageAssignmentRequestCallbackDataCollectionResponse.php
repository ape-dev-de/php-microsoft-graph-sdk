 ...
 */
class AccessPackageAssignmentRequestCallbackDataCollectionResponse
{
    /**
     ...
     * 
     * @param AccessPackageAssignmentRequestCallbackData ...$items Variable number of AccessPackageAssignmentRequestCallbackData items
     * @return self
     */
    public function setValue(AccessPackageAssignmentRequestCallbackData ...$items): self
    {
        $this->value = $items;
        return $this;
    }
