...
/**
 * Collection response for PolicyLocationCollectionResponse
 */
class PolicyLocationCollectionResponseCollectionResponse
{
    /**
     * @var PolicyLocationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return PolicyLocationCollectionResponse[]
     */
     ...
     * 
     * @param PolicyLocationCollectionResponse ...$items Variable number of PolicyLocationCollectionResponse items
     * @return self
     */
    public function setValue(PolicyLocationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PolicyLocationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PolicyLocationCollectionResponse $item
     * @return self
     */
    public function addValue(PolicyLocationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
