...
/**
 * Collection response for SecurityTag
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityTagCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityTag[]
     */
     ...
     * 
     * @param SecurityTag[] $items
     * @return self
     */
    public function setValue(array|SecurityTag $items, SecurityTag ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param SecurityTag $item
     * @return self
     */
    public function addValue(SecurityTag $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityTag>
     */
