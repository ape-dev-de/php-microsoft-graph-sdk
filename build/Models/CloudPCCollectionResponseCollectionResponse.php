...
/**
 * Collection response for CloudPCCollectionResponse
 */
class CloudPCCollectionResponseCollectionResponse
{
    /**
     * @var CloudPCCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudPCCollectionResponse ...$items Variable number of CloudPCCollectionResponse items
     * @return self
     */
    public function setValue(CloudPCCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CloudPCCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CloudPCCollectionResponse $item
     * @return self
     */
    public function addValue(CloudPCCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
