...
/**
 * Collection response for TeamJoiningDisabledEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamJoiningDisabledEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamJoiningDisabledEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamJoiningDisabledEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|TeamJoiningDisabledEventMessageDetail $items, TeamJoiningDisabledEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamJoiningDisabledEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param TeamJoiningDisabledEventMessageDetail $item
     * @return self
     */
    public function addValue(TeamJoiningDisabledEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return TeamJoiningDisabledEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, TeamJoiningDisabledEventMessageDetail>
     */
