 ...
 */
class TeamJoiningDisabledEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param TeamJoiningDisabledEventMessageDetail ...$items Variable number of TeamJoiningDisabledEventMessageDetail items
     * @return self
     */
    public function setValue(TeamJoiningDisabledEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
