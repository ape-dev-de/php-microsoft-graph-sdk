 ...
 */
class ServiceStatusCollectionResponse
{
    /**
     * @var ServiceStatus[]
     */
     ...
     * 
     * @param ServiceStatus ...$items Variable number of ServiceStatus items
     * @return self
     */
    public function setValue(ServiceStatus ...$items): self
    {
        $this->value = $items;
        return $this;
    }
