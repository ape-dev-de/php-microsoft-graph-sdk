...
/**
 * Collection response for ServiceStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServiceStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ServiceStatus[]
     */
     ...
     * 
     * @param ServiceStatus[] $items
     * @return self
     */
    public function setValue(array|ServiceStatus $items, ServiceStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServiceStatus> $value
     * @return self
     ...
     * 
     * @param ServiceStatus $item
     * @return self
     */
    public function addValue(ServiceStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ServiceStatus>
     */
