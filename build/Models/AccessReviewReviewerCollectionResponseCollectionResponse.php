...
/**
 * Collection response for AccessReviewReviewerCollectionResponse
 */
class AccessReviewReviewerCollectionResponseCollectionResponse
{
    /**
     * @var AccessReviewReviewerCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessReviewReviewerCollectionResponse ...$items Variable number of AccessReviewReviewerCollectionResponse items
     * @return self
     */
    public function setValue(AccessReviewReviewerCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AccessReviewReviewerCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AccessReviewReviewerCollectionResponse $item
     * @return self
     */
    public function addValue(AccessReviewReviewerCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
