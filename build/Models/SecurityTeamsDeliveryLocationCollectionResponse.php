...
/**
 * SecurityTeamsDeliveryLocationCollectionResponse - Collection response
 */
class SecurityTeamsDeliveryLocationCollectionResponse
{
    /**
     * @var array<int, SecurityTeamsDeliveryLocation>
     */
    public array $value = [];
