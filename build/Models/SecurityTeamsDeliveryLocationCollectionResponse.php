...
/**
 * Collection response for SecurityTeamsDeliveryLocation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityTeamsDeliveryLocationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityTeamsDeliveryLocation[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityTeamsDeliveryLocation[]
     */
     ...
     * 
     * @param SecurityTeamsDeliveryLocation[] $items
     * @return self
     */
    public function setValue(array|SecurityTeamsDeliveryLocation $items, SecurityTeamsDeliveryLocation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityTeamsDeliveryLocation> $value
     * @return self
     ...
     * 
     * @param SecurityTeamsDeliveryLocation $item
     * @return self
     */
    public function addValue(SecurityTeamsDeliveryLocation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityTeamsDeliveryLocation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityTeamsDeliveryLocation>
     */
