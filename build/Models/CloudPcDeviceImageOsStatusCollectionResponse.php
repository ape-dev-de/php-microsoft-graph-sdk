...
/**
 * CloudPcDeviceImageOsStatusCollectionResponse - Collection response
 */
class CloudPcDeviceImageOsStatusCollectionResponse
{
    /**
     * @var array<int, CloudPcDeviceImageOsStatus>
     */
    public array $value = [];
