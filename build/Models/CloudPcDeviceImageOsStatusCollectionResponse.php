...
/**
 * Collection response for CloudPcDeviceImageOsStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcDeviceImageOsStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudPcDeviceImageOsStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return CloudPcDeviceImageOsStatus[]
     */
     ...
     * 
     * @param CloudPcDeviceImageOsStatus[] $items
     * @return self
     */
    public function setValue(array|CloudPcDeviceImageOsStatus $items, CloudPcDeviceImageOsStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcDeviceImageOsStatus> $value
     * @return self
     ...
     * 
     * @param CloudPcDeviceImageOsStatus $item
     * @return self
     */
    public function addValue(CloudPcDeviceImageOsStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcDeviceImageOsStatus>
     */
