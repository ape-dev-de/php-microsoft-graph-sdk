...
/**
 * Collection response for DeviceManagementSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceManagementSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DeviceManagementSettings[] $items
     * @return self
     */
    public function setValue(array|DeviceManagementSettings $items, DeviceManagementSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceManagementSettings> $value
     * @return self
     ...
     * 
     * @param DeviceManagementSettings $item
     * @return self
     */
    public function addValue(DeviceManagementSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceManagementSettings>
     */
