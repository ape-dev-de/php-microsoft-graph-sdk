 ...
 */
class DeviceManagementSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param DeviceManagementSettings ...$items Variable number of DeviceManagementSettings items
     * @return self
     */
    public function setValue(DeviceManagementSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
