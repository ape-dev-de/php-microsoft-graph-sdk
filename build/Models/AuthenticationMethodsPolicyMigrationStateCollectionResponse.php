...
/**
 * AuthenticationMethodsPolicyMigrationStateCollectionResponse - Collection response
 */
class AuthenticationMethodsPolicyMigrationStateCollectionResponse
{
    /**
     * @var array<int, AuthenticationMethodsPolicyMigrationState>
     */
    public array $value = [];
