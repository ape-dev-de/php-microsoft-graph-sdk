...
/**
 * Collection response for AuthenticationMethodsPolicyMigrationState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationMethodsPolicyMigrationStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AuthenticationMethodsPolicyMigrationState[]
     */
    private array $value = [];
     ...
     * 
     * @return AuthenticationMethodsPolicyMigrationState[]
     */
     ...
     * 
     * @param AuthenticationMethodsPolicyMigrationState[] $items
     * @return self
     */
    public function setValue(array|AuthenticationMethodsPolicyMigrationState $items, AuthenticationMethodsPolicyMigrationState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationMethodsPolicyMigrationState> $value
     * @return self
     ...
     * 
     * @param AuthenticationMethodsPolicyMigrationState $item
     * @return self
     */
    public function addValue(AuthenticationMethodsPolicyMigrationState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationMethodsPolicyMigrationState>
     */
