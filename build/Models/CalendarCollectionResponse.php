...
/**
 * Collection response for Calendar
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CalendarCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Calendar[]
     */
     ...
     * 
     * @param Calendar[] $items
     * @return self
     */
    public function setValue(array|Calendar $items, Calendar ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Calendar $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Calendar>
     */
