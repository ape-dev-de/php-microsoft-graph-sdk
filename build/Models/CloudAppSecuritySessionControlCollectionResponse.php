...
/**
 * Collection response for CloudAppSecuritySessionControl
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudAppSecuritySessionControlCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudAppSecuritySessionControl[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudAppSecuritySessionControl[] $items
     * @return self
     */
    public function setValue(array|CloudAppSecuritySessionControl $items, CloudAppSecuritySessionControl ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudAppSecuritySessionControl> $value
     * @return self
     ...
     * 
     * @param CloudAppSecuritySessionControl $item
     * @return self
     */
    public function addValue(CloudAppSecuritySessionControl $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudAppSecuritySessionControl>
     */
