 ...
 */
class CloudAppSecuritySessionControlCollectionResponse
{
    /**
     ...
     * 
     * @param CloudAppSecuritySessionControl ...$items Variable number of CloudAppSecuritySessionControl items
     * @return self
     */
    public function setValue(CloudAppSecuritySessionControl ...$items): self
    {
        $this->value = $items;
        return $this;
    }
