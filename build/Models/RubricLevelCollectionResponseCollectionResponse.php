...
/**
 * Collection response for RubricLevelCollectionResponse
 */
class RubricLevelCollectionResponseCollectionResponse
{
    /**
     * @var RubricLevelCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RubricLevelCollectionResponse ...$items Variable number of RubricLevelCollectionResponse items
     * @return self
     */
    public function setValue(RubricLevelCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RubricLevelCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RubricLevelCollectionResponse $item
     * @return self
     */
    public function addValue(RubricLevelCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
