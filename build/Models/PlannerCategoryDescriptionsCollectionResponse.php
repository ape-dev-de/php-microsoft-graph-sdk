 ...
 */
class PlannerCategoryDescriptionsCollectionResponse
{
    /**
     ...
     * 
     * @param PlannerCategoryDescriptions ...$items Variable number of PlannerCategoryDescriptions items
     * @return self
     */
    public function setValue(PlannerCategoryDescriptions ...$items): self
    {
        $this->value = $items;
        return $this;
    }
