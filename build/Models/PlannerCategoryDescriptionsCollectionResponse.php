...
/**
 * Collection response for PlannerCategoryDescriptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerCategoryDescriptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PlannerCategoryDescriptions[] $items
     * @return self
     */
    public function setValue(array|PlannerCategoryDescriptions $items, PlannerCategoryDescriptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PlannerCategoryDescriptions> $value
     * @return self
     ...
     * 
     * @param PlannerCategoryDescriptions $item
     * @return self
     */
    public function addValue(PlannerCategoryDescriptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PlannerCategoryDescriptions>
     */
