...
/**
 * Collection response for DirectoryObjectPartnerReference
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DirectoryObjectPartnerReferenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DirectoryObjectPartnerReference[]
     */
    private array $value = [];
     ...
     * 
     * @param DirectoryObjectPartnerReference[] $items
     * @return self
     */
    public function setValue(array|DirectoryObjectPartnerReference $items, DirectoryObjectPartnerReference ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DirectoryObjectPartnerReference> $value
     * @return self
     ...
     * 
     * @param DirectoryObjectPartnerReference $item
     * @return self
     */
    public function addValue(DirectoryObjectPartnerReference $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return DirectoryObjectPartnerReference|null
     */
     ...
     * 
     * @return \ArrayIterator<int, DirectoryObjectPartnerReference>
     */
