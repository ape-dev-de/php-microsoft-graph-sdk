...
/**
 * Collection response for AttachmentItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttachmentItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AttachmentItem[]
     */
     ...
     * @return self
     */
    public function setValue(array|AttachmentItem $items, AttachmentItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttachmentItem> $value
     * @return self
     ...
     * @return self
     */
    public function addValue(AttachmentItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AttachmentItem>
     */
