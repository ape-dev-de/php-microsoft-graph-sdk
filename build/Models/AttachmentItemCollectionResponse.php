 ...
 */
class AttachmentItemCollectionResponse
{
    /**
     * @var AttachmentItem[]
     */
     ...
     * 
     * @param AttachmentItem ...$items Variable number of AttachmentItem items
     * @return self
     */
    public function setValue(AttachmentItem ...$items): self
    {
        $this->value = $items;
        return $this;
    }
