...
/**
 * Collection response for WindowsMinimumOperatingSystem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsMinimumOperatingSystemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WindowsMinimumOperatingSystem[] $items
     * @return self
     */
    public function setValue(array|WindowsMinimumOperatingSystem $items, WindowsMinimumOperatingSystem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsMinimumOperatingSystem> $value
     * @return self
     ...
     * 
     * @param WindowsMinimumOperatingSystem $item
     * @return self
     */
    public function addValue(WindowsMinimumOperatingSystem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsMinimumOperatingSystem>
     */
