 ...
 */
class WindowsMinimumOperatingSystemCollectionResponse
{
    /**
     ...
     * 
     * @param WindowsMinimumOperatingSystem ...$items Variable number of WindowsMinimumOperatingSystem items
     * @return self
     */
    public function setValue(WindowsMinimumOperatingSystem ...$items): self
    {
        $this->value = $items;
        return $this;
    }
