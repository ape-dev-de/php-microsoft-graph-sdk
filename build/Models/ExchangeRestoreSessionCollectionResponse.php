...
/**
 * Collection response for ExchangeRestoreSession
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExchangeRestoreSessionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ExchangeRestoreSession[] $items
     * @return self
     */
    public function setValue(array|ExchangeRestoreSession $items, ExchangeRestoreSession ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExchangeRestoreSession> $value
     * @return self
     ...
     * 
     * @param ExchangeRestoreSession $item
     * @return self
     */
    public function addValue(ExchangeRestoreSession $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ExchangeRestoreSession>
     */
