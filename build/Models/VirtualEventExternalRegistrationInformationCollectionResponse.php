 ...
 */
class VirtualEventExternalRegistrationInformationCollectionResponse
{
    /**
     ...
     * 
     * @param VirtualEventExternalRegistrationInformation ...$items Variable number of VirtualEventExternalRegistrationInformation items
     * @return self
     */
    public function setValue(VirtualEventExternalRegistrationInformation ...$items): self
    {
        $this->value = $items;
        return $this;
    }
