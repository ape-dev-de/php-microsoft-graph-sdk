...
/**
 * Collection response for VirtualEventExternalRegistrationInformation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualEventExternalRegistrationInformationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VirtualEventExternalRegistrationInformation[]
     */
    private array $value = [];
     ...
     * 
     * @param VirtualEventExternalRegistrationInformation[] $items
     * @return self
     */
    public function setValue(array|VirtualEventExternalRegistrationInformation $items, VirtualEventExternalRegistrationInformation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualEventExternalRegistrationInformation> $value
     * @return self
     ...
     * 
     * @param VirtualEventExternalRegistrationInformation $item
     * @return self
     */
    public function addValue(VirtualEventExternalRegistrationInformation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VirtualEventExternalRegistrationInformation>
     */
