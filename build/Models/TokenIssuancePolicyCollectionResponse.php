...
/**
 * Collection response for TokenIssuancePolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TokenIssuancePolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TokenIssuancePolicy[] $items
     * @return self
     */
    public function setValue(array|TokenIssuancePolicy $items, TokenIssuancePolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TokenIssuancePolicy> $value
     * @return self
     ...
     * 
     * @param TokenIssuancePolicy $item
     * @return self
     */
    public function addValue(TokenIssuancePolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TokenIssuancePolicy>
     */
