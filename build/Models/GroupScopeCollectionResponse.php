...
/**
 * Collection response for GroupScope
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class GroupScopeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var GroupScope[]
     */
     ...
     * 
     * @param GroupScope[] $items
     * @return self
     */
    public function setValue(array|GroupScope $items, GroupScope ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param GroupScope $item
     * @return self
     */
    public function addValue(GroupScope $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, GroupScope>
     */
