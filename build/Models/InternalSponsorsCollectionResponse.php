...
/**
 * Collection response for InternalSponsors
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InternalSponsorsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var InternalSponsors[]
     */
    private array $value = [];
     ...
     * 
     * @param InternalSponsors[] $items
     * @return self
     */
    public function setValue(array|InternalSponsors $items, InternalSponsors ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InternalSponsors> $value
     * @return self
     ...
     * 
     * @param InternalSponsors $item
     * @return self
     */
    public function addValue(InternalSponsors $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, InternalSponsors>
     */
