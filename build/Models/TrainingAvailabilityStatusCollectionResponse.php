...
/**
 * TrainingAvailabilityStatusCollectionResponse - Collection response
 */
class TrainingAvailabilityStatusCollectionResponse
{
    /**
     * @var array<int, TrainingAvailabilityStatus>
     */
    public array $value = [];
