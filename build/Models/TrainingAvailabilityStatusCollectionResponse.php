...
/**
 * Collection response for TrainingAvailabilityStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TrainingAvailabilityStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TrainingAvailabilityStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return TrainingAvailabilityStatus[]
     */
     ...
     * 
     * @param TrainingAvailabilityStatus[] $items
     * @return self
     */
    public function setValue(array|TrainingAvailabilityStatus $items, TrainingAvailabilityStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TrainingAvailabilityStatus> $value
     * @return self
     ...
     * 
     * @param TrainingAvailabilityStatus $item
     * @return self
     */
    public function addValue(TrainingAvailabilityStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TrainingAvailabilityStatus>
     */
