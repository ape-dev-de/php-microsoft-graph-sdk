...
/**
 * Collection response for PrivilegedAccessGroupAssignmentSchedule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrivilegedAccessGroupAssignmentScheduleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param PrivilegedAccessGroupAssignmentSchedule[] $items
     * @return self
     */
    public function setValue(array|PrivilegedAccessGroupAssignmentSchedule $items, PrivilegedAccessGroupAssignmentSchedule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrivilegedAccessGroupAssignmentSchedule> $value
     * @return self
     ...
     * 
     * @param PrivilegedAccessGroupAssignmentSchedule $item
     * @return self
     */
    public function addValue(PrivilegedAccessGroupAssignmentSchedule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrivilegedAccessGroupAssignmentSchedule>
     */
