...
/**
 * CallRecordsMediaStreamDirectionCollectionResponse - Collection response
 */
class CallRecordsMediaStreamDirectionCollectionResponse
{
    /**
     * @var array<int, CallRecordsMediaStreamDirection>
     */
    public array $value = [];
