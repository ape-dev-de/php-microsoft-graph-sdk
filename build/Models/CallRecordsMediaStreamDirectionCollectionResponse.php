...
/**
 * Collection response for CallRecordsMediaStreamDirection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsMediaStreamDirectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsMediaStreamDirection[]
     */
    private array $value = [];
     ...
     * 
     * @return CallRecordsMediaStreamDirection[]
     */
     ...
     * 
     * @param CallRecordsMediaStreamDirection[] $items
     * @return self
     */
    public function setValue(array|CallRecordsMediaStreamDirection $items, CallRecordsMediaStreamDirection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsMediaStreamDirection> $value
     * @return self
     ...
     * 
     * @param CallRecordsMediaStreamDirection $item
     * @return self
     */
    public function addValue(CallRecordsMediaStreamDirection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsMediaStreamDirection|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsMediaStreamDirection>
     */
