...
/**
 * Collection response for IosManagedAppRegistration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosManagedAppRegistrationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IosManagedAppRegistration[]
     */
    private array $value = [];
     ...
     * 
     * @param IosManagedAppRegistration[] $items
     * @return self
     */
    public function setValue(array|IosManagedAppRegistration $items, IosManagedAppRegistration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosManagedAppRegistration> $value
     * @return self
     ...
     * 
     * @param IosManagedAppRegistration $item
     * @return self
     */
    public function addValue(IosManagedAppRegistration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IosManagedAppRegistration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IosManagedAppRegistration>
     */
