...
/**
 * UserExperienceAnalyticsAppHealthDevicePerformanceCollectionResponse - Collection response
 */
class UserExperienceAnalyticsAppHealthDevicePerformanceCollectionResponse
{
    /**
     * @var array<int, UserExperienceAnalyticsAppHealthDevicePerformance>
     */
    public array $value = [];
