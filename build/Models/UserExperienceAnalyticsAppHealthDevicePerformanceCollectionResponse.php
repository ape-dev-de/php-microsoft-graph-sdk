...
/**
 * Collection response for UserExperienceAnalyticsAppHealthDevicePerformance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsAppHealthDevicePerformanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsAppHealthDevicePerformance[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsAppHealthDevicePerformance $items, UserExperienceAnalyticsAppHealthDevicePerformance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsAppHealthDevicePerformance> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsAppHealthDevicePerformance $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsAppHealthDevicePerformance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsAppHealthDevicePerformance>
     */
