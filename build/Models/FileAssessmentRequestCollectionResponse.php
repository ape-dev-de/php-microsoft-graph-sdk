...
/**
 * Collection response for FileAssessmentRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class FileAssessmentRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var FileAssessmentRequest[]
     */
    private array $value = [];
     ...
     * 
     * @param FileAssessmentRequest[] $items
     * @return self
     */
    public function setValue(array|FileAssessmentRequest $items, FileAssessmentRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<FileAssessmentRequest> $value
     * @return self
     ...
     * 
     * @param FileAssessmentRequest $item
     * @return self
     */
    public function addValue(FileAssessmentRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return FileAssessmentRequest|null
     */
     ...
     * 
     * @return \ArrayIterator<int, FileAssessmentRequest>
     */
