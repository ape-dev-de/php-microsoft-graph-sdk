...
/**
 * Collection response for PrintJob
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintJobCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrintJob[]
     */
     ...
     * 
     * @param PrintJob[] $items
     * @return self
     */
    public function setValue(array|PrintJob $items, PrintJob ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(PrintJob $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintJob>
     */
