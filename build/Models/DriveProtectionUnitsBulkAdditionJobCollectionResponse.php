...
/**
 * Collection response for DriveProtectionUnitsBulkAdditionJob
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DriveProtectionUnitsBulkAdditionJobCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DriveProtectionUnitsBulkAdditionJob[] $items
     * @return self
     */
    public function setValue(array|DriveProtectionUnitsBulkAdditionJob $items, DriveProtectionUnitsBulkAdditionJob ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DriveProtectionUnitsBulkAdditionJob> $value
     * @return self
     ...
     * 
     * @param DriveProtectionUnitsBulkAdditionJob $item
     * @return self
     */
    public function addValue(DriveProtectionUnitsBulkAdditionJob $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DriveProtectionUnitsBulkAdditionJob>
     */
