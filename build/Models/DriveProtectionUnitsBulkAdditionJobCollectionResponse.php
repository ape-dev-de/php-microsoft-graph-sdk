...
/**
 * DriveProtectionUnitsBulkAdditionJobCollectionResponse - Collection response
 */
class DriveProtectionUnitsBulkAdditionJobCollectionResponse
{
    /**
     * @var array<int, DriveProtectionUnitsBulkAdditionJob>
     */
    public array $value = [];
