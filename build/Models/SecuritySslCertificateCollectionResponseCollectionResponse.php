...
/**
 * Collection response for SecuritySslCertificateCollectionResponse
 */
class SecuritySslCertificateCollectionResponseCollectionResponse
{
    /**
     * @var SecuritySslCertificateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecuritySslCertificateCollectionResponse ...$items Variable number of SecuritySslCertificateCollectionResponse items
     * @return self
     */
    public function setValue(SecuritySslCertificateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecuritySslCertificateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecuritySslCertificateCollectionResponse $item
     * @return self
     */
    public function addValue(SecuritySslCertificateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
