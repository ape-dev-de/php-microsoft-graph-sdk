...
/**
 * Collection response for SecurityCaseOperationCollectionResponse
 */
class SecurityCaseOperationCollectionResponseCollectionResponse
{
    /**
     * @var SecurityCaseOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityCaseOperationCollectionResponse ...$items Variable number of SecurityCaseOperationCollectionResponse items
     * @return self
     */
    public function setValue(SecurityCaseOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityCaseOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityCaseOperationCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityCaseOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
