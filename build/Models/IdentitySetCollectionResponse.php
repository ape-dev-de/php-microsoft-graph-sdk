...
/**
 * Collection response for IdentitySet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentitySetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentitySet[]
     */
     ...
     * 
     * @param IdentitySet[] $items
     * @return self
     */
    public function setValue(array|IdentitySet $items, IdentitySet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param IdentitySet $item
     * @return self
     */
    public function addValue(IdentitySet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentitySet>
     */
