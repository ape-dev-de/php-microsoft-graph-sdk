...
/**
 * Collection response for RiskDetection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RiskDetectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RiskDetection[]
     */
     ...
     * 
     * @param RiskDetection[] $items
     * @return self
     */
    public function setValue(array|RiskDetection $items, RiskDetection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RiskDetection> $value
     * @return self
     ...
     * 
     * @param RiskDetection $item
     * @return self
     */
    public function addValue(RiskDetection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RiskDetection>
     */
