 ...
 */
class IdentityGovernanceGroupBasedSubjectSetCollectionResponse
{
    /**
     ...
     * 
     * @param IdentityGovernanceGroupBasedSubjectSet ...$items Variable number of IdentityGovernanceGroupBasedSubjectSet items
     * @return self
     */
    public function setValue(IdentityGovernanceGroupBasedSubjectSet ...$items): self
    {
        $this->value = $items;
        return $this;
    }
