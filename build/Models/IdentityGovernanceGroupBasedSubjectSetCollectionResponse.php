...
/**
 * Collection response for IdentityGovernanceGroupBasedSubjectSet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceGroupBasedSubjectSetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceGroupBasedSubjectSet[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceGroupBasedSubjectSet[]
     */
     ...
     * 
     * @param IdentityGovernanceGroupBasedSubjectSet[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceGroupBasedSubjectSet $items, IdentityGovernanceGroupBasedSubjectSet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceGroupBasedSubjectSet> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceGroupBasedSubjectSet $item
     * @return self
     */
    public function addValue(IdentityGovernanceGroupBasedSubjectSet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceGroupBasedSubjectSet|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceGroupBasedSubjectSet>
     */
