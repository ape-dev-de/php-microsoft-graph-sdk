...
/**
 * Collection response for OfferShiftRequestCollectionResponse
 */
class OfferShiftRequestCollectionResponseCollectionResponse
{
    /**
     * @var OfferShiftRequestCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param OfferShiftRequestCollectionResponse ...$items Variable number of OfferShiftRequestCollectionResponse items
     * @return self
     */
    public function setValue(OfferShiftRequestCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<OfferShiftRequestCollectionResponse> $value
     * @return self
     ...
     * 
     * @param OfferShiftRequestCollectionResponse $item
     * @return self
     */
    public function addValue(OfferShiftRequestCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
