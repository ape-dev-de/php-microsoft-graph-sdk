...
/**
 * MicrosoftManagedDesktopTypeCollectionResponse - Collection response
 */
class MicrosoftManagedDesktopTypeCollectionResponse
{
    /**
     * @var array<int, MicrosoftManagedDesktopType>
     */
    public array $value = [];
