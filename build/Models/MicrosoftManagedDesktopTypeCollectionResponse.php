...
/**
 * Collection response for MicrosoftManagedDesktopType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MicrosoftManagedDesktopTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MicrosoftManagedDesktopType[]
     */
    private array $value = [];
     ...
     * 
     * @return MicrosoftManagedDesktopType[]
     */
     ...
     * 
     * @param MicrosoftManagedDesktopType[] $items
     * @return self
     */
    public function setValue(array|MicrosoftManagedDesktopType $items, MicrosoftManagedDesktopType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MicrosoftManagedDesktopType> $value
     * @return self
     ...
     * 
     * @param MicrosoftManagedDesktopType $item
     * @return self
     */
    public function addValue(MicrosoftManagedDesktopType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MicrosoftManagedDesktopType>
     */
