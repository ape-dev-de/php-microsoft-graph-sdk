 ...
 */
class AgreementFileCollectionResponse
{
    /**
     * @var AgreementFile[]
     */
     ...
     * 
     * @param AgreementFile ...$items Variable number of AgreementFile items
     * @return self
     */
    public function setValue(AgreementFile ...$items): self
    {
        $this->value = $items;
        return $this;
    }
