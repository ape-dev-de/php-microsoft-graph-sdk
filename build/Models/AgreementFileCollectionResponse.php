...
/**
 * Collection response for AgreementFile
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AgreementFileCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AgreementFile[]
     */
     ...
     * 
     * @param AgreementFile[] $items
     * @return self
     */
    public function setValue(array|AgreementFile $items, AgreementFile ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AgreementFile> $value
     * @return self
     ...
     * 
     * @param AgreementFile $item
     * @return self
     */
    public function addValue(AgreementFile $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AgreementFile>
     */
