 ...
 */
class CloudCommunicationsCollectionResponse
{
    /**
     ...
     * 
     * @param CloudCommunications ...$items Variable number of CloudCommunications items
     * @return self
     */
    public function setValue(CloudCommunications ...$items): self
    {
        $this->value = $items;
        return $this;
    }
