...
/**
 * Collection response for CloudCommunications
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudCommunicationsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudCommunications[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudCommunications[] $items
     * @return self
     */
    public function setValue(array|CloudCommunications $items, CloudCommunications ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudCommunications> $value
     * @return self
     ...
     * 
     * @param CloudCommunications $item
     * @return self
     */
    public function addValue(CloudCommunications $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudCommunications>
     */
