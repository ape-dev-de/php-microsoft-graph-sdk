...
/**
 * Collection response for WindowsInformationProtectionProxiedDomainCollection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsInformationProtectionProxiedDomainCollectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WindowsInformationProtectionProxiedDomainCollection[] $items
     * @return self
     */
    public function setValue(array|WindowsInformationProtectionProxiedDomainCollection $items, WindowsInformationProtectionProxiedDomainCollection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsInformationProtectionProxiedDomainCollection> $value
     * @return self
     ...
     * 
     * @param WindowsInformationProtectionProxiedDomainCollection $item
     * @return self
     */
    public function addValue(WindowsInformationProtectionProxiedDomainCollection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WindowsInformationProtectionProxiedDomainCollection|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WindowsInformationProtectionProxiedDomainCollection>
     */
