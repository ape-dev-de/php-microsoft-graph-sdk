...
/**
 * WindowsInformationProtectionProxiedDomainCollectionCollectionResponse - Collection response
 */
class WindowsInformationProtectionProxiedDomainCollectionCollectionResponse
{
    /**
     * @var array<int, WindowsInformationProtectionProxiedDomainCollection>
     */
    public array $value = [];
