...
/**
 * Collection response for Bitlocker
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BitlockerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Bitlocker[]
     */
     ...
     * 
     * @param Bitlocker[] $items
     * @return self
     */
    public function setValue(array|Bitlocker $items, Bitlocker ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param Bitlocker $item
     * @return self
     */
    public function addValue(Bitlocker $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Bitlocker>
     */
