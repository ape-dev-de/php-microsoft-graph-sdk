...
/**
 * Collection response for ProtectionScopeState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProtectionScopeStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProtectionScopeState[]
     */
    private array $value = [];
     ...
     * 
     * @param ProtectionScopeState[] $items
     * @return self
     */
    public function setValue(array|ProtectionScopeState $items, ProtectionScopeState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProtectionScopeState> $value
     * @return self
     ...
     * 
     * @param ProtectionScopeState $item
     * @return self
     */
    public function addValue(ProtectionScopeState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProtectionScopeState>
     */
