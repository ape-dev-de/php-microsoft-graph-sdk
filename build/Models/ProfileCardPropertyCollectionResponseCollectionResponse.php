...
/**
 * Collection response for ProfileCardPropertyCollectionResponse
 */
class ProfileCardPropertyCollectionResponseCollectionResponse
{
    /**
     * @var ProfileCardPropertyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ProfileCardPropertyCollectionResponse ...$items Variable number of ProfileCardPropertyCollectionResponse items
     * @return self
     */
    public function setValue(ProfileCardPropertyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ProfileCardPropertyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ProfileCardPropertyCollectionResponse $item
     * @return self
     */
    public function addValue(ProfileCardPropertyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
