...
/**
 * Collection response for AccessReviewReviewerScope
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewReviewerScopeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AccessReviewReviewerScope[] $items
     * @return self
     */
    public function setValue(array|AccessReviewReviewerScope $items, AccessReviewReviewerScope ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewReviewerScope> $value
     * @return self
     ...
     * 
     * @param AccessReviewReviewerScope $item
     * @return self
     */
    public function addValue(AccessReviewReviewerScope $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessReviewReviewerScope|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewReviewerScope>
     */
