...
/**
 * Collection response for ProxiedDomainCollectionResponse
 */
class ProxiedDomainCollectionResponseCollectionResponse
{
    /**
     * @var ProxiedDomainCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ProxiedDomainCollectionResponse ...$items Variable number of ProxiedDomainCollectionResponse items
     * @return self
     */
    public function setValue(ProxiedDomainCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ProxiedDomainCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ProxiedDomainCollectionResponse $item
     * @return self
     */
    public function addValue(ProxiedDomainCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
