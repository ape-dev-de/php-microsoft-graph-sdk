 ...
 */
class EducationFeedbackCollectionResponse
{
    /**
     ...
     * 
     * @param EducationFeedback ...$items Variable number of EducationFeedback items
     * @return self
     */
    public function setValue(EducationFeedback ...$items): self
    {
        $this->value = $items;
        return $this;
    }
