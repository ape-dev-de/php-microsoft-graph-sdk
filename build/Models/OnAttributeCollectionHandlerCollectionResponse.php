...
/**
 * Collection response for OnAttributeCollectionHandler
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnAttributeCollectionHandlerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnAttributeCollectionHandler[]
     */
    private array $value = [];
     ...
     * 
     * @param OnAttributeCollectionHandler[] $items
     * @return self
     */
    public function setValue(array|OnAttributeCollectionHandler $items, OnAttributeCollectionHandler ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnAttributeCollectionHandler> $value
     * @return self
     ...
     * 
     * @param OnAttributeCollectionHandler $item
     * @return self
     */
    public function addValue(OnAttributeCollectionHandler $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnAttributeCollectionHandler>
     */
