...
/**
 * OnAttributeCollectionHandlerCollectionResponse - Collection response
 */
class OnAttributeCollectionHandlerCollectionResponse
{
    /**
     * @var array<int, OnAttributeCollectionHandler>
     */
    public array $value = [];
