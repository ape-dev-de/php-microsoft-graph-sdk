...
/**
 * Collection response for AuditResourceCollectionResponse
 */
class AuditResourceCollectionResponseCollectionResponse
{
    /**
     * @var AuditResourceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AuditResourceCollectionResponse ...$items Variable number of AuditResourceCollectionResponse items
     * @return self
     */
    public function setValue(AuditResourceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AuditResourceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AuditResourceCollectionResponse $item
     * @return self
     */
    public function addValue(AuditResourceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
