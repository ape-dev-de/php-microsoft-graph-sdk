...
/**
 * Collection response for EndpointCollectionResponse
 */
class EndpointCollectionResponseCollectionResponse
{
    /**
     * @var EndpointCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EndpointCollectionResponse ...$items Variable number of EndpointCollectionResponse items
     * @return self
     */
    public function setValue(EndpointCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EndpointCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EndpointCollectionResponse $item
     * @return self
     */
    public function addValue(EndpointCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
