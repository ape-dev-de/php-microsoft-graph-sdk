 ...
 */
class ServicePrincipalLockConfigurationCollectionResponse
{
    /**
     ...
     * 
     * @param ServicePrincipalLockConfiguration ...$items Variable number of ServicePrincipalLockConfiguration items
     * @return self
     */
    public function setValue(ServicePrincipalLockConfiguration ...$items): self
    {
        $this->value = $items;
        return $this;
    }
