...
/**
 * Collection response for ServicePrincipalLockConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServicePrincipalLockConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ServicePrincipalLockConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param ServicePrincipalLockConfiguration[] $items
     * @return self
     */
    public function setValue(array|ServicePrincipalLockConfiguration $items, ServicePrincipalLockConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServicePrincipalLockConfiguration> $value
     * @return self
     ...
     * 
     * @param ServicePrincipalLockConfiguration $item
     * @return self
     */
    public function addValue(ServicePrincipalLockConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ServicePrincipalLockConfiguration>
     */
