...
/**
 * Collection response for OnlineMeeting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnlineMeetingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnlineMeeting[]
     */
     ...
     * 
     * @param OnlineMeeting[] $items
     * @return self
     */
    public function setValue(array|OnlineMeeting $items, OnlineMeeting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnlineMeeting> $value
     * @return self
     ...
     * 
     * @param OnlineMeeting $item
     * @return self
     */
    public function addValue(OnlineMeeting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnlineMeeting>
     */
