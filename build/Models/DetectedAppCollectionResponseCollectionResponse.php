...
/**
 * Collection response for DetectedAppCollectionResponse
 */
class DetectedAppCollectionResponseCollectionResponse
{
    /**
     * @var DetectedAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DetectedAppCollectionResponse ...$items Variable number of DetectedAppCollectionResponse items
     * @return self
     */
    public function setValue(DetectedAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DetectedAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DetectedAppCollectionResponse $item
     * @return self
     */
    public function addValue(DetectedAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
