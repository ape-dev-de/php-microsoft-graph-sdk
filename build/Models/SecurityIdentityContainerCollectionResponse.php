 ...
 */
class SecurityIdentityContainerCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityIdentityContainer ...$items Variable number of SecurityIdentityContainer items
     * @return self
     */
    public function setValue(SecurityIdentityContainer ...$items): self
    {
        $this->value = $items;
        return $this;
    }
