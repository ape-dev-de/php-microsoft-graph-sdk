...
/**
 * Collection response for SecurityIdentityContainer
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityIdentityContainerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityIdentityContainer[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityIdentityContainer[] $items
     * @return self
     */
    public function setValue(array|SecurityIdentityContainer $items, SecurityIdentityContainer ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityIdentityContainer> $value
     * @return self
     ...
     * 
     * @param SecurityIdentityContainer $item
     * @return self
     */
    public function addValue(SecurityIdentityContainer $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityIdentityContainer|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityIdentityContainer>
     */
