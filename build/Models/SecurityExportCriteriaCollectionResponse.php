...
/**
 * Collection response for SecurityExportCriteria
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityExportCriteriaCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityExportCriteria[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityExportCriteria[] $items
     * @return self
     */
    public function setValue(array|SecurityExportCriteria $items, SecurityExportCriteria ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityExportCriteria> $value
     * @return self
     ...
     * 
     * @param SecurityExportCriteria $item
     * @return self
     */
    public function addValue(SecurityExportCriteria $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityExportCriteria|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityExportCriteria>
     */
