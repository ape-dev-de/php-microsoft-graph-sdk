 ...
 */
class DataSecurityAndGovernanceCollectionResponse
{
    /**
     ...
     * 
     * @param DataSecurityAndGovernance ...$items Variable number of DataSecurityAndGovernance items
     * @return self
     */
    public function setValue(DataSecurityAndGovernance ...$items): self
    {
        $this->value = $items;
        return $this;
    }
