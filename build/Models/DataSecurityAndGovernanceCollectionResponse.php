...
/**
 * Collection response for DataSecurityAndGovernance
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DataSecurityAndGovernanceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DataSecurityAndGovernance[]
     */
    private array $value = [];
     ...
     * 
     * @param DataSecurityAndGovernance[] $items
     * @return self
     */
    public function setValue(array|DataSecurityAndGovernance $items, DataSecurityAndGovernance ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DataSecurityAndGovernance> $value
     * @return self
     ...
     * 
     * @param DataSecurityAndGovernance $item
     * @return self
     */
    public function addValue(DataSecurityAndGovernance $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return DataSecurityAndGovernance|null
     */
     ...
     * 
     * @return \ArrayIterator<int, DataSecurityAndGovernance>
     */
