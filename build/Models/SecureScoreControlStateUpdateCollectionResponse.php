...
/**
 * Collection response for SecureScoreControlStateUpdate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecureScoreControlStateUpdateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecureScoreControlStateUpdate[] $items
     * @return self
     */
    public function setValue(array|SecureScoreControlStateUpdate $items, SecureScoreControlStateUpdate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecureScoreControlStateUpdate> $value
     * @return self
     ...
     * 
     * @param SecureScoreControlStateUpdate $item
     * @return self
     */
    public function addValue(SecureScoreControlStateUpdate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecureScoreControlStateUpdate|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecureScoreControlStateUpdate>
     */
