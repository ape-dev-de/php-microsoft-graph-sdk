...
/**
 * AppManagementServicePrincipalConfigurationCollectionResponse - Collection response
 */
class AppManagementServicePrincipalConfigurationCollectionResponse
{
    /**
     * @var array<int, AppManagementServicePrincipalConfiguration>
     */
    public array $value = [];
