...
/**
 * Collection response for AppManagementServicePrincipalConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppManagementServicePrincipalConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AppManagementServicePrincipalConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param AppManagementServicePrincipalConfiguration[] $items
     * @return self
     */
    public function setValue(array|AppManagementServicePrincipalConfiguration $items, AppManagementServicePrincipalConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppManagementServicePrincipalConfiguration> $value
     * @return self
     ...
     * 
     * @param AppManagementServicePrincipalConfiguration $item
     * @return self
     */
    public function addValue(AppManagementServicePrincipalConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AppManagementServicePrincipalConfiguration>
     */
