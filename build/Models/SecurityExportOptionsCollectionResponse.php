...
/**
 * Collection response for SecurityExportOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityExportOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityExportOptions[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityExportOptions[] $items
     * @return self
     */
    public function setValue(array|SecurityExportOptions $items, SecurityExportOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityExportOptions> $value
     * @return self
     ...
     * 
     * @param SecurityExportOptions $item
     * @return self
     */
    public function addValue(SecurityExportOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityExportOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityExportOptions>
     */
