 ...
 */
class OAuthConsentAppDetailCollectionResponse
{
    /**
     ...
     * 
     * @param OAuthConsentAppDetail ...$items Variable number of OAuthConsentAppDetail items
     * @return self
     */
    public function setValue(OAuthConsentAppDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
