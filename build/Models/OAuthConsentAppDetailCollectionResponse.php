...
/**
 * Collection response for OAuthConsentAppDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OAuthConsentAppDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OAuthConsentAppDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param OAuthConsentAppDetail[] $items
     * @return self
     */
    public function setValue(array|OAuthConsentAppDetail $items, OAuthConsentAppDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OAuthConsentAppDetail> $value
     * @return self
     ...
     * 
     * @param OAuthConsentAppDetail $item
     * @return self
     */
    public function addValue(OAuthConsentAppDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OAuthConsentAppDetail>
     */
