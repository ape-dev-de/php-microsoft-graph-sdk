...
/**
 * ApprovalFilterByCurrentUserOptionsCollectionResponse - Collection response
 */
class ApprovalFilterByCurrentUserOptionsCollectionResponse
{
    /**
     * @var array<int, ApprovalFilterByCurrentUserOptions>
     */
    public array $value = [];
