...
/**
 * Collection response for ApprovalFilterByCurrentUserOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ApprovalFilterByCurrentUserOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ApprovalFilterByCurrentUserOptions[]
     */
    private array $value = [];
     ...
     * 
     * @return ApprovalFilterByCurrentUserOptions[]
     */
     ...
     * 
     * @param ApprovalFilterByCurrentUserOptions[] $items
     * @return self
     */
    public function setValue(array|ApprovalFilterByCurrentUserOptions $items, ApprovalFilterByCurrentUserOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ApprovalFilterByCurrentUserOptions> $value
     * @return self
     ...
     * 
     * @param ApprovalFilterByCurrentUserOptions $item
     * @return self
     */
    public function addValue(ApprovalFilterByCurrentUserOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ApprovalFilterByCurrentUserOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ApprovalFilterByCurrentUserOptions>
     */
