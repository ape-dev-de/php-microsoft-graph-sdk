...
/**
 * Collection response for OnAttributeCollectionSubmitCustomExtension
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnAttributeCollectionSubmitCustomExtensionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnAttributeCollectionSubmitCustomExtension[]
     */
    private array $value = [];
     ...
     * 
     * @param OnAttributeCollectionSubmitCustomExtension[] $items
     * @return self
     */
    public function setValue(array|OnAttributeCollectionSubmitCustomExtension $items, OnAttributeCollectionSubmitCustomExtension ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnAttributeCollectionSubmitCustomExtension> $value
     * @return self
     ...
     * 
     * @param OnAttributeCollectionSubmitCustomExtension $item
     * @return self
     */
    public function addValue(OnAttributeCollectionSubmitCustomExtension $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnAttributeCollectionSubmitCustomExtension>
     */
