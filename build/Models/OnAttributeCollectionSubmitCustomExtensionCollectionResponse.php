...
/**
 * OnAttributeCollectionSubmitCustomExtensionCollectionResponse - Collection response
 */
class OnAttributeCollectionSubmitCustomExtensionCollectionResponse
{
    /**
     * @var array<int, OnAttributeCollectionSubmitCustomExtension>
     */
    public array $value = [];
