...
/**
 * Collection response for WorkbookNamedItemCollectionResponse
 */
class WorkbookNamedItemCollectionResponseCollectionResponse
{
    /**
     * @var WorkbookNamedItemCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookNamedItemCollectionResponse ...$items Variable number of WorkbookNamedItemCollectionResponse items
     * @return self
     */
    public function setValue(WorkbookNamedItemCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WorkbookNamedItemCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WorkbookNamedItemCollectionResponse $item
     * @return self
     */
    public function addValue(WorkbookNamedItemCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
