...
/**
 * Collection response for WebsiteType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WebsiteTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WebsiteType[]
     */
     ...
     * 
     * @param WebsiteType[] $items
     * @return self
     */
    public function setValue(array|WebsiteType $items, WebsiteType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param WebsiteType $item
     * @return self
     */
    public function addValue(WebsiteType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WebsiteType>
     */
