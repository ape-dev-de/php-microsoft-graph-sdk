...
/**
 * Collection response for BookingSchedulingPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingSchedulingPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BookingSchedulingPolicy[]
     */
    private array $value = [];
     ...
     * 
     * @param BookingSchedulingPolicy[] $items
     * @return self
     */
    public function setValue(array|BookingSchedulingPolicy $items, BookingSchedulingPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingSchedulingPolicy> $value
     * @return self
     ...
     * 
     * @param BookingSchedulingPolicy $item
     * @return self
     */
    public function addValue(BookingSchedulingPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BookingSchedulingPolicy>
     */
