 ...
 */
class BookingSchedulingPolicyCollectionResponse
{
    /**
     ...
     * 
     * @param BookingSchedulingPolicy ...$items Variable number of BookingSchedulingPolicy items
     * @return self
     */
    public function setValue(BookingSchedulingPolicy ...$items): self
    {
        $this->value = $items;
        return $this;
    }
