...
/**
 * Collection response for MicrosoftStoreForBusinessLicenseType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MicrosoftStoreForBusinessLicenseTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MicrosoftStoreForBusinessLicenseType[]
     */
    private array $value = [];
     ...
     * 
     * @return MicrosoftStoreForBusinessLicenseType[]
     */
     ...
     * 
     * @param MicrosoftStoreForBusinessLicenseType[] $items
     * @return self
     */
    public function setValue(array|MicrosoftStoreForBusinessLicenseType $items, MicrosoftStoreForBusinessLicenseType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MicrosoftStoreForBusinessLicenseType> $value
     * @return self
     ...
     * 
     * @param MicrosoftStoreForBusinessLicenseType $item
     * @return self
     */
    public function addValue(MicrosoftStoreForBusinessLicenseType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MicrosoftStoreForBusinessLicenseType>
     */
