...
/**
 * MicrosoftStoreForBusinessLicenseTypeCollectionResponse - Collection response
 */
class MicrosoftStoreForBusinessLicenseTypeCollectionResponse
{
    /**
     * @var array<int, MicrosoftStoreForBusinessLicenseType>
     */
    public array $value = [];
