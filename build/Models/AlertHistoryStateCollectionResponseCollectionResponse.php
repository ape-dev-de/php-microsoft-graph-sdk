...
/**
 * Collection response for AlertHistoryStateCollectionResponse
 */
class AlertHistoryStateCollectionResponseCollectionResponse
{
    /**
     * @var AlertHistoryStateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AlertHistoryStateCollectionResponse ...$items Variable number of AlertHistoryStateCollectionResponse items
     * @return self
     */
    public function setValue(AlertHistoryStateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AlertHistoryStateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AlertHistoryStateCollectionResponse $item
     * @return self
     */
    public function addValue(AlertHistoryStateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
