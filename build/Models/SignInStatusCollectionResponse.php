...
/**
 * Collection response for SignInStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SignInStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SignInStatus[]
     */
     ...
     * 
     * @param SignInStatus[] $items
     * @return self
     */
    public function setValue(array|SignInStatus $items, SignInStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SignInStatus> $value
     * @return self
     ...
     * 
     * @param SignInStatus $item
     * @return self
     */
    public function addValue(SignInStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SignInStatus>
     */
