 ...
 */
class CallRecordsUserIdentityCollectionResponse
{
    /**
     ...
     * 
     * @param CallRecordsUserIdentity ...$items Variable number of CallRecordsUserIdentity items
     * @return self
     */
    public function setValue(CallRecordsUserIdentity ...$items): self
    {
        $this->value = $items;
        return $this;
    }
