...
/**
 * Collection response for CallRecordsUserIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsUserIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsUserIdentity[]
     */
    private array $value = [];
     ...
     * 
     * @param CallRecordsUserIdentity[] $items
     * @return self
     */
    public function setValue(array|CallRecordsUserIdentity $items, CallRecordsUserIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsUserIdentity> $value
     * @return self
     ...
     * 
     * @param CallRecordsUserIdentity $item
     * @return self
     */
    public function addValue(CallRecordsUserIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsUserIdentity|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsUserIdentity>
     */
