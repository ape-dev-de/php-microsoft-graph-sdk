...
/**
 * X509CertificateAffinityLevelCollectionResponse - Collection response
 */
class X509CertificateAffinityLevelCollectionResponse
{
    /**
     * @var array<int, X509CertificateAffinityLevel>
     */
    public array $value = [];
