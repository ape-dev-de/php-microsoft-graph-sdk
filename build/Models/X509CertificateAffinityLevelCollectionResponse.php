...
/**
 * Collection response for X509CertificateAffinityLevel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class X509CertificateAffinityLevelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var X509CertificateAffinityLevel[]
     */
    private array $value = [];
     ...
     * 
     * @return X509CertificateAffinityLevel[]
     */
     ...
     * 
     * @param X509CertificateAffinityLevel[] $items
     * @return self
     */
    public function setValue(array|X509CertificateAffinityLevel $items, X509CertificateAffinityLevel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<X509CertificateAffinityLevel> $value
     * @return self
     ...
     * 
     * @param X509CertificateAffinityLevel $item
     * @return self
     */
    public function addValue(X509CertificateAffinityLevel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, X509CertificateAffinityLevel>
     */
