...
/**
 * Collection response for PlannerGroup
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerGroupCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PlannerGroup[]
     */
     ...
     * 
     * @param PlannerGroup[] $items
     * @return self
     */
    public function setValue(array|PlannerGroup $items, PlannerGroup ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PlannerGroup> $value
     * @return self
     ...
     * 
     * @param PlannerGroup $item
     * @return self
     */
    public function addValue(PlannerGroup $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PlannerGroup>
     */
