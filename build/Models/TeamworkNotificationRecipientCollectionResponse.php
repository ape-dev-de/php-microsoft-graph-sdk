...
/**
 * Collection response for TeamworkNotificationRecipient
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamworkNotificationRecipientCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamworkNotificationRecipient[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamworkNotificationRecipient[] $items
     * @return self
     */
    public function setValue(array|TeamworkNotificationRecipient $items, TeamworkNotificationRecipient ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamworkNotificationRecipient> $value
     * @return self
     ...
     * 
     * @param TeamworkNotificationRecipient $item
     * @return self
     */
    public function addValue(TeamworkNotificationRecipient $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamworkNotificationRecipient>
     */
