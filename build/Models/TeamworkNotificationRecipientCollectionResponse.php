...
/**
 * TeamworkNotificationRecipientCollectionResponse - Collection response
 */
class TeamworkNotificationRecipientCollectionResponse
{
    /**
     * @var array<int, TeamworkNotificationRecipient>
     */
    public array $value = [];
