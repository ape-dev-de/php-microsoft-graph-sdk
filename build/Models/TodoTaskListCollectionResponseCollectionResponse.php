...
/**
 * Collection response for TodoTaskListCollectionResponse
 */
class TodoTaskListCollectionResponseCollectionResponse
{
    /**
     * @var TodoTaskListCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TodoTaskListCollectionResponse ...$items Variable number of TodoTaskListCollectionResponse items
     * @return self
     */
    public function setValue(TodoTaskListCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TodoTaskListCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TodoTaskListCollectionResponse $item
     * @return self
     */
    public function addValue(TodoTaskListCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
