...
/**
 * Collection response for AiInteractionMentionCollectionResponse
 */
class AiInteractionMentionCollectionResponseCollectionResponse
{
    /**
     * @var AiInteractionMentionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @return AiInteractionMentionCollectionResponse[]
     */
     ...
     * 
     * @param AiInteractionMentionCollectionResponse ...$items Variable number of AiInteractionMentionCollectionResponse items
     * @return self
     */
    public function setValue(AiInteractionMentionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AiInteractionMentionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AiInteractionMentionCollectionResponse $item
     * @return self
     */
    public function addValue(AiInteractionMentionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
