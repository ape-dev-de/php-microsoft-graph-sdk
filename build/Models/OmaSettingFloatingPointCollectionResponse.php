 ...
 */
class OmaSettingFloatingPointCollectionResponse
{
    /**
     ...
     * 
     * @param OmaSettingFloatingPoint ...$items Variable number of OmaSettingFloatingPoint items
     * @return self
     */
    public function setValue(OmaSettingFloatingPoint ...$items): self
    {
        $this->value = $items;
        return $this;
    }
