...
/**
 * Collection response for OmaSettingFloatingPoint
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OmaSettingFloatingPointCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OmaSettingFloatingPoint[]
     */
    private array $value = [];
     ...
     * 
     * @param OmaSettingFloatingPoint[] $items
     * @return self
     */
    public function setValue(array|OmaSettingFloatingPoint $items, OmaSettingFloatingPoint ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OmaSettingFloatingPoint> $value
     * @return self
     ...
     * 
     * @param OmaSettingFloatingPoint $item
     * @return self
     */
    public function addValue(OmaSettingFloatingPoint $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OmaSettingFloatingPoint|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OmaSettingFloatingPoint>
     */
