...
/**
 * SecurityMailboxConfigurationTypeCollectionResponse - Collection response
 */
class SecurityMailboxConfigurationTypeCollectionResponse
{
    /**
     * @var array<int, SecurityMailboxConfigurationType>
     */
    public array $value = [];
