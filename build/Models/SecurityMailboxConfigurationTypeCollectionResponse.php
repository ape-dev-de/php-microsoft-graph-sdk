...
/**
 * Collection response for SecurityMailboxConfigurationType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityMailboxConfigurationTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityMailboxConfigurationType[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityMailboxConfigurationType[]
     */
     ...
     * 
     * @param SecurityMailboxConfigurationType[] $items
     * @return self
     */
    public function setValue(array|SecurityMailboxConfigurationType $items, SecurityMailboxConfigurationType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityMailboxConfigurationType> $value
     * @return self
     ...
     * 
     * @param SecurityMailboxConfigurationType $item
     * @return self
     */
    public function addValue(SecurityMailboxConfigurationType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityMailboxConfigurationType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityMailboxConfigurationType>
     */
