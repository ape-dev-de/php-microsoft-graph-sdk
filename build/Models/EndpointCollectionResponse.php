...
/**
 * Collection response for Endpoint
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EndpointCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Endpoint[]
     */
     ...
     * @return self
     */
    public function setValue(array|Endpoint $items, Endpoint ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Endpoint $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Endpoint>
     */
