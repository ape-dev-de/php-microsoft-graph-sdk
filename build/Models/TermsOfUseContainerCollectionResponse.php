 ...
 */
class TermsOfUseContainerCollectionResponse
{
    /**
     ...
     * 
     * @param TermsOfUseContainer ...$items Variable number of TermsOfUseContainer items
     * @return self
     */
    public function setValue(TermsOfUseContainer ...$items): self
    {
        $this->value = $items;
        return $this;
    }
