...
/**
 * Collection response for TermsOfUseContainer
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TermsOfUseContainerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TermsOfUseContainer[]
     */
    private array $value = [];
     ...
     * 
     * @param TermsOfUseContainer[] $items
     * @return self
     */
    public function setValue(array|TermsOfUseContainer $items, TermsOfUseContainer ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TermsOfUseContainer> $value
     * @return self
     ...
     * 
     * @param TermsOfUseContainer $item
     * @return self
     */
    public function addValue(TermsOfUseContainer $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TermsOfUseContainer>
     */
