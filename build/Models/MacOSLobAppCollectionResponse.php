...
/**
 * Collection response for MacOSLobApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MacOSLobAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MacOSLobApp[]
     */
     ...
     * 
     * @param MacOSLobApp[] $items
     * @return self
     */
    public function setValue(array|MacOSLobApp $items, MacOSLobApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param MacOSLobApp $item
     * @return self
     */
    public function addValue(MacOSLobApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MacOSLobApp>
     */
