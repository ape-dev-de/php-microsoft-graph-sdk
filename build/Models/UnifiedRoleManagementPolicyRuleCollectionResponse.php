...
/**
 * Collection response for UnifiedRoleManagementPolicyRule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UnifiedRoleManagementPolicyRuleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UnifiedRoleManagementPolicyRule[] $items
     * @return self
     */
    public function setValue(array|UnifiedRoleManagementPolicyRule $items, UnifiedRoleManagementPolicyRule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UnifiedRoleManagementPolicyRule> $value
     * @return self
     ...
     * 
     * @param UnifiedRoleManagementPolicyRule $item
     * @return self
     */
    public function addValue(UnifiedRoleManagementPolicyRule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UnifiedRoleManagementPolicyRule>
     */
