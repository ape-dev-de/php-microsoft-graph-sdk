...
/**
 * Collection response for SecurityWhoisRecordCollectionResponse
 */
class SecurityWhoisRecordCollectionResponseCollectionResponse
{
    /**
     * @var SecurityWhoisRecordCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityWhoisRecordCollectionResponse ...$items Variable number of SecurityWhoisRecordCollectionResponse items
     * @return self
     */
    public function setValue(SecurityWhoisRecordCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityWhoisRecordCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityWhoisRecordCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityWhoisRecordCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
