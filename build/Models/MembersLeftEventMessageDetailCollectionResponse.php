 ...
 */
class MembersLeftEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param MembersLeftEventMessageDetail ...$items Variable number of MembersLeftEventMessageDetail items
     * @return self
     */
    public function setValue(MembersLeftEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
