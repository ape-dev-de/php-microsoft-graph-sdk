...
/**
 * Collection response for MembersLeftEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MembersLeftEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MembersLeftEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param MembersLeftEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|MembersLeftEventMessageDetail $items, MembersLeftEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MembersLeftEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param MembersLeftEventMessageDetail $item
     * @return self
     */
    public function addValue(MembersLeftEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MembersLeftEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MembersLeftEventMessageDetail>
     */
