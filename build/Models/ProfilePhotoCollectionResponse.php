...
/**
 * Collection response for ProfilePhoto
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProfilePhotoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProfilePhoto[]
     */
     ...
     * 
     * @param ProfilePhoto[] $items
     * @return self
     */
    public function setValue(array|ProfilePhoto $items, ProfilePhoto ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProfilePhoto> $value
     * @return self
     ...
     * 
     * @param ProfilePhoto $item
     * @return self
     */
    public function addValue(ProfilePhoto $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProfilePhoto>
     */
