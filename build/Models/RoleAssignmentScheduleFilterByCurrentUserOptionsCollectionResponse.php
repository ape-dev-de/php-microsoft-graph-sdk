...
/**
 * Collection response for RoleAssignmentScheduleFilterByCurrentUserOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RoleAssignmentScheduleFilterByCurrentUserOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RoleAssignmentScheduleFilterByCurrentUserOptions[]
     */
    private array $value = [];
     ...
     * 
     * @return RoleAssignmentScheduleFilterByCurrentUserOptions[]
     */
     ...
     * 
     * @param RoleAssignmentScheduleFilterByCurrentUserOptions[] $items
     * @return self
     */
    public function setValue(array|RoleAssignmentScheduleFilterByCurrentUserOptions $items, RoleAssignmentScheduleFilterByCurrentUserOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RoleAssignmentScheduleFilterByCurrentUserOptions> $value
     * @return self
     ...
     * 
     * @param RoleAssignmentScheduleFilterByCurrentUserOptions $item
     * @return self
     */
    public function addValue(RoleAssignmentScheduleFilterByCurrentUserOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return RoleAssignmentScheduleFilterByCurrentUserOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, RoleAssignmentScheduleFilterByCurrentUserOptions>
     */
