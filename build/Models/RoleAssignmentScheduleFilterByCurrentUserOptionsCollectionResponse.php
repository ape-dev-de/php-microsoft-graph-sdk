...
/**
 * RoleAssignmentScheduleFilterByCurrentUserOptionsCollectionResponse - Collection response
 */
class RoleAssignmentScheduleFilterByCurrentUserOptionsCollectionResponse
{
    /**
     * @var array<int, RoleAssignmentScheduleFilterByCurrentUserOptions>
     */
    public array $value = [];
