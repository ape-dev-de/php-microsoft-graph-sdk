...
/**
 * Collection response for PromptLoginBehavior
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PromptLoginBehaviorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PromptLoginBehavior[]
     */
    private array $value = [];
     ...
     * 
     * @param PromptLoginBehavior[] $items
     * @return self
     */
    public function setValue(array|PromptLoginBehavior $items, PromptLoginBehavior ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PromptLoginBehavior> $value
     * @return self
     ...
     * 
     * @param PromptLoginBehavior $item
     * @return self
     */
    public function addValue(PromptLoginBehavior $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PromptLoginBehavior>
     */
