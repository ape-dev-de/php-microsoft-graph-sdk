...
/**
 * Collection response for TeamworkTagIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TeamworkTagIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TeamworkTagIdentity[]
     */
    private array $value = [];
     ...
     * 
     * @param TeamworkTagIdentity[] $items
     * @return self
     */
    public function setValue(array|TeamworkTagIdentity $items, TeamworkTagIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TeamworkTagIdentity> $value
     * @return self
     ...
     * 
     * @param TeamworkTagIdentity $item
     * @return self
     */
    public function addValue(TeamworkTagIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TeamworkTagIdentity>
     */
