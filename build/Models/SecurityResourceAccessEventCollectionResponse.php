...
/**
 * Collection response for SecurityResourceAccessEvent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityResourceAccessEventCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @return SecurityResourceAccessEvent[]
     */
     ...
     * 
     * @param SecurityResourceAccessEvent[] $items
     * @return self
     */
    public function setValue(array|SecurityResourceAccessEvent $items, SecurityResourceAccessEvent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityResourceAccessEvent> $value
     * @return self
     ...
     * 
     * @param SecurityResourceAccessEvent $item
     * @return self
     */
    public function addValue(SecurityResourceAccessEvent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityResourceAccessEvent|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityResourceAccessEvent>
     */
