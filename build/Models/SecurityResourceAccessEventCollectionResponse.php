...
/**
 * SecurityResourceAccessEventCollectionResponse - Collection response
 */
class SecurityResourceAccessEventCollectionResponse
{
    /**
     * @var array<int, SecurityResourceAccessEvent>
     */
    public array $value = [];
