...
/**
 * Collection response for ExternalAudienceScope
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ExternalAudienceScopeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ExternalAudienceScope[] $items
     * @return self
     */
    public function setValue(array|ExternalAudienceScope $items, ExternalAudienceScope ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ExternalAudienceScope> $value
     * @return self
     ...
     * 
     * @param ExternalAudienceScope $item
     * @return self
     */
    public function addValue(ExternalAudienceScope $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ExternalAudienceScope>
     */
