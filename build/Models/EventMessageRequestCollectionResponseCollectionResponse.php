...
/**
 * Collection response for EventMessageRequestCollectionResponse
 */
class EventMessageRequestCollectionResponseCollectionResponse
{
    /**
     * @var EventMessageRequestCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EventMessageRequestCollectionResponse ...$items Variable number of EventMessageRequestCollectionResponse items
     * @return self
     */
    public function setValue(EventMessageRequestCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EventMessageRequestCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EventMessageRequestCollectionResponse $item
     * @return self
     */
    public function addValue(EventMessageRequestCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
