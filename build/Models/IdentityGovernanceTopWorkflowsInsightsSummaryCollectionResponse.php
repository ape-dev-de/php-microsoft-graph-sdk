...
/**
 * Collection response for IdentityGovernanceTopWorkflowsInsightsSummary
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceTopWorkflowsInsightsSummaryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdentityGovernanceTopWorkflowsInsightsSummary[]
     */
    private array $value = [];
     ...
     * 
     * @return IdentityGovernanceTopWorkflowsInsightsSummary[]
     */
     ...
     * 
     * @param IdentityGovernanceTopWorkflowsInsightsSummary[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceTopWorkflowsInsightsSummary $items, IdentityGovernanceTopWorkflowsInsightsSummary ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceTopWorkflowsInsightsSummary> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceTopWorkflowsInsightsSummary $item
     * @return self
     */
    public function addValue(IdentityGovernanceTopWorkflowsInsightsSummary $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IdentityGovernanceTopWorkflowsInsightsSummary|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceTopWorkflowsInsightsSummary>
     */
