 ...
 */
class CloudPcWindowsSettingCollectionResponse
{
    /**
     ...
     * 
     * @param CloudPcWindowsSetting ...$items Variable number of CloudPcWindowsSetting items
     * @return self
     */
    public function setValue(CloudPcWindowsSetting ...$items): self
    {
        $this->value = $items;
        return $this;
    }
