...
/**
 * Collection response for CloudPcWindowsSetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcWindowsSettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudPcWindowsSetting[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudPcWindowsSetting[] $items
     * @return self
     */
    public function setValue(array|CloudPcWindowsSetting $items, CloudPcWindowsSetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcWindowsSetting> $value
     * @return self
     ...
     * 
     * @param CloudPcWindowsSetting $item
     * @return self
     */
    public function addValue(CloudPcWindowsSetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcWindowsSetting>
     */
