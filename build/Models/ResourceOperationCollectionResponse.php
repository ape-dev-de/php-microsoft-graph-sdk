...
/**
 * Collection response for ResourceOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ResourceOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ResourceOperation[] $items
     * @return self
     */
    public function setValue(array|ResourceOperation $items, ResourceOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ResourceOperation> $value
     * @return self
     ...
     * 
     * @param ResourceOperation $item
     * @return self
     */
    public function addValue(ResourceOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ResourceOperation>
     */
