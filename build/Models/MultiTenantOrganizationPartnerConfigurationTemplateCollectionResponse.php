...
/**
 * MultiTenantOrganizationPartnerConfigurationTemplateCollectionResponse - Collection response
 */
class MultiTenantOrganizationPartnerConfigurationTemplateCollectionResponse
{
    /**
     * @var array<int, MultiTenantOrganizationPartnerConfigurationTemplate>
     */
    public array $value = [];
