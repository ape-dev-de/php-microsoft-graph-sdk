...
/**
 * Collection response for MultiTenantOrganizationPartnerConfigurationTemplate
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MultiTenantOrganizationPartnerConfigurationTemplateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MultiTenantOrganizationPartnerConfigurationTemplate[]
     */
    private array $value = [];
     ...
     * 
     * @param MultiTenantOrganizationPartnerConfigurationTemplate[] $items
     * @return self
     */
    public function setValue(array|MultiTenantOrganizationPartnerConfigurationTemplate $items, MultiTenantOrganizationPartnerConfigurationTemplate ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MultiTenantOrganizationPartnerConfigurationTemplate> $value
     * @return self
     ...
     * 
     * @param MultiTenantOrganizationPartnerConfigurationTemplate $item
     * @return self
     */
    public function addValue(MultiTenantOrganizationPartnerConfigurationTemplate $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MultiTenantOrganizationPartnerConfigurationTemplate>
     */
