...
/**
 * Collection response for ScoredEmailAddressCollectionResponse
 */
class ScoredEmailAddressCollectionResponseCollectionResponse
{
    /**
     * @var ScoredEmailAddressCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ScoredEmailAddressCollectionResponse ...$items Variable number of ScoredEmailAddressCollectionResponse items
     * @return self
     */
    public function setValue(ScoredEmailAddressCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ScoredEmailAddressCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ScoredEmailAddressCollectionResponse $item
     * @return self
     */
    public function addValue(ScoredEmailAddressCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
