 ...
 */
class PartnersBillingBillingCollectionResponse
{
    /**
     ...
     * 
     * @param PartnersBillingBilling ...$items Variable number of PartnersBillingBilling items
     * @return self
     */
    public function setValue(PartnersBillingBilling ...$items): self
    {
        $this->value = $items;
        return $this;
    }
