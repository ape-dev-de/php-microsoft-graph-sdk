...
/**
 * Collection response for PartnersBillingBilling
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PartnersBillingBillingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PartnersBillingBilling[]
     */
    private array $value = [];
     ...
     * 
     * @param PartnersBillingBilling[] $items
     * @return self
     */
    public function setValue(array|PartnersBillingBilling $items, PartnersBillingBilling ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PartnersBillingBilling> $value
     * @return self
     ...
     * 
     * @param PartnersBillingBilling $item
     * @return self
     */
    public function addValue(PartnersBillingBilling $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PartnersBillingBilling>
     */
