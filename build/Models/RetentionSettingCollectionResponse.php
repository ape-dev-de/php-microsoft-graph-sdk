...
/**
 * Collection response for RetentionSetting
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RetentionSettingCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param RetentionSetting[] $items
     * @return self
     */
    public function setValue(array|RetentionSetting $items, RetentionSetting ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RetentionSetting> $value
     * @return self
     ...
     * 
     * @param RetentionSetting $item
     * @return self
     */
    public function addValue(RetentionSetting $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RetentionSetting>
     */
