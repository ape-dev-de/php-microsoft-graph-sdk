...
/**
 * Collection response for RiskDetectionCollectionResponse
 */
class RiskDetectionCollectionResponseCollectionResponse
{
    /**
     * @var RiskDetectionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RiskDetectionCollectionResponse ...$items Variable number of RiskDetectionCollectionResponse items
     * @return self
     */
    public function setValue(RiskDetectionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RiskDetectionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RiskDetectionCollectionResponse $item
     * @return self
     */
    public function addValue(RiskDetectionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
