...
/**
 * Collection response for SimulationEvent
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SimulationEventCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SimulationEvent[]
     */
     ...
     * 
     * @param SimulationEvent[] $items
     * @return self
     */
    public function setValue(array|SimulationEvent $items, SimulationEvent ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SimulationEvent> $value
     * @return self
     ...
     * 
     * @param SimulationEvent $item
     * @return self
     */
    public function addValue(SimulationEvent $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SimulationEvent>
     */
