...
/**
 * Collection response for AccessReviewQueryScope
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewQueryScopeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessReviewQueryScope[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessReviewQueryScope[] $items
     * @return self
     */
    public function setValue(array|AccessReviewQueryScope $items, AccessReviewQueryScope ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewQueryScope> $value
     * @return self
     ...
     * 
     * @param AccessReviewQueryScope $item
     * @return self
     */
    public function addValue(AccessReviewQueryScope $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AccessReviewQueryScope|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewQueryScope>
     */
