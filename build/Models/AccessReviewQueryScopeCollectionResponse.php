 ...
 */
class AccessReviewQueryScopeCollectionResponse
{
    /**
     ...
     * 
     * @param AccessReviewQueryScope ...$items Variable number of AccessReviewQueryScope items
     * @return self
     */
    public function setValue(AccessReviewQueryScope ...$items): self
    {
        $this->value = $items;
        return $this;
    }
