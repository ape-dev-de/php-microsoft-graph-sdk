...
/**
 * Collection response for RecurrenceRange
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RecurrenceRangeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RecurrenceRange[]
     */
     ...
     * 
     * @param RecurrenceRange[] $items
     * @return self
     */
    public function setValue(array|RecurrenceRange $items, RecurrenceRange ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RecurrenceRange> $value
     * @return self
     ...
     * 
     * @param RecurrenceRange $item
     * @return self
     */
    public function addValue(RecurrenceRange $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RecurrenceRange>
     */
