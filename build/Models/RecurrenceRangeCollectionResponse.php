 ...
 */
class RecurrenceRangeCollectionResponse
{
    /**
     * @var RecurrenceRange[]
     */
     ...
     * 
     * @param RecurrenceRange ...$items Variable number of RecurrenceRange items
     * @return self
     */
    public function setValue(RecurrenceRange ...$items): self
    {
        $this->value = $items;
        return $this;
    }
