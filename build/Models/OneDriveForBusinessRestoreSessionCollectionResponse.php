...
/**
 * Collection response for OneDriveForBusinessRestoreSession
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OneDriveForBusinessRestoreSessionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param OneDriveForBusinessRestoreSession[] $items
     * @return self
     */
    public function setValue(array|OneDriveForBusinessRestoreSession $items, OneDriveForBusinessRestoreSession ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OneDriveForBusinessRestoreSession> $value
     * @return self
     ...
     * 
     * @param OneDriveForBusinessRestoreSession $item
     * @return self
     */
    public function addValue(OneDriveForBusinessRestoreSession $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OneDriveForBusinessRestoreSession>
     */
