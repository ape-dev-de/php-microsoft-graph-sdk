...
class Windows10EnrollmentCompletionPageConfiguration
{
    ...
    public function __construct(array $data = [])
    {
        ...
        if (isset($data['allowNonBlockingAppInstallation'])) {
            $this->allowNonBlockingAppInstallation = is_bool($data['allowNonBlockingAppInstallation']) ? $data['allowNonBlockingAppInstallation'] : (bool)$data['allowNonBlockingAppInstallation'];
        }
    }
