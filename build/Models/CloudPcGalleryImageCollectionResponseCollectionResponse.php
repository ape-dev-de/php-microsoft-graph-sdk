...
/**
 * Collection response for CloudPcGalleryImageCollectionResponse
 */
class CloudPcGalleryImageCollectionResponseCollectionResponse
{
    /**
     * @var CloudPcGalleryImageCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudPcGalleryImageCollectionResponse ...$items Variable number of CloudPcGalleryImageCollectionResponse items
     * @return self
     */
    public function setValue(CloudPcGalleryImageCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CloudPcGalleryImageCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CloudPcGalleryImageCollectionResponse $item
     * @return self
     */
    public function addValue(CloudPcGalleryImageCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
