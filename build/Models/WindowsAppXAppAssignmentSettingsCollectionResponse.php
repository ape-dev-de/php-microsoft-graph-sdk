...
/**
 * Collection response for WindowsAppXAppAssignmentSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsAppXAppAssignmentSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsAppXAppAssignmentSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsAppXAppAssignmentSettings[] $items
     * @return self
     */
    public function setValue(array|WindowsAppXAppAssignmentSettings $items, WindowsAppXAppAssignmentSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsAppXAppAssignmentSettings> $value
     * @return self
     ...
     * 
     * @param WindowsAppXAppAssignmentSettings $item
     * @return self
     */
    public function addValue(WindowsAppXAppAssignmentSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return WindowsAppXAppAssignmentSettings|null
     */
     ...
     * 
     * @return \ArrayIterator<int, WindowsAppXAppAssignmentSettings>
     */
