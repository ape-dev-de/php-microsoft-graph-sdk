 ...
 */
class WindowsAppXAppAssignmentSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param WindowsAppXAppAssignmentSettings ...$items Variable number of WindowsAppXAppAssignmentSettings items
     * @return self
     */
    public function setValue(WindowsAppXAppAssignmentSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
