...
/**
 * Collection response for IosVppEBookCollectionResponse
 */
class IosVppEBookCollectionResponseCollectionResponse
{
    /**
     * @var IosVppEBookCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IosVppEBookCollectionResponse ...$items Variable number of IosVppEBookCollectionResponse items
     * @return self
     */
    public function setValue(IosVppEBookCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IosVppEBookCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IosVppEBookCollectionResponse $item
     * @return self
     */
    public function addValue(IosVppEBookCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
