...
/**
 * Collection response for UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDetails
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDetailsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDetails[] $items
     * @return self
     */
    public function setValue(array|UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDetails $items, UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDetails ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDetails> $value
     * @return self
     ...
     * 
     * @param UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDetails $item
     * @return self
     */
    public function addValue(UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDetails $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDetails>
     */
