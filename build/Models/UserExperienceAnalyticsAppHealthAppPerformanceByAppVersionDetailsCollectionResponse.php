...
/**
 * UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDetailsCollectionResponse - Collection response
 */
class UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDetailsCollectionResponse
{
    /**
     * @var array<int, UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDetails>
     */
    public array $value = [];
