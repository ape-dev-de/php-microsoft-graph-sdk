...
/**
 * Collection response for Fido2KeyRestrictions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Fido2KeyRestrictionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Fido2KeyRestrictions[]
     */
    private array $value = [];
     ...
     * 
     * @param Fido2KeyRestrictions[] $items
     * @return self
     */
    public function setValue(array|Fido2KeyRestrictions $items, Fido2KeyRestrictions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Fido2KeyRestrictions> $value
     * @return self
     ...
     * 
     * @param Fido2KeyRestrictions $item
     * @return self
     */
    public function addValue(Fido2KeyRestrictions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Fido2KeyRestrictions>
     */
