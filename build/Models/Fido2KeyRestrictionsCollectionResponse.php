 ...
 */
class Fido2KeyRestrictionsCollectionResponse
{
    /**
     ...
     * 
     * @param Fido2KeyRestrictions ...$items Variable number of Fido2KeyRestrictions items
     * @return self
     */
    public function setValue(Fido2KeyRestrictions ...$items): self
    {
        $this->value = $items;
        return $this;
    }
