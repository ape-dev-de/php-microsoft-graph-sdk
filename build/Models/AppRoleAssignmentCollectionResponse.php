...
/**
 * Collection response for AppRoleAssignment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppRoleAssignmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AppRoleAssignment[] $items
     * @return self
     */
    public function setValue(array|AppRoleAssignment $items, AppRoleAssignment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppRoleAssignment> $value
     * @return self
     ...
     * 
     * @param AppRoleAssignment $item
     * @return self
     */
    public function addValue(AppRoleAssignment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AppRoleAssignment>
     */
