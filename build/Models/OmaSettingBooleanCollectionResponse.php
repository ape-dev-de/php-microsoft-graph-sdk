 ...
 */
class OmaSettingBooleanCollectionResponse
{
    /**
     ...
     * 
     * @param OmaSettingBoolean ...$items Variable number of OmaSettingBoolean items
     * @return self
     */
    public function setValue(OmaSettingBoolean ...$items): self
    {
        $this->value = $items;
        return $this;
    }
