...
/**
 * Collection response for OmaSettingBoolean
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OmaSettingBooleanCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OmaSettingBoolean[]
     */
    private array $value = [];
     ...
     * 
     * @param OmaSettingBoolean[] $items
     * @return self
     */
    public function setValue(array|OmaSettingBoolean $items, OmaSettingBoolean ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OmaSettingBoolean> $value
     * @return self
     ...
     * 
     * @param OmaSettingBoolean $item
     * @return self
     */
    public function addValue(OmaSettingBoolean $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OmaSettingBoolean>
     */
