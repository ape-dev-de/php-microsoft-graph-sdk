...
class DeviceAppManagement
{
     ...
     * @var string[]
     */
    private array $windowsInformationProtectionPolicies = [];
    ...
    /**
     * @param string[] $windowsInformationProtectionPolicies
     */
    public function setWindowsInformationProtectionPolicies(array $windowsInformationProtectionPolicies): self
    {
