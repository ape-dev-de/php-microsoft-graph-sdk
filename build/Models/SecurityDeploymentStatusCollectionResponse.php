...
/**
 * Collection response for SecurityDeploymentStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityDeploymentStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityDeploymentStatus[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityDeploymentStatus[]
     */
     ...
     * 
     * @param SecurityDeploymentStatus[] $items
     * @return self
     */
    public function setValue(array|SecurityDeploymentStatus $items, SecurityDeploymentStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityDeploymentStatus> $value
     * @return self
     ...
     * 
     * @param SecurityDeploymentStatus $item
     * @return self
     */
    public function addValue(SecurityDeploymentStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityDeploymentStatus|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityDeploymentStatus>
     */
