...
/**
 * Collection response for CloudPcSourceDeviceImage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcSourceDeviceImageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudPcSourceDeviceImage[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudPcSourceDeviceImage[] $items
     * @return self
     */
    public function setValue(array|CloudPcSourceDeviceImage $items, CloudPcSourceDeviceImage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcSourceDeviceImage> $value
     * @return self
     ...
     * 
     * @param CloudPcSourceDeviceImage $item
     * @return self
     */
    public function addValue(CloudPcSourceDeviceImage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CloudPcSourceDeviceImage|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CloudPcSourceDeviceImage>
     */
