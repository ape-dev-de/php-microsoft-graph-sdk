...
/**
 * Collection response for EndUserNotificationDetailCollectionResponse
 */
class EndUserNotificationDetailCollectionResponseCollectionResponse
{
    /**
     * @var EndUserNotificationDetailCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param EndUserNotificationDetailCollectionResponse ...$items Variable number of EndUserNotificationDetailCollectionResponse items
     * @return self
     */
    public function setValue(EndUserNotificationDetailCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<EndUserNotificationDetailCollectionResponse> $value
     * @return self
     ...
     * 
     * @param EndUserNotificationDetailCollectionResponse $item
     * @return self
     */
    public function addValue(EndUserNotificationDetailCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
