 ...
 */
class PresenceStatusMessageCollectionResponse
{
    /**
     ...
     * 
     * @param PresenceStatusMessage ...$items Variable number of PresenceStatusMessage items
     * @return self
     */
    public function setValue(PresenceStatusMessage ...$items): self
    {
        $this->value = $items;
        return $this;
    }
