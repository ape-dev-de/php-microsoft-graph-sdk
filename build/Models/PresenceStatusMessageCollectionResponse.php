...
/**
 * Collection response for PresenceStatusMessage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PresenceStatusMessageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PresenceStatusMessage[]
     */
    private array $value = [];
     ...
     * 
     * @param PresenceStatusMessage[] $items
     * @return self
     */
    public function setValue(array|PresenceStatusMessage $items, PresenceStatusMessage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PresenceStatusMessage> $value
     * @return self
     ...
     * 
     * @param PresenceStatusMessage $item
     * @return self
     */
    public function addValue(PresenceStatusMessage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PresenceStatusMessage>
     */
