...
/**
 * Collection response for AutomaticUpdateMode
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AutomaticUpdateModeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AutomaticUpdateMode[]
     */
    private array $value = [];
     ...
     * 
     * @param AutomaticUpdateMode[] $items
     * @return self
     */
    public function setValue(array|AutomaticUpdateMode $items, AutomaticUpdateMode ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AutomaticUpdateMode> $value
     * @return self
     ...
     * 
     * @param AutomaticUpdateMode $item
     * @return self
     */
    public function addValue(AutomaticUpdateMode $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AutomaticUpdateMode>
     */
