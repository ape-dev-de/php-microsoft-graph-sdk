...
/**
 * OnAttributeCollectionSubmitHandlerCollectionResponse - Collection response
 */
class OnAttributeCollectionSubmitHandlerCollectionResponse
{
    /**
     * @var array<int, OnAttributeCollectionSubmitHandler>
     */
    public array $value = [];
