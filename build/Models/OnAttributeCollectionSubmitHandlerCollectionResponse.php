...
/**
 * Collection response for OnAttributeCollectionSubmitHandler
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnAttributeCollectionSubmitHandlerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnAttributeCollectionSubmitHandler[]
     */
    private array $value = [];
     ...
     * 
     * @param OnAttributeCollectionSubmitHandler[] $items
     * @return self
     */
    public function setValue(array|OnAttributeCollectionSubmitHandler $items, OnAttributeCollectionSubmitHandler ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnAttributeCollectionSubmitHandler> $value
     * @return self
     ...
     * 
     * @param OnAttributeCollectionSubmitHandler $item
     * @return self
     */
    public function addValue(OnAttributeCollectionSubmitHandler $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OnAttributeCollectionSubmitHandler>
     */
