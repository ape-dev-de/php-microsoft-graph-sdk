 ...
 */
class SignInLocationCollectionResponse
{
    /**
     * @var SignInLocation[]
     */
     ...
     * 
     * @param SignInLocation ...$items Variable number of SignInLocation items
     * @return self
     */
    public function setValue(SignInLocation ...$items): self
    {
        $this->value = $items;
        return $this;
    }
