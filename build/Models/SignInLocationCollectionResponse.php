...
/**
 * Collection response for SignInLocation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SignInLocationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SignInLocation[]
     */
     ...
     * 
     * @param SignInLocation[] $items
     * @return self
     */
    public function setValue(array|SignInLocation $items, SignInLocation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SignInLocation> $value
     * @return self
     ...
     * 
     * @param SignInLocation $item
     * @return self
     */
    public function addValue(SignInLocation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SignInLocation>
     */
