...
/**
 * Collection response for AttackSimulationOperationCollectionResponse
 */
class AttackSimulationOperationCollectionResponseCollectionResponse
{
    /**
     * @var AttackSimulationOperationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AttackSimulationOperationCollectionResponse ...$items Variable number of AttackSimulationOperationCollectionResponse items
     * @return self
     */
    public function setValue(AttackSimulationOperationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AttackSimulationOperationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AttackSimulationOperationCollectionResponse $item
     * @return self
     */
    public function addValue(AttackSimulationOperationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
