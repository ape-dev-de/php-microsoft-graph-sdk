 ...
 */
class MessagePinnedEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param MessagePinnedEventMessageDetail ...$items Variable number of MessagePinnedEventMessageDetail items
     * @return self
     */
    public function setValue(MessagePinnedEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
