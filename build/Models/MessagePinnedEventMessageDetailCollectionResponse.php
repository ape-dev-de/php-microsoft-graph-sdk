...
/**
 * Collection response for MessagePinnedEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MessagePinnedEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MessagePinnedEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param MessagePinnedEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|MessagePinnedEventMessageDetail $items, MessagePinnedEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MessagePinnedEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param MessagePinnedEventMessageDetail $item
     * @return self
     */
    public function addValue(MessagePinnedEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return MessagePinnedEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, MessagePinnedEventMessageDetail>
     */
