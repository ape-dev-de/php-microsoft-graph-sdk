...
/**
 * Collection response for AttributeMappingFunctionSchemaCollectionResponse
 */
class AttributeMappingFunctionSchemaCollectionResponseCollectionResponse
{
    /**
     * @var AttributeMappingFunctionSchemaCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AttributeMappingFunctionSchemaCollectionResponse ...$items Variable number of AttributeMappingFunctionSchemaCollectionResponse items
     * @return self
     */
    public function setValue(AttributeMappingFunctionSchemaCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AttributeMappingFunctionSchemaCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AttributeMappingFunctionSchemaCollectionResponse $item
     * @return self
     */
    public function addValue(AttributeMappingFunctionSchemaCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
