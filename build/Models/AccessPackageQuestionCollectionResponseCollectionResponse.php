...
/**
 * Collection response for AccessPackageQuestionCollectionResponse
 */
class AccessPackageQuestionCollectionResponseCollectionResponse
{
    /**
     * @var AccessPackageQuestionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageQuestionCollectionResponse ...$items Variable number of AccessPackageQuestionCollectionResponse items
     * @return self
     */
    public function setValue(AccessPackageQuestionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AccessPackageQuestionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AccessPackageQuestionCollectionResponse $item
     * @return self
     */
    public function addValue(AccessPackageQuestionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
