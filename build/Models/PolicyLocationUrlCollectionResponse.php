...
/**
 * Collection response for PolicyLocationUrl
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PolicyLocationUrlCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PolicyLocationUrl[]
     */
    private array $value = [];
     ...
     * 
     * @param PolicyLocationUrl[] $items
     * @return self
     */
    public function setValue(array|PolicyLocationUrl $items, PolicyLocationUrl ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PolicyLocationUrl> $value
     * @return self
     ...
     * 
     * @param PolicyLocationUrl $item
     * @return self
     */
    public function addValue(PolicyLocationUrl $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PolicyLocationUrl>
     */
