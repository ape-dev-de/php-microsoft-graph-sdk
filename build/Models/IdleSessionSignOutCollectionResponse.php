...
/**
 * Collection response for IdleSessionSignOut
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdleSessionSignOutCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var IdleSessionSignOut[]
     */
    private array $value = [];
     ...
     * 
     * @param IdleSessionSignOut[] $items
     * @return self
     */
    public function setValue(array|IdleSessionSignOut $items, IdleSessionSignOut ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdleSessionSignOut> $value
     * @return self
     ...
     * 
     * @param IdleSessionSignOut $item
     * @return self
     */
    public function addValue(IdleSessionSignOut $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdleSessionSignOut>
     */
