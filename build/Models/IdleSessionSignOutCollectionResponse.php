 ...
 */
class IdleSessionSignOutCollectionResponse
{
    /**
     ...
     * 
     * @param IdleSessionSignOut ...$items Variable number of IdleSessionSignOut items
     * @return self
     */
    public function setValue(IdleSessionSignOut ...$items): self
    {
        $this->value = $items;
        return $this;
    }
