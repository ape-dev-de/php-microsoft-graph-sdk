...
/**
 * Collection response for ConnectedOrganization
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConnectedOrganizationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ConnectedOrganization[] $items
     * @return self
     */
    public function setValue(array|ConnectedOrganization $items, ConnectedOrganization ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConnectedOrganization> $value
     * @return self
     ...
     * 
     * @param ConnectedOrganization $item
     * @return self
     */
    public function addValue(ConnectedOrganization $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConnectedOrganization>
     */
