...
/**
 * Collection response for IosHomeScreenItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosHomeScreenItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IosHomeScreenItem[] $items
     * @return self
     */
    public function setValue(array|IosHomeScreenItem $items, IosHomeScreenItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosHomeScreenItem> $value
     * @return self
     ...
     * 
     * @param IosHomeScreenItem $item
     * @return self
     */
    public function addValue(IosHomeScreenItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IosHomeScreenItem>
     */
