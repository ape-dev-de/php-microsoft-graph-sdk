...
/**
 * Collection response for AuthenticationEventListenerCollectionResponse
 */
class AuthenticationEventListenerCollectionResponseCollectionResponse
{
    /**
     * @var AuthenticationEventListenerCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AuthenticationEventListenerCollectionResponse ...$items Variable number of AuthenticationEventListenerCollectionResponse items
     * @return self
     */
    public function setValue(AuthenticationEventListenerCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AuthenticationEventListenerCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AuthenticationEventListenerCollectionResponse $item
     * @return self
     */
    public function addValue(AuthenticationEventListenerCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
