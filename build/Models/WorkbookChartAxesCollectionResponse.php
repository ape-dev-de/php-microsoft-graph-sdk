...
/**
 * Collection response for WorkbookChartAxes
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookChartAxesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookChartAxes[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookChartAxes[] $items
     * @return self
     */
    public function setValue(array|WorkbookChartAxes $items, WorkbookChartAxes ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookChartAxes> $value
     * @return self
     ...
     * 
     * @param WorkbookChartAxes $item
     * @return self
     */
    public function addValue(WorkbookChartAxes $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookChartAxes>
     */
