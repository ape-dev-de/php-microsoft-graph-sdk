 ...
 */
class WorkbookChartAxesCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookChartAxes ...$items Variable number of WorkbookChartAxes items
     * @return self
     */
    public function setValue(WorkbookChartAxes ...$items): self
    {
        $this->value = $items;
        return $this;
    }
