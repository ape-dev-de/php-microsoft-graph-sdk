...
/**
 * Collection response for DeviceCategory
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceCategoryCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceCategory[]
     */
     ...
     * 
     * @param DeviceCategory[] $items
     * @return self
     */
    public function setValue(array|DeviceCategory $items, DeviceCategory ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceCategory> $value
     * @return self
     ...
     * 
     * @param DeviceCategory $item
     * @return self
     */
    public function addValue(DeviceCategory $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceCategory>
     */
