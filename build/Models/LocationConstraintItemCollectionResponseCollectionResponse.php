...
/**
 * Collection response for LocationConstraintItemCollectionResponse
 */
class LocationConstraintItemCollectionResponseCollectionResponse
{
    /**
     * @var LocationConstraintItemCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param LocationConstraintItemCollectionResponse ...$items Variable number of LocationConstraintItemCollectionResponse items
     * @return self
     */
    public function setValue(LocationConstraintItemCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<LocationConstraintItemCollectionResponse> $value
     * @return self
     ...
     * 
     * @param LocationConstraintItemCollectionResponse $item
     * @return self
     */
    public function addValue(LocationConstraintItemCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
