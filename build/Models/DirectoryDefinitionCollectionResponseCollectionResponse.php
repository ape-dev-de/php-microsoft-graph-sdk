...
/**
 * Collection response for DirectoryDefinitionCollectionResponse
 */
class DirectoryDefinitionCollectionResponseCollectionResponse
{
    /**
     * @var DirectoryDefinitionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DirectoryDefinitionCollectionResponse ...$items Variable number of DirectoryDefinitionCollectionResponse items
     * @return self
     */
    public function setValue(DirectoryDefinitionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DirectoryDefinitionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DirectoryDefinitionCollectionResponse $item
     * @return self
     */
    public function addValue(DirectoryDefinitionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
