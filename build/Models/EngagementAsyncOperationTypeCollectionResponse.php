...
/**
 * EngagementAsyncOperationTypeCollectionResponse - Collection response
 */
class EngagementAsyncOperationTypeCollectionResponse
{
    /**
     * @var array<int, EngagementAsyncOperationType>
     */
    public array $value = [];
