...
/**
 * Collection response for EngagementAsyncOperationType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EngagementAsyncOperationTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EngagementAsyncOperationType[]
     */
    private array $value = [];
     ...
     * 
     * @return EngagementAsyncOperationType[]
     */
     ...
     * 
     * @param EngagementAsyncOperationType[] $items
     * @return self
     */
    public function setValue(array|EngagementAsyncOperationType $items, EngagementAsyncOperationType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EngagementAsyncOperationType> $value
     * @return self
     ...
     * 
     * @param EngagementAsyncOperationType $item
     * @return self
     */
    public function addValue(EngagementAsyncOperationType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, EngagementAsyncOperationType>
     */
