...
/**
 * Collection response for Win32LobAppFileSystemOperationType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class Win32LobAppFileSystemOperationTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Win32LobAppFileSystemOperationType[]
     */
    private array $value = [];
     ...
     * 
     * @return Win32LobAppFileSystemOperationType[]
     */
     ...
     * 
     * @param Win32LobAppFileSystemOperationType[] $items
     * @return self
     */
    public function setValue(array|Win32LobAppFileSystemOperationType $items, Win32LobAppFileSystemOperationType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<Win32LobAppFileSystemOperationType> $value
     * @return self
     ...
     * 
     * @param Win32LobAppFileSystemOperationType $item
     * @return self
     */
    public function addValue(Win32LobAppFileSystemOperationType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Win32LobAppFileSystemOperationType>
     */
