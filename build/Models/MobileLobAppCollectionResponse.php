...
/**
 * Collection response for MobileLobApp
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MobileLobAppCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MobileLobApp[]
     */
     ...
     * 
     * @param MobileLobApp[] $items
     * @return self
     */
    public function setValue(array|MobileLobApp $items, MobileLobApp ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<MobileLobApp> $value
     * @return self
     ...
     * 
     * @param MobileLobApp $item
     * @return self
     */
    public function addValue(MobileLobApp $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MobileLobApp>
     */
