 ...
 */
class CallRecordsUserFeedbackCollectionResponse
{
    /**
     ...
     * 
     * @param CallRecordsUserFeedback ...$items Variable number of CallRecordsUserFeedback items
     * @return self
     */
    public function setValue(CallRecordsUserFeedback ...$items): self
    {
        $this->value = $items;
        return $this;
    }
