...
/**
 * Collection response for CallRecordsUserFeedback
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordsUserFeedbackCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordsUserFeedback[]
     */
    private array $value = [];
     ...
     * 
     * @return CallRecordsUserFeedback[]
     */
     ...
     * 
     * @param CallRecordsUserFeedback[] $items
     * @return self
     */
    public function setValue(array|CallRecordsUserFeedback $items, CallRecordsUserFeedback ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordsUserFeedback> $value
     * @return self
     ...
     * 
     * @param CallRecordsUserFeedback $item
     * @return self
     */
    public function addValue(CallRecordsUserFeedback $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordsUserFeedback|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordsUserFeedback>
     */
