...
/**
 * Collection response for PlannerUserIds
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerUserIdsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PlannerUserIds[]
     */
     ...
     * 
     * @param PlannerUserIds[] $items
     * @return self
     */
    public function setValue(array|PlannerUserIds $items, PlannerUserIds ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PlannerUserIds> $value
     * @return self
     ...
     * 
     * @param PlannerUserIds $item
     * @return self
     */
    public function addValue(PlannerUserIds $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PlannerUserIds>
     */
