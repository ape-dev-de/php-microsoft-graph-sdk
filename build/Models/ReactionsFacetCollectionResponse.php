 ...
 */
class ReactionsFacetCollectionResponse
{
    /**
     * @var ReactionsFacet[]
     */
     ...
     * 
     * @param ReactionsFacet ...$items Variable number of ReactionsFacet items
     * @return self
     */
    public function setValue(ReactionsFacet ...$items): self
    {
        $this->value = $items;
        return $this;
    }
