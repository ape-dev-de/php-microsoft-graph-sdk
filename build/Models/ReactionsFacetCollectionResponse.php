...
/**
 * Collection response for ReactionsFacet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ReactionsFacetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ReactionsFacet[]
     */
     ...
     * 
     * @param ReactionsFacet[] $items
     * @return self
     */
    public function setValue(array|ReactionsFacet $items, ReactionsFacet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ReactionsFacet> $value
     * @return self
     ...
     * 
     * @param ReactionsFacet $item
     * @return self
     */
    public function addValue(ReactionsFacet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ReactionsFacet>
     */
