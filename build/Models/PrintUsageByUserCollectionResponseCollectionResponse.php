...
/**
 * Collection response for PrintUsageByUserCollectionResponse
 */
class PrintUsageByUserCollectionResponseCollectionResponse
{
    /**
     * @var PrintUsageByUserCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param PrintUsageByUserCollectionResponse ...$items Variable number of PrintUsageByUserCollectionResponse items
     * @return self
     */
    public function setValue(PrintUsageByUserCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<PrintUsageByUserCollectionResponse> $value
     * @return self
     ...
     * 
     * @param PrintUsageByUserCollectionResponse $item
     * @return self
     */
    public function addValue(PrintUsageByUserCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
