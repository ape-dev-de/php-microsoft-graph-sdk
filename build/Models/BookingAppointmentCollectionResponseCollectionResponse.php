...
/**
 * Collection response for BookingAppointmentCollectionResponse
 */
class BookingAppointmentCollectionResponseCollectionResponse
{
    /**
     * @var BookingAppointmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param BookingAppointmentCollectionResponse ...$items Variable number of BookingAppointmentCollectionResponse items
     * @return self
     */
    public function setValue(BookingAppointmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<BookingAppointmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param BookingAppointmentCollectionResponse $item
     * @return self
     */
    public function addValue(BookingAppointmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
