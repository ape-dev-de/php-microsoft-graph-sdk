...
/**
 * Collection response for DelegatedAdminRelationshipRequestCollectionResponse
 */
class DelegatedAdminRelationshipRequestCollectionResponseCollectionResponse
{
    /**
     * @var DelegatedAdminRelationshipRequestCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DelegatedAdminRelationshipRequestCollectionResponse ...$items Variable number of DelegatedAdminRelationshipRequestCollectionResponse items
     * @return self
     */
    public function setValue(DelegatedAdminRelationshipRequestCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DelegatedAdminRelationshipRequestCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DelegatedAdminRelationshipRequestCollectionResponse $item
     * @return self
     */
    public function addValue(DelegatedAdminRelationshipRequestCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
