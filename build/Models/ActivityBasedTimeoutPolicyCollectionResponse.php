...
/**
 * Collection response for ActivityBasedTimeoutPolicy
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ActivityBasedTimeoutPolicyCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ActivityBasedTimeoutPolicy[] $items
     * @return self
     */
    public function setValue(array|ActivityBasedTimeoutPolicy $items, ActivityBasedTimeoutPolicy ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ActivityBasedTimeoutPolicy> $value
     * @return self
     ...
     * 
     * @param ActivityBasedTimeoutPolicy $item
     * @return self
     */
    public function addValue(ActivityBasedTimeoutPolicy $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ActivityBasedTimeoutPolicy>
     */
