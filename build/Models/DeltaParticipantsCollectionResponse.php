...
/**
 * Collection response for DeltaParticipants
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeltaParticipantsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeltaParticipants[]
     */
    private array $value = [];
     ...
     * 
     * @param DeltaParticipants[] $items
     * @return self
     */
    public function setValue(array|DeltaParticipants $items, DeltaParticipants ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeltaParticipants> $value
     * @return self
     ...
     * 
     * @param DeltaParticipants $item
     * @return self
     */
    public function addValue(DeltaParticipants $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeltaParticipants>
     */
