 ...
 */
class DeltaParticipantsCollectionResponse
{
    /**
     ...
     * 
     * @param DeltaParticipants ...$items Variable number of DeltaParticipants items
     * @return self
     */
    public function setValue(DeltaParticipants ...$items): self
    {
        $this->value = $items;
        return $this;
    }
