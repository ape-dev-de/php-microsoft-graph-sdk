...
/**
 * Collection response for ConversationThreadCollectionResponse
 */
class ConversationThreadCollectionResponseCollectionResponse
{
    /**
     * @var ConversationThreadCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ConversationThreadCollectionResponse ...$items Variable number of ConversationThreadCollectionResponse items
     * @return self
     */
    public function setValue(ConversationThreadCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ConversationThreadCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ConversationThreadCollectionResponse $item
     * @return self
     */
    public function addValue(ConversationThreadCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
