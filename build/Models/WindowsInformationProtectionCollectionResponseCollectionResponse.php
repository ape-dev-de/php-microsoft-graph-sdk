...
/**
 * Collection response for WindowsInformationProtectionCollectionResponse
 */
class WindowsInformationProtectionCollectionResponseCollectionResponse
{
    /**
     * @var WindowsInformationProtectionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsInformationProtectionCollectionResponse ...$items Variable number of WindowsInformationProtectionCollectionResponse items
     * @return self
     */
    public function setValue(WindowsInformationProtectionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WindowsInformationProtectionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WindowsInformationProtectionCollectionResponse $item
     * @return self
     */
    public function addValue(WindowsInformationProtectionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
