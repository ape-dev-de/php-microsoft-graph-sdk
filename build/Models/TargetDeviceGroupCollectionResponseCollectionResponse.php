...
/**
 * Collection response for TargetDeviceGroupCollectionResponse
 */
class TargetDeviceGroupCollectionResponseCollectionResponse
{
    /**
     * @var TargetDeviceGroupCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param TargetDeviceGroupCollectionResponse ...$items Variable number of TargetDeviceGroupCollectionResponse items
     * @return self
     */
    public function setValue(TargetDeviceGroupCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<TargetDeviceGroupCollectionResponse> $value
     * @return self
     ...
     * 
     * @param TargetDeviceGroupCollectionResponse $item
     * @return self
     */
    public function addValue(TargetDeviceGroupCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
