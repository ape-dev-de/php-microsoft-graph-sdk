...
/**
 * Collection response for CallTranscriptionState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallTranscriptionStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallTranscriptionState[]
     */
    private array $value = [];
     ...
     * 
     * @param CallTranscriptionState[] $items
     * @return self
     */
    public function setValue(array|CallTranscriptionState $items, CallTranscriptionState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallTranscriptionState> $value
     * @return self
     ...
     * 
     * @param CallTranscriptionState $item
     * @return self
     */
    public function addValue(CallTranscriptionState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CallTranscriptionState>
     */
