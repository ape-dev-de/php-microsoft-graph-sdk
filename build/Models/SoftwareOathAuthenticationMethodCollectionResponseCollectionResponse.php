...
/**
 * Collection response for SoftwareOathAuthenticationMethodCollectionResponse
 */
class SoftwareOathAuthenticationMethodCollectionResponseCollectionResponse
{
    /**
     * @var SoftwareOathAuthenticationMethodCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SoftwareOathAuthenticationMethodCollectionResponse ...$items Variable number of SoftwareOathAuthenticationMethodCollectionResponse items
     * @return self
     */
    public function setValue(SoftwareOathAuthenticationMethodCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SoftwareOathAuthenticationMethodCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SoftwareOathAuthenticationMethodCollectionResponse $item
     * @return self
     */
    public function addValue(SoftwareOathAuthenticationMethodCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
