...
/**
 * Collection response for PlannerBucketTaskBoardTaskFormat
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PlannerBucketTaskBoardTaskFormatCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PlannerBucketTaskBoardTaskFormat[]
     */
    private array $value = [];
     ...
     * 
     * @param PlannerBucketTaskBoardTaskFormat[] $items
     * @return self
     */
    public function setValue(array|PlannerBucketTaskBoardTaskFormat $items, PlannerBucketTaskBoardTaskFormat ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PlannerBucketTaskBoardTaskFormat> $value
     * @return self
     ...
     * 
     * @param PlannerBucketTaskBoardTaskFormat $item
     * @return self
     */
    public function addValue(PlannerBucketTaskBoardTaskFormat $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PlannerBucketTaskBoardTaskFormat>
     */
