 ...
 */
class PlannerBucketTaskBoardTaskFormatCollectionResponse
{
    /**
     ...
     * 
     * @param PlannerBucketTaskBoardTaskFormat ...$items Variable number of PlannerBucketTaskBoardTaskFormat items
     * @return self
     */
    public function setValue(PlannerBucketTaskBoardTaskFormat ...$items): self
    {
        $this->value = $items;
        return $this;
    }
