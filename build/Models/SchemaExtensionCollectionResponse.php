...
/**
 * Collection response for SchemaExtension
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SchemaExtensionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SchemaExtension[]
     */
     ...
     * 
     * @param SchemaExtension[] $items
     * @return self
     */
    public function setValue(array|SchemaExtension $items, SchemaExtension ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SchemaExtension> $value
     * @return self
     ...
     * 
     * @param SchemaExtension $item
     * @return self
     */
    public function addValue(SchemaExtension $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SchemaExtension>
     */
