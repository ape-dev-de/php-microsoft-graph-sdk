...
/**
 * Collection response for OnOtpSendCustomExtensionHandler
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnOtpSendCustomExtensionHandlerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnOtpSendCustomExtensionHandler[]
     */
    private array $value = [];
     ...
     * 
     * @param OnOtpSendCustomExtensionHandler[] $items
     * @return self
     */
    public function setValue(array|OnOtpSendCustomExtensionHandler $items, OnOtpSendCustomExtensionHandler ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnOtpSendCustomExtensionHandler> $value
     * @return self
     ...
     * 
     * @param OnOtpSendCustomExtensionHandler $item
     * @return self
     */
    public function addValue(OnOtpSendCustomExtensionHandler $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OnOtpSendCustomExtensionHandler|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OnOtpSendCustomExtensionHandler>
     */
