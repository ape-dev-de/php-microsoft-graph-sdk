 ...
 */
class OnOtpSendCustomExtensionHandlerCollectionResponse
{
    /**
     ...
     * 
     * @param OnOtpSendCustomExtensionHandler ...$items Variable number of OnOtpSendCustomExtensionHandler items
     * @return self
     */
    public function setValue(OnOtpSendCustomExtensionHandler ...$items): self
    {
        $this->value = $items;
        return $this;
    }
