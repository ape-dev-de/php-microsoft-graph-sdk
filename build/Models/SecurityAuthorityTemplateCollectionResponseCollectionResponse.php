...
/**
 * Collection response for SecurityAuthorityTemplateCollectionResponse
 */
class SecurityAuthorityTemplateCollectionResponseCollectionResponse
{
    /**
     * @var SecurityAuthorityTemplateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityAuthorityTemplateCollectionResponse ...$items Variable number of SecurityAuthorityTemplateCollectionResponse items
     * @return self
     */
    public function setValue(SecurityAuthorityTemplateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityAuthorityTemplateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityAuthorityTemplateCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityAuthorityTemplateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
