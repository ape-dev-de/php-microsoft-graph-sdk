...
/**
 * Collection response for ServicePrincipalIdentity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ServicePrincipalIdentityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ServicePrincipalIdentity[]
     */
    private array $value = [];
     ...
     * 
     * @param ServicePrincipalIdentity[] $items
     * @return self
     */
    public function setValue(array|ServicePrincipalIdentity $items, ServicePrincipalIdentity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ServicePrincipalIdentity> $value
     * @return self
     ...
     * 
     * @param ServicePrincipalIdentity $item
     * @return self
     */
    public function addValue(ServicePrincipalIdentity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ServicePrincipalIdentity|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ServicePrincipalIdentity>
     */
