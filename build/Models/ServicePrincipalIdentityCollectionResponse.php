 ...
 */
class ServicePrincipalIdentityCollectionResponse
{
    /**
     ...
     * 
     * @param ServicePrincipalIdentity ...$items Variable number of ServicePrincipalIdentity items
     * @return self
     */
    public function setValue(ServicePrincipalIdentity ...$items): self
    {
        $this->value = $items;
        return $this;
    }
