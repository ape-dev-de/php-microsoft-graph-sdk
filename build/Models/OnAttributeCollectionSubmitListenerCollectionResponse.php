...
/**
 * Collection response for OnAttributeCollectionSubmitListener
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnAttributeCollectionSubmitListenerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnAttributeCollectionSubmitListener[]
     */
    private array $value = [];
     ...
     * 
     * @param OnAttributeCollectionSubmitListener[] $items
     * @return self
     */
    public function setValue(array|OnAttributeCollectionSubmitListener $items, OnAttributeCollectionSubmitListener ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnAttributeCollectionSubmitListener> $value
     * @return self
     ...
     * 
     * @param OnAttributeCollectionSubmitListener $item
     * @return self
     */
    public function addValue(OnAttributeCollectionSubmitListener $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OnAttributeCollectionSubmitListener|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OnAttributeCollectionSubmitListener>
     */
