...
/**
 * OnAttributeCollectionSubmitListenerCollectionResponse - Collection response
 */
class OnAttributeCollectionSubmitListenerCollectionResponse
{
    /**
     * @var array<int, OnAttributeCollectionSubmitListener>
     */
    public array $value = [];
