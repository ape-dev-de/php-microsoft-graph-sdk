...
/**
 * Collection response for AppleDeviceFeaturesConfigurationBase
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AppleDeviceFeaturesConfigurationBaseCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AppleDeviceFeaturesConfigurationBase[]
     */
    private array $value = [];
     ...
     * 
     * @param AppleDeviceFeaturesConfigurationBase[] $items
     * @return self
     */
    public function setValue(array|AppleDeviceFeaturesConfigurationBase $items, AppleDeviceFeaturesConfigurationBase ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AppleDeviceFeaturesConfigurationBase> $value
     * @return self
     ...
     * 
     * @param AppleDeviceFeaturesConfigurationBase $item
     * @return self
     */
    public function addValue(AppleDeviceFeaturesConfigurationBase $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AppleDeviceFeaturesConfigurationBase|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AppleDeviceFeaturesConfigurationBase>
     */
