...
/**
 * Collection response for ComplianceManagementPartnerCollectionResponse
 */
class ComplianceManagementPartnerCollectionResponseCollectionResponse
{
    /**
     * @var ComplianceManagementPartnerCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ComplianceManagementPartnerCollectionResponse ...$items Variable number of ComplianceManagementPartnerCollectionResponse items
     * @return self
     */
    public function setValue(ComplianceManagementPartnerCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ComplianceManagementPartnerCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ComplianceManagementPartnerCollectionResponse $item
     * @return self
     */
    public function addValue(ComplianceManagementPartnerCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
