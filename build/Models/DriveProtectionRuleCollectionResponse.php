...
/**
 * Collection response for DriveProtectionRule
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DriveProtectionRuleCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param DriveProtectionRule[] $items
     * @return self
     */
    public function setValue(array|DriveProtectionRule $items, DriveProtectionRule ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DriveProtectionRule> $value
     * @return self
     ...
     * 
     * @param DriveProtectionRule $item
     * @return self
     */
    public function addValue(DriveProtectionRule $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DriveProtectionRule>
     */
