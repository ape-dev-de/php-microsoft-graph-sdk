...
/**
 * Collection response for ChannelCollectionResponse
 */
class ChannelCollectionResponseCollectionResponse
{
    /**
     * @var ChannelCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ChannelCollectionResponse ...$items Variable number of ChannelCollectionResponse items
     * @return self
     */
    public function setValue(ChannelCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ChannelCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ChannelCollectionResponse $item
     * @return self
     */
    public function addValue(ChannelCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
