...
/**
 * Collection response for CloudPcAuditPropertyCollectionResponse
 */
class CloudPcAuditPropertyCollectionResponseCollectionResponse
{
    /**
     * @var CloudPcAuditPropertyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CloudPcAuditPropertyCollectionResponse ...$items Variable number of CloudPcAuditPropertyCollectionResponse items
     * @return self
     */
    public function setValue(CloudPcAuditPropertyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CloudPcAuditPropertyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CloudPcAuditPropertyCollectionResponse $item
     * @return self
     */
    public function addValue(CloudPcAuditPropertyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
