...
/**
 * Collection response for IosMobileAppConfigurationCollectionResponse
 */
class IosMobileAppConfigurationCollectionResponseCollectionResponse
{
    /**
     * @var IosMobileAppConfigurationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IosMobileAppConfigurationCollectionResponse ...$items Variable number of IosMobileAppConfigurationCollectionResponse items
     * @return self
     */
    public function setValue(IosMobileAppConfigurationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IosMobileAppConfigurationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IosMobileAppConfigurationCollectionResponse $item
     * @return self
     */
    public function addValue(IosMobileAppConfigurationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
