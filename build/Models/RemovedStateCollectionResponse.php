...
/**
 * Collection response for RemovedState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RemovedStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RemovedState[]
     */
     ...
     * 
     * @param RemovedState[] $items
     * @return self
     */
    public function setValue(array|RemovedState $items, RemovedState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RemovedState> $value
     * @return self
     ...
     * 
     * @param RemovedState $item
     * @return self
     */
    public function addValue(RemovedState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RemovedState>
     */
