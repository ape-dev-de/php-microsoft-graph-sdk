...
/**
 * Collection response for CallRouteCollectionResponse
 */
class CallRouteCollectionResponseCollectionResponse
{
    /**
     * @var CallRouteCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param CallRouteCollectionResponse ...$items Variable number of CallRouteCollectionResponse items
     * @return self
     */
    public function setValue(CallRouteCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<CallRouteCollectionResponse> $value
     * @return self
     ...
     * 
     * @param CallRouteCollectionResponse $item
     * @return self
     */
    public function addValue(CallRouteCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
