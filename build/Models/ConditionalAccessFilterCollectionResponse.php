...
/**
 * Collection response for ConditionalAccessFilter
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ConditionalAccessFilterCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ConditionalAccessFilter[]
     */
    private array $value = [];
     ...
     * 
     * @param ConditionalAccessFilter[] $items
     * @return self
     */
    public function setValue(array|ConditionalAccessFilter $items, ConditionalAccessFilter ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ConditionalAccessFilter> $value
     * @return self
     ...
     * 
     * @param ConditionalAccessFilter $item
     * @return self
     */
    public function addValue(ConditionalAccessFilter $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ConditionalAccessFilter>
     */
