 ...
 */
class ConditionalAccessFilterCollectionResponse
{
    /**
     ...
     * 
     * @param ConditionalAccessFilter ...$items Variable number of ConditionalAccessFilter items
     * @return self
     */
    public function setValue(ConditionalAccessFilter ...$items): self
    {
        $this->value = $items;
        return $this;
    }
