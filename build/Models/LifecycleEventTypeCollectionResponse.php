...
/**
 * Collection response for LifecycleEventType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LifecycleEventTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param LifecycleEventType[] $items
     * @return self
     */
    public function setValue(array|LifecycleEventType $items, LifecycleEventType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<LifecycleEventType> $value
     * @return self
     ...
     * 
     * @param LifecycleEventType $item
     * @return self
     */
    public function addValue(LifecycleEventType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LifecycleEventType>
     */
