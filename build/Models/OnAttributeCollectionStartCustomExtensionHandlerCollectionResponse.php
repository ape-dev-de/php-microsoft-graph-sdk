 ...
 */
class OnAttributeCollectionStartCustomExtensionHandlerCollectionResponse
{
    /**
     ...
     * 
     * @param OnAttributeCollectionStartCustomExtensionHandler ...$items Variable number of OnAttributeCollectionStartCustomExtensionHandler items
     * @return self
     */
    public function setValue(OnAttributeCollectionStartCustomExtensionHandler ...$items): self
    {
        $this->value = $items;
        return $this;
    }
