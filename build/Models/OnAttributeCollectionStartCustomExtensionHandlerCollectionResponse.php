...
/**
 * Collection response for OnAttributeCollectionStartCustomExtensionHandler
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OnAttributeCollectionStartCustomExtensionHandlerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OnAttributeCollectionStartCustomExtensionHandler[]
     */
    private array $value = [];
     ...
     * 
     * @param OnAttributeCollectionStartCustomExtensionHandler[] $items
     * @return self
     */
    public function setValue(array|OnAttributeCollectionStartCustomExtensionHandler $items, OnAttributeCollectionStartCustomExtensionHandler ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OnAttributeCollectionStartCustomExtensionHandler> $value
     * @return self
     ...
     * 
     * @param OnAttributeCollectionStartCustomExtensionHandler $item
     * @return self
     */
    public function addValue(OnAttributeCollectionStartCustomExtensionHandler $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return OnAttributeCollectionStartCustomExtensionHandler|null
     */
     ...
     * 
     * @return \ArrayIterator<int, OnAttributeCollectionStartCustomExtensionHandler>
     */
