...
/**
 * AccessReviewExpirationBehaviorCollectionResponse - Collection response
 */
class AccessReviewExpirationBehaviorCollectionResponse
{
    /**
     * @var array<int, AccessReviewExpirationBehavior>
     */
    public array $value = [];
