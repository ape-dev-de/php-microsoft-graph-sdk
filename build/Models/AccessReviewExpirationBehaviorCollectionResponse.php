...
/**
 * Collection response for AccessReviewExpirationBehavior
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessReviewExpirationBehaviorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessReviewExpirationBehavior[]
     */
    private array $value = [];
     ...
     * 
     * @return AccessReviewExpirationBehavior[]
     */
     ...
     * 
     * @param AccessReviewExpirationBehavior[] $items
     * @return self
     */
    public function setValue(array|AccessReviewExpirationBehavior $items, AccessReviewExpirationBehavior ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessReviewExpirationBehavior> $value
     * @return self
     ...
     * 
     * @param AccessReviewExpirationBehavior $item
     * @return self
     */
    public function addValue(AccessReviewExpirationBehavior $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessReviewExpirationBehavior>
     */
