...
/**
 * Collection response for FilterGroupCollectionResponse
 */
class FilterGroupCollectionResponseCollectionResponse
{
    /**
     * @var FilterGroupCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param FilterGroupCollectionResponse ...$items Variable number of FilterGroupCollectionResponse items
     * @return self
     */
    public function setValue(FilterGroupCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<FilterGroupCollectionResponse> $value
     * @return self
     ...
     * 
     * @param FilterGroupCollectionResponse $item
     * @return self
     */
    public function addValue(FilterGroupCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
