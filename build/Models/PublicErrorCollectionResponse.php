...
/**
 * Collection response for PublicError
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PublicErrorCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PublicError[]
     */
     ...
     * 
     * @param PublicError[] $items
     * @return self
     */
    public function setValue(array|PublicError $items, PublicError ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param PublicError $item
     * @return self
     */
    public function addValue(PublicError $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PublicError>
     */
