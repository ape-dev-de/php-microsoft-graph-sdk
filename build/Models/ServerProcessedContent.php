...
class ServerProcessedContent
{
     ...
     */
    private ?string $searchablePlainTexts;
    ...
    public function getSearchablePlainTexts(): ?string
    {
        return $this->searchablePlainTexts;
    }

    public function setSearchablePlainTexts(?string $searchablePlainTexts): self
    {
