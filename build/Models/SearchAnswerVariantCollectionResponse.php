...
/**
 * Collection response for SearchAnswerVariant
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SearchAnswerVariantCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SearchAnswerVariant[] $items
     * @return self
     */
    public function setValue(array|SearchAnswerVariant $items, SearchAnswerVariant ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SearchAnswerVariant> $value
     * @return self
     ...
     * 
     * @param SearchAnswerVariant $item
     * @return self
     */
    public function addValue(SearchAnswerVariant $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SearchAnswerVariant|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SearchAnswerVariant>
     */
