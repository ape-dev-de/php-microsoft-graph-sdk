...
/**
 * Collection response for AccessPackageRequestState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageRequestStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageRequestState[]
     */
    private array $value = [];
     ...
     * 
     * @return AccessPackageRequestState[]
     */
     ...
     * 
     * @param AccessPackageRequestState[] $items
     * @return self
     */
    public function setValue(array|AccessPackageRequestState $items, AccessPackageRequestState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageRequestState> $value
     * @return self
     ...
     * 
     * @param AccessPackageRequestState $item
     * @return self
     */
    public function addValue(AccessPackageRequestState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageRequestState>
     */
