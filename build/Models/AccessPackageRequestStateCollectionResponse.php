...
/**
 * AccessPackageRequestStateCollectionResponse - Collection response
 */
class AccessPackageRequestStateCollectionResponse
{
    /**
     * @var array<int, AccessPackageRequestState>
     */
    public array $value = [];
