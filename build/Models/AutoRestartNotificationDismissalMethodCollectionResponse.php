...
/**
 * AutoRestartNotificationDismissalMethodCollectionResponse - Collection response
 */
class AutoRestartNotificationDismissalMethodCollectionResponse
{
    /**
     * @var array<int, AutoRestartNotificationDismissalMethod>
     */
    public array $value = [];
