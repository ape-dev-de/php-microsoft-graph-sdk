...
/**
 * Collection response for AutoRestartNotificationDismissalMethod
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AutoRestartNotificationDismissalMethodCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AutoRestartNotificationDismissalMethod[]
     */
    private array $value = [];
     ...
     * 
     * @return AutoRestartNotificationDismissalMethod[]
     */
     ...
     * 
     * @param AutoRestartNotificationDismissalMethod[] $items
     * @return self
     */
    public function setValue(array|AutoRestartNotificationDismissalMethod $items, AutoRestartNotificationDismissalMethod ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AutoRestartNotificationDismissalMethod> $value
     * @return self
     ...
     * 
     * @param AutoRestartNotificationDismissalMethod $item
     * @return self
     */
    public function addValue(AutoRestartNotificationDismissalMethod $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AutoRestartNotificationDismissalMethod>
     */
