...
/**
 * Collection response for WindowsDeviceType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsDeviceTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsDeviceType[]
     */
    private array $value = [];
     ...
     * 
     * @param WindowsDeviceType[] $items
     * @return self
     */
    public function setValue(array|WindowsDeviceType $items, WindowsDeviceType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsDeviceType> $value
     * @return self
     ...
     * 
     * @param WindowsDeviceType $item
     * @return self
     */
    public function addValue(WindowsDeviceType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsDeviceType>
     */
