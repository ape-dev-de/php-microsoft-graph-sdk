...
/**
 * Collection response for DefaultUserRolePermissions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DefaultUserRolePermissionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DefaultUserRolePermissions[]
     */
    private array $value = [];
     ...
     * 
     * @param DefaultUserRolePermissions[] $items
     * @return self
     */
    public function setValue(array|DefaultUserRolePermissions $items, DefaultUserRolePermissions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DefaultUserRolePermissions> $value
     * @return self
     ...
     * 
     * @param DefaultUserRolePermissions $item
     * @return self
     */
    public function addValue(DefaultUserRolePermissions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DefaultUserRolePermissions>
     */
