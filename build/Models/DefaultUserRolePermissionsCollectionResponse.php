 ...
 */
class DefaultUserRolePermissionsCollectionResponse
{
    /**
     ...
     * 
     * @param DefaultUserRolePermissions ...$items Variable number of DefaultUserRolePermissions items
     * @return self
     */
    public function setValue(DefaultUserRolePermissions ...$items): self
    {
        $this->value = $items;
        return $this;
    }
