...
/**
 * Collection response for ExternalConnectorsExternalActivityCollectionResponse
 */
class ExternalConnectorsExternalActivityCollectionResponseCollectionResponse
{
    /**
     * @var ExternalConnectorsExternalActivityCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ExternalConnectorsExternalActivityCollectionResponse ...$items Variable number of ExternalConnectorsExternalActivityCollectionResponse items
     * @return self
     */
    public function setValue(ExternalConnectorsExternalActivityCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ExternalConnectorsExternalActivityCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ExternalConnectorsExternalActivityCollectionResponse $item
     * @return self
     */
    public function addValue(ExternalConnectorsExternalActivityCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
