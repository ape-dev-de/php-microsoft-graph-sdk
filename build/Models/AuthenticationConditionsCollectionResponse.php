 ...
 */
class AuthenticationConditionsCollectionResponse
{
    /**
     ...
     * 
     * @param AuthenticationConditions ...$items Variable number of AuthenticationConditions items
     * @return self
     */
    public function setValue(AuthenticationConditions ...$items): self
    {
        $this->value = $items;
        return $this;
    }
