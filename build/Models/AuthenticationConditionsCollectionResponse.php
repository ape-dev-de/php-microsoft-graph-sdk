...
/**
 * Collection response for AuthenticationConditions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationConditionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AuthenticationConditions[] $items
     * @return self
     */
    public function setValue(array|AuthenticationConditions $items, AuthenticationConditions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationConditions> $value
     * @return self
     ...
     * 
     * @param AuthenticationConditions $item
     * @return self
     */
    public function addValue(AuthenticationConditions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationConditions>
     */
