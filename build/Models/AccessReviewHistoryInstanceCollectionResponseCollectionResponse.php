...
/**
 * Collection response for AccessReviewHistoryInstanceCollectionResponse
 */
class AccessReviewHistoryInstanceCollectionResponseCollectionResponse
{
    /**
     * @var AccessReviewHistoryInstanceCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessReviewHistoryInstanceCollectionResponse ...$items Variable number of AccessReviewHistoryInstanceCollectionResponse items
     * @return self
     */
    public function setValue(AccessReviewHistoryInstanceCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AccessReviewHistoryInstanceCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AccessReviewHistoryInstanceCollectionResponse $item
     * @return self
     */
    public function addValue(AccessReviewHistoryInstanceCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
