...
/**
 * Collection response for EducationPowerPointResource
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EducationPowerPointResourceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var EducationPowerPointResource[]
     */
    private array $value = [];
     ...
     * 
     * @param EducationPowerPointResource[] $items
     * @return self
     */
    public function setValue(array|EducationPowerPointResource $items, EducationPowerPointResource ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<EducationPowerPointResource> $value
     * @return self
     ...
     * 
     * @param EducationPowerPointResource $item
     * @return self
     */
    public function addValue(EducationPowerPointResource $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return EducationPowerPointResource|null
     */
     ...
     * 
     * @return \ArrayIterator<int, EducationPowerPointResource>
     */
