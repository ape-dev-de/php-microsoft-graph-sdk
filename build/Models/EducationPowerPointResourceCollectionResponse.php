 ...
 */
class EducationPowerPointResourceCollectionResponse
{
    /**
     ...
     * 
     * @param EducationPowerPointResource ...$items Variable number of EducationPowerPointResource items
     * @return self
     */
    public function setValue(EducationPowerPointResource ...$items): self
    {
        $this->value = $items;
        return $this;
    }
