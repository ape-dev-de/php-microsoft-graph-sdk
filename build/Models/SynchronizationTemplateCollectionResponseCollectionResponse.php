...
/**
 * Collection response for SynchronizationTemplateCollectionResponse
 */
class SynchronizationTemplateCollectionResponseCollectionResponse
{
    /**
     * @var SynchronizationTemplateCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SynchronizationTemplateCollectionResponse ...$items Variable number of SynchronizationTemplateCollectionResponse items
     * @return self
     */
    public function setValue(SynchronizationTemplateCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SynchronizationTemplateCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SynchronizationTemplateCollectionResponse $item
     * @return self
     */
    public function addValue(SynchronizationTemplateCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
