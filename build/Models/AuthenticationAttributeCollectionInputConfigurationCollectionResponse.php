...
/**
 * AuthenticationAttributeCollectionInputConfigurationCollectionResponse - Collection response
 */
class AuthenticationAttributeCollectionInputConfigurationCollectionResponse
{
    /**
     * @var array<int, AuthenticationAttributeCollectionInputConfiguration>
     */
    public array $value = [];
