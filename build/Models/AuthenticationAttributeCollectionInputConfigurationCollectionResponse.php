...
/**
 * Collection response for AuthenticationAttributeCollectionInputConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AuthenticationAttributeCollectionInputConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AuthenticationAttributeCollectionInputConfiguration[] $items
     * @return self
     */
    public function setValue(array|AuthenticationAttributeCollectionInputConfiguration $items, AuthenticationAttributeCollectionInputConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AuthenticationAttributeCollectionInputConfiguration> $value
     * @return self
     ...
     * 
     * @param AuthenticationAttributeCollectionInputConfiguration $item
     * @return self
     */
    public function addValue(AuthenticationAttributeCollectionInputConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AuthenticationAttributeCollectionInputConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AuthenticationAttributeCollectionInputConfiguration>
     */
