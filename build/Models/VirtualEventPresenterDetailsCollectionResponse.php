...
/**
 * Collection response for VirtualEventPresenterDetails
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualEventPresenterDetailsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var VirtualEventPresenterDetails[]
     */
    private array $value = [];
     ...
     * 
     * @param VirtualEventPresenterDetails[] $items
     * @return self
     */
    public function setValue(array|VirtualEventPresenterDetails $items, VirtualEventPresenterDetails ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualEventPresenterDetails> $value
     * @return self
     ...
     * 
     * @param VirtualEventPresenterDetails $item
     * @return self
     */
    public function addValue(VirtualEventPresenterDetails $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, VirtualEventPresenterDetails>
     */
