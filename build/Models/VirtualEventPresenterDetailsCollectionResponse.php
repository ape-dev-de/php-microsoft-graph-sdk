 ...
 */
class VirtualEventPresenterDetailsCollectionResponse
{
    /**
     ...
     * 
     * @param VirtualEventPresenterDetails ...$items Variable number of VirtualEventPresenterDetails items
     * @return self
     */
    public function setValue(VirtualEventPresenterDetails ...$items): self
    {
        $this->value = $items;
        return $this;
    }
