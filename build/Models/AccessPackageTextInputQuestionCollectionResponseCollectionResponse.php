...
/**
 * Collection response for AccessPackageTextInputQuestionCollectionResponse
 */
class AccessPackageTextInputQuestionCollectionResponseCollectionResponse
{
    /**
     * @var AccessPackageTextInputQuestionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AccessPackageTextInputQuestionCollectionResponse ...$items Variable number of AccessPackageTextInputQuestionCollectionResponse items
     * @return self
     */
    public function setValue(AccessPackageTextInputQuestionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AccessPackageTextInputQuestionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AccessPackageTextInputQuestionCollectionResponse $item
     * @return self
     */
    public function addValue(AccessPackageTextInputQuestionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
