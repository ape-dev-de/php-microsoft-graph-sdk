...
/**
 * Collection response for ReferenceAttachment
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ReferenceAttachmentCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ReferenceAttachment[]
     */
    private array $value = [];
     ...
     * 
     * @param ReferenceAttachment[] $items
     * @return self
     */
    public function setValue(array|ReferenceAttachment $items, ReferenceAttachment ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ReferenceAttachment> $value
     * @return self
     ...
     * 
     * @param ReferenceAttachment $item
     * @return self
     */
    public function addValue(ReferenceAttachment $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ReferenceAttachment|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ReferenceAttachment>
     */
