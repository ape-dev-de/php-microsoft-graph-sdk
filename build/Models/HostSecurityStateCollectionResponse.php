...
/**
 * Collection response for HostSecurityState
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class HostSecurityStateCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var HostSecurityState[]
     */
    private array $value = [];
     ...
     * 
     * @param HostSecurityState[] $items
     * @return self
     */
    public function setValue(array|HostSecurityState $items, HostSecurityState ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<HostSecurityState> $value
     * @return self
     ...
     * 
     * @param HostSecurityState $item
     * @return self
     */
    public function addValue(HostSecurityState $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, HostSecurityState>
     */
