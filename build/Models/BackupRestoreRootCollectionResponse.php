 ...
 */
class BackupRestoreRootCollectionResponse
{
    /**
     ...
     * 
     * @param BackupRestoreRoot ...$items Variable number of BackupRestoreRoot items
     * @return self
     */
    public function setValue(BackupRestoreRoot ...$items): self
    {
        $this->value = $items;
        return $this;
    }
