...
/**
 * Collection response for BackupRestoreRoot
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BackupRestoreRootCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BackupRestoreRoot[]
     */
    private array $value = [];
     ...
     * 
     * @param BackupRestoreRoot[] $items
     * @return self
     */
    public function setValue(array|BackupRestoreRoot $items, BackupRestoreRoot ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BackupRestoreRoot> $value
     * @return self
     ...
     * 
     * @param BackupRestoreRoot $item
     * @return self
     */
    public function addValue(BackupRestoreRoot $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BackupRestoreRoot>
     */
