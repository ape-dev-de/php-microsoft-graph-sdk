...
/**
 * Collection response for MailTips
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class MailTipsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var MailTips[]
     */
     ...
     * 
     * @param MailTips[] $items
     * @return self
     */
    public function setValue(array|MailTips $items, MailTips ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(MailTips $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, MailTips>
     */
