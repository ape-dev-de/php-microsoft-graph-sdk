...
/**
 * Collection response for ManagedAppPinCharacterSet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedAppPinCharacterSetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ManagedAppPinCharacterSet[]
     */
    private array $value = [];
     ...
     * 
     * @return ManagedAppPinCharacterSet[]
     */
     ...
     * 
     * @param ManagedAppPinCharacterSet[] $items
     * @return self
     */
    public function setValue(array|ManagedAppPinCharacterSet $items, ManagedAppPinCharacterSet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedAppPinCharacterSet> $value
     * @return self
     ...
     * 
     * @param ManagedAppPinCharacterSet $item
     * @return self
     */
    public function addValue(ManagedAppPinCharacterSet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedAppPinCharacterSet>
     */
