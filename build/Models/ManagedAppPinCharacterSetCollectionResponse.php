...
/**
 * ManagedAppPinCharacterSetCollectionResponse - Collection response
 */
class ManagedAppPinCharacterSetCollectionResponse
{
    /**
     * @var array<int, ManagedAppPinCharacterSet>
     */
    public array $value = [];
