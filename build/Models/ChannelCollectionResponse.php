...
/**
 * Collection response for Channel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChannelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Channel[]
     */
     ...
     * @return self
     */
    public function setValue(array|Channel $items, Channel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Channel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Channel>
     */
