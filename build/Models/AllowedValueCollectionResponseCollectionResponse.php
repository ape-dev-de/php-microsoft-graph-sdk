...
/**
 * Collection response for AllowedValueCollectionResponse
 */
class AllowedValueCollectionResponseCollectionResponse
{
    /**
     * @var AllowedValueCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AllowedValueCollectionResponse ...$items Variable number of AllowedValueCollectionResponse items
     * @return self
     */
    public function setValue(AllowedValueCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AllowedValueCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AllowedValueCollectionResponse $item
     * @return self
     */
    public function addValue(AllowedValueCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
