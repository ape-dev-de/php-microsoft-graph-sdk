...
/**
 * TenantProtectionScopeContainerCollectionResponse - Collection response
 */
class TenantProtectionScopeContainerCollectionResponse
{
    /**
     * @var array<int, TenantProtectionScopeContainer>
     */
    public array $value = [];
