...
/**
 * Collection response for TenantProtectionScopeContainer
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TenantProtectionScopeContainerCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var TenantProtectionScopeContainer[]
     */
    private array $value = [];
     ...
     * 
     * @param TenantProtectionScopeContainer[] $items
     * @return self
     */
    public function setValue(array|TenantProtectionScopeContainer $items, TenantProtectionScopeContainer ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TenantProtectionScopeContainer> $value
     * @return self
     ...
     * 
     * @param TenantProtectionScopeContainer $item
     * @return self
     */
    public function addValue(TenantProtectionScopeContainer $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TenantProtectionScopeContainer>
     */
