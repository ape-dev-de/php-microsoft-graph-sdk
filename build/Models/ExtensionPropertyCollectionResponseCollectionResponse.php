...
/**
 * Collection response for ExtensionPropertyCollectionResponse
 */
class ExtensionPropertyCollectionResponseCollectionResponse
{
    /**
     * @var ExtensionPropertyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ExtensionPropertyCollectionResponse ...$items Variable number of ExtensionPropertyCollectionResponse items
     * @return self
     */
    public function setValue(ExtensionPropertyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ExtensionPropertyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ExtensionPropertyCollectionResponse $item
     * @return self
     */
    public function addValue(ExtensionPropertyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
