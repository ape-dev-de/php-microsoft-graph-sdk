...
/**
 * Collection response for SynchronizationJobSubject
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SynchronizationJobSubjectCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SynchronizationJobSubject[] $items
     * @return self
     */
    public function setValue(array|SynchronizationJobSubject $items, SynchronizationJobSubject ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SynchronizationJobSubject> $value
     * @return self
     ...
     * 
     * @param SynchronizationJobSubject $item
     * @return self
     */
    public function addValue(SynchronizationJobSubject $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SynchronizationJobSubject>
     */
