...
/**
 * Collection response for Photo
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PhotoCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Photo[]
     */
     ...
     * @return self
     */
    public function setValue(array|Photo $items, Photo ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Photo $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Photo>
     */
