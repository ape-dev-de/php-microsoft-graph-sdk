...
/**
 * Collection response for AttributeMappingCollectionResponse
 */
class AttributeMappingCollectionResponseCollectionResponse
{
    /**
     * @var AttributeMappingCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AttributeMappingCollectionResponse ...$items Variable number of AttributeMappingCollectionResponse items
     * @return self
     */
    public function setValue(AttributeMappingCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AttributeMappingCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AttributeMappingCollectionResponse $item
     * @return self
     */
    public function addValue(AttributeMappingCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
