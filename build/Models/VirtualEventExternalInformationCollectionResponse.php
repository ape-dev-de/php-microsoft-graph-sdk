...
/**
 * Collection response for VirtualEventExternalInformation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class VirtualEventExternalInformationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param VirtualEventExternalInformation[] $items
     * @return self
     */
    public function setValue(array|VirtualEventExternalInformation $items, VirtualEventExternalInformation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<VirtualEventExternalInformation> $value
     * @return self
     ...
     * 
     * @param VirtualEventExternalInformation $item
     * @return self
     */
    public function addValue(VirtualEventExternalInformation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return VirtualEventExternalInformation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, VirtualEventExternalInformation>
     */
