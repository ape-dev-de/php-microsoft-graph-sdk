...
/**
 * Collection response for WindowsUpdateNotificationDisplayOption
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WindowsUpdateNotificationDisplayOptionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WindowsUpdateNotificationDisplayOption[]
     */
    private array $value = [];
     ...
     * 
     * @return WindowsUpdateNotificationDisplayOption[]
     */
     ...
     * 
     * @param WindowsUpdateNotificationDisplayOption[] $items
     * @return self
     */
    public function setValue(array|WindowsUpdateNotificationDisplayOption $items, WindowsUpdateNotificationDisplayOption ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WindowsUpdateNotificationDisplayOption> $value
     * @return self
     ...
     * 
     * @param WindowsUpdateNotificationDisplayOption $item
     * @return self
     */
    public function addValue(WindowsUpdateNotificationDisplayOption $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WindowsUpdateNotificationDisplayOption>
     */
