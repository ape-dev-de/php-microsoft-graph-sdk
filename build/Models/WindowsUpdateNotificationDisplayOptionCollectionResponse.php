...
/**
 * WindowsUpdateNotificationDisplayOptionCollectionResponse - Collection response
 */
class WindowsUpdateNotificationDisplayOptionCollectionResponse
{
    /**
     * @var array<int, WindowsUpdateNotificationDisplayOption>
     */
    public array $value = [];
