...
/**
 * Collection response for AttendanceInterval
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AttendanceIntervalCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param AttendanceInterval[] $items
     * @return self
     */
    public function setValue(array|AttendanceInterval $items, AttendanceInterval ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AttendanceInterval> $value
     * @return self
     ...
     * 
     * @param AttendanceInterval $item
     * @return self
     */
    public function addValue(AttendanceInterval $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AttendanceInterval|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AttendanceInterval>
     */
