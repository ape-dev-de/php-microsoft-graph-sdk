...
/**
 * Collection response for SecurityAdditionalDataOptions
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityAdditionalDataOptionsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityAdditionalDataOptions[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityAdditionalDataOptions[]
     */
     ...
     * 
     * @param SecurityAdditionalDataOptions[] $items
     * @return self
     */
    public function setValue(array|SecurityAdditionalDataOptions $items, SecurityAdditionalDataOptions ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityAdditionalDataOptions> $value
     * @return self
     ...
     * 
     * @param SecurityAdditionalDataOptions $item
     * @return self
     */
    public function addValue(SecurityAdditionalDataOptions $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityAdditionalDataOptions|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityAdditionalDataOptions>
     */
