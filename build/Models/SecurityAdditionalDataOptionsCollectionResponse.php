...
/**
 * SecurityAdditionalDataOptionsCollectionResponse - Collection response
 */
class SecurityAdditionalDataOptionsCollectionResponse
{
    /**
     * @var array<int, SecurityAdditionalDataOptions>
     */
    public array $value = [];
