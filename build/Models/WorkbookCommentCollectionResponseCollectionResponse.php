...
/**
 * Collection response for WorkbookCommentCollectionResponse
 */
class WorkbookCommentCollectionResponseCollectionResponse
{
    /**
     * @var WorkbookCommentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookCommentCollectionResponse ...$items Variable number of WorkbookCommentCollectionResponse items
     * @return self
     */
    public function setValue(WorkbookCommentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<WorkbookCommentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param WorkbookCommentCollectionResponse $item
     * @return self
     */
    public function addValue(WorkbookCommentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
