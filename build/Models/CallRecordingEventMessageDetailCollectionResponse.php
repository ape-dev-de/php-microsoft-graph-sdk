...
/**
 * Collection response for CallRecordingEventMessageDetail
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CallRecordingEventMessageDetailCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CallRecordingEventMessageDetail[]
     */
    private array $value = [];
     ...
     * 
     * @param CallRecordingEventMessageDetail[] $items
     * @return self
     */
    public function setValue(array|CallRecordingEventMessageDetail $items, CallRecordingEventMessageDetail ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CallRecordingEventMessageDetail> $value
     * @return self
     ...
     * 
     * @param CallRecordingEventMessageDetail $item
     * @return self
     */
    public function addValue(CallRecordingEventMessageDetail $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return CallRecordingEventMessageDetail|null
     */
     ...
     * 
     * @return \ArrayIterator<int, CallRecordingEventMessageDetail>
     */
