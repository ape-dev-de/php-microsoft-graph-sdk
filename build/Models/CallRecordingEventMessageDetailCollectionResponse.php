 ...
 */
class CallRecordingEventMessageDetailCollectionResponse
{
    /**
     ...
     * 
     * @param CallRecordingEventMessageDetail ...$items Variable number of CallRecordingEventMessageDetail items
     * @return self
     */
    public function setValue(CallRecordingEventMessageDetail ...$items): self
    {
        $this->value = $items;
        return $this;
    }
