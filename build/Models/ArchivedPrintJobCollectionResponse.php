 ...
 */
class ArchivedPrintJobCollectionResponse
{
    /**
     ...
     * 
     * @param ArchivedPrintJob ...$items Variable number of ArchivedPrintJob items
     * @return self
     */
    public function setValue(ArchivedPrintJob ...$items): self
    {
        $this->value = $items;
        return $this;
    }
