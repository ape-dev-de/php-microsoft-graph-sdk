...
/**
 * Collection response for ArchivedPrintJob
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ArchivedPrintJobCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ArchivedPrintJob[]
     */
    private array $value = [];
     ...
     * 
     * @param ArchivedPrintJob[] $items
     * @return self
     */
    public function setValue(array|ArchivedPrintJob $items, ArchivedPrintJob ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ArchivedPrintJob> $value
     * @return self
     ...
     * 
     * @param ArchivedPrintJob $item
     * @return self
     */
    public function addValue(ArchivedPrintJob $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ArchivedPrintJob>
     */
