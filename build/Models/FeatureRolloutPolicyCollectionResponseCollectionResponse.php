...
/**
 * Collection response for FeatureRolloutPolicyCollectionResponse
 */
class FeatureRolloutPolicyCollectionResponseCollectionResponse
{
    /**
     * @var FeatureRolloutPolicyCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param FeatureRolloutPolicyCollectionResponse ...$items Variable number of FeatureRolloutPolicyCollectionResponse items
     * @return self
     */
    public function setValue(FeatureRolloutPolicyCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<FeatureRolloutPolicyCollectionResponse> $value
     * @return self
     ...
     * 
     * @param FeatureRolloutPolicyCollectionResponse $item
     * @return self
     */
    public function addValue(FeatureRolloutPolicyCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
