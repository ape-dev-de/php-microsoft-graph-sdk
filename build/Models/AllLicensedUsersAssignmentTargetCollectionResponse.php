...
/**
 * AllLicensedUsersAssignmentTargetCollectionResponse - Collection response
 */
class AllLicensedUsersAssignmentTargetCollectionResponse
{
    /**
     * @var array<int, AllLicensedUsersAssignmentTarget>
     */
    public array $value = [];
