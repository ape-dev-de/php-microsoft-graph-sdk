...
/**
 * Collection response for AllLicensedUsersAssignmentTarget
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AllLicensedUsersAssignmentTargetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AllLicensedUsersAssignmentTarget[]
     */
    private array $value = [];
     ...
     * 
     * @param AllLicensedUsersAssignmentTarget[] $items
     * @return self
     */
    public function setValue(array|AllLicensedUsersAssignmentTarget $items, AllLicensedUsersAssignmentTarget ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AllLicensedUsersAssignmentTarget> $value
     * @return self
     ...
     * 
     * @param AllLicensedUsersAssignmentTarget $item
     * @return self
     */
    public function addValue(AllLicensedUsersAssignmentTarget $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AllLicensedUsersAssignmentTarget|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AllLicensedUsersAssignmentTarget>
     */
