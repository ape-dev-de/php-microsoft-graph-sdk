...
/**
 * Collection response for ApplicationType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ApplicationTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ApplicationType[]
     */
     ...
     * 
     * @param ApplicationType[] $items
     * @return self
     */
    public function setValue(array|ApplicationType $items, ApplicationType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ApplicationType> $value
     * @return self
     ...
     * 
     * @param ApplicationType $item
     * @return self
     */
    public function addValue(ApplicationType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ApplicationType>
     */
