...
/**
 * Collection response for ManagedAppDataTransferLevel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedAppDataTransferLevelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ManagedAppDataTransferLevel[]
     */
    private array $value = [];
     ...
     * 
     * @return ManagedAppDataTransferLevel[]
     */
     ...
     * 
     * @param ManagedAppDataTransferLevel[] $items
     * @return self
     */
    public function setValue(array|ManagedAppDataTransferLevel $items, ManagedAppDataTransferLevel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedAppDataTransferLevel> $value
     * @return self
     ...
     * 
     * @param ManagedAppDataTransferLevel $item
     * @return self
     */
    public function addValue(ManagedAppDataTransferLevel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ManagedAppDataTransferLevel>
     */
