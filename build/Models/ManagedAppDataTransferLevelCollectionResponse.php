...
/**
 * ManagedAppDataTransferLevelCollectionResponse - Collection response
 */
class ManagedAppDataTransferLevelCollectionResponse
{
    /**
     * @var array<int, ManagedAppDataTransferLevel>
     */
    public array $value = [];
