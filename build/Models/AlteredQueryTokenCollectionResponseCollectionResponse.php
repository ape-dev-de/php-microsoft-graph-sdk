...
/**
 * Collection response for AlteredQueryTokenCollectionResponse
 */
class AlteredQueryTokenCollectionResponseCollectionResponse
{
    /**
     * @var AlteredQueryTokenCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param AlteredQueryTokenCollectionResponse ...$items Variable number of AlteredQueryTokenCollectionResponse items
     * @return self
     */
    public function setValue(AlteredQueryTokenCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<AlteredQueryTokenCollectionResponse> $value
     * @return self
     ...
     * 
     * @param AlteredQueryTokenCollectionResponse $item
     * @return self
     */
    public function addValue(AlteredQueryTokenCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
