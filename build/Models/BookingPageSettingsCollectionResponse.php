...
/**
 * Collection response for BookingPageSettings
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class BookingPageSettingsCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var BookingPageSettings[]
     */
    private array $value = [];
     ...
     * 
     * @param BookingPageSettings[] $items
     * @return self
     */
    public function setValue(array|BookingPageSettings $items, BookingPageSettings ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<BookingPageSettings> $value
     * @return self
     ...
     * 
     * @param BookingPageSettings $item
     * @return self
     */
    public function addValue(BookingPageSettings $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, BookingPageSettings>
     */
