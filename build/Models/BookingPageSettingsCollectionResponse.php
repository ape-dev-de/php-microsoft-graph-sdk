 ...
 */
class BookingPageSettingsCollectionResponse
{
    /**
     ...
     * 
     * @param BookingPageSettings ...$items Variable number of BookingPageSettings items
     * @return self
     */
    public function setValue(BookingPageSettings ...$items): self
    {
        $this->value = $items;
        return $this;
    }
