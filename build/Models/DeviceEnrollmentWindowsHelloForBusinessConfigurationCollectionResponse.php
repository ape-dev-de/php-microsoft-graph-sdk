...
/**
 * DeviceEnrollmentWindowsHelloForBusinessConfigurationCollectionResponse - Collection response
 */
class DeviceEnrollmentWindowsHelloForBusinessConfigurationCollectionResponse
{
    /**
     * @var array<int, DeviceEnrollmentWindowsHelloForBusinessConfiguration>
     */
    public array $value = [];
