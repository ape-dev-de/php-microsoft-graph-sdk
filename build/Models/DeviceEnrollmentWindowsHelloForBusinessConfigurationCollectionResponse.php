...
/**
 * Collection response for DeviceEnrollmentWindowsHelloForBusinessConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceEnrollmentWindowsHelloForBusinessConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceEnrollmentWindowsHelloForBusinessConfiguration[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceEnrollmentWindowsHelloForBusinessConfiguration[] $items
     * @return self
     */
    public function setValue(array|DeviceEnrollmentWindowsHelloForBusinessConfiguration $items, DeviceEnrollmentWindowsHelloForBusinessConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceEnrollmentWindowsHelloForBusinessConfiguration> $value
     * @return self
     ...
     * 
     * @param DeviceEnrollmentWindowsHelloForBusinessConfiguration $item
     * @return self
     */
    public function addValue(DeviceEnrollmentWindowsHelloForBusinessConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return DeviceEnrollmentWindowsHelloForBusinessConfiguration|null
     */
     ...
     * 
     * @return \ArrayIterator<int, DeviceEnrollmentWindowsHelloForBusinessConfiguration>
     */
