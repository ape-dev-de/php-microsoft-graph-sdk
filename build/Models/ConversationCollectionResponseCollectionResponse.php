...
/**
 * Collection response for ConversationCollectionResponse
 */
class ConversationCollectionResponseCollectionResponse
{
    /**
     * @var ConversationCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ConversationCollectionResponse ...$items Variable number of ConversationCollectionResponse items
     * @return self
     */
    public function setValue(ConversationCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ConversationCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ConversationCollectionResponse $item
     * @return self
     */
    public function addValue(ConversationCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
