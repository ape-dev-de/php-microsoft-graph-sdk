...
/**
 * Collection response for ManagedAppProtection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ManagedAppProtectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ManagedAppProtection[]
     */
    private array $value = [];
     ...
     * 
     * @param ManagedAppProtection[] $items
     * @return self
     */
    public function setValue(array|ManagedAppProtection $items, ManagedAppProtection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ManagedAppProtection> $value
     * @return self
     ...
     * 
     * @param ManagedAppProtection $item
     * @return self
     */
    public function addValue(ManagedAppProtection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ManagedAppProtection|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ManagedAppProtection>
     */
