...
/**
 * Collection response for RenameAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RenameActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RenameAction[]
     */
     ...
     * 
     * @param RenameAction[] $items
     * @return self
     */
    public function setValue(array|RenameAction $items, RenameAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RenameAction> $value
     * @return self
     ...
     * 
     * @param RenameAction $item
     * @return self
     */
    public function addValue(RenameAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RenameAction>
     */
