...
/**
 * Collection response for WorkbookWorksheetProtection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookWorksheetProtectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookWorksheetProtection[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookWorksheetProtection[] $items
     * @return self
     */
    public function setValue(array|WorkbookWorksheetProtection $items, WorkbookWorksheetProtection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookWorksheetProtection> $value
     * @return self
     ...
     * 
     * @param WorkbookWorksheetProtection $item
     * @return self
     */
    public function addValue(WorkbookWorksheetProtection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookWorksheetProtection>
     */
