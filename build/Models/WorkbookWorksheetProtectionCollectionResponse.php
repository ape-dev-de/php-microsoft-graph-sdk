 ...
 */
class WorkbookWorksheetProtectionCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookWorksheetProtection ...$items Variable number of WorkbookWorksheetProtection items
     * @return self
     */
    public function setValue(WorkbookWorksheetProtection ...$items): self
    {
        $this->value = $items;
        return $this;
    }
