...
/**
 * Collection response for UrlAssessmentRequest
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class UrlAssessmentRequestCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var UrlAssessmentRequest[]
     */
    private array $value = [];
     ...
     * 
     * @param UrlAssessmentRequest[] $items
     * @return self
     */
    public function setValue(array|UrlAssessmentRequest $items, UrlAssessmentRequest ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<UrlAssessmentRequest> $value
     * @return self
     ...
     * 
     * @param UrlAssessmentRequest $item
     * @return self
     */
    public function addValue(UrlAssessmentRequest $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return UrlAssessmentRequest|null
     */
     ...
     * 
     * @return \ArrayIterator<int, UrlAssessmentRequest>
     */
