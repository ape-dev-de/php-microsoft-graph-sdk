...
/**
 * Collection response for IdentityUserFlowAttributeAssignmentCollectionResponse
 */
class IdentityUserFlowAttributeAssignmentCollectionResponseCollectionResponse
{
    /**
     * @var IdentityUserFlowAttributeAssignmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentityUserFlowAttributeAssignmentCollectionResponse ...$items Variable number of IdentityUserFlowAttributeAssignmentCollectionResponse items
     * @return self
     */
    public function setValue(IdentityUserFlowAttributeAssignmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IdentityUserFlowAttributeAssignmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IdentityUserFlowAttributeAssignmentCollectionResponse $item
     * @return self
     */
    public function addValue(IdentityUserFlowAttributeAssignmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
