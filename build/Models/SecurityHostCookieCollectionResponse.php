...
/**
 * Collection response for SecurityHostCookie
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHostCookieCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SecurityHostCookie[] $items
     * @return self
     */
    public function setValue(array|SecurityHostCookie $items, SecurityHostCookie ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHostCookie> $value
     * @return self
     ...
     * 
     * @param SecurityHostCookie $item
     * @return self
     */
    public function addValue(SecurityHostCookie $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityHostCookie>
     */
