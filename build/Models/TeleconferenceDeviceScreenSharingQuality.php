...
class TeleconferenceDeviceScreenSharingQuality
{
    ...
    public function __construct(array $data = [])
    {
        ...
        if (isset($data['averageInboundBitRate'])) {
            $this->averageInboundBitRate = $data['averageInboundBitRate'];
        }
        if (isset($data['averageInboundFrameRate'])) {
            $this->averageInboundFrameRate = $data['averageInboundFrameRate'];
        }
        if (isset($data['averageOutboundBitRate'])) {
            $this->averageOutboundBitRate = $data['averageOutboundBitRate'];
        }
        if (isset($data['averageOutboundFrameRate'])) {
            $this->averageOutboundFrameRate = $data['averageOutboundFrameRate'];
        }
    }
