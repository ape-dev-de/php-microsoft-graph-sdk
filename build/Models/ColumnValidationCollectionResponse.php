...
/**
 * Collection response for ColumnValidation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ColumnValidationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param ColumnValidation[] $items
     * @return self
     */
    public function setValue(array|ColumnValidation $items, ColumnValidation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ColumnValidation> $value
     * @return self
     ...
     * 
     * @param ColumnValidation $item
     * @return self
     */
    public function addValue(ColumnValidation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ColumnValidation>
     */
