 ...
 */
class ColumnValidationCollectionResponse
{
    /**
     ...
     * 
     * @param ColumnValidation ...$items Variable number of ColumnValidation items
     * @return self
     */
    public function setValue(ColumnValidation ...$items): self
    {
        $this->value = $items;
        return $this;
    }
