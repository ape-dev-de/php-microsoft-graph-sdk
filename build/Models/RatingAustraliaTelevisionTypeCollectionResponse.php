...
/**
 * Collection response for RatingAustraliaTelevisionType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RatingAustraliaTelevisionTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RatingAustraliaTelevisionType[]
     */
    private array $value = [];
     ...
     * 
     * @return RatingAustraliaTelevisionType[]
     */
     ...
     * 
     * @param RatingAustraliaTelevisionType[] $items
     * @return self
     */
    public function setValue(array|RatingAustraliaTelevisionType $items, RatingAustraliaTelevisionType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RatingAustraliaTelevisionType> $value
     * @return self
     ...
     * 
     * @param RatingAustraliaTelevisionType $item
     * @return self
     */
    public function addValue(RatingAustraliaTelevisionType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RatingAustraliaTelevisionType>
     */
