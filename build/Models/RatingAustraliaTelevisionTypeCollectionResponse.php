...
/**
 * RatingAustraliaTelevisionTypeCollectionResponse - Collection response
 */
class RatingAustraliaTelevisionTypeCollectionResponse
{
    /**
     * @var array<int, RatingAustraliaTelevisionType>
     */
    public array $value = [];
