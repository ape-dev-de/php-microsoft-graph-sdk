...
/**
 * Collection response for SecurityHealthIssueType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHealthIssueTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityHealthIssueType[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityHealthIssueType[]
     */
     ...
     * 
     * @param SecurityHealthIssueType[] $items
     * @return self
     */
    public function setValue(array|SecurityHealthIssueType $items, SecurityHealthIssueType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHealthIssueType> $value
     * @return self
     ...
     * 
     * @param SecurityHealthIssueType $item
     * @return self
     */
    public function addValue(SecurityHealthIssueType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityHealthIssueType|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityHealthIssueType>
     */
