...
/**
 * CloudPcAuditActivityResultCollectionResponse - Collection response
 */
class CloudPcAuditActivityResultCollectionResponse
{
    /**
     * @var array<int, CloudPcAuditActivityResult>
     */
    public array $value = [];
