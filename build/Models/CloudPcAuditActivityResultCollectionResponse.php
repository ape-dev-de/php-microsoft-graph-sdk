...
/**
 * Collection response for CloudPcAuditActivityResult
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class CloudPcAuditActivityResultCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var CloudPcAuditActivityResult[]
     */
    private array $value = [];
     ...
     * 
     * @return CloudPcAuditActivityResult[]
     */
     ...
     * 
     * @param CloudPcAuditActivityResult[] $items
     * @return self
     */
    public function setValue(array|CloudPcAuditActivityResult $items, CloudPcAuditActivityResult ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<CloudPcAuditActivityResult> $value
     * @return self
     ...
     * 
     * @param CloudPcAuditActivityResult $item
     * @return self
     */
    public function addValue(CloudPcAuditActivityResult $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, CloudPcAuditActivityResult>
     */
