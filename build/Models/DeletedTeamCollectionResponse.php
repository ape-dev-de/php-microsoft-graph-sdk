...
/**
 * Collection response for DeletedTeam
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeletedTeamCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeletedTeam[]
     */
     ...
     * 
     * @param DeletedTeam[] $items
     * @return self
     */
    public function setValue(array|DeletedTeam $items, DeletedTeam ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param DeletedTeam $item
     * @return self
     */
    public function addValue(DeletedTeam $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeletedTeam>
     */
