...
/**
 * Collection response for DeviceConfigurationAssignmentCollectionResponse
 */
class DeviceConfigurationAssignmentCollectionResponseCollectionResponse
{
    /**
     * @var DeviceConfigurationAssignmentCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceConfigurationAssignmentCollectionResponse ...$items Variable number of DeviceConfigurationAssignmentCollectionResponse items
     * @return self
     */
    public function setValue(DeviceConfigurationAssignmentCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<DeviceConfigurationAssignmentCollectionResponse> $value
     * @return self
     ...
     * 
     * @param DeviceConfigurationAssignmentCollectionResponse $item
     * @return self
     */
    public function addValue(DeviceConfigurationAssignmentCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
