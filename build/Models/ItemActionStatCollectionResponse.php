...
/**
 * Collection response for ItemActionStat
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ItemActionStatCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ItemActionStat[]
     */
     ...
     * 
     * @param ItemActionStat[] $items
     * @return self
     */
    public function setValue(array|ItemActionStat $items, ItemActionStat ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ItemActionStat> $value
     * @return self
     ...
     * 
     * @param ItemActionStat $item
     * @return self
     */
    public function addValue(ItemActionStat $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ItemActionStat>
     */
