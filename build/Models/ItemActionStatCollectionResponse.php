 ...
 */
class ItemActionStatCollectionResponse
{
    /**
     * @var ItemActionStat[]
     */
     ...
     * 
     * @param ItemActionStat ...$items Variable number of ItemActionStat items
     * @return self
     */
    public function setValue(ItemActionStat ...$items): self
    {
        $this->value = $items;
        return $this;
    }
