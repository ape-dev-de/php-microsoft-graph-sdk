...
class Training
{
    ...
    public function getSupportedLocales(): ?string
    {
        return $this->supportedLocales;
    }

    public function setSupportedLocales(?string $supportedLocales): self
    {
    ...
    public function getLanguageDetails(): ?string
    {
        return $this->languageDetails;
    }

    public function setLanguageDetails(?string $languageDetails): self
    {
