...
/**
 * Collection response for RemoteAssistancePartnerCollectionResponse
 */
class RemoteAssistancePartnerCollectionResponseCollectionResponse
{
    /**
     * @var RemoteAssistancePartnerCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param RemoteAssistancePartnerCollectionResponse ...$items Variable number of RemoteAssistancePartnerCollectionResponse items
     * @return self
     */
    public function setValue(RemoteAssistancePartnerCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<RemoteAssistancePartnerCollectionResponse> $value
     * @return self
     ...
     * 
     * @param RemoteAssistancePartnerCollectionResponse $item
     * @return self
     */
    public function addValue(RemoteAssistancePartnerCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
