 ...
 */
class AgreementFilePropertiesCollectionResponse
{
    /**
     ...
     * 
     * @param AgreementFileProperties ...$items Variable number of AgreementFileProperties items
     * @return self
     */
    public function setValue(AgreementFileProperties ...$items): self
    {
        $this->value = $items;
        return $this;
    }
