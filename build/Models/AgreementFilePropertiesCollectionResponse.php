...
/**
 * Collection response for AgreementFileProperties
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AgreementFilePropertiesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AgreementFileProperties[]
     */
    private array $value = [];
     ...
     * 
     * @param AgreementFileProperties[] $items
     * @return self
     */
    public function setValue(array|AgreementFileProperties $items, AgreementFileProperties ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AgreementFileProperties> $value
     * @return self
     ...
     * 
     * @param AgreementFileProperties $item
     * @return self
     */
    public function addValue(AgreementFileProperties $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return AgreementFileProperties|null
     */
     ...
     * 
     * @return \ArrayIterator<int, AgreementFileProperties>
     */
