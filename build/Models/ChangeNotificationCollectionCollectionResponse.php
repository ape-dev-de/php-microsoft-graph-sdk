 ...
 */
class ChangeNotificationCollectionCollectionResponse
{
    /**
     ...
     * 
     * @param ChangeNotificationCollection ...$items Variable number of ChangeNotificationCollection items
     * @return self
     */
    public function setValue(ChangeNotificationCollection ...$items): self
    {
        $this->value = $items;
        return $this;
    }
