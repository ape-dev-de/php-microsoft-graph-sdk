...
/**
 * Collection response for ChangeNotificationCollection
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ChangeNotificationCollectionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ChangeNotificationCollection[]
     */
    private array $value = [];
     ...
     * 
     * @param ChangeNotificationCollection[] $items
     * @return self
     */
    public function setValue(array|ChangeNotificationCollection $items, ChangeNotificationCollection ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ChangeNotificationCollection> $value
     * @return self
     ...
     * 
     * @param ChangeNotificationCollection $item
     * @return self
     */
    public function addValue(ChangeNotificationCollection $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return ChangeNotificationCollection|null
     */
     ...
     * 
     * @return \ArrayIterator<int, ChangeNotificationCollection>
     */
