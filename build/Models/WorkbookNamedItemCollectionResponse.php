...
/**
 * Collection response for WorkbookNamedItem
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookNamedItemCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param WorkbookNamedItem[] $items
     * @return self
     */
    public function setValue(array|WorkbookNamedItem $items, WorkbookNamedItem ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookNamedItem> $value
     * @return self
     ...
     * 
     * @param WorkbookNamedItem $item
     * @return self
     */
    public function addValue(WorkbookNamedItem $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookNamedItem>
     */
