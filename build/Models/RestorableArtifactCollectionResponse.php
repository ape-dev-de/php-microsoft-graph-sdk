...
/**
 * Collection response for RestorableArtifact
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RestorableArtifactCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RestorableArtifact[]
     */
    private array $value = [];
     ...
     * 
     * @param RestorableArtifact[] $items
     * @return self
     */
    public function setValue(array|RestorableArtifact $items, RestorableArtifact ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RestorableArtifact> $value
     * @return self
     ...
     * 
     * @param RestorableArtifact $item
     * @return self
     */
    public function addValue(RestorableArtifact $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RestorableArtifact>
     */
