...
/**
 * Collection response for ListItemVersionCollectionResponse
 */
class ListItemVersionCollectionResponseCollectionResponse
{
    /**
     * @var ListItemVersionCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param ListItemVersionCollectionResponse ...$items Variable number of ListItemVersionCollectionResponse items
     * @return self
     */
    public function setValue(ListItemVersionCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<ListItemVersionCollectionResponse> $value
     * @return self
     ...
     * 
     * @param ListItemVersionCollectionResponse $item
     * @return self
     */
    public function addValue(ListItemVersionCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
