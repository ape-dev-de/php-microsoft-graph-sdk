...
/**
 * Collection response for IdentitySetCollectionResponse
 */
class IdentitySetCollectionResponseCollectionResponse
{
    /**
     * @var IdentitySetCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param IdentitySetCollectionResponse ...$items Variable number of IdentitySetCollectionResponse items
     * @return self
     */
    public function setValue(IdentitySetCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<IdentitySetCollectionResponse> $value
     * @return self
     ...
     * 
     * @param IdentitySetCollectionResponse $item
     * @return self
     */
    public function addValue(IdentitySetCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
