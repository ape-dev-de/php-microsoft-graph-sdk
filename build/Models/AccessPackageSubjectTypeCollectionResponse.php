...
/**
 * Collection response for AccessPackageSubjectType
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class AccessPackageSubjectTypeCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var AccessPackageSubjectType[]
     */
    private array $value = [];
     ...
     * 
     * @return AccessPackageSubjectType[]
     */
     ...
     * 
     * @param AccessPackageSubjectType[] $items
     * @return self
     */
    public function setValue(array|AccessPackageSubjectType $items, AccessPackageSubjectType ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<AccessPackageSubjectType> $value
     * @return self
     ...
     * 
     * @param AccessPackageSubjectType $item
     * @return self
     */
    public function addValue(AccessPackageSubjectType $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, AccessPackageSubjectType>
     */
