...
/**
 * Collection response for RubricQuality
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RubricQualityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RubricQuality[]
     */
     ...
     * 
     * @param RubricQuality[] $items
     * @return self
     */
    public function setValue(array|RubricQuality $items, RubricQuality ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RubricQuality> $value
     * @return self
     ...
     * 
     * @param RubricQuality $item
     * @return self
     */
    public function addValue(RubricQuality $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RubricQuality>
     */
