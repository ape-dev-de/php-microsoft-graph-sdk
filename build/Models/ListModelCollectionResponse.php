...
/**
 * Collection response for ListModel
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ListModelCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ListModel[]
     */
     ...
     * 
     * @param ListModel[] $items
     * @return self
     */
    public function setValue(array|ListModel $items, ListModel ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param ListModel $item
     * @return self
     */
    public function addValue(ListModel $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ListModel>
     */
