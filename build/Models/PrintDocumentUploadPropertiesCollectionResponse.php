 ...
 */
class PrintDocumentUploadPropertiesCollectionResponse
{
    /**
     ...
     * 
     * @param PrintDocumentUploadProperties ...$items Variable number of PrintDocumentUploadProperties items
     * @return self
     */
    public function setValue(PrintDocumentUploadProperties ...$items): self
    {
        $this->value = $items;
        return $this;
    }
