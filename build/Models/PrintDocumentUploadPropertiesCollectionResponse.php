...
/**
 * Collection response for PrintDocumentUploadProperties
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class PrintDocumentUploadPropertiesCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var PrintDocumentUploadProperties[]
     */
    private array $value = [];
     ...
     * 
     * @param PrintDocumentUploadProperties[] $items
     * @return self
     */
    public function setValue(array|PrintDocumentUploadProperties $items, PrintDocumentUploadProperties ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<PrintDocumentUploadProperties> $value
     * @return self
     ...
     * 
     * @param PrintDocumentUploadProperties $item
     * @return self
     */
    public function addValue(PrintDocumentUploadProperties $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, PrintDocumentUploadProperties>
     */
