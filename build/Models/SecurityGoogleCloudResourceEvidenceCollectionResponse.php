 ...
 */
class SecurityGoogleCloudResourceEvidenceCollectionResponse
{
    /**
     ...
     * 
     * @param SecurityGoogleCloudResourceEvidence ...$items Variable number of SecurityGoogleCloudResourceEvidence items
     * @return self
     */
    public function setValue(SecurityGoogleCloudResourceEvidence ...$items): self
    {
        $this->value = $items;
        return $this;
    }
