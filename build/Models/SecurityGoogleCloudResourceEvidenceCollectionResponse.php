...
/**
 * Collection response for SecurityGoogleCloudResourceEvidence
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityGoogleCloudResourceEvidenceCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityGoogleCloudResourceEvidence[]
     */
    private array $value = [];
     ...
     * 
     * @return SecurityGoogleCloudResourceEvidence[]
     */
     ...
     * 
     * @param SecurityGoogleCloudResourceEvidence[] $items
     * @return self
     */
    public function setValue(array|SecurityGoogleCloudResourceEvidence $items, SecurityGoogleCloudResourceEvidence ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityGoogleCloudResourceEvidence> $value
     * @return self
     ...
     * 
     * @param SecurityGoogleCloudResourceEvidence $item
     * @return self
     */
    public function addValue(SecurityGoogleCloudResourceEvidence $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityGoogleCloudResourceEvidence|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityGoogleCloudResourceEvidence>
     */
