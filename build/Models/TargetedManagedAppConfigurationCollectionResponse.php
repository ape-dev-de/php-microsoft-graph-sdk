...
/**
 * Collection response for TargetedManagedAppConfiguration
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class TargetedManagedAppConfigurationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param TargetedManagedAppConfiguration[] $items
     * @return self
     */
    public function setValue(array|TargetedManagedAppConfiguration $items, TargetedManagedAppConfiguration ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<TargetedManagedAppConfiguration> $value
     * @return self
     ...
     * 
     * @param TargetedManagedAppConfiguration $item
     * @return self
     */
    public function addValue(TargetedManagedAppConfiguration $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, TargetedManagedAppConfiguration>
     */
