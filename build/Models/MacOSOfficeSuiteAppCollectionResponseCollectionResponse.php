...
/**
 * Collection response for MacOSOfficeSuiteAppCollectionResponse
 */
class MacOSOfficeSuiteAppCollectionResponseCollectionResponse
{
    /**
     * @var MacOSOfficeSuiteAppCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MacOSOfficeSuiteAppCollectionResponse ...$items Variable number of MacOSOfficeSuiteAppCollectionResponse items
     * @return self
     */
    public function setValue(MacOSOfficeSuiteAppCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MacOSOfficeSuiteAppCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MacOSOfficeSuiteAppCollectionResponse $item
     * @return self
     */
    public function addValue(MacOSOfficeSuiteAppCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
