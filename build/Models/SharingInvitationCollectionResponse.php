 ...
 */
class SharingInvitationCollectionResponse
{
    /**
     ...
     * 
     * @param SharingInvitation ...$items Variable number of SharingInvitation items
     * @return self
     */
    public function setValue(SharingInvitation ...$items): self
    {
        $this->value = $items;
        return $this;
    }
