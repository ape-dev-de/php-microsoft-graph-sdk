...
/**
 * Collection response for SharingInvitation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SharingInvitationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param SharingInvitation[] $items
     * @return self
     */
    public function setValue(array|SharingInvitation $items, SharingInvitation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SharingInvitation> $value
     * @return self
     ...
     * 
     * @param SharingInvitation $item
     * @return self
     */
    public function addValue(SharingInvitation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SharingInvitation>
     */
