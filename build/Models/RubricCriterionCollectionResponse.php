...
/**
 * Collection response for RubricCriterion
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class RubricCriterionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var RubricCriterion[]
     */
     ...
     * 
     * @param RubricCriterion[] $items
     * @return self
     */
    public function setValue(array|RubricCriterion $items, RubricCriterion ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<RubricCriterion> $value
     * @return self
     ...
     * 
     * @param RubricCriterion $item
     * @return self
     */
    public function addValue(RubricCriterion $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, RubricCriterion>
     */
