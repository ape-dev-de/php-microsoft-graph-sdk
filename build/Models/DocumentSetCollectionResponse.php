...
/**
 * Collection response for DocumentSet
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DocumentSetCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DocumentSet[]
     */
     ...
     * 
     * @param DocumentSet[] $items
     * @return self
     */
    public function setValue(array|DocumentSet $items, DocumentSet ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param DocumentSet $item
     * @return self
     */
    public function addValue(DocumentSet $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DocumentSet>
     */
