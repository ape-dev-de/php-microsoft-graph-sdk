...
/**
 * Collection response for SecurityIntelligenceProfileIndicatorCollectionResponse
 */
class SecurityIntelligenceProfileIndicatorCollectionResponseCollectionResponse
{
    /**
     * @var SecurityIntelligenceProfileIndicatorCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityIntelligenceProfileIndicatorCollectionResponse ...$items Variable number of SecurityIntelligenceProfileIndicatorCollectionResponse items
     * @return self
     */
    public function setValue(SecurityIntelligenceProfileIndicatorCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<SecurityIntelligenceProfileIndicatorCollectionResponse> $value
     * @return self
     ...
     * 
     * @param SecurityIntelligenceProfileIndicatorCollectionResponse $item
     * @return self
     */
    public function addValue(SecurityIntelligenceProfileIndicatorCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
