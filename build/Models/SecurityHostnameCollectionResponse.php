...
/**
 * Collection response for SecurityHostname
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityHostnameCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityHostname[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityHostname[] $items
     * @return self
     */
    public function setValue(array|SecurityHostname $items, SecurityHostname ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityHostname> $value
     * @return self
     ...
     * 
     * @param SecurityHostname $item
     * @return self
     */
    public function addValue(SecurityHostname $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SecurityHostname>
     */
