...
/**
 * Collection response for SecurityCaseAction
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SecurityCaseActionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SecurityCaseAction[]
     */
    private array $value = [];
     ...
     * 
     * @param SecurityCaseAction[] $items
     * @return self
     */
    public function setValue(array|SecurityCaseAction $items, SecurityCaseAction ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SecurityCaseAction> $value
     * @return self
     ...
     * 
     * @param SecurityCaseAction $item
     * @return self
     */
    public function addValue(SecurityCaseAction $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return SecurityCaseAction|null
     */
     ...
     * 
     * @return \ArrayIterator<int, SecurityCaseAction>
     */
