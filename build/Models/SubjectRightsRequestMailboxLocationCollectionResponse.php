...
/**
 * Collection response for SubjectRightsRequestMailboxLocation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class SubjectRightsRequestMailboxLocationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var SubjectRightsRequestMailboxLocation[]
     */
    private array $value = [];
     ...
     * 
     * @param SubjectRightsRequestMailboxLocation[] $items
     * @return self
     */
    public function setValue(array|SubjectRightsRequestMailboxLocation $items, SubjectRightsRequestMailboxLocation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<SubjectRightsRequestMailboxLocation> $value
     * @return self
     ...
     * 
     * @param SubjectRightsRequestMailboxLocation $item
     * @return self
     */
    public function addValue(SubjectRightsRequestMailboxLocation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, SubjectRightsRequestMailboxLocation>
     */
