...
/**
 * SubjectRightsRequestMailboxLocationCollectionResponse - Collection response
 */
class SubjectRightsRequestMailboxLocationCollectionResponse
{
    /**
     * @var array<int, SubjectRightsRequestMailboxLocation>
     */
    public array $value = [];
