 ...
 */
class WorkbookRangeFormatCollectionResponse
{
    /**
     ...
     * 
     * @param WorkbookRangeFormat ...$items Variable number of WorkbookRangeFormat items
     * @return self
     */
    public function setValue(WorkbookRangeFormat ...$items): self
    {
        $this->value = $items;
        return $this;
    }
