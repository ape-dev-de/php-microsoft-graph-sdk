...
/**
 * Collection response for WorkbookRangeFormat
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class WorkbookRangeFormatCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var WorkbookRangeFormat[]
     */
    private array $value = [];
     ...
     * 
     * @param WorkbookRangeFormat[] $items
     * @return self
     */
    public function setValue(array|WorkbookRangeFormat $items, WorkbookRangeFormat ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<WorkbookRangeFormat> $value
     * @return self
     ...
     * 
     * @param WorkbookRangeFormat $item
     * @return self
     */
    public function addValue(WorkbookRangeFormat $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, WorkbookRangeFormat>
     */
