...
/**
 * Collection response for ProtectionRuleStatus
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class ProtectionRuleStatusCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var ProtectionRuleStatus[]
     */
    private array $value = [];
     ...
     * 
     * @param ProtectionRuleStatus[] $items
     * @return self
     */
    public function setValue(array|ProtectionRuleStatus $items, ProtectionRuleStatus ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<ProtectionRuleStatus> $value
     * @return self
     ...
     * 
     * @param ProtectionRuleStatus $item
     * @return self
     */
    public function addValue(ProtectionRuleStatus $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, ProtectionRuleStatus>
     */
