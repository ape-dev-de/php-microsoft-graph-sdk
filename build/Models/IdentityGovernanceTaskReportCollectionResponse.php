...
/**
 * Collection response for IdentityGovernanceTaskReport
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IdentityGovernanceTaskReportCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IdentityGovernanceTaskReport[] $items
     * @return self
     */
    public function setValue(array|IdentityGovernanceTaskReport $items, IdentityGovernanceTaskReport ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IdentityGovernanceTaskReport> $value
     * @return self
     ...
     * 
     * @param IdentityGovernanceTaskReport $item
     * @return self
     */
    public function addValue(IdentityGovernanceTaskReport $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, IdentityGovernanceTaskReport>
     */
