...
/**
 * Collection response for Entity
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class EntityCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Entity[]
     */
     ...
     * @return self
     */
    public function setValue(array|Entity $items, Entity ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Entity $item): self
    {
        $this->value[] = $item;
        return $this;
    }
