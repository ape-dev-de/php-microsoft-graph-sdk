...
/**
 * Collection response for InviteParticipantsOperation
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class InviteParticipantsOperationCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var InviteParticipantsOperation[]
     */
    private array $value = [];
     ...
     * 
     * @param InviteParticipantsOperation[] $items
     * @return self
     */
    public function setValue(array|InviteParticipantsOperation $items, InviteParticipantsOperation ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<InviteParticipantsOperation> $value
     * @return self
     ...
     * 
     * @param InviteParticipantsOperation $item
     * @return self
     */
    public function addValue(InviteParticipantsOperation $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return InviteParticipantsOperation|null
     */
     ...
     * 
     * @return \ArrayIterator<int, InviteParticipantsOperation>
     */
