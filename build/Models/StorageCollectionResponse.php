...
/**
 * Collection response for Storage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class StorageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var Storage[]
     */
     ...
     * @return self
     */
    public function setValue(array|Storage $items, Storage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * @return self
     */
    public function addValue(Storage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, Storage>
     */
