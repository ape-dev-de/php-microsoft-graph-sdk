 ...
 */
class DeviceComplianceUserOverviewCollectionResponse
{
    /**
     ...
     * 
     * @param DeviceComplianceUserOverview ...$items Variable number of DeviceComplianceUserOverview items
     * @return self
     */
    public function setValue(DeviceComplianceUserOverview ...$items): self
    {
        $this->value = $items;
        return $this;
    }
