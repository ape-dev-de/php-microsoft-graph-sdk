...
/**
 * Collection response for DeviceComplianceUserOverview
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class DeviceComplianceUserOverviewCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var DeviceComplianceUserOverview[]
     */
    private array $value = [];
     ...
     * 
     * @param DeviceComplianceUserOverview[] $items
     * @return self
     */
    public function setValue(array|DeviceComplianceUserOverview $items, DeviceComplianceUserOverview ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<DeviceComplianceUserOverview> $value
     * @return self
     ...
     * 
     * @param DeviceComplianceUserOverview $item
     * @return self
     */
    public function addValue(DeviceComplianceUserOverview $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, DeviceComplianceUserOverview>
     */
