...
/**
 * Collection response for IosHomeScreenFolderPage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class IosHomeScreenFolderPageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     ...
     * 
     * @param IosHomeScreenFolderPage[] $items
     * @return self
     */
    public function setValue(array|IosHomeScreenFolderPage $items, IosHomeScreenFolderPage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<IosHomeScreenFolderPage> $value
     * @return self
     ...
     * 
     * @param IosHomeScreenFolderPage $item
     * @return self
     */
    public function addValue(IosHomeScreenFolderPage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @param mixed $offset
     * @return IosHomeScreenFolderPage|null
     */
     ...
     * 
     * @return \ArrayIterator<int, IosHomeScreenFolderPage>
     */
