...
/**
 * Collection response for OpenTypeExtension
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class OpenTypeExtensionCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var OpenTypeExtension[]
     */
    private array $value = [];
     ...
     * 
     * @param OpenTypeExtension[] $items
     * @return self
     */
    public function setValue(array|OpenTypeExtension $items, OpenTypeExtension ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param array<OpenTypeExtension> $value
     * @return self
     ...
     * 
     * @param OpenTypeExtension $item
     * @return self
     */
    public function addValue(OpenTypeExtension $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, OpenTypeExtension>
     */
