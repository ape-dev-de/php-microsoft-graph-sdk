...
/**
 * Collection response for MailboxRestoreArtifactCollectionResponse
 */
class MailboxRestoreArtifactCollectionResponseCollectionResponse
{
    /**
     * @var MailboxRestoreArtifactCollectionResponse[]
     */
    private array $value = [];
     ...
     * 
     * @param MailboxRestoreArtifactCollectionResponse ...$items Variable number of MailboxRestoreArtifactCollectionResponse items
     * @return self
     */
    public function setValue(MailboxRestoreArtifactCollectionResponse ...$items): self
    {
        $this->value = $items;
        return $this;
    }
     ...
     * 
     * @param array<MailboxRestoreArtifactCollectionResponse> $value
     * @return self
     ...
     * 
     * @param MailboxRestoreArtifactCollectionResponse $item
     * @return self
     */
    public function addValue(MailboxRestoreArtifactCollectionResponse $item): self
    {
        $this->value[] = $item;
        return $this;
    }
