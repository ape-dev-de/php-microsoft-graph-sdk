...
/**
 * Collection response for LoginPage
 * 
 * Implements ArrayAccess, Countable, and IteratorAggregate for array-like behavior
 */
class LoginPageCollectionResponse implements \ArrayAccess, \Countable, \IteratorAggregate
{
    /**
     * @var LoginPage[]
     */
     ...
     * 
     * @param LoginPage[] $items
     * @return self
     */
    public function setValue(array|LoginPage $items, LoginPage ...$moreItems): self
    {
        if (is_array($items)) {
     ...
     * 
     * @param LoginPage $item
     * @return self
     */
    public function addValue(LoginPage $item): self
    {
        $this->value[] = $item;
        return $this;
    }
     ...
     * 
     * @return \ArrayIterator<int, LoginPage>
     */
