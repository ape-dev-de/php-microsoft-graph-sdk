...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ThreatAssessmentRequestRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for threatAssessmentRequests
 */
class ThreatAssessmentRequestsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new ThreatAssessmentRequestCollectionResponse([]);
