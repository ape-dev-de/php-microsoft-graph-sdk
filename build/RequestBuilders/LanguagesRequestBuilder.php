...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\UserFlowLanguageConfigurationRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for languages
 */
class LanguagesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new UserFlowLanguageConfigurationCollectionResponse([]);
