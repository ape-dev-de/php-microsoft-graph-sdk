...
class BackupRestoreRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): BackupRestoreRoot|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to BackupRestoreRoot|null
     */
    private function deserializeGet(string $body): BackupRestoreRoot|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(BackupRestoreRoot $body): BackupRestoreRoot|null
    {
     ...
     * Deserialize response to BackupRestoreRoot|null
     */
    private function deserializePatch(string $body): BackupRestoreRoot|null    {
        if (empty($body)) {
            return null;
        }
