...
class ExchangeRestoreSessionsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return ExchangeRestoreSessionCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): ExchangeRestoreSessionCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to ExchangeRestoreSessionCollectionResponse|null
     */
    private function deserializeGet(string $body): ExchangeRestoreSessionCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @return ExchangeRestoreSession|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(ExchangeRestoreSession $body): ExchangeRestoreSession|null
    {
    ...
    /**
     * Deserialize response to ExchangeRestoreSession|null
     */
    private function deserializePost(string $body): ExchangeRestoreSession|null    {
        if (empty($body)) {
            return null;
        }
