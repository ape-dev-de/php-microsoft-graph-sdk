...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\BackupRestore\ProtectionPolicies\ActivateRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\BackupRestore\ProtectionPolicies\DeactivateRequestBuilder;

/**
 * Request builder for /solutions/backupRestore/protectionPolicies/{protectionPolicyBase-id}
 */
class ProtectionPolicyBaseRequestBuilder extends RootBaseRequestBuilder
{
    /**
     ...
     */
    public function get(?array $select = null, ?array $expand = null): ProtectionPolicyBase|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): ProtectionPolicyBase|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(ProtectionPolicyBase $body): ProtectionPolicyBase|null
    {
     ...
     * Deserialize response to ProtectionPolicyBase|null
     */
    private function deserializePatch(string $body): ProtectionPolicyBase|null    {
        if (empty($body)) {
            return null;
        }
