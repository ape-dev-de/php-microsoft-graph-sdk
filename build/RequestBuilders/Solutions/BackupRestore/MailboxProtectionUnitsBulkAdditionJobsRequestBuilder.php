...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\BackupRestore\MailboxProtectionUnitsBulkAdditionJobs\MailboxProtectionUnitsBulkAdditionJobRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\BackupRestore\MailboxProtectionUnitsBulkAdditionJobs\CountRequestBuilder;

/**
 * Request builder for /solutions/backupRestore/mailboxProtectionUnitsBulkAdditionJobs
 */
class MailboxProtectionUnitsBulkAdditionJobsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return MailboxProtectionUnitsBulkAdditionJobCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): MailboxProtectionUnitsBulkAdditionJobCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to MailboxProtectionUnitsBulkAdditionJobCollectionResponse|null
     */
    private function deserializeGet(string $body): MailboxProtectionUnitsBulkAdditionJobCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(MailboxProtectionUnitsBulkAdditionJob $body): MailboxProtectionUnitsBulkAdditionJob|null
    {
     ...
     */
    private function deserializePost(string $body): MailboxProtectionUnitsBulkAdditionJob|null    {
        if (empty($body)) {
            return null;
        }
