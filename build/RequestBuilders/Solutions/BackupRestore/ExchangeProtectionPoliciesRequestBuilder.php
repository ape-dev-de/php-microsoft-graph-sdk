...
class ExchangeProtectionPoliciesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return ExchangeProtectionPolicyCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): ExchangeProtectionPolicyCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to ExchangeProtectionPolicyCollectionResponse|null
     */
    private function deserializeGet(string $body): ExchangeProtectionPolicyCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @return ExchangeProtectionPolicy|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(ExchangeProtectionPolicy $body): ExchangeProtectionPolicy|null
    {
    ...
    /**
     * Deserialize response to ExchangeProtectionPolicy|null
     */
    private function deserializePost(string $body): ExchangeProtectionPolicy|null    {
        if (empty($body)) {
            return null;
        }
