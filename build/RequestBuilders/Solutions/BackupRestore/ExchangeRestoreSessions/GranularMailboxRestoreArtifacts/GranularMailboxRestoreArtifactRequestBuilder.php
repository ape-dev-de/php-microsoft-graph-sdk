...
class GranularMailboxRestoreArtifactRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): GranularMailboxRestoreArtifact|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): GranularMailboxRestoreArtifact|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(GranularMailboxRestoreArtifact $body): GranularMailboxRestoreArtifact|null
    {
     ...
     * Deserialize response to GranularMailboxRestoreArtifact|null
     */
    private function deserializePatch(string $body): GranularMailboxRestoreArtifact|null    {
        if (empty($body)) {
            return null;
        }
