...
class ExchangeRestoreSessionRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): ExchangeRestoreSession|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): ExchangeRestoreSession|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(ExchangeRestoreSession $body): ExchangeRestoreSession|null
    {
     ...
     * Deserialize response to ExchangeRestoreSession|null
     */
    private function deserializePatch(string $body): ExchangeRestoreSession|null    {
        if (empty($body)) {
            return null;
        }
