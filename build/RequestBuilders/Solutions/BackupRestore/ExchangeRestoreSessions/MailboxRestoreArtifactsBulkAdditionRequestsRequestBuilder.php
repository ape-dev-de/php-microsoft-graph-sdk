...
class MailboxRestoreArtifactsBulkAdditionRequestsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return MailboxRestoreArtifactsBulkAdditionRequestCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): MailboxRestoreArtifactsBulkAdditionRequestCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to MailboxRestoreArtifactsBulkAdditionRequestCollectionResponse|null
     */
    private function deserializeGet(string $body): MailboxRestoreArtifactsBulkAdditionRequestCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(MailboxRestoreArtifactsBulkAdditionRequest $body): MailboxRestoreArtifactsBulkAdditionRequest|null
    {
     ...
     */
    private function deserializePost(string $body): MailboxRestoreArtifactsBulkAdditionRequest|null    {
        if (empty($body)) {
            return null;
        }
