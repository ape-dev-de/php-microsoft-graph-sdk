...
class SiteProtectionUnitsBulkAdditionJobRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SiteProtectionUnitsBulkAdditionJob $body): SiteProtectionUnitsBulkAdditionJob|null
    {
     ...
     * Deserialize response to SiteProtectionUnitsBulkAdditionJob|null
     */
    private function deserializePatch(string $body): SiteProtectionUnitsBulkAdditionJob|null    {
        if (empty($body)) {
            return null;
        }
