...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\BackupRestore\SiteInclusionRules\SiteProtectionRuleRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\BackupRestore\SiteInclusionRules\CountRequestBuilder;
...
class SiteInclusionRulesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(SiteProtectionRule $body): SiteProtectionRule|null
    {
     ...
     */
    private function deserializePost(string $body): SiteProtectionRule|null    {
        if (empty($body)) {
            return null;
        }
