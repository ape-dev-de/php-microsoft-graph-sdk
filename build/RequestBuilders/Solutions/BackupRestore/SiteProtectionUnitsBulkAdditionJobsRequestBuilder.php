...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\BackupRestore\SiteProtectionUnitsBulkAdditionJobs\SiteProtectionUnitsBulkAdditionJobRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\BackupRestore\SiteProtectionUnitsBulkAdditionJobs\CountRequestBuilder;

/**
 * Request builder for /solutions/backupRestore/siteProtectionUnitsBulkAdditionJobs
 */
class SiteProtectionUnitsBulkAdditionJobsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return SiteProtectionUnitsBulkAdditionJobCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): SiteProtectionUnitsBulkAdditionJobCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SiteProtectionUnitsBulkAdditionJobCollectionResponse|null
     */
    private function deserializeGet(string $body): SiteProtectionUnitsBulkAdditionJobCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(SiteProtectionUnitsBulkAdditionJob $body): SiteProtectionUnitsBulkAdditionJob|null
    {
     ...
     */
    private function deserializePost(string $body): SiteProtectionUnitsBulkAdditionJob|null    {
        if (empty($body)) {
            return null;
        }
