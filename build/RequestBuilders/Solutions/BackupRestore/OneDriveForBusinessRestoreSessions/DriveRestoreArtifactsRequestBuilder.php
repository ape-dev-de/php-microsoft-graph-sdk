...
class DriveRestoreArtifactsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return DriveRestoreArtifactCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): DriveRestoreArtifactCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to DriveRestoreArtifactCollectionResponse|null
     */
    private function deserializeGet(string $body): DriveRestoreArtifactCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(DriveRestoreArtifact $body): DriveRestoreArtifact|null
    {
     ...
     */
    private function deserializePost(string $body): DriveRestoreArtifact|null    {
        if (empty($body)) {
            return null;
        }
