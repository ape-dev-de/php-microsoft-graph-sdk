...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\BackupRestore\SharePointRestoreSessions\SiteRestoreArtifactsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\BackupRestore\SharePointRestoreSessions\SiteRestoreArtifactsBulkAdditionRequestsRequestBuilder;
...
class SharePointRestoreSessionRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SharePointRestoreSession|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): SharePointRestoreSession|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SharePointRestoreSession $body): SharePointRestoreSession|null
    {
     ...
     * Deserialize response to SharePointRestoreSession|null
     */
    private function deserializePatch(string $body): SharePointRestoreSession|null    {
        if (empty($body)) {
            return null;
        }
