...
class SiteRestoreArtifactRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SiteRestoreArtifact|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): SiteRestoreArtifact|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SiteRestoreArtifact $body): SiteRestoreArtifact|null
    {
     ...
     * Deserialize response to SiteRestoreArtifact|null
     */
    private function deserializePatch(string $body): SiteRestoreArtifact|null    {
        if (empty($body)) {
            return null;
        }
