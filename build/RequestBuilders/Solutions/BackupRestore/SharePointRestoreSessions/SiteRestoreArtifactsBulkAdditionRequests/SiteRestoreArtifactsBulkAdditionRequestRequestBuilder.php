...
class SiteRestoreArtifactsBulkAdditionRequestRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SiteRestoreArtifactsBulkAdditionRequest|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): SiteRestoreArtifactsBulkAdditionRequest|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SiteRestoreArtifactsBulkAdditionRequest $body): SiteRestoreArtifactsBulkAdditionRequest|null
    {
     ...
     * Deserialize response to SiteRestoreArtifactsBulkAdditionRequest|null
     */
    private function deserializePatch(string $body): SiteRestoreArtifactsBulkAdditionRequest|null    {
        if (empty($body)) {
            return null;
        }
