...
class SharePointProtectionPolicyRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SharePointProtectionPolicy|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): SharePointProtectionPolicy|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SharePointProtectionPolicy $body): SharePointProtectionPolicy|null
    {
     ...
     * Deserialize response to SharePointProtectionPolicy|null
     */
    private function deserializePatch(string $body): SharePointProtectionPolicy|null    {
        if (empty($body)) {
            return null;
        }
