...
class RestoreSessionBaseRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): RestoreSessionBase|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): RestoreSessionBase|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(RestoreSessionBase $body): RestoreSessionBase|null
    {
     ...
     * Deserialize response to RestoreSessionBase|null
     */
    private function deserializePatch(string $body): RestoreSessionBase|null    {
        if (empty($body)) {
            return null;
        }
