...
class DriveProtectionUnitsBulkAdditionJobRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(DriveProtectionUnitsBulkAdditionJob $body): DriveProtectionUnitsBulkAdditionJob|null
    {
     ...
     * Deserialize response to DriveProtectionUnitsBulkAdditionJob|null
     */
    private function deserializePatch(string $body): DriveProtectionUnitsBulkAdditionJob|null    {
        if (empty($body)) {
            return null;
        }
