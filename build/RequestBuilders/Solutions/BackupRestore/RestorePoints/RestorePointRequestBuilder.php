...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\BackupRestore\RestorePoints\ProtectionUnitRequestBuilder;

/**
 * Request builder for /solutions/backupRestore/restorePoints/{restorePoint-id}
 */
class RestorePointRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(RestorePoint $body): RestorePoint|null
    {
     ...
     * Deserialize response to RestorePoint|null
     */
    private function deserializePatch(string $body): RestorePoint|null    {
        if (empty($body)) {
            return null;
        }
