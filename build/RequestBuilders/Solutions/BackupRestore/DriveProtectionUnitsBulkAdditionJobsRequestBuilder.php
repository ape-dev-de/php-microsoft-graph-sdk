...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\BackupRestore\DriveProtectionUnitsBulkAdditionJobs\DriveProtectionUnitsBulkAdditionJobRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\BackupRestore\DriveProtectionUnitsBulkAdditionJobs\CountRequestBuilder;
...
class DriveProtectionUnitsBulkAdditionJobsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(DriveProtectionUnitsBulkAdditionJob $body): DriveProtectionUnitsBulkAdditionJob|null
    {
     ...
     */
    private function deserializePost(string $body): DriveProtectionUnitsBulkAdditionJob|null    {
        if (empty($body)) {
            return null;
        }
