...
class WebinarsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return VirtualEventWebinarCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): VirtualEventWebinarCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to VirtualEventWebinarCollectionResponse|null
     */
    private function deserializeGet(string $body): VirtualEventWebinarCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(VirtualEventWebinar $body): VirtualEventWebinar|null
    {
     ...
     */
    private function deserializePost(string $body): VirtualEventWebinar|null    {
        if (empty($body)) {
            return null;
        }
