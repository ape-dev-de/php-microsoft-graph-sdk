...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\Solutions\VirtualEvents\Townhalls\Sessions;
...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\Solutions\VirtualEvents\Townhalls\Sessions\AttendanceReports\MeetingAttendanceReportRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\Solutions\VirtualEvents\Townhalls\Sessions\AttendanceReports\CountRequestBuilder;

/**
 * Request builder for /solutions/virtualEvents/townhalls/{virtualEventTownhall-id}/sessions/{virtualEventSession-id}/attendanceReports
 */
class AttendanceReportsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): MeetingAttendanceReportCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to MeetingAttendanceReportCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(MeetingAttendanceReport $body): MeetingAttendanceReport
    {
