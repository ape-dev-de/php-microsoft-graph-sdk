...
/**
 * Request builder for /solutions/backupRestore/restorePoints/{restorePoint-id}/protectionUnit
 */
class ProtectionUnitRequestBuilder extends RootBaseRequestBuilder
{
    /**
