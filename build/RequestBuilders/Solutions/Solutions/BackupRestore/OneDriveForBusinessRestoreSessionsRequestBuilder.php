...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\Solutions\BackupRestore\OneDriveForBusinessRestoreSessions\OneDriveForBusinessRestoreSessionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\Solutions\BackupRestore\OneDriveForBusinessRestoreSessions\CountRequestBuilder;
...
class OneDriveForBusinessRestoreSessionsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): OneDriveForBusinessRestoreSessionCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to OneDriveForBusinessRestoreSessionCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(OneDriveForBusinessRestoreSession $body): OneDriveForBusinessRestoreSession
    {
