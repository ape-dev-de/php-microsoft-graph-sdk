...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\Solutions\BackupRestore\ExchangeRestoreSessions\GranularMailboxRestoreArtifacts\GranularMailboxRestoreArtifactRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\Solutions\BackupRestore\ExchangeRestoreSessions\GranularMailboxRestoreArtifacts\CountRequestBuilder;
...
class GranularMailboxRestoreArtifactsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): GranularMailboxRestoreArtifactCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to GranularMailboxRestoreArtifactCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(GranularMailboxRestoreArtifact $body): GranularMailboxRestoreArtifact
    {
