...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\Solutions\BackupRestore\ExchangeRestoreSessions\MailboxRestoreArtifactsBulkAdditionRequests;
...
class MailboxRestoreArtifactsBulkAdditionRequestRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): MailboxRestoreArtifactsBulkAdditionRequest
    {
        $queryParams = [];
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(MailboxRestoreArtifactsBulkAdditionRequest $body): MailboxRestoreArtifactsBulkAdditionRequest
    {
