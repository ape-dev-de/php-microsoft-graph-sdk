...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\Solutions\BackupRestore\RestoreSessions\CountRequestBuilder;

/**
 * Request builder for /solutions/backupRestore/restoreSessions
 */
class RestoreSessionsRequestBuilder extends RootBaseRequestBuilder
{
    /**
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new RestoreSessionBaseCollectionResponse($data);
