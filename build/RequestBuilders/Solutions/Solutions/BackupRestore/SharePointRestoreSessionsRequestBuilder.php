...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\Solutions\BackupRestore\SharePointRestoreSessions\SharePointRestoreSessionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\Solutions\BackupRestore\SharePointRestoreSessions\CountRequestBuilder;
...
class SharePointRestoreSessionsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): SharePointRestoreSessionCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SharePointRestoreSessionCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(SharePointRestoreSession $body): SharePointRestoreSession
    {
