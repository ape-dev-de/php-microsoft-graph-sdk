...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\Solutions\BackupRestore\MailboxInclusionRules;
...
/**
 * Request builder for /solutions/backupRestore/mailboxInclusionRules/{mailboxProtectionRule-id}
 */
class MailboxProtectionRuleRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): MailboxProtectionRule
    {
        $queryParams = [];
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(MailboxProtectionRule $body): MailboxProtectionRule
    {
