...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\Solutions\VirtualEvents\EventsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\Solutions\VirtualEvents\TownhallsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\Solutions\VirtualEvents\WebinarsRequestBuilder;
...
class VirtualEventsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): VirtualEventsRoot
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to VirtualEventsRoot
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(VirtualEventsRoot $body): VirtualEventsRoot
    {
