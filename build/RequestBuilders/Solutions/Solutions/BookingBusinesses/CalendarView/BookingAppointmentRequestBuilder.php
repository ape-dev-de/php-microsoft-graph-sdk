...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\Solutions\BookingBusinesses\CalendarView\CancelRequestBuilder;
...
class BookingAppointmentRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, string $start, string $end): BookingAppointment
    {
        $queryParams = [];
