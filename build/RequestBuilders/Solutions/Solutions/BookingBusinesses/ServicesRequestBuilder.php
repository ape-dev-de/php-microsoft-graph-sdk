...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\Solutions\BookingBusinesses\Services\BookingServiceRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\Solutions\BookingBusinesses\Services\CountRequestBuilder;
...
class ServicesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): BookingServiceCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to BookingServiceCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(BookingService $body): BookingService
    {
    ...
    /**
     * Deserialize response to BookingService
     */
