...
class BookingBusinessRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): BookingBusiness|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): BookingBusiness|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(BookingBusiness $body): BookingBusiness|null
    {
     ...
     * Deserialize response to BookingBusiness|null
     */
    private function deserializePatch(string $body): BookingBusiness|null    {
        if (empty($body)) {
            return null;
        }
