...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\BookingBusinesses\Appointments\BookingAppointmentRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Solutions\BookingBusinesses\Appointments\CountRequestBuilder;
...
class AppointmentsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): BookingAppointmentCollectionResponse|null
    {
        $queryParams = [];
