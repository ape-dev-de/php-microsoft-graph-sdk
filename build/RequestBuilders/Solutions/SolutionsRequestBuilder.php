...
class SolutionsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SolutionsRoot|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SolutionsRoot|null
     */
    private function deserializeGet(string $body): SolutionsRoot|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SolutionsRoot $body): SolutionsRoot|null
    {
     ...
     * Deserialize response to SolutionsRoot|null
     */
    private function deserializePatch(string $body): SolutionsRoot|null    {
        if (empty($body)) {
            return null;
        }
