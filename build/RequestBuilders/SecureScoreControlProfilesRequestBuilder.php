...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\SecureScoreControlProfileRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for secureScoreControlProfiles
 */
class SecureScoreControlProfilesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new SecureScoreControlProfileCollectionResponse([]);
