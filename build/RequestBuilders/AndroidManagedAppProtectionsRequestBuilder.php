...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AndroidManagedAppProtectionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for androidManagedAppProtections
 */
class AndroidManagedAppProtectionsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new AndroidManagedAppProtectionCollectionResponse([]);
