...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\UserExperienceAnalyticsMetricRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for metricValues
 */
class MetricValuesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new UserExperienceAnalyticsMetricCollectionResponse([]);
