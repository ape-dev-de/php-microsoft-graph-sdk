...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Copilot\Copilot\Users\AiUserRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Copilot\Copilot\Users\CountRequestBuilder;
...
class UsersRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): AiUserCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to AiUserCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(AiUser $body): AiUser
    {
