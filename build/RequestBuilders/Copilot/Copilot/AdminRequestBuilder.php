...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Copilot\Copilot\Admin\SettingsRequestBuilder;
...
class AdminRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): CopilotAdmin
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to CopilotAdmin
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(CopilotAdmin $body): CopilotAdmin
    {
