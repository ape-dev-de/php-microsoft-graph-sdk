...
class AiUserRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): AiUser|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): AiUser|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(AiUser $body): AiUser|null
    {
     ...
     * Deserialize response to AiUser|null
     */
    private function deserializePatch(string $body): AiUser|null    {
        if (empty($body)) {
            return null;
        }
