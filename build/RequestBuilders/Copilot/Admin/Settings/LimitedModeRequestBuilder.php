...
class LimitedModeRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): CopilotAdminLimitedMode|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to CopilotAdminLimitedMode|null
     */
    private function deserializeGet(string $body): CopilotAdminLimitedMode|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(CopilotAdminLimitedMode $body): CopilotAdminLimitedMode|null
    {
     ...
     * Deserialize response to CopilotAdminLimitedMode|null
     */
    private function deserializePatch(string $body): CopilotAdminLimitedMode|null    {
        if (empty($body)) {
            return null;
        }
