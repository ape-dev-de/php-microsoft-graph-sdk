...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Copilot\Admin;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\CopilotAdminSetting;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Copilot\Admin\Settings\LimitedModeRequestBuilder;
...
class SettingsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): CopilotAdminSetting|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to CopilotAdminSetting|null
     */
    private function deserializeGet(string $body): CopilotAdminSetting|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(CopilotAdminSetting $body): CopilotAdminSetting|null
    {
     ...
     * Deserialize response to CopilotAdminSetting|null
     */
    private function deserializePatch(string $body): CopilotAdminSetting|null    {
        if (empty($body)) {
            return null;
        }
