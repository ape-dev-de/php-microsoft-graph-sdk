...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\HealthIssueRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for healthIssues
 */
class HealthIssuesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new SecurityHealthIssueCollectionResponse([]);
