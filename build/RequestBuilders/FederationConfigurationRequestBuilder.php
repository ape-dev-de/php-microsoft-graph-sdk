...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\InternalDomainFederationRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for federationConfiguration
 */
class FederationConfigurationRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new InternalDomainFederationCollectionResponse([]);
