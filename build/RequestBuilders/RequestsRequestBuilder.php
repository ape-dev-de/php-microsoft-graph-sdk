...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DelegatedAdminRelationshipRequestRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for requests
 */
class RequestsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new DelegatedAdminRelationshipRequestCollectionResponse([]);
