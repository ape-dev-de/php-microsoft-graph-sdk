...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\MobileAppContentRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for contentVersions
 */
class ContentVersionsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new MobileAppContentCollectionResponse([]);
