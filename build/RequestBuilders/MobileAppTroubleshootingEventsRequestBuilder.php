...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\MobileAppTroubleshootingEventRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for mobileAppTroubleshootingEvents
 */
class MobileAppTroubleshootingEventsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new MobileAppTroubleshootingEventCollectionResponse([]);
