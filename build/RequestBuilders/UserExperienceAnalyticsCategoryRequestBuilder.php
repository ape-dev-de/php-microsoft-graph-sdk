...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\MetricValuesRequestBuilder;

/**
 * Request builder for {userExperienceAnalyticsCategory-id}
 */
class UserExperienceAnalyticsCategoryRequestBuilder extends BaseRequestBuilder
{
    /**
