...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\MailboxProtectionUnitsBulkAdditionJobRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for mailboxProtectionUnitsBulkAdditionJobs
 */
class MailboxProtectionUnitsBulkAdditionJobsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new MailboxProtectionUnitsBulkAdditionJobCollectionResponse([]);
