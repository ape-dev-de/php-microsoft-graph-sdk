...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\HostTrackerRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for hostTrackers
 */
class HostTrackersRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new SecurityHostTrackerCollectionResponse([]);
