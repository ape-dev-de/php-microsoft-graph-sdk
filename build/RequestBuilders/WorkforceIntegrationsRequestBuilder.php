...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\WorkforceIntegrationRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for workforceIntegrations
 */
class WorkforceIntegrationsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new WorkforceIntegrationCollectionResponse([]);
