...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Teams\Teams\Channels\SharedWithTeams\AllowedMembers;
...
/**
 * Request builder for /teams/{team-id}/channels/{channel-id}/sharedWithTeams/{sharedWithChannelTeamInfo-id}/allowedMembers/$count
 */
