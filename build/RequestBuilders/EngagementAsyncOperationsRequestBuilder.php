...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\EngagementAsyncOperationRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for engagementAsyncOperations
 */
class EngagementAsyncOperationsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new EngagementAsyncOperationCollectionResponse([]);
