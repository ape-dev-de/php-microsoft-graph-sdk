...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceLocalCredentialInfoRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for deviceLocalCredentials
 */
class DeviceLocalCredentialsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new DeviceLocalCredentialInfoCollectionResponse([]);
