...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Planner\Buckets\TasksRequestBuilder;
...
class PlannerBucketRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(string $ifMatch, PlannerBucket $body): PlannerBucket|null
    {
        $queryParams = [];
