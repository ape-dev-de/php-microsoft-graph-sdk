...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Planner\Planner\Buckets\TasksRequestBuilder;

/**
 * Request builder for /planner/buckets/{plannerBucket-id}
 */
class PlannerBucketRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(string $ifMatch, PlannerBucket $body): PlannerBucket
    {
        $queryParams = [];
