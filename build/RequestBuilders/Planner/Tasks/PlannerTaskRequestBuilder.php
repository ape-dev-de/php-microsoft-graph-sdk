...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Planner\Tasks\AssignedToTaskBoardFormatRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Planner\Tasks\BucketTaskBoardFormatRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Planner\Tasks\DetailsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Planner\Tasks\ProgressTaskBoardFormatRequestBuilder;

/**
 * Request builder for /planner/tasks/{plannerTask-id}
 */
class PlannerTaskRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(string $ifMatch, PlannerTask $body): PlannerTask|null
    {
        $queryParams = [];
