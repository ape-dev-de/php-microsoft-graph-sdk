...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\EdiscoveryReviewSetRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for reviewSets
 */
class ReviewSetsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new SecurityEdiscoveryReviewSetCollectionResponse([]);
