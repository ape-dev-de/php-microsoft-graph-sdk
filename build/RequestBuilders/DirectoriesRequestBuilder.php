...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DirectoryDefinitionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for directories
 */
class DirectoriesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new DirectoryDefinitionCollectionResponse([]);
