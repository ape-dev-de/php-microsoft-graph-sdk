...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CallRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\LogTeleconferenceDeviceQualityRequestBuilder;

/**
 * Request builder for calls
 */
class CallsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new CallCollectionResponse([]);
