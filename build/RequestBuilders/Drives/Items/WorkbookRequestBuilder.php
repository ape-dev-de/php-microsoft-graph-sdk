...
class WorkbookRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): Workbook|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to Workbook|null
     */
    private function deserializeGet(string $body): Workbook|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(Workbook $body): Workbook|null
    {
     ...
     * Deserialize response to Workbook|null
     */
    private function deserializePatch(string $body): Workbook|null    {
        if (empty($body)) {
            return null;
        }
