...
class RetentionLabelRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): ItemRetentionLabel|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to ItemRetentionLabel|null
     */
    private function deserializeGet(string $body): ItemRetentionLabel|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(ItemRetentionLabel $body): ItemRetentionLabel|null
    {
     ...
     * Deserialize response to ItemRetentionLabel|null
     */
    private function deserializePatch(string $body): ItemRetentionLabel|null    {
        if (empty($body)) {
            return null;
        }
