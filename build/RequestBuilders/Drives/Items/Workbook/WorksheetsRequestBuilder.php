...
class WorksheetsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return WorkbookWorksheetCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): WorkbookWorksheetCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to WorkbookWorksheetCollectionResponse|null
     */
    private function deserializeGet(string $body): WorkbookWorksheetCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(WorkbookWorksheet $body): WorkbookWorksheet|null
    {
     ...
     */
    private function deserializePost(string $body): WorkbookWorksheet|null    {
        if (empty($body)) {
            return null;
        }
