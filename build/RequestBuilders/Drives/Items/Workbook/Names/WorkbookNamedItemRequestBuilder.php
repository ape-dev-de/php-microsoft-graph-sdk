...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Drives\Items\Workbook\Names\RangeRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Drives\Items\Workbook\Names\WorksheetRequestBuilder;

/**
 * Request builder for /drives/{drive-id}/items/{driveItem-id}/workbook/names/{workbookNamedItem-id}
 */
class WorkbookNamedItemRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): WorkbookNamedItem|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): WorkbookNamedItem|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(WorkbookNamedItem $body): WorkbookNamedItem|null
    {
     ...
     * Deserialize response to WorkbookNamedItem|null
     */
    private function deserializePatch(string $body): WorkbookNamedItem|null    {
        if (empty($body)) {
            return null;
        }
