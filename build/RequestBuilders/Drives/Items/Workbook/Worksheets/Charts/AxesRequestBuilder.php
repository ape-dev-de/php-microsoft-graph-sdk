...
class AxesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): WorkbookChartAxes|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to WorkbookChartAxes|null
     */
    private function deserializeGet(string $body): WorkbookChartAxes|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(WorkbookChartAxes $body): WorkbookChartAxes|null
    {
     ...
     * Deserialize response to WorkbookChartAxes|null
     */
    private function deserializePatch(string $body): WorkbookChartAxes|null    {
        if (empty($body)) {
            return null;
        }
