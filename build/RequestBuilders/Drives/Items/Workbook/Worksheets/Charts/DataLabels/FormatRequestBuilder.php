...
class FormatRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): WorkbookChartDataLabelFormat|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to WorkbookChartDataLabelFormat|null
     */
    private function deserializeGet(string $body): WorkbookChartDataLabelFormat|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(WorkbookChartDataLabelFormat $body): WorkbookChartDataLabelFormat|null
    {
     ...
     * Deserialize response to WorkbookChartDataLabelFormat|null
     */
    private function deserializePatch(string $body): WorkbookChartDataLabelFormat|null    {
        if (empty($body)) {
            return null;
        }
