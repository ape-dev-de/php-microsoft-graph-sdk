...
class PointsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return WorkbookChartPointCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): WorkbookChartPointCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to WorkbookChartPointCollectionResponse|null
     */
    private function deserializeGet(string $body): WorkbookChartPointCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(WorkbookChartPoint $body): WorkbookChartPoint|null
    {
     ...
     */
    private function deserializePost(string $body): WorkbookChartPoint|null    {
        if (empty($body)) {
            return null;
        }
