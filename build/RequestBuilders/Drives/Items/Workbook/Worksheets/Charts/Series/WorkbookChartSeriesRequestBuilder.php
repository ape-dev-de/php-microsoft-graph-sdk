...
class WorkbookChartSeriesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): WorkbookChartSeries|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): WorkbookChartSeries|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(WorkbookChartSeries $body): WorkbookChartSeries|null
    {
     ...
     * Deserialize response to WorkbookChartSeries|null
     */
    private function deserializePatch(string $body): WorkbookChartSeries|null    {
        if (empty($body)) {
            return null;
        }
