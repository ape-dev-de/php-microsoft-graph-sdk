...
class FormatRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): WorkbookChartLegendFormat|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to WorkbookChartLegendFormat|null
     */
    private function deserializeGet(string $body): WorkbookChartLegendFormat|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(WorkbookChartLegendFormat $body): WorkbookChartLegendFormat|null
    {
     ...
     * Deserialize response to WorkbookChartLegendFormat|null
     */
    private function deserializePatch(string $body): WorkbookChartLegendFormat|null    {
        if (empty($body)) {
            return null;
        }
