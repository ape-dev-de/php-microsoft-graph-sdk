...
/**
 * Request builder for /drives/{drive-id}/items/{driveItem-id}/workbook/worksheets/{workbookWorksheet-id}/tables/{workbookTable-id}/rows/itemAt(index={index})
 */
class ItemAtRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(): WorkbookTableRow|\stdClass|null
    {
     ...
     */
    private function deserializeGet(string $body): WorkbookTableRow|\stdClass|null    {
        if (empty($body)) {
            return null;
        }
