...
class WorkbookPivotTableRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): WorkbookPivotTable|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): WorkbookPivotTable|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(WorkbookPivotTable $body): WorkbookPivotTable|null
    {
     ...
     * Deserialize response to WorkbookPivotTable|null
     */
    private function deserializePatch(string $body): WorkbookPivotTable|null    {
        if (empty($body)) {
            return null;
        }
