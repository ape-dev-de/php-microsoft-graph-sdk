...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Drives\Items\Workbook\Comments\WorkbookCommentRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Drives\Items\Workbook\Comments\CountRequestBuilder;
...
class CommentsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return WorkbookCommentCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): WorkbookCommentCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to WorkbookCommentCollectionResponse|null
     */
    private function deserializeGet(string $body): WorkbookCommentCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(WorkbookComment $body): WorkbookComment|null
    {
    ...
    /**
     * Deserialize response to WorkbookComment|null
     */
    private function deserializePost(string $body): WorkbookComment|null    {
        if (empty($body)) {
            return null;
        }
