...
class RepliesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return WorkbookCommentReplyCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): WorkbookCommentReplyCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to WorkbookCommentReplyCollectionResponse|null
     */
    private function deserializeGet(string $body): WorkbookCommentReplyCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(WorkbookCommentReply $body): WorkbookCommentReply|null
    {
     ...
     */
    private function deserializePost(string $body): WorkbookCommentReply|null    {
        if (empty($body)) {
            return null;
        }
