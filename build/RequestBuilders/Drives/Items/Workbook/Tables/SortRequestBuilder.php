...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Drives\Items\Workbook\Tables\Sort\ApplyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Drives\Items\Workbook\Tables\Sort\ClearRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Drives\Items\Workbook\Tables\Sort\ReapplyRequestBuilder;

/**
 * Request builder for /drives/{drive-id}/items/{driveItem-id}/workbook/tables/{workbookTable-id}/sort
 */
class SortRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): WorkbookTableSort|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to WorkbookTableSort|null
     */
    private function deserializeGet(string $body): WorkbookTableSort|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(WorkbookTableSort $body): WorkbookTableSort|null
    {
     ...
     * Deserialize response to WorkbookTableSort|null
     */
    private function deserializePatch(string $body): WorkbookTableSort|null    {
        if (empty($body)) {
            return null;
        }
