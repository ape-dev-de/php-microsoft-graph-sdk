...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Drives\Drives\List\Items\CreatedByUser\ServiceProvisioningErrors;
...
/**
 * Request builder for /drives/{drive-id}/list/items/{listItem-id}/createdByUser/serviceProvisioningErrors/$count
 */
