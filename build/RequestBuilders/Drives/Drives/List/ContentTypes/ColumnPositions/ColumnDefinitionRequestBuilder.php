...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Drives\Drives\List\ContentTypes\ColumnPositions;
...
/**
 * Request builder for /drives/{drive-id}/list/contentTypes/{contentType-id}/columnPositions/{columnDefinition-id}
 */
