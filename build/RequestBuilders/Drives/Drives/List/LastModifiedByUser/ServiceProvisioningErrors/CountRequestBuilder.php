...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Drives\Drives\List\LastModifiedByUser\ServiceProvisioningErrors;
...
/**
 * Request builder for /drives/{drive-id}/list/lastModifiedByUser/serviceProvisioningErrors/$count
 */
