...
/**
 * Request builder for /drives/{drive-id}/items/{driveItem-id}/assignSensitivityLabel
 */
class AssignSensitivityLabelRequestBuilder extends RootBaseRequestBuilder
{
    /**
