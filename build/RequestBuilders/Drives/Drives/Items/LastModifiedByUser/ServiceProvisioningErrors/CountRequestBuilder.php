...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Drives\Drives\Items\LastModifiedByUser\ServiceProvisioningErrors;
...
/**
 * Request builder for /drives/{drive-id}/items/{driveItem-id}/lastModifiedByUser/serviceProvisioningErrors/$count
 */
