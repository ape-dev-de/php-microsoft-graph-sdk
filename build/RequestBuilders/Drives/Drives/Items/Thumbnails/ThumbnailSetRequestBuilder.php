...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Drives\Drives\Items\Thumbnails;
...
/**
 * Request builder for /drives/{drive-id}/items/{driveItem-id}/thumbnails/{thumbnailSet-id}
 */
class ThumbnailSetRequestBuilder extends RootBaseRequestBuilder
{
    /**
