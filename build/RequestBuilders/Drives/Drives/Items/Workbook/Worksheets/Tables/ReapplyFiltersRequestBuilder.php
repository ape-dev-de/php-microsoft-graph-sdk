...
/**
 * Request builder for /drives/{drive-id}/items/{driveItem-id}/workbook/worksheets/{workbookWorksheet-id}/tables/{workbookTable-id}/reapplyFilters
 */
class ReapplyFiltersRequestBuilder extends RootBaseRequestBuilder
{
    /**
