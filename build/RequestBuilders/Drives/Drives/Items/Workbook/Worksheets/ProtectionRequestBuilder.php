...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Drives\Drives\Items\Workbook\Worksheets\Protection\ProtectRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Drives\Drives\Items\Workbook\Worksheets\Protection\UnprotectRequestBuilder;
...
class ProtectionRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): WorkbookWorksheetProtection
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to WorkbookWorksheetProtection
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(WorkbookWorksheetProtection $body): WorkbookWorksheetProtection
    {
