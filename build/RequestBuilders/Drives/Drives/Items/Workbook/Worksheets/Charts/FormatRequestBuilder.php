...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Drives\Drives\Items\Workbook\Worksheets\Charts\Format\FillRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Drives\Drives\Items\Workbook\Worksheets\Charts\Format\FontRequestBuilder;
...
class FormatRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): WorkbookChartAreaFormat
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to WorkbookChartAreaFormat
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(WorkbookChartAreaFormat $body): WorkbookChartAreaFormat
    {
