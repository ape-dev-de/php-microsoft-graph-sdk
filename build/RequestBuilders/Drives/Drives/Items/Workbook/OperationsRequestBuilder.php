...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Drives\Drives\Items\Workbook\Operations\WorkbookOperationRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Drives\Drives\Items\Workbook\Operations\CountRequestBuilder;
...
class OperationsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): WorkbookOperationCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to WorkbookOperationCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(WorkbookOperation $body): WorkbookOperation
    {
    ...
    /**
     * Deserialize response to WorkbookOperation
     */
