...
/**
 * Request builder for /drives/{drive-id}/items/{driveItem-id}/workbook/functions/confidence_Norm
 */
class ConfidenceNormRequestBuilder extends RootBaseRequestBuilder
{
    /**
