...
/**
 * Request builder for /drives/{drive-id}/items/{driveItem-id}/workbook/functions/percentRank_Exc
 */
class PercentRankExcRequestBuilder extends RootBaseRequestBuilder
{
    /**
