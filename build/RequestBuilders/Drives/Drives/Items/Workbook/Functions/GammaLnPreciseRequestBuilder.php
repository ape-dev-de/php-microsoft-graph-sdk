...
/**
 * Request builder for /drives/{drive-id}/items/{driveItem-id}/workbook/functions/gammaLn_Precise
 */
class GammaLnPreciseRequestBuilder extends RootBaseRequestBuilder
{
    /**
