...
/**
 * Request builder for /drives/{drive-id}/items/{driveItem-id}/workbook/functions/floor_Precise
 */
class FloorPreciseRequestBuilder extends RootBaseRequestBuilder
{
    /**
