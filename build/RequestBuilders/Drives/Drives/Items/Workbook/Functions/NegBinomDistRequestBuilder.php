...
/**
 * Request builder for /drives/{drive-id}/items/{driveItem-id}/workbook/functions/negBinom_Dist
 */
class NegBinomDistRequestBuilder extends RootBaseRequestBuilder
{
    /**
