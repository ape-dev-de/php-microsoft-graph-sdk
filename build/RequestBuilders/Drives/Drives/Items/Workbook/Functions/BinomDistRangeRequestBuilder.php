...
/**
 * Request builder for /drives/{drive-id}/items/{driveItem-id}/workbook/functions/binom_Dist_Range
 */
class BinomDistRangeRequestBuilder extends RootBaseRequestBuilder
{
    /**
