...
/**
 * Request builder for /drives/{drive-id}/items/{driveItem-id}/workbook/functions/ceiling_Precise
 */
class CeilingPreciseRequestBuilder extends RootBaseRequestBuilder
{
    /**
