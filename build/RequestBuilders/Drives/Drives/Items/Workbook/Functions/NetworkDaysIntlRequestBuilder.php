...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Drives\Drives\Items\Workbook\Functions;
...
/**
 * Request builder for /drives/{drive-id}/items/{driveItem-id}/workbook/functions/networkDays_Intl
 */
class NetworkDaysIntlRequestBuilder extends RootBaseRequestBuilder
{
    /**
