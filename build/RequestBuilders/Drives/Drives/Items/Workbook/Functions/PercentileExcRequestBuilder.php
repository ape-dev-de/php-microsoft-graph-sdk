...
/**
 * Request builder for /drives/{drive-id}/items/{driveItem-id}/workbook/functions/percentile_Exc
 */
class PercentileExcRequestBuilder extends RootBaseRequestBuilder
{
    /**
