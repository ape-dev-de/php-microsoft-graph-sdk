...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Drives\Drives\Items\CreatedByUser\ServiceProvisioningErrors;
...
/**
 * Request builder for /drives/{drive-id}/items/{driveItem-id}/createdByUser/serviceProvisioningErrors/$count
 */
