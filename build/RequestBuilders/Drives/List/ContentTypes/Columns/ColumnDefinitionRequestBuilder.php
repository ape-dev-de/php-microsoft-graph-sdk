...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Drives\List\ContentTypes\Columns;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\ColumnDefinition;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Drives\List\ContentTypes\Columns\SourceColumnRequestBuilder;

/**
 * Request builder for /drives/{drive-id}/list/contentTypes/{contentType-id}/columns/{columnDefinition-id}
 */
