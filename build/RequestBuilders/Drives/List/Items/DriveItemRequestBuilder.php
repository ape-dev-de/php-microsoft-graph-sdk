...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Drives\List\Items\DriveItem\ContentRequestBuilder;

/**
 * Request builder for /drives/{drive-id}/list/items/{listItem-id}/driveItem
 */
