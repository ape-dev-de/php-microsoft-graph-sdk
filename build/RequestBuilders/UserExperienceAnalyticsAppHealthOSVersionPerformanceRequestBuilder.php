...
/**
 * Request builder for userExperienceAnalyticsAppHealthOSVersionPerformance
 */
class UserExperienceAnalyticsAppHealthOSVersionPerformanceRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new UserExperienceAnalyticsAppHealthOSVersionPerformanceCollectionResponse([]);
