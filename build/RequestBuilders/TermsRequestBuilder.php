...
class TermsRequestBuilder extends BaseRequestBuilder
{
     ...
     *
     * You can use either:
     * 1. Type-safe QueryOptions: get(options: (new TermStoreTermQueryOptions())->top(10)->select(['displayName', 'mail']))
     ...
     */
    public function get(?TermStoreTermQueryOptions $options = null, ?array $queryParameters = null): TermStoreTermCollectionResponse
    {
        $params = $options ? $options->toArray() : ($queryParameters ?? []);
        $response = $this->client->get($this->getFullPath(), $params);
        return $this->client->deserialize($response, TermStoreTermCollectionResponse::class);
    }

    /**
     * Create a new TermStoreTerm
     *
     * @param TermStoreTerm $item The item to create
     * @return TermStoreTerm
     */
    public function post(TermStoreTerm $item): TermStoreTerm
    {
