...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\PasswordAuthenticationMethodRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for passwordMethods
 */
class PasswordMethodsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new PasswordAuthenticationMethodCollectionResponse([]);
