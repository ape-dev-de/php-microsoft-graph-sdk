...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\HistoryItemsRequestBuilder;

/**
 * Request builder for {userActivity-id}
 */
class UserActivityRequestBuilder extends BaseRequestBuilder
{
    /**
