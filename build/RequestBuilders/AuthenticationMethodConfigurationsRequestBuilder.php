...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AuthenticationMethodConfigurationRequestBuilder;
...
class AuthenticationMethodConfigurationsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new AuthenticationMethodConfigurationCollectionResponse([]);
