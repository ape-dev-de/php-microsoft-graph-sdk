...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CallTranscriptRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeltaRequestBuilder;

/**
 * Request builder for transcripts
 */
class TranscriptsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new CallTranscriptCollectionResponse([]);
