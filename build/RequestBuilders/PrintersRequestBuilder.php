...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\PrinterRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CreateRequestBuilder;

/**
 * Request builder for printers
 */
class PrintersRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new PrinterCollectionResponse([]);
