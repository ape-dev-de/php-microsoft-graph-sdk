...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Contracts\Contracts;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\Contract;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Contracts\Contracts\CheckMemberGroupsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Contracts\Contracts\CheckMemberObjectsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Contracts\Contracts\GetMemberGroupsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Contracts\Contracts\GetMemberObjectsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Contracts\Contracts\RestoreRequestBuilder;

/**
 * Request builder for /contracts/{contract-id}
 */
class ContractRequestBuilder extends RootBaseRequestBuilder
{
    /**
     * Get Contract
     *
