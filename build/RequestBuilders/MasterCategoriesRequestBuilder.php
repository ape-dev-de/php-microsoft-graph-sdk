...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\OutlookCategoryRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for masterCategories
 */
class MasterCategoriesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new OutlookCategoryCollectionResponse([]);
