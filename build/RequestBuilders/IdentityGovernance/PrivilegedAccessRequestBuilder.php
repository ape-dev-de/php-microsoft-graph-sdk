...
class PrivilegedAccessRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): PrivilegedAccessRoot|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to PrivilegedAccessRoot|null
     */
    private function deserializeGet(string $body): PrivilegedAccessRoot|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(PrivilegedAccessRoot $body): PrivilegedAccessRoot|null
    {
     ...
     * Deserialize response to PrivilegedAccessRoot|null
     */
    private function deserializePatch(string $body): PrivilegedAccessRoot|null    {
        if (empty($body)) {
            return null;
        }
