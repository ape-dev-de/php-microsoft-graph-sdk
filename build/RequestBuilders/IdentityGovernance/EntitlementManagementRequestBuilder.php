...
class EntitlementManagementRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): EntitlementManagement|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to EntitlementManagement|null
     */
    private function deserializeGet(string $body): EntitlementManagement|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(EntitlementManagement $body): EntitlementManagement|null
    {
     ...
     * Deserialize response to EntitlementManagement|null
     */
    private function deserializePatch(string $body): EntitlementManagement|null    {
        if (empty($body)) {
            return null;
        }
