...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\LifecycleWorkflows\CustomTaskExtensionsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\LifecycleWorkflows\DeletedItemsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\LifecycleWorkflows\InsightsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\LifecycleWorkflows\SettingsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\LifecycleWorkflows\TaskDefinitionsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\LifecycleWorkflows\WorkflowsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\LifecycleWorkflows\WorkflowTemplatesRequestBuilder;
...
class LifecycleWorkflowsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return IdentityGovernanceLifecycleWorkflowsContainer|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null): IdentityGovernanceLifecycleWorkflowsContainer|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to IdentityGovernanceLifecycleWorkflowsContainer|null
     */
    private function deserializeGet(string $body): IdentityGovernanceLifecycleWorkflowsContainer|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(IdentityGovernanceLifecycleWorkflowsContainer $body): IdentityGovernanceLifecycleWorkflowsContainer|null
    {
     ...
     * Deserialize response to IdentityGovernanceLifecycleWorkflowsContainer|null
     */
    private function deserializePatch(string $body): IdentityGovernanceLifecycleWorkflowsContainer|null    {
        if (empty($body)) {
            return null;
        }
