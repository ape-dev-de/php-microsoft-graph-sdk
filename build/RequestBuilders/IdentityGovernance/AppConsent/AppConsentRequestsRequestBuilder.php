...
class AppConsentRequestsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return AppConsentRequestCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): AppConsentRequestCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to AppConsentRequestCollectionResponse|null
     */
    private function deserializeGet(string $body): AppConsentRequestCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(AppConsentRequest $body): AppConsentRequest|null
    {
     ...
     */
    private function deserializePost(string $body): AppConsentRequest|null    {
        if (empty($body)) {
            return null;
        }
