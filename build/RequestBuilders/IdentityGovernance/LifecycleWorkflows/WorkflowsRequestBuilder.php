...
class WorkflowsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(IdentityGovernanceWorkflow $body): IdentityGovernanceWorkflow|null
    {
     ...
     */
    private function deserializePost(string $body): IdentityGovernanceWorkflow|null    {
        if (empty($body)) {
            return null;
        }
