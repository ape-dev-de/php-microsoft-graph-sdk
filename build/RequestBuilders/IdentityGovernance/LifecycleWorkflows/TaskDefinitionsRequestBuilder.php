...
class TaskDefinitionsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return IdentityGovernanceTaskDefinitionCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): IdentityGovernanceTaskDefinitionCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to IdentityGovernanceTaskDefinitionCollectionResponse|null
     */
    private function deserializeGet(string $body): IdentityGovernanceTaskDefinitionCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
