...
class CustomTaskExtensionsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return IdentityGovernanceCustomTaskExtensionCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): IdentityGovernanceCustomTaskExtensionCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to IdentityGovernanceCustomTaskExtensionCollectionResponse|null
     */
    private function deserializeGet(string $body): IdentityGovernanceCustomTaskExtensionCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(IdentityGovernanceCustomTaskExtension $body): IdentityGovernanceCustomTaskExtension|null
    {
     ...
     */
    private function deserializePost(string $body): IdentityGovernanceCustomTaskExtension|null    {
        if (empty($body)) {
            return null;
        }
