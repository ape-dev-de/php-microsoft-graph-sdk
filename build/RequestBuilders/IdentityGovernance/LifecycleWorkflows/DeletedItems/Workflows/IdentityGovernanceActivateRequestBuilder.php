...
/**
 * Request builder for /identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow-id}/microsoft.graph.identityGovernance.activate
 */
class IdentityGovernanceActivateRequestBuilder extends RootBaseRequestBuilder
{
    /**
