...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\LifecycleWorkflows\DeletedItems\Workflows\Versions\Tasks\TaskProcessingResultsRequestBuilder;

/**
 * Request builder for /identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow-id}/versions/{workflowVersion-versionNumber}/tasks/{task-id}
 */
class TaskRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(IdentityGovernanceTask $body): IdentityGovernanceTask|null
    {
     ...
     * Deserialize response to IdentityGovernanceTask|null
     */
    private function deserializePatch(string $body): IdentityGovernanceTask|null    {
        if (empty($body)) {
            return null;
        }
