...
class WorkflowTemplatesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return IdentityGovernanceWorkflowTemplateCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): IdentityGovernanceWorkflowTemplateCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to IdentityGovernanceWorkflowTemplateCollectionResponse|null
     */
    private function deserializeGet(string $body): IdentityGovernanceWorkflowTemplateCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
