...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\TermsOfUse\AgreementAcceptancesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\TermsOfUse\AgreementsRequestBuilder;

/**
 * Request builder for /identityGovernance/termsOfUse
 */
class TermsOfUseRequestBuilder extends RootBaseRequestBuilder
{
    /**
     ...
     */
    public function get(?array $select = null, ?array $expand = null): TermsOfUseContainer|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to TermsOfUseContainer|null
     */
    private function deserializeGet(string $body): TermsOfUseContainer|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(TermsOfUseContainer $body): TermsOfUseContainer|null
    {
     ...
     * Deserialize response to TermsOfUseContainer|null
     */
    private function deserializePatch(string $body): TermsOfUseContainer|null    {
        if (empty($body)) {
            return null;
        }
