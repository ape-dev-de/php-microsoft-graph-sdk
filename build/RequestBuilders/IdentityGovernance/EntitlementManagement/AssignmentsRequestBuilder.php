...
class AssignmentsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return AccessPackageAssignmentCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): AccessPackageAssignmentCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to AccessPackageAssignmentCollectionResponse|null
     */
    private function deserializeGet(string $body): AccessPackageAssignmentCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(AccessPackageAssignment $body): AccessPackageAssignment|null
    {
     ...
     */
    private function deserializePost(string $body): AccessPackageAssignment|null    {
        if (empty($body)) {
            return null;
        }
