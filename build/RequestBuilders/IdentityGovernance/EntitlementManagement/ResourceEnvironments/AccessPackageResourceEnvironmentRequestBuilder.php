...
class AccessPackageResourceEnvironmentRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(AccessPackageResourceEnvironment $body): AccessPackageResourceEnvironment|null
    {
     ...
     * Deserialize response to AccessPackageResourceEnvironment|null
     */
    private function deserializePatch(string $body): AccessPackageResourceEnvironment|null    {
        if (empty($body)) {
            return null;
        }
