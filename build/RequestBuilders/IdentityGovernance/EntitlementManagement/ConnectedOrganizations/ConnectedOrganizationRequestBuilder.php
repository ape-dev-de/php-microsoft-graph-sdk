...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\EntitlementManagement\ConnectedOrganizations\ExternalSponsorsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\EntitlementManagement\ConnectedOrganizations\InternalSponsorsRequestBuilder;
...
class ConnectedOrganizationRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): ConnectedOrganization|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): ConnectedOrganization|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(ConnectedOrganization $body): ConnectedOrganization|null
    {
     ...
     * Deserialize response to ConnectedOrganization|null
     */
    private function deserializePatch(string $body): ConnectedOrganization|null    {
        if (empty($body)) {
            return null;
        }
