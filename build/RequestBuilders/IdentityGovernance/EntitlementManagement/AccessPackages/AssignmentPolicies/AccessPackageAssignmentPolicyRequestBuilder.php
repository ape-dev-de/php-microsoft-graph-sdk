...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\EntitlementManagement\AccessPackages\AssignmentPolicies\AccessPackageRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\EntitlementManagement\AccessPackages\AssignmentPolicies\CatalogRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\EntitlementManagement\AccessPackages\AssignmentPolicies\CustomExtensionStageSettingsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\EntitlementManagement\AccessPackages\AssignmentPolicies\QuestionsRequestBuilder;

/**
 * Request builder for /identityGovernance/entitlementManagement/accessPackages/{accessPackage-id}/assignmentPolicies/{accessPackageAssignmentPolicy-id}
 */
class AccessPackageAssignmentPolicyRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): AccessPackageAssignmentPolicy|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): AccessPackageAssignmentPolicy|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(AccessPackageAssignmentPolicy $body): AccessPackageAssignmentPolicy|null
    {
     ...
     * Deserialize response to AccessPackageAssignmentPolicy|null
     */
    private function deserializePatch(string $body): AccessPackageAssignmentPolicy|null    {
        if (empty($body)) {
            return null;
        }
