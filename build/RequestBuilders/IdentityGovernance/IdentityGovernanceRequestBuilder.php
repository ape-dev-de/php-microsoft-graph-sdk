...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\AccessReviewsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\AppConsentRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\EntitlementManagementRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\LifecycleWorkflowsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\PrivilegedAccessRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\TermsOfUseRequestBuilder;

/**
 * Request builder for /identityGovernance
 */
class IdentityGovernanceRequestBuilder extends RootBaseRequestBuilder
{
    /**
     ...
     * @return IdentityGovernance|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null): IdentityGovernance|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to IdentityGovernance|null
     */
    private function deserializeGet(string $body): IdentityGovernance|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(IdentityGovernance $body): IdentityGovernance|null
    {
     ...
     * Deserialize response to IdentityGovernance|null
     */
    private function deserializePatch(string $body): IdentityGovernance|null    {
        if (empty($body)) {
            return null;
        }
