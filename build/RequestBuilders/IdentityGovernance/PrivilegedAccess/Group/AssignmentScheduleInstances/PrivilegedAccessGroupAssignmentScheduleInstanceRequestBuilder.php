...
class PrivilegedAccessGroupAssignmentScheduleInstanceRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): PrivilegedAccessGroupAssignmentScheduleInstance|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): PrivilegedAccessGroupAssignmentScheduleInstance|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(PrivilegedAccessGroupAssignmentScheduleInstance $body): PrivilegedAccessGroupAssignmentScheduleInstance|null
    {
     ...
     * Deserialize response to PrivilegedAccessGroupAssignmentScheduleInstance|null
     */
    private function deserializePatch(string $body): PrivilegedAccessGroupAssignmentScheduleInstance|null    {
        if (empty($body)) {
            return null;
        }
