...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\PrivilegedAccess\Group\EligibilitySchedules\PrivilegedAccessGroupEligibilityScheduleRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\PrivilegedAccess\Group\EligibilitySchedules\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\PrivilegedAccess\Group\EligibilitySchedules\FilterByCurrentUserRequestBuilder;
...
class EligibilitySchedulesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return PrivilegedAccessGroupEligibilityScheduleCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): PrivilegedAccessGroupEligibilityScheduleCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to PrivilegedAccessGroupEligibilityScheduleCollectionResponse|null
     */
    private function deserializeGet(string $body): PrivilegedAccessGroupEligibilityScheduleCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(PrivilegedAccessGroupEligibilitySchedule $body): PrivilegedAccessGroupEligibilitySchedule|null
    {
    ...
    /**
     * Deserialize response to PrivilegedAccessGroupEligibilitySchedule|null
     */
    private function deserializePost(string $body): PrivilegedAccessGroupEligibilitySchedule|null    {
        if (empty($body)) {
            return null;
        }
