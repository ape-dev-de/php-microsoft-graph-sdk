...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\PrivilegedAccess\Group\EligibilityScheduleInstances;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\PrivilegedAccessGroupEligibilityScheduleInstance;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\PrivilegedAccess\Group\EligibilityScheduleInstances\GroupRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\PrivilegedAccess\Group\EligibilityScheduleInstances\PrincipalRequestBuilder;
...
class PrivilegedAccessGroupEligibilityScheduleInstanceRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): PrivilegedAccessGroupEligibilityScheduleInstance|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to PrivilegedAccessGroupEligibilityScheduleInstance|null
     */
    private function deserializeGet(string $body): PrivilegedAccessGroupEligibilityScheduleInstance|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(PrivilegedAccessGroupEligibilityScheduleInstance $body): PrivilegedAccessGroupEligibilityScheduleInstance|null
    {
     ...
     * Deserialize response to PrivilegedAccessGroupEligibilityScheduleInstance|null
     */
    private function deserializePatch(string $body): PrivilegedAccessGroupEligibilityScheduleInstance|null    {
        if (empty($body)) {
            return null;
        }
