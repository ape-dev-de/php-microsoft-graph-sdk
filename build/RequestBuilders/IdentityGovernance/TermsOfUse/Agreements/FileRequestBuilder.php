...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\TermsOfUse\Agreements\File\LocalizationsRequestBuilder;

/**
 * Request builder for /identityGovernance/termsOfUse/agreements/{agreement-id}/file
 */
class FileRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): AgreementFile|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to AgreementFile|null
     */
    private function deserializeGet(string $body): AgreementFile|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(AgreementFile $body): AgreementFile|null
    {
     ...
     * Deserialize response to AgreementFile|null
     */
    private function deserializePatch(string $body): AgreementFile|null    {
        if (empty($body)) {
            return null;
        }
