...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\AccessReviews\HistoryDefinitions\Instances\GenerateDownloadUriRequestBuilder;
...
class AccessReviewHistoryInstanceRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): AccessReviewHistoryInstance|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): AccessReviewHistoryInstance|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(AccessReviewHistoryInstance $body): AccessReviewHistoryInstance|null
    {
     ...
     * Deserialize response to AccessReviewHistoryInstance|null
     */
    private function deserializePatch(string $body): AccessReviewHistoryInstance|null    {
        if (empty($body)) {
            return null;
        }
