...
class GenerateDownloadUriRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return AccessReviewHistoryInstance|\stdClass|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(AccessReviewHistoryInstance|\stdClass $body): AccessReviewHistoryInstance|\stdClass|null
    {
    ...
    /**
     * Deserialize response to AccessReviewHistoryInstance|\stdClass|null
     */
    private function deserializePost(string $body): AccessReviewHistoryInstance|\stdClass|null    {
        if (empty($body)) {
            return null;
        }
