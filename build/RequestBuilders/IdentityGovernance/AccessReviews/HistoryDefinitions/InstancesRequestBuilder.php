...
class InstancesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return AccessReviewHistoryInstanceCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): AccessReviewHistoryInstanceCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to AccessReviewHistoryInstanceCollectionResponse|null
     */
    private function deserializeGet(string $body): AccessReviewHistoryInstanceCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @return AccessReviewHistoryInstance|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(AccessReviewHistoryInstance $body): AccessReviewHistoryInstance|null
    {
    ...
    /**
     * Deserialize response to AccessReviewHistoryInstance|null
     */
    private function deserializePost(string $body): AccessReviewHistoryInstance|null    {
        if (empty($body)) {
            return null;
        }
