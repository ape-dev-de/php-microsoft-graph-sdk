...
class AccessReviewInstanceRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): AccessReviewInstance|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): AccessReviewInstance|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(AccessReviewInstance $body): AccessReviewInstance|null
    {
     ...
     * Deserialize response to AccessReviewInstance|null
     */
    private function deserializePatch(string $body): AccessReviewInstance|null    {
        if (empty($body)) {
            return null;
        }
