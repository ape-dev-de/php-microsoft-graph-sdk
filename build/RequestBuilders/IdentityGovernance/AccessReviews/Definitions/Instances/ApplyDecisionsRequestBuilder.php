...
/**
 * Request builder for /identityGovernance/accessReviews/definitions/{accessReviewScheduleDefinition-id}/instances/{accessReviewInstance-id}/applyDecisions
 */
class ApplyDecisionsRequestBuilder extends RootBaseRequestBuilder
{
    /**
