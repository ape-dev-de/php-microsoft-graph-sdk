...
class ContactedReviewersRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return AccessReviewReviewerCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): AccessReviewReviewerCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to AccessReviewReviewerCollectionResponse|null
     */
    private function deserializeGet(string $body): AccessReviewReviewerCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(AccessReviewReviewer $body): AccessReviewReviewer|null
    {
     ...
     */
    private function deserializePost(string $body): AccessReviewReviewer|null    {
        if (empty($body)) {
            return null;
        }
