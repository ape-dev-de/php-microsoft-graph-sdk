...
class InstancesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return AccessReviewInstanceCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): AccessReviewInstanceCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to AccessReviewInstanceCollectionResponse|null
     */
    private function deserializeGet(string $body): AccessReviewInstanceCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(AccessReviewInstance $body): AccessReviewInstance|null
    {
    ...
    /**
     * Deserialize response to AccessReviewInstance|null
     */
    private function deserializePost(string $body): AccessReviewInstance|null    {
        if (empty($body)) {
            return null;
        }
