...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\IdentityGovernance\AccessReviews\DefinitionsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\IdentityGovernance\AccessReviews\HistoryDefinitionsRequestBuilder;
...
class AccessReviewsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): AccessReviewSet
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to AccessReviewSet
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(AccessReviewSet $body): AccessReviewSet
    {
