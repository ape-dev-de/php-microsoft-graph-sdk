...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\IdentityGovernance\EntitlementManagement\ResourceEnvironments\AccessPackageResourceEnvironmentRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\IdentityGovernance\EntitlementManagement\ResourceEnvironments\CountRequestBuilder;
...
class ResourceEnvironmentsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): AccessPackageResourceEnvironmentCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to AccessPackageResourceEnvironmentCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(AccessPackageResourceEnvironment $body): AccessPackageResourceEnvironment
    {
