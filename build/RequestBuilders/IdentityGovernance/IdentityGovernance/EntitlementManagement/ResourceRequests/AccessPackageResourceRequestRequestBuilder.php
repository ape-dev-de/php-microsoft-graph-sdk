...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\IdentityGovernance\EntitlementManagement\ResourceRequests\CatalogRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\IdentityGovernance\EntitlementManagement\ResourceRequests\ResourceRequestBuilder;
...
class AccessPackageResourceRequestRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): AccessPackageResourceRequest
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to AccessPackageResourceRequest
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(AccessPackageResourceRequest $body): AccessPackageResourceRequest
    {
