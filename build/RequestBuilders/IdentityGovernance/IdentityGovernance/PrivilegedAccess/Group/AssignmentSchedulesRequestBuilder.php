...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\IdentityGovernance\PrivilegedAccess\Group\AssignmentSchedules\PrivilegedAccessGroupAssignmentScheduleRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\IdentityGovernance\PrivilegedAccess\Group\AssignmentSchedules\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\IdentityGovernance\PrivilegedAccess\Group\AssignmentSchedules\FilterByCurrentUserRequestBuilder;
...
class AssignmentSchedulesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): PrivilegedAccessGroupAssignmentScheduleCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to PrivilegedAccessGroupAssignmentScheduleCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(PrivilegedAccessGroupAssignmentSchedule $body): PrivilegedAccessGroupAssignmentSchedule
    {
