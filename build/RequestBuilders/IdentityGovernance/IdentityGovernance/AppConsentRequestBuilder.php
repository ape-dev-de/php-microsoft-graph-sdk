...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\IdentityGovernance\AppConsent\AppConsentRequestsRequestBuilder;
...
class AppConsentRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): AppConsentApprovalRoute
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to AppConsentApprovalRoute
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(AppConsentApprovalRoute $body): AppConsentApprovalRoute
    {
