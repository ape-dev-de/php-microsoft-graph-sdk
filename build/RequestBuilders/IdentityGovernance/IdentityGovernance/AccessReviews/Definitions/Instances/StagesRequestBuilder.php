...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\IdentityGovernance\AccessReviews\Definitions\Instances\Stages\AccessReviewStageRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\IdentityGovernance\AccessReviews\Definitions\Instances\Stages\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernance\IdentityGovernance\AccessReviews\Definitions\Instances\Stages\FilterByCurrentUserRequestBuilder;
...
class StagesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): AccessReviewStageCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to AccessReviewStageCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(AccessReviewStage $body): AccessReviewStage
    {
    ...
    /**
     * Deserialize response to AccessReviewStage
     */
