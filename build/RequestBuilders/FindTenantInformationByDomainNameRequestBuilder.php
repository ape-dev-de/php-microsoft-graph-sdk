...
/**
 * Request builder for findTenantInformationByDomainName(domainName='{domainName}')
 */
class FindTenantInformationByDomainNameRequestBuilder extends BaseRequestBuilder
{
    /**
