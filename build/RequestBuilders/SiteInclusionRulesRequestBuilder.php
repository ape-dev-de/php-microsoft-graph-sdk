...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\SiteProtectionRuleRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for siteInclusionRules
 */
class SiteInclusionRulesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new SiteProtectionRuleCollectionResponse([]);
