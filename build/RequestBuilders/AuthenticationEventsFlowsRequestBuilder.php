...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AuthenticationEventsFlowRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\GraphExternalUsersSelfServiceSignUpEventsFlowRequestBuilder;

/**
 * Request builder for authenticationEventsFlows
 */
class AuthenticationEventsFlowsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new AuthenticationEventsFlowCollectionResponse([]);
