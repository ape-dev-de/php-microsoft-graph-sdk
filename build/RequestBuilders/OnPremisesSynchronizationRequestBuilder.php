...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\OnPremisesDirectorySynchronizationRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for onPremisesSynchronization
 */
class OnPremisesSynchronizationRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new OnPremisesDirectorySynchronizationCollectionResponse([]);
