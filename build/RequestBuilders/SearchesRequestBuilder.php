...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\EdiscoverySearchRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for searches
 */
class SearchesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new SecurityEdiscoverySearchCollectionResponse([]);
