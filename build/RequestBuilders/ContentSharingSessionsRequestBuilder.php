...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ContentSharingSessionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for contentSharingSessions
 */
class ContentSharingSessionsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new ContentSharingSessionCollectionResponse([]);
