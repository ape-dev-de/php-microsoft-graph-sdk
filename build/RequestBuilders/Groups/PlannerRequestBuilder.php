...
class PlannerRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): PlannerGroup|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to PlannerGroup|null
     */
    private function deserializeGet(string $body): PlannerGroup|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(string $ifMatch, PlannerGroup $body): PlannerGroup|null
    {
        $queryParams = [];
     ...
     * Deserialize response to PlannerGroup|null
     */
    private function deserializePatch(string $body): PlannerGroup|null    {
        if (empty($body)) {
            return null;
        }
