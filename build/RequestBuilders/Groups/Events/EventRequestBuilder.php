...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Events;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\Event;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Events\AttachmentsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Events\CalendarRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Events\ExtensionsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Events\InstancesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Events\AcceptRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Events\CancelRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Events\DeclineRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Events\DismissReminderRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Events\ForwardRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Events\PermanentDeleteRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Events\SnoozeReminderRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Events\TentativelyAcceptRequestBuilder;

/**
 * Request builder for /groups/{group-id}/events/{event-id}
 */
