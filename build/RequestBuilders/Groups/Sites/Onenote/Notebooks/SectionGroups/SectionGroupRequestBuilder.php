...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\Onenote\Notebooks\SectionGroups\ParentNotebookRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\Onenote\Notebooks\SectionGroups\ParentSectionGroupRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\Onenote\Notebooks\SectionGroups\SectionGroupsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\Onenote\Notebooks\SectionGroups\SectionsRequestBuilder;

/**
 * Request builder for /groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}
 */
class SectionGroupRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SectionGroup $body): SectionGroup|null
    {
     ...
     * Deserialize response to SectionGroup|null
     */
    private function deserializePatch(string $body): SectionGroup|null    {
        if (empty($body)) {
            return null;
        }
