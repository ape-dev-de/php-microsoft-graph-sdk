...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\Analytics\AllTimeRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\Analytics\ItemActivityStatsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\Analytics\LastSevenDaysRequestBuilder;

/**
 * Request builder for /groups/{group-id}/sites/{site-id}/analytics
 */
class AnalyticsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): ItemAnalytics|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to ItemAnalytics|null
     */
    private function deserializeGet(string $body): ItemAnalytics|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(ItemAnalytics $body): ItemAnalytics|null
    {
     ...
     * Deserialize response to ItemAnalytics|null
     */
    private function deserializePatch(string $body): ItemAnalytics|null    {
        if (empty($body)) {
            return null;
        }
