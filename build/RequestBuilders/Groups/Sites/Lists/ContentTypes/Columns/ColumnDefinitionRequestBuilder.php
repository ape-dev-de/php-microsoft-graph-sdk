...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\Lists\ContentTypes\Columns;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\ColumnDefinition;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\Lists\ContentTypes\Columns\SourceColumnRequestBuilder;

/**
 * Request builder for /groups/{group-id}/sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/columns/{columnDefinition-id}
 */
