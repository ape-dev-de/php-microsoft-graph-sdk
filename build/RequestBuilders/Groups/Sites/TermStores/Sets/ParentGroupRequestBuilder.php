...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\TermStores\Sets\ParentGroup\SetsRequestBuilder;

/**
 * Request builder for /groups/{group-id}/sites/{site-id}/termStores/{store-id}/sets/{set-id}/parentGroup
 */
