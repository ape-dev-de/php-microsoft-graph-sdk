...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\Pages\GraphsitePage;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\CanvasLayout;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\Pages\GraphsitePage\CanvasLayout\HorizontalSectionsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\Pages\GraphsitePage\CanvasLayout\VerticalSectionRequestBuilder;

/**
 * Request builder for /groups/{group-id}/sites/{site-id}/pages/{baseSitePage-id}/graph.sitePage/canvasLayout
 */
class CanvasLayoutRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): CanvasLayout|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to CanvasLayout|null
     */
    private function deserializeGet(string $body): CanvasLayout|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(CanvasLayout $body): CanvasLayout|null
    {
     ...
     * Deserialize response to CanvasLayout|null
     */
    private function deserializePatch(string $body): CanvasLayout|null    {
        if (empty($body)) {
            return null;
        }
