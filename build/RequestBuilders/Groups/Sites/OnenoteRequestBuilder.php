...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\Onenote\NotebooksRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\Onenote\OperationsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\Onenote\PagesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\Onenote\ResourcesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\Onenote\SectionGroupsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\Onenote\SectionsRequestBuilder;

/**
 * Request builder for /groups/{group-id}/sites/{site-id}/onenote
 */
class OnenoteRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): Onenote|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to Onenote|null
     */
    private function deserializeGet(string $body): Onenote|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(Onenote $body): Onenote|null
    {
     ...
     * Deserialize response to Onenote|null
     */
    private function deserializePatch(string $body): Onenote|null    {
        if (empty($body)) {
            return null;
        }
