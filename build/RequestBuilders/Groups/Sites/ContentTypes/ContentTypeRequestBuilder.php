...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\ContentTypes;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\ContentType;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\ContentTypes\BaseTypesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\ContentTypes\ColumnLinksRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\ContentTypes\ColumnPositionsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\ContentTypes\ColumnsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\ContentTypes\AssociateWithHubSitesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\ContentTypes\CopyToDefaultContentLocationRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\ContentTypes\IsPublishedRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\ContentTypes\PublishRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\ContentTypes\UnpublishRequestBuilder;

/**
 * Request builder for /groups/{group-id}/sites/{site-id}/contentTypes/{contentType-id}
 */
class ContentTypeRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): ContentType|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): ContentType|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(ContentType $body): ContentType|null
    {
     ...
     * Deserialize response to ContentType|null
     */
    private function deserializePatch(string $body): ContentType|null    {
        if (empty($body)) {
            return null;
        }
