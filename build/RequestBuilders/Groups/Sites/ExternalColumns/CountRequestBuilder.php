...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\ExternalColumns;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;

/**
 * Request builder for /groups/{group-id}/sites/{site-id}/externalColumns/$count
 */
