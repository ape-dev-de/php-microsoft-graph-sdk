...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Calendar\Events\AttachmentsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Calendar\Events\CalendarRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Calendar\Events\ExtensionsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Calendar\Events\InstancesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Calendar\Events\AcceptRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Calendar\Events\CancelRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Calendar\Events\DeclineRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Calendar\Events\DismissReminderRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Calendar\Events\ForwardRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Calendar\Events\PermanentDeleteRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Calendar\Events\SnoozeReminderRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Calendar\Events\TentativelyAcceptRequestBuilder;

/**
 * Request builder for /groups/{group-id}/calendar/events/{event-id}
 */
