...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\SiteRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\AddRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\DeltaRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\GetAllSitesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Sites\RemoveRequestBuilder;

/**
 * Request builder for /groups/{group-id}/sites
 */
class SitesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return SiteCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): SiteCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SiteCollectionResponse|null
     */
    private function deserializeGet(string $body): SiteCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
