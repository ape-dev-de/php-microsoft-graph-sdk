...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Onenote\Notebooks\SectionGroups\Sections\Pages;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\OnenotePage;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Onenote\Notebooks\SectionGroups\Sections\Pages\ContentRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Onenote\Notebooks\SectionGroups\Sections\Pages\CopyToSectionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Onenote\Notebooks\SectionGroups\Sections\Pages\OnenotePatchContentRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Onenote\Notebooks\SectionGroups\Sections\Pages\PreviewRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Onenote\Notebooks\SectionGroups\Sections\Pages\ParentNotebookRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Onenote\Notebooks\SectionGroups\Sections\Pages\ParentSectionRequestBuilder;

/**
 * Request builder for /groups/{group-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}/pages/{onenotePage-id}
 */
class OnenotePageRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): OnenotePage|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): OnenotePage|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(OnenotePage $body): OnenotePage|null
    {
     ...
     * Deserialize response to OnenotePage|null
     */
    private function deserializePatch(string $body): OnenotePage|null    {
        if (empty($body)) {
            return null;
        }
