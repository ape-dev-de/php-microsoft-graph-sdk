...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Onenote\Notebooks\SectionGroups\Sections;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\OnenoteSection;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Onenote\Notebooks\SectionGroups\Sections\CopyToNotebookRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Onenote\Notebooks\SectionGroups\Sections\CopyToSectionGroupRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Onenote\Notebooks\SectionGroups\Sections\PagesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Onenote\Notebooks\SectionGroups\Sections\ParentNotebookRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Onenote\Notebooks\SectionGroups\Sections\ParentSectionGroupRequestBuilder;

/**
 * Request builder for /groups/{group-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}
 */
