...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Team\Channels\Messages\Replies\HostedContents;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\ChatMessageHostedContent;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Team\Channels\Messages\Replies\HostedContents\ValueRequestBuilder;

/**
 * Request builder for /groups/{group-id}/team/channels/{channel-id}/messages/{chatMessage-id}/replies/{chatMessage-id1}/hostedContents/{chatMessageHostedContent-id}
 */
