...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Team\Schedule\OfferShiftRequests\OfferShiftRequestRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Team\Schedule\OfferShiftRequests\CountRequestBuilder;

/**
 * Request builder for /groups/{group-id}/team/schedule/offerShiftRequests
 */
class OfferShiftRequestsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): OfferShiftRequestCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to OfferShiftRequestCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(OfferShiftRequest $body): OfferShiftRequest
    {
