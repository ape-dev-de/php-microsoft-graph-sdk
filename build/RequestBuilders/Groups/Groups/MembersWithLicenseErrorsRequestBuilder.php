...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\MembersWithLicenseErrors\DirectoryObjectRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\MembersWithLicenseErrors\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\MembersWithLicenseErrors\GraphApplicationRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\MembersWithLicenseErrors\GraphDeviceRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\MembersWithLicenseErrors\GraphGroupRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\MembersWithLicenseErrors\GraphOrgContactRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\MembersWithLicenseErrors\GraphServicePrincipalRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\MembersWithLicenseErrors\GraphUserRequestBuilder;

/**
 * Request builder for /groups/{group-id}/membersWithLicenseErrors
 */
class MembersWithLicenseErrorsRequestBuilder extends RootBaseRequestBuilder
{
    /**
