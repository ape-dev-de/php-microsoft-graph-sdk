...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Sites\TermStore\Sets\Terms\Relations;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\TermStoreRelation;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Sites\TermStore\Sets\Terms\Relations\FromTermRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Sites\TermStore\Sets\Terms\Relations\SetRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Sites\TermStore\Sets\Terms\Relations\ToTermRequestBuilder;

/**
 * Request builder for /groups/{group-id}/sites/{site-id}/termStore/sets/{set-id}/terms/{term-id}/relations/{relation-id}
 */
