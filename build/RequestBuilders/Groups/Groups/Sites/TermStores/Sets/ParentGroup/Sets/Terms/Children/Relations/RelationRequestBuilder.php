...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Sites\TermStores\Sets\ParentGroup\Sets\Terms\Children\Relations;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\TermStoreRelation;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Sites\TermStores\Sets\ParentGroup\Sets\Terms\Children\Relations\FromTermRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Sites\TermStores\Sets\ParentGroup\Sets\Terms\Children\Relations\SetRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Sites\TermStores\Sets\ParentGroup\Sets\Terms\Children\Relations\ToTermRequestBuilder;

/**
 * Request builder for /groups/{group-id}/sites/{site-id}/termStores/{store-id}/sets/{set-id}/parentGroup/sets/{set-id1}/terms/{term-id}/children/{term-id1}/relations/{relation-id}
 */
