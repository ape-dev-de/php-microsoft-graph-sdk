...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Events\Instances\DeltaRequestBuilder;

/**
 * Request builder for /groups/{group-id}/events/{event-id}/instances
 */
