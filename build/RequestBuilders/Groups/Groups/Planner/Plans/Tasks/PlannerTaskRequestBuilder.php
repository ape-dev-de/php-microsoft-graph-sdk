...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Planner\Plans\Tasks;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\PlannerTask;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Planner\Plans\Tasks\AssignedToTaskBoardFormatRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Planner\Plans\Tasks\BucketTaskBoardFormatRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Planner\Plans\Tasks\DetailsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Planner\Plans\Tasks\ProgressTaskBoardFormatRequestBuilder;

/**
 * Request builder for /groups/{group-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}
 */
