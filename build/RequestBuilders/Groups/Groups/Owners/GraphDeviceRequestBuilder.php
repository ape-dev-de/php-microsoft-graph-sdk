...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Owners\Graphdevice\CountRequestBuilder;

/**
 * Request builder for /groups/{group-id}/owners/graph.device
 */
