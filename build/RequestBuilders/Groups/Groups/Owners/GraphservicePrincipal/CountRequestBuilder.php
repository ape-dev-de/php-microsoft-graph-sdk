...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Owners\GraphservicePrincipal;
...
/**
 * Request builder for /groups/{group-id}/owners/graph.servicePrincipal/$count
 */
