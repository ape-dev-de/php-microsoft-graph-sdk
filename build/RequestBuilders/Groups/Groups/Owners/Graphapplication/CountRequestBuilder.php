...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Owners\Graphapplication;
...
/**
 * Request builder for /groups/{group-id}/owners/graph.application/$count
 */
