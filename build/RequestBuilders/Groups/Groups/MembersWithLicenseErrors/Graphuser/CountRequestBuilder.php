...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\MembersWithLicenseErrors\Graphuser;
...
/**
 * Request builder for /groups/{group-id}/membersWithLicenseErrors/graph.user/$count
 */
