...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\MembersWithLicenseErrors\Graphapplication;
...
/**
 * Request builder for /groups/{group-id}/membersWithLicenseErrors/graph.application/$count
 */
