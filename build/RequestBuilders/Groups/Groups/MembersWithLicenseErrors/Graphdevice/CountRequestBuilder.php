...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\MembersWithLicenseErrors\Graphdevice;
...
/**
 * Request builder for /groups/{group-id}/membersWithLicenseErrors/graph.device/$count
 */
