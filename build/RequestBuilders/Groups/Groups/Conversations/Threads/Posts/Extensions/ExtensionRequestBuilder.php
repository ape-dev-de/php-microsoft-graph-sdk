...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Conversations\Threads\Posts\Extensions;
...
/**
 * Request builder for /groups/{group-id}/conversations/{conversation-id}/threads/{conversationThread-id}/posts/{post-id}/extensions/{extension-id}
 */
