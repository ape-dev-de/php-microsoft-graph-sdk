...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Conversations\Threads\Posts\InReplyTo\Extensions;
...
/**
 * Request builder for /groups/{group-id}/conversations/{conversation-id}/threads/{conversationThread-id}/posts/{post-id}/inReplyTo/extensions/{extension-id}
 */
