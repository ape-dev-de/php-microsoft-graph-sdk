...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Conversations\Threads\Posts;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\Post;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Conversations\Threads\Posts\AttachmentsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Conversations\Threads\Posts\ExtensionsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Conversations\Threads\Posts\InReplyToRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Conversations\Threads\Posts\ForwardRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\Conversations\Threads\Posts\ReplyRequestBuilder;

/**
 * Request builder for /groups/{group-id}/conversations/{conversation-id}/threads/{conversationThread-id}/posts/{post-id}
 */
