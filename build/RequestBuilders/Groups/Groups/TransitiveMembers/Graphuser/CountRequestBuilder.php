...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\TransitiveMembers\Graphuser;
...
/**
 * Request builder for /groups/{group-id}/transitiveMembers/graph.user/$count
 */
