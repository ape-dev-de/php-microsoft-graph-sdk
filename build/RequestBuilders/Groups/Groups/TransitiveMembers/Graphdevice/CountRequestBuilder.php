...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\TransitiveMembers\Graphdevice;
...
/**
 * Request builder for /groups/{group-id}/transitiveMembers/graph.device/$count
 */
