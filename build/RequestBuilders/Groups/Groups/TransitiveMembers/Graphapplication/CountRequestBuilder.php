...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Groups\Groups\TransitiveMembers\Graphapplication;
...
/**
 * Request builder for /groups/{group-id}/transitiveMembers/graph.application/$count
 */
