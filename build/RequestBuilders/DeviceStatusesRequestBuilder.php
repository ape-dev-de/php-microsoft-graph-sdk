...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ManagedDeviceMobileAppConfigurationDeviceStatusRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for deviceStatuses
 */
class DeviceStatusesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new ManagedDeviceMobileAppConfigurationDeviceStatusCollectionResponse([]);
