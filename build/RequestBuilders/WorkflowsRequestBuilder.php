...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\WorkflowRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for workflows
 */
class WorkflowsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new IdentityGovernanceWorkflowCollectionResponse([]);
