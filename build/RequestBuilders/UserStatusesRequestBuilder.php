...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ManagedDeviceMobileAppConfigurationUserStatusRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for userStatuses
 */
class UserStatusesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new ManagedDeviceMobileAppConfigurationUserStatusCollectionResponse([]);
