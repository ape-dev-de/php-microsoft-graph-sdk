...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\LocalizedNotificationMessageRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for localizedNotificationMessages
 */
class LocalizedNotificationMessagesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new LocalizedNotificationMessageCollectionResponse([]);
