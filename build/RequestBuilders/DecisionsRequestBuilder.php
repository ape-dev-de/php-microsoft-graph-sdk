...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AccessReviewInstanceDecisionItemRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\FilterByCurrentUserRequestBuilder;

/**
 * Request builder for decisions
 */
class DecisionsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new AccessReviewInstanceDecisionItemCollectionResponse([]);
