...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Applications\Applications\HomeRealmDiscoveryPolicies;
...
/**
 * Request builder for /applications/{application-id}/homeRealmDiscoveryPolicies/$count
 */
