...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Applications\Applications\Owners\Graphendpoint;
...
/**
 * Request builder for /applications/{application-id}/owners/graph.endpoint/$count
 */
