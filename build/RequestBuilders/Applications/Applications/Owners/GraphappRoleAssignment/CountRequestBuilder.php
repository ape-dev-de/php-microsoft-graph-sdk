...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Applications\Applications\Owners\GraphappRoleAssignment;
...
/**
 * Request builder for /applications/{application-id}/owners/graph.appRoleAssignment/$count
 */
