...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Applications\Applications\Owners\Graphuser;
...
/**
 * Request builder for /applications/{application-id}/owners/graph.user/$count
 */
