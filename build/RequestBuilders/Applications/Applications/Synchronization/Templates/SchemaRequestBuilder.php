...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Applications\Applications\Synchronization\Templates;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\SynchronizationSchema;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Applications\Applications\Synchronization\Templates\Schema\DirectoriesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Applications\Applications\Synchronization\Templates\Schema\FilterOperatorsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Applications\Applications\Synchronization\Templates\Schema\FunctionsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Applications\Applications\Synchronization\Templates\Schema\ParseExpressionRequestBuilder;

/**
 * Request builder for /applications/{application-id}/synchronization/templates/{synchronizationTemplate-id}/schema
 */
