...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Applications\Owners\GraphappRoleAssignment\CountRequestBuilder;

/**
 * Request builder for /applications/{application-id}/owners/graph.appRoleAssignment
 */
