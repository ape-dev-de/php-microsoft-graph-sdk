...
class ApplicationRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): Application|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): Application|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(Application $body): Application|null
    {
     ...
     * Deserialize response to Application|null
     */
    private function deserializePatch(string $body): Application|null    {
        if (empty($body)) {
            return null;
        }
