...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Applications\Synchronization\Templates\SynchronizationTemplateRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Applications\Synchronization\Templates\CountRequestBuilder;

/**
 * Request builder for /applications/{application-id}/synchronization/templates
 */
class TemplatesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return SynchronizationTemplateCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): SynchronizationTemplateCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SynchronizationTemplateCollectionResponse|null
     */
    private function deserializeGet(string $body): SynchronizationTemplateCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(SynchronizationTemplate $body): SynchronizationTemplate|null
    {
     ...
     */
    private function deserializePost(string $body): SynchronizationTemplate|null    {
        if (empty($body)) {
            return null;
        }
