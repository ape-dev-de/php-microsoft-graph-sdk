...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\MobileAppRelationshipRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for mobileAppRelationships
 */
class MobileAppRelationshipsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new MobileAppRelationshipCollectionResponse([]);
