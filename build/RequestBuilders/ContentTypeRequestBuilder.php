...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseTypesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ColumnLinksRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ColumnPositionsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ColumnsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AssociateWithHubSitesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CopyToDefaultContentLocationRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IsPublishedRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\PublishRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\UnpublishRequestBuilder;

/**
 * Request builder for {contentType-id}
 */
class ContentTypeRequestBuilder extends BaseRequestBuilder
{
    /**
