...
/**
 * Request builder for participants_v2
 */
class ParticipantsV2RequestBuilder extends BaseRequestBuilder
{
    /**
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new CallRecordsParticipantCollectionResponse([]);
