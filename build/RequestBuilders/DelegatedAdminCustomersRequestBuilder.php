...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DelegatedAdminCustomerRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for delegatedAdminCustomers
 */
class DelegatedAdminCustomersRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new DelegatedAdminCustomerCollectionResponse([]);
