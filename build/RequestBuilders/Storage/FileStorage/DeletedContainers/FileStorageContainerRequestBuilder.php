...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Storage\FileStorage\DeletedContainers\ColumnsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Storage\FileStorage\DeletedContainers\DriveRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Storage\FileStorage\DeletedContainers\ActivateRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Storage\FileStorage\DeletedContainers\LockRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Storage\FileStorage\DeletedContainers\PermanentDeleteRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Storage\FileStorage\DeletedContainers\RestoreRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Storage\FileStorage\DeletedContainers\UnlockRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Storage\FileStorage\DeletedContainers\PermissionsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Storage\FileStorage\DeletedContainers\RecycleBinRequestBuilder;

/**
 * Request builder for /storage/fileStorage/deletedContainers/{fileStorageContainer-id}
 */
class FileStorageContainerRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): FileStorageContainer|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): FileStorageContainer|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(FileStorageContainer $body): FileStorageContainer|null
    {
     ...
     * Deserialize response to FileStorageContainer|null
     */
    private function deserializePatch(string $body): FileStorageContainer|null    {
        if (empty($body)) {
            return null;
        }
