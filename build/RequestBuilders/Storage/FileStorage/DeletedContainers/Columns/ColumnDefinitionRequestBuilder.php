...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Storage\FileStorage\DeletedContainers\Columns;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\ColumnDefinition;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Storage\FileStorage\DeletedContainers\Columns\SourceColumnRequestBuilder;

/**
 * Request builder for /storage/fileStorage/deletedContainers/{fileStorageContainer-id}/columns/{columnDefinition-id}
 */
class ColumnDefinitionRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(ColumnDefinition $body): ColumnDefinition|null
    {
     ...
     * Deserialize response to ColumnDefinition|null
     */
    private function deserializePatch(string $body): ColumnDefinition|null    {
        if (empty($body)) {
            return null;
        }
