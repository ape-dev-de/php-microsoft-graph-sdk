...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Storage\FileStorage\Containers\RecycleBin\CreatedByUserRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Storage\FileStorage\Containers\RecycleBin\ItemsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Storage\FileStorage\Containers\RecycleBin\LastModifiedByUserRequestBuilder;

/**
 * Request builder for /storage/fileStorage/containers/{fileStorageContainer-id}/recycleBin
 */
class RecycleBinRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): RecycleBin|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to RecycleBin|null
     */
    private function deserializeGet(string $body): RecycleBin|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(RecycleBin $body): RecycleBin|null
    {
     ...
     * Deserialize response to RecycleBin|null
     */
    private function deserializePatch(string $body): RecycleBin|null    {
        if (empty($body)) {
            return null;
        }
