...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Storage\Storage\FileStorage\DeletedContainers\RecycleBin\Items;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\RecycleBinItem;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Storage\Storage\FileStorage\DeletedContainers\RecycleBin\Items\CreatedByUserRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Storage\Storage\FileStorage\DeletedContainers\RecycleBin\Items\LastModifiedByUserRequestBuilder;

/**
 * Request builder for /storage/fileStorage/deletedContainers/{fileStorageContainer-id}/recycleBin/items/{recycleBinItem-id}
 */
class RecycleBinItemRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): RecycleBinItem
    {
        $queryParams = [];
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(RecycleBinItem $body): RecycleBinItem
    {
