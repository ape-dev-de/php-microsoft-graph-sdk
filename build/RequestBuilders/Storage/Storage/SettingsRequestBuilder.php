...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Storage\Storage\Settings\QuotaRequestBuilder;
...
class SettingsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): StorageSettings
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to StorageSettings
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(StorageSettings $body): StorageSettings
    {
