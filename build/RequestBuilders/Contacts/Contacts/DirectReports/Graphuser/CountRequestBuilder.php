...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Contacts\Contacts\DirectReports\Graphuser;
...
/**
 * Request builder for /contacts/{orgContact-id}/directReports/graph.user/$count
 */
