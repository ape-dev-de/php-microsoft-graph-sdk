...
class IosManagedAppProtectionRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): IosManagedAppProtection|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): IosManagedAppProtection|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(IosManagedAppProtection $body): IosManagedAppProtection|null
    {
     ...
     * Deserialize response to IosManagedAppProtection|null
     */
    private function deserializePatch(string $body): IosManagedAppProtection|null    {
        if (empty($body)) {
            return null;
        }
