...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceAppManagement\MobileApps\GraphmicrosoftStoreForBusinessApp\AssignmentsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceAppManagement\MobileApps\GraphmicrosoftStoreForBusinessApp\CategoriesRequestBuilder;
...
class GraphMicrosoftStoreForBusinessAppRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): MicrosoftStoreForBusinessApp|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to MicrosoftStoreForBusinessApp|null
     */
    private function deserializeGet(string $body): MicrosoftStoreForBusinessApp|null    {
        if (empty($body)) {
            return null;
        }
