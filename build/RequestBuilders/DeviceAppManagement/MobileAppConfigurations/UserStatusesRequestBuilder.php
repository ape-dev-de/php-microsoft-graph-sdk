...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceAppManagement\MobileAppConfigurations\UserStatuses\ManagedDeviceMobileAppConfigurationUserStatusRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceAppManagement\MobileAppConfigurations\UserStatuses\CountRequestBuilder;
...
class UserStatusesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return ManagedDeviceMobileAppConfigurationUserStatusCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): ManagedDeviceMobileAppConfigurationUserStatusCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to ManagedDeviceMobileAppConfigurationUserStatusCollectionResponse|null
     */
    private function deserializeGet(string $body): ManagedDeviceMobileAppConfigurationUserStatusCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @return ManagedDeviceMobileAppConfigurationUserStatus|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(ManagedDeviceMobileAppConfigurationUserStatus $body): ManagedDeviceMobileAppConfigurationUserStatus|null
    {
    ...
    /**
     * Deserialize response to ManagedDeviceMobileAppConfigurationUserStatus|null
     */
    private function deserializePost(string $body): ManagedDeviceMobileAppConfigurationUserStatus|null    {
        if (empty($body)) {
            return null;
        }
