...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceAppManagement\MobileAppConfigurations\DeviceStatuses\ManagedDeviceMobileAppConfigurationDeviceStatusRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceAppManagement\MobileAppConfigurations\DeviceStatuses\CountRequestBuilder;
...
class DeviceStatusesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return ManagedDeviceMobileAppConfigurationDeviceStatusCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): ManagedDeviceMobileAppConfigurationDeviceStatusCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to ManagedDeviceMobileAppConfigurationDeviceStatusCollectionResponse|null
     */
    private function deserializeGet(string $body): ManagedDeviceMobileAppConfigurationDeviceStatusCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(ManagedDeviceMobileAppConfigurationDeviceStatus $body): ManagedDeviceMobileAppConfigurationDeviceStatus|null
    {
     ...
     */
    private function deserializePost(string $body): ManagedDeviceMobileAppConfigurationDeviceStatus|null    {
        if (empty($body)) {
            return null;
        }
