...
class TargetedManagedAppConfigurationsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return TargetedManagedAppConfigurationCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): TargetedManagedAppConfigurationCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to TargetedManagedAppConfigurationCollectionResponse|null
     */
    private function deserializeGet(string $body): TargetedManagedAppConfigurationCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(TargetedManagedAppConfiguration $body): TargetedManagedAppConfiguration|null
    {
     ...
     */
    private function deserializePost(string $body): TargetedManagedAppConfiguration|null    {
        if (empty($body)) {
            return null;
        }
