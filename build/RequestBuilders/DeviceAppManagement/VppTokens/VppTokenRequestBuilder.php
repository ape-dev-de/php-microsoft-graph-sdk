...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceAppManagement\VppTokens\SyncLicensesRequestBuilder;
...
class VppTokenRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): VppToken|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): VppToken|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(VppToken $body): VppToken|null
    {
     ...
     * Deserialize response to VppToken|null
     */
    private function deserializePatch(string $body): VppToken|null    {
        if (empty($body)) {
            return null;
        }
