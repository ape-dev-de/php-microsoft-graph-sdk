...
class ManagedAppRegistrationRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(ManagedAppRegistration $body): ManagedAppRegistration|null
    {
     ...
     * Deserialize response to ManagedAppRegistration|null
     */
    private function deserializePatch(string $body): ManagedAppRegistration|null    {
        if (empty($body)) {
            return null;
        }
