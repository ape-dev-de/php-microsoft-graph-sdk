...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceAppManagement\DeviceAppManagement\DefaultManagedAppProtections\DefaultManagedAppProtectionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceAppManagement\DeviceAppManagement\DefaultManagedAppProtections\CountRequestBuilder;
...
class DefaultManagedAppProtectionsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): DefaultManagedAppProtectionCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to DefaultManagedAppProtectionCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(DefaultManagedAppProtection $body): DefaultManagedAppProtection
    {
