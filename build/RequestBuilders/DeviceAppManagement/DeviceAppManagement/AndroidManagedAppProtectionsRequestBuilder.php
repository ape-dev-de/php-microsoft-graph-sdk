...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceAppManagement\DeviceAppManagement\AndroidManagedAppProtections\AndroidManagedAppProtectionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceAppManagement\DeviceAppManagement\AndroidManagedAppProtections\CountRequestBuilder;
...
class AndroidManagedAppProtectionsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): AndroidManagedAppProtectionCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to AndroidManagedAppProtectionCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(AndroidManagedAppProtection $body): AndroidManagedAppProtection
    {
