...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceAppManagement\DeviceAppManagement\ManagedEBooks\Assignments\ManagedEBookAssignmentRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceAppManagement\DeviceAppManagement\ManagedEBooks\Assignments\CountRequestBuilder;
...
class AssignmentsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): ManagedEBookAssignmentCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to ManagedEBookAssignmentCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(ManagedEBookAssignment $body): ManagedEBookAssignment
    {
    ...
    /**
     * Deserialize response to ManagedEBookAssignment
     */
