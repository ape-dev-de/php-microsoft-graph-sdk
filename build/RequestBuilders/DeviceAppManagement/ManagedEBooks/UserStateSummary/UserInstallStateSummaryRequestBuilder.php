...
class UserInstallStateSummaryRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): UserInstallStateSummary|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): UserInstallStateSummary|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(UserInstallStateSummary $body): UserInstallStateSummary|null
    {
     ...
     * Deserialize response to UserInstallStateSummary|null
     */
    private function deserializePatch(string $body): UserInstallStateSummary|null    {
        if (empty($body)) {
            return null;
        }
