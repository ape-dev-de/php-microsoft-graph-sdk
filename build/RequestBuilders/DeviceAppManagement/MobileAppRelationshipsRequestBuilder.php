...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceAppManagement\MobileAppRelationships\MobileAppRelationshipRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceAppManagement\MobileAppRelationships\CountRequestBuilder;
...
class MobileAppRelationshipsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return MobileAppRelationshipCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): MobileAppRelationshipCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to MobileAppRelationshipCollectionResponse|null
     */
    private function deserializeGet(string $body): MobileAppRelationshipCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @return MobileAppRelationship|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(MobileAppRelationship $body): MobileAppRelationship|null
    {
    ...
    /**
     * Deserialize response to MobileAppRelationship|null
     */
    private function deserializePost(string $body): MobileAppRelationship|null    {
        if (empty($body)) {
            return null;
        }
