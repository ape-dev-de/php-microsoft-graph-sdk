...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AuthenticationStrengthPolicyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for authenticationStrengthPolicies
 */
class AuthenticationStrengthPoliciesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new AuthenticationStrengthPolicyCollectionResponse([]);
