...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\SoftwareOathAuthenticationMethodRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for softwareOathMethods
 */
class SoftwareOathMethodsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new SoftwareOathAuthenticationMethodCollectionResponse([]);
