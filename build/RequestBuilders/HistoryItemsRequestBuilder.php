...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ActivityHistoryItemRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for historyItems
 */
class HistoryItemsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new ActivityHistoryItemCollectionResponse([]);
