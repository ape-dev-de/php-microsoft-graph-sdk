...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Connections\Operations\ConnectionOperationRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Connections\Operations\CountRequestBuilder;

/**
 * Request builder for /connections/{externalConnection-id}/operations
 */
class OperationsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return ExternalConnectorsConnectionOperationCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): ExternalConnectorsConnectionOperationCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to ExternalConnectorsConnectionOperationCollectionResponse|null
     */
    private function deserializeGet(string $body): ExternalConnectorsConnectionOperationCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(ExternalConnectorsConnectionOperation $body): ExternalConnectorsConnectionOperation|null
    {
     ...
     */
    private function deserializePost(string $body): ExternalConnectorsConnectionOperation|null    {
        if (empty($body)) {
            return null;
        }
