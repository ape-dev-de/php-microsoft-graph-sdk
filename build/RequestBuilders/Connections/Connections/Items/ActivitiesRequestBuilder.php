...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Connections\Connections\Items;
...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Connections\Connections\Items\Activities\ExternalActivityRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Connections\Connections\Items\Activities\CountRequestBuilder;

/**
 * Request builder for /connections/{externalConnection-id}/items/{externalItem-id}/activities
 */
class ActivitiesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): ExternalConnectorsExternalActivityCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to ExternalConnectorsExternalActivityCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(ExternalConnectorsExternalActivity $body): ExternalConnectorsExternalActivity
    {
