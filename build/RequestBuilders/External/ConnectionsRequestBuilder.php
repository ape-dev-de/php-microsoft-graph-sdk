...
class ConnectionsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return ExternalConnectorsExternalConnectionCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): ExternalConnectorsExternalConnectionCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to ExternalConnectorsExternalConnectionCollectionResponse|null
     */
    private function deserializeGet(string $body): ExternalConnectorsExternalConnectionCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(ExternalConnectorsExternalConnection $body): ExternalConnectorsExternalConnection|null
    {
     ...
     */
    private function deserializePost(string $body): ExternalConnectorsExternalConnection|null    {
        if (empty($body)) {
            return null;
        }
