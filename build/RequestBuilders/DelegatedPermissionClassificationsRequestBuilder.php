...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DelegatedPermissionClassificationRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for delegatedPermissionClassifications
 */
class DelegatedPermissionClassificationsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new DelegatedPermissionClassificationCollectionResponse([]);
