...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceComplianceActionItemRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for scheduledActionConfigurations
 */
class ScheduledActionConfigurationsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new DeviceComplianceActionItemCollectionResponse([]);
