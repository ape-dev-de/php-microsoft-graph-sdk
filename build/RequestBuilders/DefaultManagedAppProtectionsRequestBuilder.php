...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DefaultManagedAppProtectionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for defaultManagedAppProtections
 */
class DefaultManagedAppProtectionsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new DefaultManagedAppProtectionCollectionResponse([]);
