...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DirectoryRoles\MembersRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DirectoryRoles\CheckMemberGroupsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DirectoryRoles\CheckMemberObjectsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DirectoryRoles\GetMemberGroupsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DirectoryRoles\GetMemberObjectsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DirectoryRoles\RestoreRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DirectoryRoles\ScopedMembersRequestBuilder;

/**
 * Request builder for /directoryRoles/{directoryRole-id}
 */
class DirectoryRoleRequestBuilder extends RootBaseRequestBuilder
{
    /**
     * Get directoryRole
     *
     ...
     */
    public function get(?array $select = null, ?array $expand = null): DirectoryRole|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): DirectoryRole|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(DirectoryRole $body): DirectoryRole|null
    {
     ...
     * Deserialize response to DirectoryRole|null
     */
    private function deserializePatch(string $body): DirectoryRole|null    {
        if (empty($body)) {
            return null;
        }
