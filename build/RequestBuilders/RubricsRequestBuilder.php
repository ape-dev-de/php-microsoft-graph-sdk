...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\EducationRubricRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for rubrics
 */
class RubricsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new EducationRubricCollectionResponse([]);
