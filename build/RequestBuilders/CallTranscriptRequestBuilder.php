...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\MetadataContentRequestBuilder;

/**
 * Request builder for {callTranscript-id}
 */
class CallTranscriptRequestBuilder extends BaseRequestBuilder
{
    /**
