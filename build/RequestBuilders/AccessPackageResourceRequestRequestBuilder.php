...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ResourceRequestBuilder;

/**
 * Request builder for {accessPackageResourceRequest-id}
 */
class AccessPackageResourceRequestRequestBuilder extends BaseRequestBuilder
{
    /**
