...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AccessReviewReviewerRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for contactedReviewers
 */
class ContactedReviewersRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new AccessReviewReviewerCollectionResponse([]);
