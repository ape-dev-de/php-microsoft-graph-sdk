...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\LinkedResourceRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for linkedResources
 */
class LinkedResourcesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new LinkedResourceCollectionResponse([]);
