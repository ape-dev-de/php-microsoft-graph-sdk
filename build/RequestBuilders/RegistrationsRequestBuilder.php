...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\VirtualEventRegistrationRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for registrations
 */
class RegistrationsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new VirtualEventRegistrationCollectionResponse([]);
