...
/**
 * Request builder for microsoft.graph.security.regenerateDeploymentAccessKey
 */
class SecurityRegenerateDeploymentAccessKeyRequestBuilder extends BaseRequestBuilder
{
    /**
