...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AllowedValuesRequestBuilder;

/**
 * Request builder for {customSecurityAttributeDefinition-id}
 */
class CustomSecurityAttributeDefinitionRequestBuilder extends BaseRequestBuilder
{
    /**
