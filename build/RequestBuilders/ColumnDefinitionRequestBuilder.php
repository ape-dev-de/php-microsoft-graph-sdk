...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\SourceColumnRequestBuilder;

/**
 * Request builder for {columnDefinition-id}
 */
class ColumnDefinitionRequestBuilder extends BaseRequestBuilder
{
    /**
