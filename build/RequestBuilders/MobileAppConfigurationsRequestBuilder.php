...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ManagedDeviceMobileAppConfigurationRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for mobileAppConfigurations
 */
class MobileAppConfigurationsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new ManagedDeviceMobileAppConfigurationCollectionResponse([]);
