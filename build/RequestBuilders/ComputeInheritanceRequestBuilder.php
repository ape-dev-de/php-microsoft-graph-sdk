...
/**
 * Request builder for computeInheritance(labelIds={labelIds},locale='{locale}',contentFormats={contentFormats})
 */
class ComputeInheritanceRequestBuilder extends BaseRequestBuilder
{
    /**
