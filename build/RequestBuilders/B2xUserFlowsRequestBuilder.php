...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\B2xIdentityUserFlowRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for b2xUserFlows
 */
class B2xUserFlowsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new B2xIdentityUserFlowCollectionResponse([]);
