...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\OnlineMeetingRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CreateOrGetRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\GetAllRecordingsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\GetAllTranscriptsRequestBuilder;

/**
 * Request builder for onlineMeetings
 */
class OnlineMeetingsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new OnlineMeetingCollectionResponse([]);
