...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CloudPcUserSettingRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for userSettings
 */
class UserSettingsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new CloudPcUserSettingCollectionResponse([]);
