...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\EducationSchoolRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeltaRequestBuilder;

/**
 * Request builder for schools
 */
class SchoolsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new EducationSchoolCollectionResponse([]);
