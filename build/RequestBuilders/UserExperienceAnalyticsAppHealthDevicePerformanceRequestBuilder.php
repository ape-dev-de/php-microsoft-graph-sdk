...
/**
 * Request builder for userExperienceAnalyticsAppHealthDevicePerformance
 */
class UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new UserExperienceAnalyticsAppHealthDevicePerformanceCollectionResponse([]);
