...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\VirtualEventTownhallRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\GetByUserIdAndRoleRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\GetByUserRoleRequestBuilder;

/**
 * Request builder for townhalls
 */
class TownhallsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new VirtualEventTownhallCollectionResponse([]);
