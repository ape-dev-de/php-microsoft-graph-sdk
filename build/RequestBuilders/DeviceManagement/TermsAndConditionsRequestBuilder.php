...
class TermsAndConditionsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return TermsAndConditionsCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): TermsAndConditionsCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to TermsAndConditionsCollectionResponse|null
     */
    private function deserializeGet(string $body): TermsAndConditionsCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(TermsAndConditions $body): TermsAndConditions|null
    {
     ...
     */
    private function deserializePost(string $body): TermsAndConditions|null    {
        if (empty($body)) {
            return null;
        }
