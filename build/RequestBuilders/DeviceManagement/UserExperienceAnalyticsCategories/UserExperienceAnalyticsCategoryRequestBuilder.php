...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\UserExperienceAnalyticsCategories\MetricValuesRequestBuilder;

/**
 * Request builder for /deviceManagement/userExperienceAnalyticsCategories/{userExperienceAnalyticsCategory-id}
 */
class UserExperienceAnalyticsCategoryRequestBuilder extends RootBaseRequestBuilder
{
    /**
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(UserExperienceAnalyticsCategory $body): UserExperienceAnalyticsCategory|null
    {
     ...
     * Deserialize response to UserExperienceAnalyticsCategory|null
     */
    private function deserializePatch(string $body): UserExperienceAnalyticsCategory|null    {
        if (empty($body)) {
            return null;
        }
