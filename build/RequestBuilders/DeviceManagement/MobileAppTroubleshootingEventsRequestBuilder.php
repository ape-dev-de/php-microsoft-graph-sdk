...
class MobileAppTroubleshootingEventsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return MobileAppTroubleshootingEventCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): MobileAppTroubleshootingEventCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to MobileAppTroubleshootingEventCollectionResponse|null
     */
    private function deserializeGet(string $body): MobileAppTroubleshootingEventCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(MobileAppTroubleshootingEvent $body): MobileAppTroubleshootingEvent|null
    {
     ...
     */
    private function deserializePost(string $body): MobileAppTroubleshootingEvent|null    {
        if (empty($body)) {
            return null;
        }
