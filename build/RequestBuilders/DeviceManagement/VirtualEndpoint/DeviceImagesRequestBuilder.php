...
class DeviceImagesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return CloudPcDeviceImageCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): CloudPcDeviceImageCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to CloudPcDeviceImageCollectionResponse|null
     */
    private function deserializeGet(string $body): CloudPcDeviceImageCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(CloudPcDeviceImage $body): CloudPcDeviceImage|null
    {
     ...
     */
    private function deserializePost(string $body): CloudPcDeviceImage|null    {
        if (empty($body)) {
            return null;
        }
