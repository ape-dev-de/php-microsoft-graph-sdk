...
class CloudPcGalleryImageRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): CloudPcGalleryImage|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): CloudPcGalleryImage|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(CloudPcGalleryImage $body): CloudPcGalleryImage|null
    {
     ...
     * Deserialize response to CloudPcGalleryImage|null
     */
    private function deserializePatch(string $body): CloudPcGalleryImage|null    {
        if (empty($body)) {
            return null;
        }
