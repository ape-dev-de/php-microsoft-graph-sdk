...
class RemoteAssistancePartnersRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return RemoteAssistancePartnerCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): RemoteAssistancePartnerCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to RemoteAssistancePartnerCollectionResponse|null
     */
    private function deserializeGet(string $body): RemoteAssistancePartnerCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @return RemoteAssistancePartner|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(RemoteAssistancePartner $body): RemoteAssistancePartner|null
    {
    ...
    /**
     * Deserialize response to RemoteAssistancePartner|null
     */
    private function deserializePost(string $body): RemoteAssistancePartner|null    {
        if (empty($body)) {
            return null;
        }
