 ...
 */
class UserExperienceAnalyticsAppHealthDevicePerformanceDetailsItemRequestBuilder extends RootBaseRequestBuilder
{
    /**
     ...
     */
    public function get(?array $select = null, ?array $expand = null): UserExperienceAnalyticsAppHealthDevicePerformanceDetails|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): UserExperienceAnalyticsAppHealthDevicePerformanceDetails|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(UserExperienceAnalyticsAppHealthDevicePerformanceDetails $body): UserExperienceAnalyticsAppHealthDevicePerformanceDetails|null
    {
     ...
     * Deserialize response to UserExperienceAnalyticsAppHealthDevicePerformanceDetails|null
     */
    private function deserializePatch(string $body): UserExperienceAnalyticsAppHealthDevicePerformanceDetails|null    {
        if (empty($body)) {
            return null;
        }
