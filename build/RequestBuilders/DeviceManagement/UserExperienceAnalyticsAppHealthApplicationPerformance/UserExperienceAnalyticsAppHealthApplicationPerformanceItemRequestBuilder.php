...
class UserExperienceAnalyticsAppHealthApplicationPerformanceItemRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): UserExperienceAnalyticsAppHealthApplicationPerformance|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): UserExperienceAnalyticsAppHealthApplicationPerformance|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(UserExperienceAnalyticsAppHealthApplicationPerformance $body): UserExperienceAnalyticsAppHealthApplicationPerformance|null
    {
     ...
     * Deserialize response to UserExperienceAnalyticsAppHealthApplicationPerformance|null
     */
    private function deserializePatch(string $body): UserExperienceAnalyticsAppHealthApplicationPerformance|null    {
        if (empty($body)) {
            return null;
        }
