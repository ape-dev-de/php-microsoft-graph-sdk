...
class RemoteAssistancePartnerRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): RemoteAssistancePartner|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): RemoteAssistancePartner|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(RemoteAssistancePartner $body): RemoteAssistancePartner|null
    {
     ...
     * Deserialize response to RemoteAssistancePartner|null
     */
    private function deserializePatch(string $body): RemoteAssistancePartner|null    {
        if (empty($body)) {
            return null;
        }
