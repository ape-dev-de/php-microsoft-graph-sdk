...
class DeviceManagementExchangeConnectorRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): DeviceManagementExchangeConnector|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): DeviceManagementExchangeConnector|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(DeviceManagementExchangeConnector $body): DeviceManagementExchangeConnector|null
    {
     ...
     * Deserialize response to DeviceManagementExchangeConnector|null
     */
    private function deserializePatch(string $body): DeviceManagementExchangeConnector|null    {
        if (empty($body)) {
            return null;
        }
