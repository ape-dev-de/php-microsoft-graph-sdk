...
class UserExperienceAnalyticsBaselineRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): UserExperienceAnalyticsBaseline|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): UserExperienceAnalyticsBaseline|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(UserExperienceAnalyticsBaseline $body): UserExperienceAnalyticsBaseline|null
    {
     ...
     * Deserialize response to UserExperienceAnalyticsBaseline|null
     */
    private function deserializePatch(string $body): UserExperienceAnalyticsBaseline|null    {
        if (empty($body)) {
            return null;
        }
