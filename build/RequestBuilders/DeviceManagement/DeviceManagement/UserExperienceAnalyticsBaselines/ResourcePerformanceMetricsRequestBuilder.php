...
/**
 * Request builder for /deviceManagement/userExperienceAnalyticsBaselines/{userExperienceAnalyticsBaseline-id}/resourcePerformanceMetrics
 */
class ResourcePerformanceMetricsRequestBuilder extends RootBaseRequestBuilder
{
    /**
