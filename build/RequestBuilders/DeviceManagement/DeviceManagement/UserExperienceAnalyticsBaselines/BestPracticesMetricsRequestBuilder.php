...
/**
 * Request builder for /deviceManagement/userExperienceAnalyticsBaselines/{userExperienceAnalyticsBaseline-id}/bestPracticesMetrics
 */
class BestPracticesMetricsRequestBuilder extends RootBaseRequestBuilder
{
    /**
