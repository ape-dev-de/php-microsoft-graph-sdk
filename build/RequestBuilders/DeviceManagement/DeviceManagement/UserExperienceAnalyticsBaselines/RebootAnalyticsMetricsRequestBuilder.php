...
/**
 * Request builder for /deviceManagement/userExperienceAnalyticsBaselines/{userExperienceAnalyticsBaseline-id}/rebootAnalyticsMetrics
 */
class RebootAnalyticsMetricsRequestBuilder extends RootBaseRequestBuilder
{
    /**
