...
/**
 * Request builder for /deviceManagement/userExperienceAnalyticsBaselines/{userExperienceAnalyticsBaseline-id}/appHealthMetrics
 */
class AppHealthMetricsRequestBuilder extends RootBaseRequestBuilder
{
    /**
