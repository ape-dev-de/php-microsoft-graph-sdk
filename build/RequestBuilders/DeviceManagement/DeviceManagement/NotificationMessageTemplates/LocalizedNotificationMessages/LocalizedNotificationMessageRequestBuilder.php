...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\NotificationMessageTemplates\LocalizedNotificationMessages;
...
class LocalizedNotificationMessageRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): LocalizedNotificationMessage
    {
        $queryParams = [];
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(LocalizedNotificationMessage $body): LocalizedNotificationMessage
    {
