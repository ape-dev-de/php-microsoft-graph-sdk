...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\TermsAndConditions;
...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\TermsAndConditions\Assignments\TermsAndConditionsAssignmentRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\TermsAndConditions\Assignments\CountRequestBuilder;
...
class AssignmentsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): TermsAndConditionsAssignmentCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to TermsAndConditionsAssignmentCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(TermsAndConditionsAssignment $body): TermsAndConditionsAssignment
    {
