...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\VirtualEndpoint\ProvisioningPolicies\CloudPcProvisioningPolicyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\VirtualEndpoint\ProvisioningPolicies\CountRequestBuilder;
...
class ProvisioningPoliciesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): CloudPcProvisioningPolicyCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to CloudPcProvisioningPolicyCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(CloudPcProvisioningPolicy $body): CloudPcProvisioningPolicy
    {
