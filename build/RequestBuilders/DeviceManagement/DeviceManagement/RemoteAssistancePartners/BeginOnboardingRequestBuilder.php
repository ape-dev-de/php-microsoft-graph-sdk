...
/**
 * Request builder for /deviceManagement/remoteAssistancePartners/{remoteAssistancePartner-id}/beginOnboarding
 */
class BeginOnboardingRequestBuilder extends RootBaseRequestBuilder
{
    /**
