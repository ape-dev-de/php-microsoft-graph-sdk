...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\UserExperienceAnalyticsWorkFromAnywhereModelPerformance;
...
class UserExperienceAnalyticsWorkFromAnywhereModelPerformanceRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): UserExperienceAnalyticsWorkFromAnywhereModelPerformance
    {
        $queryParams = [];
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(UserExperienceAnalyticsWorkFromAnywhereModelPerformance $body): UserExperienceAnalyticsWorkFromAnywhereModelPerformance
    {
