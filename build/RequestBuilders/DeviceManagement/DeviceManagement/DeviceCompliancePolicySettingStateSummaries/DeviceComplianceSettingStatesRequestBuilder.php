...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\DeviceCompliancePolicySettingStateSummaries;
...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\DeviceCompliancePolicySettingStateSummaries\DeviceComplianceSettingStates\DeviceComplianceSettingStateRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\DeviceCompliancePolicySettingStateSummaries\DeviceComplianceSettingStates\CountRequestBuilder;
...
class DeviceComplianceSettingStatesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): DeviceComplianceSettingStateCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to DeviceComplianceSettingStateCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(DeviceComplianceSettingState $body): DeviceComplianceSettingState
    {
    ...
    /**
     * Deserialize response to DeviceComplianceSettingState
     */
