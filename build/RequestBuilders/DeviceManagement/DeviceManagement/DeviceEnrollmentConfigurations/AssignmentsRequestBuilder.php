...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\DeviceEnrollmentConfigurations;
...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\DeviceEnrollmentConfigurations\Assignments\EnrollmentConfigurationAssignmentRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\DeviceEnrollmentConfigurations\Assignments\CountRequestBuilder;
...
class AssignmentsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): EnrollmentConfigurationAssignmentCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to EnrollmentConfigurationAssignmentCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(EnrollmentConfigurationAssignment $body): EnrollmentConfigurationAssignment
    {
