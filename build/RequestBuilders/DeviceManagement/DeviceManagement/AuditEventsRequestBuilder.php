...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\AuditEvents\AuditEventRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\AuditEvents\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\AuditEvents\GetAuditActivityTypesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\AuditEvents\GetAuditCategoriesRequestBuilder;

/**
 * Request builder for /deviceManagement/auditEvents
 */
class AuditEventsRequestBuilder extends RootBaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new AuditEventCollectionResponse($data);
