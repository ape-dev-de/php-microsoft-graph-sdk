...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\TermsAndConditions\TermsAndConditionsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\TermsAndConditions\CountRequestBuilder;

/**
 * Request builder for /deviceManagement/termsAndConditions
 */
class TermsAndConditionsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): TermsAndConditionsCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to TermsAndConditionsCollectionResponse
     */
    private function deserializeGet(string $body): mixed
    {
        ...
        foreach ($data['value'] ?? [] as $item) {
            $items[] = new TermsAndConditions($item);
        }
        $collection = new TermsAndConditionsCollectionResponse($data);
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(TermsAndConditions $body): TermsAndConditions
    {
