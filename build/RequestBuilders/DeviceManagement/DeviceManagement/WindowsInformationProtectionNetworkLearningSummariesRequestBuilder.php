...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\WindowsInformationProtectionNetworkLearningSummaries\WindowsInformationProtectionNetworkLearningSummaryRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\WindowsInformationProtectionNetworkLearningSummaries\CountRequestBuilder;
...
class WindowsInformationProtectionNetworkLearningSummariesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): WindowsInformationProtectionNetworkLearningSummaryCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to WindowsInformationProtectionNetworkLearningSummaryCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(WindowsInformationProtectionNetworkLearningSummary $body): WindowsInformationProtectionNetworkLearningSummary
    {
