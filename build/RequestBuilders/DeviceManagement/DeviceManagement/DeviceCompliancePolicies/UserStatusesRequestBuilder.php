...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\DeviceCompliancePolicies\UserStatuses\DeviceComplianceUserStatusRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\DeviceCompliancePolicies\UserStatuses\CountRequestBuilder;
...
class UserStatusesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): DeviceComplianceUserStatusCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to DeviceComplianceUserStatusCollectionResponse
     */
