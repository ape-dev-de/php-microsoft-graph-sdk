...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\UserExperienceAnalyticsDeviceScores\UserExperienceAnalyticsDeviceScoresRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceManagement\UserExperienceAnalyticsDeviceScores\CountRequestBuilder;
...
class UserExperienceAnalyticsDeviceScoresRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function byId(string $userExperienceAnalyticsDeviceScoresId): UserExperienceAnalyticsDeviceScoresRequestBuilder
    {
        return new UserExperienceAnalyticsDeviceScoresRequestBuilder($this->client, $this->requestUrl . '/' . $userExperienceAnalyticsDeviceScoresId);
    }
    /**
     * Navigate to $count
     *
