...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\RoleDefinitions\RoleAssignments\RoleDefinitionRequestBuilder;
...
class RoleAssignmentRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): RoleAssignment|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): RoleAssignment|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(RoleAssignment $body): RoleAssignment|null
    {
     ...
     * Deserialize response to RoleAssignment|null
     */
    private function deserializePatch(string $body): RoleAssignment|null    {
        if (empty($body)) {
            return null;
        }
