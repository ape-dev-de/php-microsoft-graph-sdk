...
class UserExperienceAnalyticsDeviceScoresRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return UserExperienceAnalyticsDeviceScoresCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): UserExperienceAnalyticsDeviceScoresCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to UserExperienceAnalyticsDeviceScoresCollectionResponse|null
     */
    private function deserializeGet(string $body): UserExperienceAnalyticsDeviceScoresCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(UserExperienceAnalyticsDeviceScores $body): UserExperienceAnalyticsDeviceScores|null
    {
     ...
     */
    private function deserializePost(string $body): UserExperienceAnalyticsDeviceScores|null    {
        if (empty($body)) {
            return null;
        }
