...
class DeviceStatusOverviewRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): DeviceConfigurationDeviceOverview|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to DeviceConfigurationDeviceOverview|null
     */
    private function deserializeGet(string $body): DeviceConfigurationDeviceOverview|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(DeviceConfigurationDeviceOverview $body): DeviceConfigurationDeviceOverview|null
    {
     ...
     * Deserialize response to DeviceConfigurationDeviceOverview|null
     */
    private function deserializePatch(string $body): DeviceConfigurationDeviceOverview|null    {
        if (empty($body)) {
            return null;
        }
