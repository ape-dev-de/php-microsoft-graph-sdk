...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceConfigurations\DeviceStatuses\DeviceConfigurationDeviceStatusRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceConfigurations\DeviceStatuses\CountRequestBuilder;
...
class DeviceStatusesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return DeviceConfigurationDeviceStatusCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): DeviceConfigurationDeviceStatusCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to DeviceConfigurationDeviceStatusCollectionResponse|null
     */
    private function deserializeGet(string $body): DeviceConfigurationDeviceStatusCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(DeviceConfigurationDeviceStatus $body): DeviceConfigurationDeviceStatus|null
    {
     ...
     */
    private function deserializePost(string $body): DeviceConfigurationDeviceStatus|null    {
        if (empty($body)) {
            return null;
        }
