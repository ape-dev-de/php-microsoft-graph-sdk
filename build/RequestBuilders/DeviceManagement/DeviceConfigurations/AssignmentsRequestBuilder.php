...
class AssignmentsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return DeviceConfigurationAssignmentCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): DeviceConfigurationAssignmentCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to DeviceConfigurationAssignmentCollectionResponse|null
     */
    private function deserializeGet(string $body): DeviceConfigurationAssignmentCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(DeviceConfigurationAssignment $body): DeviceConfigurationAssignment|null
    {
     ...
     */
    private function deserializePost(string $body): DeviceConfigurationAssignment|null    {
        if (empty($body)) {
            return null;
        }
