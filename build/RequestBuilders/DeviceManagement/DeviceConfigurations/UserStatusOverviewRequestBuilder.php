...
class UserStatusOverviewRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): DeviceConfigurationUserOverview|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to DeviceConfigurationUserOverview|null
     */
    private function deserializeGet(string $body): DeviceConfigurationUserOverview|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(DeviceConfigurationUserOverview $body): DeviceConfigurationUserOverview|null
    {
     ...
     * Deserialize response to DeviceConfigurationUserOverview|null
     */
    private function deserializePatch(string $body): DeviceConfigurationUserOverview|null    {
        if (empty($body)) {
            return null;
        }
