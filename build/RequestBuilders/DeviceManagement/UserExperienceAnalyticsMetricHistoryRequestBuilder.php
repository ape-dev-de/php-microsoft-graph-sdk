...
/**
 * Request builder for /deviceManagement/userExperienceAnalyticsMetricHistory
 */
class UserExperienceAnalyticsMetricHistoryRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return UserExperienceAnalyticsMetricHistoryCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): UserExperienceAnalyticsMetricHistoryCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to UserExperienceAnalyticsMetricHistoryCollectionResponse|null
     */
    private function deserializeGet(string $body): UserExperienceAnalyticsMetricHistoryCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
        ...
        foreach ($data['value'] ?? [] as $item) {
            $items[] = new UserExperienceAnalyticsMetricHistory($item);
        }
        $collection = new UserExperienceAnalyticsMetricHistoryCollectionResponse($data);
     ...
     * @return UserExperienceAnalyticsMetricHistory|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(UserExperienceAnalyticsMetricHistory $body): UserExperienceAnalyticsMetricHistory|null
    {
    ...
    /**
     * Deserialize response to UserExperienceAnalyticsMetricHistory|null
     */
    private function deserializePost(string $body): UserExperienceAnalyticsMetricHistory|null    {
        if (empty($body)) {
            return null;
        }
