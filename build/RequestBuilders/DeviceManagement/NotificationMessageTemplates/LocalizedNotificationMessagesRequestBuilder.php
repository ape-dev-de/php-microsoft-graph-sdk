...
class LocalizedNotificationMessagesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return LocalizedNotificationMessageCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): LocalizedNotificationMessageCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to LocalizedNotificationMessageCollectionResponse|null
     */
    private function deserializeGet(string $body): LocalizedNotificationMessageCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(LocalizedNotificationMessage $body): LocalizedNotificationMessage|null
    {
     ...
     */
    private function deserializePost(string $body): LocalizedNotificationMessage|null    {
        if (empty($body)) {
            return null;
        }
