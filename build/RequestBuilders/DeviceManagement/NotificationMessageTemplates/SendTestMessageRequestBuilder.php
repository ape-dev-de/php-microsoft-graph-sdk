...
/**
 * Request builder for /deviceManagement/notificationMessageTemplates/{notificationMessageTemplate-id}/sendTestMessage
 */
class SendTestMessageRequestBuilder extends RootBaseRequestBuilder
{
    /**
