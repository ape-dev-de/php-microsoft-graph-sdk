...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\NotificationMessageTemplates\LocalizedNotificationMessagesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\NotificationMessageTemplates\SendTestMessageRequestBuilder;

/**
 * Request builder for /deviceManagement/notificationMessageTemplates/{notificationMessageTemplate-id}
 */
class NotificationMessageTemplateRequestBuilder extends RootBaseRequestBuilder
{
    /**
     ...
     */
    public function get(?array $select = null, ?array $expand = null): NotificationMessageTemplate|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): NotificationMessageTemplate|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(NotificationMessageTemplate $body): NotificationMessageTemplate|null
    {
     ...
     * Deserialize response to NotificationMessageTemplate|null
     */
    private function deserializePatch(string $body): NotificationMessageTemplate|null    {
        if (empty($body)) {
            return null;
        }
