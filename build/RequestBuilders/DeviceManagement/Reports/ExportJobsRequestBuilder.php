...
class ExportJobsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return DeviceManagementExportJobCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): DeviceManagementExportJobCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to DeviceManagementExportJobCollectionResponse|null
     */
    private function deserializeGet(string $body): DeviceManagementExportJobCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @return DeviceManagementExportJob|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(DeviceManagementExportJob $body): DeviceManagementExportJob|null
    {
    ...
    /**
     * Deserialize response to DeviceManagementExportJob|null
     */
    private function deserializePost(string $body): DeviceManagementExportJob|null    {
        if (empty($body)) {
            return null;
        }
