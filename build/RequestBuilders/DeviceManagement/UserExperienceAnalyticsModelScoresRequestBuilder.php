...
class UserExperienceAnalyticsModelScoresRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return UserExperienceAnalyticsModelScoresCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): UserExperienceAnalyticsModelScoresCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to UserExperienceAnalyticsModelScoresCollectionResponse|null
     */
    private function deserializeGet(string $body): UserExperienceAnalyticsModelScoresCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(UserExperienceAnalyticsModelScores $body): UserExperienceAnalyticsModelScores|null
    {
     ...
     */
    private function deserializePost(string $body): UserExperienceAnalyticsModelScores|null    {
        if (empty($body)) {
            return null;
        }
