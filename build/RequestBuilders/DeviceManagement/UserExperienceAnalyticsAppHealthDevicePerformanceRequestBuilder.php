...
/**
 * Request builder for /deviceManagement/userExperienceAnalyticsAppHealthDevicePerformance
 */
class UserExperienceAnalyticsAppHealthDevicePerformanceRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return UserExperienceAnalyticsAppHealthDevicePerformanceCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): UserExperienceAnalyticsAppHealthDevicePerformanceCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to UserExperienceAnalyticsAppHealthDevicePerformanceCollectionResponse|null
     */
    private function deserializeGet(string $body): UserExperienceAnalyticsAppHealthDevicePerformanceCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
        ...
        foreach ($data['value'] ?? [] as $item) {
            $items[] = new UserExperienceAnalyticsAppHealthDevicePerformance($item);
        }
        $collection = new UserExperienceAnalyticsAppHealthDevicePerformanceCollectionResponse($data);
     ...
     * @return UserExperienceAnalyticsAppHealthDevicePerformance|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(UserExperienceAnalyticsAppHealthDevicePerformance $body): UserExperienceAnalyticsAppHealthDevicePerformance|null
    {
    ...
    /**
     * Deserialize response to UserExperienceAnalyticsAppHealthDevicePerformance|null
     */
    private function deserializePost(string $body): UserExperienceAnalyticsAppHealthDevicePerformance|null    {
        if (empty($body)) {
            return null;
        }
