 ...
 */
class UserExperienceAnalyticsAppHealthDevicePerformanceItemRequestBuilder extends RootBaseRequestBuilder
{
    /**
     ...
     */
    public function get(?array $select = null, ?array $expand = null): UserExperienceAnalyticsAppHealthDevicePerformance|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): UserExperienceAnalyticsAppHealthDevicePerformance|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(UserExperienceAnalyticsAppHealthDevicePerformance $body): UserExperienceAnalyticsAppHealthDevicePerformance|null
    {
     ...
     * Deserialize response to UserExperienceAnalyticsAppHealthDevicePerformance|null
     */
    private function deserializePatch(string $body): UserExperienceAnalyticsAppHealthDevicePerformance|null    {
        if (empty($body)) {
            return null;
        }
