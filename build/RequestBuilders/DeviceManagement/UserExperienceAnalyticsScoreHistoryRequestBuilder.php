...
class UserExperienceAnalyticsScoreHistoryRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return UserExperienceAnalyticsScoreHistoryCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): UserExperienceAnalyticsScoreHistoryCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to UserExperienceAnalyticsScoreHistoryCollectionResponse|null
     */
    private function deserializeGet(string $body): UserExperienceAnalyticsScoreHistoryCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(UserExperienceAnalyticsScoreHistory $body): UserExperienceAnalyticsScoreHistory|null
    {
     ...
     */
    private function deserializePost(string $body): UserExperienceAnalyticsScoreHistory|null    {
        if (empty($body)) {
            return null;
        }
