...
class UserExperienceAnalyticsWorkFromAnywhereModelPerformanceRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return UserExperienceAnalyticsWorkFromAnywhereModelPerformanceCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): UserExperienceAnalyticsWorkFromAnywhereModelPerformanceCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to UserExperienceAnalyticsWorkFromAnywhereModelPerformanceCollectionResponse|null
     */
    private function deserializeGet(string $body): UserExperienceAnalyticsWorkFromAnywhereModelPerformanceCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(UserExperienceAnalyticsWorkFromAnywhereModelPerformance $body): UserExperienceAnalyticsWorkFromAnywhereModelPerformance|null
    {
     ...
     */
    private function deserializePost(string $body): UserExperienceAnalyticsWorkFromAnywhereModelPerformance|null    {
        if (empty($body)) {
            return null;
        }
