...
class UserExperienceAnalyticsAppHealthOSVersionPerformanceRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return UserExperienceAnalyticsAppHealthOSVersionPerformanceCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): UserExperienceAnalyticsAppHealthOSVersionPerformanceCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to UserExperienceAnalyticsAppHealthOSVersionPerformanceCollectionResponse|null
     */
    private function deserializeGet(string $body): UserExperienceAnalyticsAppHealthOSVersionPerformanceCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(UserExperienceAnalyticsAppHealthOSVersionPerformance $body): UserExperienceAnalyticsAppHealthOSVersionPerformance|null
    {
     ...
     */
    private function deserializePost(string $body): UserExperienceAnalyticsAppHealthOSVersionPerformance|null    {
        if (empty($body)) {
            return null;
        }
