...
class WindowsAutopilotDeviceIdentityRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): WindowsAutopilotDeviceIdentity|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): WindowsAutopilotDeviceIdentity|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(WindowsAutopilotDeviceIdentity $body): WindowsAutopilotDeviceIdentity|null
    {
     ...
     * Deserialize response to WindowsAutopilotDeviceIdentity|null
     */
    private function deserializePatch(string $body): WindowsAutopilotDeviceIdentity|null    {
        if (empty($body)) {
            return null;
        }
