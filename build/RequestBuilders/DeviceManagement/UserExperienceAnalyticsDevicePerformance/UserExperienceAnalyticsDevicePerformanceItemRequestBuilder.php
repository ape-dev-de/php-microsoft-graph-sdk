...
class UserExperienceAnalyticsDevicePerformanceItemRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): UserExperienceAnalyticsDevicePerformance|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): UserExperienceAnalyticsDevicePerformance|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(UserExperienceAnalyticsDevicePerformance $body): UserExperienceAnalyticsDevicePerformance|null
    {
     ...
     * Deserialize response to UserExperienceAnalyticsDevicePerformance|null
     */
    private function deserializePatch(string $body): UserExperienceAnalyticsDevicePerformance|null    {
        if (empty($body)) {
            return null;
        }
