...
class DeviceCompliancePolicyRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): DeviceCompliancePolicy|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): DeviceCompliancePolicy|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(DeviceCompliancePolicy $body): DeviceCompliancePolicy|null
    {
     ...
     * Deserialize response to DeviceCompliancePolicy|null
     */
    private function deserializePatch(string $body): DeviceCompliancePolicy|null    {
        if (empty($body)) {
            return null;
        }
