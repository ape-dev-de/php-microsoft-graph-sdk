...
class AssignmentsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return DeviceCompliancePolicyAssignmentCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): DeviceCompliancePolicyAssignmentCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to DeviceCompliancePolicyAssignmentCollectionResponse|null
     */
    private function deserializeGet(string $body): DeviceCompliancePolicyAssignmentCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(DeviceCompliancePolicyAssignment $body): DeviceCompliancePolicyAssignment|null
    {
     ...
     */
    private function deserializePost(string $body): DeviceCompliancePolicyAssignment|null    {
        if (empty($body)) {
            return null;
        }
