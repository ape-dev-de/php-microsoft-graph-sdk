...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceCompliancePolicies\ScheduledActionsForRule\ScheduledActionConfigurations\DeviceComplianceActionItemRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\DeviceCompliancePolicies\ScheduledActionsForRule\ScheduledActionConfigurations\CountRequestBuilder;
...
class ScheduledActionConfigurationsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return DeviceComplianceActionItemCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): DeviceComplianceActionItemCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to DeviceComplianceActionItemCollectionResponse|null
     */
    private function deserializeGet(string $body): DeviceComplianceActionItemCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @return DeviceComplianceActionItem|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(DeviceComplianceActionItem $body): DeviceComplianceActionItem|null
    {
    ...
    /**
     * Deserialize response to DeviceComplianceActionItem|null
     */
    private function deserializePost(string $body): DeviceComplianceActionItem|null    {
        if (empty($body)) {
            return null;
        }
