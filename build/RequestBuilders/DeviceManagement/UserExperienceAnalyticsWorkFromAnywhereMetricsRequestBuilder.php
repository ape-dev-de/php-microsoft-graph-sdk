...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\UserExperienceAnalyticsWorkFromAnywhereMetrics\UserExperienceAnalyticsWorkFromAnywhereMetricRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\UserExperienceAnalyticsWorkFromAnywhereMetrics\CountRequestBuilder;
...
class UserExperienceAnalyticsWorkFromAnywhereMetricsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return UserExperienceAnalyticsWorkFromAnywhereMetricCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): UserExperienceAnalyticsWorkFromAnywhereMetricCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to UserExperienceAnalyticsWorkFromAnywhereMetricCollectionResponse|null
     */
    private function deserializeGet(string $body): UserExperienceAnalyticsWorkFromAnywhereMetricCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @return UserExperienceAnalyticsWorkFromAnywhereMetric|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(UserExperienceAnalyticsWorkFromAnywhereMetric $body): UserExperienceAnalyticsWorkFromAnywhereMetric|null
    {
    ...
    /**
     * Deserialize response to UserExperienceAnalyticsWorkFromAnywhereMetric|null
     */
    private function deserializePost(string $body): UserExperienceAnalyticsWorkFromAnywhereMetric|null    {
        if (empty($body)) {
            return null;
        }
