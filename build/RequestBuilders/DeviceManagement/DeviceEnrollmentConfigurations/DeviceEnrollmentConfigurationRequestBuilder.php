...
class DeviceEnrollmentConfigurationRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): DeviceEnrollmentConfiguration|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): DeviceEnrollmentConfiguration|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(DeviceEnrollmentConfiguration $body): DeviceEnrollmentConfiguration|null
    {
     ...
     * Deserialize response to DeviceEnrollmentConfiguration|null
     */
    private function deserializePatch(string $body): DeviceEnrollmentConfiguration|null    {
        if (empty($body)) {
            return null;
        }
