...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\DeviceCategoryRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\DeviceCompliancePolicyStatesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\DeviceConfigurationStatesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\LogCollectionRequestsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\BypassActivationLockRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\CleanWindowsDeviceRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\DeleteUserFromSharedAppleDeviceRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\DisableLostModeRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\LocateDeviceRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\LogoutSharedAppleDeviceActiveUserRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\RebootNowRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\RecoverPasscodeRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\RemoteLockRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\RequestRemoteAssistanceRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\ResetPasscodeRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\RetireRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\ShutDownRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\SyncDeviceRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\UpdateWindowsDeviceAccountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\WindowsDefenderScanRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\WindowsDefenderUpdateSignaturesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\WipeRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\UsersRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagement\ManagedDevices\WindowsProtectionStateRequestBuilder;
...
class ManagedDeviceRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(ManagedDevice $body): ManagedDevice|null
    {
     ...
     * Deserialize response to ManagedDevice|null
     */
    private function deserializePatch(string $body): ManagedDevice|null    {
        if (empty($body)) {
            return null;
        }
