...
class DeviceManagementPartnerRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): DeviceManagementPartner|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): DeviceManagementPartner|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(DeviceManagementPartner $body): DeviceManagementPartner|null
    {
     ...
     * Deserialize response to DeviceManagementPartner|null
     */
    private function deserializePatch(string $body): DeviceManagementPartner|null    {
        if (empty($body)) {
            return null;
        }
