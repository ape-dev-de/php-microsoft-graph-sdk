...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ActivityBasedTimeoutPolicyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for activityBasedTimeoutPolicies
 */
class ActivityBasedTimeoutPoliciesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new ActivityBasedTimeoutPolicyCollectionResponse([]);
