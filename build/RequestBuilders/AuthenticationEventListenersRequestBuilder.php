...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AuthenticationEventListenerRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for authenticationEventListeners
 */
class AuthenticationEventListenersRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new AuthenticationEventListenerCollectionResponse([]);
