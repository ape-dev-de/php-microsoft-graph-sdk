...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RunHealthChecksRequestBuilder;

/**
 * Request builder for {cloudPcOnPremisesConnection-id}
 */
class CloudPcOnPremisesConnectionRequestBuilder extends BaseRequestBuilder
{
    /**
