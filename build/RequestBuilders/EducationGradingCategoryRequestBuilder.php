...
/**
 * Request builder for {educationGradingCategory-id}
 */
class EducationGradingCategoryRequestBuilder extends BaseRequestBuilder
{
    /**
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(EducationGradingCategory $body): EducationGradingCategory
    {
