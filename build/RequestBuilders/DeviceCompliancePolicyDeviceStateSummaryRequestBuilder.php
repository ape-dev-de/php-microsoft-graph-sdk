...
/**
 * Request builder for deviceCompliancePolicyDeviceStateSummary
 */
class DeviceCompliancePolicyDeviceStateSummaryRequestBuilder extends BaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): DeviceCompliancePolicyDeviceStateSummary
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to DeviceCompliancePolicyDeviceStateSummary
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(DeviceCompliancePolicyDeviceStateSummary $body): DeviceCompliancePolicyDeviceStateSummary
    {
