...
/**
 * Request builder for playPrompt
 */
class PlayPromptRequestBuilder extends BaseRequestBuilder
{
     ...
     * @return PlayPromptOperation|\stdClass
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(PlayPromptOperation|\stdClass $body): PlayPromptOperation|\stdClass
    {
    ...
    /**
     * Deserialize response to PlayPromptOperation|\stdClass
     */
