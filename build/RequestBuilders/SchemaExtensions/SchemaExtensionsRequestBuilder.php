...
class SchemaExtensionsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return SchemaExtensionCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): SchemaExtensionCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SchemaExtensionCollectionResponse|null
     */
    private function deserializeGet(string $body): SchemaExtensionCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(SchemaExtension $body): SchemaExtension|null
    {
     ...
     */
    private function deserializePost(string $body): SchemaExtension|null    {
        if (empty($body)) {
            return null;
        }
