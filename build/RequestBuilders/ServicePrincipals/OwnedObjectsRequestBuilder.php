...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ServicePrincipals\OwnedObjects\DirectoryObjectRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ServicePrincipals\OwnedObjects\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ServicePrincipals\OwnedObjects\GraphApplicationRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ServicePrincipals\OwnedObjects\GraphAppRoleAssignmentRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ServicePrincipals\OwnedObjects\GraphEndpointRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ServicePrincipals\OwnedObjects\GraphGroupRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ServicePrincipals\OwnedObjects\GraphServicePrincipalRequestBuilder;

/**
 * Request builder for /servicePrincipals/{servicePrincipal-id}/ownedObjects
 */
class OwnedObjectsRequestBuilder extends RootBaseRequestBuilder
{
    /**
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): DirectoryObjectCollectionResponse|null
    {
        $queryParams = [];
