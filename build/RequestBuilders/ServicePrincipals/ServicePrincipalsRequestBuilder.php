...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ServicePrincipals\ServicePrincipals\ServicePrincipalRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ServicePrincipals\ServicePrincipals\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ServicePrincipals\ServicePrincipals\DeltaRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ServicePrincipals\ServicePrincipals\GetAvailableExtensionPropertiesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ServicePrincipals\ServicePrincipals\GetByIdsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ServicePrincipals\ServicePrincipals\ValidatePropertiesRequestBuilder;

/**
 * Request builder for /servicePrincipals
 */
class ServicePrincipalsRequestBuilder extends RootBaseRequestBuilder
{
    /**
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        foreach ($data['value'] ?? [] as $item) {
            $items[] = new ServicePrincipal($item);
        }
        $collection = new ServicePrincipalCollectionResponse($data);
     ...
     *
     * @param string $servicePrincipalId The item ID
     * @return ServicePrincipalRequestBuilder
     */
    public function byId(string $servicePrincipalId): ServicePrincipalRequestBuilder
    {
        return new ServicePrincipalRequestBuilder($this->client, $this->requestUrl . '/' . $servicePrincipalId);
    }
    /**
     * Navigate to $count
     *
