...
/**
 * Request builder for /servicePrincipals/{servicePrincipal-id}/synchronization/acquireAccessToken
 */
class AcquireAccessTokenRequestBuilder extends RootBaseRequestBuilder
{
    /**
