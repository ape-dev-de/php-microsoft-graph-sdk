...
class DelegatedPermissionClassificationsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return DelegatedPermissionClassificationCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): DelegatedPermissionClassificationCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to DelegatedPermissionClassificationCollectionResponse|null
     */
    private function deserializeGet(string $body): DelegatedPermissionClassificationCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(DelegatedPermissionClassification $body): DelegatedPermissionClassification|null
    {
     ...
     */
    private function deserializePost(string $body): DelegatedPermissionClassification|null    {
        if (empty($body)) {
            return null;
        }
