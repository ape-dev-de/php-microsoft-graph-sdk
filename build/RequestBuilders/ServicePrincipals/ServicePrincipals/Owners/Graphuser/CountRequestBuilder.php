...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ServicePrincipals\ServicePrincipals\Owners\Graphuser;
...
/**
 * Request builder for /servicePrincipals/{servicePrincipal-id}/owners/graph.user/$count
 */
