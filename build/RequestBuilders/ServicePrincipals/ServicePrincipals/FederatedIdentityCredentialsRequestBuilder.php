...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ServicePrincipals\ServicePrincipals\FederatedIdentityCredentials\FederatedIdentityCredentialRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ServicePrincipals\ServicePrincipals\FederatedIdentityCredentials\CountRequestBuilder;

/**
 * Request builder for /servicePrincipals/{servicePrincipal-id}/federatedIdentityCredentials
 */
class FederatedIdentityCredentialsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): FederatedIdentityCredentialCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to FederatedIdentityCredentialCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(FederatedIdentityCredential $body): FederatedIdentityCredential
    {
    ...
    /**
     * Deserialize response to FederatedIdentityCredential
     */
