...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ServicePrincipals\ServicePrincipals\AppRoleAssignedTo\AppRoleAssignmentRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ServicePrincipals\ServicePrincipals\AppRoleAssignedTo\CountRequestBuilder;

/**
 * Request builder for /servicePrincipals/{servicePrincipal-id}/appRoleAssignedTo
 */
class AppRoleAssignedToRequestBuilder extends RootBaseRequestBuilder
{
    /**
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): AppRoleAssignmentCollectionResponse
    {
        $queryParams = [];
