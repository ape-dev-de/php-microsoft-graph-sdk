...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AuthenticationCombinationConfigurationRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for combinationConfigurations
 */
class CombinationConfigurationsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new AuthenticationCombinationConfigurationCollectionResponse([]);
