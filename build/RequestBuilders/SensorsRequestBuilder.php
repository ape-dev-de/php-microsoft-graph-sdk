...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\SensorRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\MicrosoftgraphsecuritygetDeploymentAccessKeyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\MicrosoftgraphsecuritygetDeploymentPackageUriRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\SecurityRegenerateDeploymentAccessKeyRequestBuilder;

/**
 * Request builder for sensors
 */
class SensorsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new SecuritySensorCollectionResponse([]);
