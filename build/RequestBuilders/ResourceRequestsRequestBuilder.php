...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AccessPackageResourceRequestRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for resourceRequests
 */
class ResourceRequestsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new AccessPackageResourceRequestCollectionResponse([]);
