...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDetailsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for userExperienceAnalyticsAppHealthApplicationPerformanceByAppVersionDetails
 */
class UserExperienceAnalyticsAppHealthApplicationPerformanceByAppVersionDetailsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDetailsCollectionResponse([]);
