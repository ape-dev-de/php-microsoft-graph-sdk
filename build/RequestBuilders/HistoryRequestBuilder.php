...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RiskyServicePrincipalHistoryItemRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for history
 */
class HistoryRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new RiskyServicePrincipalHistoryItemCollectionResponse([]);
