...
/**
 * Request builder for /oauth2PermissionGrants/{oAuth2PermissionGrant-id}
 */
class OAuth2PermissionGrantRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): OAuth2PermissionGrant|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to OAuth2PermissionGrant|null
     */
    private function deserializeGet(string $body): OAuth2PermissionGrant|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(OAuth2PermissionGrant $body): OAuth2PermissionGrant|null
    {
     ...
     * Deserialize response to OAuth2PermissionGrant|null
     */
    private function deserializePatch(string $body): OAuth2PermissionGrant|null    {
        if (empty($body)) {
            return null;
        }
