...
class DelegatedAdminRelationshipsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return DelegatedAdminRelationshipCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): DelegatedAdminRelationshipCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to DelegatedAdminRelationshipCollectionResponse|null
     */
    private function deserializeGet(string $body): DelegatedAdminRelationshipCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @return DelegatedAdminRelationship|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(DelegatedAdminRelationship $body): DelegatedAdminRelationship|null
    {
    ...
    /**
     * Deserialize response to DelegatedAdminRelationship|null
     */
    private function deserializePost(string $body): DelegatedAdminRelationship|null    {
        if (empty($body)) {
            return null;
        }
