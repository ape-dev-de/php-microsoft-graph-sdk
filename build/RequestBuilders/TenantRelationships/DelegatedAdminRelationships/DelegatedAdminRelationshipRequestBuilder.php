...
class DelegatedAdminRelationshipRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): DelegatedAdminRelationship|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): DelegatedAdminRelationship|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(DelegatedAdminRelationship $body): DelegatedAdminRelationship|null
    {
     ...
     * Deserialize response to DelegatedAdminRelationship|null
     */
    private function deserializePatch(string $body): DelegatedAdminRelationship|null    {
        if (empty($body)) {
            return null;
        }
