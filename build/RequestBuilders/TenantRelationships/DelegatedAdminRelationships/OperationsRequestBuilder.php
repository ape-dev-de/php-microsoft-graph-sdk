...
class OperationsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return DelegatedAdminRelationshipOperationCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): DelegatedAdminRelationshipOperationCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to DelegatedAdminRelationshipOperationCollectionResponse|null
     */
    private function deserializeGet(string $body): DelegatedAdminRelationshipOperationCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(DelegatedAdminRelationshipOperation $body): DelegatedAdminRelationshipOperation|null
    {
     ...
     */
    private function deserializePost(string $body): DelegatedAdminRelationshipOperation|null    {
        if (empty($body)) {
            return null;
        }
