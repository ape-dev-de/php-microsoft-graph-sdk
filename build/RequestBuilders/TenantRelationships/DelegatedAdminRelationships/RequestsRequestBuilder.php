...
class RequestsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return DelegatedAdminRelationshipRequestCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): DelegatedAdminRelationshipRequestCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to DelegatedAdminRelationshipRequestCollectionResponse|null
     */
    private function deserializeGet(string $body): DelegatedAdminRelationshipRequestCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(DelegatedAdminRelationshipRequest $body): DelegatedAdminRelationshipRequest|null
    {
     ...
     */
    private function deserializePost(string $body): DelegatedAdminRelationshipRequest|null    {
        if (empty($body)) {
            return null;
        }
