...
class ServiceManagementDetailsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return DelegatedAdminServiceManagementDetailCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): DelegatedAdminServiceManagementDetailCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to DelegatedAdminServiceManagementDetailCollectionResponse|null
     */
    private function deserializeGet(string $body): DelegatedAdminServiceManagementDetailCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(DelegatedAdminServiceManagementDetail $body): DelegatedAdminServiceManagementDetail|null
    {
     ...
     */
    private function deserializePost(string $body): DelegatedAdminServiceManagementDetail|null    {
        if (empty($body)) {
            return null;
        }
