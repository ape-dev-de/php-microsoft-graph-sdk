...
class DelegatedAdminCustomerRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): DelegatedAdminCustomer|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): DelegatedAdminCustomer|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(DelegatedAdminCustomer $body): DelegatedAdminCustomer|null
    {
     ...
     * Deserialize response to DelegatedAdminCustomer|null
     */
    private function deserializePatch(string $body): DelegatedAdminCustomer|null    {
        if (empty($body)) {
            return null;
        }
