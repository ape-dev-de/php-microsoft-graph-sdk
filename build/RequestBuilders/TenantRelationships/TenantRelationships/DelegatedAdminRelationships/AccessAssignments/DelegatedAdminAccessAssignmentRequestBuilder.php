...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\TenantRelationships\TenantRelationships\DelegatedAdminRelationships\AccessAssignments;
...
class DelegatedAdminAccessAssignmentRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): DelegatedAdminAccessAssignment
    {
        $queryParams = [];
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(DelegatedAdminAccessAssignment $body): DelegatedAdminAccessAssignment
    {
