...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\TaskProcessingResultRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for taskProcessingResults
 */
class TaskProcessingResultsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new IdentityGovernanceTaskProcessingResultCollectionResponse([]);
