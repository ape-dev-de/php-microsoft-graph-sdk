...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Identity\Identity\AuthenticationEventsFlows;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\ExternalUsersSelfServiceSignUpEventsFlow;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Identity\Identity\AuthenticationEventsFlows\GraphexternalUsersSelfServiceSignUpEventsFlow\ConditionsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Identity\Identity\AuthenticationEventsFlows\GraphexternalUsersSelfServiceSignUpEventsFlow\OnAttributeCollectionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Identity\Identity\AuthenticationEventsFlows\GraphexternalUsersSelfServiceSignUpEventsFlow\OnAuthenticationMethodLoadStartRequestBuilder;

/**
 * Request builder for /identity/authenticationEventsFlows/{authenticationEventsFlow-id}/graph.externalUsersSelfServiceSignUpEventsFlow
 */
class GraphExternalUsersSelfServiceSignUpEventsFlowRequestBuilder extends RootBaseRequestBuilder
{
    /**
