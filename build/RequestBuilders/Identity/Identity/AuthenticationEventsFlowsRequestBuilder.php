...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Identity\Identity\AuthenticationEventsFlows\AuthenticationEventsFlowRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Identity\Identity\AuthenticationEventsFlows\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Identity\Identity\AuthenticationEventsFlows\GraphExternalUsersSelfServiceSignUpEventsFlowRequestBuilder;
...
class AuthenticationEventsFlowsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): AuthenticationEventsFlowCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to AuthenticationEventsFlowCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(AuthenticationEventsFlow $body): AuthenticationEventsFlow
    {
