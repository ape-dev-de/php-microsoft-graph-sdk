...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Identity\Identity\ConditionalAccess\AuthenticationContextClassReferences\AuthenticationContextClassReferenceRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Identity\Identity\ConditionalAccess\AuthenticationContextClassReferences\CountRequestBuilder;
...
class AuthenticationContextClassReferencesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): AuthenticationContextClassReferenceCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to AuthenticationContextClassReferenceCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(AuthenticationContextClassReference $body): AuthenticationContextClassReference
    {
    ...
    /**
     * Deserialize response to AuthenticationContextClassReference
     */
