...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Identity\Identity\ConditionalAccess\NamedLocations;
...
class NamedLocationRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): NamedLocation
    {
        $queryParams = [];
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(NamedLocation $body): NamedLocation
    {
