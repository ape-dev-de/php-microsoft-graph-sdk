...
class ApiConnectorsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return IdentityApiConnectorCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): IdentityApiConnectorCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to IdentityApiConnectorCollectionResponse|null
     */
    private function deserializeGet(string $body): IdentityApiConnectorCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(IdentityApiConnector $body): IdentityApiConnector|null
    {
     ...
     */
    private function deserializePost(string $body): IdentityApiConnector|null    {
        if (empty($body)) {
            return null;
        }
