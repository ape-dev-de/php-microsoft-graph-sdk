...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Identity\B2xUserFlows\IdentityProviders\IdentityProviderRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Identity\B2xUserFlows\IdentityProviders\CountRequestBuilder;
...
class IdentityProvidersRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return IdentityProviderCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): IdentityProviderCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to IdentityProviderCollectionResponse|null
     */
    private function deserializeGet(string $body): IdentityProviderCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
