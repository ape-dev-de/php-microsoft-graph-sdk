...
class B2xIdentityUserFlowRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): B2xIdentityUserFlow|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): B2xIdentityUserFlow|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(B2xIdentityUserFlow $body): B2xIdentityUserFlow|null
    {
     ...
     * Deserialize response to B2xIdentityUserFlow|null
     */
    private function deserializePatch(string $body): B2xIdentityUserFlow|null    {
        if (empty($body)) {
            return null;
        }
