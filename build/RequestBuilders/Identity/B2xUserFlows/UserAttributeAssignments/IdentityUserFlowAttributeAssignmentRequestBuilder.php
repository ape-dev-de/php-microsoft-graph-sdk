...
class IdentityUserFlowAttributeAssignmentRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): IdentityUserFlowAttributeAssignment|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): IdentityUserFlowAttributeAssignment|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(IdentityUserFlowAttributeAssignment $body): IdentityUserFlowAttributeAssignment|null
    {
     ...
     * Deserialize response to IdentityUserFlowAttributeAssignment|null
     */
    private function deserializePatch(string $body): IdentityUserFlowAttributeAssignment|null    {
        if (empty($body)) {
            return null;
        }
