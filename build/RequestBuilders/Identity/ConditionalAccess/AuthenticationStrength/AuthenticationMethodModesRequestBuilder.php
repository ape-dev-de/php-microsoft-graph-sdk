...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Identity\ConditionalAccess\AuthenticationStrength\AuthenticationMethodModes\AuthenticationMethodModeDetailRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Identity\ConditionalAccess\AuthenticationStrength\AuthenticationMethodModes\CountRequestBuilder;
...
class AuthenticationMethodModesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return AuthenticationMethodModeDetailCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): AuthenticationMethodModeDetailCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to AuthenticationMethodModeDetailCollectionResponse|null
     */
    private function deserializeGet(string $body): AuthenticationMethodModeDetailCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(AuthenticationMethodModeDetail $body): AuthenticationMethodModeDetail|null
    {
     ...
     */
    private function deserializePost(string $body): AuthenticationMethodModeDetail|null    {
        if (empty($body)) {
            return null;
        }
