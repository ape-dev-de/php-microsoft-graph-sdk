...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Identity\ConditionalAccess\AuthenticationStrength\Policies\CombinationConfigurations\AuthenticationCombinationConfigurationRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Identity\ConditionalAccess\AuthenticationStrength\Policies\CombinationConfigurations\CountRequestBuilder;

/**
 * Request builder for /identity/conditionalAccess/authenticationStrength/policies/{authenticationStrengthPolicy-id}/combinationConfigurations
 */
class CombinationConfigurationsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return AuthenticationCombinationConfigurationCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): AuthenticationCombinationConfigurationCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to AuthenticationCombinationConfigurationCollectionResponse|null
     */
    private function deserializeGet(string $body): AuthenticationCombinationConfigurationCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(AuthenticationCombinationConfiguration $body): AuthenticationCombinationConfiguration|null
    {
     ...
     */
    private function deserializePost(string $body): AuthenticationCombinationConfiguration|null    {
        if (empty($body)) {
            return null;
        }
