...
class TemplatesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return ConditionalAccessTemplateCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): ConditionalAccessTemplateCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to ConditionalAccessTemplateCollectionResponse|null
     */
    private function deserializeGet(string $body): ConditionalAccessTemplateCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
