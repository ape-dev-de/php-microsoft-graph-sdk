...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CreatedByRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ExecutionScopeRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\LastModifiedByRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernanceActivateRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernanceCreateNewVersionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityGovernanceRestoreRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RunsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\TaskReportsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\TasksRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\UserProcessingResultsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\VersionsRequestBuilder;

/**
 * Request builder for {workflow-id}
 */
class WorkflowRequestBuilder extends BaseRequestBuilder
{
    /**
     * Get workflow
     *
