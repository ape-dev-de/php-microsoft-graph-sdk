...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DelegatedAdminRelationshipRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for delegatedAdminRelationships
 */
class DelegatedAdminRelationshipsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new DelegatedAdminRelationshipCollectionResponse([]);
