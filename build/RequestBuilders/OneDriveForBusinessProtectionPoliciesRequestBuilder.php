...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\OneDriveForBusinessProtectionPolicyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for oneDriveForBusinessProtectionPolicies
 */
class OneDriveForBusinessProtectionPoliciesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new OneDriveForBusinessProtectionPolicyCollectionResponse([]);
