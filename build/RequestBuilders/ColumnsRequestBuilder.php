...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ColumnDefinitionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for columns
 */
class ColumnsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new ColumnDefinitionCollectionResponse([]);
