...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\TargetAppsRequestBuilder;

/**
 * Request builder for {targetedManagedAppConfiguration-id}
 */
class TargetedManagedAppConfigurationRequestBuilder extends BaseRequestBuilder
{
    /**
