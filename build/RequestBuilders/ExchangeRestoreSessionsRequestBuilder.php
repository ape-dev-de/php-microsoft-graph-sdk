...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ExchangeRestoreSessionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for exchangeRestoreSessions
 */
class ExchangeRestoreSessionsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new ExchangeRestoreSessionCollectionResponse([]);
