...
/**
 * Request builder for {managedDeviceMobileAppConfigurationDeviceStatus-id}
 */
class ManagedDeviceMobileAppConfigurationDeviceStatusRequestBuilder extends BaseRequestBuilder
{
    /**
     ...
     */
    public function get(?array $select = null, ?array $expand = null): ManagedDeviceMobileAppConfigurationDeviceStatus
    {
        $queryParams = [];
        if ($select !== null) {
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(ManagedDeviceMobileAppConfigurationDeviceStatus $body): ManagedDeviceMobileAppConfigurationDeviceStatus
    {
