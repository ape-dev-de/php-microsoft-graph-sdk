...
class TeamworkRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): Teamwork|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to Teamwork|null
     */
    private function deserializeGet(string $body): Teamwork|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(Teamwork $body): Teamwork|null
    {
     ...
     * Deserialize response to Teamwork|null
     */
    private function deserializePatch(string $body): Teamwork|null    {
        if (empty($body)) {
            return null;
        }
