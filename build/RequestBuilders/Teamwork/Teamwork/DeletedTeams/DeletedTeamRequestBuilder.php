...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Teamwork\Teamwork\DeletedTeams\ChannelsRequestBuilder;
...
class DeletedTeamRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): DeletedTeam
    {
        $queryParams = [];
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(DeletedTeam $body): DeletedTeam
    {
