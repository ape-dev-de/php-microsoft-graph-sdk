...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Teamwork\Teamwork\DeletedTeams\Channels\Messages\Replies\HostedContents;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\ChatMessageHostedContent;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Teamwork\Teamwork\DeletedTeams\Channels\Messages\Replies\HostedContents\ValueRequestBuilder;

/**
 * Request builder for /teamwork/deletedTeams/{deletedTeam-id}/channels/{channel-id}/messages/{chatMessage-id}/replies/{chatMessage-id1}/hostedContents/{chatMessageHostedContent-id}
 */
