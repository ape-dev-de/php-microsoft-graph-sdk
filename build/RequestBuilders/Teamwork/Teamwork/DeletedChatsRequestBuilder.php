...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Teamwork\Teamwork\DeletedChats\DeletedChatRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Teamwork\Teamwork\DeletedChats\CountRequestBuilder;
...
class DeletedChatsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): DeletedChatCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to DeletedChatCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(DeletedChat $body): DeletedChat
    {
