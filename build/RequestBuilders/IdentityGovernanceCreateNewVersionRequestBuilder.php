...
/**
 * Request builder for microsoft.graph.identityGovernance.createNewVersion
 */
class IdentityGovernanceCreateNewVersionRequestBuilder extends BaseRequestBuilder
{
    /**
