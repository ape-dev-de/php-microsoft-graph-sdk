...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AppLogCollectionRequestRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for appLogCollectionRequests
 */
class AppLogCollectionRequestsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        foreach ($data['value'] ?? [] as $item) {
            $items[] = new AppLogCollectionRequest($item);
        }
        $collection = new AppLogCollectionRequestCollectionResponse([]);
