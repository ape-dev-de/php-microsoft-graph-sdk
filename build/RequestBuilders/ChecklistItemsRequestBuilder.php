...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ChecklistItemRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for checklistItems
 */
class ChecklistItemsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new ChecklistItemCollectionResponse([]);
