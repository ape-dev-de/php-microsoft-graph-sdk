...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DelegatedAdminAccessAssignmentRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for accessAssignments
 */
class AccessAssignmentsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new DelegatedAdminAccessAssignmentCollectionResponse([]);
