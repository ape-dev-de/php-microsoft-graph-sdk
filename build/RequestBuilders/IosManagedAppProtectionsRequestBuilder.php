...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IosManagedAppProtectionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for iosManagedAppProtections
 */
class IosManagedAppProtectionsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new IosManagedAppProtectionCollectionResponse([]);
