...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\NotebookRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\GetNotebookFromWebUrlRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\GetRecentNotebooksRequestBuilder;

/**
 * Request builder for notebooks
 */
class NotebooksRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new NotebookCollectionResponse([]);
