...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ChildFoldersRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\MessageRulesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\MessagesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CopyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\MoveRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\PermanentDeleteRequestBuilder;

/**
 * Request builder for {mailFolder-id}
 */
class MailFolderRequestBuilder extends BaseRequestBuilder
{
    /**
     * Get mailFolder
     *
