...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\HistoryRequestBuilder;

/**
 * Request builder for {riskyServicePrincipal-id}
 */
class RiskyServicePrincipalRequestBuilder extends BaseRequestBuilder
{
    /**
     ...
     */
    public function get(?array $select = null, ?array $expand = null): RiskyServicePrincipal
    {
        $queryParams = [];
        if ($select !== null) {
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(RiskyServicePrincipal $body): RiskyServicePrincipal
    {
