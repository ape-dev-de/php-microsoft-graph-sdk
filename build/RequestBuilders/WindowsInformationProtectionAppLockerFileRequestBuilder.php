...
/**
 * Request builder for {windowsInformationProtectionAppLockerFile-id}
 */
class WindowsInformationProtectionAppLockerFileRequestBuilder extends BaseRequestBuilder
{
    /**
