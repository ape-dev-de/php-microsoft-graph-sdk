...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\UserFlowLanguagePageRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for overridesPages
 */
class OverridesPagesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new UserFlowLanguagePageCollectionResponse([]);
