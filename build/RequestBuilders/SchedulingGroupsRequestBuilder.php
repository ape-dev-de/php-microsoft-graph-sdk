...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\SchedulingGroupRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for schedulingGroups
 */
class SchedulingGroupsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new SchedulingGroupCollectionResponse([]);
