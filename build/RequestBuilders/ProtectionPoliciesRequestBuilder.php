...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ProtectionPolicyBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for protectionPolicies
 */
class ProtectionPoliciesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new ProtectionPolicyBaseCollectionResponse([]);
