...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\VulnerabilityRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for vulnerabilities
 */
class VulnerabilitiesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new SecurityVulnerabilityCollectionResponse([]);
