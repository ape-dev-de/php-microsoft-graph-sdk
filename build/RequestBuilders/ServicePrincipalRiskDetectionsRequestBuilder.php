...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ServicePrincipalRiskDetectionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for servicePrincipalRiskDetections
 */
class ServicePrincipalRiskDetectionsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new ServicePrincipalRiskDetectionCollectionResponse([]);
