...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\PassiveDnsRecordRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for passiveDnsReverse
 */
class PassiveDnsReverseRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new SecurityPassiveDnsRecordCollectionResponse([]);
