...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CertificateAuthorityDetailRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for certificateAuthorities
 */
class CertificateAuthoritiesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new CertificateAuthorityDetailCollectionResponse([]);
