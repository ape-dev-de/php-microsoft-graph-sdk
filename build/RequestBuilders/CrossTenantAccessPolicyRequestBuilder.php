...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DefaultRequestBuilder;
...
/**
 * Request builder for crossTenantAccessPolicy
 */
class CrossTenantAccessPolicyRequestBuilder extends BaseRequestBuilder
{
     ...
     */
    public function default(): DefaultRequestBuilder
    {
        return new DefaultRequestBuilder($this->client, $this->requestUrl . '/default');
    }
    /**
