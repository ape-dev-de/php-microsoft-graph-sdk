...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DocumentSetVersionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for documentSetVersions
 */
class DocumentSetVersionsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new DocumentSetVersionCollectionResponse([]);
