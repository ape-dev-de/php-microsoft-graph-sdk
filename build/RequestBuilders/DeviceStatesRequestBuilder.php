...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceInstallStateRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for deviceStates
 */
class DeviceStatesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new DeviceInstallStateCollectionResponse([]);
