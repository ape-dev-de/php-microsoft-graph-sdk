...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\MultiTenantOrganizationMemberRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for tenants
 */
class TenantsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new MultiTenantOrganizationMemberCollectionResponse([]);
