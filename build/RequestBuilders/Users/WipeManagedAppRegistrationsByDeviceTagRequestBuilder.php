...
/**
 * Request builder for /users/{user-id}/wipeManagedAppRegistrationsByDeviceTag
 */
class WipeManagedAppRegistrationsByDeviceTagRequestBuilder extends RootBaseRequestBuilder
{
    /**
