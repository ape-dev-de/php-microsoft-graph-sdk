...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\ContactFolders\ChildFoldersRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\ContactFolders\ContactsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\ContactFolders\PermanentDeleteRequestBuilder;

/**
 * Request builder for /users/{user-id}/contactFolders/{contactFolder-id}
 */
class ContactFolderRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): ContactFolder|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): ContactFolder|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(ContactFolder $body): ContactFolder|null
    {
     ...
     * Deserialize response to ContactFolder|null
     */
    private function deserializePatch(string $body): ContactFolder|null    {
        if (empty($body)) {
            return null;
        }
