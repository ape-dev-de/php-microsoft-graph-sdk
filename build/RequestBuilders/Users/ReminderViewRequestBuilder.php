...
/**
 * Request builder for /users/{user-id}/reminderView(StartDateTime='{StartDateTime}',EndDateTime='{EndDateTime}')
 */
class ReminderViewRequestBuilder extends RootBaseRequestBuilder
{
    /**
