...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\Teamwork\InstalledApps\ChatRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\Teamwork\InstalledApps\TeamsAppRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\Teamwork\InstalledApps\TeamsAppDefinitionRequestBuilder;

/**
 * Request builder for /users/{user-id}/teamwork/installedApps/{userScopeTeamsAppInstallation-id}
 */
class UserScopeTeamsAppInstallationRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): UserScopeTeamsAppInstallation|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): UserScopeTeamsAppInstallation|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(UserScopeTeamsAppInstallation $body): UserScopeTeamsAppInstallation|null
    {
     ...
     * Deserialize response to UserScopeTeamsAppInstallation|null
     */
    private function deserializePatch(string $body): UserScopeTeamsAppInstallation|null    {
        if (empty($body)) {
            return null;
        }
