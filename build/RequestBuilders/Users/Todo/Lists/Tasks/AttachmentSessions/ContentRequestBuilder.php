...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\Todo\Lists\Tasks\AttachmentSessions;
...
/**
 * Request builder for /users/{user-id}/todo/lists/{todoTaskList-id}/tasks/{todoTask-id}/attachmentSessions/{attachmentSession-id}/content
 */
class ContentRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function put(AttachmentSession $body): AttachmentSession
    {
    ...
    /**
     * Delete content for the navigation property attachmentSessions in users
     *
