...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\Settings\Windows\InstancesRequestBuilder;
...
class WindowsSettingRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): WindowsSetting|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): WindowsSetting|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(WindowsSetting $body): WindowsSetting|null
    {
     ...
     * Deserialize response to WindowsSetting|null
     */
    private function deserializePatch(string $body): WindowsSetting|null    {
        if (empty($body)) {
            return null;
        }
