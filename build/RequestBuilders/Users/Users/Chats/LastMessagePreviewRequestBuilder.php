...
/**
 * Request builder for /users/{user-id}/chats/{chat-id}/lastMessagePreview
 */
class LastMessagePreviewRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): ChatMessageInfo
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to ChatMessageInfo
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(ChatMessageInfo $body): ChatMessageInfo
    {
