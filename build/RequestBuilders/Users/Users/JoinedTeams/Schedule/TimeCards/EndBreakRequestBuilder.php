...
/**
 * Request builder for /users/{user-id}/joinedTeams/{team-id}/schedule/timeCards/{timeCard-id}/endBreak
 */
class EndBreakRequestBuilder extends RootBaseRequestBuilder
{
    /**
