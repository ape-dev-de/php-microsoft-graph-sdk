...
/**
 * Request builder for /users/{user-id}/joinedTeams/{team-id}/schedule/timeCards/{timeCard-id}/startBreak
 */
class StartBreakRequestBuilder extends RootBaseRequestBuilder
{
    /**
