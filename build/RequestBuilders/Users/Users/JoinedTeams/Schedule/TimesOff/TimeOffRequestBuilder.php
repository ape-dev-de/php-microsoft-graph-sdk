...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\Users\JoinedTeams\Schedule\TimesOff;
...
/**
 * Request builder for /users/{user-id}/joinedTeams/{team-id}/schedule/timesOff/{timeOff-id}
 */
class TimeOffRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): TimeOff
    {
        $queryParams = [];
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(TimeOff $body): TimeOff
    {
