...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\Users\CalendarGroups\CalendarsRequestBuilder;

/**
 * Request builder for /users/{user-id}/calendarGroups/{calendarGroup-id}
 */
class CalendarGroupRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): CalendarGroup
    {
        $queryParams = [];
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(CalendarGroup $body): CalendarGroup
    {
