...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\Users\Todo\Lists\Tasks\Attachments;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;

/**
 * Request builder for /users/{user-id}/todo/lists/{todoTaskList-id}/tasks/{todoTask-id}/attachments/{attachmentBase-id}/$value
 */
class ValueRequestBuilder extends RootBaseRequestBuilder
{
    ...
    /**
     * Delete media content for the navigation property attachments in users
     *
