...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\Users\Todo\Lists\Tasks\LinkedResources;
...
/**
 * Request builder for /users/{user-id}/todo/lists/{todoTaskList-id}/tasks/{todoTask-id}/linkedResources/{linkedResource-id}
 */
class LinkedResourceRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): LinkedResource
    {
        $queryParams = [];
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(LinkedResource $body): LinkedResource
    {
