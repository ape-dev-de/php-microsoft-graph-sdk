...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\Users\Todo\ListsRequestBuilder;

/**
 * Request builder for /users/{user-id}/todo
 */
class TodoRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): Todo
    {
        $queryParams = [];
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(Todo $body): Todo
    {
