...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\Users\Authentication\MicrosoftAuthenticatorMethods\MicrosoftAuthenticatorAuthenticationMethodRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\Users\Authentication\MicrosoftAuthenticatorMethods\CountRequestBuilder;

/**
 * Request builder for /users/{user-id}/authentication/microsoftAuthenticatorMethods
 */
class MicrosoftAuthenticatorMethodsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): MicrosoftAuthenticatorAuthenticationMethodCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to MicrosoftAuthenticatorAuthenticationMethodCollectionResponse
     */
