...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\Authentication\PhoneMethods\PhoneAuthenticationMethodRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\Authentication\PhoneMethods\CountRequestBuilder;

/**
 * Request builder for /users/{user-id}/authentication/phoneMethods
 */
class PhoneMethodsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return PhoneAuthenticationMethodCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): PhoneAuthenticationMethodCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to PhoneAuthenticationMethodCollectionResponse|null
     */
    private function deserializeGet(string $body): PhoneAuthenticationMethodCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(PhoneAuthenticationMethod $body): PhoneAuthenticationMethod|null
    {
     ...
     */
    private function deserializePost(string $body): PhoneAuthenticationMethod|null    {
        if (empty($body)) {
            return null;
        }
