...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\DataSecurityAndGovernance\ActivitiesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\DataSecurityAndGovernance\ProcessContentRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\DataSecurityAndGovernance\ProtectionScopesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\DataSecurityAndGovernance\SensitivityLabelsRequestBuilder;

/**
 * Request builder for /users/{user-id}/dataSecurityAndGovernance
 */
class DataSecurityAndGovernanceRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): UserDataSecurityAndGovernance|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to UserDataSecurityAndGovernance|null
     */
    private function deserializeGet(string $body): UserDataSecurityAndGovernance|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(UserDataSecurityAndGovernance $body): UserDataSecurityAndGovernance|null
    {
     ...
     * Deserialize response to UserDataSecurityAndGovernance|null
     */
    private function deserializePatch(string $body): UserDataSecurityAndGovernance|null    {
        if (empty($body)) {
            return null;
        }
