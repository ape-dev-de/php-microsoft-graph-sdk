...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\Activities\HistoryItemsRequestBuilder;

/**
 * Request builder for /users/{user-id}/activities/{userActivity-id}
 */
class UserActivityRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): UserActivity|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): UserActivity|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(UserActivity $body): UserActivity|null
    {
     ...
     * Deserialize response to UserActivity|null
     */
    private function deserializePatch(string $body): UserActivity|null    {
        if (empty($body)) {
            return null;
        }
