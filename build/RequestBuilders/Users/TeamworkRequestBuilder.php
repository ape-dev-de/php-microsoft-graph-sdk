...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\Teamwork\AssociatedTeamsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\Teamwork\InstalledAppsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\Teamwork\SendActivityNotificationRequestBuilder;

/**
 * Request builder for /users/{user-id}/teamwork
 */
class TeamworkRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): UserTeamwork|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to UserTeamwork|null
     */
    private function deserializeGet(string $body): UserTeamwork|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(UserTeamwork $body): UserTeamwork|null
    {
     ...
     * Deserialize response to UserTeamwork|null
     */
    private function deserializePatch(string $body): UserTeamwork|null    {
        if (empty($body)) {
            return null;
        }
