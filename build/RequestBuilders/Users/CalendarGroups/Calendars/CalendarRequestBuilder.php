...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\CalendarGroups\Calendars\CalendarPermissionsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\CalendarGroups\Calendars\CalendarViewRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\CalendarGroups\Calendars\EventsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\CalendarGroups\Calendars\AllowedCalendarSharingRolesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\CalendarGroups\Calendars\GetScheduleRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\CalendarGroups\Calendars\PermanentDeleteRequestBuilder;

/**
 * Request builder for /users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}
 */
class CalendarRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(Calendar $body): Calendar|null
    {
     ...
     * Deserialize response to Calendar|null
     */
    private function deserializePatch(string $body): Calendar|null    {
        if (empty($body)) {
            return null;
        }
