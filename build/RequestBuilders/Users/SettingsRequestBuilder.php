...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\Settings\ItemInsightsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\Settings\ShiftPreferencesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\Settings\StorageRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Users\Settings\WindowsRequestBuilder;

/**
 * Request builder for /users/{user-id}/settings
 */
class SettingsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): UserSettings|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to UserSettings|null
     */
    private function deserializeGet(string $body): UserSettings|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(UserSettings $body): UserSettings|null
    {
     ...
     * Deserialize response to UserSettings|null
     */
    private function deserializePatch(string $body): UserSettings|null    {
        if (empty($body)) {
            return null;
        }
