...
/**
 * Request builder for {schemaExtension-id}
 */
class SchemaExtensionRequestBuilder extends BaseRequestBuilder
{
    /**
     * Get schemaExtension
     *
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SchemaExtension
    {
        $queryParams = [];
        if ($select !== null) {
