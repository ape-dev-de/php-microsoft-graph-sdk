...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ParticipantRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\InviteRequestBuilder;

/**
 * Request builder for participants
 */
class ParticipantsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new ParticipantCollectionResponse([]);
