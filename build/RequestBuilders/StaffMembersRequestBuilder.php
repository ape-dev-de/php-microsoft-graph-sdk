...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BookingStaffMemberBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for staffMembers
 */
class StaffMembersRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new BookingStaffMemberBaseCollectionResponse([]);
