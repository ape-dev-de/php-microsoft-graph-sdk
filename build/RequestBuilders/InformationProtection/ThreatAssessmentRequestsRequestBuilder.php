...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\InformationProtection\ThreatAssessmentRequests\ThreatAssessmentRequestRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\InformationProtection\ThreatAssessmentRequests\CountRequestBuilder;
...
class ThreatAssessmentRequestsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return ThreatAssessmentRequestCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): ThreatAssessmentRequestCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to ThreatAssessmentRequestCollectionResponse|null
     */
    private function deserializeGet(string $body): ThreatAssessmentRequestCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(ThreatAssessmentRequest $body): ThreatAssessmentRequest|null
    {
     ...
     */
    private function deserializePost(string $body): ThreatAssessmentRequest|null    {
        if (empty($body)) {
            return null;
        }
