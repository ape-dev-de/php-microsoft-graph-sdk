...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BrowserSharedCookieRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for sharedCookies
 */
class SharedCookiesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new BrowserSharedCookieCollectionResponse([]);
