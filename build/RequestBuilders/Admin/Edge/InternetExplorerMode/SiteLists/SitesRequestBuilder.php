...
class SitesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return BrowserSiteCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): BrowserSiteCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to BrowserSiteCollectionResponse|null
     */
    private function deserializeGet(string $body): BrowserSiteCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(BrowserSite $body): BrowserSite|null
    {
     ...
     */
    private function deserializePost(string $body): BrowserSite|null    {
        if (empty($body)) {
            return null;
        }
