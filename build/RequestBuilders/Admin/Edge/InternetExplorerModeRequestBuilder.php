...
class InternetExplorerModeRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): InternetExplorerMode|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to InternetExplorerMode|null
     */
    private function deserializeGet(string $body): InternetExplorerMode|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(InternetExplorerMode $body): InternetExplorerMode|null
    {
     ...
     * Deserialize response to InternetExplorerMode|null
     */
    private function deserializePatch(string $body): InternetExplorerMode|null    {
        if (empty($body)) {
            return null;
        }
