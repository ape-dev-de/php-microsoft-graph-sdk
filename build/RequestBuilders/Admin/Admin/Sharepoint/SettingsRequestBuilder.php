...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Admin\Admin\Sharepoint;
...
class SettingsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SharepointSettings
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SharepointSettings
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SharepointSettings $body): SharepointSettings
    {
