...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Admin\Admin\Edge\InternetExplorerMode\SiteLists\PublishRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Admin\Admin\Edge\InternetExplorerMode\SiteLists\SharedCookiesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Admin\Admin\Edge\InternetExplorerMode\SiteLists\SitesRequestBuilder;
...
class BrowserSiteListRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): BrowserSiteList
    {
        $queryParams = [];
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(BrowserSiteList $body): BrowserSiteList
    {
