...
/**
 * Request builder for /admin/serviceAnnouncement/messages/{serviceUpdateMessage-id}/attachmentsArchive
 */
class AttachmentsArchiveRequestBuilder extends RootBaseRequestBuilder
{
    /**
     * List attachments
     * @return string
    ...
    /**
     * Delete attachmentsArchive for the navigation property messages in admin
     *
