...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Admin\Admin\ServiceAnnouncement\Messages\Attachments\ServiceAnnouncementAttachmentRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Admin\Admin\ServiceAnnouncement\Messages\Attachments\CountRequestBuilder;
...
class AttachmentsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): ServiceAnnouncementAttachmentCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to ServiceAnnouncementAttachmentCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(ServiceAnnouncementAttachment $body): ServiceAnnouncementAttachment
    {
