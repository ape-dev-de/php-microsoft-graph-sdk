...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Admin\Sharepoint\SettingsRequestBuilder;
...
class SharepointRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): Sharepoint|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to Sharepoint|null
     */
    private function deserializeGet(string $body): Sharepoint|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(Sharepoint $body): Sharepoint|null
    {
     ...
     * Deserialize response to Sharepoint|null
     */
    private function deserializePatch(string $body): Sharepoint|null    {
        if (empty($body)) {
            return null;
        }
