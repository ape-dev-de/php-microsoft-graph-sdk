...
class EdgeRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): Edge|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to Edge|null
     */
    private function deserializeGet(string $body): Edge|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(Edge $body): Edge|null
    {
     ...
     * Deserialize response to Edge|null
     */
    private function deserializePatch(string $body): Edge|null    {
        if (empty($body)) {
            return null;
        }
