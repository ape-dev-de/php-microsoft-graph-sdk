...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\TerminateRequestBuilder;

/**
 * Request builder for {deviceManagementPartner-id}
 */
class DeviceManagementPartnerRequestBuilder extends BaseRequestBuilder
{
    /**
