...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Domains\Domains\FederationConfiguration\InternalDomainFederationRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Domains\Domains\FederationConfiguration\CountRequestBuilder;
...
class FederationConfigurationRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): InternalDomainFederationCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to InternalDomainFederationCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(InternalDomainFederation $body): InternalDomainFederation
    {
