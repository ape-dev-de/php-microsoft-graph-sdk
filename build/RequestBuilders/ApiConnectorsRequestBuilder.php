...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityApiConnectorRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for apiConnectors
 */
class ApiConnectorsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new IdentityApiConnectorCollectionResponse([]);
