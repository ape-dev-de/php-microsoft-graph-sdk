...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ClaimsMappingPolicyRequestBuilder;

/**
 * Request builder for claimsMappingPolicies
 */
class ClaimsMappingPoliciesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new ClaimsMappingPolicyCollectionResponse([]);
