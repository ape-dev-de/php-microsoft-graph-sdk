...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\MailboxRestoreArtifactRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for mailboxRestoreArtifacts
 */
class MailboxRestoreArtifactsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new MailboxRestoreArtifactCollectionResponse([]);
