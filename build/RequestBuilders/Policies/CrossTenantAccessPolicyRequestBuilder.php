...
class CrossTenantAccessPolicyRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): CrossTenantAccessPolicy|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to CrossTenantAccessPolicy|null
     */
    private function deserializeGet(string $body): CrossTenantAccessPolicy|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(CrossTenantAccessPolicy $body): CrossTenantAccessPolicy|null
    {
     ...
     * Deserialize response to CrossTenantAccessPolicy|null
     */
    private function deserializePatch(string $body): CrossTenantAccessPolicy|null    {
        if (empty($body)) {
            return null;
        }
