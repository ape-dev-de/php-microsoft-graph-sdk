...
class PartnersRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return CrossTenantAccessPolicyConfigurationPartnerCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): CrossTenantAccessPolicyConfigurationPartnerCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to CrossTenantAccessPolicyConfigurationPartnerCollectionResponse|null
     */
    private function deserializeGet(string $body): CrossTenantAccessPolicyConfigurationPartnerCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(CrossTenantAccessPolicyConfigurationPartner $body): CrossTenantAccessPolicyConfigurationPartner|null
    {
     ...
     */
    private function deserializePost(string $body): CrossTenantAccessPolicyConfigurationPartner|null    {
        if (empty($body)) {
            return null;
        }
