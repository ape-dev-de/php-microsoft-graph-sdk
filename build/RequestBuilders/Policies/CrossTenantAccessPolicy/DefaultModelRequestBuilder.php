...
class DefaultModelRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): CrossTenantAccessPolicyConfigurationDefault|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to CrossTenantAccessPolicyConfigurationDefault|null
     */
    private function deserializeGet(string $body): CrossTenantAccessPolicyConfigurationDefault|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(CrossTenantAccessPolicyConfigurationDefault $body): CrossTenantAccessPolicyConfigurationDefault|null
    {
     ...
     * Deserialize response to CrossTenantAccessPolicyConfigurationDefault|null
     */
    private function deserializePatch(string $body): CrossTenantAccessPolicyConfigurationDefault|null    {
        if (empty($body)) {
            return null;
        }
