...
class MultiTenantOrganizationPartnerConfigurationRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): MultiTenantOrganizationPartnerConfigurationTemplate|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to MultiTenantOrganizationPartnerConfigurationTemplate|null
     */
    private function deserializeGet(string $body): MultiTenantOrganizationPartnerConfigurationTemplate|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(MultiTenantOrganizationPartnerConfigurationTemplate $body): MultiTenantOrganizationPartnerConfigurationTemplate|null
    {
     ...
     * Deserialize response to MultiTenantOrganizationPartnerConfigurationTemplate|null
     */
    private function deserializePatch(string $body): MultiTenantOrganizationPartnerConfigurationTemplate|null    {
        if (empty($body)) {
            return null;
        }
