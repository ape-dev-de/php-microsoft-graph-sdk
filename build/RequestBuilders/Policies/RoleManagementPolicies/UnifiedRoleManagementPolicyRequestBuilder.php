...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Policies\RoleManagementPolicies\EffectiveRulesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Policies\RoleManagementPolicies\RulesRequestBuilder;
...
class UnifiedRoleManagementPolicyRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(UnifiedRoleManagementPolicy $body): UnifiedRoleManagementPolicy|null
    {
     ...
     * Deserialize response to UnifiedRoleManagementPolicy|null
     */
    private function deserializePatch(string $body): UnifiedRoleManagementPolicy|null    {
        if (empty($body)) {
            return null;
        }
