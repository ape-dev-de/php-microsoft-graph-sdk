...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Policies\PermissionGrantPolicies\ExcludesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Policies\PermissionGrantPolicies\IncludesRequestBuilder;

/**
 * Request builder for /policies/permissionGrantPolicies/{permissionGrantPolicy-id}
 */
class PermissionGrantPolicyRequestBuilder extends RootBaseRequestBuilder
{
    /**
     ...
     */
    public function get(?array $select = null, ?array $expand = null): PermissionGrantPolicy|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): PermissionGrantPolicy|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(PermissionGrantPolicy $body): PermissionGrantPolicy|null
    {
     ...
     * Deserialize response to PermissionGrantPolicy|null
     */
    private function deserializePatch(string $body): PermissionGrantPolicy|null    {
        if (empty($body)) {
            return null;
        }
