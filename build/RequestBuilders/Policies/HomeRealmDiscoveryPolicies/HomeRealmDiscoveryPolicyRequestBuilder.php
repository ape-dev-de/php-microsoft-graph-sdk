...
class HomeRealmDiscoveryPolicyRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(HomeRealmDiscoveryPolicy $body): HomeRealmDiscoveryPolicy|null
    {
     ...
     * Deserialize response to HomeRealmDiscoveryPolicy|null
     */
    private function deserializePatch(string $body): HomeRealmDiscoveryPolicy|null    {
        if (empty($body)) {
            return null;
        }
