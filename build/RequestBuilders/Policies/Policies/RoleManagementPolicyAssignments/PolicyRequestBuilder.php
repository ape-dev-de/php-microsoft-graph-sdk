...
/**
 * Request builder for /policies/roleManagementPolicyAssignments/{unifiedRoleManagementPolicyAssignment-id}/policy
 */
class PolicyRequestBuilder extends RootBaseRequestBuilder
{
    /**
