...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Policies\Policies\PermissionGrantPolicies\Includes;
...
/**
 * Request builder for /policies/permissionGrantPolicies/{permissionGrantPolicy-id}/includes/$count
 */
