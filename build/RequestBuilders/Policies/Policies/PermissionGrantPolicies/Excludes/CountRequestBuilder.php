...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Policies\Policies\PermissionGrantPolicies\Excludes;
...
/**
 * Request builder for /policies/permissionGrantPolicies/{permissionGrantPolicy-id}/excludes/$count
 */
