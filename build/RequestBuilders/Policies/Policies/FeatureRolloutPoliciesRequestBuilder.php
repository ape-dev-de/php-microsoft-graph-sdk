...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Policies\Policies\FeatureRolloutPolicies\FeatureRolloutPolicyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Policies\Policies\FeatureRolloutPolicies\CountRequestBuilder;
...
class FeatureRolloutPoliciesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): FeatureRolloutPolicyCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to FeatureRolloutPolicyCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(FeatureRolloutPolicy $body): FeatureRolloutPolicy
    {
