...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Policies\Policies\CrossTenantAccessPolicy\Templates;
...
class MultiTenantOrganizationIdentitySynchronizationRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): MultiTenantOrganizationIdentitySyncPolicyTemplate
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to MultiTenantOrganizationIdentitySyncPolicyTemplate
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(MultiTenantOrganizationIdentitySyncPolicyTemplate $body): MultiTenantOrganizationIdentitySyncPolicyTemplate
    {
