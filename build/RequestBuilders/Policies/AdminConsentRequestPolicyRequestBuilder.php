...
class AdminConsentRequestPolicyRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): AdminConsentRequestPolicy|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to AdminConsentRequestPolicy|null
     */
    private function deserializeGet(string $body): AdminConsentRequestPolicy|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(AdminConsentRequestPolicy $body): AdminConsentRequestPolicy|null
    {
     ...
     * Deserialize response to AdminConsentRequestPolicy|null
     */
    private function deserializePatch(string $body): AdminConsentRequestPolicy|null    {
        if (empty($body)) {
            return null;
        }
