...
class TokenIssuancePolicyRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): TokenIssuancePolicy|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): TokenIssuancePolicy|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(TokenIssuancePolicy $body): TokenIssuancePolicy|null
    {
     ...
     * Deserialize response to TokenIssuancePolicy|null
     */
    private function deserializePatch(string $body): TokenIssuancePolicy|null    {
        if (empty($body)) {
            return null;
        }
