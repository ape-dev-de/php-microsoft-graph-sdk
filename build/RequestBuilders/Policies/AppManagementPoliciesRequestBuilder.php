...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Policies\AppManagementPolicies\AppManagementPolicyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Policies\AppManagementPolicies\CountRequestBuilder;
...
class AppManagementPoliciesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return AppManagementPolicyCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): AppManagementPolicyCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to AppManagementPolicyCollectionResponse|null
     */
    private function deserializeGet(string $body): AppManagementPolicyCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(AppManagementPolicy $body): AppManagementPolicy|null
    {
     ...
     */
    private function deserializePost(string $body): AppManagementPolicy|null    {
        if (empty($body)) {
            return null;
        }
