...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\MailboxProtectionRuleRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for mailboxInclusionRules
 */
class MailboxInclusionRulesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new MailboxProtectionRuleCollectionResponse([]);
