...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ApproversRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CollaboratorsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\GetFinalAttachmentRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\GetFinalReportRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\NotesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\TeamRequestBuilder;

/**
 * Request builder for {subjectRightsRequest-id}
 */
class SubjectRightsRequestRequestBuilder extends BaseRequestBuilder
{
    /**
