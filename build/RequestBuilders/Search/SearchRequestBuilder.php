...
class SearchRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SearchEntity|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SearchEntity|null
     */
    private function deserializeGet(string $body): SearchEntity|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SearchEntity $body): SearchEntity|null
    {
     ...
     * Deserialize response to SearchEntity|null
     */
    private function deserializePatch(string $body): SearchEntity|null    {
        if (empty($body)) {
            return null;
        }
