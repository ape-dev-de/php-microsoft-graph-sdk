...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\UserAttributeRequestBuilder;

/**
 * Request builder for {identityUserFlowAttributeAssignment-id}
 */
class IdentityUserFlowAttributeAssignmentRequestBuilder extends BaseRequestBuilder
{
    /**
