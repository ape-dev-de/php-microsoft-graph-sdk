...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\UserExperienceAnalyticsWorkFromAnywhereMetricRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for userExperienceAnalyticsWorkFromAnywhereMetrics
 */
class UserExperienceAnalyticsWorkFromAnywhereMetricsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new UserExperienceAnalyticsWorkFromAnywhereMetricCollectionResponse([]);
