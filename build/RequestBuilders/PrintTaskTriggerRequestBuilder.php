...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DefinitionRequestBuilder;

/**
 * Request builder for {printTaskTrigger-id}
 */
class PrintTaskTriggerRequestBuilder extends BaseRequestBuilder
{
    /**
