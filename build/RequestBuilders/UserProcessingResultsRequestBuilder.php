...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\UserProcessingResultRequestBuilder;
...
/**
 * Request builder for userProcessingResults
 */
class UserProcessingResultsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new IdentityGovernanceUserProcessingResultCollectionResponse([]);
