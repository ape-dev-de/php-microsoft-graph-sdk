...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\SectionGroupRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for sectionGroups
 */
class SectionGroupsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new SectionGroupCollectionResponse([]);
