...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\Authentication\SoftwareOathMethods\SoftwareOathAuthenticationMethodRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\Authentication\SoftwareOathMethods\CountRequestBuilder;

/**
 * Request builder for /me/authentication/softwareOathMethods
 */
class SoftwareOathMethodsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return SoftwareOathAuthenticationMethodCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): SoftwareOathAuthenticationMethodCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SoftwareOathAuthenticationMethodCollectionResponse|null
     */
    private function deserializeGet(string $body): SoftwareOathAuthenticationMethodCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
