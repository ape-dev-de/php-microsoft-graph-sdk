...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\Me\Insights\Used\UsedInsightRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\Me\Insights\Used\CountRequestBuilder;

/**
 * Request builder for /me/insights/used
 */
class UsedRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): UsedInsightCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to UsedInsightCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(UsedInsight $body): UsedInsight
    {
