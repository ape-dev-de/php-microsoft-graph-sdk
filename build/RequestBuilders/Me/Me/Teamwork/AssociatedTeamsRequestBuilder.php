...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\Me\Teamwork;
...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\Me\Teamwork\AssociatedTeams\AssociatedTeamInfoRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\Me\Teamwork\AssociatedTeams\CountRequestBuilder;

/**
 * Request builder for /me/teamwork/associatedTeams
 */
class AssociatedTeamsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): AssociatedTeamInfoCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to AssociatedTeamInfoCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(AssociatedTeamInfo $body): AssociatedTeamInfo
    {
    ...
    /**
     * Deserialize response to AssociatedTeamInfo
     */
