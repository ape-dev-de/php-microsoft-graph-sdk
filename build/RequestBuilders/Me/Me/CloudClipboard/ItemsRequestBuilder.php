...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\Me\CloudClipboard;
...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\Me\CloudClipboard\Items\CloudClipboardItemRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\Me\CloudClipboard\Items\CountRequestBuilder;

/**
 * Request builder for /me/cloudClipboard/items
 */
class ItemsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): CloudClipboardItemCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to CloudClipboardItemCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(CloudClipboardItem $body): CloudClipboardItem
    {
