...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\Me\Activities\HistoryItems;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\ActivityHistoryItem;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\Me\Activities\HistoryItems\ActivityRequestBuilder;

/**
 * Request builder for /me/activities/{userActivity-id}/historyItems/{activityHistoryItem-id}
 */
class ActivityHistoryItemRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): ActivityHistoryItem
    {
        $queryParams = [];
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(ActivityHistoryItem $body): ActivityHistoryItem
    {
