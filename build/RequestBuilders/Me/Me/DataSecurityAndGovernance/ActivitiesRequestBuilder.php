...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\Me\DataSecurityAndGovernance\Activities\ContentActivitiesRequestBuilder;
...
class ActivitiesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): ActivitiesContainer
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to ActivitiesContainer
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(ActivitiesContainer $body): ActivitiesContainer
    {
