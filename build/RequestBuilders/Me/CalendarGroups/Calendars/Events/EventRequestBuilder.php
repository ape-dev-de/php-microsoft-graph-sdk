...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\CalendarGroups\Calendars\Events;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\Event;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\CalendarGroups\Calendars\Events\AttachmentsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\CalendarGroups\Calendars\Events\CalendarRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\CalendarGroups\Calendars\Events\ExtensionsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\CalendarGroups\Calendars\Events\InstancesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\CalendarGroups\Calendars\Events\AcceptRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\CalendarGroups\Calendars\Events\CancelRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\CalendarGroups\Calendars\Events\DeclineRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\CalendarGroups\Calendars\Events\DismissReminderRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\CalendarGroups\Calendars\Events\ForwardRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\CalendarGroups\Calendars\Events\PermanentDeleteRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\CalendarGroups\Calendars\Events\SnoozeReminderRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Me\CalendarGroups\Calendars\Events\TentativelyAcceptRequestBuilder;

/**
 * Request builder for /me/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}/events/{event-id}
 */
class EventRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): Event|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to Event|null
     */
    private function deserializeGet(string $body): Event|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(Event $body): Event|null
    {
     ...
     * Deserialize response to Event|null
     */
    private function deserializePatch(string $body): Event|null    {
        if (empty($body)) {
            return null;
        }
