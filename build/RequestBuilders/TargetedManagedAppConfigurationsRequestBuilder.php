...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\TargetedManagedAppConfigurationRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for targetedManagedAppConfigurations
 */
class TargetedManagedAppConfigurationsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new TargetedManagedAppConfigurationCollectionResponse([]);
