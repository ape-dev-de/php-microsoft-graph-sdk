...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\OpenShiftChangeRequestRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for openShiftChangeRequests
 */
class OpenShiftChangeRequestsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new OpenShiftChangeRequestCollectionResponse([]);
