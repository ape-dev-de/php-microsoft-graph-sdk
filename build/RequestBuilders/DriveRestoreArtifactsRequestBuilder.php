...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DriveRestoreArtifactRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for driveRestoreArtifacts
 */
class DriveRestoreArtifactsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new DriveRestoreArtifactCollectionResponse([]);
