...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\GroupSettingTemplates\GroupSettingTemplates\GroupSettingTemplateRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\GroupSettingTemplates\GroupSettingTemplates\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\GroupSettingTemplates\GroupSettingTemplates\DeltaRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\GroupSettingTemplates\GroupSettingTemplates\GetAvailableExtensionPropertiesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\GroupSettingTemplates\GroupSettingTemplates\GetByIdsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\GroupSettingTemplates\GroupSettingTemplates\ValidatePropertiesRequestBuilder;
...
class GroupSettingTemplatesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): GroupSettingTemplateCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to GroupSettingTemplateCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(GroupSettingTemplate $body): GroupSettingTemplate
    {
