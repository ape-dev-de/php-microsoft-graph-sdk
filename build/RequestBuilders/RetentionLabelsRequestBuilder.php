...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RetentionLabelRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for retentionLabels
 */
class RetentionLabelsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new SecurityRetentionLabelCollectionResponse([]);
