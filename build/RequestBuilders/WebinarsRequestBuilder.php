...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\VirtualEventWebinarRequestBuilder;
...
class WebinarsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new VirtualEventWebinarCollectionResponse([]);
