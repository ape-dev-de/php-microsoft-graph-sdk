...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AccessReviewScheduleDefinitionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\FilterByCurrentUserRequestBuilder;

/**
 * Request builder for definitions
 */
class DefinitionsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new AccessReviewScheduleDefinitionCollectionResponse([]);
