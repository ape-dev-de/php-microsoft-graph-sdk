...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Devices\Devices\RegisteredUsers\GraphappRoleAssignment;
...
/**
 * Request builder for /devices/{device-id}/registeredUsers/graph.appRoleAssignment/$count
 */
