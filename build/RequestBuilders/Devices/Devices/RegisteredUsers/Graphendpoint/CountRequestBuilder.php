...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Devices\Devices\RegisteredUsers\Graphendpoint;
...
/**
 * Request builder for /devices/{device-id}/registeredUsers/graph.endpoint/$count
 */
