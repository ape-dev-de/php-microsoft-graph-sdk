...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Devices\Devices\RegisteredUsers\Graphuser;
...
/**
 * Request builder for /devices/{device-id}/registeredUsers/graph.user/$count
 */
