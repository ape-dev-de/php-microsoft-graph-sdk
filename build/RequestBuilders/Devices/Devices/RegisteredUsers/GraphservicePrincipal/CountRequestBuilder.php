...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Devices\Devices\RegisteredUsers\GraphservicePrincipal;
...
/**
 * Request builder for /devices/{device-id}/registeredUsers/graph.servicePrincipal/$count
 */
