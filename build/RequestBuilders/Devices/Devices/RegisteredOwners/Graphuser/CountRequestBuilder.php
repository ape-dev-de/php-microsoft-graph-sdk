...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Devices\Devices\RegisteredOwners\Graphuser;
...
/**
 * Request builder for /devices/{device-id}/registeredOwners/graph.user/$count
 */
