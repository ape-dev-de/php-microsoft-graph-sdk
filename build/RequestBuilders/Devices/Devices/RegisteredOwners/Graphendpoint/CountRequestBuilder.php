...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Devices\Devices\RegisteredOwners\Graphendpoint;
...
/**
 * Request builder for /devices/{device-id}/registeredOwners/graph.endpoint/$count
 */
