...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\OneDriveForBusinessRestoreSessionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for oneDriveForBusinessRestoreSessions
 */
class OneDriveForBusinessRestoreSessionsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new OneDriveForBusinessRestoreSessionCollectionResponse([]);
