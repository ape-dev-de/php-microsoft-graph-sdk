...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Sites\Sites\TermStore\Sets\ParentGroup\SetsRequestBuilder;

/**
 * Request builder for /sites/{site-id}/termStore/sets/{set-id}/parentGroup
 */
