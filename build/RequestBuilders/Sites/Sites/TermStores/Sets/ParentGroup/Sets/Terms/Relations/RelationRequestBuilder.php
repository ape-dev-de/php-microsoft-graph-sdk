...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Sites\Sites\TermStores\Sets\ParentGroup\Sets\Terms\Relations;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\TermStoreRelation;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Sites\Sites\TermStores\Sets\ParentGroup\Sets\Terms\Relations\FromTermRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Sites\Sites\TermStores\Sets\ParentGroup\Sets\Terms\Relations\SetRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Sites\Sites\TermStores\Sets\ParentGroup\Sets\Terms\Relations\ToTermRequestBuilder;

/**
 * Request builder for /sites/{site-id}/termStores/{store-id}/sets/{set-id}/parentGroup/sets/{set-id1}/terms/{term-id}/relations/{relation-id}
 */
