...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Sites\Sites\TermStores\Sets\ParentGroup\Sets\Children;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\TermStoreTerm;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Sites\Sites\TermStores\Sets\ParentGroup\Sets\Children\ChildrenRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Sites\Sites\TermStores\Sets\ParentGroup\Sets\Children\RelationsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Sites\Sites\TermStores\Sets\ParentGroup\Sets\Children\SetRequestBuilder;

/**
 * Request builder for /sites/{site-id}/termStores/{store-id}/sets/{set-id}/parentGroup/sets/{set-id1}/children/{term-id}
 */
