...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Sites\Sites\TermStores\Sets\ParentGroup\Sets\Relations;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\TermStoreRelation;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Sites\Sites\TermStores\Sets\ParentGroup\Sets\Relations\FromTermRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Sites\Sites\TermStores\Sets\ParentGroup\Sets\Relations\SetRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Sites\Sites\TermStores\Sets\ParentGroup\Sets\Relations\ToTermRequestBuilder;

/**
 * Request builder for /sites/{site-id}/termStores/{store-id}/sets/{set-id}/parentGroup/sets/{set-id1}/relations/{relation-id}
 */
