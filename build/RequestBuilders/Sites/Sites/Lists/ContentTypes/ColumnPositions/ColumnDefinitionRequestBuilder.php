...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Sites\Sites\Lists\ContentTypes\ColumnPositions;
...
/**
 * Request builder for /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/columnPositions/{columnDefinition-id}
 */
