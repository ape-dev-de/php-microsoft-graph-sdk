...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Sites\Sites\Lists\Items\DriveItem\ContentRequestBuilder;

/**
 * Request builder for /sites/{site-id}/lists/{list-id}/items/{listItem-id}/driveItem
 */
