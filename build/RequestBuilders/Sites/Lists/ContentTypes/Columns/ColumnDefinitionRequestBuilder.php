...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Sites\Lists\ContentTypes\Columns\SourceColumnRequestBuilder;

/**
 * Request builder for /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}/columns/{columnDefinition-id}
 */
