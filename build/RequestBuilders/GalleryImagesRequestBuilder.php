...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CloudPcGalleryImageRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for galleryImages
 */
class GalleryImagesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new CloudPcGalleryImageCollectionResponse([]);
