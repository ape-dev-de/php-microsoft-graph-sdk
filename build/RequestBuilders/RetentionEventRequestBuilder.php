...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RetentionEventTypeRequestBuilder;

/**
 * Request builder for {retentionEvent-id}
 */
class RetentionEventRequestBuilder extends BaseRequestBuilder
{
    /**
     * Get retentionEvent
     *
