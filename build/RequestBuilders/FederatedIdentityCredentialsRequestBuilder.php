...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\FederatedIdentityCredentialRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for federatedIdentityCredentials
 */
class FederatedIdentityCredentialsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new FederatedIdentityCredentialCollectionResponse([]);
