...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\GetPositionOfWebPartRequestBuilder;

/**
 * Request builder for {webPart-id}
 */
class WebPartRequestBuilder extends BaseRequestBuilder
{
    /**
