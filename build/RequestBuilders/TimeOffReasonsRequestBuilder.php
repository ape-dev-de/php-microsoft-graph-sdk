...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\TimeOffReasonRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for timeOffReasons
 */
class TimeOffReasonsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new TimeOffReasonCollectionResponse([]);
