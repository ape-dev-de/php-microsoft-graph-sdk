...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\SetPriorityRequestBuilder;

/**
 * Request builder for {deviceEnrollmentConfiguration-id}
 */
class DeviceEnrollmentConfigurationRequestBuilder extends BaseRequestBuilder
{
    /**
