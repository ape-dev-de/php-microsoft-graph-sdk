...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AppCatalogs\TeamsApps\AppDefinitions\BotRequestBuilder;

/**
 * Request builder for /appCatalogs/teamsApps/{teamsApp-id}/appDefinitions/{teamsAppDefinition-id}
 */
class TeamsAppDefinitionRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(TeamsAppDefinition $body): TeamsAppDefinition|null
    {
     ...
     * Deserialize response to TeamsAppDefinition|null
     */
    private function deserializePatch(string $body): TeamsAppDefinition|null    {
        if (empty($body)) {
            return null;
        }
