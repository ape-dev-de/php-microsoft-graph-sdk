...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\PermissionGrantPolicyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for permissionGrantPolicies
 */
class PermissionGrantPoliciesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new PermissionGrantPolicyCollectionResponse([]);
