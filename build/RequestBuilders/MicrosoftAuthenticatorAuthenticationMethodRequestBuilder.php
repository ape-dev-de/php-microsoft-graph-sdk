...
/**
 * Request builder for {microsoftAuthenticatorAuthenticationMethod-id}
 */
class MicrosoftAuthenticatorAuthenticationMethodRequestBuilder extends BaseRequestBuilder
{
    /**
