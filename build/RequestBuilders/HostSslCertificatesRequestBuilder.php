...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\HostSslCertificateRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for hostSslCertificates
 */
class HostSslCertificatesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new SecurityHostSslCertificateCollectionResponse([]);
