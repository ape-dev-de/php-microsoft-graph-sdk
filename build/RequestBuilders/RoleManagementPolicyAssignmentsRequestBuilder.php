...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\UnifiedRoleManagementPolicyAssignmentRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for roleManagementPolicyAssignments
 */
class RoleManagementPolicyAssignmentsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new UnifiedRoleManagementPolicyAssignmentCollectionResponse([]);
