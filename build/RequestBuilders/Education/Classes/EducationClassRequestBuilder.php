...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Education\Classes\AssignmentCategoriesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Education\Classes\AssignmentDefaultsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Education\Classes\AssignmentsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Education\Classes\AssignmentSettingsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Education\Classes\GroupRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Education\Classes\MembersRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Education\Classes\GetRecentlyModifiedSubmissionsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Education\Classes\ModulesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Education\Classes\SchoolsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Education\Classes\TeachersRequestBuilder;
...
class EducationClassRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): EducationClass|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): EducationClass|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(EducationClass $body): EducationClass|null
    {
     ...
     * Deserialize response to EducationClass|null
     */
    private function deserializePatch(string $body): EducationClass|null    {
        if (empty($body)) {
            return null;
        }
