...
class AssignmentSettingsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): EducationAssignmentSettings|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to EducationAssignmentSettings|null
     */
    private function deserializeGet(string $body): EducationAssignmentSettings|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(EducationAssignmentSettings $body): EducationAssignmentSettings|null
    {
     ...
     * Deserialize response to EducationAssignmentSettings|null
     */
    private function deserializePatch(string $body): EducationAssignmentSettings|null    {
        if (empty($body)) {
            return null;
        }
