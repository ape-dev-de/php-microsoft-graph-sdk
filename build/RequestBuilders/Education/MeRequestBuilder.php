...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Education\Me\AssignmentsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Education\Me\ClassesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Education\Me\RubricsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Education\Me\SchoolsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Education\Me\TaughtClassesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Education\Me\UserRequestBuilder;
...
class MeRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): EducationUser|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): EducationUser|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(EducationUser $body): EducationUser|null
    {
     ...
     * Deserialize response to EducationUser|null
     */
    private function deserializePatch(string $body): EducationUser|null    {
        if (empty($body)) {
            return null;
        }
