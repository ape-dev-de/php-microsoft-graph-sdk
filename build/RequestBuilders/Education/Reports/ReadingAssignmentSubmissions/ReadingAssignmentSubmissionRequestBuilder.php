...
class ReadingAssignmentSubmissionRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): ReadingAssignmentSubmission|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): ReadingAssignmentSubmission|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(ReadingAssignmentSubmission $body): ReadingAssignmentSubmission|null
    {
     ...
     * Deserialize response to ReadingAssignmentSubmission|null
     */
    private function deserializePatch(string $body): ReadingAssignmentSubmission|null    {
        if (empty($body)) {
            return null;
        }
