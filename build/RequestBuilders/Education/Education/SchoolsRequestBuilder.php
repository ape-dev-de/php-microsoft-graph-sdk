...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Education\Education\Schools\EducationSchoolRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Education\Education\Schools\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Education\Education\Schools\DeltaRequestBuilder;

/**
 * Request builder for /education/schools
 */
class SchoolsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): EducationSchoolCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to EducationSchoolCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(EducationSchool $body): EducationSchool
    {
