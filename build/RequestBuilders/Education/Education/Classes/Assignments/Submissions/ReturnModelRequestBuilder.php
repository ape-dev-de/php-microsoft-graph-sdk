...
/**
 * Request builder for /education/classes/{educationClass-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}/return
 */
class ReturnModelRequestBuilder extends RootBaseRequestBuilder
{
    /**
