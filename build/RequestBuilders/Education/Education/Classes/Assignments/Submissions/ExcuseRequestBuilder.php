...
/**
 * Request builder for /education/classes/{educationClass-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}/excuse
 */
class ExcuseRequestBuilder extends RootBaseRequestBuilder
{
    /**
