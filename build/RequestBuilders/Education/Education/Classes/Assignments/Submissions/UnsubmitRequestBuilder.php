...
/**
 * Request builder for /education/classes/{educationClass-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}/unsubmit
 */
class UnsubmitRequestBuilder extends RootBaseRequestBuilder
{
    /**
