...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\PrintUsageByUserRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for monthlyPrintUsageByUser
 */
class MonthlyPrintUsageByUserRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new PrintUsageByUserCollectionResponse([]);
