...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceConfigurationRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for deviceConfigurations
 */
class DeviceConfigurationsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new DeviceConfigurationCollectionResponse([]);
