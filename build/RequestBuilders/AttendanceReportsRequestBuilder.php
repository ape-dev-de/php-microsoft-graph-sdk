...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\MeetingAttendanceReportRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for attendanceReports
 */
class AttendanceReportsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new MeetingAttendanceReportCollectionResponse([]);
