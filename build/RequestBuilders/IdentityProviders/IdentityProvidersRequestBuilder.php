...
class IdentityProvidersRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(IdentityProvider $body): IdentityProvider|null
    {
    ...
    /**
     * Deserialize response to IdentityProvider|null
     */
    private function deserializePost(string $body): IdentityProvider|null    {
        if (empty($body)) {
            return null;
        }
