...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DomainDnsRecordRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for serviceConfigurationRecords
 */
class ServiceConfigurationRecordsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new DomainDnsRecordCollectionResponse([]);
