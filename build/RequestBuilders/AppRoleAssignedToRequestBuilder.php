...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AppRoleAssignmentRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for appRoleAssignedTo
 */
class AppRoleAssignedToRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new AppRoleAssignmentCollectionResponse([]);
