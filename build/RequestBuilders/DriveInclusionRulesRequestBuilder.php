...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DriveProtectionRuleRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for driveInclusionRules
 */
class DriveInclusionRulesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new DriveProtectionRuleCollectionResponse([]);
