...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ActivityRequestBuilder;

/**
 * Request builder for {activityHistoryItem-id}
 */
class ActivityHistoryItemRequestBuilder extends BaseRequestBuilder
{
    /**
