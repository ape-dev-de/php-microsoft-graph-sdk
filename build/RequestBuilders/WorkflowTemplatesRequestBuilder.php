...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\WorkflowTemplateRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for workflowTemplates
 */
class WorkflowTemplatesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new IdentityGovernanceWorkflowTemplateCollectionResponse([]);
