...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AccessPackageAssignmentRequestRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\FilterByCurrentUserRequestBuilder;

/**
 * Request builder for assignmentRequests
 */
class AssignmentRequestsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new AccessPackageAssignmentRequestCollectionResponse([]);
