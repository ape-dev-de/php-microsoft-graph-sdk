...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\LanguageDetailsRequestBuilder;

/**
 * Request builder for {training-id}
 */
class TrainingRequestBuilder extends BaseRequestBuilder
{
    /**
     * Get training
     *
