...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\UserInstallStateSummaryRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for userStateSummary
 */
class UserStateSummaryRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new UserInstallStateSummaryCollectionResponse([]);
