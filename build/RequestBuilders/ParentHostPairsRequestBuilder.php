...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\HostPairRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for parentHostPairs
 */
class ParentHostPairsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new SecurityHostPairCollectionResponse([]);
