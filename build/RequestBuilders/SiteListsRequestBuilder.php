...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BrowserSiteListRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for siteLists
 */
class SiteListsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new BrowserSiteListCollectionResponse([]);
