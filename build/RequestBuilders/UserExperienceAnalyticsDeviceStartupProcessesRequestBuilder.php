...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\UserExperienceAnalyticsDeviceStartupProcessRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for userExperienceAnalyticsDeviceStartupProcesses
 */
class UserExperienceAnalyticsDeviceStartupProcessesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new UserExperienceAnalyticsDeviceStartupProcessCollectionResponse([]);
