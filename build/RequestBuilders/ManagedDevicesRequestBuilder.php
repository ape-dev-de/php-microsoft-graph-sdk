...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ManagedDeviceRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for managedDevices
 */
class ManagedDevicesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new ManagedDeviceCollectionResponse([]);
