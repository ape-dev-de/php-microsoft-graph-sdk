...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\HorizontalSectionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for horizontalSections
 */
class HorizontalSectionsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new HorizontalSectionCollectionResponse([]);
