...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DispositionReviewStageStageNumberRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for dispositionReviewStages
 */
class DispositionReviewStagesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new SecurityDispositionReviewStageCollectionResponse([]);
