...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\Directory\ResourceNamespacesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\Directory\RoleAssignmentsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\Directory\RoleAssignmentScheduleInstancesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\Directory\RoleAssignmentScheduleRequestsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\Directory\RoleAssignmentSchedulesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\Directory\RoleDefinitionsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\Directory\RoleEligibilityScheduleInstancesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\Directory\RoleEligibilityScheduleRequestsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\Directory\RoleEligibilitySchedulesRequestBuilder;

/**
 * Request builder for /roleManagement/directory
 */
class DirectoryRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): RbacApplication|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to RbacApplication|null
     */
    private function deserializeGet(string $body): RbacApplication|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(RbacApplication $body): RbacApplication|null
    {
     ...
     * Deserialize response to RbacApplication|null
     */
    private function deserializePatch(string $body): RbacApplication|null    {
        if (empty($body)) {
            return null;
        }
