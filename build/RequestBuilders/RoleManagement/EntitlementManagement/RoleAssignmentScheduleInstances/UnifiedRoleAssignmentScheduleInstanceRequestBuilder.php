...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\EntitlementManagement\RoleAssignmentScheduleInstances;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\UnifiedRoleAssignmentScheduleInstance;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\EntitlementManagement\RoleAssignmentScheduleInstances\ActivatedUsingRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\EntitlementManagement\RoleAssignmentScheduleInstances\AppScopeRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\EntitlementManagement\RoleAssignmentScheduleInstances\DirectoryScopeRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\EntitlementManagement\RoleAssignmentScheduleInstances\PrincipalRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\EntitlementManagement\RoleAssignmentScheduleInstances\RoleDefinitionRequestBuilder;

/**
 * Request builder for /roleManagement/entitlementManagement/roleAssignmentScheduleInstances/{unifiedRoleAssignmentScheduleInstance-id}
 */
class UnifiedRoleAssignmentScheduleInstanceRequestBuilder extends RootBaseRequestBuilder
{
    /**
     ...
     */
    public function get(?array $select = null, ?array $expand = null): UnifiedRoleAssignmentScheduleInstance|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): UnifiedRoleAssignmentScheduleInstance|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(UnifiedRoleAssignmentScheduleInstance $body): UnifiedRoleAssignmentScheduleInstance|null
    {
     ...
     * Deserialize response to UnifiedRoleAssignmentScheduleInstance|null
     */
    private function deserializePatch(string $body): UnifiedRoleAssignmentScheduleInstance|null    {
        if (empty($body)) {
            return null;
        }
