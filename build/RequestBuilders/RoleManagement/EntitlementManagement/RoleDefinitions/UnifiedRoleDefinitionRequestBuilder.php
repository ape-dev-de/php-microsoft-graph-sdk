...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\EntitlementManagement\RoleDefinitions\InheritsPermissionsFromRequestBuilder;

/**
 * Request builder for /roleManagement/entitlementManagement/roleDefinitions/{unifiedRoleDefinition-id}
 */
class UnifiedRoleDefinitionRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(UnifiedRoleDefinition $body): UnifiedRoleDefinition|null
    {
     ...
     * Deserialize response to UnifiedRoleDefinition|null
     */
    private function deserializePatch(string $body): UnifiedRoleDefinition|null    {
        if (empty($body)) {
            return null;
        }
    ...
    /**
     * Navigate to inheritsPermissionsFrom
     *
    ...
    {
        return new InheritsPermissionsFromRequestBuilder($this->client, $this->requestUrl . '/inheritsPermissionsFrom');
    }
}
