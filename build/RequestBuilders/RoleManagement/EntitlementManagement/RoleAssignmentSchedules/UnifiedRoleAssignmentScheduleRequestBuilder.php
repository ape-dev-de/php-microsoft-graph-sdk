...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\EntitlementManagement\RoleAssignmentSchedules;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\UnifiedRoleAssignmentSchedule;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\EntitlementManagement\RoleAssignmentSchedules\ActivatedUsingRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\EntitlementManagement\RoleAssignmentSchedules\AppScopeRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\EntitlementManagement\RoleAssignmentSchedules\DirectoryScopeRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\EntitlementManagement\RoleAssignmentSchedules\PrincipalRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\EntitlementManagement\RoleAssignmentSchedules\RoleDefinitionRequestBuilder;
...
class UnifiedRoleAssignmentScheduleRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): UnifiedRoleAssignmentSchedule|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to UnifiedRoleAssignmentSchedule|null
     */
    private function deserializeGet(string $body): UnifiedRoleAssignmentSchedule|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(UnifiedRoleAssignmentSchedule $body): UnifiedRoleAssignmentSchedule|null
    {
     ...
     * Deserialize response to UnifiedRoleAssignmentSchedule|null
     */
    private function deserializePatch(string $body): UnifiedRoleAssignmentSchedule|null    {
        if (empty($body)) {
            return null;
        }
