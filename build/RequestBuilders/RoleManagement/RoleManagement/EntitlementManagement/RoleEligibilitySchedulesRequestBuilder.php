...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\RoleManagement\EntitlementManagement\RoleEligibilitySchedules\UnifiedRoleEligibilityScheduleRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\RoleManagement\EntitlementManagement\RoleEligibilitySchedules\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\RoleManagement\EntitlementManagement\RoleEligibilitySchedules\FilterByCurrentUserRequestBuilder;

/**
 * Request builder for /roleManagement/entitlementManagement/roleEligibilitySchedules
 */
class RoleEligibilitySchedulesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): UnifiedRoleEligibilityScheduleCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to UnifiedRoleEligibilityScheduleCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(UnifiedRoleEligibilitySchedule $body): UnifiedRoleEligibilitySchedule
    {
