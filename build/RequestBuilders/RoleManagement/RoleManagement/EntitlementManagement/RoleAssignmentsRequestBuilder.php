...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\RoleManagement\EntitlementManagement\RoleAssignments\UnifiedRoleAssignmentRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\RoleManagement\EntitlementManagement\RoleAssignments\CountRequestBuilder;

/**
 * Request builder for /roleManagement/entitlementManagement/roleAssignments
 */
class RoleAssignmentsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): UnifiedRoleAssignmentCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to UnifiedRoleAssignmentCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(UnifiedRoleAssignment $body): UnifiedRoleAssignment
    {
