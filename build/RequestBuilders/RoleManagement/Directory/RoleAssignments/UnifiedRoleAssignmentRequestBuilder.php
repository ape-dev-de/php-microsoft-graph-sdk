...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\Directory\RoleAssignments\AppScopeRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\Directory\RoleAssignments\DirectoryScopeRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\Directory\RoleAssignments\PrincipalRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\Directory\RoleAssignments\RoleDefinitionRequestBuilder;
...
class UnifiedRoleAssignmentRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): UnifiedRoleAssignment|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): UnifiedRoleAssignment|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(UnifiedRoleAssignment $body): UnifiedRoleAssignment|null
    {
     ...
     * Deserialize response to UnifiedRoleAssignment|null
     */
    private function deserializePatch(string $body): UnifiedRoleAssignment|null    {
        if (empty($body)) {
            return null;
        }
