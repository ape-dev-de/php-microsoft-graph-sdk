...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\Directory\RoleEligibilityScheduleInstances;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\UnifiedRoleEligibilityScheduleInstance;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\Directory\RoleEligibilityScheduleInstances\AppScopeRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\Directory\RoleEligibilityScheduleInstances\DirectoryScopeRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\Directory\RoleEligibilityScheduleInstances\PrincipalRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagement\Directory\RoleEligibilityScheduleInstances\RoleDefinitionRequestBuilder;

/**
 * Request builder for /roleManagement/directory/roleEligibilityScheduleInstances/{unifiedRoleEligibilityScheduleInstance-id}
 */
class UnifiedRoleEligibilityScheduleInstanceRequestBuilder extends RootBaseRequestBuilder
{
    /**
     ...
     */
    public function get(?array $select = null, ?array $expand = null): UnifiedRoleEligibilityScheduleInstance|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): UnifiedRoleEligibilityScheduleInstance|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(UnifiedRoleEligibilityScheduleInstance $body): UnifiedRoleEligibilityScheduleInstance|null
    {
     ...
     * Deserialize response to UnifiedRoleEligibilityScheduleInstance|null
     */
    private function deserializePatch(string $body): UnifiedRoleEligibilityScheduleInstance|null    {
        if (empty($body)) {
            return null;
        }
