...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BitlockerRecoveryKeyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for recoveryKeys
 */
class RecoveryKeysRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new BitlockerRecoveryKeyCollectionResponse([]);
