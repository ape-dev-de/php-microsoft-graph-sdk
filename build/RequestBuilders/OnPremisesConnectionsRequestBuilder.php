...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CloudPcOnPremisesConnectionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for onPremisesConnections
 */
class OnPremisesConnectionsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new CloudPcOnPremisesConnectionCollectionResponse([]);
