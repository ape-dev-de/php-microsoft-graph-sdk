...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\GranularMailboxRestoreArtifactRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for granularMailboxRestoreArtifacts
 */
class GranularMailboxRestoreArtifactsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new GranularMailboxRestoreArtifactCollectionResponse([]);
