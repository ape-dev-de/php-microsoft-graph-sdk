...
/**
 * Request builder for Invitation collection
 */
class InvitationsRequestBuilder extends BaseRequestBuilder
{
     ...
     */
    public function byId(string $id): InvitationItemRequestBuilder
    {
        return new InvitationItemRequestBuilder($this->client, $this->buildPath($id));
    }
