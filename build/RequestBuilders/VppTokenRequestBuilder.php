...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\SyncLicensesRequestBuilder;

/**
 * Request builder for {vppToken-id}
 */
class VppTokenRequestBuilder extends BaseRequestBuilder
{
    /**
     * Get vppToken
     *
