...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Shares\Shares\List\Items\DriveItem\ContentRequestBuilder;

/**
 * Request builder for /shares/{sharedDriveItem-id}/list/items/{listItem-id}/driveItem
 */
