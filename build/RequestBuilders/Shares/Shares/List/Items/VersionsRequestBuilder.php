...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Shares\Shares\List\Items\Versions\ListItemVersionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Shares\Shares\List\Items\Versions\CountRequestBuilder;

/**
 * Request builder for /shares/{sharedDriveItem-id}/list/items/{listItem-id}/versions
 */
class VersionsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): ListItemVersionCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to ListItemVersionCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(ListItemVersion $body): ListItemVersion
    {
