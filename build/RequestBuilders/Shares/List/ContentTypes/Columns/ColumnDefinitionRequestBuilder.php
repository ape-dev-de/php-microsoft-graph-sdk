...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Shares\List\ContentTypes\Columns\SourceColumnRequestBuilder;

/**
 * Request builder for /shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}/columns/{columnDefinition-id}
 */
