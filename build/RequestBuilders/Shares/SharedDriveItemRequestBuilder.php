...
class SharedDriveItemRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SharedDriveItem|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): SharedDriveItem|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SharedDriveItem $body): SharedDriveItem|null
    {
     ...
     * Deserialize response to SharedDriveItem|null
     */
    private function deserializePatch(string $body): SharedDriveItem|null    {
        if (empty($body)) {
            return null;
        }
