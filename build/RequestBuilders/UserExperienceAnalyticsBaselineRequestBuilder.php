...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AppHealthMetricsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BatteryHealthMetricsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BestPracticesMetricsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceBootPerformanceMetricsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RebootAnalyticsMetricsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ResourcePerformanceMetricsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\WorkFromAnywhereMetricsRequestBuilder;

/**
 * Request builder for {userExperienceAnalyticsBaseline-id}
 */
class UserExperienceAnalyticsBaselineRequestBuilder extends BaseRequestBuilder
{
    /**
