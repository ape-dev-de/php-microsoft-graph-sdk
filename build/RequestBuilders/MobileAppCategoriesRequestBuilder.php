...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\MobileAppCategoryRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for mobileAppCategories
 */
class MobileAppCategoriesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new MobileAppCategoryCollectionResponse([]);
