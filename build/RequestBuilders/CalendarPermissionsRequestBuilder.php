...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CalendarPermissionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for calendarPermissions
 */
class CalendarPermissionsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new CalendarPermissionCollectionResponse([]);
