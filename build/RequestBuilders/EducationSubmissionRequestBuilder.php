...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ExcuseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ReassignRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ReturnRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\SetUpResourcesFolderRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\SubmitRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\UnsubmitRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\OutcomesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ResourcesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\SubmittedResourcesRequestBuilder;

/**
 * Request builder for {educationSubmission-id}
 */
class EducationSubmissionRequestBuilder extends BaseRequestBuilder
{
    /**
     ...
     */
    public function return(): ReturnRequestBuilder
    {
        return new ReturnRequestBuilder($this->client, $this->requestUrl . '/return');
    }
    /**
