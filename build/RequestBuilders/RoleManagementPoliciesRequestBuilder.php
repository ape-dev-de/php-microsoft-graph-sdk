...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\UnifiedRoleManagementPolicyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for roleManagementPolicies
 */
class RoleManagementPoliciesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new UnifiedRoleManagementPolicyCollectionResponse([]);
