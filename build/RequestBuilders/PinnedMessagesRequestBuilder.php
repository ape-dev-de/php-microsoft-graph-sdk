...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\PinnedChatMessageInfoRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for pinnedMessages
 */
class PinnedMessagesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new PinnedChatMessageInfoCollectionResponse([]);
