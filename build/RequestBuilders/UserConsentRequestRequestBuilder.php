...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ApprovalRequestBuilder;

/**
 * Request builder for {userConsentRequest-id}
 */
class UserConsentRequestRequestBuilder extends BaseRequestBuilder
{
    /**
