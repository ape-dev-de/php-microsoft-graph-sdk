...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ServiceManagementDetailsRequestBuilder;

/**
 * Request builder for {delegatedAdminCustomer-id}
 */
class DelegatedAdminCustomerRequestBuilder extends BaseRequestBuilder
{
    /**
