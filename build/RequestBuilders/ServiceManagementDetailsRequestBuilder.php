...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DelegatedAdminServiceManagementDetailRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for serviceManagementDetails
 */
class ServiceManagementDetailsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new DelegatedAdminServiceManagementDetailCollectionResponse([]);
