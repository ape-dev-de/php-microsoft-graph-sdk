...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagementExportJobRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for exportJobs
 */
class ExportJobsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new DeviceManagementExportJobCollectionResponse([]);
