...
/**
 * Request builder for {userExperienceAnalyticsWorkFromAnywhereDevice-id}
 */
class UserExperienceAnalyticsWorkFromAnywhereDeviceRequestBuilder extends BaseRequestBuilder
{
    /**
