...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\MobileThreatDefenseConnectorRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for mobileThreatDefenseConnectors
 */
class MobileThreatDefenseConnectorsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new MobileThreatDefenseConnectorCollectionResponse([]);
