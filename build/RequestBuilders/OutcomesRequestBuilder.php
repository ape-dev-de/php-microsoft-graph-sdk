...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\EducationOutcomeRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for outcomes
 */
class OutcomesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new EducationOutcomeCollectionResponse([]);
