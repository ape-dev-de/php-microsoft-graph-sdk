...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CallRecordingRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeltaRequestBuilder;

/**
 * Request builder for recordings
 */
class RecordingsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new CallRecordingCollectionResponse([]);
