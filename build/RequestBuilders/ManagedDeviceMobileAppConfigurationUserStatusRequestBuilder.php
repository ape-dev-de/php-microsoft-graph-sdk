...
/**
 * Request builder for {managedDeviceMobileAppConfigurationUserStatus-id}
 */
class ManagedDeviceMobileAppConfigurationUserStatusRequestBuilder extends BaseRequestBuilder
{
    /**
