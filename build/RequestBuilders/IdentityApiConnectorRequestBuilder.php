...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\UploadClientCertificateRequestBuilder;

/**
 * Request builder for {identityApiConnector-id}
 */
class IdentityApiConnectorRequestBuilder extends BaseRequestBuilder
{
    /**
