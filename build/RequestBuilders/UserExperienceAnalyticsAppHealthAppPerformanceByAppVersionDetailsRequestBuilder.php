...
/**
 * Request builder for {userExperienceAnalyticsAppHealthAppPerformanceByAppVersionDetails-id}
 */
class UserExperienceAnalyticsAppHealthAppPerformanceByAppVersionDetailsRequestBuilder extends BaseRequestBuilder
{
    /**
