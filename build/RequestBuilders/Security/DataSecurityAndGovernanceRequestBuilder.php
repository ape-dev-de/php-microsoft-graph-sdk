...
class DataSecurityAndGovernanceRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): TenantDataSecurityAndGovernance|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to TenantDataSecurityAndGovernance|null
     */
    private function deserializeGet(string $body): TenantDataSecurityAndGovernance|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(TenantDataSecurityAndGovernance $body): TenantDataSecurityAndGovernance|null
    {
     ...
     * Deserialize response to TenantDataSecurityAndGovernance|null
     */
    private function deserializePatch(string $body): TenantDataSecurityAndGovernance|null    {
        if (empty($body)) {
            return null;
        }
