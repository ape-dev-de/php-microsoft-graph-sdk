...
class ArticleIndicatorRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SecurityArticleIndicator $body): SecurityArticleIndicator|null
    {
     ...
     * Deserialize response to SecurityArticleIndicator|null
     */
    private function deserializePatch(string $body): SecurityArticleIndicator|null    {
        if (empty($body)) {
            return null;
        }
