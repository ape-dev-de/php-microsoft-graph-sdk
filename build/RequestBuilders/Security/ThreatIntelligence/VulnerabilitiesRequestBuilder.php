...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\ThreatIntelligence\Vulnerabilities\VulnerabilityRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\ThreatIntelligence\Vulnerabilities\CountRequestBuilder;
...
class VulnerabilitiesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return SecurityVulnerabilityCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): SecurityVulnerabilityCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SecurityVulnerabilityCollectionResponse|null
     */
    private function deserializeGet(string $body): SecurityVulnerabilityCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(SecurityVulnerability $body): SecurityVulnerability|null
    {
    ...
    /**
     * Deserialize response to SecurityVulnerability|null
     */
    private function deserializePost(string $body): SecurityVulnerability|null    {
        if (empty($body)) {
            return null;
        }
