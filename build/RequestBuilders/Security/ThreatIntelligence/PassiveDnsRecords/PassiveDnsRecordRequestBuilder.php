...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\ThreatIntelligence\PassiveDnsRecords;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\SecurityPassiveDnsRecord;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\ThreatIntelligence\PassiveDnsRecords\ArtifactRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\ThreatIntelligence\PassiveDnsRecords\ParentHostRequestBuilder;
...
class PassiveDnsRecordRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SecurityPassiveDnsRecord|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): SecurityPassiveDnsRecord|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SecurityPassiveDnsRecord $body): SecurityPassiveDnsRecord|null
    {
     ...
     * Deserialize response to SecurityPassiveDnsRecord|null
     */
    private function deserializePatch(string $body): SecurityPassiveDnsRecord|null    {
        if (empty($body)) {
            return null;
        }
