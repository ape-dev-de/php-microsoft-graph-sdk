...
class WhoisRecordRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SecurityWhoisRecord|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): SecurityWhoisRecord|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SecurityWhoisRecord $body): SecurityWhoisRecord|null
    {
     ...
     * Deserialize response to SecurityWhoisRecord|null
     */
    private function deserializePatch(string $body): SecurityWhoisRecord|null    {
        if (empty($body)) {
            return null;
        }
