...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\ThreatIntelligence\Subdomains;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\SecuritySubdomain;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\ThreatIntelligence\Subdomains\HostRequestBuilder;
...
class SubdomainRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SecuritySubdomain|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): SecuritySubdomain|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SecuritySubdomain $body): SecuritySubdomain|null
    {
     ...
     * Deserialize response to SecuritySubdomain|null
     */
    private function deserializePatch(string $body): SecuritySubdomain|null    {
        if (empty($body)) {
            return null;
        }
