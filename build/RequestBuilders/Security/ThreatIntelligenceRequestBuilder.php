...
class ThreatIntelligenceRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SecurityThreatIntelligence|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SecurityThreatIntelligence|null
     */
    private function deserializeGet(string $body): SecurityThreatIntelligence|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SecurityThreatIntelligence $body): SecurityThreatIntelligence|null
    {
     ...
     * Deserialize response to SecurityThreatIntelligence|null
     */
    private function deserializePatch(string $body): SecurityThreatIntelligence|null    {
        if (empty($body)) {
            return null;
        }
