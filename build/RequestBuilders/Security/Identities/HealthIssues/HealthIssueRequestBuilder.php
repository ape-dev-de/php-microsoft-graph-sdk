...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Identities\HealthIssues;
...
class HealthIssueRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SecurityHealthIssue $body): SecurityHealthIssue|null
    {
     ...
     * Deserialize response to SecurityHealthIssue|null
     */
    private function deserializePatch(string $body): SecurityHealthIssue|null    {
        if (empty($body)) {
            return null;
        }
