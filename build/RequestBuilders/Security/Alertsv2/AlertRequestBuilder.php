...
class AlertRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SecurityAlert|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): SecurityAlert|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SecurityAlert $body): SecurityAlert|null
    {
     ...
     * Deserialize response to SecurityAlert|null
     */
    private function deserializePatch(string $body): SecurityAlert|null    {
        if (empty($body)) {
            return null;
        }
