...
class UserSourceRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SecurityUserSource|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): SecurityUserSource|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SecurityUserSource $body): SecurityUserSource|null
    {
     ...
     * Deserialize response to SecurityUserSource|null
     */
    private function deserializePatch(string $body): SecurityUserSource|null    {
        if (empty($body)) {
            return null;
        }
