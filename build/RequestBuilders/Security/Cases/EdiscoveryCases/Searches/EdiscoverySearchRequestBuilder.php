...
class EdiscoverySearchRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SecurityEdiscoverySearch|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): SecurityEdiscoverySearch|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SecurityEdiscoverySearch $body): SecurityEdiscoverySearch|null
    {
     ...
     * Deserialize response to SecurityEdiscoverySearch|null
     */
    private function deserializePatch(string $body): SecurityEdiscoverySearch|null    {
        if (empty($body)) {
            return null;
        }
