...
class EdiscoveryReviewTagRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SecurityEdiscoveryReviewTag|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): SecurityEdiscoveryReviewTag|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SecurityEdiscoveryReviewTag $body): SecurityEdiscoveryReviewTag|null
    {
     ...
     * Deserialize response to SecurityEdiscoveryReviewTag|null
     */
    private function deserializePatch(string $body): SecurityEdiscoveryReviewTag|null    {
        if (empty($body)) {
            return null;
        }
