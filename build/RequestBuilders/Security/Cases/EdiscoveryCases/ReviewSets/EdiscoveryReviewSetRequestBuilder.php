...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Cases\EdiscoveryCases\ReviewSets\SecurityAddToReviewSetRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Cases\EdiscoveryCases\ReviewSets\SecurityExportRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Cases\EdiscoveryCases\ReviewSets\QueriesRequestBuilder;
...
class EdiscoveryReviewSetRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return SecurityEdiscoveryReviewSet|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null): SecurityEdiscoveryReviewSet|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SecurityEdiscoveryReviewSet|null
     */
    private function deserializeGet(string $body): SecurityEdiscoveryReviewSet|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SecurityEdiscoveryReviewSet $body): SecurityEdiscoveryReviewSet|null
    {
     ...
     * Deserialize response to SecurityEdiscoveryReviewSet|null
     */
    private function deserializePatch(string $body): SecurityEdiscoveryReviewSet|null    {
        if (empty($body)) {
            return null;
        }
