...
class EdiscoveryReviewSetQueryRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SecurityEdiscoveryReviewSetQuery|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): SecurityEdiscoveryReviewSetQuery|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SecurityEdiscoveryReviewSetQuery $body): SecurityEdiscoveryReviewSetQuery|null
    {
     ...
     * Deserialize response to SecurityEdiscoveryReviewSetQuery|null
     */
    private function deserializePatch(string $body): SecurityEdiscoveryReviewSetQuery|null    {
        if (empty($body)) {
            return null;
        }
