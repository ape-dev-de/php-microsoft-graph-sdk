...
class NoncustodialDataSourcesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(SecurityEdiscoveryNoncustodialDataSource $body): SecurityEdiscoveryNoncustodialDataSource|null
    {
     ...
     */
    private function deserializePost(string $body): SecurityEdiscoveryNoncustodialDataSource|null    {
        if (empty($body)) {
            return null;
        }
