...
class EdiscoveryCaseRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SecurityEdiscoveryCase|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): SecurityEdiscoveryCase|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SecurityEdiscoveryCase $body): SecurityEdiscoveryCase|null
    {
     ...
     * Deserialize response to SecurityEdiscoveryCase|null
     */
    private function deserializePatch(string $body): SecurityEdiscoveryCase|null    {
        if (empty($body)) {
            return null;
        }
