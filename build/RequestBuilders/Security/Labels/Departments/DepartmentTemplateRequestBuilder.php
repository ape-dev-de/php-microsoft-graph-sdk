...
class DepartmentTemplateRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SecurityDepartmentTemplate $body): SecurityDepartmentTemplate|null
    {
     ...
     * Deserialize response to SecurityDepartmentTemplate|null
     */
    private function deserializePatch(string $body): SecurityDepartmentTemplate|null    {
        if (empty($body)) {
            return null;
        }
