...
class DepartmentsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return SecurityDepartmentTemplateCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): SecurityDepartmentTemplateCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SecurityDepartmentTemplateCollectionResponse|null
     */
    private function deserializeGet(string $body): SecurityDepartmentTemplateCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(SecurityDepartmentTemplate $body): SecurityDepartmentTemplate|null
    {
     ...
     */
    private function deserializePost(string $body): SecurityDepartmentTemplate|null    {
        if (empty($body)) {
            return null;
        }
