...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Labels\Categories\SubcategoriesRequestBuilder;
...
class CategoryTemplateRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SecurityCategoryTemplate|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): SecurityCategoryTemplate|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SecurityCategoryTemplate $body): SecurityCategoryTemplate|null
    {
     ...
     * Deserialize response to SecurityCategoryTemplate|null
     */
    private function deserializePatch(string $body): SecurityCategoryTemplate|null    {
        if (empty($body)) {
            return null;
        }
