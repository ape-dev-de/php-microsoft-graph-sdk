...
class DispositionReviewStageStageNumberRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SecurityDispositionReviewStage|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): SecurityDispositionReviewStage|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SecurityDispositionReviewStage $body): SecurityDispositionReviewStage|null
    {
     ...
     * Deserialize response to SecurityDispositionReviewStage|null
     */
    private function deserializePatch(string $body): SecurityDispositionReviewStage|null    {
        if (empty($body)) {
            return null;
        }
