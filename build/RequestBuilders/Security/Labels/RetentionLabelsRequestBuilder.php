...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Labels\RetentionLabels\RetentionLabelRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Labels\RetentionLabels\CountRequestBuilder;
...
class RetentionLabelsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return SecurityRetentionLabelCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): SecurityRetentionLabelCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SecurityRetentionLabelCollectionResponse|null
     */
    private function deserializeGet(string $body): SecurityRetentionLabelCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(SecurityRetentionLabel $body): SecurityRetentionLabel|null
    {
     ...
     */
    private function deserializePost(string $body): SecurityRetentionLabel|null    {
        if (empty($body)) {
            return null;
        }
