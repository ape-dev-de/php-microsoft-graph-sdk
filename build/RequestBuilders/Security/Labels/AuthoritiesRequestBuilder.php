...
class AuthoritiesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return SecurityAuthorityTemplateCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): SecurityAuthorityTemplateCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SecurityAuthorityTemplateCollectionResponse|null
     */
    private function deserializeGet(string $body): SecurityAuthorityTemplateCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(SecurityAuthorityTemplate $body): SecurityAuthorityTemplate|null
    {
     ...
     */
    private function deserializePost(string $body): SecurityAuthorityTemplate|null    {
        if (empty($body)) {
            return null;
        }
