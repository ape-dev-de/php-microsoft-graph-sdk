...
class SecurityRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): Security|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to Security|null
     */
    private function deserializeGet(string $body): Security|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(Security $body): Security|null
    {
     ...
     * Deserialize response to Security|null
     */
    private function deserializePatch(string $body): Security|null    {
        if (empty($body)) {
            return null;
        }
