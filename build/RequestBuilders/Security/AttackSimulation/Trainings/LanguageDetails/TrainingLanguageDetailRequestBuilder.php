...
class TrainingLanguageDetailRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): TrainingLanguageDetail|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): TrainingLanguageDetail|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(TrainingLanguageDetail $body): TrainingLanguageDetail|null
    {
     ...
     * Deserialize response to TrainingLanguageDetail|null
     */
    private function deserializePatch(string $body): TrainingLanguageDetail|null    {
        if (empty($body)) {
            return null;
        }
