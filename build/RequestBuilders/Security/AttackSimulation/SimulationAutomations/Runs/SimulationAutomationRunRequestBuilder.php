...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\AttackSimulation\SimulationAutomations\Runs;
...
class SimulationAutomationRunRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SimulationAutomationRun|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): SimulationAutomationRun|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SimulationAutomationRun $body): SimulationAutomationRun|null
    {
     ...
     * Deserialize response to SimulationAutomationRun|null
     */
    private function deserializePatch(string $body): SimulationAutomationRun|null    {
        if (empty($body)) {
            return null;
        }
