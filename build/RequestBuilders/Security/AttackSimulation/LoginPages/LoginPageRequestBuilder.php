...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\AttackSimulation\LoginPages;
...
/**
 * Request builder for /security/attackSimulation/loginPages/{loginPage-id}
 */
class LoginPageRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(LoginPage $body): LoginPage|null
    {
     ...
     * Deserialize response to LoginPage|null
     */
    private function deserializePatch(string $body): LoginPage|null    {
        if (empty($body)) {
            return null;
        }
