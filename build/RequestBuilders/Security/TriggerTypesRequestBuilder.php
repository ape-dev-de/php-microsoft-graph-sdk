...
class TriggerTypesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SecurityTriggerTypesRoot|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SecurityTriggerTypesRoot|null
     */
    private function deserializeGet(string $body): SecurityTriggerTypesRoot|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SecurityTriggerTypesRoot $body): SecurityTriggerTypesRoot|null
    {
     ...
     * Deserialize response to SecurityTriggerTypesRoot|null
     */
    private function deserializePatch(string $body): SecurityTriggerTypesRoot|null    {
        if (empty($body)) {
            return null;
        }
