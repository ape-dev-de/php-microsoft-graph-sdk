...
class RetentionEventsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return SecurityRetentionEventCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): SecurityRetentionEventCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SecurityRetentionEventCollectionResponse|null
     */
    private function deserializeGet(string $body): SecurityRetentionEventCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(SecurityRetentionEvent $body): SecurityRetentionEvent|null
    {
     ...
     */
    private function deserializePost(string $body): SecurityRetentionEvent|null    {
        if (empty($body)) {
            return null;
        }
