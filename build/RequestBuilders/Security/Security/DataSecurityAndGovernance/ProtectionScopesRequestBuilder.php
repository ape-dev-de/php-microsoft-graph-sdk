...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\DataSecurityAndGovernance\ProtectionScopes\ComputeRequestBuilder;
...
class ProtectionScopesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): TenantProtectionScopeContainer
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to TenantProtectionScopeContainer
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(TenantProtectionScopeContainer $body): TenantProtectionScopeContainer
    {
