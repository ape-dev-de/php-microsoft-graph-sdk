...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\Alertsv2\Comments;
...
/**
 * Request builder for /security/alerts_v2/{alert-id}/comments/$count
 */
