...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\SubjectRightsRequests\ApproversRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\SubjectRightsRequests\CollaboratorsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\SubjectRightsRequests\GetFinalAttachmentRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\SubjectRightsRequests\GetFinalReportRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\SubjectRightsRequests\NotesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\SubjectRightsRequests\TeamRequestBuilder;
