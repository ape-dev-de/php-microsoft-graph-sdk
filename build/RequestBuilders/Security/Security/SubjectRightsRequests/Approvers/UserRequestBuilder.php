...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\SubjectRightsRequests\Approvers\MailboxSettingsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\SubjectRightsRequests\Approvers\ServiceProvisioningErrorsRequestBuilder;

/**
 * Request builder for /security/subjectRightsRequests/{subjectRightsRequest-id}/approvers/{user-id}
 */
