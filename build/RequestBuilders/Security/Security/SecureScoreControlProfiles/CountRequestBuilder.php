...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\SecureScoreControlProfiles;
...
/**
 * Request builder for /security/secureScoreControlProfiles/$count
 */
