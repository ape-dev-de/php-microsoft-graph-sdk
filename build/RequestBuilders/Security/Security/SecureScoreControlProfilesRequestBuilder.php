...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\SecureScoreControlProfiles\SecureScoreControlProfileRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\SecureScoreControlProfiles\CountRequestBuilder;
...
class SecureScoreControlProfilesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): SecureScoreControlProfileCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SecureScoreControlProfileCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(SecureScoreControlProfile $body): SecureScoreControlProfile
    {
