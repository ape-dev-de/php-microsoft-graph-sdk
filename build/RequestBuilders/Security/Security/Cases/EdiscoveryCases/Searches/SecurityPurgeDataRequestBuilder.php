...
/**
 * Request builder for /security/cases/ediscoveryCases/{ediscoveryCase-id}/searches/{ediscoverySearch-id}/microsoft.graph.security.purgeData
 */
class SecurityPurgeDataRequestBuilder extends RootBaseRequestBuilder
{
    /**
