...
/**
 * Request builder for /security/cases/ediscoveryCases/{ediscoveryCase-id}/searches/{ediscoverySearch-id}/microsoft.graph.security.exportResult
 */
class SecurityExportResultRequestBuilder extends RootBaseRequestBuilder
{
    /**
