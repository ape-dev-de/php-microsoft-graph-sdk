...
/**
 * Request builder for /security/cases/ediscoveryCases/{ediscoveryCase-id}/searches/{ediscoverySearch-id}/microsoft.graph.security.exportReport
 */
class SecurityExportReportRequestBuilder extends RootBaseRequestBuilder
{
    /**
