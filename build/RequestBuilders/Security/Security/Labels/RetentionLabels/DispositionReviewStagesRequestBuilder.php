...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\Labels\RetentionLabels\DispositionReviewStages\DispositionReviewStageStageNumberRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\Labels\RetentionLabels\DispositionReviewStages\CountRequestBuilder;
...
class DispositionReviewStagesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return SecurityDispositionReviewStageCollectionResponse
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): SecurityDispositionReviewStageCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SecurityDispositionReviewStageCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(SecurityDispositionReviewStage $body): SecurityDispositionReviewStage
    {
