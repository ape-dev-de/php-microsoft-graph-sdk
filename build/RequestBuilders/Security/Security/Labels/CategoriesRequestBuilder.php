...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\Labels\Categories\CategoryTemplateRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\Labels\Categories\CountRequestBuilder;
...
class CategoriesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): SecurityCategoryTemplateCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SecurityCategoryTemplateCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(SecurityCategoryTemplate $body): SecurityCategoryTemplate
    {
