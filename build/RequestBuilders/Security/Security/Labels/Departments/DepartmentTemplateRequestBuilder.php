...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\Labels\Departments;
...
/**
 * Request builder for /security/labels/departments/{departmentTemplate-id}
 */
class DepartmentTemplateRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SecurityDepartmentTemplate
    {
        $queryParams = [];
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SecurityDepartmentTemplate $body): SecurityDepartmentTemplate
    {
