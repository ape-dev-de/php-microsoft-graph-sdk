...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\Labels\Citations;
...
/**
 * Request builder for /security/labels/citations/{citationTemplate-id}
 */
class CitationTemplateRequestBuilder extends RootBaseRequestBuilder
{
    /**
