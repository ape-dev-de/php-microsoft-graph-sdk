...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\Labels\FilePlanReferences;
...
/**
 * Request builder for /security/labels/filePlanReferences/$count
 */
