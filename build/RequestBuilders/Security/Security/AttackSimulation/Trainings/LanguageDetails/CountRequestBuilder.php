...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\AttackSimulation\Trainings\LanguageDetails;
...
/**
 * Request builder for /security/attackSimulation/trainings/{training-id}/languageDetails/$count
 */
