...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\AttackSimulation\EndUserNotifications\DetailsRequestBuilder;
...
class EndUserNotificationRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): EndUserNotification
    {
        $queryParams = [];
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(EndUserNotification $body): EndUserNotification
    {
