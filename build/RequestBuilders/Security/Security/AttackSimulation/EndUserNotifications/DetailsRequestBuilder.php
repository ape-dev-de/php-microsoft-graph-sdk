...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\AttackSimulation\EndUserNotifications;
...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\AttackSimulation\EndUserNotifications\Details\EndUserNotificationDetailRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\AttackSimulation\EndUserNotifications\Details\CountRequestBuilder;
...
class DetailsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): EndUserNotificationDetailCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to EndUserNotificationDetailCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(EndUserNotificationDetail $body): EndUserNotificationDetail
    {
