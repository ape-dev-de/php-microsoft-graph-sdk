...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\Triggers\RetentionEventsRequestBuilder;
...
class TriggersRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SecurityTriggersRoot
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SecurityTriggersRoot
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SecurityTriggersRoot $body): SecurityTriggersRoot
    {
