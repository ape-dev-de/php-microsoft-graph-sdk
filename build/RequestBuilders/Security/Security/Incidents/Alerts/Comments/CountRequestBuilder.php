...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\Incidents\Alerts\Comments;
...
/**
 * Request builder for /security/incidents/{incident-id}/alerts/{alert-id}/comments/$count
 */
