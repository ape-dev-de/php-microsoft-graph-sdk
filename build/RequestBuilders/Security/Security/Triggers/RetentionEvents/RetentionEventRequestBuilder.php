...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\Triggers\RetentionEvents;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\SecurityRetentionEvent;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\Triggers\RetentionEvents\RetentionEventTypeRequestBuilder;
...
class RetentionEventRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SecurityRetentionEvent
    {
        $queryParams = [];
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SecurityRetentionEvent $body): SecurityRetentionEvent
    {
