...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\ThreatIntelligence\HostSslCertificates\HostSslCertificateRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\ThreatIntelligence\HostSslCertificates\CountRequestBuilder;
...
class HostSslCertificatesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(SecurityHostSslCertificate $body): SecurityHostSslCertificate
    {
