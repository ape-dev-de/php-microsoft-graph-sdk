...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\ThreatIntelligence\Hosts\Trackers\HostTrackerRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\ThreatIntelligence\Hosts\Trackers\CountRequestBuilder;

/**
 * Request builder for /security/threatIntelligence/hosts/{host-id}/trackers
 */
class TrackersRequestBuilder extends RootBaseRequestBuilder
{
    /**
     * List trackers
     *
