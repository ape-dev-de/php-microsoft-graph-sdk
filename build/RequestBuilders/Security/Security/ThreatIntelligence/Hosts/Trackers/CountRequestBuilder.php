...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\ThreatIntelligence\Hosts\Trackers;
...
/**
 * Request builder for /security/threatIntelligence/hosts/{host-id}/trackers/$count
 */
