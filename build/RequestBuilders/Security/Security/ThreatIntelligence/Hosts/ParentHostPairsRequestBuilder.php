...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\ThreatIntelligence\Hosts\ParentHostPairs\HostPairRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\ThreatIntelligence\Hosts\ParentHostPairs\CountRequestBuilder;

/**
 * Request builder for /security/threatIntelligence/hosts/{host-id}/parentHostPairs
 */
class ParentHostPairsRequestBuilder extends RootBaseRequestBuilder
{
    /**
