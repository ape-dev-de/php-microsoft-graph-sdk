...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\ThreatIntelligence\Hosts\SslCertificates;
...
/**
 * Request builder for /security/threatIntelligence/hosts/{host-id}/sslCertificates/$count
 */
