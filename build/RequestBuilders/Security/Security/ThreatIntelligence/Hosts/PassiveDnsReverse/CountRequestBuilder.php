...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\ThreatIntelligence\Hosts\PassiveDnsReverse;
...
/**
 * Request builder for /security/threatIntelligence/hosts/{host-id}/passiveDnsReverse/$count
 */
