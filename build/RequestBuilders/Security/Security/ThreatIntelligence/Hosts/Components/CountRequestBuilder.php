...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\ThreatIntelligence\Hosts\Components;
...
/**
 * Request builder for /security/threatIntelligence/hosts/{host-id}/components/$count
 */
