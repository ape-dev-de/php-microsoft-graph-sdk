...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\ThreatIntelligence\Hosts\Cookies;
...
/**
 * Request builder for /security/threatIntelligence/hosts/{host-id}/cookies/$count
 */
