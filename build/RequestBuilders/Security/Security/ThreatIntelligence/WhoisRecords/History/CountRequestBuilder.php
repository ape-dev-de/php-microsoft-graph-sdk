...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Security\Security\ThreatIntelligence\WhoisRecords\History;
...
/**
 * Request builder for /security/threatIntelligence/whoisRecords/{whoisRecord-id}/history/$count
 */
