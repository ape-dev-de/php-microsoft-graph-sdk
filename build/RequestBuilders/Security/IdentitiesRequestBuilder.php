...
class IdentitiesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SecurityIdentityContainer|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SecurityIdentityContainer|null
     */
    private function deserializeGet(string $body): SecurityIdentityContainer|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SecurityIdentityContainer $body): SecurityIdentityContainer|null
    {
     ...
     * Deserialize response to SecurityIdentityContainer|null
     */
    private function deserializePatch(string $body): SecurityIdentityContainer|null    {
        if (empty($body)) {
            return null;
        }
