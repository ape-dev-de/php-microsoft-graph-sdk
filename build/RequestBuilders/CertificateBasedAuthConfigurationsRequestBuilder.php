...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CertificateBasedAuthPkiRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for certificateBasedAuthConfigurations
 */
class CertificateBasedAuthConfigurationsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new CertificateBasedAuthPkiCollectionResponse([]);
