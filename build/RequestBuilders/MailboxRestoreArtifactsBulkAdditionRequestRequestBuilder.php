...
/**
 * Request builder for {mailboxRestoreArtifactsBulkAdditionRequest-id}
 */
class MailboxRestoreArtifactsBulkAdditionRequestRequestBuilder extends BaseRequestBuilder
{
    /**
