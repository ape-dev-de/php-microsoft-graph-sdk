...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AssociatedTeamInfoRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for associatedTeams
 */
class AssociatedTeamsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new AssociatedTeamInfoCollectionResponse([]);
