...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ExchangeProtectionPolicyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for exchangeProtectionPolicies
 */
class ExchangeProtectionPoliciesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new ExchangeProtectionPolicyCollectionResponse([]);
