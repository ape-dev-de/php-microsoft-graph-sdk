...
class SignInsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return SignInCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): SignInCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SignInCollectionResponse|null
     */
    private function deserializeGet(string $body): SignInCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(SignIn $body): SignIn|null
    {
     ...
     */
    private function deserializePost(string $body): SignIn|null    {
        if (empty($body)) {
            return null;
        }
