...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\HomeRealmDiscoveryPolicyRequestBuilder;

/**
 * Request builder for homeRealmDiscoveryPolicies
 */
class HomeRealmDiscoveryPoliciesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new HomeRealmDiscoveryPolicyCollectionResponse([]);
