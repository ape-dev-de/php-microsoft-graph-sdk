...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceComplianceSettingStateRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for deviceComplianceSettingStates
 */
class DeviceComplianceSettingStatesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new DeviceComplianceSettingStateCollectionResponse([]);
