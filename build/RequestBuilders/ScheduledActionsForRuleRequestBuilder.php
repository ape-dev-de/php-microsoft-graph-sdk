...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceComplianceScheduledActionForRuleRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for scheduledActionsForRule
 */
class ScheduledActionsForRuleRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new DeviceComplianceScheduledActionForRuleCollectionResponse([]);
