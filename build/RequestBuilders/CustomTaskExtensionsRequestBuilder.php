...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CustomTaskExtensionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for customTaskExtensions
 */
class CustomTaskExtensionsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new IdentityGovernanceCustomTaskExtensionCollectionResponse([]);
