...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\EducationGradingCategoryRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for gradingCategories
 */
class GradingCategoriesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new EducationGradingCategoryCollectionResponse([]);
