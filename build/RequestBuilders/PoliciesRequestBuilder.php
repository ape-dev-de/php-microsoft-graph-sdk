...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ActivityBasedTimeoutPoliciesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AdminConsentRequestPolicyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AppManagementPoliciesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AuthenticationFlowsPolicyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AuthenticationMethodsPolicyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AuthenticationStrengthPoliciesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AuthorizationPolicyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ClaimsMappingPoliciesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ConditionalAccessPoliciesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CrossTenantAccessPolicyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DefaultAppManagementPolicyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceRegistrationPolicyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\FeatureRolloutPoliciesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\HomeRealmDiscoveryPoliciesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentitySecurityDefaultsEnforcementPolicyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\PermissionGrantPoliciesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagementPoliciesRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RoleManagementPolicyAssignmentsRequestBuilder;
