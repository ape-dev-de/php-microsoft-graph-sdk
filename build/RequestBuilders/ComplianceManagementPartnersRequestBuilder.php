...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ComplianceManagementPartnerRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for complianceManagementPartners
 */
class ComplianceManagementPartnersRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new ComplianceManagementPartnerCollectionResponse([]);
