...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IntelligenceProfileIndicatorRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for intelligenceProfileIndicators
 */
class IntelligenceProfileIndicatorsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new SecurityIntelligenceProfileIndicatorCollectionResponse([]);
