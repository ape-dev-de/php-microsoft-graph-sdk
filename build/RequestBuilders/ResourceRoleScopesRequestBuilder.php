...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AccessPackageResourceRoleScopeRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for resourceRoleScopes
 */
class ResourceRoleScopesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new AccessPackageResourceRoleScopeCollectionResponse([]);
