...
/**
 * Request builder for /reports/getSkypeForBusinessPeerToPeerActivityMinuteCounts(period='{period}')
 */
class GetSkypeForBusinessPeerToPeerActivityMinuteCountsRequestBuilder extends RootBaseRequestBuilder
{
    /**
