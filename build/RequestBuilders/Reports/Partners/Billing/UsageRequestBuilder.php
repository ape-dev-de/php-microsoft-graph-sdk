...
class UsageRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): PartnersBillingAzureUsage|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to PartnersBillingAzureUsage|null
     */
    private function deserializeGet(string $body): PartnersBillingAzureUsage|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(PartnersBillingAzureUsage $body): PartnersBillingAzureUsage|null
    {
     ...
     * Deserialize response to PartnersBillingAzureUsage|null
     */
    private function deserializePatch(string $body): PartnersBillingAzureUsage|null    {
        if (empty($body)) {
            return null;
        }
