...
class BilledRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): PartnersBillingBilledUsage|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to PartnersBillingBilledUsage|null
     */
    private function deserializeGet(string $body): PartnersBillingBilledUsage|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(PartnersBillingBilledUsage $body): PartnersBillingBilledUsage|null
    {
     ...
     * Deserialize response to PartnersBillingBilledUsage|null
     */
    private function deserializePatch(string $body): PartnersBillingBilledUsage|null    {
        if (empty($body)) {
            return null;
        }
