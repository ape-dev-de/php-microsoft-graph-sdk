...
class ManifestRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): PartnersBillingManifest|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): PartnersBillingManifest|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(PartnersBillingManifest $body): PartnersBillingManifest|null
    {
     ...
     * Deserialize response to PartnersBillingManifest|null
     */
    private function deserializePatch(string $body): PartnersBillingManifest|null    {
        if (empty($body)) {
            return null;
        }
