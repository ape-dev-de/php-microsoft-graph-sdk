...
class UnbilledRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): PartnersBillingUnbilledReconciliation|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to PartnersBillingUnbilledReconciliation|null
     */
    private function deserializeGet(string $body): PartnersBillingUnbilledReconciliation|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(PartnersBillingUnbilledReconciliation $body): PartnersBillingUnbilledReconciliation|null
    {
     ...
     * Deserialize response to PartnersBillingUnbilledReconciliation|null
     */
    private function deserializePatch(string $body): PartnersBillingUnbilledReconciliation|null    {
        if (empty($body)) {
            return null;
        }
