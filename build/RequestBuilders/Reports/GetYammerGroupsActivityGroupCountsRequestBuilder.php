...
/**
 * Request builder for /reports/getYammerGroupsActivityGroupCounts(period='{period}')
 */
class GetYammerGroupsActivityGroupCountsRequestBuilder extends RootBaseRequestBuilder
{
    /**
