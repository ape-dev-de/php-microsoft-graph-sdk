...
/**
 * Request builder for /reports/getSkypeForBusinessDeviceUsageUserDetail(date={date})
 */
class GetSkypeForBusinessDeviceUsageUserDetailRequestBuilder extends RootBaseRequestBuilder
{
    /**
