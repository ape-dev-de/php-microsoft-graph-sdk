...
/**
 * Request builder for /reports/getSkypeForBusinessPeerToPeerActivityCounts(period='{period}')
 */
class GetSkypeForBusinessPeerToPeerActivityCountsRequestBuilder extends RootBaseRequestBuilder
{
    /**
