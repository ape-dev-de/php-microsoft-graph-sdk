...
/**
 * Request builder for /reports/getOffice365GroupsActivityFileCounts(period='{period}')
 */
class GetOffice365GroupsActivityFileCountsRequestBuilder extends RootBaseRequestBuilder
{
    /**
