...
/**
 * Request builder for /reports/getTeamsDeviceUsageUserCounts(period='{period}')
 */
class GetTeamsDeviceUsageUserCountsRequestBuilder extends RootBaseRequestBuilder
{
    /**
