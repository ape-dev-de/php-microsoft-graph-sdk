...
/**
 * Request builder for /reports/getSkypeForBusinessParticipantActivityMinuteCounts(period='{period}')
 */
class GetSkypeForBusinessParticipantActivityMinuteCountsRequestBuilder extends RootBaseRequestBuilder
{
    /**
