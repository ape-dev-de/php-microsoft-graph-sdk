...
/**
 * Request builder for /reports/getOneDriveActivityFileCounts(period='{period}')
 */
class GetOneDriveActivityFileCountsRequestBuilder extends RootBaseRequestBuilder
{
    /**
