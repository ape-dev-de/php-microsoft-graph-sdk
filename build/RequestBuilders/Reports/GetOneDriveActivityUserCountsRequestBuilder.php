...
/**
 * Request builder for /reports/getOneDriveActivityUserCounts(period='{period}')
 */
class GetOneDriveActivityUserCountsRequestBuilder extends RootBaseRequestBuilder
{
    /**
