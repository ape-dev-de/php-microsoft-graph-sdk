...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Reports\Reports\Partners\BillingRequestBuilder;
...
class PartnersRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): Partners
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to Partners
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(Partners $body): Partners
    {
