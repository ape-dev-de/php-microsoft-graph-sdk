...
/**
 * Request builder for /reports/getMailboxUsageQuotaStatusMailboxCounts(period='{period}')
 */
class GetMailboxUsageQuotaStatusMailboxCountsRequestBuilder extends RootBaseRequestBuilder
{
    /**
