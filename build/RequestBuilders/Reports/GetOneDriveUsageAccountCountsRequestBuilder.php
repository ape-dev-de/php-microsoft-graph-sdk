...
/**
 * Request builder for /reports/getOneDriveUsageAccountCounts(period='{period}')
 */
class GetOneDriveUsageAccountCountsRequestBuilder extends RootBaseRequestBuilder
{
    /**
