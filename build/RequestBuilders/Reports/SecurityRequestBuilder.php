...
class SecurityRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): SecurityReportsRoot|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to SecurityReportsRoot|null
     */
    private function deserializeGet(string $body): SecurityReportsRoot|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(SecurityReportsRoot $body): SecurityReportsRoot|null
    {
     ...
     * Deserialize response to SecurityReportsRoot|null
     */
    private function deserializePatch(string $body): SecurityReportsRoot|null    {
        if (empty($body)) {
            return null;
        }
