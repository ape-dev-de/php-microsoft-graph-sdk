...
class UserRegistrationDetailsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return UserRegistrationDetailsCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): UserRegistrationDetailsCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to UserRegistrationDetailsCollectionResponse|null
     */
    private function deserializeGet(string $body): UserRegistrationDetailsCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(UserRegistrationDetails $body): UserRegistrationDetails|null
    {
     ...
     */
    private function deserializePost(string $body): UserRegistrationDetails|null    {
        if (empty($body)) {
            return null;
        }
