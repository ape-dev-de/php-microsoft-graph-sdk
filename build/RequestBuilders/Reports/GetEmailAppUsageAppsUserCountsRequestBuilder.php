...
/**
 * Request builder for /reports/getEmailAppUsageAppsUserCounts(period='{period}')
 */
class GetEmailAppUsageAppsUserCountsRequestBuilder extends RootBaseRequestBuilder
{
    /**
