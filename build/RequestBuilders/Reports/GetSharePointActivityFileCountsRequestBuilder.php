...
/**
 * Request builder for /reports/getSharePointActivityFileCounts(period='{period}')
 */
class GetSharePointActivityFileCountsRequestBuilder extends RootBaseRequestBuilder
{
    /**
