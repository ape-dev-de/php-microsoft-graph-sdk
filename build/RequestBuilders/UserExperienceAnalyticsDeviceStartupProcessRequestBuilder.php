...
/**
 * Request builder for {userExperienceAnalyticsDeviceStartupProcess-id}
 */
class UserExperienceAnalyticsDeviceStartupProcessRequestBuilder extends BaseRequestBuilder
{
    /**
