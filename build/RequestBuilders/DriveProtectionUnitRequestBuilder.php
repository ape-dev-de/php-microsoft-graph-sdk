...
/**
 * Request builder for {driveProtectionUnit-id}
 */
class DriveProtectionUnitRequestBuilder extends BaseRequestBuilder
{
    /**
     ...
     */
    public function get(?array $select = null, ?array $expand = null): DriveProtectionUnit
    {
        $queryParams = [];
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(DriveProtectionUnit $body): DriveProtectionUnit
    {
