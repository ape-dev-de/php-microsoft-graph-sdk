...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RetentionEventRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for retentionEvents
 */
class RetentionEventsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new SecurityRetentionEventCollectionResponse([]);
