...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AppConsentRequestRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\FilterByCurrentUserRequestBuilder;

/**
 * Request builder for appConsentRequests
 */
class AppConsentRequestsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new AppConsentRequestCollectionResponse([]);
