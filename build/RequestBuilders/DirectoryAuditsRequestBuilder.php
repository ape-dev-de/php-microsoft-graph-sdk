...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DirectoryAuditRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for directoryAudits
 */
class DirectoryAuditsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new DirectoryAuditCollectionResponse([]);
