...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\TelecomExpenseManagementPartnerRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for telecomExpenseManagementPartners
 */
class TelecomExpenseManagementPartnersRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new TelecomExpenseManagementPartnerCollectionResponse([]);
