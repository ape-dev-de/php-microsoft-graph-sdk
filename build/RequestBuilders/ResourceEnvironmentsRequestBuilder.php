...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AccessPackageResourceEnvironmentRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for resourceEnvironments
 */
class ResourceEnvironmentsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new AccessPackageResourceEnvironmentCollectionResponse([]);
