...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\SwapShiftsChangeRequestRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for swapShiftsChangeRequests
 */
class SwapShiftsChangeRequestsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new SwapShiftsChangeRequestCollectionResponse([]);
