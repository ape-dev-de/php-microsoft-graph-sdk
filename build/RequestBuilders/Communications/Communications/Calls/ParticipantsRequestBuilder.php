...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Communications\Communications\Calls\Participants\ParticipantRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Communications\Communications\Calls\Participants\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Communications\Communications\Calls\Participants\InviteRequestBuilder;
...
class ParticipantsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): ParticipantCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to ParticipantCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(Participant $body): Participant
    {
