...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Communications\Communications\CallRecords\Sessions\Segments;
...
/**
 * Request builder for /communications/callRecords/{callRecord-id}/sessions/{session-id}/segments/$count
 */
