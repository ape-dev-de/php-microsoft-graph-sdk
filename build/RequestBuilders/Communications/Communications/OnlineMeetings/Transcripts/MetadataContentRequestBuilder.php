...
/**
 * Request builder for /communications/onlineMeetings/{onlineMeeting-id}/transcripts/{callTranscript-id}/metadataContent
 */
class MetadataContentRequestBuilder extends RootBaseRequestBuilder
{
    /**
