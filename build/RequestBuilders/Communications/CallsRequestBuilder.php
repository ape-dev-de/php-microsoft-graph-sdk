...
class CallsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return CallCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): CallCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to CallCollectionResponse|null
     */
    private function deserializeGet(string $body): CallCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(Call $body): Call|null
    {
     ...
     */
    private function deserializePost(string $body): Call|null    {
        if (empty($body)) {
            return null;
        }
