...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Communications\OnlineMeetings\AttendanceReportsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Communications\OnlineMeetings\AttendeeReportRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Communications\OnlineMeetings\GetVirtualAppointmentJoinWebUrlRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Communications\OnlineMeetings\SendVirtualAppointmentReminderSmsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Communications\OnlineMeetings\SendVirtualAppointmentSmsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Communications\OnlineMeetings\RecordingsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Communications\OnlineMeetings\TranscriptsRequestBuilder;

/**
 * Request builder for /communications/onlineMeetings/{onlineMeeting-id}
 */
class OnlineMeetingRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): OnlineMeeting|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to OnlineMeeting|null
     */
    private function deserializeGet(string $body): OnlineMeeting|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(OnlineMeeting $body): OnlineMeeting|null
    {
     ...
     * Deserialize response to OnlineMeeting|null
     */
    private function deserializePatch(string $body): OnlineMeeting|null    {
        if (empty($body)) {
            return null;
        }
