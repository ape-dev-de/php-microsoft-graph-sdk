...
class SendDtmfTonesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return SendDtmfTonesOperation|\stdClass|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(SendDtmfTonesOperation|\stdClass $body): SendDtmfTonesOperation|\stdClass|null
    {
    ...
    /**
     * Deserialize response to SendDtmfTonesOperation|\stdClass|null
     */
    private function deserializePost(string $body): SendDtmfTonesOperation|\stdClass|null    {
        if (empty($body)) {
            return null;
        }
