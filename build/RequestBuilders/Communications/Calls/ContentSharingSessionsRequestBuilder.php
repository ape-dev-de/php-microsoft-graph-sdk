...
class ContentSharingSessionsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return ContentSharingSessionCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): ContentSharingSessionCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to ContentSharingSessionCollectionResponse|null
     */
    private function deserializeGet(string $body): ContentSharingSessionCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @return ContentSharingSession|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(ContentSharingSession $body): ContentSharingSession|null
    {
    ...
    /**
     * Deserialize response to ContentSharingSession|null
     */
    private function deserializePost(string $body): ContentSharingSession|null    {
        if (empty($body)) {
            return null;
        }
