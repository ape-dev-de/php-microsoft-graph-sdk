...
class AddLargeGalleryViewRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return AddLargeGalleryViewOperation|\stdClass|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(AddLargeGalleryViewOperation|\stdClass $body): AddLargeGalleryViewOperation|\stdClass|null
    {
    ...
    /**
     * Deserialize response to AddLargeGalleryViewOperation|\stdClass|null
     */
    private function deserializePost(string $body): AddLargeGalleryViewOperation|\stdClass|null    {
        if (empty($body)) {
            return null;
        }
