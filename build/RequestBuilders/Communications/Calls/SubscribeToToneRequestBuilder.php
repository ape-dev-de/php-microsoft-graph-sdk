...
class SubscribeToToneRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return SubscribeToToneOperation|\stdClass|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(SubscribeToToneOperation|\stdClass $body): SubscribeToToneOperation|\stdClass|null
    {
    ...
    /**
     * Deserialize response to SubscribeToToneOperation|\stdClass|null
     */
    private function deserializePost(string $body): SubscribeToToneOperation|\stdClass|null    {
        if (empty($body)) {
            return null;
        }
