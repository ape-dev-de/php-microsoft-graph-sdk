...
class ParticipantRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): Participant|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): Participant|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(Participant $body): Participant|null
    {
     ...
     * Deserialize response to Participant|null
     */
    private function deserializePatch(string $body): Participant|null    {
        if (empty($body)) {
            return null;
        }
