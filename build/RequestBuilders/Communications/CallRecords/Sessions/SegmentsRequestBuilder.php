...
class SegmentsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return CallRecordsSegmentCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): CallRecordsSegmentCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to CallRecordsSegmentCollectionResponse|null
     */
    private function deserializeGet(string $body): CallRecordsSegmentCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @return CallRecordsSegment|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(CallRecordsSegment $body): CallRecordsSegment|null
    {
    ...
    /**
     * Deserialize response to CallRecordsSegment|null
     */
    private function deserializePost(string $body): CallRecordsSegment|null    {
        if (empty($body)) {
            return null;
        }
