...
class SegmentRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): CallRecordsSegment|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): CallRecordsSegment|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(CallRecordsSegment $body): CallRecordsSegment|null
    {
     ...
     * Deserialize response to CallRecordsSegment|null
     */
    private function deserializePatch(string $body): CallRecordsSegment|null    {
        if (empty($body)) {
            return null;
        }
