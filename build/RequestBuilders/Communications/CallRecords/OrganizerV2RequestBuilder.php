...
class OrganizerV2RequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): CallRecordsOrganizer|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to CallRecordsOrganizer|null
     */
    private function deserializeGet(string $body): CallRecordsOrganizer|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(CallRecordsOrganizer $body): CallRecordsOrganizer|null
    {
     ...
     * Deserialize response to CallRecordsOrganizer|null
     */
    private function deserializePatch(string $body): CallRecordsOrganizer|null    {
        if (empty($body)) {
            return null;
        }
