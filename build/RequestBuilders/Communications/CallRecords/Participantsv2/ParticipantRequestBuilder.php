...
class ParticipantRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): CallRecordsParticipant|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): CallRecordsParticipant|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(CallRecordsParticipant $body): CallRecordsParticipant|null
    {
     ...
     * Deserialize response to CallRecordsParticipant|null
     */
    private function deserializePatch(string $body): CallRecordsParticipant|null    {
        if (empty($body)) {
            return null;
        }
