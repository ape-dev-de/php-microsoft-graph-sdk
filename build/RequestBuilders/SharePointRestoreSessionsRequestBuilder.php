...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\SharePointRestoreSessionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for sharePointRestoreSessions
 */
class SharePointRestoreSessionsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new SharePointRestoreSessionCollectionResponse([]);
