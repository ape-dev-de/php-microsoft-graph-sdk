...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ItemActivityStatRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for itemActivityStats
 */
class ItemActivityStatsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new ItemActivityStatCollectionResponse([]);
