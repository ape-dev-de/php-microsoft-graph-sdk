...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\WindowsInformationProtectionAppLearningSummaryRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for windowsInformationProtectionAppLearningSummaries
 */
class WindowsInformationProtectionAppLearningSummariesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new WindowsInformationProtectionAppLearningSummaryCollectionResponse([]);
