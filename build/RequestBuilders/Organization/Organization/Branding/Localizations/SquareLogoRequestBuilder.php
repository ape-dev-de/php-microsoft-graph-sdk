...
/**
 * Request builder for /organization/{organization-id}/branding/localizations/{organizationalBrandingLocalization-id}/squareLogo
 */
class SquareLogoRequestBuilder extends RootBaseRequestBuilder
{
    /**
