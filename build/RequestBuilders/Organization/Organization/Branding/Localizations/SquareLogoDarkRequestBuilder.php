...
/**
 * Request builder for /organization/{organization-id}/branding/localizations/{organizationalBrandingLocalization-id}/squareLogoDark
 */
class SquareLogoDarkRequestBuilder extends RootBaseRequestBuilder
{
    /**
