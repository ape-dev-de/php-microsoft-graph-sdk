...
/**
 * Request builder for /organization/{organization-id}/branding/localizations/{organizationalBrandingLocalization-id}/backgroundImage
 */
class BackgroundImageRequestBuilder extends RootBaseRequestBuilder
{
    /**
