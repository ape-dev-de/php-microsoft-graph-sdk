...
/**
 * Request builder for /organization/{organization-id}/branding/localizations/{organizationalBrandingLocalization-id}/favicon
 */
class FaviconRequestBuilder extends RootBaseRequestBuilder
{
    /**
