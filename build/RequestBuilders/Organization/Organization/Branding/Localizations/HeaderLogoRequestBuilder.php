...
/**
 * Request builder for /organization/{organization-id}/branding/localizations/{organizationalBrandingLocalization-id}/headerLogo
 */
class HeaderLogoRequestBuilder extends RootBaseRequestBuilder
{
    /**
