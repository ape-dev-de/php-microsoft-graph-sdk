...
class OrganizationItemRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): Organization|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): Organization|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(Organization $body): Organization|null
    {
     ...
     * Deserialize response to Organization|null
     */
    private function deserializePatch(string $body): Organization|null    {
        if (empty($body)) {
            return null;
        }
