...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\UnifiedRoleManagementPolicyRuleRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for effectiveRules
 */
class EffectiveRulesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new UnifiedRoleManagementPolicyRuleCollectionResponse([]);
