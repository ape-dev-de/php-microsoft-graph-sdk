...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BookingCustomQuestionRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for customQuestions
 */
class CustomQuestionsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new BookingCustomQuestionCollectionResponse([]);
