...
/**
 * Request builder for {windowsInformationProtectionNetworkLearningSummary-id}
 */
class WindowsInformationProtectionNetworkLearningSummaryRequestBuilder extends BaseRequestBuilder
{
    /**
