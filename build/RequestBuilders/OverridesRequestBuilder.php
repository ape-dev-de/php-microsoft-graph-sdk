...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\InferenceClassificationOverrideRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for overrides
 */
class OverridesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new InferenceClassificationOverrideCollectionResponse([]);
