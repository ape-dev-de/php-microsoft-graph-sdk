...
class ServicePrincipalRiskDetectionsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return ServicePrincipalRiskDetectionCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): ServicePrincipalRiskDetectionCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to ServicePrincipalRiskDetectionCollectionResponse|null
     */
    private function deserializeGet(string $body): ServicePrincipalRiskDetectionCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @return ServicePrincipalRiskDetection|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(ServicePrincipalRiskDetection $body): ServicePrincipalRiskDetection|null
    {
    ...
    /**
     * Deserialize response to ServicePrincipalRiskDetection|null
     */
    private function deserializePost(string $body): ServicePrincipalRiskDetection|null    {
        if (empty($body)) {
            return null;
        }
