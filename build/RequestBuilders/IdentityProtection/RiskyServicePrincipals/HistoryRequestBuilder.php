...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityProtection\RiskyServicePrincipals\History\RiskyServicePrincipalHistoryItemRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityProtection\RiskyServicePrincipals\History\CountRequestBuilder;
...
class HistoryRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return RiskyServicePrincipalHistoryItemCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): RiskyServicePrincipalHistoryItemCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to RiskyServicePrincipalHistoryItemCollectionResponse|null
     */
    private function deserializeGet(string $body): RiskyServicePrincipalHistoryItemCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(RiskyServicePrincipalHistoryItem $body): RiskyServicePrincipalHistoryItem|null
    {
     ...
     */
    private function deserializePost(string $body): RiskyServicePrincipalHistoryItem|null    {
        if (empty($body)) {
            return null;
        }
