...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityProtection\RiskyUsers\HistoryRequestBuilder;
...
class RiskyUserRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): RiskyUser|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): RiskyUser|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(RiskyUser $body): RiskyUser|null
    {
     ...
     * Deserialize response to RiskyUser|null
     */
    private function deserializePatch(string $body): RiskyUser|null    {
        if (empty($body)) {
            return null;
        }
