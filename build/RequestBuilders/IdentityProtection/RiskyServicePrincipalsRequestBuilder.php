...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityProtection\RiskyServicePrincipals\RiskyServicePrincipalRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityProtection\RiskyServicePrincipals\CountRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityProtection\RiskyServicePrincipals\ConfirmCompromisedRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityProtection\RiskyServicePrincipals\DismissRequestBuilder;
...
class RiskyServicePrincipalsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return RiskyServicePrincipalCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): RiskyServicePrincipalCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to RiskyServicePrincipalCollectionResponse|null
     */
    private function deserializeGet(string $body): RiskyServicePrincipalCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(RiskyServicePrincipal $body): RiskyServicePrincipal|null
    {
     ...
     */
    private function deserializePost(string $body): RiskyServicePrincipal|null    {
        if (empty($body)) {
            return null;
        }
