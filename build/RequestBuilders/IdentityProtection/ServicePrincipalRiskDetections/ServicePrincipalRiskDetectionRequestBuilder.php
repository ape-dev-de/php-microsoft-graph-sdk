...
class ServicePrincipalRiskDetectionRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): ServicePrincipalRiskDetection|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): ServicePrincipalRiskDetection|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(ServicePrincipalRiskDetection $body): ServicePrincipalRiskDetection|null
    {
     ...
     * Deserialize response to ServicePrincipalRiskDetection|null
     */
    private function deserializePatch(string $body): ServicePrincipalRiskDetection|null    {
        if (empty($body)) {
            return null;
        }
