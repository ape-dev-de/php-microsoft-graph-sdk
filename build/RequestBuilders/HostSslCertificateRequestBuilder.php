...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\SslCertificateRequestBuilder;

/**
 * Request builder for {hostSslCertificate-id}
 */
class HostSslCertificateRequestBuilder extends BaseRequestBuilder
{
    /**
