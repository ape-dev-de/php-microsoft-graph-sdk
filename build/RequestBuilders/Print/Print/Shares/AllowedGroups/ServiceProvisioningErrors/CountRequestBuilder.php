...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Print\Print\Shares\AllowedGroups\ServiceProvisioningErrors;
...
/**
 * Request builder for /print/shares/{printerShare-id}/allowedGroups/{group-id}/serviceProvisioningErrors/$count
 */
