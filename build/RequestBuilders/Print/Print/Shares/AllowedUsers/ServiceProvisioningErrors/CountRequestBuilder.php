...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Print\Print\Shares\AllowedUsers\ServiceProvisioningErrors;
...
/**
 * Request builder for /print/shares/{printerShare-id}/allowedUsers/{user-id}/serviceProvisioningErrors/$count
 */
