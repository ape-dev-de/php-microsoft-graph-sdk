...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Print\Print\Connectors\PrintConnectorRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Print\Print\Connectors\CountRequestBuilder;
...
class ConnectorsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): PrintConnectorCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to PrintConnectorCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(PrintConnector $body): PrintConnector
    {
    ...
    /**
     * Deserialize response to PrintConnector
     */
