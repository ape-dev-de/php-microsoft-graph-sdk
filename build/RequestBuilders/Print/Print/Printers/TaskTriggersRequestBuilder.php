...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Print\Print\Printers\TaskTriggers\PrintTaskTriggerRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Print\Print\Printers\TaskTriggers\CountRequestBuilder;
...
class TaskTriggersRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): PrintTaskTriggerCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to PrintTaskTriggerCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(PrintTaskTrigger $body): PrintTaskTrigger
    {
