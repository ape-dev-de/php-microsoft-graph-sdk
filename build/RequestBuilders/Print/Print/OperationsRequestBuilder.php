...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Print\Print\Operations\PrintOperationRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Print\Print\Operations\CountRequestBuilder;
...
class OperationsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): PrintOperationCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to PrintOperationCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(PrintOperation $body): PrintOperation
    {
    ...
    /**
     * Deserialize response to PrintOperation
     */
