...
class EndpointsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return PrintServiceEndpointCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): PrintServiceEndpointCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to PrintServiceEndpointCollectionResponse|null
     */
    private function deserializeGet(string $body): PrintServiceEndpointCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(PrintServiceEndpoint $body): PrintServiceEndpoint|null
    {
     ...
     */
    private function deserializePost(string $body): PrintServiceEndpoint|null    {
        if (empty($body)) {
            return null;
        }
