...
class PrintServiceRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): PrintService|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): PrintService|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(PrintService $body): PrintService|null
    {
     ...
     * Deserialize response to PrintService|null
     */
    private function deserializePatch(string $body): PrintService|null    {
        if (empty($body)) {
            return null;
        }
