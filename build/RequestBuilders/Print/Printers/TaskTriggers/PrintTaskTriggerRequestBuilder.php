...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Print\Printers\TaskTriggers;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\PrintTaskTrigger;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Print\Printers\TaskTriggers\DefinitionRequestBuilder;
...
class PrintTaskTriggerRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(PrintTaskTrigger $body): PrintTaskTrigger|null
    {
     ...
     * Deserialize response to PrintTaskTrigger|null
     */
    private function deserializePatch(string $body): PrintTaskTrigger|null    {
        if (empty($body)) {
            return null;
        }
