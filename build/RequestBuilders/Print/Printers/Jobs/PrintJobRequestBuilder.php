...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Print\Printers\Jobs;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\PrintJob;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Print\Printers\Jobs\DocumentsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Print\Printers\Jobs\AbortRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Print\Printers\Jobs\CancelRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Print\Printers\Jobs\RedirectRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Print\Printers\Jobs\StartRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Print\Printers\Jobs\TasksRequestBuilder;

/**
 * Request builder for /print/printers/{printer-id}/jobs/{printJob-id}
 */
class PrintJobRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): PrintJob|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): PrintJob|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(PrintJob $body): PrintJob|null
    {
     ...
     * Deserialize response to PrintJob|null
     */
    private function deserializePatch(string $body): PrintJob|null    {
        if (empty($body)) {
            return null;
        }
