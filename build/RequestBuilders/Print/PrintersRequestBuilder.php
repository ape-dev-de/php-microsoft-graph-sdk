...
class PrintersRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return PrinterCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): PrinterCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to PrinterCollectionResponse|null
     */
    private function deserializeGet(string $body): PrinterCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(Printer $body): Printer|null
    {
    ...
    /**
     * Deserialize response to Printer|null
     */
    private function deserializePost(string $body): Printer|null    {
        if (empty($body)) {
            return null;
        }
