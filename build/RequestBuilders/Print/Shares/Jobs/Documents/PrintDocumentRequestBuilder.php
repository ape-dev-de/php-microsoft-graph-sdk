...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Print\Shares\Jobs\Documents;

use ApeDevDe\MicrosoftGraphSdk\Http\GraphClient;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BaseRequestBuilder as RootBaseRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\Models\PrintDocument;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Print\Shares\Jobs\Documents\ValueRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Print\Shares\Jobs\Documents\CreateUploadSessionRequestBuilder;

/**
 * Request builder for /print/shares/{printerShare-id}/jobs/{printJob-id}/documents/{printDocument-id}
 */
class PrintDocumentRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): PrintDocument|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): PrintDocument|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(PrintDocument $body): PrintDocument|null
    {
     ...
     * Deserialize response to PrintDocument|null
     */
    private function deserializePatch(string $body): PrintDocument|null    {
        if (empty($body)) {
            return null;
        }
