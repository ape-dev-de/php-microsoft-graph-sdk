...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\TemporaryAccessPassAuthenticationMethodRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for temporaryAccessPassMethods
 */
class TemporaryAccessPassMethodsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new TemporaryAccessPassAuthenticationMethodCollectionResponse([]);
