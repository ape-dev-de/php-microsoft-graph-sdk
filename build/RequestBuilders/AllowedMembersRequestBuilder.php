...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ConversationMemberRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for allowedMembers
 */
class AllowedMembersRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new ConversationMemberCollectionResponse([]);
