...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\TokenIssuancePolicyRequestBuilder;

/**
 * Request builder for tokenIssuancePolicies
 */
class TokenIssuancePoliciesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new TokenIssuancePolicyCollectionResponse([]);
