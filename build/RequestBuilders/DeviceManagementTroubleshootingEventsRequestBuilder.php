...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DeviceManagementTroubleshootingEventRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for deviceManagementTroubleshootingEvents
 */
class DeviceManagementTroubleshootingEventsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new DeviceManagementTroubleshootingEventCollectionResponse([]);
