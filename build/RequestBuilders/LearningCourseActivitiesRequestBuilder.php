...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\LearningCourseActivityRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for learningCourseActivities
 */
class LearningCourseActivitiesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new LearningCourseActivityCollectionResponse([]);
