...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AgreementFileLocalizationRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for localizations
 */
class LocalizationsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new AgreementFileLocalizationCollectionResponse([]);
