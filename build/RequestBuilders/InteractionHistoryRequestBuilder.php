...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\GetAllEnterpriseInteractionsRequestBuilder;

/**
 * Request builder for interactionHistory
 */
class InteractionHistoryRequestBuilder extends BaseRequestBuilder
{
    /**
