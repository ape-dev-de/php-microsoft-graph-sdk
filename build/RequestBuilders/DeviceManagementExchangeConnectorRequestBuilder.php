...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\SyncRequestBuilder;

/**
 * Request builder for {deviceManagementExchangeConnector-id}
 */
class DeviceManagementExchangeConnectorRequestBuilder extends BaseRequestBuilder
{
    /**
