...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\EmployeeExperience\EngagementAsyncOperations\EngagementAsyncOperationRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\EmployeeExperience\EngagementAsyncOperations\CountRequestBuilder;
...
class EngagementAsyncOperationsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return EngagementAsyncOperationCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): EngagementAsyncOperationCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to EngagementAsyncOperationCollectionResponse|null
     */
    private function deserializeGet(string $body): EngagementAsyncOperationCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(EngagementAsyncOperation $body): EngagementAsyncOperation|null
    {
     ...
     */
    private function deserializePost(string $body): EngagementAsyncOperation|null    {
        if (empty($body)) {
            return null;
        }
