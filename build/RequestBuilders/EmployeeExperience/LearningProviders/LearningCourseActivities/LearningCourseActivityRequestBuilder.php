...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\EmployeeExperience\LearningProviders\LearningCourseActivities;
...
/**
 * Request builder for /employeeExperience/learningProviders/{learningProvider-id}/learningCourseActivities/{learningCourseActivity-id}
 */
class LearningCourseActivityRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(LearningCourseActivity $body): LearningCourseActivity|null
    {
     ...
     * Deserialize response to LearningCourseActivity|null
     */
    private function deserializePatch(string $body): LearningCourseActivity|null    {
        if (empty($body)) {
            return null;
        }
