...
class LearningContentsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return LearningContentCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): LearningContentCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to LearningContentCollectionResponse|null
     */
    private function deserializeGet(string $body): LearningContentCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(LearningContent $body): LearningContent|null
    {
    ...
    /**
     * Deserialize response to LearningContent|null
     */
    private function deserializePost(string $body): LearningContent|null    {
        if (empty($body)) {
            return null;
        }
