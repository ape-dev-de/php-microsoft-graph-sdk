...
class LearningContentRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): LearningContent|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): LearningContent|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(LearningContent $body): LearningContent|null
    {
     ...
     * Deserialize response to LearningContent|null
     */
    private function deserializePatch(string $body): LearningContent|null    {
        if (empty($body)) {
            return null;
        }
