...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\EmployeeExperience\LearningProviders\LearningContentsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\EmployeeExperience\LearningProviders\LearningCourseActivitiesRequestBuilder;
...
class LearningProviderRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): LearningProvider|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): LearningProvider|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(LearningProvider $body): LearningProvider|null
    {
     ...
     * Deserialize response to LearningProvider|null
     */
    private function deserializePatch(string $body): LearningProvider|null    {
        if (empty($body)) {
            return null;
        }
