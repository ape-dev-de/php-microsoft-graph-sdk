...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\EducationSubmissionResourceRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for submittedResources
 */
class SubmittedResourcesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new EducationSubmissionResourceCollectionResponse([]);
