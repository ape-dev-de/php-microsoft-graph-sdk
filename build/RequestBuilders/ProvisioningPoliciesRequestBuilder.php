...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CloudPcProvisioningPolicyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for provisioningPolicies
 */
class ProvisioningPoliciesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new CloudPcProvisioningPolicyCollectionResponse([]);
