...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IdentityUserFlowAttributeRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for userFlowAttributes
 */
class UserFlowAttributesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new IdentityUserFlowAttributeCollectionResponse([]);
