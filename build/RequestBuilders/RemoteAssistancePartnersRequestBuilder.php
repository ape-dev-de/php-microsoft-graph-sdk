...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\RemoteAssistancePartnerRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for remoteAssistancePartners
 */
class RemoteAssistancePartnersRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new RemoteAssistancePartnerCollectionResponse([]);
