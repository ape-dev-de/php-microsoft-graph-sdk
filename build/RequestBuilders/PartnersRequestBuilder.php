...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CrossTenantAccessPolicyConfigurationPartnerTenantIdRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for partners
 */
class PartnersRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new CrossTenantAccessPolicyConfigurationPartnerCollectionResponse([]);
