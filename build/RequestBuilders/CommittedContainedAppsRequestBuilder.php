...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\MobileContainedAppRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for committedContainedApps
 */
class CommittedContainedAppsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new MobileContainedAppCollectionResponse([]);
