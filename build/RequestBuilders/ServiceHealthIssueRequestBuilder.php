...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\IncidentReportRequestBuilder;

/**
 * Request builder for {serviceHealthIssue-id}
 */
class ServiceHealthIssueRequestBuilder extends BaseRequestBuilder
{
    /**
