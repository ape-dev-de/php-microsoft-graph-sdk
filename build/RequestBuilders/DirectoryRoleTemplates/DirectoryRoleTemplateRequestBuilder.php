...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DirectoryRoleTemplates\CheckMemberGroupsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DirectoryRoleTemplates\CheckMemberObjectsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DirectoryRoleTemplates\GetMemberGroupsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DirectoryRoleTemplates\GetMemberObjectsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DirectoryRoleTemplates\RestoreRequestBuilder;
...
class DirectoryRoleTemplateRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): DirectoryRoleTemplate|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): DirectoryRoleTemplate|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(DirectoryRoleTemplate $body): DirectoryRoleTemplate|null
    {
     ...
     * Deserialize response to DirectoryRoleTemplate|null
     */
    private function deserializePatch(string $body): DirectoryRoleTemplate|null    {
        if (empty($body)) {
            return null;
        }
