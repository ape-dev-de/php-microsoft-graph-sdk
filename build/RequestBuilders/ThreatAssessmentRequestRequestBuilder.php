...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\ResultsRequestBuilder;

/**
 * Request builder for {threatAssessmentRequest-id}
 */
class ThreatAssessmentRequestRequestBuilder extends BaseRequestBuilder
{
    /**
