...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\WindowsInformationProtectionNetworkLearningSummaryRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for windowsInformationProtectionNetworkLearningSummaries
 */
class WindowsInformationProtectionNetworkLearningSummariesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new WindowsInformationProtectionNetworkLearningSummaryCollectionResponse([]);
