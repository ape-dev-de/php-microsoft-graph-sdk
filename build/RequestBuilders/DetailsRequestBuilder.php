...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\EndUserNotificationDetailRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for details
 */
class DetailsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new EndUserNotificationDetailCollectionResponse([]);
