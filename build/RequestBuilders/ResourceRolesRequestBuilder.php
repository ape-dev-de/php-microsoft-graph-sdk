...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AccessPackageResourceRoleRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for resourceRoles
 */
class ResourceRolesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new AccessPackageResourceRoleCollectionResponse([]);
