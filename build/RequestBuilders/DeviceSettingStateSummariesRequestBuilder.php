...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\SettingStateDeviceSummaryRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for deviceSettingStateSummaries
 */
class DeviceSettingStateSummariesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new SettingStateDeviceSummaryCollectionResponse([]);
