...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Fido2AuthenticationMethodRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for fido2Methods
 */
class Fido2MethodsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new Fido2AuthenticationMethodCollectionResponse([]);
