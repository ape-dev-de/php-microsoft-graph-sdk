...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AgreementAcceptanceRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for acceptances
 */
class AcceptancesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new AgreementAcceptanceCollectionResponse([]);
