...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DriveProtectionUnitRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for driveProtectionUnits
 */
class DriveProtectionUnitsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new DriveProtectionUnitCollectionResponse([]);
