...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\FeatureRolloutPolicyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for featureRolloutPolicies
 */
class FeatureRolloutPoliciesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new FeatureRolloutPolicyCollectionResponse([]);
