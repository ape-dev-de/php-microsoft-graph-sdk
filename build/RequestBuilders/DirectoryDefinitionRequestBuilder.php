...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\DiscoverRequestBuilder;

/**
 * Request builder for {directoryDefinition-id}
 */
class DirectoryDefinitionRequestBuilder extends BaseRequestBuilder
{
    /**
