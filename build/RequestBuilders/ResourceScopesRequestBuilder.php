...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AccessPackageResourceScopeRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for resourceScopes
 */
class ResourceScopesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new AccessPackageResourceScopeCollectionResponse([]);
