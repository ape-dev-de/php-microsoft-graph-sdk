...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Directory\AdministrativeUnits\ExtensionsRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Directory\AdministrativeUnits\MembersRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Directory\AdministrativeUnits\ScopedRoleMembersRequestBuilder;

/**
 * Request builder for /directory/administrativeUnits/{administrativeUnit-id}
 */
class AdministrativeUnitRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): AdministrativeUnit|null
    {
        $queryParams = [];
     ...
     */
    private function deserializeGet(string $body): AdministrativeUnit|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(AdministrativeUnit $body): AdministrativeUnit|null
    {
     ...
     * Deserialize response to AdministrativeUnit|null
     */
    private function deserializePatch(string $body): AdministrativeUnit|null    {
        if (empty($body)) {
            return null;
        }
