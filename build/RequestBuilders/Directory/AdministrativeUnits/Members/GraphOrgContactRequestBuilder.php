...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Directory\AdministrativeUnits\Members\GraphorgContact\CountRequestBuilder;
...
class GraphOrgContactRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?string $consistencyLevel = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): OrgContactCollectionResponse|null
    {
        $queryParams = [];
