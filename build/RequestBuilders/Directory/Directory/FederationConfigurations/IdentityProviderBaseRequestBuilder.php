...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Directory\Directory\FederationConfigurations;
...
class IdentityProviderBaseRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): IdentityProviderBase
    {
        $queryParams = [];
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(IdentityProviderBase $body): IdentityProviderBase
    {
