...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Directory\Directory\CustomSecurityAttributeDefinitions\AllowedValuesRequestBuilder;
...
class CustomSecurityAttributeDefinitionRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): CustomSecurityAttributeDefinition
    {
        $queryParams = [];
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(CustomSecurityAttributeDefinition $body): CustomSecurityAttributeDefinition
    {
