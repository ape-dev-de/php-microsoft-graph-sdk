...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Directory\Directory\PublicKeyInfrastructure\CertificateBasedAuthConfigurationsRequestBuilder;
...
class PublicKeyInfrastructureRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null): PublicKeyInfrastructureRoot
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to PublicKeyInfrastructureRoot
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function patch(PublicKeyInfrastructureRoot $body): PublicKeyInfrastructureRoot
    {
