...
namespace ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Directory\Directory\PublicKeyInfrastructure\CertificateBasedAuthConfigurations;
...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Directory\Directory\PublicKeyInfrastructure\CertificateBasedAuthConfigurations\CertificateAuthorities\CertificateAuthorityDetailRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Directory\Directory\PublicKeyInfrastructure\CertificateBasedAuthConfigurations\CertificateAuthorities\CountRequestBuilder;
...
class CertificateAuthoritiesRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): CertificateAuthorityDetailCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to CertificateAuthorityDetailCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(CertificateAuthorityDetail $body): CertificateAuthorityDetail
    {
