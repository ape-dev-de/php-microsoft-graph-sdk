...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Directory\Directory\DeviceLocalCredentials\DeviceLocalCredentialInfoRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\Directory\Directory\DeviceLocalCredentials\CountRequestBuilder;
...
class DeviceLocalCredentialsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): DeviceLocalCredentialInfoCollectionResponse
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to DeviceLocalCredentialInfoCollectionResponse
     */
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(DeviceLocalCredentialInfo $body): DeviceLocalCredentialInfo
    {
    ...
    /**
     * Deserialize response to DeviceLocalCredentialInfo
     */
