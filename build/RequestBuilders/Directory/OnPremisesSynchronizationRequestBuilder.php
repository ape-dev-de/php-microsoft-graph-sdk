...
class OnPremisesSynchronizationRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return OnPremisesDirectorySynchronizationCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): OnPremisesDirectorySynchronizationCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to OnPremisesDirectorySynchronizationCollectionResponse|null
     */
    private function deserializeGet(string $body): OnPremisesDirectorySynchronizationCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @return OnPremisesDirectorySynchronization|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(OnPremisesDirectorySynchronization $body): OnPremisesDirectorySynchronization|null
    {
    ...
    /**
     * Deserialize response to OnPremisesDirectorySynchronization|null
     */
    private function deserializePost(string $body): OnPremisesDirectorySynchronization|null    {
        if (empty($body)) {
            return null;
        }
