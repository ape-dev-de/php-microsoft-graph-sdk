...
class CertificateBasedAuthConfigurationsRequestBuilder extends RootBaseRequestBuilder
{
     ...
     * @return CertificateBasedAuthPkiCollectionResponse|null
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function get(?array $select = null, ?array $expand = null, ?int $top = null, ?int $skip = null, ?string $search = null, ?string $filter = null, ?bool $count = null, ?array $orderby = null): CertificateBasedAuthPkiCollectionResponse|null
    {
        $queryParams = [];
    ...
    /**
     * Deserialize response to CertificateBasedAuthPkiCollectionResponse|null
     */
    private function deserializeGet(string $body): CertificateBasedAuthPkiCollectionResponse|null    {
        if (empty($body)) {
            return null;
        }
     ...
     * @throws \ApeDevDe\MicrosoftGraphSdk\Exceptions\GraphException
     */
    public function post(CertificateBasedAuthPki $body): CertificateBasedAuthPki|null
    {
     ...
     */
    private function deserializePost(string $body): CertificateBasedAuthPki|null    {
        if (empty($body)) {
            return null;
        }
