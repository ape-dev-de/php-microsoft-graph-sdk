...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AuthenticationContextClassReferenceRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for authenticationContextClassReferences
 */
class AuthenticationContextClassReferencesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new AuthenticationContextClassReferenceCollectionResponse([]);
