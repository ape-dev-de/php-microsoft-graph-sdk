...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\BookingCurrencyRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for bookingCurrencies
 */
class BookingCurrenciesRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new BookingCurrencyCollectionResponse([]);
