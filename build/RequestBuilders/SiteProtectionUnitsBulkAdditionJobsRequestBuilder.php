...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\SiteProtectionUnitsBulkAdditionJobRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for siteProtectionUnitsBulkAdditionJobs
 */
class SiteProtectionUnitsBulkAdditionJobsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new SiteProtectionUnitsBulkAdditionJobCollectionResponse([]);
