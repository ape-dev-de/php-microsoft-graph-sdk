...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\AttributeMappingFunctionSchemaRequestBuilder;
...
class FunctionsRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new AttributeMappingFunctionSchemaCollectionResponse([]);
