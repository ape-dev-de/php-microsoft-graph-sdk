...
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\PrintTaskTriggerRequestBuilder;
use ApeDevDe\MicrosoftGraphSdk\RequestBuilders\CountRequestBuilder;

/**
 * Request builder for taskTriggers
 */
class TaskTriggersRequestBuilder extends BaseRequestBuilder
{
    ...
    private function deserializeGet(string $body): mixed
    {
        ...
        $collection = new PrintTaskTriggerCollectionResponse([]);
