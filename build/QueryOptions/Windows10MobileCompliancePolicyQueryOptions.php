...
class Windows10MobileCompliancePolicyQueryOptions extends QueryOptions
{
    ...
    public const FIELD_PASSWORD_REQUIRE_TO_UNLOCK_FROM_IDLE = 'passwordRequireToUnlockFromIdle';
     ...
     * 
     * @param array<string> $select Use Windows10MobileCompliancePolicyQueryOptions::FIELD_* constants or property names
     */
