...
/**
 * Query options for DeviceConfigurationSettingState resources
 *
 ...
 * - userPrincipalName
 */
class DeviceConfigurationSettingStateQueryOptions extends QueryOptions
{
    ...
    /**
     * Select specific DeviceConfigurationSettingState properties
     * 
     * @param array<string> $select Use DeviceConfigurationSettingStateQueryOptions::FIELD_* constants or property names
     */
