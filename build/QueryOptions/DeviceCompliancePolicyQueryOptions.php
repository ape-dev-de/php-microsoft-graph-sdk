...
class DeviceCompliancePolicyQueryOptions extends QueryOptions
{
    ...
    public const FIELD_SCHEDULED_ACTIONS_FOR_RULE = 'scheduledActionsForRule';
     ...
     * 
     * @param array<string> $select Use DeviceCompliancePolicyQueryOptions::FIELD_* constants or property names
     */
